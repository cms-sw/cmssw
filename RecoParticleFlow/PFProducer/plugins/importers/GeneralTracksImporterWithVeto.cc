...
public:
  GeneralTracksImporterWithVeto(const edm::ParameterSet& conf,
    ...
    _veto(sumes.consumes<reco::PFRecTrackCollection>(conf.getParameter<edm::InputTag>("veto"))),
...
private:
  ...
  edm::EDGetTokenT<reco::PFRecTrackCollection> _src, _veto;
...
bool GeneralTracksImporterWithVeto::
