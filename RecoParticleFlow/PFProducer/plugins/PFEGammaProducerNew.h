#ifndef RecoParticleFlow_PFEGammaProducer_PFEGammaProducerNew_h_
#define RecoParticleFlow_PFEGammaProducer_PFEGammaProducerNew_h_
...
class PFEGammaProducerNew : public edm::EDProducer {
 public:
  explicit PFEGammaProducerNew(const edm::ParameterSet&);
  ~PFEGammaProducerNew();
 ...
 private:
  ...
  std::unique_ptr<PFEGammaAlgoNew>      pfeg_;
