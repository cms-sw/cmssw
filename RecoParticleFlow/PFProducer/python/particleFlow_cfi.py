...
particleFlowTmp = cms.EDProducer("PFProducer",
    ...
    pf_locC_mvaWeightFile=cms.string('/afs/cern.ch/user/r/rpatel/ConvXml/TMVARegression_BDTG_PFClusterCorr.root'),
    pf_GlobC_mvaWeightFile=cms.string('/afs/cern.ch/user/r/rpatel/ConvXml/TMVARegression_BDTG_PFGlobalCorr.root'),
