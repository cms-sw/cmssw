...
public:
  ...
  template <typename T, typename U> static double deltaEt(const T *, const U *);
  ...
  template <typename T, typename U> static double deltaR(const T *, const U *);

  // Match Candidate T to a Candidate in the Collection based on minimum Delta-R
  template <typename T, typename Collection>
  static const typename Collection::value_type *
  matchByDeltaR(const T *, const Collection *);

  // Match Candidate T to a Candidate U in the Collection based on minimum
  // Delta-Et
  template <typename T, typename Collection>
  static const typename Collection::value_type *
...
public:
  ...
  bool operator()(const U &c1, const U &c2) const {
    return PFBenchmarkAlgo::deltaR(cref, &c1) <
           PFBenchmarkAlgo::deltaR(cref, &c2);
  }
...
public:
  ...
  bool operator()(const U &c1, const U &c2) const {
    return fabs(PFBenchmarkAlgo::deltaEt(cref, &c1)) <
           fabs(PFBenchmarkAlgo::deltaEt(cref, &c2));
  }
...
PFBenchmarkAlgo::matchByDeltaR(const T *c1, const Collection *candidates) {
...
template <typename T, typename Collection>
const typename Collection::value_type *
PFBenchmarkAlgo::matchByDeltaEt(const T *c1, const Collection *candidates) {
