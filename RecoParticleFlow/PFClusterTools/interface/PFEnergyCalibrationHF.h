...
public:
  ...
  const bool& getcalibHF_use() const { return calibHF_use_; }
  const std::vector<double>& getcalibHF_eta_step() const { return calibHF_eta_step_; }
  const std::vector<double>& getcalibHF_a_EMonly() const { return calibHF_a_EMonly_; }
  const std::vector<double>& getcalibHF_b_HADonly() const { return calibHF_b_HADonly_; }
  const std::vector<double>& getcalibHF_a_EMHAD() const { return calibHF_a_EMHAD_; }
  const std::vector<double>& getcalibHF_b_EMHAD() const { return calibHF_b_EMHAD_; }
