#ifndef RecoParticleFlow_PFRootEvent_PFRootEventManagerUpgrade_h
#define RecoParticleFlow_PFRootEvent_PFRootEventManagerUpgrade_h
...
class PFRootEventManagerUpgrade {
 ...
 public:
  ...
  /// default constructor
  PFRootEventManagerUpgrade();
  
  /// \param is an option file, see IO
  PFRootEventManagerUpgrade(const char* file);

  /// destructor
  virtual ~PFRootEventManagerUpgrade();
  ...
  /// remake the PF rechit collection from rechits and digis
  void RemakeRecHits(reco::PFRecHitCollection& rechits,
  ...
  // timing plot
  TH2F*            h_time_vs_tdc_;
  TH2F*            h_time_vs_tdc5_;
  TH2F*            h_time_vs_tdc10_;
  ...
  /// rechits HCAL Upgrade
  edm::Handle<HcalUpgradeRecHitCollection> rechitsHCALUpgradeHandle_;
  edm::InputTag rechitsHCALUpgradeTag_;
  HcalUpgradeRecHitCollection rechitsHCALUpgrade_;

  /// rechits HCAL Upgrade Digi
  edm::Handle<HcalUpgradeDigiCollection> digiHCALUpgradeDigiHandle_;
  edm::InputTag digiHCALUpgradeDigiTag_;
  HcalUpgradeDigiCollection digiHCALUpgradeDigi_;
  /// remake of rechits HCAL
  reco::PFRecHitCollection rechitsHCALnew_;
  ...
  PFSuperClusterAlgo   superClusterAlgoHCAL_;
  ...
  bool   debug_;
  /// set high pileup condition on/off
  bool   debug_hiPU_;
