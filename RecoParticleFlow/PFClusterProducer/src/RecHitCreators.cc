...
#include "RecoParticleFlow/PFClusterProducer/interface/PFHBHERecHitCreatorPulses.h"
...
DEFINE_EDM_PLUGIN(PFRecHitFactory, PFHBHERecHitCreatorPulses, "PFHBHERecHitCreatorPulses");
