#ifndef RecoParticleFlow_PFClusterProducer_plugins_PFClusterProducerCudaHCAL_h
#define RecoParticleFlow_PFClusterProducer_plugins_PFClusterProducerCudaHCAL_h
...
public:
  ...
  TH1F *nRH_perPFClusterTotal_CPU =
      new TH1F("nRH_perPFClusterTotal_CPU", "nRH_perPFClusterTotal_CPU", 8000, 1000.5, 9000.5);
  TH1F *nRH_perPFClusterTotal_GPU =
      new TH1F("nRH_perPFClusterTotal_GPU", "nRH_perPFClusterTotal_GPU", 8000, 1000.5, 9000.5);
...
#endif  // RecoParticleFlow_PFClusterProducer_plugins_PFClusterProducerCudaHCAL_h
