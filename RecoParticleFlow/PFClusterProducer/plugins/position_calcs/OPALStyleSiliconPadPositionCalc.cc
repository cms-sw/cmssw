...
class OPALStyleSiliconPadPositionCalc : public PFCPositionCalculatorBase {
 public:
  OPALStyleSiliconPadPositionCalc(const edm::ParameterSet& conf) :
  ...
  OPALStyleSiliconPadPositionCalc(const OPALStyleSiliconPadPositionCalc&) = delete;
  OPALStyleSiliconPadPositionCalc& operator=(const OPALStyleSiliconPadPositionCalc&) = delete;
...
DEFINE_EDM_PLUGIN(PFCPositionCalculatorFactory,
		  OPALStyleSiliconPadPositionCalc,
		  "OPALStyleSiliconPadPositionCalc");



void OPALStyleSiliconPadPositionCalc::
