#ifndef __SharedSeedsClusterizer_H__
#define __SharedSeedsClusterizer_H__
...
class SharedSeedsClusterizer : public InitialClusteringStepBase {  
 public:
  typedef SharedSeedsClusterizer B2DGT;
