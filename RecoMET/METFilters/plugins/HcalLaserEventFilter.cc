...
HcalLaserEventFilter::HcalLaserEventFilter(const edm::ParameterSet& iConfig)
  ...
  , vetoByLaserMonitor_         (iConfig.getUntrackedParameter<bool>("vetoByLaserMonitor",true))
  , minLaserMonitorCharge_      (iConfig.getUntrackedParameter<double>("minLaserMonitorCharge_",4000.))
