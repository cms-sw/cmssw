...
for modifier in run2_miniAOD_devel, run2_nanoAOD_94XMiniAODv1, run2_nanoAOD_94XMiniAODv2, run2_nanoAOD_102Xv1:
    modifier.toModify(ecalBadCalibFilter, baddetEcal = ecalBadCalibFilter.baddetEcal +
...
for modifier in run2_nanoAOD_94XMiniAODv1, run2_nanoAOD_94XMiniAODv2, run2_nanoAOD_102Xv1:
    modifier.toModify(ecalBadCalibFilter, EcalRecHitSource = ('reducedEgamma','reducedEERecHits'))
