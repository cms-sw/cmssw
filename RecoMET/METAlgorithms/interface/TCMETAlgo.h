...
private:
  ...
  bool isGoodTrack(reco::TrackRef trackRef);
  bool closeToElectron( reco::TrackRef );
  void correctMETforMuon(reco::TrackRef, reco::MuonRef& muonRef);
  void correctMETforMuon(reco::MuonRef& muonRef);
  void correctMETforTrack( reco::TrackRef , TH2D* rf, const TVector3& );
  void correctSumEtForTrack( reco::TrackRef , TH2D* rf, const TVector3& );
  class TVector3 propagateTrackToCalorimeterFace(reco::TrackRef trackRef);
  void findGoodShowerTracks(std::vector<int>& goodShowerTracks);
  bool nearGoodShowerTrack( reco::TrackRef , const std::vector<int>& goodShowerTracks );
  int nExpectedInnerHits(reco::TrackRef);
  int nExpectedOuterHits(reco::TrackRef);
