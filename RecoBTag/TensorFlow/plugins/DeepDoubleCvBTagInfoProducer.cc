...
class DeepDoubleCvBTagInfoProducer : public edm::stream::EDProducer<>
{

public:
    explicit DeepDoubleCvBTagInfoProducer(const edm::ParameterSet&);
    ~DeepDoubleCvBTagInfoProducer() override;

    static void fillDescriptions(edm::ConfigurationDescriptions& descriptions);

private:
    typedef std::vector<reco::DeepDoubleCvBTagInfo> DeepDoubleCvBTagInfoCollection;
...
DeepDoubleCvBTagInfoProducer::DeepDoubleCvBTagInfoProducer(
...
{
    produces<DeepDoubleCvBTagInfoCollection>();
}
...
void DeepDoubleCvBTagInfoProducer::fillDescriptions(
    edm::ConfigurationDescriptions& descriptions)
{
    ...
    descriptions.add("pfDeepDoubleCvBTagInfos", desc);
}

void DeepDoubleCvBTagInfoProducer::produce(edm::Event& iEvent,
    const edm::EventSetup& iSetup)
{

    auto output_tag_infos = std::make_unique<DeepDoubleCvBTagInfoCollection>();
    ...
    for (std::size_t jet_n = 0; jet_n < jets->size(); jet_n++)
    {
        ...
        btagbtvdeep::DeepDoubleCvBFeatures features;
...
DEFINE_FWK_MODULE(DeepDoubleCvBTagInfoProducer);
