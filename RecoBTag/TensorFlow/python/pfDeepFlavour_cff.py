...
from RecoBTag.FeatureTools.pfDeepDoubleCvLTagInfos_cfi import pfDeepDoubleCvLTagInfos
from RecoBTag.FeatureTools.pfDeepDoubleCvBTagInfos_cfi import pfDeepDoubleCvBTagInfos
