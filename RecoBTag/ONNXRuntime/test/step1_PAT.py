...
# with command line options: step1 --mc --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions 124X_mcRun3_2022_realistic_v12 --step PAT --nThreads 4 --geometry DB:Extended --era Run3 --filein file:AODinput_mcRun3.root --fileout file:miniFromAOD_mcRun3.root --no_exec -n 400
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step1 nevts:4000'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    #fileName = cms.untracked.string('file:miniFromAOD_mcRun3.root'),
    fileName = cms.untracked.string('file:miniFromAOD_mcRun3_withParT.root'),
