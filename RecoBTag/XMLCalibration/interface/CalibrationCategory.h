...
template <class CI> class CalibrationCategory {
public:
   ...
   */
  virtual bool
  match(const CI &calibrationInput) const = 0; // Not implemented here

  virtual std::string name() {
    return "BaseCalibrationCategory";
  } // Set it to pure virtual?
