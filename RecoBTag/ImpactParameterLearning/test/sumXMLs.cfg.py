...
process.sumCalib = cms.EDFilter("SumHistoCalibration",
	 ...
	 xmlfiles2d = cms.vstring("RecoBTag/ImpactParameterLearning/test/2d.xml", "RecoBTag/ImpactParameterLearning/test/2d.xml"),
	 xmlfiles3d = cms.vstring("RecoBTag/ImpactParameterLearning/test/3d.xml", "RecoBTag/ImpactParameterLearning/test/3d.xml"),
	 sum2D = cms.bool(True),
	 sum3D = cms.bool(True),
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    connect = cms.string('sqlite_file:btagnew_test.db'),
