...
template <class SV> class TemplatedSecondaryVertex : public SV {
public:
  TemplatedSecondaryVertex() {}
  TemplatedSecondaryVertex(const reco::Vertex &pv, const SV &sv,
                           const GlobalVector &direction,
                           bool withPVError = false)
      : SV(sv), dist1d_(computeDist1d(pv, sv, direction, withPVError)),
  ...
  static Measurement1D computeDist1d(const reco::Vertex &pv, const SV &sv,
                                     const GlobalVector &direction,
                                     bool withPVError);
  static Measurement1D computeDist2d(
      //		const reco::Vertex &pv, const reco::Vertex &sv,
      const reco::Vertex &pv, const SV &sv, const GlobalVector &direction,
      bool withPVError);
