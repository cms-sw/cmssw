...
template <class SecondaryVertex> class VertexSorting {
public:
  VertexSorting(const edm::ParameterSet &params)
      : sortCriterium(getSortCriterium(
            params.getParameter<std::string>("sortCriterium"))) {}
  ~VertexSorting() {}
...
template <class SecondaryVertex>
std::vector<unsigned int> VertexSorting<SecondaryVertex>::
operator()(const std::vector<SecondaryVertex> &svCandidates) const {
