...
operator reco::Vertex() {
  ...
  return reco::Vertex(Vertex::Point(vertex()), err, vertexChi2(), vertexNdof(),
...
template <>
Measurement1D
TemplatedSecondaryVertex<reco::VertexCompositePtrCandidate>::computeDist1d(
    const Vertex &pv, const VertexCompositePtrCandidate &sv,
  ...
  if (error > 0.0 && dist > 1.0e-9)
    ...
    error = -1.0;
  if ((vector[0] * direction.x() + vector[1] * direction.y() +
...
template <>
Measurement1D
TemplatedSecondaryVertex<reco::VertexCompositePtrCandidate>::computeDist2d(
    const Vertex &pv, const VertexCompositePtrCandidate &sv,
    const GlobalVector &direction, bool withPVError) {
...
template <>
Measurement1D
TemplatedSecondaryVertex<reco::VertexCompositePtrCandidate>::computeDist3d(
    const Vertex &pv, const VertexCompositePtrCandidate &sv,
    const GlobalVector &direction, bool withPVError) {
...
template <>
Measurement1D TemplatedSecondaryVertex<reco::Vertex>::computeDist1d(
    const Vertex &pv, const Vertex &sv, const GlobalVector &direction,
    bool withPVError) {
  typedef ROOT::Math::SVector<double, 3> SVector1;
  typedef ROOT::Math::SMatrix<double, 3, 3, ROOT::Math::MatRepSym<double, 3>>
      SMatrixSym1;
...
template <>
Measurement1D TemplatedSecondaryVertex<reco::Vertex>::computeDist2d(
    const Vertex &pv, const Vertex &sv, const GlobalVector &direction,
    bool withPVError) {
  typedef ROOT::Math::SVector<double, 2> SVector2;
  typedef ROOT::Math::SMatrix<double, 2, 2, ROOT::Math::MatRepSym<double, 2>>
...
template <>
Measurement1D TemplatedSecondaryVertex<reco::Vertex>::computeDist3d(
    const Vertex &pv, const Vertex &sv, const GlobalVector &direction,
    bool withPVError) {
  typedef ROOT::Math::SVector<double, 3> SVector3;
  typedef ROOT::Math::SMatrix<double, 3, 3, ROOT::Math::MatRepSym<double, 3>>
