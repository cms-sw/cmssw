...
SignedDecayLength3D::apply(const TransientTrack &transientTrack,
  ...
  TrajectoryStateOnSurface theTSOS =
      closestApproachToJet(*FTS, vertex, direction, transientTrack.field());
...
TrajectoryStateOnSurface SignedDecayLength3D::closestApproachToJet(
