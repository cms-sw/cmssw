...
#tv = {}
#for k,v in training_vars.items():
#   tv['TagVarCSV_'+k] = v
#training_vars = tv
...
#
varname_regex_=re.compile(r'TagVarCSV_(?P<name>[a-zA-Z0-9]+)(:?_(?P<idx>\d+))?$')
def var_match(varname):
   '''matches the name used in the MVA training to 
   get the TaggingVariableName and index'''
   
   print "printing varname_regex"
   print "*************************************"
   print varname_regex_
   print "*************************************"
   print "printed varname_regex"
   #return
