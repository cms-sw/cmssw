...
# this is where it gets the payload from                                                
    PayloadName = cms.string('BTagMISTAGJBPLtable_v5_offline'),
    WorkingPointName = cms.string('BTagMISTAGJBPLwp_v5_offline')
)
BtagPerformanceESProducer_MISTAGJBPM = cms.ESProducer("BtagPerformanceESProducer",
# this is what it makes available
    ComponentName = cms.string('MISTAGJBPM'),
# this is where it gets the payload from                                                
    PayloadName = cms.string('BTagMISTAGJBPMtable_v5_offline'),
    WorkingPointName = cms.string('BTagMISTAGJBPMwp_v5_offline')
)
BtagPerformanceESProducer_MISTAGJBPT = cms.ESProducer("BtagPerformanceESProducer",
# this is what it makes available
    ComponentName = cms.string('MISTAGJBPT'),
# this is where it gets the payload from                                                
    PayloadName = cms.string('BTagMISTAGJBPTtable_v5_offline'),
    WorkingPointName = cms.string('BTagMISTAGJBPTwp_v5_offline')
)
BtagPerformanceESProducer_MISTAGJPL = cms.ESProducer("BtagPerformanceESProducer",
# this is what it makes available
    ComponentName = cms.string('MISTAGJPL'),
# this is where it gets the payload from                                                
    PayloadName = cms.string('BTagMISTAGJPLtable_v5_offline'),
    WorkingPointName = cms.string('BTagMISTAGJPLwp_v5_offline')
)
BtagPerformanceESProducer_MISTAGJPM = cms.ESProducer("BtagPerformanceESProducer",
# this is what it makes available
    ComponentName = cms.string('MISTAGJPM'),
# this is where it gets the payload from                                                
    PayloadName = cms.string('BTagMISTAGJPMtable_v5_offline'),
    WorkingPointName = cms.string('BTagMISTAGJPMwp_v5_offline')
)
BtagPerformanceESProducer_MISTAGJPT = cms.ESProducer("BtagPerformanceESProducer",
# this is what it makes available
    ComponentName = cms.string('MISTAGJPT'),
# this is where it gets the payload from                                                
    PayloadName = cms.string('BTagMISTAGJPTtable_v5_offline'),
    WorkingPointName = cms.string('BTagMISTAGJPTwp_v5_offline')
)
BtagPerformanceESProducer_MISTAGSSVHEM = cms.ESProducer("BtagPerformanceESProducer",
# this is what it makes available
    ComponentName = cms.string('MISTAGSSVHEM'),
# this is where it gets the payload from                                                
    PayloadName = cms.string('BTagMISTAGSSVHEMtable_v5_offline'),
    WorkingPointName = cms.string('BTagMISTAGSSVHEMwp_v5_offline')
)
BtagPerformanceESProducer_MISTAGSSVHPT = cms.ESProducer("BtagPerformanceESProducer",
# this is what it makes available
    ComponentName = cms.string('MISTAGSSVHPT'),
# this is where it gets the payload from                                                
    PayloadName = cms.string('BTagMISTAGSSVHPTtable_v5_offline'),
    WorkingPointName = cms.string('BTagMISTAGSSVHPTwp_v5_offline')
)
BtagPerformanceESProducer_MISTAGTCHEL = cms.ESProducer("BtagPerformanceESProducer",
# this is what it makes available
    ComponentName = cms.string('MISTAGTCHEL'),
# this is where it gets the payload from                                                
    PayloadName = cms.string('BTagMISTAGTCHELtable_v5_offline'),
    WorkingPointName = cms.string('BTagMISTAGTCHELwp_v5_offline')
)
BtagPerformanceESProducer_MISTAGTCHEM = cms.ESProducer("BtagPerformanceESProducer",
# this is what it makes available
    ComponentName = cms.string('MISTAGTCHEM'),
# this is where it gets the payload from                                                
    PayloadName = cms.string('BTagMISTAGTCHEMtable_v5_offline'),
    WorkingPointName = cms.string('BTagMISTAGTCHEMwp_v5_offline')
)
