...
sort -u ${CMSSW_BASE}/tmp/classes.txt.dumperct.unsorted |grep -v -e"std::">${CMSSW_BASE}/tmp/classes.txt.dumperct
...
sort -u ${CMSSW_BASE}/tmp/classes.txt.dumperft.unsorted |grep -v -e"std::">${CMSSW_BASE}/tmp/classes.txt.dumperft
...
sort -u ${CMSSW_BASE}/tmp/classes.txt.inherits.unsorted |grep -v -e"std::">${CMSSW_BASE}/tmp/classes.txt.inherits
