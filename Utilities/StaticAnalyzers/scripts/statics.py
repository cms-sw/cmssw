...
statics = set()
toplevelfuncs = set()
skipfunc = re.compile("(edm::detail::ThreadSafeRegistry)|(edm::EDMProductGetter::get)|(edm::Event::getBy)(edm::eventsetup::EventSetupRecord::get)|(BareRootProductGetter::getIt)|(edm::eventsetup::DataProxy::getImpl)|(edm::EventPrincipal::unscheduledFill)|(edm::ServiceRegistry::get)|(fwlite::internal::ProductGetter::getIt)|(edm::eventsetup::EventSetupRecord::getImplementation)|(edm::eventsetup::EventSetupRecord::getFromProxy)|(edm::eventsetup::DataProxy::get)")
skipfuncs=set()
