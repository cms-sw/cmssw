...
// For the statistics box:
  ...
  tdrStyle->SetOptStat(000001111); // To display the mean and RMS:   SetOptStat("mr");
...
// Margins:
  ...
  tdrStyle->SetPadRightMargin(0.13);//0.02);
...
// For the Global title:
  ...
  tdrStyle->SetTitleX(.15); // Set the position of the title box
