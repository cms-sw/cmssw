...
# Revision: $Id: PackageManagement.pl,v 1.11 2007/07/18 15:47:33 sashby Exp $ 
#
...
sub getpklistfromtc() {
    ...
    open(CMSTCQUERY,"wget $options  -nv -o /dev/null -O- 'https://$user:$pass\@cmstags.cern.ch/cgi-bin/CmsTC/CreateTagList?release=$releaseid' |");
