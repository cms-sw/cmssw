...
class StandardTester(object):
    ...
    def prepare(self):
        ...
        hltTests = {
                    ...
                    'hlt_mc_2018v36' : ['cmsDriver.py TTbar_Tauola_13TeV_TuneCUETP8M1_cfi -s GEN,SIM,DIGI,L1,DIGI2RAW --mc --scenario=pp -n 10 --conditions auto:run2_mc_2018v36 --relval 9000,50 --datatier "GEN-SIM-RAW" --eventcontent RAWSIM --customise=HLTrigger/Configuration/CustomConfigs.L1T --era Run2_2018 --fileout file:RelVal_Raw_2018v36_MC.root',
                               'cmsRun '+self.file2Path('HLTrigger/Configuration/test/OnLine_HLT_2018v36.py')+hltFlag_mc,
