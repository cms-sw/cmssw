...
class StandardTester(object):
    ...
    def prepare(self):
        ...
        hltTests = {
                    ...
                    'hlt_data_FULL' : ['cmsDriver.py RelVal -s NONE     --data --scenario=pp -n 10 --conditions auto:run1_hlt_FULL --relval 9000,50 --datatier "RAW" --eventcontent RAW --fileout file:RelVal_Raw_FULL_DATA.root --filein /store/data/Run2012A/MuEG/RAW/v1/000/191/718/14932935-E289-E111-830C-5404A6388697.root',
                    ...
                    'hlt_data_GRun' : ['cmsDriver.py RelVal -s NONE     --data --scenario=pp -n 10 --conditions auto:run1_hlt_GRun --relval 9000,50 --datatier "RAW" --eventcontent RAW --fileout file:RelVal_Raw_GRun_DATA.root --filein /store/data/Run2012A/MuEG/RAW/v1/000/191/718/14932935-E289-E111-830C-5404A6388697.root',
                    ...
                    'hlt_data_HIon' : ['cmsDriver.py RelVal -s NONE     --data --scenario=HeavyIons -n 10 --conditions auto:run1_hlt_HIon --relval 9000,50 --datatier "RAW" --eventcontent RAW --fileout file:RelVal_Raw_HIon_DATA.root --filein /store/hidata/HIRun2011/HIHighPt/RAW/v1/000/182/838/F20AAF66-F71C-E111-9704-BCAEC532971D.root',
                    ...
                    'hlt_data_PIon' : ['cmsDriver.py RelVal -s NONE     --data --scenario=pp -n 10 --conditions auto:run1_hlt_PIon --relval 9000,50 --datatier "RAW" --eventcontent RAW --fileout file:RelVal_Raw_PIon_DATA.root --filein /store/data/Run2012A/MuEG/RAW/v1/000/191/718/14932935-E289-E111-830C-5404A6388697.root',
