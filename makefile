...
ConfigXML_PATH	= $(TOTEMRPSIMREC)/ConfigXML
...
#CMSINCL       += -I/afs/cern.ch/sw/lcg/external/XercesC/2.7.0/slc4_ia32_gcc34/include -I/afs/cern.ch/sw/lcg/external/clhep/2.0.3.2/slc4_ia32_gcc34/include -I/afs/cern.ch/sw/lcg/external/Boost/1.32.0/slc3_ia32_gcc323/include/boost-1_32
#CMSLIB        += -L/afs/cern.ch/sw/lcg/external/XercesC/2.7.0/slc4_ia32_gcc34/lib -lxerces-c -lxerces-depdom -L/afs/cern.ch/sw/lcg/external/clhep/2.0.3.2/slc4_ia32_gcc34/lib -lCLHEP -lCLHEP-Vector-2.0.3.2


CMSINCL       += -I/afs/cern.ch/sw/lcg/external/XercesC/2.8.0/x86_64-slc5-gcc41-opt/include -I/afs/cern.ch/sw/lcg/external/clhep/2.0.4.6/x86_64-slc5-gcc41-opt/include -I/opt/boost_1_36_0
CMSLIB        += -L/afs/cern.ch/sw/lcg/external/XercesC/2.8.0/x86_64-slc5-gcc41-opt/lib -lxerces-c -lxerces-depdom -L/afs/cern.ch/sw/lcg/external/clhep/2.0.4.6/x86_64-slc5-gcc41-opt/lib -lCLHEP-2.0.4.6 -lCLHEP-Vector-2.0.4.6

#/afs/cern.ch/sw/lcg/external/XercesC/2.8.0/x86_64-slc5-gcc41-opt/ /afs/cern.ch/sw/lcg/external/clhep/2.0.4.6/x86_64-slc5-gcc41-opt/ /opt/boost_1_36_0
#/afs/cern.ch/sw/lcg/app/releases/ROOT/5.24.00/x86_64-slc5-gcc43-opt/


#CMSLIB        += -lxerces-c -lxerces-depdom
#CMSLIB	      += $(ROOTLIBS)
...
BASE_PROJECT_DIRS := $(TOTEMRPSIMREC) $(TOTEMRPSIMREC)/ConfigXML
...
PROJECT_TEST_BIN = $(join $(patsubst %$(TEST_SUB_DIR)/, %$(BIN_SUB_DIR)/, $(dir $(PROJECT_TEST_SRC))), $(basename $(notdir $(PROJECT_TEST_SRC))))
...
.PHONY : all library clean_deps deps clean test directory
...
clean:
		...
		@rm -f $(PROJ_DEPS)
		@rm -f $(MAIN_INC_PATH)/$(CINT_OUT_FILE_BASE).$(IncSuf) $(MAIN_SRC_PATH)/$(CINT_OUT_FILE_BASE).$(SrcSuf)
		@rm -f $(MAIN_STUB_PATH)/$(CINT_OUT_FILE_BASE).$(IncSuf) $(MAIN_STUB_PATH)/$(CINT_OUT_FILE_BASE).$(SrcSuf)
...
$(MAIN_SRC_PATH)/$(CINT_OUT_FILE_BASE).$(SrcSuf): $(MAIN_STUB_PATH)/$(CINT_OUT_FILE_BASE).$(SrcSuf)
	@cp $(MAIN_STUB_PATH)/$(CINT_OUT_FILE_BASE).$(IncSuf) $(MAIN_INC_PATH)/$(CINT_OUT_FILE_BASE).$(IncSuf)
	@cp $(MAIN_STUB_PATH)/$(CINT_OUT_FILE_BASE).$(SrcSuf) $(MAIN_SRC_PATH)/$(CINT_OUT_FILE_BASE).$(SrcSuf)


$(MAIN_STUB_PATH)/$(CINT_OUT_FILE_BASE).$(SrcSuf) $(MAIN_STUB_PATH)/$(CINT_OUT_FILE_BASE).$(IncSuf): $(MAIN_STUB_PATH)/$(CINT_CONF_FILE) $(PROJECT_STUB_HEADERS)
