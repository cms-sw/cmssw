...
public:
  ...
  void save(bool print_total = true,
            float minval = 0.,
            float maxval = 0.,
            const std::string& s = "svgmap.svg",
            int width = 1500,
            int height = 800);
  void save_as_fedtrackermap(bool print_total = true,
                             float minval = 0.,
                             float maxval = 0.,
                             const std::string& s = "fed_svgmap.svg",
  ...
  void save_as_fectrackermap(bool print_total = true,
                             float minval = 0.,
                             float maxval = 0.,
                             const std::string& s = "fec_svgmap.svg",
                             int width = 1500,
                             int height = 800);
  void save_as_psutrackermap(bool print_total = true,
                             float minval = 0.,
                             float maxval = 0.,
                             const std::string& s = "psu_svgmap.svg",
