...
public:
  ...
  std::unique_ptr<reco::NamedCompositeCandidateCollection> combine(const std::vector<reco::CandidatePtrVector> &,
                                                                   string_coll const &) const;
  /// return all selected candidate pairs
  std::unique_ptr<reco::NamedCompositeCandidateCollection> combine(const reco::CandidatePtrVector &,
                                                                   string_coll const &) const;
  /// return all selected candidate pairs
  std::unique_ptr<reco::NamedCompositeCandidateCollection> combine(const reco::CandidatePtrVector &,
...
private:
  ...
  typedef std::vector<
      std::pair<std::pair<reco::CandidatePtr, size_t>, std::vector<reco::CandidatePtrVector>::const_iterator> >
      CandStack;
  ...
  void combine(size_t collectionIndex,
               ...
               std::unique_ptr<reco::NamedCompositeCandidateCollection> &comps) const;
  /// select a candidate
