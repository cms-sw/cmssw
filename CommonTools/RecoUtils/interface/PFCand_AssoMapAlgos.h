...
class PFCand_AssoMapAlgos : public PF_PU_AssoMapAlgos  {
 ...
 public:
   ...
   std::auto_ptr<PFCandToVertexAssMap> CreatePFCandToVertexMap(const edm::Handle<reco::PFCandidateCollection>&, const edm::EventSetup&);

   //create the vertex to pf candidate association map
   std::auto_ptr<VertexToPFCandAssMap> CreateVertexToPFCandMap(const edm::Handle<reco::PFCandidateCollection>&, const edm::EventSetup&);
