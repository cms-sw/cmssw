...
AssociationMaps = cms.EDProducer('PF_PU_AssoMap',			
	...
	#Configuration for the reassociation of particles from inclusive vertex finder
	IVFVertexCollection = cms.InputTag(''),
		
	#Configuration for the final association
	# 0 == always first vertex
    ...
    nTrackWeight_z = cms.double(0.01),	  		    
    nTrackWeight_3D = cms.double(0.0001),
