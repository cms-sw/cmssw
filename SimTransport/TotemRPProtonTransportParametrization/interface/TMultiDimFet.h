...
protected:
  ...
  virtual void MakeRealCode(const char *filename, const char *classname,
                            Option_t *option = "");
...
public:
  ...
  TMultiDimFet(Int_t dimension, EMDFPolyType type = kMonomials,
               Option_t *option = "");
  ...
  virtual void MakeCode(const char *functionName = "MDF",
                        Option_t *option = "");        // *MENU*
  virtual void MakeHistograms(Option_t *option = "A"); // *MENU*
  virtual void MakeMethod(const Char_t *className = "MDF",
                          Option_t *option = "");                     // *MENU*
