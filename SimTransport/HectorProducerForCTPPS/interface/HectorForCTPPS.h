#ifndef SimTransport_HectorForCTPPS_h
#define SimTransport_HectorForCTPPS_h
...
class HectorForCTPPS {
    ...
    public:
        //  HectorForCTPPS(const edm::ParameterSet & ps);
        HectorForCTPPS(const edm::ParameterSet & ps, bool verbosity,bool CTPPSTransport);
        //  HectorForCTPPS();
        virtual ~HectorForCTPPS();
        typedef CLHEP::HepLorentzVector LorentzVector;
        /*!Clears ApertureFlags, prepares HectorForCTPPS for a next event*/
        void clearApertureFlags();
        /*!Clears BeamParticle, prepares HectorForCTPPS for a next Aperture check or/and a next event*/
        void clear();
