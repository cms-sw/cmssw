...
LHCTransport = cms.EDProducer("CTPPSHectorProducer",
    ...
    CTPPSHector = cms.PSet(
        HectorEtaCut,
        Beam1 = cms.string('SimTransport/CTPPSHectorProducer/data/LHCB1_Beta0.60_6.5TeV_CR142.5_v6.503.tfs'),
        Beam2 = cms.string('SimTransport/CTPPSHectorProducer/data/LHCB2_Beta0.60_6.5TeV_CR142.5_v6.503.tfs'),
