...
std::unique_ptr<CTPPSBeamParameters> CTPPSBeamParametersESSource::produce(const CTPPSBeamParametersRcd&) {
  ...
  auto bp = (setBeamPars_) ? fillBeamParameters() : std::make_unique<CTPPSBeamParameters>();
...
void CTPPSBeamParametersESSource::setBeamParameters(const edm::ParameterSet& iConfig) {
...
std::unique_ptr<CTPPSBeamParameters> CTPPSBeamParametersESSource::fillBeamParameters() {
...
void CTPPSBeamParametersESSource::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
