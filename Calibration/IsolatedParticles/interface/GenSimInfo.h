...
namespace spr{
  ...
  void cGenSimInfo(std::vector<DetId> vdets, HepMC::GenEvent::particle_const_iterator trkItr, std::vector<spr::propagatedGenTrackID>& trackIds, spr::genSimInfo & info, bool debug=false);
