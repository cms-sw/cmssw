...
#        'file:step2.root')
        "file:/afs/cern.ch/work/r/ruchi/0048FA62-B924-E411-A09C-002590DB916E.root")
)
...
process.GlobalTag = GlobalTag(process.GlobalTag, 
                              'auto:run2_mc_GRun', '')
                              #                              'MCRUN2_71_V1::All, '')  #25ns samples
#                              'MCRUN2_71_V0::All', '')  #50ns samples
#                              'PHYS14_25_V1::All', '')
#                              'MCRUN2_72_V1A::All', '') 
