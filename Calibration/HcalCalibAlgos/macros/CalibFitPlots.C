...
void PlotHist(const char* infile,
  ...
  std::string title1[20] = {"Tracks with p = 60:100 GeV (Barrel)",
                            "Tracks with p = 60:100 GeV (Transition)",
                            "Tracks with p = 60:100 GeV (Endcap)",
                            "Tracks with p = 60:100 GeV",
                            "Tracks with p = 40:60 GeV (Barrel)",
