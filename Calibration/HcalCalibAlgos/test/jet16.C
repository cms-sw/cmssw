...
gStyle->SetOptStat(1616);
gStyle->SetOptFit(161);

Int_t n = 10;
Double_t entries[n];
TH1F *histResp[n];

histResp[0]  = new TH1F("h_resp_jf1_eta16_etgamma18_22"," ",50,0., 2.);
histResp[1]  = new TH1F("h_resp_jf1_eta16_etgamma22_26"," ",50,0., 2.);
histResp[2]  = new TH1F("h_resp_jf1_eta16_etgamma27_33"," ",50,0., 2.);
histResp[3]  = new TH1F("h_resp_jf1_eta16_etgamma36_44"," ",50,0., 2.);
histResp[4]  = new TH1F("h_resp_jf1_eta16_etgamma54_66"," ",50,0., 2.);
histResp[5]  = new TH1F("h_resp_jf1_eta16_etgamma90_161"," ",50,0., 2.);
histResp[6]  = new TH1F("h_resp_jf1_eta16_etgamma165_165"," ",50,0., 2.);
histResp[7]  = new TH1F("h_resp_jf1_eta16_etgamma180_220"," ",50,0., 2.);
histResp[8]  = new TH1F("h_resp_jf1_eta16_etgamma270_330"," ",50,0., 2.);
histResp[9]  = new TH1F("h_resp_jf1_eta16_etgamma450_550"," ",50,0., 2.);

TH1F *histEtG[n];
histEtG[0]  = new TH1F("h_etg_jf1_eta16_etgamma18_22"," ",160,0., 40.);
histEtG[1]  = new TH1F("h_etg_jf1_eta16_etgamma22_26"," ",160,0., 50.);
histEtG[2]  = new TH1F("h_etg_jf1_eta16_etgamma27_33"," ",160,0., 160.);
histEtG[3]  = new TH1F("h_etg_jf1_eta16_etgamma36_44"," ",160,0., 160.);
histEtG[4]  = new TH1F("h_etg_jf1_eta16_etgamma54_66"," ",160,20., 200.);
histEtG[5]  = new TH1F("h_etg_jf1_eta16_etgamma90_161"," ",160,30.,300.);
histEtG[6]  = new TH1F("h_etg_jf1_eta16_etgamma165_165"," ",160,50., 400.);
histEtG[7]  = new TH1F("h_etg_jf1_eta16_etgamma180_220"," ",160,50., 600.);
histEtG[8]  = new TH1F("h_etg_jf1_eta16_etgamma270_330"," ",160,160., 1600.);
histEtG[9]  = new TH1F("h_etg_jf1_eta16_etgamma450_550"," ",160,160., 1600.);

TH1F *histEtJ[n];
histEtJ[0]  = new TH1F("h_etj_jf1_eta16_etgamma18_22"," ",160,0., 160.);
histEtJ[1]  = new TH1F("h_etj_jf1_eta16_etgamma22_26"," ",160,0., 160.);
histEtJ[2]  = new TH1F("h_etj_jf1_eta16_etgamma27_33"," ",160,0., 160.);
histEtJ[3]  = new TH1F("h_etj_jf1_eta16_etgamma36_44"," ",160,0., 160.);
histEtJ[4]  = new TH1F("h_etj_jf1_eta16_etgamma54_66"," ",160,20., 200.);
histEtJ[5]  = new TH1F("h_etj_jf1_eta16_etgamma90_161"," ",160,30.,300.);
histEtJ[6]  = new TH1F("h_etj_jf1_eta16_etgamma165_165"," ",160,50., 400.);
histEtJ[7]  = new TH1F("h_etj_jf1_eta16_etgamma180_220"," ",160,50., 600.);
histEtJ[8]  = new TH1F("h_etj_jf1_eta16_etgamma270_330"," ",160,160., 1600.);
histEtJ[9]  = new TH1F("h_etj_jf1_eta16_etgamma450_550"," ",160,160., 1600.);

// Histogram names needed for output filenemas
char *name[n];
name[0] = "JetResponseEt20Eta16";
name[1] = "JetResponseEt24Eta16";
name[2] = "JetResponseEt30Eta16";
name[3] = "JetResponseEt40Eta16";
name[4] = "JetResponseEt60Eta16";
name[5] = "JetResponseEt160Eta16";
name[6] = "JetResponseEt160Eta16";
name[7] = "JetResponseEt200Eta16";
name[8] = "JetResponseEt300Eta16";
name[9] = "JetResponseEt500Eta16";
...
Int_t respPoints=0;
Double_t pi=3.1616927;

// 20 GeV, Histo 0
std::ifstream in20( "d20/1-16" );
string line;
entries[0] = 0;
...
// 160 GeV, Histo 5
std::ifstream in160( "d160/1-16" );
string line;
entries[5] = 0;
while( std::getline( in160, line)){
  istringstream linestream(line);
  double Etgamma,Etjet,Etajet;
  linestream>>Etgamma>>Etjet>>Etajet;
...
//  cout<<" Here "<<i<<" Number of Points "<<respPoints<<" Number of entries  "<<entries[respPoints] <<endl;
  ...
  cout<<" Good histogram "<<endl;
    ...
    if( i == 4 )
    {
      histResp[i]->Fit("mygaus","","",0.16,0.9); 
    }
    if( i == 5 )
    {
...
TF1 *funcA1 = new TF1("funcA1","[0]*sqrt(x +[1]) + [2]",5.,por1);
TF1 *funcA2 = new TF1("funcA2","[0]/(sqrt([1]*x + [2])) + [3] ",por2,50.);
...
TCanvas c2("c2"," ",16,16,800,600);
c2->SetLogx();
gPad->SetTicks(1,1);
gr2->SetMaximum(1.0);
gr2->SetMinimum(0.0);
gr2->GetYaxis()->SetTitle("Jet Response");
gr2->GetYaxis()->SetTitleSize(0.16);
gr2->GetXaxis()->SetTitle("GammaJet E_{T} (GeV)");
gr2->GetXaxis()->SetTitleOffset(1.2);
gr2->GetXaxis()->SetRangeUser(0.95*genEtG[0],1.16*genEtG[respPoints]);
gr2->Draw("AP");
c2.Print("GammaJetEta16_1.gif");

TCanvas c3("c3"," ",16,16,800,600);
c3->SetLogx();
gPad->SetTicks(1,1);
gr3->SetMaximum(1.0);
gr3->SetMinimum(0.0);
gr3->GetYaxis()->SetTitle("Jet Response");
gr3->GetYaxis()->SetTitleSize(0.16);
gr3->GetXaxis()->SetTitle("RecJet E_{T} (GeV)");
gr3->GetXaxis()->SetTitleOffset(1.2);
gr3->GetXaxis()->SetRangeUser(0.95*genEtJ[0],1.16*genEtJ[respPoints]);
gr3->Draw("AP");
//func1->Draw("same");
funcA1->Draw("same");
funcA2->Draw("same");
