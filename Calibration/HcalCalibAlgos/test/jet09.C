...
histResp[0]  = new TH1F("h_resp_jf1_eta09_etgamma18_22"," ",50,0., 2.);
histResp[1]  = new TH1F("h_resp_jf1_eta09_etgamma22_26"," ",50,0., 2.);
histResp[2]  = new TH1F("h_resp_jf1_eta09_etgamma27_33"," ",50,0., 2.);
histResp[3]  = new TH1F("h_resp_jf1_eta09_etgamma36_44"," ",50,0., 2.);
histResp[4]  = new TH1F("h_resp_jf1_eta09_etgamma54_66"," ",50,0., 2.);
histResp[5]  = new TH1F("h_resp_jf1_eta09_etgamma90_110"," ",50,0., 2.);
histResp[6]  = new TH1F("h_resp_jf1_eta09_etgamma135_165"," ",50,0., 2.);
histResp[7]  = new TH1F("h_resp_jf1_eta09_etgamma180_220"," ",50,0., 2.);
histResp[8]  = new TH1F("h_resp_jf1_eta09_etgamma270_330"," ",50,0., 2.);
histResp[9]  = new TH1F("h_resp_jf1_eta09_etgamma450_550"," ",50,0., 2.);

TH1F *histEtG[n];
histEtG[0]  = new TH1F("h_etg_jf1_eta09_etgamma18_22"," ",100,0., 40.);
histEtG[1]  = new TH1F("h_etg_jf1_eta09_etgamma22_26"," ",100,0., 50.);
histEtG[2]  = new TH1F("h_etg_jf1_eta09_etgamma27_33"," ",100,0., 150.);
histEtG[3]  = new TH1F("h_etg_jf1_eta09_etgamma36_44"," ",100,0., 150.);
histEtG[4]  = new TH1F("h_etg_jf1_eta09_etgamma54_66"," ",100,20., 200.);
histEtG[5]  = new TH1F("h_etg_jf1_eta09_etgamma90_110"," ",100,30.,300.);
histEtG[6]  = new TH1F("h_etg_jf1_eta09_etgamma135_165"," ",100,50., 400.);
histEtG[7]  = new TH1F("h_etg_jf1_eta09_etgamma180_220"," ",100,50., 600.);
histEtG[8]  = new TH1F("h_etg_jf1_eta09_etgamma270_330"," ",100,100., 1000.);
histEtG[9]  = new TH1F("h_etg_jf1_eta09_etgamma450_550"," ",100,100., 1500.);

TH1F *histEtJ[n];
histEtJ[0]  = new TH1F("h_etj_jf1_eta09_etgamma18_22"," ",100,0., 100.);
histEtJ[1]  = new TH1F("h_etj_jf1_eta09_etgamma22_26"," ",100,0., 100.);
histEtJ[2]  = new TH1F("h_etj_jf1_eta09_etgamma27_33"," ",100,0., 150.);
histEtJ[3]  = new TH1F("h_etj_jf1_eta09_etgamma36_44"," ",100,0., 150.);
histEtJ[4]  = new TH1F("h_etj_jf1_eta09_etgamma54_66"," ",100,20., 200.);
histEtJ[5]  = new TH1F("h_etj_jf1_eta09_etgamma90_110"," ",100,30.,300.);
histEtJ[6]  = new TH1F("h_etj_jf1_eta09_etgamma135_165"," ",100,50., 400.);
histEtJ[7]  = new TH1F("h_etj_jf1_eta09_etgamma180_220"," ",100,50., 600.);
histEtJ[8]  = new TH1F("h_etj_jf1_eta09_etgamma270_330"," ",100,100., 1000.);
histEtJ[9]  = new TH1F("h_etj_jf1_eta09_etgamma450_550"," ",100,100., 1500.);

// Histogram names needed for output filenemas
char *name[n];
name[0] = "JetResponseEt20Eta09";
name[1] = "JetResponseEt24Eta09";
name[2] = "JetResponseEt30Eta09";
name[3] = "JetResponseEt40Eta09";
name[4] = "JetResponseEt60Eta09";
name[5] = "JetResponseEt100Eta09";
name[6] = "JetResponseEt150Eta09";
name[7] = "JetResponseEt200Eta09";
name[8] = "JetResponseEt300Eta09";
name[9] = "JetResponseEt500Eta09";
...
gr2->GetXaxis()->SetRangeUser(0.95*genEtG[0],1.09*genEtG[respPoints]);
gr2->Draw("AP");
c2.Print("GammaJetEta09_1.gif");
...
gr3->GetXaxis()->SetRangeUser(0.95*genEtJ[0],1.09*genEtJ[respPoints]);
gr3->Draw("AP");
//func1->Draw("same");
funcA1->Draw("same");
funcA2->Draw("same");
