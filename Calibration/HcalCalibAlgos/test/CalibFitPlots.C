...
//  FitHistExtended(infile, outfile, numb, prefix, append);
...
//  PlotHistCorrFactor(infile, text, save);
...
void FitHistExtended(std::string infile,std::string outfile,int numb,
		     std::string prefix,bool append=true) {
...
void PlotHistCorrResults(std::string infile, std::string text, bool save) {
...
void PlotHistCorrFactor(std::string infile, std::string text, bool save) {
