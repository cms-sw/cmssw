...
histResp[0]  = new TH1F("h_resp_jf1_eta11_etgamma18_22"," ",50,0., 2.);
histResp[1]  = new TH1F("h_resp_jf1_eta11_etgamma22_26"," ",50,0., 2.);
histResp[2]  = new TH1F("h_resp_jf1_eta11_etgamma27_33"," ",50,0., 2.);
histResp[3]  = new TH1F("h_resp_jf1_eta11_etgamma36_44"," ",50,0., 2.);
histResp[4]  = new TH1F("h_resp_jf1_eta11_etgamma54_66"," ",50,0., 2.);
histResp[5]  = new TH1F("h_resp_jf1_eta11_etgamma90_111"," ",50,0., 2.);
histResp[6]  = new TH1F("h_resp_jf1_eta11_etgamma135_165"," ",50,0., 2.);
histResp[7]  = new TH1F("h_resp_jf1_eta11_etgamma180_220"," ",50,0., 2.);
histResp[8]  = new TH1F("h_resp_jf1_eta11_etgamma270_330"," ",50,0., 2.);
histResp[9]  = new TH1F("h_resp_jf1_eta11_etgamma450_550"," ",50,0., 2.);

TH1F *histEtG[n];
histEtG[0]  = new TH1F("h_etg_jf1_eta11_etgamma18_22"," ",110,0., 40.);
histEtG[1]  = new TH1F("h_etg_jf1_eta11_etgamma22_26"," ",110,0., 50.);
histEtG[2]  = new TH1F("h_etg_jf1_eta11_etgamma27_33"," ",110,0., 150.);
histEtG[3]  = new TH1F("h_etg_jf1_eta11_etgamma36_44"," ",110,0., 150.);
histEtG[4]  = new TH1F("h_etg_jf1_eta11_etgamma54_66"," ",110,20., 200.);
histEtG[5]  = new TH1F("h_etg_jf1_eta11_etgamma90_111"," ",110,30.,300.);
histEtG[6]  = new TH1F("h_etg_jf1_eta11_etgamma135_165"," ",110,50., 400.);
histEtG[7]  = new TH1F("h_etg_jf1_eta11_etgamma180_220"," ",110,50., 600.);
histEtG[8]  = new TH1F("h_etg_jf1_eta11_etgamma270_330"," ",110,110., 1100.);
histEtG[9]  = new TH1F("h_etg_jf1_eta11_etgamma450_550"," ",110,110., 1500.);

TH1F *histEtJ[n];
histEtJ[0]  = new TH1F("h_etj_jf1_eta11_etgamma18_22"," ",110,0., 110.);
histEtJ[1]  = new TH1F("h_etj_jf1_eta11_etgamma22_26"," ",110,0., 110.);
histEtJ[2]  = new TH1F("h_etj_jf1_eta11_etgamma27_33"," ",110,0., 150.);
histEtJ[3]  = new TH1F("h_etj_jf1_eta11_etgamma36_44"," ",110,0., 150.);
histEtJ[4]  = new TH1F("h_etj_jf1_eta11_etgamma54_66"," ",110,20., 200.);
histEtJ[5]  = new TH1F("h_etj_jf1_eta11_etgamma90_111"," ",110,30.,300.);
histEtJ[6]  = new TH1F("h_etj_jf1_eta11_etgamma135_165"," ",110,50., 400.);
histEtJ[7]  = new TH1F("h_etj_jf1_eta11_etgamma180_220"," ",110,50., 600.);
histEtJ[8]  = new TH1F("h_etj_jf1_eta11_etgamma270_330"," ",110,110., 1100.);
histEtJ[9]  = new TH1F("h_etj_jf1_eta11_etgamma450_550"," ",110,110., 1500.);

// Histogram names needed for output filenemas
char *name[n];
name[0] = "JetResponseEt20Eta11";
name[1] = "JetResponseEt24Eta11";
name[2] = "JetResponseEt30Eta11";
name[3] = "JetResponseEt40Eta11";
name[4] = "JetResponseEt60Eta11";
name[5] = "JetResponseEt110Eta11";
name[6] = "JetResponseEt150Eta11";
name[7] = "JetResponseEt200Eta11";
name[8] = "JetResponseEt300Eta11";
name[9] = "JetResponseEt500Eta11";
...
// 110 GeV, Histo 5
std::ifstream in110( "d110/1-11" );
string line;
entries[5] = 0;
while( std::getline( in110, line)){
  istringstream linestream(line);
  double Etgamma,Etjet,Etajet;
  linestream>>Etgamma>>Etjet>>Etajet;
...
//  cout<<" Here "<<i<<" Number of Points "<<respPoints<<" Number of entries  "<<entries[respPoints] <<endl;
  ...
  cout<<" Good histogram "<<endl;
    ...
    if( i == 1 )
    {
      histResp[i]->Fit("mygaus","","",0.23,0.7); 
    }
    
    if( i == 2 )
    {
      histResp[i]->Fit("mygaus","","",0.2,0.6); 
    }
...
TF1 *func1 = new TF1("func1","[0]*sqrt(x +[1]) + [2]",11.,por2);
...
func2->SetParLimits(1,0.1,11.);
func2->SetParLimits(2,-1.5,11000.);
...
TF1 *funcA1 = new TF1("funcA1","[0]*sqrt(x +[1]) + [2]",11.,por1);
...
TCanvas c2("c2"," ",11,11,800,600);
c2->SetLogx();
gPad->SetTicks(1,1);
gr2->SetMaximum(1.0);
gr2->SetMinimum(0.0);
gr2->GetYaxis()->SetTitle("Jet Response");
gr2->GetYaxis()->SetTitleSize(0.11);
gr2->GetXaxis()->SetTitle("GammaJet E_{T} (GeV)");
gr2->GetXaxis()->SetTitleOffset(1.2);
gr2->GetXaxis()->SetRangeUser(0.95*genEtG[0],1.11*genEtG[respPoints]);
gr2->Draw("AP");
c2.Print("GammaJetEta11_1.gif");

TCanvas c3("c3"," ",11,11,800,600);
c3->SetLogx();
gPad->SetTicks(1,1);
gr3->SetMaximum(1.0);
gr3->SetMinimum(0.0);
gr3->GetYaxis()->SetTitle("Jet Response");
gr3->GetYaxis()->SetTitleSize(0.11);
gr3->GetXaxis()->SetTitle("RecJet E_{T} (GeV)");
gr3->GetXaxis()->SetTitleOffset(1.2);
gr3->GetXaxis()->SetRangeUser(0.95*genEtJ[0],1.11*genEtJ[respPoints]);
gr3->Draw("AP");
//func1->Draw("same");
funcA1->Draw("same");
funcA2->Draw("same");
