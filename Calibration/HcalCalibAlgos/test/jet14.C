...
gStyle->SetOptStat(1414);
gStyle->SetOptFit(141);

Int_t n = 10;
Double_t entries[n];
TH1F *histResp[n];

histResp[0]  = new TH1F("h_resp_jf1_eta14_etgamma18_22"," ",50,0., 2.);
histResp[1]  = new TH1F("h_resp_jf1_eta14_etgamma22_26"," ",50,0., 2.);
histResp[2]  = new TH1F("h_resp_jf1_eta14_etgamma27_33"," ",50,0., 2.);
histResp[3]  = new TH1F("h_resp_jf1_eta14_etgamma36_44"," ",50,0., 2.);
histResp[4]  = new TH1F("h_resp_jf1_eta14_etgamma54_66"," ",50,0., 2.);
histResp[5]  = new TH1F("h_resp_jf1_eta14_etgamma90_141"," ",50,0., 2.);
histResp[6]  = new TH1F("h_resp_jf1_eta14_etgamma145_165"," ",50,0., 2.);
histResp[7]  = new TH1F("h_resp_jf1_eta14_etgamma180_220"," ",50,0., 2.);
histResp[8]  = new TH1F("h_resp_jf1_eta14_etgamma270_330"," ",50,0., 2.);
histResp[9]  = new TH1F("h_resp_jf1_eta14_etgamma450_550"," ",50,0., 2.);

TH1F *histEtG[n];
histEtG[0]  = new TH1F("h_etg_jf1_eta14_etgamma18_22"," ",140,0., 40.);
histEtG[1]  = new TH1F("h_etg_jf1_eta14_etgamma22_26"," ",140,0., 50.);
histEtG[2]  = new TH1F("h_etg_jf1_eta14_etgamma27_33"," ",140,0., 150.);
histEtG[3]  = new TH1F("h_etg_jf1_eta14_etgamma36_44"," ",140,0., 150.);
histEtG[4]  = new TH1F("h_etg_jf1_eta14_etgamma54_66"," ",140,20., 200.);
histEtG[5]  = new TH1F("h_etg_jf1_eta14_etgamma90_141"," ",140,30.,300.);
histEtG[6]  = new TH1F("h_etg_jf1_eta14_etgamma145_165"," ",140,50., 400.);
histEtG[7]  = new TH1F("h_etg_jf1_eta14_etgamma180_220"," ",140,50., 600.);
histEtG[8]  = new TH1F("h_etg_jf1_eta14_etgamma270_330"," ",140,140., 1400.);
histEtG[9]  = new TH1F("h_etg_jf1_eta14_etgamma450_550"," ",140,140., 1500.);

TH1F *histEtJ[n];
histEtJ[0]  = new TH1F("h_etj_jf1_eta14_etgamma18_22"," ",140,0., 140.);
histEtJ[1]  = new TH1F("h_etj_jf1_eta14_etgamma22_26"," ",140,0., 140.);
histEtJ[2]  = new TH1F("h_etj_jf1_eta14_etgamma27_33"," ",140,0., 150.);
histEtJ[3]  = new TH1F("h_etj_jf1_eta14_etgamma36_44"," ",140,0., 150.);
histEtJ[4]  = new TH1F("h_etj_jf1_eta14_etgamma54_66"," ",140,20., 200.);
histEtJ[5]  = new TH1F("h_etj_jf1_eta14_etgamma90_141"," ",140,30.,300.);
histEtJ[6]  = new TH1F("h_etj_jf1_eta14_etgamma145_165"," ",140,50., 400.);
histEtJ[7]  = new TH1F("h_etj_jf1_eta14_etgamma180_220"," ",140,50., 600.);
histEtJ[8]  = new TH1F("h_etj_jf1_eta14_etgamma270_330"," ",140,140., 1400.);
histEtJ[9]  = new TH1F("h_etj_jf1_eta14_etgamma450_550"," ",140,140., 1500.);

// Histogram names needed for output filenemas
char *name[n];
name[0] = "JetResponseEt20Eta14";
name[1] = "JetResponseEt24Eta14";
name[2] = "JetResponseEt30Eta14";
name[3] = "JetResponseEt40Eta14";
name[4] = "JetResponseEt60Eta14";
name[5] = "JetResponseEt140Eta14";
name[6] = "JetResponseEt150Eta14";
name[7] = "JetResponseEt200Eta14";
name[8] = "JetResponseEt300Eta14";
name[9] = "JetResponseEt500Eta14";
...
// 140 GeV, Histo 5
std::ifstream in140( "d140/1-14" );
string line;
entries[5] = 0;
while( std::getline( in140, line)){
  istringstream linestream(line);
  double Etgamma,Etjet,Etajet;
  linestream>>Etgamma>>Etjet>>Etajet;
...
Float_t k[14];
ofstream outFile("Response_14.dat");
...
TF1 *func1 = new TF1("func1","[0]*sqrt(x +[1]) + [2]",14.,por2);
...
func2->SetParLimits(1,0.1,14.);
func2->SetParLimits(2,-1.5,14000.);
...
TCanvas c2("c2"," ",14,14,800,600);
c2->SetLogx();
gPad->SetTicks(1,1);
gr2->SetMaximum(1.0);
gr2->SetMinimum(0.0);
gr2->GetYaxis()->SetTitle("Jet Response");
gr2->GetYaxis()->SetTitleSize(0.14);
gr2->GetXaxis()->SetTitle("GammaJet E_{T} (GeV)");
gr2->GetXaxis()->SetTitleOffset(1.2);
gr2->GetXaxis()->SetRangeUser(0.95*genEtG[0],1.14*genEtG[respPoints]);
gr2->Draw("AP");
c2.Print("GammaJetEta14_1.gif");

TCanvas c3("c3"," ",14,14,800,600);
c3->SetLogx();
gPad->SetTicks(1,1);
gr3->SetMaximum(1.0);
gr3->SetMinimum(0.0);
gr3->GetYaxis()->SetTitle("Jet Response");
gr3->GetYaxis()->SetTitleSize(0.14);
gr3->GetXaxis()->SetTitle("RecJet E_{T} (GeV)");
gr3->GetXaxis()->SetTitleOffset(1.2);
gr3->GetXaxis()->SetRangeUser(0.95*genEtJ[0],1.14*genEtJ[respPoints]);
gr3->Draw("AP");
//func1->Draw("same");
funcA1->Draw("same");
funcA2->Draw("same");
