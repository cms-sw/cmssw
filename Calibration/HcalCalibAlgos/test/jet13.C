...
gStyle->SetOptStat(1313);
gStyle->SetOptFit(131);

Int_t n = 10;
Double_t entries[n];
TH1F *histResp[n];

histResp[0]  = new TH1F("h_resp_jf1_eta13_etgamma18_22"," ",50,0., 2.);
histResp[1]  = new TH1F("h_resp_jf1_eta13_etgamma22_26"," ",50,0., 2.);
histResp[2]  = new TH1F("h_resp_jf1_eta13_etgamma27_33"," ",50,0., 2.);
histResp[3]  = new TH1F("h_resp_jf1_eta13_etgamma36_44"," ",50,0., 2.);
histResp[4]  = new TH1F("h_resp_jf1_eta13_etgamma54_66"," ",50,0., 2.);
histResp[5]  = new TH1F("h_resp_jf1_eta13_etgamma90_131"," ",50,0., 2.);
histResp[6]  = new TH1F("h_resp_jf1_eta13_etgamma135_165"," ",50,0., 2.);
histResp[7]  = new TH1F("h_resp_jf1_eta13_etgamma180_220"," ",50,0., 2.);
histResp[8]  = new TH1F("h_resp_jf1_eta13_etgamma270_330"," ",50,0., 2.);
histResp[9]  = new TH1F("h_resp_jf1_eta13_etgamma450_550"," ",50,0., 2.);

TH1F *histEtG[n];
histEtG[0]  = new TH1F("h_etg_jf1_eta13_etgamma18_22"," ",130,0., 40.);
histEtG[1]  = new TH1F("h_etg_jf1_eta13_etgamma22_26"," ",130,0., 50.);
histEtG[2]  = new TH1F("h_etg_jf1_eta13_etgamma27_33"," ",130,0., 150.);
histEtG[3]  = new TH1F("h_etg_jf1_eta13_etgamma36_44"," ",130,0., 150.);
histEtG[4]  = new TH1F("h_etg_jf1_eta13_etgamma54_66"," ",130,20., 200.);
histEtG[5]  = new TH1F("h_etg_jf1_eta13_etgamma90_131"," ",130,30.,300.);
histEtG[6]  = new TH1F("h_etg_jf1_eta13_etgamma135_165"," ",130,50., 400.);
histEtG[7]  = new TH1F("h_etg_jf1_eta13_etgamma180_220"," ",130,50., 600.);
histEtG[8]  = new TH1F("h_etg_jf1_eta13_etgamma270_330"," ",130,130., 1300.);
histEtG[9]  = new TH1F("h_etg_jf1_eta13_etgamma450_550"," ",130,130., 1500.);

TH1F *histEtJ[n];
histEtJ[0]  = new TH1F("h_etj_jf1_eta13_etgamma18_22"," ",130,0., 130.);
histEtJ[1]  = new TH1F("h_etj_jf1_eta13_etgamma22_26"," ",130,0., 130.);
histEtJ[2]  = new TH1F("h_etj_jf1_eta13_etgamma27_33"," ",130,0., 150.);
histEtJ[3]  = new TH1F("h_etj_jf1_eta13_etgamma36_44"," ",130,0., 150.);
histEtJ[4]  = new TH1F("h_etj_jf1_eta13_etgamma54_66"," ",130,20., 200.);
histEtJ[5]  = new TH1F("h_etj_jf1_eta13_etgamma90_131"," ",130,30.,300.);
histEtJ[6]  = new TH1F("h_etj_jf1_eta13_etgamma135_165"," ",130,50., 400.);
histEtJ[7]  = new TH1F("h_etj_jf1_eta13_etgamma180_220"," ",130,50., 600.);
histEtJ[8]  = new TH1F("h_etj_jf1_eta13_etgamma270_330"," ",130,130., 1300.);
histEtJ[9]  = new TH1F("h_etj_jf1_eta13_etgamma450_550"," ",130,130., 1500.);

// Histogram names needed for output filenemas
char *name[n];
name[0] = "JetResponseEt20Eta13";
name[1] = "JetResponseEt24Eta13";
name[2] = "JetResponseEt30Eta13";
name[3] = "JetResponseEt40Eta13";
name[4] = "JetResponseEt60Eta13";
name[5] = "JetResponseEt130Eta13";
name[6] = "JetResponseEt150Eta13";
name[7] = "JetResponseEt200Eta13";
name[8] = "JetResponseEt300Eta13";
name[9] = "JetResponseEt500Eta13";
...
// 130 GeV, Histo 5
std::ifstream in130( "d130/1-13" );
string line;
entries[5] = 0;
while( std::getline( in130, line)){
  istringstream linestream(line);
  double Etgamma,Etjet,Etajet;
  linestream>>Etgamma>>Etjet>>Etajet;
...
for (Int_t i=0; i<n; i++)
{
  entries[respPoints] = histResp[i]->GetEntries();
  
//  cout<<" Here "<<i<<" Number of Points "<<respPoints<<" Number of entries  "<<entries[respPoints] <<endl;
  
  if(entries[respPoints] > entryCut)
  { 
  cout<<" Good histogram "<<endl;
    ...
    if( i == 1 )
    {
      histResp[i]->Fit("mygaus","","",0.1,0.7); 
    }
    
    if( i == 2 )
    {
      histResp[i]->Fit("mygaus","","",0.2,0.95); 
    }

    if( i == 3 )
    {
      histResp[i]->Fit("mygaus","","",0.3,0.9); 
    }
    ...
    if( i == 8 )
    {
      histResp[i]->Fit("mygaus","","",0.25,1.1); 
    }
...
Float_t k[13];
ofstream outFile("Response_13.dat");
...
/*
Double_t par[5];
TF1 *func1 = new TF1("func1","[0]+[1]*log(x+[2])-[3]/(x+[4])",13.,600.);
func1->SetParameter(0,1.);
func1->SetParameter(1,1.);
func1->SetParameter(2,1.);
func1->SetParameter(3,1.);
func1->SetParameter(4,20.);
gr1->Fit("func1", "R",  "r", 13., 600.);
...
TF1 *func1 = new TF1("func1","[0]*sqrt(x +[1]) + [2]",13.,por2);
...
func2->SetParLimits(1,0.1,13.);
func2->SetParLimits(2,-1.5,13000.);
...
TCanvas c2("c2"," ",13,13,800,600);
c2->SetLogx();
gPad->SetTicks(1,1);
gr2->SetMaximum(1.0);
gr2->SetMinimum(0.0);
gr2->GetYaxis()->SetTitle("Jet Response");
gr2->GetYaxis()->SetTitleSize(0.13);
gr2->GetXaxis()->SetTitle("GammaJet E_{T} (GeV)");
gr2->GetXaxis()->SetTitleOffset(1.2);
gr2->GetXaxis()->SetRangeUser(0.95*genEtG[0],1.13*genEtG[respPoints]);
gr2->Draw("AP");
c2.Print("GammaJetEta13_1.gif");

TCanvas c3("c3"," ",13,13,800,600);
c3->SetLogx();
gPad->SetTicks(1,1);
gr3->SetMaximum(1.0);
gr3->SetMinimum(0.0);
gr3->GetYaxis()->SetTitle("Jet Response");
gr3->GetYaxis()->SetTitleSize(0.13);
gr3->GetXaxis()->SetTitle("RecJet E_{T} (GeV)");
gr3->GetXaxis()->SetTitleOffset(1.2);
gr3->GetXaxis()->SetRangeUser(0.95*genEtJ[0],1.13*genEtJ[respPoints]);
gr3->Draw("AP");
//func1->Draw("same");
funcA1->Draw("same");
funcA2->Draw("same");
