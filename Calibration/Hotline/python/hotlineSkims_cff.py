...
seqHotlineSkimMassiveDimuon = cms.Sequence(primaryVertexFilter * CSCTightHaloFilter * HBHENoiseFilterResultProducer * HBHENoiseFilter * dimuonsHotLine * dimuonMassFilter)
