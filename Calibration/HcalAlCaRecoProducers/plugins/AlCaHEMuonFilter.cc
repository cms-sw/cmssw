...
bool AlCaHEMuonFilter::filter(edm::Event& iEvent, edm::EventSetup const& iSetup) {
  ...
  ++nAll_;
#ifdef DebugLog
  edm::LogInfo("HEMuon") << "AlCaHEMuonFilter::Run " 
			   << iEvent.id().run() << " Event " 
...
#ifdef DebugLog
	  edm::LogInfo("HEMuon") << "AlCaHEMuonFilter::Trigger "
...
#ifdef DebugLog
      edm::LogInfo("HEMuon") << "AlCaHEMuonFilter::Muon Handle " 
...
#ifdef DebugLog
	  edm::LogInfo("HEMuon") << "AlCaHEMuonFilter::Muon:Track " 
...
#ifdef DebugLog
	    edm::LogInfo("HEMuon") << "AlCaHEMuonFilter::Propagate: ECAL "
...
void AlCaHEMuonFilter::globalEndJob(const AlCaHEMuons::Counters* count) {
  edm::LogInfo("HEMuon") << "Selects " << count->nFinal_ << " out of "
...
void AlCaHEMuonFilter::beginRun(edm::Run const& iRun, edm::EventSetup const& iSetup) {
  ...
  edm::LogInfo("HEMuon") << "Run[" << nRun_ << "] " << iRun.run() 
...
void
AlCaHEMuonFilter::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
