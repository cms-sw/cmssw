...
case "startNew":
	...
	$questionnaire = $db->query("SELECT * FROM Questionnaire WHERE publication_number='".$publication_number."'")->fetch();
...
/////////////////////////
	...
	echo "<center><h1><a href='index.php'>Assessment of space needs at the LPC in 2013</a></h1></center>";
	...
	if ( $questionnaire == null){
		echo "<hr/><center><h3>There is no such questionnaire<br/>If you think that life isn't fare and this questionnaire must be, please contact to mantas.stankevicius@cern.ch</h3></center>";
  		...
  		echo "<center><h3>Institution: ".$questionnaire['publication_number']."</h3></center><hr/>";
...
// Left side
		...
		echo "    <div class='span3' style='position:fixed; top:130px'>";
  		echo "       <div id='navbar'><center>";
		echo "		<h4>Note!<br/> Edits are possible after initial submission </h4><br/>";
		echo "		 Password<br/>";
		echo "		<input type='text' id='password' name='password' style='width:185px;' placeholder='Password'><br/>";
		echo "		<button type='submit' style='height:50px; width:200px' class='btn btn-success' data-loading-text='Saving...'>Submit your survey</button><br/>";
		printForgot($questionnaire);
		echo "		<hr/>";		

  		echo "		<h3>Blocks</h3><hr/></center>";
		echo " <h5>Please complete this survey with an entry for every member of your group who will visit the LPC in 2013.<br/>";
		echo " Do not enter information about members of your group if they do not plan to visit LPC.</h5>";
  		echo "          <ul class='nav'>";
