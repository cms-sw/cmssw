...
class MixBoostEvtVtxGenerator : public BaseEvtVtxGenerator {
public:
  MixBoostEvtVtxGenerator(edm::ParameterSet const& p, edm::ConsumesCollector& iC);
  virtual ~MixBoostEvtVtxGenerator();

  MixBoostEvtVtxGenerator(MixBoostEvtVtxGenerator const&) = delete;
  MixBoostEvtVtxGenerator& operator=(MixBoostEvtVtxGenerator const&) = delete;
...
private:
  ...
  std::unique_ptr<CLHEP::RandGaussQ> fRandom;
