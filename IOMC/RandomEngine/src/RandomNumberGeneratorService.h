  ...
  namespace service {
    ...
    private:
      ...
      public:
        ...
        std::shared_ptr<CLHEP::HepRandomEngine> const& engine() const { return get_underlying(engine_); }
      ...
      public:
        ...
        LabelAndEngine* labelAndEngine() const { return get_underlying(labelAndEngine_); }
