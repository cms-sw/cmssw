...
TestRandomNumberServiceGlobal::globalBeginLuminosityBlock(edm::LuminosityBlock const& lumi,
  ...
  if(engineName_ == "RanecuEngine") {
    get_underlying(lumiCache->referenceEngine_).reset(new CLHEP::RanecuEngine());
    long int seedL[2];
    ...
    if(engineName_ == "HepJamesRandom") {
      get_underlying(lumiCache->referenceEngine_).reset(new CLHEP::HepJamesRandom(seedL));
    } else {
      get_underlying(lumiCache->referenceEngine_).reset(new edm::TRandomAdaptor(seedL));
    }
  }
...
TestRandomNumberServiceGlobal::beginStream(edm::StreamID streamID) const {
  ...
  if(engineName_ == "RanecuEngine") {
    get_underlying(streamCache->referenceEngine_).reset(new CLHEP::RanecuEngine());
    long int seedL[2];
    ...
    if(engineName_ == "HepJamesRandom") {
      get_underlying(streamCache->referenceEngine_).reset(new CLHEP::HepJamesRandom(seedL));
    } else {
      get_underlying(streamCache->referenceEngine_).reset(new edm::TRandomAdaptor(seedL));
    }
  }
