...
'root://cms-xrd-global.cern.ch//store/data/Run2017C/ZeroBias/RAW/v1/000/300/466/00000/0822F36B-5079-E711-9D36-02163E01A20B.root'
...
process.o1 = cms.OutputModule("PoolOutputModule",
        outputCommands = cms.untracked.vstring('drop *',
                                               'keep CTPPSPixel*_*_*_*'
    
),
        fileName = cms.untracked.string('simevent_CTPPS_DIG_CLU_DB_real_mem_300466.root')
        )
process.load("EventFilter.CTPPSRawToDigi.ctppsRawToDigi_cff")
