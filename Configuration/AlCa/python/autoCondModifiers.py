...
def autoCondDD4HEP(autoCond):
    ...
    for key,val in autoCond.items():
        ...
        elif key == 'phase1_2021_design':    # modification of the DD4HEP relval GT
            GlobalTagsDDHEP['phase1_2021_design_dd4hep'] = (autoCond[key],
                                                            CSCRECODIGI_Geometry_dd4hep,
                                                            CSCRECO_Geometry_dd4hep,
                                                            DTRECO_Geometry_dd4hep,
                                                            GEMRECO_Geometry_dd4hep,
                                                            ...
                                                            ZDCRECO_Geometry_dd4hep,
                                                            RPCRECO_Geometry_dd4hep)
        elif key == 'phase1_2021_cosmics':    # modification of the DD4HEP relval GT
            GlobalTagsDDHEP['phase1_2021_cosmics_dd4hep'] = (autoCond[key],
                                                             CSCRECODIGI_Geometry_dd4hep,
                                                             CSCRECO_Geometry_dd4hep,
                                                             DTRECO_Geometry_dd4hep,
                                                             GEMRECO_Geometry_dd4hep,
                                                             ...
                                                             ZDCRECO_Geometry_dd4hep,
                                                             RPCRECO_Geometry_dd4hep)
        elif key == 'phase1_2021_realistic_hi':    # modification of the DD4HEP relval GT
            GlobalTagsDDHEP['phase1_2021_hi_dd4hep'] = (autoCond[key],
                                                        CSCRECODIGI_Geometry_dd4hep,
                                                        CSCRECO_Geometry_dd4hep,
                                                        DTRECO_Geometry_dd4hep,
                                                        GEMRECO_Geometry_dd4hep,
                                                        ...
                                                        ZDCRECO_Geometry_dd4hep,
                                                        RPCRECO_Geometry_dd4hep)
        elif key == 'phase1_2023_realistic':    # modification of the DD4HEP relval GT
            GlobalTagsDDHEP['phase1_2023_dd4hep'] = (autoCond[key],
                                                     CSCRECODIGI_Geometry_dd4hep,
                                                     CSCRECO_Geometry_dd4hep,
                                                     DTRECO_Geometry_dd4hep,
                                                     GEMRECO_Geometry_dd4hep,
                                                     ...
                                                     ZDCRECO_Geometry_dd4hep,
                                                     RPCRECO_Geometry_dd4hep)
        elif key == 'phase1_2024_realistic':    # modification of the DD4HEP relval GT
            GlobalTagsDDHEP['phase1_2024_dd4hep'] = (autoCond[key],
                                                     CSCRECODIGI_Geometry_dd4hep,
                                                     CSCRECO_Geometry_dd4hep,
                                                     DTRECO_Geometry_dd4hep,
                                                     GEMRECO_Geometry_dd4hep,
