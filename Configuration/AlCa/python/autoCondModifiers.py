...
def autoCondDDD(autoCond):
    ...
    GEMRECO_Geometry_ddd        =  ','.join( ['GEMRECO_Geometry_123YV1'                , "GEMRecoGeometryRcd"            , connectionString, ""        , "2022-01-20 12:00:00.000"] )
    XMLFILE_Geometry_ddd        =  ','.join( ['XMLFILE_Geometry_123YV1_Extended2021_mc', "GeometryFileRcd"               , connectionString, "Extended", "2022-01-20 12:00:00.000"] )
    ...
    RPCRECO_Geometry_ddd        =  ','.join( ['RPCRECO_Geometry_123YV1'                , "RPCRecoGeometryRcd"            , connectionString, ""        , "2022-01-20 12:00:00.000"] )
