autoCond = {
    ...
    # GlobalTag for Run3 HLT: identical to the online GT (132X_dataRun3_HLT_v2) but with snapshot at 2023-10-13 12:00:00 (UTC)
    'run3_hlt'                        : '132X_dataRun3_HLT_frozen_v2',
    # GlobalTag for Run3 data relvals (express GT) - identical to 132X_dataRun3_Express_v4 but with Ecal timing CC label tags and snapshot at 2023-10-14 12:00:00 (UTC)
    'run3_data_express'               : '132X_dataRun3_Express_frozen_v2',
    # GlobalTag for Run3 data relvals (prompt GT) - identical to 132X_dataRun3_Prompt_v4 but with Ecal timing CC label tags and snapshot at 2023-10-14 12:00:00 (UTC)
    'run3_data_prompt'                : '132X_dataRun3_Prompt_frozen_v2',
    # GlobalTag for Run3 offline data reprocessing - snapshot at 2023-10-14 13:00:00 (UTC)
    'run3_data'                       : '132X_dataRun3_v2',
    ...
    'phase1_2023_cosmics_design'      : '132X_mcRun3_2023cosmics_design_deco_v2',
    # GlobalTag for MC production with realistic conditions for Phase1 2023 detector for Heavy Ion
    'phase1_2023_realistic_hi'        : '132X_mcRun3_2023_realistic_HI_v5',
    # GlobalTag for MC production with realistic conditions for Phase1 2024
    'phase1_2024_realistic'           : '132X_mcRun3_2024_realistic_v3',
    # GlobalTag for MC production with realistic conditions for Phase2
    'phase2_realistic'                : '131X_mcRun4_realistic_v9_0'
}
