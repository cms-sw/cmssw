autoCond = {
    ...
    'run2_data_promptlike' : '100X_dataRun2_PromptLike_v2',
    # GlobalTag for Run1 HLT: it points to the online GT
    'run1_hlt'          :   '100X_dataRun2_HLT_frozen_v2',
    # GlobalTag for Run2 HLT: it points to the online GT
    'run2_hlt'          :   '100X_dataRun2_HLT_frozen_v2',
    # GlobalTag for Run2 HLT RelVals: customizations to run with fixed L1 Menu
    'run2_hlt_relval'   :   '100X_dataRun2_HLT_relval_v2',
    # GlobalTag for Run2 HLT for HI: it points to the online GT
    'run2_hlt_hi'       :   '100X_dataRun2_HLTHI_frozen_v2',
    # GlobalTag for MC production with perfectly aligned and calibrated detector for Phase1 2017 (and 0,0,~0-centred beamspot)
    'phase1_2017_design'       :  '100X_mc2017_design_IdealBS_v4',
    # GlobalTag for MC production with realistic conditions for Phase1 2017 detector
    'phase1_2017_realistic'    : '100X_mc2017_realistic_v4',
    # GlobalTag for MC production (cosmics) with realistic alignment and calibrations for Phase1 2017 detector, Strip tracker in DECO mode
    'phase1_2017_cosmics'      : '100X_mc2017cosmics_realistic_deco_v4',
    # GlobalTag for MC production (cosmics) with realistic alignment and calibrations for Phase1 2017 detector, Strip tracker in PEAK mode
    'phase1_2017_cosmics_peak' : '100X_mc2017cosmics_realistic_peak_v4',
    # GlobalTag for MC production with perfectly aligned and calibrated detector for full Phase1 2018 (and 0,0,0-centred beamspot)
    'phase1_2018_design'       : '100X_upgrade2018_design_IdealBS_v8',
    # GlobalTag for MC production with realistic conditions for full Phase1 2018 detector
    'phase1_2018_realistic'    : '100X_upgrade2018_realistic_v12',
    # GlobalTag for MC production (cosmics) with realistic conditions for full Phase1 2018 detector,  Strip tracker in DECO mode
    'phase1_2018_cosmics'      :   '100X_upgrade2018cosmics_realistic_deco_v10',
    # GlobalTag for MC production with perfectly aligned and calibrated detector for Phase1 2019
    'phase1_2019_design'       : '100X_postLS2_design_v3', # GT containing design conditions for postLS2
    # GlobalTag for MC production with perfectly aligned and calibrated detector for Phase1 2019
    'phase1_2019_realistic'       : '100X_postLS2_realistic_v3', # GT containing realistic conditions for postLS2
    # GlobalTag for MC production with realistic conditions for Phase2 2023
    'phase2_realistic'         : '100X_upgrade2023_realistic_v2'
}
