autoCond = {
    ...
    # GlobalTag for Run3 HLT: identical to the online GT (123X_dataRun3_HLT_v8) but with snapshot at 2022-05-25 18:00:00 (UTC)
    'run3_hlt'                     : '123X_dataRun3_HLT_frozen_v3',
    # GlobalTag with fixed snapshot time for Run3 HLT RelVals: customizations to run with fixed L1 Menu
    'run3_hlt_relval'              : '123X_dataRun3_HLT_relval_v6',
    # GlobalTag for Run3 data relvals (express GT) - identical to 123X_dataRun3_Express_v7 but with snapshot at 2022-05-25 18:00:00
    'run3_data_express'            : '123X_dataRun3_Express_frozen_v3',
    # GlobalTag for Run3 data relvals (prompt GT) - identical to 123X_dataRun3_Prompt_v9 but with snapshot at 2022-05-25 18:00:00
    'run3_data_prompt'             : '123X_dataRun3_Prompt_frozen_v3',
    # GlobalTag for Run3 offline data reprocessing
    'run3_data'                    : '123X_dataRun3_v6',
    # GlobalTag for Run3 data relvals: allows customization to run with fixed L1 menu
    'run3_data_relval'             : '123X_dataRun3_relval_v5',
    ...
    'phase1_2021_design'           : '124X_mcRun3_2021_design_v2',
    # GlobalTag for MC production with realistic conditions for Phase1 2021
    'phase1_2021_realistic'        : '124X_mcRun3_2021_realistic_v2',
    # GlobalTag for MC production (cosmics) with realistic conditions for Phase1 2021,  Strip tracker in DECO mode
    'phase1_2021_cosmics'          : '124X_mcRun3_2021cosmics_realistic_deco_v3',
    ...
    'phase1_2021_cosmics_design'   : '124X_mcRun3_2021cosmics_design_deco_v2',
    # GlobalTag for MC production with realistic conditions for Phase1 2021 detector for Heavy Ion
    'phase1_2021_realistic_hi'     : '124X_mcRun3_2021_realistic_HI_v2',
    # GlobalTag for MC production with realistic conditions for Phase1 2023
    'phase1_2023_realistic'        : '124X_mcRun3_2023_realistic_v2',
    # GlobalTag for MC production with realistic conditions for Phase1 2024
    'phase1_2024_realistic'        : '124X_mcRun3_2024_realistic_v2',
    # GlobalTag for MC production with realistic conditions for Phase2
    'phase2_realistic'             : '124X_mcRun4_realistic_v3'
}
