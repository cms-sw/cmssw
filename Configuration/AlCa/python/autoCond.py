autoCond = {
    ...
    # GlobalTag for Run3 offline data reprocessing - snapshot at 2022-12-12 19:50:33 (UTC)
    'run3_data'                    : '124X_dataRun3_v13',
    # GlobalTag for Run3 data relvals: allows customization to run with fixed L1 menu - snapshot at 2022-12-14 20:24:02 (UTC)
    'run3_data_relval'             : '125X_dataRun3_relval_v5',
