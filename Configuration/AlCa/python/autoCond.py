autoCond = {
    ...
    'phase1_2025_design'           :    '140X_mcRun3_2025_design_v11',
    # GlobalTag for MC production with realistic conditions for Phase1 2025
    'phase1_2025_realistic'        :    '140X_mcRun3_2025_realistic_v25',
    # GlobalTag for MC production (cosmics) with realistic conditions for Phase1 2025, Strip tracker in DECO mode
    'phase1_2025_cosmics'          :    '140X_mcRun3_2025cosmics_realistic_deco_v14',
    # GlobalTag for MC production (cosmics) with perfectly aligned and calibrated detector for Phase1 2025, Strip tracker in DECO mode
    'phase1_2025_cosmics_design'   :    '140X_mcRun3_2025cosmics_design_deco_v11',
    ################
