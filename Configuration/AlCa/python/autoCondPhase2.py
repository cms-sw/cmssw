...
allTags["LA"] = {
    ...
    'T19' : ( ','.join( [ 'SiPixelLorentzAngle_phase2_T19_v1_mc' ,SiPixelLARecord,"frontier://FrontierPrep/CMS_CONDITIONS", "", "2019-12-20 14:00:00.000"] ), ),  #uH = 0.053/T (TBPX L3,L4), uH=0.0/T (TBPX L1,L2, TEPX+TFPX)
}
...
allTags["LAWidth"] = {
    ...
    'T19' : ( ','.join( [ 'SiPixelLorentzAngle_phase2_T19_mc_forWidthEmpty' ,SiPixelLARecord,"frontier://FrontierPrep/CMS_CONDITIONS", "forWidth", "2019-12-20 14:00:00.000"] ), ),  # uH=0.0/T (fall-back to offset)
}
...
allTags["LAfromAlignment"] = {
    ...
    'T19' : ( ','.join( [ 'SiPixelLorentzAngle_phase2_T19_mc_forWidthEmpty' ,SiPixelLARecord,"frontier://FrontierPrep/CMS_CONDITIONS", "fromAlignment", "2019-12-20 14:00:00.000"] ), ),  # uH=0.0/T (not in use)
}
...
allTags["SimLA"] = {
    ...
    'T19' : ( ','.join( [ 'SiPixelSimLorentzAngle_phase2_T19_v1_mc' ,SiPixelSimLARecord,"frontier://FrontierPrep/CMS_CONDITIONS", "", "2019-12-20 14:00:00.000"] ), ), #uH = 0.053/T (TBPX L3,L4), uH=0.0/T (TBPX L1,L2, TEPX+TFPX)
}
