...
source = cms.Source("PythiaSource",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0          ! User defined processes', 'MSUB(81)=1      ! qq->QQ massive', 'MSUB(82)=1      ! gg->QQ massive', 'MSTP(7)=4       ! 4 for CC_bar', 'CKIN(3)=50.     ! Pt hat lower cut', 'CKIN(4)=120.    ! Pt hat upper cut', 'CKIN(13)=0.     ! etamin', 'CKIN(14)=2.5    ! etamax', 'CKIN(15)=-2.5   ! -etamax', 'CKIN(16)=0.     ! -etamin')
    )
)
