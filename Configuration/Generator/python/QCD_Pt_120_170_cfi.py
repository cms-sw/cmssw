...
source = cms.Source("PythiaSource",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=1               ! QCD hight pT processes', 'CKIN(3)=120.         ! minimum pt hat for hard interactions', 'CKIN(4)=170.         ! maximum pt hat for hard interactions')
    )
)
