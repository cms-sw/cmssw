...
source = cms.Source("PythiaSource",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=1               ! QCD hight pT processes', 'CKIN(3)=50.          ! minimum pt hat for hard interactions', 'CKIN(4)=80.          ! maximum pt hat for hard interactions')
    )
)
