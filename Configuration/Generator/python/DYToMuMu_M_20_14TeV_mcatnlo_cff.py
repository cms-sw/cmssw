...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/Generator/python/DYToMuMu_M_20_14TeV_mcatnlo_cff.py,v $'),
	annotation = cms.untracked.string('Summer09: Showering of MC@NLO 3.4 DrellYan events with Herwig+Jimmy, 7 TeV- trivially modified for 14TeV')
)
