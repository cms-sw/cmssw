...
# with command line options: Configuration/GenProduction/python/RPV250_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('PYTHIA RPV Gluinos at 10TeV'),
    name = cms.untracked.string('$Source: /afs/cern.ch/user/e/evah/CMSSW_2_1_10/src/RPV250_10TeV_cff.py,v $')
)
...
process.source = cms.Source("PythiaSource",
    ...
    crossSection = cms.untracked.double(281.4),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('RPV250_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
