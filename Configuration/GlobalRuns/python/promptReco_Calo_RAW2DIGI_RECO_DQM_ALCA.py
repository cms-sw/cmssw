...
# with command line options: promptReco -s RAW2DIGI,RECO,DQM,ALCA:SiStripCalZeroBias+DQM --datatier RECO --eventcontent RECO --conditions FrontierConditions_GlobalTag,GR09_31X_V4P::All -n -1 --no_exec --data --magField 0T --scenario cosmics
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/CRAFT09/Calo/RAW/v1/000/108/959/F805B710-7F7B-DE11-9405-000423D98950.root')
)

# Output definition
process.FEVT = cms.OutputModule("PoolOutputModule",
    outputCommands = process.RECOEventContent.outputCommands,
    fileName = cms.untracked.string('promptReco_Calo_RAW2DIGI_RECO_DQM_ALCA.root'),
...
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.reconstruction_step,process.dqmoffline_step,process.pathALCARECOSiStripCalZeroBias,process.pathALCARECODQM,process.endjob_step,process.out_step,process.ALCARECOStreamCombinedOutPath)
