...
# with command line options: expressReco -s RAW2DIGI,L1Reco,RECO,DQM,ALCAPRODUCER:SiStripCalZeroBias+TkAlMinBias+MuAlCalIsolatedMu+DtCalib --data --magField AutoFromDBCurrent --scenario pp --datatier EXPRESS --eventcontent RECO,ALCARECO --conditions GR10_P_V9::All --customise Configuration/GlobalRuns/reco_TLR_38X.py --no_exec --python_filename=expressReco_Collision.py --cust_function customiseExpress --process EXPRESS --no_output
