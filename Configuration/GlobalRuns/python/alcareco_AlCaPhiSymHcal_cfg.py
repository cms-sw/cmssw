...
# Schedule definition
process.schedule = cms.Schedule(process.pathALCARECODQM,process.pathALCARECOHcalCalMinBias,process.endjob_step,process.ALCARECOStreamHcalCalMinBiasOutPath)
