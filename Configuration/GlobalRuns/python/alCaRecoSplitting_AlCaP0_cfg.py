...
# with command line options: alCaRecoSplitting -s ALCAOUTPUT:EcalCalPi0Calib+EcalCalEtaCalib --conditions FrontierConditions_GlobalTag,GR10_P_V6::All --no_exec --triggerResultsProcess RECO --filein=../alcareco_AlCaP0_ALCAPRODUCER.root -n 100 --no_output --python_filename=alCaRecoSplitting_AlCaP0_cfg.py --data
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('alCaRecoSplitting nevts:100'),
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:../alcareco_AlCaP0_ALCAPRODUCER.root')
)
...
process.ALCARECOStreamEcalCalEtaCalib = cms.OutputModule("PoolOutputModule",
    ...
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string('ALCARECOEcalCalEtaCalib'),
        dataTier = cms.untracked.string('ALCARECO')
    )
)
