...
# with command line options: alCaRecoSplitting -s ALCAOUTPUT:HcalCalDijets --conditions FrontierConditions_GlobalTag,GR10_P_V5::All --no_exec --triggerResultsProcess RECO --filein=/store/temp/data/Commissioning10/MinimumBias/ALCARECO/v9/000/135/528/26F91E4B-C160-DF11-A588-003048D37456.root --no_output --python_filename=alCaRecoSplitting_JetMETTau_cfg.py --data
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/temp/data/Commissioning10/MinimumBias/ALCARECO/v9/000/135/528/26F91E4B-C160-DF11-A588-003048D37456.root')
)
...
# Schedule definition
process.schedule = cms.Schedule(process.ALCARECOStreamHcalCalDijetsOutPath)
