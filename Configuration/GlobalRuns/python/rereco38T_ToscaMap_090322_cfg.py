...
process.FEVT = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/tmp/malgeri/promptRerecoCosmics_newmap_dqmfix.root')
)
...
# Use new-new Magnetic field: 3.8T, radius 30m, z 35m (produce 090322)
...
# trick to make it work with newnew magfield (not in 229 by)
