...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        '/castor/cern.ch/cms/store/data/Commissioning08/Cosmics/RAW-RECO/CRAFT_ALL_V4_TrackingPointing_TrackerPointing_v2/0151/02E88FAB-19DC-DD11-A909-0019B9E78D89.root'
    ),
