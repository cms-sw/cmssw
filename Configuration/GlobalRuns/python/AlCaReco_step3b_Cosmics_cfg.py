...
# with command line options: step3b -s ALCA:TkAlCosmics0T+TkAlCosmicsHLT+MuAlStandAloneCosmics+MuAlGlobalCosmics+MuAlBeamHaloOverlaps+DQM --conditions FrontierConditions_GlobalTag,CRAFT_V2P::All --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('step3b nevts:1'),
