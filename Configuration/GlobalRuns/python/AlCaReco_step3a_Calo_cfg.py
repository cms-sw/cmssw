...
# with command line options: step3a -s ALCA:HcalCalDijets --conditions FrontierConditions_GlobalTag,CRAFT_V2P::All --no_exec
...
process.dijetsHLT.HLTPaths = ['HLT_Jet30']

# Schedule definition
process.schedule = cms.Schedule(process.pathALCARECOHcalCalDijets,process.ALCARECOStreamHcalCalDijetsOutPath)
