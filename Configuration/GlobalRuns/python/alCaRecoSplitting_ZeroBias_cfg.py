...
# with command line options: alCaRecoSplitting -s ALCAOUTPUT:SiStripCalZeroBias --conditions FrontierConditions_GlobalTag,GR10_P_V6::All --no_exec --triggerResultsProcess RECO --filein=file:/build/cerminar/GlobalTag/Validation/2010-05-21/CMSSW_3_6_1_patch1/src/Configuration/GlobalRuns/python/promptReco_RAW2DIGI_L1Reco_RECO_DQM_ALCAPRODUCER_secondary.root --no_output --python_filename=alCaRecoSplitting_ZeroBias_cfg.py --data
