...
workflows[4.19] = ['', ['RunElectron2011A','RECODAlCaCalo','HARVESTD','MINIAODDATAs2']]
...
workflows[4.31] = ['', ['RunElectron2011B','HLTD','RECODreHLTAlCaCalo','HARVESTDreHLT','MINIAODDreHLT']]
...
workflows[4.44] = ['',['RunElectron2012A','HLTD','RECODreHLTAlCaCalo','HARVESTDreHLT','MINIAODDreHLT']]
...
workflows[4.54] = ['',['RunEl2012B','HLTD','RECODreHLTAlCaCalo','HARVESTDreHLT','MINIAODDreHLT']]
...
workflows[4.64] = ['',['RunEl2012C','HLTD','RECODreHLTAlCaCalo','HARVESTDreHLT','MINIAODDreHLT']]
...
workflows[4.74] = ['',['RunEl2012D','HLTD','RECODreHLTAlCaCalo','HARVESTDreHLT','MINIAODDreHLT']]
...
workflows[1325] = ['', ['TTbar_13','DIGIUP15','RECOUP15AlCaCalo','HARVESTUP15','ALCATTUp15','MINIAODMCUP15']]
workflows[1326] = ['', ['WE_13','DIGIUP15','RECOUP15AlCaCalo','HARVESTUP15','MINIAODMCUP15']]
workflows[1329] = ['', ['ZEE_13','DIGIUP15','RECOUP15AlCaCalo','HARVESTUP15','MINIAODMCUP15']]
...
workflows[1343] = ['', ['ZpMM_2250_13','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMCUP15']]
workflows[1344] = ['', ['ZpEE_2250_13','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMCUP15']]
workflows[1345] = ['', ['ZpTT_1500_13','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMCUP15']]

workflows[1352] = ['', ['HSCPstop_M_200_13','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMCUP15']]
workflows[1353] = ['', ['RSGravitonToGaGa_13','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMCUP15']]
workflows[1354] = ['', ['WpToENu_M-2000_13','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMCUP15']]
