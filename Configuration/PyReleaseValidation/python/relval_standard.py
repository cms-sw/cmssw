...
workflows[4.6]  = ['', ['MinimumBias2010A','RECOSKIM','HARVESTD','MINIAODDATAStep2']]
...
workflows[4.12] = ['', ['RunMinBias2010B','RECOD','HARVESTD','MINIAODDATAStep2']]
...
workflows[4.17] = ['', ['RunMinBias2011A','HLTD','RECODreHLT','HARVESTDreHLT','SKIMDreHLT','MINIAODDATA']]
workflows[4.18] = ['', ['RunMu2011A','RECOD','HARVESTD','MINIAODDATAStep2']]
workflows[4.19] = ['', ['RunElectron2011A','RECOD','HARVESTD','MINIAODDATAStep2']]
workflows[4.20] = ['', ['RunPhoton2011A','RECOD','HARVESTD','MINIAODDATAStep2']]
workflows[4.21] = ['', ['RunJet2011A','RECOD','HARVESTD','MINIAODDATAStep2']]
...
workflows[1315] = ['', ['SingleElectronPt10_UP15','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMC50']]
workflows[1316] = ['', ['SingleElectronPt1000_UP15','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMC50']]
workflows[1317] = ['', ['SingleElectronPt35_UP15','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMC50']]
workflows[1318] = ['', ['SingleGammaPt10_UP15','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMC50']]
workflows[1319] = ['', ['SingleGammaPt35_UP15','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMC50']]
workflows[1306]  = ['', ['SingleMuPt1_UP15','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMC50']]
workflows[1320] = ['', ['SingleMuPt10_UP15','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMC50']]
workflows[1321] = ['', ['SingleMuPt100_UP15','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMC50']]
workflows[1322] = ['', ['SingleMuPt1000_UP15','DIGIUP15','RECOUP15','HARVESTUP15','MINIAODMC50']]
