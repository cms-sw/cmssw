...
workflows[5.7] = ['H125GGgluonfusion', ['H125GGgluonfusionFS','HARVESTFS']]
...
workflows[135.7] = ['H125GGgluonfusion_13', ['H125GGgluonfusionFS_13','HARVESTUP15FS']]
...
workflows[32] = ['', ['H125GGgluonfusion','DIGI','RECO','HARVEST']]
...
workflows[1337] = ['', ['SMS-T1tttt_mGl-1500_mLSP-100_13']]
...
workflows[1332] = ['', ['H125GGgluonfusion_13']]
...
workflows[1307] = ['', ['CosmicsSPLoose_UP15']]
...
workflows[1343] = ['', ['ZpMM_2250_13']]
workflows[1344] = ['', ['ZpEE_2250_13']]
workflows[1345] = ['', ['ZpTT_1500_13']]
workflows[1352] = ['', ['HSCPstop_M_200_13']]
workflows[1353] = ['', ['RSGravitonToGaGa_13']]
workflows[1354] = ['', ['WpToENu_M-2000_13']]

workflows[1355] = ['', ['DisplacedSUSY_stopToBottom_M_300_1000mm_13']]
