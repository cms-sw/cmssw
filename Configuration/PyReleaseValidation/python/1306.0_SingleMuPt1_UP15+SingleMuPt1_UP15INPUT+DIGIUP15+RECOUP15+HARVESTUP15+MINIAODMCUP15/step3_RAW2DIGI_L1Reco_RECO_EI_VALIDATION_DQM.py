...
# with command line options: step3 --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --conditions auto:run2_mc -s RAW2DIGI,L1Reco,RECO,EI,VALIDATION,DQM --datatier GEN-SIM-RECO,DQMIO -n 2 --magField 38T_PostLS1 --eventcontent RECOSIM,DQM --filein file:step2.root --fileout file:step3.root
