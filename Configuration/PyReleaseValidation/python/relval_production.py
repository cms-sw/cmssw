...
#workflows[1002.5] = [ '',['RunHLTMonitor2024I','ReAlCaHLT','ALCAReAlCaHLTHGComb','ALCAReAlCaHLTHGCombZMUMU','ALCAHARVDSIPIXELALIHLTHGCOMBINED']] COMMENT: reads old format file
...
#workflows[1020] =  ['',['AlCaLumiPixels2021','TIER0EXPLP','ALCAEXPLP','ALCAHARVLP', 'TIER0PROMPTLP']] COMMENT: reads old format file
...
#workflows[1040.1] =  ['',['RunExpressPhy2017F','TIER0EXPSIPIXELCAL','ALCASPLITSIPIXELCAL','ALCAHARVDSIPIXELCAL']] COMMENT: reads old format file

#workflows[1041] = ['',['RunExpressPhy2017F','TIER0EXPPPSCAL','ALCASPLITPPSCAL','ALCAHARVDPPSCAL']] COMMENT: reads old format file
#workflows[1042] = ['',['RunExpressPhy2017F','TIER0EXPPPSCALALIG','ALCASPLITPPSALIG','ALCAHARVDPPSALIG']] COMMENT: reads old format file
...
#workflows[1052.1] = ['',['RunSiPixelCalCosmics2022F','ALCASPLITSIPIXELLAMCS','ALCAHARVDSIPIXELLAMCS']] COMMENT: reads old format file
