...
def generate(evt_type, energy, evtnumber):
    """
...
def _generate_PGUN(evt_type, energy, evtnumber):
    """
...
def _generate_QCD(evt_type, energy):
    """
...
def _generate_MINBIAS(evt_type, energy):
    """
...
def _generate_Higgs(evt_type, energy):
    """    
...
def _generate_TTBAR(evt_type, energy):
    """
...
def _generate_Zll(evt_type, energy):
    """
...
def _generate_Wl(evt_type, energy):
    """
    Here the settings for the Z ee simulation are added to the process.
    Energy parameter is not used.
    """ 
...
#---------------------------------
# I refuse to transalte it
# def _generate_ZPJJ(evt_type, energy):
#     """
...
def _generate_ZPll(evt_type, energy):
    """
    Here the settings for the Z ee simulation are added to the process.
    Energy parameter is not used.
    """    
...
def _generate_RS1GG(evt_type, energy):
    """
...
def _generate_HpT(evt_type, energy):
    """
    Here the settings for the RS1 graviton into gamma gamma.
    """       
...
def user_pythia_ue_settings():
    ...
    return pythiaUESettingsBlock.pythiaUESettings
