...
upgradeScenToRun={ '2017':['GenSimFull','DigiFull','RecoFull','HARVESTFull'],
		   ...
		   '2023tilted':['GenSimFull','DigiFull','RecoFullGlobal_trackingOnlyVal','HARVESTFull_trackingOnly'],#full (or almost..) reco tilted scenario
		   ...
		   '2023tiltedPU':['GenSimFull','DigiFullPU','RecoFullGlobal_trackingOnlyValPU', 'HARVESTFull_trackingOnlyPU'],#full (or almost..) reco tilted scenario with PU
