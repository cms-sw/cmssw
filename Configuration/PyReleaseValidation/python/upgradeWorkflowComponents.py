...
upgradeFragments = OrderedDict([
    ...
    ('TTbar_14TeV_cfi', UpgradeFragment(Kby(10,100),'TTbar_14TeV')),
    ('WE_14TeV_TuneCUETP8M1_cfi', UpgradeFragment(Kby(9,100),'WE_14TeV')),
    ('ZTT_Tauola_All_hadronic_14TeV_cfi', UpgradeFragment(Kby(9,100),'ZTT_14TeV')), 
    ...
    ('MinBias_14TeV_cfi', UpgradeFragment(Kby(100,100),'MinBias_14TeV')),
    ...
    ('ZEE_14TeV_cfi', UpgradeFragment(Kby(9,100),'ZEE_14')),
    ...
    ('QCD_Pt20toInf_MuEnrichedPt15_14TeV_cff', UpgradeFragment(Kby(19565, 217391),'QCD_Pt20toInfMuEnrichPt15_14TeV')), # effi = 4.6e-4,  local=8.000e-04
    ('ZMM_14TeV_cfi', UpgradeFragment(Kby(11,115),'ZMM_14')), # effi = 8.650e-01
    ('QCD_Pt15To7000_Flat_14TeV_cff', UpgradeFragment(Kby(9,50),'QCD_Pt15To7000_Flat_14TeV')),
    ('H125GGgluonfusion_14TeV_cfi', UpgradeFragment(Kby(9,50),'H125GGgluonfusion_14')),
    ...
    ('SingleEFlatPt2To100_cfi', UpgradeFragment(Kby(9,100),'SingleEFlatPt2To100')),
    ...
    ('SingleMuPt10_cfi' , UpgradeFragment(Kby(9,100), 'SingleMuPt10')),
    ('SingleMuPt100_cfi' , UpgradeFragment(Kby(9,100), 'SingleMuPt100')),
    ('SingleMuPt1000_cfi' , UpgradeFragment(Kby(9,100), 'SingleMuPt1000')),
    ('DarkSUSY_14TeV_cfi', UpgradeFragment(Kby(9,100),'DarkSUSY_14TeV')),
    ('B0ToKstarMuMu_14TeV_cfi', UpgradeFragment(Kby(304,3030),'B0ToKstarMuMu_14TeV')), # 3.3% 
    ('BsToEleEle_14TeV_cfi', UpgradeFragment(Kby(223,2222),'BsToEleEle_14TeV')), # 4.5%    
    ('BsToJpsiGamma_14TeV_cfi', UpgradeFragment(Kby(2500,25000),'BsToJpsiGamma_14TeV')), # 0.4% 
    ('BsToJpsiPhi_mumuKK_14TeV_cfi', UpgradeFragment(Kby(910,9090),'BsToJpsiPhi_mumuKK_14TeV')), # 1.1%
    ('BsToMuMu_14TeV_cfi', UpgradeFragment(Kby(313,3125),'BsToMuMu_14TeV')), # 3.2% 
    ('BsToPhiPhi_KKKK_14TeV_cfi', UpgradeFragment(Kby(556,5555),'BsToPhiPhi_KKKK_14TeV')), # 1.8%  
    ('TauToMuMuMu_14TeV_cfi', UpgradeFragment(Kby(18939,189393),'TauToMuMuMu_14TeV')), # effi = 5.280e-04
])
