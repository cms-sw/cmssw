...
steps['HLTDR2_50ns']=merge( [ {'-s':'L1REPACK,HLT:@%s'%hltKey50ns,},{'--conditions':'auto:run2_hlt',},{'--era' : 'Run2_50ns'},steps['HLTD'] ] )

hltKey25ns='relval25ns'
menuR2_25ns = autoHLT[hltKey25ns]
steps['HLTDR2_25ns']=merge( [ {'-s':'L1REPACK:GT2,HLT:@%s'%hltKey25ns,},{'--conditions':'auto:run2_hlt',},{'--era' : 'Run2_25ns'},steps['HLTD'] ] )


# custom function to be put back once the CSC tracked/untracked will have been fixed.. :-)
steps['RECODR2_50ns']=merge([{'--scenario':'pp','--conditions':'auto:run2_data','--customise':'Configuration/DataProcessing/RecoTLR.customiseDataRun2Common',},dataReco])
steps['RECODR2_25ns']=merge([{'--scenario':'pp','--conditions':'auto:run2_data','--customise':'Configuration/DataProcessing/RecoTLR.customiseDataRun2Common_25ns',},dataReco])
...
steps['RECODreHLT']=merge([{'--hltProcess':'reHLT','--conditions':'auto:run1_data'},steps['RECOD']])
steps['RECODR1reHLT']=merge([{'--hltProcess':'reHLT','--conditions':'auto:run1_data'},steps['RECODR1']])
steps['RECODreHLTAlCaCalo']=merge([{'--hltProcess':'reHLT','--conditions':'auto:run1_data'},steps['RECODAlCaCalo']])
...
steps['HARVESTDreHLT'] = merge([ {'--conditions':'auto:run1_data'}, steps['HARVESTD'] ])
steps['HARVESTDR1reHLT'] = merge([ {'--conditions':'auto:run1_data'}, steps['HARVESTDR1'] ])
steps['HARVESTDR2_50nsreHLT'] = merge([ {'--conditions':'auto:run2_data',}, steps['HARVESTD'] ])
steps['HARVESTDR2_25nsreHLT'] = merge([ {'--conditions':'auto:run2_data',}, steps['HARVESTD'] ])
...
steps['SKIMDreHLT'] = merge([ {'--conditions':'auto:run1_data','--filein':'file:step3.root'}, steps['SKIMD'] ])
...
defaultDataSets={}
defaultDataSets['2017']='CMSSW_8_0_0_pre6-80X_upgrade2017_design_v3_UPG17-v'
