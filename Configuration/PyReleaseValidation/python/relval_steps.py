...
for k in upgradeKeys:
    ...
    upgradeStepDict['RecoFullGlobal'][k] = {'-s':'RAW2DIGI,L1Reco,RECO,VALIDATION:@baseValidation+@trackingOnlyValidation+@muonOnlyValidation+@JetMETOnlyValidation,DQM:@trackingOnlyDQM+@muon',
                                      '--conditions':gt,
                                      '--datatier':'GEN-SIM-RECO,DQMIO',
                                      '-n':'10',
                                      '--runUnscheduled':'',
    ...
    upgradeStepDict['HARVESTFullGlobal'][k] = merge([{'-s': 'HARVESTING:@trackingOnlyValidation+@muonOnlyValidation+@JetMETOnlyValidation+@trackingOnlyDQM+@muon'}, upgradeStepDict['HARVESTFull'][k]])
