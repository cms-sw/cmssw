...
steps['RECODDQM']=merge([{'-s':'RAW2DIGI,L1Reco,RECO,EI,DQM:@common+@L1TMon+@muon+@hcal+@jetmet+@ecal'},steps['RECOD']])
...
steps['HARVESTDDQM']=merge([{'-s':'HARVESTING:@common+@L1TMon+@muon+@hcal+@jetmet+@ecal'},steps['HARVESTD']])
