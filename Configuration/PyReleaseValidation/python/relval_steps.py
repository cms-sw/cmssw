...
#    'CMSSW_7_1_0_pre5-START71_V1-v2',                      # 3 8 TeV , for the one sample which is part of the routine relval production (RelValZmumuJets_Pt_20_300, because of -v2)
    ...
    'CMSSW_9_4_10-94X_mc2017_realistic_v15_FastSim-v1',    # 15 - fastSim MinBias for mixing UP17
    'CMSSW_9_4_10-PU25ns_94X_mc2017_realistic_v15_FastSim-v1',# 16 - fastSim premixed MinBias UP17
    ]
