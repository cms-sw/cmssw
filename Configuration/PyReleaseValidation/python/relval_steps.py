...
#    'CMSSW_7_1_0_pre5-START71_V1-v2',                      # 3 8 TeV , for the one sample which is part of the routine relval production (RelValZmumuJets_Pt_20_300, because of -v2)
    ...
    'CMSSW_10_0_2-100X_mcRun2_asymptotic_v2_FastSim-v1',    # 7 - fastSim MinBias for mixing
    'CMSSW_10_0_2-PU25ns_100X_mcRun2_asymptotic_v2_FastSim-v1',# 8 - fastSim premixed MinBias
    ...
    'CMSSW_10_0_2-PU25ns_100X_upgrade2018_realistic_v10-v1',  #15 - fullSim PU 25ns UP18 premix
