...
step1Up2021HiProdDefaults = merge ([{'--conditions':'auto:phase1_2021_realistic_hi_dd4hep','--era':'Run3_pp_on_PbPb','--beamspot':'Run3RoundOptics25ns13TeVLowSigmaZ','--eventcontent':'RAWSIM','--geometry':'DB:Extended'},step1Up2018HiDefaults])
...
steps['Cosmics_UP21']=merge([{'cfg':'UndergroundCosmicMu_cfi.py','-n':'500','--conditions':'auto:phase1_2021_cosmics_dd4hep','--scenario':'cosmics','--era':'Run3'},Kby(666,100000),step1Defaults])
steps['Cosmics_UP21_0T']=merge([{'--magField':'0T','--conditions':'auto:phase1_2021_cosmics_0T','--era':'Run3_DDD'},steps['Cosmics_UP21']])
...
steps['BeamHalo_UP21']=merge([{'cfg':'BeamHalo_13TeV_cfi.py','-n':'500','--conditions':'auto:phase1_2021_cosmics_dd4hep','--scenario':'cosmics','--era':'Run3','--beamspot':'Realistic25ns13TeVEarly2017Collision'},Kby(666,100000),step1Defaults])
...
hiAlca2021_ppReco = {'--conditions':'auto:phase1_2021_realistic_hi_dd4hep', '--era':'Run3_pp_on_PbPb'}
...
steps['DIGICOS_UP21']=merge([{'--conditions':'auto:phase1_2021_cosmics_dd4hep','-s':'DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2017','--scenario':'cosmics','--eventcontent':'FEVTDEBUG','--datatier':'GEN-SIM-DIGI-RAW', '--era' : 'Run3'},step2Upg2015Defaults])
steps['DIGICOS_UP21_0T']=merge([{'--magField':'0T','--conditions':'auto:phase1_2021_cosmics_0T','--era':'Run3_DDD'},steps['DIGICOS_UP21']])
...
steps['RECOCOS_UP21']=merge([{'--conditions':'auto:phase1_2021_cosmics_dd4hep','-s':'RAW2DIGI,L1Reco,RECO,ALCA:MuAlGlobalCosmics,DQM','--scenario':'cosmics','--era':'Run3'},step3Up2015Hal])
steps['RECOCOS_UP21_0T']=merge([{'--magField':'0T','--conditions':'auto:phase1_2021_cosmics_0T','--era':'Run3_DDD'},steps['RECOCOS_UP21']])
...
steps['ALCABH_UP21']=merge([{'--conditions':'auto:phase1_2021_cosmics_dd4hep','-s':'ALCA:TkAlBeamHalo+MuAlBeamHaloOverlaps+MuAlBeamHalo','--era':'Run3'},step4Up2015Defaults])
...
steps['ALCACOS_UP21']=merge([{'--conditions':'auto:phase1_2021_cosmics_dd4hep','-s':'ALCA:TkAlCosmics0T+SiStripCalCosmics+SiStripCalCosmicsNano+SiPixelCalCosmics+TkAlBeamHalo+MuAlBeamHaloOverlaps+MuAlBeamHalo','--era':'Run3'},step4Up2015Defaults])
steps['ALCACOS_UP21_0T']=merge([{'--magField':'0T','--conditions':'auto:phase1_2021_cosmics_0T','--era':'Run3_DDD'},steps['ALCACOS_UP21']])
...
steps['HARVESTCOS_UP21']={'-s'          :'HARVESTING:dqmHarvesting',
                          '--conditions':'auto:phase1_2021_cosmics_dd4hep',
                          '--mc'        :'',
                          '--filein'    :'file:step3_inDQM.root',
                          '--scenario'    :'cosmics',
                          '--filein':'file:step3_inDQM.root', # unnnecessary
...
steps['HARVESTCOS_UP21_0T']=merge([{'--magField':'0T','--conditions':'auto:phase1_2021_cosmics_0T','--era':'Run3_DDD'},steps['HARVESTCOS_UP21']])
