...
steps['DIGIUPC2024']=merge([{'-s':'DIGI,L1,DIGI2RAW,HLT:@fake2'}, upcDefaults2024, step2Upg2015Defaults])
...
steps['NANOUP15FSrefine'] = merge([{'--customise':'PhysicsTools/NanoAOD/jetsAK4_CHS_cff.nanoAOD_refineFastSim_bTagDeepFlav,PhysicsTools/NanoAOD/jetsAK4_Puppi_cff.nanoAOD_refineFastSim_puppiJet'}, steps['NANOUP15FS']])
