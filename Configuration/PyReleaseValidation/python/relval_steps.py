...
#    'CMSSW_7_1_0_pre5-START71_V1-v2',                      # 3 8 TeV , for the one sample which is part of the routine relval production (RelValZmumuJets_Pt_20_300, because of -v2)
    ...
    #'CMSSW_7_6_2-76X_dataRun2_HLT_frozen_v9_rerecoGT_RelVal_DATASETSTRING-v1',    # 15 - data REMINIAOD RECO input
...
steps['SingleElectronPt10_UP15_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValSingleElectronPt10_UP15/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['SingleElectronPt1000_UP15_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValSingleElectronPt1000_UP15/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['SingleElectronPt35_UP15_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValSingleElectronPt35_UP15/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['SingleGammaPt10_UP15_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValSingleGammaPt10_UP15/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['SingleGammaPt35_UP15_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValSingleGammaPt35_UP15/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['SingleMuPt1_UP15_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValSingleMuPt1_UP15/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['SingleMuPt10_UP15_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValSingleMuPt10_UP15/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['SingleMuPt100_UP15_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValSingleMuPt100_UP15/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['SingleMuPt1000_UP15_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValSingleMuPt1000_UP15/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['NuGun_UP15_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValNuGun_UP15/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['TTbarLepton_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValTTbarLepton_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['Wjet_Pt_80_120_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValWjet_Pt_80_120_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['Wjet_Pt_3000_3500_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValWjet_Pt_3000_3500_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['SMS-T1tttt_mGl-1500_mLSP-100_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValSMS-T1tttt_mGl-1500_mLSP-100_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')} 
steps['QCD_FlatPt_15_3000HS_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValQCD_FlatPt_15_3000HS_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['Higgs200ChargedTaus_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValHiggs200ChargedTaus_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['QCD_Pt_3000_3500_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValQCD_Pt_3000_3500_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['QCD_Pt_600_800_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValQCD_Pt_600_800_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['Upsilon1SToMuMu_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValUpsilon1SToMuMu_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['BsToMuMu_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValBsToMuMu_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['JpsiMuMu_Pt-15_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValJpsiMuMu_Pt-15/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['TTbar_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValTTbar_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['WE_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValWE_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
...
steps['H125GGgluonfusion_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValH125GGgluonfusion_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['PhotonJets_Pt_10_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValPhotonJets_Pt_10_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['QQH1352T_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValQQH1352T_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['QCD_Pt_80_120_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValQCD_Pt_80_120_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['WM_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValWM_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['ZMM_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValZMM_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['ADDMonoJet_d3MD3_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValADDMonoJet_d3MD3_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['ZpMM_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValZpMM_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['WpM_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValWpM_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['PhiToMuMu_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValPhiToMuMu_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['RSKKGluon_m3000GeV_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValRSKKGluon_m3000GeV_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['ZpMM_2250_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValZpMM_2250_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['ZpEE_2250_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValZpEE_2250_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['ZpTT_1500_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValZpTT_1500_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['EtaBToJpsiJpsi_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValEtaBToJpsiJpsi_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['BuMixing_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValBuMixing_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['HSCPstop_M_200_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValHSCPstop_M_200_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['RSGravitonToGaGa_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValRSGravitonToGaGa_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
steps['WpToENu_M-2000_13_REMINIAODINPUT']={'INPUT':InputInfo(dataSet='/RelValWpToENu_M-2000_13/%s/GEN-SIM-RECO'%(baseDataSetRelease[12],),location='STD')}
