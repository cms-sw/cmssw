...
steps['RunHI2018']={'INPUT':InputInfo(dataSet='/HIMinimumBias0/Tier0_REPLAY_vocms015-v213/RAW',label='hi2018',run=[325174],events=10000,location='STD')}
steps['RunHI2018Reduced']={'INPUT':InputInfo(dataSet='/HIMinimumBiasReducedFormat0/Tier0_REPLAY_vocms015-v213/RAW',label='hi2018reduced',run=[325174],events=10000,location='STD')}
