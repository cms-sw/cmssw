...
steps['RECODR2_2018reHLT_skimSingleMu_DQMM']=merge([{'-s':'RAW2DIGI,L1Reco,RECO,SKIM:MuonPOGSkim+ZMu+MuTau,EI,PAT,ALCA:SiPixelCalSingleMuonLoose+SiPixelCalSingleMuonTight+SiStripCalZeroBias+SiStripCalMinBias+SiStripCalSmallBiasScan+TkAlMinBias+EcalESAlign,DQM:@common+@muon+@lumi+@L1TMuon'},steps['RECODR2_2018reHLT']])
steps['RECODR2_2018reHLT_skimEGamma_L1TEgDQM_DQMM']=merge([{'-s':'RAW2DIGI,L1Reco,RECO,SKIM:ZElectron+SinglePhotonJetPlusHOFilter+EXOMONOPOLE,EI,PAT,ALCA:SiStripCalZeroBias+SiStripCalMinBias+SiStripCalSmallBiasScan+TkAlMinBias+EcalESAlign,DQM:@common+@ecal+@egamma+@L1TEgamma'},steps['RECODR2_2018reHLT']])
steps['RECODR2_2018reHLT_skimMuonEG_DQMM']=merge([{'-s':'RAW2DIGI,L1Reco,RECO,SKIM:TopMuEG,EI,PAT,ALCA:SiStripCalZeroBias+SiStripCalMinBias+SiStripCalSmallBiasScan+TkAlMinBias+EcalESAlign,DQM:@common'},steps['RECODR2_2018reHLT']])
steps['RECODR2_2018reHLT_skimJetHT_DQMM']=merge([{'-s':'RAW2DIGI,L1Reco,RECO,SKIM:JetHTJetPlusHOFilter,EI,PAT,ALCA:SiStripCalZeroBias+SiStripCalMinBias+SiStripCalSmallBiasScan+TkAlMinBias+EcalESAlign,DQM:@common+@jetmet+@hcal'},steps['RECODR2_2018reHLT']])
steps['RECODR2_2018reHLT_skimDisplacedJet_DQMM']=merge([{'-s':'RAW2DIGI,L1Reco,RECO,SKIM:EXODisplacedJet,EI,PAT,ALCA:SiStripCalZeroBias+SiStripCalMinBias+SiStripCalSmallBiasScan+TkAlMinBias+EcalESAlign,DQM:@common'},steps['RECODR2_2018reHLT']])
...
steps['RECODR2_2018reHLT_skimEGamma_Offline_L1TEgDQM_DQMM']=merge([{'--conditions':'auto:run2_data'},steps['RECODR2_2018reHLT_skimEGamma_L1TEgDQM_DQMM']])
...
steps['RECODR2_2018reHLT_skimJetHT_Offline_DQMM']=merge([{'--conditions':'auto:run2_data'},steps['RECODR2_2018reHLT_skimJetHT_DQMM']])
...
steps['RECODR2_2018reHLT_skimDisplacedJet_Offline_DQMM']=merge([{'--conditions':'auto:run2_data'},steps['RECODR2_2018reHLT_skimDisplacedJet_DQMM']])
...
steps['RECODR2_2018reHLT_skimMET_Offline_DQMM']=merge([{'--conditions':'auto:run2_data'},steps['RECODR2_2018reHLT_skimMET_DQMM']])
...
steps['RECODR2_2018reHLT_skimMuonEG_Offline_DQMM']=merge([{'--conditions':'auto:run2_data'},steps['RECODR2_2018reHLT_skimMuonEG_DQMM']])
...
steps['RECODR2_2018reHLT_skimSingleMu_Offline_DQMM']=merge([{'--conditions':'auto:run2_data'},steps['RECODR2_2018reHLT_skimSingleMu_DQMM']])
...
steps['RECODR2_2018reHLT_skimMuOnia_Offline_DQMM']=merge([{'--conditions':'auto:run2_data'},steps['RECODR2_2018reHLT_skimMuOnia_DQMM']])
