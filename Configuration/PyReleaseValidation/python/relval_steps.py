...
steps['RECOMU']=merge([{'-s':'RAW2DIGI,L1Reco,RECO,VALIDATION,DQM'},stCond,step3Defaults])
...
steps['RECOQCD']=merge([{'-s':'RAW2DIGI,L1Reco,RECO,VALIDATION,DQM'},stCond,step3Defaults])
