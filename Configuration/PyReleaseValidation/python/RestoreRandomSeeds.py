...
def customise(process):
    ...
    process.RandomNumberGeneratorService.moduleSeeds = cms.PSet(
        ...
        ,simSiPixelDigis = cms.untracked.uint32(1)
        ,simSiStripDigis = cms.untracked.uint32(1)
        ,simEcalUnsuppressedDigis = cms.untracked.uint32(1)
        ,simHcalUnsuppressedDigis = cms.untracked.uint32(1)
        ,simMuonCSCDigis = cms.untracked.uint32(1)
        ,simMuonDTDigis = cms.untracked.uint32(1)
        ,simMuonRPCDigis = cms.untracked.uint32(1)
        )
