...
alcaDict2={'MinBias':'RpcCalHLT+DQM',
           'JetET20':'MuAlCalIsolatedMu+MuCaliMinBias+RpcCalHLT+DQM',
           'JetETXX':'MuAlCalIsolatedMu+MuCaliMinBias+RpcCalHLT+DQM',
           'GammaJets':'RpcCalHLT+DQM',
           'MuonPTXX':'MuAlCalIsolatedMu+MuCaliMinBias+RpcCalHLT+DQM',
           'ZW':'MuAlCalIsolatedMu+MuCaliMinBias+RpcCalHLT+DQM',
           'HCALNZS':'HcalCalMinBias+DQM',
           'HCALIST':'HcalCalIsoTrkNoHLT+DQM',
           'RELVAL':'MuAlCalIsolatedMu+MuCaliMinBias+RpcCalHLT+DQM',
