...
l1Menus= {
    ...
    'FULL'         : ( ','.join( [ 'L1Menu_Collisions2022_v1_1_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2022-06-01 09:37:45.000"] ), ),
    'GRun'         : ( ','.join( [ 'L1Menu_Collisions2022_v1_1_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2022-06-01 09:37:45.000"] ), ),
    '2022v11'      : ( ','.join( [ 'L1Menu_Collisions2022_v1_0_1_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2022-05-11 09:04:16.000"] ), ),
...
#   'symbolic GT'            : ('base GT',[('payload1',payload2')])
    ...
    'run3_mc_2022v11'        : ('phase1_2021_realistic'   ,l1Menus['GRun']),
    ...
    'run3_hlt_2022v11'       : ('run3_hlt_relval'         ,l1Menus['GRun']),
    ...
    'run3_data_2022v11'      : ('run3_data_relval'        ,l1Menus['GRun']),
