...
l1Menus= {
    ...
    'FULL'         : ( ','.join( [ 'L1Menu_Collisions2022_v1_2_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2022-06-17 10:22:00.000"] ), ),
    'GRun'         : ( ','.join( [ 'L1Menu_Collisions2022_v1_2_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2022-06-17 10:22:00.000"] ), ),
    '2022v13'      : ( ','.join( [ 'L1Menu_Collisions2022_v1_2_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2022-06-17 10:22:00.000"] ), ),
...
#   'symbolic GT'            : ('base GT',[('payload1',payload2')])
    ...
    'run3_mc_2022v13'        : ('phase1_2022_realistic'   ,l1Menus['2022v13']),
    ...
    'run3_hlt_2022v13'       : ('run3_hlt_relval'         ,l1Menus['2022v13']),
    ...
    'run3_data_2022v13'      : ('run3_data_relval'        ,l1Menus['2022v13']),
