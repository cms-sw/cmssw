...
l1Menus = {
    ...
    '2026v10'      : ( ','.join( [ 'L1Menu_Collisions2026_v1_0_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2026-02-04 14:35:13.000"] ), ),
...
#   'symbolic GT'            : ('base GT',[('payload1',payload2')])
    ...
    'run3_mc_2026v10'        : ('phase1_2026_realistic'   ,l1Menus['2026v10']),
    ...
    'run3_hlt_2026v10'       : ('run3_hlt'                ,l1Menus['2026v10']),
    ...
    'run3_data_2026v10'      : ('run3_data_prompt'        ,l1Menus['2026v10']),
