...
l1Menus = {
    ...
    'FULL'         : ( ','.join( [ 'L1Menu_Collisions2025_v1_1_1_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2025-05-05 06:00:45.000"] ), ),
    'GRun'         : ( ','.join( [ 'L1Menu_Collisions2025_v1_1_1_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2025-05-05 06:00:45.000"] ), ),
    '2025v10'      : ( ','.join( [ 'L1Menu_Collisions2025_v1_1_1_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2025-05-05 06:00:45.000"] ), ),
    ...
    'Special'      : ( ','.join( [ 'L1Menu_Collisions2025_v1_1_1_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2025-05-05 06:00:45.000"] ), ),
}
