...
l1Menus= {
    ...
    'HIon_2015_v2' : 'L1Menu_CollisionsHeavyIons2015_v5_mc',
    'PIon'         : 'L1Menu_Collisions2015_25nsStage1_v5',
    'PRef'           : 'L1Menu_Collisions2015_5TeV_pp_reference_v5_mc',
    'pp5TeV_2015_v2' : 'L1Menu_Collisions2015_5TeV_pp_reference_v5_mc',
...
#   'symbolic GT'            : ('base GT',[('payload1',payload2')])
    ...
    'run2_mc_HIon_2015_v2'   : ('run2_mc_hi'   ,l1Menus['HIon']),
    'run2_mc_PIon'           : ('run2_mc'      ,l1Menus['PIon']),
    'run2_mc_PRef'           : ('run2_mc'      ,l1Menus['PRef']),
    'run2_mc_pp5TeV_2015_v2' : ('run2_mc'      ,l1Menus['PRef']),
    ...
    'run2_hlt_HIon_2015_v2'  : ('run2_hlt_hi'  ,l1Menus['HIon']),
    'run2_hlt_PIon'          : ('run2_hlt'     ,l1Menus['PIon']),
    'run2_hlt_PRef'          : ('run2_hlt'     ,l1Menus['PRef']),
    'run2_hlt_pp5TeV_2015_v2': ('run2_hlt'     ,l1Menus['PRef']),
    ...
    'run2_data_HIon_2015_v2' : ('run2_data'    ,l1Menus['HIon']),
    'run2_data_PIon'         : ('run2_data'    ,l1Menus['PIon']),
    'run2_data_PRef'          : ('run2_data'    ,l1Menus['PRef']),
    'run2_data_pp5TeV_2015_v2': ('run2_data'    ,l1Menus['PRef']),
