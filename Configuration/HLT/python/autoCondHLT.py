...
l1Menus= {
    ...
    'FULL'         : ( ','.join( [ 'L1Menu_Collisions2016_v8_xml'                            ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-10-04 09:49:40.000"] ), ),
    'GRun'         : ( ','.join( [ 'L1Menu_Collisions2016_v8_xml'                            ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-10-04 09:49:40.000"] ), ),
