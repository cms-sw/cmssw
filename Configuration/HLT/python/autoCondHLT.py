...
l1Menus = {
    ...
    'FULL'         : ( ','.join( [ 'L1Menu_Collisions2024_v0_0_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2024-02-11 13:00:00.000"] ), ),
    'GRun'         : ( ','.join( [ 'L1Menu_Collisions2024_v0_0_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2024-02-11 13:00:00.000"] ), ),
    ...
    'Special'      : ( ','.join( [ 'L1Menu_Collisions2024_v0_0_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2024-02-11 13:00:00.000"] ), ),
}
