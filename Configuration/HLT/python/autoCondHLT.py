...
#   'symbolic GT'            : ('base GT',[('payload1',payload2')])
    ...
    'run2_mc_2018v34'        : ('phase1_2018_realistic',l1Menus['2018v34']),
    ...
    'run2_hlt_2018v34'       : ('run2_hlt_relval'      ,l1Menus['2018v34']),
    ...
    'run2_data_2018v34'      : ('run2_data_promptlike' ,l1Menus['2018v34']),
