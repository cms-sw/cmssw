...
l1Menus= {
    ...
    'FULL' : ( ','.join( [ 'L1Menu_Collisions2016_v3_xml'                            ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-05-13 10:00:00.000"] ), ),
    'GRun' : ( ','.join( [ 'L1Menu_Collisions2016_v3_xml'                            ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-05-13 10:00:00.000"] ), ),
    'HIon' : ( ','.join( [ 'L1Menu_CollisionsHeavyIons2015_v5_uGT_xml'               ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-03-04 15:00:00.000"] ), ),
    'PIon' : ( ','.join( [ 'L1Menu_Collisions2016_v3_xml'                            ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-05-13 10:00:00.000"] ), ),
