...
l1Menus = {
    ...
    'FULL'         : ( ','.join( [ 'L1Menu_Collisions2026_v1_0_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2026-02-04 14:35:13.000"] ), ),
    'GRun'         : ( ','.join( [ 'L1Menu_Collisions2026_v1_0_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2026-02-04 14:35:13.000"] ), ),
    '2025v13'      : ( ','.join( [ 'L1Menu_Collisions2026_v1_0_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2026-02-04 14:35:13.000"] ), ),
    ...
    'Special'      : ( ','.join( [ 'L1Menu_Collisions2026_v1_0_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2026-02-04 14:35:13.000"] ), ),
}
...
#   'symbolic GT'            : ('base GT',[('payload1',payload2')])
    ...
    'run3_mc_FULL'           : ('phase1_2026_realistic'   ,l1Menus['FULL']),
    'run3_mc_GRun'           : ('phase1_2026_realistic'   ,l1Menus['GRun']),
    'run3_mc_2025v13'        : ('phase1_2026_realistic'   ,l1Menus['2025v13']),
    'run3_mc_HIon'           : ('phase1_2026_realistic_hi',l1Menus['HIon']),
    'run3_mc_PIon'           : ('phase1_2026_realistic'   ,l1Menus['PIon']),
    'run3_mc_PRef'           : ('phase1_2026_realistic'   ,l1Menus['PRef']),
    'run3_mc_Special'        : ('phase1_2026_realistic'   ,l1Menus['Special']),
    ...
    'run3_hlt_2025v13'       : ('run3_hlt'                ,l1Menus['2025v13']),
    ...
    'run3_data_2025v13'      : ('run3_data_prompt'        ,l1Menus['2025v13']),
