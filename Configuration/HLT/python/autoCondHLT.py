...
l1Menus= {
    ...
    'XeXe'         : ( ','.join( [ 'L1Menu_Collisions2017_v3_m6_xml'                         ,l1tMenuRecord,connectionString,l1tMenuLabel, "2017-07-24 12:50:00.000"] ), ),
...
#   'symbolic GT'            : ('base GT',[('payload1',payload2')])
    ...
    'run2_mc_XeXe'           : ('phase1_2017_realistic',l1Menus['XeXe']),
    ...
    'run2_hlt_XeXe'          : ('run2_hlt_relval'      ,l1Menus['XeXe']),
    ...
    'run2_data_XeXe'         : ('run2_data_promptlike' ,l1Menus['XeXe']),
