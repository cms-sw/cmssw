...
l1Menus = {
    ...
    '2026v11'      : ( ','.join( [ 'L1Menu_Collisions2026_v1_1_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2026-03-12 11:22:42.000"] ), ),
...
#   'symbolic GT'            : ('base GT',[('payload1',payload2')])
    ...
    'run3_mc_2026v11'        : ('phase1_2026_realistic'   ,l1Menus['2026v11']),
    ...
    'run3_hlt_2026v11'       : ('run3_hlt'                ,l1Menus['2026v11']),
    ...
    'run3_data_2026v11'      : ('run3_data_prompt'        ,l1Menus['2026v11']),
