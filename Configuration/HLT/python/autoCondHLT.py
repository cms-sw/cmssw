...
l1Menus= {
    ...
    'FULL'         : ( ','.join( [ 'L1Menu_Collisions2016_v7_xml'                            ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-09-23 05:50:52.000000"] ), ),
    'GRun'         : ( ','.join( [ 'L1Menu_Collisions2016_v7_xml'                            ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-09-23 05:50:52.000000"] ), ),
    ...
    'PIon'         : ( ','.join( [ 'L1Menu_Collisions2016_v6r8m_m2'                          ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-09-16 13:06:50.000"] ), ),
