...
l1Menus= {
    ...
    'FULL'         : ( ','.join( [ 'L1Menu_Collisions2018_v0_0_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2018-03-05 20:43:54.000"] ), ),
    'GRun'         : ( ','.join( [ 'L1Menu_Collisions2018_v0_0_0_xml'                        ,l1tMenuRecord,connectionString,l1tMenuLabel, "2018-03-05 20:43:54.000"] ), ),
