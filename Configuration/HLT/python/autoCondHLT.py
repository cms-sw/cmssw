...
l1Menus= {
    ...
    '2018v35'      : ( ','.join( [ 'L1Menu_Collisions2018_v2_1_0-d1_xml'                     ,l1tMenuRecord,connectionString,l1tMenuLabel, "2018-08-14 11:03:08.000"] ), ),
...
#   'symbolic GT'            : ('base GT',[('payload1',payload2')])
    ...
    'run2_mc_2018v35'        : ('phase1_2018_realistic',l1Menus['2018v35']),
    ...
    'run2_hlt_2018v35'       : ('run2_hlt_relval'      ,l1Menus['2018v35']),
    ...
    'run2_data_2018v35'      : ('run2_data_promptlike' ,l1Menus['2018v35']),
