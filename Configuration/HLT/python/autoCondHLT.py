...
l1Menus= {
    ...
    '2e34v21'      : ( ','.join( [ 'L1Menu_Collisions2017_v2_m6_full_xml'                    ,l1tMenuRecord,connectionString,l1tMenuLabel, "2017-07-08 11:46:40.000"] ), ),
...
#   'symbolic GT'            : ('base GT',[('payload1',payload2')])
    ...
    'run2_mc_2e34v21'        : ('phase1_2017_realistic',l1Menus['2e34v21']),
    ...
    'run2_hlt_2e34v21'       : ('run2_hlt_relval'      ,l1Menus['2e34v21']),
    ...
    'run2_data_2e34v21'      : ('run2_data_promptlike' ,l1Menus['2e34v21']),
