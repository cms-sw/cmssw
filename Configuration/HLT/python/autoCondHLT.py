...
l1Menus= {
    ...
    'FULL'         : ( ','.join( [ 'L1Menu_Collisions2016_v5_xml'                            ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-07-08 10:00:00.000"] ), ),
    'GRun'         : ( ','.join( [ 'L1Menu_Collisions2016_v5_xml'                            ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-07-08 10:00:00.000"] ), ),
    ...
    'PIon'         : ( ','.join( [ 'L1Menu_Collisions2016_v5_xml'                            ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-07-08 10:00:00.000"] ), ),
