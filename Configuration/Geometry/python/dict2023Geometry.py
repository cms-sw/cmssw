...
trackerDict = {
    ...
    "T5" : {
        1 : [
            'Geometry/TrackerCommonData/data/trackerParameters.xml',
            'Geometry/TrackerCommonData/data/pixfwdCommon.xml',
            'Geometry/TrackerCommonData/data/TiltedTracker4025/pixfwd.xml', 
            'Geometry/TrackerCommonData/data/TiltedTracker4025/pixbar.xml', 
            'Geometry/TrackerCommonData/data/trackermaterial.xml',
            'Geometry/TrackerCommonData/data/TiltedTracker4025/tracker.xml',
            'Geometry/TrackerCommonData/data/TiltedTracker4025/pixel.xml',
            'Geometry/TrackerCommonData/data/TiltedTracker4025/trackerbar.xml',
            'Geometry/TrackerCommonData/data/TiltedTracker4025/trackerfwd.xml',
            'Geometry/TrackerCommonData/data/TiltedTracker4025/trackerStructureTopology.xml',
            'Geometry/TrackerCommonData/data/TiltedTracker4025/pixelStructureTopology.xml',
            'Geometry/TrackerSimData/data/TiltedTracker4025/trackersens.xml',
            'Geometry/TrackerSimData/data/TiltedTracker4025/pixelsens.xml',
            'Geometry/TrackerRecoData/data/TiltedTracker4025/trackerRecoMaterial.xml',
            'Geometry/TrackerSimData/data/TiltedTracker4025/trackerProdCuts.xml',
            'Geometry/TrackerSimData/data/TiltedTracker4025/pixelProdCuts.xml',
            'Geometry/TrackerSimData/data/trackerProdCutsBEAM.xml',
        ],
        "sim" : [
            'from Geometry.TrackerNumberingBuilder.trackerNumberingGeometry_cfi import *',
...
caloDict = {
    ...
    "C3" : {
        1 : [
            ...
            'Geometry/HcalCommonData/data/HGCal/hcalalgo.xml',
            'Geometry/HcalCommonData/data/hcalbarrelalgo.xml',
            'Geometry/HcalCommonData/data/SSAbsorber/hcalendcapalgo.xml',
            'Geometry/HcalCommonData/data/hcalouteralgo.xml',
            'Geometry/HcalCommonData/data/hcalforwardalgo.xml',
            'Geometry/HcalCommonData/data/hcalSimNumbering.xml',
            'Geometry/HcalCommonData/data/hcalRecNumberingRebuild.xml',
