...
if not (stage2L1Trigger.isChosen()):
    ...
    # use ECAL TPs directly rather than re-emulate from zero-suppressed data
    ...
    # use unpacked ECAL TPs directly but re-simulate HCAL TPs
    SimL1Emulator = cms.Sequence(unpackEcal+unpackCSC+unpackDT+unpackRPC+unpackEmtf+unpackCsctf+unpackBmtf
