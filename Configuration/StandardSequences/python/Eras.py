...
class Eras (object):
    ...
    def __init__(self):
        ...
        self.Phase2dev = cms.ModifierChain( self.phase1Pixel, self.trackingPhase1, self.Phase2, self.phase2dev_common, self.phase2dev_tracker, self.phase2dev_hgcal, self.phase2dev_muon )
