...
from Validation.RecoTau.TauValidationMiniAOD_cff import *
...
validationMiniAOD = cms.Sequence(type0PFMEtCorrectionPFCandToVertexAssociationForValidationMiniAOD * JetValidationMiniAOD * METValidationMiniAOD * tauValidationMiniAOD)
