...
pathALCARECOHcalCalHOTask = cms.Task(ALCARECOHcalCalHODQM)
pathALCARECOHcalCalHO = cms.Path(seqALCARECOHcalCalHO, pathALCARECOHcalCalHOTask)
pathALCARECOHcalCalHOCosmics = cms.Path(seqALCARECOHcalCalHOCosmics)
# Short-term workaround to preserve the "run for every event" while removing the use of convertToUnscheduled()
# To be reverted in a subsequent PR
pathALCARECOHcalCalIsoTrkTask = cms.Task(ALCARECOHcalCalIsoTrackDQM)
pathALCARECOHcalCalIsoTrk = cms.Path(seqALCARECOHcalCalIsoTrk,pathALCARECOHcalCalIsoTrkTask)
...
# Short-term workaround to preserve the "run for every event" while removing the use of convertToUnscheduled()
# To be reverted in a subsequent PR
pathALCARECOHcalCalIterativePhiSymTask = cms.Task(ALCARECOHcalCalPhisymDQM)
pathALCARECOHcalCalIterativePhiSym = cms.Path(seqALCARECOHcalCalIterativePhiSym, pathALCARECOHcalCalIterativePhiSymTask)
pathALCARECOHcalCalIsolatedBunchFilter = cms.Path(seqALCARECOHcalCalIsolatedBunchFilter)
# Short-term workaround to preserve the "run for every event" while removing the use of convertToUnscheduled()
# To be reverted in a subsequent PR
pathALCARECOHcalCalIsolatedBunchSelectorTask = cms.Task(ALCARECOHcalCalIsolatedBunchDQM)
pathALCARECOHcalCalIsolatedBunchSelector = cms.Path(seqALCARECOHcalCalIsolatedBunchSelector, pathALCARECOHcalCalIsolatedBunchSelectorTask)
