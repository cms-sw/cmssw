...
highlevelreco = cms.Sequence(particleFlowReco*egammarecoFull*jetHighLevelReco*tautagging*metrecoPlusHCALNoise*btagging*recoPFMET*PFTau*regionalCosmicTracksSeq*muoncosmichighlevelreco*reducedRecHits)
