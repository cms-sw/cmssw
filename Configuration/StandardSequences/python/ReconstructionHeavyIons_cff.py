...
reconstruct_PbPb = cms.Sequence(lumiInfoRunHeader*localReco*globalRecoPbPb*CastorFullReco)
reconstructionHeavyIons = cms.Sequence(reconstruct_PbPb)

reconstructionHeavyIons_HcalNZS = cms.Sequence(lumiInfoRunHeader*localReco_HcalNZS*globalRecoPbPb)
