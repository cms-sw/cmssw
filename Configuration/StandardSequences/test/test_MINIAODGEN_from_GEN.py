...
# with command line options: step1 --fileout file:HIG-RunIISummer16MiniAODv2-00732.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --nThreads 1 --era Run2_2016 --python_filename test1.py --no_exec -n 5
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/mc/RunIIWinter15GenOnly/LLJJ_QCD_EWK_SM_5f_LO_13TeV_madgraph-pythia8_TuneCUETP8M1/GEN/MCRUN2_71_V1-v1/1220000/AEC7FF09-96F7-E611-8B8F-02163E013494.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer16MiniAODv2-00732.root'),
