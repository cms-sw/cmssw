...
class cosmicsEra_Run2_2016ScenarioTest(unittest.TestCase):
    """
    unittest for cosmicsEra_Run2_2016 scenario
    ...
    def testA(self):
        """get the scenario"""
        try:
            scenario = getScenario("cosmicsEra_Run2_2016")
        except Exception as ex:
            msg = "Failed to get cosmicsEra_Run2_2016 scenario\n"
            msg += str(ex)
            self.fail(msg)
    ...
    def testPromptReco(self):
        ...
        try:
            ...
            msg += "for cosmicsEra_Run2_2016 Scenario\n"
            msg += str(ex)
            self.fail(msg)
