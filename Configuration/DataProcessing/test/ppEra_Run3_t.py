...
class ppEra_Run3ScenarioTest(unittest.TestCase):
    """
    unittest for ppEra_Run3 collisions scenario
    ...
    def testA(self):
        """get the scenario"""
        try:
            scenario = getScenario("ppEra_Run3")
        except Exception as ex:
            msg = "Failed to get ppEra_Run3 scenario\n"
            msg += str(ex)
            self.fail(msg)
