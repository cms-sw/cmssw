...
class cosmicsEra_Run2_2018_HIScenarioTest(unittest.TestCase):
    """
    unittest for cosmicsEra_Run2_2018_HI scenario
    ...
    def testA(self):
        """get the scenario"""
        try:
            scenario = getScenario("cosmicsEra_Run2_2018_HI")
        except Exception as ex:
            msg = "Failed to get cosmicsEra_Run2_2018_HI scenario\n"
            msg += str(ex)
            self.fail(msg)
    ...
    def testPromptReco(self):
        ...
        try:
            ...
            msg += "for cosmicsEra_Run2_2018_HI Scenario\n"
            msg += str(ex)
            self.fail(msg)
