...
# with command line options: skims -s SKIM:@SingleMu --data --no_exec --dbs find file,file.parent where dataset=/SingleMu/Run2012B-PromptReco-v1/RECO and run=194050 and lumi=500 -n 1000 --conditions auto:com10 --python_filename=skim_SingleMu.py
...
process.source = cms.Source("PoolSource",
    secondaryFileNames = cms.untracked.vstring('/store/data/Run2012B/SingleMu/RAW/v1/000/194/050/BE8D94C4-1C9C-E111-8B80-BCAEC518FF44.root'),
    fileNames = cms.untracked.vstring('/store/data/Run2012B/SingleMu/RECO/PromptReco-v1/000/194/050/A2D99CD5-269E-E111-A5EA-003048F11C58.root')
)
...
# Schedule definition
process.schedule = cms.Schedule(process.mutauSkimPath,process.ZMuSkimPath,process.TOPMuPlusJetsPath,process.EXOHSCPPath,process.EXOHSCPDEDXPath,process.pathlogerror,process.pfPath,process.tcPath,process.pathlogerrormonitor,process.SKIMStreamEXOHSCPOutPath,process.SKIMStreamHighMETOutPath,process.SKIMStreamLogErrorOutPath,process.SKIMStreamLogErrorMonitorOutPath,process.SKIMStreamMuTauOutPath,process.SKIMStreamTOPMuPlusJetsOutPath,process.SKIMStreamZMuOutPath)
