...
# with command line options: skim -s SKIM:WMu+ZMu+HighMET+LogError+HWW+HZZ+DiTau+EXOHSCP --data --conditions FT_R_42_V13A::All --python_filenam skim_SingleMu.py --magField AutoFromDBCurrent --no_exec
