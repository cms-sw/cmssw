...
# with command line options: skims -s SKIM:@DoubleMu --data --no_exec --dbs find file,file.parent where dataset=/DoubleMu/Run2012B-PromptReco-v1/RECO and run=194050 and lumi=500 -n 1000 --conditions auto:com10 --python_filename=skim_DoubleMu.py
...
process.source = cms.Source("PoolSource",
    secondaryFileNames = cms.untracked.vstring('/store/data/Run2012B/DoubleMu/RAW/v1/000/194/050/0C9F0977-1D9C-E111-A013-003048D2C01E.root'),
    fileNames = cms.untracked.vstring('/store/data/Run2012B/DoubleMu/RECO/PromptReco-v1/000/194/050/1A670A55-3E9E-E111-9F59-0025901D5C80.root')
)
