...
# with command line options: skims -s SKIM:@PAMuon --data --no_exec --dbs find file,file.parent where dataset=/PAMuon/Run2012B-PromptReco-v1/RECO and run=194050 and lumi=500 -n 1000 --conditions auto:com10 --python_filename=skim_PAMuon.py
...
process.SKIMStreamPsiMuMuPA = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('psiPath')
    ),
    outputCommands = cms.untracked.vstring( ('drop *', 
        'keep DetIdedmEDCollection_siStripDigis_*_*', 
        'keep DetIdedmEDCollection_siPixelDigis_*_*', 
        ...
        'drop *_MEtoEDMConverter_*_*', 
        'drop *_*_*_SKIM' ) ),
    fileName = cms.untracked.string('PsiMuMuPA.root'),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string('PsiMuMuPA'),
        dataTier = cms.untracked.string('RECO')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880)
)
process.SKIMStreamUpsMuMuPA = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('upsPath')
    ),
    outputCommands = cms.untracked.vstring( ('drop *', 
        'keep DetIdedmEDCollection_siStripDigis_*_*', 
        'keep DetIdedmEDCollection_siPixelDigis_*_*', 
        ...
        'drop *_MEtoEDMConverter_*_*', 
        'drop *_*_*_SKIM' ) ),
    fileName = cms.untracked.string('UpsMuMuPA.root'),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string('UpsMuMuPA'),
        dataTier = cms.untracked.string('RECO')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880)
)
process.SKIMStreamZMuMuPA = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('ZPath')
    ),
    outputCommands = cms.untracked.vstring( ('drop *', 
        'keep DetIdedmEDCollection_siStripDigis_*_*', 
        'keep DetIdedmEDCollection_siPixelDigis_*_*', 
        ...
        'drop *_MEtoEDMConverter_*_*', 
        'drop *_*_*_SKIM' ) ),
    fileName = cms.untracked.string('ZMuMuPA.root'),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string('ZMuMuPA'),
        dataTier = cms.untracked.string('RECO')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880)
)
...
process.SKIMStreamPsiMuMuPAOutPath = cms.EndPath(process.SKIMStreamPsiMuMuPA)
process.SKIMStreamUpsMuMuPAOutPath = cms.EndPath(process.SKIMStreamUpsMuMuPA)
process.SKIMStreamZMuMuPAOutPath = cms.EndPath(process.SKIMStreamZMuMuPA)

# Schedule definition
process.schedule = cms.Schedule(process.HighPtPath,process.ZPath,process.psiPath,process.upsPath,process.SKIMStreamHighPtPAOutPath,process.SKIMStreamPsiMuMuPAOutPath,process.SKIMStreamUpsMuMuPAOutPath,process.SKIMStreamZMuMuPAOutPath)
