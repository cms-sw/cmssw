...
# with command line options: skims -s SKIM:@NoBPTX --data --no_exec --dbs find file,file.parent where dataset=/NoBPTX/Run2012B-PromptReco-v1/RECO and run=194050 and lumi=500 -n 1000 --conditions auto:com10 --python_filename=skim_NoBPTX.py
...
process.source = cms.Source("PoolSource",
    secondaryFileNames = cms.untracked.vstring('/store/data/Run2012B/NoBPTX/RAW/v1/000/194/050/380CFFE0-389C-E111-B5EC-E0CB4E55365D.root'),
    fileNames = cms.untracked.vstring('/store/data/Run2012B/NoBPTX/RECO/PromptReco-v1/000/194/050/823DB550-049E-E111-9DFD-002481E0DEC6.root')
)
...
# Schedule definition
process.schedule = cms.Schedule(process.EXOHSCPPath,process.EXOHSCPDEDXPath,process.pathlogerror,process.pathlogerrormonitor,process.SKIMStreamEXOHSCPOutPath,process.SKIMStreamLogErrorOutPath,process.SKIMStreamLogErrorMonitorOutPath)
