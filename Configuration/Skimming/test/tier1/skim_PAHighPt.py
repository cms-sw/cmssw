...
# with command line options: skims -s SKIM:@PAHighPt --data --no_exec --dbs find file,file.parent where dataset=/PAHighPt/Run2012B-PromptReco-v1/RECO and run=194050 and lumi=500 -n 1000 --conditions auto:com10 --python_filename=skim_PAHighPt.py
...
process.SKIMStreamFlowCorrPA = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('FlowCorrPath')
    ),
    outputCommands = cms.untracked.vstring( ('drop *', 
        ...
        'drop *_*_*_SKIM' ) ),
    fileName = cms.untracked.string('FlowCorrPA.root'),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string('FlowCorrPA'),
        dataTier = cms.untracked.string('RECO')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880)
)
process.SKIMStreamHighPtPA = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('HighPtPath')
    ),
    outputCommands = cms.untracked.vstring( ('drop *', 
        'keep DetIdedmEDCollection_siStripDigis_*_*', 
        'keep DetIdedmEDCollection_siPixelDigis_*_*', 
        ...
        'drop *_MEtoEDMConverter_*_*', 
        'drop *_*_*_SKIM' ) ),
    fileName = cms.untracked.string('HighPtPA.root'),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string('HighPtPA'),
        dataTier = cms.untracked.string('RECO')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880)
)
...
process.SKIMStreamFlowCorrPAOutPath = cms.EndPath(process.SKIMStreamFlowCorrPA)
process.SKIMStreamHighPtPAOutPath = cms.EndPath(process.SKIMStreamHighPtPA)

# Schedule definition
process.schedule = cms.Schedule(process.HighPtPath,process.FlowCorrPath,process.SKIMStreamFlowCorrPAOutPath,process.SKIMStreamHighPtPAOutPath)
