...
# with command line options: skims -s SKIM:@SingleElectron --data --no_exec --dbs find file,file.parent where dataset=/SingleElectron/Run2012B-PromptReco-v1/RECO and run=194050 and lumi=500 -n 1000 --conditions auto:com10 --python_filename=skim_SingleElectron.py
...
process.source = cms.Source("PoolSource",
    secondaryFileNames = cms.untracked.vstring('/store/data/Run2012B/SingleElectron/RAW/v1/000/194/050/6CCC5377-1D9C-E111-AA82-0025901D625A.root'),
    fileNames = cms.untracked.vstring('/store/data/Run2012B/SingleElectron/RECO/PromptReco-v1/000/194/050/A06C725A-5E9E-E111-9187-001D09F24DA8.root')
)
...
process.SKIMStreamWElectron = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('WElectronPath')
    ),
    outputCommands = cms.untracked.vstring('drop *', 
    ...
    fileName = cms.untracked.string('WElectron.root'),
    dataset = cms.untracked.PSet(
...
# Schedule definition
process.schedule = cms.Schedule(process.TOPElePlusJetsPath,process.tauSkimBy2Path,process.pathlogerror,process.WElectronPath,process.pfPath,process.tcPath,process.pathlogerrormonitor,process.SKIMStreamDiTauOutPath,process.SKIMStreamHighMETOutPath,process.SKIMStreamLogErrorOutPath,process.SKIMStreamLogErrorMonitorOutPath,process.SKIMStreamTOPElePlusJetsOutPath,process.SKIMStreamWElectronOutPath)
