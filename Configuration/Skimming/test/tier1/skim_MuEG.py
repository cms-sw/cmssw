...
# with command line options: skims -s SKIM:@MuEG --data --no_exec --dbs find file,file.parent where dataset=/MuEG/Run2012B-PromptReco-v1/RECO and run=194050 and lumi=500 -n 1000 --conditions auto:com10 --python_filename=skim_MuEG.py
...
process.source = cms.Source("PoolSource",
    secondaryFileNames = cms.untracked.vstring('/store/data/Run2012B/MuEG/RAW/v1/000/194/050/6A987577-1D9C-E111-B0CD-5404A63886D4.root'),
    fileNames = cms.untracked.vstring('/store/data/Run2012B/MuEG/RECO/PromptReco-v1/000/194/050/94BEA3BE-699E-E111-907A-0030486780EC.root')
)
...
# Schedule definition
process.schedule = cms.Schedule(process.pathlogerror,process.HZZ4ePath,process.HZZ2e2mPath,process.HZZ2m2ePath,process.HZZ4mPath,process.HZZem2ePath,process.HZZem2mPath,process.pathlogerrormonitor,process.SKIMStreamHZZOutPath,process.SKIMStreamLogErrorOutPath,process.SKIMStreamLogErrorMonitorOutPath)
