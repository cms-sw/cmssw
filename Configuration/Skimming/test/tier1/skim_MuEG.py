...
# with command line options: skim -s SKIM:LogError+HWW+HZZ --data --conditions FT_R_42_V13A::All --python_filenam skim_MuEG.py --magField AutoFromDBCurrent --no_exec
