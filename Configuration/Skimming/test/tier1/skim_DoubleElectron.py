...
# with command line options: skim -s SKIM:ZElectron+LogError+HWW+HZZ --data --conditions FT_R_42_V13A::All --python_filenam skim_DoubleElectron.py --magField AutoFromDBCurrent --no_exec
