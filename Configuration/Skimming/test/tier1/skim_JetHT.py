...
# with command line options: skims -s SKIM:@JetHT --data --no_exec --dbs find file,file.parent where dataset=/JetHT/Run2012B-PromptReco-v1/RECO and run=194050 and lumi=500 -n 1000 --conditions auto:com10 --python_filename=skim_JetHT.py
...
process.source = cms.Source("PoolSource",
    secondaryFileNames = cms.untracked.vstring('/store/data/Run2012B/JetHT/RAW/v1/000/194/050/84EE38D6-1C9C-E111-8397-5404A63886CE.root'),
    fileNames = cms.untracked.vstring('/store/data/Run2012B/JetHT/RECO/PromptReco-v1/000/194/050/7CDD262D-3F9E-E111-8EBC-BCAEC518FF62.root')
)
