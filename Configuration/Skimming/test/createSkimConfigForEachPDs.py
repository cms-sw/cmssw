...
for k in autoSkim:
   ...
   if "Cosmics" in k:
      ...
      os.system('cmsDriver.py skims -s SKIM:@%s --data --no_exec --dbs \"find file,file.parent where dataset=/%s/CMSSW_7_0_8-pre8-*/RECO and run=194050 and lumi=500\" -n 1000 --conditions auto:com10 --python_filename=skim_%s.py --scenario=cosmics' %(k,k,k))
      ...
      os.system('cmsDriver.py skims -s SKIM:@%s --data --no_exec --dbs \"find file,file.parent where dataset=/%s/CMSSW_7_1_1-*/RECO and run=194050 and lumi=500\" -n 1000 --conditions auto:com10 --python_filename=skim_%s.py' %(k,k,k))
