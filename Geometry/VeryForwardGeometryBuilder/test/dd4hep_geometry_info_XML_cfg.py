...
# geometry
#from Geometry.VeryForwardGeometry.geometryIdealPPSFromDD_2018_cfi import allFiles
...
process.ctppsGeometryESModule = cms.ESProducer("PPSGeometryESProducer",
    verbosity = cms.untracked.uint32(1),
    compactViewTag = cms.string("CMS")
