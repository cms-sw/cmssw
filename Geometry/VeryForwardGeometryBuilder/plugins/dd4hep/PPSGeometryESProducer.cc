...
//  const edm::ESGetToken<cms::DDCompactView, IdealGeometryRecord> compactViewToken_;
...
//      compactViewToken_{setWhatProduced(this, &PPSGeometryESProducer::produceIdealGD)
//                            .consumes<cms::DDCompactView>(edm::ESInputTag(
...
//
 //     auto cc = setWhatProduced(this, &PPSGeometryESProducer::produceIdealGD);
 //     compactViewToken_ = cc.consumes<DDCompactView>(edm::ESInputTag());
 //                               "" /*optional module label */, CVtag_.c_str()));
 //
//      compactViewToken_(setWhatProduced(this, &PPSGeometryESProducer::produceIdealGD)
...
/*
      gdRealTokens_ = setWhatProduced(this, &PPSGeometryESProducer::produceRealGD);
      gdMisTokens_ = setWhatProduced(this, &PPSGeometryESProducer::produceMisalignedGD);
      dgdRealToken_ = setWhatProduced(this, &PPSGeometryESProducer::produceRealTG).consumes<DetGeomDesc>(edm::ESInputTag());
      dgdMisToken_ = setWhatProduced(this, &PPSGeometryESProducer::produceMisalignedTG).consumes<DetGeomDesc>(edm::ESInputTag());
*/
}
...
void PPSGeometryESProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  descriptions.add("DoodadESSourceDD4hep", desc);
}
