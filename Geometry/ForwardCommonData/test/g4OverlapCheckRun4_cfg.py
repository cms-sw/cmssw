###############################################################################
# Way to use this:
#   cmsRun g4OverlapCheck_cfg.py type=D120 tol=0.01 resol=10000
#
#   Options for type  D120, D122, D123, D124
...
options.register('type',
                 "D120",
                  ...
                  "type of operations: D120, D122, D123, D124")
...
####################################################################
# Use the options
geomFile = "Geometry.ForwardCommonData.cmsExtendedGeometryRun4" + options.type + "XML_cfi"
outFile = "cms" + options.type + str(options.tol)
