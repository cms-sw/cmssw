...
DTNumberingScheme::DTNumberingScheme(const MuonConstants& muonConstants) { initMe(muonConstants); }
...
const int DTNumberingScheme::get(const char* key, const MuonConstants& muonConstants) const {
  int result(0);
