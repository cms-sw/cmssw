...
public:
  ...
  inline void pixelRange(unsigned int arow,
                         unsigned int acol,
                         double& lower_x,
                         double& higher_x,
                         double& lower_y,
...
private:
  ...
  inline unsigned int row(double x) const {
    ...
    if (x <= (dead_edge_width_ + pitch_simX_))
      arow = 0;
    else if (x <= (dead_edge_width_ + 79 * pitch_simX_))
      arow = int((x - dead_edge_width_ - pitch_simX_) / pitch_simX_) + 1;
    else if (x <= (dead_edge_width_ + 81 * pitch_simX_))
      arow = 79;
    else if (x <= (dead_edge_width_ + 83 * pitch_simX_))
      arow = 80;
    else if (x <= (dead_edge_width_ + 162 * pitch_simX_))
      arow = int((x - dead_edge_width_ - pitch_simX_) / pitch_simX_) - 1;
    else
      arow = 159;
  ...
  inline unsigned int col(double y) const {
    ...
    if (y <= (dead_edge_width_ + pitch_simY_))
      column = 0;
    else if (y <= (dead_edge_width_ + 51 * pitch_simY_))
      column = int((y - dead_edge_width_ - pitch_simY_) / pitch_simY_) + 1;
    else if (y <= (dead_edge_width_ + 53 * pitch_simY_))
      column = 51;
    else if (y <= (dead_edge_width_ + 55 * pitch_simY_))
      column = 52;
    else if (y <= (dead_edge_width_ + 105 * pitch_simY_))
      column = int((y - dead_edge_width_ - pitch_simY_) / pitch_simY_) - 1;
    else if (y <= (dead_edge_width_ + 107 * pitch_simY_))
      column = 103;
    else if (y <= (dead_edge_width_ + 109 * pitch_simY_))
      column = 104;
    else if (y <= (dead_edge_width_ + 159 * pitch_simY_))
