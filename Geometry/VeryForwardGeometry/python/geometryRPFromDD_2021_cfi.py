...
totemGeomXMLFiles = cms.vstring(
    ...
    'Geometry/VeryForwardData/data/2021/RP_220_Right_Station.xml',
    'Geometry/VeryForwardData/data/2021/RP_220_Left_Station.xml',
...
ctppsDiamondGeomXMLFiles = cms.vstring(
    ...
    'Geometry/VeryForwardData/data/2021/CTPPS_Timing_Stations_Assembly.xml',
