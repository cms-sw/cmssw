...
process.prodBar = cms.EDAnalyzer("FastTimeGeometryTester",
                                 Detector   = cms.string("FastTimeBarrel"),
)

process.prodEnd = process.prodBar.clone(
    Detector   = "SFBX",
)

process.p1 = cms.Path(process.generator*process.prodBar*process.prodEnd)
