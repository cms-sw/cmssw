...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring(
        ...
        'Geometry/TrackerCommonData/data/FlatPlus10Percent/2017/trackermaterial.xml',
        'Geometry/TrackerCommonData/data/FlatPlus10Percent/2017/pixfwdMaterials.xml',
        'Geometry/TrackerCommonData/data/FlatPlus10Percent/2017/pixbarmaterial.xml', 
        'Geometry/TrackerCommonData/data/FlatPlus10Percent/2017/tibtidcommonmaterial.xml',
        'Geometry/TrackerCommonData/data/FlatPlus10Percent/2017/tibmaterial.xml',
        'Geometry/TrackerCommonData/data/FlatPlus10Percent/2017/tidmaterial.xml',
        'Geometry/TrackerCommonData/data/FlatPlus10Percent/2017/tobmaterial.xml',
        'Geometry/TrackerCommonData/data/FlatPlus10Percent/2017/tecmaterial.xml',
        ...
        'Geometry/TrackerCommonData/data/PhaseI/v0/pixbarladder.xml', 
        'Geometry/TrackerCommonData/data/PhaseI/v0/pixbarladderfull0.xml', 
        'Geometry/TrackerCommonData/data/PhaseI/v0/pixbarladderfull1.xml', 
        'Geometry/TrackerCommonData/data/PhaseI/v0/pixbarladderfull2.xml', 
        'Geometry/TrackerCommonData/data/PhaseI/v0/pixbarladderfull3.xml', 
        'Geometry/TrackerCommonData/data/PhaseI/v0/pixbarlayer.xml', 
        'Geometry/TrackerCommonData/data/PhaseI/v0/pixbarlayer0.xml', 
        'Geometry/TrackerCommonData/data/PhaseI/v0/pixbarlayer1.xml', 
        'Geometry/TrackerCommonData/data/PhaseI/v0/pixbarlayer2.xml', 
        'Geometry/TrackerCommonData/data/PhaseI/v0/pixbarlayer3.xml', 
        'Geometry/TrackerCommonData/data/PhaseI/v0/pixbar.xml',
        ...
        'Geometry/HcalCommonData/data/hcalSimNumbering/2018/hcalSimNumbering.xml', 
        'Geometry/HcalCommonData/data/hcalRecNumbering/2018/hcalRecNumbering.xml', 
        ...
        'Geometry/MuonCommonData/data/rpcf/2015/v2/rpcf.xml',
