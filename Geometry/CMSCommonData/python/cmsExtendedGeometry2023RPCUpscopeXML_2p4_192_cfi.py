...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/MuonCommonData/data/upscope/2.4Eta/mf.xml',
        'Geometry/MuonCommonData/data/upscope/2.4Eta/rpcf.xml',
        ...
        'Geometry/MuonCommonData/data/upscope/2.4Eta/muonNumbering.xml',
        ...
        'Geometry/RPCGeometryBuilder/data/upscope/192strips/RPCSpecs.xml',
