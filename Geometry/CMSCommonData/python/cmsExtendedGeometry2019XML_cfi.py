...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/MuonCommonData/data/mb1/2017/v1/mb1.xml',
        'Geometry/MuonCommonData/data/mb2/2017/v1/mb2.xml',
        'Geometry/MuonCommonData/data/mb3/2017/v1/mb3.xml',
        'Geometry/MuonCommonData/data/mb4/2017/v1/mb4.xml',
