...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/HGCalCommonData/data/v1/hgcal.xml',
        'Geometry/HGCalCommonData/data/v1/hgcalEE.xml',
        'Geometry/HGCalCommonData/data/v1/hgcalHEsil.xml',
        'Geometry/HGCalCommonData/data/v1/hgcalHEsci.xml',
        'Geometry/HGCalCommonData/data/v1/hgcalHEgem.xml',
        'Geometry/HGCalCommonData/data/v1/hgcalCons.xml',
