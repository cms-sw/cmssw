...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring(
        ...
        'Geometry/TrackerCommonData/data/FlatTracker/pixfwd.xml',
        'Geometry/TrackerCommonData/data/FlatTracker/pixbar.xml',
        'Geometry/TrackerCommonData/data/trackermaterial.xml',
        'Geometry/TrackerCommonData/data/FlatTracker/tracker.xml',
        'Geometry/TrackerCommonData/data/FlatTracker/pixel.xml',
        'Geometry/TrackerCommonData/data/FlatTracker/trackerbar.xml',
        'Geometry/TrackerCommonData/data/FlatTracker/trackerfwd.xml',
        'Geometry/TrackerCommonData/data/FlatTracker/trackerStructureTopology.xml',
        'Geometry/TrackerCommonData/data/FlatTracker/pixelStructureTopology.xml',
        'Geometry/TrackerSimData/data/FlatTracker/trackersens.xml',
        'Geometry/TrackerSimData/data/FlatTracker/pixelsens.xml',
        'Geometry/TrackerRecoData/data/FlatTracker/trackerRecoMaterial.xml',
        'Geometry/TrackerSimData/data/FlatTracker/trackerProdCuts.xml',
        'Geometry/TrackerSimData/data/FlatTracker/pixelProdCuts.xml',
