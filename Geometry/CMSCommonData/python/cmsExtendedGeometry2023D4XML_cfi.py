...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring(
        ...
        'Geometry/TrackerCommonData/data/TiltedTracker4026/pixfwd.xml',
        'Geometry/TrackerCommonData/data/TiltedTracker4026/pixbar.xml',
        'Geometry/TrackerCommonData/data/trackermaterial.xml',
        'Geometry/TrackerCommonData/data/TiltedTracker4026/tracker.xml',
        'Geometry/TrackerCommonData/data/TiltedTracker4026/pixel.xml',
        'Geometry/TrackerCommonData/data/TiltedTracker4026/trackerbar.xml',
        'Geometry/TrackerCommonData/data/TiltedTracker4026/trackerfwd.xml',
        'Geometry/TrackerCommonData/data/TiltedTracker4026/trackerStructureTopology.xml',
        'Geometry/TrackerCommonData/data/TiltedTracker4026/pixelStructureTopology.xml',
        'Geometry/TrackerSimData/data/TiltedTracker4026/trackersens.xml',
        'Geometry/TrackerSimData/data/TiltedTracker4026/pixelsens.xml',
        'Geometry/TrackerRecoData/data/TiltedTracker4026/trackerRecoMaterial.xml',
        'Geometry/TrackerSimData/data/TiltedTracker4026/trackerProdCuts.xml',
        'Geometry/TrackerSimData/data/TiltedTracker4026/pixelProdCuts.xml',
    ...
    cms.vstring(
        'Geometry/MuonCommonData/data/TDR_BaseLine/muonNumbering.xml',
        ...
        'Geometry/MuonSimData/data/ME0EtaPart/muonSens.xml',
