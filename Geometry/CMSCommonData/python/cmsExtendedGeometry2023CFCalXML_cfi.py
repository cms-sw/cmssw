...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/HGCalCommonData/data/cfc.xml',
        ...
        'Geometry/HGCalSimData/data/cfcsens.xml',
        'Geometry/HGCalSimData/data/cfccons.xml',
        ...
        'Geometry/HGCalSimData/data/cfcProdCuts.xml',
