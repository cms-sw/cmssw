...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring(
        ...
        'Geometry/EcalCommonData/data/ShortEE/eregalgo.xml',
        'Geometry/EcalCommonData/data/ebalgo.xml',
        'Geometry/EcalCommonData/data/ebcon.xml',
        'Geometry/EcalCommonData/data/ebrot.xml',
        'Geometry/EcalCommonData/data/eecon.xml',
        'Geometry/EcalCommonData/data/ShortEE/eefixed.xml',
        'Geometry/EcalCommonData/data/ShortEE/eehier.xml',
        ...
        'Geometry/MuonCommonData/data/TDR_Dev/me0.xml',
    ...
    cms.vstring(
        'Geometry/MuonCommonData/data/TDR_Dev/muonNumbering.xml',
