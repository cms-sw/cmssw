...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/TrackerCommonData/data/PhaseI/trackersens.xml', 
        'Geometry/TrackerCommonData/data/PhaseI/trackerRecoMaterial.xml', 
        ...
        'Geometry/TrackerCommonData/data/PhaseI/trackerProdCuts.xml', 
