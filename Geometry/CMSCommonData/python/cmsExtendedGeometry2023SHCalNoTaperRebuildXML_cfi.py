...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/HcalCommonData/data/PhaseII/Rebuild/hcalalgo.xml',
        'Geometry/HcalCommonData/data/hcalbarrelalgo.xml',
        'Geometry/HcalCommonData/data/hcalcablealgo.xml',
        'Geometry/HcalCommonData/data/PhaseII/Rebuild/hcalendcapalgo.xml', 
        'Geometry/HcalCommonData/data/hcalouteralgo.xml',
        'Geometry/HcalCommonData/data/hcalforwardalgo.xml',
        'Geometry/HcalCommonData/data/average/hcalforwardmaterial.xml',
        'Geometry/HcalCommonData/data/PhaseII/hcalSimNumberingRebuildHE.xml', 
        'Geometry/HcalCommonData/data/PhaseII/hcalRecNumberingRebuildHE.xml', 
        'Geometry/HGCalCommonData/data/NoTaper/shashlikmodule.xml',
        'Geometry/HGCalCommonData/data/NoTaper/shashliksupermodule.xml',
        'Geometry/HGCalCommonData/data/Rebuild/shashlik.xml',
