...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/MuonCommonData/data/upscope/v1/mf.xml',
        'Geometry/MuonCommonData/data/upscope/rpcf.xml',
        ...
        'Geometry/MuonCommonData/data/upscope/muonNumbering.xml',
        ...
        'Geometry/MuonSimData/data/upscope/muonSens.xml',
        'Geometry/DTGeometryBuilder/data/dtSpecsFilter.xml',
        'Geometry/CSCGeometryBuilder/data/cscSpecsFilter.xml',
        'Geometry/CSCGeometryBuilder/data/cscSpecs.xml',
        'Geometry/RPCGeometryBuilder/data/upscope/RPCSpecs.xml',
