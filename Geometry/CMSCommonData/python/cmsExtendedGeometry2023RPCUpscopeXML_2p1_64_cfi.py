...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/MuonCommonData/data/upscope/2.1Eta/mf.xml',
        'Geometry/MuonCommonData/data/upscope/2.1Eta/rpcf.xml',
        ...
        'Geometry/MuonCommonData/data/upscope/2.1Eta/muonNumbering.xml',
        ...
        'Geometry/RPCGeometryBuilder/data/upscope/64strips/RPCSpecs.xml',
