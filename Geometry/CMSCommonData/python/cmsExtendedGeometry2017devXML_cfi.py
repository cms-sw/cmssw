...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/CMSCommonData/data/Run2/v2/cms.xml',
        'Geometry/CMSCommonData/data/cmsMother.xml',
        'Geometry/CMSCommonData/data/eta3/etaMax.xml',
        'Geometry/CMSCommonData/data/cmsTracker.xml',
        'Geometry/CMSCommonData/data/Run2/caloBase.xml',
        'Geometry/CMSCommonData/data/cmsCalo.xml',
        'Geometry/CMSCommonData/data/Run2/muonBase.xml',
        ...
        'Geometry/CMSCommonData/data/Run2/cavern.xml',
        'Geometry/CMSCommonData/data/Run2/cavernData.xml',
        'Geometry/CMSCommonData/data/Run2/cavernFloor.xml',
        ...
        'Geometry/MuonCommonData/data/Run2/v2/mbCommon.xml',
        ...
        'Geometry/MuonCommonData/data/v3/mf.xml',
        ...
        'Geometry/ForwardCommonData/data/v3/forwardshield.xml',
