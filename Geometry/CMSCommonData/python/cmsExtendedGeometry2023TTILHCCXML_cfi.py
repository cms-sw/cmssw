...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/TrackerCommonData/data/PhaseII/Pixel10D_LHCC/tracker.xml',
        ...
        'Geometry/TrackerCommonData/data/PhaseII/Pixel10D_LHCC/trackerStructureTopology.xml',
        'Geometry/TrackerSimData/data/PhaseII/Pixel10D_LHCC/trackersens.xml',
        'Geometry/TrackerRecoData/data/PhaseII/Pixel10D_LHCC/trackerRecoMaterial.xml',
        ...
        'Geometry/TrackerSimData/data/PhaseII/Pixel10D_LHCC/trackerProdCuts.xml',
