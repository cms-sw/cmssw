...
void DDEcalPreshowerAlgo::doWedges()
{
  ...
  for(int I=1; I<=sz;++I) {
    ...
    for(int J=int(quadMax_[I-1]); J>=int(quadMin_[I-1]); --J) {
      ...
      // place the wedge
      DDpos(DDLogicalPart("esalgo:SWED"), parent(), icopy, DDTranslation(xpos,ypos,zpos), DDRotation("rotations:RM1299"));
      ...
      DDpos(DDLogicalPart("esalgo:SFBX"), parent(), icopy, DDTranslation(xpos,ypos,zpos), DDRotation("rotations:RM1298"));
  ...
  for(int I=sz; I>=1;--I) {
    ...
    for(int J=int(quadMax_[I-1]); J>=int(quadMin_[I-1]); --J) {
      ...
      DDpos(DDLogicalPart("esalgo:SWED"), parent(), icopy, DDTranslation(xpos,ypos,zpos), DDRotation("rotations:RM1303"));
      ...
      zpos = zlead1_ + zwedge_ceramic_diff;
      ypos = ypos - ywedge_ceramic_diff;
      DDpos(DDLogicalPart("esalgo:SFBX"), parent(), icopy, DDTranslation(xpos,ypos,zpos), DDRotation("rotations:RM1302"));
  ...
  for(int I=1; I<=sz;++I) {
    ...
    for(int J=int(quadMax_[I-1]); J>=int(quadMin_[I-1]); --J) {
      ...
      DDpos(DDLogicalPart("esalgo:SWED"), parent(), icopy+nx, DDTranslation(xpos,ypos,zpos), DDRotation("rotations:RM1301"));

      LogDebug("SFGeom")<<" debug : SWED, copy = "<< icopy+nx<<" Logical part "<<DDLogicalPart("esalgo:SWED")<<"translation "<<DDTranslation(xpos,ypos,zpos)<<" rotation "<<DDRotation("rotations:RM1301")<< endl;
      
      zpos = zlead2_ + zwedge_ceramic_diff;
      xpos = xpos + ywedge_ceramic_diff;
      DDpos(DDLogicalPart("esalgo:SFBY"), parent(), icopy, DDTranslation(xpos,ypos,zpos), DDRotation("rotations:RM1300"));
  ...
  for(int I=sz; I>=1;--I) {
    ...
    for(int J=int(quadMax_[I-1]); J>=int(quadMin_[I-1]); --J) {
      ...
      DDpos(DDLogicalPart("esalgo:SWED"), parent(), icopy+nx, DDTranslation(xpos,ypos,zpos), DDRotation("rotations:RM1305"));
      
      LogDebug("SFGeom")<<" debug : SWED, copy = "<< icopy+nx<<" Logical part "<<DDLogicalPart("esalgo:SWED")<<"translation "<<DDTranslation(xpos,ypos,zpos)<<" rotation "<<DDRotation("rotations:RM1305")<< endl;
      
      zpos = zlead2_ + zwedge_ceramic_diff;
      xpos = xpos - ywedge_ceramic_diff;
      DDpos(DDLogicalPart("esalgo:SFBY"), parent(), icopy, DDTranslation(xpos,ypos,zpos), DDRotation("rotations:RM1304"));
