...
////////////////////////////////////////////////////////////////////////////////
LocalPoint ProxyMTDTopology::localPosition(const MeasurementPoint &mp, const Topology::LocalTrackPred &trkPred) const {
...
////////////////////////////////////////////////////////////////////////////////
LocalError ProxyMTDTopology::localError(const MeasurementPoint &mp, const MeasurementError &me) const {
...
////////////////////////////////////////////////////////////////////////////////
int ProxyMTDTopology::channel(const LocalPoint &lp) const { return specificTopology().channel(lp); }
...
////////////////////////////////////////////////////////////////////////////////
std::pair<float, float> ProxyMTDTopology::pixel(const LocalPoint &lp) const { return specificTopology().pixel(lp); }

////////////////////////////////////////////////////////////////////////////////
std::pair<float, float> ProxyMTDTopology::pixel(const LocalPoint &lp, const Topology::LocalTrackAngles &dir) const {
  if (!this->surfaceDeformation())
...
////////////////////////////////////////////////////////////////////////////////
float ProxyMTDTopology::localX(const float mpX) const { return specificTopology().localX(mpX); }

////////////////////////////////////////////////////////////////////////////////
float ProxyMTDTopology::localX(const float mpX, const Topology::LocalTrackPred &trkPred) const {
  if (!this->surfaceDeformation())
...
////////////////////////////////////////////////////////////////////////////////
float ProxyMTDTopology::localY(const float mpY) const { return specificTopology().localY(mpY); }

////////////////////////////////////////////////////////////////////////////////
float ProxyMTDTopology::localY(const float mpY, const Topology::LocalTrackPred &trkPred) const {
  if (!this->surfaceDeformation())
...
SurfaceDeformation::Local2DVector ProxyMTDTopology::positionCorrection(const LocalPoint &pos,
  ...
  return this->surfaceDeformation()->positionCorrection(pos2D, dir, theLength, theWidth);
}
