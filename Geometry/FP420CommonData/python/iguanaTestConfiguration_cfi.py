...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml', 
        ...
        'Geometry/FP420CommonData/data/cmshps240.xml', 
        'Geometry/FP420CommonData/data/fp420.xml', 
        'Geometry/FP420CommonData/data/hps240.xml', 
        'Geometry/FP420CommonData/data/zzzrectangle.xml', 
        'Geometry/FP420CommonData/data/hhhrectangle.xml', 
        ...
        'Geometry/FP420SimData/data/hps240sens.xml', 
        'Geometry/FP420SimData/data/FP420ProdCuts.xml',
        'Geometry/FP420SimData/data/HPS240ProdCuts.xml'),
