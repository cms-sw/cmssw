...
process.load('Geometry.MTDTBCommonData.GeometryExtendedMTDTB2025Reco_DUTbehind_cff')
...
process.VtxSmeared.MinEta = 0.
process.VtxSmeared.MaxEta = 0.
process.VtxSmeared.MinPhi = 0.9075712110370513  # beam at 52 degrees wrt to normal to DUT surface
process.VtxSmeared.MaxPhi = 0.9075712110370513
process.VtxSmeared.BeamMeanX = 0.
process.VtxSmeared.BeamMeanY =  -91.01524204157639
...
process.generator = cms.EDProducer("FlatRandomEGunProducer",
    PGunParameters = cms.PSet(
        ...
        MinEta = cms.double(0.),
        MaxEta = cms.double(0.),
        MinPhi = cms.double(0.9075712110370513),  # beam at 52 degrees wrt to normal to DUT surface
        MaxPhi = cms.double(0.9075712110370513),
