...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
                               ...
                               'Geometry/HGCalTBCommonData/data/TB252/hgcal.xml',
                               'Geometry/HGCalTBCommonData/data/TB251/hgcalcell.xml',
                               'Geometry/HGCalTBCommonData/data/TB251/hgcalwafer.xml',
                               'Geometry/HGCalTBCommonData/data/TB252/hgcalPassive.xml',
                               'Geometry/HGCalTBCommonData/data/TB252/hgcalEE.xml',
                               'Geometry/HGCalTBCommonData/data/TB251/hgcalCons.xml',
                               'Geometry/HGCalTBCommonData/data/TB252/hgcalConsData.xml',
