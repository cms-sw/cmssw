...
void HGCalGeomParameters::loadSpecParsHexagon8(const DDFilteredView& fv, HGCalParameters& php) {
  ...
  if (php.waferMaskMode_ == siliconFileEE) {
    waferIndex_ = dbl_to_int(DDVectorGetter::get("WaferIndexEE"));
    waferTypes_ = dbl_to_int(DDVectorGetter::get("WaferTypesEE"));
    waferParts_ = dbl_to_int(DDVectorGetter::get("WaferPartialEE"));
    waferOrien_ = dbl_to_int(DDVectorGetter::get("WaferOrientEE"));
  } else if (php.waferMaskMode_ == siliconFileHE) {
    waferIndex_ = dbl_to_int(DDVectorGetter::get("WaferIndexHE"));
    waferTypes_ = dbl_to_int(DDVectorGetter::get("WaferTypesHE"));
    waferParts_ = dbl_to_int(DDVectorGetter::get("WaferPartialHE"));
    waferOrien_ = dbl_to_int(DDVectorGetter::get("WaferOrientHE"));
  }
...
void HGCalGeomParameters::loadSpecParsTrapezoid(const DDFilteredView& fv, HGCalParameters& php) {
  ...
  if (php.waferMaskMode_ == scintillatorFile) {
    tileIndx_ = dbl_to_int(DDVectorGetter::get("TileIndex"));
    tileType_ = dbl_to_int(DDVectorGetter::get("TileType"));
    tileSiPM_ = dbl_to_int(DDVectorGetter::get("TileSiPM"));
    tileHEX1_ = dbl_to_int(DDVectorGetter::get("TileHEX1"));
    tileHEX2_ = dbl_to_int(DDVectorGetter::get("TileHEX2"));
    tileHEX3_ = dbl_to_int(DDVectorGetter::get("TileHEX3"));
    tileHEX4_ = dbl_to_int(DDVectorGetter::get("TileHEX4"));
    tileRMin_ = DDVectorGetter::get("TileRMin");
    tileRMax_ = DDVectorGetter::get("TileRMax");
    rescale(tileRMin_, HGCalParameters::k_ScaleFromDDD);
    rescale(tileRMax_, HGCalParameters::k_ScaleFromDDD);
    tileRingMin_ = dbl_to_int(DDVectorGetter::get("TileRingMin"));
    tileRingMax_ = dbl_to_int(DDVectorGetter::get("TileRingMax"));
  }
