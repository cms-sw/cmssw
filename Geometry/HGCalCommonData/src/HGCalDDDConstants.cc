...
HGCalDDDConstants::HGCalDDDConstants(const HGCalParameters* hp, const std::string& name)
  ...
  if (waferHexagon6() || waferHexagon8()) {
    ...
    hgcell_ = waferHexagon8Calib() ? std::make_unique<HGCalCell>(2.0 * rmax_, hgpar_->nCellsFine_, hgpar_->nCellsCoarse_) : std::make_unique<HGCalCell>(2.0 * rmaxT_, hgpar_->nCellsFine_, hgpar_->nCellsCoarse_);
