...
std::pair<int, int> HGCalWaferMask::getTypeMode(const double& xpos,
  ...
  double dy2[corners] = {HGCalTypes::c75 * delY,
                         ...
                         -HGCalTypes::c75 * delY,
                         HGCalTypes::c00 * delY};
  double dx3[corners] = {c22 * delX,
                         HGCalTypes::c10 * delX,
                         c77 * delX,
                         -c22 * delX,
                         -HGCalTypes::c10 * delX,
                         -c77 * delX};
  double dy3[corners] = {-c88 * delY,
                         -c27 * delY,
                         c61 * delY,
                         c88 * delY,
                         c27 * delY,
                         -c61 * delY};
  double dx4[corners] = {c22 * delX,
                         -c77 * delX,
                         -HGCalTypes::c10 * delX,
                         -c22 * delX,
                         c77 * delX,
                         HGCalTypes::c10 * delX};
  double dy4[corners] = {c88 * delY,
                         c61 * delY,
                         -c27 * delY,
                         -c88 * delY,
                         -c61 * delY,
  ...
  double dy5[corners] = {HGCalTypes::c75 * delY,
                         ...
                         HGCalTypes::c00 * delY,
                         HGCalTypes::c75 * delY};
  double dx6[corners] = {-c77 * delX,
                         -HGCalTypes::c10 * delX,
                         -c22 * delX,
                         c77 * delX,
                         HGCalTypes::c10 * delX,
                         c22 * delX};
  double dy6[corners] = {c61 * delY,
                         -c27 * delY,
                         -c88 * delY,
                         -c61 * delY,
                         c27 * delY,
                         c88 * delY};
  double dx7[corners] = {-c22 * delX,
                         -HGCalTypes::c10 * delX,
                         -c77 * delX,
                         c22 * delX,
                         HGCalTypes::c10 * delX,
                         c77 * delX};
  double dy7[corners] = {c88 * delY,
                         c27 * delY,
                         -c61 * delY,
                         -c88 * delY,
                         -c27 * delY,
                         c61 * delY};
  double dx8[corners] = {c77 * delX,
                         HGCalTypes::c10 * delX,
                         c22 * delX,
                         -c77 * delX,
                         -HGCalTypes::c10 * delX,
                         -c22 * delX};
  double dy8[corners] = {-c61 * delY,
                         c27 * delY,
                         c88 * delY,
                         c61 * delY,
                         -c27 * delY,
                         -c88 * delY};
  double dx9[corners] = {-c22 * delX,
                         c77 * delX,
                         HGCalTypes::c10 * delX,
                         c22 * delX,
                         -c77 * delX,
                         -HGCalTypes::c10 * delX};
  double dy9[corners] = {-c88 * delY,
                         -c61 * delY,
                         c27 * delY,
                         c88 * delY,
                         c61 * delY,
...
std::vector<std::pair<double, double> > HGCalWaferMask::waferXY(const int& part,
  ...
  */
  ...
  double dx[48] = {HGCalTypes::c00 * delX,  HGCalTypes::c10 * delX,  HGCalTypes::c10 * delX,  HGCalTypes::c00 * delX,
                   ...
                   c22 * delX,  HGCalTypes::c10 * delX,  c77 * delX,  -c22 * delX,
                   -HGCalTypes::c10 * delX, -c77 * delX, c22 * delX,  -c77 * delX,
                   -HGCalTypes::c10 * delX, -c22 * delX, c77 * delX,  HGCalTypes::c10 * delX,
  ...
  double dy[48] = {-HGCalTypes::c10 * delY, -HGCalTypes::c50 * delY, HGCalTypes::c50 * delY,  HGCalTypes::c10 * delY,
                   ...
                   -c88 * delY, -c27 * delY, c61 * delY,  c88 * delY,
                   c27 * delY,  -c61 * delY, c88 * delY,  c61 * delY,
                   -c27 * delY, -c88 * delY, -c61 * delY, c27 * delY,
