...
std::pair<int, int> HGCalWaferMask::getTypeMode(const double& xpos,
  ...
  double dx2[corners] = {HGCalTypes::c50 * delX, -HGCalTypes::c50 * delX, -HGCalTypes::c10 * delX, -HGCalTypes::c50 * delX, HGCalTypes::c50 * delX, HGCalTypes::c10 * delX};
  double dy2[corners] = {HGCalTypes::c75 * delY, HGCalTypes::c75 * delY, 0.0, -HGCalTypes::c75 * delY, -HGCalTypes::c75 * delY, 0.0};
  double dx3[corners] = {HGCalTypes::c22 * delX, delX, HGCalTypes::c77 * delX, -HGCalTypes::c22 * delX, -delX, -HGCalTypes::c77 * delX};
  double dy3[corners] = {-HGCalTypes::c88 * delY, -HGCalTypes::c27 * delY, HGCalTypes::c61 * delY, HGCalTypes::c88 * delY, HGCalTypes::c27 * delY, -HGCalTypes::c61 * delY};
  double dx4[corners] = {HGCalTypes::c22 * delX, -HGCalTypes::c77 * delX, -delX, -HGCalTypes::c22 * delX, HGCalTypes::c77 * delX, HGCalTypes::c10 * delX};
  double dy4[corners] = {HGCalTypes::c88 * delY, HGCalTypes::c61 * delY, -HGCalTypes::c27 * delY, -HGCalTypes::c88 * delY, -HGCalTypes::c61 * delY, HGCalTypes::c27 * delY};
  double dx5[corners] = {-HGCalTypes::c50 * delX, -HGCalTypes::c10 * delX, -HGCalTypes::c50 * delX, HGCalTypes::c50 * delX, HGCalTypes::c10 * delX, HGCalTypes::c50 * delX};
  double dy5[corners] = {HGCalTypes::c75 * delY, 0.0, -HGCalTypes::c75 * delY, -HGCalTypes::c75 * delY, 0.0, HGCalTypes::c75 * delY};
  double dx6[corners] = {-HGCalTypes::c77 * delX, -HGCalTypes::c10 * delX, -HGCalTypes::c22 * delX, HGCalTypes::c77 * delX, HGCalTypes::c10 * delX, HGCalTypes::c22 * delX};
  double dy6[corners] = {HGCalTypes::c61 * delY, -HGCalTypes::c27 * delY, -HGCalTypes::c88 * delY, -HGCalTypes::c61 * delY, HGCalTypes::c27 * delY, HGCalTypes::c88 * delY};
