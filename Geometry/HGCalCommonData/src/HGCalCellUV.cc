...
std::pair<int32_t, int32_t> HGCalCellUV::HGCalCellUVFromXY0(double xloc, double yloc, int32_t placement, int32_t type, bool extend, bool debug) {
  ...
  if (debug) edm::LogVerbatim("HGCalGeom") << "HGCalCellUVFromXY0: Input " << xloc << ":" << yloc << ":" << extend << " Output " << isu << ":" << isv;
...
std::pair<int32_t, int32_t> HGCalCellUV::HGCalCellUVFromXY1(double xloc, double yloc, int32_t placement, int32_t type, bool extend, bool debug) {
  ...
  if (debug) edm::LogVerbatim("HGCalGeom") << "HGCalCellUVFromXY1: Input " << xloc << ":" << yloc << ":" << extend << " Output " << u << ":" << v;
...
std::pair<int32_t, int32_t> HGCalCellUV::HGCalCellUVFromXY3(double xloc, double yloc, int32_t placement, int32_t type, bool extend, bool debug) {
  ...
  if (debug) edm::LogVerbatim("HGCalGeom") << "HGCalCellUVFromXY3: Input " << xloc << ":" << yloc << ":" << extend << " Output " << iu << ":" << iv;
  return std::make_pair(u, v);
}
