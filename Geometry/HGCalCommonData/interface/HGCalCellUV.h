...
public:
  ...
  std::pair<int32_t, int32_t> HGCalCellUVFromXY0(
      double xloc, double yloc, int32_t placement, int32_t type, bool extend, bool debug);

  std::pair<int32_t, int32_t> HGCalCellUVFromXY1(
      double xloc, double yloc, int32_t placement, int32_t type, bool extend, bool debug);

  std::pair<int32_t, int32_t> HGCalCellUVFromXY2(
      double xloc, double yloc, int32_t placement, int32_t type, bool extend, bool debug);

  std::pair<int32_t, int32_t> HGCalCellUVFromXY3(
      double xloc, double yloc, int32_t placement, int32_t type, bool extend, bool debug);

private:
  std::pair<int32_t, int32_t> HGCalCellUVFromXY2(double xloc,
                                                 double yloc,
                                                 int ncell,
                                                 double cellX,
                                                 double cellY,
