...
class DDHGCalSiliconColdBox : public DDAlgorithm {
public:
  DDHGCalSiliconColdBox();
...
DDHGCalSiliconColdBox::DDHGCalSiliconColdBox() {
#ifdef EDM_ML_DEBUG
...
void DDHGCalSiliconColdBox::initialize(const DDNumericArguments& nArgs,
  ...
  rotmats_ = vsArgs["LayerRotm"];

#ifdef EDM_ML_DEBUG
  edm::LogVerbatim("HGCalGeom") << "HGRotCass zStart " << zMinBlock_ << " wafer width " << waferSize_ << " separations "
...
#ifdef EDM_ML_DEBUG
  edm::LogVerbatim("HGCalGeom") << "DDHGCalSiliconColdBox: NameSpace " << nameSpace_ << ":";
#endif
  cassette_.setParameter(cassettes_, cassetteShift_);
}

////////////////////////////////////////////////////////////////////
// DDHGCalSiliconColdBox methods...
////////////////////////////////////////////////////////////////////
void DDHGCalSiliconColdBox::execute(DDCompactView& cpv) {
#ifdef EDM_ML_DEBUG
...
void DDHGCalSiliconColdBox::constructLayers(const DDLogicalPart& module, DDCompactView& cpv) {
...
void DDHGCalSiliconColdBox::positionSensitive(const DDLogicalPart& glog, int layer, DDCompactView& cpv) {
...
void DDHGCalSiliconColdBox::positionPassive(const DDLogicalPart& glog,
  ...
  const auto& xyoff = geomTools_.shiftXY(layercenter, (waferSize_ + waferSepar_));
#ifdef EDM_ML_DEBUG
  edm::LogVerbatim("HGCalGeom") << "DDHGCalSiliconColdBox: PositionPassive Layer " << layer << " LayerCenter "
...
DEFINE_EDM_PLUGIN(DDAlgorithmFactory, DDHGCalSiliconColdBox, "hgcal:DDHGCalSiliconColdBox");
