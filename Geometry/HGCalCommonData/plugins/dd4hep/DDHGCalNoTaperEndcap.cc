...
#ifdef EDM_ML_DEBUG
  edm::LogVerbatim("HGCalGeom") << "Tilt Angle " << m_tiltAngle << " R " << HGCalDD4HepHelper::convert2mm(m_rMin) << ":" << HGCalDD4HepHelper::convert2mm(m_rMax) << " Offset " << HGCalDD4HepHelper::convert2mm(m_zoffset) << ":" << HGCalDD4HepHelper::convert2mm(m_xyoffset) << " Copy " << m_startCopyNo << ":" << m_incrCopyNo << " Child " << m_childName;
...
#ifdef EDM_ML_DEBUG
          edm::LogVerbatim("HGCalGeom") << "Module " << copyNo << ": location = (" << HGCalDD4HepHelper::convert2mm(offsetX) << "," << HGCalDD4HepHelper::convert2mm(offsetY) << "," << HGCalDD4HepHelper::convert2mm(offsetZ) << ") Rotation " << rotation;
#endif
...
#ifdef EDM_ML_DEBUG
          edm::LogVerbatim("HGCalGeom") << " (" << column << "," << row << "): offsetX,Y = " << HGCalDD4HepHelper::convert2mm(offsetX) << "," << HGCalDD4HepHelper::convert2mm(offsetY) << " is out of limit=" << HGCalDD4HepHelper::convert2mm(limit1) << ":" << HGCalDD4HepHelper::convert2mm(limit2) << " rMin, rMax = " << HGCalDD4HepHelper::convert2mm(m_rMin) << "," << HGCalDD4HepHelper::convert2mm(m_rMax);
#endif
        }
