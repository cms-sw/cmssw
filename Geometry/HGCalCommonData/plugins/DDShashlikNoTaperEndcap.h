#ifndef HGCalCommonData_DDShashlikNoTaperEndcap_h
#define HGCalCommonData_DDShashlikNoTaperEndcap_h
...
class DDShashlikNoTaperEndcap : public DDAlgorithm
{
public:
  DDShashlikNoTaperEndcap( void ); 
  virtual ~DDShashlikNoTaperEndcap( void );
