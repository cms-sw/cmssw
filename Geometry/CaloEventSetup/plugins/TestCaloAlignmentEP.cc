...
public:
  ...
  ReturnAli produceEEAli(const EEAlignmentRcd& /*iRecord*/) {
    ...
    for (unsigned int i(0); i != nA; ++i) {
      ...
      vtr.emplace_back(AlignTransform((2 > i ? Trl(-0.02, -0.81, -0.94) : Trl(+0.52, -0.81, +0.81)), Rot(), id));
    }
    return ali;
  }
  ...
  ReturnAli produceESAli(const ESAlignmentRcd& /*iRecord*/) {
    ...
    for (unsigned int i(0); i != nA; ++i) {
      ...
      vtr.emplace_back(AlignTransform((4 > i ? Trl(-0.02, -0.81, -0.94) : Trl(+0.52, -0.81, +0.81)), Rot(), id));
    }
    return ali;
  }
