...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring(
        ...
        'Geometry/CMSCommonData/data/cms/2030/v1/cms.xml',
        'Geometry/CMSCommonData/data/eta3/etaMax.xml',
        'Geometry/CMSCommonData/data/cmsMother.xml',
        'Geometry/CMSCommonData/data/cmsTracker.xml',
        'Geometry/CMSCommonData/data/caloBase/2030/v1/caloBase.xml',
        'Geometry/CMSCommonData/data/cmsCalo.xml',
        'Geometry/CMSCommonData/data/muonBase/2030/v2/muonBase.xml',
        ...
        'Geometry/EcalCommonData/data/eregalgo/2030/v1/eregalgo.xml',
        'Geometry/EcalCommonData/data/ebalgo.xml',
        'Geometry/EcalCommonData/data/ebcon.xml',
        'Geometry/EcalCommonData/data/ebrot.xml',
        'Geometry/EcalCommonData/data/eecon.xml',
        'Geometry/EcalCommonData/data/escon/2030/v1/escon.xml',
        'Geometry/EcalCommonData/data/esalgo/2030/v1/esalgo.xml',
        ...
        'Geometry/HcalCommonData/data/hcalSimNumbering/2030/hcalSimNumbering.xml',
        'Geometry/HcalCommonData/data/hcalRecNumbering/2030/hcalRecNumbering.xml',
        ...
        'Geometry/MuonCommonData/data/rpcf/2030/v1/rpcf.xml',
