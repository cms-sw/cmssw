...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring(
        ...
        'Geometry/MuonCommonData/data/mf/2026/v4/mf.xml',
        ...
        'Geometry/MuonCommonData/data/mfshield/2026/v2/mfshield.xml',
        'Geometry/MuonCommonData/data/ge0/TDR_Dev/v2/ge0.xml',
    ...
    cms.vstring(
        'Geometry/MuonCommonData/data/muonNumbering/TDR_DeV/v2/muonNumbering.xml',
        ...
        'Geometry/GEMGeometryBuilder/data/v9/GEMSpecsFilter.xml',
        'Geometry/GEMGeometryBuilder/data/v9/GEMSpecs.xml',
