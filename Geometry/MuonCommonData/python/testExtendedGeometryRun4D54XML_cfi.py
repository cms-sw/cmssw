...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring(
        ...
        'Geometry/CMSCommonData/data/beampipe/2030/v1/beampipe.xml',
        ...
        'Geometry/CMSCommonData/data/cms/2030/v3/cms.xml',
        'Geometry/CMSCommonData/data/caloBase/2030/v2/caloBase.xml',
        'Geometry/CMSCommonData/data/muonBase/2030/v3/muonBase.xml',
        ...
        'Geometry/EcalCommonData/data/ectkcablemat/2030/v1/ectkcablemat.xml',
        ...
        'Geometry/MuonCommonData/data/mf/2030/v2/mf.xml',
        'Geometry/MuonCommonData/data/rpcf/2030/v2/rpcf.xml',
        'Geometry/MuonCommonData/data/gemf/TDR_BaseLine/gemf.xml',
        'Geometry/MuonCommonData/data/gem11/TDR_BaseLine/gem11.xml',
        'Geometry/MuonCommonData/data/gem21/TDR_Eta16/gem21.xml',
        'Geometry/MuonCommonData/data/mfshield/2030/v1/mfshield.xml',
