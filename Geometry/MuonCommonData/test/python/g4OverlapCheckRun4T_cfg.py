###############################################################################
# Way to use this:
#   cmsRun g4OverlapCheckRun4T_cfg.py geometry=D110 tol=0.1
#
#   Options for geometry D110, D116, D126
...
options.register('geometry',
                 "D126",
                  ...
                  "geometry of operations: D110, D116, D126")
...
####################################################################
# Use the options
geomName = "Geometry.MuonCommonData.testExtendedGeometryRun4" + options.geometry + "XML_cfi"
baseName = "GeometryExtendedRun4" + options.geometry + str(options.tol)

print("Geometry file: ", geomName)
print("Base name:     ", baseName)

from Configuration.Eras.Modifier_phase2_common_cff import phase2_common
process = cms.Process('OverlapCheck',phase2_common)
