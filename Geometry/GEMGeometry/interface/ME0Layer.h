...
public:
  ...
  void add( const std::shared_ptr< ME0EtaPartition > roll);
  ...
  const std::shared_ptr< ME0EtaPartition > etaPartition(int isl) const;
...
private:
  ...
  std::vector< std::shared_ptr< ME0EtaPartition >> etaPartitions_;
