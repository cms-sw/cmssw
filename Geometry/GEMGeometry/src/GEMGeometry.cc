...
const std::vector<GEMRegion*>& GEMGeometry::regions() const {
  return allRegions;
}

const std::vector<GEMStation*>& GEMGeometry::stations() const {
  return allStations;
}

const std::vector<GEMRing*>& GEMGeometry::rings() const{
  return allRings;
}
