...
template <class T>
void CmsTrackerPhase2TPDiskBuilder<T>::buildComponent(T& fv, GeometricDet* g, const std::string& s) {
...
template <class T>
void CmsTrackerPhase2TPDiskBuilder<T>::sortNS(T& fv, GeometricDet* det) {
