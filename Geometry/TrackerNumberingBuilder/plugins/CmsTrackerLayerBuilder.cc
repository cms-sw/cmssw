...
void CmsTrackerLayerBuilder::sortNS(DDFilteredView& fv, GeometricDet* det){
  ...
  const std::function<double(const GeometricDet*)> extractPhiFunc{extractPhi};
  ...
  if(comp.front()->type()== GeometricDet::strng){
    ...
    TrackerStablePhiSort(extneg.begin(), extneg.end(), extractPhiFunc);
    TrackerStablePhiSort(extpos.begin(), extpos.end(), extractPhiFunc);
    TrackerStablePhiSort(intneg.begin(), intneg.end(), extractPhiFunc);
    TrackerStablePhiSort(intpos.begin(), intpos.end(), extractPhiFunc);
    ...
    TrackerStablePhiSort(neg.begin(), neg.end(), extractPhiFunc);
    TrackerStablePhiSort(pos.begin(), pos.end(), extractPhiFunc);
    ...
    TrackerStablePhiSort(comp.begin(), comp.end(), extractPhiFunc);
