...
TrackerTopologyEP::produce( const TrackerTopologyRcd& iRecord )
{
  ...
  // TEC: 6
  tecVals_.sideStartBit_ = ptp->vitems[6].vpars[0];
  tecVals_.wheelStartBit_ = ptp->vitems[6].vpars[1];
  tecVals_.petal_fw_bwStartBit_ = ptp->vitems[6].vpars[2];
  tecVals_.petalStartBit_ = ptp->vitems[6].vpars[3];
  tecVals_.ringStartBit_ = ptp->vitems[6].vpars[4];
  tecVals_.moduleStartBit_ = ptp->vitems[6].vpars[5];
  tecVals_.sterStartBit_ = ptp->vitems[6].vpars[6];
  tecVals_.sideMask_ = ptp->vitems[6].vpars[7];
  tecVals_.wheelMask_ = ptp->vitems[6].vpars[8];
  tecVals_.petal_fw_bwMask_ = ptp->vitems[6].vpars[9];
  tecVals_.petalMask_ = ptp->vitems[6].vpars[10];
  tecVals_.ringMask_ = ptp->vitems[6].vpars[11];
  tecVals_.moduleMask_ = ptp->vitems[6].vpars[12];
  tecVals_.sterMask_ = ptp->vitems[6].vpars[13];

  // TIB: 3
  tibVals_.layerStartBit_ = ptp->vitems[3].vpars[0];
  tibVals_.str_fw_bwStartBit_ = ptp->vitems[3].vpars[1];
  tibVals_.str_int_extStartBit_ = ptp->vitems[3].vpars[2];
  tibVals_.strStartBit_ = ptp->vitems[3].vpars[3];
  tibVals_.moduleStartBit_ = ptp->vitems[3].vpars[4];
  tibVals_.sterStartBit_ = ptp->vitems[3].vpars[5];
  tibVals_.layerMask_ = ptp->vitems[3].vpars[6];
  tibVals_.str_fw_bwMask_ = ptp->vitems[3].vpars[7];
  tibVals_.str_int_extMask_ = ptp->vitems[3].vpars[8];
  tibVals_.strMask_ = ptp->vitems[3].vpars[9];
  tibVals_.moduleMask_ = ptp->vitems[3].vpars[10];
  tibVals_.sterMask_ = ptp->vitems[3].vpars[11];

  // TID: 4
  tidVals_.sideStartBit_= ptp->vitems[4].vpars[0];
  tidVals_.wheelStartBit_= ptp->vitems[4].vpars[1];
  tidVals_.ringStartBit_= ptp->vitems[4].vpars[2];
  tidVals_.module_fw_bwStartBit_= ptp->vitems[4].vpars[3];
  tidVals_.moduleStartBit_= ptp->vitems[4].vpars[4];
  tidVals_.sterStartBit_= ptp->vitems[4].vpars[5];
  tidVals_.sideMask_= ptp->vitems[4].vpars[6];
  tidVals_.wheelMask_= ptp->vitems[4].vpars[7];
  tidVals_.ringMask_= ptp->vitems[4].vpars[8];
  tidVals_.module_fw_bwMask_= ptp->vitems[4].vpars[9];
  tidVals_.moduleMask_= ptp->vitems[4].vpars[10];
  tidVals_.sterMask_= ptp->vitems[4].vpars[11];
