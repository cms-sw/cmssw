...
TrackerTopologyEP::fillDescriptions( edm::ConfigurationDescriptions & descriptions ) 
{
  ...
  edm::ParameterSetDescription ttcslhc;
  ttcslhc.add<unsigned int>("pxb_layerStartBit",20);
  ttcslhc.add<unsigned int>("pxb_ladderStartBit",12);
  ttcslhc.add<unsigned int>("pxb_moduleStartBit",2);
  ttcslhc.add<unsigned int>("pxb_layerMask",0xF);
  ttcslhc.add<unsigned int>("pxb_ladderMask",0xFF);
  ttcslhc.add<unsigned int>("pxb_moduleMask",0x3FF);
  
  ttcslhc.add<unsigned int>("pxf_sideStartBit",23);
  ttcslhc.add<unsigned int>("pxf_diskStartBit",18);
  ttcslhc.add<unsigned int>("pxf_bladeStartBit",12); 
  ttcslhc.add<unsigned int>("pxf_panelStartBit",10);
  ttcslhc.add<unsigned int>("pxf_moduleStartBit",2);
  ttcslhc.add<unsigned int>("pxf_sideMask",0x3);
  ttcslhc.add<unsigned int>("pxf_diskMask",0xF);
  ttcslhc.add<unsigned int>("pxf_bladeMask",0x3F);
  ttcslhc.add<unsigned int>("pxf_panelMask",0x3);
  ttcslhc.add<unsigned int>("pxf_moduleMask",0xFF);
  
  ttcslhc.add<unsigned int>("tec_sideStartBit",18);
  ttcslhc.add<unsigned int>("tec_wheelStartBit",14);
  ttcslhc.add<unsigned int>("tec_petal_fw_bwStartBit",12);
  ttcslhc.add<unsigned int>("tec_petalStartBit",8);
  ttcslhc.add<unsigned int>("tec_ringStartBit",5);
  ttcslhc.add<unsigned int>("tec_moduleStartBit",2);
  ttcslhc.add<unsigned int>("tec_sterStartBit",0);  
  ttcslhc.add<unsigned int>("tec_sideMask",0x3);
  ttcslhc.add<unsigned int>("tec_wheelMask",0xF);
  ttcslhc.add<unsigned int>("tec_petal_fw_bwMask",0x3);
  ttcslhc.add<unsigned int>("tec_petalMask",0xF);
  ttcslhc.add<unsigned int>("tec_ringMask",0x7);  
  ttcslhc.add<unsigned int>("tec_moduleMask",0x7);
  ttcslhc.add<unsigned int>("tec_sterMask",0x3);
  
  ttcslhc.add<unsigned int>("tib_layerStartBit",14);
  ttcslhc.add<unsigned int>("tib_str_fw_bwStartBit",12);
  ttcslhc.add<unsigned int>("tib_str_int_extStartBit",10);
  ttcslhc.add<unsigned int>("tib_strStartBit",4);
  ttcslhc.add<unsigned int>("tib_moduleStartBit",2);
  ttcslhc.add<unsigned int>("tib_sterStartBit",0);
  ttcslhc.add<unsigned int>("tib_layerMask",0x7);
  ttcslhc.add<unsigned int>("tib_str_fw_bwMask",0x3);
  ttcslhc.add<unsigned int>("tib_str_int_extMask",0x3);
  ttcslhc.add<unsigned int>("tib_strMask",0x3F);
  ttcslhc.add<unsigned int>("tib_moduleMask",0x3);
  ttcslhc.add<unsigned int>("tib_sterMask",0x3);
  
  ttcslhc.add<unsigned int>("tid_sideStartBit",13); 
  ttcslhc.add<unsigned int>("tid_wheelStartBit",11);
  ttcslhc.add<unsigned int>("tid_ringStartBit",9);
  ttcslhc.add<unsigned int>("tid_module_fw_bwStartBit",7);
  ttcslhc.add<unsigned int>("tid_moduleStartBit",2);
  ttcslhc.add<unsigned int>("tid_sterStartBit",0);
  ttcslhc.add<unsigned int>("tid_sideMask",0x3);
  ttcslhc.add<unsigned int>("tid_wheelMask",0x3);
  ttcslhc.add<unsigned int>("tid_ringMask",0x3);
  ttcslhc.add<unsigned int>("tid_module_fw_bwMask",0x3);
