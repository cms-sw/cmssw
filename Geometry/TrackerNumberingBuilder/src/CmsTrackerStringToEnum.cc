...
// Ale
//  _map.insert(std::pair<std::string, GeometricDet::GeometricEnumType>("PixelPhase2Barrel",GeometricDet::PixelV4021Barrel));
//  _map.insert(std::pair<std::string, GeometricDet::GeometricEnumType>("PixelPhase2EndcapSubDet",GeometricDet::PixelV4021EndCap));
//  _map.insert(std::pair<std::string, GeometricDet::GeometricEnumType>("PixelPhase2EndcapFullDisk",GeometricDet::PixelPhase2FullDisk));
//  _map.insert(std::pair<std::string, GeometricDet::GeometricEnumType>("PixelPhase2EndcapReducedDisk",GeometricDet::PixelPhase2ReducedDisk));

  //  _map.insert(std::pair<std::string, GeometricDet::GeometricEnumType>("PixelPhase2PixelEndcapPanel",GeometricDet::panel));  
  //  _map.insert(std::pair<std::string, GeometricDet::GeometricEnumType>("PixelPhase2PixelEndcapStack",GeometricDet::DetUnit)); 
  ...
  //  _reverseMap.insert(std::pair<GeometricDet::GeometricEnumType, std::string>(GeometricDet::PixelV4021Barrel,"PixelBarrel"));
  //  _reverseMap.insert(std::pair<GeometricDet::GeometricEnumType, std::string>(GeometricDet::PixelV4021EndCap,"PixelEndCap"));
...
// Ale
//  _reverseMap.insert(std::pair<GeometricDet::GeometricEnumType, std::string>(GeometricDet::PixelPhase2PixelEndcapPanel,"Disk")); 
//  _reverseMap.insert(std::pair<GeometricDet::GeometricEnumType, std::string>(GeometricDet::PixelPhase2PixelEndcapStack,"Disk")); 
  //
  // done
  //
}
