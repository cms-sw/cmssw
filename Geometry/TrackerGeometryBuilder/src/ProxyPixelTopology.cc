...
////////////////////////////////////////////////////////////////////////////////
LocalError ProxyPixelTopology::localError(const MeasurementPoint &mp, const MeasurementError &me) const {
...
////////////////////////////////////////////////////////////////////////////////
int ProxyPixelTopology::channel(const LocalPoint &lp) const { return specificTopology().channel(lp); }
...
////////////////////////////////////////////////////////////////////////////////
std::pair<float, float> ProxyPixelTopology::pixel(const LocalPoint &lp) const { return specificTopology().pixel(lp); }

////////////////////////////////////////////////////////////////////////////////
std::pair<float, float> ProxyPixelTopology::pixel(const LocalPoint &lp, const Topology::LocalTrackAngles &dir) const {
  if (!this->surfaceDeformation())
...
////////////////////////////////////////////////////////////////////////////////
float ProxyPixelTopology::localX(const float mpX) const { return specificTopology().localX(mpX); }

////////////////////////////////////////////////////////////////////////////////
float ProxyPixelTopology::localX(const float mpX, const Topology::LocalTrackPred &trkPred) const {
  if (!this->surfaceDeformation())
...
////////////////////////////////////////////////////////////////////////////////
float ProxyPixelTopology::localY(const float mpY) const { return specificTopology().localY(mpY); }

////////////////////////////////////////////////////////////////////////////////
float ProxyPixelTopology::localY(const float mpY, const Topology::LocalTrackPred &trkPred) const {
  if (!this->surfaceDeformation())
