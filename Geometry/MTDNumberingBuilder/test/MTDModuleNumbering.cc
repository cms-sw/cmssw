...
void MTDModuleNumbering::fillModuleVariables(const GeometricDet* module,
                                             double& polarRadius,
                                             double& phiRad,
                                             double& z) {
  // module variables
...
void MTDModuleNumbering::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  edm::LogInfo("MTDModuleNumbering") << " Top node is  " << rDD.product() << " " << rDD.product()->name()
                                     << std::endl;
