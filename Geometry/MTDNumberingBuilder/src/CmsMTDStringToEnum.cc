...
CmsMTDStringToEnum::Impl::Impl() {
  ...
  _map.insert(
      std::pair<std::string, GeometricTimingDet::GeometricTimingEnumType>("Rod1", GeometricTimingDet::BTLTray));
  _map.insert(std::pair<std::string, GeometricTimingDet::GeometricTimingEnumType>("BModule",
  ...
  _map.insert(
      std::pair<std::string, GeometricTimingDet::GeometricTimingEnumType>("Ring", GeometricTimingDet::ETLRing));
  _map.insert(std::pair<std::string, GeometricTimingDet::GeometricTimingEnumType>("EModule",
