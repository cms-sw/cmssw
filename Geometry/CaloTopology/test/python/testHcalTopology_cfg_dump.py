...
process.HcalRecNumberingInitialization = cms.ESProducer('HcalDDDRecConstantsESModule',
                                                        appendToDataLabel = cms.string('')
)


process.HcalSimNumberingInitialization = cms.ESProducer('HcalDDDSimConstantsESModule',
                                                        appendToDataLabel = cms.string('')
)
