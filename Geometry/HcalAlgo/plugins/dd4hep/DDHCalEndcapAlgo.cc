...
struct HCalEndcapAlgo {
  ...
  HCalEndcapAlgo() {
    throw cms::Exception("HCalGeom") << "Wrong initialization to HcalEndcapAlgo";
  }
  ...
  void constructScintLayer(cms::DDNamespace& ns,
    ...
    dd4hep::Solid solid = dd4hep::Trap(0.5 * dz, 0, 0, yh, bl, tl, alp, yh, bl, tl, alp);
    ns.addSolidNS(ns.prepend(name), solid);
#ifdef EDM_ML_DEBUG
