...
#---------------
#modify Digi sequences to regenerate Trigger primitives for all subdetectors
#
process.load('Configuration/StandardSequences/Digi_cff')
#
process.simEcalTriggerPrimitiveDigis.Label = cms.string('mixData')
process.simEcalTriggerPrimitiveDigis.InstanceEB = cms.string('EBDigiCollectionDM')
process.simEcalTriggerPrimitiveDigis.InstanceEE = cms.string('EEDigiCollectionDM')
#
NewEcalDigiSequence = cms.Sequence(process.simEcalTriggerPrimitiveDigis+process.simEcalDigis)
process.calDigi.replace( process.ecalDigiSequence, NewEcalDigiSequence)

#
process.simHcalTriggerPrimitiveDigis.inputLabel = cms.VInputTag(cms.InputTag('mixData'),cms.InputTag('mixData'))


NewHcalDigiSequence = cms.Sequence(process.simHcalTriggerPrimitiveDigis+process.simHcalDigis)
process.calDigi.replace( process.hcalDigiSequence, NewHcalDigiSequence)
#
# This is all we need to do, digi-wise
#---------------
...
#
process.digitisation_step = cms.Path(process.calDigi)
