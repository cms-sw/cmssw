...
public:
  ...
  void addHcalPileups(const int bcr, const edm::EventPrincipal *,
                      unsigned int EventId, ModuleCallingContext const *);
...
private:
  ...
  edm::EDGetTokenT<HBHERecHitCollection>
      HBHERecHitToken_; // Token to retrieve information
  edm::EDGetTokenT<HORecHitCollection>
      HORecHitToken_; // Token to retrieve information
  edm::EDGetTokenT<HFRecHitCollection>
      HFRecHitToken_; // Token to retrieve information
  edm::EDGetTokenT<ZDCRecHitCollection>
      ZDCRecHitToken_; // Token to retrieve information

  edm::EDGetTokenT<HBHERecHitCollection>
      HBHERecHitPToken_; // Token to retrieve information
  edm::EDGetTokenT<HORecHitCollection>
      HORecHitPToken_; // Token to retrieve information
  edm::EDGetTokenT<HFRecHitCollection>
      HFRecHitPToken_; // Token to retrieve information
  edm::EDGetTokenT<ZDCRecHitCollection>
      ZDCRecHitPToken_; // Token to retrieve information
