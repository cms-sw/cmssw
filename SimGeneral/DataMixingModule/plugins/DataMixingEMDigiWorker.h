...
public:
  ...
  void addEMPileups(const int bcr, const edm::EventPrincipal *,
                    unsigned int EventId, const edm::EventSetup &ES,
...
private:
  ...
  edm::InputTag
      EBProducerSig_; // primary? name given to collection of EB calib digis
  edm::InputTag
      EEProducerSig_; // primary? name given to collection of EE calib digis
  edm::InputTag
      ESProducerSig_; // primary? name given to collection of ES calib digis
  ...
  edm::EDGetTokenT<EBDigiCollection>
      EBDigiToken_; // Token to retrieve information
  edm::EDGetTokenT<EEDigiCollection>
      EEDigiToken_; // Token to retrieve information
  edm::EDGetTokenT<ESDigiCollection>
      ESDigiToken_; // Token to retrieve information

  edm::EDGetTokenT<EBDigiCollection>
      EBDigiPileToken_; // Token to retrieve information
  edm::EDGetTokenT<EEDigiCollection>
      EEDigiPileToken_; // Token to retrieve information
  edm::EDGetTokenT<ESDigiCollection>
      ESDigiPileToken_; // Token to retrieve information
