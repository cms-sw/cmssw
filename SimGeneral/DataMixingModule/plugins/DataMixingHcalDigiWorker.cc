...
template <class DIGI>
void convertAdc2fChelper(const DIGI &digi, const HcalDbService &conditions,
                         CaloSamples &fC, const HcalDetId &id) {
...
template <class DIGI>
void convertAdc2fC(const DIGI &digi, const HcalDbService &conditions,
                   bool keepPedestals, CaloSamples &fC) {
...
void convertHcalDigis(const DIGIS &digis, const HcalDbService &conditions,
...
template <class DIGIS>
void buildHcalDigisHelper(DIGIS &digis, const DetId &formerID,
...
template <>
void buildHcalDigisHelper<QIE10DigiCollection>(
    QIE10DigiCollection &digis, const DetId &formerID,
    CaloSamples &resultSample, const HcalDbService &conditions) {
  // make new digi
...
template <>
void buildHcalDigisHelper<QIE11DigiCollection>(
    QIE11DigiCollection &digis, const DetId &formerID,
    CaloSamples &resultSample, const HcalDbService &conditions) {
  // make new digi
  digis.push_back(formerID.rawId());
...
template <class DIGIS>
std::unique_ptr<DIGIS> buildHcalDigis(const HcalDigiMap &map,
                                      const HcalDbService &conditions) {
...
DataMixingHcalDigiWorker::DataMixingHcalDigiWorker(const edm::ParameterSet &ps,
  ...
  HBHEdigiCollectionSig_ =
      ps.getParameter<edm::InputTag>("HBHEdigiCollectionSig");
  ...
  ZDCdigiCollectionSig_ =
      ps.getParameter<edm::InputTag>("ZDCdigiCollectionSig");
  QIE10digiCollectionSig_ =
      ps.getParameter<edm::InputTag>("QIE10digiCollectionSig");
  QIE11digiCollectionSig_ =
      ps.getParameter<edm::InputTag>("QIE11digiCollectionSig");
...
void DataMixingHcalDigiWorker::addHcalSignals(const edm::Event &e,
  ...
  LogInfo("DataMixingHcalDigiWorker")
      << "===============> adding MC signals for " << e.id();
  convertSignalHcalDigis<HBHEDigiCollection>(e, HBHEDigiToken_, *conditions,
                                             HBHEDigiStorage_);
  convertSignalHcalDigis<HODigiCollection>(e, HODigiToken_, *conditions,
                                           HODigiStorage_);
  convertSignalHcalDigis<HFDigiCollection>(e, HFDigiToken_, *conditions,
                                           HFDigiStorage_);
  convertSignalHcalDigis<QIE10DigiCollection>(e, QIE10DigiToken_, *conditions,
                                              QIE10DigiStorage_);
  convertSignalHcalDigis<QIE11DigiCollection>(e, QIE11DigiToken_, *conditions,
                                              QIE11DigiStorage_);
    ...
    if (ZDCDigis) {
      ...
      for (ZDCDigiCollection::const_iterator it = ZDCDigis->begin();
        ...
        const HcalQIEShape *shape =
            conditions->getHcalShape(channelCoder); // this one is generic
        HcalCoderDb coder(*channelCoder, *shape);
...
void DataMixingHcalDigiWorker::addHcalPileups(const int bcr,
  ...
  convertPileupHcalDigis<HBHEDigiCollection>(*ep, HBHEPileInputTag_, mcc,
                                             *conditions, HBHEDigiStorage_);
  convertPileupHcalDigis<HODigiCollection>(*ep, HOPileInputTag_, mcc,
                                           *conditions, HODigiStorage_);
  convertPileupHcalDigis<HFDigiCollection>(*ep, HFPileInputTag_, mcc,
                                           *conditions, HFDigiStorage_);
  convertPileupHcalDigis<QIE10DigiCollection>(*ep, QIE10PileInputTag_, mcc,
                                              *conditions, QIE10DigiStorage_);
  convertPileupHcalDigis<QIE11DigiCollection>(*ep, QIE11PileInputTag_, mcc,
                                              *conditions, QIE11DigiStorage_);
  ...
  if (DoZDC_) {
    ...
    if (ZDCDigisPTR) {
      ...
      const ZDCDigiCollection *ZDCDigis =
          const_cast<ZDCDigiCollection *>(ZDCDigisPTR->product());
...
void DataMixingHcalDigiWorker::putHcal(edm::Event &e,
  ...
  std::unique_ptr<HBHEDigiCollection> HBHEdigis =
      buildHcalDigis<HBHEDigiCollection>(HBHEDigiStorage_, *conditions);
  std::unique_ptr<HODigiCollection> HOdigis =
      buildHcalDigis<HODigiCollection>(HODigiStorage_, *conditions);
  std::unique_ptr<HFDigiCollection> HFdigis =
      buildHcalDigis<HFDigiCollection>(HFDigiStorage_, *conditions);
  ...
  for (ZDCDigiMap::const_iterator iZDC = ZDCDigiStorage_.begin();
    ...
    iZDCchk = iZDC;
    if ((++iZDCchk) ==
        ZDCDigiStorage_.end()) { // make sure not to lose the last one
      // make new digi
