...
public:
  ...
  void addMuonPileups(const int bcr, const edm::EventPrincipal *,
...
private:
  ...
  edm::InputTag
      DTdigi_collectionSig_; // secondary name given to collection of DT digis
  edm::InputTag
      RPCdigi_collectionSig_; // secondary name given to collection of RPC digis
  edm::InputTag
      CSCDigiTagSig_;          // primary? name given to collection of CSC digis
  edm::InputTag DTDigiTagSig_; // primary? name given to collection of DT digis
  edm::InputTag
      RPCDigiTagSig_; // primary? name given to collection of RPC digis
  ...
  edm::EDGetTokenT<DTDigiCollection>
      DTDigiToken_; // Token to retrieve information
  edm::EDGetTokenT<CSCStripDigiCollection>
      CSCStripDigiToken_; // Token to retrieve information
  edm::EDGetTokenT<CSCWireDigiCollection>
      CSCWireDigiToken_; // Token to retrieve information
  edm::EDGetTokenT<CSCComparatorDigiCollection>
      CSCCompDigiToken_; // Token to retrieve information
  edm::EDGetTokenT<RPCDigiCollection>
      RPCDigiToken_; // Token to retrieve information

  edm::EDGetTokenT<DTDigiCollection>
      DTDigiPToken_; // Token to retrieve information
  edm::EDGetTokenT<CSCStripDigiCollection>
      CSCStripDigiPToken_; // Token to retrieve information
  edm::EDGetTokenT<CSCWireDigiCollection>
      CSCWireDigiPToken_; // Token to retrieve information
  edm::EDGetTokenT<CSCComparatorDigiCollection>
      CSCCompDigiPToken_; // Token to retrieve information
  edm::EDGetTokenT<RPCDigiCollection>
      RPCDigiPToken_; // Token to retrieve information

  std::string DTDigiCollectionDM_; // secondary name to be given to new DT digis
  std::string
      RPCDigiCollectionDM_; // secondary name to be given to new RPC digis
  ...
  std::string CSCWireDigiCollectionDM_;  // secondary name given to new
                                         // collection of CSC wire digis
  std::string
      CSCComparatorDigiCollectionDM_; // secondary name given to new collection
