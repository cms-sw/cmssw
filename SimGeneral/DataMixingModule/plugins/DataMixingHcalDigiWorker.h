...
private:
  ...
  // Hcal
  edm::InputTag
      HBHEdigiCollectionSig_; // secondary name given to collection of digis
  edm::InputTag
      HOdigiCollectionSig_; // secondary name given to collection of digis
  edm::InputTag
      HFdigiCollectionSig_; // secondary name given to collection of digis
  edm::InputTag
      ZDCdigiCollectionSig_; // secondary name given to collection of digis
  edm::InputTag
      QIE10digiCollectionSig_; // secondary name given to collection of digis
  edm::InputTag
      QIE11digiCollectionSig_; // secondary name given to collection of digis
  ...
  edm::EDGetTokenT<HBHEDigiCollection>
      HBHEDigiToken_; // Token to retrieve information
  edm::EDGetTokenT<HODigiCollection>
      HODigiToken_; // Token to retrieve information
  edm::EDGetTokenT<HFDigiCollection>
      HFDigiToken_; // Token to retrieve information
  edm::EDGetTokenT<ZDCDigiCollection>
      ZDCDigiToken_; // Token to retrieve information
  edm::EDGetTokenT<QIE10DigiCollection>
      QIE10DigiToken_; // Token to retrieve information
  edm::EDGetTokenT<QIE11DigiCollection>
      QIE11DigiToken_; // Token to retrieve information

  edm::EDGetTokenT<HBHEDigiCollection>
      HBHEDigiPToken_; // Token to retrieve information
  edm::EDGetTokenT<HODigiCollection>
      HODigiPToken_; // Token to retrieve information
  edm::EDGetTokenT<HFDigiCollection>
      HFDigiPToken_; // Token to retrieve information
  edm::EDGetTokenT<ZDCDigiCollection>
      ZDCDigiPToken_; // Token to retrieve information
  edm::EDGetTokenT<QIE10DigiCollection>
      QIE10DigiPToken_; // Token to retrieve information
  edm::EDGetTokenT<QIE11DigiCollection>
      QIE11DigiPToken_; // Token to retrieve information
