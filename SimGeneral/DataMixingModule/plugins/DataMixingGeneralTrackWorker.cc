...
DataMixingGeneralTrackWorker::DataMixingGeneralTrackWorker(
  ...
  GeneralTrackLabelSig_ =
      ps.getParameter<edm::InputTag>("GeneralTrackLabelSig");

  GeneralTrackPileInputTag_ =
      ps.getParameter<edm::InputTag>("GeneralTrackPileInputTag");
  ...
  GTrackPileToken_ =
      iC.consumes<reco::TrackCollection>(GeneralTrackPileInputTag_);
}
...
void DataMixingGeneralTrackWorker::addGeneralTrackSignals(const edm::Event &e) {
  ...
  NewTrackList_ =
      std::unique_ptr<reco::TrackCollection>(new reco::TrackCollection());
...
void DataMixingGeneralTrackWorker::addGeneralTrackPileups(
  ...
  if (inputPTR) {
    ...
    const reco::TrackCollection *tracks =
        const_cast<reco::TrackCollection *>(inputPTR->product());
...
void DataMixingGeneralTrackWorker::putGeneralTrack(edm::Event &e) {
  ...
  LogInfo("DataMixingGeneralTrackWorker")
