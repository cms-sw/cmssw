...
private:
  ...
  edm::InputTag
      EBProducerSig_; // primary? name given to collection of EB calib rechits
  edm::InputTag
      EEProducerSig_; // primary? name given to collection of EE calib rechits
  edm::InputTag
      ESProducerSig_; // primary? name given to collection of ES calib rechits
  ...
  edm::InputTag
      EBPileRecHitInputTag_; // full InputTag for pileup EB calib rechits
  edm::InputTag
      EEPileRecHitInputTag_; // full InputTag for pileup EE calib rechits
  edm::InputTag
      ESPileRecHitInputTag_; // full InputTag for pileup ES calib rechits

  edm::EDGetTokenT<EBRecHitCollection>
      EBRecHitToken_; // Token to retrieve information
  edm::EDGetTokenT<EERecHitCollection>
      EERecHitToken_; // Token to retrieve information
  edm::EDGetTokenT<ESRecHitCollection>
      ESRecHitToken_; // Token to retrieve information

  edm::EDGetTokenT<EBRecHitCollection>
      EBPileRecHitToken_; // Token to retrieve information
  edm::EDGetTokenT<EERecHitCollection>
      EEPileRecHitToken_; // Token to retrieve information
  edm::EDGetTokenT<ESRecHitCollection>
      ESPileRecHitToken_; // Token to retrieve information
