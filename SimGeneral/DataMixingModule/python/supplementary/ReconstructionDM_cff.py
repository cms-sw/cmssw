...
highlevelreco = cms.Sequence(recoJetAssociations*tautagging*egammarecoFull*reducedEcalRecHitsSequence*btagging*particleFlowReco*recoPFJets*recoPFMET*PFTau)
#emergency sequence wo conversions
highlevelreco_woConv = cms.Sequence(recoJetAssociations*tautagging*egammareco_woConvPhotons*reducedEcalRecHitsSequence*btagging*particleFlowReco*recoPFJets*recoPFMET*PFTau)
