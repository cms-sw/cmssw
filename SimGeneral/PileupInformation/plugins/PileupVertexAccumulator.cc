...
//
/**\class PileupVertexAccumulator PileupVertexAccumulator.cc
 SimTracker/PileupVertexAccumulator/src/PileupVertexAccumulator.cc
...
PileupVertexAccumulator::PileupVertexAccumulator(
    const edm::ParameterSet &iConfig, edm::ProducerBase &mixMod,
...
void PileupVertexAccumulator::initializeEvent(edm::Event const &e,
  ...
  // Make sure that the first crossing processed starts indexing the minbias
  // events from zero.
...
void PileupVertexAccumulator::accumulate(edm::Event const &iEvent,
                                         edm::EventSetup const &iSetup) {
...
void PileupVertexAccumulator::finalizeEvent(edm::Event &iEvent,
                                            const edm::EventSetup &iSetup) {

  std::unique_ptr<PileupVertexContent> PUVtxC(
      new PileupVertexContent(pT_Hats_, z_posns_, t_posns_));
