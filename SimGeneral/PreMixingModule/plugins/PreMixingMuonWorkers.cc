...
namespace edm {
  ...
  public:
    PreMixingMuonWorker(const edm::ParameterSet& ps, edm::ProducerBase& producer, edm::ConsumesCollector&& iC): PreMixingMuonWorker(ps, producer, iC) {}
  ...
  template <typename DigiCollection>
  PreMixingMuonWorker<DigiCollection>::PreMixingMuonWorker(const edm::ParameterSet& ps, edm::ProducerBase& producer, edm::ConsumesCollector& iC):
...
DEFINE_EDM_PLUGIN(PreMixingWorkerFactory, edm::PreMixingDTWorker , "PreMixingDTWorker");
DEFINE_EDM_PLUGIN(PreMixingWorkerFactory, edm::PreMixingCSCWorker, "PreMixingCSCWorker");
DEFINE_EDM_PLUGIN(PreMixingWorkerFactory, edm::PreMixingRPCWorker, "PreMixingRPCWorker");
