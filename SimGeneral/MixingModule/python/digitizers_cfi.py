...
_phase2_timing_layer_new_fastTimingLayer = mtdDigitizer.clone()
phase2_timing_layer_new.toReplaceWith( theDigitizers.fastTimingLayer, _phase2_timing_layer_new_fastTimingLayer )
