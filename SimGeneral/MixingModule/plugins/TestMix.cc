...
// Get input
   ...
   // test getSignal
    std::cout<<"\n\n=================== Starting tests of signal and pileup getters  ==================="<<std::endl;
   const std::vector<SimTrack> *vTracks;
   cf->getSignal("",vTracks);
   std::cout<<"There are "<<vTracks->size()<<" SimTracks "<<std::endl;
