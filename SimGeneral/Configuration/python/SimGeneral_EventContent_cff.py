...
def _modifyDigitizerContentForHGCal( obj ):
...
eras.phase2_hgcal.toModify( SimGeneralRAW, func=_modifyDigitizerContentForHGCal )
eras.phase2_hgcal.toModify( SimGeneralFEVTDEBUG, func=_modifyDigitizerContentForHGCal )
eras.phase2_hgcal.toModify( SimGeneralRECO, func=_modifyDigitizerContentForHGCal )
