...
//                                            EB     HB     EE     HE      HO,
//                                            HF
const double Zmin[kNumberCalorimeter] = {0.000,  0.000, 317.2,
                                         391.95, 0.000, 1110.0}; // in cm
const double Zmax[kNumberCalorimeter] = {317.0,  433.2, 399.1,
                                         554.10, 661.0, 1275.0};
const double Rmin[kNumberCalorimeter] = {123.8, 177.5, 31.6, 31.6, 382.0, 12.5};
const double Rmax[kNumberCalorimeter] = {177.5, 287.7, 171.1,
                                         263.9, 407.0, 140.0};

const double EtaMin[kNumberCalorimeter] = {0.000, 0.000, 1.479,
                                           1.479, 0.000, 3.000};
const double EtaMax[kNumberCalorimeter] = {1.479, 1.479, 3.000,
                                           3.000, 1.262, 5.000};
...
const double rMoliere[kNumberCalorimeter] = {2.19, 2.19, 2.19,
                                             2.19, 2.19, 1.72}; // in cm
const double radLength[kNumberCalorimeter] = {0.89, 1.49, 0.89,
                                              1.49, 1.49, 1.76}; // in cm
const double intLength[kNumberCalorimeter] = {22.4,  16.42, 22.4,
                                              16.42, 16.42, 16.77}; // in cm
const double Z[kNumberCalorimeter] = {68.36, 68.36, 68.36,
                                      68.36, 68.36, 55.845}; // mass of molicule
...
const double pion_correl_hadem[5] = {-7.3137e-01, 1.2367e-01, -8.5607e-01,
                                     1.0989e+00, -1.2858e-02};

// pion longitudinal parameters

const double pion_par[8 * NPar][5] = {
    {4.4600e-01, 9.8040e-02, 1.4319e+00, 2.3920e+00,
     5.8971e-02}, // Mean Ecal ShowerType1
    ...
    {1.6324e+00, 1.1370e+00, 3.0111e-01, 4.4501e+00,
     -2.5984e-01}, // Mean Hcal ShowerType1
    ...
    {3.5029e+00, 5.5470e+00, 1.5174e-01, 3.9215e+00,
     -7.5815e-01}, // Mean Hcal ShowerType2
    ...
    {4.0761e-01, 5.0999e-02, 1.7222e+00, 2.1085e+00,
     5.4258e-02}, // Mean Hcal ShowerType3
    ...
    {3.6152e-02, 1.5236e-01, -5.4226e-01, 3.4917e+00,
     3.1429e-02}, // Sigma Ecal ShowerType1
    ...
    {2.7662e-01, 5.6892e-02, -1.0211e+00, 1.5592e+00,
     -2.0545e-02}, // Sigma Hcal ShowerType1
    ...
    {5.6503e-01, 3.2484e-01, -6.8870e-01, -9.6941e-01,
     -2.4937e-02}, // Sigma Hcal ShowerType2
    ...
    {2.5595e-01, 2.0105e-02, -1.7804e+00, 2.6746e+00,
     -2.6966e-02}, // Sigma Hcal ShowerType3
...
const double pion_rho[8 * NPar][5] = {
    {1.2318e-01, 3.0000e-01, 8.8725e-01, 1.6928e+00,
     0.0000e+00}, // Ecal ShowerType1
    ...
    {4.2393e-01, 2.7909e-01, 9.2577e-01, 2.7916e+00,
     -6.8012e-02}, // Hcal ShowerType1
    ...
    {3.0277e-01, 2.1400e-01, 1.2867e+00, 2.3086e+00,
     -8.7281e-02}, // Hcal ShowerType2
    ...
    {3.0154e-01, 3.6790e-01, 7.5730e-01, 1.7676e+00,
     -9.7870e-02}, // Hcal ShowerType3
...
const double pion_rpar[4 * Nrpar][5] = {
    {1.7239e+00, 9.3646e-01, -7.6784e-01, 1.6319e+00,
     0.0000e+00}, // Ecal for showerType = 1
    ...
    {2.0617e+01, 2.1354e+00, -1.3979e+00, 2.4424e+00,
     -2.0928e+00}, // Hcal for showerType = 1
    ...
    {1.3184e+01, 5.3308e+00, -6.5926e-01, 1.4287e+00,
     -9.1948e-01}, // Hcal for showerType = 2
    ...
    {9.0230e-01, 8.7071e-01, -5.9984e-01, 2.7973e+00,
     2.4553e-01}, // Hcal for showerType = 3
...
const double pro_correl_hadem[5] = {-6.7711e-01, 2.5760e-01, -4.9826e-01,
                                    3.4791e-01, 0.0000e+00};

// proton longitudinal parameters

const double pro_par[8 * NPar][5] = {
    {3.5805e-01, 8.2073e-02, 2.4040e+00, 2.8935e+00,
     7.1200e-02}, // Mean Ecal ShowerType1
    ...
    {1.5450e+00, 1.1047e+00, 2.9732e-01, 4.5325e+00,
     -2.4096e-01}, // Mean Hcal ShowerType1
    ...
    {3.9185e+00, 6.1651e+00, 1.4738e-01, 4.2079e+00,
     -8.1423e-01}, // Mean Hcal ShowerType2
    ...
    {1.9666e+00, 3.0810e+00, 1.7874e-01, 3.2441e+00,
     -4.4566e-01}, // Mean Hcal ShowerType3
    ...
    {7.9984e-02, 1.0177e-01, -4.9195e-01, 3.6549e+00,
     1.3986e-02}, // Sigma Ecal ShowerType1
    ...
    {2.3330e-01, 8.3848e-02, -1.4841e+00, 1.6539e+00,
     -8.9738e-03}, // Sigma Hcal ShowerType1
    ...
    {2.3378e-01, 8.4699e-02, -1.2727e+00, 1.3170e+00,
     -9.0939e-03}, // Sigma Hcal ShowerType2
    ...
    {2.3064e+00, 2.1994e+00, -2.4570e-01, -6.2275e+00,
     -6.5378e-03}, // Sigma Hcal ShowerType3
...
const double pro_rho[8 * NPar][5] = {
    {1.9717e+00, 6.6780e+00, 1.4425e-01, 2.2917e+00,
     -8.1369e-01}, // Ecal ShowerType1
    ...
    {2.8900e-01, 1.9972e-01, 1.3997e+00, 2.8253e+00,
     -3.0914e-02}, // Hcal ShowerType1
    ...
    {1.1195e-01, 1.1879e-01, 2.9551e+00, 1.9034e+00,
     -2.0542e-02}, // Hcal ShowerType2
    ...
    {1.4812e-01, 3.7207e-01, 6.7394e-01, 1.6932e+00,
     -8.9577e-02}, // Hcal ShowerType3
...
const double pro_rpar[4 * Nrpar][5] = {
    {2.0473e+01, 1.8293e+01, -2.7258e-03, -1.4304e+03,
     -2.7740e-01}, // Ecal for showerType = 1
    ...
    {2.0252e+01, 1.6754e+00, -3.3596e+00, 2.1412e+00,
     -2.1051e+00}, // Hcal for showerType = 1
    ...
    {1.2771e+01, 2.8591e+00, -7.5931e-01, 1.5374e+00,
     -1.2623e+00}, // Hcal for showerType = 2
    ...
    {-4.8143e+00, 1.0479e+01, -2.1974e-01, 3.0933e+00,
     2.0855e+00}, // Hcal for showerType = 3
...
const double pbar_correl_hadem[5] = {-5.8253e-01, 3.6344e-01, -4.6371e-01,
                                     2.8284e-01, 0.0000e+00};

// anti-proton longitudinal parameters

const double pbar_par[8 * NPar][5] = {
    {2.2962e+00, 1.8237e+00, 1.5856e-01, 1.1724e+01,
     -2.5137e-02}, // Mean Ecal ShowerType1
    ...
    {9.2918e-01, 3.4905e-01, 4.4705e-01, 4.3199e+00,
     -1.0055e-01}, // Mean Hcal ShowerType1
    ...
    {1.6397e+00, 1.4348e+00, 1.8597e-01, 5.0391e+00,
     -2.1112e-01}, // Mean Hcal ShowerType2
    ...
    {6.4737e-01, 7.3992e-02, 9.2454e-01, 4.8070e+00,
     -3.3204e-03}, // Mean Hcal ShowerType3
    ...
    {7.9348e-01, 6.0791e-01, -5.2480e-01, -4.1979e+00,
     -9.7594e-03}, // Sigma Ecal ShowerType1
    ...
    {2.3715e-01, 6.1849e-02, -7.9327e-01, 2.4567e+00,
     -1.5569e-02}, // Sigma Hcal ShowerType1
    ...
    {2.0364e-01, 1.1109e-01, -5.4911e-01, 2.2371e+00,
     -2.7723e-03}, // Sigma Hcal ShowerType2
    ...
    {2.4410e-01, 6.9464e-02, -5.7121e-01, 1.5400e+00,
     -1.8889e-02}, // Sigma Hcal ShowerType3
...
const double pbar_rho[8 * NPar][5] = {
    {1.6115e-01, 7.7749e-02, 1.3576e+01, 6.4878e-01,
     -3.2481e-03}, // Ecal ShowerType1
    ...
    {2.5579e-01, 1.3158e-01, 2.0117e+00, 2.6834e+00,
     -1.8803e-02}, // Hcal ShowerType1
    ...
    {2.6738e-01, 1.6698e-01, 1.6242e+00, 2.3194e+00,
     -5.4439e-02}, // Hcal ShowerType2
    ...
    {-9.2169e-02, 2.7435e-01, -1.4954e+00, 3.4936e+00,
     5.4085e-02}, // Hcal ShowerType3
...
const double pbar_rpar[4 * Nrpar][5] = {
    {1.8776e+00, 2.8426e-01, 2.3530e+01, 3.0047e+00,
     -1.7332e-01}, // Ecal for showerType = 1
    ...
    {1.7618e+01, 4.3991e+00, -9.7543e-01, 2.7789e+00,
     -1.2115e+00}, // Hcal for showerType = 1
    ...
    {1.2340e+01, 5.3893e+00, -4.9219e-01, 1.5722e+00,
     -6.8433e-01}, // Hcal for showerType = 2
    ...
    {-1.6306e+00, 3.5609e+00, -1.8903e-01, 6.6580e+00,
     4.6936e-01}, // Hcal for showerType = 3
...
const double kminus_correl_hadem[5] = {-7.3480e-01, 1.8541e-01, -7.6211e-01,
                                       9.4878e-01, 2.5519e-03};

// kaon-minus longitudinal parameters

const double kminus_par[8 * NPar][5] = {
    {4.5986e-01, 8.0360e-02, 1.9103e+00, 2.7576e+00,
     5.8024e-02}, // Mean Ecal ShowerType1
    ...
    {2.0880e+00, 1.9024e+00, 2.2650e-01, 4.5397e+00,
     -3.5337e-01}, // Mean Hcal ShowerType1
    ...
    {3.0833e+00, 4.5830e+00, 1.6380e-01, 3.8496e+00,
     -6.6617e-01}, // Mean Hcal ShowerType2
    ...
    {4.3696e-01, 5.9373e-02, 1.5520e+00, 2.8488e+00,
     4.4038e-02}, // Mean Hcal ShowerType3
    ...
    {6.6849e-02, 1.1461e-01, -6.0693e-01, 3.5849e+00,
     2.1510e-02}, // Sigma Ecal ShowerType1
    ...
    {2.7710e-01, 5.4557e-02, -9.1426e-01, 1.3652e+00,
     -2.1545e-02}, // Sigma Hcal ShowerType1
    ...
    {4.5757e-01, 2.2138e-01, -8.3016e-01, -6.5474e-01,
     -2.5193e-02}, // Sigma Hcal ShowerType2
    ...
    {1.0333e+00, 8.4267e-01, -2.2255e-01, -6.2499e+00,
     -2.0389e-02}, // Sigma Hcal ShowerType3
...
const double kminus_rho[8 * NPar][5] = {
    {-4.5951e-02, 3.6373e-01, 4.9181e-01, 6.9207e-01,
     1.4429e-02}, // Ecal ShowerType1
    ...
    {3.0252e-01, 2.0969e-01, 1.2233e+00, 2.5744e+00,
     -3.5561e-02}, // Hcal ShowerType1
    ...
    {2.5820e-01, 2.1436e-01, 1.3064e+00, 2.1257e+00,
     -7.9308e-02}, // Hcal ShowerType2
    ...
    {4.4074e-02, 1.1797e-01, 9.8745e-01, 1.2754e+00,
     0.0000e+00}, // Hcal ShowerType3
...
const double kminus_rpar[4 * Nrpar][5] = {
    {1.5255e+00, 7.1460e-01, -9.6109e-01, 2.1485e+00,
     0.0000e+00}, // Ecal for showerType = 1
    ...
    {1.8546e+01, 3.9927e+00, -6.4386e-01, 2.5076e+00,
     -1.3842e+00}, // Hcal for showerType = 1
    ...
    {2.0741e+01, 3.9654e+01, -1.8029e-01, -4.2558e-01,
     2.5375e+00}, // Hcal for showerType = 2
    ...
    {-2.9248e+00, 5.6213e+00, -3.2437e-01, 3.0222e+00,
     1.5066e+00}, // Hcal for showerType = 3
...
const double kplus_correl_hadem[5] = {-6.9227e-01, 1.8762e-01, -7.1395e-01,
                                      7.1711e-01, -7.3016e-03};

// kaon-plus longitudinal parameters

const double kplus_par[8 * NPar][5] = {
    {3.8772e-01, 7.5923e-02, 2.3857e+00, 2.8135e+00,
     7.0675e-02}, // Mean Ecal ShowerType1
    ...
    {1.6983e+00, 1.3064e+00, 2.8039e-01, 4.3610e+00,
     -2.8089e-01}, // Mean Hcal ShowerType1
    ...
    {3.3203e+00, 5.0310e+00, 1.6001e-01, 3.9441e+00,
     -7.1274e-01}, // Mean Hcal ShowerType2
    ...
    {3.8408e-01, 6.1344e-02, 1.0667e+00, 3.0242e+00,
     5.0278e-02}, // Mean Hcal ShowerType3
    ...
    {-3.5273e-02, 2.6492e-01, -2.7154e-01, 4.1599e+00,
     3.7807e-02}, // Sigma Ecal ShowerType1
    ...
    {2.6008e-01, 6.1267e-02, -1.7484e+00, 1.6088e+00,
     -1.7668e-02}, // Sigma Hcal ShowerType1
    ...
    {2.7361e-01, 5.8267e-02, -1.5294e+00, 1.0185e+00,
     -2.2741e-02}, // Sigma Hcal ShowerType2
    ...
    {1.4349e+00, 1.4443e+00, -1.2105e-01, -9.0252e+00,
     2.3150e-03}, // Sigma Hcal ShowerType3
...
const double kplus_rho[8 * NPar][5] = {
    ...
    {2.4423e-01, 2.2650e-01, 1.3877e+00, 1.8939e+00,
     -7.5389e-02}, // Hcal ShowerType2
    ...
    {4.7434e-02, 3.1872e+00, 1.6477e-01, 3.0236e-01,
     -4.2486e-01}, // Hcal ShowerType3
...
const double kplus_rpar[4 * Nrpar][5] = {
    {2.0917e+00, 1.2528e+00, -6.9494e-01, 1.7600e+00,
     0.0000e+00}, // Ecal for showerType = 1
    ...
    {2.0008e+01, 2.1622e+00, -3.4949e+00, 1.9954e+00,
     -2.0569e+00}, // Hcal for showerType = 1
    ...
    {1.2970e+01, 2.5925e+00, -1.5404e+00, 1.6391e+00,
     -1.3978e+00}, // Hcal for showerType = 2
    ...
    {2.0954e+00, 4.0916e-01, -6.9750e+01, 1.9870e+00,
     -5.3104e-02}, // Hcal for showerType = 3
...
const double ho_nonzero[5] = {4.79943e-01, 4.61158e-01, 7.09011e-01,
                              4.86440e+00, 0.0000e+00};
} // namespace Gflash
