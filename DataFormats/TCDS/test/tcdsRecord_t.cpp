...
void TestTCDSRecord::testL1aHistory() {
  ...
  uint8_t index = 0;
  const uint64_t expectedOrbits[tcds::l1aHistoryDepth_v1] =
    {1403697,1403691,1403686,1403685,1403678,1403675,1403671,1403664,1403660,1403651,1403650,1403643,1403632,1403630,1403620,1403616};
  ...
  const uint64_t expectedEventTypes[tcds::l1aHistoryDepth_v1] =
    {3,3,3,3,3,3,3,1,1,3,3,1,3,1,3,3};
