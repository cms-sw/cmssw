...
TotemTimingEventInfo::TotemTimingEventInfo( const uint8_t hwId, const uint64_t l1ATimestamp,
                                            ...
                                            const uint8_t numberOfSamples, const uint8_t offsetOfSamples ) :
  ...
  numberOfSamples_( numberOfSamples ), offsetOfSamples_( offsetOfSamples )
{}
...
TotemTimingEventInfo::TotemTimingEventInfo() :
  ...
  numberOfSamples_( 0 ), offsetOfSamples_( 0 )
{}
