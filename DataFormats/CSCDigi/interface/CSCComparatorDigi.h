...
public:
  ...
  /// comparator here can be either 0 or 1 for left or right halfstrip of given
  /// strip

  /// Default construction.
  CSCComparatorDigi();

  /// Digis are equal if they are on the same strip and have same Comparator
  /// data
  ...
  /// Get the associated halfstrip number for this comparator digi. Counts from
  /// 0.
   ...
   * e.g. if bits 0 and 13 fired, then this vector will contain the values 0 and
   * 13
   */
