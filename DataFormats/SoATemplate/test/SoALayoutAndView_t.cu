...
using SoADeviceOnlyView = SoADeviceOnlyLayout::TrivialView;
...
using RangeCheckingHostDeviceView =
    SoAHostDeviceLayout::TrivialViewTemplate<SoAHostDeviceView::restrictQualify, cms::soa::RangeChecking::Enabled>;
...
int main(void) {
  ...
  assert(0 == reinterpret_cast<uintptr_t>(h_soahd.soaMetadata().addressOf_x()) % decltype(h_soahd)::alignment);
  assert(0 == reinterpret_cast<uintptr_t>(h_soahd.soaMetadata().addressOf_y()) % decltype(h_soahd)::alignment);
  assert(0 == reinterpret_cast<uintptr_t>(h_soahd.soaMetadata().addressOf_z()) % decltype(h_soahd)::alignment);
  assert(0 == reinterpret_cast<uintptr_t>(h_soahd.soaMetadata().addressOf_a()) % decltype(h_soahd)::alignment);
  assert(0 == reinterpret_cast<uintptr_t>(h_soahd.soaMetadata().addressOf_b()) % decltype(h_soahd)::alignment);
  assert(0 == reinterpret_cast<uintptr_t>(h_soahd.soaMetadata().addressOf_r()) % decltype(h_soahd)::alignment);
  assert(0 ==
         reinterpret_cast<uintptr_t>(h_soahd.soaMetadata().addressOf_description()) % decltype(h_soahd)::alignment);
  assert(0 == reinterpret_cast<uintptr_t>(h_soahd.soaMetadata().addressOf_someNumber()) % decltype(h_soahd)::alignment);

  assert(0 ==
         reinterpret_cast<uintptr_t>(d_soahdLayout.soaMetadata().addressOf_x()) % decltype(d_soahdLayout)::alignment);
  assert(0 ==
         reinterpret_cast<uintptr_t>(d_soahdLayout.soaMetadata().addressOf_y()) % decltype(d_soahdLayout)::alignment);
  assert(0 ==
         reinterpret_cast<uintptr_t>(d_soahdLayout.soaMetadata().addressOf_z()) % decltype(d_soahdLayout)::alignment);
  assert(0 ==
         reinterpret_cast<uintptr_t>(d_soahdLayout.soaMetadata().addressOf_a()) % decltype(d_soahdLayout)::alignment);
  assert(0 ==
         reinterpret_cast<uintptr_t>(d_soahdLayout.soaMetadata().addressOf_b()) % decltype(d_soahdLayout)::alignment);
  assert(0 ==
         reinterpret_cast<uintptr_t>(d_soahdLayout.soaMetadata().addressOf_r()) % decltype(d_soahdLayout)::alignment);
  ...
  assert(0 == reinterpret_cast<uintptr_t>(d_soadoLayout.soaMetadata().addressOf_value()) %
                  decltype(d_soadoLayout)::alignment);
  assert(0 ==
         reinterpret_cast<uintptr_t>(d_soadoLayout.soaMetadata().addressOf_py()) % decltype(d_soadoLayout)::alignment);
  ...
  assert(0 ==
         reinterpret_cast<uintptr_t>(d_soaFullView.soaMetadata().addressOf_x()) % decltype(d_soaFullView)::alignment);
  assert(0 ==
         reinterpret_cast<uintptr_t>(d_soaFullView.soaMetadata().addressOf_y()) % decltype(d_soaFullView)::alignment);
  assert(0 ==
         reinterpret_cast<uintptr_t>(d_soaFullView.soaMetadata().addressOf_z()) % decltype(d_soaFullView)::alignment);
  ...
  assert(0 == reinterpret_cast<uintptr_t>(d_soaFullView.soaMetadata().addressOf_value()) %
                  decltype(d_soaFullView)::alignment);
  assert(0 ==
         reinterpret_cast<uintptr_t>(d_soaFullView.soaMetadata().addressOf_py()) % decltype(d_soaFullView)::alignment);
