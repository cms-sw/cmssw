...
TEST_CASE("SoAToAoS") {
  ...
  SECTION("Base test with SoATemplate") {
    ...
    for (size_t i = 0; i < elems; i++) {
      REQUIRE(aosConstView[i].xPos() == Approx(static_cast<float>(i)));
      REQUIRE(aosConstView[i].yPos() == Approx(static_cast<float>(i) + 0.1f));
      REQUIRE(aosConstView[i].zPos() == Approx(static_cast<float>(i) + 0.2f));
      REQUIRE(aosConstView[i].candidateDirection()(0) == Approx(static_cast<double>(i) + 0.3));
      REQUIRE(aosConstView[i].candidateDirection()(1) == Approx(static_cast<double>(i) + 0.4));
      REQUIRE(aosConstView[i].candidateDirection()(2) == Approx(static_cast<double>(i) + 0.5));

      const double *py = aosConstView[i].py();
      for (size_t j = 0; j < 3; j++) {
        REQUIRE(py[j] == Approx(static_cast<double>(3 * i + j) + 0.01));
      }
    }
    REQUIRE(aosConstView.s1() == 100);
    REQUIRE(aosConstView.s2() == Approx(42.42f));
    REQUIRE(aosConstView.s3() == (int64_t(1) << 42) + 852516352);
    REQUIRE(aosConstView.s4() == Approx(static_cast<double>((int64_t(1) << 42) + 8.52516352)));
    ...
    for (size_t i = 0; i < elems; i++) {
      ...
      REQUIRE(xPos == Approx(static_cast<float>(i)));
      REQUIRE(yPos == Approx(static_cast<float>(i) + 0.1f));
      REQUIRE(zPos == Approx(static_cast<float>(i) + 0.2f));
      REQUIRE(candidateDirection0 == Approx(static_cast<double>(i) + 0.3));
      REQUIRE(candidateDirection1 == Approx(static_cast<double>(i) + 0.4));
      REQUIRE(candidateDirection2 == Approx(static_cast<double>(i) + 0.5));
    ...
    REQUIRE(s1 == 100);
    REQUIRE(s2 == Approx(42.42f));
    REQUIRE(s3 == (int64_t(1) << 42) + 852516352);
    REQUIRE(s4 == Approx(static_cast<double>((int64_t(1) << 42) + 8.52516352)));
    ...
    for (size_t i = 0; i < elems; i++) {
      REQUIRE(soaConstView2[i].xPos() == Approx(static_cast<float>(i)));
      REQUIRE(soaConstView2[i].yPos() == Approx(static_cast<float>(i) + 0.1f));
      REQUIRE(soaConstView2[i].zPos() == Approx(static_cast<float>(i) + 0.2f));
      REQUIRE(soaConstView2[i].candidateDirection()(0) == Approx(static_cast<double>(i) + 0.3));
      REQUIRE(soaConstView2[i].candidateDirection()(1) == Approx(static_cast<double>(i) + 0.4));
      REQUIRE(soaConstView2[i].candidateDirection()(2) == Approx(static_cast<double>(i) + 0.5));
    ...
    REQUIRE(soaConstView2.s2() == Approx(42.42f));
    REQUIRE(soaConstView2.s3() == (int64_t(1) << 42) + 852516352);
    REQUIRE(soaConstView2.s4() == Approx(static_cast<double>((int64_t(1) << 42) + 8.52516352)));
