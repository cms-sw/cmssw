...
#define _DECLARE_CONST_DESCRIPTOR_SPANS_IMPL(VALUE_TYPE, CPP_TYPE, NAME, ARGS)                                        \
  (typename cms::soa::ConstSpanType<typename Metadata::BOOST_PP_CAT(ParametersTypeOf_, NAME)>)
// clang-format on
...
#define _DECLARE_DESCRIPTOR_SPANS_IMPL(VALUE_TYPE, CPP_TYPE, NAME, ARGS)                                              \
  (typename cms::soa::SpanType<typename Metadata::BOOST_PP_CAT(ParametersTypeOf_, NAME)>)
// clang-format on
