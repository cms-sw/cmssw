...
namespace csc {
  namespace io_v1 {
    ...
    public:
      ...
      L1Track(const csc::io_v1::L1Track&);

      const csc::io_v1::L1Track& operator=(const csc::io_v1::L1Track&);
      ...
      bool operator>(const csc::io_v1::L1Track&) const;
      bool operator<(const csc::io_v1::L1Track&) const;
      bool operator>=(const csc::io_v1::L1Track&) const;
      bool operator<=(const csc::io_v1::L1Track&) const;
      bool operator==(const csc::io_v1::L1Track&) const;
      ...
      //friend std::ostream& operator<<(std::ostream&, const csc::io_v1::L1Track&);
      //friend std::ostream& operator<<(std::ostream&, csc::io_v1::L1Track&);
