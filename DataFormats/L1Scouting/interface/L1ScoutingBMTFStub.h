...
namespace l1ScoutingRun3 {
  ...
  public:
    ...
    int getHwPhi() const {return hwPhi_;}
    int getHwPhiB() const {return hwPhiB_;}
    int getHwQual() const {return hwQual_;}
    int getHwEta() const {return hwEta_;}
    int getHwQEta() const {return hwQEta_;}
