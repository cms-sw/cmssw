...
namespace edmtest {
  ...
  private:
    ...
    const edm::EDGetTokenT<OrbitCollection<l1ScoutingRun3::ScMuon>> muonsToken_;

    const std::vector<int> expectedJetValues_;
    const edm::EDGetTokenT<OrbitCollection<l1ScoutingRun3::ScJet>> jetsToken_;

    const std::vector<int> expectedEGammaValues_;
    const edm::EDGetTokenT<OrbitCollection<l1ScoutingRun3::ScEGamma>> eGammasToken_;

    const std::vector<int> expectedTauValues_;
    const edm::EDGetTokenT<OrbitCollection<l1ScoutingRun3::ScTau>> tausToken_;

    const std::vector<int> expectedBxSumsValues_;
    const edm::EDGetTokenT<OrbitCollection<l1ScoutingRun3::ScBxSums>> bxSumsToken_;
  };
