...
#define SoA_view_store(TYPE, NAME)                                                                                                  \
  (TYPE, NAME)

#define SoA_view_store_list(...)                                                                                                    \
  __VA_ARGS__

#define SoA_view_value(STORE_NAME, STORE_MEMBER, LOCAL_NAME)                                                                        \
  (STORE_NAME, STORE_MEMBER, LOCAL_NAME)
 ...
 */
#define _DECLARE_VIEW_STORE_TYPE_ALIAS_IMPL(TYPE, NAME)                                                                             \
  typedef TYPE BOOST_PP_CAT(TypeOf_, NAME);
 ...
 */
#define _DECLARE_VIEW_ELEM_MEMBER_INIT_IMPL(STORE, MEMBER, LOCAL_NAME, DATA)                                                        \
 ...
 */
#define _DECLARE_VIEW_ELEMENT_VALUE_COPY_IMPL(STORE_NAME, STORE_MEMBER, LOCAL_NAME)                                                 \
 ...
 */
#define _DECLARE_VIEW_ELEMENT_CONSTR_CALL_IMPL(STORE_NAME, STORE_MEMBER, LOCAL_NAME)                                                \
...
#define _DECLARE_VIEW_SOA_ACCESSOR_IMPL(STORE_NAME, STORE_MEMBER, LOCAL_NAME)                                                       \
    /* Column */                                                                                                                    \
    SOA_HOST_DEVICE_INLINE BOOST_PP_CAT( SoAMetadata::TypeOf_, LOCAL_NAME) * LOCAL_NAME() { return BOOST_PP_CAT(LOCAL_NAME, _); }   \
...
struct CLASS {                                                                                                                      \
  ...
  /* Trivial constuctor */                                                                                                          \
  CLASS():                                                                                                                          \
  _ITERATE_ON_ALL_COMMA(_DECLARE_VIEW_MEMBER_TRIVIAL_CONSTRUCTION, ~, VALUE_LIST)                                                   \
  {}                                                                                                                                \
                                                                                                                                    \
  ...
  element operator[](size_t index) {                                                                                                \
    return element(index,                                                                                                           \
        _ITERATE_ON_ALL_COMMA(_DECLARE_VIEW_ELEMENT_CONSTR_CALL, ~, VALUE_LIST) );                                                  \
  }                                                                                                                                 \
                                                                                                                                    \
