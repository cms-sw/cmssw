...
namespace {
  struct TestGetter : public edm::EDProductGetter {
    ...
    edm::WrapperBase const* getThinnedProduct(ProductID const&, unsigned int&) const override { return nullptr; }
...
void testRefToBaseProd::getTest() {
  {
    ...
    auto& prod = reinterpret_cast<RefToBaseProd<IntValue>&>(core);
