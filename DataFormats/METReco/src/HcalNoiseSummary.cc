...
HcalNoiseSummary::HcalNoiseSummary()  
  : hasBadRBXTS4TS5_(false),
    ...
    nts4ts5noise_(0),
    nnegativenoise_(0),
    rechitCount_(0), rechitCount15_(0),
    calibCountTS45_(0),
    calibCountgt15TS45_(0),
    calibCountHF_(0),
    hitsInLaserRegion_(0),
    hitsInNonLaserRegion_(0),
    emenergy_(0.0), hadenergy_(0.0), trackenergy_(0.0),
    ...
    isolnoisee_(0), isolnoiseet_(0),
    flatnoisee_(0), flatnoiseet_(0),
    spikenoisee_(0), spikenoiseet_(0),
    trianglenoisee_(0), trianglenoiseet_(0),
    ts4ts5noisee_(0), ts4ts5noiseet_(0),
    negativenoisee_(0), negativenoiseet_(0),    
    rechitEnergy_(0), rechitEnergy15_(0),
    calibCharge_(0),    
    calibChargeTS45_(0.),
