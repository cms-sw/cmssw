...
#ifndef DataFormats_RecoHGCal_TICLLayerTile_h
#define DataFormats_RecoHGCal_TICLLayerTile_h
...
public:
  ...
  int getGlobalBin(double eta, double phi) const { return getPhiBin(phi) + getEtaBin(eta) * ticl::constants::nPhiBins; }
