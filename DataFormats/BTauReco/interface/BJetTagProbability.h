...
namespace reco {
  ...
  public:
    ...
    explicit BJetTagProbability(float discriminator, JetRef jet, TrackTagInfoRefs tracks) : discriminator_ (discriminator), jet_(jet), selectedTracksWTI_ (tracks)  {}
    ...
    /*
    trackTagInfo trackTagInfoPUV(unsigned int i) const { 
