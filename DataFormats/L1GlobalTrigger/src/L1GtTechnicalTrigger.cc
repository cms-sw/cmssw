...
// assignment operator
L1GtTechnicalTrigger& L1GtTechnicalTrigger::operator=(
...
// equal operator
bool L1GtTechnicalTrigger::operator==(
        const L1GtTechnicalTrigger& result) const
{
...
// set decision word
void L1GtTechnicalTrigger::setGtTechnicalTriggerBitNumber(
