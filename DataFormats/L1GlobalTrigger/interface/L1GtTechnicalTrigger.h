...
public:
    ...
    inline const std::string gtTechnicalTriggerName() const
    {
        return m_gtTechnicalTriggerName;
    }

    inline const unsigned int gtTechnicalTriggerBitNumber() const
    {
    ...
    inline const bool gtTechnicalTriggerResult() const
    {
