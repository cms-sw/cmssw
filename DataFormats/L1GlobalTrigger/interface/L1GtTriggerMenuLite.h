...
public:
    ...
    L1GtTriggerMenuLite(const std::string&, const L1TriggerMap&,
            const L1TriggerMap&, const L1TriggerMap&,
...
public:
    ...
    inline const L1TriggerMap& gtAlgorithmMap() const {
    ...
    inline const L1TriggerMap& gtAlgorithmAliasMap() const {
    ...
    inline const L1TriggerMap& gtTechnicalTriggerMap() const {
    ...
    inline const std::vector<unsigned int>& gtTriggerMaskAlgoTrig() const
    {
    ...
    inline const std::vector<unsigned int>& gtTriggerMaskTechTrig() const
    {
    ...
    inline const std::vector<std::vector<int> >& gtPrescaleFactorsAlgoTrig() const
    {
        return m_prescaleFactorsAlgoTrig;
    }

    void setGtPrescaleFactorsAlgoTrig(const std::vector<std::vector<int> >&);

    inline const std::vector<std::vector<int> >& gtPrescaleFactorsTechTrig() const
    {
        return m_prescaleFactorsTechTrig;
    }
...
public:
    ...
    const std::string* gtAlgorithmAlias(unsigned int bitNumber, int& errorCode) const;

    /// get the name for a physics algorithm or a technical trigger
    /// with a given bit number
    const std::string* gtAlgorithmName(unsigned int bitNumber, int& errorCode) const;
    const std::string* gtTechTrigName(unsigned int bitNumber, int& errorCode) const;
