...
TrackerTopology::TrackerTopology(const PixelBarrelValues &pxb,
    ...
    : pbVals_(pxb), pfVals_(pxf), tobVals_(tobv), tibVals_(tibv),
      tidVals_(tidv), tecVals_(tecv),
      bits_per_field{[PBModule] = {pbVals_.moduleStartBit_, pbVals_.moduleMask_,
                                   PixelSubdetector::PixelBarrel},
                     [PBLadder] = {pbVals_.ladderStartBit_, pbVals_.ladderMask_,
                                   PixelSubdetector::PixelBarrel},
                     [PBLayer] = {pbVals_.layerStartBit_, pbVals_.layerMask_,
                                  PixelSubdetector::PixelBarrel},
                     [PFModule] = {pfVals_.moduleStartBit_, pfVals_.moduleMask_,
                                   PixelSubdetector::PixelEndcap},
                     [PFPanel] = {pfVals_.panelStartBit_, pfVals_.panelMask_,
                                  PixelSubdetector::PixelEndcap},
                     [PFBlade] = {pfVals_.bladeStartBit_, pfVals_.bladeMask_,
                                  PixelSubdetector::PixelEndcap},
                     [PFDisk] = {pfVals_.diskStartBit_, pfVals_.diskMask_,
                                 PixelSubdetector::PixelEndcap},
                     [PFSide] = {pfVals_.sideStartBit_, pfVals_.sideMask_,
                                 PixelSubdetector::PixelEndcap}} {}
...
std::string TrackerTopology::print(DetId id) const {
  ...
  if (subdet == PixelSubdetector::PixelBarrel) {
    ...
    strstr << "PixelBarrel"
           << " Layer " << theLayer << " Ladder " << theLadder << " Module "
           << theModule;
    strstr << " (" << id.rawId() << ")";
    return strstr.str();
  }
  ...
  if (subdet == PixelSubdetector::PixelEndcap) {
    ...
    strstr << "PixelEndcap"
           << " Side   " << theSide << side << " Disk   " << theDisk
           << " Blade  " << theBlade << " Panel  " << thePanel << " Module "
           << theModule;
    strstr << " (" << id.rawId() << ")";
    return strstr.str();
  }
  ...
  if (subdet == StripSubdetector::TIB) {
    ...
    typeUpgrade =
        (isUpper(id) || isLower(id)) ? typeUpgrade + " stack" : "module";
    strstr << "TIB" << side << " Layer " << theLayer << " " << part
           << " String " << theString[2];
  ...
  if (subdet == StripSubdetector::TID) {
    ...
    typeUpgrade =
        (isUpper(id) || isLower(id)) ? typeUpgrade + " stack" : "module";
    strstr << "TID"
           << " Side   " << theSide << side << " Wheel " << theWheel << " Ring "
           << theRing << " " << part;
  ...
  if (subdet == StripSubdetector::TEC) {
    ...
    typeUpgrade =
        (isUpper(id) || isLower(id)) ? typeUpgrade + " stack" : "module";
    strstr << "TEC"
           << " Side   " << theSide << side << " Wheel " << theWheel
           << " Petal " << thePetal[1] << " " << petal << " Ring " << theRing;
    strstr << " Module for phase0 " << theModule << " " << type;
    strstr << " Module for phase2 " << theModule << " " << typeUpgrade;
    strstr << " (" << id.rawId() << ")";
...
TrackerTopology::moduleGeometry(const DetId &id) const {
  switch (id.subdetId()) {
  case StripSubdetector::TIB:
    return tibLayer(id) < 3 ? SiStripDetId::IB1 : SiStripDetId::IB2;
  case StripSubdetector::TOB:
    return tobLayer(id) < 5 ? SiStripDetId::OB2 : SiStripDetId::OB1;
  case StripSubdetector::TID:
    switch (tidRing(id)) {
    case 1:
      return SiStripDetId::W1A;
    case 2:
      return SiStripDetId::W2A;
    case 3:
      return SiStripDetId::W3A;
    }
  case StripSubdetector::TEC:
    switch (tecRing(id)) {
    case 1:
      return SiStripDetId::W1B;
    case 2:
      return SiStripDetId::W2B;
    case 3:
      return SiStripDetId::W3B;
    case 4:
      return SiStripDetId::W4;
      // generic function to return DetIds and boolean factors
    case 5:
      return SiStripDetId::W5;
    case 6:
      return SiStripDetId::W6;
    case 7:
      return SiStripDetId::W7;
    }
  }
