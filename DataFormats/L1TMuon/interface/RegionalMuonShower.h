...
namespace l1t {
  namespace io_v1 {
    ...
    public:
      ...
      bool operator==(const l1t::io_v1::RegionalMuonShower& rhs) const;
      inline bool operator!=(const l1t::io_v1::RegionalMuonShower& rhs) const { return !(operator==(rhs)); };
  ...
  using RegionalMuonShower = io_v1::RegionalMuonShower;
