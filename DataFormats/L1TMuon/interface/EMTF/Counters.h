...
namespace l1t {
  namespace emtf {
    ...
    Counters() : 
      track_counter(-99), orbit_counter(-99), dataword(-99) 
	{};
      
    Counters(int int_track_counter, int int_orbit_counter) :
      track_counter(int_track_counter), orbit_counter(int_orbit_counter), dataword(-99)
    	{};
