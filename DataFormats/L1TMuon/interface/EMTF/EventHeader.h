...
namespace l1t {
  namespace emtf {
	...
	wof(int_wof), me1a(int_me1a), me1b(int_me1b), me2(int_me2), me3(int_me3), me4(int_me4), format_errors(0), dataword(-99)
      ...
      const int L1A_BXN()        { return  l1a_bxn ; };
      const int SP_ts()          { return  sp_ts ; };
      const int Endcap()         { return  endcap ; };
      const int Sector()         { return  sector ; };
      const int SP_ersv()        { return  sp_ersv ; };
      const int SP_addr()        { return  sp_addr ; };
      const int Tbin()           { return  tbin ; };
      const int DDM()            { return  ddm ; };
      const int SPa()            { return  spa ; };
      const int RPCa()           { return  rpca ; };
      const int Skip()           { return  skip ; };
      const int Rdy()            { return  rdy ; };
      const int BSY()            { return  bsy ; };
      const int OSY()            { return  osy ; };
      const int WOF()            { return  wof ; };
      const int ME1a()           { return  me1a ; };
      const int ME1b()           { return  me1b ; };
      const int ME2()            { return  me2 ; };
      const int ME3()            { return  me3 ; };
      const int ME4()            { return  me4 ; };
