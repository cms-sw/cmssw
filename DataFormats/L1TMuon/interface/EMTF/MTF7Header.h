...
namespace l1t {
  namespace emtf {
    ...
    // Empty constructor
    MTF7Header() :
      amc_number(-99), bx_id(-99), orbit_number(-99), board_id(-99), lv1_id(-99), data_length(-99), user_id(-99), dataword(-99)
	{};
    ...
    MTF7Header(int int_amc_number, int int_bx_id, int int_orbit_number, int int_board_id, int int_lv1_id, int int_data_length, int int_user_id) :
      amc_number(int_amc_number), bx_id(int_bx_id), orbit_number(int_orbit_number), board_id(int_board_id), lv1_id(int_lv1_id), data_length(int_data_length), user_id(int_user_id), dataword(-99)
	{};
