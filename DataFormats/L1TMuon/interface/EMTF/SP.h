...
namespace l1t {
  namespace emtf {
	...
	format_errors(0), dataword(-99)
      ...
      const int Pt_lut_address()   { return pt_lut_address  ; };
      const int Phi_local_int()    { return phi_local_int   ; };
      const int Phi_GMT_int()      { return phi_GMT_int     ; };
      ...
      const int ME3_csc_id()       { return me3_csc_id      ; };  
      const int ME3_trk_stub_num() { return me3_trk_stub_num; };
      const int ME4_csc_id()       { return me4_csc_id      ; };
      const int ME4_trk_stub_num() { return me4_trk_stub_num; };
      const int ME1_subsector()    { return me1_subsector   ; };
      const int ME1_csc_id()       { return me1_csc_id      ; };
      const int ME1_trk_stub_num() { return me1_trk_stub_num; };      
      const int ME4_TBIN()         { return me4_TBIN        ; };
      const int ME3_TBIN()         { return me3_TBIN        ; };
      const int ME2_TBIN()         { return me2_TBIN        ; };
      const int ME1_TBIN()         { return me1_TBIN        ; };
      const int TBIN_num()         { return tbin_num        ; };
      const int HL()               { return hl              ; };
      const int C()                { return c               ; };
      const int VC()               { return vc              ; };
      const int VT()               { return vt              ; };
      const int SE()               { return se              ; };
      const int BC0()              { return bc0             ; };
      const float Pt()             { return pt              ; };
      const float Phi_local()      { return phi_local       ; };
      const float Phi_local_rad()  { return phi_local_rad   ; };
      const float Phi_global()     { return phi_global      ; };
      const float Phi_GMT()        { return phi_GMT         ; };
      const float Phi_GMT_corr()   { return phi_GMT_corr    ; };
      const float Phi_GMT_rad()    { return phi_GMT_rad     ; };
      const float Phi_GMT_global() { return phi_GMT_global  ; };
      const float Eta_GMT()        { return eta_GMT         ; };
