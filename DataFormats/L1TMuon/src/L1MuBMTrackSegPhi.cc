...
L1MuBMTrackSegPhi::L1MuBMTrackSegPhi(
    const L1MuBMTrackSegLoc& id, int phi, int phib, TSQuality quality, bool tag, int bx, bool etaFlag)
    : m_location(id), m_phi(phi), m_phib(phib), m_quality(quality), m_tag(tag), m_bx(bx), m_etaFlag(etaFlag) {
  /*
  if ( phi  < -2048 || phi  > 2047 ) {
        cerr << "TrackSegPhi : phi out of range: " << phi << endl;
  }
...
ostream& operator<<(ostream& s, const L1MuBMTrackSegPhi::TSQuality& quality) {
  switch (quality) {
    case L1MuBMTrackSegPhi::Li:
      return s << "Li ";
    case L1MuBMTrackSegPhi::Lo:
      return s << "Lo ";
    case L1MuBMTrackSegPhi::Hi:
      return s << "Hi ";
    case L1MuBMTrackSegPhi::Ho:
      return s << "Ho ";
    case L1MuBMTrackSegPhi::LL:
      return s << "LL ";
    case L1MuBMTrackSegPhi::HL:
      return s << "HL ";
    case L1MuBMTrackSegPhi::HH:
      return s << "HH ";
    case L1MuBMTrackSegPhi::Null:
      return s << "Null ";
    default:
