...
namespace l1t::io_v1 {
  RegionalMuonShower::RegionalMuonShower(bool oneNominalInTime,
  ...
  void RegionalMuonShower::setTFIdentifiers(int processor, tftype trackFinder) {
  ...
  bool RegionalMuonShower::isValid() const {
    return (isOneNominalInTime_ or isTwoLooseInTime_ or isOneTightInTime_ or isOneLooseInTime_);
  }

  bool RegionalMuonShower::operator==(const l1t::RegionalMuonShower& rhs) const {
