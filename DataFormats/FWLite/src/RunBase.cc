...
namespace fwlite
{
   ...
   edm::BasicHandle
   RunBase::getByLabelImpl(edm::WrapperInterfaceBase const* wrapperInterfaceBase, std::type_info const& iWrapperInfo, std::type_info const& /*iProductInfo*/, const edm::InputTag& iTag) const
   {
      void* prod = 0;
      void* prodPtr = &prod;
