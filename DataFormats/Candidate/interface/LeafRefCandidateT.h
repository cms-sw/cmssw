...
public:
    ...
    const Candidate * daughter( size_type ) const final  { return 0; }
    /// number of mothers
    size_t numberOfMothers() const final  { return 0; }
    /// return mother at a given position (throws an exception)
    const Candidate * mother( size_type ) const final  { return 0; }
    /// return daughter at a given position (throws an exception)
    Candidate * daughter( size_type ) final  { return 0; }
    /// return daughter with a specified role name
    Candidate * daughter(const std::string& s ) final  { return 0; }
    /// return daughter with a specified role name                                        
    const Candidate * daughter(const std::string& s ) const final  { return 0; }
