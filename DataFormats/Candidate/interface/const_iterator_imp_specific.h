...
namespace reco {
  namespace candidate {
    template<typename C>
    struct const_iterator_imp_specific : public Candidate::const_iterator_imp {
    private:
    ...
    public:
      ...
      bool equal_to( const Candidate::const_iterator_imp * o ) const { return i == dc( o ); }
      bool less_than( const Candidate::const_iterator_imp * o ) const { return i < dc( o ); }
      void assign( const Candidate::const_iterator_imp * o ) { i = dc( o ); }
      const Candidate & deref() const { return iterator_deref<C>::deref(i); }
      difference_type difference( const Candidate::const_iterator_imp * o ) const { return i - dc( o ); }
    private:
      const const_iterator & dc( const Candidate::const_iterator_imp * o ) const {
	return dynamic_cast<const const_iterator_imp_specific *>( o )->i;
      }
      const_iterator & dc( Candidate::const_iterator_imp * o ) const {
    ...
    template<typename C>
    struct const_iterator_imp_specific_dummy : public Candidate::const_iterator_imp {
      typedef ptrdiff_t difference_type;
      ...
      bool equal_to( const Candidate::const_iterator_imp * o ) const { return true; }
      bool less_than( const Candidate::const_iterator_imp * o ) const { return false; }
      void assign( const Candidate::const_iterator_imp * o ) {  }
	...
	throw cms::Exception("Invalid Dereference") 
      ...
      difference_type difference( const Candidate::const_iterator_imp * o ) const { return 0; }
    };
