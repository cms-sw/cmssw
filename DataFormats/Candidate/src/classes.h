...
namespace {
  namespace {
    ...
    edm::AssociationMap<edm::OneToOne<reco::CandidateCollection, reco::CandidateCollection> > am1;
    edm::Wrapper<edm::AssociationMap<edm::OneToOne<reco::CandidateCollection, reco::CandidateCollection> > > wam1;
  }
}
