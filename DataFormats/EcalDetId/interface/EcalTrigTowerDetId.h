...
public:
   ...
   */
  EcalTrigTowerDetId(int zside, EcalSubdetector subdet, int i, int j,
  ...
  int ietaAbs() const {
    ...
    return (id_ >> 7) & 0x7f;
    /*       else */
    /* 	throw(std::runtime_error("EcalTrigTowerDetId: ietaAbs not applicable
  ...
  int ieta() const {
    ...
    /*       else */
    /* 	throw(std::runtime_error("EcalTrigTowerDetId: ieta not applicable for
     * this subDetector.")); */
  }
  ...
  int iphi() const {
    ...
    return id_ & 0x7F;
    /*       else */
    /* 	throw(std::runtime_error("EcalTrigTowerDetId: iphi not applicable for
     * this subDetector.")); */
  }
