...
public:
  ...
  EcalTriggerElectronicsId(int tccid, int towerid, int pseudostripid,
                           int channelid);
  ...
  static const int MAX_TCCID =
      108; // To be updated with correct and final number
  ...
  static const int TCCID_PHI0_EEM_IN =
      1; // id of the inner TCC in EE- which contains phi=0 deg.
  static const int TCCID_PHI0_EEM_OUT =
      19; // id of the outer TCC in EE- which contains phi=0 deg.
  static const int TCCID_PHI0_EEP_IN =
      91; // id of the inner TCC in EE+ which contains phi=0 deg.
  static const int TCCID_PHI0_EEP_OUT =
      73; // id of the outer TCC in EE+ which contains phi=0 deg.
  static const int TCCID_PHI0_EBM =
      37; // id of the TCC in EB- which contains phi=0 deg.
  static const int TCCID_PHI0_EBP =
      55; // id of the TCC in EB+ which contains phi=0 deg.
