...
public:
  ...
  /// get a fast, compact, unique index for linear lookups (maximum value =
  /// 4194303)
  ...
  static const int MAX_DCCID = 54; // To be updated with correct and final
                                   // number
  ...
  static const int DCC_EBM =
      10; // id of the DCC in EB- which contains phi=0 deg.
  static const int DCC_EBP =
      28; // id of the DCC in EB+ which contains phi=0 deg.
  static const int DCC_EEM =
      1; // id of the DCC in EE- which contains phi=0 deg.
  static const int DCC_EEP =
      46; // id of the DCC in EE+ which contains phi=0 deg.
