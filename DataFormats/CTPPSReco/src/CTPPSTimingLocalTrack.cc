...
CTPPSTimingLocalTrack::CTPPSTimingLocalTrack( const math::XYZPoint& pos0, const math::XYZPoint& pos0_sigma,
                                              float t, float t_sigma ) :
  pos0_( pos0 ), pos0_sigma_( pos0_sigma ), num_hits_( 0 ), num_planes_( 0 ), valid_( false ),
  t_( t ), t_sigma_( t_sigma )
{}

//--- interface member functions

bool
CTPPSTimingLocalTrack::containsHit( const CTPPSTimingRecHit& recHit, float tolerance, CheckDimension check ) const
{
...
bool
operator<( const CTPPSTimingLocalTrack& lhs, const CTPPSTimingLocalTrack& rhs )
{
