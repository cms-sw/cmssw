...
class TracksHost : public PortableHostCollection<TrackLayout<TrackerTraits>> {
public:
  ...
  explicit TracksHost<TrackerTraits>(TQueue queue) : PortableHostCollection<TrackLayout<TrackerTraits>>(S, queue) {}
