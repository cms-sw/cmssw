...
const uint32_t CTPPSDetId::startArmBit = 24, CTPPSDetId::maskArm = 0x1,
               CTPPSDetId::maxArm = 1, CTPPSDetId::lowMaskArm = 0xFFFFFF;
const uint32_t CTPPSDetId::startStationBit = 22, CTPPSDetId::maskStation = 0x3,
               CTPPSDetId::maxStation = 2,
               CTPPSDetId::lowMaskStation = 0x3FFFFF;
const uint32_t CTPPSDetId::startRPBit = 19, CTPPSDetId::maskRP = 0x7,
               CTPPSDetId::maxRP = 6, CTPPSDetId::lowMaskRP = 0x7FFFF;
...
const string CTPPSDetId::rpNames[] = {"nr_tp", "nr_bt", "nr_hr", "fr_hr",
                                      "fr_tp", "fr_bt", "cyl_hr"};
...
CTPPSDetId::CTPPSDetId(uint32_t SubDet, uint32_t Arm, uint32_t Station,
                       uint32_t RomanPot)
    : DetId(DetId::VeryForward, SubDet) {
  if (SubDet != sdTrackingStrip && SubDet != sdTrackingPixel &&
      SubDet != sdTimingDiamond && SubDet != sdTimingFastSilicon) {
    throw cms::Exception("InvalidDetId")
...
std::ostream &operator<<(std::ostream &os, const CTPPSDetId &id) {
  os << "subDet=" << id.subdetId() << " arm=" << id.arm()
     << " station=" << id.station() << " rp=" << id.rp();
