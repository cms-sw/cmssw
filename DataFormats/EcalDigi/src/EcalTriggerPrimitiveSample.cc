...
EcalTriggerPrimitiveSample::EcalTriggerPrimitiveSample(const uint16_t& data) : theSample(data) { }

EcalTriggerPrimitiveSample::EcalTriggerPrimitiveSample(const int& encodedEt, const bool& fineGrain, const int& ttFlag) { 
