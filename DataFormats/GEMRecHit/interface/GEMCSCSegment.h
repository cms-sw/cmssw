...
public:
    ...
    /// Constructor
    GEMCSCSegment(const CSCSegment* csc_segment, const std::vector<const GEMRecHit*>& gem_rhs, LocalPoint origin, LocalVector direction, const AlgebraicSymMatrix& errors, double chi2);
