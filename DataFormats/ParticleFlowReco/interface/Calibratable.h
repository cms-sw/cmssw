 ...
 */
  class CandidateWrapper {
  public:
    CandidateWrapper() { reset(); }

    CandidateWrapper(double energy, double eta, double phi, double energyEcal, double energyHcal, int type)
        : energy_(energy), eta_(eta), phi_(phi), energyEcal_(energyEcal), energyHcal_(energyHcal), type_(type) {
 ...
 */
  ...
  public:
    ...
    double cand_energyEvent_, cand_energyEcal_, cand_energyHcal_, cand_eta_, cand_phi_;
