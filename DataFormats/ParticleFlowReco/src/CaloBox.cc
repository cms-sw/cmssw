...
CaloBox::CaloBox(double centerEta, double centerPhi, double dEta, double dPhi, unsigned nEta, unsigned nPhi)
    : centerEta_(centerEta), centerPhi_(centerPhi), dEta_(dEta), dPhi_(dPhi), nEta_(nEta), nPhi_(nPhi) {
  if (nEta_ % 2 != 1) {
