...
RecBlk::RecBlk(int ver, int bxAlg, int bxExt, int bxMu, int bxCal, int psIndex,
...
// pretty print the content of a RecBlk
void RecBlk::print(std::ostream& myCout) const
{
