...
CSCSharesInputTest::CSCSharesInputTest(const edm::ParameterSet &myConfig)
{
  ...
  mu_token = consumes<edm::View<reco::Muon> >(myConfig.getParameter<edm::InputTag>("MuonCollection"));
	...
	ntuples_["perEvent"] = rootFile->make<TNtuple>("perEvent", "Interesting data on a per-event basis", "Muons:RecHits:TrackingRecHits:AllMatchedRecHits:SomeMatchedRecHits:AllWiresMatchedRecHits:SomeWiresMatchedRecHits:AllStripsMatchedRecHits:SomeStripsMatchedRecHits:NotMatchedRecHits");
	ntuples_["perMuon"] = rootFile->make<TNtuple>("perMuon", "Interesting data on a per-muon basis", "TrackingRecHits:AllMatchedRecHits:SomeMatchedRecHits:AllWiresMatchedRecHits:SomeWiresMatchedRecHits:AllStripsMatchedRecHits:SomeStripsMatchedRecHits:NotMatchedRecHits");
	ntuples_["perRecHit"] = rootFile->make<TNtuple>("perRecHit", "Interesting data per RecHit", "AllMatched:SomeMatched:AllWiresMatched:SomeWiresMatched:AllStripsMatched:SomeStripsMatched:NotMatched");
