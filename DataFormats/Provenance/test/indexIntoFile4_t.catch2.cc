...
public:
  ...
  void check(edm::IndexIntoFile::IndexIntoFileItr const& iter,
    ...
    if (!theyMatch) {
      std::cout << "\nExpected        " << type << "  " << indexToRun << "  " << indexToLumi << "  "
                << indexToEventRange << "  " << indexToEvent << "  " << nEvents << "\n";
  ...
  void testFind() {
    for (int j = 0; j < 2; ++j) {
      ...
      REQUIRE(iter == indexIntoFile.end(IndexIntoFile::numericalOrder));
      ...
      REQUIRE(iter.type() == kRun);
      REQUIRE(iter.indexToRun() == 9);
      REQUIRE(iter.indexToLumi() == 11);
      REQUIRE(iter.indexToEventRange() == IndexIntoFile::invalidIndex);
      REQUIRE(iter.indexToEvent() == 0);
      REQUIRE(iter.nEvents() == 0);
      ...
      REQUIRE(iter1 == indexIntoFile.end(IndexIntoFile::numericalOrder));
      REQUIRE(iter2 == indexIntoFile.end(IndexIntoFile::numericalOrder));
      REQUIRE(iter.indexIntoFile() == &indexIntoFile);
      REQUIRE(iter.size() == 12);
      REQUIRE(iter.type() == kRun);
      REQUIRE(iter.indexToRun() == 0);
      REQUIRE(iter.indexToLumi() == IndexIntoFile::invalidIndex);
      REQUIRE(iter.indexToEventRange() == IndexIntoFile::invalidIndex);
      REQUIRE(iter.indexToEvent() == 0);
      REQUIRE(iter.nEvents() == 0);
      ...
      REQUIRE(indexIntoFile.containsItem(2, 0, 0));
      REQUIRE(!indexIntoFile.containsItem(2000, 0, 0));
      REQUIRE(iter == iter1);
      REQUIRE(iter == iter2);
      REQUIRE(iter == iter3);
      REQUIRE(iter == iter4);
      REQUIRE(iter.type() == kRun);
      REQUIRE(iter.indexToRun() == 1);
      REQUIRE(iter.indexToLumi() == 2);
      REQUIRE(iter.indexToEventRange() == 2);
      REQUIRE(iter.indexToEvent() == 0);
      REQUIRE(iter.nEvents() == 4);
      ...
      REQUIRE(iter == iter2);
      REQUIRE(iter.type() == kRun);
      REQUIRE(iter.indexToRun() == 5);
      REQUIRE(iter.indexToLumi() == 6);
      REQUIRE(iter.indexToEventRange() == 6);
      REQUIRE(iter.indexToEvent() == 0);
      REQUIRE(iter.nEvents() == 4);
      ...
      REQUIRE(iter.type() == kRun);
      REQUIRE(iter.indexToRun() == 9);
      REQUIRE(iter.indexToLumi() == 10);
      REQUIRE(iter.indexToEventRange() == 10);
      REQUIRE(iter.indexToEvent() == 0);
      REQUIRE(iter.nEvents() == 2);
      ...
      REQUIRE(iter.indexToLumi() == 2);
      REQUIRE(iter.indexToEventRange() == 2);
      REQUIRE(iter.indexToEvent() == 1);
      REQUIRE(iter.nEvents() == 4);
      REQUIRE(iter3.type() == kRun);
      REQUIRE(iter3.indexToRun() == 1);
      REQUIRE(iter3.indexToLumi() == 2);
      REQUIRE(iter3.indexToEventRange() == 3);
      REQUIRE(iter3.indexToEvent() == 0);
      REQUIRE(iter3.nEvents() == 2);

      iter3 = indexIntoFile.findPosition(IndexIntoFile::firstAppearanceOrder, 2, 0, 0);
      REQUIRE(iter3.type() == kRun);
      REQUIRE(iter3.indexToRun() == 1);
      REQUIRE(iter3.indexToLumi() == 2);
      REQUIRE(iter3.indexToEventRange() == 2);
      REQUIRE(iter3.indexToEvent() == 0);
      REQUIRE(iter3.nEvents() == 2);
      ...
      REQUIRE(iter3.type() == kRun);
      REQUIRE(iter3.indexToRun() == 9);
      REQUIRE(iter3.indexToLumi() == 11);
      REQUIRE(iter3.indexToEventRange() == -1);
      REQUIRE(iter3.indexToEvent() == 0);
      REQUIRE(iter3.nEvents() == 0);
      ...
      REQUIRE(iter == iter1);
      REQUIRE(iter.type() == kEvent);
      REQUIRE(iter.indexToRun() == 1);
      REQUIRE(iter.indexToLumi() == 3);
      REQUIRE(iter.indexToEventRange() == 2);
      REQUIRE(iter.indexToEvent() == 0);
      REQUIRE(iter.nEvents() == 4);
      ...
      REQUIRE(indexIntoFile.containsItem(2, 12, 7));
      REQUIRE(!indexIntoFile.containsItem(2, 12, 100));
      REQUIRE(iter == iter1);
      REQUIRE(iter.type() == kEvent);
      REQUIRE(iter.indexToRun() == 1);
      REQUIRE(iter.indexToLumi() == 3);
      ...
      REQUIRE(indexIntoFile.containsItem(2, 12, 0));
      REQUIRE(!indexIntoFile.containsItem(2, 100, 0));
      REQUIRE(iter == indexIntoFile.end(IndexIntoFile::numericalOrder));
...
};  // TestIndexIntoFile4Fixture

TEST_CASE("IndexIntoFile4", "[indexIntoFile4_t]") {
  TestIndexIntoFile4 fixture;
  fixture.setUp();

  SECTION("testFind") { fixture.testFind(); }
}
