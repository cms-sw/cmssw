...
namespace edm {
   ...
   */
  bool ProductNamePattern::match(edm::ProductDescription const& branch) const {
   ...
   */
  std::vector<ProductNamePattern> branchPatterns(std::vector<std::string> const& labels) {
