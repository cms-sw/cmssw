...
RPCDigiPhase2::RPCDigiPhase2(int strip, int bx, int sbx)
  : strip_(strip),
    bx_(bx),
    sbx_(sbx) {}

RPCDigiPhase2::RPCDigiPhase2()
  : strip_(0),
    bx_(0),
    sbx_(0) {}
...
std::ostream& operator<<(std::ostream& o, const RPCDigiPhase2& digi) { return o << " " << digi.strip() << " " << digi.bx(); }
