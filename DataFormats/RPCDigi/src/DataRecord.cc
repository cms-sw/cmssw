...
rpcrawtodigi::DataRecord::type() const {
...
std::string
rpcrawtodigi::DataRecord::print(const rpcrawtodigi::DataRecord &record) {
...
std::string rpcrawtodigi::DataRecord::name(
    const rpcrawtodigi::DataRecord::DataRecordType &code) {
  std::string result;
  switch (code) {
  case (None): {
    result = "None";
