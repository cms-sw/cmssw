...
_PS_CONST_TYPE(min_norm_pos, unsigned int, 0x00800000);
_PS_CONST_TYPE(mant_mask, unsigned int, 0x7f800000);
_PS_CONST_TYPE(inv_mant_mask, unsigned int, ~0x7f800000);
