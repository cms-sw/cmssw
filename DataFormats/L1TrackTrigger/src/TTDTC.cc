...
TTDTC::TTDTC(const int& numRegions, const int& numOverlappingRegions, const int& numDTCsPerRegion)
...
TTDTC::Stream& TTDTC::dtcStream(const int& dtcRegion, const int& dtcBoard, const int& dtcChannel) {
  ...
  if (oorRegion || oorBoard || oorChannel) {
    ...
    exception.addContext("TTDTC::dtcStream");
...
TTDTC::Stream TTDTC::tfpStream(const int& tfpRegion, const int& tfpChannel) const {
  ...
  if (oorRegion || oorChannel) {
    cms::Exception exception("out_of_range");
    exception.addContext("TTDTC::tfpStream");
...
int TTDTC::tkLayoutId(const int& dtcId) const {
  // check argument
...
int TTDTC::dtcId(const int& tkLayoutId) const {
  // check argument
...
int TTDTC::index(const int& dtcRegion, const int& dtcBoard, const int& dtcChannel) const {
...
int TTDTC::index(const int& tfpRegion, const int& tfpChannel) const {
