...
template <class T, class ErrorWeightType> class GlobalErrorBase {
...
public:
  ...
  /**
   * Obsolete  Constructor that allocates a null GlobalErrorBase (it does not
   * create the error matrix at all)
   */
   ...
   */
  GlobalErrorBase(T c11, T c21, T c22, T c31, T c32, T c33, T c41, T c42, T c43,
                  T c44) {
    theCartesianError(0, 0) = c11;
    theCartesianError(1, 0) = c21;
    theCartesianError(1, 1) = c22;
