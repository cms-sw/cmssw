...
PFTau3ProngSummary::PFTau3ProngSummary(const reco::PFTauTransverseImpactParameterRef& TIP,const TLorentzVector& a1,double vertex_chi2,double vertex_ndf){
  TIP_=TIP;
...
PFTau3ProngSummary::PFTau3ProngSummary(const reco::PFTauTransverseImpactParameterRef& TIP,const TLorentzVector& a1,double vertex_chi2,double vertex_ndf,const TVector3& sv,const CovMatrix& svcov){
  TIP_=TIP;
  for(unsigned int i=0;i<nsolutions;i++){
    has3ProngSolution_.push_back(false);
    solution_Chi2_.push_back(0);
