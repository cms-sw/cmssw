...
namespace reco {
   ...
   public:
     ...
     PFTau3ProngSummary();
     PFTau3ProngSummary(const reco::PFTauTransverseImpactParameterRef& TIP,const TLorentzVector& a1,double vertex_chi2,double vertex_ndf);
     PFTau3ProngSummary(const reco::PFTauTransverseImpactParameterRef& TIP,const TLorentzVector& a1,double vertex_chi2,double vertex_ndf,const TVector3& sv,const CovMatrix& svcov);
