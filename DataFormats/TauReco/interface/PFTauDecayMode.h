...
namespace reco {
   class PFTauDecayMode : public CompositeCandidate {
      ...
      const static unsigned char maxNumberOfPiZeroCandidatesAllowed = 4;  //to help with indexing.  changing this value necissitates changing the enum below
      ...
      PFTauDecayMode( Charge q,const LorentzVector& p4,const Point & vtx = Point( 0, 0, 0 ), 
                      int pdgId = 12, int status = 2, bool integerCharge = true):CompositeCandidate(q, p4, vtx, pdgId, status, integerCharge){}
