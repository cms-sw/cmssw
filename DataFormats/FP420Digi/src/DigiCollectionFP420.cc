...
#ifdef mydigidebug
  std::cout << "   !!!!!!!!!!!!!!!!    DigiCollectionFP420:: !!!!  put !!!!  "
               "start detID="
            << detID << std::endl;
#endif
...
#ifdef mydigidebug
      std::cout << "digi put:first  container_.size() = " << container_.size()
                << std::endl;
      std::cout << "digi put:first  inputRange.first = " << inputRange.first
                << std::endl;
#endif
      first = false;
    } // if
...
#ifdef mydigidebug
  std::cout << "digi put: container_.size() = " << container_.size()
            << std::endl;
  std::cout << "digi put:  inputRange.first = " << inputRange.first
            << std::endl;
  std::cout << "digi put:  inputRange.second = " << inputRange.second
            << std::endl;
#endif
...
#ifdef mydigidebug
  std::cout << "digi putclear: container_.size() = " << container_.size()
            << std::endl;
  std::cout << "digi putclear:  inputRange.first = " << inputRange.first
            << std::endl;
  std::cout << "digi putclear:  inputRange.second = " << inputRange.second
            << std::endl;
#endif
...
const DigiCollectionFP420::Range
DigiCollectionFP420::get(unsigned int detID) const {
  // get Digis of detID
...
#ifdef mydigidebug
  std::cout << "digi get1: container_.size() = " << container_.size()
            << std::endl;
  std::cout << "digi get1: returnIndexRange.first= " << returnIndexRange.first
            << std::endl;
  std::cout << "digi get1: returnIndexRange.second= " << returnIndexRange.second
            << std::endl;
#endif
  return returnRange;
}
...
const DigiCollectionFP420::Range
DigiCollectionFP420::get1(unsigned int detID) const {
  // get Digis of detID
...
#ifdef mydigidebug
  std::cout << "DigiCollectionFP420::get : returnIndexRange.first= "
            << returnIndexRange.first << std::endl;
  std::cout << "DigiCollectionFP420::get : returnIndexRange.second= "
            << returnIndexRange.second << std::endl;
#endif
...
#ifdef mydigidebug
  std::cout << "DigiCollectionFP420::get : container_.size() = "
...
#ifdef mydigidebug
  std::cout << "DigiCollectionFP420::add:    det_id=    " << det_id
            << std::endl;
#endif
...
#ifdef mydigidebug
  std::cout << "DigiCollectionFP420::  detIDs:  digiMap    size= "
