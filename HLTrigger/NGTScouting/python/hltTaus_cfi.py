...
hltTauTable = cms.EDProducer("SimplePFTauCandidateFlatTableProducer",
      ...
      variables = cms.PSet(
        ...
        leadTkPtOverTauPt = Var("?leadChargedHadrCand.isNonnull() && leadChargedHadrCand.isAvailable()?leadChargedHadrCand.pt/pt:1",float, doc="pt of the leading track divided by tau pt", precision=10),
        leadTkDeltaEta = Var("?leadChargedHadrCand.isNonnull() && leadChargedHadrCand.isAvailable()?(leadChargedHadrCand.eta - eta):0",float, doc="eta of the leading track, minus tau eta", precision=8),
        leadTkDeltaPhi = Var("?leadChargedHadrCand.isNonnull() && leadChargedHadrCand.isAvailable()?deltaPhi(leadChargedHadrCand.phi, phi):0",float, doc="phi of the leading track, minus tau phi", precision=8),
