...
hltGsfTracksL1SeededTable = cms.EDProducer("SimpleGsfTrackFlatTableProducer",
                                           skipNonExistingSrc=cms.bool(True),
                                           src=cms.InputTag("hltEgammaGsfTracksL1Seeded"),
                                           cut=cms.string(""),
                                           name=cms.string("hltGsfTrackL1Seeded"),
                                           doc=cms.string("HLT GSF tracks"),
...
hltGsfTracksUnseededTable = hltGsfTracksL1SeededTable.clone(
    src=cms.InputTag("hltEgammaGsfTracksUnseeded"),
    name=cms.string("hltGsfTrackUnseeded"),
    doc=cms.string("HLT unseeded GSF tracks")
)
