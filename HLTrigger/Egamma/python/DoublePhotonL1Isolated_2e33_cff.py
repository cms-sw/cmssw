...
#module hltL1IsoDoublePhotonEtFilter = hltEgammaDoubleEtFilter from "HLTrigger/Egamma/data/hltEgammaDoubleEtFilter.cfi"
#replace hltL1IsoDoublePhotonEtFilter.candTag =  hltL1IsoDoublePhotonL1MatchFilterRegional
#      double etcut1 = 30.0
#      double etcut2 = 20.0
#      int32  npaircut = 1
#--------------------------------------------------------------------#
...
#replace hltL1IsoDoublePhotonEtFilter.inputTag = hltL1IsoDoublePhotonL1MatchFilter
