...
void
HLTElectronPixelMatchSFilter::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  desc.add<double>("s_a_phi1B",    0) ;
  desc.add<double>("s_a_phi1I",    0) ;
  desc.add<double>("s_a_phi1F",    0) ;
  desc.add<double>("s_a_phi2B",    0) ;
  desc.add<double>("s_a_phi2I",    0) ;
  desc.add<double>("s_a_phi2F",    0) ;
  desc.add<double>("s_a_zB"   ,    0) ;
  desc.add<double>("s_a_rI"   ,    0) ;
  desc.add<double>("s_a_rF"   ,    0) ;
  desc.add<double>("s2_threshold", 0) ;
  desc.add<int>   ("use_s"       , 1) ;
  descriptions.add("hltElectronPixelMatchSFilter",desc);
}
