...
void HLTEgammaDoubleEtDeltaPhiFilter::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
bool HLTEgammaDoubleEtDeltaPhiFilter::hltFilter(edm::Event& iEvent,
