#ifndef HLTEPFMTFilter_h
#define HLTEPFMTFilter_h
...
//
template< typename T> 
class HLTEPFMTFilter : public HLTFilter {

   public:
      explicit HLTEPFMTFilter(const edm::ParameterSet&);
      ~HLTEPFMTFilter();
