...
private:
  ...
  std::map<TString,int> map_RefL1PrescaleOfStandardHLTPath; 
  ...
  int  readPrescaleFromFile(TString st);
  int  readL1PrescaleFromFile(TString st);
...
void OHltTree::Init(TTree *tree)
{
  ...
  // L1 Prescales
  fChain->SetBranchAddress("L1Tech_BPTX_plus_OR_minus.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BPTX_plus_OR_minus.v0"], &b_L1Tech_BPTX_plus_OR_minus_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_BPTX_plus_AND_minus_instance1.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BPTX_plus_AND_minus_instance1.v0"], &b_L1Tech_BPTX_plus_AND_minus_instance1_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_BSC_minBias_OR.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BSC_minBias_OR.v0"], &b_L1Tech_BSC_minBias_OR_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_BSC_minBias_threshold1.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BSC_minBias_threshold1.v0"], &b_L1Tech_BSC_minBias_threshold1_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_BSC_minBias_threshold2.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BSC_minBias_threshold2.v0"], &b_L1Tech_BSC_minBias_threshold2_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_BSC_minBias_inner_threshold1.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BSC_minBias_inner_threshold1.v0"], &b_L1Tech_BSC_minBias_inner_threshold1_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_BSC_minBias_inner_threshold2.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BSC_minBias_inner_threshold2.v0"], &b_L1Tech_BSC_minBias_inner_threshold2_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_BSC_halo_beam1_inner.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BSC_halo_beam1_inner.v0"], &b_L1Tech_BSC_halo_beam1_inner_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_BSC_halo_beam1_outer.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BSC_halo_beam1_outer.v0"], &b_L1Tech_BSC_halo_beam1_outer_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_BSC_halo_beam2_inner.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BSC_halo_beam2_inner.v0"], &b_L1Tech_BSC_halo_beam2_inner_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_BSC_halo_beam2_outer.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BSC_halo_beam2_outer.v0"], &b_L1Tech_BSC_halo_beam2_outer_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_BSC_HighMultiplicity.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BSC_HighMultiplicity.v0"], &b_L1Tech_BSC_HighMultiplicity_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_BSC_splash_beam1.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BSC_splash_beam1.v0"], &b_L1Tech_BSC_splash_beam1_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_BSC_splash_beam2.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_BSC_splash_beam2.v0"], &b_L1Tech_BSC_splash_beam2_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_RPC_TTU_barrel_Cosmics.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_RPC_TTU_barrel_Cosmics.v0"], &b_L1Tech_RPC_TTU_barrel_Cosmics_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_RPC_TTU_pointing_Cosmics.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_RPC_TTU_pointing_Cosmics.v0"], &b_L1Tech_RPC_TTU_pointing_Cosmics_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_RPC_TTU_RBst1_collisions.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_RPC_TTU_RBst1_collisions.v0"], &b_L1Tech_RPC_TTU_RBst1_collisions_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_HCAL_HF_MM_or_PP_or_PM.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_HCAL_HF_MM_or_PP_or_PM.v0"], &b_L1Tech_HCAL_HF_MM_or_PP_or_PM_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_HCAL_HF_coincidence_PM.v1_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_HCAL_HF_coincidence_PM.v1"], &b_L1Tech_HCAL_HF_coincidence_PM_v1_Prescl); 
  fChain->SetBranchAddress("L1Tech_HCAL_HF_MMP_or_MPP.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_HCAL_HF_MMP_or_MPP.v0"], &b_L1Tech_HCAL_HF_MMP_or_MPP_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_HCAL_HO_totalOR.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_HCAL_HO_totalOR.v0"], &b_L1Tech_HCAL_HO_totalOR_v0_Prescl); 
  fChain->SetBranchAddress("L1Tech_HCAL_HBHE_totalOR.v0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1Tech_HCAL_HBHE_totalOR.v0"], &b_L1Tech_HCAL_HBHE_totalOR_v0_Prescl);
  fChain->SetBranchAddress("L1_BptxPlusORMinus_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_BptxPlusORMinus"], &b_L1_BptxPlusORMinus_Prescl); 
  fChain->SetBranchAddress("L1_BptxPlus_NotBptxMinus_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_BptxPlus_NotBptxMinus"], &b_L1_BptxPlus_NotBptxMinus_Prescl); 
  fChain->SetBranchAddress("L1_BptxMinus_NotBptxPlus_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_BptxMinus_NotBptxPlus"], &b_L1_BptxMinus_NotBptxPlus_Prescl); 
  fChain->SetBranchAddress("L1_Mu5_Jet6_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_Mu5_Jet6"], &b_L1_Mu5_Jet6_Prescl); 
  fChain->SetBranchAddress("L1_EG5_TripleJet6_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_EG5_TripleJet6"], &b_L1_EG5_TripleJet6_Prescl); 
  fChain->SetBranchAddress("L1_SingleJet6_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleJet6"], &b_L1_SingleJet6_Prescl); 
  fChain->SetBranchAddress("L1_SingleJet10_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleJet10"], &b_L1_SingleJet10_Prescl); 
  fChain->SetBranchAddress("L1_DoubleEG1_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleEG1"], &b_L1_DoubleEG1_Prescl); 
  fChain->SetBranchAddress("L1_DoubleEG2_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleEG2"], &b_L1_DoubleEG2_Prescl); 
  fChain->SetBranchAddress("L1_DoubleEG5_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleEG5"], &b_L1_DoubleEG5_Prescl); 
  fChain->SetBranchAddress("L1_DoubleHfBitCountsRing1_P1N1_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleHfBitCountsRing1_P1N1"], &b_L1_DoubleHfBitCountsRing1_P1N1_Prescl); 
  fChain->SetBranchAddress("L1_DoubleHfBitCountsRing2_P1N1_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleHfBitCountsRing2_P1N1"], &b_L1_DoubleHfBitCountsRing2_P1N1_Prescl); 
  fChain->SetBranchAddress("L1_DoubleHfRingEtSumsRing1_P200N200_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleHfRingEtSumsRing1_P200N200"], &b_L1_DoubleHfRingEtSumsRing1_P200N200_Prescl); 
  fChain->SetBranchAddress("L1_DoubleHfRingEtSumsRing1_P4N4_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleHfRingEtSumsRing1_P4N4"], &b_L1_DoubleHfRingEtSumsRing1_P4N4_Prescl); 
  fChain->SetBranchAddress("L1_DoubleHfRingEtSumsRing2_P200N200_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleHfRingEtSumsRing2_P200N200"], &b_L1_DoubleHfRingEtSumsRing2_P200N200_Prescl); 
  fChain->SetBranchAddress("L1_DoubleHfRingEtSumsRing2_P4N4_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleHfRingEtSumsRing2_P4N4"], &b_L1_DoubleHfRingEtSumsRing2_P4N4_Prescl); 
  fChain->SetBranchAddress("L1_DoubleJet70_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleJet70"], &b_L1_DoubleJet70_Prescl); 
  fChain->SetBranchAddress("L1_DoubleMu3_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleMu3"], &b_L1_DoubleMu3_Prescl); 
  fChain->SetBranchAddress("L1_DoubleMuOpen_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleMuOpen"], &b_L1_DoubleMuOpen_Prescl); 
  fChain->SetBranchAddress("L1_DoubleTauJet30_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleTauJet30"], &b_L1_DoubleTauJet30_Prescl); 
  fChain->SetBranchAddress("L1_EG10_Jet15_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_EG10_Jet15"], &b_L1_EG10_Jet15_Prescl); 
  fChain->SetBranchAddress("L1_EG5_TripleJet15_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_EG5_TripleJet15"], &b_L1_EG5_TripleJet15_Prescl); 
  fChain->SetBranchAddress("L1_ETM20_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_ETM20"], &b_L1_ETM20_Prescl); 
  fChain->SetBranchAddress("L1_ETM30_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_ETM30"], &b_L1_ETM30_Prescl); 
  fChain->SetBranchAddress("L1_ETM40_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_ETM40"], &b_L1_ETM40_Prescl); 
  fChain->SetBranchAddress("L1_ETM70_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_ETM70"], &b_L1_ETM70_Prescl); 
  fChain->SetBranchAddress("L1_ETM80_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_ETM80"], &b_L1_ETM80_Prescl); 
  fChain->SetBranchAddress("L1_ETT60_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_ETT60"], &b_L1_ETT60_Prescl); 
  fChain->SetBranchAddress("L1_HTT50_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_HTT50"], &b_L1_HTT50_Prescl); 
  fChain->SetBranchAddress("L1_HTT100_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_HTT100"], &b_L1_HTT100_Prescl); 
  fChain->SetBranchAddress("L1_HTT200_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_HTT200"], &b_L1_HTT200_Prescl); 
  fChain->SetBranchAddress("L1_HTT300_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_HTT300"], &b_L1_HTT300_Prescl); 
  fChain->SetBranchAddress("L1_IsoEG10_Jet15_ForJet10_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_IsoEG10_Jet15_ForJet10"], &b_L1_IsoEG10_Jet15_ForJet10_Prescl); 
  fChain->SetBranchAddress("L1_MinBias_HTT10_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_MinBias_HTT10"], &b_L1_MinBias_HTT10_Prescl); 
  fChain->SetBranchAddress("L1_Mu3QE8_EG5_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_Mu3QE8_EG5"], &b_L1_Mu3QE8_EG5_Prescl); 
  fChain->SetBranchAddress("L1_Mu3QE8_Jet15_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_Mu3QE8_Jet15"], &b_L1_Mu3QE8_Jet15_Prescl);  
  fChain->SetBranchAddress("L1_Mu5QE8_Jet15_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_Mu5QE8_Jet15"], &b_L1_Mu5QE8_Jet15_Prescl); 
  fChain->SetBranchAddress("L1_Mu3QE8_Jet6_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_Mu3QE8_Jet6"], &b_L1_Mu3QE8_Jet6_Prescl);  
  fChain->SetBranchAddress("L1_Mu5QE8_Jet6_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_Mu5QE8_Jet6"], &b_L1_Mu5QE8_Jet6_Prescl); 
  fChain->SetBranchAddress("L1_QuadJet15_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_QuadJet15"], &b_L1_QuadJet15_Prescl); 
  fChain->SetBranchAddress("L1_SingleEG1_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleEG1"], &b_L1_SingleEG1_Prescl); 
  fChain->SetBranchAddress("L1_SingleEG10_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleEG10"], &b_L1_SingleEG10_Prescl); 
  fChain->SetBranchAddress("L1_SingleEG12_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleEG12"], &b_L1_SingleEG12_Prescl); 
  fChain->SetBranchAddress("L1_SingleEG15_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleEG15"], &b_L1_SingleEG15_Prescl); 
  fChain->SetBranchAddress("L1_SingleEG2_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleEG2"], &b_L1_SingleEG2_Prescl); 
  fChain->SetBranchAddress("L1_SingleEG20_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleEG20"], &b_L1_SingleEG20_Prescl); 
  fChain->SetBranchAddress("L1_SingleEG5_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleEG5"], &b_L1_SingleEG5_Prescl); 
  fChain->SetBranchAddress("L1_SingleEG8_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleEG8"], &b_L1_SingleEG8_Prescl); 
  fChain->SetBranchAddress("L1_SingleHfBitCountsRing1_1_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleHfBitCountsRing1_1"], &b_L1_SingleHfBitCountsRing1_1_Prescl); 
  fChain->SetBranchAddress("L1_SingleHfBitCountsRing2_1_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleHfBitCountsRing2_1"], &b_L1_SingleHfBitCountsRing2_1_Prescl); 
  fChain->SetBranchAddress("L1_SingleHfRingEtSumsRing1_200_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleHfRingEtSumsRing1_200"], &b_L1_SingleHfRingEtSumsRing1_200_Prescl); 
  fChain->SetBranchAddress("L1_SingleHfRingEtSumsRing1_4_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleHfRingEtSumsRing1_4"], &b_L1_SingleHfRingEtSumsRing1_4_Prescl); 
  fChain->SetBranchAddress("L1_SingleHfRingEtSumsRing2_200_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleHfRingEtSumsRing2_200"], &b_L1_SingleHfRingEtSumsRing2_200_Prescl); 
  fChain->SetBranchAddress("L1_SingleHfRingEtSumsRing2_4_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleHfRingEtSumsRing2_4"], &b_L1_SingleHfRingEtSumsRing2_4_Prescl); 
  fChain->SetBranchAddress("L1_SingleIsoEG10_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleIsoEG10"], &b_L1_SingleIsoEG10_Prescl); 
  fChain->SetBranchAddress("L1_SingleIsoEG12_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleIsoEG12"], &b_L1_SingleIsoEG12_Prescl); 
  fChain->SetBranchAddress("L1_SingleIsoEG15_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleIsoEG15"], &b_L1_SingleIsoEG15_Prescl); 
  fChain->SetBranchAddress("L1_SingleIsoEG5_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleIsoEG5"], &b_L1_SingleIsoEG5_Prescl); 
  fChain->SetBranchAddress("L1_SingleIsoEG8_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleIsoEG8"], &b_L1_SingleIsoEG8_Prescl); 
  fChain->SetBranchAddress("L1_SingleJet100_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleJet100"], &b_L1_SingleJet100_Prescl); 
  fChain->SetBranchAddress("L1_SingleJet15_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleJet15"], &b_L1_SingleJet15_Prescl); 
  fChain->SetBranchAddress("L1_SingleJet30_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleJet30"], &b_L1_SingleJet30_Prescl); 
  fChain->SetBranchAddress("L1_SingleJet50_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleJet50"], &b_L1_SingleJet50_Prescl); 
  fChain->SetBranchAddress("L1_SingleJet70_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleJet70"], &b_L1_SingleJet70_Prescl); 
  fChain->SetBranchAddress("L1_SingleMu0_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleMu0"], &b_L1_SingleMu0_Prescl); 
  fChain->SetBranchAddress("L1_SingleMu10_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleMu10"], &b_L1_SingleMu10_Prescl); 
  fChain->SetBranchAddress("L1_SingleMu14_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleMu14"], &b_L1_SingleMu14_Prescl); 
  fChain->SetBranchAddress("L1_SingleMu20_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleMu20"], &b_L1_SingleMu20_Prescl); 
  fChain->SetBranchAddress("L1_SingleMu3_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleMu3"], &b_L1_SingleMu3_Prescl); 
  fChain->SetBranchAddress("L1_SingleMu5_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleMu5"], &b_L1_SingleMu5_Prescl); 
  fChain->SetBranchAddress("L1_SingleMu7_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleMu7"], &b_L1_SingleMu7_Prescl); 
  fChain->SetBranchAddress("L1_SingleMuBeamHalo_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleMuBeamHalo"], &b_L1_SingleMuBeamHalo_Prescl); 
  fChain->SetBranchAddress("L1_SingleMuOpen_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleMuOpen"], &b_L1_SingleMuOpen_Prescl); 
  fChain->SetBranchAddress("L1_SingleTauJet40_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleTauJet40"], &b_L1_SingleTauJet40_Prescl); 
  fChain->SetBranchAddress("L1_SingleTauJet60_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleTauJet60"], &b_L1_SingleTauJet60_Prescl); 
  fChain->SetBranchAddress("L1_SingleTauJet80_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleTauJet80"], &b_L1_SingleTauJet80_Prescl); 
  fChain->SetBranchAddress("L1_TripleJet30_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_TripleJet30"], &b_L1_TripleJet30_Prescl); 
  fChain->SetBranchAddress("L1_ZeroBias_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_ZeroBias"], &b_L1_ZeroBias_Prescl);
  fChain->SetBranchAddress("L1_ZeroBias_Ext_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_ZeroBias_Ext"], &b_L1_ZeroBias_Ext_Prescl);
  fChain->SetBranchAddress("L1_SingleCenJet2_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleCenJet2"], &b_L1_SingleCenJet2_Prescl); 
  fChain->SetBranchAddress("L1_SingleCenJet4_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleCenJet4"], &b_L1_SingleCenJet4_Prescl); 
  fChain->SetBranchAddress("L1_SingleForJet2_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleForJet2"], &b_L1_SingleForJet2_Prescl); 
  fChain->SetBranchAddress("L1_SingleForJet4_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleForJet4"], &b_L1_SingleForJet4_Prescl); 
  fChain->SetBranchAddress("L1_SingleTauJet2_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleTauJet2"], &b_L1_SingleTauJet2_Prescl); 
  fChain->SetBranchAddress("L1_SingleTauJet4_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleTauJet4"], &b_L1_SingleTauJet4_Prescl); 
  fChain->SetBranchAddress("L1_DoubleForJet10_EtaOpp_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleForJet10_EtaOpp"], &b_L1_DoubleForJet10_EtaOpp_Prescl); 
  fChain->SetBranchAddress("L1_BscMinBiasOR_BptxPlusORMinus_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_BscMinBiasOR_BptxPlusORMinus"], &b_L1_BscMinBiasOR_BptxPlusORMinus_Prescl); 
  fChain->SetBranchAddress("L1_DoubleMuTopBottom_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleMuTopBottom"], &b_L1_DoubleMuTopBottom_Prescl); 
  fChain->SetBranchAddress("L1_DoubleEG05_TopBottom_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleEG05_TopBottom"], &b_L1_DoubleEG05_TopBottom_Prescl);  
  fChain->SetBranchAddress("L1_SingleJet20_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleJet20"], &b_L1_SingleJet20_Prescl); 
  fChain->SetBranchAddress("L1_SingleJet40_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleJet40"], &b_L1_SingleJet40_Prescl); 
  fChain->SetBranchAddress("L1_SingleJet60_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleJet60"], &b_L1_SingleJet60_Prescl); 
  fChain->SetBranchAddress("L1_SingleTauJet10_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleTauJet10"], &b_L1_SingleTauJet10_Prescl); 
  fChain->SetBranchAddress("L1_SingleTauJet20_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleTauJet20"], &b_L1_SingleTauJet20_Prescl); 
  fChain->SetBranchAddress("L1_SingleTauJet30_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleTauJet30"], &b_L1_SingleTauJet30_Prescl); 
  fChain->SetBranchAddress("L1_SingleTauJet50_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_SingleTauJet50"], &b_L1_SingleTauJet50_Prescl); 
  fChain->SetBranchAddress("L1_DoubleJet30_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleJet30"], &b_L1_DoubleJet30_Prescl);  
  fChain->SetBranchAddress("L1_DoubleTauJet14_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_DoubleTauJet14"], &b_L1_DoubleTauJet14_Prescl); 
  fChain->SetBranchAddress("L1_TripleJet14_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_TripleJet14"], &b_L1_TripleJet14_Prescl);  
  fChain->SetBranchAddress("L1_QuadJet6_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_QuadJet6"], &b_L1_QuadJet6_Prescl); 
  fChain->SetBranchAddress("L1_IsoEG10_Jet6_ForJet6_Prescl", &map_RefL1PrescaleOfStandardHLTPath["L1_IsoEG10_Jet6_ForJet6"], &b_L1_IsoEG10_Jet6_ForJet6_Prescl); 
