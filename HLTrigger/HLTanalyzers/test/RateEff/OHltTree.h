...
private:
  ...
  std::map<TString,int> map_PrescaleBitOfStandardHLTPath;
...
void OHltTree::Init(TTree *tree)
{
  ...
  fChain->SetBranchAddress("HLT_Activity_L1A_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Activity_L1A"], &b_HLT_Activity_L1A_prescl);
  fChain->SetBranchAddress("HLT_Activity_PixelClusters_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Activity_PixelClusters"], &b_HLT_Activity_PixelClusters_prescl);
  fChain->SetBranchAddress("HLT_Activity_CSC_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Activity_CSC"], &b_HLT_Activity_CSC_prescl);
  fChain->SetBranchAddress("HLT_Activity_DT_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Activity_DT"], &b_HLT_Activity_DT_prescl);
  fChain->SetBranchAddress("HLT_Activity_DT_Tuned_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Activity_DT_Tuned"], &b_HLT_Activity_DT_Tuned_prescl);
  fChain->SetBranchAddress("HLT_Activity_Ecal_SC7_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Activity_Ecal_SC7"], &b_HLT_Activity_Ecal_SC7_prescl);
  fChain->SetBranchAddress("HLT_Activity_Ecal_SC17_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Activity_Ecal_SC17"], &b_HLT_Activity_Ecal_SC17_prescl);
  fChain->SetBranchAddress("HLT_SelectEcalSpikes_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_SelectEcalSpikes_L1R"], &b_HLT_SelectEcalSpikes_L1R_prescl);
  fChain->SetBranchAddress("HLT_SelectEcalSpikesHighEt_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_SelectEcalSpikesHighEt_L1R"], &b_HLT_SelectEcalSpikesHighEt_L1R_prescl);
  fChain->SetBranchAddress("HLT_L1SingleForJet_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1SingleForJet"], &b_HLT_L1SingleForJet_prescl);
  fChain->SetBranchAddress("HLT_L1SingleCenJet_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1SingleCenJet"], &b_HLT_L1SingleCenJet_prescl);
  fChain->SetBranchAddress("HLT_L1SingleTauJet_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1SingleTauJet"], &b_HLT_L1SingleTauJet_prescl);
  fChain->SetBranchAddress("HLT_L1Jet6U_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Jet6U"], &b_HLT_L1Jet6U_prescl);
  fChain->SetBranchAddress("HLT_L1Jet6U_NoBPTX_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Jet6U_NoBPTX"], &b_HLT_L1Jet6U_NoBPTX_prescl);
  fChain->SetBranchAddress("HLT_L1Jet10U_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Jet10U"], &b_HLT_L1Jet10U_prescl);
  fChain->SetBranchAddress("HLT_L1Jet10U_NoBPTX_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Jet10U_NoBPTX"], &b_HLT_L1Jet10U_NoBPTX_prescl);
  fChain->SetBranchAddress("HLT_Jet15U_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Jet15U"], &b_HLT_Jet15U_prescl);
  fChain->SetBranchAddress("HLT_Jet15U_HcalNoiseFiltered_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Jet15U_HcalNoiseFiltered"], &b_HLT_Jet15U_HcalNoiseFiltered_prescl);
  fChain->SetBranchAddress("HLT_Jet30U_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Jet30U"], &b_HLT_Jet30U_prescl);
  fChain->SetBranchAddress("HLT_Jet50U_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Jet50U"], &b_HLT_Jet50U_prescl);
  fChain->SetBranchAddress("HLT_FwdJet20U_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_FwdJet20U"], &b_HLT_FwdJet20U_prescl);
  fChain->SetBranchAddress("HLT_DiJetAve15U_8E29_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DiJetAve15U_8E29"], &b_HLT_DiJetAve15U_8E29_prescl);
  fChain->SetBranchAddress("HLT_DiJetAve30U_8E29_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DiJetAve30U_8E29"], &b_HLT_DiJetAve30U_8E29_prescl);
  fChain->SetBranchAddress("HLT_DiJetAve50U_8E29_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DiJetAve50U_8E29"], &b_HLT_DiJetAve50U_8E29_prescl);
  fChain->SetBranchAddress("HLT_DoubleJet15U_ForwardBackward_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DoubleJet15U_ForwardBackward"], &b_HLT_DoubleJet15U_ForwardBackward_prescl);
  fChain->SetBranchAddress("HLT_QuadJet15U_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_QuadJet15U"], &b_HLT_QuadJet15U_prescl);
  fChain->SetBranchAddress("HLT_L1MET20_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1MET20"], &b_HLT_L1MET20_prescl);
  fChain->SetBranchAddress("HLT_MET45_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_MET45"], &b_HLT_MET45_prescl);
  fChain->SetBranchAddress("HLT_MET100_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_MET100"], &b_HLT_MET100_prescl);
  fChain->SetBranchAddress("HLT_HT100U_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_HT100U"], &b_HLT_HT100U_prescl);
  fChain->SetBranchAddress("HLT_L1MuOpen_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1MuOpen"], &b_HLT_L1MuOpen_prescl);
  fChain->SetBranchAddress("HLT_L1MuOpen_DT_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1MuOpen_DT"], &b_HLT_L1MuOpen_DT_prescl);
  fChain->SetBranchAddress("HLT_L1MuOpen_AntiBPTX_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1MuOpen_AntiBPTX"], &b_HLT_L1MuOpen_AntiBPTX_prescl);
  fChain->SetBranchAddress("HLT_L1Mu_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Mu"], &b_HLT_L1Mu_prescl);
  fChain->SetBranchAddress("HLT_L1Mu20_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Mu20"], &b_HLT_L1Mu20_prescl);
  fChain->SetBranchAddress("HLT_L2Mu0_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L2Mu0"], &b_HLT_L2Mu0_prescl);
  fChain->SetBranchAddress("HLT_L2Mu3_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L2Mu3"], &b_HLT_L2Mu3_prescl);
  fChain->SetBranchAddress("HLT_L2Mu5_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L2Mu5"], &b_HLT_L2Mu5_prescl);
  fChain->SetBranchAddress("HLT_L2Mu9_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L2Mu9"], &b_HLT_L2Mu9_prescl);
  fChain->SetBranchAddress("HLT_L2Mu11_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L2Mu11"], &b_HLT_L2Mu11_prescl);
  fChain->SetBranchAddress("HLT_IsoMu3_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_IsoMu3"], &b_HLT_IsoMu3_prescl);
  fChain->SetBranchAddress("HLT_Mu3_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu3"], &b_HLT_Mu3_prescl);
  fChain->SetBranchAddress("HLT_Mu5_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu5"], &b_HLT_Mu5_prescl);
  fChain->SetBranchAddress("HLT_Mu7_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu7"], &b_HLT_Mu7_prescl);
  fChain->SetBranchAddress("HLT_Mu9_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu9"], &b_HLT_Mu9_prescl);
  fChain->SetBranchAddress("HLT_L1DoubleMuOpen_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1DoubleMuOpen"], &b_HLT_L1DoubleMuOpen_prescl);
  fChain->SetBranchAddress("HLT_L1DoubleMuOpen_Tight_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1DoubleMuOpen_Tight"], &b_HLT_L1DoubleMuOpen_Tight_prescl);
  fChain->SetBranchAddress("HLT_L2DoubleMu0_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L2DoubleMu0"], &b_HLT_L2DoubleMu0_prescl);
  fChain->SetBranchAddress("HLT_DoubleMu0_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DoubleMu0"], &b_HLT_DoubleMu0_prescl);
  fChain->SetBranchAddress("HLT_DoubleMu3_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DoubleMu3"], &b_HLT_DoubleMu3_prescl);
  fChain->SetBranchAddress("HLT_Mu0_L1MuOpen_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu0_L1MuOpen"], &b_HLT_Mu0_L1MuOpen_prescl);
  fChain->SetBranchAddress("HLT_Mu3_L1MuOpen_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu3_L1MuOpen"], &b_HLT_Mu3_L1MuOpen_prescl);
  fChain->SetBranchAddress("HLT_Mu5_L1MuOpen_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu5_L1MuOpen"], &b_HLT_Mu5_L1MuOpen_prescl);
  fChain->SetBranchAddress("HLT_Mu0_L2Mu0_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu0_L2Mu0"], &b_HLT_Mu0_L2Mu0_prescl);
  fChain->SetBranchAddress("HLT_Mu3_L2Mu0_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu3_L2Mu0"], &b_HLT_Mu3_L2Mu0_prescl);
  fChain->SetBranchAddress("HLT_Mu5_L2Mu0_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu5_L2Mu0"], &b_HLT_Mu5_L2Mu0_prescl);
  fChain->SetBranchAddress("HLT_Mu0_Track0_Jpsi_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu0_Track0_Jpsi"], &b_HLT_Mu0_Track0_Jpsi_prescl);
  fChain->SetBranchAddress("HLT_Mu0_TkMu0_Jpsi_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu0_TkMu0_Jpsi"], &b_HLT_Mu0_TkMu0_Jpsi_prescl);
  fChain->SetBranchAddress("HLT_Mu0_TkMu0_Jpsi_NoCharge_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu0_TkMu0_Jpsi_NoCharge"], &b_HLT_Mu0_TkMu0_Jpsi_NoCharge_prescl);
  fChain->SetBranchAddress("HLT_Mu3_Track0_Jpsi_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu3_Track0_Jpsi"], &b_HLT_Mu3_Track0_Jpsi_prescl);
  fChain->SetBranchAddress("HLT_Mu3_TkMu0_Jpsi_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu3_TkMu0_Jpsi"], &b_HLT_Mu3_TkMu0_Jpsi_prescl);
  fChain->SetBranchAddress("HLT_Mu3_TkMu0_Jpsi_NoCharge_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu3_TkMu0_Jpsi_NoCharge"], &b_HLT_Mu3_TkMu0_Jpsi_NoCharge_prescl);
  fChain->SetBranchAddress("HLT_Mu5_Track0_Jpsi_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu5_Track0_Jpsi"], &b_HLT_Mu5_Track0_Jpsi_prescl);
  fChain->SetBranchAddress("HLT_Mu5_TkMu0_Jpsi_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu5_TkMu0_Jpsi"], &b_HLT_Mu5_TkMu0_Jpsi_prescl);
  fChain->SetBranchAddress("HLT_Mu5_TkMu0_Jpsi_NoCharge_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Mu5_TkMu0_Jpsi_NoCharge"], &b_HLT_Mu5_TkMu0_Jpsi_NoCharge_prescl);
  fChain->SetBranchAddress("HLT_L1SingleEG2_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1SingleEG2"], &b_HLT_L1SingleEG2_prescl);
  fChain->SetBranchAddress("HLT_L1SingleEG5_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1SingleEG5"], &b_HLT_L1SingleEG5_prescl);
  fChain->SetBranchAddress("HLT_L1SingleEG8_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1SingleEG8"], &b_HLT_L1SingleEG8_prescl);
  fChain->SetBranchAddress("HLT_L1DoubleEG5_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1DoubleEG5"], &b_HLT_L1DoubleEG5_prescl);
  fChain->SetBranchAddress("HLT_Ele10_LW_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Ele10_LW_L1R"], &b_HLT_Ele10_LW_L1R_prescl);
  fChain->SetBranchAddress("HLT_Ele10_LW_EleId_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Ele10_LW_EleId_L1R"], &b_HLT_Ele10_LW_EleId_L1R_prescl);
  fChain->SetBranchAddress("HLT_Ele10_SW_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Ele10_SW_L1R"], &b_HLT_Ele10_SW_L1R_prescl);
  fChain->SetBranchAddress("HLT_Ele15_LW_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Ele15_LW_L1R"], &b_HLT_Ele15_LW_L1R_prescl);
  fChain->SetBranchAddress("HLT_Ele15_SW_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Ele15_SW_L1R"], &b_HLT_Ele15_SW_L1R_prescl);
  fChain->SetBranchAddress("HLT_Ele15_SC10_LW_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Ele15_SC10_LW_L1R"], &b_HLT_Ele15_SC10_LW_L1R_prescl);
  fChain->SetBranchAddress("HLT_Ele15_SiStrip_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Ele15_SiStrip_L1R"], &b_HLT_Ele15_SiStrip_L1R_prescl);
  fChain->SetBranchAddress("HLT_Ele20_LW_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Ele20_LW_L1R"], &b_HLT_Ele20_LW_L1R_prescl);
  fChain->SetBranchAddress("HLT_Ele20_SW_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Ele20_SW_L1R"], &b_HLT_Ele20_SW_L1R_prescl);
  fChain->SetBranchAddress("HLT_DoubleEle5_SW_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DoubleEle5_SW_L1R"], &b_HLT_DoubleEle5_SW_L1R_prescl);
  fChain->SetBranchAddress("HLT_Photon10_Cleaned_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Photon10_Cleaned_L1R"], &b_HLT_Photon10_Cleaned_L1R_prescl);
  fChain->SetBranchAddress("HLT_Photon15_Cleaned_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Photon15_Cleaned_L1R"], &b_HLT_Photon15_Cleaned_L1R_prescl);
  fChain->SetBranchAddress("HLT_Photon15_TrackIso_Cleaned_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Photon15_TrackIso_Cleaned_L1R"], &b_HLT_Photon15_TrackIso_Cleaned_L1R_prescl);
  fChain->SetBranchAddress("HLT_Photon15_LooseEcalIso_Cleaned_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Photon15_LooseEcalIso_Cleaned_L1R"], &b_HLT_Photon15_LooseEcalIso_Cleaned_L1R_prescl);
  fChain->SetBranchAddress("HLT_Photon20_Cleaned_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Photon20_Cleaned_L1R"], &b_HLT_Photon20_Cleaned_L1R_prescl);
  fChain->SetBranchAddress("HLT_Photon30_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Photon30_L1R"], &b_HLT_Photon30_L1R_prescl);
  fChain->SetBranchAddress("HLT_DoublePhoton4_eeRes_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DoublePhoton4_eeRes_L1R"], &b_HLT_DoublePhoton4_eeRes_L1R_prescl);
  fChain->SetBranchAddress("HLT_DoublePhoton4_Jpsi_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DoublePhoton4_Jpsi_L1R"], &b_HLT_DoublePhoton4_Jpsi_L1R_prescl);
  fChain->SetBranchAddress("HLT_DoublePhoton4_Upsilon_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DoublePhoton4_Upsilon_L1R"], &b_HLT_DoublePhoton4_Upsilon_L1R_prescl);
  fChain->SetBranchAddress("HLT_DoublePhoton5_Jpsi_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DoublePhoton5_Jpsi_L1R"], &b_HLT_DoublePhoton5_Jpsi_L1R_prescl);
  fChain->SetBranchAddress("HLT_DoublePhoton5_Upsilon_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DoublePhoton5_Upsilon_L1R"], &b_HLT_DoublePhoton5_Upsilon_L1R_prescl);
  fChain->SetBranchAddress("HLT_DoublePhoton5_CEP_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DoublePhoton5_CEP_L1R"], &b_HLT_DoublePhoton5_CEP_L1R_prescl);
  fChain->SetBranchAddress("HLT_DoublePhoton5_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DoublePhoton5_L1R"], &b_HLT_DoublePhoton5_L1R_prescl);
  fChain->SetBranchAddress("HLT_DoublePhoton10_L1R_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DoublePhoton10_L1R"], &b_HLT_DoublePhoton10_L1R_prescl);
  fChain->SetBranchAddress("HLT_SingleLooseIsoTau20_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_SingleLooseIsoTau20"], &b_HLT_SingleLooseIsoTau20_prescl);
  fChain->SetBranchAddress("HLT_SingleLooseIsoTau20_Trk5_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_SingleLooseIsoTau20_Trk5"], &b_HLT_SingleLooseIsoTau20_Trk5_prescl);
  fChain->SetBranchAddress("HLT_SingleLooseIsoTau25_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_SingleLooseIsoTau25"], &b_HLT_SingleLooseIsoTau25_prescl);
  fChain->SetBranchAddress("HLT_DoubleLooseIsoTau15_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DoubleLooseIsoTau15"], &b_HLT_DoubleLooseIsoTau15_prescl);
  fChain->SetBranchAddress("HLT_BTagIP_Jet50U_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_BTagIP_Jet50U"], &b_HLT_BTagIP_Jet50U_prescl);
  fChain->SetBranchAddress("HLT_BTagMu_Jet10U_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_BTagMu_Jet10U"], &b_HLT_BTagMu_Jet10U_prescl);
  fChain->SetBranchAddress("HLT_StoppedHSCP_8E29_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_StoppedHSCP_8E29"], &b_HLT_StoppedHSCP_8E29_prescl);
  fChain->SetBranchAddress("HLT_L1Mu14_L1SingleEG10_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Mu14_L1SingleEG10"], &b_HLT_L1Mu14_L1SingleEG10_prescl);
  fChain->SetBranchAddress("HLT_L1Mu14_L1SingleJet6U_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Mu14_L1SingleJet6U"], &b_HLT_L1Mu14_L1SingleJet6U_prescl);
  fChain->SetBranchAddress("HLT_L1Mu14_L1ETM30_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Mu14_L1ETM30"], &b_HLT_L1Mu14_L1ETM30_prescl);
  fChain->SetBranchAddress("HLT_ZeroBias_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_ZeroBias"], &b_HLT_ZeroBias_prescl);
  fChain->SetBranchAddress("HLT_ZeroBiasPixel_SingleTrack_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_ZeroBiasPixel_SingleTrack"], &b_HLT_ZeroBiasPixel_SingleTrack_prescl);
  fChain->SetBranchAddress("HLT_MinBiasPixel_SingleTrack_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_MinBiasPixel_SingleTrack"], &b_HLT_MinBiasPixel_SingleTrack_prescl);
  fChain->SetBranchAddress("HLT_MinBiasPixel_DoubleTrack_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_MinBiasPixel_DoubleTrack"], &b_HLT_MinBiasPixel_DoubleTrack_prescl);
  fChain->SetBranchAddress("HLT_MinBiasPixel_DoubleIsoTrack5_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_MinBiasPixel_DoubleIsoTrack5"], &b_HLT_MinBiasPixel_DoubleIsoTrack5_prescl);
  fChain->SetBranchAddress("HLT_MultiVertex6_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_MultiVertex6"], &b_HLT_MultiVertex6_prescl);
  fChain->SetBranchAddress("HLT_MultiVertex8_L1ETT60_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_MultiVertex8_L1ETT60"], &b_HLT_MultiVertex8_L1ETT60_prescl);
  fChain->SetBranchAddress("HLT_CSCBeamHalo_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_CSCBeamHalo"], &b_HLT_CSCBeamHalo_prescl);
  fChain->SetBranchAddress("HLT_CSCBeamHaloOverlapRing1_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_CSCBeamHaloOverlapRing1"], &b_HLT_CSCBeamHaloOverlapRing1_prescl);
  fChain->SetBranchAddress("HLT_CSCBeamHaloOverlapRing2_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_CSCBeamHaloOverlapRing2"], &b_HLT_CSCBeamHaloOverlapRing2_prescl);
  fChain->SetBranchAddress("HLT_CSCBeamHaloRing2or3_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_CSCBeamHaloRing2or3"], &b_HLT_CSCBeamHaloRing2or3_prescl);
  fChain->SetBranchAddress("HLT_L1_BscMinBiasOR_BptxPlusORMinus_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1_BscMinBiasOR_BptxPlusORMinus"], &b_HLT_L1_BscMinBiasOR_BptxPlusORMinus_prescl);
  fChain->SetBranchAddress("HLT_L1_BptxXOR_BscMinBiasOR_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1_BptxXOR_BscMinBiasOR"], &b_HLT_L1_BptxXOR_BscMinBiasOR_prescl);
  fChain->SetBranchAddress("HLT_L1Tech_BSC_minBias_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Tech_BSC_minBias"], &b_HLT_L1Tech_BSC_minBias_prescl);
  fChain->SetBranchAddress("HLT_L1Tech_BSC_halo_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Tech_BSC_halo"], &b_HLT_L1Tech_BSC_halo_prescl);
  fChain->SetBranchAddress("HLT_L1Tech_BSC_halo_forPhysicsBackground_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Tech_BSC_halo_forPhysicsBackground"], &b_HLT_L1Tech_BSC_halo_forPhysicsBackground_prescl);
  fChain->SetBranchAddress("HLT_L1Tech_BSC_HighMultiplicity_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Tech_BSC_HighMultiplicity"], &b_HLT_L1Tech_BSC_HighMultiplicity_prescl);
  fChain->SetBranchAddress("HLT_L1Tech_RPC_TTU_RBst1_collisions_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Tech_RPC_TTU_RBst1_collisions"], &b_HLT_L1Tech_RPC_TTU_RBst1_collisions_prescl);
  fChain->SetBranchAddress("HLT_L1Tech_HCAL_HF_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1Tech_HCAL_HF"], &b_HLT_L1Tech_HCAL_HF_prescl);
  fChain->SetBranchAddress("HLT_TrackerCosmics_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_TrackerCosmics"], &b_HLT_TrackerCosmics_prescl);
  fChain->SetBranchAddress("HLT_RPCBarrelCosmics_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_RPCBarrelCosmics"], &b_HLT_RPCBarrelCosmics_prescl);
  fChain->SetBranchAddress("HLT_IsoTrackHE_8E29_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_IsoTrackHE_8E29"], &b_HLT_IsoTrackHE_8E29_prescl);
  fChain->SetBranchAddress("HLT_IsoTrackHB_8E29_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_IsoTrackHB_8E29"], &b_HLT_IsoTrackHB_8E29_prescl);
  fChain->SetBranchAddress("HLT_HcalPhiSym_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_HcalPhiSym"], &b_HLT_HcalPhiSym_prescl);
  fChain->SetBranchAddress("HLT_HcalNZS_8E29_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_HcalNZS_8E29"], &b_HLT_HcalNZS_8E29_prescl);
  fChain->SetBranchAddress("AlCa_EcalPhiSym_prescl", &map_PrescaleBitOfStandardHLTPath["AlCa_EcalPhiSym"], &b_AlCa_EcalPhiSym_prescl);
  fChain->SetBranchAddress("AlCa_EcalPi0_8E29_prescl", &map_PrescaleBitOfStandardHLTPath["AlCa_EcalPi0_8E29"], &b_AlCa_EcalPi0_8E29_prescl);
  fChain->SetBranchAddress("AlCa_EcalEta_8E29_prescl", &map_PrescaleBitOfStandardHLTPath["AlCa_EcalEta_8E29"], &b_AlCa_EcalEta_8E29_prescl);
  fChain->SetBranchAddress("AlCa_RPCMuonNoHits_prescl", &map_PrescaleBitOfStandardHLTPath["AlCa_RPCMuonNoHits"], &b_AlCa_RPCMuonNoHits_prescl);
  fChain->SetBranchAddress("AlCa_RPCMuonNoTriggers_prescl", &map_PrescaleBitOfStandardHLTPath["AlCa_RPCMuonNoTriggers"], &b_AlCa_RPCMuonNoTriggers_prescl);
  fChain->SetBranchAddress("AlCa_RPCMuonNormalisation_prescl", &map_PrescaleBitOfStandardHLTPath["AlCa_RPCMuonNormalisation"], &b_AlCa_RPCMuonNormalisation_prescl);
  fChain->SetBranchAddress("HLT_DTErrors_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_DTErrors"], &b_HLT_DTErrors_prescl);
  fChain->SetBranchAddress("HLT_Calibration_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Calibration"], &b_HLT_Calibration_prescl);
  fChain->SetBranchAddress("HLT_EcalCalibration_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_EcalCalibration"], &b_HLT_EcalCalibration_prescl);
  fChain->SetBranchAddress("HLT_HcalCalibration_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_HcalCalibration"], &b_HLT_HcalCalibration_prescl);
  fChain->SetBranchAddress("HLT_Random_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_Random"], &b_HLT_Random_prescl);
  fChain->SetBranchAddress("HLT_PixelTracks_Multiplicity70_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_PixelTracks_Multiplicity70"], &b_HLT_PixelTracks_Multiplicity70_prescl);
  fChain->SetBranchAddress("HLT_PixelTracks_Multiplicity85_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_PixelTracks_Multiplicity85"], &b_HLT_PixelTracks_Multiplicity85_prescl);
  fChain->SetBranchAddress("HLT_GlobalRunHPDNoise_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_GlobalRunHPDNoise"], &b_HLT_GlobalRunHPDNoise_prescl);
  fChain->SetBranchAddress("HLT_TechTrigHCALNoise_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_TechTrigHCALNoise"], &b_HLT_TechTrigHCALNoise_prescl);
  fChain->SetBranchAddress("HLT_L1_BPTX_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1_BPTX"], &b_HLT_L1_BPTX_prescl);
  fChain->SetBranchAddress("HLT_L1_BPTX_MinusOnly_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1_BPTX_MinusOnly"], &b_HLT_L1_BPTX_MinusOnly_prescl);
  fChain->SetBranchAddress("HLT_L1_BPTX_PlusOnly_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L1_BPTX_PlusOnly"], &b_HLT_L1_BPTX_PlusOnly_prescl);
  fChain->SetBranchAddress("HLT_L2Mu0_NoVertex_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_L2Mu0_NoVertex"], &b_HLT_L2Mu0_NoVertex_prescl);
  fChain->SetBranchAddress("HLT_LogMonitor_prescl", &map_PrescaleBitOfStandardHLTPath["HLT_LogMonitor"], &b_HLT_LogMonitor_prescl);
