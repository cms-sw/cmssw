...
##  ## removed  ("HLT_DoubleEle45_CaloIdL_v1", "L1_SingleEG20", 1, 0.15),
##    ("HLT_Ele8_CaloIdL_CaloIsoVL_Jet40_v5", "L1_SingleEG5", 1, 0.15),
##  ## removed or renamed ("HLT_DoubleEle10_CaloIdL_TrkIdVL_Ele10_v6", "L1_TripleEG5", 1, 0.15),
##    ("OpenHLT_DoubleEle10_CaloIdL_TrkIdVL_Ele10_CaloIdT_TrkIdVL", "L1_TripleEG5", 1, 0.15),
...
##    ("OpenHLT_L2DoubleMu30_NoVertex", "L1_DoubleMu3", 1, 0.15),
...
##    ("OpenHLT_DoubleMu5_IsoMu5", "L1_DoubleMu3", 1, 0.15),
...
## ############# dataset ElectronHad ###############
##  ##removed  ("HLT_HT250_Ele5_CaloIdVL_TrkIdVL_CaloIsoVL_TrkIsoVL_PFMHT35_v5", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT200_DoubleEle5_CaloIdVL_MassJpsi", "L1_HTT100", 1, 0.15),
...
## ##removed    ("HLT_Ele15_CaloIdT_CaloIsoVL_TrkIdT_TrkIsoVL_HT200_v5", "L1_EG5_HTT75", 1, 0.15),
##    ("HLT_Ele15_CaloIdT_CaloIsoVL_TrkIdT_TrkIsoVL_HT250_v5", "L1_EG5_HTT75", 1, 0.15),
##    ("OpenHLT_Ele15_CaloIdT_CaloIsoVL_TrkIdT_TrkIsoVL_HT250_PFMHT", "L1_EG5_HTT75", 1, 0.15),
...
##  ##removed  ("HLT_Ele10_CaloIdT_TrkIdVL_CaloIsoVL_TrkIsoVL_R020_MR200_v3", "L1_DoubleJet36_Central", 1, 0.15),
##    ("OpenHLT_Ele15_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_Jet35_Jet25_Deta3_Jet20", "L1_SingleEG12", 1, 0.15),
##    ("OpenHLT_Ele17_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_Jet35_Jet25_Deta3p5_Jet25", "L1_SingleEG12", 1, 0.15),
##    ("OpenHLT_Ele15_CaloIdVT_TrkIdT_Jet35_Jet25_Deta3_Jet20", "L1_SingleEG12", 1, 0.15),
...
##    ("OpenHLT_Ele25_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_DiCentralJet30_PFMHT25", "L1_SingleEG12", 1, 0.15),
...
##  ##removed   ("HLT_Ele17_CaloIdVT_TrkIdT_CentralJet30_CentralJet25_v4", "L1_SingleEG12", 1, 0.15),
##    ("OpenHLT_Ele22_CaloIdVT_TrkIdT_CentralJet30_CentralJet25", "L1_SingleEG12", 1, 0.15),
##    ("OpenHLT_Ele22_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_CentralJet30_CentralJet25", "L1_SingleEG12", 1, 0.15),
##   ##removed ("HLT_Ele17_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_CentralJet30_CentralJet25_PFMHT15_v4", "L1_SingleEG12", 1, 0.15),
##    ("OpenHLT_Ele22_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_CentralJet30_CentralJet25_PFMHT20", "L1_SingleEG12", 1, 0.15),
...
##  ##removed   ("HLT_DoubleEle8_CaloIdL_TrkIdVL_HT150_v3", "L1_DoubleEG5_HTT50", 1, 0.15),
##    ("HLT_DoubleEle8_CaloIdT_TrkIdVL_HT150_v3", "L1_DoubleEG5_HTT50", 1, 0.15)##,
##    ("OpenHLT_DoubleEle8_CaloIdT_TrkIdVL_Mass4_HT150", "L1_DoubleEG5_HTT50", 1, 0.15)##,
## ############# dataset HT ###############
##    ("HLT_DiJet130_PT130_v3", "L1_SingleJet68", 1, 0.15),
##    ("HLT_DiJet160_PT160_v3", "L1_SingleJet92", 1, 0.15),
##    ("OpenHLT_FatJetMass300_DR1p1_Deta2p0_CentralJet30_BTagIP", "L1_HTT75", 1, 0.15),
##    ("OpenHLT_FatJetMass350_DR1p1_Deta2p0_CentralJet30_BTagIP", "L1_HTT75", 1, 0.15),
##    ("OpenHLT_FatJetMass750_DR1p1_Deta2p0", "L1_HTT75", 1, 0.15),
##    ("OpenHLT_FatJetMass850_DR1p1_Deta2p0", "L1_HTT75", 1, 0.15),
##    ("HLT_HT150_v5", "L1_HTT50", 1, 0.15),
##   ##removed  ("HLT_HT150_AlphaT0p60_v4", "L1_HTT75", 1, 0.15),
##    ("HLT_HT200_v5", "L1_HTT75", 1, 0.15),
##   ##removed ("HLT_HT200_AlphaT0p53_v3", "L1_HTT100", 1, 0.15),
##   ##removed ("HLT_HT200_AlphaT0p60_v4", "L1_HTT75", 1, 0.15),
##    ("OpenHLT_HT200_AlphaT0p55", "L1_HTT75", 1, 0.15),
##    ("HLT_HT250_v5", "L1_HTT100", 1, 0.15),
##    ("HLT_HT250_AlphaT0p53_v3", "L1_HTT100", 1, 0.15),
##   ##removed ("HLT_HT250_AlphaT0p54_v3", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT250_AlphaT0p55", "L1_HTT100", 1, 0.15),
##    ("HLT_HT250_DoubleDisplacedJet60_v4", "L1_HTT100", 1, 0.15),
##   ##removed ("HLT_HT250_MHT60_v6", "L1_HTT100", 1, 0.15),
##   ##removed ("HLT_HT250_MHT70_v3", "L1_HTT100", 1, 0.15),
##   ##removed ("HLT_HT250_MHT80_v3", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT250_MHT90", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT250_MHT100", "L1_HTT100", 1, 0.15),
##    ("HLT_HT300_v6", "L1_HTT100", 1, 0.15),
##  ##removed  ("HLT_HT300_MHT75_v7", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT300_MHT80", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT300_MHT90", "L1_HTT100", 1, 0.15),
...
##  ##removed  ("HLT_HT300_AlphaT0p52_v4", "L1_HTT100", 1, 0.15),
##    ("HLT_HT300_AlphaT0p53_v3", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT300_AlphaT0p54", "L1_HTT100", 1, 0.15),
##    ("HLT_HT350_v5", "L1_HTT100", 1, 0.15),
##  ##removed  ("HLT_HT350_AlphaT0p51_v4", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT350_AlphaT0p52", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT350_MHT70", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT350_MHT80", "L1_HTT100", 1, 0.15),
##    ("HLT_HT350_AlphaT0p53_v4", "L1_HTT100", 1, 0.15),
##    ("HLT_HT400_v5", "L1_HTT100", 1, 0.15),
##    ("HLT_HT400_AlphaT0p51_v4", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT400_AlphaT0p52", "L1_HTT100", 1, 0.15),
##    ("HLT_HT450_v5", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT450_AlphaT0p52", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT450_AlphaT0p52", "L1_HTT100", 1, 0.15),
...
##  ##removed  ("HLT_R014_MR450_CentralJet40_BTagIP_v4", "L1_DoubleJet36_Central", 1, 0.15),
##    ("HLT_R020_MR150_v3", "L1_DoubleJet36_Central", 1, 0.15),
##  ##removed  ("HLT_R020_MR350_CentralJet40_BTagIP_v4", "L1_DoubleJet36_Central", 1, 0.15),
##  ##removed  ("HLT_R020_MR500_v3", "L1_DoubleJet36_Central", 1, 0.15),
##    ("HLT_R020_MR550_v3", "L1_DoubleJet36_Central", 1, 0.15),
##    ("OpenHLT_R023_MR550", "L1_DoubleJet36_Central", 1, 0.15),
##    ("OpenHLT_R023_MR350_CentralJet40_BTagIP", "L1_DoubleJet36_Central", 1, 0.15),
##    ("OpenHLT_R023_MR400_CentralJet40_BTagIP", "L1_DoubleJet36_Central", 1, 0.15),
##    ("HLT_R025_MR150_v3", "L1_DoubleJet36_Central", 1, 0.15),
##   ##removed ("HLT_R025_MR250_CentralJet40_BTagIP_v4", "L1_DoubleJet36_Central", 1, 0.15),
##   ##removed ("HLT_R025_MR400_v3", "L1_DoubleJet36_Central", 1, 0.15),
##    ("HLT_R025_MR450_v3", "L1_DoubleJet36_Central", 1, 0.15),
##    ("OpenHLT_R029_MR450", "L1_DoubleJet36_Central", 1, 0.15),
##    ("OpenHLT_R029_MR300_CentralJet40_BTagIP", "L1_DoubleJet36_Central", 1, 0.15),
##    ("OpenHLT_R029_MR250_CentralJet40_BTagIP", "L1_DoubleJet36_Central", 1, 0.15),
##   ##removed ("HLT_R033_MR300_v3", "L1_DoubleJet36_Central", 1, 0.15),
##    ("HLT_R033_MR350_v3", "L1_DoubleJet36_Central", 1, 0.15),
##    ("OpenHLT_R033_MR200_CentralJet40_BTagIP", "L1_DoubleJet36_Central", 1, 0.15),
##    ("OpenHLT_R036_MR350", "L1_DoubleJet36_Central", 1, 0.15),
##    ("OpenHLT_R036_MR200_CentralJet40_BTagIP", "L1_DoubleJet36_Central", 1, 0.15),
##   ##removed ("HLT_R038_MR200_v3", "L1_DoubleJet36_Central", 1, 0.15),
##    ("HLT_R038_MR250_v3", "L1_DoubleJet36_Central", 1, 0.15),
##    ("OpenHLT_R042_MR250", "L1_DoubleJet36_Central", 1, 0.15)##,
## ############# dataset Photon -no new paths yet ###############
...
##  ##removed  ("HLT_Photon70_CaloIdL_MHT50_v6", "L1_SingleEG20", 1, 0.15),
##    ("HLT_Photon70_CaloIdL_MHT70_v5", "L1_SingleEG20", 1, 0.15),
##    ("OpenHLT_Photon70_CaloIdL_MHT90", "L1_SingleEG20", 1, 0.15),
##    ("HLT_Photon40_R005_MR150_v3", "L1_SingleEG20", 1, 0.15),
##  ##removed  ("HLT_Photon40_R014_MR450_v3", "L1_SingleEG20", 1, 0.15),
##    ("OpenHLT_Photon40_R014_MR500_v3", "L1_SingleEG20", 1, 0.15),
...
##    ("OpenHLT_Ele27_WP80_PFMT50", "L1_SingleEG15", 1, 0.15),
...
##    ("OpenHLT_Ele32_WP70_PFMT50", "L1_SingleEG15", 1, 0.15),
...
##    ("OpenHLT_Jet240_CentralJet30_BTagIP", "L1_SingleJet92", 1, 0.15),
##    ("OpenHLT_Jet270_CentralJet30_BTagIP", "L1_SingleJet92", 1, 0.15),
...
############# dataset SingleMu ###############
   ...
   ("OpenHLT_IsoMu17_eta2p1", "L1_SingleMu10", 1, 0.15),
   ("OpenHLT_IsoMu20_eta2p1", "L1_SingleMu10", 1, 0.15),
...
##    ("OpenHLT_Mu5_Ele8_CaloIdT_TrkIdVL_Ele8_CaloIdL_TrkIdVL", "L1_MuOpen_EG5", 1, 0.15),
##    ("HLT_Mu8_Ele17_CaloIdL_v5", "L1_MuOpen_EG5", 1, 0.15),
##    ("OpenHLT_Mu8_Ele17_CaloIdT_CaloIsoVL", "L1_MuOpen_EG5", 1, 0.15),
...
##    ("OpenHLT_Mu17_Ele8_CaloIdT_CaloIsoVL", "L1_MuOpen_EG5", 1, 0.15),
##   ##removed ("HLT_DoubleMu5_Ele8_v6", "L1_MuOpen_EG5", 1, 0.15),
##    ("HLT_DoubleMu5_Ele8_CaloIdL_TrkIdVL_v6", "L1_MuOpen_EG5", 1, 0.15),
##    ("OpenHLT_DoubleMu5_Ele8_CaloIdT_TrkIdVL", "L1_MuOpen_EG5", 1, 0.15)##,
## ############# dataset MuHad ###############
## ##removed   ("HLT_Mu3_Ele8_CaloIdL_TrkIdVL_HT150_v3", "L1_Mu0_HTT50", 1, 0.15),
##    ("HLT_Mu3_Ele8_CaloIdT_TrkIdVL_HT150_v3", "L1_Mu0_HTT50", 1, 0.15),
##    ("HLT_Mu8_R005_MR200_v3", "L1_DoubleJet36_Central", 1, 0.15),
##   ##removed ("HLT_Mu8_R020_MR200_v3", "L1_DoubleJet36_Central", 1, 0.15),
##    ("HLT_Mu8_R025_MR200_v3", "L1_DoubleJet36_Central", 1, 0.15),
##   ##removed ("HLT_HT250_Mu5_PFMHT35_v5", "L1_HTT100", 1, 0.15),
##    ("HLT_HT250_Mu15_PFMHT20_v3", "L1_HTT100", 1, 0.15),
##    ("OpenHLT_HT250_Mu15_PFMHT40", "L1_HTT100", 1, 0.15),
...
##    ("OpenHLT_Mu12_DiCentralJet30_DiBTagIP3D1stTrack", "L1_SingleMu10", 1, 0.15),
##    ("HLT_Mu17_CentralJet30_BTagIP_v5", "L1_SingleMu10", 1, 0.15),
##  ##removed  ("HLT_Mu15_HT200_v3", "L1_Mu0_HTT50", 1, 0.15),
##  ##removed  ("HLT_Mu20_HT200_v3", "L1_Mu0_HTT50", 1, 0.15),
##    ("OpenHLT_Mu30_HT200", "L1_Mu0_HTT50", 1, 0.15),
##    ("OpenHLT_Mu40_HT200", "L1_Mu0_HTT50", 1, 0.15),
...
##    ("OpenHLT_DoubleMu3_Mass4_HT150", "L1_Mu0_HTT50", 1, 0.15)##,
## ############# dataset Tau ###############
...
##  ##removed  ("HLT_HT250_DoubleIsoPFTau10_Trk3_PFMHT35_v3", "L1_HTT100", 1, 0.15),
