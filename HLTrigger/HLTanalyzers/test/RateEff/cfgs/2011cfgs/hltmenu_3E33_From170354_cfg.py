...
##    ("HLT_BTagMu_DiJet110_Mu5_v9", "L1_Mu3_Jet28_Central", 2, 0.15)
...
## ############# dataset DoubleMu ###############
##   ("HLT_L1DoubleMu0_v4", "L1_DoubleMu0", 5., 0.15),
##   ("HLT_L2DoubleMu0_v7", "L1_DoubleMu0", 5., 0.15),
##   ("HLT_L2DoubleMu23_NoVertex_v7", "L1_DoubleMu3", 15., 0.15),
##   ("HLT_L2DoubleMu30_NoVertex_v3", "L1_DoubleMu3", 8., 0.15),
##   ("HLT_DoubleMu3_v9", "L1_DoubleMu0", 3.5, 0.15),
##   ("HLT_DoubleMu6_v7", "L1_DoubleMu3", 3.5, 0.15),
##   ("HLT_DoubleMu7_v7", "L1_DoubleMu3", 3.5, 0.15),
##   ("HLT_DoubleMu45_v5", "L1_DoubleMu3", 1., 0.15),
##   ("HLT_DoubleMu5_Acoplanarity03_v5", "L1_DoubleMu3p5", 80., 0.15),
##   ("OpenHLT_DoubleMu6_Acoplanarity03", "L1_DoubleMu3p5", 1., 0.15),
##   ("HLT_Mu13_Mu8_v6", "L1_DoubleMu3p5", 1., 0.15),
##   ("HLT_Mu17_Mu8_v6", "L1_DoubleMu3p5", 1., 0.15),
##   ("HLT_TripleMu5_v8", "L1_TripleMu0", 1., 0.15),
##   ("HLT_DoubleMu5_IsoMu5_v7", "L1_TripleMu0", 1., 0.15),
##   ("OpenHLT_DiMuon6_LowMass", "L1_DoubleMu3", 1., 0.15),
##   ("HLT_Mu8_Jet40_v9", "L1_Mu3_Jet20_Central", 3., 0.15)#,
## ############# dataset ElectronHad ###############
##   ("HLT_HT200_DoubleEle5_CaloIdVL_MassJPsi_v2", "L1_HTT100", 4, 0.15),#
##   ("HLT_Ele15_CaloIdT_CaloIsoVL_TrkIdT_TrkIsoVL_v1", "L1_SingleEG12", 1, 0.15),#
##   ("HLT_DoubleEle8_CaloIdT_TrkIdVL_v2", "L1_DoubleEG5", 2, 0.15),
...
##   ("HLT_Ele8_CaloIdT_TrkIdT_DiJet30_v4", "L1_EG5_DoubleJet20_Central", 2, 0.15),#seed ?
...
##   ("OpenHLT_Ele30_CaloIdT_TrkIdT_HT350", "L1_EG5_HTT100", 1, 0.15),#anywhere to be found except on the twiki  ?
##   ("OpenHLT_Ele60_CaloIdT_TrkIdT_HT400", "L1_EG5_HTT100", 1, 0.15),#
##   ("OpenHLT_Ele12_CaloIdL_CaloIsoVL_TrkIdVL_TrkIsoVL_R005_MR200", "L1_DoubleJet44_Central", 50, 0.15),
##   ("OpenHLT_Ele12_CaloIdL_CaloIsoVL_TrkIdVL_TrkIsoVL_R025_MR200", "L1_DoubleJet44_Central", 1, 0.15),
##   ("OpenHLT_Ele12_CaloIdL_CaloIsoVL_TrkIdVL_TrkIsoVL_R029_MR200", "L1_DoubleJet44_Central", 1, 0.15),
##   ("HLT_Ele25_CaloIdVT_TrkIdT_CentralJet30_v7", "L1_SingleEG20", 4, 0.15),#
##   ("HLT_Ele25_CaloIdVT_TrkIdT_DiCentralJet30_v6", "L1_SingleEG20", 8, 0.15),#
##   ("HLT_Ele25_CaloIdVT_TrkIdT_TriCentralJet30_v6", "L1_SingleEG20", 2, 0.15),#
##   ("HLT_Ele25_CaloIdVT_TrkIdT_QuadCentralJet30_v3", "L1_SingleEG20", 1, 0.15),#
##   ("HLT_Ele25_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_CentralJet30_v3", "L1_SingleEG20", 4, 0.15),#
##   ("HLT_Ele25_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_DiCentralJet30_v3", "L1_SingleEG20",3, 0.15),#
##   ("HLT_Ele25_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_TriCentralJet30_v3", "L1_SingleEG20", 1, 0.15),#
##   ("HLT_Ele25_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_QuadCentralJet30_v3", "L1_SingleEG20", 1, 0.15),#
##   ("HLT_Ele25_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_CentralJet30_BTagIP_v3", "L1_SingleEG20", 1, 0.15),##
##   ("HLT_Ele25_CaloIdVT_TrkIdT_CentralJet30_BTagIP_v7", "L1_SingleEG20", 5, 0.15),##backup, 0.5
##   ("OpenHLT_Ele20_CaloIdVT_TrkIdT_Jet35_Jet25_Deta3_Jet20", "L1_SingleEG15", 10, 0.15),#
##   ("OpenHLT_Ele20_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_Jet35_Jet25_Deta3_Jet20", "L1_SingleEG15", 1, 0.15),#
##   ("OpenHLT_Ele22_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_Jet35_Jet25_Deta3p5_Jet25", "L1_SingleEG15", 1, 0.15),#
##   ("OpenHLT_Ele27_CaloIdVT_TrkIdT_CentralJet30_CentralJet25", "L1_SingleEG15", 20, 0.15),#
##   ("OpenHLT_Ele27_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_CentralJet30_CentralJet25", "L1_SingleEG15", 15, 0.15),#
##   ("OpenHLT_Ele27_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_CentralJet30_CentralJet25_PFMHT20", "L1_SingleEG15", 1, 0.15),#
##   ("OpenHLT_Ele30_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_DiCentralJet30_PFMHT25", "L1_SingleEG15", 1, 0.15),
...
## ############# dataset MultiJet ###############
##   ("HLT_DoubleJet30_ForwardBackward_v7", "L1_DoubleForJet32_EtaOpp", 3, 0.15), 
...
##   ("HLT_CentralJet60_CentralJet53_DiBTagIP3D_v1", "L1_DoubleJet44_Central", 0, 0.15), 
##   ("OpenHLT_CentralJet46_CentralJet38_CentralJet20_DiBTagIP3D","L1_TripleJet_36_36_12_Central", 1, 0.15), 
##   ("OpenHLT_DiCentralJet46_BTagIP3DLoose", "L1_DoubleJet36_Central", 1, 0.15), 
##   ("HLT_QuadJet40_v7", "L1_QuadJet20_Central", 5, 0.15), 
##   ("HLT_QuadJet40_IsoPFTau40_v11", "L1_QuadJet20_Central", 12, 0.15), 
##   ("HLT_QuadJet45_IsoPFTau45_v6", "L1_QuadJet20_Central", 1, 0.15), 
##   ("HLT_QuadJet50_Jet40_Jet30_v3", "L1_QuadJet20_Central", 1, 0.15), 
##   ("HLT_QuadJet70_v6", "L1_QuadJet20_Central", 1, 0.15), #no backup 
##   ("HLT_EightJet120_v1", "L1_QuadJet20_Central", 1, 0.15), 
##   ("HLT_ExclDiJet60_HFOR_v6", "L1_SingleJet36", 1, 0.15), 
##   ("HLT_ExclDiJet60_HFAND_v6", "L1_SingleJet36_FwdVeto5", 5, 0.15),# expected 1Hz. unprescale in the twiki 
##   ("HLT_L1ETM30_v4", "L1_ETM30", 3, 0.15), 
##   ("HLT_L1DoubleJet36Central_v4", "L1_DoubleJet36_Central", 1, 0.15), 
##   ("HLT_L1MultiJet_v4", "L1_HTT50 OR L1_TripleJet28_Central OR L1_QuadJet20_Central", 2, 0.15)#, 
## ############# dataset MuEG ###############
##   ("HLT_Mu3_Ele8_CaloIdT_CaloIsoVL_v2", "L1_Mu3_EG5", 9, 0.15),
...
##   ("HLT_Mu8_Ele17_CaloIdL_v8", "L1_MuOpen_EG12", 10, 0.15),#users ?
##   ("HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_v3", "L1_MuOpen_EG12", 1, 0.15),
##   ("HLT_Mu8_Photon20_CaloIdVT_IsoT_v8", "L1_MuOpen_EG12", 2, 0.15),#?
##   ("HLT_Mu15_Photon20_CaloIdL_v9", "L1_MuOpen_EG12", 2, 0.15),#?
##   ("HLT_Mu15_DoublePhoton15_CaloIdL_v9", "L1_Mu7_EG5", 1, 0.15),#?
##   ("HLT_Mu17_Ele8_CaloIdL_v8", "L1_Mu7_EG5", 0, 0.15),#?
...
## ############# dataset MuHad ###############
   ("OpenHLT_Mu5_Ele8_CaloIdT_TrkIdVL_HT150", "L1_Mu0_HTT50", 1, 0.15), 
   ("OpenHLT_Mu5_Ele8_CaloIdT_TrkIdVL_Mass4_HT150", "L1_Mu0_HTT50", 1, 0.15), 
   ("OpenHLT_Mu10_R005_MR200", "L1_DoubleJet44_Central", 60, 0.15), 
   ("OpenHLT_Mu10_R025_MR200", "L1_DoubleJet44_Central", 1, 0.15), 
   ("OpenHLT_Mu10_R029_MR200", "L1_DoubleJet44_Central", 1, 0.15),#L1_DoubleJet44_Central 
   ("HLT_HT250_Mu15_PFMHT40_v3", "L1_HTT100", 1, 0.15), 
   ("OpenHLT_HT300_Mu15_PFMHT40", "L1_HTT100", 1, 0.15), 
   ("HLT_HT300_Mu5_PFMHT40_v7", "L1_HTT100", 1, 0.15), 
   ("HLT_HT350_Mu5_PFMHT45_v7", "L1_HTT100", 1, 0.15), 
   ("HLT_Mu3_DiJet30_v6", "L1_Mu3_Jet20_Central", 8, 0.15), 
   ("HLT_Mu3_TriJet30_v6", "L1_Mu3_Jet20_Central", 7, 0.15), 
   ("HLT_Mu3_QuadJet30_v6", "L1_Mu3_Jet20_Central", 6, 0.15), 
   ("HLT_Mu17_CentralJet30_v10", "L1_SingleMu10", 5, 0.15), 
   ("HLT_Mu17_DiCentralJet30_v10", "L1_SingleMu10", 6, 0.15), 
   ("HLT_Mu17_TriCentralJet30_v10", "L1_SingleMu10", 5, 0.15), 
   ("HLT_Mu17_QuadCentralJet30_v5", "L1_SingleMu10", 10, 0.15), 
   ("HLT_Mu12_DiCentralJet30_BTagIP3D_v5", "L1_SingleMu10", 50, 0.15), 
   ("HLT_Mu12_DiCentralJet20_BTagIP3D1stTrack_v2", "L1_SingleMu10", 150, 0.15), 
   ("HLT_Mu12_DiCentralJet20_DiBTagIP3D1stTrack_v3", "L1_SingleMu10", 1, 0.15), 
   ("HLT_Mu17_CentralJet30_BTagIP_v9", "L1_SingleMu10", 5, 0.15), 
   ("HLT_Mu40_HT200_v3", "L1_Mu0_HTT50", 1, 0.15), 
   ("OpenHLT_Mu60_HT200", "L1_Mu0_HTT50", 1, 0.15), 
   ("HLT_IsoMu17_CentralJet30_v5", "L1_SingleMu10", 3, 0.15), 
   ...
   ("OpenHLT_DoubleMu5_HT150", "L1_Mu0_HTT50", 1, 0.15), 
   ("OpenHLT_DoubleMu5_Mass4_HT150", "L1_Mu0_HTT50", 1, 0.15)#, 
...
##   ("OpenHLT_Photon70_CaloIdL_HT500", "L1_SingleEG20", 1, 0.15),
##   ("HLT_Photon70_CaloIdL_MHT90_v2", "L1_SingleEG20", 1, 0.15),
##   ("OpenHLT_Photon70_CaloIdL_MHT110", "L1_SingleEG20", 1, 0.15),
##   ("HLT_Photon40_CaloIdL_R005_MR150_v4", "L1_SingleEG20", 3, 0.15),
##   ("HLT_Photon40_CaloIdL_R042_MR200_v2", "L1_SingleEG20", 1, 0.15),
##   ("OpenHLT_Photon55_CaloIdL_R042_MR200", "L1_SingleEG20", 1, 0.15),
##   ("HLT_Photon40_CaloIdL_R029_MR250_v2", "L1_SingleEG20", 1, 0.15),
##   ("OpenHLT_Photon55_CaloIdL_R029_MR250", "L1_SingleEG20", 1, 0.15),
##   ("HLT_Photon40_CaloIdL_R023_MR350_v2", "L1_SingleEG20", 1, 0.15),
##   ("OpenHLT_Photon55_CaloIdL_R023_MR350", "L1_SingleEG20", 1, 0.15),
##   ("HLT_Photon40_CaloIdL_R017_MR500_v2", "L1_SingleEG20", 1, 0.15),
##   ("OpenHLT_Photon55_CaloIdL_R017_MR500", "L1_SingleEG20", 1, 0.15),
##   ("HLT_Photon30_CaloIdVT_CentralJet20_BTagIP_v1", "L1_SingleEG15", 10, 0.15)#,
...
## ############# dataset SingleMu ###############
##   ("HLT_L1SingleMu10_v4", "L1_SingleMu10", 4, 0.15),
##   ("HLT_L1SingleMu20_v4", "L1_SingleMu20", 4, 0.15),
##   ("HLT_L2Mu10_v6", "L1_SingleMu10", 4, 0.15),
##   ("HLT_L2Mu20_v6", "L1_SingleMu12", 4, 0.15),
...
##   ("HLT_IsoPFTau40_IsoPFTau30_Trk5_eta2p1_v2", "L1_DoubleTauJet36_Eta2p17 OR L1_DoubleJet44_Central", 20, 0.15)
 ############# dataset TauPlusX ###############
##   ("OpenHLT_Ele18_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_MediumIsoPFTau20", "L1_SingleEG15", 1, 0.15),
##   ("OpenHLT_Ele18_CaloIdVT_TrkIdT_MediumIsoPFTau20", "L1_SingleEG15", 90, 0.15),
##   ("OpenHLT_Ele20_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_MediumIsoPFTau20", "L1_SingleEG18 OR L1_SingleEG20", 1, 0.15),
##   ("HLT_IsoMu15_LooseIsoPFTau15_v8", "L1_SingleMu10", 1, 0.15),
##   ("HLT_IsoMu15_LooseIsoPFTau20_v6", "OpenL1_SingleMu14_Eta2p1", 1, 0.15),
##   ("OpenHLT_IsoMu15_MediumIsoPFTau20", "OpenL1_SingleMu14_Eta2p1", 1, 0.15),
##   ("HLT_IsoMu15_TightIsoPFTau20_v6", "OpenL1_SingleMu14_Eta2p1", 1, 0.15),
##BIASED   ("OpenHLT_Mu15_LooseIsoPFTau20", "L1_SingleMu10", 70, 0.15),
##BIASED   ("OpenHLT_IsoMu15", "OpenL1_SingleMu14_Eta2p1", 100, 0.15),
...
#
  ...
  ("L1_InterBunch_Bsc", 1),
  ("L1_Mu3_EG5", 1),
  ("L1_Mu3_Jet16_Central", 30),
  ("L1Tech_RPC_TTU_pointing_Cosmics.v0", 1),
  ("L1_Mu3_Jet28_Central", 6),
  ("L1_PreCollisions", 1),
