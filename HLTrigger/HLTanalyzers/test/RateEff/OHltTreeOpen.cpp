      ...
      int it)
{
   ...
   else if (menu->GetTriggerName(it).CompareTo("OpenHLT_Photon32_CaloIdL_Photon32_CaloIdL") == 0)
   {
      if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1)
      {
         if (prescaleResponse(menu, cfg, rcounter, it))
         {
            if (OpenHltPhoCuts(32, 0.15, 0.10, 0.014, 0.034, 999, 999) >= 1
                  && OpenHltPhoCuts(32, 0.15, 0.10, 0.014, 0.034, 999, 999)
                        >= 2)
            {
               triggerBit[it] = true;
            }
   ...
   else if (menu->GetTriggerName(it).CompareTo("OpenHLT_Photon28_CaloIdL_Photon26_CaloIdL") == 0)
   {
      if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1)
      {
         if (prescaleResponse(menu, cfg, rcounter, it))
         {
            if (OpenHltPhoCuts(28, 0.15, 0.10, 0.014, 0.034, 999, 999) >= 1
                  && OpenHltPhoCuts(26, 0.15, 0.10, 0.014, 0.034, 999, 999)
                        >= 2)
            {
               triggerBit[it] = true;
            }
      ...
      if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1)
      {
         if (prescaleResponse(menu, cfg, rcounter, it))
            if (OpenHltPhoCuts(32, 0.15, 0.1, 999, 999, 999, 999) >= 1
                  && OpenHltPhoCuts(26, 0.15, 0.1, 999, 999, 999, 999) >= 2)
            {
               triggerBit[it] = true;
            }
      }
      ...
      if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1)
      {
         if (prescaleResponse(menu, cfg, rcounter, it))
         {
            if (OpenHlt1PhotonSamHarperPassed(65., 0, // ET, L1isolation
                  ...
                  0.2,
                  0.2, // H iso barrel, H iso endcap
                  0.2,
                  0.2, // E iso barrel, E iso endcap
                  0.05,
                  0.05, // H/E barrel, H/E endcap
                  0.014,
                  0.035, // cluster shape barrel, cluster shape endcap
   ...
   else if (menu->GetTriggerName(it).CompareTo("OpenHLT_Ele10_MET45") == 0)
   {
      if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1)
      {
         ...
         {
            if (recoMetCal > 45
                  && OpenHlt1ElectronPassed(10., 0., 9999., 9999.)>=1)
            {
               triggerBit[it] = true;
            }
         }
   ...
   else if (menu->GetTriggerName(it).CompareTo("OpenHLT_Ele12_MET45") == 0)
   {
      if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1)
      {
         ...
         {
            if (recoMetCal > 45
                  && OpenHlt1ElectronPassed(12., 0., 9999., 9999.)>=1)
            {
               triggerBit[it] = true;
            }
         }
   ...
   else if (menu->GetTriggerName(it).CompareTo("OpenHLT_DoubleMu5_1IsoMu5_Ele8_CaloIdT_TrkIdT") == 0)
   {
      if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1)
      {
         if (prescaleResponse(menu, cfg, rcounter, it))
         {
            if (OpenHlt2MuonPassed(3., 4., 5., 2., 0)>=2&&OpenHlt1MuonPassed(
                  3.,
                  4.,
                  5.,
                  2.,
                  1)>=1 &&OpenHlt1ElectronSamHarperPassed(8., 0, // ET, L1isolation 
                  999.,
                  999., // Track iso barrel, Track iso endcap 
                  999.,
                  999., // Track/pT iso barrel, Track/pT iso endcap 
   ...
   else if (menu->GetTriggerName(it).CompareTo("OpenHLT_DoubleIsoMu5_Ele8_CaloIdT_TrkIdT") == 0)
   {
      if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1)
      {
         if (prescaleResponse(menu, cfg, rcounter, it))
         {
            if (OpenHlt2MuonPassed(3., 4., 5., 2., 0)>=2&&OpenHlt2MuonPassed(
                  3.,
                  4.,
                  5.,
                  2.,
                  1)>=2 &&OpenHlt1ElectronSamHarperPassed(8., 0, // ET, L1isolation 
                  999.,
                  999., // Track iso barrel, Track iso endcap 
                  999.,
                  999., // Track/pT iso barrel, Track/pT iso endcap 
   ...
   else if (menu->GetTriggerName(it).CompareTo("OpenHLT_TripleEle10_SW") == 0)
   {
      if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1)
      {
         if (prescaleResponse(menu, cfg, rcounter, it))
         {
            if (OpenHlt2ElectronsSamHarperPassed( 10., 0, // ET, L1isolation
                  999.,
                  999., // Track iso barrel, Track iso endcap
                  999.,
                  999., // Track/pT iso barrel, Track/pT iso endcap
      ...
      if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1)
      {
         if (prescaleResponse(menu, cfg, rcounter, it))
         {
            if (OpenHlt3ElectronsSamHarperPassed(10., 0, // ET, L1isolation
                  ...
                  999.,
                  999. // Dphi barrel, Dphi endcap
            )>=3 && OpenHlt1ElectronSamHarperPassed(10., 0, // ET, L1isolation
                  999.,
                  999., // Track iso barrel, Track iso endcap
                  999.,
                  999., // Track/pT iso barrel, Track/pT iso endcap
   ...
   else if (menu->GetTriggerName(it).CompareTo("OpenHLT_TripleEle10_3CaloIdL_3TrkIdVL_1CaloIdT_1TrkIdT")
         == 0)
   {
      if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1)
      {
         if (prescaleResponse(menu, cfg, rcounter, it))
         {
            if (OpenHlt3ElectronsSamHarperPassed(10., 0, // ET, L1isolation
                  ...
                  0.15,
                  0.10 // Dphi barrel, Dphi endcap
            )>=3 &&OpenHlt1ElectronSamHarperPassed(8., 0, // ET, L1isolation
                  999.,
                  999., // Track iso barrel, Track iso endcap
                  999.,
                  999., // Track/pT iso barrel, Track/pT iso endcap
   ...
   else if (menu->GetTriggerName(it).BeginsWith("OpenHLT_Photon26")==1)
   {
      ...
      sprintf(
            pathNamePhotonLooserIsolPhoton,
      ...
      sprintf(
            pathNamePhotonCaloIdLIsoVLPhoton,
      ...
      sprintf(
            pathNamePhotonIsolCaloIdPhoton,
            "OpenHLT_Photon%d_IsoT_CaloIdL_Photon%d",
            upperEt,
            lowerEt);
      // Two leg VLIsol + CaloIdL
      char pathNamePhotonIsoVLCaloIdLPhotonIsoVLCaloIdL[100];
      sprintf(
            pathNamePhotonIsoVLCaloIdLPhotonIsoVLCaloIdL,
      ...
      sprintf(
            pathNamePhotonIsolCaloIdLooseHEPhoton,
            "OpenHLT_Photon%d_IsoT_CaloIdL_LooseHE_Photon%d",
            upperEt,
            lowerEt);
      // Both legs Isol
      char pathNamePhotonIsolPhotonIsol[100];
      sprintf(
            pathNamePhotonIsolPhotonIsol,
      ...
      sprintf(
            pathNamePhotonIsolVLPhotonIsolVL,
      ...
      sprintf(
            pathNamePhotonIsolCaloIdPhotonIsolCaloId,
            "OpenHLT_Photon%d_IsoT_CaloIdL_Photon%d_IsoT_CaloIdL",
            upperEt,
            lowerEt);
      ...
      sprintf(
            pathNamePhotonIsolPhotonMass60,
            "OpenHLT_Photon%d_Isol_Photon%d_Mass60",
            upperEt,
            lowerEt);
      // One leg Isol + CaloId + Mass>60
      char pathNamePhotonIsolCaloIdPhotonMass60[100];
      sprintf(
            pathNamePhotonIsolCaloIdPhotonMass60,
            "OpenHLT_Photon%d_Isol_CaloId_Photon%d_Mass60",
            upperEt,
            lowerEt);
      // Both legs Isol  + Mass>60
      char pathNamePhotonIsolPhotonIsolMass60[100];
      sprintf(
            pathNamePhotonIsolPhotonIsolMass60,
            "OpenHLT_Photon%d_Isol_Photon%d_Isol_Mass60",
            upperEt,
            lowerEt);
      // Both legs Isol + CaloId + Mass>60
      char pathNamePhotonIsolCaloIdPhotonIsolCaloIdMass60[100];
      sprintf(
            pathNamePhotonIsolCaloIdPhotonIsolCaloIdMass60,
            "OpenHLT_Photon%d_Isol_CaloId_Photon%d_Isol_CaloId_Mass60",
            upperEt,
            lowerEt);
         ...
         if (TMath::Abs(ohPhotEta[i]) < 2.65)
         {
            if (ohPhotL1iso[i] >= L1iso)
            {
               if (ohPhotTiso[i] < Tiso + 0.001*ohPhotEt[i])
               {
                  ...
                  {
                     if ( (TMath::Abs(ohPhotEta[i]) < 1.479 && ohPhotHiso[i]
                           < HisoBR + 0.0025*ohPhotEt[i] && ohEleClusShap[i]
                           < ClusShapEB && ohPhotR9[i] < R9) || (1.479
                           < TMath::Abs(ohPhotEta[i])
                           && TMath::Abs(ohPhotEta[i]) < 2.65 && ohPhotHiso[i]
                           < HisoEC + 0.0025*ohPhotEt[i] && ohEleClusShap[i]
                           < ClusShapEC))
                     {
