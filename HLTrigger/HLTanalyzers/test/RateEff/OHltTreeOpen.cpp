...
bool isHTX_Mu5_pfMHTXTrigger( 
			     TString triggerName,
			     vector<double> &thresholds)
{
  TString pattern = "(OpenHLT_HT([0-9]+)_Mu5_pfMHT([0-9]+))$";
  TPRegexp matchThreshold(pattern);
...
bool isHTX_Mu15_pfMHTXTrigger( 
			      TString triggerName,
			      vector<double> &thresholds)
{
  TString pattern = "(OpenHLT_HT([0-9]+)_Mu15_pfMHT([0-9]+))$";
  TPRegexp matchThreshold(pattern);
			    ...
			    int it)
{
  ...
  /****RX(U)_MRX(U)************/
  ...
  else if (isPhotonX_R0X_MRXTrigger(triggerName, thresholds))
    {
      if (map_L1BitOfStandardHLTPath.find(triggerName)->second==1)
	{
      ...
      if (map_L1BitOfStandardHLTPath.find(triggerName)->second==1)
	{
	  if (prescaleResponse(menu, cfg, rcounter, it))
	    {
	      if (OpenHlt1MuonPassed(3., 4., thresholds[2], 2., 0)>=1)
		{
		  if (OpenHltRPassed(thresholds[0], thresholds[1], false, 7, 40.)>0)
		    triggerBit[it] = true;
		}
	    }
	}
      ...
      if (map_L1BitOfStandardHLTPath.find(triggerName)->second==1)
	{
	  if (prescaleResponse(menu, cfg, rcounter, it))
	    {
	      if (OpenHlt1MuonPassed(3., 4., thresholds[1], 2., 0)>=1)
		{
  ...
  else if (isEleLX_R0X_MRXTrigger(triggerName, thresholds))
    {
      if (map_L1BitOfStandardHLTPath.find(triggerName)->second==1)
	{
	  if (prescaleResponse(menu, cfg, rcounter, it))
  ...
  else if (isEleTX_R0X_MRXTrigger(triggerName, thresholds))
    {
      if (map_L1BitOfStandardHLTPath.find(triggerName)->second==1)
	{
	  if (prescaleResponse(menu, cfg, rcounter, it))
...
/// SingleJet BTAG
  ...
  else if (triggerName.CompareTo("OpenHLT_Mu17_Mu8") == 0)
    {
      if (map_L1BitOfStandardHLTPath.find(triggerName)->second==1)
        {
          if (prescaleResponse(menu, cfg, rcounter, it))
...
else if (triggerName.CompareTo("OpenHLT_DoubleEle8_CaloIdT_TrkIdT_v1") == 0)//new
{
  ...
  // 2011-04-26
  else if (triggerName.CompareTo("OpenHLT_Photon200_NoHE_v1") == 0)//new
    {
      if (map_L1BitOfStandardHLTPath.find(triggerName)->second==1)
	{
	  if (prescaleResponse(menu, cfg, rcounter, it))
...
//2011-05-22
  ...
  // 2011-03-29 promoted to v2 TODO check
   ...
   else if (triggerName.CompareTo("OpenHLT_Ele25_CaloIdVT_TrkIdT_CentralJet30_v3") == 0)
   {
      if (map_L1BitOfStandardHLTPath.find(triggerName)->second==1)
      {
         if (prescaleResponse(menu, cfg, rcounter, it))
   ...
   else if (triggerName.CompareTo("OpenHLT_Ele25_CaloIdVT_TrkIdT_CentralDiJet30_v3") == 0)
   {
      if (map_L1BitOfStandardHLTPath.find(triggerName)->second==1)
      {
         if (prescaleResponse(menu, cfg, rcounter, it))
   ...
   else if (triggerName.CompareTo("OpenHLT_Ele25_CaloIdVT_TrkIdT_CentralTriJet30_v3") == 0)
   {
      if (map_L1BitOfStandardHLTPath.find(triggerName)->second==1)
      {
         if (prescaleResponse(menu, cfg, rcounter, it))
   ...
   else if (triggerName.CompareTo("OpenHLT_Ele25_CaloIdVT_TrkIdT_CentralQuadJet30_v3") == 0)
   {
      if (map_L1BitOfStandardHLTPath.find(triggerName)->second==1)
      {
         if (prescaleResponse(menu, cfg, rcounter, it))
  ...
  else if (isHTX_Mu5_pfMHTXTrigger(triggerName, thresholds)) {
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1){
      if (prescaleResponse(menu,cfg,rcounter,it)){
	if(OpenHltpfMHT(thresholds[1]) && OpenHltSumCorHTPassed(thresholds[0],40.,3.)>0 && OpenHlt1MuonPassed(3.,4.,5.,2.,0)>0)
	  {
	    triggerBit[it] = true;
	  }
      }
  ...
  else if (isHTX_Mu15_pfMHTXTrigger(triggerName, thresholds)) {
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1){
      if (prescaleResponse(menu,cfg,rcounter,it)){
	if(OpenHltpfMHT(thresholds[1]) && OpenHltSumCorHTPassed(thresholds[0],40.,3.)>0 && OpenHlt1MuonPassed(10.,10.,15.,2.,0)>0)
	  {
	    triggerBit[it] = true;
	  }
      }
  ...
  else if (menu->GetTriggerName(it).CompareTo("OpenHLT_Mu15_HT200") == 0) {
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1){
      if (prescaleResponse(menu,cfg,rcounter,it)){
	if( OpenHltSumCorHTPassed(200.,40.,3.)>0 && OpenHlt1MuonPassed(0.,10.,15.,2.,0)>0)
	  {
	    triggerBit[it] = true;
	  }
      }
  ...
  else if (menu->GetTriggerName(it).CompareTo("OpenHLT_Mu20_HT200") == 0) {
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1){
      if (prescaleResponse(menu,cfg,rcounter,it)){
	if( OpenHltSumCorHTPassed(200.,40.,3.)>0 && OpenHlt1MuonPassed(0.,12.,20.,2.,0)>0)
	  {
	    triggerBit[it] = true;
	  }
      }
  ...
  //AGB - HT + 2Tau (+MET)
    ...
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1){
      if (prescaleResponse(menu,cfg,rcounter,it)){
	if(OpenHltpfMHT(35.) && OpenHltSumCorHTPassed(200.,40.,3.)>0 && OpenHltPFTauPassedNoMuonIDNoEleID(10.,3.,1.5,999.,
													  3.,3.,5.,2.,0, //muonID
													  5.,0,          // ET, L1isolation
													  999., 999.,       // Track iso barrel, Track iso endcap
    ...
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1){
      if (prescaleResponse(menu,cfg,rcounter,it)){
	if(OpenHltpfMHT(35.) && OpenHltSumCorHTPassed(250.,40.,3.)>0 && OpenHltPFTauPassedNoMuonIDNoEleID(10.,3.,1.5,999.,
													  3.,3.,5.,2.,0, //muonID
													  5.,0,          // ET, L1isolation
													  999., 999.,       // Track iso barrel, Track iso endcap
													  999., 999.,        // Track/pT iso barrel, Track/pT iso endcap
    ...
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1){
      if (prescaleResponse(menu,cfg,rcounter,it)){
	if(OpenHltpfMHT(40.) && OpenHltSumCorHTPassed(300.,40.,3.)>0 && OpenHltPFTauPassedNoMuonIDNoEleID(10.,3.,1.5,999.,
													  3.,3.,5.,2.,0, //muonID
													  5.,0,          // ET, L1isolation
													  999., 999.,       // Track iso barrel, Track iso endcap
													  999., 999.,        // Track/pT iso barrel, Track/pT iso endcap
    ...
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1){
      if (prescaleResponse(menu,cfg,rcounter,it)){
	if(OpenHltpfMHT(45.) && OpenHltSumCorHTPassed(350.,40.,3.)>0 && OpenHltPFTauPassedNoMuonIDNoEleID(10.,3.,1.5,999.,
													  3.,3.,5.,2.,0, //muonID
													  5.,0,          // ET, L1isolation
													  999., 999.,       // Track iso barrel, Track iso endcap
													  999., 999.,        // Track/pT iso barrel, Track/pT iso endcap
  ...
  else if (triggerName.BeginsWith("OpenHLT_Photon36")==1)
    {
