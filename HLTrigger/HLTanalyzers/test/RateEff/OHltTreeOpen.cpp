...
/* MET */
  ...
  else if (menu->GetTriggerName(it).CompareTo("OpenHLT_HT240_MHT50") == 0) {    
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1) {  
      if (prescaleResponse(menu,cfg,rcounter,it)) { 
...
////////////////////////////////////////////////////////////////////////
    ...
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1) { 
      if (prescaleResponse(menu,cfg,rcounter,it)) { 
        if(OpenHlt1MuonPassed(7.,15.,20.,2.,0)>=1) { 
          triggerBit[it] = true;  
        } 
      } 
    } 
    ...
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1) {  
      if (prescaleResponse(menu,cfg,rcounter,it)) {  
        if(OpenHlt1MuonPassed(7.,15.,24.,2.,0)>=1) {  
          triggerBit[it] = true;   
        }  
      }  
    }  
    ...
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1) {  
      if (prescaleResponse(menu,cfg,rcounter,it)) {  
        if(OpenHlt1MuonPassed(7.,15.,30.,2.,0)>=1) {  
          triggerBit[it] = true;   
        }  
      }  
    }  
   ...
   if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1) {  
     if (prescaleResponse(menu,cfg,rcounter,it)) { 
       if(OpenHlt2MuonPassed(0.,0.,6.,2.,0)>=2) {    
	 triggerBit[it] = true;  
       } 
     }    
   }    
   ...
   if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1) {  
     if (prescaleResponse(menu,cfg,rcounter,it)) { 
       if(OpenHlt2MuonPassed(0.,0.,7.,2.,0)>=2) {    
	 triggerBit[it] = true;  
       } 
     }    
   }    
   ...
   if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1) {  
     if (prescaleResponse(menu,cfg,rcounter,it)) { 
       if(OpenHlt2MuonPassed(0.,0.,5.,2.,0)>=3) {      
	 triggerBit[it] = true;  
       } 
     } 
   }      
    ...
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1) {  
      if (prescaleResponse(menu,cfg,rcounter,it)) { 
        if(OpenHlt1MuonPassed(7.,7.,15.,2.,1)>=1) {    
          triggerBit[it] = true;  
        } 
      }    
    }    
...
/* Electrons */
  ...
  else if(menu->GetTriggerName(it).CompareTo("OpenHLT_Ele17_EleId_Ele8_Isol_L1R") == 0) {
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1) {
      if (prescaleResponse(menu,cfg,rcounter,it)) {
        if(OpenHlt1ElectronSamHarperPassed(17.,0,          // ET, L1isolation
					   999., 999.,       // Track iso barrel, Track iso endcap
...
/* Photons */
  ...
  else if(menu->GetTriggerName(it).CompareTo("OpenHLT_Photon100_Cleaned_L1R") == 0) {
    if (map_L1BitOfStandardHLTPath.find(menu->GetTriggerName(it))->second==1) {
      if (prescaleResponse(menu,cfg,rcounter,it)) {
