...
HLTFiltCandNDM::HLTFiltCandNDM(const edm::ParameterSet& iConfig) :
...
bool
HLTFiltCandNDM::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace std;
   using namespace edm;
   ...
   auto_ptr<TriggerFilterObjectWithRefs> 
     filterobject (new TriggerFilterObjectWithRefs());
