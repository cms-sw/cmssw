...
private:
    ...
    GtLogicParser m_l1AlgoLogicParser;

    /// list of required algorithms for seeding
    std::vector<GtLogicParser::OperandToken> m_l1AlgoSeeds;

    /// vector of Rpn vectors for the required algorithms for seeding
    std::vector< const std::vector<GtLogicParser::TokenRPN>* > m_l1AlgoSeedsRpn;

    /// vector of object-type vectors for each condition in the required algorithms for seeding
    std::vector< std::vector< const std::vector<l1t::L1TGtObject>* > > m_l1AlgoSeedsObjType;
...
private:
    ...
    edm::EDGetTokenT<L1TGtObjectMapRecord>           m_l1GtObjectMapToken;
