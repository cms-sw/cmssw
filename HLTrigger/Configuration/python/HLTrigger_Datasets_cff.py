...
streamA_datasetMuMonitor_selector.triggerConditions = cms.vstring('HLT_L2Mu5', 
    'HLT_L1MuOpen_DT', 
    'HLT_L1Mu', 
    'HLT_L1MuOpen', 
    'HLT_L2Mu0', 
...
streamA_datasetJetMETTau_selector.triggerConditions = cms.vstring('HLT_Jet30U', 
    'HLT_Jet15U', 
    'HLT_BTagMu_Jet10U', 
...
streamA_datasetCommissioning_selector.triggerConditions = cms.vstring('HLT_Activity_PixelClusters', 
    'HLT_Activity_L1A', 
    'HLT_Activity_CSC', 
...
streamA_datasetEG_selector.triggerConditions = cms.vstring('HLT_Photon15_Cleaned_L1R', 
