...
# Use this if you want L1 tracks after pixel tracks, and use pixel vertices for L1 track classification
hltPhase2L1TracksCutClassifier = cms.EDProducer(
    "TrackCutClassifier",
...
hltPhase2L1TracksSelectionHighPurity = cms.EDProducer(
...
hltPhase2L1TracksSequenceClassification = cms.Sequence(
    hltPhase2L1TracksCutClassifier + hltPhase2L1TracksSelectionHighPurity
)
