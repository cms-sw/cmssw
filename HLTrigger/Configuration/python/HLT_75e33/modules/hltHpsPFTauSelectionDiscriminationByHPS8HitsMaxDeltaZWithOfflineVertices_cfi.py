...
hltHpsPFTauSelectionDiscriminationByHPS8HitsMaxDeltaZWithOfflineVertices = cms.EDProducer("PFRecoTauDiscriminationByHPSSelection",
    PFTauProducer = cms.InputTag("hltHpsPFTauCombinatoricProducer8HitsMaxDeltaZWithOfflineVertices"),
