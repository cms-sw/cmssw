...
HLTPhoton108EBTightIDTightIsoUnseededSequence = cms.Sequence((hltEgammaCandidatesUnseeded+hltEgammaClusterShapeUnseeded+hltEgammaHoverEUnseeded+hltEgammaEcalPFClusterIsoUnseeded+hltEgammaHcalPFClusterIsoUnseeded))
