...
_HLTPhase2PixelTracksSequenceExtended = _HLTPhase2PixelTracksSequence.copy()
_HLTPhase2PixelTracksSequenceExtended.insert(
    _HLTPhase2PixelTracksSequenceExtended.index(hltPhase2PixelTracksSoA),
...
(alpaka & phase2CAExtension).toReplaceWith(HLTPhase2PixelTracksSequence, _HLTPhase2PixelTracksSequenceExtended)
