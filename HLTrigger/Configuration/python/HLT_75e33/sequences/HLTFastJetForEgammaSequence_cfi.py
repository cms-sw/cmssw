...
HLTFastJetForEgammaSequence = cms.Sequence(hltEcalUncalibRecHit+ecalMultiFitUncalibRecHit+hltEcalRecHit+ecalRecHit+hltFixedGridRhoFastjetAllCaloForEGamma)
