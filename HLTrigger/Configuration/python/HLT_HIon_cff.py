# hltGetConfiguration --cff --data /dev/CMSSW_10_3_0/HIon --type HIon

# /dev/CMSSW_10_3_0/HIon/V1 (CMSSW_10_3_X_2018-10-01-2300)
...
fragment.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_10_3_0/HIon/V1')
)
