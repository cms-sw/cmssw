# /dev/CMSSW_8_0_0/HIon/V214 (CMSSW_8_0_19_patch2)
...
fragment.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_8_0_0/HIon/V214')
)
...
fragment.HLTSiStripClusterChargeCutNone = cms.PSet(  value = cms.double( 0.0 ) )
