# /dev/CMSSW_7_1_1/GRun/V63 (CMSSW_7_1_3)

import FWCore.ParameterSet.Config as cms


HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_7_1_1/GRun/V63')
)
...
hltHcalNoiseInfoProducer = cms.EDProducer( "HcalNoiseInfoProducer",
    ...
    lRBXRecHitR45Cuts = cms.vdouble(0.0, 1.0, 0.0, -0.5,
                                    0.0, 0.0, 1.0, -0.5),
    tRBXRecHitR45Cuts = cms.vdouble(0.0, 1.0, 0.0, -0.2,
                                    0.0, 0.0, 1.0, -0.2)
)
