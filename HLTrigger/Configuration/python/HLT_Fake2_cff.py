# hltGetConfiguration /dev/CMSSW_16_0_0/Fake2 --cff --data --type Fake2

# /dev/CMSSW_16_0_0/Fake2/V6 (CMSSW_16_0_0_patch1)
...
fragment.HLTConfigVersion = cms.PSet(
  tableName = cms.string("/dev/CMSSW_16_0_0/Fake2/V6")
)
