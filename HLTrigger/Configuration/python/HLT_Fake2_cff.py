# hltGetConfiguration --cff --data /dev/CMSSW_10_5_0/Fake2 --type Fake2

# /dev/CMSSW_10_5_0/Fake2/V2 (CMSSW_10_5_0_pre2)
...
fragment.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_10_5_0/Fake2/V2')
)
