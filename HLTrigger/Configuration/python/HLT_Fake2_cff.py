# hltGetConfiguration --cff --data /dev/CMSSW_12_1_0/Fake2 --type Fake2

# /dev/CMSSW_12_1_0/Fake2/V4 (CMSSW_12_1_0_pre4)
...
fragment.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_12_1_0/Fake2/V4')
)
