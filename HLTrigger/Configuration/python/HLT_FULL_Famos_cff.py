# /dev/CMSSW_7_2_0/HLT/V26 (CMSSW_7_2_0_pre6_HLT1)
...
HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_7_2_0/HLT/V26')
)
...
HLT_Ele27_WP85_Gsf_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleIsoEG25er + hltPreEle27WP85Gsf + HLTEle27WP85GsfSequence + cms.SequencePlaceholder( "HLTEndSequence" ) )
...
HLT_Ele27_WP85_Gsf_TriCentralPFJet40_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleIsoEG25er + hltPreEle27WP85GsfTriCentralPFJet40 + HLTEle27WP85GsfSequence + HLTAK4PFJetsSequence + hltEle27JetCollectionsForLeptonPlusPFJets + hltEle27TriCentralPFJet40EleCleaned + cms.SequencePlaceholder( "HLTEndSequence" ) )
HLT_Ele27_WP85_Gsf_TriCentralPFJet60_50_35_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleIsoEG25er + hltPreEle27WP85GsfTriCentralPFJet605035 + HLTEle27WP85GsfSequence + HLTAK4PFJetsSequence + hltEle27JetCollectionsForLeptonPlusPFJets + hltEle27TriCentralPFJet35EleCleaned + hltEle27DiCentralPFJet50EleCleaned + hltEle27CentralPFJet60EleCleaned + cms.SequencePlaceholder( "HLTEndSequence" ) )
