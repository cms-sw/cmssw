...
# Additional EventContent needed for the validation of the 2011 legacy HLT menu
        ...
        'keep *_hltSelectorJets20_*_*',
        'keep *_hltSelectorJetsHbb_*_*',
        'keep *_hltSelector4JetsDiJet20Hbb_*_*',
        'keep *_hltSelector4JetsDiJet20_*_*',
        'keep *_hltSelector4JetsDiJet40_*_*',
        'keep *_hltSelector4JetsDiJet70_*_*',
        'keep *_hltSelector4JetsDiJet110_*_*',
        'keep *_hltBSoftMuonDiJet20L25Jets_*_*',
        'keep *_hltBSoftMuonDiJet20L25BTagInfos_*_*',
        'keep *_hltBSoftMuonDiJet20L25BJetTagsByDR_*_*',
        'keep *_hltBSoftMuonDiJet40L25Jets_*_*',
        'keep *_hltBSoftMuonDiJet40L25BTagInfos_*_*',
        'keep *_hltBSoftMuonDiJet40L25BJetTagsByDR_*_*',
        'keep *_hltBSoftMuonDiJet70L25Jets_*_*',
        'keep *_hltBSoftMuonDiJet70L25BTagInfos_*_*',
        'keep *_hltBSoftMuonDiJet70L25BJetTagsByDR_*_*',
        'keep *_hltBSoftMuonDiJet110L25Jets_*_*',
        'keep *_hltBSoftMuonDiJet110L25BTagInfos_*_*',
        'keep *_hltBSoftMuonDiJet110L25BJetTagsByDR_*_*',
        'keep *_hltBSoftMuonDiJet20L3Jets_*_*',
        'keep *_hltBSoftMuonDiJet20L3BTagInfos_*_*',
        'keep *_hltBSoftMuonDiJet20L3BJetTagsByDR_*_*',
        'keep *_hltBSoftMuonDiJet40L3Jets_*_*',
        'keep *_hltBSoftMuonDiJet40L3BTagInfos_*_*',
        'keep *_hltBSoftMuonDiJet40L3BJetTagsByDR_*_*',
        'keep *_hltBSoftMuonDiJet70L3Jets_*_*',
        'keep *_hltBSoftMuonDiJet70L3BTagInfos_*_*',
        'keep *_hltBSoftMuonDiJet70L3BJetTagsByDR_*_*',
        'keep *_hltBSoftMuonDiJet110L3Jets_*_*',
        'keep *_hltBSoftMuonDiJet110L3BTagInfos_*_*',
        'keep *_hltBSoftMuonDiJet110L3BJetTagsByDR_*_*'
    ) )
)
