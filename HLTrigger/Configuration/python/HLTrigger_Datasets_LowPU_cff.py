...
streamA_datasetJetHT_selector.triggerConditions = cms.vstring('HLT_DiPFJetAve30_HFJEC_v2')
...
streamA_datasetSingleMu_selector.triggerConditions = cms.vstring('HLT_L1SingleMuOpen_DT_v1', 
    'HLT_L1SingleMuOpen_v1')
