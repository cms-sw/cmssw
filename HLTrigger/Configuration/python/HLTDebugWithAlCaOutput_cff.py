# /dev/CMSSW_3_0_0/pre3/HLT/V23 (CMSSW_3_0_X_2008-12-01-1600_HLT2)

import FWCore.ParameterSet.Config as cms


HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_3_0_0/pre3/HLT/V23')
)
...
outputCommands = cms.untracked.vstring( 'drop *_hlt*_*_*',
  ...
  'keep *_hltEgammaL1MatchFilterRegionalElectronTauNoL1Tau_*_*',
  ...
  'keep *_hltEgammaEtFilterElectronTauNoL1Tau_*_*',
  'keep *_hltL1IsolatedPhotonEcalIsol_*_*',
  'keep *_hltEgammaHcalIsolFilterElectronTauNoL1Tau_*_*',
  ...
  'keep *_hltEgammaHcalIsolFilterElectronTauStartup_*_*',
  'keep *_hltL1NonIsoStartUpElectronsRegionalPixelSeedGenerator_*_*',
  'keep *_hltElectronPixelMatchFilterElectronTauNoL1Tau_*_*',
