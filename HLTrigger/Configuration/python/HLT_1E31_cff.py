# /dev/CMSSW_3_0_0/pre3/1E31_V26/V1 (CMSSW_3_0_X_2008-12-01-1600_HLT2)

import FWCore.ParameterSet.Config as cms


HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_3_0_0/pre3/1E31_V26/V1')
)
