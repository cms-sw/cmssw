...
hltL1sL1Tech47CASTORHaloMuon = cms.EDFilter( "HLTLevel1GTSeed",
    saveTags = cms.bool( True ),
...
hltPrePAL1Tech47CASTORHaloMuon = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
HLT_PAL1Tech47_CASTORHaloMuon_v1 = cms.Path( HLTBeginSequence + hltL1sL1Tech47CASTORHaloMuon + hltPrePAL1Tech47CASTORHaloMuon + HLTEndSequence )
