# hltGetConfiguration --full --data /dev/CMSSW_10_5_0/PIon --type PIon --unprescale --process HLTPIon --globaltag auto:run2_hlt_PIon --input file:RelVal_Raw_PIon_DATA.root

# /dev/CMSSW_10_5_0/PIon/V2 (CMSSW_10_5_0_pre2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_10_5_0/PIon/V2')
)
