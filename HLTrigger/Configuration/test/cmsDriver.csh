...
foreach gtag ( MC DATA )
  ...
  if ( $1 == "" ) then
    ...
    set tables = ( GRun HIon PIon PRef Fake Fake1 Fake2 2018v21 )
    ...
    set tables = ( Fake Fake1 Fake2 2018v21 )
  else
    set tables = ( $1 )
  endif
  ...
  foreach table ( $tables )
    ...
    if ( $table == FULL ) then
      ...
      set Custom = " "
      set L1REPACK = L1REPACK:Full
    else if ( $table == 2018v21 ) then
      set XL1T = $XL1TPP3
      set XHLT = HLT:2018v21
      set GTAG = ${BASE2}_2018v21
      set RTAG = ${BASE2RD}_2018v21
      set NN   = $NNPP
      set SCEN = pp
      set InputGenSim = $InputGenSimGRun3
      set InputLHCRaw = $InputLHCRawGRun3
