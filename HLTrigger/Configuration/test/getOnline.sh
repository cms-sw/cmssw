...
hltGetConfiguration $HLT --process TEST --full --offline --mc   --l1 $L1T --globaltag START39_V4HI::All --unprescale --dataset '/RelValTTbar/CMSSW_3_6_3-START36_V10-v1/GEN-SIM-DIGI-RAW-HLTDEBUG' > offline_mc.py
