...
def extractBlocks(config):
  ...
  outputScouting = ( 'hltOutputScoutingPF', 'hltOutputScoutingCalo')
...
if not hasattr(hltScouting_cff,'block_hltOutputScoutingCalo'):
  hltScouting_cff.block_hltOutputScoutingCalo = cms.PSet(outputCommands = cms.untracked.vstring( 'drop *' ))

hltScoutingOutputBlocks = (
  # the DQM, HLTDQM and HLTMON streams have the HLT debug outputs used online
  hltScouting_cff.block_hltOutputScoutingPF.outputCommands,
  hltScouting_cff.block_hltOutputScoutingCalo.outputCommands,
)
