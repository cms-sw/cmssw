# /dev/CMSSW_3_10_0/pre7/HIon/V3 (CMSSW_3_10_0_pre6_HLT2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_3_10_0/pre7/HIon/V3')
)
...
process.datasets = cms.PSet( 
  ...
  HICorePhysics = cms.vstring( 'HLT_HIJet35U_Core',
    ...
    'HLT_HIJet75U_Core',
    'HLT_HIJet90U_Core',
    'HLT_HIL2DoubleMu3_Core_v2',
    'HLT_HIL2Mu20_Core_v2',
    'HLT_HIL2Mu5Tight_Core_v2',
...
process.HLT_HIL2Mu3_v2 = cms.Path( process.HLTBeginSequenceBPTX + process.hltL1sHIL1SingleMu3withBSCHF + process.hltPreHIL2Mu3 + process.hltHIL1SingleMu3withBSCHFL1Filtered + process.HLTL2muonrecoSequence + process.hltHIL2Mu3L2Filtered + process.HLTEndSequence )
process.HLT_HIL2Mu5Tight_v2 = cms.Path( process.HLTBeginSequenceBPTX + process.hltL1sHIL1SingleMu3withBSCHF + process.hltPreHIL2Mu5Tight + process.hltHIL1SingleMu3withBSCHFL1Filtered + process.HLTL2muonrecoSequence + process.hltHIL2Mu5TightL2Filtered + process.HLTEndSequence )
process.HLT_HIL2Mu5Tight_Core_v2 = cms.Path( process.HLTBeginSequenceBPTX + process.hltL1sHIL1SingleMu3withBSCHF + process.hltPreHIL2Mu5TightCore + process.hltHIL1SingleMu3withBSCHFL1Filtered + process.HLTL2muonrecoSequence + process.hltHIL2Mu5TightL2Filtered + process.HLTEndSequence )
process.HLT_HIL2Mu20_v2 = cms.Path( process.HLTBeginSequenceBPTX + process.hltL1sHIL1SingleMu3withBSCHF + process.hltPreHIL2Mu20 + process.hltHIL1SingleMu3withBSCHFL1Filtered + process.HLTL2muonrecoSequence + process.hltHIL2Mu20L2Filtered + process.HLTEndSequence )
process.HLT_HIL2Mu20_Core_v2 = cms.Path( process.HLTBeginSequenceBPTX + process.hltL1sHIL1SingleMu3withBSCHF + process.hltPreHIL2Mu20Core + process.hltHIL1SingleMu3withBSCHFL1Filtered + process.HLTL2muonrecoSequence + process.hltHIL2Mu20L2Filtered + process.HLTEndSequence )
process.HLT_HIL2DoubleMu0_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sHIL1DoubleMuOpenwithBSCHF + process.hltPreHIL2DoubleMu0 + process.hltHIDoubleMuLevel1PathL1OpenWithBSCHFFiltered + process.HLTL2muonrecoSequence + process.hltHIL2DoubleMu0L2Filtered + process.HLTEndSequence )
process.HLT_HIL2DoubleMu3_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sHIL1DoubleMuOpenwithBSCHF + process.hltPreHIL2DoubleMu3 + process.hltHIDoubleMuLevel1PathL1OpenWithBSCHFFiltered + process.HLTL2muonrecoSequence + process.hltHIL2DoubleMu3L2Filtered + process.HLTEndSequence )
process.HLT_HIL2DoubleMu3_Core_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sHIL1DoubleMuOpenwithBSCHF + process.hltPreHIL2DoubleMu3Core + process.hltHIDoubleMuLevel1PathL1OpenWithBSCHFFiltered + process.HLTL2muonrecoSequence + process.hltHIL2DoubleMu3L2Filtered + process.HLTEndSequence )
