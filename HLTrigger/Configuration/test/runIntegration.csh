...
if ( $2 == "" ) then
  ...
  set tables = ( GRun 50nsGRun HIon PIon LowPU 25ns14e33_v3 50ns_5e33_v2 25ns14e33_v1 50ns_5e33_v1 Fake )
else if ( $2 == IB ) then
  ...
  set tables = ( 25ns14e33_v3 50ns_5e33_v2 25ns14e33_v1 50ns_5e33_v1 Fake )
else
  set tables = ( $2 )
endif
