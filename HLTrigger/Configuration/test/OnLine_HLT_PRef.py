# /dev/CMSSW_8_0_0/PRef/V214 (CMSSW_8_0_19_patch2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_8_0_0/PRef/V214')
)
...
process.HLTSiStripClusterChargeCutNone = cms.PSet(  value = cms.double( 0.0 ) )
