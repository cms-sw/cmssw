// $Id: HLTCaloJetPairDzMatchFilter.cc,v 1.1 2012/02/02 23:18:35 khotilov Exp $

#include "HLTrigger/btau/src/HLTCaloJetPairDzMatchFilter.h"
...
HLTCaloJetPairDzMatchFilter::HLTCaloJetPairDzMatchFilter(const edm::ParameterSet& conf) : HLTFilter(conf)
{ 
  ...
  // to create a pair out of the same CaloJet replicated with two
  // different vertices
...
bool HLTCaloJetPairDzMatchFilter::hltFilter(edm::Event& ev, const edm::EventSetup& es, trigger::TriggerFilterObjectWithRefs & filterproduct)
{
  using namespace std;
