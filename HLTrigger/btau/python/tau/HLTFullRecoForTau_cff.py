...
ckfTrackCandidatesL25SingleTau.src = cms.InputTag('l25SingleTauPixelSeeds')
...
ckfTrackCandidatesL3SingleTau.src = cms.InputTag('l3SingleTauPixelSeeds')
...
ckfTrackCandidatesL25SingleTauMET.src = cms.InputTag('l25SingleTauMETPixelSeeds')
...
ckfTrackCandidatesL3SingleTauMET.src = cms.InputTag('l3SingleTauMETPixelSeeds')
...
hltCkfTrackCandidatesL25ElectronTau.src = cms.InputTag('hltTauRegionalPixelSeedL25ElectronTau')
...
hltCkfTrackCandidatesL3ElectronTau.src = cms.InputTag('hltTauRegionalPixelSeedsL3ElectronTau')
