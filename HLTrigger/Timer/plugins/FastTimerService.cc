...
void FastTimerService::PlotsPerElement::book(dqm::reco::DQMStore::IBooker& booker,
  ...
  // MonitorElement::setStatOverflows(1) includes underflows and overflows in the computation of mean and RMS
  time_thread_ =
  ...
  time_thread_->setStatOverflows(1);
  ...
  if (memory_usage::is_available()) {
    ...
    deallocated_->setStatOverflows(1);
  }
  ...
  time_thread_byls_->setStatOverflows(1);
  ...
  time_real_byls_->setStatOverflows(1);
  ...
  if (memory_usage::is_available()) {
    ...
    allocated_byls_->setStatOverflows(1);
    ...
    deallocated_byls_->setStatOverflows(1);
  }
}
...
void FastTimerService::PlotsPerPath::book(dqm::reco::DQMStore::IBooker& booker,
  ...
  module_counter_->setStatOverflows(1);
  ...
  module_time_thread_total_->setStatOverflows(1);
  ...
  module_time_real_total_->setStatOverflows(1);
  if (memory_usage::is_available()) {
    ...
    module_allocated_total_->setStatOverflows(1);
    ...
    module_deallocated_total_->setStatOverflows(1);
  }
