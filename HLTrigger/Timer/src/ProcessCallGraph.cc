...
void
ProcessCallGraph::preSourceConstruction(edm::ModuleDescription const & module)
{
...
edm::ModuleDescription const &
ProcessCallGraph::module(unsigned int module) const
{
...
ProcessCallGraph::NodeType const &
ProcessCallGraph::operator[](unsigned int module) const
{
...
ProcessCallGraph::depends(unsigned int module) const
{
...
ProcessCallGraph::dependencies(std::vector<unsigned int> const & path)
{
  std::vector<unsigned int> colors(boost::num_vertices(graph_));
  auto colormap = boost::make_container_vertex_map(colors);
