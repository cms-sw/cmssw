...
template <typename jetType>
void HLTJetCollectionsFilter<jetType>::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
template <typename jetType>
bool HLTJetCollectionsFilter<jetType>::hltFilter(edm::Event& iEvent,
  ...
  // The filter object
  if (saveTags())
    filterproduct.addCollectionTag(originalTag_);
