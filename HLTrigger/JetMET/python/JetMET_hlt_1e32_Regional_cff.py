...
import copy
from HLTrigger.HLTfilters.hlt1CaloJetRegional_cfi import *
# module  hlt1jet110 = hlt1CaloJet from "HLTrigger/HLTfilters/data/hlt1CaloJet.cfi"
hlt1jet110 = copy.deepcopy(hlt1CaloJetRegional)
import copy
from HLTrigger.HLTfilters.hlt1CaloJet_cfi import *
...
hlt1jet150 = copy.deepcopy(hlt1CaloJetRegional)
import copy
from HLTrigger.HLTfilters.hlt1CaloJet_cfi import *
...
hlt1jet200 = copy.deepcopy(hlt1CaloJetRegional)
import copy
from HLTrigger.HLTfilters.hlt1CaloJet_cfi import *
...
hlt2jet125 = copy.deepcopy(hlt1CaloJetRegional)
import copy
from HLTrigger.HLTfilters.hlt1CaloJetRegional_cfi import *
# module  hlt2jet150 = hlt1CaloJet from "HLTrigger/HLTfilters/data/hlt1CaloJet.cfi"
hlt2jet150 = copy.deepcopy(hlt1CaloJetRegional)
import copy
from HLTrigger.HLTfilters.hlt1CaloJet_cfi import *
...
hlt3jet85 = copy.deepcopy(hlt1CaloJetRegional)
import copy
from HLTrigger.HLTfilters.hlt1CaloJet_cfi import *
...
JetMET1jet = cms.Sequence(cms.SequencePlaceholder("hltBegin")+cms.SequencePlaceholder("l1s1jet")+pre1jet+cms.SequencePlaceholder("recoJetRegional")+hlt1jet200)
JetMET1jetPE1 = cms.Sequence(cms.SequencePlaceholder("hltBegin")+cms.SequencePlaceholder("l1s1jetPE1")+pre1jetPE1+cms.SequencePlaceholder("recoJetRegional")+hlt1jet150)
JetMET1jetPE3 = cms.Sequence(cms.SequencePlaceholder("hltBegin")+cms.SequencePlaceholder("l1s1jetPE3")+pre1jetPE3+cms.SequencePlaceholder("recoJetRegional")+hlt1jet110)
...
JetMET2jet = cms.Sequence(cms.SequencePlaceholder("hltBegin")+cms.SequencePlaceholder("l1s2jet")+pre2jet+cms.SequencePlaceholder("recoJetRegional")+hlt2jet150)
...
JetMET3jet = cms.Sequence(cms.SequencePlaceholder("hltBegin")+cms.SequencePlaceholder("l1s3jet")+pre3jet+cms.SequencePlaceholder("recoJetRegional")+hlt3jet85)
...
JetMET2jetAco = cms.Sequence(cms.SequencePlaceholder("hltBegin")+cms.SequencePlaceholder("l1s2jetAco")+pre2jetAco+cms.SequencePlaceholder("recoJetRegional")+hlt2jet125+hlt2jetAco)
...
JetMETDiJetAve110 = cms.Sequence(cms.SequencePlaceholder("hltBegin")+cms.SequencePlaceholder("l1sdijetave110")+predijetave110+cms.SequencePlaceholder("recoJetRegional")+hltdijetave110)
JetMETDiJetAve150 = cms.Sequence(cms.SequencePlaceholder("hltBegin")+cms.SequencePlaceholder("l1sdijetave150")+predijetave150+cms.SequencePlaceholder("recoJetRegional")+hltdijetave150)
JetMETDiJetAve200 = cms.Sequence(cms.SequencePlaceholder("hltBegin")+cms.SequencePlaceholder("l1sdijetave200")+predijetave200+cms.SequencePlaceholder("recoJetRegional")+hltdijetave200)
