...
void PlotMacro(){
  ...
  TFile *f = new TFile("/tmp/maborgia/pass4_8055_ClusThr_TIB_L1.root");
  TObjArray DetList(0);
  ...
  DrawClus(cC1,"Ts:Nb","Tc==4.5 && Tn==1.5",2,20,"TIB L1,Mean number of BG cluster per event","Ts","Mean BG clusters",legend,"Tc4.5:Tn1.5",0,0.15);
  ...
  DrawSame("Ts:Nb","Tc==4.5 && Tn==2.5",2,24,legend,"Tc4.5:Tn2.5");
  DrawSame("Ts:Nb","Tc==5.0 && Tn==2.5",3,24,legend,"Tc5.0:Tn2.5");
  DrawSame("Ts:Nb","Tc==5.5 && Tn==2.5",4,24,legend,"Tc5.5:Tn2.5");

  C1->cd(2);
  TLegend *legend = new TLegend(0.851008,0.437882,0.995954,1.00035); 
  DrawClus(cC1,"Ts:Ns","Tc==4.5 && Tn==1.5",2,20,"TIB L1,Mean number of Signal cluster per event","Ts","Mean Signal clusters",legend,"Tc4.5:Tn1.5",0.649,0.655);
  ...
  DrawSame("Ts:Ns","Tc==4.5 && Tn==2.5",2,24,legend,"Tc4.5:Tn2.5");
  DrawSame("Ts:Ns","Tc==5.0 && Tn==2.5",3,24,legend,"Tc5.0:Tn2.5");
  DrawSame("Ts:Ns","Tc==5.5 && Tn==2.5",4,24,legend,"Tc5.5:Tn2.5");

  C1->cd(3);
  TLegend *legend = new TLegend(0.851008,0.437882,0.995954,1.00035); 
  DrawClus(cC1,"Ts:MPVs","Tc==4.5 && Tn==1.5",2,20,"TIB L1,MPV of S/N","Ts","MPV",legend,"Tc4.5:Tn1.5",27.6,29);
  ...
  DrawSame("Ts:MPVs","Tc==4.5 && Tn==2.5",2,24,legend,"Tc4.5:Tn2.5");
  DrawSame("Ts:MPVs","Tc==5.0 && Tn==2.5",3,24,legend,"Tc5.0:Tn2.5");
  DrawSame("Ts:MPVs","Tc==5.5 && Tn==2.5",4,24,legend,"Tc5.5:Tn2.5");

  C1->cd(4);
  TLegend *legend = new TLegend(0.851008,0.437882,0.995954,1.00035); 
  DrawClus(cC1,"Ts:FWHMs","Tc==4.5 && Tn==1.5",2,20,"TIB L1,FWHM of S/N","Ts","FWHM",legend,"Tc4.5:Tn1.5",6.4,6.65);
  ...
  DrawSame("Ts:FWHMs","Tc==4.5 && Tn==2.5",2,24,legend,"Tc4.5:Tn2.5");
  DrawSame("Ts:FWHMs","Tc==5.0 && Tn==2.5",3,24,legend,"Tc5.0:Tn2.5");
  DrawSame("Ts:FWHMs","Tc==5.5 && Tn==2.5",4,24,legend,"Tc5.5:Tn2.5");
  ...
  C2->cd(1);
  TLegend *legend = new TLegend(0.851008,0.437882,0.995954,1.00035); 
  DrawClus(cC2,"Ts:NTb","Tc==4.5 && Tn==1.5",2,20,"TIB L1,Total number of BG cluster","Ts","# clusters",legend,"Tc4.5:Tn1.5",500,1400);
  ...
  DrawSame("Ts:NTb","Tc==4.5 && Tn==2.5",2,24,legend,"Tc4.5:Tn2.5");
  DrawSame("Ts:NTb","Tc==5.0 && Tn==2.5",3,24,legend,"Tc5.0:Tn2.5");
  DrawSame("Ts:NTb","Tc==5.5 && Tn==2.5",4,24,legend,"Tc5.5:Tn2.5");

  C2->cd(2);
  TLegend *legend = new TLegend(0.851008,0.437882,0.995954,1.00035); 
  DrawClus(cC2,"Ts:NTs","Tc==4.5 && Tn==1.5",2,20,"TIB L1,Total number of Signal cluster","Ts","# clusters",legend,"Tc4.5:Tn1.5",7600,7720);
  ...
  DrawSame("Ts:NTs","Tc==4.5 && Tn==2.5",2,24,legend,"Tc4.5:Tn2.5");
  DrawSame("Ts:NTs","Tc==5.0 && Tn==2.5",3,24,legend,"Tc5.0:Tn2.5");
  DrawSame("Ts:NTs","Tc==5.5 && Tn==2.5",4,24,legend,"Tc5.5:Tn2.5");

  C2->cd(3);
  TLegend *legend = new TLegend(0.851008,0.437882,0.995954,1.00035); 
  DrawClus(cC2,"Ts:MeanWb","Tc==4.5 && Tn==1.5",2,20,"TIB L1, Mean Width for BG clusters","Ts","Width (# strips)",legend,"Tc4.5:Tn1.5",1.1,1.8);
  ...
  DrawSame("Ts:MeanWb","Tc==4.5 && Tn==2.5",2,24,legend,"Tc4.5:Tn2.5");
  DrawSame("Ts:MeanWb","Tc==5.0 && Tn==2.5",3,24,legend,"Tc5.0:Tn2.5");
  DrawSame("Ts:MeanWb","Tc==5.5 && Tn==2.5",4,24,legend,"Tc5.5:Tn2.5");

  C2->cd(4);
  TLegend *legend = new TLegend(0.851008,0.437882,0.995954,1.00035); 
  DrawClus(cC2,"Ts:MeanWs","Tc==4.5 && Tn==1.5",2,20,"TIB L1,Mean Width for Signal clusters","Ts","Width (# strips)",legend,"Tc4.5:Tn1.5",3.7,4.3);
  ...
  DrawSame("Ts:MeanWs","Tc==4.5 && Tn==2.5",2,24,legend,"Tc4.5:Tn2.5");
  DrawSame("Ts:MeanWs","Tc==5.0 && Tn==2.5",3,24,legend,"Tc5.0:Tn2.5");
  DrawSame("Ts:MeanWs","Tc==5.5 && Tn==2.5",4,24,legend,"Tc5.5:Tn2.5");
