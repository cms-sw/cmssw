...
#include "AnalysisExamples/SiStripDetectorPerformance/interface/CosmicMTCCSimFilter.h"
...
namespace cms
{
CosmicMTCCSimFilter::CosmicMTCCSimFilter(const edm::ParameterSet& conf):    conf_(conf)
{
...
bool CosmicMTCCSimFilter::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  //  Step A: Get Inputs
  theStripHits.clear();
