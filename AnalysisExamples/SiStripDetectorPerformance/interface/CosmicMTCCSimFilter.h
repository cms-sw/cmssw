#ifndef COSMICMTCCSIMFILTER_H
#define COSMICMTCCSIMFILTER_H
...
namespace cms
{
class CosmicMTCCSimFilter : public edm::EDFilter {
  public:
  CosmicMTCCSimFilter(const edm::ParameterSet& conf);
  virtual ~CosmicMTCCSimFilter() {}
