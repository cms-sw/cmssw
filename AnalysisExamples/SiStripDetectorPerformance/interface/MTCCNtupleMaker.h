#ifndef AnalysisExamples_SiStripDetectorPerformance_MTCCNtupleMaker_h
#define AnalysisExamples_SiStripDetectorPerformance_MTCCNtupleMaker_h
...
class MTCCNtupleMaker : public edm::EDAnalyzer
{
 public:
  
  explicit MTCCNtupleMaker(const edm::ParameterSet& conf);
  
  virtual ~MTCCNtupleMaker();
 ...
 private:
  ...
  typedef std::map <const reco::Track *, TrackLocalAngleNew::HitLclDirAssociation> trklcldirmap;
  ...
  std::string oSeedsLabel_;
  std::string oSeedsProdInstName_;
...
#endif // AnalysisExamples_SiStripDetectorPerformance_MTCCNtupleMaker_h
