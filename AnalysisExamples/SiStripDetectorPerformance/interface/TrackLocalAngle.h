#ifndef AnalysisExamples_SiStripDetectorPerformance_TrackLocalAngle_h
#define AnalysisExamples_SiStripDetectorPerformance_TrackLocalAngle_h
...
class TrackLocalAngle 
{
 public:
  ...
  std::vector<std::pair<const TrackingRecHit*,float> > findtrackangle(const TrajectorySeed& seed, const reco::Track & theT);
 ...
 private:
  ...
  double cosineangle(LocalVector trackdirection); // [added by Andrea]
};
