...
class JetFlavourInfoMatchingCollection
    : public JetFlavourInfoMatchingCollectionBase {
public:
  ...
  JetFlavourInfoMatchingCollection(const reco::CaloJetRefProd &ref)
      : JetFlavourInfoMatchingCollectionBase(
            edm::RefToBaseProd<reco::Jet>(ref)) {}

  JetFlavourInfoMatchingCollection(
      const JetFlavourInfoMatchingCollectionBase &v)
...
typedef edm::RefProd<JetFlavourInfoMatchingCollection>
    JetFlavourInfoMatchingRefProd;

typedef edm::RefVector<JetFlavourInfoMatchingCollection>
