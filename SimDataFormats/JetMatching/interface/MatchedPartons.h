...
public:
  MatchedPartons() {}
  MatchedPartons(GenParticleRef hv, GenParticleRef n2, GenParticleRef n3,
                 GenParticleRef pd, GenParticleRef ad)
      : m_heaviest(hv), m_nearest2(n2), m_nearest3(n3), m_PhysDef(pd),
        m_AlgoDef(ad) {}
