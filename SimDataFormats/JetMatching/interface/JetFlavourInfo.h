...
namespace reco {
/**\class JetFlavourInfo JetFlavourInfo.h
 * SimDataFormats/JetMatching/interface/JetFlavourInfo.h \brief Class storing
 * the jet flavour information
 *
...
public:
  ...
  JetFlavourInfo(const GenParticleRefVector &bHadrons,
                 ...
                 const GenParticleRefVector &leptons, const int hadronFlavour,
                 const int partonFlavour)
      : m_bHadrons(bHadrons), m_cHadrons(cHadrons), m_partons(partons),
        m_leptons(leptons), m_hadronFlavour(hadronFlavour),
