 ...
 * It can store by value the matching information about flavour and parton
 * kinematics The flavour definition and the corresponding parton information
 * should be configured in the producer. The typedefs are taken from
 * reco::Particle
 * */
class JetFlavour {
public:
