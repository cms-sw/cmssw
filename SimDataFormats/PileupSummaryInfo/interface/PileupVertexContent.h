...
//
/**\class PileupVertexContent PileupVertexContent.h
SimDataFormats/PileupVertexContent/interface/PileupVertexContent.h

Description: contains information related to the details of the pileup
simulation for a given event, filled by Special "Digitizer" that has access to
each pileup event Usage: purely descriptive
*/
//
...
private:
  ...
  std::vector<float>
      t_Vtxs_; // may be empty if time information is not available
};
