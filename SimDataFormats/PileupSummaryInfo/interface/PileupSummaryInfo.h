...
//
/**\class PileupSummaryInfo PileupSummaryInfo.h
SimDataFormats/PileupSummaryInfo/interface/PileupSummaryInfo.h

Description: contains information related to the details of the pileup
simulation for a given event Usage: purely descriptive
*/
//
...
public:
  ...
  PileupSummaryInfo(const int num_PU_vertices,
                    ...
                    const std::vector<float> &sumpT_highpT,
                    const std::vector<int> &ntrks_lowpT,
                    const std::vector<int> &ntrks_highpT, int bunchCrossing);
  ...
  PileupSummaryInfo(const int num_PU_vertices,
                    ...
                    const std::vector<float> &pT_hats, int bunchCrossing,
                    float TrueNumInteractions, int bunchSpacing);
