...
//
/**\class PileupMixingContent PileupMixingContent.h
SimDataFormats/PileupMixingContent/interface/PileupMixingContent.h

Description: contains information related to the details of the pileup
simulation for a given event, filled by MixingModule Usage: purely descriptive
*/
//
...
public:
  ...
  PileupMixingContent(std::vector<int> &bunchCrossing,
                      ...
                      std::vector<edm::EventID> &eventInfos, int bunchSpacing)
