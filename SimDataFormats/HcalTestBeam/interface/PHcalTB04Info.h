...
// Class  :     PHcalTB04Info
//
/**\class PHcalTB04Info PHcalTB04Info.h
 SimDataFormats/HcalTestBeam/interface/PHcalTB04Info.h
...
public:
  ...
  void setEdep(double simtot, double sime, double simh, double digtot,
               double dige, double digh);
  void setEdepEcal(const std::vector<double> &esim,
                   const std::vector<double> &edig);
  void setEdepHcal(const std::vector<double> &esim,
                   const std::vector<double> &edig);
  ...
  void setLongProf(const std::vector<double> &es,
