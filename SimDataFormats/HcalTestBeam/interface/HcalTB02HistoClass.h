...
//
/**\class HcalTB02HistoClass HcalTB02HistoClass.h
 SimDataFormats/HcalTestBeam/interface/HcalTB02HistoClass.h
...
public:
  ...
  HcalTB02HistoClass()
      : Nprimaries(0), partID_(0), Einit(0), eta_(0), phi_(0), Eentry(0),
        EhcalTot(0), Ehcal7x7(0), Ehcal5x5(0), EhcalTotN(0), Ehcal7x7N(0),
        Ehcal5x5N(0), Nunit(0), Ntimesli(0), xEentry_(0), xEhcalTot_(0),
        xEhcalTotN_(0), xEhcal7x7_(0), xEhcal5x5_(0), xEhcal3x3_(0),
