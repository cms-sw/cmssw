...
public:
  ...
  static void unpackSquareIndex(const uint32_t &idx, int &z, int &lay, int &sec,
                                int &subsec, int &cell);
  static void unpackHexagonIndex(const uint32_t &idx, int &subdet, int &z,
                                 int &lay, int &wafer, int &celltyp, int &cell);
  static bool isValidSquare(int z, int lay, int sec, int subsec, int cell);
  static bool isValidHexagon(int subdet, int z, int lay, int wafer, int celltyp,
                             int cell);
};
