...
//#ifdef ROOT_TLorentzVector
    ...
    template <class category>
      inline HTXS::HiggsClassification Rivet2Root(category const &stxs_cat_rivet){
    ...
    inline int STXSstage1_1_to_STXSstage1_1_FineIndex(HTXS::Stage1_1::Category stage1_1,
    ...
    inline int STXSstage1_1_to_index(HTXS::Stage1_1::Category stage1_1) {
    ...
    inline int STXSstage1_1_Fine_to_STXSstage1_1_Fine_FineIndex(HTXS::Stage1_1_Fine::Category Stage1_1_Fine,
                         HiggsProdMode prodMode, tH_type tH) {
    ...
    inline int STXSstage1_1_Fine_to_index(HTXS::Stage1_1_Fine::Category Stage1_1_Fine) {
