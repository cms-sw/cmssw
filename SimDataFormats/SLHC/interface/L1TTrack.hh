...
public:
  ...
  void linearTrackFitBinary(){
    ...
    L1TWord ideltarphim[20];
    L1TWord ideltazm[20];

    L1TWord ichisq_rphi(MAXINT);
    L1TWord ichisq_rz(MAXINT);
    ...
    L1TWord idrinv(MAXINT);
    L1TWord idphi0(MAXINT);
    L1TWord idt(MAXINT);
    L1TWord idz0(MAXINT);

    L1TWord idrinv_cov(MAXINT);
    L1TWord idphi0_cov(MAXINT);
    L1TWord idt_cov(MAXINT);
    L1TWord idz0_cov(MAXINT);
