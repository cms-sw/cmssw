...
// struct to keep material accounting and geometrical informations on a
// per-detector basis, along a track
...
public:
  MaterialAccountingDetector(void)
      : m_position(), m_curvilinearIn(0.), m_curvilinearOut(0.),
        m_cosThetaIn(0.), m_cosThetaOut(0.), m_accounting() {}
