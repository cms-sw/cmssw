...
# with command line options: WprimeToMuNu_M3000GeV_14TeV_cfi_GEN_SIM.py -s GEN,SIM --conditions POSTLS161_V12::All --geometry Geometry/GEMGeometry/cmsExtendedGeometryPostLS1plusGEMXML_cfi --datatier GEN-SIM --eventcontent FEVTDEBUG -n 50000 --no_exec --fileout WprimeToMuNu_M3000GeV_14TeV_GEN_SIM.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('WprimeToMuNu_M3000GeV_14TeV_cfi_GEN_SIM.py nevts:50000'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('WprimeToMuNu_M3000GeV_14TeV_GEN_SIM.root'),
