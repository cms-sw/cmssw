...
# with command line options: h2mu_VBF_M125GeV_14TeV_cfi -s GEN,SIM --conditions POSTLS161_V12::All --geometry Geometry/GEMGeometry/cmsExtendedGeometryPostLS1plusGEMXML_cfi --datatier GEN-SIM --eventcontent FEVTDEBUG -n 50000 --no_exec --fileout h2mu_VBF_M125GeV_14TeV_GEN_SIM.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('h2mu_VBF_M125GeV_14TeV_cfi nevts:50000'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('h2mu_VBF_M125GeV_14TeV_GEN_SIM.root'),
...
# set proccess to be simulated
    processParameters = cms.vstring(
            ...
            'MSUB(123)= 1       ! qq->qqZZ->qqh (VBF SM)', 
            'MSUB(124)= 1       ! qq->qqWW->qqh (VBF SM)', 
            'PMAS(25,1)= 125.   ! m_h',
