...
# with command line options: h2mu_ggh_M125GeV_14TeV_cfi -s GEN,SIM --conditions POSTLS161_V12::All --geometry Geometry/GEMGeometry/cmsExtendedGeometryPostLS1plusGEMXML_cfi --datatier GEN-SIM --eventcontent FEVTDEBUG -n 50000 --no_exec --fileout h2mu_ggh_M125GeV_14TeV_GEN_SIM.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('h2mu_ggh_M125GeV_14TeV_cfi nevts:50000'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('h2mu_ggh_M125GeV_14TeV_GEN_SIM.root'),
