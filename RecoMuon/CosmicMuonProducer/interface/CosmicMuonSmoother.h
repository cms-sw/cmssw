...
public:
  CosmicMuonSmoother(const edm::ParameterSet &,
  ...
  trajectories(const TrajectorySeed &seed, const ConstRecHitContainer &hits,
  ...
  fit(const TrajectorySeed &seed, const ConstRecHitContainer &hits,
      const TrajectoryStateOnSurface &firstPredTsos) const;
...
private:
  ...
  void sortHitsAlongMom(ConstRecHitContainer &hits,
