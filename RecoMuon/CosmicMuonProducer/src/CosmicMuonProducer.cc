...
// 
/**\class CosmicMuonProducer CosmicMuonProducer.cc RecoMuon/CosmicMuonProducer/src/CosmicMuonProducer.cc
...
CosmicMuonProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  edm::LogInfo("CosmicMuonProducer") << "CosmicMuonProducer point 0";
  ...
  for (std::vector<Trajectory>::const_iterator theT = theTrajs.begin(); theT != theTrajs.end(); theT++) {
   ...
   edm::LogInfo("CosmicMuonProducer") << "CosmicMuonProducer point 33";

    if (theT->direction() == alongMomentum) {
   edm::LogInfo("CosmicMuonProducer") << "CosmicMuonProducer point 333";
      TrajectoryMeasurement firstM = theT->firstMeasurement();
   edm::LogInfo("CosmicMuonProducer") << "CosmicMuonProducer point 3333";

      innertsos = theT->firstMeasurement().updatedState();
   edm::LogInfo("CosmicMuonProducer") << "CosmicMuonProducer point 335";

    } else {
      innertsos = theT->lastMeasurement().updatedState();
   edm::LogInfo("CosmicMuonProducer") << "CosmicMuonProducer point 337";

    }
   edm::LogInfo("CosmicMuonProducer") << "CosmicMuonProducer point 55";
    reco::Track* theTrack;

    TSCPBuilderNoMaterial tscpBuilder;
    TrajectoryStateClosestToPoint tscp = tscpBuilder(innertsos,
                                                   GlobalPoint(0,0,0) );
    edm::LogInfo("CosmicMuonProducer") << "CosmicMuonProducer point 66";
    ...
    edm::LogInfo("CosmicMuonProducer") << "CosmicMuonProducer point 77";
