#ifndef MuonRSTrajectoryBuilder_h
#define MuonRSTrajectoryBuilder_h
...
class MuonRSTrajectoryBuilder :public TrackerTrajectoryBuilder {
 public:
  ///constructor from PSet and things from record
   MuonRSTrajectoryBuilder(const edm::ParameterSet & par,const MeasurementTracker * mt,const MagneticField * f,const Propagator * p);

   //// destructor
   ~MuonRSTrajectoryBuilder();
 ...
 private:
   ...
   ///Info/Debug category "Muon|RecoMuon|MuonRSTrajectoryBuilder"
