...
MuonHLTHcalPFClusterIsolationProducer::MuonHLTHcalPFClusterIsolationProducer(const edm::ParameterSet& config) {
...
MuonHLTHcalPFClusterIsolationProducer::~MuonHLTHcalPFClusterIsolationProducer()
{}

void MuonHLTHcalPFClusterIsolationProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  edm::ParameterSetDescription desc;
  desc.add<edm::InputTag>("recoChargedCandidateProducer", edm::InputTag("hltL1SeededRecoEcalCandidatePF"));
  ...
  descriptions.add(("hltMuonHLTHcalPFClusterIsolationProducer"), desc);
}

void MuonHLTHcalPFClusterIsolationProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup){
