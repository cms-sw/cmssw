...
private:
  ...
  void addCSCLayers(const std::pair<std::vector<DetLayer *>,
                                    std::vector<DetLayer *>> &csclayers);
  ...
  void addRPCLayers(const std::vector<DetLayer *> &barrelRPCLayers,
                    const std::pair<std::vector<DetLayer *>,
                                    std::vector<DetLayer *>> &endcapRPCLayers);
  ...
  /// both vectors are ASSUMED to be sorted inside-out
  void addGEMLayers(const std::pair<std::vector<DetLayer *>,
                                    std::vector<DetLayer *>> &gemlayers);
  //////////////////////////////
  ...
  /// gemlayers.first=forward (+Z), gemlayers.second=backward (-Z)
  /// both vectors are ASSUMED to be sorted inside-out
  void addME0Layers(const std::pair<std::vector<DetLayer *>,
                                    std::vector<DetLayer *>> &gemlayers);
