...
void MuonForwardNavigableLayer::pushResult(
    vector<const DetLayer *> &result, const MapE &map,
...
void MuonForwardNavigableLayer::pushResult(
    vector<const DetLayer *> &result, const MapB &map,
    const FreeTrajectoryState &fts) const {
...
void MuonForwardNavigableLayer::pushCompatibleResult(
    vector<const DetLayer *> &result, const MapB &map,
    const FreeTrajectoryState &fts) const {
...
void MuonForwardNavigableLayer::setDetLayer(const DetLayer *dl) {
  ...
  edm::LogError("MuonForwardNavigablaLayer")
