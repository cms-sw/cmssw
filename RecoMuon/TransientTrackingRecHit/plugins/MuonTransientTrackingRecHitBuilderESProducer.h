 ...
 *  ESProducer for the Muon Transient TrackingRecHit Builder. The Builder can be
 * taken from the EventSetup, decoupling the code in which it is used w.r.t. the
 * RecoMuon/TransientTrackingRecHit lib.
 *
