...
class MuonTransientTrackingRecHit final
    : public GenericTransientTrackingRecHit {
public:
  using MuonRecHitPointer = std::shared_ptr<MuonTransientTrackingRecHit>;
  using ConstMuonRecHitPointer =
      std::shared_ptr<MuonTransientTrackingRecHit const>;

  //  typedef ReferenceCountingPointer<MuonTransientTrackingRecHit>
  //  MuonRecHitPointer; typedef
  //  ConstReferenceCountingPointer<MuonTransientTrackingRecHit>
  ...
  static MuonRecHitPointer specificBuild(const GeomDet *geom,
