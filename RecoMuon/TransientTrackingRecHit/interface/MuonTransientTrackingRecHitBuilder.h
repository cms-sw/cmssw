...
class MuonTransientTrackingRecHitBuilder
    : public TransientTrackingRecHitBuilder {
...
public:
  ...
  MuonTransientTrackingRecHitBuilder(
      edm::ESHandle<GlobalTrackingGeometry> trackingGeometry = nullptr);
  ...
  RecHitPointer
  build(const TrackingRecHit *p,
        edm::ESHandle<GlobalTrackingGeometry> trackingGeometry) const;

  RecHitPointer build(const TrackingRecHit *p) const override;

  ConstRecHitContainer build(const trackingRecHit_iterator &start,
