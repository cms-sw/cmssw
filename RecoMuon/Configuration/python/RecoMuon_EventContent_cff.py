...
RecoMuonAOD = cms.PSet(
    outputCommands = cms.untracked.vstring(#'keep *_muons_*_*',
                                           ...
                                           'keep TrackingRecHitsOwned_thinnedGlobalMuonHits_*_*',
                                           'keep recoTracks_tevMuons_*_*',
                                           'keep recoTrackExtras_tevMuons_*_*',
                                           'keep TrackingRecHitsOwned_thinnedTevMuonHitsFirstHit_*_*',
                                           'keep TrackingRecHitsOwned_thinnedTevMuonHitsPicky_*_*',
                                           'keep TrackingRecHitsOwned_thinnedTevMuonHitsDyt_*_*',
