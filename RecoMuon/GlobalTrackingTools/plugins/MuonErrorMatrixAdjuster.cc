#include "RecoMuon/GlobalTrackingTools/interface/MuonErrorMatrixAdjuster.h"
...
MuonErrorMatrixAdjuster::MuonErrorMatrixAdjuster(const edm::ParameterSet& iConfig)
{
  ...
  //  theErrorMatrixRootFile = iConfig.getParameter<std::string>("errorMatrixRootFile");
...
{
  //  theMatrixProvider = new ErrorMatrix( theErrorMatrixRootFile.c_str());
  theMatrixProvider = new ErrorMatrix(theMatrixProvider_pset);
}
