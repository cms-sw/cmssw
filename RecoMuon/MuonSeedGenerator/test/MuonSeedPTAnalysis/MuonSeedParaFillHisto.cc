...
void MuonSeedParaFillHisto::FillOLSegmentPairByChamber(H2DRecHit10* hOL1[6], double pt1[5], double dPhiP2[2][5][5],
  ...
  for (int l=0; l<6; l++) {
      ...
      if ( MBPath[1][s1][w1] && MEPath[1][s2][w2] ) {
         ...
         hOL1[l]->Fill12a((pt1[1]*dPhiP2[1][s1][s2]), dPhiP2[1][s1][s2], dEtaP2[1][s1][s2], fabs(EtaP3[1][s1]), pt1[1], OL_Resol );
      }
  }
...
void MuonSeedParaFillHisto::FillCSCSegmentSingle(H2DRecHit6* hME2[8], double pt1[5],
                            double ME_phi[2][5][4], double ME_eta[2][5][4], bool MEPath[2][5][4]  ) {
...
void MuonSeedParaFillHisto::FillDTSegmentSingle(H2DRecHit7* hMB2[12], double pt1[5],
                            double MB_phi[2][5][3], double MB_eta[2][5][3], bool MBPath[2][5][3]  ) {
