...
void MuonIdProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   ...
   if ( innerTrackCollectionHandle_.isValid() ) {
     ...
     const std::vector<TrackDetectorAssociator::Direction> directions1 = {TrackDetectorAssociator::InsideOut, TrackDetectorAssociator::OutsideIn};
     const std::vector<TrackDetectorAssociator::Direction> directions2 = {TrackDetectorAssociator::Any};
