...
private:
  edm::InputTag
      EBdigiCollection_; // secondary name given to collection of digis
  edm::InputTag
      EEdigiCollection_; // secondary name given to collection of digis
  edm::InputTag
      tdcRecInfoCollection_; // secondary name given to collection of digis

  std::string
      EBhitCollection_; // secondary name to be given to collection of hit
  std::string
      EEhitCollection_; // secondary name to be given to collection of hit
  ...
  /*     HepMatrix makeMatrixFromVectors(const std::vector<
   * std::vector<EcalWeight> >& vecvec); */
  ...
  //    bool counterExceeded() const { return ( (counter_>nMaxPrintout_) ||
  //    (counter_<0) ) ; }
};
#endif
