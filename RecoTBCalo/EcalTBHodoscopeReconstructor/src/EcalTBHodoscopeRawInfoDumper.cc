...
EcalTBHodoscopeRawInfoDumper::EcalTBHodoscopeRawInfoDumper(
  ...
  rootfile_ = ps.getUntrackedParameter<std::string>(
      "rootfile", "ecalHodoscopeRawInfoPlots.root");
}

EcalTBHodoscopeRawInfoDumper::~EcalTBHodoscopeRawInfoDumper() {}

//========================================================================
void EcalTBHodoscopeRawInfoDumper::beginJob() {
  //========================================================================
...
//========================================================================
void EcalTBHodoscopeRawInfoDumper::endJob() {
  //========================================================================
...
void EcalTBHodoscopeRawInfoDumper::analyze(const edm::Event &e,
  ...
  if (hodoscopeRawInfo)
    for (int i = 0; i < 4; i++) {
      ...
      LogDebug("EcalTBHodoscope")
          << "Looking plane " << i << " number of hits "
          << (*hodoscopeRawInfo)[i].numberOfFiredHits() << str.str();
    }
  // Create empty output
}
