...
public:
  ...
  explicit EcalTBH2TDCRecInfoAlgo(
      const std::vector<EcalTBH2TDCRanges> &tdcZero);

  ~EcalTBH2TDCRecInfoAlgo(){};

  EcalTBTDCRecInfo reconstruct(const int &runNumber,
                               const HcalTBTiming &TDCRawInfo) const;
