...
private:
  ...
  std::string triggerDataProducer_;   // name of module/plugin/producer making
                                      // TBeventheader
  std::string triggerDataCollection_; // secondary name given to collection of
                                      // TBeventheader
  std::string
      recInfoCollection_; // secondary name to be given to collection of hits
