...
class EcalTBTDCRecInfoProducer : public edm::EDProducer {
...
private:
  ...
  std::string eventHeaderProducer_;   // name of module/plugin/producer making
                                      // TBeventheader
  std::string eventHeaderCollection_; // secondary name given to collection of
                                      // TBeventheader
  std::string
