...
EcalTBTDCRawInfoDumper::EcalTBTDCRawInfoDumper(edm::ParameterSet const &ps) {
  ...
  rootfile_ = ps.getUntrackedParameter<std::string>("rootfile",
...
//========================================================================
void EcalTBTDCRawInfoDumper::beginJob() {
  //========================================================================
  h_TDCrawValue_ =
      new TH1F("h_TDCrawValue", "TDC raw value", 2048, -0.5, 2047.5);
}

//========================================================================
void EcalTBTDCRawInfoDumper::endJob() {
  //========================================================================
