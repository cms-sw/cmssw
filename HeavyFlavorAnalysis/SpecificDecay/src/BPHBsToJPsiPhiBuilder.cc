...
BPHBsToJPsiPhiBuilder::BPHBsToJPsiPhiBuilder(const edm::EventSetup& es,
    ...
    : jPsiName("JPsi"), phiName("Phi"), evSetup(&es), jCollection(&jpsiCollection), pCollection(&phiCollection) {
...
/// get current cuts
double BPHBsToJPsiPhiBuilder::getJPsiMassMin() const { return jpsiSel->getMassMin(); }

double BPHBsToJPsiPhiBuilder::getJPsiMassMax() const { return jpsiSel->getMassMax(); }

double BPHBsToJPsiPhiBuilder::getPhiMassMin() const { return mphiSel->getMassMin(); }

double BPHBsToJPsiPhiBuilder::getPhiMassMax() const { return mphiSel->getMassMax(); }

double BPHBsToJPsiPhiBuilder::getMassMin() const { return massSel->getMassMin(); }

double BPHBsToJPsiPhiBuilder::getMassMax() const { return massSel->getMassMax(); }

double BPHBsToJPsiPhiBuilder::getProbMin() const { return chi2Sel->getProbMin(); }

double BPHBsToJPsiPhiBuilder::getMassFitMin() const { return mFitSel->getMassMin(); }

double BPHBsToJPsiPhiBuilder::getMassFitMax() const { return mFitSel->getMassMax(); }

bool BPHBsToJPsiPhiBuilder::getConstr() const { return massConstr; }
