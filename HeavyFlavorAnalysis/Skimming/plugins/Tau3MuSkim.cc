...
Tau3MuSkim::~Tau3MuSkim() { delete m_Tau3MuReco; }
...
bool Tau3MuSkim::filter(edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
void Tau3MuSkim::beginJob() {}

// ------------ method called once each job just after ending the event loop  ------------
void Tau3MuSkim::endJob() {}
