...
public:
    ...
    Int_t EqualPermutation(std::vector<UInt_t> permutation1, 
                           std::vector<UInt_t> permutation2);
    Int_t EqualPermutation_2_0(std::vector<UInt_t> permutation1, 
                               std::vector<UInt_t> permutation2);
    Int_t EqualPermutation_2_2(std::vector<UInt_t> permutation1, 
                               std::vector<UInt_t> permutation2);
    Int_t EqualPermutation_N_1(std::vector<UInt_t> permutation1, 
                               std::vector<UInt_t> permutation2);
...
private:
    ...
    void  Skip_2_0(std::vector <std::vector <UInt_t> > permutation1, 
                   std::vector <std::vector <UInt_t> > &permutation2);
    void  Skip_2_2(std::vector <std::vector <UInt_t> > permutation1, 
                   std::vector <std::vector <UInt_t> > &permutation2);
