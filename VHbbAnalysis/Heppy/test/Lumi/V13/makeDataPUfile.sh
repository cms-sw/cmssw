...
JSON=Cert_246908-255031_13TeV_PromptReco_Collisions15_25ns_JSON_v2.txt
...
pileupCalc.py -i ${JSON} --inputLumiJSON $PUJSON --calcMode true --minBiasXsec $MINBIAS --maxPileupBin 51 --numPileupBins 52  outputfile.root
