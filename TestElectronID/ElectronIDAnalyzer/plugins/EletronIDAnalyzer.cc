// -*- C++ -*-
//
// Package:    TestElectronID/EletronIDAnalyzer
// Class:      EletronIDAnalyzer
// 
/**\class EletronIDAnalyzer EletronIDAnalyzer.cc TestElectronID/EletronIDAnalyzer/plugins/EletronIDAnalyzer.cc
...
class EletronIDAnalyzer : public edm::EDAnalyzer {
   public:
      explicit EletronIDAnalyzer(const edm::ParameterSet&);
      ~EletronIDAnalyzer();
...
//
EletronIDAnalyzer::EletronIDAnalyzer(const edm::ParameterSet& iConfig):
...
EletronIDAnalyzer::~EletronIDAnalyzer()
{
...
void
EletronIDAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   // using namespace edm;
...
void 
EletronIDAnalyzer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
EletronIDAnalyzer::endJob() 
{
}
...
/*
void 
EletronIDAnalyzer::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
EletronIDAnalyzer::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
EletronIDAnalyzer::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
EletronIDAnalyzer::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
EletronIDAnalyzer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
int EletronIDAnalyzer::matchToTruth(const reco::GsfElectron &el, 
...
void EletronIDAnalyzer::findFirstNonElectronMother(const reco::Candidate *particle,
...
DEFINE_FWK_MODULE(EletronIDAnalyzer);
