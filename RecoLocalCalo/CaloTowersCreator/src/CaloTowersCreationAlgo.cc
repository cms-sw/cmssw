...
CaloTowersCreationAlgo::CaloTowersCreationAlgo()
    : theEBthreshold(-1000.), theEEthreshold(-1000.),

      theUseEtEBTresholdFlag(false), theUseEtEETresholdFlag(false),
      theUseSymEBTresholdFlag(false), theUseSymEETresholdFlag(false),

      theHcalThreshold(-1000.), theHBthreshold(-1000.), theHBthreshold1(-1000.),
      theHBthreshold2(-1000.), theHESthreshold(-1000.),
      theHESthreshold1(-1000.), theHEDthreshold(-1000.),
      theHEDthreshold1(-1000.), theHOthreshold0(-1000.),
      theHOthresholdPlus1(-1000.), theHOthresholdMinus1(-1000.),
      theHOthresholdPlus2(-1000.), theHOthresholdMinus2(-1000.),
      theHF1threshold(-1000.), theHF2threshold(-1000.),
      ...
      theHF2Weights(std::vector<double>(5, 1.)), theEBweight(1.),
      theEEweight(1.), theHBweight(1.), theHESweight(1.), theHEDweight(1.),
      theHOweight(1.), theHF1weight(1.), theHF2weight(1.), theEcutTower(-1000.),
      theEBSumThreshold(-1000.), theEESumThreshold(-1000.), theEBEScale(50.),
      theEEEScale(50.), theHBEScale(50.), theHESEScale(50.), theHEDEScale(50.),
      theHOEScale(50.), theHF1EScale(50.), theHF2EScale(50.),
      theHcalTopology(nullptr), theGeometry(nullptr),
      theTowerConstituentsMap(nullptr), theHcalAcceptSeverityLevel(0),
      theRecoveredHcalHitsAreUsed(false), theRecoveredEcalHitsAreUsed(false),
      useRejectedHitsOnly(false), theHcalAcceptSeverityLevelForRejectedHit(0),
      useRejectedRecoveredHcalHits(0), useRejectedRecoveredEcalHits(0),
      missingHcalRescaleFactorForEcal(0.), theHOIsUsed(true),
      // (for momentum reconstruction algorithm)
      theMomConstrMethod(0), theMomHBDepth(0.), theMomHEDepth(0.),
      theMomEBDepth(0.), theMomEEDepth(0.), theHcalPhase(0) {}

CaloTowersCreationAlgo::CaloTowersCreationAlgo(
    double EBthreshold, double EEthreshold,

    bool useEtEBTreshold, bool useEtEETreshold, bool useSymEBTreshold,
    bool useSymEETreshold,

    double HcalThreshold, double HBthreshold, double HBthreshold1,
    double HBthreshold2, double HESthreshold, double HESthreshold1,
    double HEDthreshold, double HEDthreshold1, double HOthreshold0,
    double HOthresholdPlus1, double HOthresholdMinus1, double HOthresholdPlus2,
    double HOthresholdMinus2, double HF1threshold, double HF2threshold,
    double EBweight, double EEweight, double HBweight, double HESweight,
    double HEDweight, double HOweight, double HF1weight, double HF2weight,
    double EcutTower, double EBSumThreshold, double EESumThreshold, bool useHO,
    // (momentum reconstruction algorithm)
    int momConstrMethod, double momHBDepth, double momHEDepth,
    double momEBDepth, double momEEDepth, int hcalPhase)

    : theEBthreshold(EBthreshold), theEEthreshold(EEthreshold),
      ...
      theHcalThreshold(HcalThreshold), theHBthreshold(HBthreshold),
      theHBthreshold1(HBthreshold1), theHBthreshold2(HBthreshold2),
      theHESthreshold(HESthreshold), theHESthreshold1(HESthreshold1),
      theHEDthreshold(HEDthreshold), theHEDthreshold1(HEDthreshold1),
      theHOthreshold0(HOthreshold0), theHOthresholdPlus1(HOthresholdPlus1),
      theHOthresholdMinus1(HOthresholdMinus1),
      theHOthresholdPlus2(HOthresholdPlus2),
      theHOthresholdMinus2(HOthresholdMinus2), theHF1threshold(HF1threshold),
      theHF2threshold(HF2threshold), theEBGrid(std::vector<double>(5, 10.)),
      theEBWeights(std::vector<double>(5, 1.)),
      theEEGrid(std::vector<double>(5, 10.)),
      theEEWeights(std::vector<double>(5, 1.)),
      theHBGrid(std::vector<double>(5, 10.)),
      ...
      theHF1Weights(std::vector<double>(5, 1.)),
      theHF2Grid(std::vector<double>(5, 10.)),
      theHF2Weights(std::vector<double>(5, 1.)), theEBweight(EBweight),
      theEEweight(EEweight), theHBweight(HBweight), theHESweight(HESweight),
      theHEDweight(HEDweight), theHOweight(HOweight), theHF1weight(HF1weight),
      theHF2weight(HF2weight), theEcutTower(EcutTower),
      theEBSumThreshold(EBSumThreshold), theEESumThreshold(EESumThreshold),
      theEBEScale(50.), theEEEScale(50.), theHBEScale(50.), theHESEScale(50.),
      theHEDEScale(50.), theHOEScale(50.), theHF1EScale(50.), theHF2EScale(50.),
      theHcalTopology(nullptr), theGeometry(nullptr),
      theTowerConstituentsMap(nullptr), theHcalAcceptSeverityLevel(0),
      theRecoveredHcalHitsAreUsed(false), theRecoveredEcalHitsAreUsed(false),
      useRejectedHitsOnly(false), theHcalAcceptSeverityLevelForRejectedHit(0),
      useRejectedRecoveredHcalHits(0), useRejectedRecoveredEcalHits(0),
      missingHcalRescaleFactorForEcal(0.), theHOIsUsed(useHO),
      // (momentum reconstruction algorithm)
      theMomConstrMethod(momConstrMethod), theMomHBDepth(momHBDepth),
      theMomHEDepth(momHEDepth), theMomEBDepth(momEBDepth),
      theMomEEDepth(momEEDepth), theHcalPhase(hcalPhase) {}

CaloTowersCreationAlgo::CaloTowersCreationAlgo(
    double EBthreshold, double EEthreshold, bool useEtEBTreshold,
    bool useEtEETreshold, bool useSymEBTreshold, bool useSymEETreshold,
    ...
    : theEBthreshold(EBthreshold), theEEthreshold(EEthreshold),
      ...
      theHOthresholdPlus2(HOthresholdPlus2),
      theHOthresholdMinus2(HOthresholdMinus2), theHF1threshold(HF1threshold),
      theHF2threshold(HF2threshold), theEBGrid(EBGrid), theEBWeights(EBWeights),
      theEEGrid(EEGrid), theEEWeights(EEWeights), theHBGrid(HBGrid),
      theHBWeights(HBWeights), theHESGrid(HESGrid), theHESWeights(HESWeights),
      theHEDGrid(HEDGrid), theHEDWeights(HEDWeights), theHOGrid(HOGrid),
      theHOWeights(HOWeights), theHF1Grid(HF1Grid), theHF1Weights(HF1Weights),
      theHF2Grid(HF2Grid), theHF2Weights(HF2Weights), theEBweight(EBweight),
      theEEweight(EEweight), theHBweight(HBweight), theHESweight(HESweight),
      theHEDweight(HEDweight), theHOweight(HOweight), theHF1weight(HF1weight),
      theHF2weight(HF2weight), theEcutTower(EcutTower),
      theEBSumThreshold(EBSumThreshold), theEESumThreshold(EESumThreshold),
...
void CaloTowersCreationAlgo::process(const HORecHitCollection &ho) {
  for (HORecHitCollection::const_iterator hoItr = ho.begin(); hoItr != ho.end();
       ++hoItr)
    assignHitHcal(&(*hoItr));
}

void CaloTowersCreationAlgo::process(const HFRecHitCollection &hf) {
  for (HFRecHitCollection::const_iterator hfItr = hf.begin(); hfItr != hf.end();
       ++hfItr)
    assignHitHcal(&(*hfItr));
}
...
void CaloTowersCreationAlgo::finish(CaloTowerCollection &result) {
  ...
  // auto k=0U;
  //  if (!theEbHandle.isValid()) std::cout << "VI ebHandle not valid" <<
  //  std::endl;
  // if (!theEeHandle.isValid()) std::cout << "VI eeHandle not valid" <<
  // std::endl;
...
void CaloTowersCreationAlgo::rescaleTowers(const CaloTowerCollection &ctc,
                                           CaloTowerCollection &ctcResult) {
  ...
  for (CaloTowerCollection::const_iterator ctcItr = ctc.begin();
    ...
    if (ctcItr->ietaAbs() >= theTowerTopology->firstHFRing()) {
      ...
      for (unsigned int iConst = 0; iConst < ctcItr->constituentsSize();
           ++iConst) {
    ...
    double newE_hadTot =
        (theHOIsUsed && twrId.ietaAbs() <= theTowerTopology->lastHORing())
            ? newE_had + newE_outer
            : newE_had;
    ...
    if (ctcItr->ietaAbs() < theTowerTopology->firstHFRing()) {
      if (newE_em > 0)
        towerP4 += CaloTower::PolarLorentzVector(newE_em * f_em, emPoint.eta(),
                                                 emPoint.phi(), 0);
      if (newE_hadTot > 0)
        towerP4 += CaloTower::PolarLorentzVector(
            newE_hadTot * f_had, hadPoint.eta(), hadPoint.phi(), 0);
    } else {
      double newE_tot = newE_em + newE_had;
      // for HF we use common point for ecal, hcal shower positions regardless
      // of the method
      if (newE_tot > 0)
        towerP4 += CaloTower::PolarLorentzVector(
            newE_tot * f_had, hadPoint.eta(), hadPoint.phi(), 0);
    }

    CaloTower rescaledTower(twrId, newE_em, newE_had, newE_outer, -1, -1,
                            towerP4, emPoint, hadPoint);
    ...
    // add topology info
    rescaledTower.setHcalSubdet(
        theTowerTopology->lastHBRing(), theTowerTopology->lastHERing(),
        theTowerTopology->lastHFRing(), theTowerTopology->lastHORing());
...
void CaloTowersCreationAlgo::assignHitHcal(const CaloRecHit *recHit) {
  ...
  double energy =
      recHit->energy(); // original RecHit energy is used to apply thresholds
  double e =
      energy *
      weight; // energies scaled by user weight: used in energy assignments

  // SPECIAL handling of tower 28 merged depths --> half into tower 28 and half
  // into tower 29
  bool merge(false);
  ...
  if (merge) {
    ...
    if (chStatusForCT == CaloTowersCreationAlgo::BadChan) {
      ...
      tower29.numBadHcalCells += 1;
             ...
             threshold) { // not bad channel: use energy if above threshold
    ...
    if (hcalDetId.subdet() == HcalOuter) {
      ...
      if (chStatusForCT == CaloTowersCreationAlgo::BadChan) {
        ...
        // add HO to constituents even if it is not used: JetMET wants to keep
        // these towers
    ...
    // HF calculates EM fraction differently
      ...
      if (chStatusForCT == CaloTowersCreationAlgo::BadChan) {
        ...
        // store energy in highest depth for towers 18-27 (for electron,photon
        // ID in endcap) also, store energy in HE part of tower 16 (for JetMET
        // cleanup)
        HcalDetId hcalDetId(detId);
        if (hcalDetId.subdet() == HcalEndcap) {
          if (theHcalPhase == 0) {
            if ((hcalDetId.depth() == 2 && hcalDetId.ietaAbs() >= 18 &&
                 hcalDetId.ietaAbs() < 27) ||
          ...
          // combine depths in phase0-like way
            ...
            if ((hcalDetId.depth() >= 3 && hcalDetId.ietaAbs() >= 18 &&
                 hcalDetId.ietaAbs() < 26) ||
                (hcalDetId.depth() >= 4 &&
                 (hcalDetId.ietaAbs() == 26 || hcalDetId.ietaAbs() == 27)) ||
...
void CaloTowersCreationAlgo::assignHitEcal(const EcalRecHit *recHit) {
  ...
  // count bad cells and avoid double counting with those from DB (Recovered are
  // counted bad)

  // somehow misses some
  // if ( (chStatusForCT == CaloTowersCreationAlgo::BadChan) & (!ecalIsBad) )
  ...
  if (chStatusForCT == CaloTowersCreationAlgo::BadChan) {
    ...
    auto sevit = std::find(theEcalSeveritiesToBeExcluded.begin(),
                           theEcalSeveritiesToBeExcluded.end(), thisEcalSevLvl);
    if (sevit == theEcalSeveritiesToBeExcluded.end())
      ++tower.numBadEcalCells; // notinDB
  }

  //      if (chStatusForCT != CaloTowersCreationAlgo::BadChan && energy >=
  //      threshold) {
...
// For now make a quick compatibility "fix" : WILL NOT WORK CORRECTLY with
// anything except the default simple p4 assignment!!! Must be rewritten for
// full functionality.
...
CaloTowersCreationAlgo::find(const CaloTowerDetId &detId) {
  ...
  if (mt.empty()) {
    mt.id = detId;
    mt.metaConstituents.reserve(
        detId.ietaAbs() < theTowerTopology->firstHFRing() ? 12 : 2);
    ++theTowerMapSize;
  }
...
void CaloTowersCreationAlgo::convert(const CaloTowerDetId &id,
  ...
  double ecalThres =
      (id.ietaAbs() <= 17) ? (theEBSumThreshold) : (theEESumThreshold);
  double E = mt.E;
  double E_em = mt.E_em;
  double E_had = mt.E_had;
  double E_outer = mt.E_outer;

  // Note: E_outer is used to save HO energy OR energy in the outermost depths
  // in endcap region In the methods with separate treatment of EM and HAD
  // components:
  //  - HO is not used to determine direction, however HO energy is added to get
  //  "total had energy"
  //  => Check if the tower is within HO coverage before adding E_outer to the
  //  "total had" energy
  //     else the energy will be double counted
  // When summing up the energy of the tower these checks are performed in the
  // loops over RecHits

  std::vector<std::pair<DetId, float>> metaContains = mt.metaConstituents;
  if (id.ietaAbs() < theTowerTopology->firstHFRing() &&
      E_em < ecalThres) { // ignore EM threshold in HF
    E -= E_em;
    E_em = 0;
    std::vector<std::pair<DetId, float>> metaContains_noecal;

    for (std::vector<std::pair<DetId, float>>::iterator i =
             metaContains.begin();
         i != metaContains.end(); ++i)
      if (i->first.det() != DetId::Ecal)
        metaContains_noecal.push_back(*i);
    metaContains.swap(metaContains_noecal);
  }
  if (id.ietaAbs() < theTowerTopology->firstHFRing() &&
      E_had < theHcalThreshold) {
    E -= E_had;
  ...
  double E_had_tot =
      (theHOIsUsed && id.ietaAbs() <= theTowerTopology->lastHORing())
          ? E_had + E_outer
          : E_had;
  ...
  case 0: { // Simple 4-momentum assignment
    ...
    // if (E>0) towerP4 = CaloTower::PolarLorentzVector(E*pf, p.eta(), p.phi(),
    // 0);
  ...
  case 1: { // separate 4-vectors for ECAL, HCAL, add to get the 4-vector of the
            // tower (=>tower has mass!)
    if (id.ietaAbs() < theTowerTopology->firstHFRing()) {
      Basic3DVectorF emP4;
      if (E_em > 0) {
        ...
        // towerP4 += CaloTower::PolarLorentzVector(E_em*emPf, emPoint.eta(),
        // emPoint.phi(), 0);
      }
      if ((E_had + E_outer) > 0) {
        massless = (E_em <= 0);
        ...
        if (!massless) {
           auto p = towerP4;
           double m2 = double(p[3]*p[3]) -
        double(p[0]*p[0])+double(p[1]*p[1])+double(p[2]*p[2]); mass1 = m2>0 ?
        std::sqrt(m2) : 0;
        }
        */
        // double hadPf = 1.0/cosh(hadPoint.eta());
        // if (E_had_tot>0) {
        //  towerP4 += CaloTower::PolarLorentzVector(E_had_tot*hadPf,
        //  hadPoint.eta(), hadPoint.phi(), 0);
        // }
      }
      ...
      towerP4 *= E;
      // double pf=1.0/cosh(p.eta());
      // if (E>0) towerP4 = CaloTower::PolarLorentzVector(E*pf, p.eta(),
      // p.phi(), 0);  // simple momentum assignment, same position
      emPoint = p;
      hadPoint = p;
    }
  } // end case 1
  ...
  case 2: { // use ECAL position for the tower (when E_cal>0), else default
            // CaloTower position (massless tower)
    if (id.ietaAbs() < theTowerTopology->firstHFRing()) {
      if (E_em > 0)
      ...
      /// if (E>0) towerP4 = CaloTower::PolarLorentzVector(E*sumPf,
      /// emPoint.eta(), emPoint.phi(), 0);
  ...
  if
    UNLIKELY((towerP4[3] == 0) & (E_outer > 0)) {
      float val =
          theHOIsUsed
              ? 0
              : 1E-9; // to keep backwards compatibility for theHOIsUsed == true
    ...
    collection.emplace_back(id, E_em, E_had, E_outer, -1, -1,
                            GlobalVector(towerP4), towerP4[3], mass2, emPoint,
                            hadPoint);
  }
  auto &caloTower = collection.back();

  // if (!massless) std::cout << "massive " << id <<' ' << mass1 <<' ' << mass2
  // <<' ' <<  caloTower.mass() << std::endl; std::cout << "CaloTowerVI "
  // <<theMomConstrMethod <<' ' << id <<' '<< E_em <<' '<< E_had <<' '<< E_outer
  // <<' '<< GlobalVector(towerP4) <<' '<< towerP4[3] <<' '<< emPoint <<' '<<
  // hadPoint << std::endl;
  // if (towerP4[3]==0) std::cout << "CaloTowerVIzero " << theEcutTower << ' '
  // << collection.back().eta() <<' '<< collection.back().phi() << std::endl;
  ...
  // set the timings
  float ecalTime =
      (mt.emSumEForTime > 0) ? mt.emSumTimeTimesE / mt.emSumEForTime : -9999;
  float hcalTime =
      (mt.hadSumEForTime > 0) ? mt.hadSumTimeTimesE / mt.hadSumEForTime : -9999;
  ...
  std::vector<DetId> allConstituents =
 theTowerConstituentsMap->constituentsOf(id);
 ...
 *theEbHandle);//, *theEcalChStatus);
    }
    else if (ac_it->subdetId() == EcalEndcap && theEeHandle.isValid()) {
      thisEcalSevLvl = theEcalSevLvlAlgo->severityLevel( *ac_it,
 *theEeHandle);//, *theEcalChStatus);
    }

    // check if the Ecal severity is ok to keep
    std::vector<int>::const_iterator sevit =
 std::find(theEcalSeveritiesToBeExcluded.begin(),
 ...
 //  hcal:
  int inEcals[2] = {0,0};
  for (std::vector<std::pair<DetId,float> >::iterator i=metaContains.begin();
 i!=metaContains.end(); ++i) { DetId detId = i->first; if(detId.det() ==
 DetId::Ecal){ if( detId.subdetId()==EcalBarrel ) inEcals[0] =1; else if(
 detId.subdetId()==EcalEndcap ) inEcals[1] =1;
    }
  }

   auto  numBadEcalChanNew =
 ecalBadChs[theTowerTopology->denseIndex(id)]+mt.numBadEcalCells; // -
 mt.numRecEcalCells if (int(numBadEcalChanNew)!=int(numBadEcalChan)) { std::cout
 << "VI wrong " << ((inEcals[1]==1) ? "EE" : "" ) << id << " " <<
 numBadEcalChanNew << " " << numBadEcalChan
               << " " << mt.numBadEcalCells << " " << mt.numRecEcalCells <<
 std::endl;
   }
   */

  numBadEcalChan = ecalBadChs[theTowerTopology->denseIndex(id)] +
                   mt.numBadEcalCells; // - mt.numRecEcalCells

  //--------------------------------------------------------------------------------------

  caloTower.setCaloTowerStatus(numBadHcalChan, numBadEcalChan, numRecHcalChan,
                               numRecEcalChan, numProbHcalChan,
                               numProbEcalChan);
  ...
  for (std::vector<std::pair<DetId, float>>::iterator i = metaContains.begin();
    ...
    if (maxCellE < i->second) {
      // need an extra check because of the funny towers that are empty except
      // for the presence of an HO hit in the constituents (JetMET wanted them
      // saved) This constituent is only used for storing the tower, but should
      // not be concidered as a hot cell canditate for configurations with useHO
      // = false
  ...
  // std::cout << "CaloTowerVI " << nalgo << ' ' << caloTower.id() <<
  // ((inEcals[1]==1) ? "EE " : " " )  << caloTower.pt() << ' ' <<
  // caloTower.et() << ' ' << caloTower.mass() << ' '
  //           << caloTower.constituentsSize() <<' '<<
  //           caloTower.towerStatusWord() << std::endl;
}
...
void CaloTowersCreationAlgo::getThresholdAndWeight(const DetId &detId,
  ...
  if (det == DetId::Ecal) {
    ...
    if (subdet == EcalBarrel) {
      ...
      weight = theEBweight;
      if (weight <= 0.) {
        ROOT::Math::Interpolator my(theEBGrid, theEBWeights,
      ...
      weight = theEEweight;
      if (weight <= 0.) {
        ROOT::Math::Interpolator my(theEEGrid, theEEWeights,
                                    ROOT::Math::Interpolation::kAKIMA);
    ...
    if (subdet == HcalBarrel) {
      threshold = (depth == 1)
                      ? theHBthreshold1
                      : (depth == 2) ? theHBthreshold2 : theHBthreshold;
      weight = theHBweight;
      if (weight <= 0.) {
        ROOT::Math::Interpolator my(theHBGrid, theHBWeights,
                                    ROOT::Math::Interpolation::kAKIMA);
      ...
      if (hcalDetId.ietaAbs() < theHcalTopology->firstHEDoublePhiRing()) {
        ...
        weight = theHESweight;
        if (weight <= 0.) {
          ROOT::Math::Interpolator my(theHESGrid, theHESWeights,
                                      ROOT::Math::Interpolation::kAKIMA);
        ...
        weight = theHEDweight;
        if (weight <= 0.) {
          ROOT::Math::Interpolator my(theHEDGrid, theHEDWeights,
                                      ROOT::Math::Interpolation::kAKIMA);
      ...
      if (hcalDetId.ietaAbs() <= 4)
        ...
        threshold = (hcalDetId.ietaAbs() <= 10) ? theHOthresholdMinus1
                                                : theHOthresholdMinus2;
      } else {
        // set threshold for ring +1 or +2
        threshold = (hcalDetId.ietaAbs() <= 10) ? theHOthresholdPlus1
                                                : theHOthresholdPlus2;
      }
      weight = theHOweight;
      if (weight <= 0.) {
        ROOT::Math::Interpolator my(theHOGrid, theHOWeights,
                                    ROOT::Math::Interpolation::kAKIMA);
      ...
      if (hcalDetId.depth() == 1) {
        ...
        weight = theHF1weight;
        if (weight <= 0.) {
          ROOT::Math::Interpolator my(theHF1Grid, theHF1Weights,
                                      ROOT::Math::Interpolation::kAKIMA);
        ...
        weight = theHF2weight;
        if (weight <= 0.) {
          ROOT::Math::Interpolator my(theHF2Grid, theHF2Weights,
                                      ROOT::Math::Interpolation::kAKIMA);
...
GlobalPoint CaloTowersCreationAlgo::hadShwrPos(
    const std::vector<std::pair<DetId, float>> &metaContains, float fracDepth,
    double hadE) {
  ...
  std::cout << "hadShwrPos called with " << metaContains.size()
            << " elements and energy " << hadE << ":" << fracDepth << std::endl;
#endif
  if (hadE <= 0)
  ...
  std::vector<std::pair<DetId, float>>::const_iterator mc_it =
      metaContains.begin();
...
GlobalPoint CaloTowersCreationAlgo::hadShwrPos(CaloTowerDetId towerId,
                                               float fracDepth) {
  ...
  if (towerId.ietaAbs() >= theTowerTopology->firstHFRing()) {
    ...
    frontCellId = HcalDetId(HcalForward,
                            towerId.zside() *
                                theTowerTopology->convertCTtoHcal(abs(iEta)),
                            iPhi, 1);
    backCellId = HcalDetId(HcalForward,
                           towerId.zside() *
                               theTowerTopology->convertCTtoHcal(abs(iEta)),
                           iPhi, 1);
  } else {
...
#ifdef EDM_ML_DEBUG
    std::cout << "Front " << frontCellId << " Back " << backCellId << " Depths "
              << frontDepth << ":" << backDepth << std::endl;
#endif
    // fix for tower 28/29 - no tower 29 at highest depths
    if (towerId.ietaAbs() == theTowerTopology->lastHERing() &&
        (theHcalPhase == 0 || theHcalPhase == 1)) {
      CaloTowerDetId towerId28(towerId.ieta() - towerId.zside(),
                               towerId.iphi());
      std::vector<DetId> items28 =
          theTowerConstituentsMap->constituentsOf(towerId28);
#ifdef EDM_ML_DEBUG
...
GlobalPoint CaloTowersCreationAlgo::hadShwPosFromCells(DetId frontCellId,
                                                       DetId backCellId,
                                                       float fracDepth) {
...
GlobalPoint CaloTowersCreationAlgo::emShwrPos(
    const std::vector<std::pair<DetId, float>> &metaContains, float fracDepth,
    double emE) {
...
GlobalPoint CaloTowersCreationAlgo::emShwrLogWeightPos(
    const std::vector<std::pair<DetId, float>> &metaContains, float fracDepth,
    double emE) {
...
void CaloTowersCreationAlgo::makeHcalDropChMap() {
  ...
  std::cout << "DropChMap with " << allChanInStatusCont.size() << " channels"
            << std::endl;
#endif
  for (std::vector<DetId>::iterator it = allChanInStatusCont.begin();
       it != allChanInStatusCont.end(); ++it) {
    ...
    if (theHcalSevLvlComputer->dropChannel(dbStatusFlag)) {
      ...
      // special case for tower 29: if HCAL hit is in depth 3 add to twr 29 as
      // well
  ...
  // now I know how many bad channels, but I also need to know if there's any
  // good ones
    ...
    for (auto &pair : hcalDropChMap) {
      ...
      for (DetId id : theTowerConstituentsMap->constituentsOf(pair.first)) {
        ...
        if (hid.subdet() != HcalBarrel && hid.subdet() != HcalEndcap)
          continue;
        const uint32_t dbStatusFlag =
            theHcalChStatus->getValues(id)->getValue();
        if (dbStatusFlag == 0 ||
            !theHcalSevLvlComputer->dropChannel(dbStatusFlag)) {
          ngood += 1;
        } else {
      ...
      if (nbad > 0 && nbad >= ngood) {
        ...
        // std::cout << "CaloTower at ieta = " << id.ieta() << ", iphi " <<
        // id.iphi() << ": set Hcal as not efficient (ngood =" << ngood << ",
        // nbad = " << nbad << ")" << std::endl;
...
unsigned int
CaloTowersCreationAlgo::hcalChanStatusForCaloTower(const CaloRecHit *hit) {
  ...
  int severityLevel =
      theHcalSevLvlComputer->getSeverityLevel(id, recHitFlag, dbStatusFlag);
  ...
  if (useRejectedHitsOnly) {
    ...
    if (!isRecovered) {
      ...
      if (theRecoveredHcalHitsAreUsed || !useRejectedRecoveredHcalHits) {
        // skip recovered hits either because they were already used or because
        // there was an explicit instruction
        return CaloTowersCreationAlgo::IgnoredChan;
    ...
    // clasify channels as problematic: no good hits are supposed to be present
    // in the extra rechit collections
  ...
  if (isRecovered) {
    return (theRecoveredHcalHitsAreUsed) ? CaloTowersCreationAlgo::RecoveredChan
...
CaloTowersCreationAlgo::ecalChanStatusForCaloTower(const EcalRecHit *hit) {
  ...
  // The methods above will become private and cannot be usef for flagging ecal
  // spikes. Use the recommended interface - we leave the parameters for spilke
  // removal to be specified by ECAL.
  ...
  //  if      (id.subdetId() == EcalBarrel) severityLevel =
  //  theEcalSevLvlAlgo->severityLevel( id, *theEbHandle);//, *theEcalChStatus);
  //  else if (id.subdetId() == EcalEndcap) severityLevel =
  //  theEcalSevLvlAlgo->severityLevel( id, *theEeHandle);//, *theEcalChStatus);
  ...
  // for CaloTowers depends on the specified maximum acceptabel severity and
  // therefore cannnot be exact correspondence between the two. ECAL has
  // additional categories describing modes of failure.) This approach is
  // different from the initial idea and from the implementation for HCAL. Still
  // make the logic similar to HCAL so that one has the ability to exclude
  // problematic channels as defined by ECAL. For definitions of ECAL severity
  // levels see RecoLocalCalo/EcalRecAlgos/interface/EcalSeverityLevelAlgo.h
  ...
  std::vector<int>::const_iterator sevit =
      std::find(theEcalSeveritiesToBeExcluded.begin(),
                theEcalSeveritiesToBeExcluded.end(), severityLevel);
  ...
  // the information from the default towers and a collection of towers created
  // from bad rechits
  ...
  if (isRecovered) {
    ...
    return std::make_tuple(accepted ? CaloTowersCreationAlgo::ProblematicChan
                                    : CaloTowersCreationAlgo::BadChan,
                           isBad);
  }
}
