...
public:
  ...
  severityLevel(const DetId &id, const EcalRecHitCollection &rhs) const;
...
private:
  ...
  /** The position in the vector is the EcalSeverityLevel
      The content defines which EcalRecHit::Flag should be mapped into that
     EcalSeverityLevel in a bit-wise way */
