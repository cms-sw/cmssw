...
typedef Eigen::Matrix<double, Eigen::Dynamic, 1, 0, PulseVectorSize, 1>
    PulseVector;
...
typedef Eigen::Matrix<double, FullSampleVectorSize, FullSampleVectorSize>
    FullSampleMatrix;
typedef Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, 0,
                      PulseVectorSize, PulseVectorSize>
    PulseMatrix;
typedef Eigen::Matrix<double, SampleVectorSize, Eigen::Dynamic, 0,
                      SampleVectorSize, PulseVectorSize>
    SamplePulseMatrix;
