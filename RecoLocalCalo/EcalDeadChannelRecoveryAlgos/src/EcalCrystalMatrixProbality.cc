...
double EcalCrystalMatrixProbality<EBDetId>::Diagonal(double x){
  double vEBDiagonal = 0.0 ;
       ...
       if ( 0.000 < x && x <= 0.010 ) { vEBDiagonal = TMath::Landau(x,7.02750e-03,2.41060e-03,true)*3.96033283438174431e+03/4.39962923475768821e+03 ; }
  else if ( 0.010 < x && x <= 0.100 ) { vEBDiagonal = TMath::Landau(x,1.70472e-03,2.47564e-03,true)*8.34898553737588554e+03/4.39962923475768821e+03 ; }
...
double EcalCrystalMatrixProbality<EBDetId>::UpDown(double x){
  ...
  else if ( 0.005 < x && x <= 0.015 ) { vEBUpDown = TMath::Landau(x, 1.51342e-02, 3.65756e-03,true)*7.04501225670452641e+02/2.20315994559946967e+03 ; }
  else if ( 0.015 < x && x <= 0.020 ) { vEBUpDown = TMath::Landau(x, 1.52460e-02, 5.04539e-03 ,true)*9.70980301933632518e+02/2.20315994559946967e+03 ; }
...
double EcalCrystalMatrixProbality<EBDetId>::ReftRight(double x){
  ...
  else if ( 0.003 < x && x <= 0.010 ) { vEBReftRight = TMath::Landau(x,  9.56298e-03,  2.59171e-03,true)*1.27769617491053555e+03/2.19081589410447168e+03 ; }
  else if ( 0.010 < x && x <= 0.070 ) { vEBReftRight = TMath::Landau(x, -1.11570e-02 , 9.08308e-04 ,true)*3.58026004645168359e+04/2.19081589410447168e+03 ; }
...
double EcalCrystalMatrixProbality<EEDetId>::Diagonal(double x){
  double vEEDiagonal = 0.0 ;
       ...
       if ( 0.000 < x && x <= 0.015 ) { vEEDiagonal = TMath::Landau(x,8.25505e-03,3.10387e-03,true)*1.68601977536835489e+03/1.86234137068993937e+03 ; }
  else if ( 0.015 < x && x <= 0.150 ) { vEEDiagonal = TMath::Landau(x,-5.58560e-04,2.44735e-03,true)*4.88463235185936264e+03/1.86234137068993937e+03 ; }
...
double EcalCrystalMatrixProbality<EEDetId>::UpDown(double x){
  double vEEUpDown = 0.0 ;
       ...
       if ( 0.000 < x && x <= 0.015 ) { vEEUpDown = TMath::Landau(x,1.34809e-02,3.70278e-03,true)*8.62383670884733533e+02/1.88498009908992071e+03 ; }
...
double EcalCrystalMatrixProbality<EEDetId>::ReftRight(double x){
  double vEEReftRight = 0.0 ;
       ...
       if ( 0.000 < x && x <= 0.015 ) { vEEReftRight = TMath::Landau(x,1.34809e-02,3.70278e-03,true)*8.62383670884733533e+02/1.88498009908992071e+03 ; }
