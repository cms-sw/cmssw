...
public:
  ...
  const int CellX[9] = {0, 0, 0 /* CC, UU, DD */, -1, -1, -1 /* LL, LU, LD */, 1, 1, 1 /* RR, RU, RD */};

  const int CellY[9] = {0, -1, 1 /* CC, UU, DD */, 0, -1, 1 /* LL, LU, LD */, 0, -1, 1 /* RR, RU, RD */};
...
public:
  ...
  double reorderMxNMatrix(EBDetId it,
