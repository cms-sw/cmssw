#ifndef RecoLocalCalo_EcalDeadChannelRecoveryAlgos_CorrectEEDeadChannelsNN_H
#define RecoLocalCalo_EcalDeadChannelRecoveryAlgos_CorrectEEDeadChannelsNN_H
...
double CorrectEEDeadChannelsNN(DeadChannelNNContext &ctx, double *M3x3Input, double epsilon=0.0000001);
