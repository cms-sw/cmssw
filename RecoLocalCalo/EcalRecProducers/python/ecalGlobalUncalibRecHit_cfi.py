...
ecalGlobalUncalibRecHit = cms.EDProducer("EcalUncalibRecHitProducer",
    ...
    outOfTimeThresholdGain12pEK    = cms.double(10),      # times estimated precision
    outOfTimeThresholdGain12mEK    = cms.double(10),      # times estimated precision
    outOfTimeThresholdGain61pEK    = cms.double(10),      # times estimated precision
    outOfTimeThresholdGain61mEK    = cms.double(10),      # times estimated precision
    amplitudeThresholdEB    = cms.double(10),
    amplitudeThresholdEE    = cms.double(10),
    amplitudeThresholdEK    = cms.double(10),
