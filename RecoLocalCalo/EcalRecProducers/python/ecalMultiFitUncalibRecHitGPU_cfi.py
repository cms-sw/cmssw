...
ecalMultiFitUncalibRecHitGPU = cms.EDProducer("EcalUncalibRecHitProducerGPU",
    digisLabelEB = cms.untracked.InputTag("ecalDigis","ebDigis"),
    digisLabelEE = cms.untracked.InputTag("ecalDigis","eeDigis"),
    recHitsLabelEB = cms.untracked.string("EcalUncalibRecHitsEBGPU"),
    recHitsLabelEE = cms.untracked.string("EcalUncalibRecHitsEEGPU"),
)
