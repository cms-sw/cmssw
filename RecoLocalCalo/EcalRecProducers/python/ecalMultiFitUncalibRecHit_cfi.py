...
ecalMultiFitUncalibRecHit = cms.EDProducer("EcalUncalibRecHitProducer",
    ...
    EKdigiCollection = cms.InputTag("ecalDigis","ekDigis"),
    ...
    noiseMatrixAsCovarianceEB = cms.bool(False),
    noiseMatrixAsCovarianceEE = cms.bool(False),
    noiseMatrixAsCovarianceEK = cms.bool(True),
    ...
    EKtimeFitParameters = cms.vdouble(-2.390548e+00, 3.553628e+00, -1.762341e+01, 6.767538e+01, -1.332130e+02, 1.407432e+02, -7.541106e+01, 1.620277e+01),
    EBamplitudeFitParameters = cms.vdouble(1.138,1.652),
    EEamplitudeFitParameters = cms.vdouble(1.890,1.400),
    EKamplitudeFitParameters = cms.vdouble(1.890,1.400),
    EBtimeFitLimits_Lower = cms.double(0.2),
    EBtimeFitLimits_Upper = cms.double(1.4),
    EEtimeFitLimits_Lower = cms.double(0.2),
    EEtimeFitLimits_Upper = cms.double(1.4),
    EKtimeFitLimits_Lower = cms.double(0.2),
    EKtimeFitLimits_Upper = cms.double(1.4),    
    # for time error
    EBtimeConstantTerm= cms.double(.6),
    EEtimeConstantTerm= cms.double(1.0),
    EKtimeConstantTerm= cms.double(1.0),
    ...
    doEKtimeCorrection = cms.bool(False),
    ...
    EKtimeCorrAmplitudeBins = cms.vdouble(
    15.7,   17.6,   19.7,   22.1,   24.8,   27.9,   31.3,   35.1,   39.4,   44.2,   49.6,   55.6,   62.4,   70,     78.6,
    88.1,   98.9,   111,    124.5,  139.7,  156.7,  175.9,  197.3,  221.4,  248.4,  278.7,  312.7,  350.9,  393.7,  441.7,
    495.6,  556.1,  624,    700.1,  785.5,  881.4,  988.9,  1109.6, 1245,   1396.9, 1567.3, 1758.6, 1973.1, 2213.9, 2484,
    2787.1, 3127.2, 3508.8, 3936.9, 4417.3, 4956.3, 5561.1, 6239.6, 7001,   7522.8, 8440.7, 9470.6, 10626),
                                         
    EKtimeCorrShiftBins     = cms.vdouble(
    -0.896, -0.896, -0.896, -0.896, -0.563, -0.392, -0.287, -0.203, -0.135, -0.100, -0.068, -0.050, -0.060, -0.052, -0.055,
    -0.050, -0.052, -0.056, -0.055, -0.056, -0.048, -0.037, -0.038, -0.037, -0.025, -0.026, -0.024, -0.013, -0.003, 0.005,
    0.020,  0.026,  0.008,  0.007,  -0.006, 0.024,  0.045,  0.062,  0.085,  0.088 , 0.111 , 0.139,  0.156,  0.176,  0.210,
    0.242,  0.267,  0.301,  0.318,  0.278,  0.287,  0.218,  0.305,  0.245,  0.184,  -0.159, -0.095, 0.037),   
    ...
    ekPulseShape = cms.vdouble( 5.2e-05,-5.26e-05 , 6.66e-05, 0.1168, 0.7575, 1.,  0.8876, 0.6732, 0.4741,  0.3194 ),   

    # for kPoorReco flag
    kPoorRecoFlagEB = cms.bool(True),
    kPoorRecoFlagEE = cms.bool(False),
    kPoorRecoFlagEK = cms.bool(False),
    chi2ThreshEB_ = cms.double(65.0),
    chi2ThreshEE_ = cms.double(50.0),
    chi2ThreshEK_ = cms.double(50.0),
