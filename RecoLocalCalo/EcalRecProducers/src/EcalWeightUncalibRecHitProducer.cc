...
EcalWeightUncalibRecHitProducer::produce(edm::Event& evt, const edm::EventSetup& es) {
   ...
   std::cout << "EcalWeightUncalibRecHitProducer: total # digis: " << digis->size() << std::endl;
   ...
   std::cout << "weights before switch:\n" << clmat1 << std::endl;
   std::cout << "weights after switch:\n" << clmat2 << std::endl;
   ...
   std::cout << "chi2 matrix before switch:\n" << clmat3 << std::endl;
   std::cout << "chi2 matrix after switch:\n" << clmat4 << std::endl;
