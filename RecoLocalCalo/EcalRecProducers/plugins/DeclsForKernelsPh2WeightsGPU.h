#ifndef RecoLocalCalo_EcalRecProducers_plugins_DeclsForKernelsPh2WeightsGPU_h
#define RecoLocalCalo_EcalRecProducers_plugins_DeclsForKernelsPh2WeightsGPU_h
    ...
    struct EventOutputDataGPU {
      ...
      void allocate(uint32_t digi_size, cudaStream_t cudaStream) {
        ...
        recHits.amplitudesAll = cms::cuda::make_device_unique<reco::ComputationScalarType[]>(
            size * EcalDataFrame_Ph2::MAXSAMPLES, cudaStream);
...
#endif  // RecoLocalCalo_EcalRecProducers_plugins_DeclsForKernelsPh2WeightsGPU_h
