...
///////
    ...
    // enum class TimeComputationStateWeights : char { NotFinished = 0, Finished = 1 };
    // enum class MinimizationStateWeights : char {
    //   NotFinished = 0,
    //   Finished = 1,
    //   Precomputed = 2,
    // };
    ...
    // //
    // struct EventInputDataGPUWeights {
    //   ecal::DigisCollection<calo::common::DevStoragePolicy> ebDigis;
    ...
    // struct ConfigurationParametersConvert {
    //   uint32_t maxChannelsEB;
    // };

    // struct InputDataGPUConvert {
    ...
    // struct ConfigurationParametersWeights {
    //   using type = double;
    //   // device ptrs
...
//     struct EventDataForScratchGPUWeights {
...
//       cms::cuda::device::unique_ptr<TimeComputationStateWeights[]> tcState;

//       void allocate(ConfigurationParametersWeights const& configParameters, cudaStream_t cudaStream) {
...
//     struct ConditionsProductsWeights {
