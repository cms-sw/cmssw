...
class EcalMultifitParametersGPUESProducer
...
void EcalMultifitParametersGPUESProducer::setIntervalFor(
...
void EcalMultifitParametersGPUESProducer::fillDescriptions(
    ...
    d.add<std::vector<double>>("EBtimeFitParameters",
        {-2.015452e+00, 3.130702e+00, -1.234730e+01, 4.188921e+01, -8.283944e+01, 9.101147e+01, -5.035761e+01, 1.105621e+01});
    d.add<std::vector<double>>("EEtimeFitParameters",
        {-2.390548e+00, 3.553628e+00, -1.762341e+01, 6.767538e+01, -1.332130e+02, 1.407432e+02, -7.541106e+01, 1.620277e+01});
