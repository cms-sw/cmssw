...
EcalUncalibRecHitWorkerMultiFit::getAlgoDescription() {
 ...
 psd1.addNode(edm::ParameterDescription<std::vector<double>>("EBPulseShapeTemplate", {1.13979e-02, 7.58151e-01, 1.00000e+00, 8.87744e-01, 6.73548e-01, 4.74332e-01, 3.19561e-01, 2.15144e-01, 1.47464e-01, 1.01087e-01, 6.93181e-02, 4.75044e-02}, true) and
 ...
 psd0.add("ecal_pulse_shape_parameters", psd1);

 edm::ParameterSetDescription psd2;
 psd2.addNode(edm::ParameterDescription<std::string>("EEdigiCollection", "", true) and
	      ...
	      edm::ParameterDescription<bool>("UseLCcorrection", true, true) and
 ...
 psd0.add("ecal_digi_parameters", psd2);

 edm::ParameterSetDescription psd3;
 psd3.addNode(edm::ParameterDescription<std::vector<double>>("EBPulseShapeCovariance", {3.001e-06,  1.233e-05,  0.000e+00, -4.416e-06, -4.571e-06, -3.614e-06, -2.636e-06, -1.286e-06, -8.410e-07, -5.296e-07,  0.000e+00,  0.000e+00, 
   ...
   edm::ParameterDescription<std::vector<double>>("EEPulseShapeCovariance", {3.941e-05,  3.333e-05,  0.000e+00, -1.449e-05, -1.661e-05, -1.424e-05, -1.183e-05, -6.842e-06, -4.915e-06, -3.411e-06,  0.000e+00,  0.000e+00, 
	 ...
	 0.000e+00,  0.000e+00,  0.000e+00,  6.446e-07,  7.575e-07,  6.886e-07,  6.146e-07,  4.283e-07,  3.882e-07,  4.293e-07,  5.493e-07,  7.027e-07}, true));

  psd0.add("ecal_pulse_shape_covariances", psd3);
 
 
  edm::ParameterSetDescription pset;
  pset.addNode(edm::ParameterDescription<std::vector<int>>("activeBXs", {-5,-4,-3,-2,-1,0,1,2,3,4}, true) and
