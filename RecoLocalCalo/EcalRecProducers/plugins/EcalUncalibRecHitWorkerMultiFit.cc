...
void EcalUncalibRecHitWorkerMultiFit::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  });
  {
    ...
    psd0.add<bool>("EcalPreMixStage2", false);
    psd0.add<std::vector<double>>("EECorrNoiseMatrixG01", {
      1.0,
      0.72698,
      0.62048,
      0.55691,
    ...
    psd0.add<bool>("EcalPreMixStage1", false);
    psd0.add<std::vector<double>>("EECorrNoiseMatrixG06", {
      1.0,
      0.71217,
      0.47464,
      0.34056,
    ...
    psd0.add<std::vector<double>>("EBCorrNoiseMatrixG01", {
      1.0,
      0.73354,
      0.64442,
      0.58851,
    ...
    psd0.add<std::vector<double>>("EBCorrNoiseMatrixG06", {
      1.0,
      0.70946,
      0.58021,
      0.49846,
    ...
    psd0.add<std::string>("EBdigiCollection", "");
    psd0.add<std::vector<double>>("EEPulseShapeCovariance", {
      3.941e-05,
      3.333e-05,
      0.0,
      -1.449e-05,
    ...
    psd0.add<std::vector<double>>("EBPulseShapeTemplate", {
      0.0113979,
      0.758151,
      1.0,
      0.887744,
    ...
    psd0.add<std::string>("ESdigiCollection", "");
    psd0.add<std::vector<double>>("EEPulseShapeTemplate", {
      0.116442,
      0.756246,
      1.0,
      0.897182,
    ...
    psd0.add<std::vector<double>>("EBCorrNoiseMatrixG12", {
      1.0,
      0.71073,
      0.55721,
      0.46089,
    ...
    psd0.add<std::vector<double>>("EECorrNoiseMatrixG12", {
      1.0,
      0.71373,
      0.44825,
      0.30152,
    ...
    psd0.add<std::string>("EEdigiCollection", "");
    psd0.add<std::vector<double>>("EBPulseShapeCovariance", {
      3.001e-06,
      1.233e-05,
      0.0,
      -4.416e-06,
    ...
    psd0.addUntracked<bool>("UseLCcorrection", true);
    desc.add<edm::ParameterSetDescription>("EcalPulseShapeParameters", psd0);
  }
  ...
  desc.add<bool>("ampErrorCalculation", true);
  ...
  desc.add<double>("chi2ThreshEB_", 65.0);
  ...
  desc.add<bool>("useLumiInfoRunHeader", true);
  ...
  desc.add<std::string>("algo", "EcalUncalibRecHitWorkerMultiFit");
  ...
  desc.add<double>("chi2ThreshEE_", 50.0);
  desc.add<bool>("doPrefitEE", false);
  desc.add<bool>("doPrefitEB", false);
  descriptions.add("ecalMultiFitUncalibRecHit", desc);
