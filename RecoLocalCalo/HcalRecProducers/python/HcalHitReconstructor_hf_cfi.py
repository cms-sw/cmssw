...
hfreco = cms.EDProducer("HcalHitReconstructor",
                        ...
                        S9S1stat = cms.PSet( long_optimumSlopeParams = cms.vdouble([0.2974,-0.02498, 0.0005243]),
                                             long_optimumSlope40     = cms.double(0.095),
                                             long_optimumSlope41     = cms.double(0.062),
                                             ...
                                             short_optimumSlopeParams = cms.vdouble([0.2974,-0.02498, 0.0005243]),
                                             short_optimumSlope40     = cms.double(0.095),
                                             short_optimumSlope41     = cms.double(0.062),
                                             shortEnergyParams        = cms.vdouble([130,-6.61,0.1153]),
