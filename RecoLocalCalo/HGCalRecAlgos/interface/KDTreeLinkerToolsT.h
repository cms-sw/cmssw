...
public:
  ...
  template <typename... Ts>
  KDTreeNodeInfoT(const DATA& d, Ts... dimargs) : data(d), dims{{dimargs...}} {}
  template <typename... Ts>
...
public:
  KDTreeNodeT() : left(nullptr), right(nullptr) {}
  ...
  void setAttributs(const KDTreeBoxT<DIM>& regionBox) { region = regionBox; }
};
