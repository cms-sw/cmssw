...
extern template class HGCalCLUEAlgoT<HGCalSiliconLayerTiles>;
extern template class HGCalCLUEAlgoT<HGCalScintillatorLayerTiles>;
extern template class HGCalCLUEAlgoT<HFNoseLayerTiles>;

using HGCalSiCLUEAlgo = HGCalCLUEAlgoT<HGCalSiliconLayerTiles>;
using HGCalSciCLUEAlgo = HGCalCLUEAlgoT<HGCalScintillatorLayerTiles>;
