...
extern template class HGCalCLUEAlgoT<HFNoseLayerTiles, HGCalScintillatorStrategy>;
...
using HFNoseCLUEAlgo = HGCalCLUEAlgoT<HFNoseLayerTiles, HGCalScintillatorStrategy>;
