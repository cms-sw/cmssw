#ifndef SISTRIPPOPCON_UNITTEST_HANDLER_NOISE_H
#define SISTRIPPOPCON_UNITTEST_HANDLER_NOISE_H
...
namespace popcon {
  ...
  template <typename T>
  class SiStripPopConHandlerUnitTestNoise : public popcon::PopConSourceHandler<T> {
  public:
