...
void condbon::cdbon_write(
    CSCobject *obj, const std::string &obj_name, int record, int global_run, const std::string &data_time) {
  int i, j, k;
...
void condbon::cdbon_read_rec(const std::string &obj_name, int record, CSCobject *obj) {
  int i, len;
