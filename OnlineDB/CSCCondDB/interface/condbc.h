...
class condbc
{
 ...
 void cdb_write (string subdet, string id_str, int id_num, string var_name,
  int size, float *value, int run, int *ret_code);
 void cdb_write (string subdet, string id_str, int id_num, string var_name,
  int size, float *value, int run, string v_par_st1, string v_par_st2,
  string v_par_st3, float v_par_num1, float v_par_num2, float v_par_num3,
  string v_rec_comment, int *ret_code);
 void cdb_write_v (string subdet, string id_str, int id_num, string var_name,
  int size, float *value, int run, string start_valid, int *ret_code);
 void cdb_write_v (string subdet, string id_str, int id_num, string var_name,
  int size, float *value, int run, string start_valid, string v_par_st1,
  string v_par_st2, string v_par_st3, float v_par_num1, float v_par_num2,
  float v_par_num3, string v_rec_comment, int *ret_code);
 ...
 void cdb_read_v (string subdet, string id_str, int id_num, string var_name,
  ...
  int *ret_size, float *value, int *run);
