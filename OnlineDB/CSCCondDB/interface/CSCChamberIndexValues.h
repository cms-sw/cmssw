...
class CSCChamberIndexValues : public edm::ESProducer, public edm::EventSetupRecordInfiniteIntervalFinder {
public:
  explicit CSCChamberIndexValues(const edm::ParameterSet &);
