...
// Latest tag:  $Name: V05-00-02-05 $
// Location:    $Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/OnlineDB/SiStripESSources/src/SiStripGainBuilderFromDb.cc,v $
