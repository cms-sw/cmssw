#ifndef FECONFIGSLIDING_H
#define FECONFIGSLIDING_H
...
class FEConfigSlidingInfo : public IODConfig {
public:
  ...
  // operators
  inline bool operator==(const FEConfigSlidingInfo& r) const { return (m_ID == r.m_ID); }
  inline bool operator!=(const FEConfigSlidingInfo& r) const { return !(*this == r); }
