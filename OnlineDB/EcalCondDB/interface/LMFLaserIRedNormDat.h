#ifndef LMFLASERIREDNORMDAT_H
#define LMFLASERIREDNORMDAT_H
...
class LMFLaserIRedNormDat : public IDataItem {
 public:
 ...
 private:
  ...
  void writeDB(const EcalLogicID* ecid, const LMFLaserIRedNormDat* item, LMFRunIOV* iov)
    throw(std::runtime_error);

  void fetchData(std::map< EcalLogicID, LMFLaserIRedNormDat >* fillVec, LMFRunIOV* iov)
     throw(std::runtime_error);
