  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunTTErrorsDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunTTErrorsDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunTTErrorsDat::fetchData():  ")+e.getMessage()));
  }
}
