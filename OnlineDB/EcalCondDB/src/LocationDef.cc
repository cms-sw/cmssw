  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("LocationDef::fetchID:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
  ...
  try {
   ...
   throw(std::runtime_error(std::string("LocationDef::setByID:  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("LocationDef::fetchAllDefs:  ")+e.getMessage()));
  }
}
