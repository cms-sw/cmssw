  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigCycleInfo::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigCycleInfo::writeDB:  ")+e.getMessage()));
  }
  // Now get the ID
  if (!this->fetchID()) {
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigCycleInfo::fetchID:  ")+e.getMessage()));
  }
  setByID(m_ID);
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigCycleInfo::fetchIDLast:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
   ...
   try {
     ...
     throw(std::runtime_error(std::string("ODRunConfigCycleInfo::setByID:  ")+e.getMessage()));
   }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigCycleInfo::fetchData():  ")+e.getMessage()));
  }
}
