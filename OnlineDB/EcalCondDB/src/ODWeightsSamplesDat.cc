  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODWeightsSamplesDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODWeightsSamplesDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODWeightsSamplesDat::fetchData():  ")+e.getMessage()));
  }
}
    ...
    noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODWeightsSamplesDat::writeArrayDB():  ")+e.getMessage()));
  }
}
