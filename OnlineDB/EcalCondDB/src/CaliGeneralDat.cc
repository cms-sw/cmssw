  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("CaliGeneralDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("CaliGeneralDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("CaliGeneralDat::fetchData():  ")+e.getMessage()));
  }
}
