  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODEcalCycle::fetchID:  ")+e.getMessage()));
  }
  setByID(m_ID);
  return m_ID;
}
  ...
  noexcept(false)
{
   ...
   try {
     ...
     throw(std::runtime_error(std::string("ODEcalCycle::setByID:  ")+e.getMessage()));
   }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODEcalCycle::fetchData():  ")+e.getMessage()));
  }
}
