  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigSeqInfo::fetchID:  ")+e.getMessage()));
  }
  setByID(m_ID);
  return m_ID;
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigSeqInfo::fetchIDLast:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
   ...
   try {
     ...
     throw(std::runtime_error(std::string("ODRunConfigSeqInfo::setByID:  ")+e.getMessage()));
   }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigSeqInfo::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigSeqInfo::writeDB():  ")+e.getMessage()));
  }
  if (!this->fetchID()) {
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigSeqInfo::fetchData():  ")+e.getMessage()));
  }
}
