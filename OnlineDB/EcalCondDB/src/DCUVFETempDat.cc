  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCUVFETempDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCUVFETempDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCUVFETempDat::fetchData():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCUVFETempDat::writeArrayDB():  ")+e.getMessage()));
  }
}
