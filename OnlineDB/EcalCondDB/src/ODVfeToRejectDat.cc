  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODVfeToRejectDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODVfeToRejectDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODVfeToRejectDat::fetchData():  ")+e.getMessage()));
  }
}
    ...
    noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODVfeToRejectDat::writeArrayDB():  ")+e.getMessage()));
  }
}
