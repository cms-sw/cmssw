  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunCrystalErrorsDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunCrystalErrorsDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunCrystalErrorsDat::fetchData():  ")+e.getMessage()));
  }
}
