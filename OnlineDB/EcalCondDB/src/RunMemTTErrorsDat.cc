  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunMemTTErrorsDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunMemTTErrorsDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunMemTTErrorsDat::fetchData():  ")+e.getMessage()));
  }
}
