...
int ODJBH4Config::fetchNextId()  noexcept(false) {
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODJBH4Config::fetchNextId():  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODJBH4Config::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODJBH4Config::writeDB():  ")+e.getMessage()));
  }
  // Now get the ID
  if (!this->fetchID()) {
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODJBH4Config::fetchData():  ")+e.getMessage()));
  }
}
...
int ODJBH4Config::fetchID()    noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODJBH4Config::fetchID:  ")+e.getMessage()));
  }
