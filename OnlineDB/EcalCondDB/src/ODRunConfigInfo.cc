  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigInfo::fetchID:  ")+e.getMessage()));
  }
  setByID(m_ID);
  return m_ID;
}
  ...
  noexcept(false)
{
   ...
   try {
     ...
     throw(std::runtime_error(std::string("ODRunConfigInfo::setByID:  ")+e.getMessage()));
   }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigInfo::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigInfo::writeDB:  ")+e.getMessage()));
  }
  // Now get the ID
  if (!this->fetchID()) {
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODRunConfigInfo::fetchData():  ")+e.getMessage()));
  }
}
