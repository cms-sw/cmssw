  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODLTCCycle::prepareWrite():  ")+e.getMessage()));
  }
}
...
void ODLTCCycle::writeDB()  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODLTCCycle::writeDB:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODLTCCycle::fetchID:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODLTCCycle::fetchData():  ")+e.getMessage()));
  }
}
