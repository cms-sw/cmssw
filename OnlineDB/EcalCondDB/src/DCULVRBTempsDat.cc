  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCULVRBTempsDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCULVRBTempsDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCULVRBTempsDat::fetchData():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCULVRBTempsDat::writeArrayDB():  ")+e.getMessage()));
  }
}
