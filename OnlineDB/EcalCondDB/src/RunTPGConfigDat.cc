  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunTPGConfigDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunTPGConfigDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunTPGConfigDat::fetchData():  ")+e.getMessage()));
  }
}
