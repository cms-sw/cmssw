  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("CaliTempDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("CaliTempDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("CaliTempDat::fetchData():  ")+e.getMessage()));
  }
}
