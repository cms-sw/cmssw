  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("FEConfigFgrEEStripDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("FEConfigFgrEEStripDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("FEConfigFgrEEStripDat::fetchData:  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("FEConfigFgrEEStripDat::writeArrayDB():  ")+e.getMessage()));
  }
}
