  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODDelaysDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODDelaysDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODDelaysDat::fetchData():  ")+e.getMessage()));
  }
}
    ...
    noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODDelaysDat::writeArrayDB():  ")+e.getMessage()));
  }
}
