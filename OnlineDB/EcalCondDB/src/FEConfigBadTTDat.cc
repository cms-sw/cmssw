  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("FEConfigBadTTDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("FEConfigBadTTDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("FEConfigBadTTDat::fetchData():  ")+e.getMessage()));
  }
}
    ...
    noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("FEConfigBadTTDat::writeArrayDB():  ")+e.getMessage()));
  }
}
