  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODTTCFCycle::prepareWrite():  ")+e.getMessage()));
  }
}
...
void ODTTCFCycle::writeDB()  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODTTCFCycle::writeDB:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODTTCFCycle::fetchID:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODTTCFCycle::fetchData():  ")+e.getMessage()));
  }
}
