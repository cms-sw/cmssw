  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODGolBiasCurrentDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODGolBiasCurrentDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODGolBiasCurrentDat::fetchData():  ")+e.getMessage()));
  }
}
    ...
    noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODGolBiasCurrentDat::writeArrayDB():  ")+e.getMessage()));
  }
}
