  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("CaliHVScanRatioDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("CaliHVScanRatioDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("CaliHVScanRatioDat::fetchData():  ")+e.getMessage()));
  }
}
