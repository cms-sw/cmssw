  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunModeDef::fetchID:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
  ...
  try {
   ...
   throw(std::runtime_error(std::string("RunModeDef::setByID:  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunModeDef::fetchAllDefs:  ")+e.getMessage()));
  }
}
