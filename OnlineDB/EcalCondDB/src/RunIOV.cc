  ...
  noexcept(false)
{
   ...
   try {
     ...
     throw(std::runtime_error(std::string("RunIOV::setByID:  ")+e.getMessage()));
   }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunIOV::writeDB:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
   ...
   try {
     ...
     throw(std::runtime_error(std::string("RunIOV::setByRun:  ")+e.getMessage()));
   }
}
  ...
  noexcept(false)
{
  ...
  DateHandler dh(m_env, m_conn);
   ...
   try {
     ...
     throw(std::runtime_error(std::string("RunIOV::setByTime(loc, run):  ") + e.getMessage()));
   }
}
  ...
  noexcept(false)
{
  ...
  DateHandler dh(m_env, m_conn);
   ...
   try {
     ...
     throw(std::runtime_error(std::string("RunIOV::setByRun(loc, run):  ")+e.getMessage()));
   }
}
  ...
  noexcept(false)
{
   ...
   try {
     ...
     throw(std::runtime_error(std::string("RunIOV::setByRecentData:  ")+e.getMessage()));
   }
}
