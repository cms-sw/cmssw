  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("CaliGainRatioDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("CaliGainRatioDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("CaliGainRatioDat::fetchData():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("CaliGainRatio::writeArrayDB():  ")+e.getMessage()));
  }
}
