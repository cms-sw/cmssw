...
int ODBadXTInfo::fetchNextId()  throw(std::runtime_error) {
...
void ODBadXTInfo::setParameters(std::map<string,string> my_keys_map){
...
int ODBadXTInfo::fetchID()    throw(std::runtime_error)
{
