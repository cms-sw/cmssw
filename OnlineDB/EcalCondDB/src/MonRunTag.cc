  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("MonRunTag::fetchID:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
  ...
  try {
   ...
   throw(std::runtime_error(std::string("MonRunTag::setByID:  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
   ...
   throw(std::runtime_error(std::string("MonRunTag::writeDB:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("MonRunTag::fetchAllTags:  ")+e.getMessage()));
  }
}
