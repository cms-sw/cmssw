  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCULVRVoltagesDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCULVRVoltagesDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCULVRVoltagesDat::fetchData():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCULVRVoltagesDat::writeArrayDB():  ")+e.getMessage()));
  }
}
