  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCULVRTempsDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCULVRTempsDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCULVRTempsDat::fetchData():  ")+e.getMessage()));
  }
}
