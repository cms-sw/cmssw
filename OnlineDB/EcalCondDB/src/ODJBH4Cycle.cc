  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODJBH4Cycle::prepareWrite():  ")+e.getMessage()));
  }
}
...
void ODJBH4Cycle::writeDB()  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODJBH4Cycle::writeDB:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODJBH4Cycle::fetchID:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("ODJBH4Cycle::fetchData():  ")+e.getMessage()));
  }
}
