  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCUIDarkDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCUIDarkDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCUIDarkDat::fetchData():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("DCUIDarkDat::writeArrayDB():  ")+e.getMessage()));
  }
}
