  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("MonRunIOV::fetchID:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
   ...
   try {
     ...
     throw(std::runtime_error(std::string("MonRunIOV::setByID:  ")+e.getMessage()));
   }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("MonRunIOV::writeDB:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("MonRunIOV::setByRun:  ")+e.getMessage()));
  }
