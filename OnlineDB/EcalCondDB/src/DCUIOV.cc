...
Tm DCUIOV::getSince() const { return m_since; }
...
Tm DCUIOV::getTill() const { return m_till; }
...
DCUTag DCUIOV::getDCUTag() const { return m_dcuTag; }

int DCUIOV::fetchID() noexcept(false) {
...
void DCUIOV::setByID(int id) noexcept(false) {
  this->checkConnection();
...
int DCUIOV::writeDB() noexcept(false) {
  this->checkConnection();
...
void DCUIOV::setByTm(DCUTag* tag, const Tm& eventTm) noexcept(false) {
  this->checkConnection();
