  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("FEConfigFgrGroupDat::prepareWrite():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  */
  ...
  try {
    ...
    throw(std::runtime_error(std::string("FEConfigFgrGroupDat::writeDB():  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("FEConfigFgrGroupDat::fetchData:  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("FEConfigFgrGroupDat::writeArrayDB():  ")+e.getMessage()));
  }
}
