  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunSeqDef::fetchID:  ")+e.getMessage()));
  }
  ...
  noexcept(false)
{
  ...
  try {
   ...
   throw(std::runtime_error(std::string("RunSeqDef::setByID:  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
    ...
    throw(std::runtime_error(std::string("RunSeqDef::fetchAllDefs:  ")+e.getMessage()));
  }
}
  ...
  noexcept(false)
{
  ...
  try {
   ...
   throw(std::runtime_error(std::string("RunSeqDef::writeDB:  ")+e.getMessage()));
  }
