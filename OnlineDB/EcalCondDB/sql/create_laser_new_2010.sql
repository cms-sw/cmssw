 ...
 *   Err. on norm. factor
 * 
 * GO 200100109: new indexes added - removed SEQ_ID from 
...
CREATE SEQUENCE PRIM_DATASET_ID_SQ;
CREATE SEQUENCE SEQ_ID_SQ;
CREATE SEQUENCE CLS_DATASET_ID_SQ;
CREATE SEQUENCE CORR_COEF_ID_SQ;
...
ALTER TABLE LMF_COLOR_DEF
  ADD CONSTRAINT LM_COLOR_DEF_PK PRIMARY KEY (COLOR)
/

INSERT INTO LMF_COLOR_DEF VALUES (0, 'blue', 'blue laser (440 nm) or blue led');
INSERT INTO LMF_COLOR_DEF VALUES (1, 'green', 'green (495 nm)');
INSERT INTO LMF_COLOR_DEF VALUES (2, 'red/orange', 'red laser (706 nm) or orange led');
INSERT INTO LMF_COLOR_DEF VALUES (3, 'IR', 'infrared (796 nm)');
...
INSERT INTO LMF_TRIG_TYPE_DEF VALUES (0, 'las', 'laser');
INSERT INTO LMF_TRIG_TYPE_DEF VALUES (1, 'led', 'led');
INSERT INTO LMF_TRIG_TYPE_DEF VALUES (2, 'tp', 'test pulse');
INSERT INTO LMF_TRIG_TYPE_DEF VALUES (3, 'ped', 'pedestal');
...
(
  ...
  CONSTRAINTS LMF_SEQ_DAT_FK1 FOREIGN KEY(RUN_IOV_ID) REFERENCES RUN_IOV,
  CONSTRAINTS LMF_SEQ_DAT_FK2 FOREIGN KEY(VMIN) REFERENCES LMF_SEQ_VERS,
  CONSTRAINTS LMF_SEQ_DAT_FK3 FOREIGN KEY(VMAX) REFERENCES LMF_SEQ_VERS
)
PARTITION BY RANGE ("SEQ_ID")
(PARTITION "LMF_SEQ_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
(
  ...
  TAG_ID         NUMBER NOT NULL,
  RUN_IOV_ID     NUMBER,          -- might be dropped in the future
  SUBRUN_NUM     NUMBER,          -- might be dropped in the future
...
(PARTITION "LMF_RUN_IOV_0" VALUES LESS THAN (MAXVALUE));
...
ALTER TABLE LMF_RUN_IOV
  ADD CONSTRAINT LMF_RUN_IOV_UK UNIQUE (SEQ_ID, LMR, COLOR, TRIG_TYPE)
/
...
ALTER TABLE LMF_RUN_IOV
  ADD CONSTRAINT LMF_RUN_IOV_FK2 FOREIGN KEY (RUN_IOV_ID)
  REFERENCES RUN_IOV(IOV_ID)
/

ALTER TABLE LMF_RUN_IOV
  ADD CONSTRAINT LMF_RUN_IOV_FK3 FOREIGN KEY (SEQ_ID)
  REFERENCES LMF_SEQ_DAT(SEQ_ID)
/

ALTER TABLE LMF_RUN_IOV
  ADD CONSTRAINT LMF_RUN_IOV_FK5 FOREIGN KEY (COLOR)
  REFERENCES LMF_COLOR_DEF
/

ALTER TABLE LMF_RUN_IOV
  ADD CONSTRAINT LMF_RUN_IOV_FK6 FOREIGN KEY (TRIG_TYPE)
...
PARTITION BY RANGE ("LMF_IOV_ID")
(PARTITION "LMF_LASER_CONFIG_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
PARTITION BY RANGE ("LMF_IOV_ID")
(PARTITION "LMF_RUN_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
PARTITION BY RANGE ("LMF_IOV_ID")
(PARTITION "LMF_TEST_PULSE_CONFIG_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
/* LMF_PRIM_DATASET_DAT */
CREATE TABLE LMF_PRIM_DATASET_DAT
(
  PRIM_DATASET_ID NUMBER,
  VMIN            NUMBER,
  VMAX            NUMBER,
  CONSTRAINTS LMF_PRIM_DATASET_DAT_PK PRIMARY KEY(PRIM_DATASET_ID),
  CONSTRAINTS LMF_PRIM_DATASET_DAT_FK1 FOREIGN KEY(VMIN) 
  REFERENCES LMF_PRIM_VERS,
  CONSTRAINTS LMF_PRIM_DATASET_DAT_FK2 FOREIGN KEY(VMAX) 
  REFERENCES LMF_PRIM_VERS
)
/

/* LMF_CLS_VERS */
CREATE TABLE LMF_CLS_VERS
(
  VERS NUMBER,
  DB_TIMESTAMP TIMESTAMP DEFAULT sys_extract_utc(SYSTIMESTAMP) NOT NULL,
  DESCR VARCHAR2(100),
  CONSTRAINTS LMF_CLS_VERS_PK PRIMARY KEY(VERS)
)
/

/* LMF_CLS_DATASET_DAT */
CREATE TABLE LMF_CLS_DATASET_DAT
(
  CLS_DATASET_ID NUMBER,
  SEQ_ID         NUMBER,
  VMIN           NUMBER,
  VMAX           NUMBER,
  CONSTRAINTS LMF_CLS_DATASET_DAT_PK PRIMARY KEY(CLS_DATASET_ID),
  CONSTRAINTS LMF_CLS_DATASET_DAT_FK1 FOREIGN KEY(VMIN) REFERENCES LMF_CLS_VERS,
  CONSTRAINTS LMF_CLS_DATASET_DAT_FK2 FOREIGN KEY(VMAX) REFERENCES LMF_CLS_VERS
)
/

/*  LMF_CLS_DAT  */
CREATE TABLE LMF_CLS_DAT
(
  CLS_ID     NUMBER,
  CLS_DATASET_ID NUMBER,
  LOGIC_ID   NUMBER NOT NULL,
...
ALTER TABLE LMF_CLS_DAT
  ADD CONSTRAINT LMF_CLS_DAT_PK PRIMARY KEY (CLS_ID)
/

ALTER TABLE LMF_CLS_DAT
  ADD CONSTRAINT LMF_CLS_DAT_FK1 FOREIGN KEY (CLS_DATASET_ID)
  REFERENCES LMF_CLS_DATASET_DAT(CLS_DATASET_ID)
/

ALTER TABLE LMF_CLS_DAT
  ADD CONSTRAINT LMF_CLS_DAT_FK2 FOREIGN KEY (REF_CLS_ID)
  REFERENCES LMF_CLS_DAT(CLS_ID)
/
...
(
  ...
  CONSTRAINTS LMF_IOV_FK1 FOREIGN KEY(VMIN) REFERENCES LMF_CORR_VERS,
  CONSTRAINTS LMF_IOV_FK2 FOREIGN KEY(VMAX) REFERENCES LMF_CORR_VERS
)
PARTITION BY RANGE ("IOV_ID")
(PARTITION "LMF_IOV_0" VALUES LESS THAN (MAXVALUE))
/
...
(PARTITION "LMF_LMR_SUB_IOV_0" VALUES LESS THAN (MAXVALUE))
/

/* LMF_CORR_COEF_DAT */
CREATE TABLE LMF_CORR_COEF_DAT
(
  CORR_COEF_ID   NUMBER NOT NULL,
  LOGIC_ID       NUMBER NOT NULL,
...
PARTITION BY RANGE ("LMR_SUB_IOV_ID")
(PARTITION "LMF_CORR_COEF_DAT" VALUES LESS THAN (MAXVALUE))
/

ALTER TABLE LMF_CORR_COEF_DAT
  ADD CONSTRAINT LMF_CORR_COEF_DAT_PK PRIMARY KEY (CORR_COEF_ID, LOGIC_ID)
/
...
PARTITION BY RANGE ("IOV_ID")
(PARTITION "RUN_LASERRUN_CONFIG_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
PARTITION BY RANGE ("LMF_IOV_ID")
(PARTITION "LMF_LASER_BLUE_PN_PRIM_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
ALTER TABLE LMF_LASER_BLUE_PN_PRIM_DAT
  ADD CONSTRAINT LMF_LASER_BLUE_PN_DAT_FK2 FOREIGN KEY (PRIM_DATASET_ID)
  REFERENCES LMF_PRIM_VERS
/
...
PARTITION BY RANGE ("LMF_IOV_ID")
(PARTITION "LMF_LASER_BLUE_PULSE_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
ALTER TABLE LMF_LASER_BLUE_PULSE_DAT
  ADD CONSTRAINT LMF_LASER_BLUE_PULSE_DAT_FK2 FOREIGN KEY (PRIM_DATASET_ID)
  REFERENCES LMF_PRIM_DATASET_DAT(PRIM_DATASET_ID)
/
...
PARTITION BY RANGE ("LMF_IOV_ID")
(PARTITION "LMF_LASER_BLUE_PRIM_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
ALTER TABLE LMF_LASER_BLUE_PRIM_DAT
  ADD CONSTRAINT LMF_LASER_BLUE_PRIM_DAT_FK2 FOREIGN KEY (PRIM_DATASET_ID)
  REFERENCES LMF_PRIM_VERS
/
...
PARTITION BY RANGE ("LMF_IOV_ID")
(PARTITION "LMF_LASER_IR_PN_PRIM_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
ALTER TABLE LMF_LASER_IR_PN_PRIM_DAT
  ADD CONSTRAINT LMF_LASER_IR_PN_DAT_FK1 FOREIGN KEY (LMF_IOV_ID)
  REFERENCES LMF_RUN_IOV
/

ALTER TABLE LMF_LASER_IR_PN_PRIM_DAT
  ADD CONSTRAINT LMF_LASER_IR_PN_DAT_FK2 FOREIGN KEY (PRIM_DATASET_ID)
  REFERENCES LMF_PRIM_DATASET_DAT
/
...
PARTITION BY RANGE ("LMF_IOV_ID")
(PARTITION "LMF_LASER_IR_PULSE_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
ALTER TABLE LMF_LASER_IR_PULSE_DAT
  ADD CONSTRAINT LMF_LASER_IR_PULSE_DAT_FK1 FOREIGN KEY (LMF_IOV_ID)
  REFERENCES LMF_RUN_IOV(LMF_IOV_ID)
/

ALTER TABLE LMF_LASER_IR_PULSE_DAT
  ADD CONSTRAINT LMF_LASER_IR_PULSE_DAT_FK2 FOREIGN KEY (PRIM_DATASET_ID)
  REFERENCES LMF_PRIM_DATASET_DAT(PRIM_DATASET_ID)
/
...
PARTITION BY RANGE ("LMF_IOV_ID")
(PARTITION "LMF_LASER_IR_PRIM_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
ALTER TABLE LMF_LASER_IR_PRIM_DAT
  ADD CONSTRAINT LMF_LASER_IR_PRIM_DAT_FK1 FOREIGN KEY (LMF_IOV_ID)
  REFERENCES LMF_RUN_IOV(LMF_IOV_ID)
/

ALTER TABLE LMF_LASER_IR_PRIM_DAT
  ADD CONSTRAINT LMF_LASER_IR_PRIM_DAT_FK2 FOREIGN KEY (PRIM_DATASET_ID)
  REFERENCES LMF_PRIM_DATASET_DAT
/
...
PARTITION BY RANGE ("LMF_IOV_ID")
(PARTITION "LMF_LED_BLUE_PN_PRIM_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
ALTER TABLE LMF_LED_BLUE_PN_PRIM_DAT
  ADD CONSTRAINT LMF_LED_BLUE_PN_DAT_FK1 FOREIGN KEY (LMF_IOV_ID)
  REFERENCES LMF_RUN_IOV
/

ALTER TABLE LMF_LED_BLUE_PN_PRIM_DAT
  ADD CONSTRAINT LMF_LED_BLUE_PN_DAT_FK2 FOREIGN KEY (PRIM_DATASET_ID)
  REFERENCES LMF_PRIM_DATASET_DAT
/
...
PARTITION BY RANGE ("LMF_IOV_ID")
(PARTITION "LMF_LED_BLUE_PRIM_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
ALTER TABLE LMF_LED_BLUE_PRIM_DAT
  ADD CONSTRAINT LMF_LED_BLUE_PRIM_DAT_FK1 FOREIGN KEY (LMF_IOV_ID)
  REFERENCES LMF_RUN_IOV(LMF_IOV_ID)
/

ALTER TABLE LMF_LED_BLUE_PRIM_DAT
  ADD CONSTRAINT LMF_LED_BLUE_PRIM_DAT_FK2 FOREIGN KEY (PRIM_DATASET_ID)
  REFERENCES LMF_PRIM_DATASET_DAT
/
...
PARTITION BY RANGE ("LMF_IOV_ID")
(PARTITION "LMF_LED_ORANGE_PN_PRIM_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
ALTER TABLE LMF_LED_ORANGE_PN_PRIM_DAT
  ADD CONSTRAINT LMF_LED_ORANGE_PN_DAT_FK1 FOREIGN KEY (LMF_IOV_ID)
  REFERENCES LMF_RUN_IOV
/

ALTER TABLE LMF_LED_ORANGE_PN_PRIM_DAT
  ADD CONSTRAINT LMF_LED_ORANGE_PN_DAT_FK2 FOREIGN KEY (PRIM_DATASET_ID)
  REFERENCES LMF_PRIM_DATASET_DAT
/
...
PARTITION BY RANGE ("LMF_IOV_ID")
(PARTITION "LMF_LED_ORANGE_PRIM_DAT_0" VALUES LESS THAN (MAXVALUE))
/
...
ALTER TABLE LMF_LED_ORANGE_PRIM_DAT
  ADD CONSTRAINT LMF_LED_ORANGE_PRIM_DAT_FK1 FOREIGN KEY (LMF_IOV_ID)
  REFERENCES LMF_RUN_IOV(LMF_IOV_ID)
/

ALTER TABLE LMF_LED_ORANGE_PRIM_DAT
  ADD CONSTRAINT LMF_LED_ORANGE_PRIM_DAT_FK2 FOREIGN KEY (PRIM_DATASET_ID)
  REFERENCES LMF_PRIM_DATASET_DAT
/
