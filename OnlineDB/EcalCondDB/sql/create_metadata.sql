...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 13,'RUN_OUTCOME_ID',1,'NUMBER','Global run quality','Global Run Quality'); 
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 13,'TASK_LIST',1,'INT','Active tasks in run','Active tasks in run (binary flags)');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 13,'TASK_OUTCOME',1,'INT','Task run quality','Task run quality (binary flags)');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 18, 'PROBLEMS_ID',1,'INT','Channel wrong identification','Channel wrong identification');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 18, 'PROBLEMS_GAIN_ZERO',1,'INT','Channel gain==0','Channel gain==0');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 18, 'PROBLEMS_GAIN_SWITCH',1,'INT','Channel forbidden gain switch','Channel forbidden gain switch');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 18, 'TASK_STATUS',1,'INT','Integrity Channel status','Integrity Channel status');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 19, 'PROBLEMS_ID',1,'INT','Trigger tower wrong identification','Trigger tower wrong identification');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 19, 'PROBLEMS_SIZE',1,'INT','Trigger Tower wrong size','Trigger Tower wrong size');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 19, 'PROBLEMS_LV1',1,'INT','LV1 wrong in Trigger Tower','LV1 wrong in Trigger Tower');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 19, 'PROBLEMS_BUNCH_X',1,'INT','BunchX wrong in Trigger Tower','BunchX wrong in Trigger Tower');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 19, 'TASK_STATUS',1,'INT','Integrity Tower status','Integrity Tower status');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 21, 'TASK_STATUS',1,'INT','Channel pedestal status','Channel pedestal status');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 22,'TASK_STATUS',1,'INT','Pedestal Offset Channel status','Pedestal Channel Offset status');
...
/* MON_TEST_PULSE_DAT */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 24,'ADC_MEAN_G1',1,'FLOAT','Mean Test-pulse Gain 1','Mean Test-pulse Gain 1 (ADC Counts)');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 24, 'TASK_STATUS',1,'INT','Test-pulse Channel status','Test-pulse Channel status');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 27, 'TASK_STATUS',1,'INT','Delays Tower status','Delays Tower status');

/* MON_PN_BLUE_DAT */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 28,'ADC_MEAN_G1',1,'FLOAT','Mean PN height Gain1',       'Mean Blue Laser PN Amplitude Gain 1 (ADC Counts)');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 28,'ADC_MEAN_G16',1,'FLOAT','Mean PN height Gain16',     'Mean Blue Laser PN Amplitude Gain 16 (ADC Counts)');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 28, 'TASK_STATUS',1,'INT','PN Blue status','PN Blue status');

/* MON_PN_GREEN_DAT */ 
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 29,'ADC_MEAN_G1',1,'FLOAT','Mean PN height Gain1',       'Mean Green Laser PN Amplitude Gain 1 (ADC Counts)');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 29,'ADC_MEAN_G16',1,'FLOAT','Mean PN height Gain16',     'Mean Green Laser PN Amplitude Gain 16 (ADC Counts)');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 29, 'TASK_STATUS',1,'INT','PN Green status','PN Green status');


/* MON_PN_RED_DAT    */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 30,'ADC_MEAN_G1',1,'FLOAT','Mean PN height Gain1',       'Mean Red Laser PN Amplitude Gain 1 (ADC Counts)');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 30,'ADC_MEAN_G16',1,'FLOAT','Mean PN height Gain16',     'Mean Red Laser PN Amplitude Gain 16 (ADC Counts)');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 30, 'TASK_STATUS',1,'INT','PN Red status','PN Red status');



/* MON_PN_IRED_DAT */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 31,'ADC_MEAN_G1',1,'FLOAT','Mean PN height Gain1',       'Mean Infra-Red Laser PN Amplitude Gain 1 (ADC Counts)');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 31,'ADC_MEAN_G16',1,'FLOAT','Mean PN height Gain16',     'Mean Infra-Red Laser PN Amplitude Gain 16 (ADC Counts)');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 31,'TASK_STATUS',1,'INT','PN Infra-Red status','PN Infra-Red status');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal,32,'TASK_STATUS',1,'INT','PN Pedestal status','PN Pedestal status');

/* MON_PN_MGPA_DAT  */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 33,'ADC_MEAN_G1',1,'FLOAT','Mean PN height Gain1',       'Mean Test-Pulse PN Amplitude Gain 1 (ADC Counts)');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 33,'ADC_MEAN_G16',1,'FLOAT','Mean PN height Gain16',     'Mean Test-Pulse PN Amplitude Gain 16 (ADC Counts)');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 33,'TASK_STATUS',1,'INT','PN Test-Pulse status','PN Test-Pulse status');


/* MON_LASER_BLUE_DAT  */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 34,'APD_MEAN',1,'FLOAT','Mean height',       'Mean Channel Amplitude for Blue Laser runs (ADC Counts)'); 
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 34,'TASK_STATUS',1,'INT','Blue Laser Channel status','Blue Laser Channel status');

/* MON_LASER_GREEN_DAT */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 35,'APD_MEAN',1,'FLOAT','Mean height',       'Mean Channel Amplitude for Green Laser runs (ADC Counts)'); 
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 35,'TASK_STATUS',1,'INT','Green Laser Channel status','Green Laser Channel status');

/* MON_LASER_RED_DAT */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 36,'APD_MEAN',1,'FLOAT','Mean height',       'Mean Channel Amplitude for Red Laser runs (ADC Counts)'); 
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 36,'TASK_STATUS',1,'INT','Red Laser Channel status','Red Laser Channel status');

/* MON_LASER_IRED_DAT */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 37,'APD_MEAN',1,'FLOAT','Mean height',       'Mean Channel Amplitude for Infra-Red Laser runs (ADC Counts)'); 
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 37,'TASK_STATUS',1,'INT','Infra-Red Laser Channel status','Infra-Red Laser Channel status');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 38, 'PROBLEMS_ID',1,'INT','MEM Channel wrong identification','Mem Channel wrong identification');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 38, 'PROBLEMS_GAIN_ZERO',1,'INT','MEM Channel gain==0','MEM Channel gain==0');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 38, 'PROBLEMS_GAIN_SWITCH',1,'INT','MEM Channel forbidden gain switch','MEM Channel forbidden gain switch');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 39, 'PROBLEMS_ID',1,'INT','MEM TTBlock wrong identification','MEM TTBlock wrong identification');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 39, 'PROBLEMS_SIZE',1,'INT','MEM TTBlock wrong size','MEM TTBlock wrong size');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 39, 'PROBLEMS_LV1',1,'INT','MEM TTBlock wrong LV1','MEM TTBlock wrong LV1');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 39, 'PROBLEMS_BUNCH_X',1,'INT','MEM TTBlock wrong BunchX','MEM TTBlock wrong BunchX');
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 39, 'TASK_STATUS',1,'INT','MEM TTBlock Integrity status','MEM TTBlock Integrity status');


/* DCU_CAPSULE_TEMP_DAT     */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal,42, 'CAPSULE_TEMP',1,'FLOAT','Capsule Temperature',       'Capsule Temperature (C)'); 

/* DCU_CAPSULE_TEMP_RAW_DAT */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal,43, 'CAPSULE_TEMP_ADC',1,'FLOAT','Raw Capsule Temperature',       'Raw Capsule Temperature (ADC Counts)'); 
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal,43, 'CAPSULE_TEMP_RMS',1,'FLOAT','Raw Capsule Temperature RMS',       'Raw Capsule Temperature RMS (ADC Counts)'); 
...
/* DCU_VFE_TEMP_DAT   */ 
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal,46,'VFE_TEMP',1,'FLOAT','Temperature of DCU chip on VFEs',       'Temperature (C) of DCU chip on VFEs');   

/* DCU_LVR_TEMPS_DAT   */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal,47 ,'T1',1,'FLOAT','Temperature of DCU chip 1 on LVR',       'Temperature (C) of DCU chip 1 on LVR');  

INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal,47 ,'T2',1,'FLOAT','Temperature (C) of DCU chip 2 on LVR',       'Temperature (C) of DCU chip 2 on LVR'); 
 
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal,47 ,'T3',1,'FLOAT','Temperature (C) of DCU chip 3 on LVR',       'Temperature (C) of DCU chip 3 on LVR');  
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 52,'APD_PEAK',1,'FLOAT','Mean height',       'Mean Channel Amplitude for Blue Laser runs (ADC Counts)'); 
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 53,'APD_PEAK',1,'FLOAT','Mean height',       'Mean Channel Amplitude for Infra-Red Laser runs (ADC Counts)'); 
...
/* LMF_PN_BLUE_DAT    */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 60,'PN_PEAK',1,'FLOAT','Mean PN height',       'Mean PN Amplitude in Blue Laser run (ADC Counts)'); 
...
/* LMF_PN_IRED_DAT   */
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 61,'PN_PEAK',1,'FLOAT','Mean PN height',       'Mean PN Amplitude in Infra-Red Laser run (ADC Counts)');
...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal, 62,'ADC_MEAN',1,'FLOAT','Mean PN height',       'Mean PN Amplitude in Test-Pulse run (ADC Counts)'); 
