...
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal,43, 'CAPS_TEMP_ADC',1,'FLOAT','Raw Capsule Temperature',       'Raw Capsule Temperature (ADC Counts)'); 
INSERT INTO COND_FIELD_META(DEF_ID, TAB_ID, FIELD_NAME, IS_PLOTTABLE, FIELD_TYPE, CONTENT_EXPLANATION, LABEL) values (COND_FIELD_SQ.NextVal,43, 'CAPS_TEMP_RMS',1,'FLOAT','Raw Capsule Temperature RMS',       'Raw Capsule Temperature RMS (ADC Counts)'); 
