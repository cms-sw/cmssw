...
void etad_etap_pt()
{
    ...
    f1->SetParameters(0.75,0.10,1.0,9.1E-31,5.0);f1->SetLineColor(42);
    f1->Draw();
    ...
    f2->SetParameters(3.0,0.10,1.0,9.1E-31,5.0);f2->SetLineColor(13);
    f2->Draw("SAME");
    TF1 *f3 = new TF1( "pt3",etad_etap_pt, 0.01,3.,5);
    f3->SetParameters(5.0,0.10,1.0,9.1E-31,5.0);f3->SetLineColor(33);
    f3->Draw("SAME");
    TF1 *f4 = new TF1( "pt4",etad_etap_pt, 0.01,3.,5);
    f4->SetParameters(10.0,0.10,1.0,9.1E-31,5.0);f4->SetLineColor(66);
    f4->Draw("SAME");
    TF1 *f5 = new TF1( "pt5",etad_etap_pt, 0.01,3.,5);f5->SetLineColor(1);
    f5->SetParameters(50.0,0.10,1.0,9.1E-31,5.0);
    f5->Draw("SAME");
    TF1 *f6 = new TF1( "pt6",etad_etap_pt, 0.01,3.,5);
    f6->SetParameters(100.0,0.10,1.0,9.1E-31,5.0);f6->SetLineColor(99);
    f6->Draw("SAME");
    gPad->SetLogy();
    c1->Draw();
    legend->SetHeader("z_0=0.10m");
