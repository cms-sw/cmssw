...
JetTagPlotter::JetTagPlotter (const TString & tagName, const EtaPtBin & etaPtBin,
  ...
  dJetFlav = new FlavourHistograms<int>
	...
	false, false, false, "b", update,std::string((const char *)("JetTag"+theExtensionString)));

  // track multiplicity in jet
  dJetMultiplicity = new FlavourHistograms<int>
	("jetMultiplicity" + es, "Jet Multiplicity", 31, -0.5, 30.5,
	false, true, true, "b", update,std::string((const char *)("JetTag"+theExtensionString)));
  ...
  dJetRecMomentum = new FlavourHistograms<double>
	...
	false, false, true, "b", update,std::string((const char *)("JetTag"+theExtensionString)));
  ...
  dJetPartonMomentum = new FlavourHistograms<double>
	...
	200, 0.0, 400.0, false, false, true, "b", update,std::string((const char *)("JetTag"+theExtensionString)));
  ...
  dJetPartonPseudoRapidity = new FlavourHistograms<double>
	...
	100, -3.5, 3.5, false, false, true, "b", update,std::string((const char *)("JetTag"+theExtensionString)));
}
...
void JetTagPlotter::finalize()
{
  ...
  //
  effPurFromHistos = new EffPurFromHistos ( dDiscriminator,std::string((const char *)("JetTag"+theExtensionString)),
