#include "DQMOffline/PFTau/plugins/PFClient_Daniele.h"
...
// -- Constructor
//
PFClient_Daniele::PFClient_Daniele(const edm::ParameterSet& parameterSet)  
{
...
// -- BeginJob
//
void PFClient_Daniele::beginJob() {
...
// -- EndJobBegin Run
// 
void PFClient_Daniele::endRun(edm::Run const& run, edm::EventSetup const& eSetup) {
  doSummaries();
...
// -- EndJob
// 
void PFClient_Daniele::endJob() {

}
//
// -- Create Summaries
//
void PFClient_Daniele::doSummaries() {
...
// -- Create Summaries
//
void PFClient_Daniele::doEfficiency() {
  for (std::vector<std::string>::const_iterator ifolder = folderNames_.begin();
                                    ifolder != folderNames_.end(); ifolder++) {
    std::string path  = "ParticleFlow/"+(*ifolder);
...
//
void PFClient_Daniele::createResolutionPlots(std::string& folder, std::string& name) {     
...
//
void PFClient_Daniele::getHistogramParameters(MonitorElement* me_slice, double& average, 
...
// -- Create Resolution Plots
//
void PFClient_Daniele::createEfficiencyPlots(std::string& folder, std::string& name) {     
...
DEFINE_FWK_MODULE (PFClient_Daniele) ;
