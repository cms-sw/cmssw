#include "DQMOffline/PFTau/plugins/PFMETAnalyzer.h"
...
// -- Constructor
//
PFMETAnalyzer::PFMETAnalyzer(const edm::ParameterSet& parameterSet)  
...
// -- Analyze
//
void PFMETAnalyzer::analyze(edm::Event const& iEvent, 
...
void PFMETAnalyzer::storeBadEvents(edm::Event const& iEvent, float& val) {
