...
PFMETMonitor::PFMETMonitor(Benchmark::Mode mode)
    : Benchmark(mode), candBench_(mode), matchCandBench_(mode) {
...
void PFMETMonitor::setParameters(const edm::ParameterSet &parameterSet) {
  ...
  createMETSpecificHistos_ =
      parameterSet.getParameter<bool>("CreateMETSpecificHistos");
...
void PFMETMonitor::setup(DQMStore::IBooker &b,
  ...
  if (createMETSpecificHistos_ && !histogramBooked_) {
    ...
    edm::ParameterSet pxPS =
        parameterSet.getParameter<edm::ParameterSet>("DeltaPxHistoParameter");
    edm::ParameterSet dpxPS =
        parameterSet.getParameter<edm::ParameterSet>("DeltaPxHistoParameter");
    edm::ParameterSet dptPS =
        parameterSet.getParameter<edm::ParameterSet>("DeltaPtHistoParameter");
    edm::ParameterSet setPS =
        parameterSet.getParameter<edm::ParameterSet>("SumEtHistoParameter");
    edm::ParameterSet dsetPS = parameterSet.getParameter<edm::ParameterSet>(
        "DeltaSumEtHistoParameter");
    edm::ParameterSet setOvsetPS = parameterSet.getParameter<edm::ParameterSet>(
        "DeltaSumEtOvSumEtHistoParameter");

    if (pxPS.getParameter<bool>("switchOn")) {
      px_ = book1D(
          b, "px_", "px_;p_{X} (GeV)", pxPS.getParameter<int32_t>("nBin"),
          pxPS.getParameter<double>("xMin"), pxPS.getParameter<double>("xMax"));
    }
    ...
    if (dpxPS.getParameter<bool>("switchOn")) {
      delta_ex_VS_set_ =
          book2D(b, "delta_ex_VS_set_", ";SE_{T, true} (GeV);#DeltaE_{X}",
                 setPS.getParameter<int32_t>("nBin"),
                 setPS.getParameter<double>("xMin"),
                 setPS.getParameter<double>("xMax"),
    ...
    // TProfile
    if (dpxPS.getParameter<bool>("switchOn")) {
      profile_delta_ex_VS_set_ = bookProfile(
          b, "profile_delta_ex_VS_set_", ";SE_{T, true} (GeV);#DeltaE_{X}",
          setPS.getParameter<int32_t>("nBin"),
          setPS.getParameter<double>("xMin"),
          setPS.getParameter<double>("xMax"),
          dptPS.getParameter<double>("xMin"),
          dptPS.getParameter<double>("xMax"), "");
      profileRMS_delta_ex_VS_set_ = bookProfile(
          b, "profileRMS_delta_ex_VS_set_", ";SE_{T, true} (GeV);#DeltaE_{X}",
          setPS.getParameter<int32_t>("nBin"),
          setPS.getParameter<double>("xMin"),
          setPS.getParameter<double>("xMax"),
          dptPS.getParameter<double>("xMin"),
    ...
    if (dsetPS.getParameter<bool>("switchOn")) {
      profile_delta_set_VS_set_ = bookProfile(
          b, "profile_delta_set_VS_set_", ";SE_{T, true} (GeV);#DeltaSE_{T}",
          setPS.getParameter<int32_t>("nBin"),
          setPS.getParameter<double>("xMin"),
          setPS.getParameter<double>("xMax"),
          dsetPS.getParameter<double>("xMin"),
          dsetPS.getParameter<double>("xMax"), "");
      profileRMS_delta_set_VS_set_ = bookProfile(
          b, "profileRMS_delta_set_VS_set_", ";SE_{T, true} (GeV);#DeltaSE_{T}",
          setPS.getParameter<int32_t>("nBin"),
          setPS.getParameter<double>("xMin"),
          setPS.getParameter<double>("xMax"),
          dsetPS.getParameter<double>("xMin"),
    ...
    if (setOvsetPS.getParameter<bool>("switchOn")) {
      ...
      profileRMS_delta_set_Over_set_VS_set_ =
          bookProfile(b, "profileRMS_delta_set_Over_set_VS_set_",
                      ";SE_{T, true} (GeV);#DeltaSE_{T}/SE_{T}",
                      setPS.getParameter<int32_t>("nBin"),
                      setPS.getParameter<double>("xMin"),
                      setPS.getParameter<double>("xMax"),
...
void PFMETMonitor::setup(DQMStore::IBooker &b) {
  ...
  if (createMETSpecificHistos_ && !histogramBooked_) {
    ...
    delta_ex_ =
        book1D(b, "delta_ex_", "#DeltaME_{X}", dpxPS.n, dpxPS.m, dpxPS.M);
    delta_ex_VS_set_ =
        book2D(b, "delta_ex_VS_set_", ";SE_{T, true} (GeV);#DeltaE_{X}",
               setPS.n, setPS.m, setPS.M, dpxPS.n, dpxPS.m, dpxPS.M);
    delta_set_VS_set_ =
        book2D(b, "delta_set_VS_set_", ";SE_{T, true} (GeV);#DeltaSE_{T}",
    ...
    delta_set_Over_set_VS_set_ =
        book2D(b, "delta_set_Over_set_VS_set_",
               ...
               setPS.M, setOvsetPS.n, setOvsetPS.m, setOvsetPS.M);

    // TProfile
    profile_delta_ex_VS_set_ = bookProfile(
        b, "profile_delta_ex_VS_set_", ";SE_{T, true} (GeV);#DeltaE_{X}",
        setPS.n, setPS.m, setPS.M, setOvsetPS.m, setOvsetPS.M, "");
    ...
    profile_delta_set_Over_set_VS_set_ =
        bookProfile(b, "profile_delta_set_Over_set_VS_set_",
                    ";SE_{T, true} (GeV);#DeltaSE_{T}/SE_{T}", setPS.n, setPS.m,
                    setPS.M, setOvsetPS.m, setOvsetPS.M, "");

    // TProfile RMS
    profileRMS_delta_ex_VS_set_ = bookProfile(
        b, "profileRMS_delta_ex_VS_set_", ";SE_{T, true} (GeV);#DeltaE_{X}",
        setPS.n, setPS.m, setPS.M, setOvsetPS.m, setOvsetPS.M, "s");
    ...
    profileRMS_delta_set_Over_set_VS_set_ =
        bookProfile(b, "profileRMS_delta_set_Over_set_VS_set_",
                    ";SE_{T, true} (GeV);#DeltaSE_{T}/SE_{T}", setPS.n, setPS.m,
                    setPS.M, setOvsetPS.m, setOvsetPS.M, "s");
    histogramBooked_ = true;
  }
}
...
void PFMETMonitor::fillOne(const reco::MET &met, const reco::MET &matchedMet,
  ...
  if (createMETSpecificHistos_ && histogramBooked_) {
    ...
    if (delta_ex_VS_set_) {
      ...
      profile_delta_ex_VS_set_->Fill(matchedMet.sumEt(),
                                     met.px() - matchedMet.px());
      profile_delta_ex_VS_set_->Fill(matchedMet.sumEt(),
                                     met.py() - matchedMet.py());
      profileRMS_delta_ex_VS_set_->Fill(matchedMet.sumEt(),
                                        met.px() - matchedMet.px());
      profileRMS_delta_ex_VS_set_->Fill(matchedMet.sumEt(),
                                        met.py() - matchedMet.py());
    }
    if (delta_set_VS_set_) {
      delta_set_VS_set_->Fill(matchedMet.sumEt(),
                              met.sumEt() - matchedMet.sumEt());
      profile_delta_set_VS_set_->Fill(matchedMet.sumEt(),
                                      met.sumEt() - matchedMet.sumEt());
      profileRMS_delta_set_VS_set_->Fill(matchedMet.sumEt(),
                                         met.sumEt() - matchedMet.sumEt());
    }
