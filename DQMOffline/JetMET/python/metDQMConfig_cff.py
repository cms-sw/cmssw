...
#        "HLT_MinBias"),
    ...
    highMETTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_MET200_v','HLT_MET200_v7','HLT_MET200_v8','HLT_MET200_v9' ), 
        andOrHlt       = cms.bool( True ),
        errorReplyHlt  = cms.bool( False ),
    ),
    lowMETTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_MET120_HBHENoiseFiltered_v','HLT_MET120_HBHENoiseFiltered_v6','HLT_MET120_HBHENoiseFiltered_v7','HLT_MET120_HBHENoiseFiltered_v8' ), 
        andOrHlt       = cms.bool( True ),
        errorReplyHlt  = cms.bool( False ),
    ),
    eleTrigger = cms.PSet(
