...
#        "HLT_MinBias"),
    ...
    highMETTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_MET200_v1','HLT_MET200_v2','HLT_MET200_v3','HLT_MET200_v4','HLT_MET200_v5' ), 
        andOrHlt       = cms.bool( True ),
        errorReplyHlt  = cms.bool( False ),
    ),
    lowMETTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_MET100_v1','HLT_MET100_v2','HLT_MET100_v3','HLT_MET100_v4','HLT_MET100_v5' ), 
        andOrHlt       = cms.bool( True ),
        errorReplyHlt  = cms.bool( False ),
    ),
    eleTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_Ele27_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_v1','HLT_Ele27_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_v2','HLT_Ele27_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_v4','HLT_Ele27_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_v3','HLT_Ele27_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_v5' ), 
        andOrHlt       = cms.bool( True ),
        errorReplyHlt  = cms.bool( False ),
    ),
