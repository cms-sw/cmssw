...
###     hltPaths       = cms.vstring( 'HLT_PFJet400_v' ), 
        hltPaths       = cms.vstring( 'HLT_PAJet120_v', 'HLT_PAForJet100Eta3_v' ), 
...
###     hltPaths       = cms.vstring( 'HLT_PFJet80_v*' ), 
        hltPaths       = cms.vstring( 'HLT_PAJet40_v*' ,'HLT_PAForJet40Eta3_v*' ),
        andOrHlt       = cms.bool( True ),
        errorReplyHlt  = cms.bool( False ),
    ),
...
###     hltPaths       = cms.vstring( 'HLT_MET400_v*' ),
        hltPaths       = cms.vstring( 'HLT_PAJet40ETM30','HLT_PAJet60ETM30' ), 
        andOrHlt       = cms.bool( True ),
        errorReplyHlt  = cms.bool( False ),
    ),
