...
#        "HLT_MinBias"),
    ...
    highPtJetTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_Jet300_v1','HLT_Jet300_v2','HLT_Jet300_v3','HLT_Jet300_v4','HLT_Jet300_v5','HLT_Jet300_v6','HLT_Jet300_v7','HLT_Jet300_v8','HLT_Jet300_v9' ), 
    ...
    lowPtJetTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_Jet80_v1','HLT_Jet80_v2','HLT_Jet80_v3','HLT_Jet80_v4','HLT_Jet80_v5','HLT_Jet80_v6','HLT_Jet80_v7','HLT_Jet80_v8','HLT_Jet80_v9' ), 
        andOrHlt       = cms.bool( True ),
        errorReplyHlt  = cms.bool( False ),
    ),
    minBiasTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_L1Tech_BSC_minBias_threshold1_v1','HLT_L1Tech_BSC_minBias_threshold1_v2','HLT_L1Tech_BSC_minBias_threshold1_v3','HLT_L1Tech_BSC_minBias_threshold1_v4','HLT_L1Tech_BSC_minBias_threshold1_v5' ), 
        andOrHlt       = cms.bool( True ),
        errorReplyHlt  = cms.bool( False ),
    ),
    highMETTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_MET200_v1','HLT_MET200_v2','HLT_MET200_v3','HLT_MET200_v4','HLT_MET200_v5','HLT_MET200_v6','HLT_MET200_v7','HLT_MET200_v8','HLT_MET200_v9' ), 
        andOrHlt       = cms.bool( True ),
        errorReplyHlt  = cms.bool( False ),
    ),
    lowMETTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_MET120_v1','HLT_MET120_v2','HLT_MET120_v3','HLT_MET120_v4','HLT_MET120_v5','HLT_MET120_v6','HLT_MET120_v7','HLT_MET120_v8','HLT_MET120_v9' ), 
        andOrHlt       = cms.bool( True ),
        errorReplyHlt  = cms.bool( False ),
    ),
    eleTrigger = cms.PSet(
