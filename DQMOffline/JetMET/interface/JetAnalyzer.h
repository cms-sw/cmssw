...
//  bool energycorrected;
  ...
  MonitorElement* mePhFrac_EmptyBunch;
  MonitorElement* meNHFrac_EmptyBunch;
  MonitorElement* meCHFrac_EmptyBunch;
  MonitorElement* mePt_EmptyBunch;
  MonitorElement* meEta_EmptyBunch;

  MonitorElement* mePhFrac_oneEmptyBunch;
  MonitorElement* meNHFrac_oneEmptyBunch;
  MonitorElement* meCHFrac_oneEmptyBunch;
  MonitorElement* mePt_oneEmptyBunch;
  MonitorElement* meEta_oneEmptyBunch;

  MonitorElement* mePhFrac_oneFullBunch;
  MonitorElement* meNHFrac_oneFullBunch;
  MonitorElement* meCHFrac_oneFullBunch;
  MonitorElement* mePt_oneFullBunch;
  MonitorElement* meEta_oneFullBunch;

  MonitorElement* meCHFrac_noEmptyBunch;
  MonitorElement* mePhFrac_noEmptyBunch;
  MonitorElement* meNHFrac_noEmptyBunch;
  MonitorElement* mePt_noEmptyBunch;
  MonitorElement* meEta_noEmptyBunch;
