...
DQMOffline = cms.Sequence(SiStripDQMTier0*ecal_dqm_source_offline7*muonMonitors*jetMETAnalyzer*hcalOfflineDQMSource)
DQMOffline_woTracker = cms.Sequence(ecal_dqm_source_offline7*muonMonitors*jetMETAnalyzer*hcalOfflineDQMSource)
