...
DQMOfflineCosmicsDPG = cms.Sequence(SiStripDQMTier0*ecal_dqm_source_offline*hcalOfflineDQMSource*triggerCosmicOfflineDQMSource*siPixelOfflineDQM_cosmics_source*dtSources*cscSources*rpcTier0Source*es_dqm_source_offline)
...
DQMOfflineCosmicsPOG = cms.Sequence(muonCosmicMonitors*jetMETDQMOfflineSourceCosmic*egammaCosmicPhotonMonitors*dqmPhysics)
