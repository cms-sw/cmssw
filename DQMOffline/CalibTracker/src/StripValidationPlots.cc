...
void StripValidationPlots::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {}

// ------------ method called once each job just before starting event loop  ------------
void StripValidationPlots::beginJob() {
  oss.str("");
  oss << 1;  //runNumber
...
void StripValidationPlots::endJob() {
