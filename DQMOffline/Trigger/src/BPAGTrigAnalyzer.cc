...
// $Id: BPAGTrigAnalyzer.cc,v 1.4 2010/01/07 13:18:15 slaunwhj Exp $
//
//
  ...
  for ( iMuonSelector = customSelectors.begin();
    ...
    for( size_t i = 0; i < triggerNames.size(); i++) {
      ...
      if ( !isValidTriggerName ) {}   
        ...
        HLTMuonBPAG * tempTop;
        tempTop = new HLTMuonBPAG ( pset, triggerNames[i], moduleNames, (*iMuonSelector), (*iTagSelector), (*iName), validTriggerNames);
