...
void EgHLTOfflineSummaryClient::runClient_()
{
  ...
  MonitorElement* hltEleSumBit = dbe_->get("EventInfo/reportSummaryContent/HLT_Electron");
  MonitorElement* hltPhoSumBit = dbe_->get("EventInfo/reportSummaryContent/HLT_Photon");
  dbe_->setCurrentFolder("EventInfo/reportSummaryContent/");
