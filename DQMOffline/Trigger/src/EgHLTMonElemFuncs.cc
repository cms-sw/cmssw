...
void MonElemFuncs::initStdEleHists(DQMStore::IBooker &iBooker, std::vector<MonElemManagerBase<OffEle>*>& histVec,const std::string& filterName,const std::string& baseName,const BinData& bins)
{
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_energy",baseName+" reco CaloEnergy;reco CaloEnergy (GeV)",bins.energy, &OffEle::energy);
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_et",baseName+" E_{T};E_{T} (GeV)",bins.et,&OffEle::et); 
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_etHigh",baseName+" E_{T};E_{T} (GeV)",bins.etHigh,&OffEle::et); 
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_etSC",baseName+" E^{SC}_{T};E^{SC}_{T} (GeV)",bins.et,&OffEle::etSC);
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_eta",baseName+" #eta;#eta",bins.eta,&OffEle::detEta);		
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_phi",baseName+" #phi;#phi (rad)",bins.phi,&OffEle::phi);
  // addStdHist<OffEle,int>(iBooker, histVec,baseName+"_charge",baseName+" Charge; charge",bins.charge,&OffEle::charge);
  
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_hOverE",baseName+" H/E; H/E",bins.hOverE,&OffEle::hOverE);
  //----Morse
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_maxr9",baseName+" MAXR9 ; MAXR9",bins.maxr9,&OffEle::r9);
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_HLTenergy",baseName+" HLT Energy;HLT Energy (GeV)",bins.HLTenergy,&OffEle::hltEnergy); 
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_HLTeta",baseName+" HLT #eta;HLT #eta",bins.HLTeta,&OffEle::hltEta);		
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_HLTphi",baseName+" HLT #phi;HLT #phi (rad)",bins.HLTphi,&OffEle::hltPhi);
  //-------
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_dPhiIn",baseName+" #Delta #phi_{in}; #Delta #phi_{in}",bins.dPhiIn,&OffEle::dPhiIn);
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_dEtaIn",baseName+" #Delta #eta_{in}; #Delta #eta_{in}",bins.dEtaIn,&OffEle::dEtaIn);
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_sigmaIEtaIEta",baseName+"#sigma_{i#etai#eta}; #sigma_{i#etai#eta}",bins.sigEtaEta,&OffEle::sigmaIEtaIEta);  
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_epIn",baseName+"E/p_{in}; E/p_{in}",bins.eOverP,&OffEle::epIn);
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_epOut",baseName+"E/p_{out}; E/p_{out}",bins.eOverP,&OffEle::epOut); 
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_invEInvP",baseName+"1/E -1/p; 1/E - 1/p",bins.invEInvP,&OffEle::invEInvP);

  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_e2x5Over5x5",baseName+"E^{2x5}/E^{5x5}; E^{2x5}/E^{5x5}",bins.e2x5,&OffEle::e2x5MaxOver5x5);
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_e1x5Over5x5",baseName+"E^{1x5}/E^{5x5}; E^{1x5}/E^{5x5}",bins.e1x5,&OffEle::e1x5Over5x5);
  //addStdHist<OffEle,float>(iBooker, histVec,baseName+"_isolEM",baseName+"Isol EM; Isol EM (GeV)",bins.isolEm,&OffEle::isolEm); 
  //addStdHist<OffEle,float>(iBooker, histVec,baseName+"_isolHad",baseName+"Isol Had; Isol Had (GeV)",bins.isolHad,&OffEle::isolHad);
  //addStdHist<OffEle,float>(iBooker, histVec,baseName+"_isolPtTrks",baseName+"Isol Pt Trks; Isol Pt Tracks (GeV/c)",bins.isolPtTrks,&OffEle::isolPtTrks); 
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_hltIsolTrksEle",baseName+"HLT Ele Isol Trks; HLT Ele Iso Tracks (GeV/c)",bins.isolPtTrks,&OffEle::hltIsolTrksEle);  
  //addStdHist<OffEle,float>(iBooker, histVec,baseName+"_hltIsolTrksPho",baseName+"HLT Pho Isol Trks; HLT Pho Iso Tracks (GeV/c)",bins.isolPtTrks,&OffEle::hltIsolTrksPho); 
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_hltIsolHad",baseName+"HLT Isol Had; HLT Isol Had (GeV)",bins.isolHad,&OffEle::hltIsolHad);
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_hltIsolEm",baseName+"HLT Isol Em; HLT Isol Em (GeV)",bins.isolEm,&OffEle::hltIsolEm);
  addStdHist<OffEle,float>(iBooker, histVec,baseName+"_DeltaE",baseName+"HLT Energy - reco SC Energy;HLT Energy - reco SC Energy (GeV)",bins.deltaE,&OffEle::DeltaE);
...
void MonElemFuncs::initStdPhoHists(DQMStore::IBooker &iBooker, std::vector<MonElemManagerBase<OffPho>*>& histVec,const std::string& filterName,const std::string& baseName,const BinData& bins)
{
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_energy",baseName+" reco Energy;reco Energy (GeV)",bins.energy, &OffPho::energy);
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_et",baseName+" E_{T};E_{T} (GeV)",bins.et,&OffPho::et); 
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_etHigh",baseName+" E_{T};E_{T} (GeV)",bins.etHigh,&OffPho::et);
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_etSC",baseName+" E^{SC}_{T};E^{SC}_{T} (GeV)",bins.et,&OffPho::etSC);
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_eta",baseName+" #eta;#eta",bins.eta,&OffPho::detEta);		
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_phi",baseName+" #phi;#phi (rad)",bins.phi,&OffPho::phi);
  
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_hOverE",baseName+" H/E; H/E",bins.hOverE,&OffPho::hOverE);
  //----Morse
  //addStdHist<OffPho,float>(iBooker,histVec,baseName+"_r9",baseName+" R9 ; R9",bins.r9,&OffPho::r9);
  //addStdHist<OffPho,float>(iBooker,histVec,baseName+"_minr9",baseName+" MINR9 ; MINR9",bins.minr9,&OffPho::r9);
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_maxr9",baseName+" MAXR9 ; MAXR9",bins.maxr9,&OffPho::r9);
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_HLTenergy",baseName+" HLT Energy;HLT Energy (GeV)",bins.HLTenergy,&OffPho::hltEnergy); 
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_HLTeta",baseName+" HLT #eta;HLT #eta",bins.HLTeta,&OffPho::hltEta);		
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_HLTphi",baseName+" HLT #phi;HLT #phi (rad)",bins.HLTphi,&OffPho::hltPhi);
  //-------
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_sigmaIEtaIEta",baseName+"#sigma_{i#etai#eta}; #sigma_{i#etai#eta}",bins.sigEtaEta,&OffPho::sigmaIEtaIEta);  
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_e2x5Over5x5",baseName+"E^{2x5}/E^{5x5}; E^{2x5}/E^{5x5}",bins.e2x5,&OffPho::e2x5MaxOver5x5);
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_e1x5Over5x5",baseName+"E^{1x5}/E^{5x5}; E^{1x5}/E^{5x5}",bins.e1x5,&OffPho::e1x5Over5x5);
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_isolEM",baseName+"Isol EM; Isol EM (GeV)",bins.isolEm,&OffPho::isolEm); 
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_isolHad",baseName+"Isol Had; Isol Had (GeV)",bins.isolHad,&OffPho::isolHad);
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_isolPtTrks",baseName+"Isol Pt Trks; Isol Pt Tracks (GeV/c)",bins.isolPtTrks,&OffPho::isolPtTrks);  
  addStdHist<OffPho,int>(iBooker,histVec,baseName+"_isolNrTrks",baseName+"Isol Nr Trks; Isol Nr Tracks",bins.isolNrTrks,&OffPho::isolNrTrks); 
  //addStdHist<OffPho,float>(iBooker,histVec,baseName+"_hltIsolTrks",baseName+"HLT Isol Trks; HLT Iso Tracks (GeV/c)",bins.isolPtTrks,&OffPho::hltIsolTrks); 
  //addStdHist<OffPho,float>(iBooker,histVec,baseName+"_hltIsolHad",baseName+"HLT Isol Had; HLT Isol Had (GeV)",bins.isolPtTrks,&OffPho::hltIsolHad);
  addStdHist<OffPho,float>(iBooker,histVec,baseName+"_DeltaE",baseName+"HLT Energy - reco SC Energy;HLT Energy - reco SC Energy (GeV)",bins.deltaE,&OffPho::DeltaE);
...
void MonElemFuncs::initStdEffHists(DQMStore::IBooker &iBooker,std::vector<MonElemWithCutBase<OffEle>*>& histVec,const std::string& filterName,const std::string& baseName,const BinData::Data1D& bins,float (OffEle::*vsVarFunc)()const,const CutMasks& masks)
{
  initStdEffHists(iBooker,histVec,filterName,baseName,bins.nr,bins.min,bins.max,vsVarFunc,masks);
}
  
void MonElemFuncs::initStdEffHists(DQMStore::IBooker &iBooker,std::vector<MonElemWithCutBase<OffPho>*>& histVec,const std::string& filterName,const std::string& baseName,const BinData::Data1D& bins,float (OffPho::*vsVarFunc)()const,const CutMasks& masks)
{
  initStdEffHists(iBooker,histVec,filterName,baseName,bins.nr,bins.min,bins.max,vsVarFunc,masks);
}

void MonElemFuncs::initStdEffHists(DQMStore::IBooker &iBooker,std::vector<MonElemWithCutBase<OffEle>*>& histVec,const std::string& filterName,const std::string& baseName,int nrBins,double xMin,double xMax,float (OffEle::*vsVarFunc)()const,const CutMasks& masks)
{
...
void MonElemFuncs::initStdEffHists(DQMStore::IBooker &iBooker,std::vector<MonElemWithCutBase<OffPho>*>& histVec,const std::string& filterName,const std::string& baseName,int nrBins,double xMin,double xMax,float (OffPho::*vsVarFunc)()const,const CutMasks& masks)
{
...
void MonElemFuncs::initStdEleCutHists(DQMStore::IBooker &iBooker,std::vector<MonElemWithCutBase<OffEle>*>& histVec,const std::string& filterName,const std::string& baseName,const BinData& bins,EgHLTDQMCut<OffEle>* cut)
{
...
void MonElemFuncs::initStdPhoCutHists(DQMStore::IBooker &iBooker,std::vector<MonElemWithCutBase<OffPho>*>& histVec,const std::string& filterName,const std::string& baseName,const BinData& bins,EgHLTDQMCut<OffPho>* cut)
{
...
void MonElemFuncs::initTightLooseTrigHists(DQMStore::IBooker &iBooker, std::vector<MonElemContainer<OffEle>*>& eleMonElems,const std::vector<std::string>& tightLooseTrigs,const BinData& bins,EgHLTDQMCut<OffEle>* eleCut)
{
  for(size_t trigNr=0;trigNr<tightLooseTrigs.size();trigNr++){
    ...
    if(trigNr!=tightLooseTrigs.size()-2) addTightLooseTrigHist(iBooker, eleMonElems,tightTrig,looseTrig,eleCut->clone(),"gsfEle",bins);
    else addTightLooseTrigHist(iBooker, eleMonElems,tightTrig,looseTrig,eleCut,"gsfEle",bins);
  }
} 


void MonElemFuncs::initTightLooseTrigHists(DQMStore::IBooker &iBooker, std::vector<MonElemContainer<OffPho>*>& phoMonElems,const std::vector<std::string>& tightLooseTrigs,const BinData& bins,EgHLTDQMCut<OffPho>* phoCut)
{
  for(size_t trigNr=0;trigNr<tightLooseTrigs.size();trigNr++){
    std::vector<std::string> splitString;
    boost::split(splitString,tightLooseTrigs[trigNr],boost::is_any_of(std::string(":")));
    ...
    //but clone it before that
    //perhaps my object ownership rules need to be re-evalulated
    if(trigNr!=tightLooseTrigs.size()-2) addTightLooseTrigHist(iBooker, phoMonElems,tightTrig,looseTrig,phoCut->clone(),"pho",bins);
    else addTightLooseTrigHist(iBooker, phoMonElems,tightTrig,looseTrig,phoCut,"pho",bins);
  }
}
...
void MonElemFuncs::addTightLooseTrigHist(DQMStore::IBooker &iBooker, std::vector<MonElemContainer<OffEle>*>& eleMonElems,
					 ...
					 const std::string& histId,const BinData& bins)
{
  ...
  MonElemFuncs::initStdEleHists(iBooker, passMonElem->monElems(),tightTrig+"_"+looseTrig,passMonElem->name(),bins);
  MonElemFuncs::initStdEleHists(iBooker, failMonElem->monElems(),tightTrig+"_"+looseTrig,failMonElem->name(),bins);
...
void MonElemFuncs::addTightLooseTrigHist(DQMStore::IBooker &iBooker, std::vector<MonElemContainer<OffPho>*>& phoMonElems,
					 const std::string& tightTrig,const std::string& looseTrig,
					 ...
					 const std::string& histId,const BinData& bins)
{
  ...
  MonElemFuncs::initStdPhoHists(iBooker, passMonElem->monElems(),tightTrig+"_"+looseTrig,passMonElem->name(),bins);
  MonElemFuncs::initStdPhoHists(iBooker, failMonElem->monElems(),tightTrig+"_"+looseTrig,failMonElem->name(),bins);
...
void MonElemFuncs::initTightLooseTrigHistsTrigCuts(DQMStore::IBooker &iBooker, std::vector<MonElemContainer<OffEle>*>& eleMonElems,const std::vector<std::string>& tightLooseTrigs,const BinData& bins)
{
  for(size_t trigNr=0;trigNr<tightLooseTrigs.size();trigNr++){
    std::vector<std::string> splitString;
    boost::split(splitString,tightLooseTrigs[trigNr],boost::is_any_of(std::string(":")));
    ...
    addTightLooseTrigHist(iBooker, eleMonElems,tightTrig,looseTrig,eleCut,"gsfEle_trigCuts",bins);
  }
} 

//we transfer ownership of phoCut to the monitor elements
void MonElemFuncs::initTightLooseTrigHistsTrigCuts(DQMStore::IBooker &iBooker, std::vector<MonElemContainer<OffPho>*>& phoMonElems,const std::vector<std::string>& tightLooseTrigs,const BinData& bins)
{
  for(size_t trigNr=0;trigNr<tightLooseTrigs.size();trigNr++){
    std::vector<std::string> splitString;
    boost::split(splitString,tightLooseTrigs[trigNr],boost::is_any_of(std::string(":")));
    ...
    addTightLooseTrigHist(iBooker, phoMonElems,tightTrig,looseTrig,phoCut,"pho_trigCuts",bins);
  }
} 


//we transfer ownership of eleCut to the monitor elements
void MonElemFuncs::initTightLooseDiObjTrigHistsTrigCuts(DQMStore::IBooker &iBooker, std::vector<MonElemContainer<OffEle>*>& eleMonElems,const std::vector<std::string>& tightLooseTrigs,const BinData& bins)
{
  for(size_t trigNr=0;trigNr<tightLooseTrigs.size();trigNr++){
    std::vector<std::string> splitString;
    boost::split(splitString,tightLooseTrigs[trigNr],boost::is_any_of(std::string(":")));
...
//we transfer ownership of phoCut to the monitor elements
void MonElemFuncs::initTightLooseDiObjTrigHistsTrigCuts(DQMStore::IBooker &iBooker, std::vector<MonElemContainer<OffPho>*>& phoMonElems,const std::vector<std::string>& tightLooseTrigs,const BinData& bins)
{
  for(size_t trigNr=0;trigNr<tightLooseTrigs.size();trigNr++){
    std::vector<std::string> splitString;
    boost::split(splitString,tightLooseTrigs[trigNr],boost::is_any_of(std::string(":")));
...
void MonElemFuncs::initTrigTagProbeHists(DQMStore::IBooker &iBooker,std::vector<MonElemContainer<OffEle>*>& eleMonElems,const std::vector<std::string> filterNames,int cutMask,const BinData& bins)
{
  for(size_t filterNr=0;filterNr<filterNames.size();filterNr++){ 
    ...
    MonElemFuncs::initStdEleCutHists(iBooker,monElemCont->cutMonElems(),trigName,trigName+"_"+monElemCont->name()+"_gsfEle_all",bins,new EgGreaterCut<OffEle,float>(etCutValue,&OffEle::etSC));
    //this is all that pass trigtagprobecut and the probe passes the test trigger
    MonElemFuncs::initStdEleCutHists(iBooker,monElemCont->cutMonElems(),trigName,trigName+"_"+monElemCont->name()+"_gsfEle_pass",bins,&(*(new EgMultiCut<OffEle>) << new EgGreaterCut<OffEle,float>(etCutValue,&OffEle::etSC) << new EgObjTrigCut<OffEle>(TrigCodes::getCode(trigName),EgObjTrigCut<OffEle>::AND)));
    //this is all that pass trigtagprobecut and the probe passes the test trigger and the probe is NOT a tag
    MonElemFuncs::initStdEleCutHists(iBooker,monElemCont->cutMonElems(),trigName,trigName+"_"+monElemCont->name()+"_gsfEle_passNotTag",bins,&(*(new EgMultiCut<OffEle>) << new EgGreaterCut<OffEle,float>(etCutValue,&OffEle::etSC) << new EgObjTrigCut<OffEle>(TrigCodes::getCode(trigName),EgObjTrigCut<OffEle>::AND,TrigCodes::getCode("hltEle32CaloIdTCaloIsoTTrkIdTTrkIsoTSC17TrackIsolFilter"),EgObjTrigCut<OffEle>::AND)));
...
void MonElemFuncs::initTrigTagProbeHist(DQMStore::IBooker &iBooker,std::vector<MonElemContainer<OffEle>*>& eleMonElems,const std::string filterName,int cutMask,const BinData& bins)
{   
...
void MonElemFuncs::initTrigTagProbeHist_2Leg(DQMStore::IBooker &iBooker,std::vector<MonElemContainer<OffEle>*>& eleMonElems,const std::string filterName,int cutMask,const BinData& bins)
{  
  ...
  MonElemContainer<OffEle>* monElemCont = new MonElemContainer<OffEle>("trigTagProbe","Trigger Tag and Probe",new EgTrigTagProbeCut_New(TrigCodes::getCode("hltEle32CaloIdTCaloIsoTTrkIdTTrkIsoTSC17TrackIsolFilter"),TrigCodes::getCode("hltEle32CaloIdTCaloIsoTTrkIdTTrkIsoTSC17HEDoubleFilter"),cutMask,&OffEle::cutCode));
  //this is all that pass trigtagprobecut
  //MonElemFuncs::initStdEleCutHists(iBooker,monElemCont->cutMonElems(),trigNameLeg2,trigNameLeg2+"_"+monElemCont->name()+"_gsfEle_allEt20",bins,new EgGreaterCut<OffEle,float>(etCutValue,&OffEle::etSC));
  //this is all that pass trigtagprobecut and the probe passes the first trigger
  //MonElemFuncs::initStdEleCutHists(iBooker,monElemCont->cutMonElems(),trigNameLeg2,trigNameLeg2+"_"+monElemCont->name()+"_gsfEle_passEt20",bins,&(*(new EgMultiCut<OffEle>) << new EgGreaterCut<OffEle,float>(etCutValue,&OffEle::etSC) << new EgObjTrigCut<OffEle>(TrigCodes::getCode(trigNameLeg1),EgObjTrigCut<OffEle>::AND)));
  //this is all that pass trigtagprobecut and the probe passes the second trigger and fails the first trigger
  MonElemFuncs::initStdEleCutHists(iBooker,monElemCont->cutMonElems(),trigNameLeg2,trigNameLeg2+"_"+monElemCont->name()+"_gsfEle_passLeg2failLeg1",bins,&(*(new EgMultiCut<OffEle>) << new EgGreaterCut<OffEle,float>(etCutValue,&OffEle::etSC) << new EgObjTrigCut<OffEle>(TrigCodes::getCode(trigNameLeg2),EgObjTrigCut<OffEle>::AND,TrigCodes::getCode(trigNameLeg1),EgObjTrigCut<OffEle>::AND)));

}


//Now same for photons
void MonElemFuncs::initTrigTagProbeHists(DQMStore::IBooker &iBooker,std::vector<MonElemContainer<OffPho>*>& phoMonElems,const std::vector<std::string> filterNames,int cutMask,const BinData& bins)
{
  for(size_t filterNr=0;filterNr<filterNames.size();filterNr++){ 
    ...
    //this is all that pass trigtagprobecut
    MonElemFuncs::initStdPhoCutHists(iBooker,monElemCont->cutMonElems(),trigName,trigName+"_"+monElemCont->name()+"_pho_all",bins,new EgGreaterCut<OffPho,float>(etCutValue,&OffPho::etSC));
    //this is all that pass trigtagprobecut and the probe passes the test trigger
    MonElemFuncs::initStdPhoCutHists(iBooker,monElemCont->cutMonElems(),trigName,trigName+"_"+monElemCont->name()+"_pho_pass",bins,&(*(new EgMultiCut<OffPho>) << new EgGreaterCut<OffPho,float>(etCutValue,&OffPho::etSC) << new EgObjTrigCut<OffPho>(TrigCodes::getCode(trigName),EgObjTrigCut<OffPho>::AND)));
    //this is all that pass trigtagprobecut and the probe passes the test trigger and the probe is NOT a tag
    MonElemFuncs::initStdPhoCutHists(iBooker,monElemCont->cutMonElems(),trigName,trigName+"_"+monElemCont->name()+"_pho_passNotTag",bins,&(*(new EgMultiCut<OffPho>) << new EgGreaterCut<OffPho,float>(etCutValue,&OffPho::etSC) << new EgObjTrigCut<OffPho>(TrigCodes::getCode(trigName),EgObjTrigCut<OffPho>::AND,TrigCodes::getCode("hltEle32CaloIdTCaloIsoTTrkIdTTrkIsoTSC17TrackIsolFilter"),EgObjTrigCut<OffPho>::AND)));
    //this is all that pass trigtagprobecut and the probe passes the test trigger and the probe is also a tag
...
void MonElemFuncs::initTrigTagProbeHist(DQMStore::IBooker &iBooker,std::vector<MonElemContainer<OffPho>*>& phoMonElems,const std::string filterName,int cutMask,const BinData& bins)
{
    std::string trigName(filterName);
