...
namespace egHLT {
  ...
  class MonElemFuncs {
   ...
   public:  
    ...
    void initTrigTagProbeHists(std::vector<MonElemContainer<OffEle>*>& eleMonElems,std::vector<std::string> filterNames,int cutMask,const BinData& bins);
    void initTrigTagProbeHists(std::vector<MonElemContainer<OffPho>*>& phoMonElems,std::vector<std::string> filterNames,int cutMask,const BinData& bins);
    void initTrigTagProbeHist(std::vector<MonElemContainer<OffEle>*>& eleMonElems,std::string filterName,int cutMask,const BinData& bins);
    void initTrigTagProbeHist(std::vector<MonElemContainer<OffPho>*>& phoMonElems,std::string filterName,int cutMask,const BinData& bins);
    void initTrigTagProbeHist_2Leg(std::vector<MonElemContainer<OffEle>*>& eleMonElems,std::string filterName,int cutMask,const BinData& bins);
