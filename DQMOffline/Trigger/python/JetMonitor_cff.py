...
PFJet60_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJet60/')
...
PFJet80_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJet80/')
...
PFJet140_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJet140/')
PFJet140_Prommonitoring.ptcut = cms.double(140)
...
PFJet200_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJet200/')
PFJet200_Prommonitoring.ptcut = cms.double(200)
...
PFJet260_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJet260/')
PFJet260_Prommonitoring.ptcut = cms.double(260)
...
PFJet320_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJet320/')
PFJet320_Prommonitoring.ptcut = cms.double(320)
...
PFJet400_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJet400/')
PFJet400_Prommonitoring.ptcut = cms.double(400)
...
PFJet500_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJet500/')
PFJet500_Prommonitoring.ptcut = cms.double(500)
...
PFJetFwd450_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJetFwd450/')
PFJetFwd450_Prommonitoring.ptcut = cms.double(450)
...
PFJetFwd40_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJetFwd40/')
PFJetFwd40_Prommonitoring.histoPSet.jetPtThrPSet = cms.PSet(
  nbins = cms.int32 (  50 ),
  xmin  = cms.double(   0.),
  xmax  = cms.double( 100.),
)
PFJetFwd40_Prommonitoring.ptcut = cms.double(40)
...
PFJetFwd60_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJetFwd60/')
PFJetFwd60_Prommonitoring.ptcut = cms.double(60)
...
PFJetFwd80_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJetFwd80/')
PFJetFwd80_Prommonitoring.ptcut = cms.double(80)
...
PFJetFwd140_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJetFwd140/')
PFJetFwd140_Prommonitoring.ptcut = cms.double(140)
...
PFJetFwd200_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJetFwd200/')
PFJetFwd200_Prommonitoring.ptcut = cms.double(200)
...
PFJetFwd260_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJetFwd260/')
PFJetFwd260_Prommonitoring.ptcut = cms.double(260)
...
PFJetFwd320_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJetFwd320/')
PFJetFwd320_Prommonitoring.ptcut = cms.double(320)
...
PFJetFwd400_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJetFwd400/')
PFJetFwd400_Prommonitoring.ptcut = cms.double(400)
...
PFJetFwd500_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_PFJetFwd500/')
PFJetFwd500_Prommonitoring.ptcut = cms.double(500)
...
AK8PFJet40_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJet40/')
AK8PFJet40_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJet40_Prommonitoring.ptcut = cms.double(40)
...
AK8PFJet60_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJet60/')
AK8PFJet60_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJet60_Prommonitoring.ptcut = cms.double(60)
...
AK8PFJet80_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJet80/')
AK8PFJet80_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJet80_Prommonitoring.ptcut = cms.double(80)
...
AK8PFJet140_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJet140/')
AK8PFJet140_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJet140_Prommonitoring.ptcut = cms.double(140)
...
AK8PFJet200_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJet200/')
AK8PFJet200_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJet200_Prommonitoring.ptcut = cms.double(200)
...
AK8PFJet260_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJet260/')
AK8PFJet260_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJet260_Prommonitoring.ptcut = cms.double(260)
...
AK8PFJet320_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJet320/')
AK8PFJet320_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJet320_Prommonitoring.ptcut = cms.double(320)
...
AK8PFJet400_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJet400/')
AK8PFJet400_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJet400_Prommonitoring.ptcut = cms.double(400)
...
AK8PFJet450_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJet450/')
AK8PFJet450_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJet450_Prommonitoring.ptcut = cms.double(450)
...
AK8PFJetFwd40_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJetFwd40/')
AK8PFJetFwd40_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJetFwd40_Prommonitoring.ptcut = cms.double(40)
...
AK8PFJetFwd60_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJetFwd60/')
AK8PFJetFwd60_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJetFwd60_Prommonitoring.ptcut = cms.double(60)
...
AK8PFJetFwd80_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJetFwd80/')
AK8PFJetFwd80_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJetFwd80_Prommonitoring.ptcut = cms.double(80)
...
AK8PFJetFwd140_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJetFwd140/')
AK8PFJetFwd140_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJetFwd140_Prommonitoring.ptcut = cms.double(140)
...
AK8PFJetFwd200_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJetFwd200/')
AK8PFJetFwd200_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJetFwd200_Prommonitoring.ptcut = cms.double(200)
...
AK8PFJetFwd260_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJetFwd260/')
AK8PFJetFwd260_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJetFwd260_Prommonitoring.ptcut = cms.double(260)
...
AK8PFJetFwd320_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJetFwd320/')
AK8PFJetFwd320_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJetFwd320_Prommonitoring.ptcut = cms.double(320)
...
AK8PFJetFwd400_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJetFwd400/')
AK8PFJetFwd400_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJetFwd400_Prommonitoring.ptcut = cms.double(400)
...
AK8PFJetFwd450_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJetFwd450/')
AK8PFJetFwd450_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJetFwd450_Prommonitoring.ptcut = cms.double(450)
...
AK8PFJetFwd500_Prommonitoring.FolderName = cms.string('HLT/JetMET/HLT_AK8PFJetFwd500/')
AK8PFJetFwd500_Prommonitoring.pfjets = cms.InputTag("ak8PFJetsCHS")
AK8PFJetFwd500_Prommonitoring.ptcut = cms.double(500)
