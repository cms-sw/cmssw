...
susHLTEleCaloJetsClient = DQMEDHarvester("DQMGenericClient",
    subDirs        = cms.untracked.vstring(
        'HLT/SUS/Ele8CaloJet30/*',
        'HLT/SUS/Ele8CaloIdMJet30/*',
        'HLT/SUS/Ele12CaloJet30/*',
        'HLT/SUS/Ele17CaloIdMJet30/*',
        'HLT/SUS/Ele23CaloJet30/*',
        'HLT/SUS/Ele23CaloIdMJet30/*'
    ),
