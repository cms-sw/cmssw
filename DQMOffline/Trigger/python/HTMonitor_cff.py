...
PFHT350MinPFJet15_HTmonitoring.jetSelection_HT   = cms.string("pt > 15 && eta < 2.5")
...
PFHT500_PFMET100_PFMHT100_HTmonitoring.jetSelection_HT   = cms.string("pt > 10 && eta < 2.5")
...
PFHT500_PFMET110_PFMHT110_HTmonitoring.jetSelection_HT   = cms.string("pt > 10 && eta < 2.5")
...
PFHT700_PFMET85_PFMHT85_HTmonitoring.jetSelection_HT   = cms.string("pt > 10 && eta < 2.5")
...
PFHT700_PFMET95_PFMHT95_HTmonitoring.jetSelection_HT   = cms.string("pt > 10 && eta < 2.5")
...
PFHT800_PFMET75_PFMHT75_HTmonitoring.jetSelection_HT   = cms.string("pt > 10 && eta < 2.5")
...
PFHT800_PFMET85_PFMHT85_HTmonitoring.jetSelection_HT   = cms.string("pt > 10 && eta < 2.5")
...
PFHT1050_HTmonitoring.jetSelection_HT   = cms.string("pt > 10 && eta < 2.5")
