...
topEfficiency_elejets = DQMEDHarvester("DQMGenericClient",
    ...
    efficiency     = cms.vstring(
        ...
        "effic_elePt_1       'efficiency vs electron p_T; electron p_T [GeV]; efficiency' elePt_1_numerator       elePt_1_denominator",
        ...
        "effic_jetPt_1       'efficiency vs leading jet p_T; jet p_T [GeV]; efficiency' jetPt_1_numerator       jetPt_1_denominator",
        ...
        "effic_elePt_1_variableBinning       'efficiency vs electron p_T; electron p_T [GeV]; efficiency' elePt_1_variableBinning_numerator       elePt_1_variableBinning_denominator",
        ...
        "effic_jetPt_1_variableBinning       'efficiency vs leading jet p_T; jet p_T [GeV]; efficiency' jetPt_1_variableBinning_numerator       jetPt_1_variableBinning_denominator",
        ...
        "effic_elePtEta_1       'efficiency vs electron p_T-#eta; electron p_T [GeV]; electron #eta' elePtEta_1_numerator       elePtEta_1_denominator",
        "effic_eleEtaPhi_1       'efficiency vs electron #eta-#phi; electron #eta ; electron #phi' eleEtaPhi_1_numerator       eleEtaPhi_1_denominator",
        "effic_jetPtEta_1       'efficiency vs jet p_T-#eta; jet p_T [GeV]; jet #eta' jetPtEta_1_numerator       jetPtEta_1_denominator",
        "effic_jetEtaPhi_1       'efficiency vs jet #eta-#phi; jet #eta ; jet #phi' jetEtaPhi_1_numerator       jetEtaPhi_1_denominator",
        "effic_elePt_jetPt       'efficiency vs electron p_T - jet p_T; electron p_T [GeV] ; jet p_T [GeV]' elePt_jetPt_numerator       elePt_jetPt_denominator",
        "effic_elePt_eventHT       'efficiency vs electron p_T - event HT; electron p_T [GeV] ; event HT [GeV]' elePt_eventHT_numerator       elePt_eventHT_denominator",
...
topEfficiency_eleHT = DQMEDHarvester("DQMGenericClient",
    ...
    efficiency     = cms.vstring(
        ...
        "effic_jetEta_1       'efficiency vs leading jet #eta; jet #eta ; efficiency' jetEta_1_numerator       jetEta_1_denominator",
        "effic_jetPhi_1       'efficiency vs leading jet #phi; jet #phi ; efficiency' jetPhi_1_numerator       jetPhi_1_denominator",
        "effic_jetPt_2       'efficiency vs sub-leading jet p_T; jet p_T [GeV]; efficiency' jetPt_2_numerator       jetPt_2_denominator",
        ...
        "effic_jetPt_1_variableBinning       'efficiency vs leading jet p_T; jet p_T [GeV]; efficiency' jetPt_1_variableBinning_numerator       jetPt_1_variableBinning_denominator",
        "effic_jetEta_1_variableBinning       'efficiency vs leading jet #eta; jet #eta ; efficiency' jetEta_1_variableBinning_numerator       jetEta_1_variableBinning_denominator",
        "effic_jetPt_2_variableBinning       'efficiency vs sub-leading jet p_T; jet p_T [GeV]; efficiency' jetPt_2_variableBinning_numerator       jetPt_2_variableBinning_denominator",
        ...
        "effic_jetPtEta_1       'efficiency vs jet p_T-#eta; jet p_T [GeV]; jet #eta' jetPtEta_1_numerator       jetPtEta_1_denominator",
        "effic_jetEtaPhi_1       'efficiency vs jet #eta-#phi; jet #eta ; jet #phi' jetEtaPhi_1_numerator       jetEtaPhi_1_denominator",
        "effic_jetPtEta_2       'efficiency vs jet p_T-#eta; jet p_T [GeV]; jet #eta' jetPtEta_2_numerator       jetPtEta_2_denominator",
...
topEfficiency_singleMu = DQMEDHarvester("DQMGenericClient",
    ...
    efficiency     = cms.vstring(
        ...
        "effic_muPt_1       'efficiency vs muon p_T; muon p_T [GeV]; efficiency' muPt_1_numerator       muPt_1_denominator",
        ...
        "effic_muPtEta_1     'efficiency vs muon p_T; muon #eta ; efficiency' muPtEta_1_numerator       muPtEta_1_denominator",
        "effic_jetPt_1       'efficiency vs leading jet p_T; jet p_T [GeV]; efficiency' jetPt_1_numerator       jetPt_1_denominator",
        "effic_jetEta_1       'efficiency vs leading jet #eta; jet #eta ; efficiency' jetEta_1_numerator       jetEta_1_denominator",
        "effic_jetPhi_1       'efficiency vs leading jet #phi; jet #phi ; efficiency' jetPhi_1_numerator       jetPhi_1_denominator",
        "effic_jetPt_2       'efficiency vs sub-leading jet p_T; jet p_T [GeV]; efficiency' jetPt_2_numerator       jetPt_2_denominator",
        ...
        "effic_jetPhi_2       'efficiency vs sub-leading jet #phi; jet #phi ; efficiency' jetPhi_2_numerator       jetPhi_2_denominator",
        "effic_eventHT       'efficiency vs event HT; event HT [GeV]; efficiency' eventHT_numerator       eventHT_denominator",
        "effic_jetPtEta_1       'efficiency vs jet p_T-#eta; jet #eta; jet p_T' jetPtEta_1_numerator       jetPtEta_1_denominator",
        "effic_jetEtaPhi_1       'efficiency vs jet #eta-#phi; jet #eta; jet #phi' jetEtaPhi_1_numerator       jetEtaPhi_1_denominator",
...
topEfficiency_diElec = DQMEDHarvester("DQMGenericClient",
    ...
    efficiency     = cms.vstring(
        ...
        "effic_eleEta_1       'efficiency vs electron #eta; electron #eta ; efficiency' eleEta_1_numerator       eleEta_1_denominator",
        "effic_elePhi_1       'efficiency vs electron #phi; electron #phi ; efficiency' elePhi_1_numerator       elePhi_1_denominator",
        "effic_elePt_2       'efficiency vs electron p_T; electron p_T [GeV]; efficiency' elePt_2_numerator       elePt_2_denominator",
        ...
        "effic_elePtEta_1       'efficiency vs electron p_T #eta; electron p_T #eta ; efficiency' elePtEta_1_numerator       elePtEta_1_denominator",
        ...
        "effic_elePtEta_2       'efficiency vs electron p_T #eta; electron p_T #eta ; efficiency' elePtEta_2_numerator       elePtEta_2_denominator",
        "effic_jetPt_1       'efficiency vs leading jet p_T; jet p_T [GeV]; efficiency' jetPt_1_numerator       jetPt_1_denominator",
        "effic_jetEta_1       'efficiency vs leading jet #eta; jet #eta ; efficiency' jetEta_1_numerator       jetEta_1_denominator",
        "effic_jetPhi_1       'efficiency vs leading jet #phi; jet #phi ; efficiency' jetPhi_1_numerator       jetPhi_1_denominator",
        "effic_jetPt_2       'efficiency vs sub-leading jet p_T; jet p_T [GeV]; efficiency' jetPt_2_numerator       jetPt_2_denominator",
        ...
        "effic_jetEtaPhi_2       'efficiency vs jet #eta-#phi; jet #eta; jet #phi' jetEtaPhi_2_numerator       jetEtaPhi_2_denominator",
        "effic_jetEtaPhi_HEP17       'efficiency vs jet #eta-#phi; jet #eta ; jet #phi' jetEtaPhi_HEP17_numerator       jetEtaPhi_HEP17_denominator",
        "effic_ele1Pt_ele2Pt    'efficiency vs ele1-ele2 p_T; ele1 p_T; ele2 p_T' ele1Pt_ele2Pt_numerator       ele1Pt_ele2Pt_denominator",
...
topEfficiency_diMu = DQMEDHarvester("DQMGenericClient",
    ...
    efficiency     = cms.vstring(
        ...
        "effic_muEta_1       'efficiency vs muon #eta; muon #eta ; efficiency' muEta_1_numerator       muEta_1_denominator",
        "effic_muPhi_1       'efficiency vs muon #phi; muon #phi ; efficiency' muPhi_1_numerator       muPhi_1_denominator",
        "effic_muPt_2       'efficiency vs muon p_T; muon p_T [GeV]; efficiency' muPt_2_numerator       muPt_2_denominator",
        ...
        "effic_muPtEta_1       'efficiency vs muon p_T #eta; muon p_T #eta ; efficiency' muPtEta_1_numerator       muPtEta_1_denominator",
        "effic_muEtaPhi_2       'efficiency vs muon #eta #phi; muon #eta #phi ; efficiency' muEtaPhi_2_numerator       muEtaPhi_2_denominator",
        "effic_muPtEta_2       'efficiency vs muon p_T #eta; muon p_T #eta ; efficiency' muPtEta_2_numerator       muPtEta_2_denominator",
        "effic_jetPt_1       'efficiency vs leading jet p_T; jet p_T [GeV]; efficiency' jetPt_1_numerator       jetPt_1_denominator",
        "effic_jetEta_1       'efficiency vs leading jet #eta; jet #eta ; efficiency' jetEta_1_numerator       jetEta_1_denominator",
        "effic_jetPhi_1       'efficiency vs leading jet #phi; jet #phi ; efficiency' jetPhi_1_numerator       jetPhi_1_denominator",
        "effic_jetPt_2       'efficiency vs sub-leading jet p_T; jet p_T [GeV]; efficiency' jetPt_2_numerator       jetPt_2_denominator",
        ...
        "effic_jetEtaPhi_2       'efficiency vs jet #eta-#phi; jet #eta; jet #phi' jetEtaPhi_2_numerator       jetEtaPhi_2_denominator",
        "effic_jetEtaPhi_HEP17       'efficiency vs jet #eta-#phi; jet #eta ; jet #phi' jetEtaPhi_HEP17_numerator       jetEtaPhi_HEP17_denominator",
        "effic_mu1Pt_mu2Pt    'efficiency vs mu1-mu2 p_T; mu1 p_T; mu2 p_T' mu1Pt_mu2Pt_numerator       mu1Pt_mu2Pt_denominator",
...
topEfficiency_ElecMu = DQMEDHarvester("DQMGenericClient",
    ...
    efficiency     = cms.vstring(
        "effic_met       'efficiency vs MET; MET [GeV]; efficiency' met_numerator       met_denominator",
        "effic_metPhi       'efficiency vs MET #phi; MET #phi; efficiency' metPhi_numerator       metPhi_denominator",
        "effic_muPt_1       'efficiency vs mu p_T; mu p_T [GeV]; efficiency' muPt_1_numerator       muPt_1_denominator",
        ...
        "effic_jetEtaPhi_2       'efficiency vs jet #eta-#phi; jet #eta; jet #phi' jetEtaPhi_2_numerator       jetEtaPhi_2_denominator",
        "effic_jetEtaPhi_HEP17       'efficiency vs jet #eta-#phi; jet #eta ; jet #phi' jetEtaPhi_HEP17_numerator       jetEtaPhi_HEP17_denominator",
        "effic_elePt_muPt    'efficiency vs ele-mu p_T; ele p_T; mu p_T' elePt_muPt_numerator       elePt_muPt_denominator",
...
fullyhadronicEfficiency_DoubleBTag = DQMEDHarvester("DQMGenericClient",
    ...
    resolution     = cms.vstring(),
    efficiency     = cms.vstring(
        "effic_jetPt_1       'efficiency vs 1st jet p_T; jet p_T [GeV]; efficiency' jetPt_1_numerator       jetPt_1_denominator",
        "effic_jetPt_2       'efficiency vs 2nd jet p_T; jet p_T [GeV]; efficiency' jetPt_2_numerator       jetPt_2_denominator",
        "effic_jetPt_3       'efficiency vs 3rd jet p_T; jet p_T [GeV]; efficiency' jetPt_3_numerator       jetPt_3_denominator",
        "effic_jetPt_4       'efficiency vs 4th jet p_T; jet p_T [GeV]; efficiency' jetPt_4_numerator       jetPt_4_denominator",
        "effic_jetPt_5       'efficiency vs 5th jet p_T; jet p_T [GeV]; efficiency' jetPt_5_numerator       jetPt_5_denominator",
        "effic_jetPt_6       'efficiency vs 6th jet p_T; jet p_T [GeV]; efficiency' jetPt_6_numerator       jetPt_6_denominator",
        #
        ...
        #
        "effic_bjetPt_1      'efficiency vs 1st b-jet p_T; bjet p_T [GeV]; efficiency' bjetPt_1_numerator  bjetPt_1_denominator",
        "effic_bjetPt_2      'efficiency vs 2nd b-jet p_T; bjet p_T [GeV]; efficiency' bjetPt_2_numerator  bjetPt_2_denominator",
        ...
        "effic_jetEtaPhi_HEP17       'efficiency vs jet #eta-#phi; jet #eta; jet #phi' jetEtaPhi_HEP17_numerator       jetEtaPhi_HEP17_denominator",
        #
        "effic_jetPt_1_variableBinning       'efficiency vs 1st jet p_T; jet p_T [GeV]; efficiency' jetPt_1_variableBinning_numerator       jetPt_1_variableBinning_denominator",
        "effic_jetPt_2_variableBinning       'efficiency vs 2nd jet p_T; jet p_T [GeV]; efficiency' jetPt_2_variableBinning_numerator       jetPt_2_variableBinning_denominator",
        "effic_jetPt_3_variableBinning       'efficiency vs 3rd jet p_T; jet p_T [GeV]; efficiency' jetPt_3_variableBinning_numerator       jetPt_3_variableBinning_denominator",
        "effic_jetPt_4_variableBinning       'efficiency vs 4th jet p_T; jet p_T [GeV]; efficiency' jetPt_4_variableBinning_numerator       jetPt_4_variableBinning_denominator",
        "effic_jetPt_5_variableBinning       'efficiency vs 5th jet p_T; jet p_T [GeV]; efficiency' jetPt_5_variableBinning_numerator       jetPt_5_variableBinning_denominator",
        "effic_jetPt_6_variableBinning       'efficiency vs 6th jet p_T; jet p_T [GeV]; efficiency' jetPt_6_variableBinning_numerator       jetPt_6_variableBinning_denominator",
        #
        ...
        #
        "effic_bjetPt_1_variableBinning   'efficiency vs 1st b-jet p_T; bjet p_T [GeV]; efficiency' bjetPt_1_variableBinning_numerator   bjetPt_1_variableBinning_denominator",
        "effic_bjetPt_2_variableBinning   'efficiency vs 2nd b-jet p_T; bjet p_T [GeV]; efficiency' bjetPt_2_variableBinning_numerator   bjetPt_2_variableBinning_denominator",
        ...
        "effic_bjetMulti      'efficiency vs b-jet multiplicity; bjet multiplicity; efficiency' bjetMulti_numerator   bjetMulti_denominator",
        #
        "effic_jetPtEta_1     'efficiency vs 1st jet p_T-#eta; jet p_T [GeV]; jet #eta' jetPtEta_1_numerator       jetPtEta_1_denominator",
        "effic_jetPtEta_2     'efficiency vs 2nd jet p_T-#eta; jet p_T [GeV]; jet #eta' jetPtEta_2_numerator       jetPtEta_2_denominator",
        "effic_jetPtEta_3     'efficiency vs 3rd jet p_T-#eta; jet p_T [GeV]; jet #eta' jetPtEta_3_numerator       jetPtEta_3_denominator",
        "effic_jetPtEta_4     'efficiency vs 4th jet p_T-#eta; jet p_T [GeV]; jet #eta' jetPtEta_4_numerator       jetPtEta_4_denominator",
        "effic_jetPtEta_5     'efficiency vs 5th jet p_T-#eta; jet p_T [GeV]; jet #eta' jetPtEta_5_numerator       jetPtEta_5_denominator",
        "effic_jetPtEta_6     'efficiency vs 6th jet p_T-#eta; jet p_T [GeV]; jet #eta' jetPtEta_6_numerator       jetPtEta_6_denominator",
        #
        ...
        #
        "effic_bjetPtEta_1    'efficiency vs 1st b-jet p_T-#eta; jet p_T [GeV]; bjet #eta' bjetPtEta_1_numerator   bjetPtEta_1_denominator",
        "effic_bjetPtEta_2    'efficiency vs 2nd b-jet p_T-#eta; jet p_T [GeV]; bjet #eta' bjetPtEta_2_numerator   bjetPtEta_2_denominator",
        #
...
fullyhadronicEfficiency_TripleBTag = DQMEDHarvester("DQMGenericClient",
    ...
    efficiency     = cms.vstring(
        ...
        "effic_bjetPt_1      'efficiency vs 1st b-jet p_T; bjet p_T [GeV]; efficiency' bjetPt_1_numerator  bjetPt_1_denominator",
        "effic_bjetPt_2      'efficiency vs 2nd b-jet p_T; bjet p_T [GeV]; efficiency' bjetPt_2_numerator  bjetPt_2_denominator",
        "effic_bjetPt_3      'efficiency vs 3rd b-jet p_T; bjet p_T [GeV]; efficiency' bjetPt_3_numerator  bjetPt_3_denominator",
        "effic_bjetPt_4      'efficiency vs 4th b-jet p_T; bjet p_T [GeV]; efficiency' bjetPt_4_numerator  bjetPt_4_denominator",
        ...
        "effic_bjetPtEta_1    'efficiency vs 1st b-jet p_T-#eta; jet p_T [GeV]; bjet #eta' bjetPtEta_1_numerator   bjetPtEta_1_denominator",
        "effic_bjetPtEta_2    'efficiency vs 2nd b-jet p_T-#eta; jet p_T [GeV]; bjet #eta' bjetPtEta_2_numerator   bjetPtEta_2_denominator",
        "effic_bjetPtEta_3    'efficiency vs 3rd b-jet p_T-#eta; jet p_T [GeV]; bjet #eta' bjetPtEta_3_numerator   bjetPtEta_3_denominator",
        "effic_bjetPtEta_4    'efficiency vs 4th b-jet p_T-#eta; jet p_T [GeV]; bjet #eta' bjetPtEta_4_numerator   bjetPtEta_4_denominator",
