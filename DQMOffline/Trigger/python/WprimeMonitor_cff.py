...
WprimeEle115.FolderName = cms.string('HLT/Wprime/WprimeEle115')
WprimeEle115.nmuons = cms.uint32(0)
WprimeEle115.nelectrons = cms.uint32(1)
WprimeEle115.njets = cms.uint32(0)
WprimeEle115.eleSelection = cms.string('pt>50 & abs(eta)<2.1 & (dr03TkSumPt+dr04EcalRecHitSumEt+dr04HcalTowerSumEt)/pt<0.1')
...
WprimeEle135.FolderName = cms.string('HLT/Wprime/WprimeEle135')
WprimeEle135.nmuons = cms.uint32(0)
WprimeEle135.nelectrons = cms.uint32(1)
WprimeEle135.njets = cms.uint32(0)
WprimeEle135.eleSelection = cms.string('pt>50 & abs(eta)<2.1 & (dr03TkSumPt+dr04EcalRecHitSumEt+dr04HcalTowerSumEt)/pt<0.1')
...
WprimeEle145.FolderName = cms.string('HLT/Wprime/WprimeEle145')
WprimeEle145.nmuons = cms.uint32(0)
WprimeEle145.nelectrons = cms.uint32(1)
WprimeEle145.njets = cms.uint32(0)
WprimeEle145.eleSelection = cms.string('pt>50 & abs(eta)<2.1 & (dr03TkSumPt+dr04EcalRecHitSumEt+dr04HcalTowerSumEt)/pt<0.1')
...
WprimeEle200.FolderName = cms.string('HLT/Wprime/WprimeEle200')
WprimeEle200.nmuons = cms.uint32(0)
WprimeEle200.nelectrons = cms.uint32(1)
WprimeEle200.njets = cms.uint32(0)
WprimeEle200.eleSelection = cms.string('pt>50 & abs(eta)<2.1 & (dr03TkSumPt+dr04EcalRecHitSumEt+dr04HcalTowerSumEt)/pt<0.1')
...
WprimeEle250.FolderName = cms.string('HLT/Wprime/WprimeEle250')
WprimeEle250.nmuons = cms.uint32(0)
WprimeEle250.nelectrons = cms.uint32(1)
WprimeEle250.njets = cms.uint32(0)
WprimeEle250.eleSelection = cms.string('pt>50 & abs(eta)<2.1 & (dr03TkSumPt+dr04EcalRecHitSumEt+dr04HcalTowerSumEt)/pt<0.1')
...
WprimeEle300.FolderName = cms.string('HLT/Wprime/WprimeEle300')
WprimeEle300.nmuons = cms.uint32(0)
WprimeEle300.nelectrons = cms.uint32(1)
WprimeEle300.njets = cms.uint32(0)
WprimeEle300.eleSelection = cms.string('pt>50 & abs(eta)<2.1 & (dr03TkSumPt+dr04EcalRecHitSumEt+dr04HcalTowerSumEt)/pt<0.1')
