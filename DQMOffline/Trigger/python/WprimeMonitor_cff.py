...
WprimeEle115.eleSelection = cms.string('pt>50 & abs(eta)<1.4442 & full5x5_sigmaIetaIeta<0.00998 & abs(deltaEtaSuperClusterTrackAtVtx)<0.00308 & abs(deltaPhiSuperClusterTrackAtVtx)< 0.0816 & hadronicOverEm<0.0414 & abs(1.0/ecalEnergy - eSuperClusterOverP/ecalEnergy)<0.0129 & passConversionVeto==1 & (dr03TkSumPt+dr04EcalRecHitSumEt+dr04HcalTowerSumEt)/pt<0.1')
WprimeEle115.eleSelection1 = cms.string('pt>50 & abs(eta)>1.566 & abs(eta)<2.5 & full5x5_sigmaIetaIeta<0.0292 & abs(deltaEtaSuperClusterTrackAtVtx)<0.00605 & abs(deltaPhiSuperClusterTrackAtVtx)< 0.0394 & hadronicOverEm<0.0641 & abs(1.0/ecalEnergy - eSuperClusterOverP/ecalEnergy)<0.0129 & passConversionVeto==1 & (dr03TkSumPt+dr04EcalRecHitSumEt+dr04HcalTowerSumEt)/pt<0.1')
