...
topHLTDiMuonDQM = cms.EDAnalyzer("TopHLTDiMuonDQM",
    ...
    ### 
    hltPaths_sig   = cms.vstring('HLT_Mu5', 'HLT_Mu9', 'HLT_IsoMu9', 'HLT_Mu15', 'HLT_DoubleMu0', 'HLT_DoubleMu3'),
    hltPaths_trig  = cms.vstring('HLT_Mu5', 'HLT_Mu5', 'HLT_Mu5',    'HLT_Mu5',  'HLT_Mu5',       'HLT_Mu5'),
    ### 
    vertexCollection = cms.InputTag('offlinePrimaryVertices'),
    vertex_X_cut     = cms.double(  0.2 ),
    vertex_Y_cut     = cms.double(  0.2 ),
