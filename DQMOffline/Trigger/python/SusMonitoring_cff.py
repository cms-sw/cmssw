...
from DQMOffline.Trigger.VBFSUSMonitor_cff import *
from DQMOffline.Trigger.LepHTMonitor_cff import *
from DQMOffline.Trigger.susHLTEleCaloJets_cff import *
from DQMOffline.Trigger.SoftMuHardJetMETSUSMonitor_cff import *
from DQMOffline.Trigger.TopMonitor_cfi import hltTOPmonitoring

# muon
double_soft_muon_muonpt = hltTOPmonitoring.clone(
    FolderName   = 'HLT/SUS/SOS/Muon/',
    # Selections
    nmuons           = 2,
...
double_soft_muon_backup_70_metpt = hltTOPmonitoring.clone(
    FolderName   = 'HLT/SUS/SOS/backup70/MET/',
    # Selections
    nmuons           = 2,
    HTdefinition     = 'pt>30 & abs(eta)<2.4',
    HTcut            = 60,
...
double_soft_muon_backup_70_mhtpt = hltTOPmonitoring.clone(
    FolderName   = 'HLT/SUS/SOS/backup70/MHT/',
    # Selections
    nmuons           = 2,
    HTdefinition     = 'pt>30 & abs(eta)<2.4',
    HTcut            = 60,
...
double_soft_muon_backup_90_metpt = hltTOPmonitoring.clone(
    FolderName   = 'HLT/SUS/SOS/backup90/MET/',
    # Selections
    nmuons           = 2,
    HTdefinition     = 'pt>30 & abs(eta)<2.4',
    HTcut            = 60,
...
double_soft_muon_backup_90_mhtpt = hltTOPmonitoring.clone(
    FolderName   = 'HLT/SUS/SOS/backup90/MHT/',
    # Selections
    nmuons           = 2,
    HTdefinition     = 'pt>30 & abs(eta)<2.4',
    HTcut            = 60,
...
triple_muon_mupt = hltTOPmonitoring.clone(
    FolderName   = 'HLT/SUS/SOS/TripleMu/Muon',
    # Selections
    nmuons           = 3,
...
triple_muon_dca_mupt = hltTOPmonitoring.clone(
    FolderName   = 'HLT/SUS/SOS/TripleMu/DCA/Muon',
    # Selections
    nmuons           = 3,
    muoSelection     = 'isGlobalMuon()',
    invMassUppercut       = 50,
...
# MuonEG
susMuEGMonitoring = hltTOPmonitoring.clone(
    FolderName = 'HLT/SUS/MuonEG/',
    nmuons = 1,
    nphotons = 1,
    nelectrons = 0,
    njets = 0,
...
susMuEGMonitoring.numGenericTriggerEventPSet.hltPaths = cms.vstring('HLT_Mu17_Photon30_IsoCaloId*')
susMuEGMonitoring.denGenericTriggerEventPSet.hltPaths = cms.vstring('')

# muon dca
double_soft_muon_dca_muonpt = hltTOPmonitoring.clone(
    FolderName   = 'HLT/SUS/SOS/DCA/Muon/',
    # Selections
    nmuons           = 2,
    HTdefinition     = 'pt>30 & abs(eta)<2.4',
    HTcut            = 60,
...
double_soft_muon_dca_metpt = hltTOPmonitoring.clone(
    FolderName   = 'HLT/SUS/SOS/DCA/MET/',
    # Selections
    nmuons           = 2,
    HTdefinition     = 'pt>30 & abs(eta)<2.4',
    HTcut            = 60,
...
susMonitorHLT = cms.Sequence(
    susHLTRazorMonitoring
  + susHLTVBFMonitoring
  + LepHTMonitor
  + susHLTEleCaloJets
  ...
  + susHLTSoftMuHardJetMETMonitoring
)
