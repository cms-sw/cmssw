...
PFHT1050_Mjjmonitoring.FolderName = cms.string('HLT/B2GMonitor/PFHT1050')
...
PFHT1050_Softdropmonitoring.FolderName = cms.string('HLT/B2GMonitor/PFHT1050')
...
AK8PFJet500_Mjjmonitoring.FolderName = cms.string('HLT/B2GMonitor/AK8PFJet500')
...
AK8PFJet500_Softdropmonitoring.FolderName = cms.string('HLT/B2GMonitor/AK8PFJet500')
...
AK8PFHT750_TrimMass50_Mjjmonitoring.FolderName = cms.string('HLT/B2GMonitor/AK8PFHT750_TrimMass50')
...
AK8PFHT750_TrimMass50_Softdropmonitoring.FolderName = cms.string('HLT/B2GMonitor/AK8PFHT750_TrimMass50')
...
AK8PFHT800_TrimMass50_Mjjmonitoring.FolderName = cms.string('HLT/B2GMonitor/AK8PFHT800_TrimMass50')
...
AK8PFHT800_TrimMass50_Softdropmonitoring.FolderName = cms.string('HLT/B2GMonitor/AK8PFHT800_TrimMass50')
...
AK8PFHT850_TrimMass50_Mjjmonitoring.FolderName = cms.string('HLT/B2GMonitor/AK8PFHT850_TrimMass50')
...
AK8PFHT850_TrimMass50_Softdropmonitoring.FolderName = cms.string('HLT/B2GMonitor/AK8PFHT850_TrimMass50')
...
AK8PFHT900_TrimMass50_Mjjmonitoring.FolderName = cms.string('HLT/B2GMonitor/AK8PFHT900_TrimMass50')
...
AK8PFHT900_TrimMass50_Softdropmonitoring.FolderName = cms.string('HLT/B2GMonitor/AK8PFHT900_TrimMass50')
