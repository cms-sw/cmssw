...
# HLT_Rsq0p25_v* tight
Rsq0p25_Tight_RazorMonitoring = hltRazorMonitoring.clone()
Rsq0p25_Tight_RazorMonitoring.FolderName = cms.string('HLT/SUSY/Rsq0p25_Tight/')
Rsq0p25_Tight_RazorMonitoring.numGenericTriggerEventPSet.hltPaths = cms.vstring("HLT_Rsq0p25_v*")
Rsq0p25_Tight_RazorMonitoring.jetSelection = cms.string("pt>120")
...
# HLT_Rsq0p30_v* tight
Rsq0p30_Tight_RazorMonitoring = hltRazorMonitoring.clone()
Rsq0p30_Tight_RazorMonitoring.FolderName = cms.string('HLT/SUSY/Rsq0p30_Tight/')
Rsq0p30_Tight_RazorMonitoring.numGenericTriggerEventPSet.hltPaths = cms.vstring("HLT_Rsq0p30_v*")
Rsq0p30_Tight_RazorMonitoring.jetSelection = cms.string("pt>120")
...
# HLT_RsqMR270_Rsq0p09_MR200_v* tight
RsqMR270_Rsq0p09_MR200_Tight_RazorMonitoring = hltRazorMonitoring.clone()
RsqMR270_Rsq0p09_MR200_Tight_RazorMonitoring.FolderName = cms.string('HLT/SUSY/RsqMR270_Rsq0p09_MR200_Tight/')
RsqMR270_Rsq0p09_MR200_Tight_RazorMonitoring.numGenericTriggerEventPSet.hltPaths = cms.vstring("HLT_RsqMR270_Rsq0p09_MR200_v*")
RsqMR270_Rsq0p09_MR200_Tight_RazorMonitoring.jetSelection = cms.string("pt>120")
...
# HLT_RsqMR270_Rsq0p09_MR200_4jet_v* tight
RsqMR270_Rsq0p09_MR200_4jet_Tight_RazorMonitoring = hltRazorMonitoring.clone()
RsqMR270_Rsq0p09_MR200_4jet_Tight_RazorMonitoring.FolderName = cms.string('HLT/SUSY/RsqMR270_Rsq0p09_MR200_4jet_Tight/')
RsqMR270_Rsq0p09_MR200_4jet_Tight_RazorMonitoring.numGenericTriggerEventPSet.hltPaths = cms.vstring("HLT_RsqMR270_Rsq0p09_MR200_4jet_v*")
RsqMR270_Rsq0p09_MR200_4jet_Tight_RazorMonitoring.jetSelection = cms.string("pt>120")
...
susyHLTRazorMonitoring = cms.Sequence(
        ...
        Rsq0p25_Tight_RazorMonitoring+
        Rsq0p30_RazorMonitoring+
        Rsq0p30_Tight_RazorMonitoring+
        RsqMR270_Rsq0p09_MR200_RazorMonitoring+
        RsqMR270_Rsq0p09_MR200_Tight_RazorMonitoring+
        ...
        RsqMR270_Rsq0p09_MR200_4jet_Tight_RazorMonitoring+
