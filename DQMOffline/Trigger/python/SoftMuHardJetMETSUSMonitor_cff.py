...
SoftMuHardJetMETSUSmonitoring = hltSUSmonitoring.clone(
    FolderName = 'HLT/SUS/SoftMuHardJetMET/',
    met   = "pfMet",
    jets  = "ak4PFJetsCHS",
    muons = "muons",
...
### Muon pt ###
###############
SoftMuHardJetMETSUSmonitoring_muPt            = SoftMuHardJetMETSUSmonitoring.clone(
    FolderName = 'HLT/SUS/SoftMuHardJetMET/Muon',
    # Muon selection
    nmuons       = 1,
...
### Jet pt ###
##############
SoftMuHardJetMETSUSmonitoring_jetPt = SoftMuHardJetMETSUSmonitoring.clone(
    FolderName = 'HLT/SUS/SoftMuHardJetMET/Jet',
    # Muon selection
    nmuons       = 1,
...
### MET pt ###
##############
SoftMuHardJetMETSUSmonitoring_metPt = SoftMuHardJetMETSUSmonitoring.clone(
    FolderName = 'HLT/SUS/SoftMuHardJetMET/MET',
    # Muon selection
    nmuons       = 1,
    muoSelection = 'pt>30 & abs(eta)<1.5',
    # Jet selection
...
susHLTSoftMuHardJetMETMonitoring = cms.Sequence(
    SoftMuHardJetMETSUSmonitoring_muPt
  + SoftMuHardJetMETSUSmonitoring_jetPt
  + SoftMuHardJetMETSUSmonitoring_metPt
)
