# Soureek Changed HLT_Ele23_WPLoose_Gsf_CentralPFJet30_BTagCVS07_v to HLT_Ele23_WPLoose_Gsf_CentralPFJet30_BTagCSV07_v
...
topSingleMuonHLTOfflineDQM = cms.EDAnalyzer("TopSingleLeptonHLTOfflineDQM",
  ...
  setup = cms.PSet(
    ...
    triggerExtras = cms.PSet(
#      src   = cms.InputTag("TriggerResults","","HLT"),
	  src = cms.InputTag("TriggerResults","","reHLT"),		
