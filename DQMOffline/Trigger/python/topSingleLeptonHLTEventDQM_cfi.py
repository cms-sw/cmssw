...
topSingleMuonHLTOfflineDQM = cms.EDAnalyzer("TopSingleLeptonHLTOfflineDQM",
  ...
  setup = cms.PSet(
    ...
    triggerExtras = cms.PSet(
      src   = cms.InputTag("TriggerResults","","HLT"),
      paths = cms.vstring(['HLT_IsoMu22_eta2p1_IterTrk02_v', 'HLT_IsoMu22_eta2p1_IterTrk02_TriCentralPFJet60_50_35_v', 'HLT_IsoMu22_eta2p1_IterTrk02_TriCentralPFJet40_v', 'HLT_IsoMu22_eta2p1_IterTrk02_CentralPFJet30_BTagCSV_v'])
    )
  ),
  ## ------------------------------------------------------
  ## PRESELECTION
  ...
  preselection = cms.PSet(
   trigger = cms.PSet(
      src    = cms.InputTag("TriggerResults","","HLT"),
      select = cms.vstring(['HLT_IsoMu22_eta2p1_IterTrk02_v', 'HLT_IsoMu22_eta2p1_IterTrk02_TriCentralPFJet60_50_35_v', 'HLT_IsoMu22_eta2p1_IterTrk02_TriCentralPFJet40_v', 'HLT_IsoMu22_eta2p1_IterTrk02_CentralPFJet30_BTagCSV_v'])
    ),
    ## [optional] : when omitted no preselection is applied
    vertex = cms.PSet(
      src    = cms.InputTag("offlinePrimaryVertices"),
