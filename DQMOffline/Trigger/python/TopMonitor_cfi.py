...
# hltTOPmonitoring.numGenericTriggerEventPSet.hltPaths      = cms.vstring("HLT_PFTOPNoMu120_PFMHTNoMu120_IDTight_v*") # HLT_ZeroBias_v*
#hltTOPmonitoring.numGenericTriggerEventPSet.hltDBKey      = cms.string("EXO_HLT_TOP")
