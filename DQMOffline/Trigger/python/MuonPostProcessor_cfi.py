...
HLTMuonPostVal = cms.EDAnalyzer("DQMGenericClient",
	...
	#									   'HLT/Muon/Distributions/HLT_L1Mu/*'),
								...
								subDirs = cms.untracked.vstring( "HLT/Muon/Distributions/HLT_L1Mu/*",
																 "HLT/Muon/Distributions/HLT_L1MuOpen/*",
																 "HLT/Muon/Distributions/HLT_L2Mu9/*",
																 "HLT/Muon/Distributions/HLT_IsoMu9/*",
																 "HLT/Muon/Distributions/HLT_IsoMu11/*",
																 "HLT/Muon/Distributions/HLT_IsoMu13/*",
																 "HLT/Muon/Distributions/HLT_IsoMu15/*",
																 "HLT/Muon/Distributions/HLT_Mu3/*",
																 "HLT/Muon/Distributions/HLT_Mu5/*",
																 "HLT/Muon/Distributions/HLT_Mu7/*",
																 "HLT/Muon/Distributions/HLT_Mu9/*",
																 "HLT/Muon/Distributions/HLT_Mu11/*",
																 "HLT/Muon/Distributions/HLT_Mu13/*",
																 "HLT/Muon/Distributions/HLT_Mu15/*",																 																 
																 
																 "HLT/Muon/Distributions/HLT_DoubleIsoMu3/*",
																 "HLT/Muon/Distributions/HLT_DoubleMu3/*",																 																 
																 "HLT/Muon/Distributions/HLT_DoubleMu3_JPsi/*",
																 "HLT/Muon/Distributions/HLT_DoubleMu3_Upsilon/*",
																 "HLT/Muon/Distributions/HLT_DoubleMu7_Z/*",
																 "HLT/Muon/Distributions/HLT_DoubleMu3_SameSign/*",
																 "HLT/Muon/Distributions/HLT_DoubleMu3_Psi2S/*"),
