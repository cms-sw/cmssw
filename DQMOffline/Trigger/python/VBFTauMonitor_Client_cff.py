...
vbftauEfficiency = DQMEDHarvester("DQMGenericClient",
  ...
  efficiency     = cms.vstring(
    ...
    "effic_mindphijmet          'min#Delta#phi(j,MET) turnON; min#Delta#phi(jet,MET); efficiency'     mindphijmet_numerator      dphijmet_denominator",
  ...
  efficiencyProfile = cms.untracked.vstring(
    ...
    "effic_mindphijmetVsLS 'min#Delta#phi(jet,MET) efficiency vs LS; LS;  min#Delta#phi(jet,MET) efficiency' mindphijmetVsLS_numeratordphijmetVsLS_denominator",
