...
SoftMuHardJetMETEfficiency_muPt = DQMEDHarvester("DQMGenericClient",
    subDirs        = cms.untracked.vstring("HLT/SUS/SoftMuHardJetMET/Muon"),
...
SoftMuHardJetMETEfficiency_jetPt = DQMEDHarvester("DQMGenericClient",
    subDirs        = cms.untracked.vstring("HLT/SUS/SoftMuHardJetMET/Jet"),
    verbose        = cms.untracked.uint32(0),
    resolution     = cms.vstring(),
    efficiency     = cms.vstring(
...
SoftMuHardJetMETEfficiency_metPt = DQMEDHarvester("DQMGenericClient",
    subDirs        = cms.untracked.vstring("HLT/SUS/SoftMuHardJetMET/MET"),
    verbose        = cms.untracked.uint32(0),
    resolution     = cms.vstring(),
    efficiency     = cms.vstring(
...
susHLTSoftMuHardJetMETClient = cms.Sequence(
