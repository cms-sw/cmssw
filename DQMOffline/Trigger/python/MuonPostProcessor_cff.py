...
hltMuonEfficiencies = cms.EDAnalyzer("DQMGenericClient",
    ...
    efficiencyProfile = cms.untracked.vstring(
        ...
        "Refefficiency_DZ_Mu1_Vertex 'Reference efficiency; NVertex; N(pass) / N' Refefficiency_DZ_Mu1_numer Refefficiency_DZ_Mu1_denom",
        "Refefficiency_DZ_Mu2_Vertex 'Reference efficiency; NVertex; N(pass) / N' Refefficiency_DZ_Mu2_numer Refefficiency_DZ_Mu2_denom",
        ...
        "MR_Refefficiency_DZ_Mu1 'Reference efficiency; NVertex; N(pass) / N' MR_Refefficiency_DZ_Mu1_numer MR_Refefficiency_DZ_Mu1_denom",
        "MR_Refefficiency_DZ_Mu2 'Reference efficiency; NVertex; N(pass) / N' MR_Refefficiency_DZ_Mu2_numer MR_Refefficiency_DZ_Mu2_denom",
...
hltMuonRefEfficiencies = cms.EDAnalyzer("HLTMuonRefMethod",
                                        ...
                                        efficiency     = cms.untracked.vstring( "Refefficiency_Eta_Mu1",
                                                                                ...
                                                                                "Refefficiency_DZ_Mu1",
                                                                                "Refefficiency_DZ_Mu2",
                                                                                "MR_Refefficiency_TurnOn_Mu1",
                                                                                "MR_Refefficiency_TurnOn_Mu2",
                                                                                "MR_Refefficiency_DZ_Mu1",
                                                                                "MR_Refefficiency_DZ_Mu2",
                                                                                ),
