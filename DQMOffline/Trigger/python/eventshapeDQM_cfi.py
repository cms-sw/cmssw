...
eventshapeDQM_Q2_top10_cent5080 = cms.EDAnalyzer('EventShapeDQM',
        triggerResults = cms.InputTag('TriggerResults','','HLT'),
        EPlabel = cms.InputTag("hiEvtPlane"),
        triggerPath = cms.string('HLT_Q2Top010_L1Centrality5080_v'),
        order = cms.int32(2),
        EPidx = cms.int32(8), #HF2
        EPlvl = cms.int32(0)
)

eventshapeDQM_Q2_bottom10_cent5080 = cms.EDAnalyzer('EventShapeDQM',
        triggerResults = cms.InputTag('TriggerResults','','HLT'),
        EPlabel = cms.InputTag("hiEvtPlane"),
        triggerPath = cms.string('HLT_Q2Bottom010_L1Centrality5080_v'),
        order = cms.int32(2),
        EPidx = cms.int32(8), #HF2
        EPlvl = cms.int32(0)
)

eventshapeDQMSequence = cms.Sequence(eventshapeDQM_Q2_top10_cent1030 * eventshapeDQM_Q2_bottom10_cent1030 * eventshapeDQM_Q2_top10_cent3050 * eventshapeDQM_Q2_bottom10_cent3050 * eventshapeDQM_Q2_top10_cent5080 * eventshapeDQM_Q2_bottom10_cent5080)
