...
private:
  ...
  MEbinning Phi_Binning{100, -3.15, 3.15};
  ...
  ObjME a_ME_BPix[10];
  ObjME a_ME_FPix[10];
  ObjME a_ME_BPix_lowRefPt[10];
  ObjME a_ME_FPix_lowRefPt[10];
  ObjME a_ME_BPix_mediumRefPt[10];
  ObjME a_ME_FPix_mediumRefPt[10];
  ObjME a_ME_BPix_highRefPt[10];
  ObjME a_ME_FPix_highRefPt[10];
...
void ZGammaplusJetsMonitor::bookHistograms(DQMStore::IBooker& ibooker,
  ...
  if (isMuonPath_) {
    bookMESub(ibooker,
              a_ME_BPix_lowRefPt,
              sizeof(a_ME_BPix_lowRefPt) / sizeof(a_ME_BPix_lowRefPt[0]),
              hist_obtag,
              histtitle_obtag,
              "BPix_lowRefPt",
              "(hltJet-BPix_lowRefPt)",
              true,
              true,
              false,
              false);
    bookMESub(ibooker,
              a_ME_FPix_lowRefPt,
              sizeof(a_ME_FPix_lowRefPt) / sizeof(a_ME_FPix_lowRefPt[0]),
              hist_obtag,
              histtitle_obtag,
              "FPix_lowRefPt",
              "(hltJet-FPix_lowRefPt)",
              true,
              true,
              false,
              false);
  ...
  bookMESub(ibooker,
            a_ME_BPix_mediumRefPt,
            sizeof(a_ME_BPix_mediumRefPt) / sizeof(a_ME_BPix_mediumRefPt[0]),
            hist_obtag,
            histtitle_obtag,
            "BPix_mediumRefPt",
            "(hltJet-BPix_mediumRefPt)",
            true,
            true,
            false,
            false);
  bookMESub(ibooker,
            a_ME_FPix_mediumRefPt,
            sizeof(a_ME_FPix_mediumRefPt) / sizeof(a_ME_FPix_mediumRefPt[0]),
            hist_obtag,
            histtitle_obtag,
            "FPix_mediumRefPt",
            "(hltJet-FPix_mediumRefPt)",
            true,
            true,
            false,
            false);
  bookMESub(ibooker,
            a_ME_BPix_highRefPt,
            sizeof(a_ME_BPix_highRefPt) / sizeof(a_ME_BPix_highRefPt[0]),
            hist_obtag,
            histtitle_obtag,
            "BPix_highRefPt",
            "(hltJet-BPix_highRefPt)",
            true,
            true,
            false,
            false);
  bookMESub(ibooker,
            a_ME_FPix_highRefPt,
            sizeof(a_ME_FPix_highRefPt) / sizeof(a_ME_FPix_highRefPt[0]),
            hist_obtag,
            histtitle_obtag,
            "FPix_highRefPt",
            "(hltJet-FPix_highRefPt)",
            true,
            true,
            false,
            false);
...
void ZGammaplusJetsMonitor::bookMESub(DQMStore::IBooker& Ibooker,
  ...
  if (dohltPhotoEtavsPhi) {
    ...
    bookME(
        Ibooker, a_me[9], hName, hTitle, nbin_Eta, minbin_Eta, maxbin_Eta, nbin_Phi, minbin_Phi, maxbin_Phi, bookDen);
