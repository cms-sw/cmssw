...
## standard
eb_dqm_source_offline = cms.Sequence(ecalBarrelMonitorModule*dqmInfoEB*ecalBarrelOccupancyTask*ecalBarrelIntegrityTask*ecalBarrelStatusFlagsTask*ecalBarrelPedestalOnlineTask*ecalBarrelTriggerTowerTask*ecalBarrelCosmicTask*ecalBarrelClusterTask*ecalBarrelHltTask*ecalBarrelClusterTaskExtras)

## standard with Selective Readout Task and Raw Data Task
eb_dqm_source_offline1 = cms.Sequence(ecalBarrelMonitorModule*dqmInfoEB*ecalBarrelOccupancyTask*ecalBarrelIntegrityTask*ecalBarrelStatusFlagsTask*ecalBarrelSelectiveReadoutTask*ecalBarrelRawDataTask*ecalBarrelPedestalOnlineTask*ecalBarrelTriggerTowerTask*ecalBarrelCosmicTask*ecalBarrelClusterTask*ecalBarrelHltTask*ecalBarrelClusterTaskExtras)

## standard
#ee_dqm_source_offline = cms.Sequence(ecalEndcapMonitorModule*dqmInfoEE*ecalEndcapOccupancyTask*ecalEndcapIntegrityTask*ecalEndcapStatusFlagsTask*ecalEndcapPedestalOnlineTask*ecalEndcapTriggerTowerTask*ecalEndcapCosmicTask*ecalEndcapClusterTask*ecalEndcapHltTask*ecalEndcapClusterTaskExtras)
...
ecalBarrelCosmicTask.EcalUncalibratedRecHitCollection = 'ecalGlobalUncalibRecHit:EcalUncalibRecHitsEB'

ecalEndcapCosmicTask.EcalRawDataCollection = 'ecalDigis:'
ecalEndcapCosmicTask.EcalUncalibratedRecHitCollection = 'ecalGlobalUncalibRecHit:EcalUncalibRecHitsEE'
...
ecalBarrelTimingTask.EcalUncalibratedRecHitCollection = 'ecalGlobalUncalibRecHit:EcalUncalibRecHitsEB'

ecalEndcapTimingTask.EcalRawDataCollection = 'ecalDigis:'
ecalEndcapTimingTask.EcalUncalibratedRecHitCollection = 'ecalGlobalUncalibRecHit:EcalUncalibRecHitsEE'
