...
ecal_dqm_source-offline1 = cms.Sequence(ecalBarrelMonitorModule*ecalBarrelIntegrityTask)
ecal_dqm_source-offline2 = cms.Sequence(ecalBarrelMonitorModule*ecalBarrelIntegrityTask*ecalBarrelStatusFlagsTask)
ecal_dqm_source-offline3 = cms.Sequence(ecalBarrelMonitorModule*ecalBarrelIntegrityTask*ecalBarrelStatusFlagsTask*ecalBarrelCosmicTask)
ecal_dqm_source-offline4 = cms.Sequence(ecalBarrelMonitorModule*ecalBarrelOccupancyTask*ecalBarrelIntegrityTask*ecalBarrelStatusFlagsTask*ecalBarrelCosmicTask)
ecal_dqm_source-offline5 = cms.Sequence(ecalBarrelMonitorModule*ecalBarrelOccupancyTask*ecalBarrelIntegrityTask*ecalBarrelStatusFlagsTask*ecalBarrelPedestalOnlineTask*ecalBarrelCosmicTask)
ecal_dqm_source-offline6 = cms.Sequence(ecalBarrelMonitorModule*ecalBarrelOccupancyTask*ecalBarrelIntegrityTask*ecalBarrelStatusFlagsTask*ecalBarrelPedestalOnlineTask*ecalBarrelTriggerTowerTask*ecalBarrelCosmicTask)
ecal_dqm_source-offline7 = cms.Sequence(ecalBarrelMonitorModule*ecalBarrelOccupancyTask*ecalBarrelIntegrityTask*ecalBarrelStatusFlagsTask*ecalBarrelPedestalOnlineTask*ecalBarrelTriggerTowerTask*ecalBarrelCosmicTask*ecalBarrelClusterTask)
ecal_dqm_source-offline9 = cms.Sequence(ecalBarrelMonitorModule*ecalBarrelOccupancyTask*ecalBarrelIntegrityTask*ecalBarrelStatusFlagsTask*ecalBarrelLaserTask*ecalBarrelPedestalOnlineTask*ecalBarrelPedestalTask*ecalBarrelTestPulseTask*ecalBarrelTriggerTowerTask*ecalBarrelTimingTask*ecalBarrelCosmicTask*ecalBarrelClusterTask)
