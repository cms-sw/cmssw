...
ecal_dqm_source-offline = cms.Sequence(ecal_dqm_source-offline1)

ecal_dqm_source-offline1 = cms.Sequence(ecalBarrelMonitorModule*dqmInfoEB*ecalBarrelIntegrityTask)
ecal_dqm_source-offline2 = cms.Sequence(ecalBarrelMonitorModule*dqmInfoEB*ecalBarrelIntegrityTask*ecalBarrelStatusFlagsTask)
ecal_dqm_source-offline3 = cms.Sequence(ecalBarrelMonitorModule*dqmInfoEB*ecalBarrelIntegrityTask*ecalBarrelStatusFlagsTask*ecalBarrelCosmicTask)
ecal_dqm_source-offline4 = cms.Sequence(ecalBarrelMonitorModule*dqmInfoEB*ecalBarrelOccupancyTask*ecalBarrelIntegrityTask*ecalBarrelStatusFlagsTask*ecalBarrelCosmicTask)
ecal_dqm_source-offline5 = cms.Sequence(ecalBarrelMonitorModule*dqmInfoEB*ecalBarrelOccupancyTask*ecalBarrelIntegrityTask*ecalBarrelStatusFlagsTask*ecalBarrelPedestalOnlineTask*ecalBarrelCosmicTask)
