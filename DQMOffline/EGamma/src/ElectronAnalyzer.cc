...
//  h1_ele_vertexY = bookH1("h_ele_vertexY","ele vertex y",nbinxyz,-0.1,0.1,"y (cm)" );
  ...
  // super-clusters
//  h1_scl_En = bookH1("h_scl_energy","ele supercluster energy",nbinp,0.,pmax);
//  h1_scl_Eta = bookH1("h_scl_eta","ele supercluster eta",nbineta,etamin,etamax);
//  h1_scl_Phi = bookH1("h_scl_phi","ele supercluster phi",nbinphi,phimin,phimax);
  h1_scl_Et = bookH1("h_scl_et","ele supercluster transverse energy",nbinpt,0.,ptmax);
...
//  h2_ele_dPhiEleCl_propOutVsPt = bookH2("h2_ele_dPhiEleCl_propOutVsPt","ele #phi_{EleCl} - #phi_{tr}, prop from outermost vs pt",nbinpt2D,0.,ptmax,nbindphimatch,dphimatchmin,dphimatchmax,"#phi_{elecl} - #phi_{tr} (rad)");
  ...
  py_ele_HoeVsPhi = bookP1("py_ele_HoeVsPhi","ele <hadronic energy / em energy> vs #phi",nbinphi2D,phimin,phimax,hoemin,hoemax,"#phi","H/E") ;
//  h2_ele_HoeVsPt = bookH2("h2_ele_HoeVsPt","ele hadronic energy / em energy vs pt",nbinpt2D,0.,ptmax,nbinhoe,hoemin,hoemax,"H/E") ;
...
//  h_ele_fbremVsPt = bookH2("h_ele_fbremVsPt","ele brem fraction vs pt",nbinpt2D,0.,ptmax,100,0.,1.,"P_{in} - P_{out} / P_{in}") ;
  ...
  // isolation
  h1_ele_tkSumPt_dr03 = bookH1("h1_ele_tkSumPt_dr03","tk isolation sum, dR=0.3",100,0.0,20.,"TkIsoSum, cone 0.3 (GeV/c)");
  h1_ele_ecalRecHitSumEt_dr03 = bookH1("h1_ele_ecalRecHitSumEt_dr03","ecal isolation sum, dR=0.3",100,0.0,20.,"EcalIsoSum, cone 0.3 (GeV)");
  h1_ele_hcalTowerSumEt_dr03 = bookH1("h1_ele_hcalTowerSumEt_dr03","hcal isolation sum, dR=0.3",100,0.0,20.,"HcalIsoSum, cone 0.3 (GeV)");
//  h1_ele_hcalDepth1TowerSumEt_dr03 = bookH1("h1_ele_hcalDepth1TowerSumEt_dr03","hcal depth1 isolation sum, dR=0.3",100,0.0,20.,"Hcal1IsoSum, cone 0.3 (GeV)");
//  h1_ele_hcalDepth2TowerSumEt_dr03 = bookH1("h1_ele_hcalDepth2TowerSumEt_dr03","hcal depth2 isolation sum, dR=0.3",100,0.0,20.,"Hcal2IsoSum, cone 0.3 (GeV)");
//  h1_ele_tkSumPt_dr04 = bookH1("h1_ele_tkSumPt_dr04","hcal isolation sum",100,0.0,20.,"TkIsoSum, cone 0.4 (GeV/c)");
//  h1_ele_ecalRecHitSumEt_dr04 = bookH1("h1_ele_ecalRecHitSumEt_dr04","ecal isolation sum, dR=0.4",100,0.0,20.,"EcalIsoSum, cone 0.4 (GeV)");
//  h1_ele_hcalTowerSumEt_dr04 = bookH1("h1_ele_hcalTowerSumEt_dr04","hcal isolation sum, dR=0.4",100,0.0,20.,"HcalIsoSum, cone 0.4 (GeV)");
////  h1_ele_hcalDepth1TowerSumEt_dr04 = bookH1("h1_ele_hcalDepth1TowerSumEt_dr04","hcal depth1 isolation sum, dR=0.4",100,0.0,20.,"Hcal1IsoSum, cone 0.4 (GeV)");
////  h1_ele_hcalDepth2TowerSumEt_dr04 = bookH1("h1_ele_hcalDepth2TowerSumEt_dr04","hcal depth2 isolation sum, dR=0.4",100,0.0,20.,"Hcal2IsoSum, cone 0.4 (GeV)");
