...
// $Id: PhotonDataCertification.cc,v 1.4 2009/03/12 16:11:27 lantonel Exp $
//
...
//   std::cout << "1 >>> found " <<  mes.size() << " monitoring elements!" << std::endl;
  
//   //dbe_->setCurrentFolder("EGamma");
//   subDirVec = dbe_->getSubdirs();
//   for (std::vector<std::string>::const_iterator ic = subDirVec.begin();ic != subDirVec.end(); ic++) {    
//     std::cout << "-AAA- Dir = >>" << ic->c_str() << "<<" << std::endl;
//   }
//   dbe_->setCurrentFolder("EGamma");
//   std::cout << "asdfasdfa\n";
//   subDirVec = dbe_->getSubdirs();
...
//   }
  ...
  //else dbe_->setCurrentFolder(RefRunDir+"/Egamma/EventInfo/Certification/");  

  dbe_->setCurrentFolder("Egamma/EventInfo/Certification/");  
