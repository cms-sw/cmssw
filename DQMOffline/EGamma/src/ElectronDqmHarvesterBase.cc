...
void ElectronDqmHarvesterBase::setBookPrefix(const std::string &prefix) { bookPrefix_ = prefix; }

void ElectronDqmHarvesterBase::setBookIndex(short index) { bookIndex_ = index; }

void ElectronDqmHarvesterBase::setBookEfficiencyFlag(const bool &eff_flag) { bookEfficiencyFlag_ = eff_flag; }
