...
l1tStage2CaloLayer2OfflineDQM = cms.EDAnalyzer("L1TStage2CaloLayer2Analyzer_Offline",
...
l1tStage2CaloLayer2OfflineDQMEmu = cms.EDAnalyzer("L1TStage2CaloLayer2Analyzer_Offline",
    electronCollection       = cms.InputTag("gedGsfElectrons"),
    caloJetCollection        = cms.InputTag("ak4CaloJets"),
    caloMETCollection          = cms.InputTag("caloMet"),
    conversionsCollection    = cms.InputTag("allConversions"),
