...
# pt
effVsPtBins = list(range(0, 30, 1))
effVsPtBins += list(range(30, 50, 2))
effVsPtBins += list(range(50, 70, 5))
effVsPtBins += list(range(70, 100, 10))
effVsPtBins += list(range(100, 200, 25))
effVsPtBins += list(range(200, 300, 50))
effVsPtBins += list(range(300, 500, 100))
effVsPtBins += list(range(500, 700, 200))
effVsPtBins += list(range(700, 1000, 300))
