...
cmsDriver.py test_${tnum}_${step}_1 -s ${DQMSEQUENCE} --conditions 81X_upgrade2023_realistic_v1 --data --filetype DQM --filein file:test_${tnum}_a_1_RAW2DIGI_RECO_DQM.root --scenario pp --customise DQMServices/Components/test/customHarvesting.py --no_exec --python_filename=test_${tnum}_${step}_1.py --era Run2_2016
