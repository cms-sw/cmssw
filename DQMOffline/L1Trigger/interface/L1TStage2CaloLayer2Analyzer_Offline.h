#ifndef L1TStage2CaloLayer2Analyzer_Offline_H
#define L1TStage2CaloLayer2Analyzer_Offline_H
...
class L1TStage2CaloLayer2Analyzer_Offline: public DQMEDAnalyzer {

public:

	L1TStage2CaloLayer2Analyzer_Offline(const edm::ParameterSet& ps);
	virtual ~L1TStage2CaloLayer2Analyzer_Offline();
...
private:
	...
	// energy sum turn ons
	MonitorElement* h_turnOnMET_pass_;
	MonitorElement* h_turnOnMHT_pass_;
	MonitorElement* h_turnOnETT_pass_;
	MonitorElement* h_turnOnHTT_pass_;

	MonitorElement* h_turnOnMET_total_;
	MonitorElement* h_turnOnMHT_total_;
	MonitorElement* h_turnOnETT_total_;
	MonitorElement* h_turnOnHTT_total_;
