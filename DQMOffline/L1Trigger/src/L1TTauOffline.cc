 ...
 *  @authors  Olivier Davignon (University of Bristol), Cécile Caillol
...
void L1TTauOffline::bookTauHistos(DQMStore::IBooker& ibooker)
{
    ...
    h_L1TauETvsTauET_EB_EE_ = ibooker.book2D("L1TauETvsTauET_EB_EE",
                                             "L1 Tau E_{T} vs PFTau E_{T} (EB+EE); PFTau "
                                             "E_{T} (GeV); L1 Tau E_{T} (GeV)",
                                             templateETvsET.nbinsX, &templateETvsET.binsX[0], templateETvsET.nbinsY,
    ...
    h_L1TauPhivsTauPhi_EB_ = ibooker.book2D("L1TauPhivsTauPhi_EB",
                                            "#phi_{tau}^{L1} vs #phi_{tau}^{offline} (EB); "
                                            "#phi_{tau}^{offline}; #phi_{tau}^{L1}",
    ...
    h_L1TauPhivsTauPhi_EE_ = ibooker.book2D("L1TauPhivsTauPhi_EE",
                                            "#phi_{tau}^{L1} vs #phi_{tau}^{offline} (EE); "
                                            "#phi_{tau}^{offline}; #phi_{tau}^{L1}",
                                            templatePHIvsPHI.nbinsX, templatePHIvsPHI.xmin, templatePHIvsPHI.xmax,
                                            templatePHIvsPHI.nbinsY, templatePHIvsPHI.ymin, templatePHIvsPHI.ymax);
    h_L1TauPhivsTauPhi_EB_EE_ = ibooker.book2D("L1TauPhivsTauPhi_EB_EE",
                                               "#phi_{tau}^{L1} vs #phi_{tau}^{offline} "
                                               "(EB+EE); #phi_{tau}^{offline}; "
                                               "#phi_{tau}^{L1}",
                                               templatePHIvsPHI.nbinsX, templatePHIvsPHI.xmin, templatePHIvsPHI.xmax,
                                               templatePHIvsPHI.nbinsY, templatePHIvsPHI.ymin, templatePHIvsPHI.ymax);
    ...
    h_resolutionTauET_EB_ = ibooker.book1D("resolutionTauET_EB",
                                           "tau ET resolution (EB); (L1 Tau E_{T} - PFTau "
                                           "E_{T})/PFTau E_{T}; events",
                                           50, -1, 1.5);
    h_resolutionTauET_EE_ = ibooker.book1D("resolutionTauET_EE",
                                           "tau ET resolution (EE); (L1 Tau E_{T} - PFTau "
                                           "E_{T})/PFTau E_{T}; events",
                                           50, -1, 1.5);
    h_resolutionTauET_EB_EE_ = ibooker.book1D("resolutionTauET_EB_EE",
                                              "tau ET resolution (EB+EE); (L1 Tau E_{T} - "
                                              "PFTau E_{T})/PFTau E_{T}; events",
                                              50, -1, 1.5);

    h_resolutionTauPhi_EB_ = ibooker.book1D("resolutionTauPhi_EB",
                                            "#phi_{tau} resolution (EB); #phi_{tau}^{L1} - "
                                            "#phi_{tau}^{offline}; events",
                                            120, -0.3, 0.3);
    h_resolutionTauPhi_EE_ = ibooker.book1D("resolutionTauPhi_EE",
                                            "tau #phi resolution (EE); #phi_{tau}^{L1} - "
                                            "#phi_{tau}^{offline}; events",
                                            120, -0.3, 0.3);
    h_resolutionTauPhi_EB_EE_ = ibooker.book1D("resolutionTauPhi_EB_EE",
                                               "tau #phi resolution (EB+EE); #phi_{tau}^{L1} "
                                               "- #phi_{tau}^{offline}; events",
                                               120, -0.3, 0.3);
