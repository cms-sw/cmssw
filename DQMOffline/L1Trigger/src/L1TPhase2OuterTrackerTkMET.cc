...
void L1TPhase2OuterTrackerTkMET::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  for (auto trackIter: *TTTrackHandle) {
    ...
    if (pt < minPt || fabs(z0) > maxZ0 || fabs(eta) > maxEta || chi2dof > chi2dofMax || bendchi2 > bendchi2Max) continue;
    if ( maxPt > 0 && pt > maxPt)  {
    ...
    if (nstubs < nStubsmin || nPS < nStubsPSmin) continue;
...
void L1TPhase2OuterTrackerTkMET::bookHistograms(DQMStore::IBooker &iBooker, edm::Run const & run, edm::EventSetup const & es) {
  ...
  Track_N = iBooker.book1D(HistoName, HistoName, psTrack_N.getParameter<int32_t>("Nbinsx"), psTrack_N.getParameter<double>("xmin"), psTrack_N.getParameter<double>("xmax"));
  ...
  HistoName = "Track_Pt";
  Track_Pt = iBooker.book1D(HistoName, HistoName, psTrack_Pt.getParameter<int32_t>("Nbinsx"), psTrack_Pt.getParameter<double>("xmin"), psTrack_Pt.getParameter<double>("xmax"));
  ...
  HistoName = "Track_Eta";
  Track_Eta = iBooker.book1D(HistoName, HistoName, psTrack_Eta.getParameter<int32_t>("Nbinsx"), psTrack_Eta.getParameter<double>("xmin"), psTrack_Eta.getParameter<double>("xmax"));
  ...
  Track_VtxZ = iBooker.book1D(HistoName, HistoName, psTrack_VtxZ.getParameter<int32_t>("Nbinsx"), psTrack_VtxZ.getParameter<double>("xmin"), psTrack_VtxZ.getParameter<double>("xmax"));
  ...
  Track_Chi2Dof = iBooker.book1D(HistoName, HistoName, psTrack_Chi2Dof.getParameter<int32_t>("Nbinsx"), psTrack_Chi2Dof.getParameter<double>("xmin"), psTrack_Chi2Dof.getParameter<double>("xmax"));
  ...
  Track_BendChi2 = iBooker.book1D(HistoName, HistoName, psTrack_BendChi2.getParameter<int32_t>("Nbinsx"), psTrack_BendChi2.getParameter<double>("xmin"), psTrack_BendChi2.getParameter<double>("xmax"));
  ...
  Track_NStubs = iBooker.book1D(HistoName, HistoName, psTrack_NStubs.getParameter<int32_t>("Nbinsx"), psTrack_NStubs.getParameter<double>("xmin"), psTrack_NStubs.getParameter<double>("xmax"));
  ...
  Track_NPSstubs = iBooker.book1D(HistoName, HistoName, psTrack_NPSstubs.getParameter<int32_t>("Nbinsx"), psTrack_NPSstubs.getParameter<double>("xmin"), psTrack_NPSstubs.getParameter<double>("xmax"));
  ...
  TkMET_QualityCuts = iBooker.book1D(HistoName, HistoName, psTrack_TkMET.getParameter<int32_t>("Nbinsx"), psTrack_TkMET.getParameter<double>("xmin"), psTrack_TkMET.getParameter<double>("xmax"));
  TkMET_QualityCuts->setAxisTitle("L1 Track MET [GeV]", 1);
  TkMET_QualityCuts->setAxisTitle("# Events", 2);

  //tkMET -- PU only
  HistoName = "TkMET_PU";
  TkMET_PU = iBooker.book1D(HistoName, HistoName, psTrack_TkMET.getParameter<int32_t>("Nbinsx"), psTrack_TkMET.getParameter<double>("xmin"), psTrack_TkMET.getParameter<double>("xmax"));
