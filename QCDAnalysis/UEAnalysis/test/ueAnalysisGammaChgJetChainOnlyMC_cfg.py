...
process.load("QCDAnalysis.UEAnalysis.UEAnalysisGammaChgJet_cfi")

process.load("QCDAnalysis.UEAnalysis.UEAnalysisJets_cfi")

process.load("QCDAnalysis.UEAnalysis.UEAnalysisGammaChgJetOnlyMC_cfi")

process.TFileService = cms.Service("TFileService",
    fileName = cms.string('file:jet15_step1.root')
)
...
process.p1 = cms.Path(process.UEAnalysisGammaChgJet*process.UEAnalysisJetsOnlyMC*process.UEAnalysisOnlyMC)
