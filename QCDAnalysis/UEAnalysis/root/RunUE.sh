...
// 1) file that contain the list of root file to be analyzed
// 2) output file name
...
// 6) eta region 
// 7) cuts on the minimu pt of the tracks in MeV
// 8) cuts on the minimum pt of MiniJet to be used only in case you are running the MPI scheme  

./UEAnalysis listMB_09.dat StreamMB_900_lumi1pb.root UE MB 1 2 900 0
