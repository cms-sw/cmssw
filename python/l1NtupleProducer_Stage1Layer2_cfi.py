...
l1NtupleProducer = cms.EDAnalyzer("L1NtupleProducer",
    ...
    gctCentralJetsSource = cms.InputTag("simCaloLegacyFormatDigis","cenJets"),
    gctNonIsoEmSource    = cms.InputTag("simCaloLegacyFormatDigis","nonIsoEm"),
    gctForwardJetsSource = cms.InputTag("simCaloLegacyFormatDigis","forJets"),
    gctIsoEmSource       = cms.InputTag("simCaloLegacyFormatDigis","isoEm"),
    gctEnergySumsSource  = cms.InputTag("simCaloLegacyFormatDigis",""),
    gctTauJetsSource     = cms.InputTag("simCaloLegacyFormatDigis","tauJets"),
    rctSource            = cms.InputTag("simCaloLegacyFormatDigis"),
