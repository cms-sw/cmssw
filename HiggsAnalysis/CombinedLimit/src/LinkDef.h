...
#include "../interface/RooScaleHGluGluLOSM.h"
#include "../interface/RooScaleHGamGamLOSM.h"
#include "../interface/RooScaleHZGamLOSM.h"
...
#pragma link C++ class RooScaleHZGamLOSM+;
