#ifndef HiggsAnalysis_HiggsToZZ4LeptonsSkimTriLeptonProducer
#define HiggsAnalysis_HiggsToZZ4LeptonsSkimTriLeptonProducer
...
class HiggsToZZ4LeptonsSkimTriLeptonProducer : public edm::EDProducer {
  
 public:
  // Constructor
  explicit HiggsToZZ4LeptonsSkimTriLeptonProducer(const edm::ParameterSet&);
