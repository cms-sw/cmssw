# Skim for MSSM Higgs->tautau->electrontau Events
...
process.load("HiggsAnalysis.Skimming.higgsToTauTau_ElectronTau_SkimPaths_cff")
process.load("HiggsAnalysis.Skimming.higgsToTauTau_ElectronTau_OutputModule_cff")
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/HiggsAnalysis/Skimming/test/higgsToTauTauElectronTauSkim.py,v $'),
