...
higgsToZZ4LeptonsHLTAnalysis = cms.EDProducer("HiggsToZZ4LeptonsHLTAnalysis",
    ...
    HLTPaths = cms.vstring('HLT_IsoMu11', 'HLT_Mu15', 'HLT_DoubleMu3', 'HLT_IsoEle15_L1I', 'HLT_IsoEle18_L1R','HLT_DoubleIsoEle10_L1I', 'HLT_DoubleIsoEle12_L1R','HLT_DoubleIsoEle10_LW_L1I','HLT_IsoEle8_IsoMu7'),
    andOr = cms.bool(True),
