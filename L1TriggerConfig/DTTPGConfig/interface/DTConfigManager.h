...
class DTConfigManager {
 ...
 public:
  ...
  inline void setDTConfigTSTheta(const DTChamberId& chambid ,const DTConfigTSTheta& conf) { my_tsthetamap[chambid] = conf; };
  ...
  void setDTConfigTrigUnit(const DTChamberId& chambid,const DTConfigTrigUnit& conf) { my_trigunitmap[chambid] = conf; };
  ...
  void setDTConfigSectColl(const DTSectCollId& sectcollid ,const DTConfigSectColl& conf){ my_sectcollmap[sectcollid] = conf; };
