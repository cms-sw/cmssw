...
namespace l1t {
  ...
  public:
    ...
    std::vector<unsigned long long> layer1HCalFBLUT() { return pnode_[layer1HCal].u64params_; }
    ...
    void setLayer1HCalFBLUT(const std::vector<unsigned long long> params) { pnode_[layer1HCal].u64params_ = params; }
