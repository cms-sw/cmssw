...
namespace l1t {
  ...
  public:
    ...
    void setMetCalibrationType(std::string type) { pnode_[metCalibration].type_ = std::move(type); }
    void setMetHFCalibrationType(std::string type) { pnode_[metHFCalibration].type_ = std::move(type); }
