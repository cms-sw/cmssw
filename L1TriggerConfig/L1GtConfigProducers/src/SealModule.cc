...
DEFINE_ANOTHER_FWK_EVENTSETUP_MODULE(L1GtPrescaleFactorsAlgoTrigTrivialProducer);
DEFINE_ANOTHER_FWK_EVENTSETUP_MODULE(L1GtPrescaleFactorsTechTrigTrivialProducer);

DEFINE_ANOTHER_FWK_EVENTSETUP_MODULE(L1GtTriggerMaskAlgoTrigTrivialProducer);
DEFINE_ANOTHER_FWK_EVENTSETUP_MODULE(L1GtTriggerMaskTechTrigTrivialProducer);

DEFINE_ANOTHER_FWK_EVENTSETUP_MODULE(L1GtTriggerMaskVetoAlgoTrigTrivialProducer);
DEFINE_ANOTHER_FWK_EVENTSETUP_MODULE(L1GtTriggerMaskVetoTechTrigTrivialProducer);
