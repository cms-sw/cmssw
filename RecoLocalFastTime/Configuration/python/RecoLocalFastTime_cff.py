...
_phase2_timing_layer_tile_fastTimingLocalReco = cms.Sequence(mtdUncalibratedRecHits*mtdRecHits)
...
_phase2_timing_layer_bar_fastTimingLocalReco = cms.Sequence(mtdUncalibratedRecHits*mtdRecHits)
