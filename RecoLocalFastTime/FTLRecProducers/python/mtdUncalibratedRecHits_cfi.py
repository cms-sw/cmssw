...
_endcapAlgo = cms.PSet(
    ...
    timeResolutionInNs = cms.string("0.0361"), # [ns]
    #timeCorr_p0 = cms.double(0.995091),
    #timeCorr_p1 = cms.double(-0.249013),
    #timeCorr_p2 = cms.double(0.0231472),
    #timeCorr_p3 = cms.double(-0.000781612)
