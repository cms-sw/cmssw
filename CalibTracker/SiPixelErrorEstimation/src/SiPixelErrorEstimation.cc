...
SiPixelErrorEstimation::SiPixelErrorEstimation(const edm::ParameterSet &ps)
    : tfile_(nullptr), ttree_all_hits_(nullptr), ttree_track_hits_(nullptr),
      ttree_track_hits_strip_(nullptr),
      trackerHitAssociatorConfig_(consumesCollector()) {
  // Read config file
  outputFile_ = ps.getUntrackedParameter<string>(
      "outputFile", "SiPixelErrorEstimation_Ntuple.root");
  ...
  tSimTrackContainer =
      consumes<edm::SimTrackContainer>(edm::InputTag("g4SimHits"));
...
void SiPixelErrorEstimation::beginJob() {
  ...
  ttree_track_hits_strip_ =
      new TTree("TrackHitNtupleStrip", "TrackHitNtupleStrip");

  ttree_track_hits_strip_->Branch("strip_rechitx", &strip_rechitx,
                                  "strip_rechitx/F", bufsize);
  ttree_track_hits_strip_->Branch("strip_rechity", &strip_rechity,
                                  "strip_rechity/F", bufsize);
  ttree_track_hits_strip_->Branch("strip_rechitz", &strip_rechitz,
                                  "strip_rechitz/F", bufsize);

  ttree_track_hits_strip_->Branch("strip_rechiterrx", &strip_rechiterrx,
                                  "strip_rechiterrx/F", bufsize);
  ttree_track_hits_strip_->Branch("strip_rechiterry", &strip_rechiterry,
                                  "strip_rechiterry/F", bufsize);

  ttree_track_hits_strip_->Branch("strip_rechitresx", &strip_rechitresx,
                                  "strip_rechitresx/F", bufsize);

  ttree_track_hits_strip_->Branch("strip_rechitresx2", &strip_rechitresx2,
                                  "strip_rechitresx2/F", bufsize);

  ttree_track_hits_strip_->Branch("strip_rechitresy", &strip_rechitresy,
                                  "strip_rechitresy/F", bufsize);

  ttree_track_hits_strip_->Branch("strip_rechitpullx", &strip_rechitpullx,
                                  "strip_rechitpullx/F", bufsize);
  ttree_track_hits_strip_->Branch("strip_rechitpully", &strip_rechitpully,
                                  "strip_rechitpully/F", bufsize);

  ttree_track_hits_strip_->Branch("strip_is_stereo", &strip_is_stereo,
                                  "strip_is_stereo/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_hit_type", &strip_hit_type,
                                  "strip_hit_type/I", bufsize);
  ttree_track_hits_strip_->Branch("detector_type", &detector_type,
                                  "detector_type/I", bufsize);

  ttree_track_hits_strip_->Branch("strip_trk_pt", &strip_trk_pt,
                                  "strip_trk_pt/F", bufsize);
  ttree_track_hits_strip_->Branch("strip_cotalpha", &strip_cotalpha,
                                  "strip_cotalpha/F", bufsize);
  ttree_track_hits_strip_->Branch("strip_cotbeta", &strip_cotbeta,
                                  "strip_cotbeta/F", bufsize);
  ttree_track_hits_strip_->Branch("strip_locbx", &strip_locbx, "strip_locbx/F",
                                  bufsize);
  ttree_track_hits_strip_->Branch("strip_locby", &strip_locby, "strip_locby/F",
                                  bufsize);
  ttree_track_hits_strip_->Branch("strip_locbz", &strip_locbz, "strip_locbz/F",
                                  bufsize);
  ttree_track_hits_strip_->Branch("strip_charge", &strip_charge,
                                  "strip_charge/F", bufsize);
  ttree_track_hits_strip_->Branch("strip_size", &strip_size, "strip_size/I",
                                  bufsize);

  ttree_track_hits_strip_->Branch("strip_edge", &strip_edge, "strip_edge/I",
                                  bufsize);
  ttree_track_hits_strip_->Branch("strip_nsimhit", &strip_nsimhit,
                                  "strip_nsimhit/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_pidhit", &strip_pidhit,
                                  "strip_pidhit/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_simproc", &strip_simproc,
                                  "strip_simproc/I", bufsize);

  ttree_track_hits_strip_->Branch("strip_subdet_id", &strip_subdet_id,
                                  "strip_subdet_id/I", bufsize);

  ttree_track_hits_strip_->Branch("strip_tib_layer", &strip_tib_layer,
                                  "strip_tib_layer/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tib_module", &strip_tib_module,
                                  "strip_tib_module/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tib_order", &strip_tib_order,
                                  "strip_tib_order/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tib_side", &strip_tib_side,
                                  "strip_tib_side/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tib_is_double_side",
                                  &strip_tib_is_double_side,
                                  "strip_tib_is_double_side/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tib_is_z_plus_side",
                                  &strip_tib_is_z_plus_side,
                                  "strip_tib_is_z_plus_side/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tib_is_z_minus_side",
                                  &strip_tib_is_z_minus_side,
                                  "strip_tib_is_z_minus_side/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tib_layer_number",
                                  &strip_tib_layer_number,
                                  "strip_tib_layer_number/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tib_string_number",
                                  &strip_tib_string_number,
                                  "strip_tib_string_number/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tib_module_number",
                                  &strip_tib_module_number,
                                  "strip_tib_module_number/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tib_is_internal_string",
                                  &strip_tib_is_internal_string,
                                  "strip_tib_is_internal_string/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tib_is_external_string",
                                  &strip_tib_is_external_string,
                                  "strip_tib_is_external_string/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tib_is_rphi", &strip_tib_is_rphi,
                                  "strip_tib_is_rphi/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tib_is_stereo", &strip_tib_is_stereo,
                                  "strip_tib_is_stereo/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tob_layer", &strip_tob_layer,
                                  "strip_tob_layer/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tob_module", &strip_tob_module,
                                  "strip_tob_module/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tob_side", &strip_tob_side,
                                  "strip_tob_side/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tob_is_double_side",
                                  &strip_tob_is_double_side,
                                  "strip_tob_is_double_side/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tob_is_z_plus_side",
                                  &strip_tob_is_z_plus_side,
                                  "strip_tob_is_z_plus_side/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tob_is_z_minus_side",
                                  &strip_tob_is_z_minus_side,
                                  "strip_tob_is_z_minus_side/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tob_layer_number",
                                  &strip_tob_layer_number,
                                  "strip_tob_layer_number/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tob_rod_number", &strip_tob_rod_number,
                                  "strip_tob_rod_number/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_tob_module_number",
                                  &strip_tob_module_number,
                                  "strip_tob_module_number/I", bufsize);

  ttree_track_hits_strip_->Branch("strip_prob", &strip_prob, "strip_prob/F",
                                  bufsize);
  ttree_track_hits_strip_->Branch("strip_qbin", &strip_qbin, "strip_qbin/I",
                                  bufsize);

  ttree_track_hits_strip_->Branch("strip_nprm", &strip_nprm, "strip_nprm/I",
                                  bufsize);

  ttree_track_hits_strip_->Branch("strip_pidhit1", &strip_pidhit1,
                                  "strip_pidhit1/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_simproc1", &strip_simproc1,
                                  "strip_simproc1/I", bufsize);

  ttree_track_hits_strip_->Branch("strip_pidhit2", &strip_pidhit2,
                                  "strip_pidhit2/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_simproc2", &strip_simproc2,
                                  "strip_simproc2/I", bufsize);

  ttree_track_hits_strip_->Branch("strip_pidhit3", &strip_pidhit3,
                                  "strip_pidhit3/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_simproc3", &strip_simproc3,
                                  "strip_simproc3/I", bufsize);

  ttree_track_hits_strip_->Branch("strip_pidhit4", &strip_pidhit4,
                                  "strip_pidhit4/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_simproc4", &strip_simproc4,
                                  "strip_simproc4/I", bufsize);

  ttree_track_hits_strip_->Branch("strip_pidhit5", &strip_pidhit5,
                                  "strip_pidhit5/I", bufsize);
  ttree_track_hits_strip_->Branch("strip_simproc5", &strip_simproc5,
                                  "strip_simproc5/I", bufsize);

  ttree_track_hits_strip_->Branch("strip_split", &strip_split, "strip_split/I",
                                  bufsize);

  ttree_track_hits_strip_->Branch("strip_clst_err_x", &strip_clst_err_x,
                                  "strip_clst_err_x/F", bufsize);
  ttree_track_hits_strip_->Branch("strip_clst_err_y", &strip_clst_err_y,
  ...
  if (include_trk_hits_) {
    ...
    ttree_track_hits_->Branch("rechiterrx", &rechiterrx, "rechiterrx/F",
                              bufsize);
    ttree_track_hits_->Branch("rechiterry", &rechiterry, "rechiterry/F",
                              bufsize);

    ttree_track_hits_->Branch("rechitresx", &rechitresx, "rechitresx/F",
                              bufsize);
    ttree_track_hits_->Branch("rechitresy", &rechitresy, "rechitresy/F",
                              bufsize);

    ttree_track_hits_->Branch("rechitpullx", &rechitpullx, "rechitpullx/F",
                              bufsize);
    ttree_track_hits_->Branch("rechitpully", &rechitpully, "rechitpully/F",
                              bufsize);
    ...
    ttree_track_hits_->Branch("pixel_split", &pixel_split, "pixel_split/I",
                              bufsize);

    ttree_track_hits_->Branch("pixel_clst_err_x", &pixel_clst_err_x,
                              "pixel_clst_err_x/F", bufsize);
    ttree_track_hits_->Branch("pixel_clst_err_y", &pixel_clst_err_y,
                              "pixel_clst_err_y/F", bufsize);
  ...
  ttree_all_hits_->Branch("rechiterrx", &all_rechiterrx, "rechiterrx/F",
                          bufsize);
  ttree_all_hits_->Branch("rechiterry", &all_rechiterry, "rechiterry/F",
                          bufsize);

  ttree_all_hits_->Branch("rechitresx", &all_rechitresx, "rechitresx/F",
                          bufsize);
  ttree_all_hits_->Branch("rechitresy", &all_rechitresy, "rechitresy/F",
                          bufsize);

  ttree_all_hits_->Branch("rechitpullx", &all_rechitpullx, "rechitpullx/F",
                          bufsize);
  ttree_all_hits_->Branch("rechitpully", &all_rechitpully, "rechitpully/F",
                          bufsize);
  ...
  ttree_all_hits_->Branch("clust_maxpixcol", &all_clust_maxpixcol,
                          "clust_maxpixcol/I", bufsize);
  ttree_all_hits_->Branch("clust_maxpixrow", &all_clust_maxpixrow,
                          "clust_maxpixrow/I", bufsize);
  ttree_all_hits_->Branch("clust_minpixcol", &all_clust_minpixcol,
                          "clust_minpixcol/I", bufsize);
  ttree_all_hits_->Branch("clust_minpixrow", &all_clust_minpixrow,
                          "clust_minpixrow/I", bufsize);

  ttree_all_hits_->Branch("clust_geoid", &all_clust_geoid, "clust_geoid/I",
                          bufsize);

  ttree_all_hits_->Branch("clust_alpha", &all_clust_alpha, "clust_alpha/F",
                          bufsize);
  ttree_all_hits_->Branch("clust_beta", &all_clust_beta, "clust_beta/F",
                          bufsize);
  ...
  ttree_all_hits_->Branch("all_pixel_split", &all_pixel_split,
                          "all_pixel_split/I", bufsize);

  ttree_all_hits_->Branch("all_pixel_clst_err_x", &all_pixel_clst_err_x,
                          "all_pixel_clst_err_x/F", bufsize);
  ttree_all_hits_->Branch("all_pixel_clst_err_y", &all_pixel_clst_err_y,
                          "all_pixel_clst_err_y/F", bufsize);
}
...
void SiPixelErrorEstimation::analyze(const edm::Event &e,
  ...
  for (vector<Trajectory>::const_iterator it = trajCollectionHandle->begin();
    ...
    for (vector<TrajectoryMeasurement>::const_iterator itTraj = tmColl.begin();
      ...
      const TransientTrackingRecHit::ConstRecHitPointer
          trans_trk_rec_hit_point = itTraj->recHit();
      ...
      const SiStripRecHit2D *hit2d = dynamic_cast<const SiStripRecHit2D *>(
          (*trans_trk_rec_hit_point).hit());
      const SiStripRecHit1D *hit1d = dynamic_cast<const SiStripRecHit1D *>(
          (*trans_trk_rec_hit_point).hit());
      ...
      // const StripGeomDetUnit* strip_geom_det_unit = dynamic_cast<const
      // StripGeomDetUnit*> ( tracker->idToDet( detid ) );
      const StripGeomDetUnit *strip_geom_det_unit =
          (const StripGeomDetUnit *)tracker->idToDetUnit(detid);

      if (strip_geom_det_unit != nullptr) {
        LocalVector lbfield =
            (strip_geom_det_unit->surface())
                .toLocal(
                    (*magneticField)
                        .inTesla(strip_geom_det_unit->surface().position()));
      ...
      // enum ModuleGeometry {UNKNOWNGEOMETRY, IB1, IB2, OB1, OB2, W1A, W2A,
      // W3A, W1B, W2B, W3B, W4, W5, W6, W7};

      if (si_strip_det_id.moduleGeometry() == 1) {
        detector_type = 1;
        // cout << "si_strip_det_id.moduleGeometry() = IB1" << endl;
        // cout << "si_strip_det_id.moduleGeometry() = " <<
        // si_strip_det_id.moduleGeometry() << endl;
      ...
      if (matchedhit) {
        // cout << endl << endl << endl;
        // cout << "Found a SiStripMatchedRecHit2D
        // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! " << endl;
        // cout
        // << endl << endl << endl;
        strip_hit_type = 0;
      ...
      if (hit1d) {
        ...
        if (!matched.empty()) {
          ...
          for (vector<PSimHit>::const_iterator m = matched.begin();
               m < matched.end(); ++m) {
            ++current_index;
            ...
            float dist =
                abs((hit1d)->localPosition().x() - (*m).localPosition().x());
      ...
      if (hit2d) {
        ...
        if (!matched.empty()) {
          ...
          for (vector<PSimHit>::const_iterator m = matched.begin();
               m < matched.end(); ++m) {
            float dist =
                abs((hit2d)->localPosition().x() - (*m).localPosition().x());
    ...
    } // for ( vector<TrajectoryMeasurement>::const_iterator itTraj =
      // tmColl.begin(); itTraj!=tmColl.end(); ++itTraj )
  ...
  for (TrackerGeometry::DetContainer::const_iterator it = pDD->dets().begin();
    ...
    for (; pixeliter != pixelrechitRangeIteratorEnd; ++pixeliter) {
      ...
      if (matched.empty()) {
        cout << "SiPixelErrorEstimation::analyze: rechits without associated "
                "simhit !!!!!!!"
             << endl;
        continue;
      }
      ...
      */
      ...
      if (!(all_subdetid == 1 || all_subdetid == 2)) {
        cout << "SiPixelErrorEstimation::analyze: Not in a pixel detector !!!!!"
             << endl;
        continue;
      }
      ...
      if ((int)detId.subdetId() == (int)PixelSubdetector::PixelBarrel) {
        ...
        float tmp1 =
            theGeomDet->surface().toGlobal(Local3DPoint(0., 0., 0.)).perp();
        float tmp2 =
            theGeomDet->surface().toGlobal(Local3DPoint(0., 0., 1.)).perp();
        ...
        std::cout << "We are not in the pixel detector" << (int)detId.subdetId()
                  << endl;
      ...
      // If this recHit does not have any simHit with the same particleType as
      // the particles generated ignore it as most probably comes from delta
      // rays.
      if (checkType_ && !found_hit_from_generated_particle)
        continue;

      all_x1 = (*closest_simhit)
                   .entryPoint()
                   .x(); // width (row index, in col direction)
      all_y1 = (*closest_simhit)
                   .entryPoint()
                   .y(); // length (col index, in row direction)
      ...
      GlobalPoint GP1 = theGeomDet->surface().toGlobal(
          Local3DPoint((*closest_simhit).entryPoint().x(),
                       (*closest_simhit).entryPoint().y(),
                       (*closest_simhit).entryPoint().z()));
      GlobalPoint GP2 = theGeomDet->surface().toGlobal(Local3DPoint(
          (*closest_simhit).exitPoint().x(), (*closest_simhit).exitPoint().y(),
      ...
      MeasurementPoint mp1 = topol->measurementPosition(
          LocalPoint((*closest_simhit).entryPoint().x(),
                     (*closest_simhit).entryPoint().y(),
                     (*closest_simhit).entryPoint().z()));
      ...
      LocalPoint lp2 =
          topol->localPosition(MeasurementPoint(all_clust_row, all_clust_col));
      all_clust_x = lp2.x();
      all_clust_y = lp2.y();
      ...
      for (int i = 0; i < (int)pixvector.size(); ++i) {
        ...
        LocalPoint lp =
            topol->localPosition(MeasurementPoint(holdpix.x, holdpix.y));
        all_pixx[i] = lp.x();
        all_pixy[i] = lp.y();
        GlobalPoint GP = theGeomDet->surface().toGlobal(
            Local3DPoint(lp.x(), lp.y(), lp.z()));
        all_pixgx[i] = GP.x();
        all_pixgy[i] = GP.y();
        all_pixgz[i] = GP.z();
      }
        ...
        for (auto const hit : tciter->recHits()) {
          ...
          if (matchedhit) {
            ...
            if (!matched.empty()) {
              ...
              for (vector<PSimHit>::const_iterator m = matched.begin();
                   m < matched.end(); ++m) {
                if (checkType_) { // only consider associated simhits with the
                                  // generated pid (muons)
                  int pid = (*m).particleType();
                  if (abs(pid) != genType_)
                    continue;
              ...
              // as the particles generated Ignore it as most probably come from
              // delta rays.
              if (checkType_ && !found_hit_from_generated_particle)
                continue;
              ...
              // if ( n_assoc_muon > 1 )
              //{
              //  // cout << " ----- This is not good: n_assoc_muon = " <<
              //  n_assoc_muon << endl;
              //  // cout << "evt = " << evt << endl;
              //}
              ...
              trk_alpha =
                  acos(locx / sqrt(locx * locx + locz * locz)) * radtodeg;
              if (isFlipped) // &&& check for FPIX !!!
                trk_alpha = 180.0 - trk_alpha;

              trk_beta =
                  acos(locy / sqrt(locy * locy + locz * locz)) * radtodeg;
              ...
              // else std::// cout << "We are not in the pixel detector.
              // detId.subdetId() = " << (int)detId.subdetId() << endl;
...
void SiPixelErrorEstimation::computeAnglesFromDetPosition(
    const SiPixelCluster &cl, const GeomDetUnit &det, float &alpha,
    float &beta) {
  ...
  // make a global vector out of the global point; this vector will point from
  // the origin of the detector to the cluster
  ...
  // note that both gv and the basis {gvx, gvy, gvz} are given in global
  // coordinates
