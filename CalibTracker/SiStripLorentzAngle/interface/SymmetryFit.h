...
class SymmetryFit {
 ...
 public:
  ...
  static TH1* symmetryChi2(std::string, const std::vector<TH1*>&, std::pair<unsigned,unsigned>);
  static TH1* symmetryChi2(const TH1*, std::pair<unsigned,unsigned>);
 ...
 private:
  ...
  SymmetryFit(const TH1*, std::pair<unsigned,unsigned>);
