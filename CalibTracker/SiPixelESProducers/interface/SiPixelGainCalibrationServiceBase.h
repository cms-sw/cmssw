...
class SiPixelGainCalibrationServicePayloadGetter : public SiPixelGainCalibrationServiceBase {
 ...
 protected:
  ...
  void    throwExepctionForBadRead(const std::string& payload, const uint32_t& detID, const int& col, const int& row, double value = -1) const;
...
template<class thePayloadObject, class theDBRecordType>
void SiPixelGainCalibrationServicePayloadGetter<thePayloadObject,theDBRecordType>::throwExepctionForBadRead(const std::string& payload, const uint32_t& detID, const int& col, const int& row, const double value) const
{
