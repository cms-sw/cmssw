...
// Plugin adapted from Andrea Venturi's myTkAnalyses/PSTools to create Voltage
// (LV/HV) ON/OFF Tracke maps in the context of Strip DCS O2O.
...
void TkVoltageMapCreator::beginRun(const edm::Run &iRun,
  ...
  // TODO could make the root file name a parameter to avoid overwriting
  // everytime...
