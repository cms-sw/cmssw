...
{
  std::cout << "getNewObjects" << std::endl;
...
void popcon::SiStripModuleHVHandler::setForTransfer() { 
  ...
  std::cout << "popcon::SiStripModuleHVHandler::setForTransfer" << std::endl;
  ...
  std::cout << "popcon::SiStripModuleHVHandler::setForTransfer (after)" << std::endl;
