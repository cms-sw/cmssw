...
class Complex {
public:
  Complex(const double realInput, const double imgInput) : real(realInput), img(imgInput) {}
  ...
  bool operator==(const Complex& number) const { return (real == number.real && img == number.img); }
