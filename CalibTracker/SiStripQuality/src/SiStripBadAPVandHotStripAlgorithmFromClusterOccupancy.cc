...
void SiStripBadAPVandHotStripAlgorithmFromClusterOccupancy::initializeDQMHistograms()
{
  ...
  subDetName.emplace_back(""); subDetName.emplace_back("TIB"); subDetName.emplace_back("TID"); subDetName.emplace_back("TOB"); subDetName.emplace_back("TEC");
  nLayers.push_back(0); nLayers.push_back(4); nLayers.push_back(3); nLayers.push_back(6); nLayers.push_back(9);
  layerName.emplace_back(""); layerName.emplace_back("Layer"); layerName.emplace_back("Disk"); layerName.emplace_back("Layer"); layerName.emplace_back("Disk");
