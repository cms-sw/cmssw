...
process.MessageLogger = cms.Service("MessageLogger",
    log_offline_Th30 = cms.untracked.PSet(
        threshold = cms.untracked.string('INFO')
    ),
    destinations = cms.untracked.vstring('log_offline_Th30.txt')
)
...
process.siStripQualityESProducer.ReduceGranularity = cms.bool(True)
...
process.stat = cms.EDAnalyzer("SiStripQualityStatistics",
                              ...
                              TkMapFileName = cms.untracked.string("Offline_Th30/TkMapBadComponents_Offline_Th30.png")  #available filetypes: .pdf .png .jpg .svg
                              )
