...
//
/**\class CastorDbRecord CastorDbRecord.h
 CalibFormats/CastorDbProducer/interface/CastorDbRecord.h
...
class CastorDbRecord
    : public edm::eventsetup::DependentRecordImplementation<
          CastorDbRecord,
          boost::mpl::vector<CastorPedestalsRcd, CastorPedestalWidthsRcd,
                             CastorGainsRcd, CastorGainWidthsRcd,
                             CastorQIEDataRcd, CastorChannelQualityRcd,
