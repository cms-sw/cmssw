...
*/
  ...
  public:
    ...
    unsigned int nScanPoints(const std::string& dac) const { return nScanPoints(iScan(dac)); }
    ...
    unsigned int scanCounter(const std::string& dac, unsigned int state) const {
      return scanCounter(iScan(dac), state);
    }

    unsigned int scanValue(const std::string& dac, unsigned int state, PixelROCName roc) const {
    ...
    std::vector<unsigned int> scanValues(const std::string& dac) const { return scanValues(iScan(dac)); }

    double scanValueMin(const std::string& dac) const { return scanValueMin(iScan(dac)); }
    double scanValueMax(const std::string& dac) const { return scanValueMax(iScan(dac)); }
    double scanValueStep(const std::string& dac) const { return scanValueStep(iScan(dac)); }
    bool scanValuesMixedAcrossROCs(const std::string& dac) const { return scanValuesMixedAcrossROCs(iScan(dac)); }
