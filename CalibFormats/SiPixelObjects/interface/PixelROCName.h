...
*/
  ...
  public:
    ...
    int layer() const {assert((id_&0x80000000)!=0); return (id_>>12)&0x3;}    
    int ladder() const {assert((id_&0x80000000)!=0); return (id_>>6)&0x1f;}    
    char HF() const {assert((id_&0x80000000)!=0); return id_&0x00000800?'F':'H';}
