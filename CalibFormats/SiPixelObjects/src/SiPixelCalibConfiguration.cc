...
unsigned int SiPixelCalibConfiguration::iScan(std::string dac) const{

  for (unsigned int i=0;i<dacs_.size();i++){
    if (dac==dacs_[i].name()) return i;
  }

  std::cout << "In SiPixelCalibConfiguration::iScan could not find dac="
            << dac <<std::endl; 
...
unsigned int SiPixelCalibConfiguration::scanValue(unsigned int iscan,
...
unsigned int SiPixelCalibConfiguration::scanCounter(unsigned int iscan,
                                                 unsigned int state) const{
...
void SiPixelCalibConfiguration::nextFECState(PixelFECConfigInterface* pixelFEC,
...
std::vector<std::pair<unsigned int, std::vector<unsigned int> > >& SiPixelCalibConfiguration::fedCardsAndChannels(unsigned int crate,
...
std::map <unsigned int, std::set<unsigned int> > SiPixelCalibConfiguration::getFEDsAndChannels (PixelNameTranslation *translation) {
...
std::set <unsigned int> SiPixelCalibConfiguration::getFEDCrates(const PixelNameTranslation* translation, const PixelFEDConfig* fedconfig) const{
...
std::set <unsigned int> SiPixelCalibConfiguration::getFECCrates(const PixelNameTranslation* translation, const PixelFECConfig* fecconfig) const{
...
std::set <unsigned int> SiPixelCalibConfiguration::getTKFECCrates(const PixelPortcardMap *portcardmap, const std::map<std::string,PixelPortCardConfig*>& mapNamePortCard, const PixelTKFECConfig* tkfecconfig) const{
...
void SiPixelCalibConfiguration::enablePixels(PixelFECConfigInterface* pixelFEC,
...
void SiPixelCalibConfiguration::disablePixels(PixelFECConfigInterface* pixelFEC,
			      unsigned int irows, unsigned int icols,
			      PixelHdwAddress theROC) const{
...
std::string SiPixelCalibConfiguration::parameterValue(std::string parameterName) const
{
