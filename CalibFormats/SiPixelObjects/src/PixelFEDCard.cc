...
*/
  colNames.emplace_back("BUSYWHENBEHIND");
  colNames.emplace_back("FEATUREREGISTER");
  colNames.emplace_back("FIFO2LIMIT");
  colNames.emplace_back("TIMEOUTOROOSLIMIT");
  colNames.emplace_back("LASTDACOFF");
  colNames.emplace_back("SIMHITSPERROC");
  colNames.emplace_back("BUSYHOLDMIN");
  colNames.emplace_back("SPARE1");
  colNames.emplace_back("SPARE2");
  colNames.emplace_back("SPARE3");
  colNames.emplace_back("SPARE4");
  colNames.emplace_back("SPARE5");
  colNames.emplace_back("SPARE6");
  colNames.emplace_back("SPARE7");
  colNames.emplace_back("SPARE8");
  colNames.emplace_back("SPARE9");
  colNames.emplace_back("SPARE10");
  ...
  colNames.emplace_back("VME_ADDRS_HEX");
  colNames.emplace_back("PIXEL_FED");
  colNames.emplace_back("CHANNEL_ID");
  colNames.emplace_back("NUM_ROCS");
  colNames.emplace_back("CHAN_OFFST_DAC");
  colNames.emplace_back("CHAN_DELAY");
  colNames.emplace_back("CHAN_BHIGH");
  colNames.emplace_back("CHAN_BLOW");
  colNames.emplace_back("CHAN_UB");
  colNames.emplace_back("OPT1_CAP");
  colNames.emplace_back("OPT2_CAP");
  colNames.emplace_back("OPT3_CAP");
  colNames.emplace_back("OPT1_INP");
  colNames.emplace_back("OPT2_INP");
  colNames.emplace_back("OPT3_INP");
  colNames.emplace_back("OPT1_OUT");
  colNames.emplace_back("OPT2_OUT");
  colNames.emplace_back("OPT3_OUT");
  colNames.emplace_back("NORTH_CLKPHB");
  colNames.emplace_back("NORTHCENTER_CLKPHB");
  colNames.emplace_back("SOUTHCENTER_CLKPHB");
  colNames.emplace_back("SOUTH_CLKPHB");
  colNames.emplace_back("NORTH_CTRL");
  colNames.emplace_back("NORTHCENTER_CTRL");
  colNames.emplace_back("SOUTHCENTER_CTRL");
  colNames.emplace_back("SOUTH_CTRL");
  colNames.emplace_back("REG0_TTCRX_FDLA");
  colNames.emplace_back("REG1_TTCRX_FDLA");
  colNames.emplace_back("REG2_TTCRX_CDLA");
  colNames.emplace_back("REG3_TTCRX_CLKD2");
  colNames.emplace_back("CENTER_CTRL");
  colNames.emplace_back("CENTER_MODE");
  colNames.emplace_back("B1_ADCGN");
  colNames.emplace_back("B2_ADCGN");
  colNames.emplace_back("B3_ADCGN");
  colNames.emplace_back("B4_ADCGN");
  colNames.emplace_back("NORTH_BADJ");
  colNames.emplace_back("NORTHCENTER_BADJ");
  colNames.emplace_back("SOUTHCENTER_BADJ");
  colNames.emplace_back("SOUTH_BADJ");
  colNames.emplace_back("NORTH_TBMMASK");
  colNames.emplace_back("NORTHCENTER_TBMMASK");
  colNames.emplace_back("SOUTHCENTER_TBMMASK");
  colNames.emplace_back("SOUTH_TBMMASK");
  colNames.emplace_back("NORTH_PWORD");
  colNames.emplace_back("NORTHCENTER_PWORD");
  colNames.emplace_back("SOUTH_PWORD");
  colNames.emplace_back("SOUTHCENTER_PWORD");
  colNames.emplace_back("SPECDAC");
  colNames.emplace_back("OOS_LVL");
  colNames.emplace_back("ERR_LVL");
  colNames.emplace_back("NORTH_FIFO1_BZ_LVL");
  colNames.emplace_back("NORTHCENTER_FIFO1_BZ_LVL");
  colNames.emplace_back("SOUTHCENTER_FIFO1_BZ_LVL");
  colNames.emplace_back("SOUTH_FIFO1_BZ_LVL");
  colNames.emplace_back("FIFO3_WRN_LVL");
  colNames.emplace_back("FED_MASTER_DELAY");
  colNames.emplace_back("NO_HITLIMIT");
  colNames.emplace_back("NC_HITLIMIT");
  colNames.emplace_back("SC_HITLIMIT");
  colNames.emplace_back("SO_HITLIMIT");
  colNames.emplace_back("NO_TESTREG");
  colNames.emplace_back("NC_TESTREG");
  colNames.emplace_back("SC_TESTREG");
  colNames.emplace_back("SO_TESTREG");
  colNames.emplace_back("TRIGGERHOLDOFF");
...
void PixelFEDCard::readDBTBMLevels(std::vector<std::vector<std::string> > &tableMat, int firstRow, int lastRow) {
  ...
  */
  ...
  colNames.emplace_back("PIXEL_FED");
  colNames.emplace_back("FED_CHAN");
  colNames.emplace_back("TBMA_HEAD_L0");
  colNames.emplace_back("TBMA_HEAD_L1");
  colNames.emplace_back("TBMA_HEAD_L2");
  colNames.emplace_back("TBMA_HEAD_L3");
  colNames.emplace_back("TBMA_HEAD_L4");
  colNames.emplace_back("TBMA_TRAIL_L0");
  colNames.emplace_back("TBMA_TRAIL_L1");
  colNames.emplace_back("TBMA_TRAIL_L2");
  colNames.emplace_back("TBMA_TRAIL_L3");
  colNames.emplace_back("TBMA_TRAIL_L4");
  colNames.emplace_back("TBMA_HEAD_B");
  colNames.emplace_back("TBMA_HEAD_UB");
  colNames.emplace_back("TBMA_TRAIL_B");
  colNames.emplace_back("TBMA_TRAIL_UB");
  /*
...
void PixelFEDCard::readDBROCLevels(std::vector<std::vector<std::string> > &tableMat, int firstRow, int lastRow) {
  ...
  */
  ...
  colNames.emplace_back("FED_ROC_NUM");
  colNames.emplace_back("PIXEL_FED");
  colNames.emplace_back("FED_CHAN");
  colNames.emplace_back("ROC_L0");
  colNames.emplace_back("ROC_L1");
  colNames.emplace_back("ROC_L2");
  colNames.emplace_back("ROC_L3");
  colNames.emplace_back("ROC_L4");
  colNames.emplace_back("ROC_B");
  colNames.emplace_back("ROC_UB");
  /*
  colNames.push_back("CONFIG_KEY_ID"    );
  colNames.push_back("CONFIG_KEY"       );
  colNames.push_back("VERSION"          );
