...
process.TPGParamProducer = cms.EDFilter("EcalTPGParamBuilder",
    ...
    outFile = cms.string('TPG_beamv4_128.txt'), #modif
   #### TPG config tag and version (if not given it will be automatically given ) ####
    TPGtag = cms.string('BEAMV4_128'),
   ...
   #### TPG calculation parameters ####
    ...
    SFGVB_Threshold = cms.uint32(25),        ## used with option forcedPedestalValue = -3 NOTE: depends on saturation scale (50 for 64 GeV) 
