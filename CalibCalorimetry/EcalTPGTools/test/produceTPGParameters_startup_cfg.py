...
process.TPGParamProducer = cms.EDFilter("EcalTPGParamBuilder",
   ...
   #### TPG calculation parameters ####
    ...
    LUT_threshold_EB = cms.double(1.5625),  ## All Trigger Primitives <= threshold (in GeV) will be set to 0 
    LUT_threshold_EE = cms.double(1.5625),  ## All Trigger Primitives <= threshold (in GeV) will be set to 0 
