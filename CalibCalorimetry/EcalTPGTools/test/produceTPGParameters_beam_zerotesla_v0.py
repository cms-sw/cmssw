...
process.TPGParamProducer = cms.EDFilter("EcalTPGParamBuilder",
    ...
    outFile = cms.string('TPG_beam_ztv0.txt'), #modif
   #### TPG config tag and version (if not given it will be automatically given ) ####
    TPGtag = cms.string('BEAM_ZEROTESLA_V0'), #modif
   ...
   #### TPG calculation parameters ####
    ...
    LUT_threshold_EE = cms.double(0.300),    ## All Trigger Primitives <= threshold (in GeV) will be set to 0  #modif
