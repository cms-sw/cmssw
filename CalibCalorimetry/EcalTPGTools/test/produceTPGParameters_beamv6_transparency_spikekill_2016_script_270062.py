...
#process.CondDB.connect = 'oracle://cms_orcon_prod/CMS_COND_31X_ECAL' ##P5 stuff
#process.CondDB.connect = 'oracle://cms_orcon_adg/CMS_COND_31X_ECAL' ##lxplus DBv1 obsolete
...
#    DBsid   = cms.string('cms_omds_lb'), ## real DB 
    DBsid   = cms.string('cms_orcon_adg'), ## real DB on lxplus
...
#    DBpass  = cms.string('0r4cms_3c4lc0nf'),
    ...
    outFile = cms.string('TPG_beamv6_trans_270062_spikekill.txt'),
   ...
   #### TPG calculation parameters ####
    ...
    transparency_corrections = cms.string('/afs/cern.ch/cms/ECAL/triggerTransp/weekly_270062'), # transparency corr to be used to compute linearizer parameters 1/crystal

    SFGVB_Threshold = cms.uint32(12),             ## (adc) SFGVB threshold in FE
    SFGVB_lut = cms.uint32(0xfffefee8),           ## SFGVB LUT in FE                                
    SFGVB_SpikeKillingThreshold = cms.int32(12),  ## (GeV) Spike killing threshold applied in TPG ET in TCC (-1 no killing)
