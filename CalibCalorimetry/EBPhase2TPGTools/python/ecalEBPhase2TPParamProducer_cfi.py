...
cms.untracked.string('../../../SimCalorimetry/EcalEBTrigPrimProducers/data/CMSSWPhaseIIPulseGraphAlt.root'),
...
outputFile = cms.untracked.string('../../../SimCalorimetry/EcalEBTrigPrimProducers/data/TEST.txt.gz'),
