  ...
  if( fEcnaParPathsEB->GetPaths() == kTRUE && fEcnaParPathsEE->GetPaths() == kTRUE )
    {
      ...
      TEcnaHistos* MyHistosEB = new TEcnaHistos(myTEcnaManagerEB, "EB");       xCnew++;
      TEcnaHistos* MyHistosEE = new TEcnaHistos(myTEcnaManagerEE, "EE");       xCnew++;
...
#define SIGE
      ...
      fMyRootFileEE->FileParameters(fKeyAnaType,   fKeyNbOfSamples,
				    fKeyRunNumber, fKeyFirstEvt,
				    fKeyLastEvt,   fKeyNbOfEvts,
				    fKeyDeeNumber, fEcnaParPathsEE->ResultsRootFilePath().Data());
      ...
      if( fMyRootFileEE->LookAtRootFile() == kTRUE )
	{
      ...
      MyHistosEE->FileParameters(fKeyAnaType.Data(), fKeyNbOfSamples, fKeyRunNumber,
				 fKeyFirstEvt, fKeyLastEvt, fKeyNbOfEvts, fKeyDeeNumber);
      MyHistosEE->SetHistoScaleY("LIN");
      MyHistosEE->SetHistoMin(); MyHistosEE->SetHistoMax();
