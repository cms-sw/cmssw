...
DetId MiscalibReaderFromXMLEcalEndcap::parseCellEntry(
...
EEDetId MiscalibReaderFromXMLEcalEndcap::getCellFromAttributes(int ix, int iy,
                                                               int iz) {
  ...
  {
    std::cout << "Null coordinates = " << ix << "," << iy << "," << iz
              << std::endl;
    return EEDetId(0);
  }
}
