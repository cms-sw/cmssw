...
//
/**\class CaloMiscalibTools CaloMiscalibTools.h
 CalibCalorimetry/CaloMiscalibTools/interface/CaloMiscalibTools.h
...
CaloMiscalibTools::CaloMiscalibTools(const edm::ParameterSet &iConfig) {
  ...
  barrelfileinpath_ =
      iConfig.getUntrackedParameter<std::string>("fileNameBarrel", "");
  endcapfileinpath_ =
      iConfig.getUntrackedParameter<std::string>("fileNameEndcap", "");

  edm::FileInPath barrelfiletmp("CalibCalorimetry/CaloMiscalibTools/data/" +
                                barrelfileinpath_);
  edm::FileInPath endcapfiletmp("CalibCalorimetry/CaloMiscalibTools/data/" +
                                endcapfileinpath_);
...
CaloMiscalibTools::produce(const EcalIntercalibConstantsRcd &iRecord) {
  ...
  CaloMiscalibTools::ReturnType mydata =
      std::make_unique<EcalIntercalibConstants>(map.get());
  //    std::cout<<"mydata "<<mydata<<std::endl;
  return mydata;
}

void CaloMiscalibTools::setIntervalFor(
