...
//
/**\class CaloMiscalibToolsMC CaloMiscalibToolsMC.h
 CalibCalorimetry/CaloMiscalibToolsMC/interface/CaloMiscalibToolsMC.h
...
CaloMiscalibToolsMC::produce(const EcalIntercalibConstantsMCRcd &iRecord) {
  ...
  CaloMiscalibToolsMC::ReturnType mydata =
      std::make_unique<EcalIntercalibConstantsMC>(map.get());
  //    std::cout<<"mydata "<<mydata<<std::endl;
  return mydata;
}

void CaloMiscalibToolsMC::setIntervalFor(
