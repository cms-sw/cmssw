...
//
/**\class WriteEcalMiscalibConstantsMC WriteEcalMiscalibConstantsMC.cc
 CalibCalorimetry/WriteEcalMiscalibConstantsMC/src/WriteEcalMiscalibConstantsMC.cc
  ...
  if (poolDbService.isAvailable()) {
    if (poolDbService->isNewTagRequest(newTagRequest_)) {
      ...
      poolDbService->createNewIOV<const EcalIntercalibConstantsMC>(
          Mcal, poolDbService->beginOfTime(), poolDbService->endOfTime(),
          newTagRequest_);
