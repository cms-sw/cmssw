...
//
/**\class CaloMiscalibToolsMC CaloMiscalibToolsMC.cc
 CalibCalorimetry/CaloMiscalibToolsMC/src/CaloMiscalibToolsMC.cc
...
class CaloMiscalibToolsMC : public edm::ESProducer,
