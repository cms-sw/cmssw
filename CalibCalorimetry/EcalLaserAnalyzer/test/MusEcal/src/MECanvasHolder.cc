...
void 
MECanvasHolder::SetCanvas( TCanvas* canvas, const char* textTL, const char* textBL, const char* textTR, const char* textBR ) 
{
  assert( canvas!=0 );
  ...
  TString fStringBL(textBL); //        = "Visit our Twiki page at https://twiki.cern.ch/twiki/bin/view/CMS/EcalLaserMonitoring";
