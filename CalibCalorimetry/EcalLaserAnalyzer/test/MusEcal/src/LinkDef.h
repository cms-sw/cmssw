...
#pragma link C++ class MEEBDisplay+;
#pragma link C++ class MEEEDisplay+;
#pragma link C++ class MECanvasHolder+;
#pragma link C++ class MEClickableCanvas+;
#pragma link C++ class MEPlotWindow+;
#pragma link C++ class MERunPanel+;
