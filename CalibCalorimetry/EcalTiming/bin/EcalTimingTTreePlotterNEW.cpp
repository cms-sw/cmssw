...
//1-D TGraphs  
  ...
  TChain *eventTimingInfoTree = new TChain("eventTimingInfoTree");
  eventTimingInfoTree ->Add("/data/cms004/oradata/BEAM10/Comb/Comb/Timing_goodCollisions_1X.root");
  eventTimingInfoTree->Add("/data/cms004/oradata/BEAM10/Comb/Comb/Timing_goodCollisions_2X.root");
  eventTimingInfoTree ->Add("/data/cms004/oradata/BEAM10/Comb/Comb/Timing_goodCollisions_3X.root");
  eventTimingInfoTree->Add("/data/cms004/oradata/BEAM10/Comb/Comb/Timing_goodCollisions_4X.root");
  eventTimingInfoTree->Add("/data/cms004/oradata/BEAM10/Comb/Comb/Timing_goodCollisions_5X.root");
  eventTimingInfoTree->Add("/data/cms004/oradata/BEAM10/Comb/Comb/Timing_goodCollisions_6X.root");
  eventTimingInfoTree->Add("/data/cms004/oradata/BEAM10/Comb/Comb/Timing_goodCollisions_7X.root");
  eventTimingInfoTree->Add("/data/cms004/oradata/BEAM10/Comb/Comb/Timing_goodCollisions_8X.root");
  eventTimingInfoTree->Add("/data/cms004/oradata/BEAM10/Comb/Comb/Timing_goodCollisions_9X.root");
  eventTimingInfoTree->Add("/data/cms004/oradata/BEAM10/Comb/Comb/Timing_goodCollisions_10X.root");


  //TTree* eventTimingInfoTree = ((TTree*) f->Get("eventTimingInfoTree"));
  //TTree* eventTimingInfoTree = myChain->GetTree();
  ...
  TH1F *hctEB    = new TH1F("hctEB",  Form("%s EB Crystal Times;Time (ns);Number of Crystals",runChar),500, -EBTimeMax, EBTimeMax);
  ...
  TH1F *hctEEmBh = new TH1F("hctEEmBh", Form("%s EE- (-10ns to 10ns) EE+ (-30ns to -10ns) ;EE- Time (ns);Number of Crystals",runChar),500, -EETimeMax, EETimeMax);
  
  
  TH2F *hctEEtoAve  = new TH2F("hctEEtoAve", Form("%s EE Crystal Times to Average Time;Crystal Time (ns);Average EE Event Time (ns)",runChar),200, -EETimeMax, EETimeMax, 200, -EETimeMax, EETimeMax);
  TH2F *hctEBtoAve  = new TH2F("hctEBtoAve", Form("%s EB Crystal Times to Average Time;Crystal Time (ns);Average EB Event Time (ns)",runChar),200, -EBTimeMax, EBTimeMax, 200, -EBTimeMax, EBTimeMax);

  TH2F *hctEBtoTerr   = new TH2F("hctEBtoTerr", Form("%s EB Crystal Times to Time Error;Crystal Time (ns);Crystal Time Error (ns)",runChar),200, -EBTimeMax, EBTimeMax, 100, 0, 5.0);
  TH2F *hctEEtoTerr   = new TH2F("hctEEtoTerr", Form("%s EE Crystal Times to Time Error;Crystal Time (ns);Crystal Time Error (ns)",runChar),200, -EETimeMax, EETimeMax, 100, 0, 5.0);
  TH2F *hctEBtoAmp    = new TH2F("hctEBtoAmp", Form("%s EB Crystal Times to Amplitude;Crystal Time (ns);Crystal Amplitude (GeV)",runChar),200, -EBTimeMax, EBTimeMax, 200, 0, 50.);
  TH2F *hctEEtoAmp    = new TH2F("hctEEtoAmp", Form("%s EE Crystal Times to Amplitude;Crystal Time (ns);Crystal Amplitude (GeV)",runChar),200, -EETimeMax, EETimeMax, 200, 0, 50.);
  TH2F *hctEBtoET    = new TH2F("hctEBtoET", Form("%s EB Crystal Times to E_{T};Crystal Time (ns);Crystal E_{T} (GeV)",runChar),200, -EBTimeMax, EBTimeMax, 200, 0, 30.);
  TH2F *hctEEtoET    = new TH2F("hctEEtoET", Form("%s EE Crystal Times to E_{T};Crystal Time (ns);Crystal E_{T} (GeV)",runChar),200, -EETimeMax, EETimeMax, 200, 0, 30.);
  TH2F *hctEBtoAmpEvt = new TH2F("hctEBtoAmpEvt", Form("%s EB Event Time to Crystal Amplitudes;Average EB Event Time (ns);Crystal Amplitude (GeV)",runChar),200, -EBTimeMax, EBTimeMax, 200, 0, 50.);
  TH2F *hctEEtoAmpEvt = new TH2F("hctEEtoAmpEvt", Form("%s EE Event Time to Crystal Amplitudes;Average EE Event Time (ns);Crystal Amplitude (GeV)",runChar),200, -EETimeMax, EETimeMax, 200, 0, 50.);
  TH2F *hctEEtoAmpErr = new TH2F("hctEEtoAmpErr", Form("%s EE Time Error to Crystal Amplitudes;Crystal Amplitude (GeV);Time Error (ns)",runChar),200, 0., 50., 100, 0., 5. );
  TH2F *hctEBtoAmpErr = new TH2F("hctEBtoAmpErr", Form("%s EB Time Error to Crystal Amplitudes;Crystal Amplitude (GeV);Time Error (ns)",runChar),200, 0., 50., 100, 0., 5. );
  ...
  TH2F *hctEBtoHashed = new TH2F("hctEBtoHashed",Form("%s EB Hashed Index to Time;EB Hashed Index;Time(ns)",runChar),62000,0.,62000., 100, -EBTimeMax, EBTimeMax);
  TH2F *hctEEtoHashed = new TH2F("hctEEtoHashed",Form("%s EE Hashed Index to Time;EE Hashed Index;Time(ns)",runChar),15000,0.,15000., 100, -EETimeMax, EETimeMax);

  TH1F *hctEBCry   = new TH1F("hctEBCry",Form("%s EB Number of Crystals;Number of EB crystals",runChar),150,0,150);
  TH1F *hctEECry   = new TH1F("hctEECry",Form("%s EE Number of Crystals;Number of EE crystals",runChar),150,0,150);
  TH2F *hctEBCryT  = new TH2F("hctEBCryT",Form("%s EB Number of Crystals to EB average time;EB average time (ns);Number of EB crystals",runChar),200, -EBTimeMax, EBTimeMax,50,0,50);
  TH2F *hctEEpCryT  = new TH2F("hctEEpCryT",Form("%s EE Number of Crystals to EE+ average time;EE+ average time (ns);Number of EE+ crystals",runChar),200, -EETimeMax, EETimeMax,50,0,50);
  TH2F *hctEEmCryT  = new TH2F("hctEEmCryT",Form("%s EE Number of Crystals to EE- average time;EE- average time (ns);Number of EE- crystals",runChar),200, -EETimeMax, EETimeMax,50,0,50);

  TH2F *hctEEMEEP      = new TH2F("hctEEMEEP",Form("%s EE+ average time to EE- average time;EE- average time (ns);EE+ average time (ns)",runChar),200, -EETimeMax, EETimeMax,200, -EETimeMax, EETimeMax);
  TH2F *hctEEMDEEPcry  = new TH2F("hctEEMDEEPcry",Form("%s EE- minus EE+ average time vs EE crystals;(EEM - EEP) average time (ns);Number EE crystals",runChar),200, -EETimeMax, EETimeMax,50,0, 50);
  TH1F *hctEEMDEEP     = new TH1F("hctEEMDEEP",Form("%s EE- minus EE+ average time;(EEM - EEP) average time (ns)",runChar),500, -EETimeMax, EETimeMax);
  
  TH2F *hctEEcryamp   = new TH2F("hctEEcryamp",Form("%s EE amplitudes vs number of crystals;Crystal Amp (GeV);Number EE crystals",runChar),200,0.,50.,50,0, 50);
  TH2F *hctEBcryamp   = new TH2F("hctEBcryamp",Form("%s EB amplitudes vs number of crystals;Crystal Amp (GeV);Number EB crystals",runChar),200,0.,50.,50,0, 50);

  TH1F *hctE1OE9   = new TH1F("hctE1OE9",  Form("%s EB E1/E9; E1/E9",runChar),500,0.,1.2);
  TH1F *hctKSwissK = new TH1F("hctKSwissK",Form("%s EB KSwissCross; KSwissCross (1-e4/e1)",runChar),500,-0.6,1.);


  TH1F *hEBTimeEtaLess5 = new TH1F("hEBTimeEtaLess5",Form("%s EB Timing |ieta|<5; Crystal Time (ns); Entries",runChar),500, -EBTimeMax, EBTimeMax);
  TH1F *hEBPlusTime     = new TH1F("hEBPlusTime", Form("%s EB+ Timing; Crystal Time (ns); Entries",runChar),500, -EBTimeMax, EBTimeMax);
  TH1F *hEBMinusTime    = new TH1F("hEBMinusTime",Form("%s EB- Timing; Crystal Time (ns); Entries",runChar),500, -EBTimeMax, EBTimeMax);
  TH2F *hEBPlus2Minus   = new TH2F("hEBPlus2Minus",Form("%s EB+ to EB- Timing; EB+ Average Time (ns); EB- Average Time (ns)",runChar),200, -EBTimeMax,EBTimeMax,200, -EBTimeMax,EBTimeMax);
  TH2F *hEEPlus2Minus   = new TH2F("hEEPlus2Minus",Form("%s EE+ to EE- Timing; EE+ Average Time (ns); EE- Average Time (ns)",runChar),200, -EETimeMax, EBTimeMax,200, -EBTimeMax, EBTimeMax);
  TH1F *hLumi           = new TH1F("hLumi" ,     Form("%s LumiSection Occupancy ; Lumi Section",runChar),int(maxlumi-minlumi), minlumi, maxlumi);
  TH1F *hAbsTime        = new TH1F("hAbsTime" ,     Form("%s Timing Occupancy ; Event Time Since Run Start (mins)",runChar),1000, 0., diffTime);
  ...
  TH2F *hAbsTimeVsEBPTime = new TH2F("hAbsTimeVsEBPTime",Form("%s EB+ Average Timing vs. Absolute Time; EB+ Average Time (ns); Minutes since run start",runChar),200, -EBTimeMax, EBTimeMax, 5000, 0., diffTime);
  TH2F *hAbsTimeVsEBMTime = new TH2F("hAbsTimeVsEBMTime",Form("%s EB- Average Timing vs. Absolute Time; EB- Average Time (ns); Minutes since run start",runChar),200, -EBTimeMax, EBTimeMax, 5000, 0., diffTime);
  TH2F *hAbsTimeVsEEPTime = new TH2F("hAbsTimeVsEEPTime",Form("%s EE+ Average Timing vs. Absolute Time; EE+ Average Time (ns); Minutes since run start",runChar),200, -EETimeMax, EETimeMax, 5000, 0., diffTime);
  TH2F *hAbsTimeVsEEMTime = new TH2F("hAbsTimeVsEEMTime",Form("%s EE- Average Timing vs. Absolute Time; EE- Average Time (ns); Minutes since run start",runChar),200, -EETimeMax, EETimeMax, 5000, 0., diffTime);
  TH2F *hTriggerVsEBPTime  = new TH2F("hTriggerVsEBPTime",Form("%s EB+ Average Timing vs. Trigger; EB+ Average Time (ns); Active Trigger Bits",runChar),200, -EBTimeMax, EBTimeMax, maxTrig, 0., maxTrig);
  TH2F *hTTriggerVsEBPTime = new TH2F("hTTriggerVsEBPTime",Form("%s EB+ Average Timing vs. Technical Trigger; EB+ Average Time (ns); Active Technical Trigger Bits",runChar),200, -EBTimeMax, EBTimeMax, maxTTrig, 0., maxTTrig);
  TH2F *hTriggerVsEBMTime  = new TH2F("hTriggerVsEBMTime",Form("%s EB- Average Timing vs. Trigger; EB- Average Time (ns); Active Trigger Bits",runChar),200, -EBTimeMax, EBTimeMax, maxTrig, 0., maxTrig);
  TH2F *hTTriggerVsEBMTime = new TH2F("hTTriggerVsEBMTime",Form("%s EB- Average Timing vs. Technical Trigger; EB- Average Time (ns); Active Technical Trigger Bits",runChar),200, -EBTimeMax, EBTimeMax, maxTTrig, 0., maxTTrig);
  TH2F *hTriggerVsEEPTime  = new TH2F("hTriggerVsEEPTime",Form("%s EE+ Average Timing vs. Trigger; EE+ Average Time (ns); Active Trigger Bits",runChar),200, -EETimeMax, EETimeMax, maxTrig, 0., maxTrig);
  TH2F *hTTriggerVsEEPTime = new TH2F("hTTriggerVsEEPTime",Form("%s EE+ Average Timing vs. Technical Trigger; EE+ Average Time (ns); Active Technical Trigger Bits",runChar),200, -EETimeMax, EETimeMax, maxTTrig, 0., maxTTrig);
  TH2F *hTriggerVsEEMTime  = new TH2F("hTriggerVsEEMTime",Form("%s EE- Average Timing vs. Trigger; EE- Average Time (ns); Active Trigger Bits",runChar),200, -EETimeMax, EETimeMax, maxTrig, 0., maxTrig);
  TH2F *hTTriggerVsEEMTime = new TH2F("hTTriggerVsEEMTime",Form("%s EE- Average Timing vs. Technical Trigger; EE- Average Time (ns); Active Technical Trigger Bits",runChar),200, -EETimeMax, EETimeMax, maxTTrig, 0., maxTTrig);
  TH2F *hBXVsEBPTime = new TH2F("hBXVsEBPTime",Form("%s EB+ Average Timing vs. BX; EB+ Average Time (ns); BX",runChar),200, -EBTimeMax, EBTimeMax, 3500, 0., 3500);
  TH2F *hBXVsEBMTime = new TH2F("hBXVsEBMTime",Form("%s EB- Average Timing vs. BX; EB- Average Time (ns); BX",runChar),200, -EBTimeMax, EBTimeMax, 3500, 0., 3500);
  TH2F *hBXVsEEPTime = new TH2F("hBXVsEEPTime",Form("%s EE+ Average Timing vs. BX; EE+ Average Time (ns); BX",runChar),200, -EETimeMax, EETimeMax, 3500, 0., 3500);
  TH2F *hBXVsEEMTime = new TH2F("hBXVsEEMTime",Form("%s EE- Average Timing vs. BX; EE- Average Time (ns); BX",runChar),200, -EETimeMax, EETimeMax, 3500, 0., 3500);
  TH2F *hTriggerVsAbsTime  = new TH2F("hTriggerVsAbsTime",Form("%s Absolute Time vs. Trigger;Minutes Since Run Start ; Active Trigger Bits",runChar),500, 0, diffTime, maxTrig, 0., maxTrig);
  TH2F *hTTriggerVsAbsTime  = new TH2F("hTTriggerVsAbsTime",Form("%s Absolute Time vs. Tech Trigger;Minutes Since Run Start ; Active Technical Trigger Bits",runChar),500, 0, diffTime, maxTTrig, 0., maxTTrig);
  TH2F *hBXVsAbsTime   = new TH2F("hBXVsAbsTime",Form("%s Absolute Time vs. BX;Minutes Since Run Start ; BX",runChar),500, 0, diffTime, 3500, 0., 3500);
 ...
 TH2F *hEBOccuBad = new TH2F("hEBOccuBad",Form("%s EB Occupancy for time < -9ns;i#phi;i#eta",runChar),360,1.,361.,171,-85.,86.);
  ...
  for (int i=0; i<nents;i++) {
     ...
     if ( abstime > 54800 )
       {
	 if( abstime < 55300 ) timediff = -2.0;
         else if (abstime < 55600 ) keepEvent = false;
       } 
     if(!keepEvent) continue;
     ...
     if ( abstime > 59500 )
       {
	 if( abstime < 59700 ) keepEvent=false;
       } 
     if(!keepEvent) continue;
