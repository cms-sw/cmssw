...
// (in particular, "setPulseShapeTemplate"/"resetPulseShapeTemplate" methods
// of MahiFit class which use the getShape(int) function).
...
public:
  ...
  // The tuple below contains the label, pulse delay, and pulse shape
