...
#    mapIOV = cms.uint32(7), # add QIEId into Lmap and also include OfflineDB and QIEMap
    mapIOV = cms.uint32(7), #
    generateHTRLmap   = cms.bool(True),
    generateuHTRLmap  = cms.bool(True),
    generateEmap      = cms.bool(True),
    generateOfflineDB = cms.bool(True),
    generateQIEMap    = cms.bool(True),
)
