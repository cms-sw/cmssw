...
EcalShowerContainmentCorrectionsESProducer::produce(
    const EcalShowerContainmentCorrectionsRcd &iRecord) {

  using namespace edm::es;
  using namespace std;

  auto pEcalShowerContainmentCorrections =
      std::make_unique<EcalShowerContainmentCorrections>();
  ...
  for (int xtal = 1; xtal <= 1700; ++xtal) {
    ...
    double values[] = {0.998959, // 3x3 x right
                       0.00124547, -0.000348259, 6.04065e-006,
                       0.999032, // 3x3 x left
                       7.90628e-005, -0.000175699, -2.60715e-007,
                       //
                       0.999983, // 3x3 y right
                       -0.000132085, 2.04773e-005, -1.21629e-005,
                       1.00002, // 3x3 y left
                       0.00016518, 5.36343e-005, 1.32094e-005,
                       //
                       0.998944, // 5x5
                       0.00100987, -0.000223207, 2.15615e-006, 0.999127,
                       0.000253437, -9.80656e-005, 1.48651e-006, 1.00006,
                       -0.000179675, 8.15627e-005, -1.21549e-005, 1.00022,
                       0.000363728, 0.000128066, 1.54473e-005};
