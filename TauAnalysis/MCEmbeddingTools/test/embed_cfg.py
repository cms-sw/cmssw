...
process.source = cms.Source("PoolSource",
    ...
    ##eventsToProcess = cms.untracked.VEventRange('1:1:6')
)
...
process.outputFiles = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/data1/veelken/CMSSW_5_3_x/skims/simDYmumu_embedded_mutau_2012Dec12_AOD.root'),                                   
