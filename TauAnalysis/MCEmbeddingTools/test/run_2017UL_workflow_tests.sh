...
dataset="root://eosuser.cern.ch//eos/user/c/cwinter/embedding_test_root_files/2017_B-v1_RAW_preselected.root"
...
cmsDriver.py RECO \
    ...
    --datatier RAWRECO \
    --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2017,TauAnalysis/MCEmbeddingTools/customisers.customiseSelecting_Reselect \
    --filein $dataset \
...
cmsDriver.py LHEprodandCLEAN \
    ...
    --eventcontent RAWRECO \
    --datatier RAWRECO \
    --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2017,TauAnalysis/MCEmbeddingTools/customisers.customiseLHEandCleaning_Reselect \
