...
### Updating to  HLT paths to be monitored by TOP PAG in 2017                                                                                                               
        vsPaths      = cms.untracked.vstring(['HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v*', 'HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v*','HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v*']),
)
...
DiElectronHLTValidation = cms.EDAnalyzer('TopDiLeptonHLTValidation',
        ...
        iTrigger     = cms.untracked.InputTag("TriggerResults","","HLT"),
### Updating to HLT paths to be monitored by TOP PAG in 2017                                                                                                                 
        vsPaths      = cms.untracked.vstring(['HLT_Ele12_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v*']),
)
...
ElecMuonHLTValidation = cms.EDAnalyzer('TopDiLeptonHLTValidation',
        ...
        iTrigger     = cms.untracked.InputTag("TriggerResults","","HLT"),
### Updating to HLT paths to be monitored by TOP PAG in 2017                                                                                                                 
        vsPaths      = cms.untracked.vstring(['HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v*','HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v*']),
)
