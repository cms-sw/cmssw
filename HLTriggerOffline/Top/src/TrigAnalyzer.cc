// -*- C++ -*-
//
// Package:    TrigAnalyzer
// Class:      TrigAnalyzer
// 
/**\class TrigAnalyzer TrigAnalyzer.cc Top/src/TrigAnalyzer.cc
...
//////
void TrigAnalyzer::efficiencies (TH1F *select, TH1F *path1,TH1F *path2, TH1F *path3, TH1F *path4,
...
void 
TrigAnalyzer::beginJob(const edm::EventSetup&)
{
  
 
  
 TFileDirectory subDirmu     = fs->mkdir("semimuEvents");
 TFileDirectory subDirel     = fs->mkdir("semielEvents");
 TFileDirectory subDirdimu   = fs->mkdir("dimuEvents");
 TFileDirectory subDirdiel   = fs->mkdir("dielEvents");
 TFileDirectory subDiremu    = fs->mkdir("emuEvents");
 TFileDirectory subDirEventType = fs->mkdir("NEvents");
 
 
  /////// histos pt, eta
  
   //semimu events 
    eta_trig_off_mu          = subDirmu.make<TH1F> ("eta_trig_off_mu","eta_trig_off_mu",51,-2.1,2.1);
    eta_off_mu               = subDirmu.make<TH1F> ("eta_off_mu","eta_off_mu",51,-2.1,2.1);
    pt_trig_off_mu           = subDirmu.make<TH1F> ("pt_trig_off_mu","pt_trig_off_mu",120,0.0,150.0);
    pt_off_mu                = subDirmu.make<TH1F> ("pt_off_mu","pt_off_mu",120,0.0,150.0);
    
 
     //semiel events  
    eta_trig_off_el          = subDirel.make<TH1F> ("eta_trig_off_el","eta_trig_off_el",51,-2.1,2.1);
    eta_off_el               = subDirel.make<TH1F> ("eta_off_el","eta_off_el",51,-2.1,2.1);
    pt_trig_off_el           = subDirel.make<TH1F> ("pt_trig_off_el","pt_trig_off_el",120,0.0,150.0);
    pt_off_el                = subDirel.make<TH1F> ("pt_off_el","pt_off_el",120,0.0,150.0);
    
     pt_trig_off_el_ni           = subDirel.make<TH1F> ("pt_trig_off_el_ni","pt_trig_off_el_ni",120,0.0,150.0);
     pt_trig_off_el_li           = subDirel.make<TH1F> ("pt_trig_off_el_li","pt_trig_off_el_li",120,0.0,150.0);
     eta_trig_off_el_ni          = subDirel.make<TH1F> ("eta_trig_off_el_ni","eta_trig_off_el_ni",51,-2.1,2.1);
     eta_trig_off_el_li          = subDirel.make<TH1F> ("eta_trig_off_el_li","eta_trig_off_el_li",51,-2.1,2.1);
 
    
    //dimu events
    eta_trig_off_dimu0       = subDirdimu.make<TH1F> ("eta_trig_off_dimu0","eta_trig_off_dimu0",51,-2.1,2.1);
    eta_off_dimu0            = subDirdimu.make<TH1F> ("eta_off_dimu0","eta_off_dimu0",51,-2.1,2.1);
    pt_trig_off_dimu0        = subDirdimu.make<TH1F> ("pt_trig_off_dimu0","pt_trig_off_dimu0",120,0.0,150.0);
    pt_off_dimu0             = subDirdimu.make<TH1F> ("pt_off_dimu0","pt_off_dimu0",120,0.0,150.0);
    
    eta_trig_off_dimu1       = subDirdimu.make<TH1F> ("eta_trig_off_dimu1","eta_trig_off_dimu1",51,-2.1,2.1);
    eta_off_dimu1            = subDirdimu.make<TH1F> ("eta_off_dimu1","eta_off_dimu1",51,-2.1,2.1);
    pt_trig_off_dimu1        = subDirdimu.make<TH1F> ("pt_trig_off_dimu1","pt_trig_off_dimu1",120,0.0,150.0);
    pt_off_dimu1             = subDirdimu.make<TH1F> ("pt_off_dimu1","pt_off_dimu1",120,0.0,150.0);
  
    
    //diel events
    
    eta_trig_off_diel0       = subDirdiel.make<TH1F> ("eta_trig_off_diel0","eta_trig_off_diel0",51,-2.1,2.1);
    eta_off_diel0            = subDirdiel.make<TH1F> ("eta_off_diel0","eta_off_diel0",51,-2.1,2.1);
    pt_trig_off_diel0        = subDirdiel.make<TH1F> ("pt_trig_off_diel0","pt_trig_off_diel0",120,0.0,150.0);
    pt_off_diel0             = subDirdiel.make<TH1F> ("pt_off_diel0","pt_off_diel0",120,0.0,150.0);
    
    eta_trig_off_diel1       = subDirdiel.make<TH1F> ("eta_trig_off_diel1","eta_trig_off_diel1",51,-2.1,2.1);
    eta_off_diel1            = subDirdiel.make<TH1F> ("eta_off_diel1","eta_off_diel1",51,-2.1,2.1);
    pt_trig_off_diel1        = subDirdiel.make<TH1F> ("pt_trig_off_diel1","pt_trig_off_diel1",120,0.0,150.0);
    pt_off_diel1             = subDirdiel.make<TH1F> ("pt_off_diel1","pt_off_diel1",120,0.0,150.0);
  
    
    //emu events
    
    eta_trig_off_emu_muon    = subDiremu.make<TH1F> ("eta_trig_off_emu_muon","eta_trig_off_emu_muon",51,-2.1,2.1);
    eta_off_emu_muon         = subDiremu.make<TH1F> ("eta_off_emu_muon","eta_off_emu_muon",51,-2.1,2.1);
    pt_trig_off_emu_muon     = subDiremu.make<TH1F> ("pt_trig_off_emu_muon","pt_trig_off_emu_muon",120,0.0,150.0);
    pt_off_emu_muon          = subDiremu.make<TH1F> ("pt_off_emu_muon","pt_off_emu_muon",120,0.0,150.0);
    
    eta_trig_off_emu_electron = subDiremu.make<TH1F> ("eta_trig_off_emu_electron","eta_trig_off_emu_electron",51,-2.1,2.1);
    eta_off_emu_electron      = subDiremu.make<TH1F> ("eta_off_emu_electron","eta_off_emu_electron",51,-2.1,2.1);
    pt_trig_off_emu_electron  = subDiremu.make<TH1F> ("pt_trig_off_emu_electron","pt_trig_off_emu_electron",120,0.0,150.0);
    pt_off_emu_electron       = subDiremu.make<TH1F> ("pt_off_emu_electron","pt_off_emu_electron",120,0.0,150.0);
  
    OR_emu                    =   subDiremu.make<TH1F> ("or_emu","or_emu",10,0.0,2.0);
    OR_off_emu                =   subDiremu.make<TH1F> ("or_off_emu","or_off_emu",10,0.0,2.0);
    
    OR_emu_li                 =   subDiremu.make<TH1F> ("or_emu_li","or_emu_li",10,0.0,2.0);
    OR_off_emu_li             =   subDiremu.make<TH1F> ("or_off_emu_li","or_off_emu_li",10,0.0,2.0);
    
    OR_emu_ni                 =   subDiremu.make<TH1F> ("or_emu_ni","or_emu_ni",10,0.0,2.0);
    OR_off_emu_ni             =   subDiremu.make<TH1F> ("or_off_emu_ni","or_off_emu_ni",10,0.0,2.0);
