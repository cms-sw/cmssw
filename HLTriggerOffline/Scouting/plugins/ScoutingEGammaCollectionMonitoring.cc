...
ScoutingEGammaCollectionMonitoring::ScoutingEGammaCollectionMonitoring(
    ...
    : outputInternalPath_(
      ...
      electronCollection_(consumes<edm::View<pat::Electron>>(
      ...
      eleIdMapTightToken_(consumes<edm::ValueMap<bool>>(
          iConfig.getParameter<edm::InputTag>("eleIdMapTight"))) {}
...
void ScoutingEGammaCollectionMonitoring::dqmAnalyze(
  ...
  edm::LogInfo("ScoutingEGammaCollectionMonitoring")
  ...
  bool fire_doubleEG_DST =
      hasPatternInHLTPath(triggerNames, "DST_PFScouting_DoubleEG");
  bool fire_singlePhoton_DST =
  ...
  if (tight_patElectron_index.size() == 2) {
    histos.patElectron.h1InvMassID->Fill(
        (patEls->ptrAt(tight_patElectron_index[0])->p4() +
         patEls->ptrAt(tight_patElectron_index[1])->p4())
            .mass());
  }
  ...
  std::sort(sortedSctIdx.begin(), sortedSctIdx.end(), [&](int i, int j) {
    return sctEls->at(i).pt() > sctEls->at(j).pt();
  });
  ...
  if (!tight_sctElectron_index.empty() && sctEls->size() > 1) {
    math::PtEtaPhiMLorentzVector first_sct_el(
        sctEls->at(0).pt(), sctEls->at(0).eta(), sctEls->at(0).phi(),
        sctEls->at(0).m());
    math::PtEtaPhiMLorentzVector second_sct_el(
        sctEls->at(1).pt(), sctEls->at(1).eta(), sctEls->at(1).phi(),
        sctEls->at(1).m());
  ...
  if (tight_sctElectron_index.size() == 2) {
    math::PtEtaPhiMLorentzVector sctEl0(
        sctEls->at(tight_sctElectron_index[0]).pt(),
        sctEls->at(tight_sctElectron_index[0]).eta(),
        sctEls->at(tight_sctElectron_index[0]).phi(), ELECTRON_MASS);
    math::PtEtaPhiMLorentzVector sctEl1(
        sctEls->at(tight_sctElectron_index[1]).pt(),
        sctEls->at(tight_sctElectron_index[1]).eta(),
        sctEls->at(tight_sctElectron_index[1]).phi(), ELECTRON_MASS);
    size_t gsfTrkIdx0 = 9999, gsfTrkIdx1 = 9999;
    bool foundGoodGsfTrkIdx0 = scoutingElectronGsfTrackIdx(
        sctEls->at(tight_sctElectron_index[0]), gsfTrkIdx0);
    bool foundGoodGsfTrkIdx1 = scoutingElectronGsfTrackIdx(
        sctEls->at(tight_sctElectron_index[1]), gsfTrkIdx1);

    if (!foundGoodGsfTrkIdx0 || !foundGoodGsfTrkIdx1) return;

    math::PtEtaPhiMLorentzVector sctElCombined0(
        getPtFromEnergyMassEta(
            sctEl0.energy(), ELECTRON_MASS,
    ...
    if (fire_doubleEG_DST) {
      ...
      } else if (fabs(sctEls->at(tight_sctElectron_index[0]).eta()) <
                     ELE_etaEB &&
                 fabs(sctEls->at(tight_sctElectron_index[1]).eta()) >
                     ELE_etaEB) {
...
void ScoutingEGammaCollectionMonitoring::bookHistograms(
  ...
  histos.patElectron.h1InvMass12 = ibook.book1D(
      "patElectron_E1E2_invMass", "patElectron_E1E2_invMass", 400, 0., 200.);
  histos.patElectron.h1InvMassID =
      ibook.book1D("patElectron_appliedID_invMass",
                   "patElectron_appliedID_invMass", 400, 0., 200.);
  ...
  histos.sctElectron.h1InvMassID =
      ibook.book1D("sctElectron_appliedID_invMass",
                   "sctElectron_appliedID_invMass", 400, 0., 200.);
  histos.sctElectron.h1InvMassIDEBEB =
      ibook.book1D("sctElectron_EBEB_appliedID_invMass",
                   "sctElectron_EBEB_appliedID_invMass", 400, 0., 200.);
  histos.sctElectron.h1InvMassIDEBEE =
      ibook.book1D("sctElectron_EBEE_appliedID_invMass",
                   "sctElectron_EBEE_appliedID_invMass", 400, 0., 200.);
  histos.sctElectron.h1InvMassIDEEEE =
      ibook.book1D("sctElectron_EEEE_appliedID_invMass",
                   "sctElectron_EEEE_appliedID_invMass", 400, 0., 200.);

  histos.sctElectron.h1InvMassID_passDoubleEG_DST = ibook.book1D(
      "sctElectron_appliedID_invMass_passDoubleEG_DST",
      "sctElectron_appliedID_invMass_passDoubleEG_DST", 400, 0., 200.);
  histos.sctElectron.h1InvMassIDEBEB_passDoubleEG_DST = ibook.book1D(
      "sctElectron_EBEB_appliedID_invMass_passDoubleEG_DST",
      "sctElectron_EBEB_appliedID_invMass_passDoubleEG_DST", 400, 0., 200.);
  histos.sctElectron.h1InvMassIDEBEE_passDoubleEG_DST = ibook.book1D(
      "sctElectron_EBEE_appliedID_invMass_passDoubleEG_DST",
      "sctElectron_EBEE_appliedID_invMass_passDoubleEG_DST", 400, 0., 200.);
  histos.sctElectron.h1InvMassIDEEEE_passDoubleEG_DST = ibook.book1D(
      "sctElectron_EEEE_appliedID_invMass_passDoubleEG_DST",
      "sctElectron_EEEE_appliedID_invMass_passDoubleEG_DST", 400, 0., 200.);

  histos.sctElectron.h1InvMassID_passSinglePhoton_DST = ibook.book1D(
      "sctElectron_appliedID_invMass_passSinglePhoton_DST",
      "sctElectron_appliedID_invMass_passSinglePhoton_DST", 400, 0., 200.);
  histos.sctElectron.h1InvMassIDEBEB_passSinglePhoton_DST = ibook.book1D(
      ...
      "sctElectron_EBEB_appliedID_invMass_passSinglePhoton_DST", 400, 0., 200.);
  histos.sctElectron.h1InvMassIDEBEE_passSinglePhoton_DST = ibook.book1D(
      ...
      "sctElectron_EBEE_appliedID_invMass_passSinglePhoton_DST", 400, 0., 200.);
  histos.sctElectron.h1InvMassIDEEEE_passSinglePhoton_DST = ibook.book1D(
      ...
      "sctElectron_EEEE_appliedID_invMass_passSinglePhoton_DST", 400, 0., 200.);
}

// ------------ method fills 'descriptions' with the allowed parameters for the
// module  ------------
void ScoutingEGammaCollectionMonitoring::fillDescriptions(
...
bool ScoutingEGammaCollectionMonitoring::scoutingElectronID(
...
bool ScoutingEGammaCollectionMonitoring::scoutingElectronGsfTrackID(
    const Run3ScoutingElectron el, size_t trackIdx) const {
  ...
  math::PtEtaPhiMLorentzVector particleSC(el.pt(), el.eta(), el.phi(),
                                          ELECTRON_MASS);
  math::PtEtaPhiMLorentzVector particleTrk(
      el.trkpt()[trackIdx], el.trketa()[trackIdx], el.trkphi()[trackIdx],
      ELECTRON_MASS);
...
bool ScoutingEGammaCollectionMonitoring::scoutingElectronGsfTrackIdx(
    const Run3ScoutingElectron el, size_t& trackIdx) const {
...
bool ScoutingEGammaCollectionMonitoring::hasPatternInHLTPath(
    const edm::TriggerNames& triggerNames, const std::string& pattern) const {
  for (unsigned int i = 0; i < triggerNames.size(); ++i) {
    const std::string& triggerName = triggerNames.triggerName(i);

    // Check if triggerName starts with the specified prefix
    if (triggerName.find(pattern) ==
        0) {        // Position 0 means it starts with 'prefix'
