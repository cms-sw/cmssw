...
//
/**\class Run3ScoutingTrackToRecoTrackProducer Run3ScoutingTrackToRecoTrackProducer.cc HLTriggerOffline/Scouting/plugins/Run3ScoutingTrackToRecoTrackProducer.cc
...
#include "HLTriggerOffline/Scouting/interface/ScoutingDataConversion.h"
...
void Run3ScoutingTrackToRecoTrackProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  for (const auto& sTrack : *scoutingTracksH) {
    reco::Track recoTrack = dqm::makeRecoTrack(sTrack);
