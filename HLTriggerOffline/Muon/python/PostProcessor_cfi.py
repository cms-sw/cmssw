...
postProcessor = cms.EDFilter("PostProcessor",
    ...
    efficiency     = cms.vstring(
        ...
        "recTurnOn_L1Filtered 'L1 Turn On label=L1Filtered;Highest Reconstructed Muon p_{T} (GeV);L1 Pass / Reco (%)' recPassMaxPt_L1Filtered recPassMaxPt_All", 
        "recEffEta_L1Filtered 'L1 #eta Efficiency label=L1Filtered;Reconstructed Muon #eta;L1 Pass / Reco (%)' recPassEta_L1Filtered recPassEta_All", 
        "recEffPhi_L1Filtered 'L1 #phi Efficiency label=L1Filtered;Reconstructed Muon #phi;L1 Pass / Reco (%)' recPassPhi_L1Filtered recPassPhi_All", 
