...
hltTauValidationFolder_MC_IDEAL =  'HLT/TauRelVal/MC_1E31/'
hltTauValidationFolder_PF_IDEAL =  'HLT/TauRelVal/PF_1E31/'
    ...
    MonitorSetup = cms.VPSet(
        cms.PSet(
            ...
            Filter                = cms.untracked.VInputTag(
                                        ...
                                        cms.InputTag("hltFilterL3IsolationCutDoubleLooseIsoTau15Trk5","",hltTauValidationProcess_IDEAL)
                                        ),
