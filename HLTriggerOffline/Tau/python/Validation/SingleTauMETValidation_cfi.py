...
SingleTauMETPathVal = cms.EDFilter("HLTTauValidation",
    ...
    L1SeedFilter          = cms.untracked.InputTag("hltSingleTauMETL1SeedFilter","","TEST"),
    L2EcalIsolFilter      = cms.untracked.InputTag("hltFilterSingleTauMETEcalIsolation","","TEST"),
    L25PixelIsolFilter    = cms.untracked.InputTag("hltFilterL25SingleTauMET","","TEST"),
    L3SiliconIsolFilter   = cms.untracked.InputTag("hltFilterL3SingleTauMET","","TEST"),
    ...
    LogFileName           = cms.untracked.string('SingleTauMETValidation.log'),
