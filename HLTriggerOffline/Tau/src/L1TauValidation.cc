...
// 
/**\class L1TauValidation L1TauValidation.cc UserCode/L1TauValidation/src/L1TauValidation.cc
...
// $Id: L1TauValidation.cc,v 1.3 2008/04/24 21:27:31 chinhan Exp $
//
//
...
L1TauValidation::beginJob(const edm::EventSetup&)
{
  ...
  h_L1TauEta = store->book1D("L1TauEta","L1TauEt",60,-4.,4.);
  ...
  h_L1Tau1Eta = store->book1D("L1Tau1Eta","L1Tau1Et",60,-4.,4.);
  ...
  h_L1Tau2Eta = store->book1D("L1Tau2Eta","L1Tau2Et",60,-4.,4.);
  ...
  //
  h_PFTauEt = store->book1D("PFTauEt","PFTauEt",50,0.,100.);
  h_PFTauEt->getTH1F()->Sumw2();
  h_PFTauEta = store->book1D("PFTauEta","PFTauEt",60,-4.,4.);
  h_PFTauEta->getTH1F()->Sumw2();
  h_PFTauPhi = store->book1D("PFTauPhi","PFTauPhi",50,-3.2,3.2);
  h_PFTauPhi->getTH1F()->Sumw2();
  ...
  h_MCTauHadEta = store->book1D("MCTauHadEta","MCTauHadEt",60,-4.,4.);
  ...
  h_L1MCMatchedTauEta = store->book1D("L1MCMatchedTauEta","L1MCMatchedTauEt",60,-4.,4.);
  ...
  h_EffMCTauEta = store->book1D("EffMCTauEta","EffMCTauEt",60,-4.,4.);
  ...
  h_MCPFTauHadEt = store->book1D("MCPFTauHadEt","MCPFTauHadEt",50,0.,100.);
  h_MCPFTauHadEt->getTH1F()->Sumw2();
  h_MCPFTauHadEta = store->book1D("MCPFTauHadEta","MCPFTauHadEt",60,-4.,4.);
  h_MCPFTauHadEta->getTH1F()->Sumw2();
  h_MCPFTauHadPhi = store->book1D("MCPFTauHadPhi","MCPFTauHadPhi",50,-3.2,3.2);
  h_MCPFTauHadPhi->getTH1F()->Sumw2();

  h_L1MCPFMatchedTauEt = store->book1D("L1MCPFMatchedTauEt","L1MCPFMatchedTauEt",50,0.,100.);
  h_L1MCPFMatchedTauEt->getTH1F()->Sumw2();
  h_L1MCPFMatchedTauEta = store->book1D("L1MCPFMatchedTauEta","L1MCPFMatchedTauEt",60,-4.,4.);
  h_L1MCPFMatchedTauEta->getTH1F()->Sumw2();
  h_L1MCPFMatchedTauPhi = store->book1D("L1MCPFMatchedTauPhi","L1MCPFMatchedTauPhi",50,-3.2,3.2);
  h_L1MCPFMatchedTauPhi->getTH1F()->Sumw2();

  h_EffMCPFTauEt = store->book1D("EffMCPFTauEt","EffMCPFTauEt",50,0.,100.);
  h_EffMCPFTauEt->getTH1F()->Sumw2();
  h_EffMCPFTauEta = store->book1D("EffMCPFTauEta","EffMCPFTauEt",60,-4.,4.);
  h_EffMCPFTauEta->getTH1F()->Sumw2();
  h_EffMCPFTauPhi = store->book1D("EffMCPFTauPhi","EffMCPFTauPhi",50,-3.2,3.2);
  h_EffMCPFTauPhi->getTH1F()->Sumw2();

  h_PFMCTauDeltaR = store->book1D("PFMCTauDeltaR","PFMCTauDeltaR",60,0.,6.);
  h_PFMCTauDeltaR->getTH1F()->Sumw2();
  ...
  h_L1SingleTauEffPFMCMatchEt = store->book1D("L1SingleTauEffPFMCMatchEt","L1SingleTauEffPFMCMatchEt",
					     50,0.,100.);
  h_L1SingleTauEffPFMCMatchEt->getTH1F()->Sumw2();
  h_L1DoubleTauEffPFMCMatchEt = store->book1D("L1DoubleTauEffPFMCMatchEt","L1DoubleTauEffPFMCMatchEt",
					     40,0.,80.);
  h_L1DoubleTauEffPFMCMatchEt->getTH1F()->Sumw2();
...
L1TauValidation::endJob() {
  ...
  h_EffMCPFTauEt->getTH1F()->Divide(h_EffMCPFTauEt->getTH1F(),h_MCPFTauHadEt->getTH1F(),1.,1.,"b");
  h_EffMCPFTauEta->getTH1F()->Divide(h_EffMCPFTauEta->getTH1F(),h_MCPFTauHadEta->getTH1F(),1.,1.,"b");
  h_EffMCPFTauPhi->getTH1F()->Divide(h_EffMCPFTauPhi->getTH1F(),h_MCPFTauHadPhi->getTH1F(),1.,1.,"b");
...
void
L1TauValidation::getL1extraObjects(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
...
void
L1TauValidation::getPFTauObjects(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;
...
void
L1TauValidation::getGenObjects(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;
...
void
L1TauValidation::fillGenHistograms() {
...
void
L1TauValidation::fillPFTauHistograms() {
...
void
L1TauValidation::calcL1MCTauMatching() {
  bool singleTauPassed = false;
  bool doubleTauPassed = false;
  bool muTauPassed = false;
  bool isoEgTauPassed = false;
...
void
L1TauValidation::calcL1MCPFTauMatching() {
  bool singleTauPassed = false;
  bool doubleTauPassed = false;
  bool muTauPassed = false;
  bool isoEgTauPassed = false;
...
void
L1TauValidation::convertToIntegratedEff(TH1* histo, double nGenerated)
{
...
void
L1TauValidation::printTrigReport() {
  using namespace std;
