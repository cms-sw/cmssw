...
/// Constructor
ElectronOfETauDQM::ElectronOfETauDQM(const edm::ParameterSet& pset)  
{
...
void ElectronOfETauDQM::beginJob(const edm::EventSetup&){
...
/// Destructor
ElectronOfETauDQM::~ElectronOfETauDQM(){
}

void ElectronOfETauDQM::analyze(const edm::Event & event , const edm::EventSetup& setup){
  ...
  if(!triggerObj.isValid()) { 
    edm::LogWarning("ElectronOfETauDQM") << "RAW-type HLT results not found, skipping event";
    return;
  }
