#ifndef HLTTauL25Validation_h
#define HLTTauL25Validation_h

// -*- C++ -*-
//
// Package:    HLTTauL25Validation
// Class:      HLTTauL25Validation
// 
/**\class HLTTauL25Validation HLTTauL25Validation.cc 
...
// class declaration    
class HLTTauL25Validation : public edm::EDAnalyzer {

public:
  explicit HLTTauL25Validation(const edm::ParameterSet&);
  ~HLTTauL25Validation() {}
...
private:
  ...
  std::vector<TLorentzVector> getVectorOfVisibleTauJets(const edm::Event& iEvent);
