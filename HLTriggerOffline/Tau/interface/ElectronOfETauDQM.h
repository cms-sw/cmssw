#ifndef HLTriggerOffline_Tau_ElectronOfETauDQM_H
#define HLTriggerOffline_Tau_ElectronOfETauDQM_H
...
class ElectronOfETauDQM : public edm::EDAnalyzer{
public:
  /// Constructor
  explicit ElectronOfETauDQM(const edm::ParameterSet& pset);
