...
hltHiggsPosttestJetSMP = hltHiggsPostProcessor.clone()
hltHiggsPosttestJetSMP.subDirs = ['HLT/Higgs/testJetSMP']
hltHiggsPosttestJetSMP.efficiencyProfile = efficiency_strings
