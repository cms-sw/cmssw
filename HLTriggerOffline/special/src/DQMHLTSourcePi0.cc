...
//--------------------------------------------------------
void DQMHLTSourcePi0::beginJob(const EventSetup& context){
...
//--------------------------------------------------------
void DQMHLTSourcePi0::beginRun(const edm::Run& r, const EventSetup& context) {

}

//--------------------------------------------------------
void DQMHLTSourcePi0::beginLuminosityBlock(const LuminosityBlock& lumiSeg, 
...
void DQMHLTSourcePi0::analyze(const Event& iEvent, 
...
//--------------------------------------------------------
void DQMHLTSourcePi0::endLuminosityBlock(const LuminosityBlock& lumiSeg, 
                                          const EventSetup& context) {
}
//--------------------------------------------------------
void DQMHLTSourcePi0::endRun(const Run& r, const EventSetup& context){

}
//--------------------------------------------------------
void DQMHLTSourcePi0::endJob(){
...
void DQMHLTSourcePi0::convxtalid(Int_t &nphi,Int_t &neta)
{
  // Barrel only
...
int DQMHLTSourcePi0::diff_neta_s(Int_t neta1, Int_t neta2){
  Int_t mdiff;
  mdiff=(neta1-neta2);
  return mdiff;
}
...
int DQMHLTSourcePi0::diff_nphi_s(Int_t nphi1,Int_t nphi2) {
  Int_t mdiff;
