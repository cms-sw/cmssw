...
SingleJetPathVal = cms.EDFilter("HLTJetMETValidation",
...
#    refLeptonCollection   = cms.untracked.InputTag("NOTHING"),
    DQMFolder             = cms.untracked.string('HLT/HLTJETMET/SingleJet'),
...
#    RefFilter             = cms.untracked.InputTag("hltL1s1Level1jet15","","HLT"),
    RefFilter             = cms.untracked.InputTag("hlt1jet30","","HLT"),
    ProbeFilter           = cms.untracked.InputTag("hlt1jet80","","HLT"),
