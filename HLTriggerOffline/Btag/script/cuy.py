...
#	    newth.SetYTitle(theaddition[ikey].YTitle)
	...
	if thesuper[ikey].Stack == "false" or thesuper[ikey].Stack == None:
	    astack.Draw()
#	    astack.Draw("nostack")
#	    if thesuper[ikey].Option: 
#	     mystr=thesuper[ikey].Option+" nostack" 
#	     astack.Draw("nostack Hist")
#	     astack.Draw("nostack "+thesuper[ikey].Option)
#	     print "nostack "+thesuper[ikey].Option
	    if thesuper[ikey].Option: astack.Draw("nostack Hist")
	    else: astack.Draw("nostack")
	if thesuper[ikey].XTitle != None:
