...
# with command line options: step3 -s HARVESTING:validationHarvesting+dqmHarvesting --harvesting AtRunEnd -n 10 --filein file:step2_VALIDATION.root --conditions auto:mc --mc
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:step2_VALIDATION.root'),
