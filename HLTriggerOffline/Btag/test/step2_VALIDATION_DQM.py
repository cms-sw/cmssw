...
# with command line options: step2 -s VALIDATION,DQM -n 10 --filein /store/user/marfin/TTbar_TuneZ2star_13TeV-powheg-tauola/RelValTTbar_8e33_2pt1v4/317184e5e599f32779cb714fb62573b2/output_20_1_zIW.root --eventcontent FEVTDEBUGHLT --conditions auto:mc --mc --customise=HLTriggerOffline/Btag/Validation/customizeHLTBtag.customizeHLTBtag
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step2_VALIDATION_DQM.root'),
...
# Schedule definition
process.schedule = cms.Schedule(process.prevalidation_step,process.validation_step,process.dqmoffline_step,process.endjob_step,process.FEVTDEBUGHLToutput_step)
