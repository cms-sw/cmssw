...
SUSY_HLT_InclusiveHT_aux600 = cms.EDAnalyzer("SUSY_HLT_InclusiveHT",
  ...
  TriggerPath = cms.string('HLT_PFHT600_v1'),
  TriggerPathAuxiliaryForHadronic = cms.string('HLT_IsoMu24_IterTrk02_v1'),
  TriggerFilter = cms.InputTag('hltPFHT600', '', 'reHLT'), #the last filter in the path
...
SUSY_HLT_InclusiveHT_aux600_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
  subDirs = cms.untracked.vstring("HLTriggerOffline/SUSYBSM/HLT_PFHT600_v1"),
