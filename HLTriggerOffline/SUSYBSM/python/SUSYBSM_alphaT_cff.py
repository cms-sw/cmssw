...
# Control trigger
SUSY_HLT_HT200_alphaT0p51 = cms.EDProducer("SUSY_HLT_alphaT",
...
# Primary triggers
SUSY_HLT_HT200_alphaT0p57 = cms.EDProducer("SUSY_HLT_alphaT",
  trigSummary       = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'), #to use with test sample
  TriggerResults    = cms.InputTag('TriggerResults','','HLT'),        #to use with test sample
  caloJetCollection = cms.InputTag("ak4CaloJets"),
  pfJetCollection   = cms.InputTag("ak4PFJetsCHS"),
...
SUSY_HLT_HT250_alphaT0p55 = cms.EDProducer("SUSY_HLT_alphaT",
  trigSummary = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'), #to use with test sample
  pfJetCollection = cms.InputTag("ak4PFJetsCHS"),
  caloJetCollection = cms.InputTag("ak4CaloJets"),
  TriggerResults = cms.InputTag('TriggerResults','','HLT'), #to use with test sample
...
SUSY_HLT_HT300_alphaT0p53 = cms.EDProducer("SUSY_HLT_alphaT",
  trigSummary = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'), #to use with test sample
  pfJetCollection = cms.InputTag("ak4PFJetsCHS"),
  caloJetCollection = cms.InputTag("ak4CaloJets"),
  TriggerResults = cms.InputTag('TriggerResults','','HLT'), #to use with test sample
...
SUSY_HLT_HT350_alphaT0p52 = cms.EDProducer("SUSY_HLT_alphaT",
  trigSummary = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'), #to use with test sample
...
SUSY_HLT_HT400_alphaT0p51 = cms.EDProducer("SUSY_HLT_alphaT",
  trigSummary = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'), #to use with test sample
  pfJetCollection = cms.InputTag("ak4PFJetsCHS"),
  caloJetCollection = cms.InputTag("ak4CaloJets"),
  TriggerResults = cms.InputTag('TriggerResults','','HLT'), #to use with test sample
...
# Backup triggers
SUSY_HLT_HT200_alphaT0p63 = cms.EDProducer("SUSY_HLT_alphaT",
  trigSummary       = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'), #to use with test sample
  TriggerResults    = cms.InputTag('TriggerResults','','HLT'), #to use with test sample
  caloJetCollection = cms.InputTag("ak4CaloJets"),
  pfJetCollection   = cms.InputTag("ak4PFJetsCHS"),
...
SUSY_HLT_HT250_alphaT0p58 = cms.EDProducer("SUSY_HLT_alphaT",
  trigSummary = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'), #to use with test sample
  pfJetCollection = cms.InputTag("ak4PFJetsCHS"),
  caloJetCollection = cms.InputTag("ak4CaloJets"),
  TriggerResults = cms.InputTag('TriggerResults','','HLT'), #to use with test sample
...
SUSY_HLT_HT300_alphaT0p54 = cms.EDProducer("SUSY_HLT_alphaT",
  trigSummary = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'), #to use with test sample
  pfJetCollection = cms.InputTag("ak4PFJetsCHS"),
  caloJetCollection = cms.InputTag("ak4CaloJets"),
  TriggerResults = cms.InputTag('TriggerResults','','HLT'), #to use with test sample
...
SUSY_HLT_HT350_alphaT0p53 = cms.EDProducer("SUSY_HLT_alphaT",
  trigSummary = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'), #to use with test sample
  pfJetCollection = cms.InputTag("ak4PFJetsCHS"),#ak4PFJetsCHS
  caloJetCollection = cms.InputTag("ak4CaloJets"),
  TriggerResults = cms.InputTag('TriggerResults','','HLT'), #to use with test sample
...
SUSY_HLT_HT400_alphaT0p52 = cms.EDProducer("SUSY_HLT_alphaT",
  trigSummary = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'), #to use with test sample
  pfJetCollection = cms.InputTag("ak4PFJetsCHS"),
  caloJetCollection = cms.InputTag("ak4CaloJets"),
  TriggerResults = cms.InputTag('TriggerResults','','HLT'), #to use with test sample
