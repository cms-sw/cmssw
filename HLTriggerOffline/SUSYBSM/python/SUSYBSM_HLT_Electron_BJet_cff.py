...
SUSY_HLT_Electron_BJet = cms.EDAnalyzer("SUSY_HLT_Electron_BJet",
  ...
  TriggerPath = cms.string('HLT_Ele10_CaloIdM_TrackIdM_CentralPFJet30_BTagCSV0p5PF_v'),
  TriggerFilterEle = cms.InputTag('hltSingleEle10CaloIdMTrackIdMEtFilter','','HLT'), #the last filter in the sequence HLTSingleEle10CaloIdMTrackIdMSequence 
...
SUSY_HLT_Electron_BJet_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    subDirs        = cms.untracked.vstring("HLT/SUSYBSM/HLT_Ele10_CaloIdM_TrackIdM_CentralPFJet30_BTagCSV0p5PF"),
