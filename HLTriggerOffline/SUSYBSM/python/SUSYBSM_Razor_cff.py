...
SUSY_HLT_Razor_QuadJet = cms.EDAnalyzer("SUSY_HLT_Razor",
  ...
  pfJetCollection = cms.InputTag("ak4PFJetsCHS"),
  TriggerResults = cms.InputTag('TriggerResults','','HLT'),
  TriggerPath = cms.string('HLT_RsqMR300_Rsq0p09_MR200_4jet_v1'),
  TriggerFilter = cms.InputTag('hltRsqMR300Rsq0p09MR200', '', 'HLT'), #the last filter in the path
  CaloFilter = cms.InputTag('hltRsqMR200Rsq0p01MR100Calo', '', 'HLT'), #filter implementing cuts on calo MR and Rsq
  hemispheres = cms.InputTag('hemispheres')
)
...
SUSY_HLT_Razor_DM = cms.EDAnalyzer("SUSY_HLT_Razor",
  ...
  pfJetCollection = cms.InputTag("ak4PFJetsCHS"),
  TriggerResults = cms.InputTag('TriggerResults','','HLT'),
  TriggerPath = cms.string('HLT_Rsq0p36_v1'),
...
SUSY_HLT_Razor_Main_7e33 = cms.EDAnalyzer("SUSY_HLT_Razor",
  ...
  pfJetCollection = cms.InputTag("ak4PFJetsCHS"),
  TriggerResults = cms.InputTag('TriggerResults','','HLT'),
  TriggerPath = cms.string('HLT_RsqMR260_Rsq0p09_MR200_v1'),
...
SUSY_HLT_Razor_QuadJet_7e33 = cms.EDAnalyzer("SUSY_HLT_Razor",
  ...
  pfJetCollection = cms.InputTag("ak4PFJetsCHS"),
  TriggerResults = cms.InputTag('TriggerResults','','HLT'),
  TriggerPath = cms.string('HLT_RsqMR260_Rsq0p09_MR200_4jet_v1'),
  TriggerFilter = cms.InputTag('hltRsqMR260Rsq0p09MR200', '', 'HLT'), #the last filter in the path
  CaloFilter = cms.InputTag('hltRsqMR160Rsq0p01MR100Calo', '', 'HLT'), #filter implementing cuts on calo MR and Rsq
  hemispheres = cms.InputTag('hemispheres')
)
...
SUSY_HLT_Razor_PostVal_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    subDirs        = cms.untracked.vstring("HLT/SUSYBSM/HLT_RsqMR300_Rsq0p09_MR200_v1", "HLT/SUSYBSM/HLT_RsqMR300_Rsq0p09_MR200_4jet_v1", "HLT/SUSYBSM/HLT_Rsq0p36_v1", "HLT/SUSYBSM/HLT_RsqMR260_Rsq0p09_MR200_v1", "HLT/SUSYBSM/HLT_RsqMR260_Rsq0p09_MR200_4jet_v1"),
