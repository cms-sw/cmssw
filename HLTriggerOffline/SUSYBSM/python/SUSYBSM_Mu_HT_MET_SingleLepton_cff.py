...
SUSY_HLT_Mu15_HT350_MET50_SingleLepton = cms.EDProducer('SUSY_HLT_SingleLepton',
...
SUSY_HLT_Mu15_HT400_MET50_SingleLepton = cms.EDProducer('SUSY_HLT_SingleLepton',
                                                 electronCollection = cms.InputTag(''),
                                                 muonCollection = cms.InputTag('muons'),
                                                 pfMetCollection = cms.InputTag('pfMet'),
                                                 pfJetCollection = cms.InputTag('ak4PFJets'),
