...
SUSY_HLT_MET_HT_MUON = cms.EDAnalyzer("SUSY_HLT_Muon_Hadronic",
  ...
  #TriggerPath = cms.string('HLT_Mu6_PFHT200_PFMET100_NoiseCleaned_v'),
  TriggerPath = cms.string('HLT_Mu6_PFHT200_PFMET100_JetIdCleaned_v'),
...
SUSY_HLT_MET_HT_MUON_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    #subDirs        = cms.untracked.vstring("HLT/SUSYBSM/HLT_Mu6_PFHT200_PFMET100_NoiseCleaned"),
    subDirs        = cms.untracked.vstring("HLT/SUSYBSM/HLT_Mu6_PFHT200_PFMET100_JetIdCleaned"),
