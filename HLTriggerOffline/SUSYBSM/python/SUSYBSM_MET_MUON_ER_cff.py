...
SUSY_HLT_MET_MUON_ER = cms.EDAnalyzer("SUSY_HLT_Muon_Hadronic",
  ...
  TriggerPath = cms.string('HLT_Mu14er_PFMET120_NoiseCleaned_v1'),   
  ...
  TriggerFilter = cms.InputTag('hltMu14erPFMET120L3PreFiltered', '', 'HLTX'), #the last filter in the path
...
SUSY_HLT_MET_MUON_ER_FASTSIM = cms.EDAnalyzer("SUSY_HLT_Muon_Hadronic",
  ...
  TriggerPathAuxiliaryForMuon = cms.string('HLT_PFHT900_v1'),
  TriggerPathAuxiliaryForHadronic = cms.string('HLT_IsoMu24_eta2p1_IterTrk02_v1'),
  TriggerFilter = cms.InputTag('hltMu14erPFMET120L3PreFiltered', '', 'HLT'), #the last filter in the path
  ptMuonOffline = cms.untracked.double(16.0), 
  etaMuonOffline = cms.untracked.double(2.1), 
  HTOffline = cms.untracked.double(0.0),
  METOffline = cms.untracked.double(200.0),
...
SUSY_HLT_MET_MUON_ER_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    subDirs        = cms.untracked.vstring("HLTriggerOffline/SUSYBSM/HLT_Mu14er_PFMET120_NoiseCleaned_v1"),
