...
SUSY_HLT_DiJet_MET = cms.EDAnalyzer("SUSY_HLT_DiJet_MET",
  ...
  TriggerPath = cms.string('HLT_DiCentralPFJet55_PFMET110_JetIdCleaned_v'),
...
SUSY_HLT_DiJet_MET_FASTSIM = cms.EDAnalyzer("SUSY_HLT_DiJet_MET",
  trigSummary = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'), 
  pfMETCollection = cms.InputTag("pfMet"),
  caloMETCollection = cms.InputTag("caloMet"),
  pfJetCollection = cms.InputTag("ak4PFJetsCHS"),
...
SUSY_HLT_DiJet_MET_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    subDirs        = cms.untracked.vstring("HLT/SUSYBSM/HLT_DiCentralPFJet55_PFMET110_JetIdCleaned_v"),
