...
SUSY_HLT_MET_HT_MUON_ER = cms.EDAnalyzer("SUSY_HLT_Muon_Hadronic",
  ...
  TriggerPath = cms.string('HLT_Mu3er_PFHT140_PFMET125_NoiseCleaned_v1'),
  ...
  TriggerFilter = cms.InputTag('hltMu3erPFHT140PFMET125L3PreFiltered', '', 'HLTX'), #the last filter in the path
...
SUSY_HLT_MET_HT_MUON_ER_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    subDirs        = cms.untracked.vstring("HLT/SUSYBSM/HLT_Mu3er_PFHT140_PFMET125_NoiseCleaned_v1"),
