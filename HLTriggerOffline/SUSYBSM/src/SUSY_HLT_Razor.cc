...
double 
  SUSY_HLT_Razor::CalcR(double MR, const TLorentzVector& ja, const TLorentzVector& jb, const edm::Handle<edm::View<reco::MET> >& inputMet, const std::vector<math::XYZTLorentzVector>& muons){
