...
TString MCEtCutString = "PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcEt > ";
MCEtCutString += MCEtCut;
TString l1MatchCutString = "PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.l1Match";
TString EtCutString = "PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.Et > ";
EtCutString +=  EtCut;
TString IEcalCutString = "PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.IEcal < ";
IEcalCutString += IEcalCut;
TString IHcalCutString = "(PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.IHcal < ";
IHcalCutString += IHcalBarrelCut; 
IHcalCutString += " && fabs(PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.eta) < 1.5) || (PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.IHcal < ";
IHcalCutString +=  IHcalEndcapCut;
IHcalCutString += " && fabs(PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.eta) > 1.5 && fabs(PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.eta) < 2.5)";
TString ItrackCutString = "PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.Itrack < ";
...
allEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcEt>>l1NumEt",MCEtCutString);
TH1F *l1NumEta = new TH1F("l1NumEta", "Efficiency vs. eta;eta;Eff.", 100, -2.5, 2.5);
allEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcEta>>l1NumEta",MCEtCutString);
TH1F *l1NumPhi = new TH1F("l1NumPhi", "Efficiency vs. phi;phi;Eff.", 100, 0, 6.2832);
allEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcPhi>>l1NumPhi",MCEtCutString);
Long64_t total = allEvents->GetEntries();
Long64_t pass0 = allEvents->GetEntries("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.Et > -999.");
...
l1MatchEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcEt>>l1MatchNumEt",l1MatchCutPathMCString);
...
l1MatchEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcEta>>l1MatchNumEta",l1MatchCutPathMCString);
...
l1MatchEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcPhi>>l1MatchNumPhi",l1MatchCutPathMCString);
...
EtEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcEt>>EtNumEt",EtCutPathMCString);
...
EtEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcEta>>EtNumEta",EtCutPathMCString);
...
EtEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcPhi>>EtNumPhi",EtCutPathMCString);
...
IEcalEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcEt>>IEcalNumEt",IEcalCutPathMCString);
...
IEcalEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcEta>>IEcalNumEta",IEcalCutPathMCString);
...
IEcalEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcPhi>>IEcalNumPhi",IEcalCutPathMCString);
...
IHcalEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcEt>>IHcalNumEt",IHcalCutPathMCString);
...
IHcalEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcEta>>IHcalNumEta",IHcalCutPathMCString);
...
IHcalEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcPhi>>IHcalNumPhi",IHcalCutPathMCString);
...
ItrackEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcEt>>ItrackNumEt",ItrackCutPathMCString);
...
ItrackEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcEta>>ItrackNumEta",ItrackCutPathMCString);
...
ItrackEvents->Draw("PhotHLTCutVarss_hltCutVars_RelaxedDoublePhots_EGAMMAHLT.obj.mcPhi>>ItrackNumPhi",ItrackCutPathMCString);
...
TCanvas *myCanvas = new TCanvas("myCanvas", "Relaxed Double Photon Efficiencies vs. Et", 1500, 1000);
myCanvas->Divide(3,2);
myCanvas->cd(1);
...
myCanvas->cd(5);
ItrackHistEt->Draw("e");
myCanvas->Print("images/EffVEtRDP.gif");
myCanvas->cd(1);
...
myCanvas->Print("images/EffVEtaRDP.gif");
myCanvas->cd(1);
...
myCanvas->Print("images/EffVPhiRDP.gif");
