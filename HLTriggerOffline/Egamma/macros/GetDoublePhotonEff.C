...
Double_t EtCut = 20.;                 // Et Cut
Double_t IEcalCut = 2.5;              // Ecal Isolation (Ecal Cluster Et in dR < 0.3 not part of photon SC)
Double_t IHcalBarrelCut = 8.;         // Hcal Isolation in barrel (Hcal Et in dR < 0.3)
Double_t IHcalEndcapCut = 6.;         // "    "         "  endcap
Double_t ItrackCut = 3.;              // Track Isolation (Number of tracks in dR < 0.3)

/* Strings for various cuts formed as TCuts */
TString MCEtCutString = "PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcEt > ";
MCEtCutString += MCEtCut;
TString l1MatchCutString = "PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.l1Match";
TString EtCutString = "PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.Et > ";
EtCutString +=  EtCut;
TString IEcalCutString = "PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.IEcal < ";
IEcalCutString += IEcalCut;
TString IHcalCutString = "(PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.IHcal < ";
IHcalCutString += IHcalBarrelCut; 
IHcalCutString += " && fabs(PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.eta) < 1.5) || (PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.IHcal < ";
IHcalCutString +=  IHcalEndcapCut;
IHcalCutString += " && fabs(PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.eta) > 1.5 && fabs(PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.eta) < 2.5)";
TString ItrackCutString = "PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.Itrack < ";
...
allEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcEt>>l1NumEt",MCEtCutString);
TH1F *l1NumEta = new TH1F("l1NumEta", "Efficiency vs. eta;eta;Eff.", 100, -2.5, 2.5);
allEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcEta>>l1NumEta",MCEtCutString);
TH1F *l1NumPhi = new TH1F("l1NumPhi", "Efficiency vs. phi;phi;Eff.", 100, 0, 6.2832);
allEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcPhi>>l1NumPhi",MCEtCutString);
Long64_t total = allEvents->GetEntries();
Long64_t pass0 = allEvents->GetEntries("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.Et > -999.");
...
l1MatchEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcEt>>l1MatchNumEt",l1MatchCutPathMCString);
...
l1MatchEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcEta>>l1MatchNumEta",l1MatchCutPathMCString);
...
l1MatchEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcPhi>>l1MatchNumPhi",l1MatchCutPathMCString);
...
EtEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcEt>>EtNumEt",EtCutPathMCString);
...
EtEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcEta>>EtNumEta",EtCutPathMCString);
...
EtEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcPhi>>EtNumPhi",EtCutPathMCString);
...
TTree *IEcalEvents = CopyTreeMulti(IEcalCutPathString, allEvents, 2);

TH1F *IEcalNumEt = new TH1F("IEcalNumEt", "Ecal Isolation Efficiency vs. Et;Et (GeV);Eff.", 100, 0, 150);
IEcalEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcEt>>IEcalNumEt",IEcalCutPathMCString);
...
IEcalEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcEta>>IEcalNumEta",IEcalCutPathMCString);
...
IEcalEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcPhi>>IEcalNumPhi",IEcalCutPathMCString);
...
IHcalEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcEt>>IHcalNumEt",IHcalCutPathMCString);
...
IHcalEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcEta>>IHcalNumEta",IHcalCutPathMCString);
...
IHcalEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcPhi>>IHcalNumPhi",IHcalCutPathMCString);
...
TTree *ItrackEvents = CopyTreeMulti(ItrackCutPathString, allEvents, 2);

TH1F *ItrackNumEt = new TH1F("ItrackNumEt", "Track Isolation Efficiency vs. Et;Et (GeV);Eff.", 100, 0, 150);
ItrackEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcEt>>ItrackNumEt",ItrackCutPathMCString);
...
ItrackEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcEta>>ItrackNumEta",ItrackCutPathMCString);
...
ItrackEvents->Draw("PhotHLTCutVarss_hltCutVars_DoublePhots_EGAMMAHLT.obj.mcPhi>>ItrackNumPhi",ItrackCutPathMCString);
...
TCanvas *myCanvas = new TCanvas("myCanvas", "Double Photon Efficiencies vs. Et", 1500, 1000);
myCanvas->Divide(3,2);
myCanvas->cd(1);
...
myCanvas->cd(5);
ItrackHistEt->Draw("e");
myCanvas->Print("images/EffVEtDP.gif");
myCanvas->cd(1);
...
myCanvas->Print("images/EffVEtaDP.gif");
myCanvas->cd(1);
...
myCanvas->Print("images/EffVPhiDP.gif");
