...
TString l1MatchPTCutString = "ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.l1Match";
TString EtPTCutString = "ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.Et > ";
EtPTCutString +=  EtCut;
TString IHcalPTCutString = "ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.IHcal < ";
IHcalPTCutString += IHcalCut;
TString pixMatchPTCutString = "ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.pixMatch >= ";
pixMatchPTCutString += pixMatchCut;

TString MCEtCutString = "ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.mcEt > ";
MCEtCutString += MCEtCut;
TString l1MatchCutString = "ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.l1Match";
TString EtCutString = "ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.Et > ";
EtCutString +=  EtCut;
TString IHcalCutString = "ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.IHcal < ";
IHcalCutString += IHcalCut;
TString pixMatchCutString = "ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.pixMatch >= ";
pixMatchCutString += pixMatchCut;
TString EoverpCutString = "(ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.Eoverp < ";
EoverpCutString += EoverpBarrelCut; 
EoverpCutString += " && fabs(ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.eta) < 1.5) || (ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.Eoverp < ";
EoverpCutString +=  EoverpEndcapCut;
EoverpCutString += " && fabs(ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.eta) > 1.5 && fabs(ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.eta) < 2.5)";
TString ItrackCutString = "ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.Itrack < ";
...
allEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcEt>>l1NumEt",MCEtPTCutString);
TH1F *l1NumEta = new TH1F("l1NumEta", "Efficiency vs. eta;eta;Eff.", 100, -2.5, 2.5);
allEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcEta>>l1NumEta",MCEtPTCutString);
TH1F *l1NumPhi = new TH1F("l1NumPhi", "Efficiency vs. phi;phi;Eff.", 100, 0, 6.2832);
allEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcPhi>>l1NumPhi",MCEtPTCutString);
Long64_t total = allEvents->GetEntries();
Long64_t pass0 = allEvents->GetEntries("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.Et > -999.");
...
l1MatchEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcEt>>l1MatchNumEt",l1MatchCutPathMCString);
...
l1MatchEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcEta>>l1MatchNumEta",l1MatchCutPathMCString);
...
l1MatchEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcPhi>>l1MatchNumPhi",l1MatchCutPathMCString);
...
EtEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcEt>>EtNumEt",EtCutPathMCString);
...
EtEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcEta>>EtNumEta",EtCutPathMCString);
...
EtEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcPhi>>EtNumPhi",EtCutPathMCString);
...
IHcalEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcEt>>IHcalNumEt",IHcalCutPathMCString);
...
IHcalEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcEta>>IHcalNumEta",IHcalCutPathMCString);
...
IHcalEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcPhi>>IHcalNumPhi",IHcalCutPathMCString);
...
PixMatchEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcEt>>PixMatchNumEt",pixMatchCutPathMCString);
...
PixMatchEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcEta>>PixMatchNumEta",pixMatchCutPathMCString);
...
PixMatchEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_DoubleElecsPT_EGAMMAHLT.obj.mcPhi>>PixMatchNumPhi",pixMatchCutPathMCString);
...
EoverpEvents->Draw("ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.mcEt>>EoverpNumEt",EoverpCutPathMCString);
...
EoverpEvents->Draw("ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.mcEta>>EoverpNumEta",EoverpCutPathMCString);
...
EoverpEvents->Draw("ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.mcPhi>>EoverpNumPhi",EoverpCutPathMCString);
...
HLTEvents->Draw("ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.mcEt>>ItrackNumEt",ItrackCutPathMCString);
...
HLTEvents->Draw("ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.mcEta>>ItrackNumEta",ItrackCutPathMCString);
...
HLTEvents->Draw("ElecHLTCutVarss_hltCutVars_DoubleElecs_EGAMMAHLT.obj.mcPhi>>ItrackNumPhi",ItrackCutPathMCString);
...
TCanvas *myCanvas = new TCanvas("myCanvas", "Double Electron Efficiencies vs. Et", 1500, 1000);
myCanvas->Divide(3,2);
myCanvas->cd(1);
...
myCanvas->cd(6);
ItrackHistEt->Draw("e");
myCanvas->Print("images/EffVEtDE.gif");
myCanvas->cd(1);
...
myCanvas->Print("images/EffVEtaDE.gif");
myCanvas->cd(1);
...
myCanvas->Print("images/EffVPhiDE.gif");
