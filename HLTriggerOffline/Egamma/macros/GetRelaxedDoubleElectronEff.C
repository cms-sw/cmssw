...
Double_t EtCut = 12.;                 // Et Cut
Double_t IHcalCut = 9.;               // Hcal Isolation (Hcal Et in dR < 0.15)
Double_t pixMatchCut = 1;             // Pixel Match Cut
Double_t EoverpBarrelCut = 15000.;       // E/p Cut for electrons in barrel
...
TString MCEtPTCutString = "ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcEt > ";
MCEtPTCutString += MCEtCut;
TString l1MatchPTCutString = "ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.l1Match";
TString EtPTCutString = "ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.Et > ";
EtPTCutString +=  EtCut;
TString IHcalPTCutString = "ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.IHcal < ";
IHcalPTCutString += IHcalCut;
TString pixMatchPTCutString = "ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.pixMatch >= ";
pixMatchPTCutString += pixMatchCut;

TString MCEtCutString = "ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.mcEt > ";
MCEtCutString += MCEtCut;
TString l1MatchCutString = "ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.l1Match";
TString EtCutString = "ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.Et > ";
EtCutString +=  EtCut;
TString IHcalCutString = "ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.IHcal < ";
IHcalCutString += IHcalCut;
TString pixMatchCutString = "ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.pixMatch >= ";
pixMatchCutString += pixMatchCut;
TString EoverpCutString = "(ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.Eoverp < ";
EoverpCutString += EoverpBarrelCut; 
EoverpCutString += " && fabs(ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.eta) < 1.5) || (ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.Eoverp < ";
EoverpCutString +=  EoverpEndcapCut;
EoverpCutString += " && fabs(ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.eta) > 1.5 && fabs(ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.eta) < 2.5)";
TString ItrackCutString = "ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.Itrack < ";
...
allEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcEt>>l1NumEt",MCEtPTCutString);
TH1F *l1NumEta = new TH1F("l1NumEta", "Efficiency vs. eta;eta;Eff.", 100, -2.5, 2.5);
allEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcEta>>l1NumEta",MCEtPTCutString);
TH1F *l1NumPhi = new TH1F("l1NumPhi", "Efficiency vs. phi;phi;Eff.", 100, 0, 6.2832);
allEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcPhi>>l1NumPhi",MCEtPTCutString);
Long64_t total = allEvents->GetEntries();
Long64_t pass0 = allEvents->GetEntries("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.Et > -999.");

//TFile *file1 = new TFile("../test/ZEE-HLTEgamma-l1Match.root");
TTree *l1MatchEvents = CopyTreeMulti(l1MatchCutPathString, allEvents, 2);

TH1F *l1MatchNumEt = new TH1F("l1MatchNumEt", "L1 Match Efficiency vs. Et", 100, 0, 150);
l1MatchEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcEt>>l1MatchNumEt",l1MatchCutPathMCString);
...
l1MatchEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcEta>>l1MatchNumEta",l1MatchCutPathMCString);
...
l1MatchEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcPhi>>l1MatchNumPhi",l1MatchCutPathMCString);
...
TTree *EtEvents = CopyTreeMulti(EtCutPathString, allEvents, 2);

TH1F *EtNumEt = new TH1F("EtNumEt", "Et Cut Efficiency vs. Et;Et (GeV);Eff.", 100, 0, 150);
EtEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcEt>>EtNumEt",EtCutPathMCString);
...
EtEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcEta>>EtNumEta",EtCutPathMCString);
...
EtEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcPhi>>EtNumPhi",EtCutPathMCString);
...
//TFile *file3 = new TFile("../test/ZEE-HLTEgamma-IHcal.root");
TTree *IHcalEvents = CopyTreeMulti(IHcalCutPathString, allEvents, 2);

TH1F *IHcalNumEt = new TH1F("IHcalNumEt", "Hcal Isolation Efficiency vs. Et;Et (GeV);Eff.", 100, 0, 150);
IHcalEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcEt>>IHcalNumEt",IHcalCutPathMCString);
...
IHcalEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcEta>>IHcalNumEta",IHcalCutPathMCString);
...
IHcalEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcPhi>>IHcalNumPhi",IHcalCutPathMCString);
...
//TFile *file4 = new TFile("../test/ZEE-HLTEgamma-pixMatch.root");
TTree *PixMatchEvents = CopyTreeMulti(pixMatchCutPathString, allEvents, 2);

TH1F *PixMatchNumEt = new TH1F("PixMatchNumEt", "Pixel Match Efficiency vs. Et;Et (GeV);Eff.", 100, 0, 150);
PixMatchEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcEt>>PixMatchNumEt",pixMatchCutPathMCString);
...
PixMatchEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcEta>>PixMatchNumEta",pixMatchCutPathMCString);
...
PixMatchEvents->Draw("ElecHLTCutVarsPreTracks_hltCutVars_RelaxedDoubleElecsPT_EGAMMAHLT.obj.mcPhi>>PixMatchNumPhi",pixMatchCutPathMCString);
...
//TFile *file5 = new TFile("../test/ZEE-HLTEgamma-Eoverp.root");
TTree *EoverpEvents = CopyTreeMulti(EoverpCutPathString, PixMatchEvents, 2);

TH1F *EoverpNumEt = new TH1F("EoverpNumEt", "E/p Cut Efficiency vs. Et;Et (GeV);Eff.", 100, 0, 150);
EoverpEvents->Draw("ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.mcEt>>EoverpNumEt",EoverpCutPathMCString);
...
EoverpEvents->Draw("ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.mcEta>>EoverpNumEta",EoverpCutPathMCString);
...
EoverpEvents->Draw("ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.mcPhi>>EoverpNumPhi",EoverpCutPathMCString);
...
//TFile *file6 = new TFile("../test/ZEE-HLTEgamma-Itrack.root");
TTree *HLTEvents = CopyTreeMulti(ItrackCutPathString, PixMatchEvents, 2);

TH1F *ItrackNumEt = new TH1F("ItrackNumEt", "Track Isolation Efficiency vs. Et;Et (GeV);Eff.", 100, 0, 150);
HLTEvents->Draw("ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.mcEt>>ItrackNumEt",ItrackCutPathMCString);
...
HLTEvents->Draw("ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.mcEta>>ItrackNumEta",ItrackCutPathMCString);
...
HLTEvents->Draw("ElecHLTCutVarss_hltCutVars_RelaxedDoubleElecs_EGAMMAHLT.obj.mcPhi>>ItrackNumPhi",ItrackCutPathMCString);
...
if (total != 0) eff0 = (Double_t)pass0 / (Double_t)total;
if (pass0 != 0) eff1 = (Double_t)pass1 / (Double_t)pass0;
if (pass1 != 0) eff2 = (Double_t)pass2 / (Double_t)pass1;
if (pass2 != 0) eff3 = (Double_t)pass3 / (Double_t)pass2;
if (pass3 != 0) eff4 = (Double_t)pass4 / (Double_t)pass3;
if (pass4 != 0) eff5 = (Double_t)pass5 / (Double_t)pass4;
if (pass5 != 0) eff6 = (Double_t)pass6 / (Double_t)pass5;
if (pass6 != 0) eff = (Double_t)pass6 / (Double_t)pass0;
...
TCanvas *myCanvas = new TCanvas("myCanvas", "Relaxed Double Electron Efficiencies vs. Et", 1500, 1000);
myCanvas->Divide(3,2);
myCanvas->cd(1);
...
myCanvas->cd(6);
ItrackHistEt->Draw("e");
myCanvas->Print("images/EffVEtRDE.gif");
myCanvas->cd(1);
...
myCanvas->Print("images/EffVEtaRDE.gif");
myCanvas->cd(1);
...
myCanvas->Print("images/EffVPhiRDE.gif");
