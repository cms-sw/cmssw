...
#akCsFilter1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiSignalGenJets'))

akCsFilter1CalobTagger = bTaggers("akCsFilter1Calo",0.1)

#create objects locally since they dont load properly otherwise
#akCsFilter1Calomatch = akCsFilter1CalobTagger.match
akCsFilter1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter1CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCsFilter1CaloJetSequence = cms.Sequence(akCsFilter1CaloJetSequence_data)
