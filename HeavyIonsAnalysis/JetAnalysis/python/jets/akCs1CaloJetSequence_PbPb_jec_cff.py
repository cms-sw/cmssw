...
akCs1CaloJetSequence = cms.Sequence(akCs1CaloJetSequence_jec)
akCs1CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akCs1CaloJetAnalyzer.jetPtMin = cms.double(1)
