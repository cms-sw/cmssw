...
ak2PFparton = patJetPartonMatch.clone(src = cms.InputTag("ak2PFJets"), matched = cms.InputTag("hiGenParticles"))
...
ak2PFJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
