...
akPu5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPu5PFJets"), matched = cms.InputTag("hiGenParticles"))
...
akPu5PFJetTracksAssociatorAtVertex.tracks = cms.InputTag("PureTracks")
...
akPu5PFJetAnalyzer.jtPtMin = cms.untracked.double(1)
