...
#akCsFilter1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))
...
akCsFilter1CaloJetSequence = cms.Sequence(akCsFilter1CaloJetSequence_mb)
