...
ak3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("ak3CaloJets"), matched = cms.InputTag("hiGenParticles"))
...
ak3CaloJetTracksAssociatorAtVertex.tracks = cms.InputTag("PureTracks")
