...
akPu1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPu1PFJets"), matched = cms.InputTag("hiGenParticles"))
...
akPu1PFJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
