...
akVs4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVs4CaloJets"), matched = cms.InputTag("hiGenParticles"))
...
akVs4CaloJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
