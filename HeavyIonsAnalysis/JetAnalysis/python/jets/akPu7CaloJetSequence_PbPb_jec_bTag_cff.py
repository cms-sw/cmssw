...
akPu7Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPu7CaloJets"), matched = cms.InputTag("genParticles"))
...
akPu7CaloJetTracksAssociatorAtVertex.tracks = cms.InputTag("hiGeneralTracks")
...
akPu7CaloImpactParameterTagInfos.primaryVertex = cms.InputTag("hiSelectedVertex")
...
akPu7CaloSoftPFMuonsTagInfos.primaryVertex = cms.InputTag("hiSelectedVertex")
...
akPu7CaloJetAnalyzer.jtPtMin = cms.untracked.double(1)
