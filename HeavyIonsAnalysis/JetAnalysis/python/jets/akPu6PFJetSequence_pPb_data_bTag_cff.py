...
akPu6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPu6PFJets"), matched = cms.InputTag("hiGenParticles"))
...
akPu6PFJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
