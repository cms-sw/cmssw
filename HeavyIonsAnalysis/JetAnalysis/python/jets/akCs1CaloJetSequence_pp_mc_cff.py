...
#akCs1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1GenJets'))

akCs1CalobTagger = bTaggers("akCs1Calo",0.1)

#create objects locally since they dont load properly otherwise
#akCs1Calomatch = akCs1CalobTagger.match
akCs1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akCs1CaloJets"), matched = cms.InputTag("genParticles"))
...
akCs1CaloJetSequence = cms.Sequence(akCs1CaloJetSequence_mc)
