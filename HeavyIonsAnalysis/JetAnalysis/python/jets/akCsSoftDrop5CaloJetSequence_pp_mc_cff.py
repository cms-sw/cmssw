...
#akCsSoftDrop5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))

akCsSoftDrop5CalobTagger = bTaggers("akCsSoftDrop5Calo",0.5)

#create objects locally since they dont load properly otherwise
#akCsSoftDrop5Calomatch = akCsSoftDrop5CalobTagger.match
akCsSoftDrop5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDrop5CaloJets"), matched = cms.InputTag("genParticles"))
