...
#akCsFilter6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))
...
akCsFilter6CaloJetSequence = cms.Sequence(akCsFilter6CaloJetSequence_mb)
