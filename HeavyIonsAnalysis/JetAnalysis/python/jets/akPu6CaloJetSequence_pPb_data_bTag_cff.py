...
akPu6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPu6CaloJets"), matched = cms.InputTag("hiGenParticles"))
...
akPu6CaloJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
