...
#akCsSoftDrop5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))
...
akCsSoftDrop5CaloJetSequence = cms.Sequence(akCsSoftDrop5CaloJetSequence_mb)
