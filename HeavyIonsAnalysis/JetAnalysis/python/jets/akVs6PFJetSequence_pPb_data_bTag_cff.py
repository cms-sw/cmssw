...
akVs6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVs6PFJets"), matched = cms.InputTag("hiGenParticles"))
...
akVs6PFJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
