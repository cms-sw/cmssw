...
ak7Caloparton = patJetPartonMatch.clone(src = cms.InputTag("ak7CaloJets"), matched = cms.InputTag("genParticles"))
...
ak7CaloJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
...
ak7CaloImpactParameterTagInfos.primaryVertex = cms.InputTag("offlinePrimaryVertices")
...
ak7CaloSoftPFMuonsTagInfos.primaryVertex = cms.InputTag("offlinePrimaryVertices")
