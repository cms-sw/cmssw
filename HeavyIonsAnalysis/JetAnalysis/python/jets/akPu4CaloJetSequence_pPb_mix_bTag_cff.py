...
akPu4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPu4CaloJets"), matched = cms.InputTag("hiGenParticles"))
...
akPu4CaloJetTracksAssociatorAtVertex.tracks = cms.InputTag("PureTracks")
