...
akVs7PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVs7PFJets"), matched = cms.InputTag("genParticles"))
...
akVs7PFJetTracksAssociatorAtVertex.tracks = cms.InputTag("PureTracks")
...
akVs7PFImpactParameterTagInfos.primaryVertex = cms.InputTag("offlinePrimaryVertices")
...
akVs7PFSoftPFMuonsTagInfos.primaryVertex = cms.InputTag("offlinePrimaryVertices")
...
akVs7PFJetAnalyzer.jtPtMin = cms.untracked.double(1)
