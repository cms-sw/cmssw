...
akPu7Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPu7CaloJets"), matched = cms.InputTag("hiGenParticles"))
...
akPu7CaloJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
...
akPu7CaloImpactParameterTagInfos.primaryVertex = cms.InputTag("offlinePrimaryVertices")
...
akPu7CaloSoftPFMuonsTagInfos.primaryVertex = cms.InputTag("offlinePrimaryVertices")
