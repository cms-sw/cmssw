...
#akCsSoftDrop2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))
...
akCsSoftDrop2CaloJetSequence = cms.Sequence(akCsSoftDrop2CaloJetSequence_mb)
