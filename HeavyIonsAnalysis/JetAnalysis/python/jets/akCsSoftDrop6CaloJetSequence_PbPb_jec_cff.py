...
#akCsSoftDrop6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiSignalGenJets'))

akCsSoftDrop6CalobTagger = bTaggers("akCsSoftDrop6Calo",0.6)

#create objects locally since they dont load properly otherwise
#akCsSoftDrop6Calomatch = akCsSoftDrop6CalobTagger.match
akCsSoftDrop6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDrop6CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCsSoftDrop6CaloJetSequence = cms.Sequence(akCsSoftDrop6CaloJetSequence_jec)
akCsSoftDrop6CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsSoftDrop6CaloJetAnalyzer.jetPtMin = cms.double(1)
