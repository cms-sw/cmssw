...
akCsFilter2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter2CaloJets"), matched = cms.InputTag("genParticles"))
...
akCsFilter2CaloJetSequence = cms.Sequence(akCsFilter2CaloJetSequence_jec)
akCsFilter2CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsFilter2CaloJetAnalyzer.jetPtMin = cms.double(1)
