...
ak5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("ak5CaloJets"), matched = cms.InputTag("hiGenParticles"))
...
ak5CaloJetTracksAssociatorAtVertex.tracks = cms.InputTag("PureTracks")
...
ak5CaloJetAnalyzer.jtPtMin = cms.untracked.double(1)
