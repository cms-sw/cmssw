...
akCsFilter3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter3CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCsFilter3CaloJetSequence = cms.Sequence(akCsFilter3CaloJetSequence_mc)
