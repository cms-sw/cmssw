...
#akCs3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiSignalGenJets'))

akCs3CalobTagger = bTaggers("akCs3Calo",0.3)

#create objects locally since they dont load properly otherwise
#akCs3Calomatch = akCs3CalobTagger.match
akCs3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akCs3CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCs3CaloJetSequence = cms.Sequence(akCs3CaloJetSequence_data)
