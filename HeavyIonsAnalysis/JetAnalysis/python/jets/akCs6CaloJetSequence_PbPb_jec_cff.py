...
#akCs6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiSignalGenJets'))

akCs6CalobTagger = bTaggers("akCs6Calo",0.6)

#create objects locally since they dont load properly otherwise
#akCs6Calomatch = akCs6CalobTagger.match
akCs6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akCs6CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCs6CaloJetSequence = cms.Sequence(akCs6CaloJetSequence_jec)
akCs6CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akCs6CaloJetAnalyzer.jetPtMin = cms.double(1)
