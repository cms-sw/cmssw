...
akVs2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVs2PFJets"), matched = cms.InputTag("hiGenParticles"))
...
akVs2PFJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
