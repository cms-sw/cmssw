...
akCsSoftDrop3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDrop3CaloJets"), matched = cms.InputTag("genParticles"))
...
akCsSoftDrop3CaloJetSequence = cms.Sequence(akCsSoftDrop3CaloJetSequence_mc)
