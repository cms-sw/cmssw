...
ak1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("ak1CaloJets"), matched = cms.InputTag("hiGenParticles"))
...
ak1CaloJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
