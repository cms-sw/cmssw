...
akPu4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPu4PFJets"), matched = cms.InputTag("hiGenParticles"))
...
akPu4PFJetTracksAssociatorAtVertex.tracks = cms.InputTag("PureTracks")
...
akPu4PFJetAnalyzer.jtPtMin = cms.untracked.double(1)
