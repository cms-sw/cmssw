...
akCsFilter5CaloJetSequence = cms.Sequence(akCsFilter5CaloJetSequence_jec)
akCsFilter5CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsFilter5CaloJetAnalyzer.jetPtMin = cms.double(1)
