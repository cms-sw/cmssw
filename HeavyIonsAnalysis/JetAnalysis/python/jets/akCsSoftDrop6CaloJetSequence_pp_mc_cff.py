...
akCsSoftDrop6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDrop6CaloJets"), matched = cms.InputTag("genParticles"))
...
akCsSoftDrop6CaloJetSequence = cms.Sequence(akCsSoftDrop6CaloJetSequence_mc)
