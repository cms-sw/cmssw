...
#akCsFilter4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))
...
akCsFilter4CaloJetSequence = cms.Sequence(akCsFilter4CaloJetSequence_mb)
