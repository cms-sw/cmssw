...
akVs3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVs3PFJets"), matched = cms.InputTag("hiGenParticles"))
...
akVs3PFJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
