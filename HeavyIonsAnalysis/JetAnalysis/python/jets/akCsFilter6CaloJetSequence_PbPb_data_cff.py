...
#akCsFilter6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiSignalGenJets'))

akCsFilter6CalobTagger = bTaggers("akCsFilter6Calo",0.6)

#create objects locally since they dont load properly otherwise
#akCsFilter6Calomatch = akCsFilter6CalobTagger.match
akCsFilter6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter6CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCsFilter6CaloJetSequence = cms.Sequence(akCsFilter6CaloJetSequence_data)
