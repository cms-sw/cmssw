...
akVs4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVs4PFJets"), matched = cms.InputTag("hiGenParticles"))
...
akVs4PFJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
