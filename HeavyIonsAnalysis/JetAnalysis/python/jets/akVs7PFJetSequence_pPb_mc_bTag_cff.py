...
akVs7PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVs7PFJets"), matched = cms.InputTag("hiGenParticles"))
...
akVs7PFJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
