...
akPu2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPu2PFJets"), matched = cms.InputTag("hiGenParticles"))
...
akPu2PFJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
