...
akVs7Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVs7CaloJets"), matched = cms.InputTag("hiGenParticles"))
...
akVs7CaloJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
...
akVs7CaloImpactParameterTagInfos.primaryVertex = cms.InputTag("offlinePrimaryVertices")
...
akVs7CaloSoftPFMuonsTagInfos.primaryVertex = cms.InputTag("offlinePrimaryVertices")
