...
akVs6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVs6CaloJets"), matched = cms.InputTag("hiGenParticles"))
...
akVs6CaloJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
...
akVs6CaloJetAnalyzer.jtPtMin = cms.untracked.double(1)
