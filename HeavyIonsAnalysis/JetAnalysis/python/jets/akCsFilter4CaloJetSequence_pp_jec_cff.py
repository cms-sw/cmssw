...
akCsFilter4CaloJetSequence = cms.Sequence(akCsFilter4CaloJetSequence_jec)
akCsFilter4CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsFilter4CaloJetAnalyzer.jetPtMin = cms.double(1)
