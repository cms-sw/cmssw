...
akVs2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVs2CaloJets"), matched = cms.InputTag("hiGenParticles"))
...
akVs2CaloJetTracksAssociatorAtVertex.tracks = cms.InputTag("generalTracks")
...
akVs2CaloJetAnalyzer.jtPtMin = cms.untracked.double(1)
