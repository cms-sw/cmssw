...
#akCsFilter3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))
...
akCsFilter3CaloJetSequence = cms.Sequence(akCsFilter3CaloJetSequence_mb)
