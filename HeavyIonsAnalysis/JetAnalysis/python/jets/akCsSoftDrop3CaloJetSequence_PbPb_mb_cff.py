...
#akCsSoftDrop3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))
...
akCsSoftDrop3CaloJetSequence = cms.Sequence(akCsSoftDrop3CaloJetSequence_mb)
