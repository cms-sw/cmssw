...
'file:/afs/cern.ch/cms/CAF/CMSPHYS/PHYS_HEAVYIONS/cms/CMSSW_7_5_5_patch2/src/hiReco0T_RAW2DIGI_L1Reco_RECO_1.root'
...
process.load('HeavyIonsAnalysis.JetAnalysis.HiMixGenNoPu_cff')
...
process.ana_step = cms.Path(process.mix*process.heavyIon*
                            process.hltanalysis *
