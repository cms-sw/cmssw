...
IChargeFP420::hit_map_type InduceChargeFP420::induce(CDrifterFP420::collection_type _collection_points, int numStrips, double localPitch, int numStripsW, double localPitchW, int zside){
...
//#endif
   ...
   for (int i=stripLeftW; i<=stripRightW; i++){
	 ...
	 //    if(zside == 1 ) {
	 std::cout << " *InduceChargeFP420:=========== zside=" << zside << std::endl;
	 std::cout << " chargePos= " << chargePosition << std::endl;
	 std::cout << "Position3D= " << Position3D << std::endl;
