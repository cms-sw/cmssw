...
CDrifterFP420::collection_type ChargeDrifterFP420::drift(const CDrifterFP420::ionization_type ion, const G4ThreeVector& driftDir,const int& zside){
  //
  //
#ifdef mydigidebug5
  ...
  for (unsigned int i=0; i<ion.size(); i++){
    _temp[i] = drift(ion[i], driftDir, zside);
  }
  return _temp;
}

AmplitudeSegmentFP420 ChargeDrifterFP420::drift
(const EnergySegmentFP420& edu, const G4ThreeVector& drift, const int& zside){
  //
  //
...
#ifdef mydigidebug5
  std::cout << "=================================================================== " << std::endl;
  std::cout << "ChargeDrifterFP420: zside= " << zside << std::endl;
...
#ifdef mydigidebug5
  std::cout << "ChargeDrifterFP420: drift: zside=" << zside << "pathFraction=" << pathFraction << std::endl;
...
#endif
#ifdef mydigidebug5
  std::cout << "ChargeDrifterFP420: drift: zside=" << zside << "pathValue=" << pathValue << std::endl;
