...
public:
  ...
  ClusterFP420( unsigned int, const HDigiFP420Range&, float&, float&);
  ...
  //global ID of the corresponding DetUnit --> to be used for transformations to local and to global reference frames
