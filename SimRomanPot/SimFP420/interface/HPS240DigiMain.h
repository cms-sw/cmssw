#ifndef HPS240DigiMain_h
#define HPS240DigiMain_h
...
#include "SimRomanPot/SimFP420/interface/ZeroSuppressHPS240.h"
...
public:
  ...
  HPS240DigiMain(const edm::ParameterSet& conf);
  //HPS240DigiMain();
  ~HPS240DigiMain();
...
///////////	        IChargeFP420* theIChargeFP420;
  ...
  ZeroSuppressHPS240* theZSuppressHPS240;
  DigiConverterHPS240* theDConverterHPS240;
