...
public:
  ...
  // send number of data channels per controller stream
  void sendDataChannelCount(unsigned int nDataChannels) { sendTrivialProduct_(0, nDataChannels); }

  // receive number of data channels per controller stream
  void receiveDataChannelCount(unsigned int& nDataChannels) { receiveTrivialProduct_(0, nDataChannels); }
