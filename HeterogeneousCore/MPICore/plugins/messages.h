 ...
 *   - the stream id of the original process (to allow sending any reply to the correct stream)
 */
 ...
 * augmented with the MPI message id and the EDM stream number
 *
 ...
 * augmented with the MPI message id and with the EDM stream number
 *
