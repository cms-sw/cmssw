...
files = [
    ...
    {"whole (w/o filters)": "/data/user/apolova/dev1/CMSSW_15_1_0_pre4/src/HeterogeneousCore/MPICore/test/test_results/whole_wo_filters/whole_summary_table.csv"},
    ...
    {"OpenMPI5 on same cores": "/data/user/apolova/dev1/CMSSW_15_1_0_pre4/src/HeterogeneousCore/MPICore/test/test_results/ompi5/local-remote_t-s-c_same_cores/local_summary_table.csv"},
    {"MPICH on same cores": "/data/user/apolova/dev1/CMSSW_15_1_0_pre4/src/HeterogeneousCore/MPICore/test/test_results/mpich/one_buffer_serial/same_cores/local_summary_table.csv"}

]

output_dir = "./milan-genoa-ompi5"
