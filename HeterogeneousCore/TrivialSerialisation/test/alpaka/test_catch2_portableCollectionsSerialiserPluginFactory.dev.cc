...
TEST_CASE("Test MemoryCopyTraits", "[MemoryCopyTraits]") {
  ...
  SECTION("PortableCollection<Device, ALPAKA_ACCELERATOR_NAMESPACE::portabletest::TestSoALayout<128, false>>") {
    ...
    const std::string deviceProductTypeAlias = EDM_STRINGIZE(portabletest::TestDeviceCollection);
    const int size = 10;
  ...
  SECTION("DeviceProduct<PortableDeviceObject>") {
    ...
    const std::string deviceProductTypeAlias = EDM_STRINGIZE(portabletest::TestDeviceObject);
  ...
  SECTION("DeviceProduct<PortableDeviceCollection2>") {
    ...
    const std::string deviceProductTypeAlias = EDM_STRINGIZE(portabletest::TestDeviceCollection2);
    const int size1 = 7;
    const int size2 = 11;
