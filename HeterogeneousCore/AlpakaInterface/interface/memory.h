...
namespace cms::alpakatools {
  ...
  std::enable_if_t<alpaka::concepts::Device<TDev> and not std::is_array_v<T>, device_buffer<TDev, T>> make_device_buffer(
      TDev const& device) {
  ...
  template <typename T, typename TQueue>
  std::enable_if_t<alpaka::concepts::Queue<TQueue>, device_view<alpaka::Dev<TQueue>, T[]>> make_device_view(TQueue const& queue,
                                                                                                    T* data,
                                                                                                    Extent extent) {
