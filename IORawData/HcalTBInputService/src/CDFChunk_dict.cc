//
// File generated by rootcint at Thu Aug  4 10:14:21 2005.
...
class G__CDFChunk_dictdOcxx_tag {};

void* operator new(size_t size,G__CDFChunk_dictdOcxx_tag* p) {
...
void operator delete(void *p,G__CDFChunk_dictdOcxx_tag* x) {
...
void G__DELDMY_CDFChunk_dictdOcxx() { G__operator_delete(0); }
