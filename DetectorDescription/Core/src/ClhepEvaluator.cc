...
void
dd_exchange_value( std::vector<std::string> & vars,
...
void
ClhepEvaluator::set( const std::string & ns, const std::string & name,
...
void
ClhepEvaluator::set(const std::string & n, const std::string & v)
{
...
double
ClhepEvaluator::eval(const std::string & ns, const std::string & expr)
{   
...
double
ClhepEvaluator::eval(const char * expression)
{
...
bool
ClhepEvaluator::isDefined( const std::string & ns, //< current namespace
...
void
ClhepEvaluator::prepare(const std::string & ns, 
...
void
ClhepEvaluator::throwex( const std::string & ns, 
			 const std::string & name, 
...
void
ClhepEvaluator::checkname( const std::string & s ) const
{
