...
{ 
  ...
  os << "<table border=\"0\">" << endl
     << "<tr><td>thetaX =</td><td>" << CMS_CONVERT_TO( x.Theta(), deg ) << " deg</td><tr>" << endl
     << "<tr><td>phiX =</td><td>" << CMS_CONVERT_TO( x.Phi(), deg ) << " deg</td><tr>" << endl
     << "<tr><td>thetaY =</td><td>" << CMS_CONVERT_TO( y.Theta(), deg ) << " deg</td><tr>" << endl
     << "<tr><td>phiY =</td><td>" << CMS_CONVERT_TO( y.Phi(), deg ) << " deg</td><tr>" << endl     
     << "<tr><td>thetaZ =</td><td>" << CMS_CONVERT_TO( z.Theta(), deg ) << " deg</td><tr>" << endl
     << "<tr><td>phiZ =</td><td>" << CMS_CONVERT_TO( z.Phi(), deg ) << " deg</td><tr>" << endl     
     << "</table>";
...
bool DDHtmlMaDetails::details(ostream & os, const DDName & nm)
{
  ...
  os << "<p>density = " << CMS_CONVERT_TO( ma.density(), g_per_cm3 ) << " g/cm3 </p>" << endl;
  ...
  if ( co ) {
    ...
    os << "<p>z = " << ma.z() << "</p>" << endl;
    os << "<p>a = " << CMS_CONVERT_TO( ma.a(), g_per_mole ) << "g/mole</p>" << endl;
  }
