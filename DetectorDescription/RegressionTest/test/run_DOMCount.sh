...
cfiFiles="${cfiFiles} Geometry/CMSCommonData/cmsExtendedGeometry2023simXML_cfi"
cfiFiles="${cfiFiles} Geometry/CMSCommonData/cmsExtendedGeometry2023tiltedXML_cfi"
cfiFiles="${cfiFiles} Geometry/CMSCommonData/cmsExtendedGeometry2023GRecoXML_cfi"
