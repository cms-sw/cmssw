...
cfiFiles="${cfiFiles} Geometry/CMSCommonData/cmsExtendedGeometry2023DevXML_cfi"
cfiFiles="${cfiFiles} Geometry/CMSCommonData/cmsExtendedGeometry2023MuonXML_cfi"
cfiFiles="${cfiFiles} Geometry/CMSCommonData/cmsExtendedGeometry2023XML_cfi"
