...
void
DDLPgonGenerator::preProcessElement( const std::string& name, const std::string& nmspace, DDCompactView& cpv )
{
...
void
DDLPgonGenerator::processElement( const std::string& name,
				  ...
				  DDCompactView& cpv )
{
  ...
  {
    DDSolid extrudedpolygon = 
      DDSolidFactory::extrudedpolygon( getDDName( nmspace ),
				       x, y,
				       z, zx, zy, zscale );
  } else
  {
