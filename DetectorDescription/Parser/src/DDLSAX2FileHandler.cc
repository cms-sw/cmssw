...
DDLSAX2FileHandler::DDLSAX2FileHandler( DDCompactView & cpv ) : cpv_(cpv), xmlelems_() {
  init();
  //  cpv_ = &cpv;  
}

// void DDLSAX2FileHandler::setStorage( DDCompactView & cpv ) {
//   cpv_ = &cpv;
// }
...
// void DDLSAX2FileHandler::setCPV( DDCompactView& cpv ) {
//   cpv_ = & cpv;
// }
