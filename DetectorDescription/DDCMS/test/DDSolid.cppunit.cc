...
void testDDSolid::checkDDSolid() {
  ...
  while (fview.next(0)) {
    ...
    if ((dd4hep::isA<dd4hep::SubtractionSolid>(fview.solid()) and not dd4hep::isA<dd4hep::TruncatedTube>(fview.solid()) and not dd4hep::isA<dd4hep::PseudoTrap>(fview.solid()))) {
