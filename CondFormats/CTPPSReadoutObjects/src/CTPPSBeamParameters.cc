...
CTPPSBeamParameters::CTPPSBeamParameters()
    : beam_momentum_45_(0.),
      ...
      beta_star_y_45_(0.),
      beta_star_y_56_(0.),
      beam_divergence_x_45_(0.),
      beam_divergence_x_56_(0.),
      beam_divergence_y_45_(0.),
      beam_divergence_y_56_(0.),
      half_crossing_angle_x_45_(0.),
      half_crossing_angle_x_56_(0.),
      half_crossing_angle_y_45_(0.),
      half_crossing_angle_y_56_(0.),
      vtx_offset_x_45_(0.),
      vtx_offset_x_56_(0.),
      vtx_offset_y_45_(0.),
      vtx_offset_y_56_(0.),
