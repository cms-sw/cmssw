...
HBHEHFLogicalMapEntry::HBHEHFLogicalMapEntry(
                                             ...
                                             int in_qieid,
                                             int in_uhtr_cr, int in_uhtr, std::string in_uhtr_fpga, int in_uhtr_dcc, int in_uhtr_spigot, int in_uhtr_fi, int in_uhtr_fedid, int in_uhtr_trgf, int in_uhtr_trgfc
                                            )
{
  int mytopbot;
  ...
  mycrate_ = in_cr;
  myhtr_ = in_htr;
  (in_s_fpga=="bot") ? mytb_ = "b" : mytb_ = "t";
  my_htr_fi_ = in_htr_fi;
  ...
  myuhtr_trgf_ = in_uhtr_trgf;
  myuhtr_trgfc_ = in_uhtr_trgfc;
...
char* CALIBLogicalMapEntry::printLMapLine() 
{
  ...
  sprintf(myline,"%1d %6d %6d %6d %6d %6s %7s",0,mysid_,hcalcalibid.ieta(),hcalcalibid.iphi(),mydphi_,mydet.c_str(),rbxid.rbx().c_str());
                                     ...
                                     )
{
  ...
  HcalTrigTowerDetId htrigdid( in_et, in_ph, in_dep );
  myeta_ = in_et;
  myphi_ = in_ph;
