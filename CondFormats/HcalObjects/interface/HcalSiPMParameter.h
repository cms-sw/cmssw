...
public:
  ...
  HcalSiPMParameter () : id_ (0), type_ (0), fcByPE_ (0), darkCurrent_ (0),
    auxi1_(0), auxi2_(0) {}
  
  HcalSiPMParameter (unsigned long fId, int type, float fcByPE, 
		     float darkCurrent, int auxi1=0, float auxi2=0) : 
  id_(fId), type_(type), fcByPE_(fcByPE), darkCurrent_(darkCurrent),
    auxi1_(auxi1), auxi2_(auxi2) {}
