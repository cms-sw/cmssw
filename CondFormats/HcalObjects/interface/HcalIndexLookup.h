...
public:
    ...
    inline bool operator==(const HcalIndexLookup& r) const
        {return data_ == r.data_ && sorted_ == r.sorted_;}
...
private:
    ...
    {
        ar & data_ & sorted_;
        if (hasDuplicateIds()) throw cms::Exception(
            "In HcalIndexLookup::load: invalid data");        
    }
