...
int main()
{
    ...
    */
    ...
    testSerialization<std::pair<std::string, std::vector<HcalQIETypes>>>();
    ...
    testSerialization<std::vector<HcalQIETypes>>();
    ...
    testSerialization<std::vector<std::pair<std::string, std::vector<HcalQIETypes>>>>();
