#ifndef CondFormats_EcalObjects_EcalWeightRecAlgoWeights_HH
#define CondFormats_EcalObjects_EcalWeightRecAlgoWeights_HH
/**
...
class EcalWeightRecAlgoWeights {

  public:
    EcalWeightRecAlgoWeights();
    ~EcalWeightRecAlgoWeights();
