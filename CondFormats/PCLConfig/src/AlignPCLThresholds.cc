...
void AlignPCLThresholds::printAll() const {
  ...
  for(const auto & m_threshold : m_thresholds){
    edm::LogVerbatim("AlignPCLThresholds")<<" ===================================================================================================================";
    edm::LogVerbatim("AlignPCLThresholds")<<"key : " << m_threshold.first <<" \n"
					  ...
					  <<"| maxMoveThetaXcut : " <<std::setw(4)<< (m_threshold.second).getMaxMoveThetaXcut()<<std::setw(5)<<" urad"
					  <<"| ErrorThetaXcut   : " <<std::setw(4)<< (m_threshold.second).getErrorThetaXcut()  <<std::setw(5)<<" urad\n" 
					  ...
					  <<"| maxMoveThetaYcut : " <<std::setw(4)<< (m_threshold.second).getMaxMoveThetaYcut()<<std::setw(5)<<" urad"
					  <<"| ErrorThetaYcut   : " <<std::setw(4)<< (m_threshold.second).getErrorThetaYcut()  <<std::setw(5)<<" urad\n" 
					  ...
					  <<"| maxMoveThetaZcut : " <<std::setw(4)<< (m_threshold.second).getMaxMoveThetaZcut()<<std::setw(5)<<" urad"
					  <<"| ErrorThetaZcut   : " <<std::setw(4)<< (m_threshold.second).getErrorThetaZcut()  <<std::setw(5)<<" urad";
	...
	edm::LogVerbatim("AlignPCLThresholds")<<"Extra DOF " << j << " with label: "<<getExtraDOFLabelForAlignable(m_threshold.first,j);	  
