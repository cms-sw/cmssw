...
public:
  ...
  AlignPCLThreshold(const coordThresholds& X=coordThresholds(),const coordThresholds& tX=coordThresholds(),
		    const coordThresholds& Y=coordThresholds(),const coordThresholds& tY=coordThresholds(),
		    const coordThresholds& Z=coordThresholds(),const coordThresholds& tZ=coordThresholds(),
