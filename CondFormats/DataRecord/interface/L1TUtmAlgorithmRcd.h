...
//class L1TUtmAlgorithmRcd : public edm::eventsetup::DependentRecordImplementation<L1TUtmAlgorithmRcd, boost::mp11::mp_list<L1TriggerKeyListRcd,L1TriggerKeyRcd> > {};
