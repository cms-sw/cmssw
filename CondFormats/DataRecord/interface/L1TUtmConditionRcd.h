...
//class L1TUtmConditionRcd : public edm::eventsetup::DependentRecordImplementation<L1TUtmConditionRcd, boost::mp11::mp_list<L1TriggerKeyListRcd,L1TriggerKeyRcd> > {};
