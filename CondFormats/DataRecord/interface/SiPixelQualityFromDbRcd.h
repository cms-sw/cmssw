#ifndef DataRecord_SiPixelQualityFromDbRcd_h
#define DataRecord_SiPixelQualityFromDbRcd_h
// -*- C++ -*-
//
// Package:     DataRecord
...
class SiPixelQualityFromDbRcd : public edm::eventsetup::EventSetupRecordImplementation<SiPixelQualityFromDbRcd> {};
