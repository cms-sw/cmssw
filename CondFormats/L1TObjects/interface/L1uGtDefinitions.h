#ifndef CondFormats_L1TObjects_L1uGtDefinitions_h
#define CondFormats_L1TObjects_L1uGtDefinitions_h
...
struct L1uGtConditionTypeStringToEnum {
    const char* label;
    L1uGtConditionType value;
};

L1uGtConditionType l1GtConditionTypeStringToEnum(const std::string&);
std::string l1GtConditionTypeEnumToString(const L1uGtConditionType&);

/// condition categories
enum L1uGtConditionCategory {
    CondNull,
    CondMuon,
    CondCalo,
    CondEnergySum,
...
struct L1uGtConditionCategoryStringToEnum {
    const char* label;
    L1uGtConditionCategory value;
};


L1uGtConditionCategory l1GtConditionCategoryStringToEnum(const std::string&);
std::string l1GtConditionCategoryEnumToString(const L1uGtConditionCategory&);
