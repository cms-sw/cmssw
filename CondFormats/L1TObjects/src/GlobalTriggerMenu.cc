...
// constructor
GlobalTriggerMenu::GlobalTriggerMenu()
...
GlobalTriggerMenu::GlobalTriggerMenu(
        ...
        const std::vector<std::vector<GlobalMuonTemplate> >& vecMuonTemplateVal,
        const std::vector<std::vector<GlobalCaloTemplate> >& vecCaloTemplateVal,
        ...
        const std::vector<std::vector<GlobalCorrelationTemplate> >& vecCorrelationTemplateVal,
        const std::vector<std::vector<GlobalMuonTemplate> >& corMuonTemplateVal,
        const std::vector<std::vector<GlobalCaloTemplate> >& corCaloTemplateVal,
...
// copy constructor
GlobalTriggerMenu::GlobalTriggerMenu(const GlobalTriggerMenu& rhs)
{
...
// assignment operator
GlobalTriggerMenu& GlobalTriggerMenu::operator=(const GlobalTriggerMenu& rhs) {
...
void GlobalTriggerMenu::setGtConditionMap(const std::vector<l1t::ConditionMap>& condMap) {
    m_conditionMap = condMap;
}

// build the condition maps
void GlobalTriggerMenu::buildGtConditionMap() {
    ...
    for (std::vector<std::vector<GlobalMuonTemplate> >::iterator
        ...
        for (std::vector<GlobalMuonTemplate>::iterator
    ...
    chipNr = -1;
    for (std::vector<std::vector<GlobalCaloTemplate> >::iterator
        ...
        for (std::vector<GlobalCaloTemplate>::iterator
                itCond = itCondOnChip->begin(); itCond != itCondOnChip->end();
                itCond++) {
    ...
    */
    ...
    chipNr = -1;
    for (std::vector<std::vector<GlobalCorrelationTemplate> >::iterator
        ...
        for (std::vector<GlobalCorrelationTemplate>::iterator
                itCond = itCondOnChip->begin(); itCond != itCondOnChip->end();
                itCond++) {
...
void GlobalTriggerMenu::setGtTriggerMenuInterface(const std::string& menuInterface) {
    m_triggerMenuInterface = menuInterface;
}

void GlobalTriggerMenu::setGtTriggerMenuName(const std::string& menuName) {
    m_triggerMenuName = menuName;
}

void GlobalTriggerMenu::setGtTriggerMenuImplementation(const std::string& menuImplementation) {
    m_triggerMenuImplementation = menuImplementation;
}

// set menu associated scale key
void GlobalTriggerMenu::setGtScaleDbKey(const std::string& scaleKey) {
    m_scaleDbKey = scaleKey;
}

// get / set the vectors containing the conditions
void GlobalTriggerMenu::setVecMuonTemplate(
        const std::vector<std::vector<GlobalMuonTemplate> >& vecMuonTempl) {

    m_vecMuonTemplate = vecMuonTempl;
}

void GlobalTriggerMenu::setVecCaloTemplate(
        const std::vector<std::vector<GlobalCaloTemplate> >& vecCaloTempl) {

    m_vecCaloTemplate = vecCaloTempl;
}

void GlobalTriggerMenu::setVecEnergySumTemplate(
        const std::vector<std::vector<L1GtEnergySumTemplate> >& vecEnergySumTempl) {

    m_vecEnergySumTemplate = vecEnergySumTempl;
}

void GlobalTriggerMenu::setVecJetCountsTemplate(
        const std::vector<std::vector<L1GtJetCountsTemplate> >& vecJetCountsTempl) {

    m_vecJetCountsTemplate = vecJetCountsTempl;
}

void GlobalTriggerMenu::setVecCastorTemplate(
        const std::vector<std::vector<L1GtCastorTemplate> >& vecCastorTempl) {

    m_vecCastorTemplate = vecCastorTempl;
}

void GlobalTriggerMenu::setVecHfBitCountsTemplate(
        const std::vector<std::vector<L1GtHfBitCountsTemplate> >& vecHfBitCountsTempl) {

    m_vecHfBitCountsTemplate = vecHfBitCountsTempl;
}

void GlobalTriggerMenu::setVecHfRingEtSumsTemplate(
        const std::vector<std::vector<L1GtHfRingEtSumsTemplate> >& vecHfRingEtSumsTempl) {

    m_vecHfRingEtSumsTemplate = vecHfRingEtSumsTempl;
}

void GlobalTriggerMenu::setVecBptxTemplate(
        const std::vector<std::vector<L1GtBptxTemplate> >& vecBptxTempl) {

    m_vecBptxTemplate = vecBptxTempl;
}

void GlobalTriggerMenu::setVecExternalTemplate(
        const std::vector<std::vector<L1GtExternalTemplate> >& vecExternalTempl) {

    m_vecExternalTemplate = vecExternalTempl;
}

void GlobalTriggerMenu::setVecCorrelationTemplate(
        const std::vector<std::vector<GlobalCorrelationTemplate> >& vecCorrelationTempl) {

    m_vecCorrelationTemplate = vecCorrelationTempl;
}

// set the vectors containing the conditions for correlation templates
void GlobalTriggerMenu::setCorMuonTemplate(
        const std::vector<std::vector<GlobalMuonTemplate> >& corMuonTempl) {

    m_corMuonTemplate = corMuonTempl;
}

void GlobalTriggerMenu::setCorCaloTemplate(
        const std::vector<std::vector<GlobalCaloTemplate> >& corCaloTempl) {

    m_corCaloTemplate = corCaloTempl;
}

void GlobalTriggerMenu::setCorEnergySumTemplate(
...
void GlobalTriggerMenu::setGtAlgorithmMap(const l1t::AlgorithmMap& algoMap) {
    m_algorithmMap = algoMap;
}

// set the algorithm map (by algorithm aliases)
void GlobalTriggerMenu::setGtAlgorithmAliasMap(const l1t::AlgorithmMap& algoMap) {
    m_algorithmAliasMap = algoMap;
}

// set the technical trigger map
void GlobalTriggerMenu::setGtTechnicalTriggerMap(const l1t::AlgorithmMap& ttMap) {
    m_technicalTriggerMap = ttMap;
}

// print the trigger menu (bit number, algorithm name, logical expression)
void GlobalTriggerMenu::print(std::ostream& myCout, int& printVerbosity) const {
...
const bool GlobalTriggerMenu::gtAlgorithmResult(const std::string& algName,
