...
L1uGtCondition::L1uGtCondition(const std::string& cName)
{
    m_condName = cName;
...
L1uGtCondition::L1uGtCondition(const std::string& cName,
                             const l1t::L1uGtConditionCategory& cCategory,
                             const l1t::L1uGtConditionType& cType)
{
...
const int L1uGtCondition::nrObjects() const
{
...
const bool L1uGtCondition::wsc() const
{
...
// and with spatial correlations
const bool L1uGtCondition::corr() const
{
...
// print condition
void L1uGtCondition::print(std::ostream& myCout) const
{
    ...
    switch (m_condCategory) {
        ...
        default: {
                ...
                << "  - no such category defined. Check l1t::L1uGtConditionCategory enum."
                << std::endl;
    ...
    switch (m_condType) {
        ...
        default: {
                ...
                << " - no such type defined. Check l1t::L1uGtConditionType enum."
                << std::endl;
            }
            break;
    }
...
std::ostream& operator<<(std::ostream& os, const L1uGtCondition& result)
{
    result.print(os);
    return os;
