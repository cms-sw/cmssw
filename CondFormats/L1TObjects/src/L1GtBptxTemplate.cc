...
// constructors
L1GtBptxTemplate::L1GtBptxTemplate() : L1GtCondition() {
  m_condCategory = CondBptx;
  m_condType = TypeBptx;
}

L1GtBptxTemplate::L1GtBptxTemplate(const std::string& cName) : L1GtCondition(cName) {
  m_condCategory = CondBptx;
  m_condType = TypeBptx;
}
...
// copy constructor
L1GtBptxTemplate::L1GtBptxTemplate(const L1GtBptxTemplate& cp) : L1GtCondition(cp.m_condName) { copy(cp); }
