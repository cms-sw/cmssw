...
L1uGtCorrelationTemplate::L1uGtCorrelationTemplate()
        : L1uGtCondition()
{
...
//   from condition name
L1uGtCorrelationTemplate::L1uGtCorrelationTemplate(const std::string& cName)
...
L1uGtCorrelationTemplate::L1uGtCorrelationTemplate(const std::string& cName,
        const l1t::L1uGtConditionCategory& cond0Cat,
        const l1t::L1uGtConditionCategory& cond1Cat,
...
// copy constructor
L1uGtCorrelationTemplate::L1uGtCorrelationTemplate(const L1uGtCorrelationTemplate& cp)
...
// assign operator
L1uGtCorrelationTemplate& L1uGtCorrelationTemplate::operator= (const L1uGtCorrelationTemplate& cp)
{
...
void L1uGtCorrelationTemplate::setCond0Category(
        const l1t::L1uGtConditionCategory& condCateg) {

    m_cond0Category = condCateg;
}

void L1uGtCorrelationTemplate::setCond1Category(
        const l1t::L1uGtConditionCategory& condCateg) {
...
void L1uGtCorrelationTemplate::setCond0Index(const int& condIndex) {
    m_cond0Index = condIndex;
}

void L1uGtCorrelationTemplate::setCond1Index(const int& condIndex) {
    m_cond1Index = condIndex;
}


// set the correlation parameters of the condition
void L1uGtCorrelationTemplate::setCorrelationParameter(
...
void L1uGtCorrelationTemplate::print(std::ostream& myCout) const
{

    myCout << "\n  L1uGtCorrelationTemplate print..." << std::endl;
...
void L1uGtCorrelationTemplate::copy(const L1uGtCorrelationTemplate& cp)
{
...
std::ostream& operator<<(std::ostream& os, const L1uGtCorrelationTemplate& result)
{
    result.print(os);
    return os;
