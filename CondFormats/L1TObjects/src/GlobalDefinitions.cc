...
// l1t::GlobalConditionType
constexpr entry<l1t::GlobalConditionType> l1GtConditionTypeStringToEnumMap[] = {
        ...
        {0, (l1t::GlobalConditionType) - 1}
};

// l1t::GlobalConditionCategory
constexpr entry<l1t::GlobalConditionCategory> l1GtConditionCategoryStringToEnumMap[] = {
  ...
  {0, (l1t::GlobalConditionCategory) - 1}
};
...
l1t::GlobalConditionType l1t::l1GtConditionTypeStringToEnum(const std::string& label) {
    l1t::GlobalConditionType value = keyToValue(label.c_str(), l1GtConditionTypeStringToEnumMap);

    // in case of unrecognized l1t::GlobalConditionType, return l1t::TypeNull
    // to be dealt by the corresponding module
    if (value == (l1t::GlobalConditionType) -1) {
        edm::LogInfo("GlobalDefinitions")  << "\n  '" << label
                << "' is not a recognized l1t::GlobalConditionType. \n  Return l1t::TypeNull.";
...
std::string l1t::l1GtConditionTypeEnumToString(const l1t::GlobalConditionType& conditionType) {
...
l1t::GlobalConditionCategory l1t::l1GtConditionCategoryStringToEnum(const std::string& label) {
  l1t::GlobalConditionCategory value = keyToValue(label.c_str(), l1GtConditionCategoryStringToEnumMap);
  // in case of unrecognized l1t::GlobalConditionCategory, return l1t::CondNull
  // to be dealt by the corresponding module
  if (value == (l1t::GlobalConditionCategory) -1) {
    edm::LogInfo("GlobalDefinitions") << "\n  '" << label
            << "' is not a recognized l1t::GlobalConditionCategory. \n  Return l1t::CondNull.";
...
std::string l1t::l1GtConditionCategoryEnumToString(const l1t::GlobalConditionCategory& conditionCategory) {
