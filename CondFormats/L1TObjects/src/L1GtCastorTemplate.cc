...
// constructors
L1GtCastorTemplate::L1GtCastorTemplate() : L1GtCondition() {
  m_condCategory = CondCastor;
  m_condType = TypeCastor;
}

L1GtCastorTemplate::L1GtCastorTemplate(const std::string& cName) : L1GtCondition(cName) {
  m_condCategory = CondCastor;
  m_condType = TypeCastor;
}
...
// copy constructor
L1GtCastorTemplate::L1GtCastorTemplate(const L1GtCastorTemplate& cp) : L1GtCondition(cp.m_condName) { copy(cp); }
