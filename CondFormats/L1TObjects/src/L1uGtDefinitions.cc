...
// l1t::L1uGtConditionType
constexpr entry<l1t::L1uGtConditionType> l1GtConditionTypeStringToEnumMap[] = {
        ...
        {0, (l1t::L1uGtConditionType) - 1}
};

// l1t::L1uGtConditionCategory
constexpr entry<l1t::L1uGtConditionCategory> l1GtConditionCategoryStringToEnumMap[] = {
  ...
  {0, (l1t::L1uGtConditionCategory) - 1}
};
...
l1t::L1uGtConditionType l1t::l1GtConditionTypeStringToEnum(const std::string& label) {
    l1t::L1uGtConditionType value = keyToValue(label.c_str(), l1GtConditionTypeStringToEnumMap);

    // in case of unrecognized l1t::L1uGtConditionType, return l1t::TypeNull
    // to be dealt by the corresponding module
    if (value == (l1t::L1uGtConditionType) -1) {
        edm::LogInfo("L1uGtDefinitions")  << "\n  '" << label
                << "' is not a recognized l1t::L1uGtConditionType. \n  Return l1t::TypeNull.";
...
std::string l1t::l1GtConditionTypeEnumToString(const l1t::L1uGtConditionType& conditionType) {
...
l1t::L1uGtConditionCategory l1t::l1GtConditionCategoryStringToEnum(const std::string& label) {
  l1t::L1uGtConditionCategory value = keyToValue(label.c_str(), l1GtConditionCategoryStringToEnumMap);
  // in case of unrecognized l1t::L1uGtConditionCategory, return l1t::CondNull
  // to be dealt by the corresponding module
  if (value == (l1t::L1uGtConditionCategory) -1) {
    edm::LogInfo("L1uGtDefinitions") << "\n  '" << label
            << "' is not a recognized l1t::L1uGtConditionCategory. \n  Return l1t::CondNull.";
...
std::string l1t::l1GtConditionCategoryEnumToString(const l1t::L1uGtConditionCategory& conditionCategory) {
