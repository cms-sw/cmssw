...
// constructor
L1uGtTriggerMenu::L1uGtTriggerMenu()
...
L1uGtTriggerMenu::L1uGtTriggerMenu(
        ...
        const std::vector<std::vector<L1uGtMuonTemplate> >& vecMuonTemplateVal,
        const std::vector<std::vector<L1uGtCaloTemplate> >& vecCaloTemplateVal,
        ...
        const std::vector<std::vector<L1uGtCorrelationTemplate> >& vecCorrelationTemplateVal,
        const std::vector<std::vector<L1uGtMuonTemplate> >& corMuonTemplateVal,
        const std::vector<std::vector<L1uGtCaloTemplate> >& corCaloTemplateVal,
...
// copy constructor
L1uGtTriggerMenu::L1uGtTriggerMenu(const L1uGtTriggerMenu& rhs)
{
...
// assignment operator
L1uGtTriggerMenu& L1uGtTriggerMenu::operator=(const L1uGtTriggerMenu& rhs) {
...
void L1uGtTriggerMenu::setGtConditionMap(const std::vector<l1t::ConditionMap>& condMap) {
    m_conditionMap = condMap;
}

// build the condition maps
void L1uGtTriggerMenu::buildGtConditionMap() {
    ...
    for (std::vector<std::vector<L1uGtMuonTemplate> >::iterator
        ...
        for (std::vector<L1uGtMuonTemplate>::iterator
    ...
    chipNr = -1;
    for (std::vector<std::vector<L1uGtCaloTemplate> >::iterator
        ...
        for (std::vector<L1uGtCaloTemplate>::iterator
                itCond = itCondOnChip->begin(); itCond != itCondOnChip->end();
                itCond++) {
    ...
    */
    ...
    chipNr = -1;
    for (std::vector<std::vector<L1uGtCorrelationTemplate> >::iterator
        ...
        for (std::vector<L1uGtCorrelationTemplate>::iterator
                itCond = itCondOnChip->begin(); itCond != itCondOnChip->end();
                itCond++) {
...
void L1uGtTriggerMenu::setGtAlgorithmMap(const l1t::AlgorithmMap& algoMap) {
    m_algorithmMap = algoMap;
}

// set the algorithm map (by algorithm aliases)
void L1uGtTriggerMenu::setGtAlgorithmAliasMap(const l1t::AlgorithmMap& algoMap) {
    m_algorithmAliasMap = algoMap;
}

// set the technical trigger map
void L1uGtTriggerMenu::setGtTechnicalTriggerMap(const l1t::AlgorithmMap& ttMap) {
    m_technicalTriggerMap = ttMap;
}

// print the trigger menu (bit number, algorithm name, logical expression)
void L1uGtTriggerMenu::print(std::ostream& myCout, int& printVerbosity) const {
...
const bool L1uGtTriggerMenu::gtAlgorithmResult(const std::string& algName,
