...
GlobalCondition::GlobalCondition(const std::string& cName,
                             const l1t::GlobalConditionCategory& cCategory,
                             const l1t::GlobalConditionType& cType)
{
...
void GlobalCondition::print(std::ostream& myCout) const
{
    ...
    switch (m_condCategory) {
        ...
        default: {
                ...
                << "  - no such category defined. Check l1t::GlobalConditionCategory enum."
                << std::endl;
    ...
    switch (m_condType) {
        ...
        default: {
                ...
                << " - no such type defined. Check l1t::GlobalConditionType enum."
                << std::endl;
            }
            break;
    }
