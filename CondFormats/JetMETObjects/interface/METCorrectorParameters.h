  ...
  public:
    ...
    */ 
    ...
    METCorrectorParameters(const METCorrectorParameters::Definitions& fDefinitions,
      ...
      : mRecords(fRecords) { valid_ = true;} //mDefinitions(fDefinitions) 
    */
    //-------- Member functions ----------
    ...
    //unsigned size(unsigned fVar)                                 const; // to be commented out
    //int binIndex(const std::vector<float>& fX)                   const;
    //int neighbourBin(unsigned fIndex, unsigned fVar, bool fNext) const; // to be commented out
...
class METCorrectorParametersCollection {
  //---------------- METCorrectorParametersCollection class ----------------
 ...
 public:
  ...
  METCorrectorParametersCollection() { corrections_.clear(); correctionsL5_.clear(); correctionsL7_.clear(); }
