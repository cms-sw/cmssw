...
{
  public:
    enum VarTypes   {kJetPt,kJetEta,kJetPhi,kJetE,kJetEMF,kRelLepPt,kPtRel,kNPV,kJetA,kRho,kJPTrawE,kJPTrawEt,kJPTrawEta,kJPTrawZSP};
    ...
    void setJPTrawZSP   (float fJPTrawZSP);  
