...
CSCL1TPLookupTableME11ILT::CSCL1TPLookupTableME11ILT()
    : GEM_pad_CSC_hs_ME1b_even_(0),
      ...
      CSC_slope_cosi_3to1_L1_ME11_even_(0),
      CSC_slope_cosi_3to1_L1_ME11_odd_(0),

      CSC_slope_cosi_corr_L1_ME11_even_(0),
      CSC_slope_cosi_corr_L2_ME11_even_(0),
      CSC_slope_cosi_corr_L1_ME11_odd_(0),
      CSC_slope_cosi_corr_L2_ME11_odd_(0),

      CSC_slope_corr_L1_ME11_even_(0),
      CSC_slope_corr_L2_ME11_even_(0),
      CSC_slope_corr_L1_ME11_odd_(0),
      CSC_slope_corr_L2_ME11_odd_(0),

      es_diff_slope_L1_ME1a_even_(0),
      es_diff_slope_L2_ME1a_even_(0),
      es_diff_slope_L1_ME1a_odd_(0),
      es_diff_slope_L2_ME1a_odd_(0),
      es_diff_slope_L1_ME1b_even_(0),
      es_diff_slope_L2_ME1b_even_(0),
      es_diff_slope_L1_ME1b_odd_(0),
...
void CSCL1TPLookupTableME11ILT::set_GEM_pad_CSC_es_ME1b_odd(t_lut lut) { GEM_pad_CSC_es_ME1b_odd_ = std::move(lut); }
...
unsigned CSCL1TPLookupTableME11ILT::GEM_pad_CSC_es_ME1a_even(unsigned pad) const {
  return GEM_pad_CSC_es_ME1a_even_.at(pad);
}

unsigned CSCL1TPLookupTableME11ILT::GEM_pad_CSC_es_ME1b_odd(unsigned pad) const {
  return GEM_pad_CSC_es_ME1b_odd_.at(pad);
}
...
// GEM-CSC trigger: slope correction
unsigned CSCL1TPLookupTableME11ILT::CSC_slope_cosi_2to1_L1_ME11_even(unsigned slope) const {
  return CSC_slope_cosi_2to1_L1_ME11_even_[slope];
}

unsigned CSCL1TPLookupTableME11ILT::CSC_slope_cosi_2to1_L1_ME11_odd(unsigned slope) const {
  return CSC_slope_cosi_2to1_L1_ME11_odd_[slope];
}

unsigned CSCL1TPLookupTableME11ILT::CSC_slope_cosi_3to1_L1_ME11_even(unsigned slope) const {
  return CSC_slope_cosi_3to1_L1_ME11_even_[slope];
}

unsigned CSCL1TPLookupTableME11ILT::CSC_slope_cosi_3to1_L1_ME11_odd(unsigned slope) const {
  return CSC_slope_cosi_3to1_L1_ME11_odd_[slope];
}

unsigned CSCL1TPLookupTableME11ILT::CSC_slope_cosi_corr_L1_ME11_even(unsigned slope) const {
  return CSC_slope_cosi_corr_L1_ME11_even_[slope];
}

unsigned CSCL1TPLookupTableME11ILT::CSC_slope_cosi_corr_L1_ME11_odd(unsigned slope) const {
  return CSC_slope_cosi_corr_L1_ME11_odd_[slope];
}

unsigned CSCL1TPLookupTableME11ILT::CSC_slope_cosi_corr_L2_ME11_even(unsigned slope) const {
  return CSC_slope_cosi_corr_L2_ME11_even_[slope];
}

unsigned CSCL1TPLookupTableME11ILT::CSC_slope_cosi_corr_L2_ME11_odd(unsigned slope) const {
  return CSC_slope_cosi_corr_L2_ME11_odd_[slope];
}

unsigned CSCL1TPLookupTableME11ILT::CSC_slope_corr_L1_ME11_even(unsigned slope) const {
  return CSC_slope_corr_L1_ME11_even_[slope];
}

unsigned CSCL1TPLookupTableME11ILT::CSC_slope_corr_L1_ME11_odd(unsigned slope) const {
  return CSC_slope_corr_L1_ME11_odd_[slope];
}

unsigned CSCL1TPLookupTableME11ILT::CSC_slope_corr_L2_ME11_even(unsigned slope) const {
  return CSC_slope_corr_L2_ME11_even_[slope];
}

unsigned CSCL1TPLookupTableME11ILT::CSC_slope_corr_L2_ME11_odd(unsigned slope) const {
  return CSC_slope_corr_L2_ME11_odd_[slope];
}

unsigned CSCL1TPLookupTableME11ILT::es_diff_slope_L1_ME1a_even(unsigned es_diff) const {
  return es_diff_slope_L1_ME1a_even_[es_diff];
}

unsigned CSCL1TPLookupTableME11ILT::es_diff_slope_L2_ME1a_even(unsigned es_diff) const {
  return es_diff_slope_L2_ME1a_even_[es_diff];
}

unsigned CSCL1TPLookupTableME11ILT::es_diff_slope_L1_ME1a_odd(unsigned es_diff) const {
  return es_diff_slope_L1_ME1a_odd_[es_diff];
}

unsigned CSCL1TPLookupTableME11ILT::es_diff_slope_L2_ME1a_odd(unsigned es_diff) const {
  return es_diff_slope_L2_ME1a_odd_[es_diff];
}

unsigned CSCL1TPLookupTableME11ILT::es_diff_slope_L1_ME1b_even(unsigned es_diff) const {
  return es_diff_slope_L1_ME1b_even_[es_diff];
}

unsigned CSCL1TPLookupTableME11ILT::es_diff_slope_L2_ME1b_even(unsigned es_diff) const {
  return es_diff_slope_L2_ME1b_even_[es_diff];
}

unsigned CSCL1TPLookupTableME11ILT::es_diff_slope_L1_ME1b_odd(unsigned es_diff) const {
  return es_diff_slope_L1_ME1b_odd_[es_diff];
}

unsigned CSCL1TPLookupTableME11ILT::es_diff_slope_L2_ME1b_odd(unsigned es_diff) const {
  return es_diff_slope_L2_ME1b_odd_[es_diff];
}
