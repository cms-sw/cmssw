...
namespace pixelgpudetails {
  ...
  void SiPixelRawToClusterGPUKernel::makeClustersAsync(bool isRun2,
...

    {
      ...
      if (isRun2)
        gpuCalibPixel::calibDigis<true><<<blocks, threadsPerBlock, 0, stream>>>(digis_d.view()->moduleInd_,
                                                                                digis_d.view()->xx_,
                                                                                digis_d.view()->yy_,
                                                                                digis_d.view()->adc_,
                                                                                gains,
        ...
        gpuCalibPixel::calibDigis<false><<<blocks, threadsPerBlock, 0, stream>>>(digis_d.view()->moduleInd_,
                                                                                 digis_d.view()->xx_,
                                                                                 digis_d.view()->yy_,
                                                                                 digis_d.view()->adc_,
                                                                                 gains,
