...
/*
if (mType == TrackerGeometry::ModuleType::Ph2PSS) {
  if (fabs(localPosClu.y() - localPosHit.y())>1.1565) {
    std::cout << "--------------------" << std::endl;
    std::cout << "PSSy HIT OUT OF RANGE! simhit: " << &*simhit << " clust: " << clustIt << std::endl;
    std::cout << "Module detid: " << rawid <<std::endl;
    std::cout << "Look at y...  " << localPosHit.y() << " " << localPosClu.y() << " " << clustIt->column() << std::endl;
    std::cout << "Look at x...  " << localPosHit.x() << " " << localPosClu.x() << " " << clustIt->center() << std::endl;
    std::cout << "Cluster size  " << rechitIt->cluster()->size() << std::endl;
    std::cout << "simtrack info: " << clusterSimTrackIds.size() << " simtracks; Ids: ";
    for (unsigned int i(0); i < clusterSimTrackIds.size(); ++i) {
      std::cout << clusterSimTrackIds.at(i) << " " << simTracks[clusterSimTrackIds.at(i)].momentum().pt() << " ";
    }
    std::cout << std::endl;
//    continue;
  }
...
if (mType == TrackerGeometry::ModuleType::Ph2PSP) {
  if (fabs(localPosClu.y() - localPosHit.y())>0.0722811) {
    std::cout << "--------------------" << std::endl;
    std::cout << "PSPy HIT OUT OF RANGE! simhit: " << &*simhit << " clust: " << clustIt << std::endl;
    std::cout << "Module detid: " << rawid <<std::endl;
    std::cout << "Look at y...  " << localPosHit.y() << " " << localPosClu.y() << " " << clustIt->column() << std::endl;
    std::cout << "Look at x...  " << localPosHit.x() << " " << localPosClu.x() << " " << clustIt->center() << std::endl;
    std::cout << "Cluster size  " << rechitIt->cluster()->size() << std::endl;
    std::cout << "simtrack info: " << clusterSimTrackIds.size() << " simtracks; Ids: ";
    for (unsigned int i(0); i < clusterSimTrackIds.size(); ++i) {
      std::cout << clusterSimTrackIds.at(i) << " ";
    }
    std::cout << std::endl;
//    continue;
  }
...
if (mType == TrackerGeometry::ModuleType::Ph2SS) {
  if (fabs(localPosClu.y() - localPosHit.y())>2.5125) {
    std::cout << "--------------------" << std::endl;
    std::cout << "2SSy HIT OUT OF RANGE! simhit: " << &*simhit << " clust: " << clustIt << std::endl;
    std::cout << "Module detid: " << rawid <<std::endl;
    std::cout << "Look at y...  " << localPosHit.y() << " " << localPosClu.y() << " " << clustIt->column() << std::endl;
    std::cout << "Look at x...  " << localPosHit.x() << " " << localPosClu.x() << " " << clustIt->center() << std::endl;
    std::cout << "Cluster size  " << rechitIt->cluster()->size() << std::endl;
...
if (mType == TrackerGeometry::ModuleType::Ph2PSS) {
  if (fabs(localPosClu.x() - localPosHit.x())>0.02) {
    std::cout << "--------------------" << std::endl;
    std::cout << "PSSx HIT OUT OF RANGE! simhit: " << &*simhit << " clust: " << clustIt << std::endl;
    std::cout << "Module detid: " << rawid <<std::endl;
    std::cout << "Look at y...  " << localPosHit.y() << " " << localPosClu.y() << " " << clustIt->column() << std::endl;
    std::cout << "Look at x...  " << localPosHit.x() << " " << localPosClu.x() << " " << clustIt->center() << std::endl;
    std::cout << "Cluster size  " << rechitIt->cluster()->size() << std::endl;
...
if (mType == TrackerGeometry::ModuleType::Ph2PSP) {
  if (fabs(localPosClu.x() - localPosHit.x())>0.02) {
    std::cout << "--------------------" << std::endl;
    std::cout << "PSPx HIT OUT OF RANGE! simhit: " << &*simhit << " clust: " << clustIt << std::endl;
    std::cout << "Module detid: " << rawid <<std::endl;
    std::cout << "Look at y...  " << localPosHit.y() << " " << localPosClu.y() << " " << clustIt->column() << std::endl;
    std::cout << "Look at x...  " << localPosHit.x() << " " << localPosClu.x() << " " << clustIt->center() << std::endl;
    std::cout << "Cluster size  " << rechitIt->cluster()->size() << std::endl;
...
if (mType == TrackerGeometry::ModuleType::Ph2SS) {
  if (fabs(localPosClu.x() - localPosHit.x())>0.02) {
    std::cout << "--------------------" << std::endl;
    std::cout << "2SSx HIT OUT OF RANGE! simhit: " << &*simhit << " clust: " << clustIt << std::endl;
    std::cout << "Module detid: " << rawid <<std::endl;
    std::cout << "Look at y...  " << localPosHit.y() << " " << localPosClu.y() << " " << clustIt->column() << std::endl;
    std::cout << "Look at x...  " << localPosHit.x() << " " << localPosClu.x() << " " << clustIt->center() << std::endl;
    std::cout << "Cluster size  " << rechitIt->cluster()->size() << std::endl;
