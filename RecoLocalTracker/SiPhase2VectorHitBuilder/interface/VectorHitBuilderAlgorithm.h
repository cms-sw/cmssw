...
class VectorHitBuilderAlgorithm : public VectorHitBuilderAlgorithmBase {
 public:
  ...
  class LocalPositionSort {
      public: 
          LocalPositionSort(const TrackerGeometry *geometry, const ClusterParameterEstimator<Phase2TrackerCluster1D>* cpe, const GeomDet * geomDet) : geom_(geometry), cpe_(cpe), geomDet_(geomDet) {}
