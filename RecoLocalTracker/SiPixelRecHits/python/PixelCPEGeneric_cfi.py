...
phase2_tracker.toModify(PixelCPEGenericESProducer,
  ...
  xerr_barrel_ln = cms.vdouble(0.00025, 0.00030, 0.00035, 0.00035),
  xerr_barrel_ln_def = 0.00035,
  yerr_barrel_ln = cms.vdouble(0.00210, 0.00115, 0.00125),
  ...
  # if SmallPitch
  # xerr_barrel_l1 = cms.vdouble(0.00104, 0.000691, 0.00122),
  # xerr_barrel_l1_def = 0.00321,
  # yerr_barrel_l1 = cms.vdouble(0.00199, 0.00136, 0.0015, 0.00153, 0.00152, 0.00171, 0.00154, 0.00157, 0.00154),
  # yerr_barrel_l1_def = 0.00164
  # else
  xerr_barrel_l1 = cms.vdouble(0.00025, 0.00030, 0.00035, 0.00035),
  xerr_barrel_l1_def = 0.00035,
  yerr_barrel_l1 = cms.vdouble(0.00210, 0.00115, 0.00125),
