...
/**
   ...
   also implements direct access to measurement frame, since that is needed
during the track refitting
...
public:
  ...
  virtual void localParameters(AClusters const &clusters,
                               ALocalValues &retValues, const GeomDetUnit &gd,
                               const LocalTrajectoryParameters &ltp) const {}

  virtual LocalValues localParameters(const SiStripCluster &,
                                      const GeomDetUnit &) const {
  ...
  virtual LocalValues
  localParameters(const SiStripCluster &cluster, const GeomDetUnit &gd,
  ...
  localParametersV(const SiStripCluster &cluster, const GeomDetUnit &gd,
                   const TrajectoryStateOnSurface &tsos) const {
    VLocalValues vlp;
