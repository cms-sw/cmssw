...
public:
  ...
  virtual LocalValues localParameters(const T &cluster, const GeomDetUnit &gd,
                                      const LocalTrajectoryParameters &) const {
    return localParameters(cluster, gd);
  }
  virtual LocalValues
  localParameters(const T &cluster, const GeomDetUnit &gd,
  ...
  virtual VLocalValues
  localParametersV(const T &cluster, const GeomDetUnit &gd,
                   const TrajectoryStateOnSurface &tsos) const {
    VLocalValues vlp;
  ...
  virtual void enterLocalParameters(unsigned int id,
