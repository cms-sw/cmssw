...
namespace ALPAKA_ACCELERATOR_NAMESPACE::sistrip {
    ...
    class siStripConvKer_fillClCollSlim {
      ...
      ALPAKA_FN_HOST_ACC void operator()(
        ...
        SiStripClustersSlimView slimCollection
      ) const {
        //
  ...
  void SiStripClustersToLegacyAlgo::consumeSoA(Queue& queue, const SiStripClustersDevice& clusters_d, uint32_t goodCandidates) {
  ...
  SiStripClustersToLegacyAlgo::convert(Queue& queue, const SiStripDigiHost& amplitudes_h) {
