{
  TFile *_file0 = TFile::Open("pull_matched_1simhit.root");
  ...
  // TIB_X_L1_COMBINED->Fit("gaus");
  //TIB_X_L1->Fit("gaus");
  TIB_X_L1_COMBINED->SetLineColor(kBlack);
  TIB_X_L1_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  TIB_X_L1_COMBINED->SetLineColor(kBlack);
  // TIB_X_L1_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  gStyle->SetOptFit(1111);
  TIB_X_L1_COMBINED->Draw();
  ...
  // TIB_X_L2_COMBINED->Fit("gaus");
  // TIB_X_L2->Fit("gaus");
  TIB_X_L2_COMBINED->SetLineColor(kBlack);
  TIB_X_L2_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  TIB_X_L2_COMBINED->SetLineColor(kBlack);
  // TIB_X_L2_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  gStyle->SetOptFit(1111);
  TIB_X_L2_COMBINED->Draw();
  ...
  //  TIB_Y_L1_COMBINED->Fit("gaus");
  // TIB_Y_L1->Fit("gaus");
  TIB_Y_L1_COMBINED->SetLineColor(kBlack);
  TIB_Y_L1_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  TIB_Y_L1_COMBINED->SetLineColor(kBlack);
  // TIB_Y_L1_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  gStyle->SetOptFit(1111);
  TIB_Y_L1_COMBINED->Draw();
  ...
  // TIB_Y_L2_COMBINED->Fit("gaus");
  // TIB_Y_L2->Fit("gaus");
  TIB_Y_L2_COMBINED->SetLineColor(kBlack);
  TIB_Y_L2_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  TIB_Y_L2_COMBINED->SetLineColor(kBlack);
  // TIB_Y_L2_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  gStyle->SetOptFit(1111);
  TIB_Y_L2_COMBINED->Draw();
  ...
  // TOB_X_L1_COMBINED->Fit("gaus");
  // TOB_X_L1->Fit("gaus");
  TOB_X_L1_COMBINED->SetLineColor(kBlack);
  TOB_X_L1_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  TOB_X_L1_COMBINED->SetLineColor(kBlack);
  //  TOB_X_L1_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  gStyle->SetOptFit(1111);
  TOB_X_L1_COMBINED->Draw();
  ...
  // TOB_X_L2_COMBINED->Fit("gaus");
  //  TOB_X_L2->Fit("gaus");
  TOB_X_L2_COMBINED->SetLineColor(kBlack);
  TOB_X_L2_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  TOB_X_L2_COMBINED->SetLineColor(kBlack);
  //  TOB_X_L2_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  gStyle->SetOptFit(1111);
  TOB_X_L2_COMBINED->Draw();
  ...
  //  TOB_Y_L1_COMBINED->Fit("gaus");
  //  TOB_Y_L1->Fit("gaus");
  TOB_Y_L1_COMBINED->SetLineColor(kBlack);
  TOB_Y_L1_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  TOB_Y_L1_COMBINED->SetLineColor(kBlack);
  //  TOB_Y_L1_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  gStyle->SetOptFit(1111);
  TOB_Y_L1_COMBINED->Draw();
  ...
  //  TOB_Y_L2_COMBINED->Fit("gaus");
  //  TOB_Y_L2->Fit("gaus");
  TOB_Y_L2_COMBINED->SetLineColor(kBlack);
  TOB_Y_L2_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  TOB_Y_L2_COMBINED->SetLineColor(kBlack);
  //  TOB_Y_L2_COMBINED->GetFunction("gaus")->SetLineColor(kBlack);
  gStyle->SetOptFit(1111);
  TOB_Y_L2_COMBINED->Draw();
