...
public:
  ...
  void localParameters(AClusters const &clusters, ALocalValues &retValues,
  ...
  StripClusterParameterEstimator::LocalValues
  localParameters(const SiStripCluster &, const GeomDetUnit &,
  ...
  StripCPEfromTrackAngle(edm::ParameterSet &conf, const MagneticField &mag,
