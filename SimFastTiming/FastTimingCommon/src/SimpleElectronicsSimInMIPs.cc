...
void SimpleElectronicsSimInMIPs::run(const ftl::FTLSimHitDataAccumulator& input, FTLDigiCollection& output) const {
...
void SimpleElectronicsSimInMIPs::updateOutput(FTLDigiCollection& coll, const FTLDataFrame& rawDataFrame) const {
  int itIdx(9);
