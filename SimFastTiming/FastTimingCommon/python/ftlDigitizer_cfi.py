...
_barrel_FastTimeDigitizer = cms.PSet(
        hitCollection     = cms.InputTag("g4SimHits:FastTimerHitsBarrel"),
        digiCollection    = cms.string("FTLBarrel"),
        ...
        ElectronicsSimilation = cms.PSet(
            # n bits for the ADC 
...
_endcap_FastTimeDigitizer = cms.PSet(
        hitCollection     = cms.InputTag("g4SimHits:FastTimerHitsEndcap"),
        digiCollection    = cms.string("FTLEndcap"),
        maxSimHitsAccTime = cms.uint32(100),
        bxTime            = cms.double(25),
        tofDelay          = cms.double(1),
        DeviceSimulation = cms.PSet(
