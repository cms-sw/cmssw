...
# Reconstruction sequence: no electron or photon ID & isolation, no b-tagging (needs vertex)
...
process.patBeforeLevel0Reco_withoutPFTau.remove(process.patAODPhotonIsolation)
process.patBeforeLevel0Reco_withoutPFTau.remove(process.patAODPhotonID)


# Cleaning sequence: only keep muons and jets (+ CaloMET)
