...
namespace pat {
  ...
  protected:
    PhysVarHisto * h_nSignalTracks_;       //!<   Number of tracks in signal cone
    PhysVarHisto * h_nIsolationTracks_;    //!<   Number of tracks in isolation cone
    PhysVarHisto * h_emEnergyFraction_ ;   //!<   &&& document this
    PhysVarHisto * h_eOverP_  ;            //!<   &&& document this
  };
}
#endif
