#ifndef __InputGenJetsParticlePlusHadronSelector__
#define __InputGenJetsParticlePlusHadronSelector__

/* \class InputGenJetsParticlePlusHadronSelector
 * 
...
class InputGenJetsParticlePlusHadronSelector : public edm::EDProducer {
  // collection type
 public:
  typedef std::vector<bool>     ParticleBitmap;
  typedef std::vector<const reco::GenParticle*> ParticleVector;
      
  InputGenJetsParticlePlusHadronSelector(const edm::ParameterSet & ); 
  ~InputGenJetsParticlePlusHadronSelector(); 
