...
void MuonVertexTableProducer::produce(edm::StreamID, edm::Event& iEvent, const edm::EventSetup& iSetup) const 
{
  ...
  std::map<std::string,std::vector<float>> chi2,ndof,normChi2,dR,originalMuonIdx1,originalMuonIdx2,refittedTrackIdx1,refittedTrackIdx2,isDSAMuon1,isDSAMuon2;
  std::map<std::string,std::vector<float>> displacedTrackIso03Dimuon1,displacedTrackIso03Dimuon2,displacedTrackIso04Dimuon1,displacedTrackIso04Dimuon2;
  std::map<std::string,std::vector<float>> displacedTrackIso03Muon1,displacedTrackIso03Muon2,displacedTrackIso04Muon1,displacedTrackIso04Muon2,proxDeltaR;
  std::map<std::string,std::vector<float>> DCA,DCAstatus,DCAx,DCAy,DCAz;
  std::map<std::string,std::vector<float>> hitsInFrontOfVert1,missHitsAfterVert1,hitsInFrontOfVert2,missHitsAfterVert2;

  std::map<std::string,std::vector<float>> refittedTrackIdx,refittedTrackIsDSAMuon,refittedTrackOriginalIdx,refittedTrackPt,refittedTrackPtErr,refittedTrackPx,refittedTrackPy,refittedTrackPz;
  std::map<std::string,std::vector<float>> refittedTrackEta,refittedTrackEtaErr,refittedTrackPhi,refittedTrackPhiErr,refittedTrackCharge,refittedTrackNormChi2,refittedTrackNdof,refittedTrackChi2;
  std::map<std::string,std::vector<float>> refittedTrackDzPV,refittedTrackDzPVErr,refittedTrackDxyPVTraj,refittedTrackDxyPVTrajErr,refittedTrackDxyPVSigned,refittedTrackDxyPVSignedErr,refittedTrackIp3DPVSigned,refittedTrackIp3DPVSignedErr;
  std::map<std::string,std::vector<float>> refittedTrackIso03Dimuon1,refittedTrackIso03Dimuon2,refittedTrackIso04Dimuon1,refittedTrackIso04Dimuon2,refittedTrackIso03Muon1,refittedTrackIso03Muon2,refittedTrackIso04Muon1,refittedTrackIso04Muon2;
  ...
  for(size_t i = 0; i < patMuonHandle->size(); i++){
    ...
    for(size_t j = i+1; j < patMuonHandle->size(); j++){
      ...
      displacedTrackIso03Dimuon1["PATPAT"].push_back(getDisplacedTrackerIsolation<pat::Muon,pat::Muon>(*generalTracks.product(), muon_i, muonVertex,*beamSpotHandle.product(), &muon_j, 0.3));
      displacedTrackIso04Dimuon1["PATPAT"].push_back(getDisplacedTrackerIsolation<pat::Muon,pat::Muon>(*generalTracks.product(), muon_i, muonVertex,*beamSpotHandle.product(), &muon_j, 0.4));
      displacedTrackIso03Dimuon2["PATPAT"].push_back(getDisplacedTrackerIsolation<pat::Muon,pat::Muon>(*generalTracks.product(), muon_j, muonVertex,*beamSpotHandle.product(), &muon_i, 0.3));
      displacedTrackIso04Dimuon2["PATPAT"].push_back(getDisplacedTrackerIsolation<pat::Muon,pat::Muon>(*generalTracks.product(), muon_j, muonVertex,*beamSpotHandle.product(), &muon_i, 0.4));
      displacedTrackIso03Muon1["PATPAT"].push_back(getDisplacedTrackerIsolation<pat::Muon,pat::Muon>(*generalTracks.product(), muon_i, muonVertex,*beamSpotHandle.product(), nullptr, 0.3));
      displacedTrackIso04Muon1["PATPAT"].push_back(getDisplacedTrackerIsolation<pat::Muon,pat::Muon>(*generalTracks.product(), muon_i, muonVertex,*beamSpotHandle.product(), nullptr, 0.4));
      displacedTrackIso03Muon2["PATPAT"].push_back(getDisplacedTrackerIsolation<pat::Muon,pat::Muon>(*generalTracks.product(), muon_j, muonVertex,*beamSpotHandle.product(), nullptr, 0.3));
      displacedTrackIso04Muon2["PATPAT"].push_back(getDisplacedTrackerIsolation<pat::Muon,pat::Muon>(*generalTracks.product(), muon_j, muonVertex,*beamSpotHandle.product(), nullptr, 0.4));
      ...
      else proxDeltaR["PATPAT"].push_back(-1);
      ...
      for (size_t k = 0; k < refittedTracks.size(); ++k) {
        ...
        GlobalVector muonRefTrackDir_i(refittedTrack.track().px(),refittedTrack.track().py(),refittedTrack.track().pz());
        refittedTrackDxyPVSigned["PATPAT"].push_back(IPTools::signedTransverseImpactParameter(refittedTrack, muonRefTrackDir_i, pv).second.value());
        refittedTrackDxyPVSignedErr["PATPAT"].push_back(IPTools::signedTransverseImpactParameter(refittedTrack, muonRefTrackDir_i, pv).second.error());
        refittedTrackIp3DPVSigned["PATPAT"].push_back(IPTools::signedImpactParameter3D(refittedTrack, muonRefTrackDir_i, pv).second.value());
        refittedTrackIp3DPVSignedErr["PATPAT"].push_back(IPTools::signedImpactParameter3D(refittedTrack, muonRefTrackDir_i, pv).second.error());  
        
        refittedTrackIdx["PATPAT"].push_back(ppRefittedTrackIdx_counter);
        if (k == 0) refittedTrackIdx1["PATPAT"].push_back(ppRefittedTrackIdx_counter);
        if (k == 1) refittedTrackIdx2["PATPAT"].push_back(ppRefittedTrackIdx_counter);
        ppRefittedTrackIdx_counter++;
      }

      refittedTrackIso03Dimuon1["PATPAT"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_i.track(), muonVertex,*beamSpotHandle.product(), &refittedTrack_j.track(), 0.3));
      refittedTrackIso04Dimuon1["PATPAT"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_i.track(), muonVertex,*beamSpotHandle.product(), &refittedTrack_j.track(), 0.4));
      refittedTrackIso03Dimuon2["PATPAT"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_j.track(), muonVertex,*beamSpotHandle.product(), &refittedTrack_i.track(), 0.3));
      refittedTrackIso04Dimuon2["PATPAT"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_j.track(), muonVertex,*beamSpotHandle.product(), &refittedTrack_i.track(), 0.4));
      refittedTrackIso03Muon1["PATPAT"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_i.track(), muonVertex,*beamSpotHandle.product(), nullptr, 0.3));
      refittedTrackIso04Muon1["PATPAT"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_i.track(), muonVertex,*beamSpotHandle.product(), nullptr, 0.4));
      refittedTrackIso03Muon2["PATPAT"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_j.track(), muonVertex,*beamSpotHandle.product(), nullptr, 0.3));
      refittedTrackIso04Muon2["PATPAT"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_j.track(), muonVertex,*beamSpotHandle.product(), nullptr, 0.4));
    }
    ...
    for(size_t j = 0; j < dsaMuonHandle->size(); j++){
      ...
      displacedTrackIso03Dimuon1["PATDSA"].push_back(getDisplacedTrackerIsolation<pat::Muon,reco::Track>(*generalTracks.product(), muon_i, muonVertex,*beamSpotHandle.product(), &muonTrack_j, 0.3));
      displacedTrackIso04Dimuon1["PATDSA"].push_back(getDisplacedTrackerIsolation<pat::Muon,reco::Track>(*generalTracks.product(), muon_i, muonVertex,*beamSpotHandle.product(), &muonTrack_j, 0.4));
      displacedTrackIso03Dimuon2["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track,pat::Muon>(*generalTracks.product(), muonTrack_j, muonVertex,*beamSpotHandle.product(), &muon_i, 0.3));
      displacedTrackIso04Dimuon2["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track,pat::Muon>(*generalTracks.product(), muonTrack_j, muonVertex,*beamSpotHandle.product(), &muon_i, 0.4));
      displacedTrackIso03Muon1["PATDSA"].push_back(getDisplacedTrackerIsolation<pat::Muon,reco::Track>(*generalTracks.product(), muon_i, muonVertex,*beamSpotHandle.product(), nullptr, 0.3));
      displacedTrackIso04Muon1["PATDSA"].push_back(getDisplacedTrackerIsolation<pat::Muon,reco::Track>(*generalTracks.product(), muon_i, muonVertex,*beamSpotHandle.product(), nullptr, 0.4));
      displacedTrackIso03Muon2["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track,pat::Muon>(*generalTracks.product(), muonTrack_j, muonVertex,*beamSpotHandle.product(), nullptr, 0.3));
      displacedTrackIso04Muon2["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track,pat::Muon>(*generalTracks.product(), muonTrack_j, muonVertex,*beamSpotHandle.product(), nullptr, 0.4));
      ...
      else proxDeltaR["PATDSA"].push_back(-1);
      ...
      for (size_t k = 0; k < refittedTracks.size(); ++k) {
        ...
        GlobalVector muonRefTrackDir_i(refittedTrack.track().px(),refittedTrack.track().py(),refittedTrack.track().pz());
        refittedTrackDxyPVSigned["PATDSA"].push_back(IPTools::signedTransverseImpactParameter(refittedTrack, muonRefTrackDir_i, pv).second.value());
        refittedTrackDxyPVSignedErr["PATDSA"].push_back(IPTools::signedTransverseImpactParameter(refittedTrack, muonRefTrackDir_i, pv).second.error());
        refittedTrackIp3DPVSigned["PATDSA"].push_back(IPTools::signedImpactParameter3D(refittedTrack, muonRefTrackDir_i, pv).second.value());
        refittedTrackIp3DPVSignedErr["PATDSA"].push_back(IPTools::signedImpactParameter3D(refittedTrack, muonRefTrackDir_i, pv).second.error());  
        
        refittedTrackIdx["PATDSA"].push_back(pdRefittedTrackIdx_counter);
        if (k == 0) refittedTrackIdx1["PATDSA"].push_back(pdRefittedTrackIdx_counter);
        if (k == 1) refittedTrackIdx2["PATDSA"].push_back(pdRefittedTrackIdx_counter);
        pdRefittedTrackIdx_counter++;
      }
  
      refittedTrackIso03Dimuon1["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_i.track(), muonVertex,*beamSpotHandle.product(), &refittedTrack_j.track(), 0.3));
      refittedTrackIso04Dimuon1["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_i.track(), muonVertex,*beamSpotHandle.product(), &refittedTrack_j.track(), 0.4));
      refittedTrackIso03Dimuon2["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_j.track(), muonVertex,*beamSpotHandle.product(), &refittedTrack_i.track(), 0.3));
      refittedTrackIso04Dimuon2["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_j.track(), muonVertex,*beamSpotHandle.product(), &refittedTrack_i.track(), 0.4));
      refittedTrackIso03Muon1["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_i.track(), muonVertex,*beamSpotHandle.product(), nullptr, 0.3));
      refittedTrackIso04Muon1["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_i.track(), muonVertex,*beamSpotHandle.product(), nullptr, 0.4));
      refittedTrackIso03Muon2["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_j.track(), muonVertex,*beamSpotHandle.product(), nullptr, 0.3));
      refittedTrackIso04Muon2["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_j.track(), muonVertex,*beamSpotHandle.product(), nullptr, 0.4));
    }
  }
  ...
  for(size_t i = 0; i < dsaMuonHandle->size(); i++){
    ...
    for(size_t j = i + 1; j < dsaMuonHandle->size(); j++){
      ...
      displacedTrackIso03Dimuon1["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), muonTrack_i, muonVertex,*beamSpotHandle.product(), &muonTrack_j, 0.3));
      displacedTrackIso04Dimuon1["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), muonTrack_i, muonVertex,*beamSpotHandle.product(), &muonTrack_j, 0.4));
      displacedTrackIso03Dimuon2["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), muonTrack_j, muonVertex,*beamSpotHandle.product(), &muonTrack_i, 0.3));
      displacedTrackIso04Dimuon2["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), muonTrack_j, muonVertex,*beamSpotHandle.product(), &muonTrack_i, 0.4));
      displacedTrackIso03Muon1["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), muonTrack_i, muonVertex,*beamSpotHandle.product(), nullptr, 0.3));
      displacedTrackIso04Muon1["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), muonTrack_i, muonVertex,*beamSpotHandle.product(), nullptr, 0.4));
      displacedTrackIso03Muon2["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), muonTrack_j, muonVertex,*beamSpotHandle.product(), nullptr, 0.3));
      displacedTrackIso04Muon2["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), muonTrack_j, muonVertex,*beamSpotHandle.product(), nullptr, 0.4));
      ...
      for (size_t k = 0; k < refittedTracks.size(); ++k) {
        ...
        GlobalVector muonRefTrackDir_i(refittedTrack.track().px(),refittedTrack.track().py(),refittedTrack.track().pz());
        refittedTrackDxyPVSigned["DSADSA"].push_back(IPTools::signedTransverseImpactParameter(refittedTrack, muonRefTrackDir_i, pv).second.value());
        refittedTrackDxyPVSignedErr["DSADSA"].push_back(IPTools::signedTransverseImpactParameter(refittedTrack, muonRefTrackDir_i, pv).second.error());
        refittedTrackIp3DPVSigned["DSADSA"].push_back(IPTools::signedImpactParameter3D(refittedTrack, muonRefTrackDir_i, pv).second.value());
        refittedTrackIp3DPVSignedErr["DSADSA"].push_back(IPTools::signedImpactParameter3D(refittedTrack, muonRefTrackDir_i, pv).second.error());  
        
        refittedTrackIdx["DSADSA"].push_back(ddRefittedTrackIdx_counter);
        if (k == 0) refittedTrackIdx1["DSADSA"].push_back(ddRefittedTrackIdx_counter);
        if (k == 1) refittedTrackIdx2["DSADSA"].push_back(ddRefittedTrackIdx_counter);
        ddRefittedTrackIdx_counter++;
      }
  
      refittedTrackIso03Dimuon1["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_i.track(), muonVertex,*beamSpotHandle.product(), &refittedTrack_j.track(), 0.3));
      refittedTrackIso04Dimuon1["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_i.track(), muonVertex,*beamSpotHandle.product(), &refittedTrack_j.track(), 0.4));
      refittedTrackIso03Dimuon2["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_j.track(), muonVertex,*beamSpotHandle.product(), &refittedTrack_i.track(), 0.3));
      refittedTrackIso04Dimuon2["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_j.track(), muonVertex,*beamSpotHandle.product(), &refittedTrack_i.track(), 0.4));
      refittedTrackIso03Muon1["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_i.track(), muonVertex,*beamSpotHandle.product(), nullptr, 0.3));
      refittedTrackIso04Muon1["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_i.track(), muonVertex,*beamSpotHandle.product(), nullptr, 0.4));
      refittedTrackIso03Muon2["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_j.track(), muonVertex,*beamSpotHandle.product(), nullptr, 0.3));
      refittedTrackIso04Muon2["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track,reco::Track>(*generalTracks.product(), refittedTrack_j.track(), muonVertex,*beamSpotHandle.product(), nullptr, 0.4));
    }
  }
