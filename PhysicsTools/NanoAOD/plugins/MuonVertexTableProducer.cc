...
void MuonVertexTableProducer::produce(edm::StreamID, edm::Event& iEvent, const edm::EventSetup& iSetup) const {
  ...
  for (size_t i = 0; i < patMuonHandle->size(); i++) {
    ...
    for (size_t j = i + 1; j < patMuonHandle->size(); j++) {
      ...
      refittedTrackIso03Dimuon1["PATPAT"].push_back(
          getDisplacedTrackerIsolation<reco::Track, reco::Track>(*generalTracks.product(),
                                                                 refittedTrack_i.track(),
                                                                 muonVertex,
                                                                 *beamSpotHandle.product(),
                                                                 &refittedTrack_j.track(),
                                                                 0.3));
      refittedTrackIso04Dimuon1["PATPAT"].push_back(
          getDisplacedTrackerIsolation<reco::Track, reco::Track>(*generalTracks.product(),
                                                                 refittedTrack_i.track(),
                                                                 muonVertex,
                                                                 *beamSpotHandle.product(),
                                                                 &refittedTrack_j.track(),
                                                                 0.4));
      refittedTrackIso03Dimuon2["PATPAT"].push_back(
          getDisplacedTrackerIsolation<reco::Track, reco::Track>(*generalTracks.product(),
                                                                 refittedTrack_j.track(),
                                                                 muonVertex,
                                                                 *beamSpotHandle.product(),
                                                                 &refittedTrack_i.track(),
                                                                 0.3));
      refittedTrackIso04Dimuon2["PATPAT"].push_back(
          getDisplacedTrackerIsolation<reco::Track, reco::Track>(*generalTracks.product(),
                                                                 refittedTrack_j.track(),
                                                                 muonVertex,
                                                                 *beamSpotHandle.product(),
      ...
      refittedTrackIso03Muon1["PATPAT"].push_back(getDisplacedTrackerIsolation<reco::Track, reco::Track>(
          *generalTracks.product(), refittedTrack_i.track(), muonVertex, *beamSpotHandle.product(), nullptr, 0.3));
      refittedTrackIso04Muon1["PATPAT"].push_back(getDisplacedTrackerIsolation<reco::Track, reco::Track>(
          *generalTracks.product(), refittedTrack_i.track(), muonVertex, *beamSpotHandle.product(), nullptr, 0.4));
      refittedTrackIso03Muon2["PATPAT"].push_back(getDisplacedTrackerIsolation<reco::Track, reco::Track>(
          *generalTracks.product(), refittedTrack_j.track(), muonVertex, *beamSpotHandle.product(), nullptr, 0.3));
      refittedTrackIso04Muon2["PATPAT"].push_back(getDisplacedTrackerIsolation<reco::Track, reco::Track>(
          *generalTracks.product(), refittedTrack_j.track(), muonVertex, *beamSpotHandle.product(), nullptr, 0.4));
    }
    ...
    for (size_t j = 0; j < dsaMuonHandle->size(); j++) {
      ...
      displacedTrackIso03Dimuon1["PATDSA"].push_back(getDisplacedTrackerIsolation<pat::Muon, reco::Track>(
          *generalTracks.product(), muon_i, muonVertex, *beamSpotHandle.product(), &muonTrack_j, 0.3));
      displacedTrackIso04Dimuon1["PATDSA"].push_back(getDisplacedTrackerIsolation<pat::Muon, reco::Track>(
          *generalTracks.product(), muon_i, muonVertex, *beamSpotHandle.product(), &muonTrack_j, 0.4));
      displacedTrackIso03Dimuon2["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track, pat::Muon>(
          *generalTracks.product(), muonTrack_j, muonVertex, *beamSpotHandle.product(), &muon_i, 0.3));
      displacedTrackIso04Dimuon2["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track, pat::Muon>(
          *generalTracks.product(), muonTrack_j, muonVertex, *beamSpotHandle.product(), &muon_i, 0.4));
      ...
      displacedTrackIso03Muon2["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track, pat::Muon>(
          *generalTracks.product(), muonTrack_j, muonVertex, *beamSpotHandle.product(), nullptr, 0.3));
      displacedTrackIso04Muon2["PATDSA"].push_back(getDisplacedTrackerIsolation<reco::Track, pat::Muon>(
          *generalTracks.product(), muonTrack_j, muonVertex, *beamSpotHandle.product(), nullptr, 0.4));
      ...
      refittedTrackIso03Dimuon1["PATDSA"].push_back(
          getDisplacedTrackerIsolation<reco::Track, reco::Track>(*generalTracks.product(),
                                                                 refittedTrack_i.track(),
                                                                 muonVertex,
                                                                 *beamSpotHandle.product(),
                                                                 &refittedTrack_j.track(),
                                                                 0.3));
      refittedTrackIso04Dimuon1["PATDSA"].push_back(
          getDisplacedTrackerIsolation<reco::Track, reco::Track>(*generalTracks.product(),
                                                                 refittedTrack_i.track(),
                                                                 muonVertex,
                                                                 *beamSpotHandle.product(),
                                                                 &refittedTrack_j.track(),
                                                                 0.4));
      refittedTrackIso03Dimuon2["PATDSA"].push_back(
          getDisplacedTrackerIsolation<reco::Track, reco::Track>(*generalTracks.product(),
                                                                 refittedTrack_j.track(),
                                                                 muonVertex,
                                                                 *beamSpotHandle.product(),
                                                                 &refittedTrack_i.track(),
                                                                 0.3));
      refittedTrackIso04Dimuon2["PATDSA"].push_back(
          getDisplacedTrackerIsolation<reco::Track, reco::Track>(*generalTracks.product(),
                                                                 refittedTrack_j.track(),
                                                                 muonVertex,
                                                                 *beamSpotHandle.product(),
  ...
  for (size_t i = 0; i < dsaMuonHandle->size(); i++) {
    ...
    for (size_t j = i + 1; j < dsaMuonHandle->size(); j++) {
      ...
      displacedTrackIso03Dimuon1["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track, reco::Track>(
          *generalTracks.product(), muonTrack_i, muonVertex, *beamSpotHandle.product(), &muonTrack_j, 0.3));
      displacedTrackIso04Dimuon1["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track, reco::Track>(
          *generalTracks.product(), muonTrack_i, muonVertex, *beamSpotHandle.product(), &muonTrack_j, 0.4));
      displacedTrackIso03Dimuon2["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track, reco::Track>(
          *generalTracks.product(), muonTrack_j, muonVertex, *beamSpotHandle.product(), &muonTrack_i, 0.3));
      displacedTrackIso04Dimuon2["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track, reco::Track>(
          *generalTracks.product(), muonTrack_j, muonVertex, *beamSpotHandle.product(), &muonTrack_i, 0.4));
      displacedTrackIso03Muon1["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track, reco::Track>(
          *generalTracks.product(), muonTrack_i, muonVertex, *beamSpotHandle.product(), nullptr, 0.3));
      displacedTrackIso04Muon1["DSADSA"].push_back(getDisplacedTrackerIsolation<reco::Track, reco::Track>(
          *generalTracks.product(), muonTrack_i, muonVertex, *beamSpotHandle.product(), nullptr, 0.4));
      ...
      refittedTrackIso03Dimuon1["DSADSA"].push_back(
          getDisplacedTrackerIsolation<reco::Track, reco::Track>(*generalTracks.product(),
                                                                 refittedTrack_i.track(),
                                                                 muonVertex,
                                                                 *beamSpotHandle.product(),
                                                                 &refittedTrack_j.track(),
                                                                 0.3));
      refittedTrackIso04Dimuon1["DSADSA"].push_back(
          getDisplacedTrackerIsolation<reco::Track, reco::Track>(*generalTracks.product(),
                                                                 refittedTrack_i.track(),
                                                                 muonVertex,
                                                                 *beamSpotHandle.product(),
                                                                 &refittedTrack_j.track(),
                                                                 0.4));
      refittedTrackIso03Dimuon2["DSADSA"].push_back(
          getDisplacedTrackerIsolation<reco::Track, reco::Track>(*generalTracks.product(),
                                                                 refittedTrack_j.track(),
                                                                 muonVertex,
                                                                 *beamSpotHandle.product(),
                                                                 &refittedTrack_i.track(),
                                                                 0.3));
      refittedTrackIso04Dimuon2["DSADSA"].push_back(
          getDisplacedTrackerIsolation<reco::Track, reco::Track>(*generalTracks.product(),
                                                                 refittedTrack_j.track(),
                                                                 muonVertex,
                                                                 *beamSpotHandle.product(),
