...
fatJetTable = simpleCandidateFlatTableProducer.clone(
    ...
    variables = cms.PSet(P4Vars,
        ...
        particleNet_QCD2HF = Var("bDiscriminator('pfParticleNetFromMiniAODAK8DiscriminatorsJetTags:QCD2hf')",float,doc="ParticleNet tagger QCD 2 HF (b/c) score",precision=10),
        particleNet_QCD1HF = Var("bDiscriminator('pfParticleNetFromMiniAODAK8DiscriminatorsJetTags:QCD1hf')",float,doc="ParticleNet tagger QCD 1 HF (b/c) score",precision=10),
        particleNet_QCD0HF = Var("bDiscriminator('pfParticleNetFromMiniAODAK8DiscriminatorsJetTags:QCD0hf')",float,doc="ParticleNet tagger QCD 0 HF (b/c) score",precision=10),
