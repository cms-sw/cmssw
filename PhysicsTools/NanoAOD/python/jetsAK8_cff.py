...
fatJetTable = simpleCandidateFlatTableProducer.clone(
    ...
    variables = cms.PSet(P4Vars,
        ...
        particleNet_TvsQCD = Var("bDiscriminator('pfParticleNetDiscriminatorsJetTags:TvsQCD')",float,doc="ParticleNet tagger (w/ mass) top vs QCD discriminator",precision=10),
        particleNet_WvsQCD = Var("bDiscriminator('pfParticleNetDiscriminatorsJetTags:WvsQCD')",float,doc="ParticleNet tagger (w/ mass) W vs QCD discriminator",precision=10),
        particleNet_ZvsQCD = Var("bDiscriminator('pfParticleNetDiscriminatorsJetTags:ZvsQCD')",float,doc="ParticleNet tagger (w/ mass) Z vs QCD discriminator",precision=10),
        particleNet_XbbvsQCD = Var("bDiscriminator('pfParticleNetFromMiniAODAK8DiscriminatorsJetTags:HbbvsQCD')",float,doc="ParticleNet tagger X(->bb) vs QCD discriminator",precision=10),
        particleNet_XccvsQCD = Var("bDiscriminator('pfParticleNetFromMiniAODAK8DiscriminatorsJetTags:HccvsQCD')",float,doc="ParticleNet tagger X(->cc) vs QCD discriminator",precision=10),
        particleNet_XttvsQCD = Var("bDiscriminator('pfParticleNetFromMiniAODAK8DiscriminatorsJetTags:HttvsQCD')",float,doc="ParticleNet tagger X(->tau_h tau_x) vs QCD discriminator",precision=10),
        particleNet_H4qvsQCD = Var("bDiscriminator('pfParticleNetDiscriminatorsJetTags:H4qvsQCD')",float,doc="ParticleNet tagger (w/ mass) H(->VV->qqqq) vs QCD discriminator",precision=10),
        particleNet_QCD = Var("bDiscriminator('pfParticleNetFromMiniAODAK8DiscriminatorsJetTags:QCD2hf')+bDiscriminator('pfParticleNetFromMiniAODAK8DiscriminatorsJetTags:QCD1hf')+bDiscriminator('pfParticleNetFromMiniAODAK8DiscriminatorsJetTags:QCD0hf')",float,doc="ParticleNet tagger QCD(0+1+2HF) sum",precision=10),
        particleNet_QCDHF = Var("bDiscriminator('pfParticleNetFromMiniAODAK8DiscriminatorsJetTags:QCD2hf')+bDiscriminator('pfParticleNetFromMiniAODAK8DiscriminatorsJetTags:QCD1hf')",float,doc="ParticleNet tagger QCD 1 or 2 HF (b/c) vs. 0HF score",precision=10),
        particleNet_mass = Var("bDiscriminator('pfParticleNetFromMiniAODAK8DiscriminatorsJetTags:masscorr')",float,doc="ParticleNet mass regression",precision=10),
