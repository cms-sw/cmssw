...
fatJetTable = simpleCandidateFlatTableProducer.clone(
    ...
    variables = cms.PSet(P4Vars,
        ...
        particleNetWithMass_ZbbvsQCD = Var("bDiscriminator('pfParticleNetDiscriminatorsJetTags:ZbbvsQCD')",float,doc="ParticleNet tagger (w/mass) Z(->bb) vs QCD discriminator",precision=10),
        particleNetWithMass_ZccvsQCD = Var("bDiscriminator('pfParticleNetDiscriminatorsJetTags:ZccvsQCD')",float,doc="ParticleNet tagger (w/mass) Z(->cc) vs QCD discriminator",precision=10),
