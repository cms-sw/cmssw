...
electronTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(CandVars,
        ...
        dr03TkSumPt = Var("dr03TkSumPt()",float,doc="Non-PF track isolation within a delta R cone of 0.3",precision=10),
        dr03EcalRecHitSumEt = Var("dr03EcalRecHitSumEt()",float,doc="Non-PF Ecal isolation within a delta R cone of 0.3",precision=10),
        dr03HcalDepth1TowerSumEt = Var("dr03HcalDepth1TowerSumEt()",float,doc="Non-PF Hcal isolation within a delta R cone of 0.3",precision=10),
