...
slimmedElectronsWithUserData = cms.EDProducer("PATElectronUserDataEmbedder",
    ...
    userInts = cms.PSet(
        ...
        seediEta = cms.InputTag("seedLocationEle:iEta"),
        seediPhi = cms.InputTag("seedLocationEle:iPhi"),
        seediX = cms.InputTag("seedLocationEle:iX"),
        seediY = cms.InputTag("seedLocationEle:iY"),
    ),
    userCands = cms.PSet(
