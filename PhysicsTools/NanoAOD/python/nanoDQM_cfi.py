...
nanoDQM = cms.EDAnalyzer("NanoAODDQM",
    vplots = cms.PSet(
        Electron = cms.PSet(
            sels = cms.PSet(
                Good = cms.string('pt > 15 && abs(dxy) < 0.2 && abs(dz) < 0.5 && cutBased >= 3 && miniPFIso_all/pt < 0.4')
            ),
            plots = cms.VPSet(
                Plot1D('PFIso03_all', 'PFIso03_all', 20, 0, 400, 'PF isolation dR=0.3, total (with rho*EA PU corrections)'),
                Plot1D('PFIso03_chg', 'PFIso03_chg', 20, 0, 200, 'PF isolation dR=0.3, charged component'),
                ...
                Plot1D('dz', 'dz', 20, -.3, .3, 'dz (with sign) wrt first PV, in cm'),
                Plot1D('dzErr', 'dzErr', 20, 0, .2, 'dz uncertainty, in cm'),
                Plot1D('eCorr', 'eCorr', 20, 0.6, 6, 'ratio of the calibrated energy/miniaod energy'),
                ...
                Plot1D('ip3d', 'ip3d', 20, 0, .2, '3D impact parameter wrt first PV, in cm'),
                NoPlot('jetIdx'),
                Plot1D('lostHits', 'lostHits', 2, -0.5, 1.5, 'number of missing inner hits'),
                NoPlot('mass'),
                Plot1D('mcMatchFlav', 'mcMatchFlav', 20, 0, 30, 'Flavour of genParticle for MC matching to status==1 electrons or photons: 1 = prompt electron (including gamma*->mu mu), 15 = electron from prompt tau, 22 = prompt photon (likely conversion), 5 = electron from b, 4 = electron from c, 3 = electron from light or unknown, 0 = unmatched'),
                NoPlot('mcMatchIdx'),
                Plot1D('miniPFIso_all', 'miniPFIso_all', 20, 0, 300, 'mini PF isolation, total (with scaled rho*EA PU corrections)'),
                Plot1D('miniPFIso_chg', 'miniPFIso_chg', 20, 0, 200, 'mini PF isolation, charged component'),
                ...
                NoPlot('photonIdx'),
                Plot1D('pt', 'pt', 20, 0, 200, "pt*userFloat('eCorr')"),
        ...
        FatJet = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('mpruned', 'mpruned', 20, 0, 300, 'Pruned mass'),
                ...
                NoPlot('subJetIdx2'),
                NoPlot('subJetIdx3'),
                Plot1D('tau1', 'tau1', 20, 0.05, 0.6, 'Nsubjettiness (1 axis)'),
                Plot1D('tau2', 'tau2', 20, 0.04, 0.4, 'Nsubjettiness (2 axis)'),
                Plot1D('tau3', 'tau3', 20, 0.03, 0.3, 'Nsubjettiness (3 axis)'),
            )
        ),
        Flag = cms.PSet(
            sels = cms.PSet(),
        ...
        IsoTrack = cms.PSet(
            sels = cms.PSet(),
            plots = cms.VPSet(
                Plot1D('PFIso03_all', 'PFIso03_all', 20, 0, 200, 'PF isolation dR=0.3, total (deltaBeta corrections)'),
                Plot1D('PFIso03_chg', 'PFIso03_chg', 20, 0, 90, 'PF isolation dR=0.3, charged component'),
                ...
                Plot1D('eta', 'eta', 20, -3, 3, 'eta'),
                Plot1D('miniPFIso_all', 'miniPFIso_all', 20, 0, 200, 'mini PF isolation, total (with scaled rho*EA PU corrections)'),
                Plot1D('miniPFIso_chg', 'miniPFIso_chg', 20, 0, 20, 'mini PF isolation, charged component'),
                Plot1D('phi', 'phi', 20, -3.14159, 3.14159, 'phi'),
                Plot1D('pt', 'pt', 20, 0, 200, 'pt'),
            )
        ),
        ...
        MET = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('genPhi', 'genPhi', 20, -4, 4, 'genMET.phi'),
                Plot1D('genPt', 'genPt', 20, 0, 500, 'genMET.pt'),
                Plot1D('phi', 'phi', 20, -3.14159, 3.14159, 'phi'),
                Plot1D('pt', 'pt', 20, 0, 400, 'pt'),
                Plot1D('rawEt', 'rawEt', 20, 0, 400, 'raw (uncorrected) scalar sum of Et'),
        ...
        METCalo = cms.PSet(
            sels = cms.PSet(),
            plots = cms.VPSet(
                Plot1D('phi', 'phi', 20, -3.14159, 3.14159, 'caloMETPhi'),
                Plot1D('pt', 'pt', 20, 0, 400, 'caloMETPt'),
                Plot1D('sumEt', 'sumEt', 20, 300, 4000, 'scalar sum of Et'),
            )
        ),
        METpuppi = cms.PSet(
            sels = cms.PSet(),
        ...
        Muon = cms.PSet(
            sels = cms.PSet(
                Good = cms.string('pt > 15 && abs(dxy) < 0.2 && abs(dz) < 0.5 && mediumId && miniPFIso_all/pt < 0.4')
            ),
            plots = cms.VPSet(
                Plot1D('PFIso03_all', 'PFIso03_all', 20, 0, 300, 'PF isolation dR=0.3, total (deltaBeta corrections)'),
                Plot1D('PFIso03_chg', 'PFIso03_chg', 20, 0, 200, 'PF isolation dR=0.3, charged component'),
                ...
                NoPlot('jetIdx'),
                NoPlot('mass'),
                Plot1D('mcMatchFlav', 'mcMatchFlav', 16, -0.5, 15.5, 'Flavour of genParticle for MC matching to status==1 muons: 1 = prompt muon (including gamma*->mu mu), 15 = muon from prompt tau, 5 = muon from b, 4 = muon from c, 3 = muon from light or unknown, 0 = unmatched'),
                NoPlot('mcMatchIdx'),
        ...
        Photon = cms.PSet(
            sels = cms.PSet(),
            plots = cms.VPSet(
                Plot1D('PFIso03_all', 'PFIso03_all', 20, 0, 300, 'PF isolation dR=0.3, total (with rho*EA PU corrections)'),
                Plot1D('PFIso03_chg', 'PFIso03_chg', 20, 0, 200, 'PF isolation dR=0.3, charged component (with rho*EA PU corrections)'),
                NoPlot('VIDNestedWPBitmap'),
                ...
                NoPlot('jetIdx'),
                NoPlot('mass'),
                Plot1D('mcMatchFlav', 'mcMatchFlav', 14, -0.5, 13.5, 'Flavour of genParticle for MC matching to status==1 photons or electrons: 1 = prompt photon, 13 = prompt electron, 0 = unknown or unmatched'),
                NoPlot('mcMatchIdx'),
        ...
        SV = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('phi', 'phi', 20, -3.14159, 3.14159, 'phi'),
                Plot1D('pt', 'pt', 20, 0, 200, 'pt'),
                Plot1D('x', 'x', 20, -.5, .5, 'secondary vertex X position, in cm'),
                Plot1D('y', 'y', 20, -.5, .5, 'secondary vertex Y position, in cm'),
        ...
        Tau = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('mcMatchFlav', 'mcMatchFlav', 6, -0.5, 5.5, 'Flavour of genParticle for MC matching to status==2 taus: 1 = prompt electron, 2 = prompt muon, 3 = tau->e decay, 4 = tau->mu decay, 5 = hadronic tau decay, 0 = unknown or unmatched'),
                NoPlot('mcMatchIdx'),
