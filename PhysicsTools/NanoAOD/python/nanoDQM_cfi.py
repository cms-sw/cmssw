    ...
    vplots = cms.PSet(
        ...
        PV = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('sumpx', 'sumpx', 2, -100, 100, 'main primary vertex sum px of the charged pf candidates'),
                Plot1D('sumpy', 'sumpy', 2, -100, 100, 'main primary vertex sum py of the charged pf candidates'),
