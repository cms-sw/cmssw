    ...
    vplots = cms.PSet(
        ...
        Photon = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('cleanmask', 'cleanmask', 1, 0.5, 1.5, 'simple cleaning mask with priority to leptons'),
                Plot1D('cutBased_RunIIIWinter22','cutBased_RunIIIWinter22', 4, -0.5, 3.5,'cut-based ID bitmap, RunIIIWinter22, (0:fail, 1:loose, 2:medium, 3:tight)'),
                ...
                NoPlot('vidNestedWPBitmap'),
                NoPlot('vidNestedWPBitmap_RunIIIWinter22'),
            )
        ),
