    ...
    vplots = cms.PSet(
        ...
        Electron = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('seediEta', 'seediEta', 180, -90, 90, 'iEta of seed crystal'),
                Plot1D('seediPhi', 'seediPhi', 360, 0, 360, 'iPhi of seed crystal'),
                Plot1D('seediX', 'seediX', 100, 0, 100, 'iX of seed crystal'),
                Plot1D('seediY', 'seediY', 100, 0, 100, 'iY of seed crystal'),
