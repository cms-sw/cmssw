    ...
    vplots = cms.PSet(
        ...
        FatJet = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('btagDDBvL', 'btagDDBvL', 20, 0, 1, 'DeepDoubleX discriminator for H(Z)->bb vs QCD'),
                Plot1D('btagDDCvB', 'btagDDCvB', 20, 0, 1, 'DeepDoubleX discriminator for H(Z)->cc vs H(Z)->bb'),
                Plot1D('btagDDCvL', 'btagDDCvL', 20, 0, 1, 'DeepDoubleX discriminator for H(Z)->cc vs QCD'),
                Plot1D('btagMD_DDBvL', 'btagMD_DDBvL', 20, 0, 1, 'DeepDoubleX (mass-decorrelated) discriminator for H(Z)->bb vs QCD'),
                Plot1D('btagMD_DDCvB', 'btagMD_DDCvB', 20, 0, 1, 'DeepDoubleX (mass-decorrelated) discriminator for H(Z)->cc vs H(Z)->bb'),
                Plot1D('btagMD_DDCvL', 'btagMD_DDCvL', 20, 0, 1, 'DeepDoubleX (mass-decorrelated) discriminator for H(Z)->cc vs QCD'),
