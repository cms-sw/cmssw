    ...
    vplots = cms.PSet(
        ...
        Electron = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('pfRelIso03_all_Fall17V2', 'pfRelIso03_all', 20, 0, 2, 'PF relative isolation dR=0.3 with 94 EffArea, total (with rho*EA PU corrections)'),
                Plot1D('pfRelIso03_chg_Fall17V2', 'pfRelIso03_chg', 20, 0, 2, 'PF relative isolation dR=0.3 with 94 EffArea, charged component'),
                Plot1D('phi', 'phi', 20, -3.14159, 3.14159, 'phi'),
                NoPlot('photonIdx'),
