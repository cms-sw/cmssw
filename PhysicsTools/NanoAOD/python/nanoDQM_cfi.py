    ...
    vplots = cms.PSet(
        ...
        Electron = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('energyscaleUp', 'energyScaleUp', 20, 0, 200, 'Energy ScaleUp'),
                Plot1D('energyscaleDown', 'energyScaleDown', 20, 0, 200, 'Energy ScaleDown'),
                Plot1D('energysigmaUp', 'energySigmaUp', 20, 0, 200, 'Energy SigmaUp'),
                Plot1D('energysigmaDown', 'energySigmaDown', 20, 0, 200, 'Energy SigmaDown'),
            )
        ),
        FatJet = cms.PSet(
            sels = cms.PSet(),
