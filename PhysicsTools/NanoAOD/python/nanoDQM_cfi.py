    ...
    vplots = cms.PSet(
        ...
        Proton = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('multiRP_chi2', 'multiRP_chi2', 20, 0, 6e-07, 'chi 2'),
                Plot1D('multiRP_ndof', 'multiRP_ndof', 1, -0.5, 0.5, 'n dof'),
                Plot1D('multiRP_pt', 'multiRP_pt', 20, 0.06, 2, 'pt'),
                Plot1D('multiRP_sector45', 'multiRP_sector45', 2, -0.5, 1.5, 'LHC sector 45'),
                Plot1D('multiRP_sector56', 'multiRP_sector56', 2, -0.5, 1.5, 'LHC sector 56'),
                Plot1D('multiRP_t', 'multiRP_t', 20, -2, -0.02, 't'),
                Plot1D('multiRP_thetaX', 'multiRP_thetaX', 20, -0.0004, 0.0004, 'scattering angle in the y direction'),
                Plot1D('multiRP_thetaXUnc', 'multiRP_thetaXUnc', 20, 9e-06, 9e-06, 'theta X uncertainty'),
                Plot1D('multiRP_thetaY', 'multiRP_thetaY', 20, -0.001, 0.001, 'scattering angle in the x direction'),
                Plot1D('multiRP_thetaYUnc', 'multiRP_thetaYUnc', 20, 2e-05, 2e-05, 'theta Y uncertainty'),
                ...
                Plot1D('multiRP_vtxY', 'multiRP_vtxY', 20, -0.07, 0.07, 'vertex y'),
                Plot1D('multiRP_vtxYUnc', 'multiRP_vtxYUnc', 20, 0.02, 0.02, 'vy Error'),
                Plot1D('multiRP_xi', 'multiRP_xi', 20, 0, 0.3, 'fractional momentum loss'),
                Plot1D('multiRP_xiUnc', 'multiRP_xiUnc', 20, 0.003, 0.003, 'uncertainty on xi or dp/p'),
                Plot1D('singleRP_decRPId', 'singleRP_decRPId', 20, 0, 200, 'Detector ID'),
                Plot1D('singleRP_sector45', 'singleRP_sector45', 2, -0.5, 1.5, 'LHC sector 45'),
                Plot1D('singleRP_sector56', 'singleRP_sector56', 2, -0.5, 1.5, 'LHC sector 56'),
                Plot1D('singleRP_thetaY', 'singleRP_thetaY', 20, -0.003, 0.003, 'th y'),
                Plot1D('singleRP_thetaYUnc', 'singleRP_thetaYUnc', 20, 0, 0.0002, 'theta Y uncertainty'),
                Plot1D('singleRP_xi', 'singleRP_xi', 20, 0.03, 0.2, 'xi or dp/p'),
                Plot1D('singleRP_xiUnc', 'singleRP_xiUnc', 20, 6e-05, 0.0005, 'uncertainty on xi or dp/p'),
            )
        ),
        Pileup = cms.PSet(
            sels = cms.PSet(),
