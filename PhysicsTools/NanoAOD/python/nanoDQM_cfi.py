    ...
    vplots = cms.PSet(
        ...
        FatJet = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('particleNetWithMass_TvsQCD', 'particleNetWithMass_TvsQCD', 20, -1, 1, 'ParticleNet (mass-correlated) top vs. QCD score'),
                Plot1D('particleNetWithMass_WvsQCD', 'particleNetWithMass_WvsQCD', 20, -1, 1, 'ParticleNet (mass-correlated) W vs. QCD score'),
                Plot1D('particleNetWithMass_ZvsQCD', 'particleNetWithMass_ZvsQCD', 20, -1, 1, 'ParticleNet (mass-correlated) Z vs. QCD score'),
                Plot1D('particleNetWithMass_H4qvsQCD', 'particleNetWithMass_H4qvsQCD', 20, -1, 1, 'ParticleNet (mass-correlated) H(->VV->qqqq) vs. QCD score'),
                Plot1D('particleNetWithMass_HbbvsQCD', 'particleNetWithMass_HbbvsQCD', 20, -1, 1, 'ParticleNet (mass-correlated) H->bb vs. QCD score'),
                Plot1D('particleNetWithMass_HccvsQCD', 'particleNetWithMass_HccvsQCD', 20, -1, 1, 'ParticleNet (mass-correlated) H->cc vs. QCD score'),
                Plot1D('particleNetWithMass_ZbbvsQCD', 'particleNetWithMass_ZbbvsQCD', 20, -1, 1, 'ParticleNet (mass-correlated) Z->bb vs. QCD score'),
                Plot1D('particleNetWithMass_ZccvsQCD', 'particleNetWithMass_HccvsQCD', 20, -1, 1, 'ParticleNet (mass-correlated) H->cc vs. QCD score'),
                ...
                Plot1D('particleNet_Xbb', 'particleNet_Xbb', 20, 0, 1, 'ParticleNet X->bb score'),
                Plot1D('particleNet_Xcc', 'particleNet_Xcc', 20, 0, 1, 'ParticleNet X->cc score'),
                Plot1D('particleNet_Xqq', 'particleNet_Xqq', 20, 0, 1, 'ParticleNet X->qq (uds) score'),
                Plot1D('particleNet_Xgg', 'particleNet_Xgg', 20, 0, 1, 'ParticleNet X->gg score'),
                Plot1D('particleNet_Xtt', 'particleNet_Xtt', 20, 0, 1, 'ParticleNet X->tautau score'),
                Plot1D('particleNet_Xtm', 'particleNet_Xtm', 20, 0, 1, 'ParticleNet X->mutau score'),
                Plot1D('particleNet_Xte', 'particleNet_Xte', 20, 0, 1, 'ParticleNet X->etau score'),
