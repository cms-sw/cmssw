    ...
    vplots = cms.PSet(
        ...
        CorrT1METJet = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('muonSubtrDeltaEta', 'muonSubtrDeltaEta', 40, -0.4, 0.4, 'muon-subtracted raw eta - eta'),
                Plot1D('muonSubtrDeltaPhi', 'muonSubtrDeltaPhi', 40, -0.4, 0.4, 'muon-subtracted raw phi - phi'),
                Plot1D('phi', 'phi', 20, -3.14159, 3.14159, 'phi'),
        ...
        FatJet = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('globalParT3_WvsQCD', 'globalParT3_WvsQCD', 20, -1, 1, 'GlobalParT-3 (Xqq+Xcs/Xqq+Xcs+QCD) binarized score'),
        ...
        Jet = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('btagUParTAK4probb', 'btagUParTAK4probb', 20, -1, 1, 'UnifiedParT b raw score'),
                Plot1D('btagUParTAK4probbb', 'btagUParTAK4probbb', 20, -1, 1, 'UnifiedParT bb raw score'),
        ...
        Muon = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('bestTrackType', 'bestTrackType', 7, -0.5, 6.5, 'Type of track used'),
                Plot1D('jetNDauCharged', 'jetNDauCharged', 20, -0.5, 19.5, 'number of charged daughters of the closest jet'),
                Plot1D('pdgId', 'pdgId', 27, -13.5, 13.5, 'PDG code assigned by the event reconstruction (not by MC truth)'),
