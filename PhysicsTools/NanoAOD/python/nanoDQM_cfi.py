    ...
    vplots = cms.PSet(
        ...
        Jet = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                NoPlot('genJetIdx'),
                Plot1D('hadronFlavour', 'hadronFlavour', 6, -0.5, 5.5, 'flavour from hadron ghost clustering'),
                Plot1D('jetId', 'jetId', 3, 0, 3, 'Jet ID flags bit1 is loose (always false in 2017 since it does not exist), bit2 is tight, bit3 is tightLepVeto'),
                Plot1D('mass', 'mass', 20, 0, 200, 'mass'),
        ...
        Photon = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('cleanmask', 'cleanmask', 1, 0.5, 1.5, 'simple cleaning mask with priority to leptons'),
                Plot1D('cutBased', 'cutBased', 4, -0.5, 3.5,'cut-based ID bitmap, RunIIIWinter22V1, (0:fail, 1:loose, 2:medium, 3:tight)'),
                Plot1D('cutBasedFall17V2', 'cutBasedFall17V2', 4, -0.5, 3.5, 'cut-based ID bitmap, Fall17V2, (0:fail, 1:loose, 2:medium, 3:tight)'),
                Plot1D('eCorr', 'eCorr', 20, 0.8, 1.2, 'ratio of the calibrated energy/miniaod energy'),
                NoPlot('electronIdx'),
                ...
                Plot1D('mvaID_RunIIIWinter22V1', 'mvaID_RunIIIWinter22V1', 20, -1, 1, 'MVA_RunIIIWinter22V1 ID score'),
                Plot1D('mvaID_WP80', 'mvaID_WP80', 2, -0.5, 1.5, 'MVA ID WP80'),
                Plot1D('mvaID_WP90', 'mvaID_WP90', 2, -0.5, 1.5, 'MVA ID WP90'),
                Plot1D('mvaID_RunIIIWinter22V1_WP80', 'mvaID_RunIIIWinter22V1_WP80', 2, -0.5, 1.5, 'MVA_RunIIIWinter22V1 ID WP80'),
                Plot1D('mvaID_RunIIIWinter22V1_WP90', 'mvaID_RunIIIWinter22V1_WP90', 2, -0.5, 1.5, 'MVA_RunIIIWinter22V1 ID WP90'),
                ...
                Plot1D('pfRelIso03_allFall17V2', 'pfRelIso03_allFall17V2', 20, 0, 2, 'PF relative isolation dR=0.3, total (with rho*EA PU corrections)'),
                Plot1D('pfRelIso03_chgFall17V2', 'pfRelIso03_chgFall17V2', 20, 0, 2, 'PF relative isolation dR=0.3, charged component (with rho*EA PU corrections)'),
