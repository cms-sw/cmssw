...
ak4ScoutingJetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
      ...
      variables = cms.PSet(
         P4Vars,
         area = Var("jetArea()", float, doc="jet catchment area, for JECs",precision=10, lazyEval=True),
         chHEF = Var("chargedHadronEnergy()/(chargedHadronEnergy()+neutralHadronEnergy()+photonEnergy()+electronEnergy()+muonEnergy())", float, doc="charged Hadron Energy Fraction", precision= 6, lazyEval=True),
         neHEF = Var("neutralHadronEnergy()/(chargedHadronEnergy()+neutralHadronEnergy()+photonEnergy()+electronEnergy()+muonEnergy())", float, doc="neutral Hadron Energy Fraction", precision= 6, lazyEval=True),
         chEmEF = Var("(electronEnergy()+muonEnergy())/(chargedHadronEnergy()+neutralHadronEnergy()+photonEnergy()+electronEnergy()+muonEnergy())", float, doc="charged Electromagnetic Energy Fraction", precision= 6, lazyEval=True),
         neEmEF = Var("(photonEnergy())/(chargedHadronEnergy()+neutralHadronEnergy()+photonEnergy()+electronEnergy()+muonEnergy())", float, doc="neutral Electromagnetic Energy Fraction", precision= 6, lazyEval=True),
         muEF = Var("(muonEnergy())/(chargedHadronEnergy()+neutralHadronEnergy()+photonEnergy()+electronEnergy()+muonEnergy())", float, doc="muon Energy Fraction", precision= 6, lazyEval=True),
         nCh = Var("chargedHadronMultiplicity()", int, doc="number of charged hadrons in the jet", lazyEval=True),
         nNh = Var("neutralHadronMultiplicity()", int, doc="number of neutral hadrons in the jet", lazyEval=True),
         nMuons = Var("muonMultiplicity()", int, doc="number of muons in the jet", lazyEval=True),
         nElectrons = Var("electronMultiplicity()", int, doc="number of electrons in the jet", lazyEval=True),
         nPhotons = Var("photonMultiplicity()", int, doc="number of photons in the jet", lazyEval=True),
