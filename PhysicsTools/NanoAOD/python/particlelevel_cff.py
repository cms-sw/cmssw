...
HTXSCategoryTable = cms.EDProducer("SimpleHTXSFlatTableProducer",
    ...
    variables=cms.PSet(
        ...
        stage_1_1_pTjet30 = Var("stage1_1_cat_pTjet30GeV",int, doc="HTXS stage-1.1 category (jet pt>30 GeV)"),
        stage_1_1_pTjet25 = Var("stage1_1_cat_pTjet25GeV",int, doc="HTXS stage-1.1 category (jet pt>25 GeV)"),
        stage_1_1_fine_pTjet30 = Var("stage1_1_fine_cat_pTjet30GeV",int, doc="HTXS stage-1.1 category fine binning (jet pt>30 GeV)"),
        stage_1_1_fine_pTjet25 = Var("stage1_1_fine_cat_pTjet25GeV",int, doc="HTXS stage-1.1 category fine binning (jet pt>25 GeV)"),
