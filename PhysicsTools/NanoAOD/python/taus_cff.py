...
run2_nanoAOD_106X2015.toModify(_mvaAntiEVars2015, rawAntiEle = None)
...
(run2_nanoAOD_92X | run2_nanoAOD_94XMiniAODv2 | run2_nanoAOD_106X2015 | run2_nanoAOD_94X2016 | run2_nanoAOD_102Xv1 | run2_nanoAOD_106Xv1).toModify(tauTable,
...
(run2_miniAOD_80XLegacy | run2_nanoAOD_106X2015).toModify(tauTable,
...
for era in [run2_miniAOD_80XLegacy, run2_nanoAOD_92X, run2_nanoAOD_94XMiniAODv1, run2_nanoAOD_94XMiniAODv2, \
            run2_nanoAOD_106X2015, run2_nanoAOD_94X2016, run2_nanoAOD_102Xv1, run2_nanoAOD_106Xv1]:
    era.toModify(tauTable.variables,
