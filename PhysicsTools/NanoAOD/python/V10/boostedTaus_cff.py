...
from PhysicsTools.NanoAOD.nano_eras_cff import run2_nanoAOD_106Xv2,run2_nanoAOD_106Xv1,run3_nanoAOD_122
...
_modifiers = (run2_nanoAOD_106Xv1 | run3_nanoAOD_122)
