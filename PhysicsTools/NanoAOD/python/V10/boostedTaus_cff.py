...
from PhysicsTools.NanoAOD.nano_eras_cff import run2_nanoAOD_106Xv2,run2_miniAOD_80XLegacy,run2_nanoAOD_92X,run2_nanoAOD_94XMiniAODv1,run2_nanoAOD_94X2016,run2_nanoAOD_94XMiniAODv2,run2_nanoAOD_102Xv1,run2_nanoAOD_106Xv1,run3_nanoAOD_122

##################### Import reusable funtions and objects from std taus ########
from PhysicsTools.NanoAOD.V10.taus_cff import _tauIdWPMask, tausMCMatchLepTauForTable, tausMCMatchHadTauForTable,tauMCTable
