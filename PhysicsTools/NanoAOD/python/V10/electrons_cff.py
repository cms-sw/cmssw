...
(run2_miniAOD_80XLegacy | run2_nanoAOD_94X2016 | run2_nanoAOD_94XMiniAODv1 | run2_nanoAOD_94XMiniAODv2 | run2_nanoAOD_102Xv1).toModify(slimmedElectronsUpdated, src = "slimmedElectronsTo106X" )
...
(run2_miniAOD_80XLegacy | run2_nanoAOD_94X2016).toModify(electron_id_modules_WorkingPoints_nanoAOD,
        modules = cms.vstring(
            'RecoEgamma.ElectronIdentification.Identification.cutBasedElectronID_Fall17_94X_V1_cff',
            'RecoEgamma.ElectronIdentification.Identification.cutBasedElectronID_Fall17_94X_V2_cff',
            'RecoEgamma.ElectronIdentification.Identification.heepElectronID_HEEPV70_cff',
...
(run2_nanoAOD_94XMiniAODv1 | run2_nanoAOD_94XMiniAODv2).toModify(calibratedPatElectronsNano,
...
(run2_miniAOD_80XLegacy | run2_nanoAOD_94X2016).toModify(slimmedElectronsWithUserData.userInts,
...
(run2_nanoAOD_94XMiniAODv1 | run2_nanoAOD_94XMiniAODv2 | run2_miniAOD_80XLegacy | run2_nanoAOD_102Xv1 | run2_nanoAOD_106Xv1 | run2_nanoAOD_106Xv2).toModify(electronTable.variables,
...
_modifiers = (run2_miniAOD_80XLegacy | run2_nanoAOD_94XMiniAODv1 | run2_nanoAOD_94XMiniAODv2 | run2_nanoAOD_94X2016 |run2_nanoAOD_102Xv1 | run2_nanoAOD_106Xv1)
_modifiers.toModify(bitmapVIDForEle, src = "slimmedElectronsUpdated")
_modifiers.toModify(bitmapVIDForEleSpring15, src = "slimmedElectronsUpdated")
_modifiers.toModify(bitmapVIDForEleSum16, src = "slimmedElectronsUpdated")
_modifiers.toModify(bitmapVIDForEleHEEP, src = "slimmedElectronsUpdated")
_modifiers.toModify(isoForEle, src = "slimmedElectronsUpdated")
_modifiers.toModify(ptRatioRelForEle, srcLep = "slimmedElectronsUpdated")
_modifiers.toModify(seedGainEle, src = "slimmedElectronsUpdated")
_modifiers.toModify(slimmedElectronsWithUserData, src = "slimmedElectronsUpdated")
_modifiers.toModify(calibratedPatElectronsNano, src = "slimmedElectronsUpdated")
