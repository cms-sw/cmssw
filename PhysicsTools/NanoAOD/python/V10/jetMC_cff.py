...
from PhysicsTools.NanoAOD.V10.jetsAK8_cff import fatJetTable as _fatJetTable
from PhysicsTools.NanoAOD.V10.jetsAK8_cff import subJetTable as _subJetTable
