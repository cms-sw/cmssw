...
from PhysicsTools.NanoAOD.V10.globals_cff import genTable,genFilterTable
from PhysicsTools.NanoAOD.V10.met_cff import metMCTable
...
from PhysicsTools.NanoAOD.V10.common_cff import Var,CandVars
