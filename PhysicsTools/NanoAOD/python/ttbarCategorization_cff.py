...
(run2_miniAOD_80XLegacy | run2_nanoAOD_106X2015).toModify( matchGenBHadron, jetFlavourInfos = cms.InputTag("genJetFlavourAssociation"),)

(run2_miniAOD_80XLegacy | run2_nanoAOD_106X2015).toModify( matchGenCHadron, jetFlavourInfos = cms.InputTag("genJetFlavourAssociation"),)
