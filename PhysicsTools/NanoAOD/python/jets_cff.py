...
fatJetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        n2b1 = Var("userFloat('nb1AK8PuppiSoftDrop:ecfN2')", float, doc="N2 with beta=1", precision=10),
        n3b1 = Var("userFloat('nb1AK8PuppiSoftDrop:ecfN3')", float, doc="N3 with beta=1", precision=10),
