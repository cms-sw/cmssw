...
fatJetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        subJetIdx1 = Var("?nSubjetCollections()>0 && subjets().numberOfSourceCandidatePtrs()>0?subjets().sourceCandidatePtr(0).key():-1", int,
		     doc="index of first subjet"),
        subJetIdx2 = Var("?nSubjetCollections()>0 && subjets().numberOfSourceCandidatePtrs()>1?subjets().sourceCandidatePtr(1).key():-1", int,
