...
### Era dependent customization
run2_miniAOD_80XLegacy.toModify( fatJetTable, msoftdrop_chs = Var("userFloat('ak8PFJetsCHSSoftDropMass')",float, doc="Legacy uncorrected soft drop mass with CHS",precision=10))
