...
fatJetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        deepTagMD_ZvsQCD = Var("(bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probZbb')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probZcc')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probZqq'))/(bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probZbb')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probZcc')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probZqq')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDbb')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDcc')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDb')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDc')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDothers'))",float,doc="Mass-decorrelated DeepBoostedJet tagger Z vs QCD discriminator",precision=10),
        ...
        deepTagMD_ZbbvsQCD = Var("(bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probZbb'))/(bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probZbb')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDbb')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDcc')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDb')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDc')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDothers'))",float,doc="Mass-decorrelated DeepBoostedJet tagger Z->bb vs QCD discriminator",precision=10),
        deepTagMD_HbbvsQCD = Var("(bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probHbb'))/(bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probHbb')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDbb')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDcc')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDb')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDc')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDothers'))",float,doc="Mass-decorrelated DeepBoostedJet tagger H->bb vs QCD discriminator",precision=10),
        ...
        deepTagMD_H4qvsQCD = Var("(bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probHqqqq'))/(bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probHqqqq')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDbb')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDcc')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDb')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDc')+bDiscriminator('pfMassDecorrelatedDeepBoostedJetTags:probQCDothers'))",float,doc="Mass-decorrelated DeepBoostedJet tagger H->4q vs QCD discriminator",precision=10),
