#ifndef PhysicsTools_Utilities_Exception_h
#define PhysicsTools_Utilities_Exception_h
// -*- C++ -*-
//
// Package:     Utilities
// Class  :     Exception
// 
/**\class Exception Exception.h PhysicsTools/Utilities/interface/Exception.h
