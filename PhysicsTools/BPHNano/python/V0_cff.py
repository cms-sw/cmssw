...
KshortToPiPiTable = cms.EDProducer(
    ...
    variables = cms.PSet(
        ...
        CandVars,
        # fit and vtx info        
        chi2 = Var("userFloat('sv_chi2')", float, doc = "chi2 of fitted vertex", precision=12),
        svprob = Var("userFloat('sv_prob')", float, doc = "vertex probability of fitted vertex"),
        ...
        prefit_mass = Var("userFloat('prefit_mass')", float, doc = "pre-fit mass of the vertex", precision=12),
        ...
        vtx_x = Var("userFloat('vtx_x')", float, doc = "x position of fitted vertex", precision=12),
        vtx_y = Var("userFloat('vtx_y')", float, doc = "y position of fitted vertex", precision=12),
        vtx_z = Var("userFloat('vtx_z')", float, doc = "z position of fitted vertex", precision=12),
        ...
        fit_cos_theta_2D = Var("userFloat('fitted_cos_theta_2D')", float, doc = "cos 2D of fitted vertex wrt beamspot"),
        # post-fit momentum
        fit_mass = Var("userFloat('fitted_mass')", float, doc = "post-fit mass of the vertex"),
        fit_massErr = Var("userFloat('massErr')", float, doc = "post-fit mass error", precision=12),
        fit_trk1_pt = Var("userFloat('trk1_pt')", float, doc = "post-fit pt of the leading track", precision=12),
        fit_trk1_eta = Var("userFloat('trk1_eta')", float, doc = "post-fit eta of the leading track", precision=12),
        fit_trk1_phi = Var("userFloat('trk1_phi')", float, doc = "post-fit phi of the leading track", precision=12),
        fit_trk2_pt = Var("userFloat('trk2_pt')", float, doc = "post-fit pt of the subleading track", precision=12),
        fit_trk2_eta = Var("userFloat('trk2_eta')", float, doc = "post-fit eta of the subleading track", precision=12),
        fit_trk2_phi = Var("userFloat('trk2_phi')", float, doc = "post-fit phi of the subleading track", precision=12),
        fit_pt = Var("userFloat('fitted_pt')", float, doc = "post-fit pt of the V0 candidate", precision=12),
        fit_eta = Var("userFloat('fitted_eta')", float, doc = "post-fit eta of the V0 candidate", precision=12),
        fit_phi = Var("userFloat('fitted_phi')", float, doc = "post-fit phi of the V0 candidate", precision=12),
        # track match
        ...
        fit_trk1_charge = Var("userInt('fit_trk1_charge')", int, doc= "leading track charge"),
        fit_trk2_charge = Var("userInt('fit_trk2_charge')", int, doc= "subleading track charge"),
    )
)
