...
KshortToPiPiTable = cms.EDProducer(
    ...
    variables = cms.PSet(
        ...
        CandVars,
        # fit and vtx info        
        chi2 = Var("userFloat('sv_chi2')", float, doc = "chi2 of fitted vertex"),
        ...
        fit_massErr = Var("userFloat('massErr')", float, doc = "post-fit mass error"),
        fit_trk1_pt = Var("userFloat('trk1_pt')", float, doc = "post-fit pt of the leading track"),
        fit_trk1_eta = Var("userFloat('trk1_eta')", float, doc = "post-fit eta of the leading track"),
        fit_trk1_phi = Var("userFloat('trk1_phi')", float, doc = "post-fit phi of the leading track"),
        fit_trk2_pt = Var("userFloat('trk2_pt')", float, doc = "post-fit pt of the subleading track"),
        fit_trk2_eta = Var("userFloat('trk2_eta')", float, doc = "post-fit eta of the subleading track"),
        fit_trk2_phi = Var("userFloat('trk2_phi')", float, doc = "post-fit phi of the subleading track"),
        # track match
