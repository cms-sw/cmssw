...
BToTrkTrkMuMuTable = cms.EDProducer(
    ...
    variables = cms.PSet(
        ...
        fit_massErr_KK = Var("userFloat('fitted_massErr_KK')", float, doc = "uncertainty of the mass of the B candidate for the leading trk->Kaon subleading trk->pion mass hypothesis"),
        fit_massErr_Kpi = Var("userFloat('fitted_massErr_Kpi')", float, doc = "uncertainty of the mass of the B candidate for the leading trk->Kaon subleading trk->pion mass hypothesis"),
        fit_massErr_piK = Var("userFloat('fitted_massErr_piK')", float, doc = "uncertainty mass of the B candidate for the leading trk->Kaon subleading trk->pion mass hypothesis"),
        ...
        min_dr      = Var("userFloat('min_dr')", float, doc = "min DR of the two tracks with the two muons"),
        max_dr      = Var("userFloat('max_dr')", float, doc = "max DR of the two tracks with the two muons"),
        # vtx info
        ...
        trk1_iso04 = Var("userFloat('trk1_iso04')", float, doc = "leading track isolation DR<0.4"),
        trk2_iso04 = Var("userFloat('trk2_iso04')", float, doc = "subleading track isolation DR<0.4"),
        trk1_svip2d     = Var("userFloat('trk1_svip2d')", float, doc = "2D IP of the leading track wrt the dimuon vertex"),
