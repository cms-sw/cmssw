 ...
 public:
  ...
  explicit BToV0LLBuilder(const edm::ParameterSet &cfg)
      : bFieldToken_{esConsumes<MagneticField, IdealMagneticFieldRecord>()},
        ...
        v0s_{consumes<pat::CompositeCandidateCollection>(
            cfg.getParameter<edm::InputTag>("v0s"))},
        v0_ttracks_{consumes<TransientTrackCollection>(
            cfg.getParameter<edm::InputTag>("v0TransientTracks"))},
...
void BToV0LLBuilder::produce(edm::StreamID, edm::Event &evt,
