...
namespace helpers {
  struct DeltaR {
    double operator()( const reco::Candidate & c1, const reco::Candidate & c2 ) const {
      return ROOT::Math::VectorUtil::DeltaR( c1.p4(), c2.p4() );
    }
  };
}

template<typename S, typename D = helpers::DeltaR>
