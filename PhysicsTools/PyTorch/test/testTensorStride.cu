...
class TestTensorStride : public CppUnit::TestFixture {
  CPPUNIT_TEST_SUITE(TestTensorStride);
  CPPUNIT_TEST(test);
...
CPPUNIT_TEST_SUITE_REGISTRATION(TestTensorStride);
