...
NamedCandCombinerBase::NamedCandCombinerBase(std::string name) :
  checkCharge_(false), dauCharge_(), overlap_(), name_(std::move(name)) {
}

NamedCandCombinerBase::NamedCandCombinerBase(std::string name, int q1, int q2) :
  checkCharge_(true), dauCharge_(2), overlap_(), name_(std::move(name)) {
  dauCharge_[0] = q1;
  dauCharge_[1] = q2;
}

NamedCandCombinerBase::NamedCandCombinerBase(std::string name, int q1, int q2, int q3) :
  checkCharge_(true), dauCharge_(3), overlap_(), name_(std::move(name)) {
  dauCharge_[0] = q1;
  dauCharge_[1] = q2;
  dauCharge_[2] = q3;
}
...
NamedCandCombinerBase::NamedCandCombinerBase(std::string name, int q1, int q2, int q3, int q4) :
  checkCharge_(true), dauCharge_(4), overlap_(), name_(std::move(name)) {
  dauCharge_[0] = q1;
  dauCharge_[1] = q2;
  dauCharge_[2] = q3;
  dauCharge_[3] = q4;
...
NamedCandCombinerBase::NamedCandCombinerBase(const std::string& name, bool checkCharge, const vector<int> & dauCharge) :
