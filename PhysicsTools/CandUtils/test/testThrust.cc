...
void testThrust::checkAll() {
  {
    ...
    cands.emplace_back(+1, Particle::LorentzVector(1, 1, 0, 1));
    cands.emplace_back(+1, Particle::LorentzVector(-1, -1, 0, 1));
  ...
  {
    std::vector<LeafCandidate> cands;
    cands.emplace_back(+1, Particle::LorentzVector(0.7, 0.5, 0, 1));
    cands.emplace_back(+1, Particle::LorentzVector(-0.7, -0.5, 0, 1));
    Thrust t(cands.begin(), cands.end());
    CPPUNIT_ASSERT(fabs(t.thrust() - 1.0) < 1.e-6);
  }
  {
    std::vector<LeafCandidate> cands;
    cands.emplace_back(+1, Particle::LorentzVector(1, 0, 0, 1));
    cands.emplace_back(+1, Particle::LorentzVector(0, 1, 0, 1));
    Thrust t(cands.begin(), cands.end());
