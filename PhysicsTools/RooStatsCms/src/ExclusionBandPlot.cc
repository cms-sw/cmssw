...
ExclusionBandPlot::ExclusionBandPlot(const char* name,
  ...
  // y band 1 sigma
  m_y_band_graph_1sigma = new TGraphAsymmErrors(n_points, x_vals, y_vals, nullptr, nullptr, y_down_bars1, y_up_bars1);
  ...
  // y band 2 sigma
  m_y_band_graph_2sigma = new TGraphAsymmErrors(n_points, x_vals, y_vals, nullptr, nullptr, y_down_bars2, y_up_bars2);
...
**/
void ExclusionBandPlot::setXaxisTitle(const char* title) { m_y_band_graph_2sigma->GetXaxis()->SetTitle(title); }
...
plot. Indeed its axes will be the only one to be drawn.
**/
void ExclusionBandPlot::setYaxisTitle(const char* title) { m_y_band_graph_2sigma->GetYaxis()->SetTitle(title); }
...
plot. Indeed its axes will be the only one to be drawn.
**/
void ExclusionBandPlot::setTitle(const char* title) { m_y_band_graph_2sigma->SetTitle(title); }
...
void ExclusionBandPlot::print(const char* options) { std::cout << "\nExclusionBandPlot object " << GetName() << ":\n"; }
