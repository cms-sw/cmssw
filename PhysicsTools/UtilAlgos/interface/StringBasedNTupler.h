...
class TreeBranch {
 public:
  TreeBranch(): class_(""),expr_(""),order_(""),selection_(""),maxIndexName_(""),branchAlias_("") {}
    TreeBranch(const std::string& C, const edm::InputTag& S, const std::string& E, const std::string& O, const std::string& SE, std::string Mi, std::string Ba) :
      class_(C),src_(S),expr_(E),order_(O), selection_(SE),maxIndexName_(std::move(Mi)),branchAlias_(std::move(Ba)){
