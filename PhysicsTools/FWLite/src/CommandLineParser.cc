...
void
CommandLineParser::parseArguments (int argc, char** argv, bool returnArgs)
{   
   bool callHelp = false;
   SVec argsVec;
   m_argv0 = argv[0];
...
bool 
CommandLineParser::_setVariableFromString (const string &arg,
...
bool
CommandLineParser::_setVariablesFromFile (const string &filename)
{
