...
namespace helper {
    ...
    class Parser {
        public:
            ...
            static bool   test(const reco::parser::SelectorPtr &sel, edm::TypeWithDict type, const void * obj);
            /// Make a edm::ObjectWithDict(type, obj) and pass it to the expression
            static double eval(const reco::parser::ExpressionPtr &sel, edm::TypeWithDict type, const void * obj);
    };
