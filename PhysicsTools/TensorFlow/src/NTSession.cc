...
class NTSessionFactory : public SessionFactory {
 public:
  ...
  Status NewSession(const SessionOptions& options,
    ...
    NTSession* session =
        new NTSession(options, new DeviceMgr(std::move(devices)), this);
    {
...
Status NTSession::RunInternal(int64 step_id, const RunOptions& run_options,
...
Status NTSession::CreateExecutors(
...
Status NTSession::MakeCallable(const CallableOptions& callable_options,
...
::tensorflow::Status NTSession::RunCallable(
