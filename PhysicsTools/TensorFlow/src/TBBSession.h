...
namespace tensorflow {
  ...
  private:
    ...
    ::tensorflow::Status WaitForNotification(tbb::task_arena& task_arena,
                                             tbb::task_group& task_group,
                                             Notification* n,
                                             int64 timeout_in_ms);
    void WaitForNotification(tbb::task_arena& task_arena,
                             tbb::task_group& task_group,
                             RunState* run_state,
    ...
    void SchedClosure(tbb::task_arena& task_arena, tbb::task_group& task_group, std::function<void()> c);
