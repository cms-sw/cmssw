...
https://github.com/tensorflow/tensorflow/blob/v2.0.0/tensorflow/core/common_runtime/direct_session.h
...
namespace tensorflow {
  ...
  private:
    ...
    ::tensorflow::Status ExtendLocked(GraphDef graph) EXCLUSIVE_LOCKS_REQUIRED(graph_state_lock_);
