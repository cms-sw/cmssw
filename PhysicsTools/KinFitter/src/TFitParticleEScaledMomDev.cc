...
// Constructor --
//----------------
TFitParticleEScaledMomDev::TFitParticleEScaledMomDev() : TAbsFitParticle() { init(nullptr, nullptr); }
...
TFitParticleEScaledMomDev::TFitParticleEScaledMomDev(const TString& name,
                                                     const TString& title,
                                                     TLorentzVector* pini,
