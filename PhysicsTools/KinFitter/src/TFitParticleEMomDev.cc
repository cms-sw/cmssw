...
TFitParticleEMomDev::TFitParticleEMomDev(TLorentzVector* pini, const TMatrixD* theCovMatrix)
  :TAbsFitParticle()  
{
  init(pini, theCovMatrix);
}

TFitParticleEMomDev::TFitParticleEMomDev(const TString &name, const TString &title, 
...
TAbsFitParticle* TFitParticleEMomDev::clone( TString newname ) const {
