...
// Constructor --
//----------------
TFitParticleMCCart::TFitParticleMCCart() : TAbsFitParticle() { init(nullptr, 0., nullptr); }
...
TFitParticleMCCart::TFitParticleMCCart(TVector3* p, Double_t M, const TMatrixD* theCovMatrix) : TAbsFitParticle() {
