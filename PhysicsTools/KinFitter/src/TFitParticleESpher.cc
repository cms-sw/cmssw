...
// Constructor --
//----------------
TFitParticleESpher::TFitParticleESpher() : TAbsFitParticle() { init(nullptr, nullptr); }
...
TFitParticleESpher::TFitParticleESpher(TLorentzVector* pini, const TMatrixD* theCovMatrix) : TAbsFitParticle() {
