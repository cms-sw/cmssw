...
// Constructor --
//----------------
TFitParticleMomDev::TFitParticleMomDev() : TAbsFitParticle() { init(nullptr, nullptr); }
...
TFitParticleMomDev::TFitParticleMomDev(TLorentzVector* pini, const TMatrixD* theCovMatrix) : TAbsFitParticle() {
  init(pini, theCovMatrix);
}

TFitParticleMomDev::TFitParticleMomDev(const TString& name,
                                       const TString& title,
                                       TLorentzVector* pini,
