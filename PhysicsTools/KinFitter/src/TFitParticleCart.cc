...
// Constructor --
//----------------
TFitParticleCart::TFitParticleCart() : TAbsFitParticle() { init(nullptr, nullptr); }
...
TFitParticleCart::TFitParticleCart(TLorentzVector* pini, const TMatrixD* theCovMatrix) : TAbsFitParticle() {
  init(pini, theCovMatrix);
}

TFitParticleCart::TFitParticleCart(const TString& name,
                                   const TString& title,
                                   TLorentzVector* pini,
