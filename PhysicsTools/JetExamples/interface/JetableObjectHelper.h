...
public:
  ...
  reco::CandidateRefVector etOrderedCaloTowers(double etThreshold) const;
  ...
  reco::CandidateRefVector towersWithinCone(double coneEta, double conePhi, double coneRadius, double etEthreshold);
