...
leptonType = NTupleObjectType("lepton", baseObjectTypes = [ particleType ], variables = [
    ...
    NTupleVariable("relIsoAn04",  lambda x : x.relIsoAn if hasattr(x,'relIsoAn') else  -999, help="PF Activity Anulus, pile-up corrected"),
