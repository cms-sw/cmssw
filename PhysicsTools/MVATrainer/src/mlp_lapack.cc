...
/*  -- LAPACK driver routine (version 2.0) --   
   ...
   Parameter adjustments   
    ...
    extern /* Subroutine */ int dormlq_(const char *, const char *, integer *, integer *, 
...
/*  -- LAPACK routine (version 2.0) --   
   ...
   Parameter adjustments   
    ...
    extern /* Subroutine */ int dlarfb_(const char *, const char *, const char *, const char *, 
	    integer *, integer *, integer *, doublereal *, integer *, 
	    doublereal *, integer *, doublereal *, integer *, doublereal *, 
	    integer *);
    static integer nx;
    extern /* Subroutine */ int dlarft_(const char *, const char *, integer *, integer *, 
...
/* L20: */
    ...
    } else if (lsame_(norm, "O") || *(unsigned const char *)norm == '1') {
...
/* Subroutine */ int dlarfb_(char *side, char *trans, const char *direct, const char *
...
/* Subroutine */ int dlascl_(const char *type, integer *kl, integer *ku, doublereal 
...
/*  -- LAPACK routine (version 2.0) --   
   ...
   Parameter adjustments   
    ...
    char ch__1[2];
    /* Builtin functions   
       Subroutine */ void s_cat(const char *, char **, integer *, integer *, ftnlen);
    /* Local variables */
    static logical left;
    static integer i;
    ...
    extern /* Subroutine */ int dorml2_(const char *, const char *, integer *, integer *, 
	    integer *, doublereal *, integer *, doublereal *, doublereal *, 
...
/*  -- LAPACK routine (version 2.0) --   
   ...
   Parameter adjustments   
    ...
    extern logical lsame_(const char *, const char *);
    static integer nbmin, iinfo, i1, i2, i3;
    extern /* Subroutine */ int dorm2r_(const char *, const char *, integer *, integer *, 
	    integer *, doublereal *, integer *, doublereal *, doublereal *, 
	    integer *, doublereal *, integer *);
    static integer ib, ic, jc, nb, mi, ni;
    extern /* Subroutine */ int dlarfb_(const char *, const char *, const char *, const char *, 
...
/* >>Start of File<<   
    ...
    integer ret_val;
    /* Builtin functions   
       Subroutine */ void s_copy(const char *, const char *, ftnlen, ftnlen);
...
/* Subroutine */ int dtrmm_(char *side, const char *uplo, char *transa, const char *diag, 
...
/* Subroutine */ int dtrmv_(const char *uplo, char *trans, const char *diag, integer *n, 
...
/* Subroutine */ int dtrsm_(char *side, const char *uplo, char *transa, const char *diag, 
	integer *m, integer *n, doublereal *alpha, doublereal *a, integer *
	lda, doublereal *b, integer *ldb)
{
...
#ifdef KR_headers
VOID s_cat(lp, rpp, rnp, np, ll) const char *lp, *rpp[]; ftnlen rnp[], *np, ll;
#else
VOID s_cat(char *lp, const char *rpp[], ftnlen rnp[], ftnlen *np, ftnlen ll)
#endif
{
ftnlen i, n, nc;
const char *f__rp;
...
#ifdef KR_headers
VOID s_copy(a, b, la, lb) register const char *a, *b; ftnlen la, lb;
#else
