...
process.selectedPatMuons.cut     = 'isTrackerMuon=1 & isGlobalMuon=1 & innerTrack.numberOfValidHits>=11 & globalTrack.normalizedChi2<10.0  & globalTrack.getHitPattern.numberOfValidMuonHits(\'TRACK_HITS\') > 0 & abs(dB)<0.02 & (trackIso+caloIso)/pt<0.05'
