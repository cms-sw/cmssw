...
void PatMCMatching::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  // get muon collection
      ...
      switch (muon->genParticle(i)->status()) {
        case 1:
          histContainer_["DR_status1Match"]->Fill(
              ROOT::Math::VectorUtil::DeltaR(muon->p4(), muon->genParticle(i)->p4()));
          break;
        case 3:
