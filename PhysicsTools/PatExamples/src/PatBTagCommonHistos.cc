...
PatBTagCommonHistos::Set(std::string flavor)
{
  ...
  for (const auto & i : tagbl){
	histoid = "jet_pt_"+flavor+"_taggable"+i;        histotitle = flavor+" jet_taggable p_{T} [GeV/c]";
	histocontainer_["jet_pt_"+flavor+"_taggable"+i]=fs->make<TH1D>(histoid.c_str(),histotitle.c_str(),njptarray-1,jetptxbins);
	histoid = "jet_pt_uncorr_"+flavor+"_taggable"+i; histotitle = flavor+" jet_taggable p_{T} uncorr [GeV/c]";
	histocontainer_["jet_pt_uncorr_"+flavor+"_taggable"+i]=fs->make<TH1D>(histoid.c_str(),histotitle.c_str(),njptarray-1,jetptxbins);
	histoid = "jet_eta_"+flavor+"_taggable"+i;       histotitle = flavor+" jet_taggable #eta";
	histocontainer_["jet_eta_"+flavor+"_taggable"+i]=fs->make<TH1D>(histoid.c_str(),histotitle.c_str(),netaarray-1,jetetabins);
	histoid = "jet_eta_"+flavor+"_taggable"+i+"_030";
	histocontainer_["jet_eta_"+flavor+"_taggable"+i+"_030"]=fs->make<TH1D>(histoid.c_str(),"jet #eta",netaarray-1,jetetabins);
	histoid = "jet_eta_"+flavor+"_taggable"+i+"_3050";
	histocontainer_["jet_eta_"+flavor+"_taggable"+i+"_3050"]=fs->make<TH1D>(histoid.c_str(),"jet #eta",netaarray-1,jetetabins);
	histoid = "jet_eta_"+flavor+"_taggable"+i+"_50";
	histocontainer_["jet_eta_"+flavor+"_taggable"+i+"_50"]=fs->make<TH1D>(histoid.c_str(),"jet #eta",netaarray-1,jetetabins);
  }
