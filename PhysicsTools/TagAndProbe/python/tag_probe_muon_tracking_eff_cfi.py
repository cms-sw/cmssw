...
staProbeCands = cms.EDFilter("RecoChargedCandidateRefSelector",
...
muon_cands = cms.Sequence(allTracks+staTracks*tagCands+trackerCands+staProbeCands*StaTkMap*StaTkMatched+StaTkUnmatched+muonTagProbeMap+tagMuonMatch+allProbeMuonMatch+passProbeMuonMatch)
