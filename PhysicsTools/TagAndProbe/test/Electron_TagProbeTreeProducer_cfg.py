...
process.PassingWP95.cut = cms.string(
    ...
    " && (gsfTrack.getHitPattern.numberOfHits(\'MISSING_INNER_HITS\') <= 1)"
    " && ((isEB"
...
process.PassingWP90.cut = cms.string(
    process.goodElectrons.cut.value() +
    " && (gsfTrack.getHitPattern.numberOfHits(\'MISSING_INNER_HITS\') == 0 && !(-0.02<convDist<0.02 && -0.02<convDcot<0.02))"
    " && ((isEB"
...
ProbeVariablesToStore = cms.PSet(
    ...
    probe_gsfEle_missingHits = cms.string("gsfTrack.getHitPattern.numberOfHits(\'MISSING_INNER_HITS\')"),
    ...
    probe_gsfEle_hasValidHitInFirstPixelBarrel = cms.string("gsfTrack.getHitPattern.hasValidHitInFirstPixelBarrel(\'TRACK_HITS\')"),
...
TagVariablesToStore = cms.PSet(
    ...
    gsfEle_missingHits = cms.string("gsfTrack.getHitPattern.numberOfHits(\'MISSING_INNER_HITS\')"),
    gsfEle_convDist = cms.string("convDist"),
    gsfEle_convDcot = cms.string("convDcot"),
    gsfEle_convRadius = cms.string("convRadius"),     
    gsfEle_hasValidHitInFirstPixelBarrel = cms.string("gsfTrack.getHitPattern.hasValidHitInFirstPixelBarrel(\'TRACK_HITS\')"),
    ## super cluster quantities
