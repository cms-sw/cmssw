#ifndef PATMatchLessByDPt_h_
#define PATMatchLessByDPt_h_
...
namespace pat {
  template <typename C1, typename C2> struct PATMatchLessByDPt {
  public: 
    PATMatchLessByDPt ( const edm::ParameterSet& cfg,
