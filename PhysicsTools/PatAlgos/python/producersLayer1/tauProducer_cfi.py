...
patTaus = cms.EDProducer("PATTauProducer",
    ...
    tauIDSources = cms.PSet(
        ...
        ##Commenting out all new algos for pre5 unit test
        ##These must be readded in pre6!!!
        ...
        #puCorrPtSumdR03 = cms.InputTag("hpsPFTauPUcorrPtSumdR03"),
        ...
        ##the above should be added back in for pre6!!
    ),
