...
# , l1GlobalTriggerObjectMapRecord = cms.InputTag( "hltL1GtObjectMap" )                # default; change only, if you know exactly, what you are doing!
...
# , mainBxOnly                     = cms.bool( True )                                  # default; setting this to False might spoil the x-links between L1 conditions and objects
