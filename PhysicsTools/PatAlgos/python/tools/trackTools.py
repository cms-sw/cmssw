...
class MakePATTrackCandidates(ConfigToolBase):
    ...
    def __init__(self):
        ...
        self.addParameter(self._defaultParameters,'mcAs',None, "eplicate mc match as the one used by PAT on this AOD collection (None=no mc match); choose 'photon', 'electron', 'muon', 'tau','jet', 'met' as input string",allowedValues=['photon', 'electron', 'muon', 'tau','jet', 'met'], acceptNoneValue = True) 
