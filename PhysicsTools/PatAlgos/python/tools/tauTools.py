...
hpsTauIDSources = [
    ...
    ("weightedNeutralIsoPtSum1NQ", "MVA3IsolationNeutralIsoPtSumWeight1NQ"),
    ("weightedNeutralIsoPtSum2NQ", "MVA3IsolationNeutralIsoPtSumWeight2NQ"),
    ("weightedNeutralHadronIsoPtSum1", "MVA3IsolationNeutralHadronIsoPtSumWeight1"),
    ("weightedNeutralHadronIsoPtSum2", "MVA3IsolationNeutralHadronIsoPtSumWeight2"),
    ("weightedNeutralHadronIsoPtSum1NQ", "MVA3IsolationNeutralHadronIsoPtSumWeight1NQ"),
    ("weightedNeutralHadronIsoPtSum2NQ", "MVA3IsolationNeutralHadronIsoPtSumWeight2NQ"),
