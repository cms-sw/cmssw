...
hpsTauIDSources = [
    ...
    ("byRelLooseCombinedIsolationDeltaBetaCorr", "DiscriminationByRelLooseCombinedIsolationDBSumPtCorr"),
    ("byMediumCombinedIsolationDeltaBetaCorr", "DiscriminationByMediumCombinedIsolationDBSumPtCorr"),
    ("byRelMediumCombinedIsolationDeltaBetaCorr", "DiscriminationByRelMediumCombinedIsolationDBSumPtCorr"),
    ("byTightCombinedIsolationDeltaBetaCorr", "DiscriminationByTightCombinedIsolationDBSumPtCorr"),
    ("byRelTightCombinedIsolationDeltaBetaCorr", "DiscriminationByRelTightCombinedIsolationDBSumPtCorr"),
