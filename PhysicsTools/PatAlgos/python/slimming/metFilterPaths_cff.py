...
from RecoMET.METFilters.metFilters_cff import HBHENoiseFilterResultProducer, HBHENoiseFilter, HBHEIsoNoiseFilter, CSCTightHaloFilter, hcalLaserEventFilter, EcalDeadCellTriggerPrimitiveFilter, eeBadScFilter, ecalLaserCorrFilter, EcalDeadCellBoundaryEnergyFilter, primaryVertexFilter 
...
Flag_HBHEIsoNoiseFilter = cms.Path(HBHENoiseFilterResultProducer * HBHEIsoNoiseFilter)
...
allMetFilterPaths=['HBHENoiseFilter','HBHEIsoNoiseFilter','CSCTightHaloFilter','hcalLaserEventFilter','EcalDeadCellTriggerPrimitiveFilter','EcalDeadCellBoundaryEnergyFilter','goodVertices','eeBadScFilter',
...
def miniAOD_customizeMETFiltersFastSim(process):
    ...
    for X in 'CSCTightHaloFilter', 'HBHENoiseFilter', 'HBHEIsoNoiseFilter', 'HBHENoiseFilterResultProducer':
