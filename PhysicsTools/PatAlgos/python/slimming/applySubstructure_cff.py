...
def applySubstructure( process ) :
    ...
    process.selectedPatJetsAK8.cut = cms.string("obj.pt() > 170")
    ...
    process.selectedPatJetsAK8PFCHSSoftDrop.cut = cms.string("obj.pt() > 170")
    ...
    process.selectedPatJetsCMSTopTagCHS.cut = cms.string("obj.pt() > 200")
