...
slimmedPhotons = cms.EDProducer("PATPhotonSlimmer",
    ...
    saveNonZSClusterShapes = cms.string("(obj.r9()>0.8 || obj.chargedHadronIso()<20 || obj.chargedHadronIso()<0.3*obj.pt())"), # save additional user floats: (sigmaIetaIeta,sigmaIphiIphi,sigmaIetaIphi,r9,e1x5_over_e5x5)_NoZS 
