...
def miniAOD_customizeCommon(process):
    ...
    run2_miniAOD_80XLegacy.toModify(process.slimmedJetsNoDeepFlavour, dropTagInfos = '1' )
    ...
    run2_miniAOD_94XFall17.toModify(process.slimmedJetsNoDeepFlavour, dropTagInfos = '1' )
