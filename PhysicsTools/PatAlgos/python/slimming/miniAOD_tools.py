...
def miniAOD_customizeCommon(process):
    ...
    stage1L1Trigger.toModify(process.prefiringweight, DataEraECAL = "2016BtoH", DoMuons = cms.bool(False) )
    stage2L1Trigger_2017.toModify(process.prefiringweight, DataEraECAL = "2017BtoF", DoMuons = cms.bool(False))
