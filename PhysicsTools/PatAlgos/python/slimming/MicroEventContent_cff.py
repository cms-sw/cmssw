...
_pp_on_AA_2018_And_pp_on_PbPb_run3_extraCommands = [
    'keep patPackedCandidates_hipixeltracks_*_*',
]
from Configuration.Eras.Modifier_pp_on_AA_2018_cff import pp_on_AA_2018
from Configuration.Eras.Modifier_pp_on_PbPb_run3_cff import pp_on_PbPb_run3
(pp_on_AA_2018 | pp_on_PbPb_run3).toModify(MicroEventContent, outputCommands = MicroEventContent.outputCommands + _pp_on_AA_2018_And_pp_on_PbPb_run3_extraCommands)
(pp_on_AA_2018 | pp_on_PbPb_run3).toModify(MicroEventContentMC, outputCommands = MicroEventContentMC.outputCommands + _pp_on_AA_2018_And_pp_on_PbPb_run3_extraCommands)
