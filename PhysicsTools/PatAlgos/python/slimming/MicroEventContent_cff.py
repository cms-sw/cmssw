...
MicroEventContent = cms.PSet(
    outputCommands = cms.untracked.vstring(
        ...
        'keep recoTrackExtras_slimmedGeneralTrackExtras_*_*',
        'keep recoTrackExtras_slimmedStandAloneMuonExtras_*_*',
        'keep recoTrackExtras_slimmedGlobalMuonExtras_*_*',
        'keep recoTrackExtras_slimmedTevMuonExtrasFirstHit_*_*',
        'keep recoTrackExtras_slimmedTevMuonExtrasPicky_*_*',
        'keep recoTrackExtras_slimmedTevMuonExtrasDyt_*_*',
        'keep TrackingRecHitsOwned_slimmedGeneralTrackHits_*_*',
        'keep TrackingRecHitsOwned_slimmedStandAloneMuonHits_*_*',
        'keep TrackingRecHitsOwned_slimmedGlobalMuonHits_*_*',
