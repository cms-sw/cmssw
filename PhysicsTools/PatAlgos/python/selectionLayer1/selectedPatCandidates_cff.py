...
(pp_on_AA | _mAOD | run2_miniAOD_UL_preSummer20).toReplaceWith(selectedPatCandidatesTask,
                                                               selectedPatCandidatesTask.copyAndExclude([selectedPatDisplacedMuons]))
(pp_on_AA | _mAOD | run2_miniAOD_UL_preSummer20).toModify(selectedPatCandidateSummary.candidates,
