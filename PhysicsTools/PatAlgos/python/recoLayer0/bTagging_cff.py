...
supportedBtagDiscr = {
  ...
  , 'pfDeepDoubleCvLJetTags:probHcc'                     : [["pfDeepDoubleBTagInfos"], ['pfBoostedDoubleSVAK8TagInfos', "pfImpactParameterAK8TagInfos", 'pfInclusiveSecondaryVertexFinderAK8TagInfos']]
