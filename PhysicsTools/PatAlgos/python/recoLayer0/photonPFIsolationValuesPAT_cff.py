...
import CommonTools.ParticleFlow.Isolation.photonPFIsolationValuesPFBRECO_cff as m

phPFIsoValueCharged03PFIdPAT = m.phPFIsoValueCharged03PFIdPFBRECO.clone()
phPFIsoValueCharged03PFIdPAT.deposits[0].src = 'phPFIsoDepositChargedPAT'

phPFIsoValueChargedAll03PFIdPAT = m.phPFIsoValueChargedAll03PFIdPFBRECO.clone()
phPFIsoValueChargedAll03PFIdPAT.deposits[0].src = 'phPFIsoDepositChargedAllPAT'

phPFIsoValueGamma03PFIdPAT = m.phPFIsoValueGamma03PFIdPFBRECO.clone()
phPFIsoValueGamma03PFIdPAT.deposits[0].src = 'phPFIsoDepositGammaPAT'

phPFIsoValueNeutral03PFIdPAT = m.phPFIsoValueNeutral03PFIdPFBRECO.clone()
phPFIsoValueNeutral03PFIdPAT.deposits[0].src = 'phPFIsoDepositNeutralPAT'

phPFIsoValuePU03PFIdPAT = m.phPFIsoValuePU03PFIdPFBRECO.clone()
phPFIsoValuePU03PFIdPAT.deposits[0].src = 'phPFIsoDepositPUPAT'

phPFIsoValueCharged04PFIdPAT = m.phPFIsoValueCharged04PFIdPFBRECO.clone()
phPFIsoValueCharged04PFIdPAT.deposits[0]. src = 'phPFIsoDepositChargedPAT'

phPFIsoValueChargedAll04PFIdPAT = m.phPFIsoValueChargedAll04PFIdPFBRECO.clone()
phPFIsoValueChargedAll04PFIdPAT.deposits[0].src = 'phPFIsoDepositChargedAllPAT'

phPFIsoValueGamma04PFIdPAT = m.phPFIsoValueGamma04PFIdPFBRECO.clone()
phPFIsoValueGamma04PFIdPAT.deposits[0].src = 'phPFIsoDepositGammaPAT'

phPFIsoValueNeutral04PFIdPAT = m.phPFIsoValueNeutral04PFIdPFBRECO.clone()
phPFIsoValueNeutral04PFIdPAT.deposits[0].src = 'phPFIsoDepositNeutralPAT'

phPFIsoValuePU04PFIdPAT = m.phPFIsoValuePU04PFIdPFBRECO.clone()
