# FWStorage/TFileAdaptor Description

## Introduction
The package contains a plugin to ROOT to allow a custom `TFile` to be generated by calls to `TFile::Open`. The custom class internally uses the `Storage` object from FWStorage/StorageFactory.
