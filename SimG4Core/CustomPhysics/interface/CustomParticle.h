...
public:
  CustomParticle(const G4String &aName, G4double mass, G4double width,
...
inline void CustomParticle::SetCloud(G4ParticleDefinition *theCloud) {
  m_cloud = theCloud;
}
inline G4ParticleDefinition *CustomParticle::GetCloud() { return m_cloud; }
inline void CustomParticle::SetSpectator(G4ParticleDefinition *theSpectator) {
  m_spec = theSpectator;
}
