...
void GflashHistogram::bookHistogram(TString histFileName) 
{
  ...
  g4stepCharge  = new TH2F("g4stepCharge","G4Step Charge",300,120.,420,5,-2.5,2.5);
  ...
  //  g4spotRZ  = new TH2F("g4spotRZ","r-z of spots in global coordinate",1200,-600.,600.,400,.0,400.0);
  g4spotXY  = new TH2F("g4spotXY","x-y of spots in global coordinate",800,-400.,400.,800,-400.0,400.0);
  ...
  g4stepRho         = new TH1F("g4stepRho","rho of G4Step",200,120.,320.);
