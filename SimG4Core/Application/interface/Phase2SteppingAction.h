#ifndef SimG4Core_Phase2SteppingAction_H
#define SimG4Core_Phase2SteppingAction_H
...
private:
  ...
  G4String cmseName_, trackerName_, caloName_, btlName_;
};
...
inline bool Phase2SteppingAction::isOutOfTimeWindow(const G4Region* reg, const double& time) const {
