...
inline void MonopoleTransportation::SetPropagatorInField(
...
inline void
MonopoleTransportation::SetThresholdWarningEnergy(G4double newEnWarn) {
  fThreshold_Warning_Energy = newEnWarn;
}

inline void
MonopoleTransportation::SetThresholdImportantEnergy(G4double newEnImp) {
