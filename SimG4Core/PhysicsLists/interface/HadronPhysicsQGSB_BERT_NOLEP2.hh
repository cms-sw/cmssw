#ifndef HadronPhysicsQGSB_BERT_NOLEP2_h
#define HadronPhysicsQGSB_BERT_NOLEP2_h 1
...
class HadronPhysicsQGSB_BERT_NOLEP2 : public G4VPhysicsConstructor {

public: 
  HadronPhysicsQGSB_BERT_NOLEP2(const G4String& name ="hadron",G4bool quasiElastic=true);
  virtual ~HadronPhysicsQGSB_BERT_NOLEP2();
