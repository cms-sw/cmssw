...
QGSPCMS_BIC::QGSPCMS_BIC(G4LogicalVolumeToDDLogicalPartMap& map,
  ...
  edm::LogInfo("PhysicsList") << "You are using the simulation engine: "
			      << "QGSP_BIC 3.3 with Flags for EM Physics "
  ...
  if (hadPhys) {
    ...
    RegisterPhysics( new HadronPhysicsQGSP_BIC("hadron",quasiElastic));
