...
G4ThreadLocal CMSHadronPhysicsFTFP_BERT_ATL::ThreadPrivate
    *CMSHadronPhysicsFTFP_BERT_ATL::tpdata = nullptr;
...
void CMSHadronPhysicsFTFP_BERT_ATL::CreateModels() {
  ...
  tpdata->theAntiBaryon->RegisterMe(
      tpdata->theFTFPAntiBaryon = new G4FTFPAntiBarionBuilder(QuasiElastic));
}
