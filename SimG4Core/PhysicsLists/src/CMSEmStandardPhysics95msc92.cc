...
CMSEmStandardPhysics95msc92::CMSEmStandardPhysics95msc92(const G4String& name, G4int ver, std::string reg):
  G4VPhysicsConstructor(name), verbose(ver), region(reg) {
  G4LossTableManager::Instance();
}

CMSEmStandardPhysics95msc92::~CMSEmStandardPhysics95msc92() {}

void CMSEmStandardPhysics95msc92::ConstructParticle() {
  // gamma
  G4Gamma::Gamma();
...
void CMSEmStandardPhysics95msc92::ConstructProcess() 
{
  ...
  while( (*theParticleIterator)() ){
    ...
    if (particleName == "gamma") {
      ...
      msc->AddEmModel(0,new CMSUrbanMscModel92());
