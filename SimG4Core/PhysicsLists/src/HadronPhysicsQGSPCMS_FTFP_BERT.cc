...
void HadronPhysicsQGSPCMS_FTFP_BERT::CreateModels() {
  ...
  G4cout << "     1) between BERT  and FTFP over the interval " << minFTFP / GeV
         << " to " << maxBERT / GeV << " GeV. " << G4endl;
  G4cout << "     2) between FTFP and QGSP over the interval " << minQGSP / GeV
         << " to " << maxFTFP / GeV << " GeV. " << G4endl;
