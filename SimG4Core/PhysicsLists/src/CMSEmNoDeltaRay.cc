...
CMSEmNoDeltaRay::CMSEmNoDeltaRay(const G4String &name, G4int ver,
...
void CMSEmNoDeltaRay::ConstructProcess() {
  ...
  for (const auto &particleName : emList.PartNames()) {
    ...
    if (particleName == "gamma") {
    ...
    } else if (particleName == "pi+" || particleName == "kaon+" ||
               particleName == "kaon-" || particleName == "proton" ||
               particleName == "pi-") {
      ...
      pmanager->AddProcess(new G4hPairProduction(), -1, -4, 4);
               ...
               particleName == "deuteron" || particleName == "lambda_c+" ||
               particleName == "omega-" || particleName == "sigma_c+" ||
               particleName == "sigma_c++" || particleName == "sigma+" ||
               particleName == "sigma-" || particleName == "tau+" ||
               particleName == "tau-" || particleName == "triton" ||
