...
void CMSHadronPhysicsFTFP_BERT::DumpBanner() {
  G4cout << G4endl
         << " FTFP_BERT : new threshold between BERT and FTFP is over the "
            "interval "
         << G4endl << " for pions :   " << minFTFP_pion / GeV << " to "
         << maxBERT_pion / GeV << " GeV" << G4endl
         << " for kaons :   " << minFTFP_kaon / GeV << " to "
         << maxBERT_kaon / GeV << " GeV" << G4endl
         << " for proton :  " << minFTFP_proton / GeV << " to "
         << maxBERT_proton / GeV << " GeV" << G4endl
         << " for neutron : " << minFTFP_neutron / GeV << " to "
         << maxBERT_neutron / GeV << " GeV" << G4endl << G4endl;
}
...
void CMSHadronPhysicsFTFP_BERT::ExtraConfiguration() {
  ...
  // Modify Neutrons
  auto xs_n_in =
      (G4NeutronInelasticXS *)G4CrossSectionDataSetRegistry::Instance()
          ->GetCrossSectionDataSet(G4NeutronInelasticXS::Default_Name());
