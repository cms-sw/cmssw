...
//
//
// File name:     CMSUrbanMscModel92 made of G4UrbanMscModel92 
//                Geant4 9.5p01 by V.Ivanchenko
//
// Author:        Laszlo Urban
//
...
#ifndef CMSUrbanMscModel92_h
#define CMSUrbanMscModel92_h 1
...
class CMSUrbanMscModel92 : public G4VMscModel
{

public:

  CMSUrbanMscModel92(const G4String& nam = "UrbanMsc92");

  virtual ~CMSUrbanMscModel92();
...
private:
  ...
  CMSUrbanMscModel92 & operator=(const  CMSUrbanMscModel92 &right);
  CMSUrbanMscModel92(const  CMSUrbanMscModel92&);
...
inline
G4double CMSUrbanMscModel92::GetLambda(G4double e)
{
  G4double x;
  if(theLambdaTable) {
...
inline
void CMSUrbanMscModel92::SetParticle(const G4ParticleDefinition* p)
{
  if (p != particle) {
    particle = p;
    mass = p->GetPDGMass();
...
inline
void CMSUrbanMscModel92::UpdateCache()                                   
{
    lnZ = std::log(Zeff);
