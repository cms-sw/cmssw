...
HadronPhysicsCMS::HadronPhysicsCMS(const G4String &name, G4bool quasiElastic)
    : G4VPhysicsConstructor("hadron"), theNeutrons(nullptr),
      theBertiniNeutron(nullptr), theBinaryNeutron(nullptr),
      theFTFPNeutron(nullptr), theQGSPNeutron(nullptr), thePiK(nullptr),
      theBertiniPiK(nullptr), theBinaryPiK(nullptr), theFTFPPiK(nullptr),
      theQGSPPiK(nullptr), thePro(nullptr), theBertiniPro(nullptr),
      theBinaryPro(nullptr), theFTFPPro(nullptr), theQGSPPro(nullptr),
      theFTFNeutron(nullptr), theFTFPiK(nullptr), theFTFPro(nullptr),
      modelName(name), QuasiElastic(quasiElastic) {}
