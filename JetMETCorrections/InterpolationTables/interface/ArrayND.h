...
namespace npstat {
  ...
  public:
    ...
    void jointMemSliceScan(Num2* buffer,
    ...
    /** 
        ...
        */
    template <typename Num2>
    inline void exportMemSlice(Num2* buffer,
                               unsigned long bufLen,
                               const unsigned* fixedIndices,
                               const unsigned* fixedIndexValues,
                               unsigned nFixedIndices) const {
    ...
    /**
        ...
        */
    template <typename Num2>
    inline void importMemSlice(const Num2* buffer,
                               unsigned long bufLen,
                               const unsigned* fixedIndices,
                               const unsigned* fixedIndexValues,
                               unsigned nFixedIndices) {
    ...
    const Numeric& operator()(
        unsigned i0, unsigned i1, unsigned i2, unsigned i3, unsigned i4, unsigned i5, unsigned i6) const;

    Numeric& operator()(
        unsigned i0, unsigned i1, unsigned i2, unsigned i3, unsigned i4, unsigned i5, unsigned i6, unsigned i7);
    const Numeric& operator()(
        unsigned i0, unsigned i1, unsigned i2, unsigned i3, unsigned i4, unsigned i5, unsigned i6, unsigned i7) const;
    ...
    Numeric& operator()(unsigned i0,
                        ...
                        unsigned i7,
                        unsigned i8);
    const Numeric& operator()(unsigned i0,
                              unsigned i1,
                              unsigned i2,
                              unsigned i3,
                              unsigned i4,
  ...
  private:
    ...
    template <typename Num1, unsigned Len1, unsigned Dim1, typename Num2, unsigned Len2, unsigned Dim2>
    void outerProductLoop(unsigned level,
                          unsigned long idx0,
                          unsigned long idx1,
                          unsigned long idx2,
    ...
    void contractLoop(unsigned thisLevel,
                      unsigned resLevel,
                      unsigned pos1,
                      unsigned pos2,
    ...
    void transposeLoop(unsigned level,
                       unsigned pos1,
                       unsigned pos2,
                       unsigned long idxThis,
                       unsigned long idxRes,
    ...
    template <typename Num2, unsigned Len2, unsigned Dim2>
    void dotProductLoop(unsigned level,
                        unsigned long idx0,
                        unsigned long idx1,
                        unsigned long idx2,
    ...
    template <typename Num2, unsigned Len2, unsigned Dim2>
    void marginalizeLoop(unsigned level,
                         unsigned long idx,
                         unsigned levelRes,
                         unsigned long idxRes,
                         const ArrayND<Num2, Len2, Dim2>& prior,
    ...
    template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
    void copyRangeLoopFunct(unsigned level,
                            unsigned long idx0,
                            unsigned long idx1,
                            const ArrayND<Num2, Len2, Dim2>& r,
    ...
    template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
    void commonSubrangeLoop(unsigned level,
                            unsigned long idx0,
                            unsigned long idx1,
                            const unsigned* thisCorner,
                            const unsigned* range,
    ...
    template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
    void dualCircularLoop(unsigned level,
                          unsigned long idx0,
                          unsigned long idx1,
                          const unsigned* thisCorner,
                          const unsigned* range,
    ...
    template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
    void flatCircularLoop(unsigned level,
                          unsigned long idx0,
                          unsigned long idx1,
                          const unsigned* thisCorner,
                          const unsigned* range,
    ...
    // is flat.
    template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
    void circularFlatLoop(unsigned level,
                          unsigned long idx0,
                          unsigned long idx1,
                          const unsigned* thisCorner,
                          const unsigned* range,
    ...
    template <typename Num2, unsigned Len2, unsigned Dim2>
    unsigned long verifySliceCompatibility(const ArrayND<Num2, Len2, Dim2>& slice,
                                           const unsigned* fixedIndices,
                                           const unsigned* fixedIndexValues,
                                           unsigned nFixedIndices) const;

    // Buffer compatibility verification with a slice
    unsigned long verifyBufferSliceCompatibility(unsigned long bufLen,
                                                 const unsigned* fixedIndices,
                                                 const unsigned* fixedIndexValues,
                                                 unsigned nFixedIndices,
    ...
    template <typename Num2, class Functor>
    void jointSliceLoop(unsigned level,
                        unsigned long idx0,
                        unsigned level1,
                        unsigned long idx1,
                        Num2* sliceData,
    ...
    template <typename Num2, class Functor>
    void scaleBySliceInnerLoop(unsigned level,
                               unsigned long idx0,
                               Num2& scale,
                               const unsigned* projectedIndices,
    ...
    template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
    void scaleBySliceLoop(unsigned level,
                          unsigned long idx0,
                          unsigned level1,
                          unsigned long idx1,
    ...
    template <typename Num2>
    void projectInnerLoop(unsigned level,
                          unsigned long idx0,
    ...
    void projectLoop(unsigned level,
                     unsigned long idx0,
                     unsigned level1,
                     unsigned long idx1,
                     unsigned* currentIndex,
    ...
    template <typename Num2, unsigned Len2, unsigned Dim2, typename Num3, class Op>
    void projectLoop2(unsigned level,
                      unsigned long idx0,
                      unsigned level1,
                      unsigned long idx1,
                      ArrayND<Num2, Len2, Dim2>* projection,
    ...
    template <typename Num2>
    void projectInnerLoop2(unsigned level,
                           unsigned long idx0,
    ...
    template <typename Num2, typename Integer>
    void processSubrangeLoop(unsigned level,
                             unsigned long idx0,
                             unsigned* currentIndex,
    ...
    template <typename Accumulator>
    void convertToLastDimCdfLoop(
        ArrayND* sumSlice, unsigned level, unsigned long idx0, unsigned long idxSlice, bool useTrapezoids);
    ...
    template <typename Num2, unsigned Len2, unsigned Dim2>
    void verifyProjectionCompatibility(const ArrayND<Num2, Len2, Dim2>& projection,
                                       const unsigned* projectedIndices,
                                       unsigned nProjectedIndices) const;
  };
}  // namespace npstat
...
#define me_macro_check_loop_prerequisites(METHOD, INNERLOOP) /**/                                               \
  ...
  template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>                                         \
  void ArrayND<Numeric, Len, Dim>::METHOD(ArrayND<Num2, Len2, Dim2>& other,                                     \
                                          const unsigned* thisCorner,                                           \
                                          const unsigned* range,                                                \
                                          const unsigned* otherCorner,                                          \
                                          ...
                                          Functor binaryFunct) {                                                \
    if (!shapeIsKnown_)                                                                                         \
      throw npstat::NpstatInvalidArgument("Initialize npstat::ArrayND before calling method \"" #METHOD "\"");  \
    if (!other.shapeIsKnown_)                                                                                   \
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::" #METHOD ": uninitialized argument array");     \
    if (dim_ != other.dim_)                                                                                     \
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::" #METHOD ": incompatible argument array rank"); \
    if (arrLen != dim_)                                                                                         \
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::" #METHOD ": incompatible index length");        \
    if (dim_) {                                                                                                 \
      assert(thisCorner);                                                                                       \
      assert(range);                                                                                            \
      assert(otherCorner);                                                                                      \
      INNERLOOP(0U, 0UL, 0UL, thisCorner, range, otherCorner, other, binaryFunct);                              \
    } else                                                                                                      \
...
namespace npstat {
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
  void ArrayND<Numeric, Len, Dim>::commonSubrangeLoop(unsigned level,
                                                      unsigned long idx0,
                                                      unsigned long idx1,
                                                      const unsigned* thisCorner,
                                                      const unsigned* range,
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
  void ArrayND<Numeric, Len, Dim>::dualCircularLoop(unsigned level,
                                                    unsigned long idx0,
                                                    unsigned long idx1,
                                                    const unsigned* thisCorner,
                                                    const unsigned* range,
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
  void ArrayND<Numeric, Len, Dim>::flatCircularLoop(unsigned level,
                                                    unsigned long idx0,
                                                    unsigned long idx1,
                                                    const unsigned* thisCorner,
                                                    const unsigned* range,
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
  void ArrayND<Numeric, Len, Dim>::circularFlatLoop(unsigned level,
                                                    unsigned long idx0,
                                                    unsigned long idx1,
                                                    const unsigned* thisCorner,
                                                    const unsigned* range,
  ...
  me_macro_check_loop_prerequisites(jointSubrangeScan, commonSubrangeLoop)
      me_macro_check_loop_prerequisites(dualCircularScan, dualCircularLoop)
          me_macro_check_loop_prerequisites(flatCircularScan,
                                            flatCircularLoop) me_macro_check_loop_prerequisites(circularFlatScan,
                                                                                                circularFlatLoop)

              template <typename Numeric, unsigned StackLen, unsigned StackDim>
              template <typename Num2, unsigned Len2, unsigned Dim2>
              Numeric ArrayND<Numeric, StackLen, StackDim>::marginalizeInnerLoop(unsigned long idx,
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  void ArrayND<Numeric, StackLen, StackDim>::marginalizeLoop(const unsigned level,
                                                             unsigned long idx,
                                                             const unsigned levelRes,
                                                             unsigned long idxRes,
                                                             const ArrayND<Num2, Len2, Dim2>& prior,
                                                             const unsigned* indexMap,
                                                             ArrayND& result) const {
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  ArrayND<Numeric, StackLen, StackDim> ArrayND<Numeric, StackLen, StackDim>::marginalize(
      const ArrayND<Num2, Len2, Dim2>& prior, const unsigned* indexMap, const unsigned mapLen) const {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  void ArrayND<Numeric, Len, Dim>::buildFromShapePtr(const unsigned* sizes, const unsigned dim) {
    dim_ = dim;
    if (dim_) {
      assert(sizes);
      for (unsigned i = 0; i < dim_; ++i)
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  ArrayND<Numeric, StackLen, StackDim>::ArrayND(const ArrayND<Num2, Len2, Dim2>& slicedArray,
                                                const unsigned* fixedIndices,
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  ArrayShape ArrayND<Numeric, StackLen, StackDim>::sliceShape(const unsigned* fixedIndices,
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  unsigned long ArrayND<Numeric, StackLen, StackDim>::verifySliceCompatibility(const ArrayND<Num2, Len2, Dim2>& slice,
                                                                               const unsigned* fixedIndices,
                                                                               const unsigned* fixedIndexValues,
                                                                               const unsigned nFixedIndices) const {
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  unsigned long ArrayND<Numeric, StackLen, StackDim>::verifyBufferSliceCompatibility(const unsigned long bufLen,
                                                                                     const unsigned* fixedIndices,
                                                                                     const unsigned* fixedIndexValues,
                                                                                     const unsigned nFixedIndices,
                                                                                     unsigned long* sliceStrides) const {
  ...
  void ArrayND<Numeric, StackLen, StackDim>::jointSliceLoop(const unsigned level,
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
  void ArrayND<Numeric, StackLen, StackDim>::jointSliceScan(ArrayND<Num2, Len2, Dim2>& slice,
                                                            const unsigned* fixedIndices,
                                                            const unsigned* fixedIndexValues,
                                                            const unsigned nFixedIndices,
                                                            Functor binaryFunct) {
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, class Functor>
  void ArrayND<Numeric, StackLen, StackDim>::jointMemSliceScan(Num2* slice,
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2>
  void ArrayND<Numeric, StackLen, StackDim>::projectInnerLoop(const unsigned level,
                                                              unsigned long idx0,
                                                              unsigned* currentIndex,
                                                              AbsArrayProjector<Numeric, Num2>& projector,
                                                              const unsigned* projectedIndices,
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2, typename Num3, class Op>
  void ArrayND<Numeric, StackLen, StackDim>::projectLoop(const unsigned level,
                                                         const unsigned long idx0,
                                                         const unsigned level1,
                                                         const unsigned long idx1,
                                                         unsigned* currentIndex,
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  void ArrayND<Numeric, StackLen, StackDim>::verifyProjectionCompatibility(const ArrayND<Num2, Len2, Dim2>& projection,
                                                                           const unsigned* projectedIndices,
                                                                           const unsigned nProjectedIndices) const {
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2, typename Num3>
  void ArrayND<Numeric, StackLen, StackDim>::project(ArrayND<Num2, Len2, Dim2>* projection,
                                                     AbsArrayProjector<Numeric, Num3>& projector,
                                                     const unsigned* projectedIndices,
                                                     const unsigned nProjectedIndices) const {
    assert(projection);
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2, typename Num3>
  void ArrayND<Numeric, StackLen, StackDim>::addToProjection(ArrayND<Num2, Len2, Dim2>* projection,
                                                             AbsArrayProjector<Numeric, Num3>& projector,
                                                             const unsigned* projectedIndices,
                                                             const unsigned nProjectedIndices) const {
    assert(projection);
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2, typename Num3>
  void ArrayND<Numeric, StackLen, StackDim>::subtractFromProjection(ArrayND<Num2, Len2, Dim2>* projection,
                                                                    AbsArrayProjector<Numeric, Num3>& projector,
                                                                    const unsigned* projectedIndices,
                                                                    const unsigned nProjectedIndices) const {
    assert(projection);
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2>
  void ArrayND<Numeric, StackLen, StackDim>::projectInnerLoop2(const unsigned level,
                                                               const unsigned long idx0,
                                                               AbsVisitor<Numeric, Num2>& projector,
                                                               const unsigned* projectedIndices,
                                                               const unsigned nProjectedIndices) const {
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2, typename Num3, class Op>
  void ArrayND<Numeric, StackLen, StackDim>::projectLoop2(const unsigned level,
                                                          const unsigned long idx0,
                                                          const unsigned level1,
                                                          const unsigned long idx1,
                                                          ArrayND<Num2, Len2, Dim2>* projection,
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, class Functor>
  void ArrayND<Numeric, StackLen, StackDim>::scaleBySliceInnerLoop(const unsigned level,
                                                                   const unsigned long idx0,
                                                                   Num2& scale,
                                                                   const unsigned* projectedIndices,
                                                                   const unsigned nProjectedIndices,
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
  void ArrayND<Numeric, StackLen, StackDim>::scaleBySliceLoop(unsigned level,
                                                              unsigned long idx0,
                                                              unsigned level1,
                                                              unsigned long idx1,
                                                              ArrayND<Num2, Len2, Dim2>& slice,
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
  void ArrayND<Numeric, StackLen, StackDim>::jointScan(ArrayND<Num2, Len2, Dim2>& r, Functor binaryFunct) {
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
  void ArrayND<Numeric, StackLen, StackDim>::applySlice(ArrayND<Num2, Len2, Dim2>& slice,
                                                        const unsigned* fixedIndices,
                                                        const unsigned nFixedIndices,
                                                        Functor binaryFunct) {
    if (nFixedIndices) {
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  inline bool ArrayND<Numeric, StackLen, StackDim>::isCompatible(const ArrayShape& shape) const {
    if (!shapeIsKnown_)
      return false;
    if (dim_ != shape.size())
      return false;
  ...
  template <typename Numeric, unsigned StackLen, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  inline bool ArrayND<Numeric, StackLen, StackDim>::isShapeCompatible(const ArrayND<Num2, Len2, Dim2>& r) const {
    if (!shapeIsKnown_)
      return false;
    if (!r.shapeIsKnown_)
      return false;
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, typename Integer>
  void ArrayND<Numeric, Len, Dim>::processSubrangeLoop(const unsigned level,
                                                       unsigned long idx0,
                                                       unsigned* currentIndex,
                                                       AbsArrayProjector<Numeric, Num2>& f,
                                                       const BoxND<Integer>& subrange) const {
  ...
  template <typename Num2, typename Integer>
  void ArrayND<Numeric, Len, StackDim>::processSubrange(AbsArrayProjector<Numeric, Num2>& f,
                                                        const BoxND<Integer>& subrange) const {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2>
  inline ArrayND<Numeric, Len, Dim>& ArrayND<Numeric, Len, Dim>::setData(const Num2* data,
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
  ArrayND<Numeric, Len, Dim>::ArrayND(const ArrayND<Num2, Len2, Dim2>& r, Functor f)
      : data_(0), strides_(nullptr), shape_(nullptr), len_(r.len_), dim_(r.dim_), shapeIsKnown_(r.shapeIsKnown_) {
    if (dim_) {
      // Copy the shape
      shape_ = makeBuffer(dim_, localShape_, Dim);
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
  void ArrayND<Numeric, Len, Dim>::copyRangeLoopFunct(const unsigned level,
                                                      unsigned long idx0,
                                                      unsigned long idx1,
                                                      const ArrayND<Num2, Len2, Dim2>& r,
                                                      const ArrayRange& range,
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  ArrayND<Numeric, Len, Dim>::ArrayND(const ArrayND<Num2, Len2, Dim2>& r, const ArrayRange& range)
      : data_(0), strides_(nullptr), shape_(nullptr), len_(r.len_), dim_(r.dim_), shapeIsKnown_(r.shapeIsKnown_) {
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
  ArrayND<Numeric, Len, Dim>::ArrayND(const ArrayND<Num2, Len2, Dim2>& r, const ArrayRange& range, Functor f)
      : data_(0), strides_(nullptr), shape_(nullptr), len_(r.len_), dim_(r.dim_), shapeIsKnown_(r.shapeIsKnown_) {
    if (!range.isCompatible(r.shape_, r.dim_))
      throw npstat::NpstatInvalidArgument(
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  ArrayND<Numeric, Len, Dim>::ArrayND(const unsigned* sizes, const unsigned dim)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  ArrayND<Numeric, Len, Dim>::ArrayND(const unsigned n0, const unsigned n1)
      : data_(0), strides_(nullptr), shape_(nullptr), len_(1UL), shapeIsKnown_(true) {
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  ArrayND<Numeric, Len, Dim>::ArrayND(const unsigned n0, const unsigned n1, const unsigned n2)
      : data_(0), strides_(nullptr), shape_(nullptr), len_(1UL), shapeIsKnown_(true) {
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  ArrayND<Numeric, Len, Dim>::ArrayND(const unsigned n0, const unsigned n1, const unsigned n2, const unsigned n3)
      : data_(0), strides_(nullptr), shape_(nullptr), len_(1UL), shapeIsKnown_(true) {
  ...
  ArrayND<Numeric, Len, Dim>::ArrayND(
      const unsigned n0, const unsigned n1, const unsigned n2, const unsigned n3, const unsigned n4)
      : data_(0), strides_(nullptr), shape_(nullptr), len_(1UL), shapeIsKnown_(true) {
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  ArrayND<Numeric, Len, Dim>::ArrayND(
      const unsigned n0, const unsigned n1, const unsigned n2, const unsigned n3, const unsigned n4, const unsigned n5)
      : data_(0), strides_(nullptr), shape_(nullptr), len_(1UL), shapeIsKnown_(true) {
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num1, unsigned Len1, unsigned Dim1, typename Num2, unsigned Len2, unsigned Dim2>
  void ArrayND<Numeric, Len, Dim>::outerProductLoop(const unsigned level,
                                                    unsigned long idx0,
                                                    unsigned long idx1,
                                                    unsigned long idx2,
                                                    const ArrayND<Num1, Len1, Dim1>& a1,
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num1, unsigned Len1, unsigned Dim1, typename Num2, unsigned Len2, unsigned Dim2>
  ArrayND<Numeric, Len, Dim>::ArrayND(const ArrayND<Num1, Len1, Dim1>& a1, const ArrayND<Num2, Len2, Dim2>& a2)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  ArrayND<Numeric, Len, Dim>& ArrayND<Numeric, Len, Dim>::operator=(const ArrayND& r) {
    if (this == &r)
      return *this;
    if (shapeIsKnown_) {
      if (!r.shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  ArrayND<Numeric, Len, Dim>& ArrayND<Numeric, Len, Dim>::operator=(const ArrayND<Num2, Len2, Dim2>& r) {
    if ((void*)this == (void*)(&r))
      return *this;
    if (shapeIsKnown_) {
      if (!r.shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2, class Functor>
  ArrayND<Numeric, Len, Dim>& ArrayND<Numeric, Len, Dim>::assign(const ArrayND<Num2, Len2, Dim2>& r, Functor f) {
    if (shapeIsKnown_) {
      if (!r.shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  void ArrayND<Numeric, Len, Dim>::convertLinearIndex(unsigned long l, unsigned* idx, const unsigned idxLen) const {
    if (!shapeIsKnown_)
      throw npstat::NpstatInvalidArgument(
          "Initialize npstat::ArrayND before calling "
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  unsigned long ArrayND<Numeric, Len, Dim>::linearIndex(const unsigned* index, unsigned idxLen) const {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::value(const unsigned* index, const unsigned dim) {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline const Numeric& ArrayND<Numeric, Len, Dim>::value(const unsigned* index, const unsigned dim) const {
    if (!shapeIsKnown_)
      throw npstat::NpstatInvalidArgument("Initialize npstat::ArrayND before calling method \"value\"");
    if (dim != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::value: incompatible index length");
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::linearValue(const unsigned long index) {
    return data_[index];
  }

  template <typename Numeric, unsigned Len, unsigned Dim>
  inline const Numeric& ArrayND<Numeric, Len, Dim>::linearValue(const unsigned long index) const {
    return data_[index];
  }

  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::linearValueAt(const unsigned long index) {
    if (index >= len_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline const Numeric& ArrayND<Numeric, Len, Dim>::linearValueAt(const unsigned long index) const {
    if (index >= len_)
      throw npstat::NpstatOutOfRange("In npstat::ArrayND::linearValueAt: linear index out of range");
    return data_[index];
  }
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline unsigned ArrayND<Numeric, Len, Dim>::coordToIndex(const double x, const unsigned idim) const {
    if (x <= 0.0)
      return 0;
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline const Numeric& ArrayND<Numeric, Len, Dim>::closest(const double* x, const unsigned dim) const {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::closest(const double* x, const unsigned dim) {
    if (!shapeIsKnown_)
      throw npstat::NpstatInvalidArgument("Initialize npstat::ArrayND before calling method \"closest\"");
    if (dim != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::closest: incompatible data length");
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline const Numeric& ArrayND<Numeric, Len, Dim>::valueAt(const unsigned* index, const unsigned dim) const {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::valueAt(const unsigned* index, const unsigned dim) {
    if (!shapeIsKnown_)
      throw npstat::NpstatInvalidArgument("Initialize npstat::ArrayND before calling method \"valueAt\"");
    if (dim != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::valueAt: incompatible index length");
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::operator()(const unsigned i) {
    if (1U != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline const Numeric& ArrayND<Numeric, Len, Dim>::operator()(const unsigned i) const {
    if (1U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::operator(): wrong # of args (not rank 1 array)");
    return data_[i];
  }
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  const Numeric& ArrayND<Numeric, Len, Dim>::at(const unsigned i0) const {
    if (1U != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  Numeric& ArrayND<Numeric, Len, Dim>::at(const unsigned i0) {
    if (1U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::at: wrong # of args (not rank 1 array)");
    if (i0 >= shape_[0])
      throw npstat::NpstatOutOfRange("In npstat::ArrayND::at: index 0 out of range (rank 1)");
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::operator()(const unsigned i0, const unsigned i1) {
    if (2U != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline const Numeric& ArrayND<Numeric, Len, Dim>::operator()(const unsigned i0, const unsigned i1) const {
    if (2U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::operator(): wrong # of args (not rank 2 array)");
    return data_[i0 * strides_[0] + i1];
  }
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  const Numeric& ArrayND<Numeric, Len, Dim>::at(const unsigned i0, const unsigned i1) const {
    if (2U != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  Numeric& ArrayND<Numeric, Len, Dim>::at(const unsigned i0, const unsigned i1) {
    if (2U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::at: wrong # of args (not rank 2 array)");
    if (i0 >= shape_[0])
      throw npstat::NpstatOutOfRange("In npstat::ArrayND::at: index 0 out of range (rank 2)");
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline const Numeric& ArrayND<Numeric, Len, Dim>::operator()(const unsigned i0,
                                                               const unsigned i1,
  ...
  inline const Numeric& ArrayND<Numeric, Len, Dim>::operator()(
      const unsigned i0, const unsigned i1, const unsigned i2, const unsigned i3, const unsigned i4) const {
    if (5U != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::operator()(const unsigned i0, const unsigned i1, const unsigned i2) {
    if (3U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::operator(): wrong # of args (not rank 3 array)");
    return data_[i0 * strides_[0] + i1 * strides_[1] + i2];
  }
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::operator()(const unsigned i0,
                                                         const unsigned i1,
                                                         const unsigned i2,
                                                         const unsigned i3) {
    if (4U != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::operator()(
      const unsigned i0, const unsigned i1, const unsigned i2, const unsigned i3, const unsigned i4) {
    if (5U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::operator(): wrong # of args (not rank 5 array)");
    return data_[i0 * strides_[0] + i1 * strides_[1] + i2 * strides_[2] + i3 * strides_[3] + i4];
  }
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  const Numeric& ArrayND<Numeric, Len, Dim>::at(const unsigned i0, const unsigned i1, const unsigned i2) const {
    if (3U != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  const Numeric& ArrayND<Numeric, Len, Dim>::at(const unsigned i0,
                                                const unsigned i1,
                                                const unsigned i2,
                                                const unsigned i3) const {
    if (4U != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  Numeric& ArrayND<Numeric, Len, Dim>::at(const unsigned i0, const unsigned i1, const unsigned i2) {
    if (3U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::at: wrong # of args (not rank 3 array)");
    if (i0 >= shape_[0])
      throw npstat::NpstatOutOfRange("In npstat::ArrayND::at: index 0 out of range (rank 3)");
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  Numeric& ArrayND<Numeric, Len, Dim>::at(const unsigned i0, const unsigned i1, const unsigned i2, const unsigned i3) {
    if (4U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::at: wrong # of args (not rank 4 array)");
    if (i0 >= shape_[0])
      throw npstat::NpstatOutOfRange("In npstat::ArrayND::at: index 0 out of range (rank 4)");
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <unsigned Len2, unsigned Dim2>
  double ArrayND<Numeric, Len, Dim>::maxAbsDifference(const ArrayND<Numeric, Len2, Dim2>& r) const {
    if (!isShapeCompatible(r))
      throw npstat::NpstatInvalidArgument(
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <unsigned Len2, unsigned Dim2>
  bool ArrayND<Numeric, Len, Dim>::operator==(const ArrayND<Numeric, Len2, Dim2>& r) const {
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <unsigned Len2, unsigned Dim2>
  inline bool ArrayND<Numeric, Len, Dim>::operator!=(const ArrayND<Numeric, Len2, Dim2>& r) const {
    return !(*this == r);
  }

  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2>
  ArrayND<Numeric, Len, Dim> ArrayND<Numeric, Len, Dim>::operator*(const Num2& r) const {
    if (!shapeIsKnown_)
      throw npstat::NpstatInvalidArgument("Initialize npstat::ArrayND before calling method \"operator*\"");
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <unsigned Len2, unsigned Dim2>
  ArrayND<Numeric, Len, Dim> ArrayND<Numeric, Len, Dim>::operator+(const ArrayND<Numeric, Len2, Dim2>& r) const {
    if (!isShapeCompatible(r))
      throw npstat::NpstatInvalidArgument(
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2>
  ArrayND<Numeric, Len, Dim>& ArrayND<Numeric, Len, Dim>::operator*=(const Num2& r) {
    if (!shapeIsKnown_)
      throw npstat::NpstatInvalidArgument("Initialize npstat::ArrayND before calling method \"operator*=\"");
    for (unsigned long i = 0; i < len_; ++i)
      data_[i] *= r;
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  ArrayND<Numeric, Len, Dim>& ArrayND<Numeric, Len, Dim>::makeNonNegative() {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  unsigned ArrayND<Numeric, Len, Dim>::makeCopulaSteps(const double tolerance, const unsigned nCycles) {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num3, typename Num2, unsigned Len2, unsigned Dim2>
  ArrayND<Numeric, Len, Dim>& ArrayND<Numeric, Len, Dim>::addmul(const ArrayND<Num2, Len2, Dim2>& r, const Num3& c) {
    if (!isShapeCompatible(r))
      throw npstat::NpstatInvalidArgument(
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  Numeric ArrayND<Numeric, Len, Dim>::interpolate1(const double* coords, const unsigned dim) const {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  Numeric ArrayND<Numeric, Len, Dim>::interpolateLoop(const unsigned level,
                                                      const double* coords,
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric ArrayND<Numeric, Len, Dim>::interpolate3(const double* coords, const unsigned dim) const {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <class Functor>
  ArrayND<Numeric, Len, Dim>& ArrayND<Numeric, Len, Dim>::scanInPlace(Functor f) {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  ArrayND<Numeric, Len, Dim>& ArrayND<Numeric, Len, Dim>::constFill(const Numeric c) {
    if (!shapeIsKnown_)
  ...
  void ArrayND<Numeric, Len, Dim>::linearFillLoop(
      const unsigned level, const double s0, const unsigned long idx, const double shift, const double* coeffs) {
    const unsigned imax = shape_[level];
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  ArrayND<Numeric, Len, Dim>& ArrayND<Numeric, Len, Dim>::linearFill(const double* coeffs,
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <class Functor>
  void ArrayND<Numeric, Len, Dim>::functorFillLoop(const unsigned level,
                                                   const unsigned long idx,
                                                   Functor f,
                                                   unsigned* farg) {
    const unsigned imax = shape_[level];
  ...
  void ArrayND<Numeric, Len, Dim>::convertToLastDimCdfLoop(
      ArrayND* sumSlice, const unsigned level, unsigned long idx0, unsigned long idxSlice, const bool useTrapezoids) {
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Accumulator>
  inline void ArrayND<Numeric, Len, Dim>::convertToLastDimCdf(ArrayND* sumSlice, const bool useTrapezoids) {
    if (!shapeIsKnown_)
      throw npstat::NpstatInvalidArgument(
          "Initialize npstat::ArrayND before calling "
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  bool ArrayND<Numeric, Len, Dim>::isClose(const ArrayND<Num2, Len2, Dim2>& r, const double eps) const {
    if (eps < 0.0)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  ArrayND<Numeric, Len, Dim> ArrayND<Numeric, Len, Dim>::outer(const ArrayND<Num2, Len2, Dim2>& r) const {
    return ArrayND<Numeric, Len, Dim>(*this, r);
  }

  template <typename Numeric, unsigned Len, unsigned Dim>
  void ArrayND<Numeric, Len, Dim>::contractLoop(unsigned thisLevel,
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  ArrayND<Numeric, Len, Dim> ArrayND<Numeric, Len, Dim>::contract(const unsigned pos1, const unsigned pos2) const {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  void ArrayND<Numeric, Len, Dim>::transposeLoop(const unsigned level,
                                                 const unsigned pos1,
                                                 const unsigned pos2,
                                                 unsigned long idxThis,
                                                 unsigned long idxRes,
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  Numeric ArrayND<Numeric, Len, Dim>::min(unsigned* index, const unsigned indexLen) const {
    if (!shapeIsKnown_)
      throw npstat::NpstatInvalidArgument("Initialize npstat::ArrayND before calling method \"min\"");
    if (indexLen != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  Numeric ArrayND<Numeric, Len, Dim>::max(unsigned* index, const unsigned indexLen) const {
    if (!shapeIsKnown_)
      throw npstat::NpstatInvalidArgument("Initialize npstat::ArrayND before calling method \"max\"");
    if (indexLen != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Accumulator>
  ArrayND<Numeric, Len, Dim> ArrayND<Numeric, Len, Dim>::derivative(const double inscale) const {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Accumulator>
  Accumulator ArrayND<Numeric, Len, Dim>::sumBelowLoop(const unsigned level,
                                                       unsigned long idx0,
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Accumulator>
  Accumulator ArrayND<Numeric, Len, Dim>::cdfValue(const unsigned* index, const unsigned indexLen) const {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Accumulator>
  ArrayND<Numeric, Len, Dim> ArrayND<Numeric, Len, Dim>::cdfArray(const double inscale) const {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  ArrayND<Numeric, Len, Dim> ArrayND<Numeric, Len, Dim>::transpose(const unsigned pos1, const unsigned pos2) const {
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  void ArrayND<Numeric, Len, Dim>::multiMirror(ArrayND<Num2, Len2, Dim2>* out) const {
    assert(out);
    if (!shapeIsKnown_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  void ArrayND<Numeric, Len, Dim>::rotate(const unsigned* shifts,
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  void ArrayND<Numeric, Len, Dim>::dotProductLoop(const unsigned level,
                                                  unsigned long idx0,
                                                  unsigned long idx1,
                                                  unsigned long idx2,
                                                  const ArrayND<Num2, Len2, Dim2>& r,
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  ArrayND<Numeric, Len, Dim> ArrayND<Numeric, Len, Dim>::dot(const ArrayND<Num2, Len2, Dim2>& r) const {
    if (!dim_)
      throw npstat::NpstatInvalidArgument(
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline const Numeric& ArrayND<Numeric, Len, Dim>::cl(const double i0) const {
    if (1U != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline const Numeric& ArrayND<Numeric, Len, Dim>::cl(const double i0, const double i1) const {
    if (2U != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline const Numeric& ArrayND<Numeric, Len, Dim>::cl(const double i0, const double i1, const double i2) const {
    if (3U != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline const Numeric& ArrayND<Numeric, Len, Dim>::cl(const double i0,
                                                       const double i1,
                                                       const double i2,
  ...
  inline const Numeric& ArrayND<Numeric, Len, Dim>::cl(
      const double i0, const double i1, const double i2, const double i3, const double i4) const {
    if (5U != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline const Numeric& ArrayND<Numeric, Len, Dim>::cl(
      const double i0, const double i1, const double i2, const double i3, const double i4, const double i5) const {
    if (6U != dim_)
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::cl(const double i0) {
    if (1U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::cl: wrong # of args (not rank 1 array)");
    return data_[coordToIndex(i0, 0)];
  }
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::cl(const double i0, const double i1) {
    if (2U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::cl: wrong # of args (not rank 2 array)");
    return data_[coordToIndex(i0, 0) * strides_[0] + coordToIndex(i1, 1)];
  }
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::cl(const double i0, const double i1, const double i2) {
    if (3U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::cl: wrong # of args (not rank 3 array)");
    return data_[coordToIndex(i0, 0) * strides_[0] + coordToIndex(i1, 1) * strides_[1] + coordToIndex(i2, 2)];
  }
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::cl(const double i0, const double i1, const double i2, const double i3) {
    if (4U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::cl: wrong # of args (not rank 4 array)");
    return data_[coordToIndex(i0, 0) * strides_[0] + coordToIndex(i1, 1) * strides_[1] +
                 coordToIndex(i2, 2) * strides_[2] + coordToIndex(i3, 3)];
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::cl(
      const double i0, const double i1, const double i2, const double i3, const double i4) {
    if (5U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::cl: wrong # of args (not rank 5 array)");
    return data_[coordToIndex(i0, 0) * strides_[0] + coordToIndex(i1, 1) * strides_[1] +
                 coordToIndex(i2, 2) * strides_[2] + coordToIndex(i3, 3) * strides_[3] + coordToIndex(i4, 4)];
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  inline Numeric& ArrayND<Numeric, Len, Dim>::cl(
      const double i0, const double i1, const double i2, const double i3, const double i4, const double i5) {
    if (6U != dim_)
      throw npstat::NpstatInvalidArgument("In npstat::ArrayND::cl: wrong # of args (not rank 6 array)");
    return data_[coordToIndex(i0, 0) * strides_[0] + coordToIndex(i1, 1) * strides_[1] +
                 coordToIndex(i2, 2) * strides_[2] + coordToIndex(i3, 3) * strides_[3] +
  ...
  template <typename Numeric, unsigned Len, unsigned Dim>
  void ArrayND<Numeric, Len, Dim>::restore(const gs::ClassId& id, std::istream& in, ArrayND* array) {
  ...
  template <typename Numeric, unsigned Len, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  void ArrayND<Numeric, Len, StackDim>::exportSubrange(const unsigned* corner,
  ...
  template <typename Numeric, unsigned Len, unsigned StackDim>
  template <typename Num2, unsigned Len2, unsigned Dim2>
  void ArrayND<Numeric, Len, StackDim>::importSubrange(const unsigned* corner,
                                                       const unsigned lenCorner,
