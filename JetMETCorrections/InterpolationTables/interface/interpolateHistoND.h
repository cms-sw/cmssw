...
namespace npstat {
  ...
  template <typename Float, class Axis>
  Float interpolateHistoND(
      const HistoND<Float, Axis>& histo, double x0, double x1, double x2, unsigned interpolationDegree);

  template <typename Float, class Axis>
  Float interpolateHistoND(
      const HistoND<Float, Axis>& histo, double x0, double x1, double x2, double x3, unsigned interpolationDegree);
...
namespace npstat {
  ...
  template <typename Float, class Axis>
  Float interpolateHistoND(const HistoND<Float, Axis>& histo, const double x0, const unsigned interpolationDegree) {
