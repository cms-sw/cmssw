...
namespace npstat {
  namespace Private {
    ...
    struct AbsHelper {
      ...
      inline static return_type delta(const T& v1, const T& v2) { return std::abs(v1 - v2); }

      inline static return_type value(const T& v1) { return std::abs(v1); }
    };
    ...
    struct AbsHelper<T, 1> {
      ...
      inline static return_type delta(const T& v1, const T& v2) { return v1 > v2 ? v1 - v2 : v2 - v1; }

      inline static return_type value(const T& v1) { return v1; }
    };
  }  // namespace Private
  ...
  /**
    ...
    */
  template <typename T>
  inline typename Private::AbsReturnType<T>::type absDifference(const T& v1, const T& v2) {
  ...
  /**
    ...
    */
  template <typename T>
  inline typename Private::AbsReturnType<T>::type absValue(const T& v1) {
