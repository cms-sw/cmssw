...
namespace npstat {
  ...
  public:
    ...
    inline void setDescription(const std::string& newDescription) { description_ = newDescription; }
    ...
    inline bool operator!=(const StorableMultivariateFunctor& r) const { return !(*this == r); }
    //@}
    ...
    static inline const char* classname() { return "npstat::StorableMultivariateFunctor"; }
