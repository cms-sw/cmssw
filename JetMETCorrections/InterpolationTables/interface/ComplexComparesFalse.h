...
namespace npstat {
  ...
  struct ComplexComparesFalse {
    inline static bool less(const T& l, const T& r) { return l < r; }

    inline static bool more(const T& l, const T& r) { return l > r; }
  };

  template <class T>
  struct ComplexComparesFalse<std::complex<T> > {
    inline static bool less(const std::complex<T>&, const std::complex<T>&) { return false; }

    inline static bool more(const std::complex<T>&, const std::complex<T>&) { return false; }
  };
}  // namespace npstat
