...
namespace npstat {
  void StorableMultivariateFunctor::validateDescription(const std::string& description) const {
  ...
  StorableMultivariateFunctor* StorableMultivariateFunctor::read(const gs::ClassId& id, std::istream& in) {
