...
from RecoTauTag.RecoTau.CaloRecoTauDiscriminationAgainstHadronicJets_cfi import *
caloRecoTauDiscriminationAgainstHadronicJets.CaloTauProducer = cms.InputTag('tcRecoTauProducer')
