...
ak4TrackJetsL1L2L3 = ak4TrackJetsL1.clone(correctors = ['ak4TrackL1L2L3Corrector'])

# L1FastL2L3 Correction Producers
ak4CaloJetsL1FastL2L3 = ak4CaloJetsL1.clone(correctors = ['ak4CaloL1FastL2L3Corrector'])
ak4PFJetsL1FastL2L3 = ak4PFJetsL1.clone(correctors = ['ak4PFL1FastL2L3Corrector'])
ak4PFCHSJetsL1FastL2L3 = ak4PFCHSJetsL1.clone(correctors = ['ak4PFCHSL1FastL2L3Corrector'])
ak4JPTJetsL1FastL2L3 = ak4JPTJetsL1.clone(correctors = ['ak4JPTL1FastL2L3Corrector'])
ak4TrackJetsL1FastL2L3 = ak4TrackJetsL1.clone(correctors = ['ak4TrackL1FastL2L3Corrector'])

# L1FastL2L3Residual Correction Producers
ak4CaloJetsL1FastL2L3Residual = ak4CaloJetsL1.clone(correctors = ['ak4CaloL1FastL2L3ResidualCorrector'])
ak4PFJetsL1FastL2L3Residual = ak4PFJetsL1.clone(correctors = ['ak4PFL1FastL2L3ResidualCorrector'])
ak4PFCHSJetsL1FastL2L3Residual = ak4PFCHSJetsL1.clone(correctors = ['ak4PFCHSL1FastL2L3ResidualCorrector'])
ak4JPTJetsL1FastL2L3Residual = ak4JPTJetsL1.clone(correctors = ['ak4JPTL1FastL2L3ResidualCorrector'])
ak4TrackJetsL1FastL2L3Residual = ak4TrackJetsL1.clone(correctors = ['ak4TrackL1FastL2L3ResidualCorrector'])
