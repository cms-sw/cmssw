...
L2L3JetCorrectorIcone7 = cms.ESSource("JetCorrectionServiceChain",  
    correctors = cms.vstring('L2RelativeJetCorrectorIcone7','L3AbsoluteJetCorrectorIcone7'),
    label = cms.string('L2L3JetCorrectorIcone7') 
)
...
L2L3CorJetIcone7 = cms.EDProducer("CaloJetCorrectionProducer",
    src = cms.InputTag("iterativeCone7CaloJets"),
    correctors = cms.vstring('L2L3JetCorrectorIcone7')
)
