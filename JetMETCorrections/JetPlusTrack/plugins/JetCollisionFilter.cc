#include "JetMETCorrections/JetPlusTrack/plugins/JetCollisionFilter.h"
...
// Check if Primary vertex exist
   ...
   if(!result) { std::cout<<" Vertex is outside 10 cms "<<std::endl; return retcode;}

   std::cout<<" PV exists in the acceptable range (+-10 cm) and bx = "<<bx<<std::endl;  
