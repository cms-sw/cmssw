...
#ifndef SinglePionEfficiency_h
#define SinglePionEfficiency_h
...
public :
   ...
   SinglePionEfficiency(TTree *tree=0);
   virtual ~SinglePionEfficiency();
...
#ifdef SinglePionEfficiency_cxx
SinglePionEfficiency::SinglePionEfficiency(TTree *tree)
{
...
SinglePionEfficiency::~SinglePionEfficiency()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t SinglePionEfficiency::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SinglePionEfficiency::LoadTree(Long64_t entry)
{
...
void SinglePionEfficiency::Init(TTree *tree)
{
...
Bool_t SinglePionEfficiency::Notify()
{
...
void SinglePionEfficiency::Show(Long64_t entry)
{
...
Int_t SinglePionEfficiency::Cut(Long64_t entry)
{
...
#endif // #ifdef SinglePionEfficiency_cxx
