#define SinglePionEfficiencyVSpT_cxx
#include "SinglePionEfficiencyVSpT.h"
#include <TStyle.h>
#include <TCanvas.h>

void SinglePionEfficiencyVSpT::setTDRStyle(Int_t xlog, Int_t ylog) {
...
void SinglePionEfficiencyVSpT::Loop()
{
//   In a ROOT session, you can do:
//      Root > .L SinglePionEfficiencyVSpT.C
//      Root > SinglePionEfficiencyVSpT t
