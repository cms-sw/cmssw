...
// $Id: MuonTCMETValueMapProducer.cc,v 1.3 2009/07/30 14:32:16 fgolf Exp $
//
//
...
namespace cms {
  ...
  void MuonTCMETValueMapProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
	...
	if( mu_track->pt() < minpt_ ) 
	     muMETCorrData = reco::MuonMETCorrectionData(reco::MuonMETCorrectionData::NotUsed, deltax, deltay);
  ...
  bool MuonTCMETValueMapProducer::isGoodCaloMuon( const reco::Muon* muon, const int index ) {
    ...
    for (int iMu = 0; iMu < muon_h->size(); iMu++) {
  ...
  TVector3 MuonTCMETValueMapProducer::propagateTrack( const reco::Muon* muon) {
    ...
    outerTrkPosition.SetPtEtaPhi( 999., -999., 3 * TMath::Pi() );
