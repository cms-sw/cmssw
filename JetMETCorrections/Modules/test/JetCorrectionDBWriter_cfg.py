...
process.PoolDBOutputService = cms.Service('PoolDBOutputService', 
   ...
   toPut = cms.VPSet( 
      ...
      cms.PSet(
         ...
         tag    = cms.string('JetCorrectorParametersCollection_Spring10_V5_AK5PF'), 
      ...
      cms.PSet(
         ...
         tag    = cms.string('JetCorrectorParametersCollection_Spring10_V5_AK5TRK'), 
         label  = cms.string('AK5TRK') 
      ),
      cms.PSet(
         record = cms.string('AK7Calo'), 
         tag    = cms.string('JetCorrectorParametersCollection_Spring10_V5_AK7Calo'), 
         label  = cms.string('AK7Calo') 
      ),
      cms.PSet(
         record = cms.string('AK7PF'), 
         tag    = cms.string('JetCorrectorParametersCollection_Spring10_V5_AK7PF'), 
         label  = cms.string('AK7PF') 
      ),
      cms.PSet(
         record = cms.string('AK7JPT'),                           
         tag    = cms.string('JetCorrectorParametersCollection_Spring10_V5_AK7JPT'),
     ...
     cms.PSet(
         ...
         tag    = cms.string('JetCorrectorParametersCollection_Spring10_V5_IC5PF'), 
         label  = cms.string('IC5PF') 
      ),
      cms.PSet(
         record = cms.string('KT4Calo'), 
         tag    = cms.string('JetCorrectorParametersCollection_Spring10_V5_KT4Calo'), 
         label  = cms.string('KT4Calo') 
      ),
      cms.PSet(
         record = cms.string('KT4PF'), 
         tag    = cms.string('JetCorrectorParametersCollection_Spring10_V5_KT4PF'), 
         label  = cms.string('KT4PF') 
      ),
      cms.PSet(
         record = cms.string('KT6Calo'), 
         tag    = cms.string('JetCorrectorParametersCollection_Spring10_V5_KT6Calo'), 
         label  = cms.string('KT6Calo') 
      ),
      cms.PSet(
         record = cms.string('KT6PF'), 
         tag    = cms.string('JetCorrectorParametersCollection_Spring10_V5_KT6PF'), 
