...
process.jec = cms.ESSource("PoolDBESSource",CondDBSetup,
                   ...
                   toGet =  cms.VPSet(
                       cms.PSet(record = cms.string("JetCorrectionsRecord"),
                                tag = cms.string("JetCorrectorParametersCollection_Spring10_V6_AK4Calo"),
                                label=cms.untracked.string("AK4Calo")),
                       cms.PSet(record = cms.string("JetCorrectionsRecord"),
                                tag = cms.string("JetCorrectorParametersCollection_Spring10_V6_AK4PF"),
                                label=cms.untracked.string("AK4PF")),                                   
                       cms.PSet(record = cms.string("JetCorrectionsRecord"),
                                tag = cms.string("JetCorrectorParametersCollection_Summer10_V6_AK4JPT"),
                       ...
                       cms.PSet(record = cms.string("JetCorrectionsRecord"),
                                tag = cms.string("JetCorrectorParametersCollection_Spring10_V6_AK8Calo"),
...
##-------------------- User analyzer  --------------------------------
process.ak4caloDemo  = cms.EDAnalyzer('FactorizedJetCorrectorDemo',
    ...
    PayloadName              = cms.string('AK4Calo'),
...
process.p = cms.Path(process.ak4caloDemo)
