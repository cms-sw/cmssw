...
public:
  inline explicit FFTEtaLogPtConeRadiusMapper(const std::shared_ptr<npstat::AbsMultivariateFunctor>& f)
...
public:
  ...
  // in the constructor
  //
  inline FFTSpecificScaleCalculator(const std::shared_ptr<npstat::AbsMultivariateFunctor>& f,
