...
typedef FFTJetCorrectorSequence<reco::FFTAnyJet<reco::BasicJet>,
                                FFTJetCorrectorTransientFromJet,
                                FFTJetCorrectorResultFromTransient>
    FFTBasicJetCorrectorSequence;

typedef FFTJetCorrectorSequence<reco::FFTAnyJet<reco::CaloJet>,
                                FFTJetCorrectorTransientFromJet,
                                FFTJetCorrectorResultFromTransient>
    FFTCaloJetCorrectorSequence;

typedef FFTJetCorrectorSequence<reco::FFTAnyJet<reco::GenJet>,
                                FFTJetCorrectorTransientFromJet,
                                FFTJetCorrectorResultFromTransient>
    FFTGenJetCorrectorSequence;

typedef FFTJetCorrectorSequence<reco::FFTAnyJet<reco::PFJet>,
                                FFTJetCorrectorTransientFromJet,
                                FFTJetCorrectorResultFromTransient>
    FFTPFJetCorrectorSequence;

typedef FFTJetCorrectorSequence<reco::FFTAnyJet<reco::TrackJet>,
                                FFTJetCorrectorTransientFromJet,
                                FFTJetCorrectorResultFromTransient>
    FFTTrackJetCorrectorSequence;

typedef FFTJetCorrectorSequence<reco::FFTAnyJet<reco::JPTJet>,
                                FFTJetCorrectorTransientFromJet,
                                FFTJetCorrectorResultFromTransient>
