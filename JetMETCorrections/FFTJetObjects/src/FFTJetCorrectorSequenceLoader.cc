...
#define add_loader_1(Record) (*this)[#Record] = new ConcreteFFTJetRcdMapper<FFTBasicJetCorrectorSequence, Record>()
...
#define add_loader_3(Record) (*this)[#Record] = new ConcreteFFTJetRcdMapper<FFTGenJetCorrectorSequence, Record>()
...
#define add_loader_2(Record) (*this)[#Record] = new ConcreteFFTJetRcdMapper<FFTCaloJetCorrectorSequence, Record>()
...
#define add_loader_4(Record) (*this)[#Record] = new ConcreteFFTJetRcdMapper<FFTPFJetCorrectorSequence, Record>()
...
#define add_loader_5(Record) (*this)[#Record] = new ConcreteFFTJetRcdMapper<FFTTrackJetCorrectorSequence, Record>()
...
#define add_loader_6(Record) (*this)[#Record] = new ConcreteFFTJetRcdMapper<FFTJPTJetCorrectorSequence, Record>()
