...
public:
  explicit HcalTB06BeamDetectorBuilder(edm::ParameterSet const& p, edm::ConsumesCollector cc) : hcParToken_{cc.esConsumes<edm::Transition::BeginRun>()}, hcPar_{nullptr} {}
