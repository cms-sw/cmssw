...
private:
  void BookHistos();
  void StoreWeights();
  void HistInit(const char *name, const char *title, Int_t nbinsx, Axis_t xlow,
                Axis_t xup);
  void HistInit(const char *name, const char *title, Int_t nbinsx, Axis_t xlow,
...
private:
  ...
  // SumEnerDeposit - all deposited energy on all steps ;  SumStepl - length in
  // steel !!!
...
private:
  ...
  //   TString fRecreateFile;          // Recreate the file flag,
  //   default="RECREATE"
};
