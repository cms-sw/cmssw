...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
                               ...
                               'Geometry/HGCalTBCommonData/data/TB181/Oct183/hgcal.xml',
                               'Geometry/HGCalTBCommonData/data/TB181/Oct183/hgcalEE.xml',
                               'Geometry/HGCalTBCommonData/data/TB181/Oct183/hgcalHE.xml',
                               'Geometry/HGCalTBCommonData/data/TB181/ahcal.xml',
                               'Geometry/HGCalTBCommonData/data/TB181/Oct183/hgcalBeam.xml',
