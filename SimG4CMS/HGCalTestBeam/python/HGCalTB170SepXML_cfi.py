...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
                               ...
                               'Geometry/HGCalTBCommonData/data/TB170/Sep17/hgcal.xml',
                               'Geometry/HGCalTBCommonData/data/TB170/Sep17/hgcalEE.xml',
                               'Geometry/HGCalTBCommonData/data/TB170/Sep17/hgcalHE.xml',
                               ...
                               'Geometry/HGCalTBCommonData/data/TB170/Sep17/hgcalCons.xml'
                               ),
