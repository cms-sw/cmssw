...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
                               ...
                               'Geometry/HGCalCommonData/data/TB170/Sep17/hgcal.xml',
                               'Geometry/HGCalCommonData/data/TB170/Sep17/hgcalEE.xml',
                               'Geometry/HGCalCommonData/data/TB170/Sep17/hgcalHE.xml',
                               ...
                               'Geometry/HGCalCommonData/data/TB170/Sep17/hgcalCons.xml'
                               ),
