...
process.load('SimG4CMS.HGCalTestBeam.hgcalTBMBAnalyzerCERNBeam18Oct1_cfi')
...
process.analysis_step = cms.Path(process.HGCalTBCheckGunPostion*process.HGCalTBAnalyzer*process.hgcalTBMBAnalyzerCERNBeam18Oct1)
