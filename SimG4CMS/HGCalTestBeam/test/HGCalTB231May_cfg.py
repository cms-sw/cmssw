...
process = cms.Process("PROD",Phase2C22I13M9,phase2_hgcalOnly)
process.load("SimGeneral.HepPDTESSource.pythiapdt_cfi")
process.load("IOMC.EventVertexGenerators.VtxSmearedGauss_cfi")
process.load("Geometry.HGCalTBCommonData.testHGCalTB231May_cff")
...
process.g4SimHits.FileNameGDML = 'hgcalTB23May.gdml'
