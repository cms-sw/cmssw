...
// .L MakeHFNPlots.C+g
//
//   To make plot of layers from a file created using .SimHit/Digi/RecHitStudy
//     makeLayerPlots(fname, type, todomin, todomax, tag, text, save)
//
//   where
//     fname   std::string   Name of the ROOT file (hfnSimHitD44tt.root)
//     type    int           File type (0:SimHit; 2:Digi; 3:RecHit)
//     todomin int           Range of plots to make (minimum: -1
//     todomax int           maximum: 8)
...
void makeLayerPlots(std::string fname="hfnSimHitD44tt.root", int type=0,
