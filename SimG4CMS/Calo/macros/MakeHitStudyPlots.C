...
void makeHitStudyPlots(std::string file1="analRun3Old.root", std::string tag1="Old",
                       std::string file2="analRun3New.root", std::string tag2="New",
                       int todo=0, std::string dirnm="CaloSimHitStudy", 
		       bool save=false) {

  std::string names[18] = {"Edep", "EdepEM", "EdepHad", "EdepTk", "Etot", 
                           "EtotG", "Hit", "HitHigh", "HitLow", "HitMu", 
                           "HitTk", "Time", "TimeAll", "TimeTk", "EneInc", 
                           "EtaInc", "PhiInc", "PtInc"};
  int         numb[18] = {9, 9, 9, 16, 9, 9, 9, 1, 1, 1, 16, 9, 9, 16, 1, 1,
			  1, 1};
  int         rebin[18] = {10, 10, 10, 1, 10, 10, 10, 10, 10, 10, 10, 10, 10, 
                           10, 1, 1, 1, 1};
