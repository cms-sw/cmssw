...
double EvolutionECAL::InducedAbsorptionEM(double lumi, double eta) {
  ...
  std::unique_ptr<TF1>ftmp1 = std::make_unique<TF1>("ftmp1", this, &EvolutionECAL::EquilibriumFractionColorCentersEM, 0.0, 22.0, 3, "EvolutionECAL", "EquilibriumFractionColorCentersEM");
