...
#suffix='_gem_dphi0_pat2'; inputDir = '/pnfs/cms/WAX/11/store/user/lpcgem/khotilov/GEM_MuGun_PU0_L1_dphi_pat2/'
...
from RPCGEM.GEMValidation.GEMCSCAnalyzer_cfi import GEMCSCAnalyzer
#GEMCSCAnalyzer.simTrackMatching.verboseSimHit = 1
#GEMCSCAnalyzer.simTrackMatching.verboseGEMDigi = 1
#GEMCSCAnalyzer.simTrackMatching.verboseCSCDigi = 1
#GEMCSCAnalyzer.simTrackMatching.verboseCSCStub = 1
#GEMCSCAnalyzer.simTrackMatching.simMuOnlyGEM = False
#GEMCSCAnalyzer.simTrackMatching.simMuOnlyCSC = False
#GEMCSCAnalyzer.simTrackMatching.discardEleHitsCSC = False
#GEMCSCAnalyzer.simTrackMatching.discardEleHitsGEM = False
...
#    minDeltaStrip = cms.untracked.int32(1),
    ...
    simTrackGEMMatching = GEMCSCAnalyzer.simTrackMatching.clone(),
