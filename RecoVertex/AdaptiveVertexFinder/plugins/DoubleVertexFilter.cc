...
DoubleVertexFilter::DoubleVertexFilter(const edm::ParameterSet &params)
  ...
  token_secondaryVertex = consumes<reco::VertexCollection>(
...
void DoubleVertexFilter::produce(edm::StreamID, edm::Event &event,
  ...
  for (std::vector<reco::Vertex>::const_iterator sv =
