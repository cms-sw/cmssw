...
template <class InputContainer, class VTX>
TemplatedVertexArbitrator<InputContainer, VTX>::TemplatedVertexArbitrator(
...
template <class InputContainer, class VTX>
void TemplatedVertexArbitrator<InputContainer, VTX>::produce(
  ...
  if (primaryVertices->size() != 0) {
    ...
    //        const edm::RefVector< TrackCollection > tracksForArbitration=
    //        selectedTracks;
    Product theRecoVertices = theArbitrator->trackVertexArbitrator(
        beamSpot, pv, selectedTracks, theSecVertexColl);
