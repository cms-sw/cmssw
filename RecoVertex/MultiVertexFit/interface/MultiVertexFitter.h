...
public:
  ...
  typedef std::map<reco::TransientTrack, SeedToWeightMap>
   ...
   */
  std::vector<CachingVertex<5>>
  vertices(const std::vector<std::vector<reco::TransientTrack>> &,
   ...
   */
  std::vector<CachingVertex<5>>
  vertices(const std::vector<std::vector<TrackAndWeight>> &,
           const std::vector<reco::TransientTrack> &primaries =
               std::vector<reco::TransientTrack>());
   ...
   */
  std::vector<CachingVertex<5>>
  vertices(const std::vector<CachingVertex<5>> &,
           const std::vector<reco::TransientTrack> &primaries =
               std::vector<reco::TransientTrack>());
   ...
   */
  std::vector<CachingVertex<5>>
  vertices(const std::vector<TransientVertex> &,
           const std::vector<reco::TransientTrack> &primaries =
               std::vector<reco::TransientTrack>());
