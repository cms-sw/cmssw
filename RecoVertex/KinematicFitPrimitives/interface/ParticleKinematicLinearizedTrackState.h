...
public:
  ...
  typedef ReferenceCountingPointer<LinearizedTrackState<6>>
...
private:
   ...
   */
  ParticleKinematicLinearizedTrackState(const GlobalPoint &linP,
  ...
  /**
   * Method calculating the track parameters and the Jacobians for charged
   * particles.
   */
  void computeChargedJacobians() const;

  /**
   * Method calculating the track parameters and the Jacobians for neutral
   * particles.
   */
