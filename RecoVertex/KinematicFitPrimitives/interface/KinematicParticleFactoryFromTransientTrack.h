...
public:
   ...
   * Default destructor
   */
  ~KinematicParticleFactoryFromTransientTrack() { delete propagator; }
  ...
  RefCountedKinematicParticle particle(const reco::TransientTrack &initialTrack,
                                       ...
                                       float chiSquared, float degreesOfFr,
                                       float &m_sigma) const;
  ...
  particle(const reco::TransientTrack &initialTrack,
           const ParticleMass &massGuess, float chiSquared, float degreesOfFr,
           float &m_sigma, const FreeTrajectoryState &freestate) const;
   ...
   */
  RefCountedKinematicParticle
  particle(const KinematicState &kineState, float &chiSquared, float &ndf,
