...
private:
  ...
  mutable math::Graph<RefCountedKinematicVertex, RefCountedKinematicParticle>
      treeGraph;
  mutable math::GraphWalker<RefCountedKinematicVertex,
                            RefCountedKinematicParticle> *treeWalker;
};
#endif
