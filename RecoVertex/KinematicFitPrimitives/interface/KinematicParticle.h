...
public:
  ...
  virtual bool operator==(
      const ReferenceCountingPointer<KinematicParticle> &other) const = 0;
   ...
   */
  virtual ReferenceCountingPointer<KinematicParticle>
   ...
   * Kalman flter vertex fit. Should be implemented by user.  For
   * track(helix)-like objects one can use the
