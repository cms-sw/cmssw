...
public:
  ...
  propagateToTheTransversePCA(const KinematicState &state,
                              const GlobalPoint &referencePoint) const override;

  bool willPropagateToTheTransversePCA(const KinematicState &state,
...
private:
  /**
   * Internal private methods, distinguishing between the propagation of
   * neutrals and propagation of cahrged tracks.
   */
  virtual KinematicState
  propagateToTheTransversePCACharged(const KinematicState &state,
                                     const GlobalPoint &referencePoint) const;

  virtual KinematicState
  propagateToTheTransversePCANeutral(const KinematicState &state,
                                     const GlobalPoint &referencePoint) const;
