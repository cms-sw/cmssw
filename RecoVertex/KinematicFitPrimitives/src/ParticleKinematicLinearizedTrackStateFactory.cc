...
ParticleKinematicLinearizedTrackStateFactory::linearizedTrackState(
    const GlobalPoint &linP, RefCountedKinematicParticle &prt) const {
  return RefCountedLinearizedTrackState(
      new ParticleKinematicLinearizedTrackState(linP, prt));
}

const ParticleKinematicLinearizedTrackStateFactory *
ParticleKinematicLinearizedTrackStateFactory::clone() const {
...
ParticleKinematicLinearizedTrackStateFactory::linearizedTrackState(
  ...
  throw VertexException("ParticleKinematicLinearizedTrackStateFactory from "
                        "TransientTrack not possible");
}
ParticleKinematicLinearizedTrackStateFactory::RefCountedLinearizedTrackState
ParticleKinematicLinearizedTrackStateFactory::linearizedTrackState(
