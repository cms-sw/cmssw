...
bool TransientTrackKinematicParticle::
operator==(const KinematicParticle &other) const {
  ...
  const TransientTrackKinematicParticle *lPart =
      dynamic_cast<const TransientTrackKinematicParticle *>(lp);
  if (lPart != nullptr) {
...
KinematicState
TransientTrackKinematicParticle::stateAtPoint(const GlobalPoint &point) const {
...
TransientTrackKinematicParticle::initialTransientTrack() const {
  return inTrack;
}

ReferenceCountingPointer<KinematicParticle>
TransientTrackKinematicParticle::refittedParticle(
    const KinematicState &state, float chi2, float ndf,
    KinematicConstraint *cons) const {
  TransientTrackKinematicParticle *ncp =
      const_cast<TransientTrackKinematicParticle *>(this);
  return ReferenceCountingPointer<KinematicParticle>(
      new TransientTrackKinematicParticle(
          state, chi2, ndf, cons,
          ReferenceCountingPointer<KinematicParticle>(ncp), propagator,
...
TransientTrackKinematicParticle::particleLinearizedTrackState(
  ...
  TransientTrackKinematicParticle *cr =
      const_cast<TransientTrackKinematicParticle *>(this);
