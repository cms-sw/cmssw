...
template <unsigned int N> class LinearizedTrackState : public ReferenceCounted {

public:
  typedef ROOT::Math::SVector<double, N> AlgebraicVectorN;
  typedef ROOT::Math::SVector<double, N - 2> AlgebraicVectorM;
  typedef ROOT::Math::SMatrix<double, N, 3, ROOT::Math::MatRepStd<double, N, 3>>
      AlgebraicMatrixN3;
  typedef ROOT::Math::SMatrix<double, N, N - 2,
                              ROOT::Math::MatRepStd<double, N, N - 2>>
      AlgebraicMatrixNM;
  typedef ROOT::Math::SMatrix<double, N - 2, 3,
                              ROOT::Math::MatRepStd<double, N - 2, 3>>
      AlgebraicMatrixM3;
  typedef ROOT::Math::SMatrix<double, N, N, ROOT::Math::MatRepSym<double, N>>
      AlgebraicSymMatrixNN;
  typedef ROOT::Math::SMatrix<double, N - 2, N - 2,
                              ROOT::Math::MatRepSym<double, N - 2>>
      AlgebraicSymMatrixMM;
  typedef ROOT::Math::SMatrix<double, N + 1, N + 1,
                              ROOT::Math::MatRepSym<double, N + 1>>
      AlgebraicSymMatrixOO;

  typedef ReferenceCountingPointer<RefittedTrackState<N>>
   ...
   * A new object of the same type is returned, without change to the existing
   * one.
   */
  virtual ReferenceCountingPointer<LinearizedTrackState<N>>
  ...
  virtual std::vector<ReferenceCountingPointer<LinearizedTrackState<N>>>
  components() const = 0;
