...
FsmwLinearizationPointFinder::FsmwLinearizationPointFinder(signed int n_pairs,
                                                           float we, float frac,
                                                           float cut, int nwa)
...
FsmwLinearizationPointFinder::FsmwLinearizationPointFinder(
    const RecTracksDistanceMatrix *m, signed int n_pairs, float we, float frac,
    float cut, int nwa)
    : CrossingPtBasedLinearizationPointFinder(
          m, FsmwModeFinder3d(frac, we, cut, nwa), n_pairs) {}
