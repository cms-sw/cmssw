...
class FsmwLinearizationPointFinder
...
public:
   ...
   */
  FsmwLinearizationPointFinder(signed int n_pairs = 250, float weight_exp = -2.,
                               float fraction = .5, float cut = 10,
                               int no_weight_above = 10);

  FsmwLinearizationPointFinder(const RecTracksDistanceMatrix *m,
                               signed int n_pairs = 250, float weight_exp = -2.,
                               float fraction = .5, float cut = 10,
                               int no_weight_above = 10);
