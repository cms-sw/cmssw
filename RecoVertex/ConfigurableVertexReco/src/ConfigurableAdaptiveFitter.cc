...
// #include
// "RecoVertex/LinearizationPointFinders/interface/GenericLinearizationPointFinder.h"
...
void ConfigurableAdaptiveFitter::configure(const edm::ParameterSet &n) {
  ...
  AdaptiveVertexFitter *fitter =
      new AdaptiveVertexFitter(ann, linpt, updator, estimator, *smoother);
  delete smoother;
...
namespace {
const ConfFitterBuilder<ConfigurableAdaptiveFitter> t("avf",
