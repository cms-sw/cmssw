...
class GsfVertexTrackCompatibilityEstimator
    : public VertexTrackCompatibilityEstimator<5> {
...
private:
  BDpair estimateFittedTrack(const CachingVertex<5> &v,
                             const RefCountedVertexTrack track) const;
  BDpair estimateNFittedTrack(const CachingVertex<5> &v,
                              const RefCountedVertexTrack track) const;
