...
protected:
  virtual void
  resetEvent(const std::vector<reco::TransientTrack> &tracks) const {}

  virtual void
  analyseInputTracks(const std::vector<reco::TransientTrack> &tracks) const {}
  ...
  virtual void
  analyseVertexCandidates(const std::vector<TransientVertex> &vts) const {}

  virtual void
  analyseFoundVertices(const std::vector<TransientVertex> &vts) const {}
