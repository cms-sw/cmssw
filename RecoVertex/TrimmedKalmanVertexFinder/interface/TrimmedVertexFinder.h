...
public:
  ...
  TrimmedVertexFinder(const VertexFitter<5> *vf, const VertexUpdator<5> *vu,
   ...
   */
  std::vector<TransientVertex>
  vertices(std::vector<reco::TransientTrack> &remain, const reco::BeamSpot &s,
...
private:
  ...
  theWorst(const CachingVertex<5> &vtx,
