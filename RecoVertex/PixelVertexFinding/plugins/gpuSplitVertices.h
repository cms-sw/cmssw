#ifndef RecoVertex_PixelVertexFinding_plugins_gpuSplitVertices_h
#define RecoVertex_PixelVertexFinding_plugins_gpuSplitVertices_h
...
namespace gpuVertexFinder {
  ...
  __device__ __forceinline__ void splitVertices(VtxSoAView& pdata, WsSoAView& pws, float maxChi2) {
    ...
    float const* __restrict__ chi2 = data.chi2().data();
    uint32_t& nvFinal = data.nvFinal();

    int32_t const* __restrict__ nn = data.ndof().data();
...
#endif  // RecoVertex_PixelVertexFinding_plugins_gpuSplitVertices_h
