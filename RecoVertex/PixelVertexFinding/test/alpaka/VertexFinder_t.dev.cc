    ...
    void runKernels(Queue& queue) {
      ...
      for (int nav = 30; nav < 80; nav += 20) {
        ...
        for (int i = 8; i < 20; ++i) {
          ...
          {
            auto mx =
                std::minmax_element(vertices_h.view().chi2().data(), vertices_h.view().chi2().data() + vertices_h.view().nvFinal());
          ...
          {
            auto mx = std::minmax_element(vertices_h.view().wv().data(), vertices_h.view().wv().data() + vertices_h.view().nvFinal());
          ...
          {
            auto mx =
                std::minmax_element(vertices_h.view().ptv2().data(), vertices_h.view().ptv2().data() + vertices_h.view().nvFinal());
