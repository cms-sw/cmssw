...
# with command line options: ProtonMonteCarloProduction/Configuration/POMWIG_SingleDiffractiveMinusZmumu_M20_13TeV_cff.py --fileout file:step1.root --mc --eventcontent RAWSIM --runUnscheduled --datatier GEN-SIM --conditions 106X_mc2017_realistic_v6 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --nThreads 8 --geometry DB:Extended --era Run2_2017 --python_filename POMWIG_SingleDiffractiveMinusZmumu_M20_13TeV_cff_step1.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 1476
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('ProtonMonteCarloProduction/Configuration/POMWIG_SingleDiffractiveMinusZmumu_M20_13TeV_cff.py nevts:1476'),
