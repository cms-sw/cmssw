...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('GeneratorInterface/PomwigInterface/python/POMWIG_SingleDiffractivePlusZmumu_M50_13TeV_cff.py nevts:100000'),
...
process.generator = cms.EDFilter("PomwigGeneratorFilter",
    HerwigParameters = cms.PSet(
        SDInclusiveWmunu = cms.vstring(
            ...
            'MODPDF(1)  = -1      ! Set MODPDF CTEQ66', 
            'MODPDF(2)  = 10550         ! Set MODPDF'
        ),
