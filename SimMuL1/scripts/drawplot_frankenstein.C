void drawplot_frankenstein()
{
  ...
  getPTHistos("minbias_pt06_pat2",filesDir, filesDir, gem_label);
  ...
  gPad->Print(plotDir + "rates__120-214_PU100__def-3s__gem-3s-3s1b__Frankenstein_pat2" + ext);


  ((TCanvas*)gROOT->FindObject("cAll100r"))->cd();
  hh_ratio = setHistoRatio(hh_no1a, result_def_eta_no1a, "", 0.,1.1);
  hh_ratio->Draw("e1");
  gPad->Print(plotDir + "rates__120-214_PU100__def-3s__gem-3s-3s1b__Frankenstein_pat2__ratio" + ext);
  ...
  gPad->Print(plotDir + "rates__120-214_PU100__def-3s-3s1b__gem-3s-3s1b__Frankenstein_pat2" + ext);


  ((TCanvas*)gROOT->FindObject("cAll100r"))->cd();
  hh_ratio = setHistoRatio(hh_no1a, result_def_eta_no1a_3s1b, "", 0.,1.1);
  hh_ratio->Draw("e1");
  gPad->Print(plotDir + "rates__120-214_PU100__def-3s-3s1b__gem-3s-3s1b__Frankenstein_pat2__ratio" + ext);
  ...
  getPTHistos("minbias_pt06_pat8",filesDir, filesDir, gem_label);
  hh = (TH1D*)result_def_3s1b->Clone("gem_new");
  for (int b = hh->FindBin(6.01); b <= hh->GetNbinsX(); ++b) hh->SetBinContent(b, 0);
  hh_all = (TH1D*)result_def_eta_all_3s1b->Clone("gem_new_eta_all");
  for (int b = hh_all->FindBin(6.01); b <= hh_all->GetNbinsX(); ++b) hh_all->SetBinContent(b, 0);
  ...
  gPad->Print(plotDir + "rates__120-214_PU100__def-3s__gem-3s-3s1b__Frankenstein_pat8" + ext);


  ((TCanvas*)gROOT->FindObject("cAll100r"))->cd();
  hh_ratio = setHistoRatio(hh_no1a, result_def_eta_no1a, "", 0.,1.1);
  hh_ratio->Draw("e1");
  gPad->Print(plotDir + "rates__120-214_PU100__def-3s__gem-3s-3s1b__Frankenstein_pat8__ratio" + ext);
  ...
  gPad->Print(plotDir + "rates__120-214_PU100__def-3s-3s1b__gem-3s-3s1b__Frankenstein_pat8" + ext);


  ((TCanvas*)gROOT->FindObject("cAll100r"))->cd();
  hh_ratio = setHistoRatio(hh_no1a, result_def_eta_no1a_3s1b, "", 0.,1.1);
  hh_ratio->Draw("e1");
  gPad->Print(plotDir + "rates__120-214_PU100__def-3s-3s1b__gem-3s-3s1b__Frankenstein_pat8__ratio" + ext);
  ...
  */
  ...
  if (get_ptshift) { //-----
    ...
    gPad->Print(plotDir + "rates__164-214_PU100__sequential__3s_tightGEM__Frankenstein_pat2" + ext);

    ((TCanvas*)gROOT->FindObject("cAll100r"))->cd();
    hh_ratio = setHistoRatio(result_gem_3s1b__pat2__ptshift, result_gem_3s1b__pat2, "", 0.,1.1);
    hh_ratio->Draw("e1");
    gPad->Print(plotDir + "rates__164-214_PU100__sequential__3s_tightGEM__Frankenstein_pat2__ratio" + ext);
    ...
    gPad->Print(plotDir + "rates__164-214_PU100__sequential__3s_xtightGEM__Frankenstein_pat2" + ext);

    ((TCanvas*)gROOT->FindObject("cAll100r"))->cd();
    hh_ratio = setHistoRatio(result_gem_3s1b__pat2__ptshiftX, result_gem_3s1b__pat2, "", 0.,1.1);
    hh_ratio->Draw("e1");
    gPad->Print(plotDir + "rates__164-214_PU100__sequential__3s_xtightGEM__Frankenstein_pat2__ratio" + ext);
  ...
  if (get_ptshift) { //-----
    ...
    gPad->Print(plotDir + "rates__164-214_PU100__sequential__2s_tightGEM__Frankenstein_pat2" + ext);

    ((TCanvas*)gROOT->FindObject("cAll100r"))->cd();
    hh_ratio = setHistoRatio(result_gem_2s1b__pat2__ptshift, result_gem_2s1b__pat2, "", 0.,1.1);
    hh_ratio->Draw("e1");
    gPad->Print(plotDir + "rates__164-214_PU100__sequential__2s_tightGEM__Frankenstein_pat2__ratio" + ext);
    ...
    gPad->Print(plotDir + "rates__164-214_PU100__sequential__2s_xtightGEM__Frankenstein_pat2" + ext);

    ((TCanvas*)gROOT->FindObject("cAll100r"))->cd();
    hh_ratio = setHistoRatio(result_gem_2s1b__pat2__ptshiftX, result_gem_2s1b__pat2, "", 0.,1.1);
    hh_ratio->Draw("e1");
    gPad->Print(plotDir + "rates__164-214_PU100__sequential__2s_xtightGEM__Frankenstein_pat2__ratio" + ext);
  ...
  gPad->Print(plotDir + "rates__164-214_PU100__sequential__2s3s123__Frankenstein_pat2" + ext);

  ((TCanvas*)gROOT->FindObject("cAll100r"))->cd();
  hh_ratio = setHistoRatio(result_gem_2s123__pat2, result_gem_2s1b__pat2, "", 0.,1.1);
  hh_ratio->Draw("e1");
  gPad->Print(plotDir + "rates__164-214_PU100__sequential__2s3s123__Frankenstein_pat2__ratio" + ext);

  ((TCanvas*)gROOT->FindObject("cAll100r"))->cd();
  hh_ratio = setHistoRatio(result_gem_2s13__pat2, result_gem_3s1b__pat2, "", 0.,1.4);
  hh_ratio->Draw("e1");
  gPad->Print(plotDir + "rates__164-214_PU100__sequential__3s2s13__Frankenstein_pat2__ratio" + ext);
  ...
  gPad->Print(plotDir + "rates__120-214_PU100__sequential__GMT2s1b__Frankenstein_pat2" + ext);

  ((TCanvas*)gROOT->FindObject("cAll100r"))->cd();
  hh_ratio = setHistoRatio(result_gem_sing_no1a__pat2, result_def_gmtsing_no1a__pat2, "", 0.,1.1);
  hh_ratio->Draw("e1");
  gPad->Print(plotDir + "rates__120-214_PU100__sequential__GMT2s1b__Frankenstein_pat2__ratio" + ext);
