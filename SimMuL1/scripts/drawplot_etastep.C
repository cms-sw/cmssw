...
TFile *f;
char pdir[111] = "plots/efficiency/";
...
void gem_eff_draw(TString ext)
{
  ...
  TString f_def =      "files/hp_dimu_6_0_1_POSTLS161_V12__pu000_w3_def_pat2.root";
  TString f_g98_pt10 = "files/hp_dimu_6_0_1_POSTLS161_V12__pu000_w3_gem98_pt10_pat2.root";
  TString f_g98_pt15 = "files/hp_dimu_6_0_1_POSTLS161_V12__pu000_w3_gem98_pt15_pat2.root";
  TString f_g98_pt20 = "files/hp_dimu_6_0_1_POSTLS161_V12__pu000_w3_gem98_pt20_pat2.root";
  TString f_g98_pt30 = "files/hp_dimu_6_0_1_POSTLS161_V12__pu000_w3_gem98_pt30_pat2.root";
  TString f_g98_pt40 = "files/hp_dimu_6_0_1_POSTLS161_V12__pu000_w3_gem98_pt40_pat2.root";

  double rpt[2] = {0.,49.99};

  TString htitle = "Efficiency for a muon in 1.6<|#eta|<2.12 to have TF track;p_{T}^{MC} [GeV/c];Efficiency";
  ...
  */
  ...
  leg->SetNColumns(2);
  leg->SetBorderSize(0);
  //  leg->SetBorderStyle(0);
  leg->SetFillStyle(0);
  leg->SetTextSize(0.04);
  leg->SetHeader("TF track requires #geq2 stubs, one from ME1");
  ...
  leg->SetBorderSize(0);
  leg->SetFillStyle(0);
  leg->SetHeader("TF track requires #geq3 stubs, one from ME1");
  ...
  leg->AddEntry(h_eff_tf10_3s, "#geq3 stubs", "");
  leg->AddEntry(h_eff_tf10_gpt10_2s1b, "#geq2 stubs with GEM in ME1", "");
  ...
  leg->SetBorderSize(0);
  leg->SetFillStyle(0);
  leg->SetHeader("TF track requires #geq3 stubs and");
  leg->AddEntry(h_eff_tf10_3s, "p_{T}^{TF}#geq10", "l");
  leg->AddEntry(h_eff_tf20_3s, "p_{T}^{TF}#geq20", "l");
  leg->AddEntry(h_eff_tf30_3s, "p_{T}^{TF}#geq30", "l");
  leg->Draw();
  ...
  leg->SetBorderSize(0);
  leg->SetFillStyle(0);
  leg->SetHeader("TF track requires #geq3 stubs with ME1 and");
  leg->AddEntry(h_eff_tf10_3s, "p_{T}^{TF}#geq10", "l");
  leg->AddEntry(h_eff_tf20_3s, "p_{T}^{TF}#geq20", "l");
  leg->AddEntry(h_eff_tf30_3s, "p_{T}^{TF}#geq30", "l");
  leg->Draw();
  ...
  leg->SetBorderSize(0);
  leg->SetFillStyle(0);
  leg->SetHeader("TF track: p_{T}^{TF}#geq20 and #geq2 stubs");
  ...
  leg->SetBorderSize(0);
  leg->SetFillStyle(0);
  leg->SetHeader("TF track: p_{T}^{TF}#geq20 and #geq3 stubs");
...
void drawplot_etastep(char *fname, char* pu, char *dname="tf")
{
  ...
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_2s_pt10,"p_{T}^{TF}#geq10, stubs in (2+)st","pl");
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_2s_pt20,"p_{T}^{TF}#geq20, stubs in (2+)st","pl");
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_2s_pt25,"p_{T}^{TF}#geq25, stubs in (2+)st","pl");
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_2s_pt30,"p_{T}^{TF}#geq30, stubs in (2+)st","pl");
  leg1->Draw();
  ...
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_2s1b_pt10,"p_{T}^{TF}#geq10, stubs in ME1+(1+)st","pl");
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_2s1b_pt20,"p_{T}^{TF}#geq20, stubs in ME1+(1+)st","pl");
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_2s1b_pt25,"p_{T}^{TF}#geq25, stubs in ME1+(1+)st","pl");
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_2s1b_pt30,"p_{T}^{TF}#geq30, stubs in ME1+(1+)st","pl");
  leg1->Draw();
  ...
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_3s_pt10,"p_{T}^{TF}#geq10, stubs in (3+)st","pl");
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_3s_pt20,"p_{T}^{TF}#geq20, stubs in (3+)st","pl");
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_3s_pt25,"p_{T}^{TF}#geq25, stubs in (3+)st","pl");
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_3s_pt30,"p_{T}^{TF}#geq30, stubs in (3+)st","pl");
  leg1->Draw();
  ...
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_3s1b_pt10,"p_{T}^{TF}#geq10, stubs in ME1+(2+)st","pl");
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_3s1b_pt20,"p_{T}^{TF}#geq20, stubs in ME1+(2+)st","pl");
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_3s1b_pt25,"p_{T}^{TF}#geq25, stubs in ME1+(2+)st","pl");
  leg1->AddEntry(h_eff_pt_after_tfcand_eta1b_3s1b_pt30,"p_{T}^{TF}#geq30, stubs in ME1+(2+)st","pl");
  leg1->Draw();
