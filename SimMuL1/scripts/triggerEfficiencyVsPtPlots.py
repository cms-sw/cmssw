...
def setEffHisto(num_name, den_name, dir, nrebin, lcolor, lstyle, lwidth,
    ...
    hd0 = getH(dir,den_name)
    hn0 = getH(dir,num_name)
...
def getEffHisto(fname, hdir, num_name, den_name, nrebin, lcolor, lstyle, lwidth, title, x_range, y_range):
    fh = TFile.Open(fname)
