...
##kGray=920, kOrange=800, kSpring=820, kTeal=840, kAzure=860, kViolet=880, kPink=900
...
def setEffHisto(f_name, num_name, den_name, dir, nrebin, lcolor, lstyle, lwidth,
                htitle, xtitle, ytitle, x_range, y_range):
    """Set efficiency histogram"""
    hd0 = getH(f_name, dir,den_name)
    hn0 = getH(f_name, dir,num_name)
    
    hd = hd0.Clone(den_name + "_cln")
    hn = hn0.Clone(num_name + "_cln")
    hd.Sumw2()
    hn.Sumw2()
...
def drawplot_etastep(fname, pu, dname="tf"):
    ...
    interactive = 0
    if (interactive):
        c_eff_eta_simh_by_st = TCanvas("c_eff_eta_simh_by_st","c_eff_eta_simh_by_st",900,800 ) 
        c_eff_eta_simh_by_st.Divide(2,2,0.0001,0.0001)
        
        h_eta_me1_initial = setEffHisto("h_eta_me1_initial","h_eta_initial0",dir, etareb, kBlue, 1, 2, "eff(#eta): SimHits#geq4 in ME1 (MC 20<p_{T}<100)","MC #eta","",xrange,yrange)
        h_eta_me2_initial = setEffHisto("h_eta_me2_initial","h_eta_initial0",dir, etareb, kBlue, 1, 2, "eff(#eta): SimHits#geq4 in ME2 (MC 20<p_{T}<100)","MC #eta","",xrange,yrange)
        h_eta_me3_initial = setEffHisto("h_eta_me3_initial","h_eta_initial0",dir, etareb, kBlue, 1, 2, "eff(#eta): SimHits#geq4 in ME3 (MC 20<p_{T}<100)","MC #eta","",xrange,yrange)
        h_eta_me4_initial = setEffHisto("h_eta_me4_initial","h_eta_initial0",dir, etareb, kBlue, 1, 2, "eff(#eta): SimHits#geq4 in ME4 (MC 20<p_{T}<100)","MC #eta","",xrange,yrange)
        ...
        c_eff_eta_simh_by_st = TCanvas("c_eff_eta_mpc_by_st","c_eff_eta_mpc_by_st",900,800 ) 
        c_eff_eta_mpc_by_st.Divide(2,2,0.0001,0.0001)
        
        h_eta_me1_mpc = setEffHisto("h_eta_me1_mpc","h_eta_initial0",dir, etareb, kBlack, 1, 2, "","MC #eta","",xrange,yrange)
        h_eta_me2_mpc = setEffHisto("h_eta_me2_mpc","h_eta_initial0",dir, etareb, kBlack, 1, 2, "","MC #eta","",xrange,yrange)
        h_eta_me3_mpc = setEffHisto("h_eta_me3_mpc","h_eta_initial0",dir, etareb, kBlack, 1, 2, "","MC #eta","",xrange,yrange)
        h_eta_me4_mpc = setEffHisto("h_eta_me4_mpc","h_eta_initial0",dir, etareb, kBlack, 1, 2, "","MC #eta","",xrange,yrange)
    ...
    if (interactive):
        ...
        c_eff_eta_simh = TCanvas("c_eff_eta_simh","c_eff_eta_simh",1000,600 ) 
        
        h_eta_initial_1st = setEffHisto("h_eta_initial_1st","h_eta_initial0",dir, etareb, kBlue, 1, 2, "eff(#eta): SimHits#geq4 in #geqN CSC stations","MC #eta","",xrange,yrange)
        h_eta_initial_2st = setEffHisto("h_eta_initial_2st","h_eta_initial0",dir, etareb, kBlue, 9, 2, "","MC #eta","",xrange,yrange)
        h_eta_initial_3st = setEffHisto("h_eta_initial_3st","h_eta_initial0",dir, etareb, kBlue, 2, 2, "","MC #eta","",xrange,yrange)
        
        h_eta_initial_1st.Draw("hist")
        h_eta_initial_2st.Draw("hist same")
        h_eta_initial_3st.Draw("hist same")
        
        l_eff_eta_simh = TLegend(0.347,0.222,0.926,0.535,"","brNDC")
        ...
        c_eff_eta_mpc = TCanvas("c_eff_eta_mpc","c_eff_eta_mpc",1000,600 ) 
        ...
        c_eff_eta_mpc_relative = TCanvas("c_eff_eta_mpc_relative","c_eff_eta_mpc_relative",1000,600 ) 
        ...
        h_eta_mpc_2st_r = setEffHisto("h_eta_mpc_2st","h_eta_initial_2st",dir, etareb, kBlue, 9, 2, "","MC #eta","",xrange,yrange)
        h_eta_mpc_3st_r = setEffHisto("h_eta_mpc_3st","h_eta_initial_3st",dir, etareb, kBlue, 2, 2, "","MC #eta","",xrange,yrange)
    ...
    ##################################################################################################
    if (interactive):
        c_eff_eta_simh_me1 = TCanvas("c_eff_eta_simh_me1","c_eff_eta_simh_me1",1000,600 ) 
        ...
        h_eta_me1_initial_2st = setEffHisto("h_eta_me1_initial_2st","h_eta_initial0",dir, etareb, kBlue, 9, 2, "","MC #eta","",xrange,yrange)
        h_eta_me1_initial_3st = setEffHisto("h_eta_me1_initial_3st","h_eta_initial0",dir, etareb, kBlue, 2, 2, "","MC #eta","",xrange,yrange)
    ...
    if (interactive):
        c_eff_eta_me1_stubs = TCanvas("c_eff_eta_me1_stubs","c_eff_eta_me1_stubs",1000,600 ) 
    ...
    if interactive:
        c_eff_eta_me1_tf = TCanvas("c_eff_eta_me1_tf","c_eff_eta_me1_tf",1000,600 ) 
        ...
        c_eff_eta_tf = TCanvas("c_eff_eta_tf","c_eff_eta_tf",1000,600 ) 
        ...
        c_eff_eta_tf_3st1a = TCanvas("c_eff_eta_tf_3st1a","c_eff_eta_tf_3st1a",1000,600 ) 
        ...
        c_eff_eta_tf_q = TCanvas("c_eff_eta_tf_q","c_eff_eta_tf_q",1000,600 ) 
    ...
    """
    h_eff_eta_steps_full10 = 0
    if (h_eff_eta_steps_full10):
        
        c22x10 = TCanvas("h_eff_eta_steps_full10","h_eff_eta_steps_full10",1000,600 ) 
    ...
    c22x10tf = TCanvas("h_eff_eta_steps_full10tf","h_eff_eta_steps_full10tf",1000,600 ) 
    ...
    cme1na = TCanvas("h_eff_eta_me1_after_alct","h_eff_eta_me1_after_alct",1000,600 ) 
    ...
    cme1nc = TCanvas("h_eff_eta_me1_after_clct","h_eff_eta_me1_after_clct",1000,600 ) 
    ...
    cme1nc = TCanvas("h_eff_eta_me1_after_alctt","h_eff_eta_me1_after_alctt",1000,600 ) 
    ...
    """
    h_wg_me11_initial = getH(dir,"h_wg_me11_initial")
    h_wg_me11_after_alct_okAlct = getH(dir,"h_wg_me11_after_alct_okAlct")
    ...
    h_eff_wg_me11_after_alct_okAlct =  h_wg_me11_after_alct_okAlct.Clone("h_eff_wg_me11_after_alct_okAlct")
    h_eff_wg_me11_after_alctclct_okAlctClct =  h_wg_me11_after_alctclct_okAlctClct.Clone("h_eff_wg_me11_after_alctclct_okAlctClct")
    h_eff_wg_me11_after_lct_okAlctClct =  h_wg_me11_after_lct_okAlctClct.Clone("h_eff_wg_me11_after_lct_okAlctClct")
    ...
    cme11wgv= TCanvas("h_eff_wg_me11_after_alct","h_eff_wg_me11_after_alct",1000,600 ) 
...
#_______________________________________________________________________________
def simTrackToAlctMatchingEfficiencyVsEta(input_dir, file_name, output_dir, ext):
    ...
    h_eta_initial = dir.Get("h_eta_initial")
    h_eta_me1_after_alct = dir.Get("h_eta_me1_after_alct")
    h_eta_me1_after_alct_okAlct = dir.Get("h_eta_me1_after_alct_okAlct")
    ...
    h_eff_eta_me1_after_alct = setEffHisto(file, "h_eta_me1_after_alct","h_eta_initial",dir_name, etareb, kBlue+1, 2, 2, title,xTitle,yTitle,xrange,yrange)
    h_eff_eta_me1_after_alct_okAlct = setEffHisto(file, "h_eta_me1_after_alct_okAlct","h_eta_initial",dir_name, etareb, kBlue+1, 1, 2, "","","",xrange,yrange)
    ...
    leg.AddEntry(h_eff_eta_me1_after_alct_okAlct,"correct ALCT","pl")
    leg.Draw()
    c.Print("%ssimTrackToAlctMatchingEfficiencyVsEta%s"%(output_dir, ext))


#_______________________________________________________________________________
def simTrackToClctMatchingEfficiencyVsEta(input_dir, file_name, output_dir, ext):
    ...
    h_eta_initial = dir.Get("h_eta_initial")
    h_eta_me1_after_clct = dir.Get("h_eta_me1_after_clct")
    h_eta_me1_after_clct_okClct = dir.Get("h_eta_me1_after_clct_okClct")
    ...
    h_eff_eta_me1_after_clct = setEffHisto(file, "h_eta_me1_after_clct","h_eta_initial",dir_name, etareb, kBlue+1, 2, 2, title,xTitle,yTitle,xrange,yrange)
    h_eff_eta_me1_after_clct_okClct = setEffHisto(file, "h_eta_me1_after_clct_okClct","h_eta_initial",dir_name, etareb, kBlue+1, 1, 2, "","","",xrange,yrange)
    ...
    leg.AddEntry(h_eff_eta_me1_after_clct_okClct,"correct CLCT","pl")
    leg.Draw()
    c.Print("%ssimTrackToClctMatchingEfficiencyVsEta%s"%(output_dir, ext))


#_______________________________________________________________________________
def simTrackToLctMatchingEfficiencyVsEta(input_dir, file_name, output_dir, ext):
    ...
    h_eta_initial = dir.Get("h_eta_initial")
    h_eta_me1_after_lct = dir.Get("h_eta_me1_after_lct")
    h_eta_me1_after_lct_okAlct = dir.Get("h_eta_me1_after_lct_okAlct")
    h_eta_me1_after_lct_okClct = dir.Get("h_eta_me1_after_lct_okClct")
    h_eta_me1_after_lct_okAlctClct = dir.Get("h_eta_me1_after_lct_okAlctClct")
    h_eta_me1_after_lct_okClctAlct = dir.Get("h_eta_me1_after_lct_okClctAlct")
    ...
    h_eff_eta_me1_after_lct = setEffHisto(file, "h_eta_me1_after_lct","h_eta_initial",dir_name, etareb, kRed, 2, 2, topTitle,xTitle,yTitle,xrange,yrange)
    h_eff_eta_me1_after_lct_okAlct = setEffHisto(file, "h_eta_me1_after_lct_okAlct","h_eta_initial",dir_name, etareb, kRed+1, 2, 2, "eff(#eta): ME1 stub studies","#eta","",xrange,yrange)
    h_eff_eta_me1_after_lct_okClct = setEffHisto(file, "h_eta_me1_after_lct_okClct","h_eta_initial",dir_name, etareb, kRed+2, 2, 2, "eff(#eta): ME1 stub studies","#eta","",xrange,yrange)
    h_eff_eta_me1_after_lct_okAlctClct = setEffHisto(file, "h_eta_me1_after_lct_okAlctClct","h_eta_initial",dir_name, etareb, kRed+3, 2, 2, "eff(#eta): ME1 stub studies","#eta","",xrange,yrange)
    h_eff_eta_me1_after_lct_okClctAlct = setEffHisto(file, "h_eta_me1_after_lct_okClctAlct","h_eta_initial",dir_name, etareb, kRed+4, 1,2, "","","",xrange,yrange)
...
def simTrackToLctMatchingEfficiencyVsEta(input_dir, file_name, output_dir, ext):
    ...
    h_eff_eta_me1_after_lct = setEffHisto(file, "h_eta_me1_after_lct","h_eta_initial",dir_name, etareb, kRed, 2, 2, "eff(#eta): ME1 stub studies","#eta","",xrange,yrange)
    h_eff_eta_me1_after_lct_okAlct = setEffHisto(file, "h_eta_me1_after_lct_okAlct","h_eta_initial",dir_name, etareb, kPink+2, 2, 2, "eff(#eta): ME1 stub studies","#eta","",xrange,yrange)
    h_eff_eta_me1_after_lct_okClct = setEffHisto(file, "h_eta_me1_after_lct_okClct","h_eta_initial",dir_name, etareb, kBlue, 2, 2, "eff(#eta): ME1 stub studies","#eta","",xrange,yrange)
    h_eff_eta_me1_after_lct_okAlctClct = setEffHisto(file, "h_eta_me1_after_lct_okAlctClct","h_eta_initial",dir_name, etareb, kOrange+2, 2, 2, "eff(#eta): ME1 stub studies","#eta","",xrange,yrange)
    h_eff_eta_me1_after_lct_okClctAlct = setEffHisto(file, "h_eta_me1_after_lct_okClctAlct","h_eta_initial",dir_name, etareb, kGreen+2, 1,2, "","","",xrange,yrange)
    ...
    leg = TLegend(0.5,0.6,0.926,0.9,"","brNDC")
    leg.SetBorderSize(0)
    leg.SetFillStyle(0)
...
#    leg.SetNColumns(2)
    ...
    leg.AddEntry(h_eff_eta_me1_after_lct,"any LCT","pl")
    leg.AddEntry(h_eff_eta_me1_after_lct_okAlct,"LCT with correct ALCT","pl")
    leg.AddEntry(h_eff_eta_me1_after_lct_okClct,"LCT with correct CLCT","pl")
    leg.AddEntry(h_eff_eta_me1_after_lct_okAlctClct,"LCT with correct ALCT and CLCT (ALCT-to-CLCT matching)","pl")
    leg.AddEntry(h_eff_eta_me1_after_lct_okClctAlct,"LCT with correct ALCT and CLCT (CLCT-to-ALCT matching)","pl")
    leg.Draw()

    c.Print("%ssimTrackToLctMatchingEfficiencyVsEta%s"%(output_dir, ext))

#_______________________________________________________________________________
def simTrackToAlctMatchingEfficiencyVsPhi(input_dir, file_name, output_dir, ext):
    dir_name = "GEMCSCTriggerEfficiency"
    file = TFile.Open(input_dir + file_name)
    if not file:
        sys.exit('Input ROOT file %s is missing.' %(file_name))
    ...
    h_phi_initial = dir.Get("h_phi_initial")
    h_phi_me1_after_alct = dir.Get("h_phi_me1_after_alct")
    h_phi_me1_after_alct_okAlct = dir.Get("h_phi_me1_after_alct_okAlct")
    h_phi_me1_after_clct = dir.Get("h_phi_me1_after_clct")
    h_phi_me1_after_clct_okClct = dir.Get("h_phi_me1_after_clct_okClct")
    h_phi_me1_after_lct = dir.Get("h_phi_me1_after_lct")
    h_phi_me1_after_lct_okAlctClct = dir.Get("h_phi_me1_after_lct_okAlctClct")
#    h_phi_after_mplct = dir.Get("h_phi_after_mplct")

    etareb = 1
    yrange = [0.6,1.2]
    xrange = [-3.14,3.14]    

    h_eff_phi_me1_after_alct = setEffHisto(file, "h_phi_me1_after_alct","h_phi_initial",dir_name, etareb, kRed, 0, 2, "eff(#phi): ME1 stub studies","#phi","",xrange,yrange)
    h_eff_phi_me1_after_alct_okAlct = setEffHisto(file, "h_phi_me1_after_alct_okAlct","h_phi_initial",dir_name, etareb, kRed+2, 0, 2, "eff(#phi): ME1 stub studies","#phi","",xrange,yrange)
    h_eff_phi_me1_after_clct = setEffHisto(file, "h_phi_me1_after_clct","h_phi_initial",dir_name, etareb, kBlue, 0, 2, "eff(#phi): ME1 stub studies","#phi","",xrange,yrange)
    h_eff_phi_me1_after_clct_okClct = setEffHisto(file, "h_phi_me1_after_clct_okClct","h_phi_initial",dir_name, etareb, kBlue+4, 0, 2, "eff(#phi): ME1 stub studies","#phi","",xrange,yrange)
    h_eff_phi_me1_after_lct = setEffHisto(file, "h_phi_me1_after_lct","h_phi_initial",dir_name, etareb, kGreen+1, 0, 2, "eff(#phi): ME1 stub studies","#phi","",xrange,yrange)
    h_eff_phi_me1_after_lct_okAlctClct = setEffHisto(file, "h_phi_me1_after_lct_okAlctClct","h_phi_initial",dir_name, etareb, kOrange, 0, 2, "eff(#phi): ME1 stub studies","#phi","",xrange,yrange)
#    h_eff_phi_after_mplct = setEffHisto(file, "h_phi_me1_after_mplct","h_phi_initial",dir_name, etareb, kGreen+2, 2, 2, "eff(#phi): ME1 stub studies","#phi","",xrange,yrange)
 ...
 #    h_eff_phi_me1_after_mplct.Draw("same hist")
    ...
    c.Print("%ssimTrackToALctMatchingEfficiencyVsPhi%s"%(output_dir, ext))

    
#_______________________________________________________________________________
def simTrackToClctMatchingEfficiencyVsPhi(input_dir, file_name, output_dir, ext):
    pass

#_______________________________________________________________________________
def simTrackToLctMatchingEfficiencyVsPhi(input_dir, file_name, output_dir, ext):
    pass

#_______________________________________________________________________________
def simTrackToMpcLctMatchingEfficiencyVsEta(input_dir, file_name, output_dir, ext):
    pass
...
#    gem_eff_draw_gem1b(input_dir, file_name, output_dir, ext)
    #gem_eff_draw()    
    simTrackToAlctMatchingEfficiencyVsEta(input_dir, file_name, output_dir, ext)
    simTrackToClctMatchingEfficiencyVsEta(input_dir, file_name, output_dir, ext)
    simTrackToLctMatchingEfficiencyVsEta(input_dir, file_name, output_dir, ext)

    simTrackToAlctMatchingEfficiencyVsPhi(input_dir, file_name, output_dir, ext)
    simTrackToClctMatchingEfficiencyVsPhi(input_dir, file_name, output_dir, ext)
    simTrackToLctMatchingEfficiencyVsPhi(input_dir, file_name, output_dir, ext)
