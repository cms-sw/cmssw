...
# with command line options: step3 --conditions auto:phase2_realistic -n 10 --era Phase2_timing_layer_new --eventcontent FEVTDEBUGHLT,MINIAODSIM,DQM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,RECOSIM,PAT,VALIDATION:@phase2Validation+@miniAODValidation,DQM:@phase2+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --geometry Extended2023D24 --no_exec --filein file:step2.root --fileout file:step3.root
...
#add in the MTD track extender
process.load('RecoMTD.TrackExtender.trackExtender_cfi')

process.FEVTDEBUGHLToutput.outputCommands.append('keep *_trackExtender_*_*')

# Path and EndPath definitions
process.raw2digi_step = cms.Path(process.RawToDigi)
process.L1Reco_step = cms.Path(process.L1Reco)
process.reconstruction_step = cms.Path(process.reconstruction+process.trackExtender)
