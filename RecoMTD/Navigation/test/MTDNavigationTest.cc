...
MTDNavigationTest::~MTDNavigationTest() { std::cout << "Muon Navigation Printer End. " << std::endl; }

void MTDNavigationTest::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;
