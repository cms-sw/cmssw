...
struct CaloTauSelectorDefinition {
  ...
  CaloTauSelectorDefinition ( const edm::ParameterSet & cfg, edm::ConsumesCollector && iC ) {
    ...
    discriminatorTokens_ = edm::vector_transform( discriminators_, [&](edm::ParameterSet const & pSet){return iC.consumes<reco::CaloTauDiscriminator>(pSet.getParameter<edm::InputTag>("discriminator"));} );
