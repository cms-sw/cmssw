...
class TauElementsOperators{
 public:
  ...
  const reco::TrackRefVector tracksInCone(const math::XYZVector& coneAxis,std::string coneMetric,double coneSize,double ptTrackMin)const;
  const reco::TrackRefVector tracksInCone(const math::XYZVector& coneAxis,std::string coneMetric,double coneSize,double ptTrackMin,double tracktorefpoint_maxDZ,double refpoint_Z, const reco::Vertex &myPV)const;
  ...
  const reco::TrackRefVector tracksInAnnulus(const math::XYZVector& coneAxis,std::string innerconeMetric,double innerconeSize,std::string outerconeMetric,double outerconeSize,double ptTrackMin)const;  
  const reco::TrackRefVector tracksInAnnulus(const math::XYZVector& coneAxis,std::string innerconeMetric,double innerconeSize,std::string outerconeMetric,double outerconeSize,double ptTrackMin,double tracktorefpoint_maxDZ,double refpoint_Z, const reco::Vertex &myPV)const;  
