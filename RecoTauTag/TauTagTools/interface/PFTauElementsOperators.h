#ifndef _PFTauElementsOperators_H_
#define _PFTauElementsOperators_H_
...
class PFTauElementsOperators{
 public:
  PFTauElementsOperators(TauRef& theTauRef):AreaMetric_recoElements_maxabsEta_(2.5){  
    PFJetRef_=(*theTauRef).getpfjetRef();
    PFCands_=(*theTauRef).getSelectedPFCands();
    PFChargedHadrCands_=(*theTauRef).getSelectedPFChargedHadrCands();
    PFNeutrHadrCands_=(*theTauRef).getSelectedPFNeutrHadrCands();
    PFGammaCands_=(*theTauRef).getSelectedPFGammaCands();
  }
