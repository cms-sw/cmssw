...
class CaloTauElementsOperators : public TauElementsOperators {
 public:
  ...
  std::vector<std::pair<math::XYZPoint,float> > EcalRecHitsInCone(const math::XYZVector& coneAxis,std::string coneMetric,double coneSize,double EcalRecHit_minEt,const std::vector<std::pair<math::XYZPoint,float> >& myEcalRecHits)const;
  ...
  std::vector<std::pair<math::XYZPoint,float> > EcalRecHitsInAnnulus(const math::XYZVector& coneAxis,std::string innerconeMetric,double innerconeSize,std::string outerconeMetric,double outerconeSize,double EcalRecHit_minEt,const std::vector<std::pair<math::XYZPoint,float> >& myEcalRecHits)const;

  // These function kept for out-of-box compatability with 2_2_X
  std::vector<std::pair<math::XYZPoint,float> > EcalRecHitsInCone(const math::XYZVector& coneAxis,std::string coneMetric,double coneSize,double EcalRecHit_minEt)const;
  std::vector<std::pair<math::XYZPoint,float> > EcalRecHitsInAnnulus(const math::XYZVector& coneAxis,std::string innerconeMetric,double innerconeSize,std::string outerconeMetric,double outerconeSize,double EcalRecHit_minEt)const; 

  // return all neutral Ecal BasicClusters in a cone of metric* "coneMetric" and size "coneSize" around a direction "coneAxis" 
  std::vector<std::pair<math::XYZPoint,float> > neutralEcalBasicClustersInCone(const math::XYZVector& coneAxis,std::string coneMetric,double coneSize,double neutralEcalBasicCluster_minEt)const;
  ...
  std::vector<std::pair<math::XYZPoint,float> > neutralEcalBasicClustersInAnnulus(const math::XYZVector& coneAxis,std::string innerconeMetric,double innerconeSize,std::string outerconeMetric,double outerconeSize,double neutralEcalBasicCluster_minEt)const; 
