...
<<<<<<< HEAD:RecoTauTag/HLTProducers/src/HLTPFDiJetCorrCheckerWithDiTau.cc
// user include files
...
>>>>>>> 895df58e36cff1d7dc27b1bf37aee7f604adc704:RecoTauTag/HLTProducers/src/HLTDiPFJetPlusTausCandidatePFJetProducer.cc
