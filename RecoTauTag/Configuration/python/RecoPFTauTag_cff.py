...
PFTau = cms.Sequence(cms.SequencePlaceholder("iterativeCone5PFJets")*ic5PFJetTracksAssociatorAtVertex*pfRecoTauTagInfoProducer*pfRecoTauProducer*pfRecoTauProducerHighEfficiency*pfRecoTauDiscriminationByIsolation*pfRecoTauDiscriminationHighEfficiency)
