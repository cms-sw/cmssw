...
LorentzVectorParticle TrackTools::lorentzParticleAtPosition(const TrackParticle& p, const TVector3& v) {
  TVectorT<double> FreePar(TrackHelixVertexFitter::NFreeTrackPar + TrackHelixVertexFitter::NExtraPar +
                           TrackHelixVertexFitter::MassOffSet);
  TMatrixTSym<double> FreeParCov(TrackHelixVertexFitter::NFreeTrackPar + TrackHelixVertexFitter::NExtraPar +
                                 TrackHelixVertexFitter::MassOffSet);
