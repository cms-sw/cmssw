...
namespace tauImpactParameter {
  ...
  public:
    ...
    static void analyticESolver(TLorentzVector& nu_plus,
                                TLorentzVector& nu_minus,
                                const TLorentzVector& A1,
                                bool& isReal);
    static void numericalESolver(TLorentzVector& nu_plus,
                                 TLorentzVector& nu_minus,
                                 const TLorentzVector& A1,
                                 bool& isReal);
    static void solveByRotation(const TVector3& TauDir,
                                const TLorentzVector& A1,
    ...
    static LorentzVectorParticle estimateNu(const LorentzVectorParticle& a1,
                                            const TVector3& pv,
                                            int ambiguity,
                                            TLorentzVector& tau);
