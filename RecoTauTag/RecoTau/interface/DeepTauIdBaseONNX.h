#ifndef DeepTauIdBaseONNX_H
#define DeepTauIdBaseONNX_H

/*
 * \class DeepTauIdBaseONNX
 *
 * Base class for DeepTauId producers: DeepTauIdONNX and DeepTauIdSONIC
 *
 */
...
class DeepTauIdBaseONNX : public Producer {
public:
...
public:
  DeepTauIdBaseONNX(const edm::ParameterSet& cfg)
      : Producer(cfg),
...
protected:
  ...
  void createTauBlockInputs(const TauCastType& tau,
    ...
    const auto& get = [&](int var_index) -> float& { return *(tauBlockInputs + tauInputs_indices_.at(var_index)); };
  ...
  void createEgammaBlockInputs(unsigned idx,
    ...
    const auto& get = [&](int var_index) -> float& { return *(egammaBlockInputs + var_index); };
  ...
  void createMuonBlockInputs(unsigned idx,
    ...
    const auto& get = [&](int var_index) -> float& { return *(muonBlockInputs + var_index); };
  ...
  void createHadronsBlockInputs(unsigned idx,
    ...
    const auto& get = [&](int var_index) -> float& { return *(hadronBlockInputs + var_index); };
