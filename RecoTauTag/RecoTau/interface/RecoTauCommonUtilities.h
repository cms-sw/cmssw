...
namespace reco {
  ...
  namespace tau {
    ...
    /// Given a range over a container of type C, return a new 'end' iterator such that only
    /// <N> elements are taken.  If there are less than N elements in the array, leave the <end>
    /// as it is
    ...
    template<typename InputIterator>
      ...
      {
        return sumPFVector(begin, end, &PFCandidate::p4, reco::Candidate::LorentzVector());
      }
