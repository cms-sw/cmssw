...
void AntiElectronIDMVA3GBR::Initialize_from_file(const std::string& methodName,
...
double AntiElectronIDMVA3GBR::MVAValue(Float_t TauEtaAtEcalEntrance,
				    Float_t TauPt,
...
double AntiElectronIDMVA3GBR::MVAValue(const reco::PFTau& thePFTau,
...
double
AntiElectronIDMVA3GBR::minimum(double a,double b){
...
double
AntiElectronIDMVA3GBR:: dCrackPhi(double phi, double eta){
...
//compute the unsigned distance to the closest phi-crack in the barrel
double
AntiElectronIDMVA3GBR:: dCrackEta(double eta){
