...
{
  // Get the discriminator result for this tau
  // N.B. result is negated!  lower = more "tau like"!
...
DEFINE_EDM_PLUGIN(RecoTauCleanerPluginFactory, reco::tau::RecoTauDiscriminantCleanerPlugin, "RecoTauDiscriminantCleanerPlugin");
