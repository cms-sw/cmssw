...
class CaloRecoTauDiscriminationByCharge : public CaloTauDiscriminationProducerBase  {
   public:
      explicit CaloRecoTauDiscriminationByCharge(const ParameterSet& iConfig):CaloTauDiscriminationProducerBase(iConfig){   
...
double CaloRecoTauDiscriminationByCharge::discriminate(const CaloTauRef& theTauRef)
{
