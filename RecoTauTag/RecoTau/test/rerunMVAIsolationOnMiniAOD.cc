	...
	if(additionalCollectionsAvailable_)
	{
		...
		for(unsigned iPFTau = 0; iPFTau < pfTaus->size(); iPFTau++)
		{
			...
			for(unsigned iTau = 0; iTau < unmatchedTaus.size(); iTau++)
			{
				...
				nPhoton->Fill((float)reco::tau::mva::tau_n_photons_total(*pfTau),(float)reco::tau::mva::tau_n_photons_total(*unmatchedTaus.at(iTau)));
				ptWeightedDetaStrip->Fill(reco::tau::mva::tau_pt_weighted_deta_strip(*pfTau, pfTau->decayMode()),reco::tau::mva::tau_pt_weighted_deta_strip(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode()));
				ptWeightedDphiStrip->Fill(reco::tau::mva::tau_pt_weighted_dphi_strip(*pfTau, pfTau->decayMode()),reco::tau::mva::tau_pt_weighted_dphi_strip(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode()));
				ptWeightedDrSignal->Fill(reco::tau::mva::tau_pt_weighted_dr_signal(*pfTau, pfTau->decayMode()),reco::tau::mva::tau_pt_weighted_dr_signal(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode()));
				ptWeightedDrIsolation->Fill(reco::tau::mva::tau_pt_weighted_dr_iso(*pfTau, pfTau->decayMode()),reco::tau::mva::tau_pt_weighted_dr_iso(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode()));
				leadTrackChi2->Fill(reco::tau::mva::tau_leadTrackChi2(*pfTau),unmatchedTaus.at(iTau)->leadingTrackNormChi2());
				eRatio->Fill(reco::tau::mva::tau_Eratio(*pfTau),reco::tau::mva::tau_Eratio(*unmatchedTaus.at(iTau)));
				...
				if((float)reco::tau::mva::tau_n_photons_total(*pfTau) != (float)reco::tau::mva::tau_n_photons_total(*unmatchedTaus.at(iTau))){
					if(verbosity_) std::cout << "nPhoton PF: = " << (float)reco::tau::mva::tau_n_photons_total(*pfTau) << ", pat = " << (float)reco::tau::mva::tau_n_photons_total(*unmatchedTaus.at(iTau)) << std::endl;
					differences->Fill(17);
					differencesWeighted->Fill(17,std::abs((float)reco::tau::mva::tau_n_photons_total(*pfTau)-(float)reco::tau::mva::tau_n_photons_total(*unmatchedTaus.at(iTau))));
				}
				if(reco::tau::mva::tau_pt_weighted_deta_strip(*pfTau, pfTau->decayMode()) != reco::tau::mva::tau_pt_weighted_deta_strip(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode())){
					if(verbosity_) std::cout << "ptWeightedDetaStrip: PF = " << reco::tau::mva::tau_pt_weighted_deta_strip(*pfTau, pfTau->decayMode()) << ", pat = " << reco::tau::mva::tau_pt_weighted_deta_strip(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode()) << std::endl;
					differences->Fill(18);
					differencesWeighted->Fill(18,std::abs(reco::tau::mva::tau_pt_weighted_deta_strip(*pfTau, pfTau->decayMode())-reco::tau::mva::tau_pt_weighted_deta_strip(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode())));
					difference_ptWeightedDetaStrip->Fill(std::abs(reco::tau::mva::tau_pt_weighted_deta_strip(*pfTau, pfTau->decayMode())-reco::tau::mva::tau_pt_weighted_deta_strip(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode())));
				}
				if(reco::tau::mva::tau_pt_weighted_dphi_strip(*pfTau, pfTau->decayMode()) != reco::tau::mva::tau_pt_weighted_dphi_strip(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode())){
					if(verbosity_) std::cout << "ptWeightedDphiStrip: PF = " << reco::tau::mva::tau_pt_weighted_dphi_strip(*pfTau, pfTau->decayMode()) << ", pat = " << reco::tau::mva::tau_pt_weighted_dphi_strip(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode()) << std::endl;
					differences->Fill(19);
					differencesWeighted->Fill(19,std::abs(reco::tau::mva::tau_pt_weighted_dphi_strip(*pfTau, pfTau->decayMode())-reco::tau::mva::tau_pt_weighted_dphi_strip(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode())));
					difference_ptWeightedDphiStrip->Fill(std::abs(reco::tau::mva::tau_pt_weighted_dphi_strip(*pfTau, pfTau->decayMode())-reco::tau::mva::tau_pt_weighted_dphi_strip(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode())));
				}
				if(reco::tau::mva::tau_pt_weighted_dr_signal(*pfTau, pfTau->decayMode()) != reco::tau::mva::tau_pt_weighted_dr_signal(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode())){
					if(verbosity_) std::cout << "ptWeightedDrSignal: PF = " << reco::tau::mva::tau_pt_weighted_dr_signal(*pfTau, pfTau->decayMode()) << ", pat = " << reco::tau::mva::tau_pt_weighted_dr_signal(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode()) << std::endl;
					differences->Fill(20);
					differencesWeighted->Fill(20,std::abs(reco::tau::mva::tau_pt_weighted_dr_signal(*pfTau, pfTau->decayMode())-reco::tau::mva::tau_pt_weighted_dr_signal(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode())));
					difference_ptWeightedDrSignal->Fill(std::abs(reco::tau::mva::tau_pt_weighted_dr_signal(*pfTau, pfTau->decayMode())-reco::tau::mva::tau_pt_weighted_dr_signal(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode())));
				}
				if(reco::tau::mva::tau_pt_weighted_dr_iso(*pfTau, pfTau->decayMode()) != reco::tau::mva::tau_pt_weighted_dr_iso(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode())){
					if(verbosity_) std::cout << "ptWeightedDrIso: PF = " << reco::tau::mva::tau_pt_weighted_dr_iso(*pfTau, pfTau->decayMode()) << ", pat = " << reco::tau::mva::tau_pt_weighted_dr_iso(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode()) << std::endl;
					differences->Fill(21);
					differencesWeighted->Fill(21,std::abs(reco::tau::mva::tau_pt_weighted_dr_iso(*pfTau, pfTau->decayMode())-reco::tau::mva::tau_pt_weighted_dr_iso(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode())));
					difference_ptWeightedDrIso->Fill(std::abs(reco::tau::mva::tau_pt_weighted_dr_iso(*pfTau, pfTau->decayMode())-reco::tau::mva::tau_pt_weighted_dr_iso(*unmatchedTaus.at(iTau),unmatchedTaus.at(iTau)->decayMode())));
				}
				if(reco::tau::mva::tau_leadTrackChi2(*pfTau) != unmatchedTaus.at(iTau)->leadingTrackNormChi2()){
					if(verbosity_) std::cout << "leadTrackChi2: PF = " << reco::tau::mva::tau_leadTrackChi2(*pfTau) << ", pat = " << unmatchedTaus.at(iTau)->leadingTrackNormChi2() << std::endl;
					differences->Fill(22);
					differencesWeighted->Fill(22,std::abs(reco::tau::mva::tau_leadTrackChi2(*pfTau)-unmatchedTaus.at(iTau)->leadingTrackNormChi2()));
				}
				if(reco::tau::mva::tau_Eratio(*pfTau) != reco::tau::mva::tau_Eratio(*unmatchedTaus.at(iTau))){
					if(verbosity_) std::cout << "eRatio: PF = " << reco::tau::mva::tau_Eratio(*pfTau) << ", pat = " << reco::tau::mva::tau_Eratio(*unmatchedTaus.at(iTau)) << std::endl;
					differences->Fill(23);
					differencesWeighted->Fill(23,std::abs(reco::tau::mva::tau_Eratio(*pfTau)-reco::tau::mva::tau_Eratio(*unmatchedTaus.at(iTau))));
				}
				if(verbosity_) std::cout << "=============================================================" << std::endl;
			}
		}
