...
void FWMuonRhoPhiProxyBuilder::setItem(const FWEventItem* iItem) {
...
REGISTER_FWPROXYBUILDER(FWMuonRhoPhiProxyBuilder,
                        reco::Muon,
                        "Muons",
                        FWViewType::kRhoPhiBit | FWViewType::kRhoPhiPFBit);
