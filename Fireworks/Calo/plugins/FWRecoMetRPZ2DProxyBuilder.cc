...
class FWRecoMetRPZ2DProxyBuilder : public FWRPZ2DDataProxyBuilder
{
public:
...
//
void
FWRecoMetRPZ2DProxyBuilder::buildRhoPhi(const FWEventItem* iItem,
                                    TEveElementList** product)
{
...
void
FWRecoMetRPZ2DProxyBuilder::buildRhoZ(const FWEventItem* iItem,
                                  TEveElementList** product)
{
   TEveElementList* tList = *product;
   if(0 == tList) {
...
REGISTER_FWRPZDATAPROXYBUILDERBASE(FWRecoMetRPZ2DProxyBuilder,reco::METCollection,"recoMET");
