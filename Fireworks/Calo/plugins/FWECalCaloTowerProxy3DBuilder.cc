// -*- C++ -*-
// $Id: FWECalCaloTowerProxy3DBuilder.cc,v 1.1 2009/01/12 03:53:06  chrjones Exp $
//
...
class FWECalCaloTowerProxy3DBuilder : public FWRPZDataProxyBuilder
{

public:
   FWECalCaloTowerProxy3DBuilder():m_hist(0), m_sliceIndex(-1), m_handleEcal(true), m_towers(0) { setHighPriority( true ); }
...
TEveCaloDataHist* FWECalCaloTowerProxy3DBuilder::m_data = 0;

void FWECalCaloTowerProxy3DBuilder::build(const FWEventItem* iItem, TEveElementList** product)
{
   /*
     TH2F* hist = 0;
...
std::string
FWECalCaloTowerProxy3DBuilder::histName() const
{
   return "ecal3D";
}

void
FWECalCaloTowerProxy3DBuilder::itemBeingDestroyedImp(const FWEventItem* iItem)
{
...
void
FWECalCaloTowerProxy3DBuilder::modelChanges(const FWModelIds& iIds,
                                          TEveElement* iElements )
{
...
void
FWECalCaloTowerProxy3DBuilder::applyChangesToAllModels(TEveElement* iElements)
{
...
// -------------------------------
// classFWHCalCaloTowerProxy3DBuilder
// ------------------------------
class FWHCalCaloTowerProxy3DBuilder : public FWECalCaloTowerProxy3DBuilder
{

public:
   FWHCalCaloTowerProxy3DBuilder() { handleHcal(); }
   virtual ~FWHCalCaloTowerProxy3DBuilder() {}

   // ---------- const member functions ---------------------
   virtual std::string histName() const { return "hcal3D"; }
