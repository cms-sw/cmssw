...
// $Id: FWPFTauProxyBuilder.cc,v 1.3 2010/04/16 10:59:50 amraktad Exp $
//
...
REGISTER_FWPROXYBUILDER(FWPFTauProxyBuilder, reco::PFTau, "PFTau", FWViewType::kAll3DBits | FWViewType::kRhoPhiBit  | FWViewType::kRhoZBit);
