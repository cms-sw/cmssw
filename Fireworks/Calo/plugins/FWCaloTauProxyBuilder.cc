...
// $Id: FWCaloTauProxyBuilder.cc,v 1.3 2010/04/16 10:59:50 amraktad Exp $
//
...
REGISTER_FWPROXYBUILDER(FWCaloTauProxyBuilder, reco::CaloTau, "CaloTau", FWViewType::kAll3DBits | FWViewType::kRhoPhiBit  | FWViewType::kRhoZBit);
