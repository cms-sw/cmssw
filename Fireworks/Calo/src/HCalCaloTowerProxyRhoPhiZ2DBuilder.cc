...
// $Id: HCalCaloTowerProxyRhoPhiZ2DBuilder.cc,v 1.10 2008/11/06 22:05:21 amraktad Exp $
//
...
//
REGISTER_FWRPZDATAPROXYBUILDERBASE(HCalCaloTowerProxyRhoPhiZ2DBuilder,CaloTowerCollection,"HCalRhoZSeparate");
//
