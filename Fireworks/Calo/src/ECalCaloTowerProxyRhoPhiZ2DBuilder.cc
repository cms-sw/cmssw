...
// $Id: ECalCaloTowerProxyRhoPhiZ2DBuilder.cc,v 1.9 2008/06/09 19:54:03 chrjones Exp $
//
...
//
REGISTER_FWRPZ2DDATAPROXYBUILDER(ECalCaloTowerProxyRhoPhiZ2DBuilder,CaloTowerCollection,"ECalOld");
