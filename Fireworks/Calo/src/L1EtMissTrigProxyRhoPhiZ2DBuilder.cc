...
// $Id: L1EtMissTrigProxyRhoPhiZ2DBuilder.cc,v 1.2 2008/06/09 19:54:03 chrjones Exp $
//
...
// user include files
#include "Fireworks/Calo/interface/L1EtMissTrigProxyRhoPhiZ2DBuilder.h"
...
//
L1EtMissTrigProxyRhoPhiZ2DBuilder::L1EtMissTrigProxyRhoPhiZ2DBuilder()
{
}

// L1EtMissTrigProxyRhoPhiZ2DBuilder::L1EtMissTrigProxyRhoPhiZ2DBuilder(const L1EtMissTrigProxyRhoPhiZ2DBuilder& rhs)
// {
...
//
// metMissber functions
//
void 
L1EtMissTrigProxyRhoPhiZ2DBuilder::buildRhoPhi(const FWEventItem* iItem,
					    TEveElementList** product)
{
  ...
  // make a counter
   ...
   }// end loop over etmiss particle objects

}


void 
L1EtMissTrigProxyRhoPhiZ2DBuilder::buildRhoZ(const FWEventItem* iItem,
					    TEveElementList** product)
{
...
REGISTER_FWRPZ2DDATAPROXYBUILDER(L1EtMissTrigProxyRhoPhiZ2DBuilder,l1extra::L1EtMissParticleCollection,"L1EtMissTrig");
