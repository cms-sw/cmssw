...
//--------------------------------------------------------------------------------
//
const char* FWTrackDetailView::m_det_tracker_str[6]={"PXB","PXF","TIB","TID","TOB","TEC"};
...
void
FWTrackDetailView::prepareData(const FWModelId &id, const reco::Track* track)
{
...
void
FWTrackDetailView::build (const FWModelId &id, const reco::Track* track, TEveWindowSlot* slot)
{
...
double
FWTrackDetailView::getSignedResidual (const DetIdToMatrix *detIdToGeo, unsigned int id, double resX)
{
...
void
FWTrackDetailView::drawBox(Float_t *pos, Color_t fillCol, Int_t fillType, bool bg)
{
   // background
   if (bg)
   {
