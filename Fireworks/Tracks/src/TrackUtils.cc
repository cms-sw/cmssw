...
// Package:     Core
// Class  :     TrackUtils
// $Id: TrackUtils.cc,v 1.16 2010/04/07 15:23:55 yana Exp $
//
...
namespace fireworks {
  ...
  //______________________________________________________________________________
   ...
   double
   estimateField( const reco::Track& track, bool highQuality )
   {
      ...
      {
	 estimate = estimateField( track.outerPosition().x(), 
				   track.outerPosition().y(),
				   track.vx(),
				   track.vy(),
				   track.px(),
      ...
      {
	estimate = estimateField( track.innerPosition().x(), 
				  track.innerPosition().y(),
				  track.vx(),
				  track.vy(),
				  track.px(),
   ...
   double
   estimateField( double vx1, double vy1, double vx2, double vy2, double px, double py )
   {
