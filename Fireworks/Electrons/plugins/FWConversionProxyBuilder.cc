...
FWConversionProxyBuilder::FWConversionProxyBuilder() : m_common(nullptr) {
  m_common = new TEveElementList("common conversion scene");
  m_common->IncDenyDestroy();
}

FWConversionProxyBuilder::~FWConversionProxyBuilder() { m_common->DecDenyDestroy(); }
...
void FWConversionProxyBuilder::cleanLocal() { m_common->DestroyElements(); }

void FWConversionProxyBuilder::buildViewType(const reco::Conversion& conversion,
                                             unsigned int iIndex,
                                             TEveElement& oItemHolder,
                                             FWViewType::EType type,
                                             const FWViewContext*) {
...
REGISTER_FWPROXYBUILDER(FWConversionProxyBuilder,
                        reco::Conversion,
                        "Conversions",
