...
class MFAnalyzer : public edm::EDAnalyzer
{
public:
  explicit MFAnalyzer( const edm::ParameterSet& );
  ~MFAnalyzer( void );
...
void
MFAnalyzer::analyze( const edm::Event& iEvent, const edm::EventSetup& iSetup )
{
...
void
MFAnalyzer::evaluate (const double point [3], double field [3]) const
{
