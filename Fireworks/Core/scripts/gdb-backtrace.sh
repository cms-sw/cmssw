...
# This script is a copy of $ROOTSYS/etc/gdb-backtrace in svn trunk,
# which is by TUnixSystem::StackTrace() on Linux and MacOS X.

# Script here is used by cmsShow.cc to print stack trace on 
# SIGILL, SIGILL, SIGBUS, and SIGFPE signal actions.
