ifeq ($(shell uname), Linux) 
   ...
   ProjectLibs := $(BoostLibs) $(RootLibs) CLHEP-1.9.4.2 gsl gslcblas HepMCfio HepMC pcre  sigc-2.0 nsl crypt dl z 
   ProjectIncludes :=  external/inc/boost/1.34.1-cms/include external/inc/clhep/1.9.3.2-cms/include external/inc/gsl/1.10-cms/include external/inc/hepmc/2.03.06/include external/inc/sigcpp/2.0.17-cms/include/sigc++-2.0
else 
   ifeq ($(shell uname), Darwin)
      ...
      ProjectLibs := $(BoostLibs) $(RootLibs) CLHEP-1.9.4.2 gsl gslcblas Core RIO HepMCfio HepMC sigc-2.0.0 dl
      ProjectIncludes :=  external/inc/boost/1.38.0/include external/inc/clhep/1.9.4.2/include external/inc/gsl/1.10/include external/inc/hepmc/2.03.06/include external/inc/sigcpp/2.0.17/include/sigc++-2.0
   endif     
endif
