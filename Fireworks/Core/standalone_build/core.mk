ifeq ($(shell uname), Linux)
   ...
   ifeq ($(shell uname), Darwin)
      ...
      CoreLibs :=  $(BoostLibs) $(RootLibs) CLHEP-1.9.4.2 gsl gslcblas HepMCfio HepMC sigc-2.0.0 dl
      CoreIncludes :=  external/inc/boost/1.38.0/include external/inc/clhep/1.9.4.2/include external/inc/gsl/1.10/include external/inc/hepmc/2.03.06/include external/inc/sigcpp/2.0.17/include/sigc++-2.0
   endif     
endif
