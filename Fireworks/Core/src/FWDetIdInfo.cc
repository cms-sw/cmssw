...
std::string FWDetIdInfo::info(const DetId& id) {
...
std::string FWDetIdInfo::info(const std::set<DetId>& idSet) {
   std::string text;
...
std::string FWDetIdInfo::info(const std::vector<DetId>& idSet) {
   std::string text;
