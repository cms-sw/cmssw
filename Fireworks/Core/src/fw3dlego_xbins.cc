...
namespace fw3dlego {
  ...
  const double xbins_hf[xbins_hf_n] = {-5.205, -4.903, -4.730, -4.552, -4.377, -4.204, -4.027, -3.853, -3.677, -3.503,
                                       -3.327, -3.152, -2.976, -2.866, 2.866,  2.976,  3.152,  3.327,  3.503,  3.677,
                                       3.853,  4.027,  4.204,  4.377,  4.552,  4.730,  4.903,  5.205};
}  // namespace fw3dlego
