...
// $Id: ElectronDetailView.cc,v 1.14 2008/11/04 11:46:33 amraktad Exp $
//
...
TEveElementList *ElectronDetailView::getEcalCrystalsBarrel (
...
TEveElementList *ElectronDetailView::getEcalCrystalsEndcap (
     const DetIdToMatrix &geo,
