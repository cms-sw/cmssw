...
// $Id: FWExpressionEvaluator.cc,v 1.5 2012/08/03 18:20:28 wmtan Exp $
//
...
void
FWExpressionEvaluator::setClassName(const std::string& iClassName)
{
...
//
const std::string&
FWExpressionEvaluator::expression() const
{
   return m_expression;
}

double
FWExpressionEvaluator::evalExpression(const void* iObject) const
{
