...
//
MuonsProxyPUBuilder::MuonsProxyPUBuilder()
{
}

// MuonsProxyPUBuilder::MuonsProxyPUBuilder(const MuonsProxyPUBuilder& rhs)
// {
...
// member functions
//
void MuonsProxyPUBuilder::build (TEveElementList **product) 
{
