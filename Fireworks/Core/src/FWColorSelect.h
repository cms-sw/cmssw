...
class FWColorRow : public TGCompositeFrame {
 ...
 public:
  ...
  Int_t GetRowIndex() { return fRowIndex; }
  Int_t GetSelectedIndex() { return fSelectedIndex; }
  Pixel_t GetSelectedColor() { return fSelectedColor; }
...
class FWColorPopup : public TGCompositeFrame {
 ...
 public:
  ...
  void EndPopup();
  FWColorRow *GetActiveRow() { return fSelectedRow; }
