...
REGISTER_FWPROXYBUILDER(FWPFJetLegoProxyBuilder, reco::PFJet, "PFJet", FWViewType::kLegoPFECALBit);
REGISTER_FWPROXYBUILDER(FWPatJetLegoProxyBuilder, pat::Jet, "PFPatJet", FWViewType::kLegoPFECALBit);
