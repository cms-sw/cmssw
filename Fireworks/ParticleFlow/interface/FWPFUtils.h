...
namespace FWPFUtils
{
   ...
   inline float   caloZ1()    { return 303.353; }  // Longitudinal distance between the interaction point and last tracker layer - Endcap
   ...
   inline float   caloZ2()    { return 400.458; }  // Longitudinal distance between the interaction point and the endcap envelope - Endcap 
}
#endif
