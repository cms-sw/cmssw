...
FWPFUtils::FWPFUtils() : m_trackerTrackPropagator(0), m_trackPropagator(0), m_magField(0)
{
   // ECAL
...
//______________________________________________________________________________
TEveTrack *
FWPFUtils::getTrack( const reco::Track &iData )
{
...
//______________________________________________________________________________
TEveVector
FWPFUtils::lineCircleIntersect( const TEveVector &v1, const TEveVector &v2, float r )
{
   // Definitions
   float x, y;
...
//______________________________________________________________________________
TEveVector
FWPFUtils::lineLineIntersect( const TEveVector &p1, const TEveVector &p2, const TEveVector &p3, const TEveVector &p4 )
{
   TEveVector a = p2 - p1;
   TEveVector b = p4 - p3;
   TEveVector c = p3 - p1;
...
//______________________________________________________________________________
TEveVector
FWPFUtils::cross( const TEveVector &v1, const TEveVector &v2 )
{
   TEveVector vec;
...
//______________________________________________________________________________
float
FWPFUtils::linearInterpolation( const TEveVector &p1, const TEveVector &p2, float z )
{
   float y;
...
//______________________________________________________________________________
float
FWPFUtils::dot( const TEveVector &v1, const TEveVector &v2 )
{
...
//______________________________________________________________________________
bool
FWPFUtils::checkIntersect( const TEveVector &p, float r )
{
