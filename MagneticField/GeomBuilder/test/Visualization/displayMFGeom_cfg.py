...
#    MF_plane_d1 = cms.untracked.vdouble(0, 0., 2000),
#    MF_plane_d2 = cms.untracked.vdouble(0, 900., 0.),

#Field map on ZY plane @ X=0 (full CMS)
    MF_plane_d0 = cms.untracked.vdouble(0, -900, -2400),
    MF_plane_d1 = cms.untracked.vdouble(0, -900., 2400),
    MF_plane_d2 = cms.untracked.vdouble(0, 900., -2400.),
...
#    MF_plane_d1 = cms.untracked.vdouble(-900, 900, -165.),
#    MF_plane_d2 = cms.untracked.vdouble(900, -900, -165.),

#Field map on XY plane @ S11 feet
#    MF_plane_d0 = cms.untracked.vdouble(0, -900, 0),
#    MF_plane_d1 = cms.untracked.vdouble(0, 0, 0),
#    MF_plane_d2 = cms.untracked.vdouble(900, -900, 0),

#XY plane @ Z_SECTION
#    MF_plane_d0 = cms.untracked.vdouble(-900, -900, Z_SECTION),
#    MF_plane_d1 = cms.untracked.vdouble(-900, 900, Z_SECTION),
#    MF_plane_d2 = cms.untracked.vdouble(900, -900, Z_SECTION),

#CASTOR detail
#    MF_plane_d0 = cms.untracked.vdouble(-200, -200, -1519.49571429),
#    MF_plane_d1 = cms.untracked.vdouble(-200, 200, -1519.49571429),
#    MF_plane_d2 = cms.untracked.vdouble(200, -200, -1519.49571429),


    MF_plane_N  = cms.untracked.int32(1000), #Field map bins
#    MF_plane_N2  = cms.untracked.int32(500),
