...
int main(int argc, char **argv) {
  ...
  if (type == 5) {
    ...
    cout << ooPnt[0] << " " << ooPnt[1] << " " << ooPnt[2] << endl;
    cout << dist0[0] << " " << dist0[1] << " " << dist0[2] << endl;
    cout << rParm[0] << " " << rParm[1] << " " << rParm[2] << " " << rParm[3]
         << endl;
  }
  ...
  if (!fullDump) {
    cout << ". . ." << endl;
    cout << B[0] << " " << B[1] << " " << B[2] << " (last line of B-field only)"
         << endl;
    cout << Bmin[0] << " " << Bmin[1] << " " << Bmin[2] << " (min B-field abs)"
         << endl;
    cout << Bmax[0] << " " << Bmax[1] << " " << Bmax[2] << " (max B-field abs)"
         << endl;
    for (int i = 0; i != 3; ++i)
