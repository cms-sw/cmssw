...
public:
  ...
  /// field values
  void interpolateAtPoint(double X1, double X2, double X3, float &Bx, float &By,
                          float &Bz);

  // calculates indices from coordinates
  void putCoordGetInd(double X1, double X2, double X3, int &Index1, int &Index2,
                      int &Index3);
  // takes indices and returns magnetic field values
  void putIndicesGetB(int Index1, int Index2, int Index3, float &Bx, float &By,
                      float &Bz);
  // takes indices, calculates coordinates, and returns coordinates
  void putIndGetCoord(int Index1, int Index2, int Index3, double &X1,
                      double &X2, double &X3);
