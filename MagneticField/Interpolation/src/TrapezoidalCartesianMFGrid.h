 ...
 *  The grid must have uniform spacing in two coordinates and increasing spacing
 * in the other. Increasing spacing is supported only for x and y for the time
 * being
 *
 *  \author T. Todorov
 */
