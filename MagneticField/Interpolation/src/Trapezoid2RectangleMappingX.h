 ...
 *  It is assumed that x is the coordinate along the trapezoid bases while y is
 * along the trapezoid height.
 *
 *  \author T. Todorov
 */
...
#ifdef DEBUG_GRID_TRM
    std::cout << "Trapezoid2RectangleMappingX constructed with x0,y0 " << x0
              << " " << y0 << " b/a= " << bovera << " h= " << h << std::endl;
#endif
  }
...
#ifdef DEBUG_GRID
    std::cout << xtrap << " " << ytrap << " transformed to rectangle " << xrec
              << " " << yrec << std::endl;
#endif
  }
...
#ifdef DEBUG_GRID
    std::cout << xrec << " " << yrec << " transformed to trapezoid " << xtrap
              << " " << ytrap << std::endl;
#endif
  }
