// include header for MagneticFieldGrid (regular + extension for some
// trapezoids)
...
void MagneticFieldGrid::load(const string &name) {
  ...
  case 2:
    ...
    inFile >> ReferencePoint[0] >> ReferencePoint[1] >> ReferencePoint[2];
    inFile >> BasicDistance0[0] >> BasicDistance0[1] >> BasicDistance0[2];
    inFile >> BasicDistance1[0][0] >> BasicDistance1[1][0] >>
        BasicDistance1[2][0];
    inFile >> BasicDistance1[0][1] >> BasicDistance1[1][1] >>
        BasicDistance1[2][1];
    inFile >> BasicDistance1[0][2] >> BasicDistance1[1][2] >>
        BasicDistance1[2][2];
    inFile >> BasicDistance2[0][0] >> BasicDistance2[1][0] >>
        BasicDistance2[2][0];
    inFile >> BasicDistance2[0][1] >> BasicDistance2[1][1] >>
        BasicDistance2[2][1];
    inFile >> BasicDistance2[0][2] >> BasicDistance2[1][2] >>
        BasicDistance2[2][2];
  ...
  case 5:
    ...
    inFile >> ReferencePoint[0] >> ReferencePoint[1] >> ReferencePoint[2];
    inFile >> BasicDistance0[0] >> BasicDistance0[1] >> BasicDistance0[2];
    inFile >> RParAsFunOfPhi[0] >> RParAsFunOfPhi[1] >> RParAsFunOfPhi[2] >>
        RParAsFunOfPhi[3];
    break;
  default:
...
void MagneticFieldGrid::interpolateAtPoint(double X1, double X2, double X3,
  ...
  MagInterpol.defineCellPoint000(tmpX[0], tmpX[1], tmpX[2], double(tmpB[0]),
                                 double(tmpB[1]), double(tmpB[2]));
  ...
  MagInterpol.defineCellPoint100(tmpX[0], tmpX[1], tmpX[2], double(tmpB[0]),
                                 double(tmpB[1]), double(tmpB[2]));
  ...
  MagInterpol.defineCellPoint010(tmpX[0], tmpX[1], tmpX[2], double(tmpB[0]),
                                 double(tmpB[1]), double(tmpB[2]));
  ...
  MagInterpol.defineCellPoint110(tmpX[0], tmpX[1], tmpX[2], double(tmpB[0]),
                                 double(tmpB[1]), double(tmpB[2]));
  ...
  MagInterpol.defineCellPoint001(tmpX[0], tmpX[1], tmpX[2], double(tmpB[0]),
                                 double(tmpB[1]), double(tmpB[2]));
  ...
  MagInterpol.defineCellPoint101(tmpX[0], tmpX[1], tmpX[2], double(tmpB[0]),
                                 double(tmpB[1]), double(tmpB[2]));
  ...
  MagInterpol.defineCellPoint011(tmpX[0], tmpX[1], tmpX[2], double(tmpB[0]),
                                 double(tmpB[1]), double(tmpB[2]));
  ...
  MagInterpol.defineCellPoint111(tmpX[0], tmpX[1], tmpX[2], double(tmpB[0]),
                                 double(tmpB[1]), double(tmpB[2]));
  // interpolate
...
//
void MagneticFieldGrid::putCoordGetInd(double X1, double X2, double X3,
...
void MagneticFieldGrid::putIndicesGetB(int Index1, int Index2, int Index3,
                                       float &Bx, float &By, float &Bz) {
  BVector FieldEntry;
...
// FIXME: same as above.
void MagneticFieldGrid::putIndGetCoord(int Index1, int Index2, int Index3,
