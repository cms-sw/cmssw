...
RectangularCartesianMFGrid::uncheckedValueInTesla(const LocalPoint &p) const {
  ...
  //   (*TimingReport::current())["MagneticFieldProvider::valueInTesla(RectangularCartesianMFGrid)"];
...
void RectangularCartesianMFGrid::toGridFrame(const LocalPoint &p, double &a,
...
MFGrid::LocalPoint RectangularCartesianMFGrid::fromGridFrame(double a, double b,
                                                             double c) const {
