...
template <class T> class MagneticFieldProvider;
...
public:
  ...
  MagVolume(const PositionType &pos, const RotationType &rot,
            const MagneticFieldProvider<float> *mfp, double sf = 1.)
  ...
  /// Temporary hack to pass information on material. Will eventually be
  /// replaced!
...
private:
  ...
  // Temporary hack to keep information on material. Will eventually be
  // replaced!
  bool isIronFlag;
};
