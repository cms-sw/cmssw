...
config.General.workArea = 'crab_projects_ME0Segment_AnalysisDavid'
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'dummyPSetName'
config.JobType.outputFiles = ['ME0MuonAnalyzerOutput.root']  # in case the output is not an EDM ROOT file
...
config.Data.outLFNDirBase = '/store/user/piet/ME0Segment_Time/AnalysisDavid'
