...
process.combinedMVATrainer = cms.EDAnalyzer("JetTagMVATreeTrainer",
	...
	fileNames = cms.vstring(
		"/user/pvmulder/NewEraOfDataAnalysis/BTagServiceWork/CMSSW_5_3_4_patch1_SETEST/CMSSW_5_3_4_patch1/src/Rootfiles/RootFiles_SCtagger_TTJets_newSL_newCSV_noFit_OffsetFix/combinedMVA_DUSG.root",
	),
