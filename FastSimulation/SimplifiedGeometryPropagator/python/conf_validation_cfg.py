...
process.simHitTPAssocProducer.simHitSrc = cms.VInputTag(cms.InputTag("MuonSimHits","TrackerHits"), cms.InputTag("MuonSimHits","MuonCSCHits"), cms.InputTag("MuonSimHits","MuonDTHits"), cms.InputTag("fastSimProducer","MuonRPCHits"))
