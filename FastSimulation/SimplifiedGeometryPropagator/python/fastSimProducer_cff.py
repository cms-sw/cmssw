...
fastSimProducer = cms.EDProducer(
    ...
    # CloseByParticleGun support: when > 0 [cm], a particle born outside the
    # tracker is moved backwards along its momentum by this distance before the
    # calorimeter-layer navigation, so a vertex sitting on or just past the
    # entrance layer is still picked up. 0 disables the shift.
