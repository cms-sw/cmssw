...
process.theMixObjects.mixSH.input = cms.VInputTag(cms.InputTag("MuonSimHits","MuonCSCHits"), cms.InputTag("MuonSimHits","MuonDTHits"), cms.InputTag("MuonSimHits","MuonRPCHits"), cms.InputTag("fastSimProducer","TrackerHits"))
...
process.mixSimHits.input = cms.VInputTag(cms.InputTag("MuonSimHits","MuonCSCHits"), cms.InputTag("MuonSimHits","MuonDTHits"), cms.InputTag("MuonSimHits","MuonRPCHits"), cms.InputTag("fastSimProducer","TrackerHits"))
...
#    )
process.theDigitizersValid.mergedtruth.simHitCollections = cms.PSet(
        muon = cms.VInputTag(cms.InputTag("MuonSimHits","MuonDTHits"), cms.InputTag("MuonSimHits","MuonCSCHits"), cms.InputTag("MuonSimHits","MuonRPCHits")),
        trackerAndPixel = cms.VInputTag(cms.InputTag("fastSimProducer","TrackerHits"))
    )
...
process.AllSimHitsValidation.ModuleLabel = cms.string('fastSimProducer')
