...
pixelPluginsPhase2.append(
    cms.PSet(
        ...
        #templateId                 = cms.int32( 40 ), #commented off for no reason, but no seg fault now
        ...
        RegularPixelResolutionFile = cms.string('pixelhistos/3-18-25_barrel_v1.root'),
        #BigPixelResolutionFile = cms.string('pixelhistos/3-18-25_barrel_v1.root'),
        #EdgePixelResolutionFile = cms.string('pixelhistos/3-18-25_barrel_v1.root'),
...
pixelPluginsPhase2.append(
    cms.PSet(
        ...
        type = cms.string("PixelTemplateSmearerPlugin"),
        #templateId                 = cms.int32( 41 ),   #commented off for no reason, but no seg fault now
