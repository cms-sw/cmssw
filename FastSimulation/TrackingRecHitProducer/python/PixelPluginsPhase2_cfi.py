...
pixelPluginsPhase2.append(
    cms.PSet(
        ...
        RegularPixelResolutionFile = cms.string('pixelhistos/3-18-25_barrel.root'),
        BigPixelResolutionFile = cms.string('pixelhistos/3-18-25_barrel.root'),
        EdgePixelResolutionFile = cms.string('pixelhistos/3-18-25_barrel.root'),
...
pixelPluginsPhase2.append(
    cms.PSet(
        ...
        RegularPixelResolutionFile = cms.string('pixelhistos/3-18-25_forward.root'),
        BigPixelResolutionFile = cms.string('pixelhistos/3-18-25_forward.root'),
        EdgePixelResolutionFile = cms.string('pixelhistos/3-18-25_forward.root'),
        ## BigPixelResolutionFile     = cms.string('FastSimulation/TrackingRecHitProducer/data/BarrelEdge2017.root'),
        ## EdgePixelResolutionFile    = cms.string('FastSimulation/TrackingRecHitProducer/data/BarrelEdge2017.root'),
        MergeHitsOn                = cms.bool(False),
