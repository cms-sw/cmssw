...
{
  std::cout << "P SiPixelGaussianSmearingRecHitConverterAlgorithm"<< std::endl;
  ...
  if ( thePixelResolutionFile3) {
    thePixelResolutionFile3->Close();
    delete thePixelResolutionFile3;
  }
  thePixelResolutionFile1=0;
  thePixelResolutionFile2=0;
  thePixelResolutionFile3=0;
}
...
//-----------------------------------------------------------------------------
bool SiPixelGaussianSmearingRecHitConverterAlgorithm::hitsMerge(const PSimHit& simHit)
{
