...
//------------------------------------------------------
void GSRecHitValidation::makeHitsPlots(TString prefix, const SiTrackerGSRecHit2D * rechit, PSimHit * simHit, int numpartners){
...
std::pair<LocalPoint,LocalVector> GSRecHitValidation::projectHit( const PSimHit& hit, const StripGeomDetUnit* stripDet,
...
DEFINE_SEAL_MODULE();
DEFINE_ANOTHER_FWK_MODULE(GSRecHitValidation);
