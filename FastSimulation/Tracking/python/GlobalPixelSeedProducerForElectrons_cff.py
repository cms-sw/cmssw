...
globalPixelSeedsForElectrons.simTrackSelection.skipSimTrackIdTags = [cms.InputTag("globalPixelStepIds")]
...
globalPixelSeedsForPhotons.simTrackSelection.skipSimTrackIdTags = [cms.InputTag("globalPixelStepIds")]
