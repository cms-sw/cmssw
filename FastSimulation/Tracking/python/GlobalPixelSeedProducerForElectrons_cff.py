...
globalPixelSeedsForElectrons.originRadius = cms.vdouble(0.2)
globalPixelSeedsForElectrons.originpTMin = cms.vdouble(1.5)
globalPixelSeedsForElectrons.originHalfLength = cms.vdouble(15.)
...
globalPixelSeedsForPhotons.originHalfLength = cms.vdouble(15.)
