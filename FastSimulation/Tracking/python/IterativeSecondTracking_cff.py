...
iterativeSecondTracking = cms.Sequence(iterativeSecondSeeds+iterativeSecondTrackCandidatesWithTriplets+iterativeSecondTrackCandidatesWithPlTriplets+iterativeSecondTracks+iterativeSecondTrackMerging+iterativeSecondTrackFiltering)
