...
# with command line options: MinBias_13TeV_pythia8_TuneCUETP8M1_cfi --conditions auto:run2_mc --fast -n 1000 --eventcontent FASTPU --relval 100000,1000 -s GEN,SIM --datatier GEN-SIM-RECO --beamspot NominalCollision2015 --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --magField 38T_PostLS1
...
process.reconstruction_step = cms.Path(process.fastTkReconstruction)
process.genfiltersummary_step = cms.EndPath(process.genFilterSummary)
process.endjob_step = cms.EndPath(process.endOfProcess)
process.FASTPUoutput_step = cms.EndPath(process.FASTPUoutput)

# Schedule definition
process.schedule = cms.Schedule(process.generation_step,process.genfiltersummary_step,process.simulation_step,process.reconstruction_step,process.endjob_step,process.FASTPUoutput_step)
