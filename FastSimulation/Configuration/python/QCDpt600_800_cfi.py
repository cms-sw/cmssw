...
source = cms.Source("PythiaSource",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=1               ! QCD hight pT processes', 'CKIN(3)=600.          ! minimum pt hat for hard interactions', 'CKIN(4)=800.          ! maximum pt hat for hard interactions')
    )
)
