...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/FastSimulation/Configuration/python/Attic/PYTHIA6_MinBias_2360GeV_cff_py_GEN_FASTSIM.py,v $')
)
