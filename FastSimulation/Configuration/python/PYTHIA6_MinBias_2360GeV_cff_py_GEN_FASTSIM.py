...
# with command line options: Configuration/GenProduction/python/PYTHIA6_MinBias_2360GeV_cff.py -s GEN,FASTSIM --pileup=NoPileUp --conditions=STARTUP3X_V8L::All --eventcontent=FEVTDEBUGHLT --beamspot=Early900GeVCollision --datatier GEN-SIM-DIGI-RECO -n 100 --no_exec
