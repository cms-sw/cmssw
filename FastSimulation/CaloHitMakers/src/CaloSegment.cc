...

{
  ...
  switch (mat)
    ...
    case PbWO4:
      {
	radLenIncm =
	  in.getCalorimeter()->ecalProperties(1)->radLenIncm();
	intLenIncm =
	  in.getCalorimeter()->ecalProperties(1)->interactionLength();
      }
      break;
    case CRACK:
      {
    ...
    case PS:
      {
	radLenIncm = 
	  in.getCalorimeter()->layer1Properties(1)->radLenIncm();
	intLenIncm = 
	  in.getCalorimeter()->layer1Properties(1)->interactionLength();
      }
      break;
    case HCAL:
      {
	radLenIncm = 
	  in.getCalorimeter()->hcalProperties(1)->radLenIncm();
	intLenIncm = 
	  in.getCalorimeter()->hcalProperties(1)->interactionLength();
      }
      break;
    case ECALHCALGAP:
      {
