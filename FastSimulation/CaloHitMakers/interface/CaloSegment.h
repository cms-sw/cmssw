...
class CaloSegment 
{
  ...
  CaloSegment(const CaloPoint& in,const CaloPoint& out,double si,double siX0,double liX0,Material mat=PbWO4);
  ~CaloSegment(){;}
  ...
  /// In which detector
  inline const std::string& whichDetector() const {return detector_;};
