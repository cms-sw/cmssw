...
from FastSimulation.HighLevelTrigger.HLTFastRecoForTau_cff import *  # IT IS NOT NEEDED ANY MORE IN 44X, but it is in 42X
from FastSimulation.HighLevelTrigger.HLTFastRecoForB_cff import *
from FastSimulation.HighLevelTrigger.HLTFastRecoForPF_cff import *   # IT IS NOT NEEDED ANY MORE IN 44X, but it is in 42X
