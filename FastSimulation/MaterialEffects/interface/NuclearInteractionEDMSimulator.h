#ifndef FastSimulation_MaterialEffects_NuclearInteractionEDMSimulator_H
#define FastSimulation_MaterialEffects_NuclearInteractionEDMSimulator_H
...
class NuclearInteractionEDMSimulator : public MaterialEffectsSimulator
{
 public:

  /// Constructor
  NuclearInteractionEDMSimulator(const edm::ParameterSet& inputFiles,
  ...
  /// Default Destructor
  ~NuclearInteractionEDMSimulator();
