...
#    echo "MAXNU" $maxnu
    ...
    sed -e "s/==INPUTFILE==/$inputfilename/" -e "s/==TOTEV==/$totev/" -e "s/==MAXNU==/$maxnu/" -e "s/==NUFILE==/$nufile/" -e "s/==ROOTFILE==/$rootfile/" NITemplate.cfg > tmp_cfgfile
#    
