...
# Pixel Barrel services 
# Pixel Barrel services 
# Pixel endcap services
# TIB1 services  
# TIB2 services  
# TIB3 services  
# TIB4 services  
...
# TEC Layer 9
# Barrel Wall
# Endcap Wall : 4.86<eta<4.91
# Endcap Wall : 4.82<eta<4.86
# Endcap Wall : 4.40<eta<4.82
# Endcap Wall : 4.00<eta<4.40
# Endcap Wall : 3.71<eta<4.00
# Endcap Wall : 3.61<eta<3.71
# Endcap Wall : 3.50<eta<3.61
# Endcap Wall : 3.00<eta<3.50
# Endcap Wall
# Endcap Wall
# Pixel Barrel services 
# Pixel Barrel services 
...
# Endcap Wall : 3.50<eta<3.61
# Endcap Wall : 3.00<eta<3.50
# Endcap wall: decrease from 3.0 (v2) to 1.0 (v3)
# Endcap wall
...
TrackerMaterialBlock = cms.PSet(
    TrackerMaterial = cms.PSet(
        ...
        FudgeFactor = cms.vdouble(0.4, 2.0, 1.6, 1.45, 1.45, 
            1.45, 1.45, 2.0, 2.0, 2.0, 
            2.5, 1.5, 4.0, 5.5, 0.7, 
            2.0, 2.0, 2.0, 0.7, 2.0, 
            2.0, 2.0, 0.7, 2.0, 2.0, 
            2.0, 0.7, 2.0, 2.0, 2.0, 
            ...
            1.4, 2.5, 0.6, 1.4, 3.0, 
            0.6, 3.0, 0.6, 3.0, 0.6, 
            3.8, 18.74, 4.57, 0.604, 0.424, 
            0.327, 0.591, 1.81, 2.37, 1.0, 
            1.6),
        ...
        FudgeLayer = cms.vuint32(106, 106, 107, 6, 7, 
            8, 9, 10, 11, 12, 
            110, 110, 111, 111, 13, 
            13, 13, 13, 14, 14, 
            14, 14, 15, 15, 15, 
        ...
        FudgeMax = cms.vdouble(27.5, 32.0, 13.0, 68.0, 68.0, 
            68.0, 68.0, 42.0, 42.0, 42.0, 
            54.0, 24.0, 30.5, 110.0, 18.0, 
            30.0, 46.0, 108.0, 18.0, 30.0, 
            46.0, 108.0, 18.0, 30.0, 46.0, 
            108.0, 18.0, 30.0, 46.0, 108.0, 
            18.0, 30.0, 46.0, 108.0, 18.0, 
            30.0, 46.0, 108.0, 60.0, 78.0, 
            92.0, 24.0, 34.0, 39.0, 24.0, 
            34.0, 39.0, 24.0, 34.0, 39.0, 
            32.0, 40.0, 46.0, 32.0, 40.0, 
            46.0, 32.0, 40.0, 46.0, 32.0, 
            60.0, 32.0, 60.0, 32.0, 60.0, 
            301.0, 4.65, 4.84, 7.37, 10.99, 
            14.7, 16.24, 18.13, 30.0, 35.0, 
            120.0),
        ...
        #    replace famosSimHits.TrackerMaterial.EndcapCables2Thickness = { 0.080, 0.130, 0.130 }         # 70% increase
        #**********************************************************************
        ...
        FudgeMin = cms.vdouble(0.0, 27.5, 0.0, 35.0, 35.0, 
            35.0, 35.0, 34.0, 34.0, 34.0, 
            47.5, 22.0, 27.5, 72.0, 0.0, 
            18.0, 36.0, 55.0, 0.0, 18.0, 
            36.0, 55.0, 0.0, 18.0, 36.0, 
            55.0, 0.0, 18.0, 36.0, 55.0, 
            0.0, 18.0, 36.0, 55.0, 0.0, 
            18.0, 36.0, 55.0, 55.0, 62.0, 
            78.0, 0.0, 24.0, 34.0, 0.0, 
            24.0, 34.0, 0.0, 24.0, 34.0, 
            0.0, 32.0, 41.0, 0.0, 32.0, 
            41.0, 0.0, 32.0, 41.0, 0.0, 
            32.0, 0.0, 32.0, 0.0, 32.0, 
            120.0, 4.42, 4.65, 4.84, 7.37, 
            10.99, 14.7, 16.24, 18.13, 33.0, 
            68.0)
    )
)
