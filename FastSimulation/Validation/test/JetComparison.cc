...
JetComparison::JetComparison(edm::ParameterSet const& conf) {
  ...
  meNTowers60_vs_eta = new TH2F("number_of_towers_with_60_percents_energy_vs_eta",
                                ...
                                -0.5,
                                99.5);
  meNTowers90_vs_eta = new TH2F("number_of_towers_with_90_percents_energy_vs_eta",
...
JetComparison::~JetComparison() { cout << " outputFile_.size() =  " << outputFile_.size() << endl; }
