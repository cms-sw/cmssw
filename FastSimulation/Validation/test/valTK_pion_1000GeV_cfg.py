...
process.source = cms.Source("FlatRandomPtGunSource",
    PGunParameters = cms.untracked.PSet(
        ...
        MinPt = cms.untracked.double(1000.0),
...
process.o1 = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('test_pion_1000GeV.root')
)
...
process.multiTrackValidator.outputFile = 'valid_pion_1000GeV.root'
process.MessageLogger.destinations = ['detailedInfo_pi1000.txt']
