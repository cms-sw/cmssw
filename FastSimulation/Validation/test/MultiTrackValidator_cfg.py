################################################################################
# this is the FastSim equivalent of Validation/RecoTrack/test/MultiTrackValidator_cfg.py
# please verify regularly that this file is in sync with the FullSim original 
# all FastSim specific changes are indicated
#
# this configuration file assumes an input file generated with cmsDriver steps GEN,SIM,RECOBEFMIX,DIGI:pdigi_valid and eventcontent FEVTDEBUGHLT
#################################################################################
...
# it switches to the FastSim-way of matching hits to tracking particles
process.validation = cms.Sequence(
    #process.tpClusterProducer *
    process.quickTrackAssociatorByHits *
    process.multiTrackValidator
)
# END FASTSIM SPECIFIC
