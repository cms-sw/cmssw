...
double min = 0.50;
double max = 1.025;
TFile *_file0 = TFile::Open("valid_pion_1GeV.root");
TFile *_file1 = TFile::Open("valid_pion_10GeV.root");
TFile *_file2 = TFile::Open("valid_pion_100GeV.root");

//170pre12 fullsim
//TFile *_file3 = TFile::Open("/localscratch/azzi/FAMOS/FULLSIMVALID/CMSSW_1_7_0_pre12/src/valid_pion_10gev_RelVal_id.root");
...
ll->AddEntry(histo0,"#pi pt=1 GeV - 180pre2","P");
ll->AddEntry(histo1,"#pi pt=10 GeV - 180pre2","P");
ll->AddEntry(histo2,"#pi pt=100 GeV - 180pre2","P");
//ll->AddEntry(histo3,"#pi pt=10 GeV","P");

ll->SetFillColor(kWhite);
ll->Draw();
c.SaveAs( "pion_eff.gif" );
//c.Clear();
