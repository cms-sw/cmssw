...
process.o1 = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('test_mu_10GeV.root')
)
...
process.multiTrackValidator.outputFile = 'valid_mu_10GeV.root'
process.MessageLogger.destinations = ['detailedInfo_mu10.txt']
