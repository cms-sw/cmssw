...
process.source = cms.Source("FlatRandomPtGunSource",
    PGunParameters = cms.untracked.PSet(
        MaxPt = cms.untracked.double(1.001),
        MinPt = cms.untracked.double(0.999),
...
process.o1 = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('test_mu_1GeV.root')
)
...
process.multiTrackValidator.outputFile = 'valid_mu_1GeV.root'
process.MessageLogger.destinations = ['detailedInfo_mu1.txt']
