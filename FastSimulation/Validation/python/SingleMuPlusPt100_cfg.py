...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/SingleMuPlusPt100_cfg.py,v $'),
...
process.ReleaseValidation = cms.untracked.PSet(
    ...
    primaryDatasetName = cms.untracked.string('RelValFastSimSingleMuPlusPt100')
)
...
process.source = cms.Source("FlatRandomPtGunSource",
    ...
    psethack = cms.string('single mu pt 100 pos'),
