...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/SingleGammaPt35_cfg.py,v $'),
    annotation = cms.untracked.string('RelVal FastSim single particle gun photons, Pt=35 GeV')
)
process.ReleaseValidation = cms.untracked.PSet(
    ...
    primaryDatasetName = cms.untracked.string('RelValFastSimSingleGammaPt35')
)
...
process.source = cms.Source("FlatRandomPtGunSource",
    ...
    psethack = cms.string('single gamma E=35'),
