...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/DiElectron_Pt_5_100_cfg.py,v $'),
    annotation = cms.untracked.string('RelVal FastSim di electron pt=5-100GeV')
)
process.ReleaseValidation = cms.untracked.PSet(
    ...
    primaryDatasetName = cms.untracked.string('RelValFastSimDiElectron_Pt_5_100')
)
