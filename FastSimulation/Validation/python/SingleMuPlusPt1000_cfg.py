...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/SingleMuPlusPt1000_cfg.py,v $'),
    annotation = cms.untracked.string('RelVal FastSim single particle gun mu+ 1000GeV')
)
process.ReleaseValidation = cms.untracked.PSet(
    ...
    primaryDatasetName = cms.untracked.string('RelValFastSimSingleMuPlusPt1000')
)
...
process.source = cms.Source("FlatRandomPtGunSource",
    ...
    psethack = cms.string('single mu pt 1000 pos'),
