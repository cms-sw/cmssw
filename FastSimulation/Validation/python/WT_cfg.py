...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/WT_cfg.py,v $'),
    annotation = cms.untracked.string('RelVal FastSim W to tau nu')
)
process.ReleaseValidation = cms.untracked.PSet(
    ...
    primaryDatasetName = cms.untracked.string('RelValFastSimWT')
)
