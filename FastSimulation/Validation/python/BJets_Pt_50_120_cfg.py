...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/BJets_Pt_50_120_cfg.py,v $'),
    annotation = cms.untracked.string('RelVal FastSim b jets with pt hat 50-120GeV')
)
process.ReleaseValidation = cms.untracked.PSet(
    ...
    primaryDatasetName = cms.untracked.string('RelValFastSimBJets_Pt_50_120')
)
