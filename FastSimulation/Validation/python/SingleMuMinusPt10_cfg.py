...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/SingleMuMinusPt10_cfg.py,v $'),
    annotation = cms.untracked.string('RelVal FastSim single particle gun mu- 10GeV')
)
process.ReleaseValidation = cms.untracked.PSet(
    ...
    primaryDatasetName = cms.untracked.string('RelValFastSimSingleMuMinusPt10')
)
...
process.source = cms.Source("FlatRandomPtGunSource",
    ...
    psethack = cms.string('single mu pt 10 neg'),
