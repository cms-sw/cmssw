...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/SingleGammaE1000_cfg.py,v $'),
    annotation = cms.untracked.string('RelVal FastSim single particle gun photons, E=1000 GeV')
)
process.ReleaseValidation = cms.untracked.PSet(
    ...
    primaryDatasetName = cms.untracked.string('RelValFastSimSingleGammaE1000')
)
...
process.source = cms.Source("FlatRandomEGunSource",
    PGunParameters = cms.untracked.PSet(
        ...
        MinE = cms.untracked.double(999.999),
        MinPhi = cms.untracked.double(-3.14159265359), ## in radians

        MaxE = cms.untracked.double(1000.001)
    ),
    Verbosity = cms.untracked.int32(0), ## set to 1 (or greater) for printouts

    psethack = cms.string('single gamma E=1000'),
