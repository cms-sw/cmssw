...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/ZPrimeEEM1000_cfg.py,v $'),
    annotation = cms.untracked.string('RelVal FastSim SSM ZPrime, M=1000 GeV, with decay to electrons')
)
process.ReleaseValidation = cms.untracked.PSet(
    ...
    primaryDatasetName = cms.untracked.string('RelValFastSimZPrimeEEM1000')
)
