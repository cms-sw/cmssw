...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/SinglePiPlusPt10_cfg.py,v $'),
    annotation = cms.untracked.string('RelVal FastSim single particle gun pi+ 10GeV')
)
process.ReleaseValidation = cms.untracked.PSet(
    ...
    primaryDatasetName = cms.untracked.string('RelValFastSimSinglePiPlusPt10')
)
...
process.source = cms.Source("FlatRandomPtGunSource",
    ...
    psethack = cms.string('single pi pt 10 pos'),
