...
process.geant4eTrackRefit.src = cms.InputTag("PionTracksProducer","pionTrack","PIONS")
...
process.schedule = cms.Schedule(process.PionTracksProducer, process.g4RefitPath, process.v0, process.e)
