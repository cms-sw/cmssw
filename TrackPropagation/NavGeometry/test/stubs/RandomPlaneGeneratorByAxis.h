...
public:
  ...
  RandomPlaneGeneratorByAxis(float maxTilt, PlaneType type = arbitrary);
...
private:
  TkRotation<double> rotationAroundX(double) const;
  TkRotation<double> rotationAroundY(double) const;
  TkRotation<double> rotationAroundZ(double) const;
