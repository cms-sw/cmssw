...
#include "IOPool/Streamer/src/DQMStreamerReader.h"
...
typedef edm::DQMStreamerReader NewDQMStreamerFileReader;
...
using edm::DQMStreamerReader;

DEFINE_FWK_INPUT_SOURCE(NewEventStreamFileReader);
DEFINE_FWK_INPUT_SOURCE(NewDQMStreamerFileReader);
