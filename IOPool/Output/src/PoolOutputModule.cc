...
namespace edm {
  ...
  void PoolOutputModule::finishEndFile() { rootOutputFile_->finishEndFile(); get_underlying(rootOutputFile_).reset(); }
  ...
  void PoolOutputModule::reallyOpenFile() {
    ...
    get_underlying(rootOutputFile_).reset(new RootOutputFile(this, names.first, names.second));
  }
