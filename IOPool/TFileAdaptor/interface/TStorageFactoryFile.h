...
/** TFile wrapper around #StorageFactory and SEAL's #Storage.  */
class TStorageFactoryFile : public TFile
{
public:
    ClassDef (TStorageFactoryFile, 0); // ROOT File operating on SEAL's Storage.
...
private:
    ...
    seal::Storage	*m_storage;		//< Real underlying storage
