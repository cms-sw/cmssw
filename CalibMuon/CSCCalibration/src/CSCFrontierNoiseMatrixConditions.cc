...
CSCFrontierNoiseMatrixConditions::CSCFrontierNoiseMatrixConditions(const edm::ParameterSet& iConfig)
{
...
CSCFrontierNoiseMatrixConditions::~CSCFrontierNoiseMatrixConditions()
{
...
CSCFrontierNoiseMatrixConditions::produceNoiseMatrix(const CSCNoiseMatrixRcd& iRecord)
{
 ...
 void CSCFrontierNoiseMatrixConditions::setIntervalFor(const edm::eventsetup::EventSetupRecordKey &, const edm::IOVSyncValue&,
