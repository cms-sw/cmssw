...
public:
   ...
   *
   * WARNING: <br>
   * ME1a channels are unganged i.e. 48, not the startup 16 ganged.
   *
   */
  IndexType stripChannelsPerLayer( IndexType is, IndexType ir ) const {
    const IndexType nSCinC[16] = { 64,80,64,48,  80,80,0,0,  80,80,0,0,  80,80,0,0 };
   ...
   *
   * WARNING: <br>
   * In the upgrade scenario, ME1a channels are appended to conditions data. <br>
   * ME1b keeps 80 channels for indexing purposes, however channels 65-80 are ignored in the unganged case.
   *
   */
  IndexType stripChannelsToNextLayer( IndexType is, IndexType ir ) const {
    const IndexType nSCtoN[16] = { 80,80,64,48,  80,80,0,0,  80,80,0,0,  80,80,0,0 };
