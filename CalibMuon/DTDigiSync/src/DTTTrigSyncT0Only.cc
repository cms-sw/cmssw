...
double DTTTrigSyncT0Only::offset(const DTLayer *layer, const DTWireId &wireId,
  ...
  if (debug) {
    cout << "[DTTTrigSyncT0Only] Offset (ns): "
...
double DTTTrigSyncT0Only::emulatorOffset(const DTWireId &wireId, double &tTrig,
                                         double &t0cell) const {
  tTrig = 0.;
  t0cell = 0.;
  return 0.;
