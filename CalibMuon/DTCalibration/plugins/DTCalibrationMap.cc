...
float DTCalibrationMap::tTrig(const DTWireId& wireId) const {
...
float DTCalibrationMap::sigma_tTrig(const DTWireId& wireId) const {
...
float DTCalibrationMap::kFactor(const DTWireId& wireId) const {
...
float DTCalibrationMap::meanVDrift(const DTWireId& wireId) const {
...
float DTCalibrationMap::sigma_meanVDrift(const DTWireId& wireId) const {
