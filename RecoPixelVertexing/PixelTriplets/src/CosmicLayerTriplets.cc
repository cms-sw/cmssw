...
CosmicLayerTriplets::~CosmicLayerTriplets() {
  for (auto allLayersWithHit : allLayersWithHits) {
    delete allLayersWithHit;
  }
}
...
void CosmicLayerTriplets::init(const SiStripRecHit2DCollection& collstereo,
  ...
  if (_geometry == "STANDARD" || _geometry == "TECPAIRS_TOBTRIPLETS") {
    ...
    //   //LayersWithHits
    lh1 = new LayerWithHits(bl1, collrphi, ttopo.tobDetIdLayerComparator(4));
    allLayersWithHits.push_back(lh1);
    lh2 = new LayerWithHits(bl2, collrphi, ttopo.tobDetIdLayerComparator(5));
    allLayersWithHits.push_back(lh2);
    lh3 = new LayerWithHits(bl3, collrphi, ttopo.tobDetIdLayerComparator(6));
    allLayersWithHits.push_back(lh3);
  }
  if (_geometry == "MTCC") {
    ...
    lh1 = new LayerWithHits(bl1, collrphi, ttopo.tibDetIdLayerComparator(1));
    allLayersWithHits.push_back(lh1);
    lh2 = new LayerWithHits(bl2, collrphi, ttopo.tibDetIdLayerComparator(2));
    allLayersWithHits.push_back(lh2);
    lh3 = new LayerWithHits(bl3, collrphi, ttopo.tobDetIdLayerComparator(1));
    allLayersWithHits.push_back(lh3);
    lh4 = new LayerWithHits(bl4, collrphi, ttopo.tobDetIdLayerComparator(2));
    allLayersWithHits.push_back(lh4);
  }
}
