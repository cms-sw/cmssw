...
GroupedCkfTrajectoryBuilder.trajectoryFilter.refToPSet_ = 'MinBiasCkfTrajectoryFilter'
GroupedCkfTrajectoryBuilder.inOutTrajectoryFilter.refToPSet_ = 'MinBiasCkfTrajectoryFilter'
