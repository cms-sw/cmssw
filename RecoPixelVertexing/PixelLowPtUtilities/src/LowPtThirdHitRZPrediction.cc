...
/*****************************************************************************/
void LowPtThirdHitRZPrediction::invertCircle(Global2DVector& c,float& r)
{
...
/*****************************************************************************/
void LowPtThirdHitRZPrediction::invertPoint(Global2DVector& p)
{
...
/*****************************************************************************/
pair<float,float> LowPtThirdHitRZPrediction::findMinimalCircles(float r)
{ 
...
/*****************************************************************************/
pair<float,float> LowPtThirdHitRZPrediction::findTouchingCircles(float r)
{
...
/*****************************************************************************/
pair<float,float> LowPtThirdHitRZPrediction::findArcIntersection
...
/*****************************************************************************/
void LowPtThirdHitRZPrediction::fitParabola
...
/*****************************************************************************/
void LowPtThirdHitRZPrediction::findRectangle
...
/*****************************************************************************/
float LowPtThirdHitRZPrediction::areaParallelogram
...
/*****************************************************************************/
float LowPtThirdHitRZPrediction::angleRatio
...
/*****************************************************************************/
void LowPtThirdHitRZPrediction::spinCloser(float phi[3])
{
...
/*****************************************************************************/
void LowPtThirdHitRZPrediction::calculateRangesBarrel
...
/*****************************************************************************/
void LowPtThirdHitRZPrediction::calculateRangesForward
...
/*****************************************************************************/
void LowPtThirdHitRZPrediction::calculateRanges
...
/*****************************************************************************/
void LowPtThirdHitRZPrediction::getRanges
...
/*****************************************************************************/
void LowPtThirdHitRZPrediction::initLayer(const DetLayer *layer)
{
