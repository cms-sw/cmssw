...
Measurement1D PVPositionBuilder::average(std::vector< const reco::Track* > & trks) const {
...
Measurement1D PVPositionBuilder::wtAverage(std::vector< const reco::Track* > & trks) const {
  double ntracks = double(trks.size());
