...
class RCTInfo {
 public:
  RCTInfo() {
    ...
    c5BC0 = 0;
    c6BC0 = 0;
    for(unsigned int & i : ieRank) i = 0;
    for(unsigned int & i : ieCard) i = 0;
    for(unsigned int & i : ieRegn) i = 0;
    mBits = 0;
    qBits = 0;
    for(unsigned int & i : neRank) i = 0;
    for(unsigned int & i : neCard) i = 0;
    for(unsigned int & i : neRegn) i = 0;
    oBits = 0;
    tBits = 0;
    for(auto & i : hfEt) {
      for(int j = 0; j < 4; j++) {
