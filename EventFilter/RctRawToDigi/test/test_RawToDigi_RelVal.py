...
process.l1compare.RCTsourceData = cms.InputTag( "l1RctHwDigis" )
process.l1compare.RCTsourceEmul = cms.InputTag( "simRctDigis" )
...
# ETP,HTP,RCT,RCT,DTP,DTF,CTP,CTF,RPC,LTC,GMT,GT
...
process.l1demonrct.VerboseFlag = cms.untracked.int32(0)
process.l1demonrct.DataEmulCompareSource = cms.InputTag("l1compare")
process.l1demonrct.HistFile = cms.untracked.string('test_RawToDigi_RelVal.root')
process.l1demonrct.disableROOToutput = cms.untracked.bool( False )
