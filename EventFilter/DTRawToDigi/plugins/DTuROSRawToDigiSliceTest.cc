...
int DTuROSRawToDigiSliceTest::theROS(int crate, int slot, int link) {
  ...
  if (link <= 23) return 4;
  if (link <= 35) return 10;
  if (link <= 59) return 11;
  return 10;
}
...
int DTuROSRawToDigiSliceTest::theROB(int crate, int slot, int link) {
  ...
  if (slot ==  9) rob = (link-60)%24;
  if (slot ==  8) rob = (link-48)%24;
  if (slot ==  5) rob = (link-60)%24;
  if (slot ==  4) rob = (link-48)%24;
  if (slot ==  3) rob = (link-60)%24;
  if (slot ==  2) rob = (link-48)%24;
