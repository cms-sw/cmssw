#ifndef GCTBLOCKUNPACKERV3_H
#define GCTBLOCKUNPACKERV3_H

#include "EventFilter/GctRawToDigi/src/GctBlockUnpackerBase.h"

/*!
* \class GctBlockUnpackerV3
* \brief Third version of the block unpacker - unpacks current hardware output.
* 
*  Block Unpacker Version 3... complies with Pipeline Formats v37 and
*  is up to date with the hardware as of 20th March 2009.
* 
*  This is a temporary 'staging-point' class to get something working for the
*  lab tests.  This will soon be scrapped to be replaced by a new unpacker
*  code structure.
* 
...
class GctBlockUnpackerV3 : public GctBlockUnpackerBase
{
public:

  /// Constructor.
  /*! \param hltMode - set true to unpack only BX zero and GCT output data (i.e. to run as quickly as possible).*/
  GctBlockUnpackerV3(bool hltMode = false);
  
  ~GctBlockUnpackerV3(); ///< Destructor.
...
private:
  ...
  typedef void (GctBlockUnpackerV3::*PtrToUnpackFn)(const unsigned char *, const GctBlockHeaderBase&);
