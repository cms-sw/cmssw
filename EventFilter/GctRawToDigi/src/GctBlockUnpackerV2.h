...
protected:
  ...
  RctJetCrateMap& rctJetCrateMap() { return rctJetCrate_; }  ///< get the RCT jet crate map.
  const RctJetCrateMap& rctJetCrateMap() const { return rctJetCrate_; }  ///< get the RCT jet crate map.
...
private:
  ...
  static RctCrateMap rctJetCrate_;
