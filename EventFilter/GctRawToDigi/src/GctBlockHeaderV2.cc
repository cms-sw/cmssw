...
GctBlockHeaderBase::BlockLengthMap GctBlockHeaderV2::blockLengthV2_(initArray3, initArray3 + sizeof(initArray3) / sizeof(initArray3[0]));
...
GctBlockHeaderBase::BlockNameMap GctBlockHeaderV2::blockNameV2_(initArray4, initArray4 + sizeof(initArray4) / sizeof(initArray4[0]));
