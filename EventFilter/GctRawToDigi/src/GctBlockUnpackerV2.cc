...
void GctBlockUnpackerV2::blockToGctJetCandsAndCounts(const unsigned char * d, const GctBlockHeaderBase& hdr)
{
  ...
  gctHFBitCounts_->push_back(L1GctHFBitCounts::fromConcHFBitCounts(id,7,0,p32[0])); // Channel 0 carries both HF counts and sums
  gctHFRingEtSums_->push_back(L1GctHFRingEtSums::fromConcRingSums(id,7,0,p32[0]));  
