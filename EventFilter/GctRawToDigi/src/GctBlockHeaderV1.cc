...
GctBlockHeaderV1::GctBlockHeaderV1(uint16_t id, uint16_t nsamples, uint16_t bcid, uint16_t evid):
  GctBlockHeaderBase()
{
...
GctBlockHeaderBase::BlockLengthMap GctBlockHeaderV1::blockLength_(initArray1, initArray1 + sizeof(initArray1) / sizeof(initArray1[0]));
...
GctBlockHeaderBase::BlockNamePair initArray2[] = {
  ...
  GctBlockHeaderBase::BlockNamePair(0x5a,"ConcJet: Jet Counts Output to Global Trigger (deprecated + removed from unpack)"),
...
GctBlockHeaderBase::BlockNameMap GctBlockHeaderV1::blockName_(initArray2, initArray2 + sizeof(initArray2) / sizeof(initArray2[0]));
