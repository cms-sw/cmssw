	...
	namespace stage2 {
		namespace emtf {
			...
			void checkFormat(auto payload){
				...
				if(GetHexBits(payload[0], 16, 31) != 0) edm::LogError("L1T|EMTF") << "Payload[0] has more than 16 bits in 'AMC Data Trailer'";
				if(GetHexBits(payload[1], 16, 31) != 0) edm::LogError("L1T|EMTF") << "Payload[1] has more than 16 bits in 'AMC Data Trailer'";
				if(GetHexBits(payload[2], 16, 31) != 0) edm::LogError("L1T|EMTF") << "Payload[2] has more than 16 bits in 'AMC Data Trailer'";
				if(GetHexBits(payload[3], 16, 31) != 0) edm::LogError("L1T|EMTF") << "Payload[3] has more than 16 bits in 'AMC Data Trailer'";
				if(GetHexBits(payload[3], 16, 31) != 0) edm::LogError("L1T|EMTF") << "Payload[3] has more than 16 bits in 'AMC Data Trailer'";
				if(GetHexBits(payload[3], 16, 31) != 0) edm::LogError("L1T|EMTF") << "Payload[3] has more than 16 bits in 'AMC Data Trailer'";
				if(GetHexBits(payload[3], 16, 31) != 0) edm::LogError("L1T|EMTF") << "Payload[3] has more than 16 bits in 'AMC Data Trailer'";
				if(GetHexBits(payload[3], 16, 31) != 0) edm::LogError("L1T|EMTF") << "Payload[3] has more than 16 bits in 'AMC Data Trailer'";
				...
				//Check Format
				if(GetHexBits(tr1a, 12, 15) != 15) edm::LogError("L1T|EMTF") << "Format identifier bits in TR1a are incorrect";
				if(GetHexBits(tr1b, 12, 15) != 15) edm::LogError("L1T|EMTF") << "Format identifier bits in TR1b are incorrect";
				if(GetHexBits(tr1b, 0, 3)   != 15) edm::LogError("L1T|EMTF") << "Format identifier bits in TR1b are incorrect";
				if(GetHexBits(tr1b, 4, 6)   != 7) edm::LogError("L1T|EMTF") << "Format identifier bits in TR1b are incorrect";
				if(GetHexBits(tr1c, 9, 11)  != 0) edm::LogError("L1T|EMTF") << "Format identifier bits in TR1c are incorrect";
				if(GetHexBits(tr1c, 12, 15) != 15) edm::LogError("L1T|EMTF") << "Format identifier bits in TR1c are incorrect";
				if(GetHexBits(tr1d, 12, 15) != 15) edm::LogError("L1T|EMTF") << "Format identifier bits in TR1d are incorrect";
				if(GetHexBits(tr2a, 5, 11)  != 0) edm::LogError("L1T|EMTF") << "Format identifier bits in TR2a are incorrect";
				if(GetHexBits(tr2a, 12, 15) != 14) edm::LogError("L1T|EMTF") << "Format identifier bits in TR2a are incorrect";
				if(GetHexBits(tr2b, 12, 15) != 14) edm::LogError("L1T|EMTF") << "Format identifier bits in TR2b are incorrect";
				if(GetHexBits(tr2c, 12, 15) != 14) edm::LogError("L1T|EMTF") << "Format identifier bits in TR2c are incorrect";
				if(GetHexBits(tr2d, 12, 15) != 14) edm::LogError("L1T|EMTF") << "Format identifier bits in TR2d are incorrect";
