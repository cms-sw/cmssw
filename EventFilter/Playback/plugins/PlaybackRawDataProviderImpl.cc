...
#include "PlaybackRawDataProviderImpl.h"
...
PlaybackRawDataProviderImpl::PlaybackRawDataProviderImpl(const ParameterSet& iConfig)
  : queueSize_(0)
  , eventQueue_(0)
  , runNumber_(0)
  , evtNumber_(0)
...
//______________________________________________________________________________
PlaybackRawDataProviderImpl::~PlaybackRawDataProviderImpl()
{
...
//______________________________________________________________________________
void PlaybackRawDataProviderImpl::analyze(const Event& iEvent,
...
//______________________________________________________________________________
void PlaybackRawDataProviderImpl::beginJob(const EventSetup&)
{
...
//______________________________________________________________________________
void PlaybackRawDataProviderImpl::endJob()
{
...
//______________________________________________________________________________
FEDRawDataCollection* PlaybackRawDataProviderImpl::getFEDRawData()
{
  waitReadSem();
...
//______________________________________________________________________________
FEDRawDataCollection* PlaybackRawDataProviderImpl::getFEDRawData(unsigned int& runNumber,
...
//______________________________________________________________________________
void PlaybackRawDataProviderImpl::sem_print()
{
  lock();
  int wsem,rsem;
...
DEFINE_FWK_MODULE(PlaybackRawDataProviderImpl);
