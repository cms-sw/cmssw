...
namespace stor
{
  ...
  WebPageHelper<SMWebPageHelper>(appDesc, "$Name: CMSSW_4_4_5_patch3 $", this, &stor::SMWebPageHelper::addDOMforHyperLinks),
  sharedResources_(sharedResources),
  consumerWebPageHelper_(appDesc, "$Name: CMSSW_4_4_5_patch3 $", this, &stor::SMWebPageHelper::addDOMforHyperLinks)
  {}
