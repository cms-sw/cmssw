...
namespace stor
{
  ...
  WebPageHelper<SMWebPageHelper>(appDesc, "$Name: V07-03-05 $", this, &stor::SMWebPageHelper::addDOMforHyperLinks),
  sharedResources_(sharedResources),
  consumerWebPageHelper_(appDesc, "$Name: V07-03-05 $", this, &stor::SMWebPageHelper::addDOMforHyperLinks)
  {}
