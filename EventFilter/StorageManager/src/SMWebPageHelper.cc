...
namespace stor
{
  ...
  WebPageHelper<SMWebPageHelper>(appDesc, "$Name: CMSSW_5_3_11 $", this, &stor::SMWebPageHelper::addDOMforHyperLinks),
  sharedResources_(sharedResources),
  consumerWebPageHelper_(appDesc, "$Name: CMSSW_5_3_11 $", this, &stor::SMWebPageHelper::addDOMforHyperLinks)
  {}
