...
namespace stor
{
  ...
  WebPageHelper<SMWebPageHelper>(appDesc, "$Name: V08-04-00-01 $", this, &stor::SMWebPageHelper::addDOMforHyperLinks),
  sharedResources_(sharedResources),
  consumerWebPageHelper_(appDesc, "$Name: V08-04-00-01 $", this, &stor::SMWebPageHelper::addDOMforHyperLinks)
  {}
