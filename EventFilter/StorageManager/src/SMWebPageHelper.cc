// $Id: SMWebPageHelper.cc,v 1.1.2.11 2011/02/28 17:56:06 mommsen Exp $
...
namespace stor
{
  ...
  WebPageHelper<SMWebPageHelper>(appDesc, "$Name: SMPSdev_branch $", this, &stor::SMWebPageHelper::addDOMforHyperLinks),
  sharedResources_(sharedResources),
  consumerWebPageHelper_(appDesc, "$Name: SMPSdev_branch $", this, &stor::SMWebPageHelper::addDOMforHyperLinks)
  {}
