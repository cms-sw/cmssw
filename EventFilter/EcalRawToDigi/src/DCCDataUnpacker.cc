...
DCCDataUnpacker::DCCDataUnpacker(EcalElectronicsMapper *mapper, bool hU,
                                 bool srpU, bool tccU, bool feU, bool memU,
                                 bool syncCheck, bool feIdCheck,
...
void DCCDataUnpacker::unpack(const uint64_t *buffer, size_t bufferSize,
                             unsigned int smId, unsigned int fedId) {
...
uint16_t DCCDataUnpacker::getChannelValue(const int fed, const int ccu,
                                          const int strip,
                                          const int xtal) const {
