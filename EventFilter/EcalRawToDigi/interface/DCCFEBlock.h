...
public:
  DCCFEBlock(DCCDataUnpacker *u, EcalElectronicsMapper *m, DCCEventBlock *e,
             bool unpack, bool forceToKeepFRdata);
  ...
  int unpack(const uint64_t **data, unsigned int *dwToEnd, bool zs,
...
protected:
  ...
  virtual void
  fillEcalElectronicsError(std::unique_ptr<EcalElectronicsIdCollection> *){};
