...
enum globalFieds {
  ...
  NUMB_XTAL = 5,
  NUMB_STRIP = 5,
  NUMB_PSEUDOSTRIPS = 30,  // input1 and input2 of TCC board has at most 30
                           // PS_input (12 of which are duplicated)
...
/* 1st TTC Command */
/*                 Half :       1 bits: 7                 1st Half (0), 2nd Half
 * (1) */
/*                 TE           1 bit : 6                 Test Enable Identifier
 */
/*                 Type         2 bits: 5-4               Laser (00), LED (01)
 * Test pulse (10), Pedestal (11) */
/*                 Color        2 bits: 3-2               Blue (00), Red(01),
 * Infrared (10), Green (11) */

/* 2nd TCC Command */
/*                 DCC #:     6 bits: 5-0.              DCC 1 to 54. Zero means
 * all DCC */
