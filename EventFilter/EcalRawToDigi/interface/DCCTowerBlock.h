...
public:
  DCCTowerBlock(DCCDataUnpacker *u, EcalElectronicsMapper *m, DCCEventBlock *e,
...
protected:
  ...
  void fillEcalElectronicsError(
      std::unique_ptr<EcalElectronicsIdCollection> *) override;

  std::unique_ptr<EBDigiCollection> *digis_;

  EBDetId *pDetId_;

  // to restructure as common collections to DCCSCBlock, to inherit from
  // DCCFEBlock
