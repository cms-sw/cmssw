...
inline unsigned int RPCAMCLinkEvent::getGroup(unsigned int id)
{
    return (id & group_mask_);
}

inline unsigned int RPCAMCLinkEvent::getLevel(unsigned int id)
{
    return (id & level_mask_);
}

inline unsigned int RPCAMCLinkEvent::getEvent(unsigned int id)
{
    return (id & event_mask_);
}
