...
TwinMuxRecord::TwinMuxRecord(std::uint64_t const record)
    : record_(record)
{}

BlockHeader::BlockHeader(std::uint64_t const record)
    : record_(record)
{}

BlockHeader::BlockHeader(unsigned int ufov, unsigned int n_amc, unsigned int orbit_counter)
    : record_(0x0)
{
...
BlockTrailer::BlockTrailer(std::uint64_t const record)
    : record_(record)
{}
...
BlockAMCContent::BlockAMCContent(std::uint64_t const record)
    : record_(record)
{}
...
TwinMuxTrailer::TwinMuxTrailer(std::uint64_t const record)
    : record_(record)
{}

TwinMuxTrailer::TwinMuxTrailer(std::uint32_t crc
                               , unsigned int event_counter
                               , unsigned int data_length)
    : record_(0x0)
{
