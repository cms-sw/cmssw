...
Header::Header(std::uint64_t const record)
    : record_(record)
{}

Header::Header(unsigned int ufov, unsigned int n_amc, unsigned int orbit_counter)
    : record_(0x0)
{
...
AMCHeader::AMCHeader(std::uint64_t const record)
    : record_(record)
{}
