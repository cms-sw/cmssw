#ifndef EventFilter_CSCRawToDigi_CSCTMBHeader2020_rev0_h
#define EventFilter_CSCRawToDigi_CSCTMBHeader2020_rev0_h
#include "EventFilter/CSCRawToDigi/interface/CSCVTMBHeaderFormat.h"
#include "DataFormats/MuonDetId/interface/CSCDetId.h"

struct CSCTMBHeader2020_rev0 : public CSCVTMBHeaderFormat {
  enum { NWORDS = 43 };
  CSCTMBHeader2020_rev0();
  CSCTMBHeader2020_rev0(const unsigned short* buf);
