...
struct CSCTMBHeader2006 : public CSCVTMBHeaderFormat {
  ...
  virtual uint16_t ALCTMatchTime() const {return alctMatchTime;}
  ...
  virtual uint16_t Bxn0Diff() const {return bxn0Diff;}
  virtual uint16_t Bxn1Diff() const {return bxn1Diff;}
