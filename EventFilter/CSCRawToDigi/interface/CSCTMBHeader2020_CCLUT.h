...
struct CSCTMBHeader2020_CCLUT : public CSCVTMBHeaderFormat {
  ...
  struct {
    ...
    //unsigned clct0_comparator_code : 11, run3_trig_df : 1, clct0_xky : 2, hmt_nhits_bit0 : 1,
    //    flag10 : 1;  // 11-bits comp code + run3_trig_df data format switch

    unsigned clctCounterLow : 15, flag11 : 1;
    // 12
    unsigned clctCounterHigh : 15, flag12 : 1;
    // unsigned copad_match:8, gemA_vpf:1, gemB_vpf:1, gemA_over_flow:1, gemB_over_flow:1, gemA_sync:1, gemB_sync:1, gems_sync:1, flag12:1;
    // unsigned lct1_with_copad:1, lct1_with_gemB:1, lct1_with_gemA:1, lct1_nogem:1, lct0_with_copad:1, lct0_with_gemB:1, lct0_with_gemA:1, lct0_nogem:1, gemA_vpf:1, gemB_vpf:1, gemA_over_flow:1, gemB_over_flow:1, gemA_sync:1, gemB_sync:1, gems_sync:1, flag12:1;
    ...
    // unsigned clct1_comparator_code : 11, gem_enable : 1, clct1_xky : 2, hmt_nhits_bit1 : 1,
    //    flag14 : 1;  // 11-bits comp code + gem_enable status flag
  ...
  */
    ...
    // 40
    // unsigned activeCFEBs_2:2, readCFEBs_2:2, cfeb_badbits_found_2:2,parity_err_cfeb_ram_2:2, CFEBsEnabled_2:2, buf_fence_cnt_is_peak:1, gem_csc_bend_enable:1, trig_source_vec:2, tmb_trig_pulse:1, flag40:1;
