  ...
  if (theALCTHeader != NULL)
    {
      ...
      crcvec.emplace_back(std::make_pair(theALCTHeader->sizeInWords(), theALCTHeader->data()));
    }
  if (theAnodeData != NULL)
    {
      ...
      crcvec.emplace_back(std::make_pair(theAnodeData->sizeInWords(), theAnodeData->data()));
