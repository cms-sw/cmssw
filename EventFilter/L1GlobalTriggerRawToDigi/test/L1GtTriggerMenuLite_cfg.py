...
# with the options set in "user choices"
#
#
...
if (useRelValSample == True) and (useLocalFiles == False) :
    ...
    if (useRelease == 'CMSSW_3_5_X') or (useRelease == 'CMSSW_3_6_X')  :
        if globalTag == 'MC' :
...
if (useRelValSample == True) and (useLocalFiles == False) :
    if useGlobalTag.count('IDEAL') or useGlobalTag.count('MC') :
        ...
        if ((useRelease == 'CMSSW_3_5_X') or (useRelease == 'CMSSW_3_6_X')) and (useSample == 'RelValQCD_Pt_80_120') and (dataType == 'RECO') :
        ...
        elif ((useRelease == 'CMSSW_3_5_X') or (useRelease == 'CMSSW_3_6_X')) and (useSample == 'RelValTTbar') and (dataType == 'RECO') :
