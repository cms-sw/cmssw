...
namespace smproxy
{
  ...
  stor::WebPageHelper<SMPSWebPageHelper>(appDesc, "$Name: V03-03-02 $", this, &smproxy::SMPSWebPageHelper::addDOMforHyperLinks),
  stateMachine_(stateMachine),
  consumerWebPageHelper_(appDesc, "$Name: V03-03-02 $", this, &smproxy::SMPSWebPageHelper::addDOMforHyperLinks)
  { }
