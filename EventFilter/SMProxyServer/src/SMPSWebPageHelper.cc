// $Id: SMPSWebPageHelper.cc,v 1.1.2.14 2011/03/01 08:32:15 mommsen Exp $
...
namespace smproxy
{
  ...
  stor::WebPageHelper<SMPSWebPageHelper>(appDesc, "$Name: SMPSdev_branch $", this, &smproxy::SMPSWebPageHelper::addDOMforHyperLinks),
  stateMachine_(stateMachine),
  consumerWebPageHelper_(appDesc, "$Name: SMPSdev_branch $", this, &smproxy::SMPSWebPageHelper::addDOMforHyperLinks)
  { }
