...
namespace smproxy
{
  ...
  stor::WebPageHelper<SMPSWebPageHelper>(appDesc, "$Name: V03-02-00 $", this, &smproxy::SMPSWebPageHelper::addDOMforHyperLinks),
  stateMachine_(stateMachine),
  consumerWebPageHelper_(appDesc, "$Name: V03-02-00 $", this, &smproxy::SMPSWebPageHelper::addDOMforHyperLinks)
  { }
