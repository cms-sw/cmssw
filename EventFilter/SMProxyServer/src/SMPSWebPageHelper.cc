...
namespace smproxy
{
  ...
  stor::WebPageHelper<SMPSWebPageHelper>(appDesc, "$Name: V02-01-00 $", this, &smproxy::SMPSWebPageHelper::addDOMforHyperLinks),
  stateMachine_(stateMachine),
  consumerWebPageHelper_(appDesc, "$Name: V02-01-00 $", this, &smproxy::SMPSWebPageHelper::addDOMforHyperLinks)
  { }
