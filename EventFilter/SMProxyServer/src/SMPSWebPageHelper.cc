...
namespace smproxy
{
  ...
  stor::WebPageHelper<SMPSWebPageHelper>(appDesc, "$Name: CMSSW_5_3_11 $", this, &smproxy::SMPSWebPageHelper::addDOMforHyperLinks),
  stateMachine_(stateMachine),
  consumerWebPageHelper_(appDesc, "$Name: CMSSW_5_3_11 $", this, &smproxy::SMPSWebPageHelper::addDOMforHyperLinks)
  { }
