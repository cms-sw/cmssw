...
namespace smproxy
{
  ...
  stor::WebPageHelper<SMPSWebPageHelper>(appDesc, "$Name: CMSSW_4_4_5 $", this, &smproxy::SMPSWebPageHelper::addDOMforHyperLinks),
  stateMachine_(stateMachine),
  consumerWebPageHelper_(appDesc, "$Name: CMSSW_4_4_5 $", this, &smproxy::SMPSWebPageHelper::addDOMforHyperLinks)
  { }
