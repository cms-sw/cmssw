    ...
    void analyze(const edm::Event & e, const edm::EventSetup& c) {
      ...
      if( size>0 ) {
        ...
        edm::LogInfo( "GlobalNumberAnalysis" ) << "sizes: "
                                               << " BGOSize " << std::hex << (unsigned int) record->sizes.BGOSize
                                               << "  reserved2;" << std::hex << (unsigned int)record->sizes.reserved2
                                               << "  reserved1;" << std::hex << (unsigned int) record->sizes.reserved1
                                               << "  reserved0;" << std::hex << (unsigned int)record->sizes.reserved0
                                               << "  BSTSize;" << std::hex << (unsigned int)record->sizes.BSTSize
                                               << "  L1AhistSize;" << std::hex << (unsigned int)record->sizes.L1AhistSize
        ...
        edm::LogInfo( "GlobalNumberAnalysis" ) << "====================BST record==================="
                                               ...
                                               << "\ngpstimelow;" << std::setw(20) << std::hex << record->bst.gpstimelow
                                               << "\nbireserved8_11;" << std::setw(16) << record->bst.bireserved8_11
                                               << "\nbireserved12_15;" << std::setw(15) << record->bst.bireserved12_15
                                               << "\nbstMaster;" << std::setw(21) << record->bst.bstMaster
                                               << "\nturnCountLow;" << std::setw(18) << record->bst.turnCountLow
                                               << "\nturnCountHigh;" << std::setw(17) << record->bst.turnCountHigh
                                               << "\nlhcFillLow;" << std::setw(20) << record->bst.lhcFillLow
                                               << "\nlhcFillHigh;" << std::setw(19) << record->bst.lhcFillHigh
                                               << "\nbeamMode;" << std::setw(22) << record->bst.beamMode
                                               << "\nparticleTypes;" << std::setw(17) << record->bst.particleTypes
                                               << "\nbeamMomentum;" << std::setw(18) << record->bst.beamMomentum
                                               << "\nintensityBeam1;" << std::setw(16) << record->bst.intensityBeam1
                                               << "\nintensityBeam2;" << std::setw(16) << record->bst.intensityBeam2
                                               << "\nbireserved40_43;" << std::setw(15) << record->bst.bireserved40_43
                                               << "\nbireserved44_47;" << std::setw(15) << record->bst.bireserved44_47
                                               << "\nbireserved48_51;" << std::setw(15) << record->bst.bireserved48_51
                                               << "\nbireserved52_55;" << std::setw(15) << record->bst.bireserved52_55
                                               << "\nbireserved56_59;" << std::setw(15) << record->bst.bireserved56_59
                                               << "\nbireserved60_63;" << std::setw(15) << record->bst.bireserved60_63
                                               << std::endl;
        ...
        edm::LogInfo( "GlobalNumberAnalysis" ) << "value of nowtime: hex " << std::hex << nowtime << std::dec << ", dec " << nowtime
                                               << "\nGPS time " << ctime(&nowtime) << "plus microseconds: " << std::dec << record->bst.gpstimelow
                                               << "\nBeam " << (record->bst.bstMaster >> 8)
