...
// Created:     13.1.2005
//
// $Id: CSCTFTBEventHeader.cc,v 1.1 2006/02/22 23:16:42 lgray Exp $
//
// Revision History
...
static const char* const kIdString  = "$Id: CSCTFTBEventHeader.cc,v 1.1 2006/02/22 23:16:42 lgray Exp $";
