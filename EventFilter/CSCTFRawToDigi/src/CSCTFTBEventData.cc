...
// Created:     13.1.2005
//
// $Id: CSCTFTBEventData.cc,v 1.1 2006/06/22 00:34:18 lgray Exp $
//
// Revision History
...
static const char* const kIdString  = "$Id: CSCTFTBEventData.cc,v 1.1 2006/06/22 00:34:18 lgray Exp $";
