...
// Created:     13.1.2005
//
// $Id: CSCTFTBEventData.cc,v 1.2 2006/02/27 10:43:57 lgray Exp $
//
// Revision History
...
static const char* const kIdString  = "$Id: CSCTFTBEventData.cc,v 1.2 2006/02/27 10:43:57 lgray Exp $";
