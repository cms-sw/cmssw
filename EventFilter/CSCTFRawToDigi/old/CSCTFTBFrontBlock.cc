...
// Created:     24.1.2005
//
// $Id: CSCTFTBFrontBlock.cc,v 1.2 2006/06/22 14:46:05 lgray Exp $
//
// Revision History
...
static const char* const kIdString  = "$Id: CSCTFTBFrontBlock.cc,v 1.2 2006/06/22 14:46:05 lgray Exp $";
