...
#ifndef EventFilter_Phase2TrackerRawToDigi_Phase2TrackerRawToDigiUnpacker_H
#define EventFilter_Phase2TrackerRawToDigi_Phase2TrackerRawToDigiUnpacker_H
...
namespace sistrip {
  ...
  private:
    ...
    /// sets the Phase2TrackerEventSummary -> not yet implemented for FEDBuffer class
    void updateEventSummary( const sistrip::Phase2TrackerFEDBuffer&, SiStripEventSummary& );
...
#endif // EventFilter_Phase2TrackerRawToDigi_Phase2TrackerRawToDigiUnpacker_H
