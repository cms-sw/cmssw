...
muonCSCDigis = cms.EDProducer("CSCDigiProducer",
    neutrons = cms.PSet(
        ...
        eventOccupancy = cms.vdouble(0.000709, 0.000782, 0.000162, 0.000162, 0.00238, 0.000141, 0.00101, 0.000126, 0.000129),
    ...
    strips = cms.PSet(
        ...
        bunchTimingOffsets = cms.vdouble(0.0, 20.0, 20.0, 45.0, 45.0, 45.0, 45.0, 45.0, 45.0, 45.0, 45.0),
        ...
        resistiveCrosstalkScaling = cms.double(1.2),
    ...
    wires = cms.PSet(
        ...
        bunchTimingOffsets = cms.vdouble(0.0, 13.0, 13.0, 28.0, 28.0, 28.0, 28.0, 28.0, 28.0, 28.0, 28.0),
        tailShaping = cms.int32(2),
        doNoise = cms.bool(True)
    ),
