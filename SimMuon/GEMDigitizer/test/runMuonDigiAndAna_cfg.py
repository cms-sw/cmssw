...
#'root://eoscms//eos/cms/store/user/mileva/gemTest/genSimpt10Merged.root'
...
process.load('SimMuon.GEMDigitizer.muonGEMDigisAna_cfi')
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:outputDigi_pt10.root'),
...
#TFileService only for tests, shouldn't be here in general
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('myTestDidi.root')
)
