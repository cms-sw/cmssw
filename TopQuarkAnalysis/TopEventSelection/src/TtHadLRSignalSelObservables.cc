...
void TtHadLRSignalSelObservables::operator() (TtHadEvtSolution &TS)
{
	...
	Hadp->SetPxPyPzE(topJets[0].getRecJet().px(),topJets[0].getRecJet().py(),topJets[0].getRecJet().pz(),topJets[3].getRecJet().energy());
	Hadq->SetPxPyPzE(topJets[1].getRecJet().px(),topJets[1].getRecJet().py(),topJets[1].getRecJet().pz(),topJets[2].getRecJet().energy());	
	Hadj->SetPxPyPzE(topJets[2].getRecJet().px(),topJets[2].getRecJet().py(),topJets[2].getRecJet().pz(),topJets[2].getRecJet().energy());
	Hadk->SetPxPyPzE(topJets[3].getRecJet().px(),topJets[3].getRecJet().py(),topJets[3].getRecJet().pz(),topJets[3].getRecJet().energy());
	Hadb->SetPxPyPzE(topJets[4].getRecJet().px(),topJets[4].getRecJet().py(),topJets[4].getRecJet().pz(),topJets[1].getRecJet().energy());
	Hadbbar->SetPxPyPzE(topJets[4].getRecJet().px(),topJets[4].getRecJet().py(),topJets[4].getRecJet().pz(),topJets[1].getRecJet().energy());

	//sort the topJets in Et
	std::sort(topJets.begin(),topJets.end(),EtComparator);

	//Et-Sum of the lightest jets
	double EtSum = topJets[5].getRecJet().et()+topJets[5].getRecJet().et();
	...
	double px3 = topJets[4].getRecJet().px();     double px4 = topJets[5].getRecJet().px();
	double py3 = topJets[4].getRecJet().py();     double py4 = topJets[5].getRecJet().py();
	double pz3 = topJets[4].getRecJet().pz();     double pz4 = topJets[5].getRecJet().pz();
	double E3  = topJets[4].getRecJet().energy(); double E4  = topJets[5].getRecJet().energy();
	...
	double Ljets1BdiscSum = topJets[2].getBDiscriminator("trackCountingJetTags") + topJets[3].getBDiscriminator("trackCountingJetTags");
	double Ljets2BdiscSum = topJets[4].getBDiscriminator("trackCountingJetTags") + topJets[5].getBDiscriminator("trackCountingJetTags");
