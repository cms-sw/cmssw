					 ...
					 const bool training = false, const bool isSignal = false)
{
  ...
  values.push_back( PhysicsTools::Variable::Value("jet1_etaetaMomentMomentLogEt", sigsel.jet_etaetaMomentMomentLogEt(1) ) );
  values.push_back( PhysicsTools::Variable::Value("jet2_etaetaMomentMomentLogEt", sigsel.jet_etaetaMomentMomentLogEt(2) ) );
  values.push_back( PhysicsTools::Variable::Value("jet3_etaetaMomentMomentLogEt", sigsel.jet_etaetaMomentMomentLogEt(3) ) );
  values.push_back( PhysicsTools::Variable::Value("jet4_etaetaMomentMomentLogEt", sigsel.jet_etaetaMomentMomentLogEt(4) ) );
  values.push_back( PhysicsTools::Variable::Value("jet5_etaetaMomentMomentLogEt", sigsel.jet_etaetaMomentMomentLogEt(5) ) );
  values.push_back( PhysicsTools::Variable::Value("jet6_etaetaMomentMomentLogEt", sigsel.jet_etaetaMomentMomentLogEt(6) ) );
  values.push_back( PhysicsTools::Variable::Value("jet1_etaphiMomentMomentLogEt", sigsel.jet_etaphiMomentMomentLogEt(1) ) );
  values.push_back( PhysicsTools::Variable::Value("jet2_etaphiMomentMomentLogEt", sigsel.jet_etaphiMomentMomentLogEt(2) ) );
  values.push_back( PhysicsTools::Variable::Value("jet3_etaphiMomentMomentLogEt", sigsel.jet_etaphiMomentMomentLogEt(3) ) );
  values.push_back( PhysicsTools::Variable::Value("jet4_etaphiMomentMomentLogEt", sigsel.jet_etaphiMomentMomentLogEt(4) ) );
  values.push_back( PhysicsTools::Variable::Value("jet5_etaphiMomentMomentLogEt", sigsel.jet_etaphiMomentMomentLogEt(5) ) );
  values.push_back( PhysicsTools::Variable::Value("jet6_etaphiMomentMomentLogEt", sigsel.jet_etaphiMomentMomentLogEt(6) ) );
  values.push_back( PhysicsTools::Variable::Value("jet1_phiphiMomentMomentLogEt", sigsel.jet_phiphiMomentMomentLogEt(1) ) );
  values.push_back( PhysicsTools::Variable::Value("jet2_phiphiMomentMomentLogEt", sigsel.jet_phiphiMomentMomentLogEt(2) ) );
  values.push_back( PhysicsTools::Variable::Value("jet3_phiphiMomentMomentLogEt", sigsel.jet_phiphiMomentMomentLogEt(3) ) );
  values.push_back( PhysicsTools::Variable::Value("jet4_phiphiMomentMomentLogEt", sigsel.jet_phiphiMomentMomentLogEt(4) ) );
  values.push_back( PhysicsTools::Variable::Value("jet5_phiphiMomentMomentLogEt", sigsel.jet_phiphiMomentMomentLogEt(5) ) );
  values.push_back( PhysicsTools::Variable::Value("jet6_phiphiMomentMomentLogEt", sigsel.jet_phiphiMomentMomentLogEt(6) ) );
