...
//
TtSemiKinFitterEtThetaPhi::TtSemiKinFitterEtThetaPhi() {
  maxNrIter = 200;
  maxDeltaS = 5e-5;
  maxF = 1e-4;
  // initialisation
...
TtSemiKinFitterEtThetaPhi::TtSemiKinFitterEtThetaPhi(int a, double b, double c, vector<int> d) {
  maxNrIter = a;
  maxDeltaS = b;
  maxF = c;
  constraints = d;
...
TtSemiEvtSolution TtSemiKinFitterEtThetaPhi::addKinFitInfo(TtSemiEvtSolution * asol) {
...
// Setup the fitter
//
void TtSemiKinFitterEtThetaPhi::setupFitter() {
  
  theFitter = new TKinFitter("TtFit", "TtFit");

  TMatrixD empty3(3,3);
  fitHadb = new TFitParticleEtThetaPhi("Jet1", "Jet1", 0, &empty3);
  fitHadp = new TFitParticleEtThetaPhi("Jet2", "Jet2", 0, &empty3);
  fitHadq = new TFitParticleEtThetaPhi("Jet3", "Jet3", 0, &empty3);
  fitLepb = new TFitParticleEtThetaPhi("Jet4", "Jet4", 0, &empty3);
