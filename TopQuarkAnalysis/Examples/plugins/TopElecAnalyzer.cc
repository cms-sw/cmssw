...
void TopElecAnalyzer::analyze(const edm::Event& evt, const edm::EventSetup& setup) {
  ...
  std::cout << "=======================================================" << std::endl;
  std::cout << std::setw(5) << "ele :" << std::setw(13) << "et :" << std::setw(13) << "eta :" << std::setw(13)
            << "phi :" << std::setw(11) << "relIso" << std::endl;
  std::cout << "-------------------------------------------------------" << std::endl;
  for (const auto& elec : *elecs) {
    std::cout << std::setw(3) << i << " : " << std::setw(10) << elec.pt() << " : " << std::setw(10) << elec.eta()
              << " : " << std::setw(10) << elec.phi() << " : " << std::setw(10)
              << (elec.dr03TkSumPt() + elec.dr03EcalRecHitSumEt() + elec.dr03HcalTowerSumEt()) / elec.et() << std::endl;
    i++;
  }
  std::cout << "=======================================================" << std::endl;
}
