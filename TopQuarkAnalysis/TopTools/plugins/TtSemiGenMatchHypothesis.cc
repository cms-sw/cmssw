...
TtSemiGenMatchHypothesis::TtSemiGenMatchHypothesis(const edm::ParameterSet& cfg):
...
TtSemiGenMatchHypothesis::~TtSemiGenMatchHypothesis()
{
}

void
TtSemiGenMatchHypothesis::produce(edm::Event& evt, const edm::EventSetup& setup)
{
...
reco::NamedCompositeCandidate
TtSemiGenMatchHypothesis::fillHypo(std::vector<reco::ShallowCloneCandidate>& leafs)
{
