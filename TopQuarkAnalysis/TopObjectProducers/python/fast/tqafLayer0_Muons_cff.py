...
# PATLayer0 Muon isolation
patAODMuonIsolations.associations = ['muParamGlobalIsoDepositCalByAssociatorTowers:ecal', 'muParamGlobalIsoDepositCalByAssociatorTowers:hcal', 'muParamGlobalIsoDepositCalByAssociatorTowers:ho', 'muParamGlobalIsoDepositTk', 'muParamGlobalIsoDepositJets']
layer0MuonIsolations.associations = ['muParamGlobalIsoDepositCalByAssociatorTowers:ecal', 'muParamGlobalIsoDepositCalByAssociatorTowers:hcal', 'muParamGlobalIsoDepositCalByAssociatorTowers:ho', 'muParamGlobalIsoDepositTk', 'muParamGlobalIsoDepositJets']
...
allLayer0Muons.isolation.user = cms.VPSet(cms.PSet(
