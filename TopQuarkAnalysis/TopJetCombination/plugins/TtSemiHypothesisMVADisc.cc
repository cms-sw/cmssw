...
void
TtSemiHypothesisMVADisc::produce(edm::Event& evt, const edm::EventSetup& setup)
{
  ...
  *pKey=TtSemiEvent::kMVADisc;
  evt.put(pKey, "Key");
}

reco::NamedCompositeCandidate
TtSemiHypothesisMVADisc::buildHypo(const edm::Handle<std::vector<pat::Jet>  >& jets, 
...
reco::NamedCompositeCandidate
TtSemiHypothesisMVADisc::fillHypo(std::vector<reco::ShallowCloneCandidate>& leafs)
{
