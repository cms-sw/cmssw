...
//  bool matchLepW = false; //commented out since gcc461 complained that this variable was set but unused
  ...
  evtselectVarMatch.emplace_back(38, matchLepl&&matchLepn&&((matchHadp&&matchHadq)||(matchHadpq&&matchHadqp)));
  ...
  evtselectVarMatch.emplace_back(39, matchLepl&&matchLepn&&((matchHadp&&matchHadq)||(matchHadpq&&matchHadqp)));
  ...
  evtselectVarMatch.emplace_back(40, matchLepl&&matchLepn&&((matchHadp&&matchHadq)||(matchHadpq&&matchHadqp)));
  ...
  evtselectVarMatch.emplace_back(41, matchLepl&&matchLepn&&((matchHadp&&matchHadq)||(matchHadpq&&matchHadqp)));
  ...
  evtselectVarMatch.emplace_back(62, ((matchHadp&&matchHadq)||(matchHadpq&&matchHadqp))&&matchHadb&&matchLepb);
  ...
  evtselectVarMatch.emplace_back(63, ((matchHadp&&matchHadq)||(matchHadpq&&matchHadqp))&&matchHadb&&matchLepb);
  ...
  evtselectVarMatch.emplace_back(64, ((matchHadp&&matchHadq)||(matchHadpq&&matchHadqp))&&matchHadb&&matchLepb);
  ...
  evtselectVarMatch.emplace_back(65, ((matchHadp&&matchHadq)||(matchHadpq&&matchHadqp))&&matchHadb&&matchLepb);
  ...
  evtselectVarMatch.emplace_back(66, ((matchHadp&&matchHadq)||(matchHadpq&&matchHadqp))&&matchHadb&&matchLepb);
