...
if not options.useData :
    ...
    process.source.fileNames = [
        ...
        #'file:/afs/cern.ch/work/d/devdatta/CMSREL/CMSSW_5_3_13_patch3_Bpbh/src/BpbH/BprimeTobH/test/crab_0_140228_182411/res/pickevents_1_1_Y8G.root'
        #/BprimeBprimeToBHBHinc_M-1000_TuneZ2star_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V7C-v1/AODSIM
        '/store/mc/Summer12_DR53X/BprimeBprimeToBHBHinc_M-1000_TuneZ2star_8TeV-madgraph/AODSIM/PU_S10_START53_V7C-v1/10000/024BEF94-E93D-E211-BB47-0030487F16F7.root' 
    ]
...
#DM: process.load('RecoMET.METAnalyzers.CSCHaloFilter_cfi')
...
#DM: process.load('RecoMET.METFilters.tobtecfakesfilter_cfi')
# if true, only events passing filter (bad events) will pass
#DM: process.tobtecfakesfilter.filter=cms.bool(False) 
...
#DM: process.load('EGamma.EGammaAnalysisTools.electronIdMVAProducer_cfi') 
