...
/////////////////////////////////////////////////////////////////
  ...
  //A.createTrendLastRuns("369098752@Summary_ClusterChargeCorr_OnTrack@landauPeak,436207616@Summary_ClusterChargeCorr_OnTrack@landauPeak,402653184@Summary_ClusterChargeCorr_OnTrack@landauPeak,469762048@Summary_ClusterChargeCorr_OnTrack@landauPeak", "ClusterChargeCorr_OnTrack_landau.gif", 0, "369098752@Summary_ClusterChargeCorr_OnTrack@landauPeak > 0.0 && 369098752@Summary_ClusterChargeCorr_OnTrack@entries > 10000.0", NRuns);
  //A.closeFile(); return;
