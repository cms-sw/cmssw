/** \file
 * 
 * implementation of CSCMonitor::MonitorALCT(...) method
...
void CSCMonitor::MonitorALCT(std::vector<CSCEventData>::iterator data,int ChamberID ){
...
if (data->nalct()) {
     ...
     CSCAnodeData anodeData = data->alctData();
