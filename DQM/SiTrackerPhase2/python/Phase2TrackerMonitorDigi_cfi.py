...
digiMon = DQMEDAnalyzer('Phase2TrackerMonitorDigi',
                        ...
                        NumberOfDigisPerDetH = cms.PSet(
                            ...
                            title  = cms.string("Number of digis per det in {};Number of digis;Number of dets"),
                        ...
                        DigiOccupancySH = cms.PSet(
                            ...
                            title  = cms.string("Digi occupancy of Strips in {}"),
                            NxBins = cms.int32(51),
                        ...
                        DigiOccupancyPH = cms.PSet(
                            ...
                            title  = cms.string("Digi occupancy of Pixels in {}"),
                            NxBins = cms.int32(51),
                        ...
                        ChargeXYMapH = cms.PSet(
                            ...
                            title  = cms.string("Digi_Charge_XY in {};Row;Column"),
                        ...
                        DigiChargeH = cms.PSet(
                            ...
                            title  = cms.string("Digi charge in {};Digi charge [ADC]"),
                            NxBins = cms.int32(16),
                            xmin   = cms.double(-0.5),
                        ...
                        TotalNumberOfDigisPerLayerH = cms.PSet(
                            name   = cms.string("Num_Digis_Per_Event"),
                            title  = cms.string("Number of digis per event in {};Number of digis;Number of events"),
                        ...
                        NumberOfHitDetsPerLayerH = cms.PSet(
                            ...
                            title  = cms.string("Number of hit detectors with digis per event in {};Number of hit detectors;Number of events"),
                            NxBins = cms.int32(1000),
                            xmin   = cms.double(-0.5),
                        ...
                        ClusterWidthH = cms.PSet(
                            ...
                            title  = cms.string("Digi Cluster Width in {};Cluster width"),
                            NxBins = cms.int32(16),
                            xmin   = cms.double(-0.5),
                            xmax   = cms.double(15.5),
                            switch = cms.bool(True)
