...
protected:
  ...
  /// Book the ME
  void bookHistos(DQMStore::IBooker & ibooker, const DTSuperLayerId& dtSL, const std::string& folder, const std::string& histoTag);
  void bookHistos(DQMStore::IBooker & ibooker, const DTChamberId& dtCh, const std::string& folder, const std::string& histoTag);
