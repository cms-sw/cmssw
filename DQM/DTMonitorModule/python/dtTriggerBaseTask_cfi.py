...
dtTriggerBaseMonitor = cms.EDAnalyzer("DTLocalTriggerBaseTask",
    ...
    inputTagTMphIn = cms.untracked.InputTag('twinMuxStage2Digis'),
    inputTagTMphOut = cms.untracked.InputTag('twinMuxStage2Digis'),
    inputTagTMth = cms.untracked.InputTag('twinMuxStage2Digis'),
