...
process.load("DQM.EcalBarrelMonitorClient.EcalMonitorTask_cfi")
'''
else :
    ecalDQM += '''
### ECAL DQM MODULES ###
...
if newFramework :
    if physics :
        customizations += '''
process.ecalMonitorTask.taskParaeters.Common.hltTaskMode = 2
'''
...
if not newFramework and not physics and (daqtype == 'globalDAQ') :
    customizations += '''
