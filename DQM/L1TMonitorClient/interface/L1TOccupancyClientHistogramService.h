...
class L1TOccupancyClientHistogramService {
  ...
  public:
    ...
    void setMaskedBins(const std::string& test, const std::vector<edm::ParameterSet>& mask); //set masked channels specified in python
    ...
    TH2F* getRebinnedHistogram(DQMStore::IGetter &igetter, const std::string& iHistName, const std::string& iHistLocation); // Get rebinned version of the hist
