...
dqmRatioTimingPlots = DQMEDHarvester("DQMGenericClient",
    ...
    efficiency = cms.vstring(
       "Ratio_First_Bunch_In_Train_Minus_2 'First Bunch In Train Minus 2 Ratio; Bunch crossing number relative to L1A; Algorithm trigger bit' first_bunch_in_train_minus2 den_first_bunch_in_train_minus2",
       "Ratio_First_Bunch_In_Train_Minus_1 'First Bunch In Train Minus 1 Ratio; Bunch crossing number relative to L1A; Algorithm trigger bit' first_bunch_in_train_minus1 den_first_bunch_in_train_minus1",
       ...
       "Ratio_Prescaled_Two_Bucket_Before_Train 'Two Bucket Before Train Ratio for Prescaled Triggers; Bunch crossing number relative to L1A; Algorithm trigger bit' prescaled_algo_two_bucket_before_train_ prescaled_algo_two_bucket_before_train_den_",
       "Ratio_Prescaled_One_Bucket_Before_Train 'One Bucket Before Train Ratio for Prescaled Triggers; Bunch crossing number relative to L1A; Algorithm trigger bit' prescaled_algo_one_bucket_before_train_ prescaled_algo_one_bucket_before_train_den_",
       ...
       "Ratio_Unprescaled_Two_Bucket_Before_Train 'Two Bucket Before Train Ratio for Unprescaled Triggers; Bunch crossing number relative to L1A; Algorithm trigger bit' unprescaled_algo_two_bucket_before_train_ unprescaled_algo_two_bucket_before_train_den_",
       "Ratio_Unprescaled_One_Bucket_Before_Train 'One Bucket Before Train Ratio for Unprescaled Triggers; Bunch crossing number relative to L1A; Algorithm trigger bit' unprescaled_algo_one_bucket_before_train_ unprescaled_algo_one_bucket_before_train_den_",
