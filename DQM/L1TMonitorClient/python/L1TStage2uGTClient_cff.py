...
dqmRatioTimingPlots = DQMEDHarvester("DQMGenericClient",
    ...
    efficiency = cms.vstring(
       ...
       "Ratio_Prescaled_First_Bunch_In_Train 'First Bunch In Train Ratio for Prescaled Triggers; Bunch crossing number relative to L1A; Algorithm trigger bit' prescaled_first_collision_run_ den_prescaled_first_collision_run_",
       "Ratio_Prescaled_Isolated_Bunch 'Isolated Bunch Ratio for Prescaled Triggers; Bunch crossing number relative to L1A; Algorithm trigger bit' prescaled_isolated_collision_run_ den_prescaled_isolated_collision_run_",
       "Ratio_Prescaled_Last_Bunch_In_Train 'Last Bunch In Train Ratio for Prescaled Triggers; Bunch crossing number relative to L1A; Algorithm trigger bit' prescaled_last_collision_run_ den_prescaled_last_collision_run_",
       "Ratio_Unprescaled_First_Bunch_In_Train 'First Bunch In Train Ratio for Unprescaled Triggers; Bunch crossing number relative to L1A; Algorithm trigger bit' unprescaled_first_collision_run_ den_unprescaled_first_collision_run_",
       "Ratio_Unprescaled_Isolated_Bunch 'Isolated Bunch Ratio for Unprescaled Triggers; Bunch crossing number relative to L1A; Algorithm trigger bit' unprescaled_isolated_collision_run_ den_unprescaled_isolated_collision_run_",
       "Ratio_Unprescaled_Last_Bunch_In_Train 'Last Bunch In Train Ratio for Unprescaled Triggers; Bunch crossing number relative to L1A; Algorithm trigger bit' unprescaled_last_collision_run_ den_unprescaled_last_collision_run_",
    ),
