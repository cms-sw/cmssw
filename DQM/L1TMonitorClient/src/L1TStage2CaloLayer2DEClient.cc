...
void L1TStage2CaloLayer2DEClient::book(DQMStore::IBooker &ibooker) {
  ...
  CenJetRankComp_ = ibooker.book1D(
    "CenJetsRankDERatio", "Data/Emul of central jet E_{T}", 2048, -0.5, 2047.5);
  CenJetEtaComp_ = ibooker.book1D(
    "CenJetsEtaDERatio", "Data/Emul of central jet Eta", 229, -114.5, 114.5);
  CenJetPhiComp_ = ibooker.book1D(
    "CenJetsPhiDERatio", "Data/Emul of central jet Phi", 144, -0.5, 143.5);
  ForJetRankComp_=ibooker.book1D(
    "ForJetsRankDERatio", "Data/Emul of forward jet E_{T}", 2048, -0.5, 2047.5);
  ForJetEtaComp_=ibooker.book1D(
    "ForJetsEtaDERatio", "Data/Emul of forward jet Eta", 229, -114.5, 114.5);
  ForJetPhiComp_=ibooker.book1D(
    "ForJetsPhiDERatio", "Data/Emul of forward jet Phi", 144, -0.5, 143.5);
  IsoEGRankComp_=ibooker.book1D(
    "IsoEGRankDERatio", "Data/Emul of isolated eg E_{T}", 512, -0.5, 511.5);
  IsoEGEtaComp_=ibooker.book1D(
    "IsoEGEtaDERatio", "Data/Emul of isolated eg Eta", 229, -114.5, 114.5);
  IsoEGPhiComp_=ibooker.book1D(
    "IsoEGPhiDERatio", "Data/Emul of isolated eg Phi", 144, -0.5, 143.5);
  NonIsoEGRankComp_=ibooker.book1D(
    "NonIsoEGRankDERatio", "Data/Emul of non-isolated eg E_{T}",
    512, -0.5, 511.5);
  NonIsoEGEtaComp_ = ibooker.book1D(
    "NonIsoEGEtaDERatio", "Data/Emul of non-isolated eg Eta",
    229, -114.5, 114.5);
  NonIsoEGPhiComp_ = ibooker.book1D(
    "NonIsoEGPhiDERatio", "Data/Emul of non-isolated eg Phi", 144, -0.5, 143.5);
  TauRankComp_ = ibooker.book1D(
    "TauRankDERatio", "Data/Emul of relax tau E_{T}", 512, -0.5, 511.5);
  TauEtaComp_ = ibooker.book1D(
    "TauEtaDERatio", "Data/Emul of relax tau Eta", 229, -114.5, 114.5);
  TauPhiComp_ = ibooker.book1D(
    "TauPhiDERatio", "Data/Emul of relax tau eg Phi", 144, -0.5, 143.5);
  IsoTauRankComp_ = ibooker.book1D(
    "IsoTauRankDERatio", "Data/Emul of iso tau E_{T}", 512, -0.5, 511.5);
  IsoTauEtaComp_ = ibooker.book1D(
    "IsoTauEtaDERatio", "Data/Emul of iso tau Eta", 229, -114.5, 114.5);
  IsoTauPhiComp_ = ibooker.book1D(
    "IsoTauPhiDERatio", "Data/Emul of iso tau eg Phi", 144, -0.5, 143.5);
  METComp_ = ibooker.book1D("METRatio","Data/Emul of MET", 4096, -0.5, 4095.5);
  METPhiComp_ = ibooker.book1D(
    "METPhiRatio", "Data/Emul of MET Phi", 1008, -0.5, 1007.5);
  METHFComp_ = ibooker.book1D(
    "METHFRatio", "Data/Emul of METHF", 4096, -0.5, 4095.5);
  METHFPhiComp_ = ibooker.book1D(
    "METHFPhiRatio", "Data/Emul of METHF Phi", 1008, -0.5, 1007.5);
  MHTComp_ = ibooker.book1D("MHTRatio", "Data/Emul of MHT", 4096, -0.5, 4095.5);
  METPhiComp_ = ibooker.book1D(
    "MHTPhiRatio", "Data/Emul of MHT Phi",1008, -0.5, 1007.5);
  MHTHFComp_ = ibooker.book1D(
    "MHTHFRatio", "Data/Emul of MHTHF", 4096, -0.5, 4095.5);
  MHTPhiComp_ = ibooker.book1D(
    "MHTHFPhiRatio","Data/Emul of MHTHF Phi", 1008, -0.5, 1007.5);
  ETTComp_ = ibooker.book1D(
    "ETTRatio","Data/Emul of ET Total", 4096, -0.5, 4095.5);
  ETTEMComp_ = ibooker.book1D(
    "ETTEMRatio","Data/Emul of ET Total", 4096, -0.5, 4095.5);
  HTTComp_ = ibooker.book1D(
    "HTTRatio","Data/Emul of HT Total", 4096, -0.5, 4095.5);

  MinBiasHFP0Comp_ = ibooker.book1D(
    "MinBiasHFP0Ratio", "Data/Emul MinBiasHFP0", 16, -0.5, 15.5);
  MinBiasHFM0Comp_ = ibooker.book1D(
    "MinBiasHFM0Ratio", "Data/Emul MinBiasHFM0", 16, -0.5, 15.5);
  MinBiasHFP1Comp_ = ibooker.book1D(
    "MinBiasHFP1Ratio", "Data/Emul MinBiasHFP1", 16, -0.5, 15.5);
  MinBiasHFM1Comp_ = ibooker.book1D(
    "MinBiasHFM1Ratio", "Data/Emul MinBiasHFM1", 16, -0.5, 15.5);

  TowerCountComp_ = ibooker.book1D(
    "TowCountRatio", "Data/Emul Tower Count", 5904, -0.5, 5903.5);
}
