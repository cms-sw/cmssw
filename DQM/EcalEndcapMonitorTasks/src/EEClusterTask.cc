...
void EEClusterTask::setup(void){
  ...
  if ( dbe_ ) {
    ...
    meBCETFwdMapProjR_->setAxisTitle("transverse energy", 2);
    ...
    meBCETFwdMapProjPhi_->setAxisTitle("transverse energy", 2);
