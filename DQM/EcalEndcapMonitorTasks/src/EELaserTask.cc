...
void EELaserTask::beginJob(const EventSetup& c){
  ...
  if ( dbe ) {
    dbe->setCurrentFolder("EcalEndcap/EELaserTask");
    dbe->rmdir("EcalEndcap/EELaserTask");
  }
...
void EELaserTask::setup(void){
  ...
  if ( dbe ) {
    ...
    dbe->setCurrentFolder("EcalEndcap/EELaserTask/Laser1");
    for (int i = 0; i < 36 ; i++) {
    ...
    dbe->setCurrentFolder("EcalEndcap/EELaserTask/Laser2");
    for (int i = 0; i < 36 ; i++) {
    ...
    dbe->setCurrentFolder("EcalEndcap/EELaserTask/Laser3");
    for (int i = 0; i < 36 ; i++) {
    ...
    dbe->setCurrentFolder("EcalEndcap/EELaserTask/Laser4");
    for (int i = 0; i < 36 ; i++) {
    ...
    dbe->setCurrentFolder("EcalEndcap/EEPnDiodeTask/Laser1");

    dbe->setCurrentFolder("EcalEndcap/EEPnDiodeTask/Laser1/Gain01");
    for (int i = 0; i < 36 ; i++) {
    ...
    dbe->setCurrentFolder("EcalEndcap/EEPnDiodeTask/Laser1/Gain16");
    for (int i = 0; i < 36 ; i++) {
    ...
    dbe->setCurrentFolder("EcalEndcap/EEPnDiodeTask/Laser2");

    dbe->setCurrentFolder("EcalEndcap/EEPnDiodeTask/Laser2/Gain01");
    for (int i = 0; i < 36 ; i++) {
    ...
    dbe->setCurrentFolder("EcalEndcap/EEPnDiodeTask/Laser2/Gain16");
    for (int i = 0; i < 36 ; i++) {
    ...
    dbe->setCurrentFolder("EcalEndcap/EEPnDiodeTask/Laser3");

    dbe->setCurrentFolder("EcalEndcap/EEPnDiodeTask/Laser3/Gain01");
    for (int i = 0; i < 36 ; i++) {
    ...
    dbe->setCurrentFolder("EcalEndcap/EEPnDiodeTask/Laser3/Gain16");
    for (int i = 0; i < 36 ; i++) {
    ...
    dbe->setCurrentFolder("EcalEndcap/EEPnDiodeTask/Laser4");

    dbe->setCurrentFolder("EcalEndcap/EEPnDiodeTask/Laser4/Gain01");
    for (int i = 0; i < 36 ; i++) {
    ...
    dbe->setCurrentFolder("EcalEndcap/EEPnDiodeTask/Laser4/Gain16");
    for (int i = 0; i < 36 ; i++) {
