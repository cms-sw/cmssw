...
void EBLaserTask::beginJob(const EventSetup& c){
  ...
  if ( dqmStore_ ) {
    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask");
    dqmStore_->rmdir(prefixME_ + "EcalBarrel/EBLaserTask");
  }
...
void EBLaserTask::setup(void){
  ...
  if ( dqmStore_ ) {
    ...
    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser1");
    for (int i = 0; i < 36; i++) {
      sprintf(histo, "EBLT shape %s L1A", Numbers::sEB(i+1).c_str());
      meShapeMapL1A_[i] = dqmStore_->bookProfile2D(histo, histo, 1700, 0., 1700., 10, 0., 10., 4096, 0., 4096., "s");
      ...
      meAmplMapL1A_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplMapL1A_[i]->setAxisTitle("ieta", 1);
      meAmplMapL1A_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplMapL1A_[i], i+1);
      sprintf(histo, "EBLT timing %s L1A", Numbers::sEB(i+1).c_str());
      meTimeMapL1A_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 250, 0., 10., "s");
      meTimeMapL1A_[i]->setAxisTitle("ieta", 1);
      meTimeMapL1A_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meTimeMapL1A_[i], i+1);
      sprintf(histo, "EBLT amplitude over PN %s L1A", Numbers::sEB(i+1).c_str());
      meAmplPNMapL1A_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplPNMapL1A_[i]->setAxisTitle("ieta", 1);
      meAmplPNMapL1A_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplPNMapL1A_[i], i+1);

      sprintf(histo, "EBLT shape %s L1B", Numbers::sEB(i+1).c_str());
      meShapeMapL1B_[i] = dqmStore_->bookProfile2D(histo, histo, 1700, 0., 1700., 10, 0., 10., 4096, 0., 4096., "s");
      ...
      meAmplMapL1B_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplMapL1B_[i]->setAxisTitle("ieta", 1);
      meAmplMapL1B_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplMapL1B_[i], i+1);
      sprintf(histo, "EBLT timing %s L1B", Numbers::sEB(i+1).c_str());
      meTimeMapL1B_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 250, 0., 10., "s");
      meTimeMapL1B_[i]->setAxisTitle("ieta", 1);
      meTimeMapL1B_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meTimeMapL1B_[i], i+1);
      sprintf(histo, "EBLT amplitude over PN %s L1B", Numbers::sEB(i+1).c_str());
      meAmplPNMapL1B_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplPNMapL1B_[i]->setAxisTitle("ieta", 1);
      meAmplPNMapL1B_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplPNMapL1B_[i], i+1);
    }

    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser2");
    for (int i = 0; i < 36; i++) {
      sprintf(histo, "EBLT shape %s L2A", Numbers::sEB(i+1).c_str());
      meShapeMapL2A_[i] = dqmStore_->bookProfile2D(histo, histo, 1700, 0., 1700., 10, 0., 10., 4096, 0., 4096., "s");
      ...
      meAmplMapL2A_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplMapL2A_[i]->setAxisTitle("ieta", 1);
      meAmplMapL2A_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplMapL2A_[i], i+1);
      sprintf(histo, "EBLT timing %s L2A", Numbers::sEB(i+1).c_str());
      meTimeMapL2A_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 250, 0., 10., "s");
      meTimeMapL2A_[i]->setAxisTitle("ieta", 1);
      meTimeMapL2A_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meTimeMapL2A_[i], i+1);
      sprintf(histo, "EBLT amplitude over PN %s L2A", Numbers::sEB(i+1).c_str());
      meAmplPNMapL2A_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplPNMapL2A_[i]->setAxisTitle("ieta", 1);
      meAmplPNMapL2A_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplPNMapL2A_[i], i+1);

      sprintf(histo, "EBLT shape %s L2B", Numbers::sEB(i+1).c_str());
      meShapeMapL2B_[i] = dqmStore_->bookProfile2D(histo, histo, 1700, 0., 1700., 10, 0., 10., 4096, 0., 4096., "s");
      ...
      meAmplMapL2B_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplMapL2B_[i]->setAxisTitle("ieta", 1);
      meAmplMapL2B_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplMapL2B_[i], i+1);
      sprintf(histo, "EBLT timing %s L2B", Numbers::sEB(i+1).c_str());
      meTimeMapL2B_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 250, 0., 10., "s");
      meTimeMapL2B_[i]->setAxisTitle("ieta", 1);
      meTimeMapL2B_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meTimeMapL2B_[i], i+1);
      sprintf(histo, "EBLT amplitude over PN %s L2B", Numbers::sEB(i+1).c_str());
      meAmplPNMapL2B_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplPNMapL2B_[i]->setAxisTitle("ieta", 1);
      meAmplPNMapL2B_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplPNMapL2B_[i], i+1);
    }

    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser3");
    for (int i = 0; i < 36; i++) {
      sprintf(histo, "EBLT shape %s L3A", Numbers::sEB(i+1).c_str());
      meShapeMapL3A_[i] = dqmStore_->bookProfile2D(histo, histo, 1700, 0., 1700., 10, 0., 10., 4096, 0., 4096., "s");
      ...
      meAmplMapL3A_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplMapL3A_[i]->setAxisTitle("ieta", 1);
      meAmplMapL3A_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplMapL3A_[i], i+1);
      sprintf(histo, "EBLT timing %s L3A", Numbers::sEB(i+1).c_str());
      meTimeMapL3A_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 250, 0., 10., "s");
      meTimeMapL3A_[i]->setAxisTitle("ieta", 1);
      meTimeMapL3A_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meTimeMapL3A_[i], i+1);
      sprintf(histo, "EBLT amplitude over PN %s L3A", Numbers::sEB(i+1).c_str());
      meAmplPNMapL3A_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplPNMapL3A_[i]->setAxisTitle("ieta", 1);
      meAmplPNMapL3A_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplPNMapL3A_[i], i+1);

      sprintf(histo, "EBLT shape %s L3B", Numbers::sEB(i+1).c_str());
      meShapeMapL3B_[i] = dqmStore_->bookProfile2D(histo, histo, 1700, 0., 1700., 10, 0., 10., 4096, 0., 4096., "s");
      ...
      meAmplMapL3B_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplMapL3B_[i]->setAxisTitle("ieta", 1);
      meAmplMapL3B_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplMapL3B_[i], i+1);
      sprintf(histo, "EBLT timing %s L3B", Numbers::sEB(i+1).c_str());
      meTimeMapL3B_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 250, 0., 10., "s");
      meTimeMapL3B_[i]->setAxisTitle("ieta", 1);
      meTimeMapL3B_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meTimeMapL3B_[i], i+1);
      sprintf(histo, "EBLT amplitude over PN %s L3B", Numbers::sEB(i+1).c_str());
      meAmplPNMapL3B_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplPNMapL3B_[i]->setAxisTitle("ieta", 1);
      meAmplPNMapL3B_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplPNMapL3B_[i], i+1);
    }

    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser4");
    for (int i = 0; i < 36; i++) {
      sprintf(histo, "EBLT shape %s L4A", Numbers::sEB(i+1).c_str());
      meShapeMapL4A_[i] = dqmStore_->bookProfile2D(histo, histo, 1700, 0., 1700., 10, 0., 10., 4096, 0., 4096., "s");
      ...
      meAmplMapL4A_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplMapL4A_[i]->setAxisTitle("ieta", 1);
      meAmplMapL4A_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplMapL4A_[i], i+1);
      sprintf(histo, "EBLT timing %s L4A", Numbers::sEB(i+1).c_str());
      meTimeMapL4A_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 250, 0., 10., "s");
      meTimeMapL4A_[i]->setAxisTitle("ieta", 1);
      meTimeMapL4A_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meTimeMapL4A_[i], i+1);
      sprintf(histo, "EBLT amplitude over PN %s L4A", Numbers::sEB(i+1).c_str());
      meAmplPNMapL4A_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplPNMapL4A_[i]->setAxisTitle("ieta", 1);
      meAmplPNMapL4A_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplPNMapL4A_[i], i+1);

      sprintf(histo, "EBLT shape %s L4B", Numbers::sEB(i+1).c_str());
      meShapeMapL4B_[i] = dqmStore_->bookProfile2D(histo, histo, 1700, 0., 1700., 10, 0., 10., 4096, 0., 4096., "s");
      ...
      meAmplMapL4B_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplMapL4B_[i]->setAxisTitle("ieta", 1);
      meAmplMapL4B_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplMapL4B_[i], i+1);
      sprintf(histo, "EBLT timing %s L4B", Numbers::sEB(i+1).c_str());
      meTimeMapL4B_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 250, 0., 10., "s");
      meTimeMapL4B_[i]->setAxisTitle("ieta", 1);
      meTimeMapL4B_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meTimeMapL4B_[i], i+1);
      sprintf(histo, "EBLT amplitude over PN %s L4B", Numbers::sEB(i+1).c_str());
      meAmplPNMapL4B_[i] = dqmStore_->bookProfile2D(histo, histo, 85, 0., 85., 20, 0., 20., 4096, 0., 4096.*12., "s");
      meAmplPNMapL4B_[i]->setAxisTitle("ieta", 1);
      meAmplPNMapL4B_[i]->setAxisTitle("iphi", 2);
      dqmStore_->tag(meAmplPNMapL4B_[i], i+1);
    }

    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser1/PN");

    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser1/PN/Gain01");
    for (int i = 0; i < 36; i++) {
    ...
    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser1/PN/Gain16");
    for (int i = 0; i < 36; i++) {
    ...
    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser2/PN");

    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser2/PN/Gain01");
    for (int i = 0; i < 36; i++) {
    ...
    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser2/PN/Gain16");
    for (int i = 0; i < 36; i++) {
    ...
    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser3/PN");

    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser3/PN/Gain01");
    for (int i = 0; i < 36; i++) {
    ...
    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser3/PN/Gain16");
    for (int i = 0; i < 36; i++) {
    ...
    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser4/PN");

    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser4/PN/Gain01");
    for (int i = 0; i < 36; i++) {
    ...
    dqmStore_->setCurrentFolder(prefixME_ + "EcalBarrel/EBLaserTask/Laser4/PN/Gain16");
    for (int i = 0; i < 36; i++) {
