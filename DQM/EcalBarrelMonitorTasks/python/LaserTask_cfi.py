laserTask = dict(
    MEs = dict(
        ...
        Occupancy = dict(path = "Occupancy/Calibration/LaserTask digi occupancy L%(wl)s", otype = 'Ecal2P', btype = 'SuperCrystal', kind = 'TH2F'),
        ...
        PNAmplitude = dict(path = "PN/Laser/Laser%(wl)s/LaserTask PN amplitude L%(wl)s", otype = 'SMMEM', btype = 'Crystal', kind = 'TProfile')
    )
)
