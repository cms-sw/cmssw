...
process.siStripFineDelayHit = cms.EDFilter("SiStripFineDelayHit",
...
process.histosA = cms.EDFilter("SiStripCommissioningSource",
...
process.histosB = cms.EDFilter("SiStripCommissioningSource",
    SummaryInputModuleLabel = cms.string('digis'),
    CommissioningTask = cms.untracked.string('UNDEFINED'),
    HistoUpdateFreq = cms.untracked.int32(10),
