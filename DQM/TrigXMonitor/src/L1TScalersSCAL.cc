...
void L1TScalersSCAL::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  nev_++;
  // access SCAL info
  ...
  if (!(a && c && d)) {
    ...
    for (auto it4 = bunchCrossings->begin(); it4 != bunchCrossings->end(); ++it4) {
