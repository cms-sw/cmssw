...
void Test_SiStrip_HistId::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  std::cout << "------------------------------------" << std::endl;
  std::cout << "hid1 component id / component type: " << hidmanager.getComponentId(hid1) << " / "
            << hidmanager.getComponentType(hid1) << std::endl;
  std::cout << "hid2 component id / component type: " << hidmanager.getComponentId(hid2) << " / "
            << hidmanager.getComponentType(hid2) << std::endl;
  std::cout << "hid3 component id / component type: " << hidmanager.getComponentId(hid3) << " / "
            << hidmanager.getComponentType(hid3) << std::endl;
  std::cout << "------------------------------------" << std::endl;
  std::string hid4 = "just for_testing% _#31";
  std::cout << "hid4=" << hid4 << std::endl;
  std::cout << "hid4 component id / component type: " << hidmanager.getComponentId(hid4) << " / "
