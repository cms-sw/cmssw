// -*- C++ -*-
//
// Package:    OuterTrackerMonitorSimulation
// Class:      OuterTrackerMonitorSimulation
// 
/**\class OuterTrackerMonitorSimulation OuterTrackerMonitorSimulation.cc DQM/OuterTrackerMonitorSimulation/plugins/OuterTrackerMonitorSimulation.cc
...
#include "DQM/OuterTrackerMonitorSimulation/interface/OuterTrackerMonitorSimulation.h"
...
//
OuterTrackerMonitorSimulation::OuterTrackerMonitorSimulation(const edm::ParameterSet& iConfig)
...
OuterTrackerMonitorSimulation::~OuterTrackerMonitorSimulation()
{
...
void
OuterTrackerMonitorSimulation::beginRun(const edm::Run& run, const edm::EventSetup& es)
{
...
void 
OuterTrackerMonitorSimulation::endJob(void) 
{
	
}

//define this as a plug-in
DEFINE_FWK_MODULE(OuterTrackerMonitorSimulation);
