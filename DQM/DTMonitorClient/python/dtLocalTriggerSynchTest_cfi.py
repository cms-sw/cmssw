...
run2_25ns_specific.toModify( triggerSynchTest, hwSources = cms.untracked.vstring('TM'))

from Configuration.Eras.Modifier_run2_HI_specific_cff import run2_HI_specific
run2_HI_specific.toModify( triggerSynchTest, hwSources = cms.untracked.vstring('TM'))

from Configuration.Eras.Modifier_pA_2016_cff import pA_2016
pA_2016.toModify( triggerSynchTest, hwSources = cms.untracked.vstring('TM'))
