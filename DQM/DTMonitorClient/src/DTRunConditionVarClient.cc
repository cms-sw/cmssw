...
void DTRunConditionVarClient::bookWheelHistos(DQMStore::IBooker & ibooker, string histoType, string subfolder, int wh, int nbins, float min, float max, bool isVDCorr )
{
