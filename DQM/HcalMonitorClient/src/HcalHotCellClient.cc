...
void HcalHotCellClient::getSJ6histos(const char* dir, const char* name, TH2F* h[6])
{
  TH2F* dummy=new TH2F();
  ostringstream hname;
  hname.str("");
  ...
  hname.str("");
  return;
} // void HcalHotCellClient::getSJ6histos(2D)

void HcalHotCellClient::getSJ6histos(const char* dir, const char* name, TH1F* h[6])
{
  TH1F* dummy=new TH1F();
  ostringstream hname;
  hname <<process_.c_str()<<dir<<"HB HF Depth 1 "<<name;
  ...
  hname.str("");
  return;
} // void HcalHotCellClient::getSJ6histos(1D)
