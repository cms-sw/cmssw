...
ContainerSingle1D::ContainerSingle1D(std::string const &folder, Quantity *qx,
                                     Quantity *qy)
...
ContainerSingle1D::ContainerSingle1D(std::string const &folder,
                                     std::string const &qname, Quantity *qx,
                                     Quantity *qy)
...
/* virtual */ void ContainerSingle1D::book(DQMStore::IBooker &ib,
  ...
  _me = ib.book1D(_qname + (aux.empty() ? aux : "_" + aux),
                  _qname + (aux.empty() ? aux : " " + aux), _qx->nbins(),
                  _qx->min(), _qx->max());
  customize();
}
...
/* virtual */ double
ContainerSingle1D::getBinContent(HcalElectronicsId const &id) {
  return _me->getBinContent(_qx->getBin(id));
}
/* virtual */ double
ContainerSingle1D::getBinEntries(HcalElectronicsId const &id) {
  return _me->getBinEntries(_qx->getBin(id));
}
...
/* virtual */ double
ContainerSingle1D::getBinContent(HcalTrigTowerDetId const &id) {
  return _me->getBinContent(_qx->getBin(id));
}
/* virtual */ double
ContainerSingle1D::getBinEntries(HcalTrigTowerDetId const &id) {
  return _me->getBinEntries(_qx->getBin(id));
}

/* virtual */ void
ContainerSingle1D::setBinContent(HcalTrigTowerDetId const &id, int x) {
  _me->setBinContent(_qx->getBin(id), x);
}
/* virtual */ void
ContainerSingle1D::setBinContent(HcalTrigTowerDetId const &id, double x) {
  _me->setBinContent(_qx->getBin(id), x);
}
