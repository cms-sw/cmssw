...
ContainerSingle2D::ContainerSingle2D(std::string const &folder, Quantity *qx,
...
/* virtual */ void ContainerSingle2D::initialize(std::string const &folder,
  ...
  Container::initialize(
      folder, qz->name() + "vs" + qy->name() + "vs" + qx->name(), debug);
  _qx = qx;
  _qy = qy;
  _qz = qz;
  _qx->setAxisType(quantity::fXAxis);
...
/* virtual */ void ContainerSingle2D::book(DQMStore::IBooker &ib,
  ...
  _me = ib.book2D(_qname + (aux.empty() ? aux : "_" + aux),
                  ...
                  _qx->min(), _qx->max(), _qy->nbins(), _qy->min(), _qy->max());
  customize();
}
...
/* virtual */ void ContainerSingle2D::load(DQMStore::IGetter &ig,
                                           std::string subsystem,
                                           std::string aux) {
  _me = ig.get(subsystem + "/" + _folder + "/" + _qname + "/" + _qname +
               (aux.empty() ? aux : "_" + aux));
}
...
/* virtual */ void ContainerSingle2D::setBinContent(double x, double y,
                                                    double z) {
  _me->setBinContent(_qx->getBin(x), _qy->getBin(y), z);
}
...
/* virtula */ double
ContainerSingle2D::getBinContent(HcalElectronicsId const &id) {
  return _me->getBinContent(_qx->getBin(id), _qy->getBin(id));
}
/* virtual */ double
ContainerSingle2D::getBinContent(HcalElectronicsId const &id, int x) {
  if (_qx->isCoordinate())
    return _me->getBinContent(_qx->getBin(id), _qy->getBin(x));
  else
    return _me->getBinContent(_qx->getBin(x), _qy->getBin(id));
...
/* virtual */ double
ContainerSingle2D::getBinContent(HcalElectronicsId const &id, double x) {
  if (_qx->isCoordinate())
    return _me->getBinContent(_qx->getBin(id), _qy->getBin(x));
  else
    return _me->getBinContent(_qx->getBin(x), _qy->getBin(id));
...
/* virtula */ double
ContainerSingle2D::getBinEntries(HcalElectronicsId const &id) {
  return _me->getBinEntries(_qx->getBin(id) +
                            _qx->wofnbins() * _qy->getBin(id));
}
/* virtual */ double
ContainerSingle2D::getBinEntries(HcalElectronicsId const &id, int x) {
  if (_qx->isCoordinate())
    return _me->getBinEntries(_qx->getBin(id) +
                              _qx->wofnbins() * _qy->getBin(x));
  else
...
/* virtual */ double
ContainerSingle2D::getBinEntries(HcalElectronicsId const &id, double x) {
  if (_qx->isCoordinate())
    return _me->getBinEntries(_qx->getBin(id) +
                              _qx->wofnbins() * _qy->getBin(x));
  else
...
/* virtula */ double
ContainerSingle2D::getBinContent(HcalTrigTowerDetId const &id) {
  return _me->getBinContent(_qx->getBin(id), _qy->getBin(id));
}
/* virtual */ double
ContainerSingle2D::getBinContent(HcalTrigTowerDetId const &id, int x) {
  if (_qx->isCoordinate())
    return _me->getBinContent(_qx->getBin(id), _qy->getBin(x));
  else
    return _me->getBinContent(_qx->getBin(x), _qy->getBin(id));
...
/* virtual */ double
ContainerSingle2D::getBinContent(HcalTrigTowerDetId const &id, double x) {
  if (_qx->isCoordinate())
    return _me->getBinContent(_qx->getBin(id), _qy->getBin(x));
  else
    return _me->getBinContent(_qx->getBin(x), _qy->getBin(id));
...
/* virtula */ double
ContainerSingle2D::getBinEntries(HcalTrigTowerDetId const &id) {
  return _me->getBinEntries(_qx->getBin(id) +
                            _qx->wofnbins() * _qy->getBin(id));
}
/* virtual */ double
ContainerSingle2D::getBinEntries(HcalTrigTowerDetId const &id, int x) {
  if (_qx->isCoordinate())
    return _me->getBinEntries(_qx->getBin(id) +
                              _qx->wofnbins() * _qy->getBin(x));
  else
...
/* virtual */ double
ContainerSingle2D::getBinEntries(HcalTrigTowerDetId const &id, double x) {
  if (_qx->isCoordinate())
    return _me->getBinEntries(_qx->getBin(id) +
                              _qx->wofnbins() * _qy->getBin(x));
  else
...
/* virtual */ void
ContainerSingle2D::setBinContent(HcalTrigTowerDetId const &id, int x) {
  _me->setBinContent(_qx->getBin(id), _qy->getBin(id), x);
}
/* virtual */ void
ContainerSingle2D::setBinContent(HcalTrigTowerDetId const &id, double x) {
  _me->setBinContent(_qx->getBin(id), _qy->getBin(id), x);
}
/* virtual */ void
ContainerSingle2D::setBinContent(HcalTrigTowerDetId const &id, int x, int y) {
  if (_qx->isCoordinate())
    _me->setBinContent(_qx->getBin(id), _qy->getBin(x), y);
  else
    _me->setBinContent(_qx->getBin(x), _qy->getBin(id), y);
