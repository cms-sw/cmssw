...
public:
  ...
  virtual void setBinContent(HcalElectronicsId const &id, int x, double y,
                             int) {
    setBinContent(id, x, y);
  }
  virtual void setBinContent(HcalElectronicsId const &id, double x, int y,
                             int) {
    setBinContent(id, x, y);
  }
  virtual void setBinContent(HcalElectronicsId const &id, double x, double y,
                             int) {
    setBinContent(id, x, y);
  }
  ...
  virtual double getBinEntries(HcalTrigTowerDetId const &tid, double x,
                               double) {
    return getBinEntries(tid, x);
  }
  ...
  virtual double getBinContent(HcalTrigTowerDetId const &tid, double x,
                               double) {
    return getBinContent(tid, x);
  }
  ...
  virtual void setBinContent(HcalTrigTowerDetId const &id, int x, double y,
                             int) {
    setBinContent(id, x, y);
  }
  virtual void setBinContent(HcalTrigTowerDetId const &id, double x, int y,
                             int) {
    setBinContent(id, x, y);
  }
  virtual void setBinContent(HcalTrigTowerDetId const &id, double x, double y,
                             int) {
    setBinContent(id, x, y);
  }
  virtual void setBinContent(HcalTrigTowerDetId const &id, int x, int y,
                             double) {
    setBinContent(id, x, y);
  }
  virtual void setBinContent(HcalTrigTowerDetId const &id, int x, double y,
