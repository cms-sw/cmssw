...
getValueType_did const getValue_functions_did[nDetectorQuantityType] = {
    getValue_iphi, getValue_ieta, getValue_depth, getValue_Subdet,
    getValue_SubdetPM};
...
getLabels_did const getLabels_functions_did[nDetectorQuantityType] = {
    getLabels_iphi, getLabels_ieta, getLabels_depth, getLabels_Subdet,
    getLabels_SubdetPM};
std::string const name_did[nDetectorQuantityType] = {"iphi", "ieta", "depth",
                                                     "Subdet", "SubdetPM"};
