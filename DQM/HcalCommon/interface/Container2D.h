...
public:
  Container2D();
  Container2D(
      std::string const &folder, hashfunctions::HashType, quantity::Quantity *,
      quantity::Quantity *,
  ...
  //	@nametitle,
  virtual void
  initialize(std::string const &folder, hashfunctions::HashType,
  ...
  virtual void
  initialize(std::string const &folder, std::string const &qname,
