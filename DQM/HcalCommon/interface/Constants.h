 ...
 */
    ...
    std::map<unsigned int, unsigned int> const fed2crate_map = {
        ...
        {1119, 22}, {1120, 29}, {1121, 29}, {1122, 32}, {1123, 32},
        {1124, 23}, {1125, 23}, {1126, 27}, {1127, 27}, {1128, 26}, {1129, 26}, {1130, 33}, {1131, 33},
        {1134, 38}, {1135, 38},
    };
    ...
    std::vector<unsigned int> const crateList = {3, 6, 7, 13, 20, 21, 22, 23, 24, 25, 26, 27, 29, 30, 31, 32, 33, 34, 35, 37, 38};
