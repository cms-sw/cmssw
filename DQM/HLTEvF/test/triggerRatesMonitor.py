...
process.triggerRatesMonitor.l1tResults = cms.untracked.InputTag('gtStage2Digis')
process.triggerRatesMonitor.hltResults = cms.untracked.InputTag('TriggerResults', '', 'HLT')
