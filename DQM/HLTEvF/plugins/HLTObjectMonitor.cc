...
class HLTObjectMonitor : public DQMEDAnalyzer {
  ...
  double dxyFinder(double, double, const edm::Handle<reco::RecoChargedCandidateCollection>&, const edm::Handle<reco::BeamSpot>&);
...
double HLTObjectMonitor::dxyFinder(double eta, double phi, const edm::Handle<reco::RecoChargedCandidateCollection>& recoChargedCands, const edm::Handle<reco::BeamSpot>& recoBeamSpot)
{
  double dxy = -99.;
