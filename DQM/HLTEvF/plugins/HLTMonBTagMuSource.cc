  ...
  m_plotL3Discriminator(0)
{
  ...
  m_L25TagInfoToken_ = consumes<reco::SoftLeptonTagInfoCollection>(config.getParameter<edm::InputTag>("L25TagInfo"));
  m_L25JetTagsToken_ = consumes<reco::JetTagCollection>(config.getParameter<edm::InputTag>("L25JetTags"));
  m_L3TagInfoToken_ = consumes<reco::SoftLeptonTagInfoCollection>(config.getParameter<edm::InputTag>("L3TagInfo"));
