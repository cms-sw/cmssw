...
void FSQDQM::bookHistograms(DQMStore::IBooker& bei, edm::Run const&, edm::EventSetup const&) {
  ...
  h_leadingtrkpt_ntrk_away =
      bei.bookProfile("h_leadingtrkpt_ntrk_away", "h_leadingtrkpt_ntrk_away", 50, 0, 50, 0, 30, " ");
  h_leadingtrkpt_ntrk_towards =
      bei.bookProfile("h_leadingtrkpt_ntrk_towards", "h_leadingtrkpt_ntrk_towards", 50, 0, 50, 0, 30, " ");
  h_leadingtrkpt_ntrk_transverse =
      bei.bookProfile("h_leadingtrkpt_ntrk_transverse", "h_leadingtrkpt_ntrk_transverse", 50, 0, 50, 0, 30, " ");
  h_leadingtrkpt_ptsum_away =
      bei.bookProfile("h_leadingtrkpt_ptsum_away", "h_leadingtrkpt_ptsum_away", 50, 0, 50, 0, 30, " ");
  h_leadingtrkpt_ptsum_towards =
      bei.bookProfile("h_leadingtrkpt_ptsum_towards", "h_leadingtrkpt_ptsum_towards", 50, 0, 50, 0, 30, " ");
  h_leadingtrkpt_ptsum_transverse =
      bei.bookProfile("h_leadingtrkpt_ptsum_transverse", "h_leadingtrkpt_ptsum_transverse", 50, 0, 50, 0, 30, " ");
}
