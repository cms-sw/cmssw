...
private:
  ...
  ///////////////////////////
  // Histograms - Dijet
  std::vector<MonitorElement*> dijet_PFJet1_pt;
  std::vector<MonitorElement*> dijet_PFJet1_eta;
  std::vector<MonitorElement*> dijet_PFJet1_phi;
  std::vector<MonitorElement*> dijet_PFJet1_rapidity;
  std::vector<MonitorElement*> dijet_PFJet1_mass;
  std::vector<MonitorElement*> dijet_PFJet2_pt;
  std::vector<MonitorElement*> dijet_PFJet2_eta;
  std::vector<MonitorElement*> dijet_PFJet2_phi;
  std::vector<MonitorElement*> dijet_PFJet2_rapidity;
  std::vector<MonitorElement*> dijet_PFJet2_mass;
  ...
  // Histograms - DiPhoton
  //
  MonitorElement* diphoton_Photon1_pt;
  MonitorElement* diphoton_Photon1_energy;
  MonitorElement* diphoton_Photon1_et;
  MonitorElement* diphoton_Photon1_eta;
  MonitorElement* diphoton_Photon1_etasc;
  MonitorElement* diphoton_Photon1_phi;
  MonitorElement* diphoton_Photon1_hovere_eb;
  MonitorElement* diphoton_Photon1_hovere_ee;
  MonitorElement* diphoton_Photon1_sigmaietaieta_eb;
  MonitorElement* diphoton_Photon1_sigmaietaieta_ee;
  MonitorElement* diphoton_Photon1_trksumptsolidconedr03_eb;
  MonitorElement* diphoton_Photon1_trksumptsolidconedr03_ee;
  MonitorElement* diphoton_Photon1_e1x5e5x5_eb;
  MonitorElement* diphoton_Photon1_e1x5e5x5_ee;
  MonitorElement* diphoton_Photon1_e2x5e5x5_eb;
  MonitorElement* diphoton_Photon1_e2x5e5x5_ee;
  MonitorElement* diphoton_Photon2_pt;
  MonitorElement* diphoton_Photon2_energy;
  MonitorElement* diphoton_Photon2_et;
  MonitorElement* diphoton_Photon2_eta;
  MonitorElement* diphoton_Photon2_etasc;
  MonitorElement* diphoton_Photon2_phi;
  MonitorElement* diphoton_Photon2_hovere_eb;
  MonitorElement* diphoton_Photon2_hovere_ee;
  MonitorElement* diphoton_Photon2_sigmaietaieta_eb;
  MonitorElement* diphoton_Photon2_sigmaietaieta_ee;
  MonitorElement* diphoton_Photon2_trksumptsolidconedr03_eb;
  MonitorElement* diphoton_Photon2_trksumptsolidconedr03_ee;
  MonitorElement* diphoton_Photon2_e1x5e5x5_eb;
  MonitorElement* diphoton_Photon2_e1x5e5x5_ee;
  MonitorElement* diphoton_Photon2_e2x5e5x5_eb;
  MonitorElement* diphoton_Photon2_e2x5e5x5_ee;
