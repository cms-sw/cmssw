...
private:
  ...
  edm::EDGetTokenT<reco::JetTagCollection> btagDeepCSVToken_;
  edm::EDGetTokenT<reco::JetTagCollection> btagDeepJetToken_;
  edm::EDGetTokenT<reco::JetTagCollection> btagParticleNetToken_;
  edm::EDGetTokenT<reco::JetTagCollection> btagRobustParTToken_;
  ...
  std::vector<MonitorElement*> Jet_btagDeepCSV;
  std::vector<MonitorElement*> Jet_btagDeepJet;
  std::vector<MonitorElement*> Jet_btagParticleNet;
  std::vector<MonitorElement*> Jet_btagRobustParT;
