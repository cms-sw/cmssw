...
template class SusyDQM<reco::Muon, reco::GsfElectron, reco::Photon, reco::PFJet, reco::PFMET>;
template class SusyDQM< pat::Muon, pat::Electron, pat::Photon, pat::Jet, pat::MET >;
