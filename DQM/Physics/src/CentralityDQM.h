...
private:
  ...
  MonitorElement* hi_track_pt;
  MonitorElement* hi_track_mul;
  MonitorElement* hi_track_eta;
  MonitorElement* hi_track_phi;

  MonitorElement* hi_hf_hf;
  MonitorElement* hi_hf_min;
  MonitorElement* hi_hf_plus;
  MonitorElement* hi_hf_minu_eta;
  MonitorElement* hi_hf_plus_eta;
  MonitorElement* hi_hf_hfhit;
  MonitorElement* hi_zdc_zdc;
  MonitorElement* hi_pix_npix;
  MonitorElement* hi_pix_tracks;
  MonitorElement* hi_tracks_ntracks;
  MonitorElement* hi_et_net;
  MonitorElement* hi_et_ee;
  MonitorElement* hi_ee_nee;
  MonitorElement* hi_ee_plus;
  MonitorElement* hi_ee_min;
  MonitorElement* hi_eb_eb;
  MonitorElement* hi_ver_vz;
