...
ewkMuDQM = cms.EDAnalyzer("EwkMuDQM",
      ...
      phoTag = cms.untracked.InputTag("slimmedPhotons"),
      # Main cuts ->
      ...
      TrackerHitsCut = cms.untracked.int32(5),  # Hits in inner track > 10
      PixelHitsCut = cms.untracked.int32(0),  # Pixel Hits  > 0
      MuonHitsCut = cms.untracked.int32(0),  # Valid Muon Hits  > 0
      IsAlsoTrackerMuon = cms.untracked.bool(True),
      NMatchesCut = cms.untracked.int32(1),  # At least 2 Chambers matched with segments
