...
#    process.simpleEleId70cIso          *
    ...
    process.dqmAk4PFCHSL1FastL2L3CorrectorChainChain * process.topSingleMuonMediumDQM     +
    #process.topSingleElectronLooseDQM  +
    process.dqmAk4PFCHSL1FastL2L3CorrectorChainChain * process.topSingleElectronMediumDQM +
    process.dqmAk4PFCHSL1FastL2L3CorrectorChainChain * process.singleTopMuonMediumDQM      +
    process.dqmAk4PFCHSL1FastL2L3CorrectorChainChain * process.singleTopElectronMediumDQM
)
