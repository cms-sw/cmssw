...
bool SiStripActionExecutor::readConfiguration()
{
  ...
  auto const fpath = pSet_.getUntrackedParameter<std::string>("SummaryConfigPath",
...
//
bool SiStripActionExecutor::readTkMapConfiguration(edm::EventSetup const& eSetup)
{
                                             ...
                                             DQMStore& dqm_store)
{
  ...
  auto const& detidList = edm::Service<SiStripDetInfoFileReader>{}->getAllDetIds();
