...
#include "DQM/SiStripMonitorClient/interface/TmModule.h"
#include <fstream>
#include <iostream>
...
TrackerMap::TrackerMap(string s) {
  
  int ntotmod=0;
  xsize=340;ysize=200;ix=0;iy=0; //used to compute the place of each layer in the tracker map
  firstcall = true;
