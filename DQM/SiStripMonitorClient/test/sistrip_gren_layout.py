...
dtlayout(dqmitems, "SiStrip_NumberOfDigis_Summary",
...
dtlayout(dqmitems, "SiStrip_NumberOfClusters_Summary",
...
dtlayout(dqmitems, "SiStrip_ClusterWidth_Summary",
...
dtlayout(dqmitems, "SiStrip_NumberOfDigis_Summary_TIB_Layer1",
