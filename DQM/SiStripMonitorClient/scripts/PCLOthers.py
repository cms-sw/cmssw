...
def main():
    ...
    dirERROR="DQMData/Run " + runNum + "/PixelPhase1/Run summary/SiPixelQualityPCL/BadROC_Other/"
                        ...
                        if hist2.GetBinContent(binx,biny)!=0 and check:
                            ...
                            if len(binTBM)!=0:
                                ...
                                if hist2.GetBinContent(binx,biny)!=0:
                                    binTBM.append(binx)
                c.SaveAs('MergedPCLOther_BPix_Layer{0}_TBM.pdf'.format(lyr))
                os.system('gs -dBATCH -dNOPAUSE -sDEVICE=png16m -dUseCropBox -sOutputFile=MergedPCLOther_BPix_Layer{0}_TBM.png -r144 -q MergedPCLOther_BPix_Layer{0}_TBM.pdf'.format(lyr))
                os.system('rm -f MergedPCLOther_BPix_Layer{0}_TBM.pdf'.format(lyr))
        else :
                    ...
                    for binx in range(1,hist2.GetNbinsX()+1):
                        ...
                        if hist2.GetBinContent(binx,biny)!=0 and check:
                            ...
                            if len(binTBM)!=0:
                                ...
                                if hist2.GetBinContent(binx,biny)!=0:
                                    binTBM.append(binx)
                c.SaveAs('MergedPCLOther_FPix_Ring{0}_TBM.pdf'.format(ring))
                os.system('gs -dBATCH -dNOPAUSE -sDEVICE=png16m -dUseCropBox -sOutputFile=MergedPCLOther_FPix_Ring{0}_TBM.png -r144 -q MergedPCLOther_FPix_Ring{0}_TBM.pdf'.format(ring))
                os.system('rm -f MergedPCLOther_FPix_Ring{0}_TBM.pdf'.format(ring))
