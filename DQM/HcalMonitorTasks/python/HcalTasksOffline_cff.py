...
# Require at least 2000 events for the dead cell monitor to process at end of lumi block?  Do we want this functionality in offline, or do we want to rely only on the never-present test?
