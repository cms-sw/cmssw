...
#    EELaserLedUncalibRecHit = cms.untracked.InputTag("ecalLaserLedUncalibRecHit", "EcalUncalibRecHitsEE"),
    ...
    EBCpuDigi = cms.untracked.InputTag("ecalDigisLegacy", "ebDigis"),
    EECpuDigi = cms.untracked.InputTag("ecalDigisLegacy", "eeDigis"),
    EBGpuDigi = cms.untracked.InputTag("ecalDigis", "ebDigis"),
    EEGpuDigi = cms.untracked.InputTag("ecalDigis", "eeDigis"),
    EBCpuUncalibRecHit = cms.untracked.InputTag("ecalMultiFitUncalibRecHitLegacy", "EcalUncalibRecHitsEB"),
