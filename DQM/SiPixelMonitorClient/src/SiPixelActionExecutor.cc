...
#include "DQM/SiPixelMonitorClient/interface/TrackerMap.h"
#include "DQM/SiPixelMonitorClient/interface/SiPixelUtility.h"
//#include "DQM/SiPixelMonitorClient/interface/SiStripQualityTester.h"
...
// -- Read Configuration File
//
bool SiPixelActionExecutor::readConfiguration(int& tkmap_freq, int& sum_freq) {
//  if (configParser_ == 0) {
//    configParser_ = new SiStripConfigParser();
//    configParser_->getDocument("sistrip_monitorelement_config.xml");
//  }
...
//  }
  ...
  mui->cd();
  SiPixelActionExecutor::DetMapType valueMap;
  ...
  int gval = 0;
  int bval = 0;
  for (SiPixelActionExecutor::DetMapType::const_iterator it = valueMap.begin();
       it != valueMap.end(); it++) {
...
//
void SiPixelActionExecutor::getValuesForTkMap(MonitorUserInterface* mui,
 vector<string> me_names, SiPixelActionExecutor::DetMapType & values) {
...
// -- Browse through the Folder Structure
//
void SiPixelActionExecutor::fillSummary(MonitorUserInterface* mui,
...
void SiPixelActionExecutor::createCollation(MonitorUserInterface * mui){
  ...
  for (vector<string>::iterator it = contentVec.begin();
    ...
    string coll_dir = "Collector/Collated/"
             +dir_path.substr(dir_path.find("SiPixel"),dir_path.size());
