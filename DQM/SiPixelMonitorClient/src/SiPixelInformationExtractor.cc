...
// 
void SiPixelInformationExtractor::fillSummaryHistoList(MonitorUserInterface * mui, string& str_name, vector<string>& histos){
  string currDir = mui->pwd();
...
// 
void SiPixelInformationExtractor::selectSummaryHistos(MonitorUserInterface * mui,string str_name, vector<string>& names, vector<MonitorElement*>& mes) {
...
// -- plot Summary Histos
//
void SiPixelInformationExtractor::plotSummaryHistos(MonitorUserInterface * mui,
...
//
void SiPixelInformationExtractor::readSummaryHistoList(MonitorUserInterface* mui, std::string& str_name, xgi::Output * out) {
