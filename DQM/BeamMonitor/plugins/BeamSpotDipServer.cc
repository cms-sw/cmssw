...
#include "DQM/BeamMonitor/dip-5.7.0/include/Dip.h"
#include "DQM/BeamMonitor/dip-5.7.0/include/DipFactory.h"
#include "DQM/BeamMonitor/dip-5.7.0/include/DipPublication.h"
#include "DQM/BeamMonitor/dip-5.7.0/include/DipTimestamp.h"
...
// read from database
{
  ...
  err_width_y = bs.GetBeamWidthYError();
      ...
      events = 0.; // not provided by BeamSpotOnlineObject
      meanPV = 0.; // not provided by BeamSpotOnlineObject
  err_meanPV = 0.; // not provided by BeamSpotOnlineObject
       rmsPV = 0.; // not provided by BeamSpotOnlineObject
   err_rmsPV = 0.; // not provided by BeamSpotOnlineObject
       maxPV = 0.; // not provided by BeamSpotOnlineObject
