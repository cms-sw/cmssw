...
void L1TStage2RegionalMuonCandComp::bookHistograms(DQMStore::IBooker& ibooker, const edm::Run&, const edm::EventSetup&) {
  ...
  muColl1link = ibooker.book1D("muColl1link", (muonColl1Title+" mismatching link"+trkAddrIgnoreText).c_str(), 36, 35.5, 71.5);
  muColl1link->setAxisTitle("Link", 1);
  muColl1processor = ibooker.book1D("muColl1processor", (muonColl1Title+" mismatching processor"+trkAddrIgnoreText).c_str(), 12, -0.5, 15.5);
  muColl1processor->setAxisTitle("Processor", 1);
  muColl1trackFinderType = ibooker.book1D("muColl1trackFinderType", (muonColl1Title+" mismatching track finder type"+trkAddrIgnoreText).c_str(), 5, -0.5, 4.5);
  ...
  muColl2link = ibooker.book1D("muColl2link", (muonColl2Title+" mismatching link"+trkAddrIgnoreText).c_str(), 36, 35.5, 71.5);
  muColl2link->setAxisTitle("Link", 1);
  muColl2processor = ibooker.book1D("muColl2processor", (muonColl2Title+" mismatching processor"+trkAddrIgnoreText).c_str(), 12, -0.5, 15.5);
  muColl2processor->setAxisTitle("Processor", 1);
  muColl2trackFinderType = ibooker.book1D("muColl2trackFinderType", (muonColl2Title+" mismatching track finder type"+trkAddrIgnoreText).c_str(), 5, -0.5, 4.5);
