...
void L1TStage2CaloLayer2::bookHistograms(DQMStore::IBooker &ibooker, edm::Run const&, edm::EventSetup const&)
{
  ...
  stage2CaloLayer2Asymmetry_ = ibooker.book1D("Assymetry", "Assymetry; Assymetry; Counts", 256, -0.5, 255.5);
  stage2CaloLayer2Centrality_ = ibooker.book1D("Centrality", "Centrality; Centrality; Counts", 8, 0, 8);
