...
void L1TStage2MuonComp::bookHistograms(DQMStore::IBooker& ibooker, const edm::Run&, const edm::EventSetup&) {
  ...
  muColl1hwPhi = ibooker.book1D("muColl1hwPhi", (muonColl1Title+" muon #phi mismatch").c_str(), 576, -0.5, 575.5);
  muColl1hwPhi->setAxisTitle("Hardware #phi", 1);
  muColl1hwCharge = ibooker.book1D("muColl1hwCharge", (muonColl1Title+" muon charge mismatch").c_str(), 2, -0.5, 1.5);
  muColl1hwCharge->setAxisTitle("Hardware charge", 1);
  muColl1hwChargeValid = ibooker.book1D("muColl1hwChargeValid", (muonColl1Title+" muon charge valid mismatch").c_str(), 2, -0.5, 1.5);
  muColl1hwChargeValid->setAxisTitle("Hardware charge valid", 1);
  muColl1hwQual = ibooker.book1D("muColl1hwQual", (muonColl1Title+" muon quality mismatch").c_str(), 16, -0.5, 15.5);
  muColl1hwQual->setAxisTitle("Hardware quality", 1);
  muColl1hwIso = ibooker.book1D("muColl1hwIso", (muonColl1Title+" muon isolation mismatch").c_str(), 4, -0.5, 3.5);
  muColl1hwIso->setAxisTitle("Hardware isolation", 1);
  muColl1Index = ibooker.book1D("muColl1Index", (muonColl1Title+" Input muon index mismatch").c_str(), 108, -0.5, 107.5);
  ...
  muColl2hwPhi = ibooker.book1D("muColl2hwPhi", (muonColl2Title+" muon #phi mismatch").c_str(), 576, -0.5, 575.5);
  muColl2hwPhi->setAxisTitle("Hardware #phi", 1);
  muColl2hwCharge = ibooker.book1D("muColl2hwCharge", (muonColl2Title+" muon charge mismatch").c_str(), 2, -0.5, 1.5);
  muColl2hwCharge->setAxisTitle("Hardware charge", 1);
  muColl2hwChargeValid = ibooker.book1D("muColl2hwChargeValid", (muonColl2Title+" muon charge valid mismatch").c_str(), 2, -0.5, 1.5);
  muColl2hwChargeValid->setAxisTitle("Hardware charge valid", 1);
  muColl2hwQual = ibooker.book1D("muColl2hwQual", (muonColl2Title+" muon quality mismatch").c_str(), 16, -0.5, 15.5);
  muColl2hwQual->setAxisTitle("Hardware quality", 1);
  muColl2hwIso = ibooker.book1D("muColl2hwIso", (muonColl2Title+" muon isolation mismatch").c_str(), 4, -0.5, 3.5);
  muColl2hwIso->setAxisTitle("Hardware isolation", 1);
  muColl2Index = ibooker.book1D("muColl2Index", (muonColl2Title+" Input muon index mismatch").c_str(), 108, -0.5, 107.5);
