...
l1Stage1GtHwValidation = cms.EDAnalyzer("L1GtHwValidation",
    ...
    L1GtDataDaqInputTag = cms.InputTag("gtStage1Digis"),
    ...
    L1GctDataInputTag = cms.InputTag("valCaloStage1LegacyFormatDigis"),   

    DQMStore = cms.untracked.bool(False),
    DirName = cms.untracked.string("L1TEMU/Stage1GTexpert"), 
