#ifndef SiStripMonitorTrackEfficiency_H
#define SiStripMonitorTrackEfficiency_H
...
class SiStripMonitorTrackEfficiency : public edm::EDAnalyzer {
 public:
  typedef TransientTrackingRecHit::ConstRecHitPointer ConstRecHitPointer;
  enum RecHitType { Single=0, Matched=1, Projected=2, Null=3};
  explicit SiStripMonitorTrackEfficiency(const edm::ParameterSet&);
