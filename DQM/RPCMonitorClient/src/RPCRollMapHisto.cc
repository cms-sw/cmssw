...
MonitorElement* RPCRollMapHisto::bookBarrel(IBooker& booker,
                                            const int wheel,
                                            const std::string& name,
                                            const std::string& title,
                                            const bool useRollInfo)
{
...
void RPCRollMapHisto::setBarrelRollAxis(MonitorElement* me, const int wheel, const int axis, const bool useRollInfo)
{
  ...
  if ( axis == 1 ) h->GetXaxis()->SetNoAlphanumeric(true);
  else if ( axis == 2 ) h->GetYaxis()->SetNoAlphanumeric(true);  

  const std::array<const std::string, 21> labelsRoll = {{
        "RB1in_B", "RB1in_F", "RB1out_B", "RB1out_F",
        "RB2in_B", "RB2in_F", "RB2out_B", "RB2out_F",
        "", // empty space reserved for the RB2in_M or RB2out_M
        "RB3-_B",  "RB3-_F", "RB3+_B", "RB3+_F",
        "RB4,-_B", "RB4,-_F", "RB4+_B", "RB4+_F",
        "RB4--_B", "RB4--_F", "RB4++_B", "RB4++_F"
  }};
  const std::array<const std::string, 21> labelsCh = {{
        "RB1in", "", "RB1out", "",
        "RB2in", "", "", "RB2out", "",
        "RB3-",  "", "RB3+", "",
        "RB4,-", "", "RB4+", "",
...
void RPCRollMapHisto::setEndcapRollAxis(MonitorElement* me, const int disk, const int axis, const bool useRollInfo)
{
  ...
  const std::array<const std::string, 6> labelsRoll = {{
    //"C", "Ring1 B", "A", 
    "C", "Ring2 B", "A", 
    "C", "Ring3 B", "A"
  }};
  const std::array<const std::string, 6> labelsCh = {{
    //"", "Ring1", "", 
    "", "Ring2", "", 
    "", "Ring3", ""
  }};
...
MonitorElement* RPCRollMapHisto::bookEndcap(IBooker& booker,
                                            const int disk,
                                            const std::string& name, 
                                            const std::string& title,
                                            const bool useRollInfo)
