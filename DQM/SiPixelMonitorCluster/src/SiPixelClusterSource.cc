...
void SiPixelClusterSource::getrococcupancy(DetId detId,const edm::DetSetVector<PixelDigi> diginp,const TrackerTopology* const tTopo,std::vector<MonitorElement*> meinput) {
...
void SiPixelClusterSource::getrococcupancye(DetId detId, auto const & clustColl, const TrackerTopology* const pTT,
