...
//-----------------------------------------------------------------------------------
{
  ...
  if(!trackEfficiency_ && tkTracks->size() == 1 ){
    ...
    (tkTracks->front()).getHitPattern().numberOfValidHits(reco::HitPattern::TRACK_HITS) > 8)
...
//-----------------------------------------------------------------------------------
{
  ...
  if( nUpMuon == 1)
  {
    ...
    if(isInTrackerAcceptance && (*staTracks)[idxUpMuon].getHitPattern().numberOfValidHits(reco::HitPattern::TRACK_HITS) > 28)
    {
      //---------------------------------------------------
