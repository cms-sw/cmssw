...
TrackMon = cms.EDFilter("TrackingMonitor",
    ...
    SeedProducer  = cms.InputTag("newSeedsFromTriplets"),
	...
	# Track |p|	
    TrackPBin = cms.int32(500),
    TrackPMin = cms.double(0),
    TrackPMax = cms.double(30),

	# Track pT
    TrackPtBin = cms.int32(1000),
    TrackPtMin = cms.double(0.1),
    TrackPtMax = cms.double(200),

	# Track px 
    TrackPxBin = cms.int32(1000),
    TrackPxMin = cms.double(-10.0),
    TrackPxMax = cms.double(10.0),

	# Track py
    TrackPyBin = cms.int32(1000),
    TrackPyMin = cms.double(-10.0),
    TrackPyMax = cms.double(10.0),
