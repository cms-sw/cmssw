...
class TrackAnalyzer 
{
	...
	void bookHistosForBeamSpot(DQMStore::IBooker & ibooker);
        ...
        void bookHistosForEfficiencyFromHitPatter(DQMStore::IBooker &ibooker, const edm::EventSetup & iSetup, std::string suffix);
	...
	void fillHistosForLScertification(const edm::EventSetup& iSetup, const reco::Track & track, std::string sname);
        ...
        void fillHistosForEfficiencyFromHitPatter(const reco::Track & track, std::string suffix, float monitoring);
