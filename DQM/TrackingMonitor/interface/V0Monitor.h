...
protected:
  ...
  MonitorElement* bookHisto1D(DQMStore::IBooker & ibooker,std::string name, const std::string& title, const std::string& xaxis, const std::string& yaxis, MEbinning binning);
  MonitorElement* bookHisto2D(DQMStore::IBooker & ibooker,std::string name, const std::string& title, const std::string& xaxis, const std::string& yaxis, MEbinning xbinning, MEbinning ybinning);
  MonitorElement* bookProfile(DQMStore::IBooker & ibooker,std::string name, const std::string& title, const std::string& xaxis, const std::string& yaxis, MEbinning xbinning, MEbinning ybinning);
