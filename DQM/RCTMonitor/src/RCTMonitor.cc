...
RCTMonitor::RCTMonitor(const edm::ParameterSet& iConfig)
    : m_nevts(0),
      ...
      m_enableMonitorDaemon(
          iConfig.getUntrackedParameter<bool>("EnableMonitorDaemon")),
...
void RCTMonitor::beginJob() { BookRCT(); }
...
void RCTMonitor::BookRCT() {
  ...
  m_rctIsoEmRankEtaPhi1 =
      m_dbe->book2D("RctIsoEmRankEtaPhi", "ISO EM RANK", PHIBINS, PHIMIN,
                    PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctIsoEmOccEtaPhi1 =
      m_dbe->book2D("RctIsoEmOccEtaPhi", "ISO EM OCCUPANCY", PHIBINS, PHIMIN,
                    PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctIsoEmRank1 =
      m_dbe->book1D("RctIsoEmRank", "ISO EM RANK", R6BINS, R6MIN, R6MAX);
  m_rctIsoEmRankEtaPhi10 =
      m_dbe->book2D("RctIsoEmRankEtaPhi10", "ISO EM RANK", PHIBINS, PHIMIN,
                    PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctIsoEmOccEtaPhi10 =
      m_dbe->book2D("RctIsoEmOccEtaPhi10", "ISO EM OCCUPANCY", PHIBINS, PHIMIN,
                    PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctIsoEmRank10 =
      m_dbe->book1D("RctIsoEmRank10", "ISO EM RANK", R6BINS, R6MIN, R6MAX);

  m_rctNonIsoEmRankEtaPhi1 =
      m_dbe->book2D("RctNonIsoEmRankEtaPhi", "NON-ISO EM RANK", PHIBINS, PHIMIN,
                    PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctNonIsoEmOccEtaPhi1 =
      m_dbe->book2D("RctNonIsoEmOccEtaPhi", "NON-ISO EM OCCUPANCY", PHIBINS,
                    PHIMIN, PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctNonIsoEmRank1 =
      m_dbe->book1D("RctNonIsoEmRank", "NON-ISO EM RANK", R6BINS, R6MIN, R6MAX);
  m_rctNonIsoEmRankEtaPhi10 =
      m_dbe->book2D("RctNonIsoEmRankEtaPhi10", "NON-ISO EM RANK", PHIBINS,
                    PHIMIN, PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctNonIsoEmOccEtaPhi10 =
      m_dbe->book2D("RctNonIsoEmOccEtaPhi10", "NON-ISO EM OCCUPANCY", PHIBINS,
                    PHIMIN, PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctNonIsoEmRank10 = m_dbe->book1D("RctNonIsoEmRank10", "NON-ISO EM RANK",
                                      R6BINS, R6MIN, R6MAX);

  m_rctRelaxedEmRankEtaPhi1 =
      m_dbe->book2D("RctRelaxedEmRankEtaPhi", "RELAXED EM RANK", PHIBINS,
                    PHIMIN, PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctRelaxedEmOccEtaPhi1 =
      m_dbe->book2D("RctRelaxedEmOccEtaPhi", "RELAXED EM OCCUPANCY", PHIBINS,
                    PHIMIN, PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctRelaxedEmRank1 = m_dbe->book1D("RctRelaxedEmRank", "RELAXED EM RANK",
                                      R6BINS, R6MIN, R6MAX);
  m_rctRelaxedEmRankEtaPhi10 =
      m_dbe->book2D("RctRelaxedEmRankEtaPhi", "RELAXED EM RANK", PHIBINS,
                    PHIMIN, PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctRelaxedEmOccEtaPhi10 =
      m_dbe->book2D("RctRelaxedEmOccEtaPhi10", "RELAXED EM OCCUPANCY", PHIBINS,
                    PHIMIN, PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctRelaxedEmRank10 = m_dbe->book1D("RctRelaxedEmRank", "RELAXED EM RANK",
                                       R6BINS, R6MIN, R6MAX);

  m_rctRegionsEtEtaPhi =
      m_dbe->book2D("RctRegionsEtEtaPhi", "REGION E_{T}", PHIBINS, PHIMIN,
                    PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctRegionsOccEtaPhi =
      m_dbe->book2D("RctRegionsOccEtaPhi", "REGION OCCUPANCY", PHIBINS, PHIMIN,
                    PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctTauVetoEtaPhi =
      m_dbe->book2D("RctTauVetoEtaPhi", "TAU VETO OCCUPANCY", PHIBINS, PHIMIN,
                    PHIMAX, ETABINS, ETAMIN, ETAMAX);
  m_rctRegionEt =
      m_dbe->book1D("RctRegionEt", "REGION E_{T}", R10BINS, R10MIN, R10MAX);
}
