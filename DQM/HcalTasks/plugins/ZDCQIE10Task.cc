...
void ZDCQIE10Task::_process(edm::Event const& e, edm::EventSetup const& es) {
	...
	for (int i = 0; i < digi.samples(); i++) {
		...
		sample[1][i] = QIE10_regular_fC[digi[i].adc()][digi[i].capid()];
		if ( i == 1 ){
			sample_ZDCp_TS1 = QIE10_regular_fC[digi[i].adc()][digi[i].capid()];
		}
		if ( i == 2){
			sample_ZDCp_TS2 = QIE10_regular_fC[digi[i].adc()][digi[i].capid()];
		}
		...
		sample[0][i] = QIE10_regular_fC[digi[i].adc()][digi[i].capid()];
		if ( i == 1 ){
			sample_ZDCm_TS1 = QIE10_regular_fC[digi[i].adc()][digi[i].capid()];
		}
		if ( i == 2){
			sample_ZDCm_TS2 = QIE10_regular_fC[digi[i].adc()][digi[i].capid()];
		}
        ...
        _cfC_EChannel[did()]->Fill(QIE10_regular_fC[digi[i].adc()][digi[i].capid()]);
        ...
        _cfC_vs_TS_EChannel[did()]->Fill(i, QIE10_regular_fC[digi[i].adc()][digi[i].capid()]);
	    }
