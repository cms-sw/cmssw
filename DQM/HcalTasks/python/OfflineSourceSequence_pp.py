...
_phase1_hcalOfflineSourceSequence.remove(digiTask)
_phase1_hcalOfflineSourceSequence.remove(recHitTask)
...
_phase2_hcalOfflineSourceSequence = cms.Sequence(recHitTask)
