...
run_num = '355184'
lum_num = 17
file_source = [f'/store/t0streamer/Data/ExpressCosmics/000/{run_num[:3]}/{run_num[3:]}/run{run_num}_ls{num:04}_streamExpressCosmics_StorageManager.dat' for num in range(1, lum_num)]
source = cms.Source("NewEventStreamFileReader",fileNames = cms.untracked.vstring(*file_source))
