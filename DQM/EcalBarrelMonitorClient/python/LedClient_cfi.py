...
ledClient = dict(
    ...
    MEs = dict(
        ...
        QualitySummary = dict(path = 'Summary/Calibration/LedClient led quality L%(wl)s', otype = 'EE', btype = 'SuperCrystal', kind = 'TH2F'),
        PNQualitySummary = dict(path = 'Summary/Calibration/LedClient PN quality L%(wl)s', otype = 'EEMEM', btype = 'Crystal', kind = 'TH2F')
    ),
    sources = dict(
