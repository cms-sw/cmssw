...
seedInputTag     ['siStripTripletStep'] = cms.InputTag("siStripTripletStepSeeds")
trackCandInputTag['siStripTripletStep'] = cms.InputTag("siStripTripletStepTrackCandidates")
trackSeedSizeBin ['siStripTripletStep'] = cms.int32(400)
trackSeedSizeMin ['siStripTripletStep'] = cms.double(0)
trackSeedSizeMax ['siStripTripletStep'] = cms.double(100000)                         
clusterLabel     ['siStripTripletStep'] = cms.vstring('Strip')
clusterBin       ['siStripTripletStep'] = cms.int32(500)
clusterMax       ['siStripTripletStep'] = cms.double(100000)
