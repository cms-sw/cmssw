...
highPurityPtRange0to1.cut = cms.string("obj.quality(reco::TrackBase::highPurity) && obj.pt() >= 0 && obj.pt() < 1 ")
...
numCutString    ['highPurityPtRange0to1'] = cms.string("") # default: " obj.pt() >= 1 & obj.quality(reco::TrackBase::highPurity) "
denCutString    ['highPurityPtRange0to1'] = cms.string(" obj.pt() >= 0 && obj.pt() < 1 ") # it is as in the default config (just be sure)

highPurityPtRange1to10 = trackSelector.clone()
highPurityPtRange1to10.cut = cms.string("obj.quality(reco::TrackBase::highPurity) && obj.pt() >= 1 && obj.pt() < 10 ")
...
numCutString    ['highPurityPtRange1to10'] = cms.string("") # default: " obj.pt() >= 1 & obj.quality(reco::TrackBase::highPurity) "
denCutString    ['highPurityPtRange1to10'] = cms.string(" obj.pt() >= 1 && obj.pt() < 10 ") # it is as in the default config (just be sure)


highPurityPt10 = trackSelector.clone()
highPurityPt10.cut = cms.string("obj.quality(reco::TrackBase::highPurity) && obj.pt() >= 10")
...
numCutString    ['highPurityPt10'] = cms.string("") # default: " obj.pt() >= 1 & obj.quality(reco::TrackBase::highPurity) "
denCutString    ['highPurityPt10'] = cms.string(" obj.pt() >= 10 ") # it is as in the default config (just be sure)


###### old monitored track collections
highPurityPt1 = trackSelector.clone()
highPurityPt1.cut = cms.string("obj.quality(reco::TrackBase::highPurity) & obj.pt() >= 1")
...
numCutString    ['highPurityPt1'] = cms.string("") # default: " obj.pt() >= 1 & obj.quality(reco::TrackBase::highPurity) "
denCutString    ['highPurityPt1'] = cms.string(" obj.pt() >= 1 ") # it is as in the default config (just be sure)
