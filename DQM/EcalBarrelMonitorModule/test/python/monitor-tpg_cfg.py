...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/users/dellaric/data/h4b.00015071.A.0.0.root')
)
...
process.ecalBarrelDataSequence = cms.Sequence(process.preScaler*process.ecalEBunpacker*process.ecal2006TBHodoscopeReconstructor*process.ecal2006TBTDCReconstructor*process.ecalUncalibHit*process.ecalRecHit*process.ecalTriggerPrimitiveDigis*process.ecalTriggerPrimitiveDigis2)
...
process.ecalTriggerPrimitiveDigis.Label = 'ecalEBunpacker'
...
process.ecalTriggerPrimitiveDigis2.Label = 'ecalEBunpacker'
...
process.ecalBarrelOccupancyTask.EcalTrigPrimDigiCollection = 'ecalTriggerPrimitiveDigis2'
