...
process.q = cms.Path(process.ecalDataSequence*~process.ecalPrescaler*process.hybridClusteringSequence*process.multi5x5BasicClustersCleaned*process.multi5x5SuperClustersCleaned)
