...
namespace sistrip {
  ...
  static const uint16_t SPY_DELAY_CHIP_BUFFER_SIZE_IN_BYTES = SPY_DELAY_CHIP_PAYLOAD_SIZE_IN_BYTES+8;               // Extra 8 bytes for counters
  ...
  inline uint16_t FEDSpyChannelUnpacker::sampleNumber() const
  {
    return currentSample_;
  }

  inline bool FEDSpyChannelUnpacker::hasData() const
  {
