...
double 
RazorVarProducer::CalcR(double MR, const TLorentzVector& ja, const TLorentzVector& jb, const edm::Handle<reco::CaloMETCollection>& inputMet, const std::vector<math::XYZTLorentzVector>& muons){
