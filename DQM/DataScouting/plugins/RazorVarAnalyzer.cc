...
RazorVarAnalyzer::RazorVarAnalyzer(const edm::ParameterSet &conf)
    : ScoutingAnalyzerBase(conf),
      m_eleCollectionTag(conf.getUntrackedParameter<edm::InputTag>(
          "eleCollectionName",
      ...
      m_muCollectionTag(conf.getUntrackedParameter<edm::InputTag>(
          "muCollectionName", edm::InputTag("hltL3MuonCandidates"))),
      m_razorVarCollectionTag(
          conf.getUntrackedParameter<edm::InputTag>("razorVarCollectionName")) {
  // set Token(-s)
  m_jetCollectionTagToken_ = consumes<reco::CaloJetCollection>(
      conf.getUntrackedParameter<edm::InputTag>(
          "jetCollectionName", edm::InputTag("hltCaloJetIDPassed")));
  ...
  m_eleCollectionTagToken_ = consumes<reco::ElectronCollection>(
      conf.getUntrackedParameter<edm::InputTag>(
          "eleCollectionName",
          edm::InputTag("hltPixelMatchElectronsActivity")));
  m_razorVarCollectionTagToken_ = consumes<std::vector<double>>(
      conf.getUntrackedParameter<edm::InputTag>("razorVarCollectionName"));
}
...
void RazorVarAnalyzer::bookHistograms(DQMStore::IBooker &iBooker,
  ...
  m_rsqMRFullyInc =
      bookH2withSumw2(iBooker, "rsqMRFullyInc", "M_{R} vs R^{2} (All Events)",
                      400, 0., 4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
  m_rsqMRInc4J =
      bookH2withSumw2(iBooker, "rsqMRInc4J", "M_{R} vs R^{2} (>= 4j)", 400, 0.,
                      4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
  m_rsqMRInc6J =
      bookH2withSumw2(iBooker, "rsqMRInc6J", "M_{R} vs R^{2} (>= 6j)", 400, 0.,
                      4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
  m_rsqMRInc8J =
      bookH2withSumw2(iBooker, "rsqMRInc8J", "M_{R} vs R^{2} (>= 8j)", 400, 0.,
                      4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
  m_rsqMRInc10J =
      bookH2withSumw2(iBooker, "rsqMRInc10J", "M_{R} vs R^{2} (>= 10j)", 400,
                      0., 4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
  m_rsqMRInc12J =
      bookH2withSumw2(iBooker, "rsqMRInc12J", "M_{R} vs R^{2} (>= 12j)", 400,
                      0., 4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
  m_rsqMRInc14J =
      bookH2withSumw2(iBooker, "rsqMRInc14J", "M_{R} vs R^{2} (>= 14j)", 400,
                      0., 4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");

  // the by box histograms
  m_rsqMREleMu =
      bookH2withSumw2(iBooker, "rsqMREleMu", "M_{R} vs R^{2} (EleMu box)", 400,
                      0., 4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
  m_rsqMRMuMu =
      bookH2withSumw2(iBooker, "rsqMRMuMu", "M_{R} vs R^{2} (MuMu box)", 400,
                      0., 4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
  m_rsqMREleEle =
      bookH2withSumw2(iBooker, "rsqMREleEle", "M_{R} vs R^{2} (EleEle box)",
                      400, 0., 4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
  m_rsqMRMu =
      bookH2withSumw2(iBooker, "rsqMRMu", "M_{R} vs R^{2} (Mu box)", 400, 0.,
                      4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
  m_rsqMREle =
      bookH2withSumw2(iBooker, "rsqMREle", "M_{R} vs R^{2} (Ele box)", 400, 0.,
                      4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
  m_rsqMRHad =
      bookH2withSumw2(iBooker, "rsqMRHad", "M_{R} vs R^{2} (Had box)", 400, 0.,
                      4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");

  // the by box histograms
  m_rsqMRMuMJ =
      bookH2withSumw2(iBooker, "rsqMRMuMJ", "M_{R} vs R^{2} (Mu box >= 4j)",
                      400, 0., 4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
  m_rsqMREleMJ =
      bookH2withSumw2(iBooker, "rsqMREleMJ", "M_{R} vs R^{2} (Ele box >= 5j)",
                      400, 0., 4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
  m_rsqMRHadMJ =
      bookH2withSumw2(iBooker, "rsqMRHadMJ", "M_{R} vs R^{2} (Had box >= 6j)",
                      400, 0., 4000., 50, 0., 1., "M_{R} [GeV]", "R^{2}");
}
...
void RazorVarAnalyzer::analyze(const edm::Event &iEvent,
  ...
  if (muon_handle.isValid()) {
    for (std::vector<reco::RecoChargedCandidate>::const_iterator it =
             muon_handle->begin();
         it != muon_handle->end(); ++it) {
  ...
  if (ele_handle.isValid()) {
    for (reco::ElectronCollection::const_iterator it = ele_handle->begin();
         it != ele_handle->end(); ++it) {
