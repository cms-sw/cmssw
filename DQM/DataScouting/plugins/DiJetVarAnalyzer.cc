...
DiJetVarAnalyzer::DiJetVarAnalyzer(const edm::ParameterSet &conf)
    : ScoutingAnalyzerBase(conf),
      jetCollectionTag_(
          conf.getUntrackedParameter<edm::InputTag>("jetCollectionTag")),
      widejetsCollectionTag_(
          conf.getUntrackedParameter<edm::InputTag>("widejetsCollectionTag")),
      metCollectionTag_(
          conf.getUntrackedParameter<edm::InputTag>("metCollectionTag")),
      metCleanCollectionTag_(
          conf.getUntrackedParameter<edm::InputTag>("metCleanCollectionTag")),
      ...
      HLTpathMain_(triggerExpression::parse(
          conf.getParameter<std::string>("HLTpathMain"))),
      HLTpathMonitor_(triggerExpression::parse(
          conf.getParameter<std::string>("HLTpathMonitor"))),
      triggerConfiguration_(conf.getParameterSet("triggerConfiguration"),
                            consumesCollector()) {
  // set Token(-s)
  jetCollectionTagToken_ = consumes<reco::CaloJetCollection>(
      conf.getUntrackedParameter<edm::InputTag>("jetCollectionTag"));
  widejetsCollectionTagToken_ =
      consumes<std::vector<math::PtEtaPhiMLorentzVector>>(
          conf.getUntrackedParameter<edm::InputTag>("widejetsCollectionTag"));
  metCollectionTagToken_ = consumes<reco::CaloMETCollection>(
      conf.getUntrackedParameter<edm::InputTag>("metCollectionTag"));
  metCleanCollectionTagToken_ = consumes<reco::CaloMETCollection>(
      conf.getUntrackedParameter<edm::InputTag>("metCleanCollectionTag"));
}
...
void DiJetVarAnalyzer::bookHistograms(DQMStore::IBooker &iBooker,
  ...
  float massBins[N_mass_bins + 1] = {
      1,    3,    6,    10,   16,   23,   31,   40,   50,   61,   74,   88,
      103,  119,  137,  156,  176,  197,  220,  244,  270,  296,  325,  354,
      386,  419,  453,  489,  526,  565,  606,  649,  693,  740,  788,  838,
      890,  944,  1000, 1058, 1118, 1181, 1246, 1313, 1383, 1455, 1530, 1607,
      1687, 1770, 1856, 1945, 2037, 2132, 2231, 2332, 2438, 2546, 2659, 2775,
      2895, 3019, 3147, 3279, 3416, 3558, 3704, 3854, 4010, 4171, 4337, 4509,
      4686, 4869, 5058, 5253, 5455, 5663, 5877, 6099, 6328, 6564, 6808, 7000};

  // 1D histograms
  m_cutFlow = bookH1withSumw2(iBooker, "h1_cutFlow", "Cut Flow", 7, 0., 7.,
  ...
  m_MjjWide_finalSel = bookH1withSumw2(
      iBooker, "h1_MjjWide_finalSel", "M_{jj} WideJets (final selection)", 8000,
      0., 8000., "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_finalSel_varbin = bookH1withSumw2BinArray(
      iBooker, "h1_MjjWide_finalSel_varbin",
      "M_{jj} WideJets (final selection)", N_mass_bins, massBins,
      "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_finalSel_WithoutNoiseFilter = bookH1withSumw2(
      iBooker, "h1_MjjWide_finalSel_WithoutNoiseFilter",
      "M_{jj} WideJets (final selection, without noise filters)", 8000, 0.,
      8000., "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_finalSel_WithoutNoiseFilter_varbin = bookH1withSumw2BinArray(
      iBooker, "h1_MjjWide_finalSel_WithoutNoiseFilter_varbin",
      "M_{jj} WideJets (final selection, without noise filters)", N_mass_bins,
      massBins, "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_deta_0p0_0p5 =
      bookH1withSumw2(iBooker, "h1_MjjWide_deta_0p0_0p5",
                      "M_{jj} WideJets (0.0<=#Delta#eta<0.5)", 8000, 0., 8000.,
                      "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_deta_0p5_1p0 =
      bookH1withSumw2(iBooker, "h1_MjjWide_deta_0p5_1p0",
                      "M_{jj} WideJets (0.5<=#Delta#eta<1.0)", 8000, 0., 8000.,
                      "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_deta_1p0_1p5 =
      bookH1withSumw2(iBooker, "h1_MjjWide_deta_1p0_1p5",
                      "M_{jj} WideJets (1.0<=#Delta#eta<1.5)", 8000, 0., 8000.,
                      "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_deta_1p5_2p0 =
      bookH1withSumw2(iBooker, "h1_MjjWide_deta_1p5_2p0",
                      "M_{jj} WideJets (1.5<=#Delta#eta<2.0)", 8000, 0., 8000.,
                      "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_deta_2p0_2p5 =
      bookH1withSumw2(iBooker, "h1_MjjWide_deta_2p0_2p5",
                      "M_{jj} WideJets (2.0<=#Delta#eta<2.5)", 8000, 0., 8000.,
                      "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_deta_2p5_3p0 =
      bookH1withSumw2(iBooker, "h1_MjjWide_deta_2p5_3p0",
                      "M_{jj} WideJets (2.5<=#Delta#eta<3.0)", 8000, 0., 8000.,
                      "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_deta_3p0_inf = bookH1withSumw2(
      iBooker, "h1_MjjWide_deta_3p0_inf", "M_{jj} WideJets (#Delta#eta>=3.0)",
      8000, 0., 8000., "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_den_NOdeta = bookH1withSumw2(
      iBooker, "h1_MjjWide_den_NOdeta", "HLT Efficiency Studies (no deta cut)",
      400, 0., 2000., "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_num_NOdeta = bookH1withSumw2(
      iBooker, "h1_MjjWide_num_NOdeta", "HLT Efficiency Studies (no deta cut)",
      400, 0., 2000., "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_den_detaL4 =
      bookH1withSumw2(iBooker, "h1_MjjWide_den_detaL4",
                      "HLT Efficiency Studies (deta cut < 4.0)", 400, 0., 2000.,
                      "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_num_detaL4 =
      bookH1withSumw2(iBooker, "h1_MjjWide_num_detaL4",
                      "HLT Efficiency Studies (deta cut < 4.0)", 400, 0., 2000.,
                      "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_den_detaL3 =
      bookH1withSumw2(iBooker, "h1_MjjWide_den_detaL3",
                      "HLT Efficiency Studies (deta cut < 3.0)", 400, 0., 2000.,
                      "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_num_detaL3 =
      bookH1withSumw2(iBooker, "h1_MjjWide_num_detaL3",
                      "HLT Efficiency Studies (deta cut < 3.0)", 400, 0., 2000.,
                      "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_den_detaL2 =
      bookH1withSumw2(iBooker, "h1_MjjWide_den_detaL2",
                      "HLT Efficiency Studies (deta cut < 2.0)", 400, 0., 2000.,
                      "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_num_detaL2 =
      bookH1withSumw2(iBooker, "h1_MjjWide_num_detaL2",
                      "HLT Efficiency Studies (deta cut < 2.0)", 400, 0., 2000.,
                      "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_den = bookH1withSumw2(
      iBooker, "h1_MjjWide_den", "HLT Efficiency Studies (default deta cut)",
      400, 0., 2000., "M_{jj} WideJets [GeV]", "Number of events");

  m_MjjWide_num = bookH1withSumw2(
      iBooker, "h1_MjjWide_num", "HLT Efficiency Studies (default deta cut)",
      400, 0., 2000., "M_{jj} WideJets [GeV]", "Number of events");

  m_DetajjWide_finalSel =
      bookH1withSumw2(iBooker, "h1_DetajjWide_finalSel",
                      "#Delta#eta_{jj} WideJets (final selection)", 100, 0., 5.,
                      "#Delta#eta_{jj} WideJets", "Number of events");

  m_DetajjWide = bookH1withSumw2(
      iBooker, "h1_DetajjWide",
      "#Delta#eta_{jj} WideJets (final selection except #Delta#eta cut)", 100,
      0., 5., "#Delta#eta_{jj} WideJets", "Number of events");

  m_DphijjWide_finalSel =
      bookH1withSumw2(iBooker, "h1_DphijjWide_finalSel",
                      "#Delta#phi_{jj} WideJets (final selection)", 100, 0.,
                      TMath::Pi() + 0.0001, "#Delta#phi_{jj} WideJets [rad.]",
                      "Number of events");

  m_selJets_pt =
      bookH1withSumw2(iBooker, "h1_selJets_pt", "Selected CaloJets", 500, 0.,
                      5000., "Jet Pt [GeV]", "Number of events");

  m_selJets_eta =
      bookH1withSumw2(iBooker, "h1_selJets_eta", "Selected CaloJets", 100, -5.,
                      5., "#eta", "Number of events");

  m_selJets_phi = bookH1withSumw2(
      iBooker, "h1_selJets_phi", "Selected CaloJets", 100, -TMath::Pi(),
      TMath::Pi(), "#phi (rad.)", "Number of events");

  m_selJets_hadEnergyFraction = bookH1withSumw2(
      iBooker, "h1_selJets_hadEnergyFraction", "Selected CaloJets", 110, 0.,
      1.1, "HAD Energy Fraction", "Number of events");

  m_selJets_emEnergyFraction = bookH1withSumw2(
      iBooker, "h1_selJets_emEnergyFraction", "Selected CaloJets", 110, 0., 1.1,
      "EM Energy Fraction", "Number of events");

  m_selJets_towersArea =
      bookH1withSumw2(iBooker, "h1_selJets_towersArea", "Selected CaloJets",
                      200, 0., 2., "towers area", "Number of events");

  m_metDiff =
      bookH1withSumw2(iBooker, "h1_metDiff", "Met - MetCleaned", 500, -1000.,
                      1000., "met - metcleaned [GeV]", "Number of events");

  m_metCases = bookH1withSumw2(iBooker, "h1_metCases", "Met cases", 3, 0., 3.,
  ...
  m_metCaseNoMetClean =
      bookH1withSumw2(iBooker, "h1_metCaseNoMetClean", "Met - MetCleaned", 1000,
                      0., 2000., "MET [GeV]", "Number of events");

  m_HT_inclusive =
      bookH1withSumw2(iBooker, "h1_HT_inclusive", "HT (inclusive)", 150, 0.,
                      15000., "HT [GeV]", "Number of events");

  m_HT_finalSel =
      bookH1withSumw2(iBooker, "h1_HT_finalSel", "HT (final selection)", 150,
                      0., 15000., "HT [GeV]", "Number of events");

  // 2D histograms
  m_DetajjVsMjjWide = bookH2withSumw2(
      iBooker, "h2_DetajjVsMjjWide", "#Delta#eta_{jj} vs M_{jj} WideJets", 8000,
      0., 8000., 100, 0., 5., "M_{jj} WideJets [GeV]",
      "#Delta#eta_{jj} WideJets");

  m_DetajjVsMjjWide_rebin = bookH2withSumw2(
      iBooker, "h2_DetajjVsMjjWide_rebin", "#Delta#eta_{jj} vs M_{jj} WideJets",
      400, 0., 8000., 50, 0., 5., "M_{jj} WideJets [GeV]",
      "#Delta#eta_{jj} WideJets");

  m_metVSmetclean =
      bookH2withSumw2(iBooker, "h2_metVSmetclean", "MET clean vs MET", 100, 0.,
                      2000., 100, 0., 2000., "MET [GeV]", "MET clean [GeV]");
}
...
void DiJetVarAnalyzer::analyze(const edm::Event &iEvent,
  ...
  if (widejets_handle->size() >= 2) {
    wj1.SetPtEtaPhiM(widejets_handle->at(0).pt(), widejets_handle->at(0).eta(),
                     widejets_handle->at(0).phi(),
                     widejets_handle->at(0).mass());
    wj2.SetPtEtaPhiM(widejets_handle->at(1).pt(), widejets_handle->at(1).eta(),
  ...
  if (calomet_handle.isValid() && calometClean_handle.isValid()) {
    ...
    //       "---" << std::endl;
    m_metCases->Fill(0);
    m_metDiff->Fill((calomet_handle->front()).pt() -
                    (calometClean_handle->front()).pt());
    m_metVSmetclean->Fill((calomet_handle->front()).pt(),
                          (calometClean_handle->front()).pt());
  ...
  if (calojets_handle->size() >= numwidejets_) {
    ...
    // << thisJet->phi() << endl;
    if (thisJet->energyFractionHadronic() > maxHADfraction_ ||
        thisJet->emEnergyFraction() > maxEMfraction_)
  ...
  // Met filter
  if (calomet_handle.isValid() && calometClean_handle.isValid()) {
    if (fabs((calomet_handle->front()).pt() -
             (calometClean_handle->front()).pt()) > 0.1)
      pass_metFilter = false;
  }
  // Full selection (no deta cut)
  if (pass_nocut && pass_twowidejets && pass_etaptcuts && pass_JetIDtwojets &&
      pass_dphi && pass_metFilter)
    pass_fullsel_NOdeta = true;
  // Full selection (various deta cuts)
  if (pass_nocut && pass_twowidejets && pass_etaptcuts && pass_JetIDtwojets &&
      pass_dphi && pass_metFilter && pass_deta_L4)
    pass_fullsel_detaL4 = true;
  if (pass_nocut && pass_twowidejets && pass_etaptcuts && pass_JetIDtwojets &&
      pass_dphi && pass_metFilter && pass_deta_L3)
    pass_fullsel_detaL3 = true;
  if (pass_nocut && pass_twowidejets && pass_etaptcuts && pass_JetIDtwojets &&
      pass_dphi && pass_metFilter && pass_deta_L2)
    pass_fullsel_detaL2 = true;
  // Full selection (default deta cut)
  if (pass_nocut && pass_twowidejets && pass_etaptcuts && pass_deta &&
      pass_JetIDtwojets && pass_dphi && pass_metFilter)
    pass_fullsel = true;
  ...
  if (HLTpathMain_ and HLTpathMonitor_ and
      triggerConfiguration_.setEvent(iEvent, c)) {
