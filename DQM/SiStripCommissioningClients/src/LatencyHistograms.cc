...
// -----------------------------------------------------------------------------
/** */
LatencyHistograms::LatencyHistograms( DQMStore* bei ) 
...
// -----------------------------------------------------------------------------
/** */
LatencyHistograms::LatencyHistograms( DQMOldReceiver* mui ) 
...
// -----------------------------------------------------------------------------	 
/** */	 
void LatencyHistograms::histoAnalysis( bool debug ) {
  ...
  for ( ; iter != histos().end(); iter++ ) {
    ...
    LatencyAnalysis anal( iter->first );
    anal.analysis( profs );
...
// -----------------------------------------------------------------------------
/** */
void LatencyHistograms::createSummaryHisto( const sistrip::Monitorable& mon, 
