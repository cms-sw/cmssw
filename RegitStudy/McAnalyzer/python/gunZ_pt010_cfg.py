...
generator = cms.EDProducer("Pythia6PtYDistGun",
        ...
        kinematicsFile = cms.FileInPath('HeavyIonsAnalysis/Configuration/data/jpsipbpb.root'),
        ...
        #PythiaNoRadiation = cms.vstring('MSTP(61)=0','MSTP(71)=0'),
        ...
        parameterSets = cms.vstring('pythiaZtoMuons')#,'PythiaNoRadiation')
        )
                           )
