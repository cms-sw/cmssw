...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/home/llr/cms/chapon/data_CMS/regit_dev_7X/CMSSW_7_2_0_pre5/test/pythiagun_jpsi_gen.root')
)
...
process.reconstruction_step = cms.Path(process.reconstructionHeavyIons*process.regionalMuonRecoPbPb)
