...
process.source = cms.Source("PoolSource",
      fileNames = cms.untracked.vstring("file:/tmp/echapon/pythiagun_bJpsi_step2_pp_100_1_PSX.root"),
...
process.reGlbMuonAssociatorByHits.tracksTag                     = cms.InputTag('globalMuons')
...
process.mcmatchanalysis = cms.EDAnalyzer("McMatchTrackAnalyzer",
                                         ...
                                         type2Tracks        = cms.untracked.InputTag("globalMuons"),
                                         type2MapTag        = cms.untracked.InputTag("GlbMuonAssociatorByHits"),
...
# centrality is not there in pp reco -> we need to create it
# process.load('RecoHI.HiCentralityAlgos.HiCentrality_cfi')
# process.prodcent = cms.Path(process.hiCentrality)
