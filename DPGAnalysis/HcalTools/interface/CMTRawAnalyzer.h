...
const int nsub = 4;  const int ndepth = 7; 
const int neta = 82;  const int nphi = 72;   float bphi = 72.;
const int zneta = 22;  const int znphi = 18;   float zbphi= 18.;
const int npfit = 220; float anpfit = 220.;// for SiPM:
