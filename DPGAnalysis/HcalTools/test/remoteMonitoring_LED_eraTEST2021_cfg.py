...
#      fileName = cms.string("LED_run377804.root")
 #     fileName = cms.string("LED_run377449.root")
      fileName = cms.string("LED_run346610.root")
...
#                            firstRun = cms.untracked.uint32(329416),
         ...
         '/store/group/dpg_hcal/comm_hcal/USC/run346610/USC_346610.root',
#         '/store/group/dpg_hcal/comm_hcal/USC/run377449/USC_377449.root',
#         '/store/group/dpg_hcal/comm_hcal/USC/run377804/USC_377804.root',
), 
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
                                  ...
                                  ratioHBMin = cms.double(0.80),
                                  ratioHBMax = cms.double(1.04),
                                  ratioHEMin = cms.double(0.85),
                                  ratioHEMax = cms.double(1.04),
                                  ...
                                  rmsHBMax = cms.double(1.5),
                                  rmsHEMin = cms.double(0.6),
                                  rmsHEMax = cms.double(1.09),
