...
int main(int argc, char *argv[])
{
  ...
  //
 TString MethodName[NMethods] = { "PLOT0", "PLOT1", "PLOT2", "PLOT3", "PLOT4", "PLOT5" , "PLOT6" , "PLOT7" , "PLOT8" , "PLOT9" , "PLOT10"  , "PLOT11" , "PLOT12" , "PLOT13" };
//______________________________________________________________________________________________________________________________    
 ...
 TString LEDrunsM[NMAXM] = {
   // reference first run 315812 has Local run key: LED - 2000 events, masks: HCAL_Laser 
"315812","315984","316826","317116","317193","317268","317271","317273","317363","317444","317606","317607","317609","317610","317611","317612","317613","317617","317785","318758","319198","319401","319517","319519","319520",
"319564","319612","319734","319771","319774","319857","319969","320117","320158","320203","320205","320348","320579","320873","320892","320952","321019","321036","321187","321339","321359","321371","321447","321514",         
         "322781","322782","323314","323502","323579","323613","323742","324030","324032","324138","324225","324296","324919","325141","325787","326234",         "326875","327288","327438","327552","327579"                                                                    

 };
    cout << "********************************************************************* first massives defined " <<  endl;
 Float_t X0M[NMAXM] = {

   0.,      2.,     17.,     22.,      23.,    24.,      24.,     24.,    27.,     29.,     32.,      32.,     32.,     32.,     32.,     32.,     32.,     32.,     38.,     51.,     58.,    63.,     65.,     65.,     65.,   
  66.,     68.,     70.,     71.,     71.,     72.,      74.,     77.,    78.,     79.,     79.,      80.,     85.,     90.,     91.,     92.,     93.,     93.,     98.,    101.,     101.,  101.,    104.,    106.,            
          129.,    129.,    138.,    141.,    142.,     143.,    146.,   150.,    150.,    151.,     153.,    155.,    165.,    169.,    179.,    183.,             195.,    203.,     205.,  208.,    209.,                                                               
 ...
 //TCanvas  *c1 = new TCanvas("c1","GSM",20,50,920,850);
  ...
  //          Float_t x1=0.00; Float_t x2=45.00;
          Float_t x1=0.00; Float_t x2=215.0;


  // y(ordinate) for All Days
	  //  Float_t y1=0.985; Float_t y2=  1.015; 
    Float_t y1=0.9; Float_t y2=  1.1; 
  ...
  //-----------------------------------------------------------------------------------------------------
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  const Int_t NDEP =3;const Int_t NETA0=83;const Int_t NPHI0=73;
  //  const Int_t NDEP =5;const Int_t NETA0=83;const Int_t NPHI0=73;
  //
  Double_t mapRATIO[NDEP][NETA0][NPHI0]; Double_t mapRATIOD2[NETA0][NPHI0]; Int_t mapRATIOD20[NETA0][NPHI0]; 

  //Double_t normalization[NDEP][NETA0][NPHI0]; 
  Double_t normalization[NETA0][NPHI0]; 
    cout << "************************************** NDEP = " << NDEP  << "  NETA0 = " << NETA0  << "  NPHI0 = " << NPHI0  <<  endl;
...
Double_t GSMRATIOD2[NMAXSIZE][NETA0][NPHI0]; 
  ...
  if(yearcase == 1 ) {
    ...
    cout << "************************************** NMINmM = " << NMINmM  << " NMAXmM  = " << NMAXmM  << " NMAXaM  = " << NMAXaM  <<  endl;
  ...
  Int_t NMAX = 0;
	...
	//    Double_t cutMinA =50000.; Double_t cutMaxA = 150000.;
        Double_t cutMinA =100.; Double_t cutMaxA = 5000.;
...
//      TH2F *twod4= (TH2F*)hfile->Get("h_mapDepth4ADCAmpl_HB");
	...
	// HBP17 selection:   
	if(flagHBP17selection == 0 || (flagHBP17selection == 1 && ( (( jjj > 56 && jjj < 62 ) && (kkk >63 && kkk < 68 )) || (( jjj > 61 && jjj < 71 ) && (kkk == 64 || kkk == 66 )))) ||  (flagHBP17selection == 2 && !( (( jjj > 14 && jjj < 25 ) && (kkk >55 && kkk < 64 ))) ) ) {
...
*/
	...
	if(normalization[jjj][kkk] != 0 ) {
	  ...
	  else{if(GSMRATIOD2[k1][jjj][kkk]>0.) BADruns->Fill(float(k1));} // fill #channels outside  R  unit
...
*/
    ...
    if(Method == 7 ) {
      ...
      for (int jjj=1;jjj<=cx;jjj++) {
		if( BADruns->GetBinContent(jjj) >200.) {cout<<"BADruns w/ content>60:   jjj= " << jjj  <<" run= " <<   LEDruns[jjj-1]    <<"  R ouside unit-range for # channels= " << BADruns->GetBinContent(jjj) <<endl;++nbadruns;}
