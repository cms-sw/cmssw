...
CMTRawAnalyzer::CMTRawAnalyzer(const edm::ParameterSet& iConfig){
  ...
  for(int k0 = 0; k0<nsub; k0++) {
	...
	if(k0 == 1) {mapRADDAM_HED2[k1][k2] = 0.;mapRADDAM_HED20[k1][k2] = 0.;}
	for(int k3 = 0; k3<nphi; k3++) {
	  ...
	  if(k0 == 1) {mapRADDAM_HE[k1][k2][k3] = 0.;mapRADDAM0_HE[k1][k2][k3] = 0;}
	}//for  
      }//for  
    }//for  
  }//for  
	...
	for(int k3 = 0; k3<nphi; k3++) {
	  for(int k2 = 0; k2<neta; k2++) {
		...
		if(k1+1  ==3) {
		  ...
		  if(bbbc/bbb1 > lsdep_estimator1_HBdepth3_    ) h_sumCutADCAmplperLSdepth3HBu->Fill( float(lscounterM1) ,bbbc); 
		  h_sum0ADCAmplperLSdepth3HBu->Fill( float(lscounterM1) ,bbb1);

		  if(bbbc/bbb1 > lsdep_estimator1_HBdepth3_    ) h_2DsumADCAmplLSdepth3HBu->Fill(double(ieta), double(k3), bbbc);
		...
		if(k1+1  ==4) {
		  ...
		  if(bbbc/bbb1 > lsdep_estimator1_HBdepth4_    ) h_sumCutADCAmplperLSdepth4HBu->Fill( float(lscounterM1) ,bbbc); 
		  h_sum0ADCAmplperLSdepth4HBu->Fill( float(lscounterM1) ,bbb1);

		  if(bbbc/bbb1 > lsdep_estimator1_HBdepth4_    ) h_2DsumADCAmplLSdepth4HBu->Fill(double(ieta), double(k3), bbbc);
		...
		if(k1+1  ==4) {
		  ...
		  if(bbbc/bbb1 > lsdep_estimator1_HEdepth4_    ) h_sumCutADCAmplperLSdepth4HEu->Fill( float(lscounterM1) ,bbbc); 
		  h_sum0ADCAmplperLSdepth4HEu->Fill( float(lscounterM1) ,bbb1);

		  if(bbbc/bbb1 > lsdep_estimator1_HEdepth4_    ) h_2DsumADCAmplLSdepth4HEu->Fill(double(ieta), double(k3), bbbc);
		...
		if(k1+1  ==5) {
		  ...
		  if(bbbc/bbb1 > lsdep_estimator1_HEdepth5_    ) h_sumCutADCAmplperLSdepth5HEu->Fill( float(lscounterM1) ,bbbc); 
		  h_sum0ADCAmplperLSdepth5HEu->Fill( float(lscounterM1) ,bbb1);

		  if(bbbc/bbb1 > lsdep_estimator1_HEdepth5_    ) h_2DsumADCAmplLSdepth5HEu->Fill(double(ieta), double(k3), bbbc);
		...
		if(k1+1  ==6) {
		  ...
		  if(bbbc/bbb1 > lsdep_estimator1_HEdepth6_    ) h_sumCutADCAmplperLSdepth6HEu->Fill( float(lscounterM1) ,bbbc); 
		  h_sum0ADCAmplperLSdepth6HEu->Fill( float(lscounterM1) ,bbb1);

		  if(bbbc/bbb1 > lsdep_estimator1_HEdepth6_    ) h_2DsumADCAmplLSdepth6HEu->Fill(double(ieta), double(k3), bbbc);
		...
		if(k1+1  ==7) {
		  ...
		  if(bbbc/bbb1 > lsdep_estimator1_HEdepth7_    ) h_sumCutADCAmplperLSdepth7HEu->Fill( float(lscounterM1) ,bbbc); 
		  h_sum0ADCAmplperLSdepth7HEu->Fill( float(lscounterM1) ,bbb1);

		  if(bbbc/bbb1 > lsdep_estimator1_HEdepth7_    ) h_2DsumADCAmplLSdepth7HEu->Fill(double(ieta), double(k3), bbbc);
		...
		if(k1+1  ==3) {
		  ...
		  if(bbbc/bbb1 > lsdep_estimator1_HFdepth3_    ) h_sumCutADCAmplperLS6u->Fill( float(lscounterM1) ,bbbc); 
		  h_sum0ADCAmplperLS6u->Fill( float(lscounterM1) ,bbb1);

		  if(bbbc/bbb1 > lsdep_estimator1_HFdepth3_    ) h_2DsumADCAmplLSdepth3HFu->Fill(double(ieta), double(k3), bbbc);
		...
		if(k1+1  ==4) {
		  ...
		  if(bbbc/bbb1 > lsdep_estimator1_HFdepth4_    ) h_sumCutADCAmplperLS7u->Fill( float(lscounterM1) ,bbbc); 
		  h_sum0ADCAmplperLS7u->Fill( float(lscounterM1) ,bbb1);

		  if(bbbc/bbb1 > lsdep_estimator1_HFdepth4_    ) h_2DsumADCAmplLSdepth4HFu->Fill(double(ieta), double(k3), bbbc);
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////   HODigiCollection
	...
	if( k0 == 1 ) {
	  for(int k1 = 0; k1<ndepth; k1++) {
	    // k2: 0-81
	    for(int k2 = 0; k2<neta; k2++) {
	      int k2plot = k2-41;int kkk = k2plot; if(k2plot >0 ) kkk=k2plot+1; //-41 +41 !=0
  ...
  if(recordHistoes_ && studyCalibCellsHist_) {
	...
	for(int k3 = 0; k3<nphi; k3++) {
	  ...
	  if(k1==0 || k1==1) {
	    ...
	    if(k30==71 ||k30==nphi || k30==1 || k30==2) kk3=71; else kk3=((k30-3)/4)*4+3;
	  }
	  else if(k1==2){
	    if(abs(k20)<=4){
	      kk2=0;
	      if(k30==71||k30==nphi||k30==1||k30==2||k30==3||k30==4) kk3=71; else kk3=((k30-5)/6)*6+5;
	    }
	    else{
	      if(abs(k20)>4  && abs(k20)<=10)  kk2=1;
	      if(abs(k20)>10 && abs(k20)<=15)  kk2=2;
	      if(k20<0) kk2=-kk2;
	      if(k30==71 ||k30==nphi || (k30>=1 && k30<=10)) kk3=71; else kk3=((k30-11)/12)*12+11;
	    }
	  }
	  else if(k1==3){
	    if(k20>0) kk2=1; else kk2=-1;
...
void CMTRawAnalyzer::beginJob()
{
  ...
  if(recordHistoes_) {
    ...
    h_mapADCAmplfirstpeak_HE = new TH2F("h_mapADCAmplfirstpeak_HE"," ", neta, -41., 41., nphi, 0., bphi);// for amplmaxts 1TS w/ max
    h_mapADCAmplfirstpeak0_HE = new TH2F("h_mapADCAmplfirstpeak0_HE"," ", neta, -41., 41., nphi, 0., bphi);// for amplmaxts 1TS w/ max
    h_mapADCAmplsecondpeak_HE = new TH2F("h_mapADCAmplsecondpeak_HE"," ", neta, -41., 41., nphi, 0., bphi);// for amplmaxts 1TS w/ max
    h_mapADCAmplsecondpeak0_HE = new TH2F("h_mapADCAmplsecondpeak0_HE"," ", neta, -41., 41., nphi, 0., bphi);// for amplmaxts 1TS w/ max

    h_mapADCAmpl11firstpeak_HE = new TH2F("h_mapADCAmpl11firstpeak_HE"," ", neta, -41., 41., nphi, 0., bphi);// for ampl3ts 3TSs
    h_mapADCAmpl11firstpeak0_HE = new TH2F("h_mapADCAmpl11firstpeak0_HE"," ", neta, -41., 41., nphi, 0., bphi);// for ampl3ts 3TSs
    h_mapADCAmpl11secondpeak_HE = new TH2F("h_mapADCAmpl11secondpeak_HE"," ", neta, -41., 41., nphi, 0., bphi);// for ampl3ts 3TSs
    h_mapADCAmpl11secondpeak0_HE = new TH2F("h_mapADCAmpl11secondpeak0_HE"," ", neta, -41., 41., nphi, 0., bphi);// for ampl3ts 3TSs

    h_mapADCAmpl12firstpeak_HE = new TH2F("h_mapADCAmpl12firstpeak_HE"," ", neta, -41., 41., nphi, 0., bphi);// for ampl 4TSs
    h_mapADCAmpl12firstpeak0_HE = new TH2F("h_mapADCAmpl12firstpeak0_HE"," ", neta, -41., 41., nphi, 0., bphi);// for ampl 4TSs
    h_mapADCAmpl12secondpeak_HE = new TH2F("h_mapADCAmpl12secondpeak_HE"," ", neta, -41., 41., nphi, 0., bphi);// for ampl 4TSs
    h_mapADCAmpl12secondpeak0_HE = new TH2F("h_mapADCAmpl12secondpeak0_HE"," ", neta, -41., 41., nphi, 0., bphi);// for ampl 4TSs
  ...
  h_sumADCAmplEtaPhiLs_orbitNum = new TH1F("h_sumADCAmplEtaPhiLs_orbitNum"," ", 1000, 25000000.,40000000.);
    ...
    //--------------------------------------------------
    h_mapGetRMSOverNormalizedSignal_HB=new TH2F("h_mapGetRMSOverNormalizedSignal_HB"," ",neta,-41.,41.,nphi,0.,bphi);
    h_mapGetRMSOverNormalizedSignal0_HB=new TH2F("h_mapGetRMSOverNormalizedSignal0_HB"," ",neta,-41.,41.,nphi,0.,bphi);
    h_mapGetRMSOverNormalizedSignal_HE=new TH2F("h_mapGetRMSOverNormalizedSignal_HE"," ",neta,-41.,41.,nphi,0.,bphi);
    h_mapGetRMSOverNormalizedSignal0_HE=new TH2F("h_mapGetRMSOverNormalizedSignal0_HE"," ",neta,-41.,41.,nphi,0.,bphi);
    h_mapGetRMSOverNormalizedSignal_HF=new TH2F("h_mapGetRMSOverNormalizedSignal_HF"," ",neta,-41.,41.,nphi,0.,bphi);
    h_mapGetRMSOverNormalizedSignal0_HF=new TH2F("h_mapGetRMSOverNormalizedSignal0_HF"," ",neta,-41.,41.,nphi,0.,bphi);
    h_mapGetRMSOverNormalizedSignal_HO=new TH2F("h_mapGetRMSOverNormalizedSignal_HO"," ",neta,-41.,41.,nphi,0.,bphi);
    h_mapGetRMSOverNormalizedSignal0_HO=new TH2F("h_mapGetRMSOverNormalizedSignal0_HO"," ",neta,-41.,41.,nphi,0.,bphi);
    //--------------------------------------------------
...
void CMTRawAnalyzer::fillDigiErrors(HBHEDigiCollection::const_iterator& digiItr)
{
	...
	if(studyRunDependenceHist_ && flagtodefinebadchannel_==0) ++badchannels[sub-1][mdepth-1][ieta+41][iphi];// 0-neta ; 0-71
...
//     ii = 0 to 9
  ...
  //////      
	...
	if(pedestalw0 < pedestalwHBMax_ || pedestalw1 < pedestalwHBMax_
	  ...
	  if(mdepth==3) h_mapDepth3pedestalw_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==4) h_mapDepth4pedestalw_HB->Fill(double(ieta), double(iphi), 1.);
	}
	if(pedestal0 < pedestalHBMax_ || pedestal1 < pedestalHBMax_
	  ...
	  if(mdepth==3) h_mapDepth3pedestal_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==4) h_mapDepth4pedestal_HB->Fill(double(ieta), double(iphi), 1.);
	}
	for (int ii=0; ii<TSsize; ii++) {
	...
	if(amplitude < ADCAmplHBMin_ || amplitude > ADCAmplHBMax_) {
	  if(studyRunDependenceHist_ && flagtodefinebadchannel_==5) ++badchannels[sub-1][mdepth-1][ieta+41][iphi];// 0-neta ; 0-71
	...
	if(aveamplitude1 < TSmeanHBMin_ || aveamplitude1 > TSmeanHBMax_ ) {
	  if(studyRunDependenceHist_ && flagtodefinebadchannel_==4) ++badchannels[sub-1][mdepth-1][ieta+41][iphi];// 0-neta ; 0-71
	...
	if(ts_with_max_signal < TSpeakHBMin_ || ts_with_max_signal > TSpeakHBMax_ ) {
	  if(studyRunDependenceHist_ && flagtodefinebadchannel_==3) ++badchannels[sub-1][mdepth-1][ieta+41][iphi];// 0-neta ; 0-71
	...
	if(rmsamplitude < rmsHBMin_ || rmsamplitude > rmsHBMax_ ) {
	  if(studyRunDependenceHist_ && flagtodefinebadchannel_==2) ++badchannels[sub-1][mdepth-1][ieta+41][iphi];// 0-neta ; 0-71
	...
	if(ratio < ratioHBMin_ || ratio > ratioHBMax_  ) {
	  if(studyRunDependenceHist_ && flagtodefinebadchannel_==1) ++badchannels[sub-1][mdepth-1][ieta+41][iphi];// 0-neta ; 0-71
...
// double ADC_ped = 0.;
 for (int ii=0; ii<TSsize; ii++) {  
    ...
    if(flagsipmcorrection_ != 0 ) {
      if(sub == 2 ) { 
	double xa = amplitude/40.;double xb = ampl/40.;double xc = amplitude345/40.;double xd = ampl3ts/40.;double xe = amplmaxts/40.;double txa = tocampl/40.;
	// ADDI case:
	if( ((ieta==-16||ieta==15) && mdepth==4) ||  ((ieta==-17||ieta==16) && (mdepth==2||mdepth==3)) || ((ieta==-18||ieta==17) && mdepth==5) ) {
	  ...
	  double corrforxa = a2*xa*xa + b1*xa + c0;double corrforxb = a2*xb*xb + b1*xb + c0;double corrforxc = a2*xc*xc + b1*xc + c0;double corrforxd = a2*xd*xd + b1*xd + c0;double corrforxe = a2*xe*xe + b1*xe + c0;double corrfortxa = a2*txa*txa + b1*txa + c0;
	  h_corrforxaADDI_HE->Fill(amplitude, corrforxa);
	  h_corrforxaADDI0_HE->Fill(amplitude, 1.);
	  amplitude *= corrforxa;ampl *= corrforxb;amplitude345 *= corrforxc;ampl3ts *= corrforxd;amplmaxts *= corrforxe;tocampl *= corrfortxa;
	}
	// MAIN case:
	else {
...
// HE starts:
	...
	if(pedestalw0 < pedestalwHBMax_ || pedestalw1 < pedestalwHBMax_
	  ...
	  if(mdepth==2) h_mapDepth2pedestalw_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==3) h_mapDepth3pedestalw_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==3) h_mapDepth4pedestalw_HB->Fill(double(ieta), double(iphi), 1.);
	}
	if(pedestal0 < pedestalHBMax_ || pedestal1 < pedestalHBMax_
	   || pedestal2 < pedestalHBMax_ || pedestal3 < pedestalHBMax_) {
	  if(mdepth==1) h_mapDepth1pedestal_HB->Fill(double(ieta), double(iphi), 1.);
	...
	if(amplitude < ADCAmplHBMin_ || amplitude > ADCAmplHBMax_) {
	  ...
	  if(mdepth==1) h_mapDepth1ADCAmpl225_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==2) h_mapDepth2ADCAmpl225_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==3) h_mapDepth3ADCAmpl225_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==4) h_mapDepth4ADCAmpl225_HB->Fill(double(ieta), double(iphi), 1.);
	}// if
	//	if(amplitude >400.) averSIGNALoccupancy_HB += 1.;
	if(amplitude < 35.) {
	  if(mdepth==1) h_mapDepth1ADCAmpl225Copy_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==2) h_mapDepth2ADCAmpl225Copy_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==3) h_mapDepth3ADCAmpl225Copy_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==4) h_mapDepth4ADCAmpl225Copy_HB->Fill(double(ieta), double(iphi), 1.);
	}// if
	// for averaged values:
	if(mdepth==1) h_mapDepth1ADCAmpl_HB->Fill(double(ieta), double(iphi), amplitude);
	if(mdepth==2) h_mapDepth2ADCAmpl_HB->Fill(double(ieta), double(iphi), amplitude);
	if(mdepth==3) h_mapDepth3ADCAmpl_HB->Fill(double(ieta), double(iphi), amplitude);
	if(mdepth==4) h_mapDepth4ADCAmpl_HB->Fill(double(ieta), double(iphi), amplitude);
	if(mdepth==1) h_mapDepth1ADCAmpl12_HB->Fill(double(ieta), double(iphi), ampl);
	if(mdepth==2) h_mapDepth2ADCAmpl12_HB->Fill(double(ieta), double(iphi), ampl);
	if(mdepth==3) h_mapDepth3ADCAmpl12_HB->Fill(double(ieta), double(iphi), ampl);
	if(mdepth==4) h_mapDepth4ADCAmpl12_HB->Fill(double(ieta), double(iphi), ampl);
	///////////////////////////////////////////////////////////////////////////////	//AZ: 21.09.2018 for Pavel Bunin:
	///////////////////////////////////////////////////////////////////////////////	//AZ: 25.10.2018 for Pavel Bunin: gain stability vs LSs using LED from abort gap
	h_bcnvsamplitude_HB->Fill( float(bcn) , amplitude );
	h_bcnvsamplitude0_HB->Fill( float(bcn) , 1. );
	...
	if(aveamplitude1 < TSmeanHBMin_ || aveamplitude1 > TSmeanHBMax_ ) {
	  ...
	  if(mdepth==1) h_mapDepth1TSmeanA225_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==2) h_mapDepth2TSmeanA225_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==3) h_mapDepth3TSmeanA225_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==4) h_mapDepth4TSmeanA225_HB->Fill(double(ieta), double(iphi), 1.);
	}// if
	// for averaged values:
	if(mdepth==1) h_mapDepth1TSmeanA_HB->Fill(double(ieta), double(iphi), aveamplitude1);
	if(mdepth==2) h_mapDepth2TSmeanA_HB->Fill(double(ieta), double(iphi), aveamplitude1);
	if(mdepth==3) h_mapDepth3TSmeanA_HB->Fill(double(ieta), double(iphi), aveamplitude1);
	if(mdepth==4) h_mapDepth4TSmeanA_HB->Fill(double(ieta), double(iphi), aveamplitude1);
	if(amplitude > forallestimators_amplitude_bigger_) sumEstimator2[sub-1][mdepth-1][ieta+41][iphi] += aveamplitude1;
      }//if(studyTSmeanShapeHist_
      ///////////////////////////////
	...
	if(ts_with_max_signal < TSpeakHBMin_ || ts_with_max_signal > TSpeakHBMax_ ) {
	  ...
	  if(mdepth==1) h_mapDepth1TSmaxA225_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==2) h_mapDepth2TSmaxA225_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==3) h_mapDepth3TSmaxA225_HB->Fill(double(ieta), double(iphi), 1.);
	  if(mdepth==4) h_mapDepth4TSmaxA225_HB->Fill(double(ieta), double(iphi), 1.);
	}// if
	// for averaged values:
	if(mdepth==1) h_mapDepth1TSmaxA_HB->Fill(double(ieta),double(iphi),float(ts_with_max_signal));
	if(mdepth==2) h_mapDepth2TSmaxA_HB->Fill(double(ieta),double(iphi),float(ts_with_max_signal));
	if(mdepth==3) h_mapDepth3TSmaxA_HB->Fill(double(ieta),double(iphi),float(ts_with_max_signal));
	if(mdepth==4) h_mapDepth4TSmaxA_HB->Fill(double(ieta),double(iphi),float(ts_with_max_signal));
	if(amplitude > forallestimators_amplitude_bigger_) sumEstimator3[sub-1][mdepth-1][ieta+41][iphi] += float(ts_with_max_signal);
      }//if(studyTSmaxShapeHist_
      ///////////////////////////////
	...
	if(rmsamplitude < rmsHBMin_ || rmsamplitude > rmsHBMax_ ) {
	  ...
	  if(mdepth==4) h_mapDepth4Amplitude225_HB->Fill(double(ieta), double(iphi), 1.);
	}// if
	// for averaged values:
	if(mdepth==1) h_mapDepth1Amplitude_HB->Fill(double(ieta), double(iphi), rmsamplitude);    
	if(mdepth==2) h_mapDepth2Amplitude_HB->Fill(double(ieta), double(iphi), rmsamplitude);    
	if(mdepth==3) h_mapDepth3Amplitude_HB->Fill(double(ieta), double(iphi), rmsamplitude);    
	if(mdepth==4) h_mapDepth4Amplitude_HB->Fill(double(ieta), double(iphi), rmsamplitude);    
	if(amplitude > forallestimators_amplitude_bigger_) sumEstimator4[sub-1][mdepth-1][ieta+41][iphi] += rmsamplitude;
      }//if(studyRMSshapeHist_)
      ///////////////////////////////
	...
	if(ratio < ratioHBMin_ || ratio > ratioHBMax_  ) {
	  ...
	  if(mdepth==4) h_mapDepth4Ampl047_HB->Fill(double(ieta), double(iphi), 1.);
	  // //
	}//if(ratio
	// for averaged values:
	if(mdepth==1) h_mapDepth1Ampl_HB->Fill(double(ieta), double(iphi), ratio);    
	...
	if(mdepth==4) h_mapDepth4Ampl_HB->Fill(double(ieta), double(iphi), ratio);    
	if(amplitude > forallestimators_amplitude_bigger_) sumEstimator5[sub-1][mdepth-1][ieta+41][iphi] += ratio;
      }//if(studyRatioShapeHist_)
      ///////////////////////////////
	...
	if(mdepth==1) h_mapDepth1AmplE34_HB->Fill(double(ieta), double(iphi), amplitude);    
	if(mdepth==2) h_mapDepth2AmplE34_HB->Fill(double(ieta), double(iphi), amplitude);    
	if(mdepth==3) h_mapDepth3AmplE34_HB->Fill(double(ieta), double(iphi), amplitude);    
	if(mdepth==4) h_mapDepth4AmplE34_HB->Fill(double(ieta), double(iphi), amplitude);    
      }// if(studyDiffAmplHist_)     
      ...
      if(mdepth==4) h_mapDepth4_HB->Fill(double(ieta), double(iphi), 1.);    
    }//if ( sub == 1 )
