  ...
  TDirectory *dir = (TDirectory *)hfile1->FindObjectAny(dirnm.c_str());
   ...
   //   }
    ...
    for (int i=1;i<=Ceff->GetXaxis()->GetNbins();i++) {
	  ...
	  //	  Diffe_Depth1_HB->SetBinContent(i,j,ccc1);
	  	  if(ccc1 < 2.5 || ccc1>4.5)  Diffe_Depth1_HB->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
   ...
   //   }
    ...
    for (int i=1;i<=C2ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 2.4 || ccc1>4.4)  Diffe_Depth2_HB->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
   ...
   //   }
    ...
    for (int i=1;i<=C3ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 2.4 || ccc1>4.6)  Diffe_Depth1_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
    ...
    for (int i=1;i<=C4ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 2.4 || ccc1>4.6)  Diffe_Depth2_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
    ...
    for (int i=1;i<=C5ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 2.4 || ccc1>4.6)  Diffe_Depth3_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
    ...
    for (int i=1;i<=C6ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 0.5 || ccc1>1.5 )  Diffe_Depth1_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
    ...
    for (int i=1;i<=C7ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 0.5 || ccc1>1.5)  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
   ...
   //   if(owod0->IsA()->InheritsFrom("TH2F")){
    ...
    for (int i=1;i<=C8ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 4.0 || ccc1>5.0)  Diffe_Depth4_HO->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
