...
# eos ls -latr /eos/cms/store/data/Run2018A/HcalNZS/RAW/v1/000/316/
# eos ls -latr /eos/cms/store/data/Run2018A/HcalNZS/RAW/v1/000/316/982/00000/
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
'/store/data/Run2018A/HcalNZS/RAW/v1/000/316/982/00000/228C54E3-EB61-E811-ACB3-FA163E2EA36F.root'
#                           'file:/afs/cern.ch/work/z/zhokin/hcal/toc1/CMSSW_10_6_5_patch1/src/WORK/my.root'
        ),
...
#                            firstRun = cms.untracked.uint32(316982),
#                            fileNames = cms.untracked.vstring(
#'/store/data/Run2018A/HcalNZS/RAW/v1/000/316/982/00000/228C54E3-EB61-E811-ACB3-FA163E2EA36F.root'
#        ),
#    secondaryFileNames = cms.untracked.vstring()
...
# eoscp /eos/cms/store/data/Run2018D/SingleMuon/ALCARECO/HcalCalHBHEMuonFilter-PromptReco-v2/000/325/172/00000/90635E6F-32C1-BF4E-A6F9-B84E85723051.root my.root
#eos ls -latr /eos/cms/store/data/Run2018D/SingleMuon/ALCARECO/HcalCalHBHEMuonFilter-PromptReco-v2/000/325/172/00000/
#eos ls -latr /eos/cms/store/data/Run2018E/ZeroBias/RAW/v1/000/325/700/00000/0439205E-54D1-3249-98C1-064D418F374F.root
# eoscp /eos/cms/store/data/Run2018E/ZeroBias/RAW/v1/000/325/700/00000/0439205E-54D1-3249-98C1-064D418F374F.root  my.root
# eos ls -latr /eos/cms/store/data/Run2018A/HcalNZS/RAW/v1/000/316/982/00000/228C54E3-EB61-E811-ACB3-FA163E2EA36F.root
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_325172_1.root'),
                                  #HistOutFile = cms.untracked.string('Global_316982.root'),
...
#process.p = cms.Path(process.hcalDigis*process.seqALCARECOHcalCalMinBiasDigi*process.seqALCARECOHcalCalMinBias*process.Analyzer)

#process.p = cms.Path(process.seqALCARECOHcalCalMinBiasDigi*process.seqALCARECOHcalCalMinBias*process.Analyzer)
