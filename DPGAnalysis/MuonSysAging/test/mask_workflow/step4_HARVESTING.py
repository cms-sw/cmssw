...
# with command line options: step4 --filetype DQM --conditions auto:run2_mc --mc -s HARVESTING:@standardValidation+@standardDQM+@miniAODValidation+@miniAODDQM --era Run2_2016 -n 200 --no_exec
...
process.source = cms.Source("DQMRootSource",
    fileNames = cms.untracked.vstring('file:step3_RAW2DIGI_L1Reco_RECO_EI_PAT_VALIDATION_DQM_inDQM.root')
)
