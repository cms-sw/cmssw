/** \class MuDTSegmentExtTableProducer MuDTSegmentExtTableProducer.cc DTDPGAnalysis/MuonDPGNtuples/src/MuDTSegmentExtTableProducer.cc
 *  
...
#include "DPGAnalysis/MuonTools/plugins/MuDTSegmentExtTableProducer.h"
