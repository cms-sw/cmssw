...
simClusterTable = cms.EDProducer("SimpleSimClusterFlatTableProducer",
    ...
    variables = cms.PSet(CandVars,
        ...
        boundaryPmag = Var('g4Tracks().at(0).getMomentumAtBoundary().P()', 'float', precision=14, doc='magnitude of the boundary 3-momentum vector'),
        boundaryP4 = Var('g4Tracks().at(0).getMomentumAtBoundary().mag()', 'float', precision=14, doc='magnitude of four vector'),
        boundaryEnergy = Var('g4Tracks().at(0).getMomentumAtBoundary().energy()', 'float', precision=14, doc='magnitude of four vector'),
        boundaryPt = Var('g4Tracks().at(0).getMomentumAtBoundary().pt()', 'float', precision=14, doc='magnitude of four vector'),
