...
void
DuplicateRecHits::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
   edm::Service<TFileService> tfserv;
...
void 
DuplicateRecHits::beginRun(const edm::Run& iRun, const edm::EventSetup& iSetup)
{
...
void 
DuplicateRecHits::endRun(const edm::Run& iRun, const edm::EventSetup&)
{
}
...
void 
DuplicateRecHits::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
DuplicateRecHits::endJob() 
{
}
