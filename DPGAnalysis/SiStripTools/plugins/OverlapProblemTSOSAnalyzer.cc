...
void OverlapProblemTSOSAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;
...
void OverlapProblemTSOSAnalyzer::beginRun(const edm::Run& iRun, const edm::EventSetup&) {}

void OverlapProblemTSOSAnalyzer::endRun(const edm::Run& iRun, const edm::EventSetup&) {}
