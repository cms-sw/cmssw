...
# DQM Modules
#-------------------------------------------------
process.load("DPGAnalysis.SiStripTools.testrepro.dqm_withclonedclustermonitor_cff")
...
process.p = cms.Path(process.siStripDigis*process.siStripZeroSuppression*
                     ...
                     process.APVPhases+process.consecutiveHEs+ # APV phase and Event History producers
                     process.newDigisMap+process.unpackerBadListMap+ process.unpackerBadList + #occupancy and bad modules maps
# DQM modules before filter
