...
DigiPileupCorrHistogramMaker::DigiPileupCorrHistogramMaker():
  m_pileupcollectionToken(), m_useVisibleVertices(false), m_hitname(), m_nbins(500), m_scalefact(), m_binmax(), m_labels(),
...
DigiPileupCorrHistogramMaker::DigiPileupCorrHistogramMaker(const edm::ParameterSet& iConfig, edm::ConsumesCollector && iC):
  m_pileupcollectionToken(iC.mayConsume<std::vector<PileupSummaryInfo> >(iConfig.getParameter<edm::InputTag>("pileupSummaryCollection"))),
