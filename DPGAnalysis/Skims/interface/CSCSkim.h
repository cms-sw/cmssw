...
private: 
  ...
  bool doBFieldStudySelection(const edm::Handle<reco::TrackCollection>& saTracks, const edm::Handle<reco::TrackCollection>& Tracks, const edm::Handle<reco::MuonCollection>& gMuons);
