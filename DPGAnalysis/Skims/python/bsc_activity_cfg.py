...
process.ecalskim = cms.EDFilter("ECALActivity",
...
process.ecal = cms.Path(process.ecalskim)
...
process.bsc = cms.Path(process.hltLevel1GTSeed)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/DPGAnalysis/Skims/python/bsc_activity_cfg.py,v $'),
    annotation = cms.untracked.string('BSC_ACTIVITY skim')
)
...
process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('BSC_activity.root'),
    outputCommands = cms.untracked.vstring('keep *','drop *_MEtoEDMConverter_*_*'),
    dataset = cms.untracked.PSet(
    	      dataTier = cms.untracked.string('RECO'),
    	      filterName = cms.untracked.string('BSC_Activity')),
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('ecal','bsc','clusters')
    )
)
