...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/DPGAnalysis/Skims/python/StoppedHSCP_cfg.py,v $'),
    annotation = cms.untracked.string('CRAFT StoppedHSCP skim')
)
