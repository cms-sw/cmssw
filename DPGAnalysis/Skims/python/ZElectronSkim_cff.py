...
PassingVeryLooseId = goodElectrons.clone(
    cut = cms.string(
        ...
        #    " && (gsfTrack.getHitPattern.numberOfHits(\'MISSING_INNER_HITS\')<=1 && !(-0.02<convDist<0.02 && -0.02<convDcot<0.02))" #wrt std WP90 allowing 1 numberOfMissingExpectedHits
            " && (gsfTrack.getHitPattern.numberOfHits(\'MISSING_INNER_HITS\')<=1 )" #wrt std WP90 allowing 1 numberOfMissingExpectedHits 
