...
//     const double qoverpt = (*resiter)[kQoverPt];
  ...
  parNum.push_back(kBfrompt);   parName.emplace_back("bfrompt");   start.push_back(0.);       step.push_back(0.1*stdev/0.05);  low.push_back(0.);    high.push_back(0.);
  parNum.push_back(kBfrompz);   parName.emplace_back("bfrompz");   start.push_back(0.);       step.push_back(0.1*stdev/0.05);  low.push_back(0.);    high.push_back(0.);
  parNum.push_back(kdEdx);      parName.emplace_back("dEdx");      start.push_back(0.);       step.push_back(0.1*stdev/0.05);  low.push_back(0.);    high.push_back(0.);
