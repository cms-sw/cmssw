...
public:
  ...
  MuonResiduals6DOFrphiFitter(int residualsModel, int minHits, const CSCGeometry *cscGeometry): MuonResidualsFitter(residualsModel, minHits), m_cscGeometry(cscGeometry) {};
