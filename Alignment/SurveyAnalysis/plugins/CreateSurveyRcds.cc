...
void CreateSurveyRcds::analyze(const edm::Event &event,
  ...
  if (m_inputGeom == "sqlite") {
    ...
    aligner.applyAlignments<TrackerGeometry>(
        &(*tracker), &(*alignments), &(*alignmentErrors), AlignTransform());
  }
...
void CreateSurveyRcds::setGeometry(Alignable *ali) {
  ...
  if (m_generatedSimple) {
    if ((level == 2) ||
        ((level == 1) && (ali->mother()->alignableObjectId() != 2))) {
...
void CreateSurveyRcds::setSurveyErrors(Alignable *ali) {
  ...
  if ((level <= 2) && (subdetlevel == 4)) {
    ...
    error4 = 0.001;
    error5 = 0.001;
    // error0=0.01; error1=0.002; error2=0.002; error3=0.0002; error4=0.0002;
    // error5=0.001; if ((level == 2)&&(nComp == 2)){ 	error1 = 0.01;
    //}
  }
  ...
  if ((level <= 2) && (subdetlevel == 5)) {
    // error0 = 0.015; error1 = 0.015; error2 = 0.05; error3 = 0.001; error4 =
    // 0.001; error5 = 0.001;
    error0 = 0.015;
    error1 = 0.003;
    error2 = 0.003;
