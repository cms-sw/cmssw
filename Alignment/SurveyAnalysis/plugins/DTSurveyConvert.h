...
//
/**\class DTSurveyConvert DTSurveyConvert.cc
 Alignment/DTSurveyConvert/src/DTSurveyConvert.cc

 Description: Reads survey information, process it and outputs a text file with
 results
