...
void SurveyInputCSCfromPins::orient(const LocalVector& LC1, const LocalVector& LC2, double a, double b, double &T, double &dx, double &dy, double &dz, double &PhX, double &PhZ) {
