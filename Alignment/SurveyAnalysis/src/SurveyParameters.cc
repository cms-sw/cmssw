...
AlignmentParameters *
SurveyParameters::cloneFromSelected(const AlgebraicVector &,
                                    const AlgebraicSymMatrix &) const {
  throw cms::Exception("BadInheritance")
...
AlgebraicMatrix
SurveyParameters::derivatives(const TrajectoryStateOnSurface &,
...
AlgebraicMatrix
SurveyParameters::selectedDerivatives(const TrajectoryStateOnSurface &,
                                      const AlignableDetOrUnitPtr &) const {
  throw cms::Exception("BadInheritance")
