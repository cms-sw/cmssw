...
public:
  ...
  /*! Constructor from a string stream.\n
    ...
    A line needs to be of the form <tt>rawID1 y_1_1 x_1_1 y_2_1 x_2_1 rawId2
    y_1_2 x_1_2 y_2_2 x_2_2 sigma_y sigma_x</tt>\n <tt>x_i_1</tt> denoting the
    left, <tt>x_i_2</tt> the right module. The data is then mapped to \verbatim
    -------------++--------------
            (1) +||+ (3)
                 ||
    ...
    - <tt>y_1_2, x_1_2 -> (2)</tt>
    - <tt>y_2_2, x_2_2 -> (3)</tt>
    The sigmas denote the Gaussian error of the measurement in the u and v
    coordinate
    */
