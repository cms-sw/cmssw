...
# frontier://FrontierProd/CMS_COND_31X_FROM21X     DTAlignmentErrorRcd       DTIdealGeometryErrors200_mc
# frontier://FrontierProd/CMS_COND_31X_ALIGNMENT   CSCAlignmentRcd           CSCIdealGeometry310me42_mc
# frontier://FrontierProd/CMS_COND_31X_ALIGNMENT   CSCAlignmentErrorRcd      CSCIdealGeometryErrors310me42_mc
...
# frontier://FrontierProd/CMS_COND_31X_FROM21X     TrackerAlignmentErrorRcd  TrackerIdealGeometryErrors210_mc
...
process.ideal31Xfrom21X = cms.ESSource("PoolDBESSource",
                                       ...
                                       toGet = cms.VPSet(cms.PSet(record = cms.string("DTAlignmentRcd"), tag = cms.string("DTIdealGeometry200_mc")),
                                                         cms.PSet(record = cms.string("DTAlignmentErrorRcd"), tag = cms.string("DTIdealGeometryErrors200_mc")),
