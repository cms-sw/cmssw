...
//--------------------------------------------------------------------------------------------------
AlignableTracker::AlignableTracker(const TrackerAlignmentRcd& iRecord )  
{
  ...
  iRecord.getRecord<IdealGeometryRecord>().get( theGeometricTracker );
  iRecord.getRecord<TrackerDigiGeometryRecord>().get( theTrackingGeometry ); 
