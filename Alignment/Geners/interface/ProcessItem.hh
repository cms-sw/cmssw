...
template <template <typename, typename, typename, typename> class Visitor,
          typename T, typename Arg1, typename Arg2, int Mode>
...
bool GENERS_GENERIC_ITEM_PROCESSOR(GENERS_GENERATED_IO_CONSTNESS T &obj,
  ...
  return Private::GENERS_GENERATED_IO_PROCESSOR<
      ...
      M::Signature &(M::ISPOD | M::ISSTDCONTAINER | M::ISWRITABLE |
                     M::ISPOINTER | M::ISSHAREDPTR | M::ISIOPTR | M::ISPAIR |
                     M::ISSTRING | M::ISTUPLE |
                     M::ISEXTERNAL)>::process(obj, a1, p2, processClassId);
}
} // namespace gs
...
struct GENERS_CONTAINER_ITERATION_PROC {
  ...
  static bool process(const T &v, Arg1 &a1, Arg2 *p2, std::size_t) {
    ...
    for (typename T::const_iterator it = v.begin(); it != end && itemStatus;
         ++it)
  ...
  static bool process(T &obj, Arg1 &a1, Arg2 *p2, const std::size_t newSize) {
    ...
    for (std::size_t i = 0; i < newSize && itemStatus; ++i)
      itemStatus =
          Visitor<Arg1, Arg2, T, InContainerCycle>::process(obj, a1, p2, i);
    return itemStatus;
  }
#endif
};
...
template <template <typename, typename, typename, typename> class Visitor,
          typename T, typename Arg1, typename Arg2>
struct GENERS_GENERATED_IO_PROCESSOR<Visitor, T, Arg1, Arg2,
                                     IOTraits<int>::ISPOD> {
  // POD-processing visitor
  static bool process(GENERS_GENERATED_IO_CONSTNESS T &obj, Arg1 &a1, Arg2 *p2,
                      const bool processClassId) {
...
struct GENERS_GENERATED_IO_PROCESSOR<Visitor, T, Arg1, Arg2,
  ...
  static bool process(GENERS_GENERATED_IO_CONSTNESS T &obj, Arg1 &a1, Arg2 *p2,
                      const bool processClassId) {
    return Visitor<
        Arg1, Arg2, typename T::element_type *,
        Int2Type<IOTraits<int>::ISPOINTER>>::process(obj.getIOReference(), a1,
                                                     p2, processClassId);
  }
};
...
template <template <typename, typename, typename, typename> class Visitor,
          typename T, typename Arg1, typename Arg2>
struct GENERS_GENERATED_IO_PROCESSOR<Visitor, T, Arg1, Arg2,
                                     IOTraits<int>::ISSHAREDPTR> {
  // There is not enough info here to decide how the shared pointer
  // should be managed. Therefore, just call the visitor.
  static bool process(GENERS_GENERATED_IO_CONSTNESS T &obj, Arg1 &a1, Arg2 *p2,
                      bool /* processClassId */) {
    return Visitor<Arg1, Arg2, T,
                   Int2Type<IOTraits<int>::ISSHAREDPTR>>::process(obj, a1, p2,
                                                                  true);
  }
};
...
template <template <typename, typename, typename, typename> class Visitor,
          typename T, typename Arg1, typename Arg2>
struct GENERS_GENERATED_IO_PROCESSOR<Visitor, T, Arg1, Arg2,
                                     IOTraits<int>::ISSTDCONTAINER> {
private:
  // The following function will be fired on containers which
  // store PODs contiguously
  static bool process2(GENERS_GENERATED_IO_CONSTNESS T &obj, Arg1 &a1, Arg2 *p2,
                       const bool processClassId, Int2Type<true>) {
    return Visitor<Arg1, Arg2, T, InPODArray>::process(obj, a1, p2,
                                                       processClassId);
  }

  // The following function will be fired on containers which
  // do not not store PODs contiguously
  static bool process2(GENERS_GENERATED_IO_CONSTNESS T &v, Arg1 &a1, Arg2 *p2,
                       const bool processClassId, Int2Type<false>) {
    GENERS_GENERATED_IO_CONSTNESS std::size_t sz = v.size();
    return Visitor<Arg1, Arg2, T, InContainerSize>::process(sz, a1, p2,
                                                            processClassId) &&
...
public:
  static bool process(GENERS_GENERATED_IO_CONSTNESS T &obj, Arg1 &a1, Arg2 *p2,
                      const bool processClassId) {
    if (Visitor<Arg1, Arg2, T, InContainerHeader>::process(obj, a1, p2,
                                                           processClassId)) {
      ...
      try {
        bodyStatus =
            process2(obj, a1, p2, processClassId,
