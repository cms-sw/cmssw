...
public:
  ...
  retrieveEntry(const unsigned long long id) const;
  ...
  inline const CatalogEntry *lastEntryMade() const { return lastEntry_.get(); }
...
private:
  ...
  void findByName(const NameMap &nmap, const SearchSpecifier &namePattern,
