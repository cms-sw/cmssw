...
template <typename T> struct IOIsPOD {
...
#define gs_declare_type_as_pod(T) /**/                                         \
  namespace gs {                                                               \
  template <> struct IOIsPOD<T> {                                              \
    enum { value = 1 };                                                        \
  };                                                                           \
  template <> struct IOIsPOD<T const> {                                        \
    enum { value = 1 };                                                        \
  };                                                                           \
  template <> struct IOIsPOD<T volatile> {                                     \
    enum { value = 1 };                                                        \
  };                                                                           \
  template <> struct IOIsPOD<T const volatile> {                               \
    enum { value = 1 };                                                        \
  };                                                                           \
  }
