...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
std::vector<double> ALIUtils::GetRotationAnglesFromMatrix( CLHEP::HepRotation& rotm, double origAngleX, double origAngleY, double origAngleZ )
{
  double pii = acos(0.)*2;
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
std::vector<double> ALIUtils::GetRotationAnglesFromMatrix( CLHEP::HepRotation& rotm )
{
  double pii = acos(0.)*2;
  std::vector<double> newang(3);
  //-  double angleX = origAngleX;
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
int ALIUtils::checkMatrixEquations( double angleX, double angleY, double angleZ, CLHEP::HepRotation* rotorig)
{
