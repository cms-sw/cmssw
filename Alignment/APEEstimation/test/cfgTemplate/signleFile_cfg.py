...
process.TrackRefitterForApeEstimator = cms.EDProducer("TrackRefitter",
    src = cms.InputTag("ALCARECOTkAlMuonIsolated"),
    beamSpot = cms.InputTag("offlineBeamSpot"),
    srcConstr = cms.InputTag(""),
    MeasurementTrackerEvent = cms.InputTag("MeasurementTrackerEvent"),
...
process.ApeEstimator1 = cms.EDAnalyzer("ApeEstimator",
    ...
    TrackerTreeFile = cms.string('/afs/cern.ch/work/a/ajkumar/APE_newCPE/CMSSW_7_2_0_pre6/src/Alignment/TrackerTreeGenerator/hists/TrackerTree.root'),
...
process.RefitterSequence = cms.Sequence(process.offlineBeamSpot+process.MeasurementTrackerEvent+process.TrackRefitterForApeEstimator)
...
process.RefitterHighPuritySequence = cms.Sequence(process.offlineBeamSpot+process.MeasurementTrackerEvent+process.HighPuritySelector+process.TrackRefitterHighPurityForApeEstimator)
...
process.p = cms.Path(process.TriggerSelectionSequence+process.RefitterHighPuritySequence+process.ApeEstimatorSequence)
...
process.TFileService = cms.Service("TFileService",
    ...
    fileName = cms.string('/afs/cern.ch/work/a/ajkumar/APE_newCPE/CMSSW_7_2_0_pre6/src/ApeEstimator/ApeEstimator/hists/workingArea/data11.root')
)
