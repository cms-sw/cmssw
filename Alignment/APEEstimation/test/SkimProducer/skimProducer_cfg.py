...
if trackSelection == "SingleMu":
    trackSelector = Alignment.APEEstimation.AlignmentTrackSelector_cff.MuSkimSelector
elif trackSelection == "DoubleMu":
    trackSelector = Alignment.APEEstimation.AlignmentTrackSelector_cff.DoubleMuSkimSelector
elif trackSelection == "MinBias":
    trackSelector = Alignment.APEEstimation.AlignmentTrackSelector_cff.MinBiasSkimSelector
elif trackSelection == "Cosmics":
    trackSelector = Alignment.APEEstimation.AlignmentTrackSelector_cff.CosmicsSkimSelector
...
process.seqTrackselRefit = trackselRefit.getSequence(process, str(trackSelector.src)[14:-2]) # Since trackSelector.src is an InputTag now, maybe there is an easier way
...
process.out = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('%s'%(outputName)),
