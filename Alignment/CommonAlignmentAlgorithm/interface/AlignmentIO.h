...
public:
  ...
  virtual void writeAlignmentParameters(const align::Alignables &alivec,
                                        ...
                                        bool validCheck, int &ierr) = 0;

  /// read AlignmentParameters
  virtual align::Parameters
  readAlignmentParameters(const align::Alignables &alivec, const char *filename,
                          int iter, int &ierr) = 0;

  /// write RigidBodyAlignmentParameters as applied on top of original positions
  virtual void
  writeOrigRigidBodyAlignmentParameters(const align::Alignables &alivec,
                                        const char *filename, int iter,
                                        bool validCheck, int &ierr) = 0;
  ...
  virtual AlignablePositions
  readAlignableAbsolutePositions(const align::Alignables &alivec,
  ...
  virtual AlignablePositions
  readAlignableOriginalPositions(const align::Alignables &alivec,
                                 const char *filename, int iter, int &ierr) = 0;
  ...
  virtual AlignableShifts
  readAlignableRelativePositions(const align::Alignables &alivec,
                                 const char *filename, int iter, int &ierr) = 0;
};
