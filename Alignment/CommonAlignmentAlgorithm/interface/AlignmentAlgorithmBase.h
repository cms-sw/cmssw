...
public:
  ...
  public:
    EventInfo(const edm::EventID &theEventId,
        ...
        : eventId_(theEventId), trajTrackPairs_(theTrajTrackPairs),
          beamSpot_(theBeamSpot), clusterValueMap_(theClusterValueMap) {}
  ...
  public:
    EndRunInfo(const edm::RunID &theRunId,
        ...
        : runId_(theRunId), tkLasBeams_(theTkLasBeams),
  ...
  virtual void endRun(const EndRunInfo &runInfo,
