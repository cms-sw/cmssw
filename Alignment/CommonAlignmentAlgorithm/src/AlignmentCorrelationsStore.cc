...
void AlignmentCorrelationsStore::correlations(Alignable *ap1, Alignable *ap2,
                                              AlgebraicSymMatrix &cov, int row,
                                              int col) const {
...
void AlignmentCorrelationsStore::setCorrelations(Alignable *ap1, Alignable *ap2,
  ...
  if (ap1 == previousAlignable) {
    fillCorrelationsTable(ap1, ap2, previousCorrelations, cov, row, col,
                          transpose);
  } else {
...
void AlignmentCorrelationsStore::fillCorrelationsTable(
    Alignable *ap1, Alignable *ap2, CorrelationsTable *table,
...
void AlignmentCorrelationsStore::fillCovariance(Alignable *ap1, Alignable *ap2,
...
void AlignmentCorrelationsStore::fillCovarianceT(Alignable *ap1, Alignable *ap2,
                                                 const AlgebraicMatrix &entry,
                                                 AlgebraicSymMatrix &cov,
                                                 int row, int col) const {
  int nRow = entry.num_row();
...
void AlignmentCorrelationsStore::readFromCovariance(
    Alignable *ap1, Alignable *ap2, AlgebraicMatrix &entry,
