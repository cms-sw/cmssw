...
bool AlignableModifier::modify( Alignable* alignable, const edm::ParameterSet& pSet )
{
  ...
  for (auto & parameterName : parameterNames) {
    if  ( parameterName == "distribution" ) distribution_ = pSet.getParameter<std::string>( parameterName );
    else if ( parameterName == "setError" ) setError_ = pSet.getParameter<bool>( parameterName );
    else if ( parameterName == "setRotations") setRotations_ = pSet.getParameter<bool>( parameterName );
    else if ( parameterName == "setTranslations") setTranslations_ = pSet.getParameter<bool>( parameterName );
    else if ( parameterName == "scale" )    scale_ = pSet.getParameter<double>( parameterName );
    else if ( parameterName == "scaleError" ) scaleError_ = pSet.getParameter<double>( parameterName );
    else if ( parameterName == "phiX" )    phiX_     = pSet.getParameter<double>( parameterName );
    else if ( parameterName == "phiY" )    phiY_     = pSet.getParameter<double>( parameterName );
    else if ( parameterName == "phiZ" )    phiZ_     = pSet.getParameter<double>( parameterName );
    else if ( parameterName == "dX" )      dX_       = pSet.getParameter<double>( parameterName );
    else if ( parameterName == "dY" )      dY_       = pSet.getParameter<double>( parameterName );
    else if ( parameterName == "dZ" )      dZ_       = pSet.getParameter<double>( parameterName );
    else if ( parameterName == "dXlocal" ) dXlocal_  = pSet.getParameter<double>( parameterName );
    else if ( parameterName == "dYlocal" ) dYlocal_  = pSet.getParameter<double>( parameterName );
    else if ( parameterName == "dZlocal" ) dZlocal_  = pSet.getParameter<double>( parameterName );
    else if ( parameterName == "twist" )   twist_    = pSet.getParameter<double>( parameterName );
    else if ( parameterName == "shear" )   shear_    = pSet.getParameter<double>( parameterName );
    else if ( parameterName == "localX" ) { phiXlocal_=pSet.getParameter<double>( parameterName ); rotX_++; }
    else if ( parameterName == "localY" ) { phiYlocal_=pSet.getParameter<double>( parameterName ); rotY_++; }
    else if ( parameterName == "localZ" ) { phiZlocal_=pSet.getParameter<double>( parameterName ); rotZ_++; }
    else if ( parameterName == "phiXlocal" ) { phiXlocal_=pSet.getParameter<double>( parameterName ); rotX_++; }
    else if ( parameterName == "phiYlocal" ) { phiYlocal_=pSet.getParameter<double>( parameterName ); rotY_++; }
    else if ( parameterName == "phiZlocal" ) { phiZlocal_=pSet.getParameter<double>( parameterName ); rotZ_++; }
