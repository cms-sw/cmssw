...
AlignmentTrackSelector = cms.EDFilter("AlignmentTrackSelectorModule",
    ...
    RorZofFirstHitMin_ = cms.vdouble(0.0,0.0),
    RorZofFirstHitMax_ = cms.vdouble(999.0,999.0),
    RorZofLastHitMin_ = cms.vdouble(0.0,0.0),
    RorZofLastHitMax_ = cms.vdouble(999.0,999.0),
