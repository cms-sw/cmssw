...
# HLT_L1MuOpen is the open-muon trigger for the CRAFT minimal table
ALCARECOMuAlCalIsolatedMuHLT.HLTPaths = ["HLT_L1MuOpen"] # ["HLT_L1_MuonOpen", "HLT_L1MuOpen", "HLT_L1Mu", "HLT_Mu3", "HLT_Mu5", "HLT_Mu7", "HLT_Mu9", "HLT_Mu11", "HLT_Mu13", "HLT_Mu15", "HLT_Mu15_L1Mu7", "HLT_L2Mu9", "HLT_IsoMu9", "HLT_IsoMu11", "HLT_IsoMu13", "HLT_IsoMu15"] # ['HLT_IsoMu11','HLT_Mu15_L1Mu7']
