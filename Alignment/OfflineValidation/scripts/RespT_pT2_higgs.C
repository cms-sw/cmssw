...
for (int i=1;i<=nbin;i++){
  ...
  MyTree->Project("d0","(respt/pt)/pt",cutname);
  resd0->Fit("gaus");
...
for (int i=1;i<=nbin;i++){
  ...
  cout << "cutname is " << cutname <<endl;
  TH1F *resd0= new TH1F("d0","d0",500,-0.3,0.3);  
  MyTree2->Project("d0","(respt/pt)/pt",cutname);
  resd0->Fit("gaus");
  meanorig[i-1]=1.*resd0->GetMean();
  rms[i-1]=1.*resd0->GetRMS();
  mean[i-1]=1.*gaus->GetParameter(1);
...
// /////////////////////////////////////////////////////////////////////
 for (int i=1;i<=nbin;i++){
   ...
   cout << "cutname is " << cutname <<endl;
   TH1F *resd0= new TH1F("d0","d0",500,-0.3,0.3);  
   MyTree3->Project("d0","(respt/pt)/pt",cutname);
   resd0->Fit("gaus");
   meanorig[i-1]=1.*resd0->GetMean();
   rms[i-1]=1.*resd0->GetRMS();
...
// /////////////////////////////////////////////////////////////////////
 for (int i=1;i<=nbin;i++){
   ...
   cout << "cutname is " << cutname <<endl;
   TH1F *resd0= new TH1F("d0","d0",500,-0.3,0.3);  
   MyTree4->Project("d0","(respt/pt)/pt",cutname);
   resd0->Fit("gaus");
   meanorig[i-1]=1.*resd0->GetMean();
   rms[i-1]=1.*resd0->GetRMS();
   cost[i-1]=gaus->GetParameter(0);
...
// /////////////////////////////////////////////////////////////////////
 for (int i=1;i<=nbin;i++){
   ...
   cout << "cutname is " << cutname <<endl;
   TH1F *resd0= new TH1F("d0","d0",500,-0.3,0.3);  
   MyTree5->Project("d0","(respt/pt)/pt",cutname);
   resd0->Fit("gaus");
   meanorig[i-1]=1.*resd0->GetMean();
   rms[i-1]=1.*resd0->GetRMS();
   cost[i-1]=gaus->GetParameter(0);
 ...
 hframe_scen4 = new TH2F("hframe_scen4","SigmapT/pT_gaus_scen3",25,0.,100.,100,0.006,0.6);
 hframe_scen4->SetTitle("#sigma(p_{T})/p_{T}^{2} vs p_{T} for #mu from Z->#mu#mu  ");
 hframe_scen4->SetXTitle("p_{T} [GeV/c]");
 hframe_scen4->SetYTitle("#sigma(p_{T})/p^{2}_{T}");
 hframe_scen4->Draw();
...
hframeb = new TH2F("hframeb","#sigma(p_{T})/p_{T}^{2} vs p_{T} for #mu from Z->#mu#mu",25,0.,100.,100,0.0003,0.04);
hframeb->SetYTitle("#sigma(p_{T})/p_{T}^{2}");
hframeb->SetXTitle("p_{T} [GeV/c]");
hframeb->Draw();
...
Canv->Update();
Canv->SaveAs("SigmapT_pT2_gaus.eps");
Canv->SaveAs("SigmapT_pT2_gaus.gif");
