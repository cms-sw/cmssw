...
hframe = new TH2F("hframe","Resd0_gaus",25,0.,2.5,100,5,200.);
...
for (int i=1;i<=nbin;i++){
  ...
  sprintf(cutname,"abs(eta)>=%f && abs(eta)<%f && eff==1 && TrackID==13",binstart, binstop);
  cout << "cutname is " << cutname <<endl;
  TH1F *resd0= new TH1F("d0","d0",500,-0.04,0.04);   
...
hframe_scen1 = new TH2F("hframe_scen1","Resd0_gaus_scen1",25,0.,2.5,100,5,200.);
...
hframe_scen2 = new TH2F("hframe_scen1","Resd0_gaus_scen2",25,0.,2.5,100,5,200.);
...
hframe_scen3 = new TH2F("hframe_scen1","Resd0_gaus_scen3",25,0.,2.5,100,5,200.);
