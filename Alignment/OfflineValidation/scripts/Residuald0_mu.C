...
for(int i=0; i<4; i++){
  ...
  Resd0[i]->SetTitle("#sigma(d_{0})");    
  Resd0[i]->SetXTitle("#sigma(d_{0}) ");
...
Legend("Resd0[0]","Resd0[1]","Resd0[2]","Resd0[3]",Resd0[0],Resd0[1],Resd0[2],Resd0[3]);
...
TLegend *leg = new TLegend(0.45,0.77.,1.,0.9); 
leg->SetTextAlign(32);
leg->SetTextColor(1);
