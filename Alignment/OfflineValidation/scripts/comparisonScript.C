...
void comparisonScript(string inFile="../test/testComparison.root",string outDir="outputDir/")
{
	...
	//syntax (TCut Cut, dirrectory name, bool savePlot, std::string plotName, bool autolimits, int ColorCode (0=z/-z separation| 1= subdetector seperation ))
	c1.plot3x5Profile( levelCut, "Tracker", 50,true,"Tracker.pdf", false ,1);
	c1.plot3x5Profile( levelCut+PXBCut,"PXB", 50, true,  "PXB.pdf", false ,0);
	c1.plot3x5Profile( levelCut+PXFCut,"PXF", 50, true,  "PXF.pdf", false,0 );
	c1.plot3x5Profile( levelCut+TIBCut,"TIB", 50 , true,  "TIB.pdf", false,0 );
	c1.plot3x5Profile( levelCut+TIDCut,"TID", 50, true,  "TID.pdf", false,0) ;
	c1.plot3x5Profile( levelCut+TOBCut,"TOB", 50, true,  "TOB.pdf", false ,0);
	c1.plot3x5Profile( levelCut+TECCut,"TEC", 50, true,  "TEC.pdf", false,0 );
