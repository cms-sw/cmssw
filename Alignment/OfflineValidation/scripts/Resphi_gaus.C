...
for (int i=1;i<=nbin;i++){
  ...
  TH1F *resd0= new TH1F("d0","d0",500,-0.0015.,0.0015);   
  MyTree->Project("d0","(resphi)",cutname);
  resd0->Fit("gaus");
...
hframe = new TH2F("hframe","Resphi_gaus",25,0.,2.5,100,0.00005,0.002);
hframe->SetTitle("#sigma(#phi) vs #eta, p_{T} = 100 GeV/c");
...
gr->Draw("P");
Canv->Update();
//Canv->SaveAs("Resphi_gaus_scen0.eps");
//Canv->WaitPrimitive();
...
hframe_scen1 = new TH2F("hframe_scen1","Resphi_gaus_scen1",25,0.,2.5,100,0.00005,0.002);
hframe_scen1->SetTitle("#sigma(#phi) vs #eta, p_{T} = 100 GeV/c");
hframe_scen1->SetXTitle("#eta");
hframe_scen1->SetYTitle("#sigma(#phi) [rad]");
hframe_scen1->Draw();
...
gr_scen1->Draw("P");
Canv->Update();
//Canv->SaveAs("Resphi_gaus_scen1.eps");
//Canv->WaitPrimitive();
...
hframe_scen2 = new TH2F("hframe_scen2","Resphi_gaus_scen2",25,0.,2.5,100,0.00005,0.001);
hframe_scen2->SetTitle("#sigma(#phi) vs #eta, p_{T} = 100 GeV/c");
hframe_scen2->SetXTitle("#eta");
hframe_scen2->SetYTitle("#sigma(#phi) [rad]");
hframe_scen2->Draw();
...
gr_scen2->Draw("P");
Canv->Update();
//Canv->SaveAs("Resphi_gaus_scen2.eps");
//Canv->WaitPrimitive();
...
for (int i=1;i<=nbin;i++){
  ...
  cout << "cutname is " << cutname <<endl;
  TH1F *resd0= new TH1F("d0","d0",500,-0.0015.,0.0015);   
  MyTree4->Project("d0","(resphi)",cutname);
  resd0->Fit("gaus");
  meanorig[i-1]=1.*resd0->GetMean();
  rms[i-1]=1.*resd0->GetRMS();
  cost[i-1]=gaus->GetParameter(0);
...
hframe_scen3 = new TH2F("hframe_scen3","Resphi_gaus_scen3",25,0.,2.5,100,0.00005,0.002);
hframe_scen3->SetTitle("#sigma(#phi) vs #eta, p_{T} = 100 GeV/c");
hframe_scen3->SetXTitle("#eta");
hframe_scen3->SetYTitle("#sigma(#phi) [rad]");
hframe_scen3->Draw();
...
for (int i=1;i<=nbin;i++){
  ...
  cout << "cutname is " << cutname <<endl;
  TH1F *resd0= new TH1F("d0","d0",500,-0.0015.,0.0015);   
  MyTree5->Project("d0","(resphi)",cutname);
  resd0->Fit("gaus");
  meanorig[i-1]=1.*resd0->GetMean();
  rms[i-1]=1.*resd0->GetRMS();
  cost[i-1]=gaus->GetParameter(0);
...
hframe_scen4 = new TH2F("hframe_scen4","Resphi_gaus_scen4",25,0.,2.5,100,0.00005,0.002);
hframe_scen4->SetTitle("#sigma(#phi) vs #eta, p_{T} = 100 GeV/c");
hframe_scen4->SetXTitle("#eta");
hframe_scen4->SetYTitle("#sigma(#phi) [rad]");
hframe_scen4->Draw();
...
Canv->Update();
Canv->SaveAs("Resphi_eta_gaus_CMSSW.eps");
Canv->SaveAs("Resphi_eta_gaus_CMSSW.gif");
