...
TFile f1("Misalignment_SurveyLASOnlyScenario_refitter_zmumu_singlemuSurveyLASCosmics.root");
TTree *MyTree2=Tracks;
  
TFile f2("../../singlemu_310607/Misalignment10.root");
TTree *MyTree3=Tracks;
  
TFile f3("../../singlemu_310607/Misalignment100.root");
...
hframe = new TH2F("hframe","Resphi_gaus",25,0.,2.5,100,0.00005,0.001);
...
hframe_scen1 = new TH2F("hframe_scen1","Resphi_gaus_scen1",25,0.,2.5,100,0.00005,0.001);
...
hframe_scen2 = new TH2F("hframe_scen1","Resphi_gaus_scen2",25,0.,2.5,100,0.00005,0.001);
...
hframe_scen3 = new TH2F("hframe_scen1","Resphi_gaus_scen3",25,0.,2.5,100,0.00005,0.001);
