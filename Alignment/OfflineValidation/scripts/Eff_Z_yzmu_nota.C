...
TFile f1("Misalignment_SurveyLASOnlyScenario_refitter_zmumuSurveyLASCosmics.root");
...
TFile f4("../../Z/Misalignment_NOAPE_2.root");
...
TH1F *yzmuzero = new TH1F("yzmuzero","yzmu zero",50,0.,2.7); 
TH1F *yzmuuno = new TH1F("yzmuuno","yzmu uno",50,0.,2.7); 
...
// //&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
 ...
 MyTree5->Project("yzmuzero_scen1_noErr","yzmu","yzmu>-101.");
 MyTree5->Project("yzmuuno_scen1_noErr","yzmu","eff==1 && recyzmu>-101.");
 ...
 Effyzmu_scen1_noErr->SetMarkerStyle(25);
 Effyzmu_scen1_noErr->SetMarkerColor(6);
...
leg1->AddEntry(Effyzmu_scen1,"SurveyLASCosmics Misalignment", "P");
leg1->AddEntry(Effyzmu_scen2,"10pb-1 Misalignment", "P");
leg1->AddEntry(Effyzmu_scen3,"100pb-1 Misalignment", "P");
leg1->AddEntry(Effyzmu_scen1_noErr,"10pb-1 Misalignment; APE not used", "P");
...
c1->SaveAs("Eff_Z_yzmu_CMSSW_1_3_4_lat.gif");
c1->SaveAs("Eff_Z_yzmu_CMSSW_1_3_4_lat.eps");
c1->SaveAs("Eff_Z_yzmu_CMSSW_1_3_4_lat.pdf");
