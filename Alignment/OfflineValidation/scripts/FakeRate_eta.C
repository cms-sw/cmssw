...
MyTree->Project("etazero","abs(receta)","recnhit>=8");
MyTree->Project("etauno","abs(receta)","recnhit>=8 && eff==1");
...
etadue->SetTitle("Fake rate vs #eta for bt03_ttH120_8j");
...
MyTree1->Project("etazero_scen1","abs(receta)","recnhit>=8");
MyTree1->Project("etauno_scen1","abs(receta)","recnhit>=8 && eff==1");
...
etadue_scen1->SetTitle("Fake rate vs #eta for bt03_ttH120_8j");
...
MyTree2->Project("etazero_noErr","abs(receta)","recnhit>=8");
MyTree2->Project("etauno_noErr","abs(receta)","recnhit>=8 && eff==1");
...
etadue->SetAxisRange(-0.005,0.15,"Y");
etadue->Draw();
...
c1->Update();
c1->SaveAs("Fake_eta_tth.eps");
c1->SaveAs("Fake_eta_tth.gif");
c1->WaitPrimitive();
