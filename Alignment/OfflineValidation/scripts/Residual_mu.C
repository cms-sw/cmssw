...
for(int i=0; i<4; i++){
  ...
  Respt[i]->SetTitle("#sigma(p_{T})/p_{T}");    
  Respt[i]->SetXTitle("#sigma(p_{T})/p_{T} ");
...
Legend("Respt[0]","Respt[1]","Respt[2]","Respt[3]",Respt[0],Respt[1],Respt[2],Respt[3]);
...
TLegend *leg = new TLegend(0.35,0.87.,1.,1.); 
leg->SetTextAlign(32);
leg->SetTextColor(1);
