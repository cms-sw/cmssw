...
//	void collectTrackRecExtrap(reco::MuonCollection::const_iterator muon, ResidualRefitting::storage_trackExtrap& storeTemp);
	...
	void CollectTrackHits(const edm::Handle<reco::TrackCollection>& trackColl, ResidualRefitting::storage_trackExtrap& trackExtrap,
                              const edm::EventSetup& eventSetup);
	void StoreTrackerRecHits(DetId detid, const TrackerTopology* tTopo, int iTrack, int iRec);
	void NewTrackMeasurements(const edm::Handle<reco::TrackCollection>& trackCollOrig, const edm::Handle<reco::TrackCollection>& trackColl,
	  ResidualRefitting::storage_trackExtrap& trackExtrap);
	int MatchTrackWithRecHits(reco::TrackCollection::const_iterator trackIt, const edm::Handle<reco::TrackCollection>& ref);
	...
	void cylExtrapTrkSam(int recNum, const reco::TrackRef& track, ResidualRefitting::storage_trackExtrap& storage, double rho);
