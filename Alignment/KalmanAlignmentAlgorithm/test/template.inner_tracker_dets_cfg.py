...
process.AlignmentProducer.algoConfig.AlgorithmConfig = cms.PSet(
    ...
    Setups = cms.vstring( "InnerTrackerTracking" ),

    InnerTrackerTracking = cms.PSet(
        AlignmentUpdator = cms.PSet( process.SingleTrajectoryUpdatorForStrips ),
        MetricsUpdator = cms.PSet( process.InnerTrackerExtendedMetricsUpdator ),
        TrajectoryFactory = cms.PSet( process.ReferenceTrajectoryFactory ),

        Tracking = cms.vint32( 3, 4 ),
        External = cms.vint32( 5, 6 ),
        ...
        MinExternalTrackingHits = cms.untracked.uint32(5)
    )
...
process.AlignmentProducer.algoConfig.ParameterConfig = cms.PSet(
    ...
    InitializationSelector = cms.vstring( "OuterTrackerDets", "InnerTrackerLayers", "InnerTrackerDets" ),
