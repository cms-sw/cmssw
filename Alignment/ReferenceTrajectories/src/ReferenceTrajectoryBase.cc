...
ReferenceTrajectoryBase::ReferenceTrajectoryBase(unsigned int nPar,
    ...
    : theValidityFlag(false), theParamCovFlag(false), theNumberOfHits(nHits),
      theNumberOfPars(nPar), theNumberOfVirtualMeas(nVirtualMeas),
      theNumberOfVirtualPars(nVirtualPar), theTsosVec(), theRecHits(),
      ...
      theTrajectoryPositionCov(nMeasPerHit * nHits, 0), theParameters(nPar),
...
bool ReferenceTrajectoryBase::useRecHit(
