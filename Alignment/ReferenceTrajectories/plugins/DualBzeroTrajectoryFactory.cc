...
protected:
  ...
  const DualBzeroTrajectoryInput
...
DualBzeroTrajectoryFactory::trajectories(
  ...
  while (itTracks != tracks.end()) {
    const DualBzeroTrajectoryInput input =
        this->referenceStateAndRecHits(*itTracks);
...
const TrajectoryStateOnSurface DualBzeroTrajectoryFactory::propagateExternal(
...
DEFINE_EDM_PLUGIN(TrajectoryFactoryPlugin, DualBzeroTrajectoryFactory,
