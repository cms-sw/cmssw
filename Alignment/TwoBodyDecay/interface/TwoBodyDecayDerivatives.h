...
public:
  ...
  TwoBodyDecayDerivatives(double mPrimary = 91.1876,
   ...
   */
  const std::pair<AlgebraicMatrix, AlgebraicMatrix>
  selectedDerivatives(const TwoBodyDecay &tbd,
   ...
   */
  const std::pair<AlgebraicMatrix, AlgebraicMatrix>
  selectedDerivatives(const TwoBodyDecayParameters &param,
                      const std::vector<bool> &selector) const;
...
private:
  ...
  const std::pair<AlgebraicMatrix, AlgebraicMatrix>
  dqsdzi(const TwoBodyDecayParameters &param,
