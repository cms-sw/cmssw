...
void HGCDigitizer::initializeEvent(edm::Event const& e, edm::EventSetup const& c){}
void HGCDigitizer::accumulate(edm::Event const& e, edm::EventSetup const& c){}
void HGCDigitizer::accumulate(PileUpEventPrincipal const& e, edm::EventSetup const& eventSetup) {}
void HGCDigitizer::finalizeEvent(edm::Event& e, edm::EventSetup const& c){}
