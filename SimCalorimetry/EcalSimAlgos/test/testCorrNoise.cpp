...
int main() {
  ...
  TH1F *uncorr = new TH1F(
      "uncorr", "first 3 samples, uncorrelated distribution", 200, -10., 10.);
  TH1F *corr = new TH1F("corr", "first 3 samples, correlated distribution", 200,
                        -10., 10.);

  TH1F *uncorrPed = new TH1F(
      "uncorrPed", "first 3 samples, uncorrelated average", 200, -10., 10.);
  TH1F *corrPed = new TH1F("corrPed", "first 3 samples, correlated average",
                           200, -10., 10.);
  ...
  const int csize = 500;
  TCanvas *showNoise =
      new TCanvas("showNoise", "showNoise", 2 * csize, 2 * csize);
  ...
  TCanvas *showNoiseFrame =
      new TCanvas("showNoiseFrame", "showNoiseFrame", 2 * csize, 2 * csize);
