...
public:
  ...
  /// ctor
  EcalCoder(bool addNoise, bool PreMix1, Noisifier *ebCorrNoise0,
            Noisifier *eeCorrNoise0 = nullptr,
            Noisifier *ebCorrNoise1 = nullptr,
            Noisifier *eeCorrNoise1 = nullptr,
            Noisifier *ebCorrNoise2 = nullptr,
            Noisifier *eeCorrNoise2 =
                nullptr); // make EE version optional for tb compatibility
  /// dtor
  virtual ~EcalCoder();
  ...
  virtual void analogToDigital(CLHEP::HepRandomEngine *, const EcalSamples &clf,
...
private:
  ...
  void encode(const EcalSamples &ecalSamples, EcalDataFrame &df,
  ...
  void findPedestal(const DetId &detId, int gainId, double &pedestal,
                    double &width) const;
  ...
  const EcalIntercalibConstantsMC
      *m_intercals; // record specific for simulation of gain variation in MC
