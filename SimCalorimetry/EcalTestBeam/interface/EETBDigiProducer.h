#ifndef EETBDDIGIPRODUCER_H
#define EETBDDIGIPRODUCER_H
...
class EETBDigiProducer : public edm::EDProducer
{
public:
  ...
  //
  explicit EETBDigiProducer(const edm::ParameterSet& params);
  virtual ~EETBDigiProducer();
...
private:
  ...
  std::string digiCollectionLabel_;
  std::string hitsProducerLabel_;
