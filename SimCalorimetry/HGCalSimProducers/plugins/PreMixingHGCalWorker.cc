...
private:
  edm::EDGetTokenT<PreMixHGCSimAccumulator> signalToken_;
...
PreMixingHGCalWorker::PreMixingHGCalWorker(const edm::ParameterSet& ps,
    ...
    : signalToken_(iC.consumes<PreMixHGCSimAccumulator>(ps.getParameter<edm::InputTag>("digiTagSig"))),
...
void PreMixingHGCalWorker::addSignals(const edm::Event& e, const edm::EventSetup& ES) {
  edm::Handle<PreMixHGCSimAccumulator> handle;
