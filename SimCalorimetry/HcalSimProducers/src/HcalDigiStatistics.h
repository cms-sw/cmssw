...
public:
  HcalDigiStatistics(std::string name, int maxBin, float amplitudeThreshold,
                     float expectedPedestal, float binPrevToBinMax,
                     float binNextToBinMax, CaloHitAnalyzer &amplitudeAnalyzer)
...
template <class Digi> void HcalDigiStatistics::analyze(const Digi &digi) {
