...
ProtoJet2::ProtoJet2(): m_e(0), m_px(0), m_py(0), m_pz(0) {
}

ProtoJet2::ProtoJet2(const Candidates& theConstituents) {
...
HepLorentzVector ProtoJet2::getLorentzVector() const {
...
void ProtoJet2::calculateLorentzVector() {
