...
// $Id: JetTracksAssociatorAtCaloFace.cc,v 1.5 2010/03/16 21:45:55 srappocc Exp $
//
...
void JetTracksAssociatorAtCaloFace::beginRun( edm::Run const & run, edm::EventSetup const & setup)
{
}
