////////////////////////////////////////////////////////////////////////////////
//
// OldFastjetJetProducer
// ------------------
//
//            04/21/2009 Philipp Schieferdecker <philipp.schieferdecker@cern.ch>
////////////////////////////////////////////////////////////////////////////////

#include "RecoJets/JetProducers/plugins/OldFastjetJetProducer.h"
...
OldFastjetJetProducer::OldFastjetJetProducer(const edm::ParameterSet& iConfig)
  : OldVirtualJetProducer( iConfig ),
...
//______________________________________________________________________________
OldFastjetJetProducer::~OldFastjetJetProducer()
{
} 
...
void OldFastjetJetProducer::produce( edm::Event & iEvent, const edm::EventSetup & iSetup )
{
  ...
  if (!makeTrackJet(jetTypeE)) {
     ...
     OldVirtualJetProducer::produce( iEvent, iSetup );
...
void OldFastjetJetProducer::produceTrackJets( edm::Event & iEvent, const edm::EventSetup & iSetup )
{
...
//______________________________________________________________________________
void OldFastjetJetProducer::runAlgorithm( edm::Event & iEvent, edm::EventSetup const& iSetup)
{
  // run algorithm
  /*
  fjInputs_.clear();
...
DEFINE_FWK_MODULE(OldFastjetJetProducer);
