# /frozen/2015/50ns_5e33/v3.0/HLT/V1 (CMSSW_7_4_6_patch3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/frozen/2015/50ns_5e33/v3.0/HLT/V1')
)
...
process.datasets = cms.PSet( 
  ...
  Charmonium = cms.vstring( 'HLT_Dimuon0_Jpsi_Muon_v1',
  ...
  DQMOfflinePD = cms.vstring( 'HLT_DiPFJetAve40_v1',
    'HLT_PFHT350_v2',
    'HLT_QuadPFJet_SingleBTagCSV_VBF_Mqq500_v2' ),
  ...
  DoubleMuon = cms.vstring( 'HLT_DoubleMu18NoFiltersNoVtx_v1',
  ...
  HTMHT = cms.vstring( 'HLT_DiCentralPFJet55_PFMET110_NoiseCleaned_v1',
  ...
  LookAreaPD = ( cms.vstring( 'HLT_AK4CaloJet100_v2',
    ...
    'HLT_Mu34_v1',
    'HLT_Mu350_v1',
    'HLT_Mu38NoFiltersNoVtxDisplaced_DisplacedJet60_Loose_v2')+cms.vstring( 'HLT_Mu38NoFiltersNoVtxDisplaced_DisplacedJet60_Tight_v2',
    ...
    'HLT_VBF_DisplacedJet40_VVTightID_Hadronic_v2',
    'HLT_ZeroBias_v1') ),
  MET = cms.vstring( 'HLT_CaloMET200_NoiseCleaned_v2',
    'HLT_CaloMHTNoPU90_PFMET90_PFMHT90_IDTight_BTagCSV0p72_v1',
    'HLT_CaloMHTNoPU90_PFMET90_PFMHT90_IDTight_v1',
    'HLT_MET250_v1',
    'HLT_MET300_v1',
  ...
  MuOnia = cms.vstring( 'HLT_Dimuon0_Phi_Barrel_v1',
    'HLT_Dimuon0_Upsilon_Muon_v1',
    'HLT_Dimuon13_Upsilon_v1',
    'HLT_Dimuon8_Upsilon_Barrel_v1',
    'HLT_Mu16_TkMu0_dEta18_Onia_v2',
  ...
  TestEnablesEcalHcalDQM = cms.vstring( 'HLT_EcalCalibration_v1',
    'HLT_HcalCalibration_v1' ),
  ToTOTEM = cms.vstring( 'HLT_L1SingleMuOpen_v1' ),
...
process.HLTFastRecopixelvertexingSequence = cms.Sequence( process.hltFastPrimaryVertex + cms.ignore( process.hltFastPVPixelVertexFilter ) + process.hltFastPVPixelTracks + process.hltFastPVJetTracksAssociator + cms.ignore( process.hltFastPVJetVertexChecker ) + process.hltFastPVPixelTracksRecover + process.hltFastPVPixelTracksMerger + process.hltFastPVPixelVertices + cms.ignore( process.hltFastPVPixelVerticesFilter ) )
process.HLTFastPrimaryVertexSequence = cms.Sequence( cms.ignore( process.hltSelectorJets20L1FastJet ) + cms.ignore( process.hltSelectorCentralJets20L1FastJeta ) + cms.ignore( process.hltSelector4CentralJetsL1FastJet ) + process.HLTDoLocalPixelSequenceRegForBTag + process.HLTFastRecopixelvertexingSequence )
...
process.HLTAK4PFJetsCorrectionSequence = cms.Sequence( process.hltFixedGridRhoFastjetAll + process.HLTAK4PFCorrectorProducersSequence + process.hltAK4PFJetsCorrected )
...
process.HLTriggerFinalPath = cms.Path( process.hltGtDigis + process.hltScalersRawToDigi + process.hltFEDSelector + process.hltTriggerSummaryAOD + process.hltTriggerSummaryRAW + cms.ignore( process.hltBoolFalse ) )


process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_QuadJet45_TripleBTagCSV0p67_v2, process.HLTriggerFinalPath ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'file:00529081-1EF1-E411-9BA2-0026189438EF.root'
#        'root://cms-xrd-global.cern.ch//store/mc/RunIISpring15Digi74/QCD_Pt-15to3000_TuneCUETP8M1_Flat_13TeV_pythia8/GEN-SIM-RAW/Flat_10_50_50ns_tsg_MCRUN2_74_V6-v1/00000/00529081-1EF1-E411-9BA2-0026189438EF.root',
    ),
...
process.l1GtTriggerMenuXml = cms.ESProducer("L1GtTriggerMenuXmlProducer",
  ...
  DefXmlFile = cms.string('L1Menu_Collisions2015_50nsGct_v3_L1T_Scales_20141121.xml'),
...
_customInfo['inputFile' ]=  ['file:00529081-1EF1-E411-9BA2-0026189438EF.root']
