#ifndef JetProducers_AntiKtJetProducer_h
#define JetProducers_AntiKtJetProducer_h

/** \class AntiKtJetProducer
 *
 * AntiKtJetProducer is the EDProducer subclass which runs
 * the AntiKtJetAlgorithm for jetfinding.
 * 
...
namespace cms
{
  class AntiKtJetProducer : public cms::BaseJetProducer
  {
  public:

    AntiKtJetProducer(const edm::ParameterSet& ps);

    /**Default destructor*/
    virtual ~AntiKtJetProducer() {}
    /** run algorithm itself */
    virtual bool runAlgorithm (const JetReco::InputCollection& fInput, JetReco::OutputCollection* fOutput);

  private:
    /** Reconstruction algorithm*/
    AntiKtJetAlgorithmWrapper alg_;
  };
}
