#ifndef JetProducers_AntiKtPilupSubtractionJetProducer_h
#define JetProducers_AntiKtPilupSubtractionJetProducer_h
...
namespace cms
{
  class AntiKtPilupSubtractionJetProducer : public cms::BasePilupSubtractionJetProducer
  {
  public:

    AntiKtPilupSubtractionJetProducer(const edm::ParameterSet& ps);

    /**Default destructor*/
    virtual ~AntiKtPilupSubtractionJetProducer() {}
