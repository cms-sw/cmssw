...
void reco::helper::JetIDHelper::calculate( const edm::Event& event, const reco::CaloJet &jet, const int iDbg )
{
  ...
  if( iDbg > 1 ) {
    cout<<"E:";
    for (auto & subtower : subtowers) cout<<" "<<subtower.E<<","<<subtower.Nhit;
    cout<<"\nECal_E:";
    for (auto & Ecal_subtower : Ecal_subtowers) cout<<" "<<Ecal_subtower.E<<","<<Ecal_subtower.Nhit;
    cout<<"\nHCal_E:";
    for (auto & Hcal_subtower : Hcal_subtowers) cout<<" "<<Hcal_subtower.E<<","<<Hcal_subtower.Nhit;
    cout<<"\nHO_E:";
    for (auto & HO_subtower : HO_subtowers) cout<<" "<<HO_subtower.E<<","<<HO_subtower.Nhit;
    cout<<"\nHPD_E:";
    for (double HPD_energie : HPD_energies) cout<<" "<<HPD_energie;
    cout<<"\nRBX_E:";
    for (double RBX_energie : RBX_energies) cout<<" "<<RBX_energie;
    cout<<endl;
  }
...
{
  double totalE = 0;
  for(double descending_energie : descending_energies) totalE += descending_energie;
...
{
  double totalE = 0;
  for(auto descending_tower : descending_towers) totalE += descending_tower.E;
