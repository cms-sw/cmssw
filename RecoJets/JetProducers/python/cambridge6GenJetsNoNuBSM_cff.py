...
# $Id: cambridge6GenJetsNoNuBSM_cff.py,v 1.3 2008/08/20 16:10:09 oehler Exp $
...
cambridge6GenJetsNoNuBSM = cms.EDProducer("CambridgeJetProducer",
    FastjetNoPU,
    CambridgeJetParameters,
    GenJetParametersNoNuBSM,
    
    alias = cms.untracked.string('CAMBRIDGE6GenJetNoNuBSM'),
