...
RecoJetsFEVT = cms.PSet(
    outputCommands = cms.untracked.vstring('keep recoCaloJets_*_*_*', 
                                           ...
                                           'keep *_ak8JetTracksAssociatorAtVertex*_*_*', 
                                           'keep *_ak8JetTracksAssociatorAtCaloFace*_*_*', 
                                           'keep *_ak8JetExtender_*_*',
                                           'keep *_ak4JetID_*_*','keep *_ak8JetID_*_*',
                                           'keep *_sc5JetID_*_*','keep *_sc7JetID_*_*',
                                           'keep *_ak4JetID_*_*','keep *_ic7JetID_*_*',
                                           ...
                                           'keep *_ak8BasicJets_*_*',
                                           'keep *_ak8CastorJetID_*_*',
...
RecoJetsAOD = cms.PSet(
    outputCommands = cms.untracked.vstring(#        'keep *_kt4CaloJets_*_*', 
                                           ...
                                           'keep *_ak4JetTracksAssociatorAtVertexPF_*_*', 
                                           'keep *_ak4JetTracksAssociatorExplicit_*_*',
                                           #'keep *_ak8JetTracksAssociatorAtVertex_*_*', 
                                           #        'keep *_ak4JetExtender_*_*', 
                                           #'keep *_kt4JetExtender_*_*', 
                                           'keep *_ak4JetExtender_*_*', 
                                           #'keep *_ak8JetExtender_*_*',       
