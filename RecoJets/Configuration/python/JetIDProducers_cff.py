...
from RecoJets.JetProducers.ak8JetID_cfi import *
...
recoAllJetIds = cms.Sequence( ak4JetID + ak8JetID + sc5JetID + sc7JetID + ak4JetID +
                              kt4JetID + #kt6JetID +
                              ca4JetID + ca6JetID + gk5JetID + gk7JetID )

recoJetIds = cms.Sequence( ak4JetID + ak8JetID + ak4JetID )
