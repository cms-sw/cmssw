...
process.partonJetCorrectionExample = cms.EDFilter("PartonJetCorrectionExample",
    ...
    gJetCorrector = cms.string('L7PartonJetCorrectorAK5gJet'),
    qJetCorrector = cms.string('L7PartonJetCorrectorAK5qJet'),
    bJetCorrector = cms.string('L7PartonJetCorrectorAK5bJet'),
    bTopCorrector = cms.string('L7PartonJetCorrectorAK5bTop')
)
