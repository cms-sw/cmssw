...
# filter optimization for FFTJet pule-up determination for CaloJets
#
...
from RecoJets.FFTJetProducers.fftjetpileupprocessor_calostudy_cfi import *
from RecoJets.JetAnalyzers.fftjetpileupanalyzer_cfi import *

fftjet_pileup_analyzer.histoLabel = cms.InputTag(
    "pileupprocessor", "FFTJetPileupCaloStudy")
