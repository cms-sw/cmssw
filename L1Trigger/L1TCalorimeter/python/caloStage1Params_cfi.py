...
caloStage1Params.jetSeedThreshold      = cms.double(0.5)
...
caloStage1Params.jetCalibrationLUTFile = cms.FileInPath("L1Trigger/L1TCalorimeter/data/jetCalibrationLUT_stage1_symmetric_usingGCTParameters_test.txt")
