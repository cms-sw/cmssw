...
namespace l1t {
  ...
  L1TStage2CaloAnalyzer::L1TStage2CaloAnalyzer(const edm::ParameterSet& iConfig)
    ...
    typeStr_.emplace_back("tower");
    typeStr_.emplace_back("cluster");
    typeStr_.emplace_back("mpeg");
    typeStr_.emplace_back("mptau");
    typeStr_.emplace_back("mpjet");
    typeStr_.emplace_back("mpsumet");
    typeStr_.emplace_back("mpsumethf");
    typeStr_.emplace_back("mpsumetem");
    typeStr_.emplace_back("mpsummetx");
    typeStr_.emplace_back("mpsummetxhf");
    typeStr_.emplace_back("mpsummety");
    typeStr_.emplace_back("mpsummetyhf");
    typeStr_.emplace_back("mpsumht");
    typeStr_.emplace_back("mpsumhthf");
    typeStr_.emplace_back("mpsummhtx");
    typeStr_.emplace_back("mpsummhtxhf");
    typeStr_.emplace_back("mpsummhty");
    typeStr_.emplace_back("mpsummhtyhf");
    typeStr_.emplace_back("eg");
    typeStr_.emplace_back("tau");
    typeStr_.emplace_back("jet");
    typeStr_.emplace_back("sumet");
    typeStr_.emplace_back("sumetem");
    typeStr_.emplace_back("sumht");
    typeStr_.emplace_back("summet");
    typeStr_.emplace_back("summethf");
    typeStr_.emplace_back("summht");
    typeStr_.emplace_back("summhthf");
    typeStr_.emplace_back("mpminbiashfp0");
    typeStr_.emplace_back("mpminbiashfm0");
    typeStr_.emplace_back("mpminbiashfp1");
    typeStr_.emplace_back("mpminbiashfm1");
    typeStr_.emplace_back("minbiashfp0");
    typeStr_.emplace_back("minbiashfm0");
    typeStr_.emplace_back("minbiashfp1");
    typeStr_.emplace_back("minbiashfm1");
    typeStr_.emplace_back("mpsumhitowercount");
    typeStr_.emplace_back("sumhitowercount");
    typeStr_.emplace_back("sumcentrality");
    typeStr_.emplace_back("sumasymet");
    typeStr_.emplace_back("sumasymethf");
    typeStr_.emplace_back("sumasymht");
    typeStr_.emplace_back("sumasymhthf");
  }
