...
#                                           'keep *_*_*_L1TEMULATION'),    
    fileName = cms.untracked.string('SimL1Emulator_Stage1_l1extra.root'),
...
## see L1Trigger/L1TCalorimeter/python/l1tCaloStage1Digis_cfi.py and
## L1Trigger/L1TCalorimeter/python/l1tStage1CaloParams_cfi.py for more info
