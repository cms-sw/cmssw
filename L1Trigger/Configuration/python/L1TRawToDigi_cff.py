...
def unpack_stage2():
    ...
    L1TRawToDigi_Stage2 = cms.Sequence(rpcCPPFRawToDigi + RPCTwinMuxRawToDigi + twinMuxStage2Digis * bmtfDigis + omtfStage2Digis + emtfStage2Digis + caloLayer1Digis + caloStage2Digis + gmtStage2Digis + gtStage2Digis)
