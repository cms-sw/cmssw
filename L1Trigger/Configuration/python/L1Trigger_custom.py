...
def customiseL1Menu(process):
    ...
    if l1MenuSource == 'sqlFile' :
        ...
        useSqlFile = '/afs/cern.ch/user/g/ghete/public/L1Menu/L1Menu_Collisions2012_v3/sqlFile/L1Menu_Collisions2012_v3_mc.db'
        menuDbTag = 'L1GtTriggerMenu_L1Menu_Collisions2012_v3_mc'
        ...
        useXmlFile = 'L1Menu_Collisions2012_v3_L1T_Scales_20101224_Imp0_0x102b.xml'
