...
public:
  ...
  virtual int GetTowerNumOnTb(const L1RpcConst::L1RpcConeCrdnts& coneCrdnts) = 0;

  ///Returns pointer to PAC that should run given LogCone.
  virtual const L1RpcPac* GetPac(const L1RpcConst::L1RpcConeCrdnts& coneCrdnts) const = 0;

  ///Returns the index of TC that should run given LogCone.
  virtual int GetTCNum(const L1RpcConst::L1RpcConeCrdnts& coneCrdnts) = 0;

  ///Returns the index of TB (in TC) that should run given LogCone.
  virtual int GetTBNum(const L1RpcConst::L1RpcConeCrdnts& coneCrdnts) = 0;
