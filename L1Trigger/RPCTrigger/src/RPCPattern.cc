...
int RPCPattern::getBendingStripFrom(int logPlane, int m_tower) {
...
int RPCPattern::getBendingStripTo(int logPlane, int m_tower) {
  if (m_Strips[logPlane].m_StripTo == RPCConst::m_NOT_CONECTED+1)
    return  RPCConst::m_NOT_CONECTED;                                                   //expand
  return m_Strips[logPlane].m_StripTo - m_Strips[RPCConst::m_REF_PLANE[m_tower]].m_StripFrom - (RPCConst::m_LOGPLANE_SIZE[m_tower][logPlane] - RPCConst::m_LOGPLANE_SIZE[m_tower][RPCConst::m_REF_PLANE[m_tower]])/2;
}
