...
L1MuDTTrackSegEta::L1MuDTTrackSegEta() : m_location(), m_position(0), m_quality(0), m_bx(0) {}

L1MuDTTrackSegEta::L1MuDTTrackSegEta(int wheel_id, int sector_id, int station_id, int pos, int quality, int bx)
    : m_location(wheel_id, sector_id, station_id), m_position(pos), m_quality(quality), m_bx(bx) {}

L1MuDTTrackSegEta::L1MuDTTrackSegEta(const L1MuDTTrackSegLoc& id, int pos, int quality, int bx)
