...
L1MuDTSecProcId::L1MuDTSecProcId() : m_wheel(0), m_sector(0) {}

L1MuDTSecProcId::L1MuDTSecProcId(int wheel_id, int sector_id) : m_wheel(wheel_id), m_sector(sector_id) {
...
L1MuDTSecProcId::L1MuDTSecProcId(const L1MuDTSecProcId& id) : m_wheel(id.m_wheel), m_sector(id.m_sector) {}
...
//
int L1MuDTSecProcId::locwheel() const { return (m_wheel / abs(m_wheel) * (abs(m_wheel) - 1)); }
...
ostream& operator<<(ostream& s, const L1MuDTSecProcId& id) {
  ...
  s << "Sector Processor ( " << setw(2) << id.wheel() << "," << setw(2) << id.sector() << " )";
  return s;
}
