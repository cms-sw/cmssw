...
class L1MuDTEUX : public L1AbstractProcessor {
  ...
  private:
    ...
    int               theExtFilter = 1;        // extrapolation quality filter
    unsigned short    nbit_phi = 12;           // number of bits used for phi
    unsigned short    nbit_phib = 10;          // number of bits used for phib
