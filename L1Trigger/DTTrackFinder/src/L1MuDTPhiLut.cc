...
int L1MuDTPhiLut::load() {
  ...
  for ( int idx = 0; idx < 2; idx++ ) {
    ...
    // assemble file name
    edm::FileInPath lut_f = edm::FileInPath(string("L1Trigger/DTTrackFinder/parameters/" + phi_dir + phi_str + ".lut"));
...
void L1MuDTPhiLut::setPrecision() {
  ...
  nbit_phi  = 12;
  nbit_phib = 10;
  nbit_phi  = L1MuDTTFConfig::getNbitsPhiPhi();
  nbit_phib = L1MuDTTFConfig::getNbitsPhiPhib();
...
//
pair<unsigned short, unsigned short> L1MuDTPhiLut::getPrecision() {
