...
void Phase2L1TGMTStubProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  }
  {
    ...
    psd0.add<std::vector<int>>("eta_1",
                               {
                                   -46, -45, -43, -41, -39, -37, -35, -30, -28, -26, -23, -20, -18,
                                   -15, -9,  -6,  -3,  -1,  1,   3,   6,   9,   15,  18,  20,  23,
                                   26,  28,  30,  35,  37,  39,  41,  43,  45,  46,  //1503 I think the large entries at the end here were a mistake
                               });
    psd0.add<std::vector<int>>(
        "eta_2",
        {
            -41, -39, -38, -36, -34, -32, -30, -26, -24, -22, -20, -18, -15, -13, -8, -5, -3, -1,
            1,   3,   5,   8,   13,  15,  18,  20,  22,  24,  26,  30,  32,  34,  36, 38, 39, 41,  //1334
        });
    psd0.add<std::vector<int>>(
        "eta_3",
        {
            -35, -34, -32, -31, -29, -27, -26, -22, -20, -19, -17, -15, -13, -11, -6, -4, -2, -1,
            1,   2,   4,   6,   11,  13,  15,  17,  19,  20,  22,  26,  27,  29,  31, 32, 34, 35,  //1148
        });
