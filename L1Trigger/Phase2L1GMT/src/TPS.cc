...
std::vector<l1t::TrackerMuon> TPS::processEvent(const std::vector<edm::Ptr<l1t::TrackerMuon::L1TTTrackType> >& tracks,
      ...
      std::vector<PreTrackMatchedMuon> muCleaned8 = tps_->cleanNeighbor(mu8, mu7, mu0, false);  //ARGH! 9 sectors - so some duplicates very rarely
...
std::vector<edm::Ptr<l1t::TrackerMuon::L1TTTrackType> > TPS::associateTracksWithNonant(const std::vector<edm::Ptr<l1t::TrackerMuon::L1TTTrackType> >& tracks, uint processor) {
