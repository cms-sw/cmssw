...
// constructors
//     default
L1GtExternalCondition::L1GtExternalCondition() : L1GtConditionEvaluation() { m_conditionResult = false; }

//     from base template condition (from event setup usually)
L1GtExternalCondition::L1GtExternalCondition(const L1GtCondition *externalTemplate, const bool result)
...
L1GtExternalCondition::L1GtExternalCondition(const L1GtExternalCondition &cp) : L1GtConditionEvaluation() { copy(cp); }
