...
namespace L1Analysis
{
  ...
  public:
    ...
    void SetEm   (edm::Handle<l1t::EGammaBxCollection> em,   unsigned maxL1Upgrade);
    void SetTau  (edm::Handle<l1t::TauBxCollection>    tau,  unsigned maxL1Upgrade);
    void SetJet  (edm::Handle<l1t::JetBxCollection>    jet,  unsigned maxL1Upgrade);
    void SetSum  (edm::Handle<l1t::EtSumBxCollection>  sums, unsigned maxL1Upgrade);
    void SetMuon (edm::Handle<l1t::MuonBxCollection>   muon, unsigned maxL1Upgrade);
