...
public:
  ...
  bool LLLSeeding(FPGAStub* innerFPGAStub, L1TStub* innerStub, FPGAStub* middleFPGAStub, L1TStub* middleStub, FPGAStub* outerFPGAStub, L1TStub* outerStub){
	  
    if (debug1) {
      cout << "FPGATrackletCalculatorDisplaced "<<getName()<<" "<<layer_<<" trying stub triplet in layer (L L L): "
    ...
    if(fabs(rinvapprox)>rinvcut){
      if (debug1) 
	cout << "FPGATrackletCalculator::LLL Seeding irinv too large: "
	     <<rinvapprox<<"("<<irinv<<")\n";
      success = false;
    }
    ...
    if (debug1) {
      cout << "FPGATrackletCalculatorDisplaced "<<getName()<<" Found LLL tracklet in sector = "
  ...
  bool DDLSeeding(FPGAStub* innerFPGAStub, L1TStub* innerStub, FPGAStub* middleFPGAStub, L1TStub* middleStub, FPGAStub* outerFPGAStub, L1TStub* outerStub){
	  
    if (debug1) {
      cout << "FPGATrackletCalculatorDisplaced "<<getName()<<" "<<layer_<<" trying stub triplet in  (L2 D1 D2): "
    ...
    if(fabs(rinvapprox)>rinvcut){
      if (debug1) 
	cout << "FPGATrackletCalculator::DDL Seeding irinv too large: "
	     <<rinvapprox<<"("<<irinv<<")\n";
      success = false;
    }
    if (fabs(z0approx)>1.8*z0cut) {
    ...
    if (debug1) {
      cout << "FPGATrackletCalculatorDisplaced "<<getName()<<" Found DDL tracklet in sector = "
	   <<iSector_<<" phi0 = "<<phi0<<endl;
    }
  ...
  bool LLDSeeding(FPGAStub* innerFPGAStub, L1TStub* innerStub, FPGAStub* middleFPGAStub, L1TStub* middleStub, FPGAStub* outerFPGAStub, L1TStub* outerStub){
	  
    if (debug1) {
      cout << "FPGATrackletCalculatorDisplaced "<<getName()<<" "<<layer_<<" trying stub triplet in  (L2L3D1): "
    ...
    if(fabs(rinvapprox)>rinvcut){
      if (debug1) 
	cout << "FPGATrackletCalculator:: LLD Seeding irinv too large: "
	     <<rinvapprox<<"("<<irinv<<")\n";
      success = false;
    }
    if (fabs(z0approx)>1.8*z0cut) {
    ...
    if (debug1) {
      cout << "FPGATrackletCalculatorDisplaced "<<getName()<<" Found LLD tracklet in sector = "
	   <<iSector_<<" phi0 = "<<phi0<<endl;
    }
