...
#ifndef FPGACABLING_H
#define FPGACABLING_H
...
public:
  ...
  void writephirange() {
    ...
    std::map<string, FPGADTC>::const_iterator it=dtcranges.begin();
...
private:
  ...
  std::map<string,FPGADTC> dtcranges;

  std::map<string,FPGADTC> dtcs;
