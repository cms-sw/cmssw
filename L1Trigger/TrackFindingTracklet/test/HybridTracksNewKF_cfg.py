...
process.load( 'Configuration.Geometry.GeometryExtended2026DD88Reco_cff' ) 
process.load( 'Configuration.Geometry.GeometryExtended2026DD88_cff' )
...
#from MCsamples.RelVal_1130_DD88.PU200_TTbar_14TeV_cfi import *
