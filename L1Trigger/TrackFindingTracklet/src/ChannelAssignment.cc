...
namespace trklet {
  ...
  ChannelAssignment::ChannelAssignment(const Config& iConfig, const Setup* setup)
      : setup_(setup),
        ...
        tqBaseShiftChi21_(iConfig.tqBaseShiftChi21_),
        tqWidthInvV0_(iConfig.tqWidthInvV0_),
        tqWidthInvV1_(iConfig.tqWidthInvV1_),
        tqWidthMVA_(iConfig.tqWidthMVA_),
        tqBinEdges_(iConfig.tqBinEdges_),
