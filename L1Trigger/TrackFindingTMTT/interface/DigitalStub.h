...
namespace tmtt {
  ...
  public:
    ...
    void init(float phi_orig,
              ...
              unsigned int max_qOverPt_bin_orig,
    ...
    int iDigi_Rt() const {
      this->okGP();
      return iDigi_Rt_;
    }  // r coord. relative to chosen radius
    ...
    int iDigi_Z_KF() const {
      this->okSForTF();
      return iDigi_Z_KF_;
    }  // z coord for internal KF use
    // %%% Those exclusively input to HT.
    unsigned int iDigi_PhiSec() const {
      this->okHT();
      return iDigi_PhiSec_;
    }  // phi sector number
    ...
    unsigned int iDigi_Nonant() const {
      this->okGP();
      return iDigi_Nonant_;
    }  // phi nonant number
    int iDigi_PhiO() const {
      this->okGP();
      return iDigi_PhiO_;
    }  // phi coord. relative to nonant
    ...
    unsigned int iDigi_LayerID() const {
      this->okHT();
      return iDigi_LayerID_;
    }
    // %%% Those exclusively input to GP.
    float phiO() const {
      this->okGP();
