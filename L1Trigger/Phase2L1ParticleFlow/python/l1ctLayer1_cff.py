...
l1tLayer1HGCal = cms.EDProducer("L1TCorrelatorLayer1Producer",
    ...
    hgcalInputConversionParameters = cms.PSet(
        ...
        multiclass_id = cms.PSet(
            ...
            wp_PU = cms.vdouble(0.32930246, 0.6724721),
            wp_Pi = cms.vdouble(0.13878925, 0.061126072),
            wp_EgEm = cms.vdouble(0.16249725, 0.25411782),
            wp_PFEm = cms.vdouble(0.16249725, 0.25411782),
        ),
