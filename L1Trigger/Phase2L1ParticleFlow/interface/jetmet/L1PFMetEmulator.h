...
namespace L1METEmu {
  ...
  inline Particle_xy Get_xy(l1ct::pt_t hwPt, l1ct::glbphi_t hwPhi) {
    ...
    */
    ...
    poly_t cos_var = cos2_par0[phibin] + cos2_par1[phibin] * (hwPhi - phi2_edges[phibin]) +
                     cos2_par2[phibin] * (hwPhi - phi2_edges[phibin]) * (hwPhi - phi2_edges[phibin]);
    poly_t sin_var = sin2_par0[phibin] + sin2_par1[phibin] * (hwPhi - phi2_edges[phibin]) +
