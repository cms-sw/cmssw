...
namespace l1tpf_impl { 
  ...
  class PuppiAlgo : public PUAlgoBase {
    ...
    protected:
        ...
        virtual void computePuppiWeights(Region &r, const std::vector<float> & alphaC, const std::vector<float> & alphaF, float alphaCMed, float alphaCRms, float alphaFMed, float alphaFRms) const ;
