...
namespace l1t {
  ...
  public:
    L1TYellowAlg_v1(const L1TYellowDBParams & dbPars);
    virtual ~L1TYellowAlg_v1();
    virtual void processEvent(edm::Event& iEvent, L1TYellowOutputCollection & out);
  private:
    void do_something_specific_to_v1_firmware();
    L1TYellowDBParams const & db;
    int data_specific_to_v1_firmware;
  };

  class L1TYellowAlg_v2 : public L1TYellowAlg {
  public:
    L1TYellowAlg_v2(const L1TYellowDBParams & dbPars);
