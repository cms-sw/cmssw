...
//--- Métodos públicos
//------------------------------------------------------------------
bool DTPrimitive::isValidTime(void) { return (tdcTimeStamp >= 0 ? true : false); }
...
int DTPrimitive::getTDCTimeNoOffset(void) { return tdcTimeStamp - timeCorrection; }
