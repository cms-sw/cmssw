...
int MuonPathFilter::areCousins(metaPrimitive mp, metaPrimitive segunda) {
    if(mp.rawId!=segunda.rawId) return 0;
    if(mp.wi1==segunda.wi1 and mp.tdc1==segunda.tdc1 and mp.wi1!=-1 and mp.tdc1!=-1) return 1;
    if(mp.wi2==segunda.wi2 and mp.tdc2==segunda.tdc2 and mp.wi2!=-1 and mp.tdc2!=-1) return 2;
    if(mp.wi3==segunda.wi3 and mp.tdc3==segunda.tdc3 and mp.wi3!=-1 and mp.tdc3!=-1) return 3;
    if(mp.wi4==segunda.wi4 and mp.tdc4==segunda.tdc4 and mp.wi4!=-1 and mp.tdc4!=-1) return 4;
    return 0;
}
