...
#process.GlobalTag.globaltag = "94X_dataRun2_ReReco_EOY17_v2" #silvia gt
...
#process.source = cms.Source("PoolSource",fileNames = cms.untracked.vstring('file:/afs/cern.ch/user/g/goys/public/fit/digis_segments_partRun2017FSingleMuonRAW-RECO.root')) #silvia file
