...
private:
  ...
  public:
    ...
    TTUResults(int idx, int bx, int wh1, int wh2) : m_ttuidx(idx), m_bx(bx), m_trigWheel1(wh1), m_trigWheel2(wh2) { ; }

    TTUResults(int idx, int bx, int wh1, int wh2, int wdg)
        : m_ttuidx(idx), m_bx(bx), m_trigWheel1(wh1), m_trigWheel2(wh2), m_wedge(wdg) {
      ;
    }
