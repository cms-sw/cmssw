...
public:
  ...
  public:
    ...
    bool operator==(const Seed& rhs) { return (m_sectorId == rhs.m_sectorId) && (m_stationId == rhs.m_stationId); };
  ...
  public:
    ...
    void updateTrkLength() { m_tracklength = m_seeds.size(); };

    bool operator<(const Track& rhs) { return m_tracklength < rhs.m_tracklength; };
  ...
  void setMinTrkLength(int val) { m_mintrklength = val; };
