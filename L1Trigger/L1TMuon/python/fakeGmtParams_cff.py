...
gmtParams = cms.ESProducer('L1TMuonGlobalParamsESProducer',
    ...
    BEtaExtrapolationLUTPath     = cms.string(os.path.join(lut_dir, 'EtaExtrapolation.txt')),
    OEtaExtrapolationLUTPath     = cms.string(os.path.join(lut_dir, 'EtaExtrapolation.txt')),
    FEtaExtrapolationLUTPath     = cms.string(os.path.join(lut_dir, 'EtaExtrapolation.txt')),
