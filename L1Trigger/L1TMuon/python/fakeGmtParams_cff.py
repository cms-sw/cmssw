...
gmtParams = cms.ESProducer('L1TMuonGlobalParamsESProducer',
    ...
    BPhiExtrapolationLUTPath     = cms.string(os.path.join(lut_dir, 'PhiExtrapolation_6eta_6pt_3out_3outshift_20170217.txt')),
    OPhiExtrapolationLUTPath     = cms.string(os.path.join(lut_dir, 'PhiExtrapolation_6eta_6pt_3out_3outshift_20170217.txt')),
    FPhiExtrapolationLUTPath     = cms.string(os.path.join(lut_dir, 'PhiExtrapolation_6eta_6pt_3out_3outshift_20170217.txt')),
