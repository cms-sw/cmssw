//-------------------------------------------------
//
/**   \Class: DTSectCollSegm.h
 *
 *
 *    Muon Sector Collector Trigger Phi candidate 
 *
 *    $Date: 2004/03/18 09:43:34 $
 *    
 *
...
//
//--------------------------------------------------
#ifndef DT_SECT_COLL_SEGM_H
#define DT_SECT_COLL_SEGM_H
...
class DTSectCollSegm : public DTTrigData {

 public:

  //!  Constructor
  DTSectCollSegm(DTChamberId, int);
  //!  Constructor
/*   DTSectCollSegm(MuBarChamberId, int,  */
/* 		    const DTTracoTrigData* tracotrig, int); */
  DTSectCollSegm(DTChamberId, int, 
		    const DTTracoTrigData*, int);
  //!  Constructor
/*   DTSectCollSegm(const DTSectCollSegm& seg); */
  DTSectCollSegm(const DTSectCollSegm&);
  //!  Destructor 
  ~DTSectCollSegm();
  ...
  //! Assignment operator
  DTSectCollSegm& operator=(const DTSectCollSegm& seg);
