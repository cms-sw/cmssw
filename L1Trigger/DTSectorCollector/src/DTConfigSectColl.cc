...
// Constructors --
//----------------
DTConfigSectColl::DTConfigSectColl(edm::ParameterSet& ps) : m_ps(&ps) { 
...
DTConfigSectColl::setDefaults() {
  ...
  mycsp = m_ps->getParameter<int>("SCCSP2");
  if (mycsp<0 || mycsp>7){
  ...
  mycsp = m_ps->getParameter<int>("SCCSP3");
  if (mycsp<0 || mycsp>7){
  ...
  mycsp = m_ps->getParameter<int>("SCCSP4");
  if (mycsp<0 || mycsp>7){
  ...
  mycsp = m_ps->getParameter<int>("SCCSP5");
  if (mycsp<0 || mycsp>7){
