...
l1tVertexNTupler = cms.EDAnalyzer('VertexNTupler',
  ...
  l1TracksInputTags    = cms.VInputTag( l1tVertexProducer.l1TracksInputTag ),
  ...
  l1VertexInputTags   = cms.VInputTag( cms.InputTag("l1tVertexProducer", l1tVertexProducer.l1VertexCollectionName.value()) ),
