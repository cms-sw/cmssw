...
process.MessageLogger.categories = cms.untracked.vstring('L1CaloTkTauStudies', 'FwkReport')
...
# Runs the CaloTkTau algorithm that we are studying
...
# --------------------------------------------------------------------------------------------
#
# ----    Produce the L1CaloTkTaus using Emulator
