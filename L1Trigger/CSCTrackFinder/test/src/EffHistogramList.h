...
namespace csctf_analysis
{
  class  EffHistogramList
  {
	...
	EffHistogramList(const std::string dirname, const edm::ParameterSet* parameters);
  	...
  	TH1F* EffPtOverall, *EffPtCSCOnly, *EffPtOverlap, *EffPtDTOnly, *EffPtCSCRestricted;
  	...
  	TLegend* TrackerLeg1CSCOnly, *TrackerLeg1Overlap, *TrackerLeg1DTOnly, *TrackerLeg1CSCRestricted, *TrackerLeg1Overall;
  	TCanvas* PhiEff, *EtaEff, *SignedEtaEff, *PtEffAllOverall, *PtEffAllCSCOnly, *PtEffAllOverlap, *PtEffAllDTOnly, *PtEffAllCSCRestricted;
