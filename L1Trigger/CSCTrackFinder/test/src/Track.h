...
namespace csctf_analysis {
  ...
  public:
    ...
    virtual void setHistList(TrackHistogramList* histolist) { histlist = histolist; };
    ...
    virtual std::vector<unsigned int>* ghostMatchedIndecies() const { return ghostMatchedToIndex; };
    ...
    virtual int quality() const { return Quality; };
