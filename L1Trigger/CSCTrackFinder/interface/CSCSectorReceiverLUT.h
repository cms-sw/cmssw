...
class CSCSectorReceiverLUT
{
 public:
  ...
  lclphidat localPhi(int strip, int pattern, int quality, int lr, bool gangedME1a = false ) const;
  lclphidat localPhi(unsigned address, bool gangedME1a =  false ) const;
  lclphidat localPhi(lclphiadd address, bool gangedME1a = false ) const;

  gblphidat globalPhiME(int phi_local, int wire_group, int cscid, bool gangedME1a = false) const;
  gblphidat globalPhiME(unsigned address, bool gangedME1a = false) const;
  gblphidat globalPhiME(gblphiadd address, bool gangedME1a = false ) const;

  gblphidat globalPhiMB(int phi_local,int wire_group, int cscid, bool gangedME1a = false) const;
  gblphidat globalPhiMB(unsigned address, bool gangedME1a = false) const;
  gblphidat globalPhiMB(gblphiadd address, bool gangedME1a = false) const;

  gbletadat globalEtaME(int phi_bend, int phi_local, int wire_group, int cscid, bool gangedME1a = false) const;
  gbletadat globalEtaME(unsigned address, bool gangedME1a = false) const;
  gbletadat globalEtaME(gbletaadd address, bool gangedME1a = false) const;
