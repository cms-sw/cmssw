...
void vpp_generated_2014_05_15::wrap
(
...
)
{
	...
	// correct ME1/1a csc ids 
	// this correction is removed because we have ME1/1 unganged now
/*
	if (me1aCSCidp > 9) me1aCSCidp -= 9;
	if (me1bCSCidp > 9) me1bCSCidp -= 9;
	if (me1cCSCidp > 9) me1cCSCidp -= 9;
	if (me1dCSCidp > 9) me1aCSCidp -= 9;
	if (me1eCSCidp > 9) me1bCSCidp -= 9;
	if (me1fCSCidp > 9) me1cCSCidp -= 9;
*/
