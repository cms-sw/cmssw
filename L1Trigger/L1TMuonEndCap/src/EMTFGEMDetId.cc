...
EMTFGEMDetId::EMTFGEMDetId(const GEMDetId& id) : gemDetId_(id), me0DetId_(), isME0_(false) {}

EMTFGEMDetId::EMTFGEMDetId(const ME0DetId& id) : gemDetId_(), me0DetId_(id), isME0_(true) {}
