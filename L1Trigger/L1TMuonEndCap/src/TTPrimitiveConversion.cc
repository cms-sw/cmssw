...
void TTPrimitiveConversion::configure(
    const TTGeometryTranslator* tp_ttgeom, const SectorProcessorLUT* lut, int verbose, int endcap, int sector, int bx) {
...
// TT functions
void TTPrimitiveConversion::convert_tt(const TTTriggerPrimitive& ttmuon_primitive, EMTFHit& conv_hit) const {
