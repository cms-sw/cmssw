...
#ifndef CSCTriggerPrimitives_CSCTriggerPrimitivesDQM_h
#define CSCTriggerPrimitives_CSCTriggerPrimitivesDQM_h

/** \class CSCTriggerPrimitivesDQM
 *
...
class CSCTriggerPrimitivesDQM : public edm::EDAnalyzer
{
 public:
  /// Constructor
 ...
 private:
  ...
  MonitorElement *hAlctCompTotal2i;
  MonitorElement *hClctCompFound2i; 		   
  MonitorElement *hClctCompSameN2i;
  MonitorElement *hClctCompMatch2i;
  MonitorElement *hClctCompTotal2i;
  MonitorElement *hLCTCompFound2i;
