...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string("$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/L1Trigger/CSCTriggerPrimitives/test/EvtGen+DetSim+Digi+CscLCTs_cfg.py,v $"),
