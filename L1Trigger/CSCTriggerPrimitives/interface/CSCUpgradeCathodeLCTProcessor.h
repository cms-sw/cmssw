...
protected:
  ...
  bool busyMap[CSCConstants::MAX_NUM_HALF_STRIPS_7CFEBS][CSCConstants::MAX_CLCT_TBINS];
...
private:
  ...
  std::vector<CSCCLCTDigi> findLCTs(
      const std::vector<int> halfstrip[CSCConstants::NUM_LAYERS][CSCConstants::MAX_NUM_HALF_STRIPS_7CFEBS]) override;
