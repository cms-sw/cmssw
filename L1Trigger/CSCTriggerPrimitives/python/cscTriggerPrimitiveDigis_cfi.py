...
def _modifyCscTriggerPrimitiveDigisForRun2( object ) :
    ...
    object.alctParam07.alctGhostCancellationBxDepth = cms.tracked.int32(1)
    object.alctParam07.alctGhostCancellationSideQuality = cms.tracked.bool(True)
    object.alctParam07.alctPretrigDeadtime = cms.tracked.uint32(4)
...
cscTriggerPrimitiveDigis = cms.EDProducer("CSCTriggerPrimitivesProducer",
    ...
    debugParameters = cms.tracked.bool(False),
    ...
    checkBadChambers_ = cms.tracked.bool(True),
    ...
    commonParam = cms.PSet(
        ...
        smartME1aME1b = cms.tracked.bool(False),
        gangedME1a = cms.tracked.bool(True),
        
        # flagis to optionally disable finding stubs in ME42 or ME1a
        disableME1a = cms.tracked.bool(False),
        disableME42 = cms.tracked.bool(False)
    ),
    ...
    alctParam07 = cms.PSet(
        ...
        alctEarlyTbins = cms.tracked.int32(4),

        # Use narrow pattern mask for ring 1 chambers
        alctNarrowMaskForR1 = cms.tracked.bool(False),

        # configured, not hardcoded, hit persistency
        alctHitPersist  = cms.tracked.uint32(6)
    ),
    ...
    alctSLHC = cms.PSet(
        ...
        # Use narrow pattern mask for ring 1 chambers
        alctNarrowMaskForR1 = cms.tracked.bool(True),
        ...
        alctGhostCancellationBxDepth = cms.tracked.int32(1),
        ...
        alctGhostCancellationSideQuality = cms.tracked.bool(True),
        
        # how soon after pretrigger and alctDriftDelay can next pretrigger happen?
        alctPretrigDeadtime = cms.tracked.uint32(0),
        ...
        alctUseCorrectedBx = cms.tracked.bool(True)
    ),
    ...
    clctParam07 = cms.PSet(
        ...
        clctStartBxShift  = cms.tracked.int32(0)
    ),
    ...
    clctSLHC = cms.PSet(
        ...
        useDeadTimeZoning = cms.tracked.bool(True),
        
        # Width (in #HS) of a fixed dead zone around a key HS:
        clctStateMachineZone = cms.tracked.uint32(8),
        ...
        useDynamicStateMachineZone = cms.tracked.bool(True),
        ...
        clctPretriggerTriggerZone = cms.tracked.uint32(5),
        ...
        # and temporary store the regular "key layer hit" time into the CSCCLCTDigi fullBX:
        clctUseCorrectedBx = cms.tracked.bool(True)
    ),
    ...
    tmbParam = cms.PSet(
        ...
        # Configure early_tbins instead of hardcoding it
        tmbEarlyTbins = cms.tracked.int32(4),
        ...
        tmbReadoutEarliest2 = cms.tracked.bool(True),
        ...
        tmbDropUsedAlcts = cms.tracked.bool(True)
    ),
    ...
    tmbSLHC = cms.PSet(
        ...
        # L1A readout window, as there is only room just for two in the TMB header.
        # If false, all LCTs would be readout in L1A window.
        tmbReadoutEarliest2 = cms.tracked.bool(False),

        # For CLCT-centric matching, whether to drop ALCTs that were matched
        # to CLCTs in this BX, and not use them in the following BX 
        # (default non-upgrade TMB behavior).
        tmbDropUsedAlcts = cms.tracked.bool(False),
        ...
        clctToAlct = cms.tracked.bool(False),
