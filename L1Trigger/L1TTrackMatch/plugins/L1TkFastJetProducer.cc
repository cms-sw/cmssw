...
class L1TkFastJetProducer : public edm::EDProducer 
{
public:
  ...
  explicit L1TkFastJetProducer(const edm::ParameterSet&);
  ~L1TkFastJetProducer();
...
//////////////
// constructor
L1TkFastJetProducer::L1TkFastJetProducer(const edm::ParameterSet& iConfig) :
   ...
   PVertexToken(consumes<L1TkPrimaryVertexCollection>(iConfig.getParameter<edm::InputTag>("L1PrimaryVertexTag"))) 
{
  ...
  produces<L1TkJetParticleCollection>("L1FastTkJets");
...
/////////////
// destructor
L1TkFastJetProducer::~L1TkFastJetProducer() {
}

///////////
// producer
void L1TkFastJetProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  std::unique_ptr<L1TkJetParticleCollection> L1FastTkJets(new L1TkJetParticleCollection);
  ...
  iEvent.put( std::move(L1FastTkJets), "L1FastTkJets");
...
void
L1TkFastJetProducer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void
L1TkFastJetProducer::endJob() {
}

// ------------ method called when starting to processes a run  ------------
/*
void
L1TkFastJetProducer::beginRun(edm::Run& iRun, edm::EventSetup const& iSetup)
{
}
*/
...
/*
void
L1TkFastJetProducer::endRun(edm::Run&, edm::EventSetup const&)
{
}
*/
...
/*
void
L1TkFastJetProducer::beginLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
}
*/
...
/*
void
L1TkFastJetProducer::endLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
}
*/
...
void
L1TkFastJetProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(L1TkFastJetProducer);
