...
L1TkCaloHTMiss = cms.EDProducer("L1TkHTMissProducer",
     ...
     jet_minNtracksHighPt=cms.int(0),       #Add track jet quality criteria pT>100
     jet_minNtracksLowPt=cms.int(0),        #Add track jet quality criteria pT>50
...
L1TrackerHTMiss.jet_minPt = cms.double(5.0)
L1TrackerHTMiss.jet_minNtracksLowPt=cms.int(2)
L1TrackerHTMiss.jet_minNtracksHighPt=cms.int(3)
L1TrackerHTMiss.UseCaloJets = cms.bool(False)
L1TrackerHTMiss.DoVtxConstrain = cms.bool(False)      # turn on/off applying any vertex constraint
L1TrackerHTMiss.PrimaryVtxConstrain = cms.bool(False) # primary vertex already applied to track jet collections
