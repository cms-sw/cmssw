...
void DTTrigPhase2Prod::printmP(const metaPrimitive& mP) const {
  DTSuperLayerId slId(mP.rawId);
  LogInfo("DTTrigPhase2Prod") << (int)slId << "\t " << setw(2) << left << mP.wi1 << " " << setw(2) << left << mP.wi2
...
void DTTrigPhase2Prod::printmPC(const metaPrimitive& mP) const {
  DTChamberId ChId(mP.rawId);
  LogInfo("DTTrigPhase2Prod") << (int)ChId << "\t  " << setw(2) << left << mP.wi1 << " " << setw(2) << left << mP.wi2
                              ...
                              << " " << setw(5) << left << mP.tdc7 << " " << setw(5) << left << mP.tdc8 << " "
                              << setw(2) << left << mP.lat1 << " " << setw(2) << left << mP.lat2 << " " << setw(2)
                              << left << mP.lat3 << " " << setw(2) << left << mP.lat4 << " " << setw(2) << left
                              << mP.lat5 << " " << setw(2) << left << mP.lat6 << " " << setw(2) << left << mP.lat7
                              << " " << setw(2) << left << mP.lat8 << " " << setw(10) << right << mP.x << " " << setw(9)
                              << left << mP.tanPhi << " " << setw(5) << left << mP.t0 << " " << setw(13) << left
