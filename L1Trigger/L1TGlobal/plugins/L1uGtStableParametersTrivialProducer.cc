...
// constructor(s)
L1uGtStableParametersTrivialProducer::L1uGtStableParametersTrivialProducer(
    const edm::ParameterSet& parSet) {

    // tell the framework what data is being produced
    setWhatProduced(
        this, &L1uGtStableParametersTrivialProducer::produceGtStableParameters);
...
DEFINE_FWK_EVENTSETUP_MODULE(L1uGtStableParametersTrivialProducer);
