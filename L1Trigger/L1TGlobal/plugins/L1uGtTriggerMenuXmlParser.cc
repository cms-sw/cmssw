...
// constructor
l1t::L1uGtTriggerMenuXmlParser::L1uGtTriggerMenuXmlParser() :
...
void l1t::L1uGtTriggerMenuXmlParser::setGtNumberConditionChips(
...
void l1t::L1uGtTriggerMenuXmlParser::setGtPinsOnConditionChip(const unsigned int& pinsOnConditionChipValue) {
...
// in the hardware
void l1t::L1uGtTriggerMenuXmlParser::setGtOrderConditionChip(
...
void l1t::L1uGtTriggerMenuXmlParser::setGtNumberPhysTriggers(
...
void l1t::L1uGtTriggerMenuXmlParser::setGtNumberTechTriggers(
...
void l1t::L1uGtTriggerMenuXmlParser::setGtNumberL1JetCounts(const unsigned int& numberL1JetCountsValue) {
...
void l1t::L1uGtTriggerMenuXmlParser::setGtConditionMap(const std::vector<ConditionMap>& condMap) {
    m_conditionMap = condMap;
}

// set the trigger menu name
void l1t::L1uGtTriggerMenuXmlParser::setGtTriggerMenuInterface(const std::string& menuInterface) {
    m_triggerMenuInterface = menuInterface;
}

void l1t::L1uGtTriggerMenuXmlParser::setGtTriggerMenuName(const std::string& menuName) {
    m_triggerMenuName = menuName;
}

void l1t::L1uGtTriggerMenuXmlParser::setGtTriggerMenuImplementation(const std::string& menuImplementation) {
    m_triggerMenuImplementation = menuImplementation;
}

// set menu associated scale key
void l1t::L1uGtTriggerMenuXmlParser::setGtScaleDbKey(const std::string& scaleKey) {
...
void l1t::L1uGtTriggerMenuXmlParser::setCorEnergySumTemplate(
...
void l1t::L1uGtTriggerMenuXmlParser::setGtAlgorithmMap(const AlgorithmMap& algoMap) {
    m_algorithmMap = algoMap;
}

// set the algorithm map (by algorithm aliases)
void l1t::L1uGtTriggerMenuXmlParser::setGtAlgorithmAliasMap(const AlgorithmMap& algoMap) {
    m_algorithmAliasMap = algoMap;
}

// set the technical trigger map
void l1t::L1uGtTriggerMenuXmlParser::setGtTechnicalTriggerMap(const AlgorithmMap& ttMap) {
...
void l1t::L1uGtTriggerMenuXmlParser::parseXmlFile(const std::string& defXmlFile,
...
void l1t::L1uGtTriggerMenuXmlParser::setGtTriggerMenuInterfaceDate(const std::string& val) {

    m_triggerMenuInterfaceDate = val;

}

void l1t::L1uGtTriggerMenuXmlParser::setGtTriggerMenuInterfaceAuthor(const std::string& val) {

    m_triggerMenuInterfaceAuthor = val;

}

void l1t::L1uGtTriggerMenuXmlParser::setGtTriggerMenuInterfaceDescription(const std::string& val) {
...
void l1t::L1uGtTriggerMenuXmlParser::setGtTriggerMenuDate(const std::string& val) {

    m_triggerMenuDate = val;

}

void l1t::L1uGtTriggerMenuXmlParser::setGtTriggerMenuAuthor(const std::string& val) {

    m_triggerMenuAuthor = val;

}

void l1t::L1uGtTriggerMenuXmlParser::setGtTriggerMenuDescription(const std::string& val) {

    m_triggerMenuDescription = val;

}

void l1t::L1uGtTriggerMenuXmlParser::setGtAlgorithmImplementation(const std::string& val) {
...
XERCES_CPP_NAMESPACE::XercesDOMParser* l1t::L1uGtTriggerMenuXmlParser::initXML(const std::string &xmlFile) {
...
XERCES_CPP_NAMESPACE::DOMNode* l1t::L1uGtTriggerMenuXmlParser::findXMLChild(
...
std::string l1t::L1uGtTriggerMenuXmlParser::getXMLAttribute(const XERCES_CPP_NAMESPACE::DOMNode* node,
...
std::string l1t::L1uGtTriggerMenuXmlParser::getXMLTextValue(XERCES_CPP_NAMESPACE::DOMNode* node) {
...
bool l1t::L1uGtTriggerMenuXmlParser::hexString2UInt128(const std::string& hexString,
    ...
    if (hexStart == hexEnd) {
        ...
        LogDebug("L1uGtTriggerMenuXmlParser") << "No hex value found in: " << tempStr << std::endl;
    ...
    if (tempStr.empty() ) {
        ...
        LogDebug("L1uGtTriggerMenuXmlParser") << "Empty value in " << __PRETTY_FUNCTION__
            << std::endl;
    ...
    if (*endPtr != 0) {
        ...
        LogDebug("L1uGtTriggerMenuXmlParser") << "Unable to convert " << tempStr << " to hex."
            << std::endl;
...
bool l1t::L1uGtTriggerMenuXmlParser::getXMLHexTextValue128Old(XERCES_CPP_NAMESPACE::DOMNode* node,
    boost::uint64_t& dstL, boost::uint64_t& dstH) {

    if (node == 0) {

        LogDebug("L1uGtTriggerMenuXmlParser") << "node == 0 in " << __PRETTY_FUNCTION__ << std::endl;
...
bool l1t::L1uGtTriggerMenuXmlParser::getXMLHexTextValue128(const std::string& childName,
    boost::uint64_t& dstL, boost::uint64_t& dstH) {
...
bool l1t::L1uGtTriggerMenuXmlParser::getXMLHexTextValueOld(XERCES_CPP_NAMESPACE::DOMNode* node,
    boost::uint64_t& dst) {
...
bool l1t::L1uGtTriggerMenuXmlParser::getXMLHexTextValue(const std::string& childName,
    boost::uint64_t& dst) {
 ...
 */
bool l1t::L1uGtTriggerMenuXmlParser::countConditionChildMaxBits( const std::string& childName, 
    unsigned int& dst) {
...
bool l1t::L1uGtTriggerMenuXmlParser::getConditionChildValuesOld(XERCES_CPP_NAMESPACE::DOMNode* node,
    ...
    if (n1 == 0) {
        ...
        LogDebug("L1uGtTriggerMenuXmlParser") << "Child of condition not found ( " << childName
            << ")" << std::endl;
    ...
    for (unsigned int i = 0; i < num; i++) {
        if (n1 == 0) {
            ...
            LogDebug("L1uGtTriggerMenuXmlParser") << "Not enough values in condition child ( "
                << childName << ")" << std::endl;
        ...
        if ( !getXMLHexTextValueOld(n1, dst[i]) ) {
            ...
            edm::LogError("L1uGtTriggerMenuXmlParser") << "Error converting condition child ( "
...
void l1t::L1uGtTriggerMenuXmlParser::cleanupXML(XERCES_CPP_NAMESPACE::XercesDOMParser* parser) {
...
bool l1t::L1uGtTriggerMenuXmlParser::parseVmeXML(XERCES_CPP_NAMESPACE::XercesDOMParser* parser) {
    ...
    if (n1 == 0) {
        ...
        edm::LogError("L1uGtTriggerMenuXmlParser") << "Error: No vme tag found." << std::endl;
        return false;
    }
...
void l1t::L1uGtTriggerMenuXmlParser::clearMaps() {
...
bool l1t::L1uGtTriggerMenuXmlParser::insertConditionIntoMap(GlobalCondition& cond, const int chipNr) {
    ...
    if ((m_conditionMap[chipNr]).count(cName) != 0) {
        LogTrace("L1uGtTriggerMenuXmlParser") << "      Condition " << cName
...
bool l1t::L1uGtTriggerMenuXmlParser::insertAlgorithmIntoMap(const L1GtAlgorithm& alg) {
    ...
    if (m_algorithmMap.count(algName) != 0) {
        LogTrace("L1uGtTriggerMenuXmlParser") << "      Algorithm \"" << algName
            << "\"already exists in the algorithm map- not inserted!" << std::endl;
        return false;
    }

    if (m_algorithmAliasMap.count(algAlias) != 0) {
        LogTrace("L1uGtTriggerMenuXmlParser") << "      Algorithm alias \"" << algAlias
    ...
    if ((bitNumber < 0) || (bitNumber >= static_cast<int>(m_numberPhysTriggers))) {
        LogTrace("L1uGtTriggerMenuXmlParser") << "      Bit number " << bitNumber
    ...
    if (m_algorithmMap.size() >= m_numberPhysTriggers) {
        LogTrace("L1uGtTriggerMenuXmlParser") << "      More than maximum allowed "
    ...
    if ((chipNr < 0) || (chipNr > static_cast<int>(m_numberConditionChips))) {
        LogTrace("L1uGtTriggerMenuXmlParser") << "      Chip number " << chipNr
    ...
    if ((outputPin < 0) || (outputPin > static_cast<int>(m_pinsOnConditionChip))) {
        LogTrace("L1uGtTriggerMenuXmlParser") << "      Output pin " << outputPin
...
bool l1t::L1uGtTriggerMenuXmlParser::insertTechTriggerIntoMap(const L1GtAlgorithm& alg) {
    ...
    if (m_technicalTriggerMap.count(algName) != 0) {
        LogTrace("L1uGtTriggerMenuXmlParser") << "      Technical trigger \""
                << algName
    ...
    if ((bitNumber < 0)
        ...
        LogTrace("L1uGtTriggerMenuXmlParser") << "      Bit number "
...
l1t::GlobalConditionType l1t::L1uGtTriggerMenuXmlParser::getTypeFromType(const std::string& type) {
...
int l1t::L1uGtTriggerMenuXmlParser::getNumFromType(const std::string &type) {
...
int l1t::L1uGtTriggerMenuXmlParser::getBitFromNode(XERCES_CPP_NAMESPACE::DOMNode* node) {

    if (getXMLAttribute(node, m_xmlAttrMode) != m_xmlAttrModeBit) {

        edm::LogError("L1uGtTriggerMenuXmlParser") << "Invalid mode for single bit" << std::endl;
    ...
    if (tmpStr == "0") {
        ...
        edm::LogError("L1uGtTriggerMenuXmlParser") << "Bad bit value (" << tmpStr << ")"
            << std::endl;
        return -1;
    }
}
...
int l1t::L1uGtTriggerMenuXmlParser::getGEqFlag(XERCES_CPP_NAMESPACE::DOMNode* node,
    ...
    if (n1 != 0) {
        ...
        if (n1 == 0) {
            ...
            LogDebug("L1uGtTriggerMenuXmlParser") << "No \"greater or equal\" tag found"
                << std::endl;
...
bool l1t::L1uGtTriggerMenuXmlParser::getMuonMipIsoBits(XERCES_CPP_NAMESPACE::DOMNode* node,
...
std::string l1t::L1uGtTriggerMenuXmlParser::l1t2string( l1t::MenuName data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string l1t::L1uGtTriggerMenuXmlParser::l1t2string( l1t::ScalesKey data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string l1t::L1uGtTriggerMenuXmlParser::l1t2string( l1t::FirmwareVersion data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string l1t::L1uGtTriggerMenuXmlParser::l1t2string( l1t::DateTime date ){
  std::stringstream ss;
  ss << std::setfill('0');
...
std::string l1t::L1uGtTriggerMenuXmlParser::l1t2string( l1t::Label data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string l1t::L1uGtTriggerMenuXmlParser::l1t2string( l1t::Description data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string l1t::L1uGtTriggerMenuXmlParser::l1t2string( l1t::ConditionName data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
...
std::string l1t::L1uGtTriggerMenuXmlParser::l1t2string( l1t::CalorimeterObjectType data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string l1t::L1uGtTriggerMenuXmlParser::l1t2string( l1t::AlgorithmName data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string l1t::L1uGtTriggerMenuXmlParser::l1t2string( l1t::AlgorithmIndex data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string l1t::L1uGtTriggerMenuXmlParser::l1t2string( l1t::AlgorithmEquation data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
...
bool l1t::L1uGtTriggerMenuXmlParser::parseMuon(l1t::MuonCondition condMu,
...
//     // get values
    ...
    std::vector<GlobalMuonTemplate::ObjectParameter> objParameter(nrObj);
    GlobalMuonTemplate::CorrelationParameter corrParameter;
...
//         //<< std::endl;
    ...
    // get the type of the condition, as defined in enum, from the condition type
    // as defined in the XML file
    GlobalConditionType cType = getTypeFromType(type);
    //LogTrace("L1uGtTriggerMenuXmlParser")
    ...
    GlobalMuonTemplate muonCond(name);
...
bool l1t::L1uGtTriggerMenuXmlParser::parseCalo(l1t::CalorimeterCondition condCalo,
        unsigned int chipNr, const bool corrFlag) {
    ...
    if (particle == m_xmlConditionAttrObjectNoIsoEG) {
        ...
        edm::LogError("L1uGtTriggerMenuXmlParser") << "Wrong particle for calo-condition ("
            << particle << ")" << std::endl;
        return false;
    }
    ...
    // temporary storage of the parameters
    std::vector<GlobalCaloTemplate::ObjectParameter> objParameter(nrObj);
    GlobalCaloTemplate::CorrelationParameter corrParameter;
    ...
    GlobalCaloTemplate caloCond(name);
...
bool l1t::L1uGtTriggerMenuXmlParser::parseEnergySum(
...
bool l1t::L1uGtTriggerMenuXmlParser::parseJetCounts(XERCES_CPP_NAMESPACE::DOMNode* node,
    ...
    if (particle != m_xmlConditionAttrObjectJetCounts) {
        edm::LogError("L1uGtTriggerMenuXmlParser") << "Wrong particle for JetCounts condition ("
            << particle << ")" << std::endl;
        return false;
    }
    ...
    GlobalConditionType cType = TypeJetCounts;
    ...
    if (*endPtr != 0) {
        ...
        LogDebug("L1uGtTriggerMenuXmlParser") << "Unable to convert " << type << " to dec."
            << std::endl;
    ...
    if ((typeInt < 0) || (typeInt > static_cast<int>(m_numberL1JetCounts))) {
        LogDebug("L1uGtTriggerMenuXmlParser") << "Count index " << typeInt
    ...
    if ( !insertConditionIntoMap(jetCountsCond, chipNr)) {
        ...
        edm::LogError("L1uGtTriggerMenuXmlParser") << "    Error: duplicate condition (" << name
            << ")" << std::endl;
...
bool l1t::L1uGtTriggerMenuXmlParser::parseCastor(XERCES_CPP_NAMESPACE::DOMNode* node,
    const std::string& name, unsigned int chipNr) {
    ...
    GlobalConditionType cType = TypeCastor;
...
bool l1t::L1uGtTriggerMenuXmlParser::parseHfBitCounts(XERCES_CPP_NAMESPACE::DOMNode* node,
    const std::string& name, unsigned int chipNr) {
    ...
    if (particle != m_xmlConditionAttrObjectHfBitCounts) {
        edm::LogError("L1uGtTriggerMenuXmlParser") << "Wrong particle for HfBitCounts condition ("
            << particle << ")" << std::endl;
        return false;
    }
    ...
    GlobalConditionType cType = TypeHfBitCounts;
...
bool l1t::L1uGtTriggerMenuXmlParser::parseHfRingEtSums(XERCES_CPP_NAMESPACE::DOMNode* node,
    const std::string& name, unsigned int chipNr) {
    ...
    if (particle != m_xmlConditionAttrObjectHfRingEtSums) {
        edm::LogError("L1uGtTriggerMenuXmlParser") << "Wrong particle for HfRingEtSums condition ("
            << particle << ")" << std::endl;
        return false;
    }
    ...
    GlobalConditionType cType = TypeHfRingEtSums;
...
bool l1t::L1uGtTriggerMenuXmlParser::parseBptx(XERCES_CPP_NAMESPACE::DOMNode* node,
    const std::string& name, unsigned int chipNr) {
    ...
    GlobalConditionType cType = TypeBptx;
    ...
    LogTrace("L1uGtTriggerMenuXmlParser") << bptxCond << "\n" << std::endl;
...
bool l1t::L1uGtTriggerMenuXmlParser::parseExternal(XERCES_CPP_NAMESPACE::DOMNode* node,
    const std::string& name, unsigned int chipNr) {
    ...
    GlobalConditionType cType = TypeExternal;
    ...
    LogTrace("L1uGtTriggerMenuXmlParser") << externalCond << "\n" << std::endl;
...
bool l1t::L1uGtTriggerMenuXmlParser::parseCorrelation(
        XERCES_CPP_NAMESPACE::DOMNode* node, const std::string& name,
        unsigned int chipNr) {
    ...
    GlobalCorrelationTemplate correlationCond(name);
    ...
    LogTrace("L1uGtTriggerMenuXmlParser") << "    Condition category: "
            << condition << ", particle: " << particle << ", type: " << type
            << "\n" << std::endl;

    // condition type
    GlobalConditionType cType = l1t::Type2cor;
    ...
    std::vector<GlobalConditionCategory> condCateg(nrObj);
    ...
    for (int iSubCond = 0; iSubCond < nrObj; ++iSubCond) {
        ...
        LogTrace("L1uGtTriggerMenuXmlParser") << "    Sub-condition category: "
    ...
    // temporary storage of the parameters
    GlobalCorrelationTemplate::CorrelationParameter corrParameter;
    std::vector<boost::uint64_t> tmpValues(nrObj);
 ...
 *
 */
bool l1t::L1uGtTriggerMenuXmlParser::parseId( l1t::Meta meta ) {
...
//     if (headerNode == 0) {
//         edm::LogError("L1uGtTriggerMenuXmlParser") << "Error: No child of <" << m_xmlTagDef
//                 << "> tag found." << std::endl;
//         return false;
//     }
...
bool l1t::L1uGtTriggerMenuXmlParser::workCondition(XERCES_CPP_NAMESPACE::DOMNode* node,
    const std::string& name, unsigned int chipNr) {
    ...
    if (condition.empty() || particle.empty() || type.empty() ) {
        ...
        edm::LogError("L1uGtTriggerMenuXmlParser") << "Missing attributes for condition " << name
            << std::endl;
...
bool l1t::L1uGtTriggerMenuXmlParser::parseConditions( l1t::ConditionList conditions ){
...
bool l1t::L1uGtTriggerMenuXmlParser::workAlgorithm( l1t::Algorithm algorithm,
    unsigned int chipNr) {
...
bool l1t::L1uGtTriggerMenuXmlParser::parseAlgorithms( l1t::AlgorithmList algorithms ) {
...
bool l1t::L1uGtTriggerMenuXmlParser::workTechTrigger(XERCES_CPP_NAMESPACE::DOMNode* node,
...
bool l1t::L1uGtTriggerMenuXmlParser::parseTechTriggers(XERCES_CPP_NAMESPACE::XercesDOMParser* parser) {
    ...
    if (algNode == 0) {
        edm::LogError("L1uGtTriggerMenuXmlParser") << "    Error: No <"
...
//bool L1uGtTriggerMenuXmlParser::workXML(XERCES_CPP_NAMESPACE::XercesDOMParser* parser) {
bool l1t::L1uGtTriggerMenuXmlParser::workXML( std::auto_ptr<l1t::L1TriggerMenu> tm ) {
