...
void 
L1TUtmTriggerMenuDumper::analyze(Event const& iEvent, EventSetup const& iSetup){}
...
void
L1TUtmTriggerMenuDumper::beginRun(Run const& run, EventSetup const& iSetup)
{
...
void
L1TUtmTriggerMenuDumper::endRun(Run const&, EventSetup const&)
{
}

void
L1TUtmTriggerMenuDumper::beginLuminosityBlock(LuminosityBlock const&, EventSetup const&)
{
}

void
L1TUtmTriggerMenuDumper::endLuminosityBlock(LuminosityBlock const&, EventSetup const&)
{
}

void
L1TUtmTriggerMenuDumper::fillDescriptions(ConfigurationDescriptions& descriptions) {
