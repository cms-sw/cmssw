...
public:
    ...
    //
    inline const std::vector<std::vector<GlobalCorrelationTemplate> >& vecCorrelationTemplate() const {
...
private:
    ...
    l1t::GlobalConditionType getTypeFromType(const std::string& type);
