#ifndef L1uGtProducer_h
#define L1uGtProducer_h
...
class L1uGtProducer : public edm::EDProducer
{

public:

    explicit L1uGtProducer(const edm::ParameterSet&);
    ~L1uGtProducer();
