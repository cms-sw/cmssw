...
// constructor
L1GlobalTriggerMenuXmlParser::L1GlobalTriggerMenuXmlParser() :
...
void L1GlobalTriggerMenuXmlParser::setGtNumberConditionChips(
...
void L1GlobalTriggerMenuXmlParser::setGtPinsOnConditionChip(const unsigned int& pinsOnConditionChipValue) {
...
// in the hardware
void L1GlobalTriggerMenuXmlParser::setGtOrderConditionChip(
...
void L1GlobalTriggerMenuXmlParser::setGtNumberPhysTriggers(
...
void L1GlobalTriggerMenuXmlParser::setGtNumberTechTriggers(
...
void L1GlobalTriggerMenuXmlParser::setGtNumberL1JetCounts(const unsigned int& numberL1JetCountsValue) {
...
void L1GlobalTriggerMenuXmlParser::setGtAlgorithmMap(const AlgorithmMap& algoMap) {
    m_algorithmMap = algoMap;
}

// set the algorithm map (by algorithm aliases)
void L1GlobalTriggerMenuXmlParser::setGtAlgorithmAliasMap(const AlgorithmMap& algoMap) {
    m_algorithmAliasMap = algoMap;
}

// set the technical trigger map
void L1GlobalTriggerMenuXmlParser::setGtTechnicalTriggerMap(const AlgorithmMap& ttMap) {
...
void L1GlobalTriggerMenuXmlParser::parseXmlFile(const std::string& defXmlFile,
    ...
    LogTrace("L1GlobalTriggerMenuXmlParser") << "\nOpening XML-File: \n  " << defXmlFile << std::endl;
...
void L1GlobalTriggerMenuXmlParser::setGtTriggerMenuInterfaceDate(const std::string& val) {

    m_triggerMenuInterfaceDate = val;

}

void L1GlobalTriggerMenuXmlParser::setGtTriggerMenuInterfaceAuthor(const std::string& val) {

    m_triggerMenuInterfaceAuthor = val;

}

void L1GlobalTriggerMenuXmlParser::setGtTriggerMenuInterfaceDescription(const std::string& val) {
...
void L1GlobalTriggerMenuXmlParser::setGtTriggerMenuDate(const std::string& val) {

    m_triggerMenuDate = val;

}

void L1GlobalTriggerMenuXmlParser::setGtTriggerMenuAuthor(const std::string& val) {

    m_triggerMenuAuthor = val;

}

void L1GlobalTriggerMenuXmlParser::setGtTriggerMenuDescription(const std::string& val) {

    m_triggerMenuDescription = val;

}

void L1GlobalTriggerMenuXmlParser::setGtAlgorithmImplementation(const std::string& val) {
...
XERCES_CPP_NAMESPACE::XercesDOMParser* L1GlobalTriggerMenuXmlParser::initXML(const std::string &xmlFile) {
    ...
    try {
        ...
        edm::LogError("L1GlobalTriggerMenuXmlParser")
...
XERCES_CPP_NAMESPACE::DOMNode* L1GlobalTriggerMenuXmlParser::findXMLChild(
...
std::string L1GlobalTriggerMenuXmlParser::getXMLAttribute(const XERCES_CPP_NAMESPACE::DOMNode* node,
...
std::string L1GlobalTriggerMenuXmlParser::getXMLTextValue(XERCES_CPP_NAMESPACE::DOMNode* node) {
...
bool L1GlobalTriggerMenuXmlParser::hexString2UInt128(const std::string& hexString,
    ...
    if (hexStart == hexEnd) {
        ...
        LogDebug("L1GlobalTriggerMenuXmlParser") << "No hex value found in: " << tempStr << std::endl;
    ...
    if (tempStr.empty() ) {
        ...
        LogDebug("L1GlobalTriggerMenuXmlParser") << "Empty value in " << __PRETTY_FUNCTION__
            << std::endl;
    ...
    if (*endPtr != 0) {
        ...
        LogDebug("L1GlobalTriggerMenuXmlParser") << "Unable to convert " << tempStr << " to hex."
            << std::endl;
...
bool L1GlobalTriggerMenuXmlParser::getXMLHexTextValue128Old(XERCES_CPP_NAMESPACE::DOMNode* node,
    boost::uint64_t& dstL, boost::uint64_t& dstH) {

    if (node == 0) {

        LogDebug("L1GlobalTriggerMenuXmlParser") << "node == 0 in " << __PRETTY_FUNCTION__ << std::endl;
...
bool L1GlobalTriggerMenuXmlParser::getXMLHexTextValue128(const std::string& childName,
    boost::uint64_t& dstL, boost::uint64_t& dstH) {
...
bool L1GlobalTriggerMenuXmlParser::getXMLHexTextValueOld(XERCES_CPP_NAMESPACE::DOMNode* node,
    boost::uint64_t& dst) {
    ...
    if (dummyH != 0) {
        edm::LogError("L1GlobalTriggerMenuXmlParser") << "Too large hex-value!" << std::endl;
        return false;
    }
...
bool L1GlobalTriggerMenuXmlParser::getXMLHexTextValue(const std::string& childName,
    boost::uint64_t& dst) {
 ...
 */
bool L1GlobalTriggerMenuXmlParser::countConditionChildMaxBits( const std::string& childName, 
    unsigned int& dst) {
...
bool L1GlobalTriggerMenuXmlParser::getConditionChildValuesOld(XERCES_CPP_NAMESPACE::DOMNode* node,
    ...
    if (node == 0) {
        ...
        LogDebug("L1GlobalTriggerMenuXmlParser")
    ...
    if (n1 == 0) {
        ...
        LogDebug("L1GlobalTriggerMenuXmlParser") << "Child of condition not found ( " << childName
            << ")" << std::endl;
    ...
    for (unsigned int i = 0; i < num; i++) {
        if (n1 == 0) {
            ...
            LogDebug("L1GlobalTriggerMenuXmlParser") << "Not enough values in condition child ( "
                << childName << ")" << std::endl;
        ...
        if ( !getXMLHexTextValueOld(n1, dst[i]) ) {
            ...
            edm::LogError("L1GlobalTriggerMenuXmlParser") << "Error converting condition child ( "
...
void L1GlobalTriggerMenuXmlParser::cleanupXML(XERCES_CPP_NAMESPACE::XercesDOMParser* parser) {
...
bool L1GlobalTriggerMenuXmlParser::parseVmeXML(XERCES_CPP_NAMESPACE::XercesDOMParser* parser) {
    ...
    if (n1 == 0) {
        ...
        edm::LogError("L1GlobalTriggerMenuXmlParser") << "Error: Found no XML child" << std::endl;
    ...
    if (n1 == 0) {
        ...
        edm::LogError("L1GlobalTriggerMenuXmlParser") << "Error: No vme tag found." << std::endl;
        return false;
    }
...
void L1GlobalTriggerMenuXmlParser::clearMaps() {
...
bool L1GlobalTriggerMenuXmlParser::insertConditionIntoMap(L1GtCondition& cond, const int chipNr) {
    ...
    if ((m_conditionMap[chipNr]).count(cName) != 0) {
        LogTrace("L1GlobalTriggerMenuXmlParser") << "      Condition " << cName
...
bool L1GlobalTriggerMenuXmlParser::insertAlgorithmIntoMap(const L1GtAlgorithm& alg) {
    ...
    if (m_algorithmMap.count(algName) != 0) {
        LogTrace("L1GlobalTriggerMenuXmlParser") << "      Algorithm \"" << algName
            << "\"already exists in the algorithm map- not inserted!" << std::endl;
        return false;
    }

    if (m_algorithmAliasMap.count(algAlias) != 0) {
        LogTrace("L1GlobalTriggerMenuXmlParser") << "      Algorithm alias \"" << algAlias
    ...
    if ((bitNumber < 0) || (bitNumber >= static_cast<int>(m_numberPhysTriggers))) {
        LogTrace("L1GlobalTriggerMenuXmlParser") << "      Bit number " << bitNumber
    ...
    if (m_algorithmMap.size() >= m_numberPhysTriggers) {
        LogTrace("L1GlobalTriggerMenuXmlParser") << "      More than maximum allowed "
    ...
    if ((chipNr < 0) || (chipNr > static_cast<int>(m_numberConditionChips))) {
        LogTrace("L1GlobalTriggerMenuXmlParser") << "      Chip number " << chipNr
    ...
    if ((outputPin < 0) || (outputPin > static_cast<int>(m_pinsOnConditionChip))) {
        LogTrace("L1GlobalTriggerMenuXmlParser") << "      Output pin " << outputPin
...
bool L1GlobalTriggerMenuXmlParser::insertTechTriggerIntoMap(const L1GtAlgorithm& alg) {
    ...
    if (m_technicalTriggerMap.count(algName) != 0) {
        LogTrace("L1GlobalTriggerMenuXmlParser") << "      Technical trigger \""
                << algName
    ...
    if ((bitNumber < 0)
        ...
        LogTrace("L1GlobalTriggerMenuXmlParser") << "      Bit number "
...
L1GtConditionType L1GlobalTriggerMenuXmlParser::getTypeFromType(const std::string& type) {
...
int L1GlobalTriggerMenuXmlParser::getNumFromType(const std::string &type) {
...
int L1GlobalTriggerMenuXmlParser::getBitFromNode(XERCES_CPP_NAMESPACE::DOMNode* node) {

    if (getXMLAttribute(node, m_xmlAttrMode) != m_xmlAttrModeBit) {

        edm::LogError("L1GlobalTriggerMenuXmlParser") << "Invalid mode for single bit" << std::endl;
    ...
    if (tmpStr == "0") {
        ...
        edm::LogError("L1GlobalTriggerMenuXmlParser") << "Bad bit value (" << tmpStr << ")"
            << std::endl;
        return -1;
    }
}
...
int L1GlobalTriggerMenuXmlParser::getGEqFlag(XERCES_CPP_NAMESPACE::DOMNode* node,
    ...
    if (n1 != 0) {
        ...
        if (n1 == 0) {
            ...
            LogDebug("L1GlobalTriggerMenuXmlParser") << "No \"greater or equal\" tag found"
                << std::endl;
...
bool L1GlobalTriggerMenuXmlParser::getMuonMipIsoBits(XERCES_CPP_NAMESPACE::DOMNode* node,
...
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::MenuName data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::ScalesKey data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::FirmwareVersion data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::DateTime date ){
  std::stringstream ss;
  ss << std::setfill('0');
...
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::Label data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::Description data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::ConditionName data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::CalorimeterConditionType data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::ConditionEtComparison data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::CalorimeterObjectType data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::AlgorithmName data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::AlgorithmIndex data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::AlgorithmEquation data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
std::string L1GlobalTriggerMenuXmlParser::l1t2string( l1t::Threshold data ){
  std::stringstream ss;
  ss << data;
  return ss.str();
}
...
bool L1GlobalTriggerMenuXmlParser::parseMuon(l1t::MuonCondition condMu,
    ...
    std::string particle = "mu";//l1t2string( condMu.objectType() );
...
//         edm::LogError("L1GlobalTriggerMenuXmlParser") << "Wrong particle for muon-condition ("
//             << particle << ")" << std::endl;
//         return false;
//     }
...
//     if (nrObj < 0) {
//         edm::LogError("L1GlobalTriggerMenuXmlParser") << "Unknown type for muon-condition (" << type
...
//     if (intGEq < 0) {
//         edm::LogError("L1GlobalTriggerMenuXmlParser") << "Error getting \"greater or equal\" flag"
//             << std::endl;
//         return false;
//     }
...
//         if ( !countConditionChildMaxBits2(node, m_xmlTagDeltaPhi, maxbits) ) {
//             return false;
//         }
...
//         LogTrace("L1GlobalTriggerMenuXmlParser") << myCoutStream.str() << "\n" << std::endl;
//     }
...
bool L1GlobalTriggerMenuXmlParser::parseCalo(l1t::CalorimeterCondition condCalo,
        unsigned int chipNr, const bool corrFlag) {
    ...
    if (particle == m_xmlConditionAttrObjectNoIsoEG) {
        ...
        edm::LogError("L1GlobalTriggerMenuXmlParser") << "Wrong particle for calo-condition ("
            << particle << ")" << std::endl;
        return false;
    }
    ...
    int nrObj = getNumFromType(type);
    if (nrObj < 0) {
        edm::LogError("L1GlobalTriggerMenuXmlParser") << "Unknown type for calo-condition (" << type
            << ")" << "\nCan not determine number of trigger objects. " << std::endl;
        return false;
    }
    ...
    if( int(condCalo.objectParameters().objectParameter().size())!=nrObj ){
      edm::LogError("L1GlobalTriggerMenuXmlParser") << " condCalo objects: nrObj = " << nrObj
...
bool L1GlobalTriggerMenuXmlParser::parseEnergySum(
...
bool L1GlobalTriggerMenuXmlParser::parseJetCounts(XERCES_CPP_NAMESPACE::DOMNode* node,
    ...
    if (particle != m_xmlConditionAttrObjectJetCounts) {
        edm::LogError("L1GlobalTriggerMenuXmlParser") << "Wrong particle for JetCounts condition ("
            << particle << ")" << std::endl;
        return false;
    }
    ...
    if (*endPtr != 0) {
        ...
        LogDebug("L1GlobalTriggerMenuXmlParser") << "Unable to convert " << type << " to dec."
            << std::endl;
    ...
    if ((typeInt < 0) || (typeInt > static_cast<int>(m_numberL1JetCounts))) {
        LogDebug("L1GlobalTriggerMenuXmlParser") << "Count index " << typeInt
    ...
    if ( !insertConditionIntoMap(jetCountsCond, chipNr)) {
        ...
        edm::LogError("L1GlobalTriggerMenuXmlParser") << "    Error: duplicate condition (" << name
            << ")" << std::endl;
...
bool L1GlobalTriggerMenuXmlParser::parseCastor(XERCES_CPP_NAMESPACE::DOMNode* node,
    const std::string& name, unsigned int chipNr) {
...
bool L1GlobalTriggerMenuXmlParser::parseHfBitCounts(XERCES_CPP_NAMESPACE::DOMNode* node,
    const std::string& name, unsigned int chipNr) {
    ...
    if (particle != m_xmlConditionAttrObjectHfBitCounts) {
        edm::LogError("L1GlobalTriggerMenuXmlParser") << "Wrong particle for HfBitCounts condition ("
            << particle << ")" << std::endl;
        return false;
    }
...
bool L1GlobalTriggerMenuXmlParser::parseHfRingEtSums(XERCES_CPP_NAMESPACE::DOMNode* node,
    const std::string& name, unsigned int chipNr) {
    ...
    if (particle != m_xmlConditionAttrObjectHfRingEtSums) {
        edm::LogError("L1GlobalTriggerMenuXmlParser") << "Wrong particle for HfRingEtSums condition ("
            << particle << ")" << std::endl;
        return false;
    }
...
bool L1GlobalTriggerMenuXmlParser::parseBptx(XERCES_CPP_NAMESPACE::DOMNode* node,
    const std::string& name, unsigned int chipNr) {
    ...
    LogTrace("L1GlobalTriggerMenuXmlParser") << bptxCond << "\n" << std::endl;
...
bool L1GlobalTriggerMenuXmlParser::parseExternal(XERCES_CPP_NAMESPACE::DOMNode* node,
    const std::string& name, unsigned int chipNr) {
    ...
    LogTrace("L1GlobalTriggerMenuXmlParser") << externalCond << "\n" << std::endl;
...
bool L1GlobalTriggerMenuXmlParser::parseCorrelation(
        XERCES_CPP_NAMESPACE::DOMNode* node, const std::string& name,
        unsigned int chipNr) {
    ...
    LogTrace("L1GlobalTriggerMenuXmlParser") << "    Condition category: "
    ...
    for (int iSubCond = 0; iSubCond < nrObj; ++iSubCond) {
        ...
        LogTrace("L1GlobalTriggerMenuXmlParser") << "    Sub-condition category: "
 ...
 *
 */
bool L1GlobalTriggerMenuXmlParser::parseId( l1t::Meta meta ) {
...
//     if (headerNode == 0) {
//         edm::LogError("L1GlobalTriggerMenuXmlParser") << "Error: No child of <" << m_xmlTagDef
//                 << "> tag found." << std::endl;
//         return false;
//     }
...
//     m_triggerMenuAuthor = l1t2string( meta.changesAuthor() );
    ...
    m_scaleDbKey = l1t2string( meta.scalesKey() );
...
bool L1GlobalTriggerMenuXmlParser::workCondition(XERCES_CPP_NAMESPACE::DOMNode* node,
    const std::string& name, unsigned int chipNr) {
    ...
    LogDebug("L1GlobalTriggerMenuXmlParser") << " HELLO WORLD " << std::endl;

    if (condition.empty() || particle.empty() || type.empty() ) {

        edm::LogError("L1GlobalTriggerMenuXmlParser") << "Missing attributes for condition " << name
            << std::endl;
...
bool L1GlobalTriggerMenuXmlParser::parseConditions( l1t::ConditionList conditions ){
...
bool L1GlobalTriggerMenuXmlParser::workAlgorithm( l1t::Algorithm algorithm,
    unsigned int chipNr) {
...
bool L1GlobalTriggerMenuXmlParser::parseAlgorithms( l1t::AlgorithmList algorithms ) {
...
//     if (chipNode == 0) {
//         edm::LogError("L1GlobalTriggerMenuXmlParser") << "  Error: No child found for " << m_xmlTagDef
//             << std::endl;
//         return false;
//     }
...
//     if (chipNode == 0) {
//         edm::LogError("L1GlobalTriggerMenuXmlParser") << "  Error: Could not find <" << m_xmlTagChip
//             << std::endl;
//         return false;
//     }
...
//         //LogTrace("L1GlobalTriggerMenuXmlParser") << std::endl;
...
//         if (algNode == 0) {
//             edm::LogError("L1GlobalTriggerMenuXmlParser") << "    Error: No <" << m_xmlTagAlgorithms
...
bool L1GlobalTriggerMenuXmlParser::workTechTrigger(XERCES_CPP_NAMESPACE::DOMNode* node,
...
bool L1GlobalTriggerMenuXmlParser::parseTechTriggers(XERCES_CPP_NAMESPACE::XercesDOMParser* parser) {
    ...
    if (algNode == 0) {
        edm::LogError("L1GlobalTriggerMenuXmlParser") << "    Error: No <"
...
//bool L1GlobalTriggerMenuXmlParser::workXML(XERCES_CPP_NAMESPACE::XercesDOMParser* parser) {
bool L1GlobalTriggerMenuXmlParser::workXML( std::auto_ptr<l1t::L1TriggerMenu> tm ) {
...
//         edm::LogError("L1GlobalTriggerMenuXmlParser") << "Error: First XML child is not \" "
