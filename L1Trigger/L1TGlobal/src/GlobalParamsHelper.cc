...
void GlobalParamsHelper::setGtTotalBxInEvent(
...
void GlobalParamsHelper::setGtNumberPhysTriggers(
...
void GlobalParamsHelper::setGtNumberL1Mu(const unsigned int& numberL1MuValue) {
...
void GlobalParamsHelper::setGtNumberL1EG(
...
void GlobalParamsHelper::setGtNumberL1Jet(
...
void GlobalParamsHelper::setGtNumberL1Tau(
...
void GlobalParamsHelper::setGtNumberChips(
...
void GlobalParamsHelper::setGtPinsOnChip(
...
// in the hardware
void GlobalParamsHelper::setGtOrderOfChip(
