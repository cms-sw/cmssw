...
CorrelationWithOverlapRemovalTemplate::CorrelationWithOverlapRemovalTemplate() : GlobalCondition() {
...
CorrelationWithOverlapRemovalTemplate::CorrelationWithOverlapRemovalTemplate(
    const CorrelationWithOverlapRemovalTemplate& cp)
...
// assign operator
CorrelationWithOverlapRemovalTemplate& CorrelationWithOverlapRemovalTemplate::operator=(
    const CorrelationWithOverlapRemovalTemplate& cp) {
  copy(cp);
  return *this;
}
...
void CorrelationWithOverlapRemovalTemplate::setCond0Index(const int& condIndex) { m_cond0Index = condIndex; }

void CorrelationWithOverlapRemovalTemplate::setCond1Index(const int& condIndex) { m_cond1Index = condIndex; }

void CorrelationWithOverlapRemovalTemplate::setCond2Index(const int& condIndex) { m_cond2Index = condIndex; }
...
void CorrelationWithOverlapRemovalTemplate::print(std::ostream& myCout) const {
  ...
  myCout << "    minOverlapRemovalEtaCutValue        = " << std::dec
         << m_correlationParameter.minOverlapRemovalEtaCutValue << std::endl;
  myCout << "    maxOverlapRemovalEtaCutValue        = " << std::dec
         << m_correlationParameter.maxOverlapRemovalEtaCutValue << std::endl;
  myCout << "    precOverlapRemovalEtaCut            = " << std::dec << m_correlationParameter.precOverlapRemovalEtaCut
         << std::endl;
  myCout << "    minOverlapRemovalPhiCutValue        = " << std::dec
         << m_correlationParameter.minOverlapRemovalPhiCutValue << std::endl;
  myCout << "    maxOverlapRemovalPhiCutValue        = " << std::dec
         << m_correlationParameter.maxOverlapRemovalPhiCutValue << std::endl;
  myCout << "    precOverlapRemovalPhiCut            = " << std::dec << m_correlationParameter.precOverlapRemovalPhiCut
         << std::endl;
  myCout << "    minOverlapRemovalDRCutValue         = " << std::dec
         << m_correlationParameter.minOverlapRemovalDRCutValue << std::endl;
  myCout << "    maxOverlapRemovalDRCutValue         = " << std::dec
         << m_correlationParameter.maxOverlapRemovalDRCutValue << std::endl;
  myCout << "    precOverlapRemovalDRCut             = " << std::dec << m_correlationParameter.precOverlapRemovalDRCut
         << std::endl;
