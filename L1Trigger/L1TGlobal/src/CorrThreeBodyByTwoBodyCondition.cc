 ...
 *
 *  v1 Logic:
 *  - Define 3 GtConditionCategories: (1st & 2nd correlation legs, and 3rd correlation leg)
 *
 ...
 *
 *      - Loop over all objects of leg3 
 *        - Check for dEta, dPhi, dR, correlation condition of 3rd leg with 1st and 2nd leg objects,each.
 *        - If NOT passing correlation cuts, save objects leg1, leg2, leg3  object.
 *      - End loop leg3
 *
 *    - End loop leg2
 *
...
// constructors
//     default
l1t::CorrThreeBodyByTwoBodyCondition::CorrThreeBodyByTwoBodyCondition() : ConditionEvaluation() {}

//     from base template condition (from event setup usually)
l1t::CorrThreeBodyByTwoBodyCondition::CorrThreeBodyByTwoBodyCondition(const GlobalCondition* corrTemplate,
    ...
    : ConditionEvaluation(),
      m_gtCorrelationThreeBodyByTwoBodyTemplate(
          static_cast<const CorrelationThreeBodyByTwoBodyTemplate*>(corrTemplate)),
...
// copy constructor
void l1t::CorrThreeBodyByTwoBodyCondition::copy(const l1t::CorrThreeBodyByTwoBodyCondition& cp) {
  m_gtCorrelationThreeBodyByTwoBodyTemplate = cp.gtCorrelationThreeBodyByTwoBodyTemplate();
  m_uGtB = cp.getuGtB();
...
l1t::CorrThreeBodyByTwoBodyCondition::CorrThreeBodyByTwoBodyCondition(const l1t::CorrThreeBodyByTwoBodyCondition& cp)
    : ConditionEvaluation() {
  copy(cp);
}

// destructor
l1t::CorrThreeBodyByTwoBodyCondition::~CorrThreeBodyByTwoBodyCondition() {
  // empty
}

// equal operator
l1t::CorrThreeBodyByTwoBodyCondition& l1t::CorrThreeBodyByTwoBodyCondition::operator=(
    const l1t::CorrThreeBodyByTwoBodyCondition& cp) {
  copy(cp);
  return *this;
}

// methods
void l1t::CorrThreeBodyByTwoBodyCondition::setGtCorrelationThreeBodyByTwoBodyTemplate(
    const CorrelationThreeBodyByTwoBodyTemplate* caloTempl) {
  m_gtCorrelationThreeBodyByTwoBodyTemplate = caloTempl;
}

///   set the pointer to uGT GlobalBoard
void l1t::CorrThreeBodyByTwoBodyCondition::setuGtB(const GlobalBoard* ptrGTB) { m_uGtB = ptrGTB; }

void l1t::CorrThreeBodyByTwoBodyCondition::setScales(const GlobalScales* sc) { m_gtScales = sc; }

// try all object permutations and check spatial correlations, if required
const bool l1t::CorrThreeBodyByTwoBodyCondition::evaluateCondition(const int bxEval) const {
  // std::cout << "m_isDebugEnabled = " << m_isDebugEnabled << std::endl;
  // std::cout << "m_verbosity = " << m_verbosity << std::endl;

  //std::ostringstream myCout;
  //m_gtCorrelationThreeBodyByTwoBodyTemplate->print(myCout);
  //LogDebug("L1TGlobal")
  //   << "CorrelationThreeBodyByTwoBody Condition Evaluation \n" << myCout.str() << std::endl;
  ...
  const GtConditionCategory cond0Categ = m_gtCorrelationThreeBodyByTwoBodyTemplate->cond0Category();
  const GtConditionCategory cond1Categ = m_gtCorrelationThreeBodyByTwoBodyTemplate->cond1Category();
  const GtConditionCategory cond2Categ = m_gtCorrelationThreeBodyByTwoBodyTemplate->cond2Category();
  ...
  CorrelationThreeBodyByTwoBodyTemplate::CorrelationThreeBodyByTwoBodyParameter corrPar =
      *(m_gtCorrelationThreeBodyByTwoBodyTemplate->correlationParameter());
  ...
  for (std::vector<SingleCombInCond>::const_iterator it0Comb = cond0Comb.begin(); it0Comb != cond0Comb.end();
    ...
    for (std::vector<SingleCombInCond>::const_iterator it1Comb = cond1Comb.begin(); it1Comb != cond1Comb.end();
      ...
      for (std::vector<SingleCombInCond>::const_iterator it2Comb = cond2Comb.begin(); it2Comb != cond2Comb.end();
        ...
        // /////////////////////////////////////////////////////////////////////////////////////////
        //
        // here check if there is a correlation condition satisfied of 3rd-leg and 1st-leg object ...if yes, continue
        //
        // /////////////////////////////////////////////////////////////////////////////////////////
        // These all require some delta eta and phi calculations.  Do them first...for now real calculation but need to
        // revise this to line up with firmware calculations.
        ...
        // /////////////////////////////////////////////////////////////////////////////////////////
        //
        // here check if there is a correlation condition satisfied of 3rd-leg and 2nd-leg object ...if yes, continue
        //
        // /////////////////////////////////////////////////////////////////////////////////////////
        // These all require some delta eta and phi calculations.  Do them first...for now real calculation but need to
        // revise this to line up with firmware calculations.
...
const l1t::L1Candidate* l1t::CorrThreeBodyByTwoBodyCondition::getCandidate(const int bx, const int indexCand) const {
  ...
  switch ((m_gtCorrelationThreeBodyByTwoBodyTemplate->objectType())[0]) {
    case gtEG:
...
const bool l1t::CorrThreeBodyByTwoBodyCondition::checkObjectParameter(const int iCondition,
                                                                      const l1t::L1Candidate& cand) const {
  return true;
}

void l1t::CorrThreeBodyByTwoBodyCondition::print(std::ostream& myCout) const {
  myCout << "Dummy Print for CorrThreeBodyByTwoBodyCondition" << std::endl;
  m_gtCorrelationThreeBodyByTwoBodyTemplate->print(myCout);
