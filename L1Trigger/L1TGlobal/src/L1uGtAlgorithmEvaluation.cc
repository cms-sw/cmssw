...
l1t::L1uGtAlgorithmEvaluation::L1uGtAlgorithmEvaluation(const L1GtAlgorithm& alg) :
  m_algoResult(false),
...
void l1t::L1uGtAlgorithmEvaluation::evaluateAlgorithm(const int chipNumber,
...
void l1t::L1uGtAlgorithmEvaluation::print(std::ostream& myCout) const {
