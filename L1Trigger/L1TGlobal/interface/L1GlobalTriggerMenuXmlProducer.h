#ifndef L1TGlobal_L1GlobalTriggerMenuXmlProducer_h
#define L1TGlobal_L1GlobalTriggerMenuXmlProducer_h
...
// class declaration
class L1GlobalTriggerMenuXmlProducer : public edm::ESProducer
{

public:

    /// constructor
    L1GlobalTriggerMenuXmlProducer(const edm::ParameterSet&);

    /// destructor
    ~L1GlobalTriggerMenuXmlProducer();
