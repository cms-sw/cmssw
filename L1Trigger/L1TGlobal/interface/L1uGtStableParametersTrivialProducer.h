#ifndef L1GtConfigProducers_L1uGtStableParametersTrivialProducer_h
#define L1GtConfigProducers_L1uGtStableParametersTrivialProducer_h

/**
 * \class L1uGtStableParametersTrivialProducer
 * 
 * 
...
// class declaration
class L1uGtStableParametersTrivialProducer : public edm::ESProducer
{

public:

    /// constructor
    L1uGtStableParametersTrivialProducer(const edm::ParameterSet&);

    /// destructor
    ~L1uGtStableParametersTrivialProducer();

    /// public methods

    /// L1 GT parameters
    boost::shared_ptr<L1uGtStableParameters> produceGtStableParameters(
        const L1uGtStableParametersRcd&);
