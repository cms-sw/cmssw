...
process.hgcalTriggerPrimitiveDigiProducer.FECodec.NData = cms.uint32(12) # put number larger than max number of trigger cells in module
...
process.hgcaltriggerbestchoicetester = cms.EDAnalyzer(
    ...
    beTriggerCellsAll = cms.InputTag('hgcalTriggerPrimitiveDigiProducer:SingleCellClusterAlgo'),
    beTriggerCellsSelect = cms.InputTag('hgcalTriggerPrimitiveDigiFEReproducer:SingleCellClusterAlgo'),
