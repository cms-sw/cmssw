...
process.hgcalTriggerPrimitiveDigiProducer.FECodec.CodecIndex = cms.uint32(2) 
...
process.hgcalTriggerPrimitiveDigiFEReproducer.FECodec.CodecIndex = cms.uint32(2) 
