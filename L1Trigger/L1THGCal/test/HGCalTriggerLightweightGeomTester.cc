...
class HGCalTriggerLightweightGeomTester : public edm::EDAnalyzer 
{
    public:
        explicit HGCalTriggerLightweightGeomTester(const edm::ParameterSet& );
        ~HGCalTriggerLightweightGeomTester();
    ...
    private:
        void fillTriggerGeometry(const HGCalTriggerLightweightGeometryBase::es_info& );
        void checkConsistency(const HGCalTriggerLightweightGeometryBase::es_info& );
        void setTreeModuleSize(const size_t n);
        void setTreeTriggerCellSize(const size_t n);

        std::unique_ptr<HGCalTriggerLightweightGeometryBase> triggerGeometry_; 
...
/*****************************************************************/
HGCalTriggerLightweightGeomTester::HGCalTriggerLightweightGeomTester(const edm::ParameterSet& conf) 
/*****************************************************************/
{
    //setup geometry 
    ...
    HGCalTriggerLightweightGeometryBase* geometry = HGCalTriggerLightweightGeometryFactory::get()->create(trigGeomName,geometryConfig);
...
/*****************************************************************/
HGCalTriggerLightweightGeomTester::~HGCalTriggerLightweightGeomTester() 
/*****************************************************************/
{
}

/*****************************************************************/
void HGCalTriggerLightweightGeomTester::beginRun(const edm::Run& /*run*/, 
                                          const edm::EventSetup& es)
/*****************************************************************/
{
    triggerGeometry_->reset();
    HGCalTriggerLightweightGeometryBase::es_info info;
...
void HGCalTriggerLightweightGeomTester::checkConsistency(const HGCalTriggerLightweightGeometryBase::es_info& info)
{
    ...
    for( const auto& triggercell_cells : triggercells_to_cells )
    {
        ...
        HGCalTriggerLightweightGeometryBase::geom_set cells_geom = triggerGeometry_->getCellsFromTriggerCell(id);
    ...
    for( const auto& module_triggercells : modules_to_triggercells )
    {
        ...
        HGCalTriggerLightweightGeometryBase::geom_set triggercells_geom = triggerGeometry_->getTriggerCellsFromModule(id);
    ...
    for( const auto& module_cells : modules_to_cells )
    {
        ...
        HGCalTriggerLightweightGeometryBase::geom_set cells_geom = triggerGeometry_->getCellsFromModule(id);
...
/*****************************************************************/
void HGCalTriggerLightweightGeomTester::fillTriggerGeometry(const HGCalTriggerLightweightGeometryBase::es_info& info)
/*****************************************************************/
{
...
/*****************************************************************/
void HGCalTriggerLightweightGeomTester::analyze(const edm::Event& e, 
			      const edm::EventSetup& es) 
/*****************************************************************/
{
...
/*****************************************************************/
void HGCalTriggerLightweightGeomTester::setTreeModuleSize(const size_t n) 
/*****************************************************************/
{
...
/*****************************************************************/
void HGCalTriggerLightweightGeomTester::setTreeTriggerCellSize(const size_t n) 
/*****************************************************************/
{
...
DEFINE_FWK_MODULE(HGCalTriggerLightweightGeomTester);
