...
def custom_geometry_decentralized_V9(process, implementation=2):
    if implementation==1:
        ...
        process.hgcalTriggerGeometryESProducer.TriggerGeometry.L1TLinksMapping = cms.FileInPath("L1Trigger/L1THGCal/data/links_mapping_decentralized_jun19_0.txt")
