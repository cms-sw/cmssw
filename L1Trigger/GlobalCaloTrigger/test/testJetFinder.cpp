...
void putRegionsInVector(ifstream &fin, RegionsVector &regions, int numRegions);
...
void putJetsInVector(ifstream &fin, RawJetsVector &jets, int numJets);
...
bool compareRegionsVectors(RegionsVector &vector1, RegionsVector &vector2, string description);
/// Compares JetsVectors, prints a message about the comparison, returns true if identical, else false.
bool compareJetsVectors(RawJetsVector &vector1, RawJetsVector &vector2, string description);
