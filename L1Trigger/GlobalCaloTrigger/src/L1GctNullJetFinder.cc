...
//DEFINE STATICS
const unsigned int L1GctNullJetFinder::MAX_REGIONS_IN =
    (((L1CaloRegionDetId::N_ETA) / 2) + 1) * L1GctNullJetFinder::N_COLS;
const unsigned int L1GctNullJetFinder::N_COLS = 4;
const unsigned int L1GctNullJetFinder::CENTRAL_COL0 = 1;

L1GctNullJetFinder::L1GctNullJetFinder(int id) : L1GctJetFinderBase(id) { this->reset(); }
