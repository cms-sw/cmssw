#ifndef L1TriggerConfig_XmlConfigTools_l1t_TriggerSystem_h
#define L1TriggerConfig_XmlConfigTools_l1t_TriggerSystem_h
...
public:
    ...
    void addProcessor(const char *processor, const char *role, const char *crate, const char *slot); // must have all parameters
