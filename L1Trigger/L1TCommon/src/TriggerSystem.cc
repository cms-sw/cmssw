...
void TriggerSystem::addParameter(const char *id, const char *procOrRole, const char *type, const char *value, const char *delim) {
...
void TriggerSystem::addTable(const char *id, const char *procOrRole, const char *columns, const char *types,  const vector<string>& rows, const char *delim) {
    // some tables forget to specify delimeter and we get an empty string here
    //  force the "," default delimeter
    if( strlen(delim) == 0 ) delim = ",";
