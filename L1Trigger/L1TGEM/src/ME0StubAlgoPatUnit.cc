...
ME0StubPrimitive l1t::me0::pat_unit(const std::vector<uint64_t>& data,
    ...
    */
    ...
    int ly_tresh_final;
    if (ly_thresh_patid[best.PatternId()-1] > ly_thresh_eta[partition]) {ly_tresh_final = ly_thresh_patid[best.PatternId()-1];}
    else {ly_tresh_final = ly_thresh_eta[partition];}
