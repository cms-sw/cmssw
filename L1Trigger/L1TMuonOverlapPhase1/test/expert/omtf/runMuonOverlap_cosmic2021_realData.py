...
# process.simOmtfDigis.patternsXMLFile = cms.FileInPath("L1Trigger/L1TMuonOverlapPhase1/test/expert/omtf/Patterns_0x00012_oldSample_3_30Files_grouped1_classProb1_recalib_12pats.xml")
# process.simOmtfDigis.minDtPhiQuality = cms.int32(2)
# process.simOmtfDigis.minDtPhiBQuality = cms.int32(2)
#
# process.simOmtfDigis.rpcMaxClusterSize = cms.int32(3)
...
process.L1TMuonPath = cms.Path( process.omtfStage2Digis + process.L1MuonAnalyzerOmtfHW + process.simOmtfDigis) #process.omtfStage2Raw +  process.L1TMuonSeq + + process.L1MuonAnalyzerOmtfHW
