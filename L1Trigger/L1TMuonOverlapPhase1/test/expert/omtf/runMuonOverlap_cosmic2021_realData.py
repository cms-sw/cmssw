...
if verbose: 
    process.MessageLogger = cms.Service("MessageLogger",
       ...
       categories        = cms.untracked.vstring('l1tOmtfEventPrint', 'L1T', 'OmtfUnpacker::produce', 'OMTFReconstruction', 'l1MuonAnalyzerOmtf'), #'OMTFReconstruction',
       omtfEventPrint = cms.untracked.PSet(    
                         filename  = cms.untracked.string('log_MuonOverlap_cosmics'),
                         ...
                         l1MuonAnalyzerOmtf= cms.untracked.PSet( limit = cms.untracked.int32(10000000) ),
...
# process.simOmtfPhase1Digis.patternsXMLFile = cms.FileInPath("L1Trigger/L1TMuonOverlapPhase1/test/expert/omtf/Patterns_0x00012_oldSample_3_30Files_grouped1_classProb1_recalib_12pats.xml")
# process.simOmtfPhase1Digis.minDtPhiQuality = cms.int32(2)
# process.simOmtfPhase1Digis.minDtPhiBQuality = cms.int32(2)
#
# process.simOmtfPhase1Digis.rpcMaxClusterSize = cms.int32(3)
...
process.L1TMuonPath = cms.Path( process.omtfStage2Digis + process.L1MuonAnalyzerOmtfHW + process.simOmtfPhase1Digis) #process.omtfStage2Raw +  process.L1TMuonSeq + + process.L1MuonAnalyzerOmtfHW
