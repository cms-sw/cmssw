...
private:
  ...
  static bool sortJets (const jetData &jet1, const jetData &jet2); //define this as static as it doesn't need a GctErrorAnalyzer object
...
void
GctErrorAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
  using namespace std;
  ...
  if(doMissingEnergySums_) {
	...
	if(checkCollections(intHtMissD, GCT_INT_HTMISS_QUANTA, "Internal Missing Ht Data")) {
	  for(const auto & i : *intHtMissD) {
		...
		if(i.capBlock() == 0x301 && i.capIndex() == 0 && i.isThereHtx()) missingHtD_HtXPosLeaf1->Fill(i.htx());
		if(i.capBlock() == 0x301 && i.capIndex() == 1 && i.isThereHtx()) missingHtD_HtXPosLeaf2->Fill(i.htx());
		if(i.capBlock() == 0x301 && i.capIndex() == 2 && i.isThereHtx()) missingHtD_HtXPosLeaf3->Fill(i.htx());
		if(i.capBlock() == 0x701 && i.capIndex() == 0 && i.isThereHtx()) missingHtD_HtXNegLeaf1->Fill(i.htx());
		if(i.capBlock() == 0x701 && i.capIndex() == 1 && i.isThereHtx()) missingHtD_HtXNegLeaf2->Fill(i.htx());
		if(i.capBlock() == 0x701 && i.capIndex() == 2 && i.isThereHtx()) missingHtD_HtXNegLeaf3->Fill(i.htx());
		
		if(i.capBlock() == 0x301 && i.capIndex() == 0 && i.isThereHty()) missingHtD_HtYPosLeaf1->Fill(i.hty());
		if(i.capBlock() == 0x301 && i.capIndex() == 1 && i.isThereHty()) missingHtD_HtYPosLeaf2->Fill(i.hty());
		if(i.capBlock() == 0x301 && i.capIndex() == 2 && i.isThereHty()) missingHtD_HtYPosLeaf3->Fill(i.hty());
		if(i.capBlock() == 0x701 && i.capIndex() == 0 && i.isThereHty()) missingHtD_HtYNegLeaf1->Fill(i.hty());
		if(i.capBlock() == 0x701 && i.capIndex() == 1 && i.isThereHty()) missingHtD_HtYNegLeaf2->Fill(i.hty());
		if(i.capBlock() == 0x701 && i.capIndex() == 2 && i.isThereHty()) missingHtD_HtYNegLeaf3->Fill(i.hty());	      
	      }
	    }
	  }
	}
...
void 
GctErrorAnalyzer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
GctErrorAnalyzer::endJob() {
}

void
GctErrorAnalyzer::plotRCTRegions(const edm::Handle<L1CaloRegionCollection> &caloRegions) {
  ...
  for(const auto & i : *caloRegions) {
    ...
    if(doRCTMBx_ || i.bx() == RCTTrigBx_) {
      if(i.et()>0) RCT_EtEtaPhi_->Fill(i.gctEta(),i.gctPhi(),i.et());
      if(i.tauVeto()) RCT_TvEtaPhi_->Fill(i.gctEta(),i.gctPhi());
      if(i.fineGrain()) RCT_FgEtaPhi_->Fill(i.gctEta(),i.gctPhi());
      if(i.overFlow()) RCT_OfEtaPhi_->Fill(i.gctEta(),i.gctPhi());
    }
  }
}

void
GctErrorAnalyzer::plotIsoEm(const edm::Handle<L1GctEmCandCollection> &isoEgD, const edm::Handle<L1GctEmCandCollection> &isoEgE) {
...
void
GctErrorAnalyzer::plotNonIsoEm(const edm::Handle<L1GctEmCandCollection> &nonIsoEgD, const edm::Handle<L1GctEmCandCollection> &nonIsoEgE) {
  //loop over all the data candidates - if multiple bx, then this should be a multiple of GCT_OBJECT_QUANTA
...
void
GctErrorAnalyzer::plotEGErrors(const edm::Handle<L1GctEmCandCollection> &isoEgD, const edm::Handle<L1GctEmCandCollection> &isoEgE, const edm::Handle<L1GctEmCandCollection> &nonIsoEgD, const edm::Handle<L1GctEmCandCollection> &nonIsoEgE, const edm::Handle<L1CaloEmCollection> &emRegions) {
  ...
  for(const auto & i : *emRegions) {
    if(i.bx() == RCTTrigBx_) {
      if(i.isolated()) {
	if(i.rank()>0) errorEmRegionIsoEtEtaPhi_->Fill(i.regionId().ieta(),i.regionId().iphi(),i.rank());
      }
      else{
	if(i.rank()>0) errorEmRegionNonIsoEtEtaPhi_->Fill(i.regionId().ieta(),i.regionId().iphi(),i.rank());
      }
    }
  }
  ...
  for(const auto & i : *isoEgD) {
    if(i.bx() == GCTTrigBx_) {
      if(i.rank()>0) errorIsoEtEtaPhiD_->Fill(i.regionId().ieta(),i.regionId().iphi(),i.rank());
    }
  }
  for(const auto & i : *nonIsoEgD) {
    if(i.bx() == GCTTrigBx_) {
      if(i.rank()>0) errorNonIsoEtEtaPhiD_->Fill(i.regionId().ieta(),i.regionId().iphi(),i.rank());
    }
  }
  ...
  for(const auto & i : *isoEgE) {
    if(i.bx() == EmuTrigBx_) {
      if(i.rank()>0) errorIsoEtEtaPhiE_->Fill(i.regionId().ieta(),i.regionId().iphi(),i.rank());
    }
  }
  for(const auto & i : *nonIsoEgE) {
    if(i.bx() == EmuTrigBx_) {
      if(i.rank()>0) errorNonIsoEtEtaPhiE_->Fill(i.regionId().ieta(),i.regionId().iphi(),i.rank());
    }
  }
}

void
GctErrorAnalyzer::plotCenJets(const edm::Handle<L1GctJetCandCollection> &cenJetsD, const edm::Handle<L1GctJetCandCollection> &cenJetsE) {
...
void
GctErrorAnalyzer::plotTauJets(const edm::Handle<L1GctJetCandCollection> &tauJetsD, const edm::Handle<L1GctJetCandCollection> &tauJetsE) {
...
void
GctErrorAnalyzer::plotForJets(const edm::Handle<L1GctJetCandCollection> &forJetsD, const edm::Handle<L1GctJetCandCollection> &forJetsE) {
...
void
GctErrorAnalyzer::plotIntJets(const edm::Handle<L1GctInternJetDataCollection> &intJetsE) {
...
bool 
GctErrorAnalyzer::sortJets(const jetData &jet1, const jetData &jet2) {
  return jet1.et > jet2.et;
}

template<class T> 
bool 
GctErrorAnalyzer::checkCollections(const T &collection, const unsigned int &constraint, const std::string &label) {
...
void
GctErrorAnalyzer::plotJetErrors(const edm::Handle<L1GctJetCandCollection> &cenJetsD, const edm::Handle<L1GctJetCandCollection> &cenJetsE, const edm::Handle<L1GctJetCandCollection> &tauJetsD, const edm::Handle<L1GctJetCandCollection> &tauJetsE, const edm::Handle<L1GctJetCandCollection> &forJetsD, const edm::Handle<L1GctJetCandCollection> &forJetsE, const edm::Handle<L1CaloRegionCollection> &caloRegions) {
  ...
  for(const auto & i : *caloRegions) {
    if(i.bx() == RCTTrigBx_) {
      if(i.et()>0) errorRegionEtEtaPhi_->Fill(i.gctEta(),i.gctPhi(),i.et());
      if(i.tauVeto()) errorRegionTvEtaPhi_->Fill(i.gctEta(),i.gctPhi());
      if(i.overFlow()) errorRegionOfEtaPhi_->Fill(i.gctEta(),i.gctPhi());
    }
  }
  ...
  for(const auto & i : *cenJetsD) {
    if(i.bx() == GCTTrigBx_) {
      if(i.rank()>0) cenJet_errorEtEtaPhiData_->Fill(i.regionId().ieta(),i.regionId().iphi(),i.rank());
    }
  }
  for(const auto & i : *tauJetsD) {
    if(i.bx() == GCTTrigBx_) {
      if(i.rank()>0) tauJet_errorEtEtaPhiData_->Fill(i.regionId().ieta(),i.regionId().iphi(),i.rank());
    }
  }
  for(const auto & i : *forJetsD) {
    if(i.bx() == GCTTrigBx_) {
      if(i.rank()>0) forJet_errorEtEtaPhiData_->Fill(i.regionId().ieta(),i.regionId().iphi(),i.rank());
    }
  }
  ...
  for(const auto & i : *cenJetsE) {
    if(i.bx() == EmuTrigBx_) {
      if(i.rank()>0) cenJet_errorEtEtaPhiEmu_->Fill(i.regionId().ieta(),i.regionId().iphi(),i.rank());
    }
  }
  for(const auto & i : *tauJetsE) {
    if(i.bx() == EmuTrigBx_) {
      if(i.rank()>0) tauJet_errorEtEtaPhiEmu_->Fill(i.regionId().ieta(),i.regionId().iphi(),i.rank());
    }
  }
  for(const auto & i : *forJetsE) {
    if(i.bx() == EmuTrigBx_) {
      if(i.rank()>0) forJet_errorEtEtaPhiEmu_->Fill(i.regionId().ieta(),i.regionId().iphi(),i.rank());
    }
  }
...
void
GctErrorAnalyzer::plotHFRingSums(const edm::Handle<L1GctHFRingEtSumsCollection> &hfRingSumsD, const edm::Handle<L1GctHFRingEtSumsCollection> &hfRingSumsE) {
...
void
GctErrorAnalyzer::plotHFBitCounts(const edm::Handle<L1GctHFBitCountsCollection> &hfBitCountsD, const edm::Handle<L1GctHFBitCountsCollection> &hfBitCountsE) {
...
void
GctErrorAnalyzer::plotHFErrors(const edm::Handle<L1GctHFRingEtSumsCollection> &hfRingSumsD, const edm::Handle<L1GctHFRingEtSumsCollection> &hfRingSumsE, const edm::Handle<L1GctHFBitCountsCollection> &hfBitCountsD, const edm::Handle<L1GctHFBitCountsCollection> &hfBitCountsE, const edm::Handle<L1CaloRegionCollection> &caloRegions) {
  ...
  for(const auto & i : *caloRegions) {
    if(i.bx() == RCTTrigBx_) {
      if(i.et()>0) errorRegionEtEtaPhi_->Fill(i.gctEta(),i.gctPhi(),i.et());
      if(i.fineGrain()) errorRegionFgEtaPhi_->Fill(i.gctEta(),i.gctPhi());
      if(i.overFlow()) errorRegionOfEtaPhi_->Fill(i.gctEta(),i.gctPhi());
    }
  }
...
void
GctErrorAnalyzer::plotTotalE(const edm::Handle<L1GctEtTotalCollection> &totalEtD, const edm::Handle<L1GctEtTotalCollection> &totalEtE) {

  for(const auto & i : *totalEtD) {
    if(doGCTMBx_ || i.bx() == GCTTrigBx_) {
      totalEtD_Of_->Fill(i.overFlow());
      if(!i.overFlow()) totalEtD_->Fill(i.et());      
    }
  }
  for(const auto & i : *totalEtE) {
    if(doEmuMBx_ || i.bx() == EmuTrigBx_) {
      totalEtE_Of_->Fill(i.overFlow());
      if(!i.overFlow()) totalEtE_->Fill(i.et());
    } 
  }
}

void
GctErrorAnalyzer::plotTotalH(const edm::Handle<L1GctEtHadCollection> &totalHtD, const edm::Handle<L1GctEtHadCollection> &totalHtE) {

  for(const auto & i : *totalHtD) {
    if(doGCTMBx_ || i.bx() == GCTTrigBx_) {
      totalHtD_Of_->Fill(i.overFlow());
      if(!i.overFlow()) totalHtD_->Fill(i.et());
    }
  }
  for(const auto & i : *totalHtE) {
    if(doEmuMBx_ || i.bx() == EmuTrigBx_) {
      totalHtE_Of_->Fill(i.overFlow());
      if(!i.overFlow()) totalHtE_->Fill(i.et());
    }
  }
}

void
GctErrorAnalyzer::plotTotalEErrors(const edm::Handle<L1GctEtTotalCollection> &totalEtD, const edm::Handle<L1GctEtTotalCollection> &totalEtE, const edm::Handle<L1GctEtHadCollection> &totalHtD, const edm::Handle<L1GctEtHadCollection> &totalHtE, const edm::Handle<L1CaloRegionCollection> &caloRegions) {
  ...
  for(const auto & i : *totalEtD) {
    if(i.bx() == GCTTrigBx_) {
      ...
      if(!i.overFlow()) errorTotalEtD_->Fill(i.et());
    }
  }
  for(const auto & i : *totalEtE) {
    if(i.bx() == EmuTrigBx_) {
      errorTotalEtE_Of_->Fill(i.overFlow());      
      if(!i.overFlow()) errorTotalEtE_->Fill(i.et());
    } 
  }
  ...
  for(const auto & i : *totalHtD) {
    if(i.bx() == GCTTrigBx_) {
      ...
      if(!i.overFlow()) errorTotalHtD_->Fill(i.et());
    }
  }
  for(const auto & i : *totalHtE) {
    if(i.bx() == EmuTrigBx_) {
      errorTotalHtE_Of_->Fill(i.overFlow());
      if(!i.overFlow()) errorTotalHtE_->Fill(i.et());
    }
  }
}

void
GctErrorAnalyzer::plotMissingEt(const edm::Handle<L1GctEtMissCollection> &missingEtD, const edm::Handle<L1GctEtMissCollection> &missingEtE) {
...
void
GctErrorAnalyzer::plotMissingHt(const edm::Handle<L1GctHtMissCollection> &missingHtD, const edm::Handle<L1GctHtMissCollection> &missingHtE) {
...
GctErrorAnalyzer::plotMissingEErrors(const edm::Handle<L1GctEtMissCollection> &missingEtD, const edm::Handle<L1GctEtMissCollection> &missingEtE, const edm::Handle<L1GctHtMissCollection> &missingHtD, const edm::Handle<L1GctHtMissCollection> &missingHtE, edm::Handle<L1CaloRegionCollection> &caloRegions, const edm::Handle<L1GctInternJetDataCollection> &intJetsE, const edm::Handle<L1GctInternHtMissCollection> intMissingHtD) {
  ...
  if(doExtraMissingHTDebug_) {
	...
	if(i.bx() == GCTTrigBx_) {
	  if(!i.overflow()) {
	    ...
	    if(i.capBlock() == 0x301 && i.capIndex() == 0 && i.isThereHtx()) errorMissingHtD_HtXPosLeaf1->Fill(i.htx());
	    if(i.capBlock() == 0x301 && i.capIndex() == 1 && i.isThereHtx()) errorMissingHtD_HtXPosLeaf2->Fill(i.htx());
	    if(i.capBlock() == 0x301 && i.capIndex() == 2 && i.isThereHtx()) errorMissingHtD_HtXPosLeaf3->Fill(i.htx());
	    if(i.capBlock() == 0x701 && i.capIndex() == 0 && i.isThereHtx()) errorMissingHtD_HtXNegLeaf1->Fill(i.htx());
	    if(i.capBlock() == 0x701 && i.capIndex() == 1 && i.isThereHtx()) errorMissingHtD_HtXNegLeaf2->Fill(i.htx());
	    if(i.capBlock() == 0x701 && i.capIndex() == 2 && i.isThereHtx()) errorMissingHtD_HtXNegLeaf3->Fill(i.htx());
	  
	    if(i.capBlock() == 0x301 && i.capIndex() == 0 && i.isThereHty()) errorMissingHtD_HtYPosLeaf1->Fill(i.hty());
	    if(i.capBlock() == 0x301 && i.capIndex() == 1 && i.isThereHty()) errorMissingHtD_HtYPosLeaf2->Fill(i.hty());
	    if(i.capBlock() == 0x301 && i.capIndex() == 2 && i.isThereHty()) errorMissingHtD_HtYPosLeaf3->Fill(i.hty());
	    if(i.capBlock() == 0x701 && i.capIndex() == 0 && i.isThereHty()) errorMissingHtD_HtYNegLeaf1->Fill(i.hty());
	    if(i.capBlock() == 0x701 && i.capIndex() == 1 && i.isThereHty()) errorMissingHtD_HtYNegLeaf2->Fill(i.hty());
	    if(i.capBlock() == 0x701 && i.capIndex() == 2 && i.isThereHty()) errorMissingHtD_HtYNegLeaf3->Fill(i.hty());
	  }
	}
      }
    }
  ...
  if(checkCollections(intJetsE, NUM_INT_JETS, "Intermediate Jets Emulator")) {
    ...
    for(const auto & i : *intJetsE) {
      if(i.bx() == EmuTrigBx_) {
	if(!i.oflow() && i.et()) errorIntJetsE_EtEtaPhi->Fill(i.regionId().ieta(),i.regionId().iphi(),i.et());
      }
    }
  }
