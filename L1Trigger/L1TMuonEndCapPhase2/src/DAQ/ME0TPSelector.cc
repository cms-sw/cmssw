...
// Utils
// ===========================================================================
int ME0TPSelector::get_input_link(
        const TriggerPrimitive& tp, 
        TPInfo& tp_info
) const {
    int ilink = -1;
...
int ME0TPSelector::calculate_input_link(
        const int& tp_subsector, const int& tp_csc_id, 
