...
namespace emtf::phase2 {
  ...
  enum class feature_id_t { kPhi = 0, kTheta = 1, kBend = 2, kQuality = 3, kTime = 4, size, begin = 0, end = size };

  enum class theta_id_t { kTheta1 = 0, kTheta2 = 1, size, begin = 0, end = size };

  enum class reduced_site_id_t { kME1 = 0, kME2 = 1, kME3 = 2, kME4 = 3, kME0 = 4, size, begin = 0, end = size };
