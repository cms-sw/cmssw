...
process.generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack = cms.string('single muon+/- pt 2 to 120 flat in 1/pt positive endcap')
)
...
from L1Trigger.L1TMuonEndCapPhase2.config import customise_debug

#call to customisation function customise_mc imported from L1Trigger.L1TMuonEndCapPhase2.config
process = customise_debug(process)
