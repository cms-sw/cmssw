...
public:
  ...
  SeedForPhotonConversionFromQuadruplets(edm::ConsumesCollector& iC,
                                         const edm::ParameterSet& SeedComparitorPSet,
  ...
  double simpleGetSlope(const SeedingHitSet::ConstRecHitPointer& ohit,
...
protected:
  ...
  bool buildSeedBool(TrajectorySeedCollection& seedCollection,
                     const SeedingHitSet& hits,
                     const FreeTrajectoryState& fts,
                     const edm::EventSetup& es,
                     bool apply_dzCut,
