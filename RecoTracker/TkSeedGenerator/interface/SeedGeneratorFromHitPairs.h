...
public:
  ...
  /// from base class 
  virtual  void seeds(TrajectorySeedCollection &output,const edm::Event& ev, const edm::EventSetup& c, const TrackingRegion& region) {
    OrderedHitPairs pairs;
    pairGenerator()->hitPairs(region,pairs,ev,c); 
