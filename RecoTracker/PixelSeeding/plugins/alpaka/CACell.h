...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  public:
    ...
    ALPAKA_FN_ACC ALPAKA_FN_INLINE int addOuterNeighbor(Acc1D const& acc,
    ...
    ALPAKA_FN_ACC ALPAKA_FN_INLINE int addTrack(Acc1D const& acc, tindex_type t, CellTracksVector& cellTracks) {
      if (tracks().empty()) {
    ...
    ALPAKA_FN_ACC ALPAKA_FN_INLINE static bool dcaCutH(float x1,
                                                       float y1,
                                                       float x2,
                                                       float y2,
                                                       float x3,
