#ifndef TrajectoryStateOnDetInfosProducer_H
#define TrajectoryStateOnDetInfosProducer_H
// user include files
...
class TrajectoryStateOnDetInfosProducer : public edm::EDProducer {
   public:
      explicit TrajectoryStateOnDetInfosProducer(const edm::ParameterSet&);
      ~TrajectoryStateOnDetInfosProducer();
