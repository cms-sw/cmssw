...
process.dedxDiscrimMAP = cms.EDAnalyzer("DeDxDiscriminatorLearnerFromCalibTree",
    ...
    P_Min               = cms.double  (10.0 ),
    P_Max               = cms.double  (9999.0),
    P_NBins             = cms.int32   (1   ),
    ...
    calibrationPath    = cms.untracked.string("Gains.root"),
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    connect = cms.string('sqlite_file:Data7TeV_Deco_SiStripDeDxMip_3D_Rcd.db'),
