...
public:
  ...
  float sumX0D(int il, int ol, const PixelRecoPointRZ &pointI,
               const PixelRecoPointRZ &pointO) const;

  float sumX0D(const PixelRecoPointRZ &pointI, const PixelRecoPointRZ &pointM,
               const PixelRecoPointRZ &pointO) const;

  // as used in seeding
  // z at beamline, point on two layers
  float sumX0D(float zV, int il, int ol, const PixelRecoPointRZ &pointI,
               const PixelRecoPointRZ &pointO) const;
...
private:
  ...
  LayerItr findLayer(const PixelRecoPointRZ &point, LayerItr i1,
                     LayerItr i2) const;
  float sum2RmRn(LayerItr i1, LayerItr i2, float rTarget,
