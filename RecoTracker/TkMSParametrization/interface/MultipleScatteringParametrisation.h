...
public:
  ...
  float operator()(float pt, float cotTheta, const PixelRecoPointRZ &point,
  ...
  /// layer by layer contribution is calculated
  float operator()(float pt, const PixelRecoPointRZ &point1,
  ...
  float operator()(float pT, const PixelRecoPointRZ &pointV,
