...
public:
  ...
  std::pair<PixelRecoPointRZ, bool>
  crossing(const PixelRecoLineRZ &line) const dso_hidden;
  std::pair<PixelRecoPointRZ, bool>
  crossing(const SimpleLineRZ &line) const dso_hidden;
