...
private:
  ...
  double computeChi2Increment(MeasurementExtractor me, TransientTrackingRecHit::ConstRecHitPointer hit) {
    switch (hit->dimension()) {
      case 1:
        return computeChi2Increment<1>(me, hit);
      case 2:
        return computeChi2Increment<2>(me, hit);
      case 3:
        return computeChi2Increment<3>(me, hit);
      case 4:
        return computeChi2Increment<4>(me, hit);
      case 5:
        return computeChi2Increment<5>(me, hit);
    }
  ...
  TH1F *hTotChi2Increment, *hTotChi2GoodHit, *hTotChi2BadHit, *hTotChi2DeltaHit, *hTotChi2NSharedHit,
      *hTotChi2SharedHit;
