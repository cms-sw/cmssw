...
TrackerTrajectoryBuilder::~TrackerTrajectoryBuilder(){
...
void
TrackerTrajectoryBuilder::seedMeasurements(const TrajectorySeed& seed,  std::vector<TrajectoryMeasurement> & result) const
{
...
TempTrajectory TrackerTrajectoryBuilder::
...
bool TrackerTrajectoryBuilder::toBeContinued (const TempTrajectory& traj) const
{
 ...
 bool TrackerTrajectoryBuilder::qualityFilter( const TempTrajectory& traj) const
{
...
void 
TrackerTrajectoryBuilder::addToResult (TempTrajectory& tmptraj, 
