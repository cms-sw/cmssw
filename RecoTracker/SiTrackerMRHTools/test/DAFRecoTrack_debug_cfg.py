...
process.MessageLogger = cms.Service("MessageLogger",
                                    destinations = cms.untracked.vstring("debugTracking"),
                                    debugModules = cms.untracked.vstring("*"),
                                    categories = cms.untracked.vstring("DAFTrackProducerAlgorithm", "MultiRecHitCollector", "SiTrackerMultiRecHitUpdator"),
                                    debugTracking = cms.untracked.PSet(threshold = cms.untracked.string("DEBUG"),
                                                                       DEBUG = cms.untracked.PSet(limit = cms.untracked.int32(0)),
                                                                       default = cms.untracked.PSet(limit = cms.untracked.int32(0)),
                                                                       DAFTrackProducerAlgorithm = cms.untracked.PSet(limit = cms.untracked.int32(-1)),
                                                                       MultiRecHitCollector = cms.untracked.PSet(limit = cms.untracked.int32(-1)), 
                                                                       SiTrackerMultiRecHitUpdator = cms.untracked.PSet(limit = cms.untracked.int32(-1)) 
                                                                       )
                                    )
