...
SiTrackerMultiRecHitUpdatorMTFESProducer::~SiTrackerMultiRecHitUpdatorMTFESProducer() {}

boost::shared_ptr<SiTrackerMultiRecHitUpdatorMTF> 
SiTrackerMultiRecHitUpdatorMTFESProducer::produce(const MultiRecHitRecord & iRecord){ 
