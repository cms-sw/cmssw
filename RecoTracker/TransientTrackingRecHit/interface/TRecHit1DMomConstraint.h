...
class TRecHit1DMomConstraint final : public TransientTrackingRecHit {
 public:
  ...
  const TrackingRecHit * hit() const override {return 0;}//fixme return invalid
  TrackingRecHit * cloneHit() const override { return 0;}
  ...
  const GeomDetUnit* detUnit() const override {return 0;}
