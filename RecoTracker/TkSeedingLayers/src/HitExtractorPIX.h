...
public:
  HitExtractorPIX(TrackerDetSide side, int idLayer,
                  const std::string &hitProducer, edm::ConsumesCollector &iC);
...
private:
  typedef edm::ContainerMask<edmNew::DetSetVector<SiPixelCluster>>
      SkipClustersCollection;
  void useSkipClusters_(const edm::InputTag &m,
