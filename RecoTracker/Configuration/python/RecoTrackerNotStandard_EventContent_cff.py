...
RecoTrackerNotStandardFEVT = cms.PSet(
    outputCommands = cms.untracked.vstring('keep *_ctfNoOverlaps_*_*', 
        'keep *_ctfPixelLess_*_*', 
        'keep *_ctfCombinedSeeds_*_*')
)
#RECO content
...
RecoTrackerNotStandardAOD = cms.PSet(
    outputCommands = cms.untracked.vstring('keep recoTracks_ctfNoOverLaps_*_*', 
