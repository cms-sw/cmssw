#ifndef TkDetLayers_Phase2OTECLayer_h
#define TkDetLayers_Phase2OTECLayer_h
...
class Phase2OTECLayer GCC11_FINAL : public ForwardDetLayer, public GeometricSearchDetWithGroups {
 public:
  Phase2OTECLayer(std::vector<const PixelBlade*>& blades);
  ~Phase2OTECLayer();
