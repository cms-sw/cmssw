...
GeometricSearchTracker* GeometricSearchTrackerBuilder::build(const GeometricDet* theGeometricTracker,
  ...
  for (auto it = theGeometricDetLayers.begin(); it != theGeometricDetLayers.end(); it++) {
    if ((*it)->type() == GeometricDet::PixelBarrel) {
      vector<const GeometricDet*> thePxlBarGeometricDetLayers = (*it)->components();
      for (auto it2 = thePxlBarGeometricDetLayers.begin(); it2 != thePxlBarGeometricDetLayers.end(); it2++) {
    ...
    if ((*it)->type() == GeometricDet::TIB) {
      ...
      for (auto it2 = theTIBGeometricDetLayers.begin(); it2 != theTIBGeometricDetLayers.end(); it2++) {
    ...
    if ((*it)->type() == GeometricDet::TOB) {
      ...
      for (auto it2 = theTOBGeometricDetLayers.begin(); it2 != theTOBGeometricDetLayers.end(); it2++) {
    ...
    if ((*it)->type() == GeometricDet::PixelEndCap) {
      ...
      for (auto it2 = thePxlFwdGeometricDetLayers.begin(); it2 != thePxlFwdGeometricDetLayers.end(); it2++) {
    ...
    if ((*it)->type() == GeometricDet::TID) {
      ...
      for (auto it2 = theTIDGeometricDetLayers.begin(); it2 != theTIDGeometricDetLayers.end(); it2++) {
        if ((*it2)->positionBounds().z() < 0)
    ...
    if ((*it)->type() == GeometricDet::TEC) {
      ...
      for (auto it2 = theTECGeometricDetLayers.begin(); it2 != theTECGeometricDetLayers.end(); it2++) {
        if ((*it2)->positionBounds().z() < 0)
