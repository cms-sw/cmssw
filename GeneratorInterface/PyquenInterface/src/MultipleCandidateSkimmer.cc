...
MultipleCandidateSkimmer::MultipleCandidateSkimmer(const edm::ParameterSet& iConfig)
   : BaseHiGenSkimmer(iConfig)
{
...
bool MultipleCandidateSkimmer::filter(HepMC::GenEvent * evt){
