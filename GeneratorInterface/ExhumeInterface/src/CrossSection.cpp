...
extern "C" {
	void structm(double *,double *,double *,double *,double *,double *,
...
Exhume::CrossSection::CrossSection(const edm::ParameterSet& pset):
	...
	LambdaQCD(pset.getUntrackedParameter<double>("LambdaQCD",80)),
	...
	AlphaEw(pset.getUntrackedParameter<double>("AlphaEw",(1.0/137.0359895))),
	...
	root_s(pset.getUntrackedParameter<double>("comEnergy",14000.0)),
