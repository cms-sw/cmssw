...
////////////////////////////////////////////////////////////////////////////////
Exhume::QQ::QQ(const edm::ParameterSet& pset) : TwoSpace(pset) {
...
double Exhume::QQ::SubProcess() {
  ...
  double _Sigma = AlphaS(0.5 * SqrtsHat) * AlphaS(0.5 * SqrtsHat) * qMassSq * pow((1 - 4 * qMassSq * InvsHat), 1.5) /
                  (24.0 * etsq * etsq);
...
void Exhume::QQ::Amp2LIPS() { return; }
