...
inline double RandArrayFunction::StandardRand() const { return CLHEP::RandFlat::shoot(hjRandomEngine); }

inline double RandArrayFunction::Fire() const { return MapRandom(StandardRand()); }

inline double RandArrayFunction::Shoot() const { return Fire(); }

inline double RandArrayFunction::operator()() const { return Fire(); }

inline void RandArrayFunction::ShootArray(int size, double *array) const { FireArray(size, array); }
