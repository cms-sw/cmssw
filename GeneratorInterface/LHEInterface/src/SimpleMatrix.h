#ifndef GeneratorInterface_LHEInterface_SimpleMatrix_h
#define GeneratorInterface_LHEInterface_SimpleMatrix_h
...
#endif // GeneratorEvent_LHEInterface_SimpleMatrix_h
