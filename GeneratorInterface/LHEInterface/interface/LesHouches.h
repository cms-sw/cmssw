...
//
#ifndef GeneratorInterface_LHEInterface_LesHouches_h
#define GeneratorInterface_LHEInterface_LesHouches_h
...
#endif // GeneratorInterface_LHEInterface_LesHouches_h
