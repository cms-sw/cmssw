...
# this is a copy of run_generic_tarball_cvmfs.sh with additional pT smearing (for processes involving elastic photons)
# for questions contact Michael.Pitt@cern.ch
