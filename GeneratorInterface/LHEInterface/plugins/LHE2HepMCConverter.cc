...
// $Id: LHE2HepMCConverter.cc,v 1.2 2013/03/01 21:45:29 wdd Exp $
//
//
...
void
LHE2HepMCConverter::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void
LHE2HepMCConverter::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
