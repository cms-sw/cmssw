...
static bool hwgive(const std::string &paramString)
{
	...
	if (!std::strncmp(param, "IPROC", 5)) {
		...
		hwuwts.REPWT[4][0][0] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][1][0] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][2][0] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][3][0] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][4][0] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][0][1] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][1][1] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][2][1] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][3][1] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][4][1] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][0][2] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][1][2] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][2][2] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][3][2] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][4][2] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][0][3] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][1][3] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][2][3] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][3][3] = std::atof(&param[std::strcspn(param, "=") + 1]);
		...
		hwuwts.REPWT[4][4][3] = std::atof(&param[std::strcspn(param, "=") + 1]);
