...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('D*+ -> D0 pi+ -> (K-pi+) pi+ at 13TeV'),
    name = cms.untracked.string('$Source: test_d0k2pi_ptdstarcut_gen_13TeV.py,v $')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('2pi_ptdstarcut_gen.root'),
