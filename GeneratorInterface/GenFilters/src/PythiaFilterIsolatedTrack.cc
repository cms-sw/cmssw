...
PythiaFilterIsolatedTrack::PythiaFilterIsolatedTrack(const edm::ParameterSet& iConfig) :nAll_(0), nGood_(0), ecDist_(317.0), ecRad_(129.0) {
...
void PythiaFilterIsolatedTrack::endJob() {
  edm::LogInfo("PythiaFilter") << "PythiaFilterIsolatedTrack::Accepts "
                               << nGood_ <<" events out of " << nAll_
			       << std::endl;
}
