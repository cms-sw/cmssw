...
class PythiaFilterGammaJetWithBg : public edm::global::EDFilter<> {
public:
...
bool PythiaFilterGammaJetWithBg::filter(edm::StreamID, edm::Event& iEvent, const edm::EventSetup& iSetup) const {
  bool accepted = false;
