...
# with command line options: GeneratorInterface/ReggeGribovPartonMCInterface/ReggeGribovPartonMC_cfi.py -s GEN --conditions auto:mc --datatier GEN --eventcontent RAWSIM -n 1 --scenario HeavyIons --no_exec
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ReggeGribovPartonMC_cfi_py_GEN.root'),
