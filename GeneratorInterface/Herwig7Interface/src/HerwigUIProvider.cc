...
namespace Herwig {
  ...
  HerwigUIProvider::~HerwigUIProvider() { ThePEG::Repository::cleanup(); }
...
*/
    ...
    std::vector<std::string> aReadDirectories =
        pset.getUntrackedParameter<std::vector<std::string> >("appendReadDirectories", std::vector<std::string>());
    std::vector<std::string> pReadDirectories =
        pset.getUntrackedParameter<std::vector<std::string> >("prependReadDirectories", std::vector<std::string>());
