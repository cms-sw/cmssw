...
void
AlpgenExtractor::beginRun(const edm::Run& iRun, const edm::EventSetup& iSetup)
{
...
void
AlpgenExtractor::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
}
