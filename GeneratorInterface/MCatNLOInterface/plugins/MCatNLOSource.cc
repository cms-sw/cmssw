...
MCatNLOSource::MCatNLOSource(const edm::ParameterSet &params, const edm::InputSourceDescription &desc)
...
void MCatNLOSource::endJob() { reader.reset(); }

void MCatNLOSource::nextEvent() { return; }
