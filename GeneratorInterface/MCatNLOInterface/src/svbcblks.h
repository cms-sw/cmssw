...
c
c     xm2  = Vector boson mass (or photon virtuality) squared
c     xm02 = Nominal vector boson mass squared
c     gah  = width
...
c sh = (p_had1 + p_had2)^2
      ...
      real * 8 xm2,bwfmpl,bwfmmn,bwdelf,xmlow2,xmupp2
      common/bwcmm/xm2,bwfmpl,bwfmmn,bwdelf,xmlow2,xmupp2
      real * 8 cthw2,sthw2
      common/cweinang/cthw2,sthw2
