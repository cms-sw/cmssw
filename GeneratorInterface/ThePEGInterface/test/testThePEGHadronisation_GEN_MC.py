...
# with command line options: Configuration/GenProduction/testThePEGHadronisation -s GEN --datatier GEN -n 100 --eventcontent RAWSIM --conditions FrontierConditions_GlobalTag,MC_31X_V9::All --no_exec --mc --customise=Configuration/GenProduction/custom
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/GeneratorInterface/ThePEGInterface/test/testThePEGHadronisation_GEN_MC.py,v $')
)
