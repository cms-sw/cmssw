...
cmsDriver.py "$MYPATH/testThePEGGeneratorFilter" -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --datatier GEN $CMSOPTS
cmsDriver.py "$MYPATH/testThePEGHadronisation"   -s GEN --datatier GEN $CMSOPTS
cmsDriver.py "$MYPATH/testThePEGHadronisation"   -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --datatier GEN $CMSOPTS
