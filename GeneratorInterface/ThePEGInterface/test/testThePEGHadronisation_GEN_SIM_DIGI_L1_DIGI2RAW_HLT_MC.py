...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/GeneratorInterface/ThePEGInterface/test/testThePEGHadronisation_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_MC.py,v $')
)
