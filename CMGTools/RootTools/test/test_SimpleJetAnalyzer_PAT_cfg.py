...
DYJetsFall11_PAT = cfg.MCComponent(
    ...
    files = getFiles('/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola/Fall11-PU_S6_START42_V14B-v1/AODSIM/V2/PAT_CMG_V2_5_0', 'cmgtools', 'pat.*root')[:50],
    # files = getFiles('/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola/Fall11-PU_S6_START42_V14B-v1/AODSIM/V3', 'cmgtools_group', '.*root')[:10],
    # files = getFiles('/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola/Fall11-PU_S6_START42_V14B-v1/AODSIM/V2/PAT_CMG_V3_0_0', 'cmgtools', 'tree.*root')[:10],
    xSection = 3048.,
    nGenEvents = 34915945,
    triggers = [],
    effCorrFactor = 1 )
...
DYJetsChamonix_PAT = cfg.MCComponent(
    name = 'DYJetsChamonix',
    files = getFiles('/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola/Fall11-PU_Chamonix12_START44_V10-v2/AODSIM/PAT_CMG_V3_0_0', 'cmgtools', 'pat.*root')[:1],
...
selectedComponents  = [DYJetsChamonix_PAT] 
