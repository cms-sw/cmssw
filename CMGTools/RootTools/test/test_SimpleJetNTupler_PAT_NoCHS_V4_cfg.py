...
jetNtu = cfg.Analyzer(
    ...
    genJetsCollection = (('selectedPatJetsAK5NoPUSub','genJets'),'vector<reco::GenJet>'),
...
DYJetsFall11_PAT = cfg.MCComponent(
    ...
    files = getFiles('/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola/Fall11-PU_S6_START42_V14B-v1/AODSIM/V4/PAT_CMG_4_0_0', 'cmgtools', 'pat.*root')[:],
    xSection = 3048.,
    nGenEvents = 34915945,
    triggers = [],
    effCorrFactor = 1 )
...
DYJetsChamonix_PAT = cfg.MCComponent(
    name = 'DYJetsChamonix',
    files = getFiles('/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola/Fall11-PU_Chamonix12_START44_V10-v2/AODSIM/PAT_CMG_V3_0_0', 'cmgtools', 'pat.*root')[:],
...
DYJetsFall11_PAT.splitFactor = 100
