...
susyCore_globalVariables = [
            ...
            NTupleVariable("nJet20", lambda ev: len(ev.cleanJets), int, help="Number of jets with pt > 20"),
            NTupleVariable("nJet20a", lambda ev: len(ev.cleanJetsAll), int, help="Number of jets with pt > 20"),
            NTupleVariable("nBJetLoose20", lambda ev: len(ev.bjetsLoose), int, help="Number of jets with pt > 20 passing CSV loose"),
            NTupleVariable("nBJetMedium20", lambda ev: len(ev.bjetsMedium), int, help="Number of jets with pt > 20 passing CSV medium"),
            NTupleVariable("nBJetTight20", lambda ev: sum([j.btagWP("CSVv2IVFT") for j in ev.bjetsMedium]), int, help="Number of jets with pt > 20 passing CSV tight"),
...
#            NTupleVariable("nBJetTight25", lambda ev: sum([j.btagWP("CSVv2IVFT") for j in ev.bjetsMedium]), int, help="Number of jets with pt > 25 passing CSV tight"),
            ...
            NTupleVariable("nJet25", lambda ev: sum([j.pt() > 25 for j in ev.cleanJets]), int, help="Number of jets with pt > 30, |eta|<2.4"),
            NTupleVariable("nJet25a", lambda ev: sum([j.pt() > 25 for j in ev.cleanJetsAll]), int, help="Number of jets with pt > 30, |eta|<4.7"),
            NTupleVariable("nBJetLoose25", lambda ev: sum([j.btagWP("CSVv2IVFL") for j in ev.cleanJets if j.pt() > 25]), int, help="Number of jets with pt > 30 passing CSV loose"),
            NTupleVariable("nBJetMedium25", lambda ev: sum([j.btagWP("CSVv2IVFM") for j in ev.bjetsMedium if j.pt() > 25]), int, help="Number of jets with pt > 30 passing CSV medium"),
            NTupleVariable("nBJetTight25", lambda ev: sum([j.btagWP("CSVv2IVFT") for j in ev.bjetsMedium if j.pt() > 25]), int, help="Number of jets with pt > 30 passing CSV tight"),
