...
void mvaefficiencyele()
{

  //gROOT->SetStyle("Plain");
  
  TFile * mc = new TFile("DYJetsM50_tnp2.root");
  TTree * mc_tree = mc->Get("tpTreeEl/fitter_tree") ;
  TFile * data = new TFile("DoubleElectron_tnp2.root");
  TTree * data_tree = data->Get("tpTreeEl/fitter_tree") ;

  double pt_binsL[11] = {7,10,15,20,25,30,38,45,60,80,100}; 
  ...
  TH1F *hLMmceta = new TH1F("LepMVALooseEff_mceta","LepMVALooseEff_mceta",6,eta_bins);
  TH1F *hLMdataeta = new TH1F("LepMVALooseEff_dataeta","LepMVALooseEff_dataeta",6,eta_bins);
  TH2F *hLMmc2D = new TH2F("LepMVALooseEff_mc2D","LepMVALooseEff_mc2D",10,pt_binsL,6,eta_bins);
  TH2F *hLMdata2D = new TH2F("LepMVALooseEff_data2D","LepMVALooseEff_data2D",10,pt_binsL,6,eta_bins);
  ...
  TH1F *hLMmceta_den = new TH1F("LepMVALooseEff_mceta_den","LepMVALooseEff_mceta_den",6,eta_bins);
  TH1F *hLMdataeta_den = new TH1F("LepMVALooseEff_dataeta_den","LepMVALooseEff_dataeta_den",6,eta_bins);
  TH2F *hLMmc2D_den = new TH2F("LepMVALooseEff_mc2D_den","LepMVALooseEff_mc2D_den",10,pt_binsL,6,eta_bins);
  TH2F *hLMdata2D_den = new TH2F("LepMVALooseEff_data2D_den","LepMVALooseEff_data2D_den",10,pt_binsL,6,eta_bins);
  ...
  TH1F *hLMmceta_num = new TH1F("LepMVALooseEff_mceta_num","LepMVALooseEff_mceta_num",6,eta_bins);
  TH1F *hLMdataeta_num = new TH1F("LepMVALooseEff_dataeta_num","LepMVALooseEff_dataeta_num",6,eta_bins);
  TH2F *hLMmc2D_num = new TH2F("LepMVALooseEff_mc2D_num","LepMVALooseEff_mc2D_num",10,pt_binsL,6,eta_bins);
  ...
  TH1F *hTMmceta = new TH1F("LepMVATightEff_mceta","LepMVATightEff_mceta",6,eta_bins);
  TH1F *hTMdataeta = new TH1F("LepMVATightEff_dataeta","LepMVATightEff_dataeta",6,eta_bins);
  TH2F *hTMmc2D = new TH2F("LepMVATightEff_mc2D","LepMVATightEff_mc2D",9,pt_binsT,6,eta_bins);
  TH2F *hTMdata2D = new TH2F("LepMVATightEff_data2D","LepMVATightEff_data2D",9,pt_binsT,6,eta_bins);
  ...
  TH1F *hTMmceta_den = new TH1F("LepMVATightEff_mceta_den","LepMVATightEff_mceta_den",6,eta_bins);
  TH1F *hTMdataeta_den = new TH1F("LepMVATightEff_dataeta_den","LepMVATightEff_dataeta_den",6,eta_bins);
  TH2F *hTMmc2D_den = new TH2F("LepMVATightEff_mc2D_den","LepMVATightEff_mc2D_den",9,pt_binsT,6,eta_bins);
  TH2F *hTMdata2D_den = new TH2F("LepMVATightEff_data2D_den","LepMVATightEff_data2D_den",9,pt_binsT,6,eta_bins);
  ...
  TH1F *hTMmceta_num = new TH1F("LepMVATightEff_mceta_num","LepMVATightEff_mceta_num",6,eta_bins);
  TH1F *hTMdataeta_num = new TH1F("LepMVATightEff_dataeta_num","LepMVATightEff_dataeta_num",6,eta_bins);
  TH2F *hTMmc2D_num = new TH2F("LepMVATightEff_mc2D_num","LepMVATightEff_mc2D_num",9,pt_binsT,6,eta_bins);
  TH2F *hTMdata2D_num = new TH2F("LepMVATightEff_data2D_num","LepMVATightEff_data2D_num",9,pt_binsT,6,eta_bins);

  TH2F *hTMSF2D = new TH2F("LepMVATightSF2D","LepMVATightSF2D",9,pt_binsT,6,eta_bins);
  ...
  TH1F *hTCmceta = new TH1F("TightChargeEff_mceta","TightChargeEff_mceta",6,eta_bins);
  TH1F *hTCdataeta = new TH1F("TightChargeEff_dataeta","TightChargeEff_dataeta",6,eta_bins);
  TH2F *hTCmc2D = new TH2F("TightChargeEff_mc2D","TightChargeEff_mc2D",9,pt_binsT,6,eta_bins);
  TH2F *hTCdata2D = new TH2F("TightChargeEff_data2D","TightChargeEff_data2D",9,pt_binsT,6,eta_bins);
  ...
  TH1F *hTCmceta_den = new TH1F("TightChargeEff_mceta_den","TightChargeEff_mceta_den",6,eta_bins);
  TH1F *hTCdataeta_den = new TH1F("TightChargeEff_dataeta_den","TightChargeEff_dataeta_den",6,eta_bins);
  TH2F *hTCmc2D_den = new TH2F("TightChargeEff_mc2D_den","TightChargeEff_mc2D_den",9,pt_binsT,6,eta_bins);
  TH2F *hTCdata2D_den = new TH2F("TightChargeEff_data2D_den","TightChargeEff_data2D_den",9,pt_binsT,6,eta_bins);
  ...
  TH1F *hTCmceta_num = new TH1F("TightChargeEff_mceta_num","TightChargeEff_mceta_num",6,eta_bins);
  TH1F *hTCdataeta_num = new TH1F("TightChargeEff_dataeta_num","TightChargeEff_dataeta_num",6,eta_bins);
  TH2F *hTCmc2D_num = new TH2F("TightChargeEff_mc2D_num","TightChargeEff_mc2D_num",9,pt_binsT,6,eta_bins);
  TH2F *hTCdata2D_num = new TH2F("TightChargeEff_data2D_num","TightChargeEff_data2D_num",9,pt_binsT,6,eta_bins);

  TH2F *hTCSF2D = new TH2F("TightChargeSF2D","TightChargeSF2D",9,pt_binsT,6,eta_bins);
