void trainMVA_4l(TString name) {
    ...
    TCut all = "nLepGood >= 4  && abs(mZ1-91.2)>10 && (nBJetLoose25 >= 2 || nBJetMedium25 >= 1)";

    if (name.Contains("ttZ")) {
      TFile *fBkg = TFile::Open("/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/TTZJets/ttHLepTreeProducerBase/ttHLepTreeProducerBase_tree.root");
      TTree *tBkg = (TTree *) fBkg->Get("ttHLepTreeProducerBase");
      tBkg.AddFriend("newMVA/t", "/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/0_leptonMVA_v3/lepMVAFriend_TTZJets.root");
      factory->AddBackgroundTree(tBkg, 1.0);
    } else if (name.Contains("ZZ")) {
      TFile *fBkg1 = TFile::Open("/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/ZZTo4mu/ttHLepTreeProducerBase/ttHLepTreeProducerBase_tree.root");
      TTree *tBkg1 = (TTree *) fBkg1->Get("ttHLepTreeProducerBase");
      tBkg1.AddFriend("newMVA/t", "/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/0_leptonMVA_v3/lepMVAFriend_ZZTo4mu.root");
      factory->AddBackgroundTree(tBkg1, 1.0);
      TFile *fBkg2 = TFile::Open("/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/ZZTo4e/ttHLepTreeProducerBase/ttHLepTreeProducerBase_tree.root");
      TTree *tBkg2 = (TTree *) fBkg2->Get("ttHLepTreeProducerBase");
      tBkg2.AddFriend("newMVA/t", "/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/0_leptonMVA_v3/lepMVAFriend_ZZTo4e.root");
      factory->AddBackgroundTree(tBkg2, 1.0);
      TFile *fBkg3 = TFile::Open("/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/ZZTo4tau/ttHLepTreeProducerBase/ttHLepTreeProducerBase_tree.root");
      TTree *tBkg3 = (TTree *) fBkg3->Get("ttHLepTreeProducerBase");
      tBkg3.AddFriend("newMVA/t", "/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/0_leptonMVA_v3/lepMVAFriend_ZZTo4tau.root");
      factory->AddBackgroundTree(tBkg3, 1.0);
      TFile *fBkg4 = TFile::Open("/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/ZZ2e2mu/ttHLepTreeProducerBase/ttHLepTreeProducerBase_tree.root");
      TTree *tBkg4 = (TTree *) fBkg4->Get("ttHLepTreeProducerBase");
      tBkg4.AddFriend("newMVA/t", "/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/0_leptonMVA_v3/lepMVAFriend_ZZ2e2mu.root");
      factory->AddBackgroundTree(tBkg4, 1.0);
      TFile *fBkg5 = TFile::Open("/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/ZZ2e2tau/ttHLepTreeProducerBase/ttHLepTreeProducerBase_tree.root");
      TTree *tBkg5 = (TTree *) fBkg5->Get("ttHLepTreeProducerBase");
      tBkg5.AddFriend("newMVA/t", "/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/0_leptonMVA_v3/lepMVAFriend_ZZ2e2tau.root");
      factory->AddBackgroundTree(tBkg5, 1.0);
      TFile *fBkg6 = TFile::Open("/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/ZZ2mu2tau/ttHLepTreeProducerBase/ttHLepTreeProducerBase_tree.root");
      TTree *tBkg6 = (TTree *) fBkg6->Get("ttHLepTreeProducerBase");
      tBkg6.AddFriend("newMVA/t", "/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/0_leptonMVA_v3/lepMVAFriend_ZZ2mu2tau.root");
      factory->AddBackgroundTree(tBkg6, 1.0);
      ...
      tBkg6.AddFriend("newMVA/t", "/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/0_leptonMVA_v3/lepMVAFriend_ZZ2mu2tau.root");
      factory->AddBackgroundTree(tBkg6, 1.0);
      TFile *fBkg7 = TFile::Open("/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/TTZJets/ttHLepTreeProducerBase/ttHLepTreeProducerBase_tree.root");
      TTree *tBkg7 = (TTree *) fBkg7->Get("ttHLepTreeProducerBase");
      tBkg7.AddFriend("newMVA/t", "/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/0_leptonMVA_v3/lepMVAFriend_TTZJets.root");
      factory->AddBackgroundTree(tBkg7, 1.0);
    } else  {
...
//     }
    ...
    factory->AddVariable("nJet25", 'I');
    //factory->AddVariable("m4l",'F');
    factory->AddVariable("mZ2",'F');
    factory->AddVariable("ht4l",'F');
