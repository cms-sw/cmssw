...
if __name__ == '__main__':
    ...
    # QCD handling
    antiMuIsoForQCD = isOneJet or cutstring.find('Xcat_VBF_looseX')!=-1 or cutstring.find('Xcat_VBFX')!=-1  or cutstring.find('Xcat_J0_mediumX')!=-1 or cutstring.find('Xcat_J0_highX')!=-1 or cutstring.find('Xcat_VBF_tightX')!=-1 or isBtag
    antiMuRlxTauIsoForQCD = cutstring.find('Xcat_J1_high_mediumhiggsX')!=-1# or cutstring.find('Xcat_VBF_tightX')!=-1 

    antiMuRlxTauIsoForQCDYield = cutstring.find('Xcat_J1_high_mediumhiggsX')!=-1 or cutstring.find('Xcat_VBF_tightX')!=-1 
