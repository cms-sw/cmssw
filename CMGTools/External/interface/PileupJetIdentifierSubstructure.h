...
// $Id $
//
// PileupJetIdentifierSubstructure
//
...
#ifndef PileupJetIdentifierSubstructure_h
#define PileupJetIdentifierSubstructure_h
...
// ----------------------------------------------------------------------------------------------------
class StoredPileupJetIdentifierSubstructure {
 public:
	friend class PileupJetIdAlgoSubstructure;

	StoredPileupJetIdentifierSubstructure();
	~StoredPileupJetIdentifierSubstructure(); 
...
// ----------------------------------------------------------------------------------------------------
class PileupJetIdentifierSubstructure : public StoredPileupJetIdentifierSubstructure {
 public:
	friend class PileupJetIdAlgoSubstructure;
	...
	PileupJetIdentifierSubstructure & operator= (const StoredPileupJetIdentifierSubstructure & lhs) { ((StoredPileupJetIdentifierSubstructure &)(*this)) = lhs; return *this;}
	...
	//Jet Substructure
	DECLARE_VARIABLE(trimmass   ,float);
	DECLARE_VARIABLE(trimarea   ,float);
	DECLARE_VARIABLE(filtermass ,float);
	DECLARE_VARIABLE(filterarea ,float);
	DECLARE_VARIABLE(prunedmass ,float);
	DECLARE_VARIABLE(prunedarea ,float);
	DECLARE_VARIABLE(nsubjets   ,float);
	DECLARE_VARIABLE(massdrop   ,float);
	DECLARE_VARIABLE(massdropcorr,float);
	DECLARE_VARIABLE(tau1        ,float);
	DECLARE_VARIABLE(tau2        ,float);
	DECLARE_VARIABLE(tau3        ,float);
	DECLARE_VARIABLE(tau4        ,float);
	DECLARE_VARIABLE(tau2tau1    ,float);
};
