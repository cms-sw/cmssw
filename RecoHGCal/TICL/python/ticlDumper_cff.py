...
ticl_barrel.toModify(ticlDumper,
                     tracksterCollections = [
                        *[cms.PSet(treeName=cms.string(label), inputTag=cms.InputTag(label)) for label in ticlIterLabelsPSet.labels],
                        *[cms.PSet(treeName=cms.string(label), inputTag=cms.InputTag(label)) for label in ticlBarrelIterLabels],
                        cms.PSet(
                            treeName=cms.string("simtrackstersSC"),
                            inputTag=cms.InputTag("ticlSimTracksters", "fromBoundarySimCluster"),
                            tracksterType=cms.string("SimTracksterSC")
