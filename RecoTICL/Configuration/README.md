...
| `localreco.py` | orchestrate the existing HGCAL local-reco task upstream of TICL and type-check the local-reco -> TICL boundary (`hgcalMergeLayerClusters` feeds TICL's layer clusters) |
