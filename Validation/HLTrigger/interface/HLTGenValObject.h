...
public:
  ...
  HLTGenValObject(const reco::GenParticle &p) : p4Polar_(p.p4()), p4Cartesian_(p.p4()), trigObject_(0,0.,0.,0.,0.) {}
  ...
  HLTGenValObject(const reco::Candidate::PolarLorentzVector &p) : p4Polar_(p), p4Cartesian_(p), trigObject_(0,0.,0.,0.,0.) {}
