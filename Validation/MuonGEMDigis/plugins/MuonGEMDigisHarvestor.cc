...
void MuonGEMDigisHarvestor::ProcessBooking( DQMStore::IBooker& ibooker, DQMStore::IGetter& ig, const char* label, const TString& suffix, TH1F* track_hist, TH1F* sh_hist )
{
