...
void MaterialBudgetHGCalHistos::book() 
{
  ...
  // HGC_G10_FR4
  hmgr->addHistoProf1( new TProfile("410", "MB prof Eta [HGC_G10_FR4];#eta;x/X_{0}", 250, -5.0, 5.0 ) );
  hmgr->addHistoProf1( new TProfile("420", "MB prof Phi [HGC_G10_FR4];#varphi [rad];x/X_{0}", 180, -3.2, 3.2 ) );
  hmgr->addHistoProf2( new TProfile2D("430", "MB prof Eta  Phi [HGC_G10_FR4];#eta;#varphi;x/X_{0}", 250, -5., 5., 180, -3.2, 3.2 ) );
  hmgr->addHistoProf1( new TProfile("440", "MB prof R [HGC_G10_FR4];R [mm];x/X_{0}", 300, 0., 3000. ) );
  ...
  // Aluminium
  hmgr->addHistoProf1( new TProfile("1310", "MB prof Eta [Aluminium];#eta;x/X_{0}", 250, -5.0, 5.0 ) );
  hmgr->addHistoProf1( new TProfile("1320", "MB prof Phi [Aluminium];#varphi [rad];x/X_{0}", 180, -3.2, 3.2 ) );
  hmgr->addHistoProf2( new TProfile2D("1330", "MB prof Eta  Phi [Aluminium];#eta;#varphi;x/X_{0}", 250, -5., 5., 180, -3.2, 3.2 ) );
  hmgr->addHistoProf1( new TProfile("1340", "MB prof R [Aluminium];R [mm];x/X_{0}", 300, 0., 3000. ) );
  ...
  // HGC_G10_FR4
  hmgr->addHistoProf1( new TProfile("10410", "IL prof Eta [HGC_G10_FR4];#eta;#lambda/#lambda_{0}", 250, -5.0, 5.0 ) );
  hmgr->addHistoProf1( new TProfile("10420", "IL prof Phi [HGC_G10_FR4];#varphi [rad];#lambda/#lambda_{0}", 180, -3.2, 3.2 ) );
  hmgr->addHistoProf2( new TProfile2D("10430", "IL prof Eta  Phi [HGC_G10_FR4];#eta;#varphi;#lambda/#lambda_{0}", 250, -5., 5., 180, -3.2, 3.2 ) );
  hmgr->addHistoProf1( new TProfile("10440", "IL prof R [HGC_G10_FR4];R [mm];#lambda/#lambda_{0}", 300, 0., 3000. ) );
  ...
  // Aluminium
  hmgr->addHistoProf1( new TProfile("11310", "IL prof Eta [Aluminium];#eta;#lambda/#lambda_{0}", 250, -5.0, 5.0 ) );
  hmgr->addHistoProf1( new TProfile("11320", "IL prof Phi [Aluminium];#varphi [rad];#lambda/#lambda_{0}", 180, -3.2, 3.2 ) );
  hmgr->addHistoProf2( new TProfile2D("11330", "IL prof Eta  Phi [Aluminium];#eta;#varphi;#lambda/#lambda_{0}", 250, -5., 5., 180, -3.2, 3.2 ) );
  hmgr->addHistoProf1( new TProfile("11340", "IL prof R [Aluminium];R [mm];#lambda/#lambda_{0}", 300, 0., 3000. ) );
