...
process.g4SimHits.Watchers = cms.VPSet(cms.PSet(
    MaterialBudget = cms.PSet(
        DetectorTypes = cms.vstring('BeamPipe','Tracker','EM Calorimeter','HG Calorimeter', 'Hadron Calorimeter', 'Muon System','Forward Shield'),
        Constituents  = cms.vint32(4,2,1,1,2,1,1),
        StackOrder    = cms.vint32(1,2,3,4,5,6,7),
        DetectorNames = cms.vstring('BEAM','BEAM1','BEAM2','BEAM3','Tracker','PLT','ECAL','HGCal','CALO','VCAL','MUON','OQUA'),
        DetectorLevels= cms.vint32(3,3,3,3,3,3,4,4,3,3,3,3),
