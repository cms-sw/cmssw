...
for geom in {'Extended2015','Extended2017Plan1'}; do
  ${python_cmd} ${VGEO_DIR}/test/runP_Tracker.py geom=$geom label=Tracker >$TEST_DIR/runP_Tracker_cfg.log 2>&1
    
done

${python_cmd} ${VGEO_DIR}/test/MaterialBudget.py -s -d Tracker -g 'Extended2017Plan1'
${python_cmd} ${VGEO_DIR}/test/MaterialBudget.py -s -d Tracker -g 'Extended2015' -gc 'Extended2017Plan1'
