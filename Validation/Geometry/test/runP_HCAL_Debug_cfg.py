...
process.g4SimHits.Watchers = cms.VPSet(cms.PSet(
    MaterialBudgetHcal = cms.PSet(
        ...
        EtaMin0      = cms.untracked.double(2.650),
        EtaMax0      = cms.untracked.double(2.868),
        EtaMin1      = cms.untracked.double(2.868),
        EtaMax1      = cms.untracked.double(3.000),
        EtaMin2      = cms.untracked.double(0.783),
        EtaMax2      = cms.untracked.double(0.870),
