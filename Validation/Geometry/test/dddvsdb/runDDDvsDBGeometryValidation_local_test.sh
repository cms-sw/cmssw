...
# or change the above to cvs co -r yourtag to make sure new files get in :)
...
cp $CMSSW_BASE/src/GeometryReaders/XMLIdealGeometryESSource/test/readBigXMLAndDump.py .
