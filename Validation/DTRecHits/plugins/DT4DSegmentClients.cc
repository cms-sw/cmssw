...
void DT4DSegmentClients::analyze(const Event& e, const EventSetup& context){
  ...
  MonitorElement * hResAlpha = dbe->get("4D_All_hResAlpha");
  MonitorElement * hResBeta = dbe->get("4D_All_hResBeta");
  MonitorElement * hResX = dbe->get("4D_All_hResX");
  MonitorElement * hResY = dbe->get("4D_All_hResY");
  MonitorElement * hResBetaRZ = dbe->get("4D_All_hResBetaRZ");
  MonitorElement * hResYRZ = dbe->get("4D_All_hResYRZ");

  MonitorElement * hResAlpha_W0 = dbe->get("4D_W0_hResAlpha");
  MonitorElement * hResBeta_W0 = dbe->get("4D_W0_hResBeta");
  MonitorElement * hResX_W0 = dbe->get("4D_W0_hResX");
  MonitorElement * hResY_W0 = dbe->get("4D_W0_hResY");
  MonitorElement * hResBetaRZ_W0 = dbe->get("4D_W0_hResBetaRZ");
  MonitorElement * hResYRZ_W0 = dbe->get("4D_W0_hResYRZ");

  MonitorElement * hResAlpha_W1 = dbe->get("4D_W1_hResAlpha");
  MonitorElement * hResBeta_W1 = dbe->get("4D_W1_hResBeta");
  MonitorElement * hResX_W1 = dbe->get("4D_W1_hResX");
  MonitorElement * hResY_W1 = dbe->get("4D_W1_hResY");
  MonitorElement * hResBetaRZ_W1 = dbe->get("4D_W1_hResBetaRZ");
  MonitorElement * hResYRZ_W1 = dbe->get("4D_W1_hResYRZ");

  MonitorElement * hResAlpha_W2 = dbe->get("4D_W2_hResAlpha");
  MonitorElement * hResBeta_W2 = dbe->get("4D_W2_hResBeta");
  MonitorElement * hResX_W2 = dbe->get("4D_W2_hResX");
  MonitorElement * hResY_W2 = dbe->get("4D_W2_hResY");
  MonitorElement * hResBetaRZ_W2 = dbe->get("4D_W2_hResBetaRZ");
  MonitorElement * hResYRZ_W2 = dbe->get("4D_W2_hResYRZ");

  MonitorElement * hPullAlpha = dbe->get("4D_All_hPullAlpha");
  MonitorElement * hPullBeta = dbe->get("4D_All_hPullBeta");
  MonitorElement * hPullX = dbe->get("4D_All_hPullX");
  MonitorElement * hPullY = dbe->get("4D_All_hPullY");
  MonitorElement * hPullBetaRZ = dbe->get("4D_All_hPullBetaRZ");
  MonitorElement * hPullYRZ = dbe->get("4D_All_hPullYRZ");

  MonitorElement * hPullAlpha_W0 = dbe->get("4D_W0_hPullAlpha");
  MonitorElement * hPullBeta_W0 = dbe->get("4D_W0_hPullBeta");
  MonitorElement * hPullX_W0 = dbe->get("4D_W0_hPullX");
  MonitorElement * hPullY_W0 = dbe->get("4D_W0_hPullY");
  MonitorElement * hPullBetaRZ_W0 = dbe->get("4D_W0_hPullBetaRZ");
  MonitorElement * hPullYRZ_W0 = dbe->get("4D_W0_hPullYRZ");

  MonitorElement * hPullAlpha_W1 = dbe->get("4D_W1_hPullAlpha");
  MonitorElement * hPullBeta_W1 = dbe->get("4D_W1_hPullBeta");
  MonitorElement * hPullX_W1 = dbe->get("4D_W1_hPullX");
  MonitorElement * hPullY_W1 = dbe->get("4D_W1_hPullY");
  MonitorElement * hPullBetaRZ_W1 = dbe->get("4D_W1_hPullBetaRZ");
  MonitorElement * hPullYRZ_W1 = dbe->get("4D_W1_hPullYRZ");

  MonitorElement * hPullAlpha_W2 = dbe->get("4D_W2_hPullAlpha");
  MonitorElement * hPullBeta_W2 = dbe->get("4D_W2_hPullBeta");
  MonitorElement * hPullX_W2 = dbe->get("4D_W2_hPullX");
  MonitorElement * hPullY_W2 = dbe->get("4D_W2_hPullY");
  MonitorElement * hPullBetaRZ_W2 = dbe->get("4D_W2_hPullBetaRZ");
  MonitorElement * hPullYRZ_W2 = dbe->get("4D_W2_hPullYRZ");
