...
void endJob(void);
 ...
 void     findEndcapMatrix(int nCellInX, int nCellInY,
                           ...
                           MapType&  themap);
 void     findShashlikMatrix(int nCellInX, int nCellInY,
                           int CentralX, int CentralY,int CentralZ,
                           MapType&  themap);
...
private:
 ...
 edm::InputTag EKuncalibrechitCollection_;
 ...
 MonitorElement* meEKe5x5_;
 MonitorElement* meEKe5x5OverSimHits_;
 MonitorElement* meEKe5x5OverGun_;

 MonitorElement* meEBRecHitLog10Energy_;
 MonitorElement* meEERecHitLog10Energy_;
 MonitorElement* meEKRecHitLog10Energy_;
 ...
 MonitorElement* meEKRecHitLog10EnergyContr_;
 ...
 MonitorElement* meEKRecHitLog10Energy5x5Contr_;
 ...
 MonitorElement* meEKRecHitsOccupancyPlusFlag5_6_;     
 MonitorElement* meEKRecHitsOccupancyMinusFlag5_6_;     
 MonitorElement* meEKRecHitsOccupancyPlusFlag8_9_;     
 MonitorElement* meEKRecHitsOccupancyMinusFlag8_9_;     
 ...
 MonitorElement* meEKRecHitFlags_;
 MonitorElement* meEKRecHitSimHitvsSimHitFlag5_6_;
 MonitorElement* meEKRecHitSimHitFlag6_;
 MonitorElement* meEKRecHitSimHitFlag7_;
