...
process.ctppsFastProtonSimulation.stripsRecHitsParams.roundToPitch = False
...
process.TFileService = cms.Service('TFileService',
    fileName = cms.string("output_reco_simu_diff_without_det_sm.root"),
...
process.validation_step = cms.Path(process.scoringPlaneValidation)
