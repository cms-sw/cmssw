...
# --- Configuration ---
# Root file
root_file_path = "/afs/cern.ch/user/g/gjedrzej/private/mainTask/CMSSW_15_0_11/src/Validation/CTPPS/test/simu/simu_2018_protons.root"  
# Set the output directory for plots
output_directory = "plotsProtons/"
...
def plot_histograms_from_folders(file_path, base_dir, sub_dirs, hist_names, output_dir):
    ...
    for sub_dir_name in sub_dirs:
        ...
        for hist_name in hist_names:
            ...
            c = ROOT.TCanvas(f"c_{sub_dir_name}_{hist_name}", f"{sub_dir_name} - {hist_name}", 800, 600)
            ...
            # Save the plot
            safe_file_name = f"{sub_dir_name}_{hist_name}".replace(" ", "_").replace(";", "")
