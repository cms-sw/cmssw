...
{
  auto cc = setWhatProduced(this, iConfig.getParameter<std::string>("outputOpticsLabel"));

  inputOpticsToken_ = cc.consumesFrom<LHCInterpolatedOpticalFunctionsSetCollection, CTPPSInterpolatedOpticsRcd>
    (edm::ESInputTag("", iConfig.getParameter<std::string>("inputOpticsLabel")));
}
