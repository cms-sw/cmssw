...
setenv MYWORKDIR /afs/cern.ch/user/n/nancy/scratch0/CMSSW/test/CMSSW_3_8_1/src/Validation/RecoEgamma/test
...
#---------------------------------------------------------------
 ...
 rfcp   PhotonValidationRelVal381_${outFileName}.root            ${MYOUT}/.
