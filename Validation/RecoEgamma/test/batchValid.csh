...
setenv MYWORKDIR /afs/cern.ch/user/n/nancy/scratch0/CMSSW/test/CMSSW_3_6_0_pre5/src/Validation/RecoEgamma/test
...
#---------------------------------------------------------------
 ...
 rfcp   PhotonValidationRelVal360pre5_${outFileName}.root            ${MYOUT}/.
