...
setenv MYWORKDIR /afs/cern.ch/user/n/nancy/scratch0/CMSSW/test/CMSSW_3_8_0_pre1/src/Validation/RecoEgamma/test
...
#---------------------------------------------------------------
 ...
 rfcp   PhotonValidationRelVal380pre1_${outFileName}.root            ${MYOUT}/.
