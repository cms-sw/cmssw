...
process.electronMcMiniAODSignalPostValidator.InputFolderName = cms.string("EgammaV/ElectronMcMiniAODSignalValidator")
process.electronMcMiniAODSignalPostValidator.OutputFolderName = cms.string("EgammaV/ElectronMcMiniAODSignalValidator")
