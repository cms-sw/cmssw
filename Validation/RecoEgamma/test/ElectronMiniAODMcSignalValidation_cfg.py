...
process.load("Validation.RecoEgamma.ElectronMcMiniAODSignalValidator_cfi")
...
process.electronMcMiniAODSignalValidator.InputFolderName = cms.string("EgammaV/ElectronMcMiniAODSignalValidator")
process.electronMcMiniAODSignalValidator.OutputFolderName = cms.string("EgammaV/ElectronMcMiniAODSignalValidator")
