...
if ( $VAL_ANALYZER == ElectronMcValidator ) then
...
else if ($VAL_ANALYZER == ElectronDataCertifier ) then
...
else if ($VAL_ANALYZER == ElectronFakeValidator ) then
...
h_ele_phiEff 0 0 1 1 h_ele_matchingObjectPhi_matched h_CaloJet_phi 1 0
...
h_ele_ptEff_all 0 0 1 1 h_ele_vertexPt_all h_CaloJet_Pt 1 0
