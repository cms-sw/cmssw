...
//  setStoreFolder("EgammaV/ElectronMcSignalValidator") ;
  ...
  h1_recEleNum = ElectronDqmAnalyzerBase::bookH1(iBooker, "recEleNum","# rec electrons",11, -0.5,10.5,"N_{ele}");
  h1_recCoreNum = ElectronDqmAnalyzerBase::bookH1(iBooker, "recCoreNum","# rec electron cores",21, -0.5,20.5,"N_{core}");
  h1_recTrackNum = ElectronDqmAnalyzerBase::bookH1(iBooker, "recTrackNum","# rec gsf tracks",41, -0.5,40.5,"N_{track}");
  h1_recSeedNum = ElectronDqmAnalyzerBase::bookH1(iBooker, "recSeedNum","# rec electron seeds",101, -0.5,100.5,"N_{seed}");
  ...
  h1_mc_Pt_matched = ElectronDqmAnalyzerBase::bookH1(iBooker, "Pt_matched","Efficiency vs gen transverse momentum",pteff_nbin,5.,pt_max);
  ...
  h2_ele_PoPtrueVsPhi = ElectronDqmAnalyzerBase::bookH2(iBooker, "PoPtrueVsPhi","ele momentum / gen momentum vs phi",phi2D_nbin,phi_min,phi_max,50,poptrue_min,poptrue_max);
  h2_ele_PoPtrueVsPt = ElectronDqmAnalyzerBase::bookH2(iBooker, "PoPtrueVsPt","ele momentum / gen momentum vs eta",pt2D_nbin,0.,pt_max,50,poptrue_min,poptrue_max);
  ...
  h2_ele_EtaMnEtaTrueVsEta = ElectronDqmAnalyzerBase::bookH2(iBooker, "EtaMnEtaTrueVsEta","ele momentum  eta - gen  eta vs eta",eta2D_nbin,eta_min,eta_max,deta_nbin/2,deta_min,deta_max);
  h2_ele_EtaMnEtaTrueVsPhi = ElectronDqmAnalyzerBase::bookH2(iBooker, "EtaMnEtaTrueVsPhi","ele momentum  eta - gen  eta vs phi",phi2D_nbin,phi_min,phi_max,deta_nbin/2,deta_min,deta_max);
  h2_ele_EtaMnEtaTrueVsPt = ElectronDqmAnalyzerBase::bookH2(iBooker, "EtaMnEtaTrueVsPt","ele momentum  eta - gen  eta vs pt",pt_nbin,0.,pt_max,deta_nbin/2,deta_min,deta_max);
  ...
  h1_ele_PhiMnPhiTrue2 = ElectronDqmAnalyzerBase::bookH1(iBooker, "PhiMnPhiTrue2","ele momentum  phi - gen  phi",dphimatch2D_nbin,dphimatch_min,dphimatch_max);
  ...
  h1_scl_EoEtrue_barrel_eg = bookH1withSumw2(iBooker, "EoEtrue_barrel_eg","ele ecal energy / gen energy, barrel, ecal driven",50,0.2,1.2,"E/E_{gen}");
  ...
  h1_scl_EoEtrue_endcaps_eg = bookH1withSumw2(iBooker, "EoEtrue_endcaps_eg","ele ecal energy / gen energy, endcaps, ecal driven",50,0.2,1.2,"E/E_{gen}");
  ...
  h1_scl_EoEtrue_barrel_new_eg = bookH1withSumw2(iBooker, "EoEtrue_barrel_new_eg","ele ecal energy / gen energy, barrel, ecal driven",poptrue_nbin,poptrue_min,poptrue_max,"E/E_{gen}");
  ...
  h1_scl_EoEtrue_endcaps_new_eg = bookH1withSumw2(iBooker, "EoEtrue_endcaps_new_eg","ele ecal energy / gen energy, endcaps, ecal driven",poptrue_nbin,poptrue_min,poptrue_max,"E/E_{gen}");
  ...
  h2_scl_EtVsEta = ElectronDqmAnalyzerBase::bookH2(iBooker, "etVsEta","ele supercluster transverse energy vs eta",eta2D_nbin,eta_min,eta_max,pt_nbin,0.,pt_max);
  h2_scl_EtVsPhi = ElectronDqmAnalyzerBase::bookH2(iBooker, "etVsPhi","ele supercluster transverse energy vs phi",phi2D_nbin,phi_min,phi_max,pt_nbin,0.,pt_max);
  h2_scl_EtaVsPhi = ElectronDqmAnalyzerBase::bookH2(iBooker, "etaVsPhi","ele supercluster eta vs phi",phi2D_nbin,phi_min,phi_max,eta2D_nbin,eta_min,eta_max);
  ...
  h1_scl_SigEtaEta_eg = bookH1withSumw2(iBooker, "sigetaeta_eg","ele supercluster sigma eta eta, ecal driven",100,0.,0.05,"#sigma_{#eta #eta}","Events","ELE_LOGY E1 P");
  h1_scl_SigEtaEta_eg_barrel = bookH1withSumw2(iBooker, "sigetaeta_eg_barrel","ele supercluster sigma eta eta, ecal driven barrel",100,0.,0.05,"#sigma_{#eta #eta}","Events","ELE_LOGY E1 P");
  h1_scl_SigEtaEta_eg_endcaps = bookH1withSumw2(iBooker, "sigetaeta_eg_endcaps","ele supercluster sigma eta eta, ecal driven endcaps",100,0.,0.05,"#sigma_{#eta #eta}","Events","ELE_LOGY E1 P");
  h1_scl_SigIEtaIEta_eg = bookH1withSumw2(iBooker, "sigietaieta_eg","ele supercluster sigma ieta ieta, ecal driven",100,0.,0.05,"#sigma_{i#eta i#eta}","Events","ELE_LOGY E1 P");
  h1_scl_SigIEtaIEta_eg_barrel = bookH1withSumw2(iBooker, "sigietaieta_barrel_eg","ele supercluster sigma ieta ieta, barrel, ecal driven",100,0.,0.05,"#sigma_{i#eta i#eta}","Events","ELE_LOGY E1 P");
  h1_scl_SigIEtaIEta_eg_endcaps = bookH1withSumw2(iBooker, "sigietaieta_endcaps_eg","ele supercluster sigma ieta ieta, endcaps, ecal driven",100,0.,0.05,"#sigma_{i#eta i#eta}","Events","ELE_LOGY E1 P");
  h1_scl_E1x5_eg = bookH1withSumw2(iBooker, "E1x5_eg","ele supercluster energy in 1x5, ecal driven",p_nbin,0., p_max,"E1x5 (GeV)","Events","ELE_LOGY E1 P");
  h1_scl_E1x5_eg_barrel = bookH1withSumw2(iBooker, "E1x5_eg_barrel","ele supercluster energy in 1x5, ecal driven barrel",p_nbin,0., p_max,"E1x5 (GeV)","Events","ELE_LOGY E1 P");
  h1_scl_E1x5_eg_endcaps = bookH1withSumw2(iBooker, "E1x5_eg_endcaps","ele supercluster energy in 1x5, ecal driven endcaps",p_nbin,0., p_max,"E1x5 (GeV)","Events","ELE_LOGY E1 P");
  h1_scl_E2x5max_eg = bookH1withSumw2(iBooker, "E2x5max_eg","ele supercluster energy in 2x5 _max, ecal driven",p_nbin,0.,p_max,"E2x5 (GeV)","Events","ELE_LOGY E1 P");
  h1_scl_E2x5max_eg_barrel = bookH1withSumw2(iBooker, "E2x5max_eg_barrel","ele supercluster energy in 2x5 _max, ecal driven barrel",p_nbin,0.,p_max,"E2x5 (GeV)","Events","ELE_LOGY E1 P");
  h1_scl_E2x5max_eg_endcaps = bookH1withSumw2(iBooker, "E2x5max_eg_endcaps","ele supercluster energy in 2x5 _max, ecal driven endcaps",p_nbin,0.,p_max,"E2x5 (GeV)","Events","ELE_LOGY E1 P");
  h1_scl_E5x5_eg = bookH1withSumw2(iBooker, "E5x5_eg","ele supercluster energy in 5x5, ecal driven",p_nbin,0.,p_max,"E5x5 (GeV)","Events","ELE_LOGY E1 P");
  h1_scl_E5x5_eg_barrel = bookH1withSumw2(iBooker, "E5x5_eg_barrel","ele supercluster energy in 5x5, ecal driven barrel",p_nbin,0.,p_max,"E5x5 (GeV)","Events","ELE_LOGY E1 P");
  h1_scl_E5x5_eg_endcaps = bookH1withSumw2(iBooker, "E5x5_eg_endcaps","ele supercluster energy in 5x5, ecal driven endcaps",p_nbin,0.,p_max,"E5x5 (GeV)");
  ...
  h2_ele_seed_dphi2VsEta = ElectronDqmAnalyzerBase::bookH2(iBooker, "seedDphi2_VsEta","ele seed dphi 2nd layer vs eta",eta2D_nbin,eta_min,eta_max,50,-0.003,+0.003) ;
  h2_ele_seed_dphi2VsPt = ElectronDqmAnalyzerBase::bookH2(iBooker, "seedDphi2_VsPt","ele seed dphi 2nd layer vs pt",pt2D_nbin,0.,pt_max,50,-0.003,+0.003) ;
  ...
  h2_ele_seed_dphi2posVsEta = ElectronDqmAnalyzerBase::bookH2(iBooker, "seedDphi2Pos_VsEta","ele seed dphi 2nd layer positron vs eta",eta2D_nbin,eta_min,eta_max,50,-0.003,+0.003) ;
  h2_ele_seed_dphi2posVsPt = ElectronDqmAnalyzerBase::bookH2(iBooker, "seedDphi2Pos_VsPt","ele seed dphi 2nd layer positron vs pt",pt2D_nbin,0.,pt_max,50,-0.003,+0.003) ;
  h1_ele_seed_drz2 = bookH1withSumw2(iBooker, "seedDrz2","ele seed dr (dz) 2nd layer", 50,-0.03,+0.03,"r(z)_{hit}-r(z)_{pred} (cm)") ;
  h2_ele_seed_drz2VsEta = ElectronDqmAnalyzerBase::bookH2(iBooker, "seedDrz2_VsEta","ele seed dr/dz 2nd layer vs eta",eta2D_nbin,eta_min,eta_max,50,-0.03,+0.03) ;
  h2_ele_seed_drz2VsPt = ElectronDqmAnalyzerBase::bookH2(iBooker, "seedDrz2_VsPt","ele seed dr/dz 2nd layer vs pt",pt2D_nbin,0.,pt_max,50,-0.03,+0.03) ;
  ...
  h2_ele_seed_drz2posVsEta = ElectronDqmAnalyzerBase::bookH2(iBooker, "seedDrz2Pos_VsEta","ele seed dr/dz 2nd layer positron vs eta",eta2D_nbin,eta_min,eta_max,50,-0.03,+0.03) ;
  h2_ele_seed_drz2posVsPt = ElectronDqmAnalyzerBase::bookH2(iBooker, "seedDrz2Pos_VsPt","ele seed dr/dz 2nd layer positron vs pt",pt2D_nbin,0.,pt_max,50,-0.03,+0.03) ;
  ...
  h1_ele_fbrem_eg = bookH1withSumw2(iBooker, "brem_eg","ele brem fraction, mode of GSF components, ecal driven",100,0.,1.);
  ...
  h1_ele_mva_eg = bookH1withSumw2(iBooker, "mva_eg","ele identification mva, ecal driven",100,-1.,1.);
...
void ElectronMcSignalValidator::analyze( const edm::Event & iEvent, const edm::EventSetup & iSetup )
 {
  ...
  h1_recSeedNum->Fill((*gsfElectronSeeds).size());
    // --- AC ---
  //std::cout << "fin remplissage" << std::endl; // to be removed
 ...
 //  std::cout << "McSignal analyze : fin analyze" << std::endl; // to be removed
}
