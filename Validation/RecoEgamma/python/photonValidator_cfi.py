...
photonValidation = cms.EDAnalyzer("PhotonValidator",
    ...
    conversionOITrackProducer =cms.InputTag('ckfOutInTracksFromConversions'),
    conversionIOTrackProducer =cms.InputTag('ckfInOutTracksFromConversions'),
    ...
    trackingParticle = cms.InputTag("tpSelection"),
