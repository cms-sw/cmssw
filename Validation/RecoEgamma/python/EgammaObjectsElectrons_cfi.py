...
EgammaObjectsProducerElectrons = cms.EDAnalyzer("EgammaObjects",
    particleID = cms.int32(11),
    hist_min_EOverTruth = cms.double(0.5),
    hist_max_deltaEta = cms.double(0.05),
    RecoCollection = cms.InputTag("pixelMatchElectrons"),
    hist_min_Eta = cms.double(-2.7),
    hist_bins_EtaOverTruth = cms.int32(100),
    ...
    hist_bins_PhiOverTruth = cms.int32(100),
    hist_max_deltaPhi = cms.double(0.025),
    outputFile = cms.string('SDPV_Electrons.root'),
    hist_max_EtaOverTruth = cms.double(1.05),
    hist_min_EtaOverTruth = cms.double(0.95),
    hist_max_E = cms.double(400.0),
    hist_max_recoMass = cms.double(120.0),
    hist_bins_recoMass = cms.int32(240),
    hist_min_EtOverTruth = cms.double(0.6),
    hist_max_PhiOverTruth = cms.double(1.01),
    hist_bins_deltaEta = cms.int32(100),
    hist_min_recoMass = cms.double(0.0),
    hist_min_deltaEta = cms.double(-0.05),
    hist_max_EtOverTruth = cms.double(1.1),
    EtCut = cms.int32(5),
    hist_max_Eta = cms.double(2.7),
    hist_bins_Et = cms.int32(110),
    hist_bins_deltaPhi = cms.int32(100),
    hist_min_Et = cms.double(0.0),
    hist_max_Phi = cms.double(3.14159),
    hist_min_PhiOverTruth = cms.double(0.99),
    hist_min_deltaPhi = cms.double(-0.025),
    hist_max_Et = cms.double(110.0),
