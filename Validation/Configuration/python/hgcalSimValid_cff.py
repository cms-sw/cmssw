...
from RecoTICL.PatternRecognition.mergedTrackstersProducer_cfi import mergedTrackstersProducer as _mergedTrackstersProducer
...
from SimCalorimetry.TICLSimProducers.SimTracksters_cff import *
