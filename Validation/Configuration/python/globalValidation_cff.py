...
_run2SL_globalValidation = cms.Sequence(
      gemSimValid
    + recoMuonValidation
)
...
#run2_GEMSliceTest.toReplaceWith( globalValidation, _run3_globalValidation )
run2_GEMSliceTest.toReplaceWith( globalPrevalidationMuons, _run2SL_globalValidation )
