    ...
    efficiency = cms.vstring(
        ...
        *[ item
            ...
            for item in (    
                    ...
                    f"'Score{thr}/Fake_vs_EnTime' 'Fake Rate vs Energy-Time' Score{thr}/RecoClustersMatchedSimClustersEn_Time RecoClustersEn_Time fake",
                    f"'Score{thr}/Fake_vs_EtaTime' 'Fake Rate vs #eta-Time' Score{thr}/RecoClustersMatchedSimClustersEta_Time RecoClustersEta_Time fake",
                    f"'Score{thr}/Fake_vs_PhiTime' 'Fake Rate vs #phi-Time' Score{thr}/RecoClustersMatchedSimClustersPhi_Time RecoClustersPhi_Time fake",
                    f"'Score{thr}/Fake_vs_MultTime' 'Fake Rate vs Mult-Time' Score{thr}/RecoClustersMatchedSimClustersMult_Time RecoClustersMult_Time fake",
            )
            ],
    ),
    efficiencyProfile = cms.untracked.vstring( # for smoother rebinning
        ...
        *[ item
            ...
            for item in (
                    ...
                    f"'Score{thr}/Fake_vs_Time' 'Fake Rate vs Time' Score{thr}/RecoClustersMatchedSimClustersTime RecoClustersTime fake", 
                    # Merge rate
                    ...
                    f"'Score{thr}/Merge_vs_Time' 'Merge Rate vs Time' Score{thr}/RecoClustersMultiMatchedSimClustersTime RecoClustersTime",
            )
          ],
    ),
