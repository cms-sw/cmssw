...
pfJetResValidation1.MatchCollection = cms.InputTag('ak4GenJetsNoNu') # for global Validatio
...
pfJetResValidation2.MatchCollection = cms.InputTag('ak4GenJetsNoNu','','PFlowDQMnoTracking')
