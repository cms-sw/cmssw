...
process.source = cms.Source("PoolSource",
                   fileNames = cms.untracked.vstring('file:MEtoEDM_TTbar_PFlow.root'),
...
process.dqmSaver.workflow = '/PFlow/Validation/TTbar'
...
process.pfClientSequence = cms.Sequence(process.pfJetClient * process.pfMETClient * process.pfDanieleClient * process.pfElectronClient)
