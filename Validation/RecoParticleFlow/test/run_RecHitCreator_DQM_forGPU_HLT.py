...
process.pfHBHEGPUComparisonTask_HLT = DQMEDAnalyzer("PFRecHitCreatorGPUComparisonTask",
                                                    recHitsSourceCPU = cms.untracked.InputTag("hltHbhereco"),
                                                    pfRecHitsSourceCPU = cms.untracked.InputTag("hltParticleFlowRecHitHBHE"),
                                                    pfRecHitsSourceGPU = cms.untracked.InputTag("hltParticleFlowRecHitHBHEonGPU"),
                                                    pfClusterSourceCPU = cms.untracked.InputTag('hltParticleFlowClusterHBHE'),
                                                    pfClusterSourceGPU = cms.untracked.InputTag('hltParticleFlowClusterHBHEonGPU'),
...
process.options.numberOfThreads = 1#8
