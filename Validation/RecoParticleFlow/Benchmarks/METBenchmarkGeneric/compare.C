...
//string dir2 = "DQMData/PFTask/Benchmarks/met/Gen";
  ...
  const string dir2 = "DQMData/Run\ 1/PFTask/Run\ summary/pfMet";
...
//const char* file2 = "benchmark.root";
  const char* file1 = "benchmark_0.root";
  const char* file2 = "benchmark_1.root";
  ...
  Comparator comp(file1,
		  ...
		  file2,
		  dir2.c_str());
  comp.SetStyles(style1, style2, "355", "360pre4");
