...
text.DrawLatex(20,460,"Double-leptonic ttbar events");

gPad->SaveAs("MET_DoubleLepton.pdf");
gPad->SaveAs("MET_DoubleLepton.png");
...
text.SetTextColor(1);
text.SetTextSize(0.03);
text.DrawLatex(45,45,"Double-leptonic ttbar events");

gPad->SaveAs("METLog_DoubleLepton.pdf");
gPad->SaveAs("METLog_DoubleLepton.png");
...
text.SetTextColor(1);
text.SetTextSize(0.03);
text.DrawLatex(1,700,"Double-leptonic ttbar events");

gPad->SaveAs("Phi_DoubleLepton.pdf");
gPad->SaveAs("Phi_DoubleLepton.png");
