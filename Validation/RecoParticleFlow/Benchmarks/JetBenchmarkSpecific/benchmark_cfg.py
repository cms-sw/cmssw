...
process.source = cms.Source (
    ...
    # Fast
     ...
     # Full
       #'rfio:/castor/cern.ch/user/p/pjanot/CMSSW370pre4/aod_QCDForPF_Full_001.root',
       #'rfio:/castor/cern.ch/user/p/pjanot/CMSSW370pre4/aod_QCDForPF_Full_002.root', 
       #'rfio:/castor/cern.ch/user/p/pjanot/CMSSW370pre4/aod_QCDForPF_Full_003.root',
       ),
...
process.pfJetBenchmark.OutputFile = cms.untracked.string('JetBenchmark_Fast_370pre4.root')
