...
# with command line options: step3_2018 --conditions auto:phase1_2018_realistic -n 10 --era Run2_2018 --eventcontent RECOSIM,MINIAODSIM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT --datatier GEN-SIM-RECO,MINIAODSIM --geometry DB:Extended --filein file:step2.root --fileout file:step3.root --nThreads=2 --no_exec --python_filename=step3_2018_default.py
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step3_2018 nevts:10'),
...
#file = open('allDump_2018_default_cfg.py','w')
