// -*- C++ -*-
//
// Package:    OuterTrackerV
// Class:      OuterTrackerV
// 
/**\class OuterTrackerV OuterTrackerV.cc Validation/OuterTrackerV/plugins/OuterTrackerV.cc
...
#include "Validation/OuterTrackerV/interface/OuterTrackerV.h"
...
//
OuterTrackerV::OuterTrackerV(const edm::ParameterSet& iConfig)
...
void
OuterTrackerV::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void
OuterTrackerV::beginRun(const edm::Run& run, const edm::EventSetup& es)
{
...
void 
OuterTrackerV::endJob(void) 
{
	
}

//define this as a plug-in
DEFINE_FWK_MODULE(OuterTrackerV);
