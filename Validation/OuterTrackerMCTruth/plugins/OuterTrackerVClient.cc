...
// 
/**\class OuterTrackerV OuterTrackerVClient.cc Validation/OuterTrackerV/plugins/OuterTrackerVClient.cc
...
#include "Validation/OuterTrackerV/interface/OuterTrackerVClient.h"
