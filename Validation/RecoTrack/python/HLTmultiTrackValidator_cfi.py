...
hltMultiTrackValidator.lipTP    = cms.double(30.0)
hltMultiTrackValidator.tipTP    = cms.double(60.0)
hltMultiTrackValidator.histoProducerAlgoBlock.generalTpSelector.ptMin = cms.double( 0.9)
hltMultiTrackValidator.histoProducerAlgoBlock.generalTpSelector.lip   = cms.double(30.0)
hltMultiTrackValidator.histoProducerAlgoBlock.generalTpSelector.tip   = cms.double(60.0)
