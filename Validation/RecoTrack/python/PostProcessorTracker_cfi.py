...
postProcessorTrack = DQMEDHarvester("DQMGenericClient",
    ...
    "duplicatesRate_dr_jet 'Duplicates Rate vs dr (track,jet)' num_duplicate_drj num_reco_drj",
    ...
    "effic_vs_dr_jet 'Efficiency vs dr (track,jet)' num_assoc(simToReco)_drj num_simul_drj",
    ...
    "pileuprate_dr_jet 'Pileup rate vs dr (track,jet)' num_pileup_drj num_reco_drj",
    ...
    "fakerate_vs_dr_jet 'Fake rate vs dr (track,jet)' num_assoc(recoToSim)_drj num_reco_drj fake",
