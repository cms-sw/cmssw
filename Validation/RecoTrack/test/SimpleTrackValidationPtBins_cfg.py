"""
This script runs the SimpleTrackValidationPtBins.
It is just meant for testing and development.

To run:
cmsRun SimpleTrackValidationPtBins_cfg.py inputFiles=file:/path/to/step2.root
"""
...
process = cms.Process("SimpleTrackValidationPtBins",Phase2C17I13M9)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('simple_validation_ptbins.root')
)
...
process.SimpleTrackValidationPtBins = cms.EDAnalyzer("SimpleTrackValidationPtBins",
...
process.simDoubletProduction = cms.Path(
    ...
    process.SimpleTrackValidationPtBins 
)
