...
SiPixelTrackingRecHitsValid::SiPixelTrackingRecHitsValid(const edm::ParameterSet& ps)
  ...
  recoTrackCollectionToken_ =
      consumes<reco::TrackCollection>(edm::InputTag(ps.getUntrackedParameter<std::string>("src")));
...
void SiPixelTrackingRecHitsValid::bookHistograms(DQMStore::IBooker& ibooker,
  ...
  for (int i = 0; i < 3; i++)  // loop over layers
  {
    ...
    meResXvsAlphaBarrelFlippedLaddersLayer[i] =
    ...
    meResYvsAlphaBarrelFlippedLaddersLayer[i] =
    ...
    meResXvsBetaBarrelFlippedLaddersLayer[i] =
    ...
    meResYvsBetaBarrelFlippedLaddersLayer[i] =
    ...
    for (int j = 0; j < 8; j++)  // loop over rings
    {
      ...
      meResXvsBetaBarrelLayerModule[i][j] =
          ibooker.bookProfile(chisto, chisto, 20, barrel_betal, barrel_betah, 100, 0.0, resxh, "");
      sprintf(chisto, "meResYvsBetaBarrelLayerModule_%d_%d", i + 1, j + 1);
      meResYvsBetaBarrelLayerModule[i][j] =
          ibooker.bookProfile(chisto, chisto, 20, barrel_betal, barrel_betah, 100, 0.0, resyh, "");
  ...
  for (int i = 0; i < 2; i++)    // loop over disks
    for (int j = 0; j < 4; j++)  // loop over plaquettes
    {
      ...
      mePullXvsAlphaZmPanel1DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_p1_alphal, pull_forward_p1_alphah, 100, pullxl, pullxh, "");
      sprintf(chisto, "mePullYvsAlphaZmPanel1DiskPlaq_%d_%d", i + 1, j + 1);
      mePullYvsAlphaZmPanel1DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_p1_alphal, pull_forward_p1_alphah, 100, pullyl, pullyh, "");
      sprintf(chisto, "mePullXvsBetaZmPanel1DiskPlaq_%d_%d", i + 1, j + 1);
      mePullXvsBetaZmPanel1DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_neg_betal, pull_forward_neg_betah, 100, pullxl, pullxh, "");
      sprintf(chisto, "mePullYvsBetaZmPanel1DiskPlaq_%d_%d", i + 1, j + 1);
      mePullYvsBetaZmPanel1DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_neg_betal, pull_forward_neg_betah, 100, pullyl, pullyh, "");
      ...
      mePullXvsEtaZmPanel1DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_neg_etal, pull_forward_neg_etah, 100, pullxl, pullxh, "");
      sprintf(chisto, "mePullYvsEtaZmPanel1DiskPlaq_%d_%d", i + 1, j + 1);
      mePullYvsEtaZmPanel1DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_neg_etal, pull_forward_neg_etah, 100, pullyl, pullyh, "");
      ...
      mePullXvsAlphaZpPanel1DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_p1_alphal, pull_forward_p1_alphah, 100, pullxl, pullxh, "");
      sprintf(chisto, "mePullYvsAlphaZpPanel1DiskPlaq_%d_%d", i + 1, j + 1);
      mePullYvsAlphaZpPanel1DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_p1_alphal, pull_forward_p1_alphah, 100, pullyl, pullyh, "");
      sprintf(chisto, "mePullXvsBetaZpPanel1DiskPlaq_%d_%d", i + 1, j + 1);
      mePullXvsBetaZpPanel1DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_pos_betal, pull_forward_pos_betah, 100, pullxl, pullxh, "");
      sprintf(chisto, "mePullYvsBetaZpPanel1DiskPlaq_%d_%d", i + 1, j + 1);
      mePullYvsBetaZpPanel1DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_pos_betal, pull_forward_pos_betah, 100, pullyl, pullyh, "");
      ...
      mePullXvsEtaZpPanel1DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_pos_etal, pull_forward_pos_etah, 100, pullxl, pullxh, "");
      sprintf(chisto, "mePullYvsEtaZpPanel1DiskPlaq_%d_%d", i + 1, j + 1);
      mePullYvsEtaZpPanel1DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_pos_etal, pull_forward_pos_etah, 100, pullyl, pullyh, "");

      if (j > 2)
        continue;  // panel 2 has only 3 plaquettes
      ...
      mePullXvsAlphaZmPanel2DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_p2_alphal, pull_forward_p2_alphah, 100, pullxl, pullxh, "");
      sprintf(chisto, "mePullYvsAlphaZmPanel2DiskPlaq_%d_%d", i + 1, j + 1);
      mePullYvsAlphaZmPanel2DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_p2_alphal, pull_forward_p2_alphah, 100, pullyl, pullyh, "");
      sprintf(chisto, "mePullXvsBetaZmPanel2DiskPlaq_%d_%d", i + 1, j + 1);
      mePullXvsBetaZmPanel2DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_neg_betal, pull_forward_neg_betah, 100, pullxl, pullxh, "");
      sprintf(chisto, "mePullYvsBetaZmPanel2DiskPlaq_%d_%d", i + 1, j + 1);
      mePullYvsBetaZmPanel2DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_neg_betal, pull_forward_neg_betah, 100, pullyl, pullyh, "");
      ...
      mePullXvsEtaZmPanel2DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_neg_etal, pull_forward_neg_etah, 100, pullxl, pullxh, "");
      sprintf(chisto, "mePullYvsEtaZmPanel2DiskPlaq_%d_%d", i + 1, j + 1);
      mePullYvsEtaZmPanel2DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_neg_etal, pull_forward_neg_etah, 100, pullyl, pullyh, "");
      ...
      mePullXvsAlphaZpPanel2DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_p2_alphal, pull_forward_p2_alphah, 100, pullxl, pullxh, "");
      sprintf(chisto, "mePullYvsAlphaZpPanel2DiskPlaq_%d_%d", i + 1, j + 1);
      mePullYvsAlphaZpPanel2DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_p2_alphal, pull_forward_p2_alphah, 100, pullyl, pullyh, "");
      sprintf(chisto, "mePullXvsBetaZpPanel2DiskPlaq_%d_%d", i + 1, j + 1);
      mePullXvsBetaZpPanel2DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_pos_betal, pull_forward_pos_betah, 100, pullxl, pullxh, "");
      sprintf(chisto, "mePullYvsBetaZpPanel2DiskPlaq_%d_%d", i + 1, j + 1);
      mePullYvsBetaZpPanel2DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_pos_betal, pull_forward_pos_betah, 100, pullyl, pullyh, "");
      ...
      mePullXvsEtaZpPanel2DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_pos_etal, pull_forward_pos_etah, 100, pullxl, pullxh, "");
      sprintf(chisto, "mePullYvsEtaZpPanel2DiskPlaq_%d_%d", i + 1, j + 1);
      mePullYvsEtaZpPanel2DiskPlaq[i][j] = ibooker.bookProfile(
          chisto, chisto, 20, pull_forward_pos_etal, pull_forward_pos_etah, 100, pullyl, pullyh, "");
    ...
    for (TrackerGeometry::DetContainer::const_iterator it = pDD->dets().begin(); it != pDD->dets().end(); it++) {
      ...
      for (; pixeliter != pixelrechitRangeIteratorEnd; ++pixeliter) {
        ...
        if ((int)detId.subdetId() == (int)PixelSubdetector::PixelBarrel) {
          ...
          edm::LogWarning("SiPixelTrackingRecHitsValid")
              << "Pixel rechit collection but we are not in the pixel detector" << (int)detId.subdetId();
      }
    }
    // ------------------------------------------------ all hits ---------------------------------------------------------------
          ...
          if (matchedhit) {
            ...
            if (!matched.empty()) {
              ...
              if ((int)detId.subdetId() == (int)PixelSubdetector::PixelBarrel) {
                ...
                edm::LogWarning("SiPixelTrackingRecHitsValid")
                    << "Pixel rechit but we are not in the pixel detector" << (int)detId.subdetId();
