...
if __name__ == "__main__":
    ...
    cmsDriverCommand = "cmsDriver.py harvest --scenario pp --filetype DQM --conditions auto:run2_mc --mc -s HARVESTING:postProcessorTrackSequence -n -1 --filein {0}".format(filelist)
