...
TauEfficiencies = cms.EDAnalyzer("DQMHistEffProducer",
    plots = cms.PSet(
      PFTauIDMatchingEfficiencies = cms.PSet(
        ...
        denominator = cms.string('RecoTauV/pfRecoTauProducer_TauMCProducer/nRef_Taus_vs_#PAR#TauVisible'),
      ...
      PFTauIDTrackIsolationEfficienies = cms.PSet(
        ...
        denominator = cms.string('RecoTauV/pfRecoTauProducer_TauMCProducer/nRef_Taus_vs_#PAR#TauVisible'),
        efficiency = cms.string('RecoTauV/pfRecoTauProducer_pfRecoTauDiscriminationByTrackIsolation/IsolationEff#PAR#'),
        parameter = cms.vstring('pt', 'eta', 'phi', 'energy')
      ),
      PFTauIDECALIsolationEfficienies = cms.PSet(
        ...
        denominator = cms.string('RecoTauV/pfRecoTauProducer_TauMCProducer/nRef_Taus_vs_#PAR#TauVisible'),
        efficiency = cms.string('RecoTauV/pfRecoTauProducer_pfRecoTauDiscriminationByECALIsolation/IsolationEff#PAR#'),
        parameter = cms.vstring('pt', 'eta', 'phi', 'energy')
      ),
      ...
      PFTauHighEfficiencyIDMatchingEfficiencies = cms.PSet(
        ...
        denominator = cms.string('RecoTauV/pfRecoTauProducerHighEfficiency_TauMCProducer/nRef_Taus_vs_#PAR#TauVisible'),
      ...
      PFTauHighEfficiencyIDTrackIsolationEfficienies = cms.PSet(
        ...
        denominator = cms.string('RecoTauV/pfRecoTauProducerHighEfficiency_TauMCProducer/nRef_Taus_vs_#PAR#TauVisible'),
        efficiency = cms.string('RecoTauV/pfRecoTauProducerHighEfficiency_pfRecoTauDiscriminationByTrackIsolationHighEfficiency/IsolationEff#PAR#'),
        parameter = cms.vstring('pt', 'eta', 'phi', 'energy')
      ),
      PFTauHighEfficiencyIDECALIsolationEfficienies = cms.PSet(
        ...
        denominator = cms.string('RecoTauV/pfRecoTauProducerHighEfficiency_TauMCProducer/nRef_Taus_vs_#PAR#TauVisible'),
        efficiency = cms.string('RecoTauV/pfRecoTauProducerHighEfficiency_pfRecoTauDiscriminationByECALIsolationHighEfficiency/IsolationEff#PAR#'),
        parameter = cms.vstring('pt', 'eta', 'phi', 'energy')
      ),
      ...
      CaloTauIDMatchingEfficiencies = cms.PSet(
        ...
        denominator = cms.string('RecoTauV/caloRecoTauProducer_TauMCProducer/nRef_Taus_vs_#PAR#TauVisible'),
...
saveTauEff = cms.EDAnalyzer("DQMSimpleFileSaver",
  outputFileName = cms.string('CMSSW_2_2_1_HadronicTauOneAndThreeProng_ALL_NewDiscriminators.root')
)

saveTauEffFast = cms.EDAnalyzer("DQMSimpleFileSaver",
  outputFileName = cms.string('FastSim_CMSSW_2_2_1_HadronicTauOneAndThreeProng_ALL_Florian.root')
)
