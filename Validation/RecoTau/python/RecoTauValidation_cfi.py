...
proc.RunHPSValidation.discriminators = cms.VPSet(
   ...
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseCombinedIsolationDBSumPtCorr3HitsdR03"),plotStep = cms.bool(True),container = cms.string("hpsPFTauBasicDiscriminatorsdR03"),provenanceConfigLabel=cms.string("workingPoints"),idLabel=cms.string("ByLooseCombinedIsolationDBSumPtCorr3HitsdR03")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumCombinedIsolationDBSumPtCorr3HitsdR03"),plotStep = cms.bool(True),container = cms.string("hpsPFTauBasicDiscriminatorsdR03"),provenanceConfigLabel=cms.string("workingPoints"),idLabel=cms.string("ByMediumCombinedIsolationDBSumPtCorr3HitsdR03")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightCombinedIsolationDBSumPtCorr3HitsdR03"),plotStep = cms.bool(True),container = cms.string("hpsPFTauBasicDiscriminatorsdR03"),provenanceConfigLabel=cms.string("workingPoints"),idLabel=cms.string("ByTightCombinedIsolationDBSumPtCorr3HitsdR03")),
