...
proc.RunHPSValidation.discriminators = cms.VPSet(
   ...
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByIsolationMVArun2v1DBoldDMwLTraw"),selectionCut = cms.double(0.5),plotStep = cms.bool(False)),
   ...
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByIsolationMVArun2v1DBnewDMwLTraw"),selectionCut = cms.double(0.5),plotStep = cms.bool(False)),
   ...
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByIsolationMVArun2v1PWoldDMwLTraw"),selectionCut = cms.double(0.5),plotStep = cms.bool(False)),
   ...
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByIsolationMVArun2v1PWnewDMwLTraw"),selectionCut = cms.double(0.5),plotStep = cms.bool(False)),
   ...
   cms.PSet( discriminator = cms.string("hpsPFTauChargedIsoPtSumdR03"),selectionCut = cms.double(0.5),plotStep = cms.bool(False)),
   cms.PSet( discriminator = cms.string("hpsPFTauNeutralIsoPtSumdR03"),selectionCut = cms.double(0.5),plotStep = cms.bool(False)),
   cms.PSet( discriminator = cms.string("hpsPFTauPUcorrPtSumdR03"),selectionCut = cms.double(0.5),plotStep = cms.bool(False)),
   cms.PSet( discriminator = cms.string("hpsPFTauNeutralIsoPtSumWeightdR03"),selectionCut = cms.double(0.5),plotStep = cms.bool(False)),
   cms.PSet( discriminator = cms.string("hpsPFTauFootprintCorrectiondR03"),selectionCut = cms.double(0.5),plotStep = cms.bool(False)),
   cms.PSet( discriminator = cms.string("hpsPFTauPhotonPtSumOutsideSignalConedR03"),selectionCut = cms.double(0.5),plotStep = cms.bool(False)),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByIsolationMVArun2v1DBdR03oldDMwLTraw"),selectionCut = cms.double(0.5),plotStep = cms.bool(False)),
   ...
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByIsolationMVArun2v1PWdR03oldDMwLTraw"),selectionCut = cms.double(0.5),plotStep = cms.bool(False)),
