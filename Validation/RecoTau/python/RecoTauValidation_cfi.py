...
proc.RunHPSValidation.discriminators = cms.VPSet(
   ...
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseCombinedIsolationDBSumPtCorr3Hits"),plotStep = cms.bool(True),**tauIDbasicinputs("hpsPFTauBasicDiscriminators", "ByLooseCombinedIsolationDBSumPtCorr3Hits")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumCombinedIsolationDBSumPtCorr3Hits"),plotStep = cms.bool(True),**tauIDbasicinputs("hpsPFTauBasicDiscriminators", "ByMediumCombinedIsolationDBSumPtCorr3Hits")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightCombinedIsolationDBSumPtCorr3Hits"),plotStep = cms.bool(True),**tauIDbasicinputs("hpsPFTauBasicDiscriminators", "ByTightCombinedIsolationDBSumPtCorr3Hits")),
   ...
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseMuonRejection3"),plotStep = cms.bool(True),container = cms.string("hpsPFTauDiscriminationByMuonRejection3"),workingPointIndex = cms.int32(0)),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightMuonRejection3"),plotStep = cms.bool(True),container = cms.string("hpsPFTauDiscriminationByMuonRejection3"),workingPointIndex = cms.int32(1)),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6VLooseElectronRejection"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByMVA6ElectronRejection", "_VLoose")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6LooseElectronRejection"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByMVA6ElectronRejection", "_Loose")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6MediumElectronRejection"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByMVA6ElectronRejection", "_Medium")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6TightElectronRejection"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByMVA6ElectronRejection", "_Tight")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6VTightElectronRejection"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByMVA6ElectronRejection", "_VTight")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVLooseIsolationMVArun2v1DBoldDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBoldDMwLT", "_VLoose")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseIsolationMVArun2v1DBoldDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBoldDMwLT", "_Loose")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumIsolationMVArun2v1DBoldDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBoldDMwLT", "_Medium")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightIsolationMVArun2v1DBoldDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBoldDMwLT", "_Tight")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVTightIsolationMVArun2v1DBoldDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBoldDMwLT", "_VTight")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVVTightIsolationMVArun2v1DBoldDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBoldDMwLT", "_VVTight")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVLooseIsolationMVArun2v1DBnewDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBnewDMwLT", "_VLoose")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseIsolationMVArun2v1DBnewDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBnewDMwLT", "_Loose")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumIsolationMVArun2v1DBnewDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBnewDMwLT", "_Medium")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightIsolationMVArun2v1DBnewDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBnewDMwLT", "_Tight")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVTightIsolationMVArun2v1DBnewDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBnewDMwLT", "_VTight")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVVTightIsolationMVArun2v1DBnewDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBnewDMwLT", "_VVTight")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseCombinedIsolationDBSumPtCorr3HitsdR03"),plotStep = cms.bool(True),**tauIDbasicinputs("hpsPFTauBasicDiscriminatorsdR03", "ByLooseCombinedIsolationDBSumPtCorr3HitsdR03")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumCombinedIsolationDBSumPtCorr3HitsdR03"),plotStep = cms.bool(True),**tauIDbasicinputs("hpsPFTauBasicDiscriminatorsdR03", "ByMediumCombinedIsolationDBSumPtCorr3HitsdR03")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightCombinedIsolationDBSumPtCorr3HitsdR03"),plotStep = cms.bool(True),**tauIDbasicinputs("hpsPFTauBasicDiscriminatorsdR03", "ByTightCombinedIsolationDBSumPtCorr3HitsdR03")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVLooseIsolationMVArun2v1DBdR03oldDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBdR03oldDMwLT", "_VLoose")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseIsolationMVArun2v1DBdR03oldDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBdR03oldDMwLT", "_Loose")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumIsolationMVArun2v1DBdR03oldDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBdR03oldDMwLT", "_Medium")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightIsolationMVArun2v1DBdR03oldDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBdR03oldDMwLT", "_Tight")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVTightIsolationMVArun2v1DBdR03oldDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBdR03oldDMwLT", "_VTight")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVVTightIsolationMVArun2v1DBdR03oldDMwLT"),plotStep = cms.bool(False),**tauIDMVAinputs("hpsPFTauDiscriminationByIsolationMVArun2v1DBdR03oldDMwLT", "_VVTight")),
)
