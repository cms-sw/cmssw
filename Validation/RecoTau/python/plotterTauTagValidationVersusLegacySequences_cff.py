...
def ConvertToLegacyNames(input):
  ...
  drawJobs = cms.PSet(                                     
    PFJetMatchingEff = cms.PSet(
      plots = cms.VPSet(
         cms.PSet(
            ...
            legendEntry = cms.string('pre6 code on 228')
            ),
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/fixedConePFTauProducer_Matched/PFJetMatchingEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
      ),
    ...
    LeadingTrackPtCutEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/fixedConePFTauProducer_fixedConePFTauDiscriminationByLeadingTrackPtCut/LeadingTrackPtCutEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    TrackIsolationEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/fixedConePFTauProducer_fixedConePFTauDiscriminationByTrackIsolation/TrackIsolationEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    ECALIsolationEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/fixedConePFTauProducer_fixedConePFTauDiscriminationByECALIsolation/ECALIsolationEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    AgainstElectronEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/fixedConePFTauProducer_fixedConePFTauDiscriminationAgainstElectron/AgainstElectronEff#PAR#')), 
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    AgainstMuonEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/fixedConePFTauProducer_fixedConePFTauDiscriminationAgainstMuon/AgainstMuonEff#PAR#')), 
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
  ...
  drawJobs = cms.PSet(                                     
    PFJetMatchingEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducer_Matched/PFJetMatchingEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    LeadingTrackPtCutEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducer_shrinkingConePFTauDiscriminationByLeadingTrackPtCut/LeadingTrackPtCutEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    TrackIsolationEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducer_shrinkingConePFTauDiscriminationByTrackIsolation/TrackIsolationEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    ECALIsolationEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducer_shrinkingConePFTauDiscriminationByECALIsolation/ECALIsolationEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    AgainstElectronEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducer_shrinkingConePFTauDiscriminationAgainstElectron/AgainstElectronEff#PAR#')), 
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    AgainstMuonEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducer_shrinkingConePFTauDiscriminationAgainstMuon/AgainstMuonEff#PAR#')), 
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
  ...
  drawJobs = cms.PSet(                                     
    CaloJetMatchingEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/caloRecoTauProducer_Matched/CaloJetMatchingEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    LeadingTrackPtCutEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/caloRecoTauProducer_caloRecoTauDiscriminationByLeadingTrackPtCut/LeadingTrackPtCutEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    IsolationEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/caloRecoTauProducer_caloRecoTauDiscriminationByIsolation/IsolationEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    AgainstElectronEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/caloRecoTauProducer_caloRecoTauDiscriminationAgainstElectron/AgainstElectronEff#PAR#')), 
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
  ...
  drawJobs = cms.PSet(                                     
    PFJetMatchingEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerTanc_Matched/PFJetMatchingEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    LeadingTrackPtCutEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerTanc_shrinkingConePFTauDiscriminationByLeadingPionPtCut/LeadingPionPtCutEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    TaNCfrOnePercentEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerTanc_shrinkingConePFTauDiscriminationByTaNCfrOnePercent/TaNCfrOnePercentEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    TaNCfrHalfPercentEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerTanc_shrinkingConePFTauDiscriminationByTaNCfrHalfPercent/TaNCfrHalfPercentEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    TaNCfrQuarterPercentEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerTanc_shrinkingConePFTauDiscriminationByTaNCfrQuarterPercent/TaNCfrQuarterPercentEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    TaNCfrTenthPercentEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerTanc_shrinkingConePFTauDiscriminationByTaNCfrTenthPercent/TaNCfrTenthPercentEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    AgainstElectronEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerTanc_shrinkingConePFTauDiscriminationAgainstElectron/AgainstElectronEff#PAR#')), 
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    AgainstMuonEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerTanc_shrinkingConePFTauDiscriminationAgainstMuon/AgainstMuonEff#PAR#')), 
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
  ...
  drawJobs = cms.PSet(                                     
    PFJetMatchingEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerLeadingPion_Matched/PFJetMatchingEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    LeadingTrackPtCutEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerLeadingPion_shrinkingConePFTauDiscriminationByLeadingPionPtCut/LeadingPionPtCutEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    TrackIsolationEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerLeadingPion_shrinkingConePFTauDiscriminationByTrackIsolationUsingLeadingPion/TrackIsolationEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    ECALIsolationEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerLeadingPion_shrinkingConePFTauDiscriminationByECALIsolationUsingLeadingPion/ECALIsolationEff#PAR#')),
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    AgainstElectronEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerLeadingPion_shrinkingConePFTauDiscriminationAgainstElectron/AgainstElectronEff#PAR#')), 
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
    ...
    AgainstMuonEff = cms.PSet(
      plots = cms.VPSet(
         ...
         cms.PSet(
            dqmMonitorElements = cms.vstring(ConvertToLegacyNames('#PROCESSDIR#/RecoTauV/shrinkingConePFTauProducerLeadingPion_shrinkingConePFTauDiscriminationAgainstMuon/AgainstMuonEff#PAR#')), 
            process = cms.string( 'reference'),
            drawOptionEntry = cms.string('eff_overlay02'),
            legendEntry = cms.string('228 code on 228')
            )
