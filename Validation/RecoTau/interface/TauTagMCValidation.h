#ifndef TauTagMCValidation_h
#define TauTagMCValidation_h

// -*- C++ -*-
//
// Package:    TauTagMCValidation
// Class:      TauTagMCValidation
//
/* *\class TauTagMCValidation TauTagMCValidation.cc
...
// class declaration
class TauTagMCValidation : public DQMEDAnalyzer{

public:
  explicit TauTagMCValidation(const edm::ParameterSet&);
  ~TauTagMCValidation();
