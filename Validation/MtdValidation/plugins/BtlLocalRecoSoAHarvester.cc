...
// Class:      BtlLocalRecoSoAHarvester
//
/**\class BtlLocalRecoSoAHarvester BtlLocalRecoSoAHarvester.cc Validation/MtdValidation/plugins/BtlLocalRecoSoAHarvester.cc
...
class BtlLocalRecoSoAHarvester : public DQMEDHarvester {
public:
  explicit BtlLocalRecoSoAHarvester(const edm::ParameterSet& iConfig);
  ~BtlLocalRecoSoAHarvester() override;
...
BtlLocalRecoSoAHarvester::BtlLocalRecoSoAHarvester(const edm::ParameterSet& iConfig)
    : folder_(iConfig.getParameter<std::string>("folder")) {}

BtlLocalRecoSoAHarvester::~BtlLocalRecoSoAHarvester() {}

// ------------ endjob tasks ----------------------------
void BtlLocalRecoSoAHarvester::dqmEndJob(DQMStore::IBooker& ibook, DQMStore::IGetter& igetter) {
  ...
  if (!meBtlHitLogEnergy || !meBtlHitEnergy || missing_ru_slice || !meNevents) {
    edm::LogError("BtlLocalRecoSoAHarvester") << "Monitoring histograms not found!" << std::endl;
    return;
  }
...
void BtlLocalRecoSoAHarvester::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  edm::ParameterSetDescription desc;

  desc.add<std::string>("folder", "MTD/BTL/LocalRecoSoA/");

  descriptions.add("btlLocalRecoSoAPostProcessor", desc);
}

DEFINE_FWK_MODULE(BtlLocalRecoSoAHarvester);
