...
void EtlRecoHarvester::dqmEndJob(DQMStore::IBooker& ibook, DQMStore::IGetter& igetter) {
  ...
  if (!meTrackEffEtaTotZneg || !meTrackEffPhiTotZneg || !meTrackEffPtTotZneg || !meTrackEffEtaMtdZneg || !meTrackEffPhiMtdZneg || !meTrackEffPtMtdZneg || !meTrackEffEtaTotZpos || !meTrackEffPhiTotZpos || !meTrackEffPtTotZpos || !meTrackEffEtaMtdZpos || !meTrackEffPhiMtdZpos || !meTrackEffPtMtdZpos) {
  ...
  // --- Book  histograms
  ibook.cd(folder_);
  meEtlEtaEff_[0] = ibook.book1D("EtlEtaEffZneg"," Track Efficiency VS Eta (-Z);#eta;Efficiency", meTrackEffEtaTotZneg->getNbinsX(), meTrackEffEtaTotZneg->getTH1()->GetXaxis()->GetXmin() , meTrackEffEtaTotZneg->getTH1()->GetXaxis()->GetXmax() );
  meEtlPhiEff_[0] = ibook.book1D("EtlPhiEffZneg","Track Efficiency VS Phi (-Z);#phi;Efficiency [rad]", meTrackEffPhiTotZneg->getNbinsX(), meTrackEffPhiTotZneg->getTH1()->GetXaxis()->GetXmin(), meTrackEffPhiTotZneg->getTH1()->GetXaxis()->GetXmax());
  meEtlPtEff_[0] = ibook.book1D("EtlPtEffZneg","Track Efficiency VS Pt (-Z);Pt;Efficiency [GeV]", meTrackEffPtTotZneg->getNbinsX(), meTrackEffPtTotZneg->getTH1()->GetXaxis()->GetXmin(), meTrackEffPtTotZneg->getTH1()->GetXaxis()->GetXmax());
  meEtlEtaEff_[1] = ibook.book1D("EtlEtaEffZpos"," Track Efficiency VS Eta (+Z);#eta;Efficiency", meTrackEffEtaTotZpos->getNbinsX(), meTrackEffEtaTotZpos->getTH1()->GetXaxis()->GetXmin() , meTrackEffEtaTotZpos->getTH1()->GetXaxis()->GetXmax() );
  meEtlPhiEff_[1] = ibook.book1D("EtlPhiEffZpos","Track Efficiency VS Phi (+Z);#phi;Efficiency [rad]", meTrackEffPhiTotZpos->getNbinsX(), meTrackEffPhiTotZpos->getTH1()->GetXaxis()->GetXmin(), meTrackEffPhiTotZpos->getTH1()->GetXaxis()->GetXmax());
  meEtlPtEff_[1] = ibook.book1D("EtlPtEffZpos","Track Efficiency VS Pt (+Z);Pt;Efficiency [GeV]", meTrackEffPtTotZpos->getNbinsX(), meTrackEffPtTotZpos->getTH1()->GetXaxis()->GetXmin(), meTrackEffPtTotZpos->getTH1()->GetXaxis()->GetXmax());
  ...
  for (int ibin = 1; ibin <= meTrackEffEtaTotZneg->getNbinsX(); ibin++) {
   ...
   double bin_err = sqrt((meTrackEffEtaMtdZneg->getBinContent(ibin)*(meTrackEffEtaTotZneg->getBinContent(ibin)-meTrackEffEtaMtdZneg->getBinContent(ibin)))/pow(meTrackEffEtaTotZneg->getBinContent(ibin),3));
  ...
  for (int ibin = 1; ibin <= meTrackEffEtaTotZpos->getNbinsX(); ibin++) {
   ...
   double bin_err = sqrt((meTrackEffEtaMtdZpos->getBinContent(ibin)*(meTrackEffEtaTotZpos->getBinContent(ibin)-meTrackEffEtaMtdZpos->getBinContent(ibin)))/pow(meTrackEffEtaTotZpos->getBinContent(ibin),3));
  ...
  for (int ibin = 1; ibin <= meTrackEffPhiTotZneg->getNbinsX(); ibin++) {
   ...
   double bin_err = sqrt((meTrackEffPhiMtdZneg->getBinContent(ibin)*(meTrackEffPhiTotZneg->getBinContent(ibin)-meTrackEffPhiMtdZneg->getBinContent(ibin)))/pow(meTrackEffPhiTotZneg->getBinContent(ibin),3));
  ...
  for (int ibin = 1; ibin <= meTrackEffPhiTotZpos->getNbinsX(); ibin++) {
   ...
   double bin_err = sqrt((meTrackEffPhiMtdZpos->getBinContent(ibin)*(meTrackEffPhiTotZpos->getBinContent(ibin)-meTrackEffPhiMtdZpos->getBinContent(ibin)))/pow(meTrackEffPhiTotZpos->getBinContent(ibin),3));
  ...
  for (int ibin = 1; ibin <= meTrackEffPtTotZneg->getNbinsX(); ibin++) {
   ...
   double bin_err = sqrt((meTrackEffPtMtdZneg->getBinContent(ibin)*(meTrackEffPtTotZneg->getBinContent(ibin)-meTrackEffPtMtdZneg->getBinContent(ibin)))/pow(meTrackEffPtTotZneg->getBinContent(ibin),3));
  ...
  for (int ibin = 1; ibin <= meTrackEffPtTotZpos->getNbinsX(); ibin++) {
   ...
   double bin_err = sqrt((meTrackEffPtMtdZpos->getBinContent(ibin)*(meTrackEffPtTotZpos->getBinContent(ibin)-meTrackEffPtMtdZpos->getBinContent(ibin)))/pow(meTrackEffPtTotZpos->getBinContent(ibin),3));
