...
void fit_to_data(TH1D* h_TrackMatchedTP, TString str){
    ...
    Double_t range_max = h_TrackMatchedTP->GetXaxis()->GetBinLowEdge(h_TrackMatchedTP->GetNbinsX())+h_TrackMatchedTP->GetBinWidth(0);
    ...
    for(Int_t i=1; i<h_TrackMatchedTP->GetNbinsX()/2; i++){
      ...
      if (int_norm-0.68<min) res = i*bin_width;
    }
    ...
    xresframe->Draw();
    if (str.Contains("BTL") && str.Contains("Mtd")) legend_res->AddEntry("histogram","BTL", "PLerr");
    else if (str.Contains("BTL") && str.Contains("Gen")) legend_res->AddEntry("histogram","GenTrack (barrel)", "PLerr");
    else if (str.Contains("ETLPt") && str.Contains("Mtd")) legend_res->AddEntry("histogram","ETL (one hit)", "PLerr");
    else if (str.Contains("ETLPt") && str.Contains("Gen")) legend_res->AddEntry("histogram","GenTrack (end-caps)", "PLerr");
    else if (str.Contains("ETL2") && str.Contains("Mtd")) legend_res->AddEntry("histogram","ETL (2 hits)", "PLerr");
    else if (str.Contains("ETL2") && str.Contains("Gen")) legend_res->AddEntry("histogram","GenTrack (end-caps)", "PLerr");
