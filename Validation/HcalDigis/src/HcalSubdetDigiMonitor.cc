  ...
  noise_(noise)
{
  ...
  ibooker.setCurrentFolder("HcalDigisV/HcalDigiTask");
  ...
  */
  ...
  if(noise_ == 0) {   
    ...
    meNdigis = book1D(ibooker, histo, Ndigis);

    // maps of occupancies
    sprintf (histo, "HcalDigiTask_ieta_iphi_occupancy_map_depth1_%s", sub ) ;
    meOccupancy_map_depth1 = book2D(ibooker, histo,  ietaLim, iphiLim);

    sprintf (histo, "HcalDigiTask_ieta_iphi_occupancy_map_depth2_%s", sub ) ;
    meOccupancy_map_depth2 = book2D(ibooker, histo,  ietaLim, iphiLim);

    sprintf (histo, "HcalDigiTask_ieta_iphi_occupancy_map_depth3_%s", sub ) ;
    meOccupancy_map_depth3 = book2D(ibooker, histo,  ietaLim, iphiLim);

    sprintf (histo, "HcalDigiTask_ieta_iphi_occupancy_map_depth4_%s", sub ) ;
    meOccupancy_map_depth4 = book2D(ibooker, histo,  ietaLim, iphiLim);

    // occupancies vs ieta
    sprintf (histo, "HcalDigiTask_occupancy_vs_ieta_depth1_%s", sub ) ;
    meOccupancy_vs_ieta_depth1 = book1D(ibooker, histo,  ietaLim);

    sprintf (histo, "HcalDigiTask_occupancy_vs_ieta_depth2_%s", sub ) ;
    meOccupancy_vs_ieta_depth2 = book1D(ibooker, histo,  ietaLim);

    sprintf (histo, "HcalDigiTask_occupancy_vs_ieta_depth3_%s", sub ) ;
    meOccupancy_vs_ieta_depth3 = book1D(ibooker, histo,  ietaLim);

    sprintf (histo, "HcalDigiTask_occupancy_vs_ieta_depth4_%s", sub ) ;
    meOccupancy_vs_ieta_depth4 = book1D(ibooker, histo,  ietaLim);
