...
// $Id: JPTJetTesterUnCorr.cc,v 1.1 2011/02/23 16:57:16 kovitang Exp $
...
void JPTJetTesterUnCorr::beginJob(){
}

void JPTJetTesterUnCorr::endJob() {
 if (!mOutputFile.empty() && &*edm::Service<DQMStore>()) edm::Service<DQMStore>()->save (mOutputFile);
}


void JPTJetTesterUnCorr::analyze(const edm::Event& mEvent, const edm::EventSetup& mSetup)
{
...
void JPTJetTesterUnCorr::fillMatchHists (const reco::GenJet& fGenJet, const reco::JPTJet& fJPTJet) {
