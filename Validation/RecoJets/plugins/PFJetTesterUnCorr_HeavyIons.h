#ifndef ValidationRecoJetsPFJetTesterUnCorr_HeavyIons_h
#define ValidationRecoJetsPFJetTesterUnCorr_HeavyIons_h

// Producer for validation histograms for PFJet objects
// F. Ratnikov, Sept. 7, 2006
// Modified by Chiyoung.Jeong Feb 2, 2010
// $Id: PFJetTesterUnCorr_HeavyIons.h,v 1.7 2011/09/20 22:56:36 kovitang Exp $
...
class PFJetTesterUnCorr_HeavyIons : public edm::EDAnalyzer {
public:

  PFJetTesterUnCorr_HeavyIons (const edm::ParameterSet&);
  ~PFJetTesterUnCorr_HeavyIons();
...
private:
  ...
  MonitorElement* mChargedHadrons_PFcand_pT; 
  MonitorElement* mNeutralHadrons_PFcand_pT;
  MonitorElement* mPhotons_PFcand_pT;

  MonitorElement* mNumChargedHadrons;
  MonitorElement* mNumNeutralHadrons;
  MonitorElement* mNumPhotons;


  MonitorElement* mSumJetPtFraction_ChargedHadrons;
  MonitorElement* mSumJetPtFraction_NeutralHadrons;
  MonitorElement* mSumJetPtFraction_Photons;
