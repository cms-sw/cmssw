#ifndef NewMuonTrackValidatorBase_h
#define NewMuonTrackValidatorBase_h

/** \class NewMuonTrackValidatorBase
...
class NewMuonTrackValidatorBase {
 public:
  /// Constructor
  NewMuonTrackValidatorBase(const edm::ParameterSet& pset, edm::ConsumesCollector iC) : NewMuonTrackValidatorBase(pset)
    {
  ...
  void doProfileX(TH2 * th2, MonitorElement* me){
    if (th2->GetNbinsX()==me->getNbinsX()){
      ...
      throw cms::Exception("NewMuonTrackValidator") << "Different number of bins!";
    }
  }
