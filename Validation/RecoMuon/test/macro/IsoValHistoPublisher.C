...
void IsoValHistoPublisher(const char* newFile = "NEW_FILE", const char* refFile = "REF_FILE") {
  ...
  while ((rKey = (TKey*)iter_r())) {
    ...
    Plot4Histograms(newDir + "/muonIso3",
                    ...
                    scollname,
                    "IsoHistos3",
                    "Number of tracks, jets around #mu",
                    refLabel,
                    newLabel,
                    plots3,
                    0,
    ...
    Plot4Histograms(newDir + "/muonIso4",
                    ...
                    scollname,
                    "IsoHistos4",
                    "Average p_{T}, weighted E_{T} aroun #mu",
                    refLabel,
                    newLabel,
                    plots4,
                    0,
    ...
    TString gscommand = "gs -dBATCH -dNOPAUSE -q -sDEVICE=pdfwrite -sOutputFile=" + mergefile + " " + newDir +
                        "/muonIso1.pdf " + newDir + "/muonIso2.pdf " + newDir + "/muonIso3.pdf " + newDir +
                        "/muonIso4.pdf " + newDir + "/muonIso5.pdf " + newDir + "/muonIso6.pdf ";
