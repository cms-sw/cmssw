...
l3TkMuonTrackFSV.label_tp_effic = 'mergedtruth:MergedTrackTruth'
l3TkMuonTrackFSV.label_tp_fake = 'mergedtruth:MergedTrackTruth'
...
l3TkMuonMuTrackFSV.label_tp_effic = 'mergedtruth:MergedTrackTruth'
l3TkMuonMuTrackFSV.label_tp_fake = 'mergedtruth:MergedTrackTruth'
