...
recoMuonValidatorPF = cms.EDAnalyzer("RecoMuonValidatorPF",
    MuonServiceProxy,
    tpSelector = muonTPSet,

    #PF RECO comparisons
    matchPFRECOMomMagn = cms.untracked.double(0.00001),
    matchPFRECOMomDir = cms.untracked.double(0.000000000000001),
