...
postProcessorMuonMultiTrackHLTComp = cms.EDAnalyzer(
    ...
    "Eff_L3L2_Eta 'Eff_{L3,L2} vs #eta' hltL3Muons_tpToL3Association/effic hltL2Muons_UpdatedAtVtx_tpToL2Association/effic",
    "Eff_L3L2_Pt 'Eff_{L3,L2} vs p_{T}' hltL3Muons_tpToL3Association/efficPt hltL2Muons_UpdatedAtVtx_tpToL2Association/efficPt",
    "Eff_L3L2_Hit 'Eff_{L3,L2} vs n Hits' hltL3Muons_tpToL3Association/effic_vs_hit hltL2Muons_UpdatedAtVtx_tpToL2Association/effic_vs_hit",
    ...
    "Eff_L3L2_Eta_mabh 'Eff_{L3,L2} vs #eta' hltL3Muons_tpToL3MuonAssociation/effic hltL2Muons_UpdatedAtVtx_tpToL2MuonAssociation/effic",
    "Eff_L3L2_Pt_mabh 'Eff_{L3,L2} vs p_{T}' hltL3Muons_tpToL3MuonAssociation/efficPt hltL2Muons_UpdatedAtVtx_tpToL2MuonAssociation/efficPt",
    "Eff_L3L2_Hit_mabh 'Eff_{L3,L2} vs n Hits' hltL3Muons_tpToL3MuonAssociation/effic_vs_hit hltL2Muons_UpdatedAtVtx_tpToL2MuonAssociation/effic_vs_hit",
    ),
