...
postProcessorMuonMultiTrackHLTComp = cms.EDAnalyzer(
    ...
    subDirs = cms.untracked.vstring("HLT/Muon/MultiTrack/"), 
    efficiency = cms.vstring(
    "Eff_GlbTk_Eta 'Eff_{GLB,TK} vs #eta' hltL3Muons_tpToL3Association/effic hltL3TkFromL2_tpToL3TkTrackAssociation/effic",
    "Eff_GlbTk_Pt 'Eff_{GLB,TK} vs p_{T}' hltL3Muons_tpToL3Association/efficPt hltL3TkFromL2_tpToL3TkTrackAssociation/efficPt",
    "Eff_GlbTk_Hit 'Eff_{GLB,TK} vs n Hits' hltL3Muons_tpToL3Association/effic_vs_hit hltL3TkFromL2_tpToL3TkTrackAssociation/effic_vs_hit",
    "Eff_GlbSta_Eta 'Eff_{GLB,STA} vs #eta' hltL3Muons_tpToL3Association/effic hltL2Muons_UpdatedAtVtx_tpToL2Association/effic",
    "Eff_GlbSta_Pt 'Eff_{GLB,STA} vs p_{T}' hltL3Muons_tpToL3Association/efficPt hltL2Muons_UpdatedAtVtx_tpToL2Association/efficPt",
    "Eff_GlbSta_Hit 'Eff_{GLB,STA} vs n Hits' hltL3Muons_tpToL3Association/effic_vs_hit hltL2Muons_UpdatedAtVtx_tpToL2Association/effic_vs_hit",

    "Eff_GlbTk_Eta_mabh 'Eff_{GLB,TK} vs #eta' hltL3Muons_tpToL3MuonAssociation/effic hltL3TkFromL2_tpToL3TkMuonAssociation/effic",
    "Eff_GlbTk_Pt_mabh 'Eff_{GLB,TK} vs p_{T}' hltL3Muons_tpToL3MuonAssociation/efficPt hltL3TkFromL2_tpToL3TkMuonAssociation/efficPt",
    "Eff_GlbTk_Hit_mabh 'Eff_{GLB,TK} vs n Hits' hltL3Muons_tpToL3MuonAssociation/effic_vs_hit hltL3TkFromL2_tpToL3TkMuonAssociation/effic_vs_hit",
    "Eff_GlbSta_Eta_mabh 'Eff_{GLB,STA} vs #eta' hltL3Muons_tpToL3MuonAssociation/effic hltL2Muons_UpdatedAtVtx_tpToL2MuonAssociation/effic",
    "Eff_GlbSta_Pt_mabh 'Eff_{GLB,STA} vs p_{T}' hltL3Muons_tpToL3MuonAssociation/efficPt hltL2Muons_UpdatedAtVtx_tpToL2MuonAssociation/efficPt",
    "Eff_GlbSta_Hit_mabh 'Eff_{GLB,STA} vs n Hits' hltL3Muons_tpToL3MuonAssociation/effic_vs_hit hltL2Muons_UpdatedAtVtx_tpToL2MuonAssociation/effic_vs_hit",
    ),
