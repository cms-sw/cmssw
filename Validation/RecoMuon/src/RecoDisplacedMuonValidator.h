#ifndef Validation_RecoMuon_RecoDisplacedMuonValidator_H
#define Validation_RecoMuon_RecoDisplacedMuonValidator_H
...
class RecoDisplacedMuonValidator : public DQMOneEDAnalyzer<> {
public:
