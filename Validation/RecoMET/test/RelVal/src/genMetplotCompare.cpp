...
int main(int argc, char *argv[]) {
  ...
  hd = pc->AddHistoData("GenMET"); hd->SetType(1);
  hd = pc->AddHistoData("GenMETPhi"); hd->SetType(3);
  hd = pc->AddHistoData("GenMETSig"); hd->SetType(1);
  hd = pc->AddHistoData("GenMEx"); hd->SetType(2);
  hd = pc->AddHistoData("GenMEy"); hd->SetType(2);
  hd = pc->AddHistoData("GenSumET"); hd->SetType(2);
