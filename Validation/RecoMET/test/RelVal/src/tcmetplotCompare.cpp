...
//  hd = pc->AddHistoData("muonSAhits"); hd->SetType(0);
  ...
  hd = pc->AddHistoData("trackEta"); hd->SetType(2);
  hd = pc->AddHistoData("trackD0"); hd->SetType(2);
  hd = pc->AddHistoData("muonPt"); hd->SetType(2);
  hd = pc->AddHistoData("muonNormalizedChi2"); hd->SetType(4);
  hd = pc->AddHistoData("muonNhits"); hd->SetType(1);
  hd = pc->AddHistoData("muonEta"); hd->SetType(2);
  hd = pc->AddHistoData("muonD0"); hd->SetType(2);
