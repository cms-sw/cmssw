...
int main(int argc, char *argv[]) {
	...
	hd = pc->AddHistoData("METResolution_GenMETTrue_InMETBins"); hd->SetType(0);
	hd = pc->AddHistoData("METResolution_GenMETTrue_MET400to500"); hd->SetType(2);
	hd = pc->AddHistoData("METResolution_GenMETTrue_MET300to400"); hd->SetType(2);
	hd = pc->AddHistoData("METResolution_GenMETTrue_MET200to300"); hd->SetType(1);
	hd = pc->AddHistoData("METResolution_GenMETTrue_MET150to200"); hd->SetType(1);
	hd = pc->AddHistoData("METResolution_GenMETTrue_MET100to150"); hd->SetType(0);
	hd = pc->AddHistoData("METResolution_GenMETTrue_MET80to100"); hd->SetType(0);
	hd = pc->AddHistoData("METResolution_GenMETTrue_MET60to80"); hd->SetType(0);
	hd = pc->AddHistoData("METResolution_GenMETTrue_MET40to60"); hd->SetType(0);
	hd = pc->AddHistoData("METResolution_GenMETTrue_MET20to40"); hd->SetType(0);
	hd = pc->AddHistoData("METResolution_GenMETTrue_MET0to20"); hd->SetType(0);

	hd = pc->AddHistoData("MET_Nvtx30toInf"); hd->SetType(1);
	hd = pc->AddHistoData("MET_Nvtx21to30"); hd->SetType(1);
	hd = pc->AddHistoData("MET_Nvtx16to20"); hd->SetType(1);
	hd = pc->AddHistoData("MET_Nvtx11to15"); hd->SetType(1);
	hd = pc->AddHistoData("MET_Nvtx6to10"); hd->SetType(1);
	hd = pc->AddHistoData("MET_Nvtx0to5"); hd->SetType(1);

	hd = pc->AddHistoData("SumET_Nvtx30toInf"); hd->SetType(2);
	hd = pc->AddHistoData("SumET_Nvtx21to30"); hd->SetType(2);
	hd = pc->AddHistoData("SumET_Nvtx16to20"); hd->SetType(2);
	hd = pc->AddHistoData("SumET_Nvtx11to15"); hd->SetType(2);
	hd = pc->AddHistoData("SumET_Nvtx6to10"); hd->SetType(2);
	hd = pc->AddHistoData("SumET_Nvtx0to5"); hd->SetType(2);
	...
	for (int index = 0; index < pc->GetNumHistos(); index++) {
		...
		if (hnew->GetEntries() <= 1 || href->GetEntries() <= 1) {
			...
			cerr << name << " error: no entries"; combinedFailed = true;
		}
