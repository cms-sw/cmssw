...
void GlobalRecHitsHistogrammer::bookHistograms(DQMStore::IBooker& ibooker, edm::Run const&, edm::EventSetup const&) {
  //monitor elements
...
void GlobalRecHitsHistogrammer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
