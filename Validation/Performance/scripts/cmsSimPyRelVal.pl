...
%SimPython=(
	    "GEN,SIM"=>"Configuration/PyReleaseValidation/python/SimulationG4.py",
	    #"SIM"=>"SimulationG4.py", #To run SIM only need GEN done already!
	    "DIGI"=>"Configuration/PyReleaseValidation/python/Simulation.py",
	    #Adding RECO step
	    "RECO"=>"Configuration/PyReleaseValidation/python/Simulation.py"
	   );
