...
# "castordir" (Path String), "perfsuitedir" (Path string), "TimeSizeEvents" (int), "IgProfEvents" (int), "ValgrindEvents" (int),
...
# "candles" list of (string)s, "bypasshlt" (boolean), "runonspare" (boolean), "logfile" (path string)
#
#  It is advised not to change the keywords perfsuitedir and logfile as these are configured by the server. However
#  if used they will override the servers pre-set values.
#
