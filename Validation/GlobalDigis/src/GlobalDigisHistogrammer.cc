...
edm::Handle<PGlobalDigi> srcGlobalDigis;
  ...
  // get Ecal info
	...
	mehEcalSHEvAEESHE[0]->
	  Fill(EECalDigi.AEE/EECalDigi.SHE,EECalDigi.SHE,1);
      }
    }
	...
	mehEcalSHEvAEESHE[1]->
	  Fill(EBCalDigi.AEE/EBCalDigi.SHE,EBCalDigi.SHE,1);
      }
    }
	...
	mehHcalSHEvAEE[0]->
	  Fill(HBCalDigi.AEE,HBCalDigi.SHE,1);
      }
    }
	...
	mehHcalSHEvAEE[1]->
	  Fill(HECalDigi.AEE,HECalDigi.SHE,1);
      }
    }
	...
	mehHcalSHEvAEE[2]->
	  Fill(HOCalDigi.AEE,HOCalDigi.SHE,1);
      }
    }
	...
	mehHcalSHEvAEE[3]->
	  Fill(HFCalDigi.AEE,HFCalDigi.SHE,1);
      }
    }
