...
process.GEN = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('mu_plus_pt100GeV.root')
)

process.configurationMetadata = cms.untracked.PSet(
    version = cms.untracked.string('$Revision: 1.1 $'),
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/Validation/MuonHits/python/GenMuonPlsPt100GeV_cfg.py,v $'),
