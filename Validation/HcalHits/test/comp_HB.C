// Commands executed in a GLOBAL scope, e.g. created hitograms aren't erased...
{
   ...
   TFile f1("HB_histo_208.root");
   TFile f2("HB_histo_210pre5.root");
   //   TFile f3("histo_HB_164.root");
   ...
   //   f1_hist[1]->SetMaximum(400.);
   //f1_hist[2]->SetMaximum(100.);
   //   f1_hist[3]->SetMaximum(300.);
   //f1_hist[4]->SetMaximum(60000.);
   //f1_hist[5]->SetMinimum(0.7);
   f1_hist[5]->SetMaximum(1.02.);
   //f1_hist[6]->SetMaximum(700.);
   //f1_hist[7]->SetMaximum(500.);
   //f1_hist[8]->SetMaximum(250.);
   ...
   for (int i = 0; i < Nhist; i++){
     ...
     */
     ...
     if(i == 0 || i == 1 || i == 2 || i == 3 || i == 4 || i == 5 || i == 6 || i == 8 ) {
       ...
       //       TLegend *leg = new TLegend(0.67, 0.65, 0.97, 0.8, "","brNDC");
     }
     else {
     ...
     leg->AddEntry(f1_hist[i],"CMSSW_208","l");
     leg->AddEntry(f2_hist[i],"CMSSW_210pre5","l");
     //     leg->AddEntry(f3_hist[i],"CMSSW_1_7_0","l");
