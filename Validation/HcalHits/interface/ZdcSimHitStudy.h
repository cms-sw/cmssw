...
protected:
  ...
  int FillHitValHist(int side, int section, int channel, double energy,
                     double time);
...
private:
  ...
  MonitorElement *meAllZdcNHit_, *meBadZdcDetHit_, *meBadZdcSecHit_,
      *meBadZdcIdHit_;
  ...
  MonitorElement *meZdcSectionHit_, *meZdcChannelHit_, *meZdcEnergyHit_,
      *meZdcTimeWHit_;
  MonitorElement *meZdcHadEnergyHit_, *meZdcEMEnergyHit_, *meZdcTimeHit_,
      *meZdcHadL10EneP_;
  MonitorElement *meZdc10EneP_, *meZdcEHadCh_, *meZdcEEMCh_, *meZdcEML10EneP_;
  MonitorElement *meZdcEneEmN1_, *meZdcEneEmN2_, *meZdcEneEmN3_, *meZdcEneEmN4_,
      *meZdcEneEmN5_;
  MonitorElement *meZdcEneHadN1_, *meZdcEneHadN2_, *meZdcEneHadN3_,
      *meZdcEneHadN4_;
  MonitorElement *meZdcEneTEmN1_, *meZdcEneTEmN2_, *meZdcEneTEmN3_,
      *meZdcEneTEmN4_, *meZdcEneTEmN5_;
  MonitorElement *meZdcEneTHadN1_, *meZdcEneTHadN2_, *meZdcEneTHadN3_,
      *meZdcEneTHadN4_;
  MonitorElement *meZdcEneHadNTot_, *meZdcEneEmNTot_, *meZdcEneNTot_;
  MonitorElement *meZdcCorEEmNEHadN_;
  MonitorElement *meZdcEneEmP1_, *meZdcEneEmP2_, *meZdcEneEmP3_, *meZdcEneEmP4_,
      *meZdcEneEmP5_;
  MonitorElement *meZdcEneHadP1_, *meZdcEneHadP2_, *meZdcEneHadP3_,
      *meZdcEneHadP4_;
  MonitorElement *meZdcEneTEmP1_, *meZdcEneTEmP2_, *meZdcEneTEmP3_,
      *meZdcEneTEmP4_, *meZdcEneTEmP5_;
  MonitorElement *meZdcEneTHadP1_, *meZdcEneTHadP2_, *meZdcEneTHadP3_,
      *meZdcEneTHadP4_;
