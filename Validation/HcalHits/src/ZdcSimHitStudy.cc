...
void ZdcSimHitStudy::beginJob() {
  if (dbe_) {
    ...
    if (checkHit_) {
      ...
      /////////////////////////////////////////////////////////
      // Above the histograms were made to show a 2D distribution of energy in #phi and #eta with the Z weight being energy, now I will make a histogram where the Z weight is just counts. These plots can then be divided to find the average energy per particle simulated in that region


      //Foward Pi0s
      dbe_->setCurrentFolder("ZDCValidation/GenParticles/Forward");
      genpart_Pi0F_counts = dbe_->book2D("Pi0_Forward_Counts","Number of Forward Generated Pi0s",200,7.5,13,100,-3.15,3.15);
      ...
      //Profile
      //MonitorElement *genpart_Pi0F_profile=0;
      genpart_Pi0F_profile = dbe_->bookProfile("Pi0_Forward_Profile","Number of Forward Generated Pi0s",200,7.5,13,100,-3.15,3.15,"");
      genpart_Pi0F_profile->setAxisTitle("#eta",1);
      genpart_Pi0F_profile->setAxisTitle("#phi (radians)",2);
      // genpart_Pi0F_profile->setAxisTitle("Energy (GeV)",3);
      genpart_Pi0F_profile->getTProfile()->SetOption("lego2z,prof");
      genpart_Pi0F_profile->getTProfile()->SetTitleOffset(1.4,"x");
      genpart_Pi0F_profile->getTProfile()->SetTitleOffset(1.4,"y");

      //Backward Pi0s
      dbe_->setCurrentFolder("ZDCValidation/GenParticles/Backward");
      genpart_Pi0B_counts = dbe_->book2D("Pi0_Backwards_Counts","Number of Backward Generated Pi0s",200,-13,-7.5,100,-3.15,3.15);
      ...
      //Profile                                                      
      genpart_Pi0B_profile = dbe_->bookProfile("Pi0_Backward_Profile","Backward Generated Pi0s",200,-13,-7.5,100,-3.15,3.15,"");
      genpart_Pi0B_profile->setAxisTitle("#eta",1);
      genpart_Pi0B_profile->setAxisTitle("#phi (radians)",2);
      //genpart_Pi0B_profile->setAxisTitle("Energy (GeV)",3);
      genpart_Pi0B_profile->getTProfile()->SetOption("lego2z,prof");
      genpart_Pi0B_profile->getTProfile()->SetTitleOffset(1.4,"x");
      genpart_Pi0B_profile->getTProfile()->SetTitleOffset(1.4,"y");

       //Foward Neutrons
      dbe_->setCurrentFolder("ZDCValidation/GenParticles/Forward");
      genpart_NeutF_counts = dbe_->book2D("Neutron_Forward_Counts","Number of Forward Generated Neutrons",200,7.5,13,100,-3.15,3.15);
      ...
      //Profile                                                      
      genpart_NeutF_profile = dbe_->bookProfile("Neutron_Forward_Profile","Forward Generated Neutron",200,7.5,13,100,-3.15,3.15,"");
      genpart_NeutF_profile->setAxisTitle("#eta",1);
      genpart_NeutF_profile->setAxisTitle("#phi (radians)",2);
      //genpart_NeutF_profile->setAxisTitle("Energy (GeV)",3);
      genpart_NeutF_profile->getTProfile()->SetOption("lego2z,prof");
      genpart_NeutF_profile->getTProfile()->SetTitleOffset(1.4,"x");
      genpart_NeutF_profile->getTProfile()->SetTitleOffset(1.4,"y");

      //Backward Neutrons
      dbe_->setCurrentFolder("ZDCValidation/GenParticles/Backward");
      genpart_NeutB_counts = dbe_->book2D("Neutron_Backwards_Counts","Number of Backward Generated Neutrons",200,-13,-7.5,100,-3.15,3.15);
      ...
      //Profile                                                                                         
      genpart_NeutB_profile = dbe_->bookProfile("Neutron_Backward_Profile","Backward Generated Neutrons",200,-13,-7.5,100,-3.15,3.15,"");
      genpart_NeutB_profile->setAxisTitle("#eta",1);
      genpart_NeutB_profile->setAxisTitle("#phi (radians)",2);
      //genpart_NeutB_profile->setAxisTitle("Energy (GeV)",3);
      genpart_NeutB_profile->getTProfile()->SetOption("lego2z,prof");
      genpart_NeutB_profile->getTProfile()->SetTitleOffset(1.4,"x");
      genpart_NeutB_profile->getTProfile()->SetTitleOffset(1.4,"y");    


       //Foward Gammas
      dbe_->setCurrentFolder("ZDCValidation/GenParticles/Forward");
      genpart_GammaF_counts = dbe_->book2D("Gamma_Forward_Counts","Number of Forward Generated Gammas",200,7.5,13,100,-3.15,3.15);
      ...
      //Profile                                                        
      genpart_GammaF_profile = dbe_->bookProfile("Gamma_Forward_Profile","Forward Generated Gammas",200,7.5,13,100,-3.15,3.15,"");
      genpart_GammaF_profile->setAxisTitle("#eta",1);
      genpart_GammaF_profile->setAxisTitle("#phi (radians)",2);
      //genpart_GammaF_profile->setAxisTitle("Energy (GeV)",3);
      genpart_GammaF_profile->getTProfile()->SetOption("lego2z,prof");
      genpart_GammaF_profile->getTProfile()->SetTitleOffset(1.4,"x");
      genpart_GammaF_profile->getTProfile()->SetTitleOffset(1.4,"y");

      //Backward Gammas
      dbe_->setCurrentFolder("ZDCValidation/GenParticles/Backward");
      genpart_GammaB_counts = dbe_->book2D("Gamma_Backwards_Counts","Number of Backward Generated Gammas",200,-13,-7.5,100,-3.15,3.15);
      ...
      //Profile                                                                                         
      genpart_GammaB_profile = dbe_->bookProfile("Gamma_Backward_Profile","Backward Generated Gammas",200,-13,-7.5,100,-3.15,3.15,"");
      genpart_GammaB_profile->setAxisTitle("#eta",1);
      genpart_GammaB_profile->setAxisTitle("#phi (radians)",2);
      //genpart_GammaB_profile->setAxisTitle("Energy (GeV)",3);
      genpart_GammaB_profile->getTProfile()->SetOption("lego2z,prof");
      genpart_GammaB_profile->getTProfile()->SetTitleOffset(1.4,"x");
      genpart_GammaB_profile->getTProfile()->SetTitleOffset(1.4,"y");
