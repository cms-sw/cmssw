...
cmsDriver.py SingleMuPt40Fwd_cfi -s GEN,SIM,DIGI,L1 --conditions auto:run2_design --magField 38T_PostLS1 --datatier GEN-SIM-DIGI --geometry Extended2023 --evt_type Validation/MuonGEMHits/SingleMuPt40Fwd_cfi --eventcontent FEVTDEBUG -n 1000 --no_exec --fileout out_digi.root --customise SLHCUpgradeSimulations/Configuration/gemCustom.customise2023,SLHCUpgradeSimulations/Configuration/fixMissingUpgradeGTPayloads.fixRPCConditions,SLHCUpgradeSimulations/Configuration/fixMissingUpgradeGTPayloads.fixCSCAlignmentConditions,SimMuon/GEMDigitizer/customizeGEMDigi.customize_digi_addGEM_muon_only --python_filename=gen_sim_digi_cfg.py  
