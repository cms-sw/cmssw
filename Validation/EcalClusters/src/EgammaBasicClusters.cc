  ...
  for(const auto & barrelBasicCluster : *barrelBasicClusters)
    {
      ...
      hist_EB_BC_ET_vs_Eta_->Fill( barrelBasicCluster.energy()/std::cosh(barrelBasicCluster.position().eta()), barrelBasicCluster.eta() );
      hist_EB_BC_ET_vs_Phi_->Fill( barrelBasicCluster.energy()/std::cosh(barrelBasicCluster.position().eta()), barrelBasicCluster.phi() );
    }
  ...
  for(const auto & endcapBasicCluster : *endcapBasicClusters)
    {
      ...
      hist_EE_BC_ET_vs_Eta_->Fill( endcapBasicCluster.energy()/std::cosh(endcapBasicCluster.position().eta()), endcapBasicCluster.eta() );
      hist_EE_BC_ET_vs_Phi_->Fill( endcapBasicCluster.energy()/std::cosh(endcapBasicCluster.position().eta()), endcapBasicCluster.phi() );
