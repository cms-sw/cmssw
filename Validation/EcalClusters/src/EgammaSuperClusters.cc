  ...
  for(const auto & barrelCorSuperCluster : *barrelCorSuperClusters)
    {
      ...
      hist_EB_CorSC_ET_vs_Eta_->Fill( barrelCorSuperCluster.energy()/std::cosh(barrelCorSuperCluster.position().eta()), barrelCorSuperCluster.eta() );
      hist_EB_CorSC_ET_vs_Phi_->Fill( barrelCorSuperCluster.energy()/std::cosh(barrelCorSuperCluster.position().eta()), barrelCorSuperCluster.phi() );
  ...
  for(const auto & endcapCorSuperCluster : *endcapCorSuperClusters)
    {
      ...
      hist_EE_CorSC_ET_vs_Eta_->Fill( endcapCorSuperCluster.energy()/std::cosh(endcapCorSuperCluster.position().eta()), endcapCorSuperCluster.eta() );
      hist_EE_CorSC_ET_vs_Phi_->Fill( endcapCorSuperCluster.energy()/std::cosh(endcapCorSuperCluster.position().eta()), endcapCorSuperCluster.phi() );
      hist_EE_CorSC_ET_vs_R_->Fill( endcapCorSuperCluster.energy()/std::cosh(endcapCorSuperCluster.position().eta()), 
