...
EgammaSuperClusters::EgammaSuperClusters(const edm::ParameterSet &ps)
    : MCTruthCollectionToken_(consumes<edm::HepMCProduct>(
          ps.getParameter<edm::InputTag>("MCTruthCollection"))),
      barrelRawSuperClusterCollectionToken_(
          consumes<reco::SuperClusterCollection>(ps.getParameter<edm::InputTag>(
      ...
      barrelRecHitCollectionToken_(consumes<EcalRecHitCollection>(
          ps.getParameter<edm::InputTag>("barrelRecHitCollection"))),
      endcapRecHitCollectionToken_(consumes<EcalRecHitCollection>(
          ps.getParameter<edm::InputTag>("endcapRecHitCollection"))),
      hsSize_(ps, "Size"), hsNumBC_(ps, "NumBC"), hsET_(ps, "ET"),
      hsEta_(ps, "Eta"), hsPhi_(ps, "Phi"), hsS1toS9_(ps, "S1toS9"),
      hsS25toE_(ps, "S25toE"), hsEoverTruth_(ps, "EoverTruth"),
      hsdeltaR_(ps, "deltaR"), hsphiWidth_(ps, "phiWidth"),
      hsetaWidth_(ps, "etaWidth"), hspreshowerE_(ps, "preshowerE"),
      hsR_(ps, "R"), hist_EB_RawSC_Size_(nullptr), hist_EE_RawSC_Size_(nullptr),
      hist_EB_CorSC_Size_(nullptr), hist_EE_CorSC_Size_(nullptr),
      hist_EE_PreSC_Size_(nullptr), hist_EB_RawSC_NumBC_(nullptr),
      hist_EE_RawSC_NumBC_(nullptr), hist_EB_CorSC_NumBC_(nullptr),
      hist_EE_CorSC_NumBC_(nullptr), hist_EE_PreSC_NumBC_(nullptr),
      hist_EB_RawSC_ET_(nullptr), hist_EE_RawSC_ET_(nullptr),
      hist_EB_CorSC_ET_(nullptr), hist_EE_CorSC_ET_(nullptr),
      hist_EE_PreSC_ET_(nullptr), hist_EB_RawSC_Eta_(nullptr),
      hist_EE_RawSC_Eta_(nullptr), hist_EB_CorSC_Eta_(nullptr),
      hist_EE_CorSC_Eta_(nullptr), hist_EE_PreSC_Eta_(nullptr),
      hist_EB_RawSC_Phi_(nullptr), hist_EE_RawSC_Phi_(nullptr),
      hist_EB_CorSC_Phi_(nullptr), hist_EE_CorSC_Phi_(nullptr),
      hist_EE_PreSC_Phi_(nullptr), hist_EB_RawSC_S1toS9_(nullptr),
      hist_EE_RawSC_S1toS9_(nullptr), hist_EB_CorSC_S1toS9_(nullptr),
      hist_EE_CorSC_S1toS9_(nullptr), hist_EE_PreSC_S1toS9_(nullptr),
      hist_EB_RawSC_S25toE_(nullptr), hist_EE_RawSC_S25toE_(nullptr),
      hist_EB_CorSC_S25toE_(nullptr), hist_EE_CorSC_S25toE_(nullptr),
      hist_EE_PreSC_S25toE_(nullptr), hist_EB_RawSC_EoverTruth_(nullptr),
      hist_EE_RawSC_EoverTruth_(nullptr), hist_EB_CorSC_EoverTruth_(nullptr),
      hist_EE_CorSC_EoverTruth_(nullptr), hist_EE_PreSC_EoverTruth_(nullptr),
      hist_EB_RawSC_deltaR_(nullptr), hist_EE_RawSC_deltaR_(nullptr),
      hist_EB_CorSC_deltaR_(nullptr), hist_EE_CorSC_deltaR_(nullptr),
      hist_EE_PreSC_deltaR_(nullptr), hist_EE_PreSC_preshowerE_(nullptr),
      hist_EE_CorSC_preshowerE_(nullptr), hist_EE_CorSC_phiWidth_(nullptr),
      hist_EB_CorSC_phiWidth_(nullptr), hist_EE_CorSC_etaWidth_(nullptr),
      hist_EB_CorSC_etaWidth_(nullptr), hist_EB_CorSC_ET_vs_Eta_(nullptr),
      hist_EB_CorSC_ET_vs_Phi_(nullptr), hist_EE_CorSC_ET_vs_Eta_(nullptr),
      hist_EE_CorSC_ET_vs_Phi_(nullptr), hist_EE_CorSC_ET_vs_R_(nullptr) {}
...
void EgammaSuperClusters::bookHistograms(DQMStore::IBooker &_ibooker,
  ...
  hist_EE_RawSC_Size_ =
      _ibooker.book1D("hist_EE_RawSC_Size_", "# Raw SuperClusters in Endcap",
                      hsSize_.bins, hsSize_.min, hsSize_.max);
  hist_EB_CorSC_Size_ = _ibooker.book1D("hist_EB_CorSC_Size_",
                                        "# Corrected SuperClusters in Barrel",
                                        hsSize_.bins, hsSize_.min, hsSize_.max);
  hist_EE_CorSC_Size_ = _ibooker.book1D("hist_EE_CorSC_Size_",
                                        "# Corrected SuperClusters in Endcap",
                                        hsSize_.bins, hsSize_.min, hsSize_.max);
  hist_EE_PreSC_Size_ = _ibooker.book1D(
      "hist_EE_PreSC_Size_", "# SuperClusters with Preshower in Endcap",
      hsSize_.bins, hsSize_.min, hsSize_.max);

  // Number of BasicClusters in SuperCluster
  //
  hist_EB_RawSC_NumBC_ =
      _ibooker.book1D("hist_EB_RawSC_NumBC_",
                      "# of Basic Clusters in Raw Super Clusters in Barrel",
                      hsNumBC_.bins, hsNumBC_.min, hsNumBC_.max);
  hist_EE_RawSC_NumBC_ =
      _ibooker.book1D("hist_EE_RawSC_NumBC_",
                      "# of Basic Clusters in Raw Super Clusters in Endcap",
                      hsNumBC_.bins, hsNumBC_.min, hsNumBC_.max);
  hist_EB_CorSC_NumBC_ = _ibooker.book1D(
      "hist_EB_CorSC_NumBC_",
      "# of Basic Clusters in Corrected SuperClusters in Barrel", hsNumBC_.bins,
      hsNumBC_.min, hsNumBC_.max);
  hist_EE_CorSC_NumBC_ = _ibooker.book1D(
      "hist_EE_CorSC_NumBC_",
      "# of Basic Clusters in Corrected SuperClusters in Endcap", hsNumBC_.bins,
      hsNumBC_.min, hsNumBC_.max);
  hist_EE_PreSC_NumBC_ = _ibooker.book1D(
  ...
  hist_EE_RawSC_ET_ =
      _ibooker.book1D("hist_EE_RawSC_ET_", "ET of Raw SuperClusters in Endcap",
                      hsET_.bins, hsET_.min, hsET_.max);
  hist_EB_CorSC_ET_ = _ibooker.book1D("hist_EB_CorSC_ET_",
                                      "ET of Corrected SuperClusters in Barrel",
                                      hsET_.bins, hsET_.min, hsET_.max);
  hist_EE_CorSC_ET_ = _ibooker.book1D("hist_EE_CorSC_ET_",
                                      "ET of Corrected SuperClusters in Endcap",
                                      hsET_.bins, hsET_.min, hsET_.max);
  hist_EE_PreSC_ET_ = _ibooker.book1D(
      "hist_EE_PreSC_ET_", "ET of SuperClusters with Preshower in Endcap",
      hsET_.bins, hsET_.min, hsET_.max);

  // Eta distribution of SuperClusters
  //
  hist_EB_RawSC_Eta_ = _ibooker.book1D("hist_EB_RawSC_Eta_",
                                       "Eta of Raw SuperClusters in Barrel",
                                       hsEta_.bins, hsEta_.min, hsEta_.max);
  hist_EE_RawSC_Eta_ = _ibooker.book1D("hist_EE_RawSC_Eta_",
                                       "Eta of Raw SuperClusters in Endcap",
                                       hsEta_.bins, hsEta_.min, hsEta_.max);
  hist_EB_CorSC_Eta_ = _ibooker.book1D(
      "hist_EB_CorSC_Eta_", "Eta of Corrected SuperClusters in Barrel",
      hsEta_.bins, hsEta_.min, hsEta_.max);
  hist_EE_CorSC_Eta_ = _ibooker.book1D(
      "hist_EE_CorSC_Eta_", "Eta of Corrected SuperClusters in Endcap",
      hsEta_.bins, hsEta_.min, hsEta_.max);
  hist_EE_PreSC_Eta_ = _ibooker.book1D(
      "hist_EE_PreSC_Eta_", "Eta of SuperClusters with Preshower in Endcap",
      hsEta_.bins, hsEta_.min, hsEta_.max);

  // Phi distribution of SuperClusters
  //
  hist_EB_RawSC_Phi_ = _ibooker.book1D("hist_EB_RawSC_Phi_",
                                       "Phi of Raw SuperClusters in Barrel",
                                       hsPhi_.bins, hsPhi_.min, hsPhi_.max);
  hist_EE_RawSC_Phi_ = _ibooker.book1D("hist_EE_RawSC_Phi_",
                                       "Phi of Raw SuperClusters in Endcap",
                                       hsPhi_.bins, hsPhi_.min, hsPhi_.max);
  hist_EB_CorSC_Phi_ = _ibooker.book1D(
      "hist_EB_CorSC_Phi_", "Phi of Corrected SuperClusters in Barrel",
      hsPhi_.bins, hsPhi_.min, hsPhi_.max);
  hist_EE_CorSC_Phi_ = _ibooker.book1D(
      "hist_EE_CorSC_Phi_", "Phi of Corrected SuperClusters in Endcap",
      hsPhi_.bins, hsPhi_.min, hsPhi_.max);
  hist_EE_PreSC_Phi_ = _ibooker.book1D(
      "hist_EE_PreSC_Phi_", "Phi of SuperClusters with Preshower in Endcap",
      hsPhi_.bins, hsPhi_.min, hsPhi_.max);

  // S1/S9 distribution of SuperClusters
  //
  hist_EB_RawSC_S1toS9_ = _ibooker.book1D(
      "hist_EB_RawSC_S1toS9_", "S1/S9 of Raw Super Clusters in Barrel",
      hsS1toS9_.bins, hsS1toS9_.min, hsS1toS9_.max);
  hist_EE_RawSC_S1toS9_ = _ibooker.book1D(
      "hist_EE_RawSC_S1toS9_", "S1/S9 of Raw Super Clusters in Endcap",
      hsS1toS9_.bins, hsS1toS9_.min, hsS1toS9_.max);
  hist_EB_CorSC_S1toS9_ = _ibooker.book1D(
      "hist_EB_CorSC_S1toS9_", "S1/S9 of Corrected SuperClusters in Barrel",
      hsS1toS9_.bins, hsS1toS9_.min, hsS1toS9_.max);
  hist_EE_CorSC_S1toS9_ = _ibooker.book1D(
      "hist_EE_CorSC_S1toS9_", "S1/S9 of Corrected SuperClusters in Endcap",
      hsS1toS9_.bins, hsS1toS9_.min, hsS1toS9_.max);
  hist_EE_PreSC_S1toS9_ =
      _ibooker.book1D("hist_EE_PreSC_S1toS9_",
  ...
  hist_EB_RawSC_S25toE_ = _ibooker.book1D(
      "hist_EB_RawSC_S25toE_", "S25/E of Raw Super Clusters in Barrel",
      hsS25toE_.bins, hsS25toE_.min, hsS25toE_.max);
  hist_EE_RawSC_S25toE_ = _ibooker.book1D(
      "hist_EE_RawSC_S25toE_", "S25/E of Raw Super Clusters in Endcap",
      hsS25toE_.bins, hsS25toE_.min, hsS25toE_.max);
  hist_EB_CorSC_S25toE_ = _ibooker.book1D(
      "hist_EB_CorSC_S25toE_", "S25/E of Corrected SuperClusters in Barrel",
      hsS25toE_.bins, hsS25toE_.min, hsS25toE_.max);
  hist_EE_CorSC_S25toE_ = _ibooker.book1D(
      "hist_EE_CorSC_S25toE_", "S25/E of Corrected SuperClusters in Endcap",
      hsS25toE_.bins, hsS25toE_.min, hsS25toE_.max);
  hist_EE_PreSC_S25toE_ =
      _ibooker.book1D("hist_EE_PreSC_S25toE_",
                      "S25/E of SuperClusters with Preshower in Endcap",
                      hsS25toE_.bins, hsS25toE_.min, hsS25toE_.max);

  // E/E(true) distribution of SuperClusters
  //
  hist_EB_RawSC_EoverTruth_ = _ibooker.book1D(
      "hist_EB_RawSC_EoverTruth_", "E/True E of Raw SuperClusters in Barrel",
      hsEoverTruth_.bins, hsEoverTruth_.min, hsEoverTruth_.max);
  hist_EE_RawSC_EoverTruth_ = _ibooker.book1D(
      "hist_EE_RawSC_EoverTruth_", "E/True E of Raw SuperClusters in Endcap",
      hsEoverTruth_.bins, hsEoverTruth_.min, hsEoverTruth_.max);
  ...
  hist_EE_CorSC_EoverTruth_ =
      _ibooker.book1D("hist_EE_CorSC_EoverTruth_",
                      "E/True E of Corrected SuperClusters in Endcap",
                      hsEoverTruth_.bins, hsEoverTruth_.min, hsEoverTruth_.max);
  hist_EE_PreSC_EoverTruth_ =
      _ibooker.book1D("hist_EE_PreSC_EoverTruth_",
                      "E/True E of SuperClusters with Preshower in Endcap",
                      hsEoverTruth_.bins, hsEoverTruth_.min, hsEoverTruth_.max);

  // dR distribution of SuperClusters from truth
  //
  hist_EB_RawSC_deltaR_ = _ibooker.book1D(
      "hist_EB_RawSC_deltaR_", "dR to MC truth of Raw Super Clusters in Barrel",
      hsdeltaR_.bins, hsdeltaR_.min, hsdeltaR_.max);
  hist_EE_RawSC_deltaR_ = _ibooker.book1D(
      "hist_EE_RawSC_deltaR_", "dR to MC truth of Raw Super Clusters in Endcap",
      hsdeltaR_.bins, hsdeltaR_.min, hsdeltaR_.max);
  hist_EB_CorSC_deltaR_ =
      _ibooker.book1D("hist_EB_CorSC_deltaR_",
                      "dR to MC truth of Corrected SuperClusters in Barrel",
                      hsdeltaR_.bins, hsdeltaR_.min, hsdeltaR_.max);
  hist_EE_CorSC_deltaR_ =
      _ibooker.book1D("hist_EE_CorSC_deltaR_",
                      "dR to MC truth of Corrected SuperClusters in Endcap",
                      hsdeltaR_.bins, hsdeltaR_.min, hsdeltaR_.max);
  hist_EE_PreSC_deltaR_ = _ibooker.book1D(
  ...
  hist_EE_CorSC_preshowerE_ = _ibooker.book1D(
      "hist_EE_CorSC_preshowerE_",
      "preshower energy in Corrected Super Clusters with Preshower in Endcap",
      hspreshowerE_.bins, hspreshowerE_.min, hspreshowerE_.max);

  //
  hist_EB_CorSC_ET_vs_Eta_ = _ibooker.book2D(
      "hist_EB_CorSC_ET_vs_Eta_", "Corr Super Cluster ET versus Eta in Barrel",
      hsET_.bins, hsET_.min, hsET_.max, hsEta_.bins, hsEta_.min, hsEta_.max);

  hist_EB_CorSC_ET_vs_Phi_ = _ibooker.book2D(
      "hist_EB_CorSC_ET_vs_Phi_", "Corr Super Cluster ET versus Phi in Barrel",
      hsET_.bins, hsET_.min, hsET_.max, hsPhi_.bins, hsPhi_.min, hsPhi_.max);

  hist_EE_CorSC_ET_vs_Eta_ = _ibooker.book2D(
      "hist_EE_CorSC_ET_vs_Eta_", "Corr Super Cluster ET versus Eta in Endcap",
      hsET_.bins, hsET_.min, hsET_.max, hsEta_.bins, hsEta_.min, hsEta_.max);

  hist_EE_CorSC_ET_vs_Phi_ = _ibooker.book2D(
      "hist_EE_CorSC_ET_vs_Phi_", "Corr Super Cluster ET versus Phi in Endcap",
      hsET_.bins, hsET_.min, hsET_.max, hsPhi_.bins, hsPhi_.min, hsPhi_.max);

  hist_EE_CorSC_ET_vs_R_ = _ibooker.book2D(
      "hist_EE_CorSC_ET_vs_R_", "Corr Super Cluster ET versus Radius in Endcap",
      hsET_.bins, hsET_.min, hsET_.max, hsR_.bins, hsR_.min, hsR_.max);
}
...
void EgammaSuperClusters::analyze(const edm::Event &evt,
  ...
  evt.getByToken(barrelRawSuperClusterCollectionToken_,
                 pBarrelRawSuperClusters);
  if (!pBarrelRawSuperClusters.isValid()) {
    edm::LogError("EgammaSuperClusters")
        << "Error! can't get collection Raw SC";
    skipBarrel = true;
  }

  edm::Handle<reco::SuperClusterCollection> pBarrelCorSuperClusters;
  evt.getByToken(barrelCorSuperClusterCollectionToken_,
                 pBarrelCorSuperClusters);
  ...
  EcalClusterLazyTools lazyTool(evt, es, barrelRecHitCollectionToken_,
                                endcapRecHitCollectionToken_);

  // Get the BARREL collections
  const reco::SuperClusterCollection *barrelRawSuperClusters =
      pBarrelRawSuperClusters.product();
  const reco::SuperClusterCollection *barrelCorSuperClusters =
      pBarrelCorSuperClusters.product();
  ...
  for (reco::SuperClusterCollection::const_iterator aClus =
           barrelRawSuperClusters->begin();
       aClus != barrelRawSuperClusters->end(); aClus++) {
    // kinematics
    hist_EB_RawSC_NumBC_->Fill(aClus->clustersSize());
    hist_EB_RawSC_ET_->Fill(aClus->energy() /
                            std::cosh(aClus->position().eta()));
  ...
  for (reco::SuperClusterCollection::const_iterator aClus =
           barrelCorSuperClusters->begin();
       aClus != barrelCorSuperClusters->end(); aClus++) {
    // kinematics
    hist_EB_CorSC_NumBC_->Fill(aClus->clustersSize());
    hist_EB_CorSC_ET_->Fill(aClus->energy() /
                            std::cosh(aClus->position().eta()));
    hist_EB_CorSC_Eta_->Fill(aClus->position().eta());
    hist_EB_CorSC_Phi_->Fill(aClus->position().phi());

    hist_EB_CorSC_ET_vs_Eta_->Fill(
        aClus->energy() / std::cosh(aClus->position().eta()), aClus->eta());
    hist_EB_CorSC_ET_vs_Phi_->Fill(
        aClus->energy() / std::cosh(aClus->position().eta()), aClus->phi());
  ...
  evt.getByToken(endcapRawSuperClusterCollectionToken_,
                 pEndcapRawSuperClusters);
  ...
  evt.getByToken(endcapPreSuperClusterCollectionToken_,
  ...
  evt.getByToken(endcapCorSuperClusterCollectionToken_,
                 pEndcapCorSuperClusters);
  ...
  const reco::SuperClusterCollection *endcapRawSuperClusters =
      pEndcapRawSuperClusters.product();
  const reco::SuperClusterCollection *endcapPreSuperClusters =
      pEndcapPreSuperClusters.product();
  const reco::SuperClusterCollection *endcapCorSuperClusters =
      pEndcapCorSuperClusters.product();
  ...
  for (reco::SuperClusterCollection::const_iterator aClus =
    ...
    hist_EE_CorSC_ET_vs_Eta_->Fill(
        aClus->energy() / std::cosh(aClus->position().eta()), aClus->eta());
    hist_EE_CorSC_ET_vs_Phi_->Fill(
        aClus->energy() / std::cosh(aClus->position().eta()), aClus->phi());
...
void EgammaSuperClusters::closestMCParticle(const HepMC::GenEvent *genEvent,
  ...
  for (HepMC::GenEvent::particle_const_iterator currentParticle =
    ...
    if ((*currentParticle)->status() == 1) {
      ...
      HepMC::FourVector vtx =
          (*currentParticle)->production_vertex()->position();
      double phiTrue = (*currentParticle)->momentum().phi();
      double etaTrue = ecalEta((*currentParticle)->momentum().eta(),
                               vtx.z() / 10., vtx.perp() / 10.);
