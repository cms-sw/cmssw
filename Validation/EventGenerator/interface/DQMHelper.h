...
class DQMHelper{
 public: 
  ...
  MonitorElement* book1dHisto(std::string name,std::string title,int n,double xmin,double xmax,const std::string& xaxis, const std::string& yaxis);
  MonitorElement* book2dHisto(std::string name,std::string title,int nx,double xmin,double xmax,int ny,double ymin,double ymax,const std::string& xaxis, const std::string& yaxis);
