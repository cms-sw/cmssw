...
void BasicGenParticleValidation::bookHistograms(DQMStore::IBooker &i, edm::Run const &, edm::EventSetup const &){
  ...
  genJetCentral = dqm.book1dHisto("genJetCentral", "GenJet multiplicity |eta|.lt.2.5", 50, 0, 50,"N_{gen-jets |#eta|#lt2.5}","Number of events");
  
  genJetTotPt = dqm.book1dHisto("genJetTotPt", "Log10(GenJet total pt)", 100, -5, 5,"log_{10}(#SumP_{t}^{gen-jets}) (log_{10}(GeV))","Number of events");
