...
genvalid_all_genWgt = cms.Sequence(genvalid_all+genvalid_genWgt)
genvalid_all_lheWgt = cms.Sequence(genvalid_all+genvalid_lheWgt)
genvalid_all_allWgt = cms.Sequence(genvalid_all+genvalid_allWeight)
