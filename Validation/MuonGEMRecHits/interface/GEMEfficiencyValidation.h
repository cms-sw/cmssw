#ifndef GEMEfficiencyValidation_H
#define GEMEfficiencyValidation_H
...
class GEMEfficiencyValidation : public GEMBaseValidation
{
public:
  explicit GEMEfficiencyValidation( const edm::ParameterSet& );
  ~GEMEfficiencyValidation() override;
