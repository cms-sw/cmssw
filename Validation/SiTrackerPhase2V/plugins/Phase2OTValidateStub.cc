 ...
 * performance of stub reconstruction by comparing them with tracking particles. 
 * It generates histograms to assess stub efficiency and residual performance.
 * 
 * Usage:
