...
void Phase2OTHarvestTracks::dqmEndJob(DQMStore::IBooker &ibooker, DQMStore::IGetter &igetter) {
  ...
  MonitorElement *meN_displaced_pt_zoom =
      igetter.get(topFolderName_ + "/Extended_L1TF/Displaced/EfficiencyIngredients/match_displaced_tp_pt_zoom");
  ...
  if (std::find(prompt_respt_pt2to3.begin(), prompt_respt_pt2to3.end(), nullptr) == prompt_respt_pt2to3.end()) {
    ...
    edm::LogWarning("DataNotFound") << "Monitor elements for extended prompt pT resolution (2-3) cannot be found!\n";
  }
  ...
  if (std::find(displaced_respt_pt2to3.begin(), displaced_respt_pt2to3.end(), nullptr) ==
    ...
    edm::LogWarning("DataNotFound") << "Monitor elements for extended displaced pT resolution (2-3) cannot be found!\n";
  }
  ...
  if (std::find(prompt_respt_pt3to8.begin(), prompt_respt_pt3to8.end(), nullptr) == prompt_respt_pt3to8.end()) {
    ...
    edm::LogWarning("DataNotFound") << "Monitor elements for pT resolution (3-8) (prompt) cannot be found!\n";
  }
  ...
  if (std::find(displaced_respt_pt3to8.begin(), displaced_respt_pt3to8.end(), nullptr) ==
    ...
    edm::LogWarning("DataNotFound") << "Monitor elements for pT resolution (3-8) (displaced) cannot be found!\n";
  }
  ...
  if (std::find(prompt_respt_pt8toInf.begin(), prompt_respt_pt8toInf.end(), nullptr) == prompt_respt_pt8toInf.end()) {
    ...
    edm::LogWarning("DataNotFound") << "Monitor elements for pT resolution (8-inf) (prompt) cannot be found!\n";
  }
  ...
  if (std::find(displaced_respt_pt8toInf.begin(), displaced_respt_pt8toInf.end(), nullptr) ==
    ...
    edm::LogWarning("DataNotFound") << "Monitor elements for pT resolution (8-inf) (displaced) cannot be found!\n";
  }
