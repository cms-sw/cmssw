...
if (options.geometry == "D88"):
    ...
    inFile = 'file:step1D88.root'
    outFile = 'file:step2D88.root'
elif (options.geometry == "D93"):
    from Configuration.Eras.Era_Phase2C11I13M9_cff import Phase2C11I13M9
    process = cms.Process('SingleMuonDigi',Phase2C11I13M9)
    process.load('Configuration.Geometry.GeometryExtended2026D93Reco_cff')
    globalTag = "auto:phase2_realistic_T21"
    inFile = 'file:step1D93.root'
    outFile = 'file:step2D93.root'
else:
    from Configuration.Eras.Era_Phase2C11I13M9_cff import Phase2C11I13M9
    process = cms.Process('SingleMuonDigi',Phase2C11I13M9)
    process.load('Configuration.Geometry.GeometryExtended2026D92Reco_cff')
    globalTag = "auto:phase2_realistic_T21"
    inFile = 'file:step1D92.root'
    outFile = 'file:step2D92.root'
