...
HGCalCellHitSum::HGCalCellHitSum(const edm::ParameterSet& iConfig)
  ...
  for (int i=1; i <= 50; i++) {
    hELCSMaxF.emplace_back(fs->make<TH1D>(Form("hELCSMaxF_layer_%02d", i), Form("Energy for layer %d", i), 500, 0., 500.));
    hELCSMaxCN.emplace_back(fs->make<TH1D>(Form("hELCSMaxCN_layer_%02d", i), Form("Energy for layer %d", i), 500, 0., 500.));
    hELCSMaxCK.emplace_back(fs->make<TH1D>(Form("hELCSMaxCK_layer_%02d", i), Form("Energy for layer %d", i), 500, 0., 500.));
  }
  for (int i=1; i <= 50; i++) {
    hHxELCSMaxF.emplace_back(fs->make<TH1D>(Form("hHxELCSMaxF_layer_%02d",i),Form("Energy for layer %d",i), 500, 0., 500.));
    hHxELCSMaxCN.emplace_back(fs->make<TH1D>(Form("hHxELCSMaxCN_layer_%02d",i),Form("Energy for layer %d",i), 500, 0., 500.));
    hHxELCSMaxCK.emplace_back(fs->make<TH1D>(Form("hHxELCSMaxCK_layer_%02d",i),Form("Energy for layer %d",i), 500, 0., 500.));
    hNHxELCSMaxF.emplace_back(fs->make<TH1D>(Form("hNHxELCSMaxF_layer_%02d",i),Form("Energy for layer %d",i), 500, 0., 500.));
    hNHxELCSMaxCN.emplace_back(fs->make<TH1D>(Form("hNHxELCSMaxCN_layer_%02d",i),Form("Energy for layer %d",i), 500, 0., 500.));
    hNHxELCSMaxCK.emplace_back(fs->make<TH1D>(Form("hNHxELCSMaxCK_layer_%02d", i), Form("Energy for layer %d", i), 500, 0., 500.));
    hELossDQMEqV.emplace_back(fs->make<TH1D>(Form("hELossDQMEqV_layer_%02d", i), Form("hELossDQMEqV_layer_%02d", i), 100, 0, 0.1));
    hELossLayer.emplace_back(fs->make<TH1D>(Form("hELossLayer_%02d", i), Form("hELossLayer_%02d", i), 1000, 0., 1000.));
  }
  for (int i=1; i <= 50; i++) {
    hXYhits.emplace_back(fs->make<TH2D>(Form("hXYhits_layer_%02d", i), Form("Hits in XY for layer %d", i), 600, -300., 300., 600, -300., 300.));
    hXYhitsF.emplace_back(fs->make<TH2D>(Form("hXYhitsF_layer_%02d", i), Form("HitsF in XY for layer %d", i), 600, -300., 300., 600, -300., 300.));
    hXYhitsCN.emplace_back(fs->make<TH2D>(Form("hXYhitsCN_layer_%02d", i), Form("HitsCN in XY for layer %d", i), 600, -300., 300., 600, -300., 300.));
    hXYhitsCK.emplace_back(fs->make<TH2D>(Form("hXYhitsCK_layer_%02d", i), Form("HitsCK in XY for layer %d", i), 600, -300., 300., 600, -300., 300.));
    hXYhitsB.emplace_back(fs->make<TH2D>(Form("hXYhitsB_layer_%02d", i), Form("HitsB in XY for layer %d", i), 600, -300., 300., 600, -300., 300.));
    hXYhitsLELCN.emplace_back(fs->make<TH2D>(Form("hXYhitsLELCN_layer_%02d", i), Form("LELCN in XY for layer %d", i), 600, -300., 300., 600, -300., 300.));
    hXYhitsHELCN.emplace_back(fs->make<TH2D>(Form("hXYhitsHELCN_layer_%02d", i), Form("HELCN in XY for layer %d", i), 600, -300., 300., 600, -300., 300.));
    hXYhitsLELCK.emplace_back(fs->make<TH2D>(Form("hXYhitsLELCK_layer_%02d", i), Form("LELCK in XY for layer %d", i), 600, -300., 300., 600, -300., 300.));
    hXYhitsHELCK.emplace_back(fs->make<TH2D>(Form("hXYhitsHELCK_layer_%02d", i), Form("HELCK in XY for layer %d", i), 600, -300., 300., 600, -300., 300.));
  }
  for (int i=1; i <= 50; i++) {
  ...
  for (int i = 1; i <= 50; i++) {
    hNHxXYhitsF.emplace_back(fs->make<TH2D>(Form("hNHxXYhitsF_layer_%02d", i), Form("NHx HitsF in XY for layer %d", i), 600, -300., 300., 600, -300., 300.));
    hNHxXYhitsCN.emplace_back(fs->make<TH2D>(Form("hNHxXYhitsCN_layer_%02d", i), Form("NHx HitsCN in XY for layer %d", i), 600, -300., 300., 600, -300., 300.));
    hNHxXYhitsCK.emplace_back(fs->make<TH2D>(Form("hNHxXYhitsCK_layer_%02d",i),Form("NHx HitsCK in XY for layer %d",i), 600, -300., 300., 600, -300., 300.));
  }
