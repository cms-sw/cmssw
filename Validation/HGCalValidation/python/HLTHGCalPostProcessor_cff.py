...
hltLcToCP_linking = _hltHgcalValidator.label_LCToCPLinking
hltPostProcessorHGCALlayerclusters = _postProcessorHGCALlayerclusters.clone(
    subDirs = cms.untracked.vstring(hltPrefix + _hltHgcalValidator.label_layerClustersPlots + '/' + hltLcToCP_linking),
)

hltSubdirsSim = [hltPrefix + _hltHgcalValidator.label_SimClusters + '/'+iteration+'/' for iteration in hltTracksterLabels]
