...
void PrimaryVertexAnalyzer4PUSlimmed::bookHistograms(DQMStore::IBooker& i,
  ...
  if (do_generic_sim_plots_) {
    mes_["root_folder"]["GenVtx_vs_BX"] = i.book2D("GenVtx_vs_BX", "GenVtx_vs_BX", 16, -12.5, 3.5, nPUbins_, 0., double(nPUbins_));
  ...
  for (auto const& l : reco_vertex_collections_) {
    ...
    mes_[label]["RecoVtx_vs_GenVtx"] =
      i.bookProfile("RecoVtx_vs_GenVtx", "RecoVtx_vs_GenVtx", nPUbins_, 0., double(nPUbins_), nPUbins_, 0., double(nPUbins_));
    mes_[label]["MatchedRecoVtx_vs_GenVtx"] =
      i.bookProfile("MatchedRecoVtx_vs_GenVtx", "MatchedRecoVtx_vs_GenVtx", int(nPUbins_/2), 0., double(nPUbins_), nPUbins_, 0., double(nPUbins_));
    ...
    mes_[label]["MisTagRate_vs_PU"] = i.bookProfile("MisTagRate_vs_PU", "MisTagRate_vs_PU", int(nPUbins_/2), 0., double(nPUbins_), 2, 0., 1.);
    ...
    mes_[label]["MisTagRate_vs_NumTracks"] =
      i.bookProfile("MisTagRate_vs_NumTracks", "MisTagRate_vs_NumTracks", int(nPUbins_/2), 0., double(nPUbins_), 2, 0., 1.);
    ...
    mes_[label]["MisTagRateSignalIsHighest_vs_PU"] =
      i.bookProfile("MisTagRateSignalIsHighest_vs_PU", "MisTagRateSignalIsHighest_vs_PU", nPUbins_, 0., double(nPUbins_), 2, 0., 1.);
    ...
    mes_[label]["MisTagRateSignalIsHighest_vs_NumTracks"] = i.bookProfile(
         "MisTagRateSignalIsHighest_vs_NumTracks", "MisTagRateSignalIsHighest_vs_NumTracks", int(nPUbins_/2), 0., double(nPUbins_), 2, 0., 1.);
    ...
    mes_[label]["MisTagRateSignalIsNotHighest_vs_PU"] = i.bookProfile(								      								      
         "MisTagRateSignalIsNotHighest_vs_PU", "MisTagRateSignalIsNotHighest_vs_PU", int(nPUbins_/2), 0., double(nPUbins_), 2, 0., 1.);
    ...
    mes_[label]["GenAllAssoc2Reco_NumVertices"] =
        i.book1D("GenAllAssoc2Reco_NumVertices", "GeneratedAllAssoc2Reco_NumVertices", int(nPUbins_/2), 0., double(nPUbins_));
    ...
    mes_[label]["GenAllAssoc2RecoMatched_NumVertices"] =
        i.book1D("GenAllAssoc2RecoMatched_NumVertices", "GeneratedAllAssoc2RecoMatched_NumVertices", int(nPUbins_/2), 0., double(nPUbins_));
    ...
    mes_[label]["GenAllAssoc2RecoMultiMatched_NumVertices"] = i.book1D(								       
        "GenAllAssoc2RecoMultiMatched_NumVertices", "GeneratedAllAssoc2RecoMultiMatched_NumVertices", int(nPUbins_/2), 0., double(nPUbins_));
    ...
    mes_[label]["RecoAllAssoc2Gen_NumVertices"] =
        i.book1D("RecoAllAssoc2Gen_NumVertices", "ReconstructedAllAssoc2Gen_NumVertices", int(nPUbins_/2), 0., double(nPUbins_));
    ...
    mes_[label]["RecoAllAssoc2Gen_PU"] = i.book1D("RecoAllAssoc2Gen_PU", "ReconstructedAllAssoc2Gen_PU", int(nPUbins_/2), 0., double(nPUbins_));
    ...
    mes_[label]["RecoAllAssoc2GenMatched_NumVertices"] =
        i.book1D("RecoAllAssoc2GenMatched_NumVertices", "ReconstructedAllAssoc2GenMatched_NumVertices", int(nPUbins_/2), 0., double(nPUbins_));
    ...
    mes_[label]["RecoAllAssoc2GenMatched_PU"] =
        i.book1D("RecoAllAssoc2GenMatched_PU", "ReconstructedAllAssoc2GenMatched_PU", int(nPUbins_/2), 0., double(nPUbins_));
    ...
    mes_[label]["RecoAllAssoc2GenMultiMatched_NumVertices"] = i.book1D(								       
        "RecoAllAssoc2GenMultiMatched_NumVertices", "ReconstructedAllAssoc2GenMultiMatched_NumVertices", int(nPUbins_/2), 0., double(nPUbins_));
    ...
    mes_[label]["RecoAllAssoc2GenMultiMatched_PU"] =
        i.book1D("RecoAllAssoc2GenMultiMatched_PU", "ReconstructedAllAssoc2GenMultiMatched_PU", int(nPUbins_/2), 0., double(nPUbins_));
    ...
    mes_[label]["RecoAllAssoc2MultiMatchedGen_NumVertices"] =
        i.book1D("RecoAllAssoc2MultiMatchedGen_NumVertices", "RecoAllAssoc2MultiMatchedGen_NumVertices", int(nPUbins_/2), 0., double(nPUbins_));
    ...
    mes_[label]["RecoAllAssoc2MultiMatchedGen_PU"] =
        i.book1D("RecoAllAssoc2MultiMatchedGen_PU", "RecoAllAssoc2MultiMatchedGen_PU", int(nPUbins_/2), 0., double(nPUbins_));
