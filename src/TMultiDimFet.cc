                                ...
                                Option_t *)
{
   ...
   outFile << "// " << endl
      << "// File " << filename
      << " generated by TMultiDimFet::MakeRealCode" << endl;
   // Time stamp
   TDatime date;
   ...
   outFile << "// This file contains the function " << endl
      ...
      << "// from TMultiDimFet and the point x" << endl
      << "// " << endl
   ...
   if (opt.Contains("m")) {
      ...
      for (Int_t i = 0; i < fNCoefficients; i++) {
         ...
         for (Int_t j = 0; j < fNVariables; j++) {
            ...
            switch (p) { 
               case 1: break;
               case 2: cout << " * y" << j; break;
               default:
                  switch(fPolyType) {
                     case kLegendre:  cout << " * L" << p-1 << "(y" << j << ")"; break;
                     case kChebyshev: cout << " * C" << p-1 << "(y" << j << ")"; break;
                     default:         cout << " * y" << j << "^" << p-1; break;
                  }
            }
      ...
      for (Int_t i = 0; i < fNCoefficients; i++) {
         ...
         for (Int_t j = 0; j < fNVariables; j++) {
            ...
            switch (p) {
               ...
               default:
                  switch(fPolyType) {
                     case kLegendre:  cout << "*Leg(" << p-1 << ",y" << j << ")"; break;
                     case kChebyshev: cout << "*C" << p-1 << "(y" << j << ")"; break;
                     default:         cout << "*y" << j << "**" << p-1; break;
                  }
            }
