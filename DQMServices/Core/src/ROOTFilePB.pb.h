...
namespace dqmstorepb {
  ...
  class ROOTFilePB_Histo : public ::PROTOBUF_NAMESPACE_ID::
...
#pragma GCC diagnostic ignored "-Wstrict-aliasing"
  ...
  inline void ROOTFilePB_Histo::set_full_pathname(std::string&& value) {
    _has_bits_[0] |= 0x00000001u;
    full_pathname_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  ...
  inline void ROOTFilePB_Histo::set_allocated_full_pathname(std::string* full_pathname) {
    ...
    full_pathname_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
                                       full_pathname);
  ...
  inline void ROOTFilePB_Histo::set_streamed_histo(std::string&& value) {
    _has_bits_[0] |= 0x00000002u;
    streamed_histo_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
