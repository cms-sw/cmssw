...
inline void ROOTFilePB_Histo::set_full_pathname(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  full_pathname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:dqmstorepb.ROOTFilePB.Histo.full_pathname)
}
inline void ROOTFilePB_Histo::set_full_pathname(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  full_pathname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* ROOTFilePB_Histo::release_full_pathname() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return full_pathname_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ROOTFilePB_Histo::set_allocated_full_pathname(std::string* full_pathname) {
  ...
  full_pathname_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), full_pathname,
      GetArena());
...
inline void ROOTFilePB_Histo::set_streamed_histo(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  streamed_histo_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:dqmstorepb.ROOTFilePB.Histo.streamed_histo)
}
inline void ROOTFilePB_Histo::set_streamed_histo(const void* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  streamed_histo_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* ROOTFilePB_Histo::release_streamed_histo() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return streamed_histo_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ROOTFilePB_Histo::set_allocated_streamed_histo(std::string* streamed_histo) {
  ...
  streamed_histo_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), streamed_histo,
      GetArena());
