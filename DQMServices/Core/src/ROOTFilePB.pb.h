...
#ifndef PROTOBUF_INCLUDED_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto
#define PROTOBUF_INCLUDED_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto
...
namespace dqmstorepb {
  ...
  class ROOTFilePB_Histo
      : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:dqmstorepb.ROOTFilePB.Histo) */ {
  public:
    ROOTFilePB_Histo();
    ...
    inline ROOTFilePB_Histo* New() const final { return CreateMaybeMessage<ROOTFilePB_Histo>(NULL); }

    ROOTFilePB_Histo* New(::google::protobuf::Arena* arena) const final {
  ...
  class ROOTFilePB
      : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:dqmstorepb.ROOTFilePB) */ {
  public:
    ROOTFilePB();
    virtual ~ROOTFilePB();
    ...
    inline ROOTFilePB* New() const final { return CreateMaybeMessage<ROOTFilePB>(NULL); }

    ROOTFilePB* New(::google::protobuf::Arena* arena) const final { return CreateMaybeMessage<ROOTFilePB>(arena); }
    void CopyFrom(const ::google::protobuf::Message& from) final;
    void MergeFrom(const ::google::protobuf::Message& from) final;
...
#pragma GCC diagnostic ignored "-Wstrict-aliasing"
  ...
  // required string full_pathname = 1;
  inline bool ROOTFilePB_Histo::has_full_pathname() const { return (_has_bits_[0] & 0x00000001u) != 0; }
  inline void ROOTFilePB_Histo::set_has_full_pathname() { _has_bits_[0] |= 0x00000001u; }
  inline void ROOTFilePB_Histo::clear_has_full_pathname() { _has_bits_[0] &= ~0x00000001u; }
  ...
  inline void ROOTFilePB_Histo::set_full_pathname(::std::string&& value) {
    set_has_full_pathname();
    full_pathname_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  ...
  inline ::std::string* ROOTFilePB_Histo::release_full_pathname() {
    ...
    clear_has_full_pathname();
    return full_pathname_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  }
  ...
  // required uint32 size = 2;
  inline bool ROOTFilePB_Histo::has_size() const { return (_has_bits_[0] & 0x00000004u) != 0; }
  inline void ROOTFilePB_Histo::set_has_size() { _has_bits_[0] |= 0x00000004u; }
  inline void ROOTFilePB_Histo::clear_has_size() { _has_bits_[0] &= ~0x00000004u; }
  ...
  // required bytes streamed_histo = 3;
  inline bool ROOTFilePB_Histo::has_streamed_histo() const { return (_has_bits_[0] & 0x00000002u) != 0; }
  inline void ROOTFilePB_Histo::set_has_streamed_histo() { _has_bits_[0] |= 0x00000002u; }
  inline void ROOTFilePB_Histo::clear_has_streamed_histo() { _has_bits_[0] &= ~0x00000002u; }
  ...
  inline void ROOTFilePB_Histo::set_streamed_histo(::std::string&& value) {
    set_has_streamed_histo();
    streamed_histo_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  ...
  inline ::std::string* ROOTFilePB_Histo::release_streamed_histo() {
    ...
    clear_has_streamed_histo();
    return streamed_histo_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  }
  ...
  // required uint32 flags = 4;
  inline bool ROOTFilePB_Histo::has_flags() const { return (_has_bits_[0] & 0x00000008u) != 0; }
  inline void ROOTFilePB_Histo::set_has_flags() { _has_bits_[0] |= 0x00000008u; }
  inline void ROOTFilePB_Histo::clear_has_flags() { _has_bits_[0] &= ~0x00000008u; }
  ...
  // repeated .dqmstorepb.ROOTFilePB.Histo histo = 1;
  inline int ROOTFilePB::histo_size() const { return histo_.size(); }
  ...
  inline ::google::protobuf::RepeatedPtrField<::dqmstorepb::ROOTFilePB_Histo>* ROOTFilePB::mutable_histo() {
...
#endif  // PROTOBUF_INCLUDED_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto
