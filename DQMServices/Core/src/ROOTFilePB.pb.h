...
#ifndef GOOGLE_PROTOBUF_INCLUDED_ROOTFilePB_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_ROOTFilePB_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_ROOTFilePB_2eproto
...
struct TableStruct_ROOTFilePB_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ROOTFilePB_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::dqmstorepb::ROOTFilePB* Arena::CreateMaybeMessage<::dqmstorepb::ROOTFilePB>(Arena*);
template<> ::dqmstorepb::ROOTFilePB_Histo* Arena::CreateMaybeMessage<::dqmstorepb::ROOTFilePB_Histo>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace dqmstorepb {
...
class ROOTFilePB_Histo :
 ...
 public:
  ...
  inline ROOTFilePB_Histo* New() const final {
    return CreateMaybeMessage<ROOTFilePB_Histo>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_ROOTFilePB_2eproto);
    return ::descriptor_table_ROOTFilePB_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_ROOTFilePB_2eproto;
};
// -------------------------------------------------------------------
...
class ROOTFilePB :
 ...
 public:
  ...
  inline ROOTFilePB* New() const final {
    return CreateMaybeMessage<ROOTFilePB>(nullptr);
  }
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::dqmstorepb::ROOTFilePB_Histo >*
      mutable_histo();
  const ::dqmstorepb::ROOTFilePB_Histo& histo(int index) const;
  ::dqmstorepb::ROOTFilePB_Histo* add_histo();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::dqmstorepb::ROOTFilePB_Histo >&
      histo() const;
...
inline void ROOTFilePB_Histo::clear_full_pathname() {
  full_pathname_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline void ROOTFilePB_Histo::set_full_pathname(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  full_pathname_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
...
inline void ROOTFilePB_Histo::set_full_pathname(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  full_pathname_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void ROOTFilePB_Histo::set_full_pathname(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  full_pathname_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* ROOTFilePB_Histo::mutable_full_pathname() {
  ...
  return full_pathname_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ROOTFilePB_Histo::release_full_pathname() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return full_pathname_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ROOTFilePB_Histo::set_allocated_full_pathname(std::string* full_pathname) {
  ...
  full_pathname_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), full_pathname);
...
inline void ROOTFilePB_Histo::clear_streamed_histo() {
  streamed_histo_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline void ROOTFilePB_Histo::set_streamed_histo(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  streamed_histo_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
...
inline void ROOTFilePB_Histo::set_streamed_histo(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  streamed_histo_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void ROOTFilePB_Histo::set_allocated_streamed_histo(std::string* streamed_histo) {
  ...
  streamed_histo_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), streamed_histo);
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::dqmstorepb::ROOTFilePB_Histo >*
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::dqmstorepb::ROOTFilePB_Histo >&
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_ROOTFilePB_2eproto
