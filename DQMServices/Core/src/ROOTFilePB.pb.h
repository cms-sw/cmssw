...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto;
...
class ROOTFilePB_Histo :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 ROOTFilePB_Histo::_internal_size() const {
  return size_;
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 ROOTFilePB_Histo::_internal_flags() const {
  return flags_;
}
...
inline ::dqmstorepb::ROOTFilePB_Histo* ROOTFilePB::_internal_add_histo() {
  return histo_.Add();
}
