...
#pragma GCC diagnostic ignored "-Wstrict-aliasing"
  ...
  inline const std::string& ROOTFilePB_Histo::_internal_full_pathname() const { return full_pathname_.GetNoArena(); }
  ...
  inline const std::string& ROOTFilePB_Histo::_internal_streamed_histo() const { return streamed_histo_.GetNoArena(); }
