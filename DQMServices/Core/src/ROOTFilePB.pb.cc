...
constexpr ROOTFilePB_Histo::ROOTFilePB_Histo(
...
constexpr ROOTFilePB::ROOTFilePB(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : histo_(){}
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto = {
  false, false, 196, descriptor_table_protodef_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto, "DQMServices/Core/src/ROOTFilePB.proto", 
  &descriptor_table_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto_once, nullptr, 0, 2,
  schemas, file_default_instances, TableStruct_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto::offsets,
  file_level_metadata_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto, file_level_enum_descriptors_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto, file_level_service_descriptors_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto,
};
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto(&descriptor_table_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto);
namespace dqmstorepb {
...
ROOTFilePB_Histo::ROOTFilePB_Histo(::PROTOBUF_NAMESPACE_ID::Arena* arena)
...
ROOTFilePB_Histo::ROOTFilePB_Histo(const ROOTFilePB_Histo& from)
  ...
  if (from._internal_has_full_pathname()) {
    full_pathname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_full_pathname(), 
      GetArena());
  }
  ...
  if (from._internal_has_streamed_histo()) {
    streamed_histo_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_streamed_histo(), 
      GetArena());
  }
...
void ROOTFilePB_Histo::InternalSwap(ROOTFilePB_Histo* other) {
  ...
  full_pathname_.Swap(&other->full_pathname_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  streamed_histo_.Swap(&other->streamed_histo_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ROOTFilePB_Histo, flags_)
