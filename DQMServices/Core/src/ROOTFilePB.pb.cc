...
extern PROTOBUF_INTERNAL_EXPORT_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ROOTFilePB_Histo_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto;
...
const char descriptor_table_protodef_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto_sccs[2] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto = {
  &descriptor_table_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto_initialized, descriptor_table_protodef_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto, "DQMServices/Core/src/ROOTFilePB.proto", 196,
  &descriptor_table_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto_once, descriptor_table_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto_sccs, descriptor_table_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto::offsets,
  file_level_metadata_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto, 2, file_level_enum_descriptors_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto, file_level_service_descriptors_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto), true);
namespace dqmstorepb {
...
ROOTFilePB_Histo::ROOTFilePB_Histo(const ROOTFilePB_Histo& from)
  ...
  if (from._internal_has_full_pathname()) {
    full_pathname_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.full_pathname_);
  }
  ...
  if (from._internal_has_streamed_histo()) {
    streamed_histo_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.streamed_histo_);
  }
...
void ROOTFilePB_Histo::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ROOTFilePB_Histo_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto.base);
  full_pathname_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  streamed_histo_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
::PROTOBUF_NAMESPACE_ID::uint8* ROOTFilePB_Histo::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      this->_internal_full_pathname().data(), static_cast<int>(this->_internal_full_pathname().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "dqmstorepb.ROOTFilePB.Histo.full_pathname");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_full_pathname(), target);
  }
  ...
  if (cached_has_bits & 0x00000002u) {
    target = stream->WriteBytesMaybeAliased(
        3, this->_internal_streamed_histo(), target);
  }
...
// @@protoc_insertion_point(generalized_merge_from_start:dqmstorepb.ROOTFilePB.Histo)
  ...
  const ROOTFilePB_Histo* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ROOTFilePB_Histo>(
          &from);
  if (source == nullptr) {
...
void ROOTFilePB_Histo::InternalSwap(ROOTFilePB_Histo* other) {
  ...
  full_pathname_.Swap(&other->full_pathname_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  streamed_histo_.Swap(&other->streamed_histo_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
::PROTOBUF_NAMESPACE_ID::uint8* ROOTFilePB::_InternalSerialize(
  ...
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_histo_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(1, this->_internal_histo(i), target, stream);
  }
...
// @@protoc_insertion_point(generalized_merge_from_start:dqmstorepb.ROOTFilePB)
  ...
  const ROOTFilePB* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ROOTFilePB>(
          &from);
  if (source == nullptr) {
...
bool ROOTFilePB::IsInitialized() const {
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(histo_)) return false;
  return true;
}
...
template<> PROTOBUF_NOINLINE ::dqmstorepb::ROOTFilePB_Histo* Arena::CreateMaybeMessage< ::dqmstorepb::ROOTFilePB_Histo >(Arena* arena) {
  return Arena::CreateInternal< ::dqmstorepb::ROOTFilePB_Histo >(arena);
}
template<> PROTOBUF_NOINLINE ::dqmstorepb::ROOTFilePB* Arena::CreateMaybeMessage< ::dqmstorepb::ROOTFilePB >(Arena* arena) {
