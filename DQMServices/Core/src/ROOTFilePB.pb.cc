...
extern PROTOBUF_INTERNAL_EXPORT_ROOTFilePB_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ROOTFilePB_Histo_ROOTFilePB_2eproto;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_ROOTFilePB_ROOTFilePB_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsscc_info_ROOTFilePB_ROOTFilePB_2eproto}, {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ROOTFilePB_Histo_ROOTFilePB_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_ROOTFilePB_Histo_ROOTFilePB_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_ROOTFilePB_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_ROOTFilePB_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_ROOTFilePB_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_ROOTFilePB_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ROOTFilePB_2eproto = {
  &descriptor_table_ROOTFilePB_2eproto_initialized, descriptor_table_protodef_ROOTFilePB_2eproto, "ROOTFilePB.proto", 175,
  &descriptor_table_ROOTFilePB_2eproto_once, descriptor_table_ROOTFilePB_2eproto_sccs, descriptor_table_ROOTFilePB_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_ROOTFilePB_2eproto::offsets,
  file_level_metadata_ROOTFilePB_2eproto, 2, file_level_enum_descriptors_ROOTFilePB_2eproto, file_level_service_descriptors_ROOTFilePB_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_ROOTFilePB_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_ROOTFilePB_2eproto), true);
namespace dqmstorepb {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_full_pathname(), ptr, ctx, "dqmstorepb.ROOTFilePB.Histo.full_pathname");
          CHK_(ptr);
...
bool ROOTFilePB::IsInitialized() const {
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(this->histo())) return false;
  return true;
}
