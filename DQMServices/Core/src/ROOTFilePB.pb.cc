...
namespace protobuf_DQMServices_2fCore_2fsrc_2fROOTFilePB_2eproto {
  ...
  void AddDescriptorsImpl() {
    ...
    ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(descriptor, 196);
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile("DQMServices/Core/src/ROOTFilePB.proto",
...
namespace dqmstorepb {
  ...
  ROOTFilePB_Histo::ROOTFilePB_Histo(const ROOTFilePB_Histo& from)
    ...
    if (from.has_full_pathname()) {
      full_pathname_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                                       from.full_pathname_);
    }
    streamed_histo_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    if (from.has_streamed_histo()) {
      streamed_histo_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
  ...
  bool ROOTFilePB_Histo::MergePartialFromCodedStream(::google::protobuf::io::CodedInputStream* input) {
        ...
        case 2: {
          if (static_cast< ::google::protobuf::uint8>(tag) ==
            ...
            DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(input, &size_)));
          } else {
            goto handle_unusual;
          }
          break;
...
#undef DO_
  ...
  void ROOTFilePB_Histo::SerializeWithCachedSizes(::google::protobuf::io::CodedOutputStream* output) const {
    ...
    if (cached_has_bits & 0x00000001u) {
      ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
          ...
          "dqmstorepb.ROOTFilePB.Histo.full_pathname");
      ::google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(1, this->full_pathname(), output);
    }
    ...
    // required bytes streamed_histo = 3;
    if (cached_has_bits & 0x00000002u) {
      ::google::protobuf::internal::WireFormatLite::WriteBytesMaybeAliased(3, this->streamed_histo(), output);
    }
  ...
  ::google::protobuf::uint8* ROOTFilePB_Histo::InternalSerializeWithCachedSizesToArray(
    ...
    if (cached_has_bits & 0x00000001u) {
      ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
          ...
          ::google::protobuf::internal::WireFormat::SERIALIZE,
          "dqmstorepb.ROOTFilePB.Histo.full_pathname");
      target = ::google::protobuf::internal::WireFormatLite::WriteStringToArray(1, this->full_pathname(), target);
    }
    ...
    // required bytes streamed_histo = 3;
    if (cached_has_bits & 0x00000002u) {
      target = ::google::protobuf::internal::WireFormatLite::WriteBytesToArray(3, this->streamed_histo(), target);
    }
  ...
  size_t ROOTFilePB_Histo::RequiredFieldsByteSizeFallback() const {
    ...
    if (has_full_pathname()) {
      // required string full_pathname = 1;
      total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(this->full_pathname());
    }

    if (has_streamed_histo()) {
      // required bytes streamed_histo = 3;
      total_size += 1 + ::google::protobuf::internal::WireFormatLite::BytesSize(this->streamed_histo());
    }
  ...
  bool ROOTFilePB::MergePartialFromCodedStream(::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION)                 \
  if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) \
  goto failure
    ::google::protobuf::uint32 tag;
...
#undef DO_
  ...
  void ROOTFilePB::SerializeWithCachedSizes(::google::protobuf::io::CodedOutputStream* output) const {
  ...
  size_t ROOTFilePB::ByteSizeLong() const {
    ...
    // repeated .dqmstorepb.ROOTFilePB.Histo histo = 1;
    {
      ...
      for (unsigned int i = 0; i < count; i++) {
        total_size += ::google::protobuf::internal::WireFormatLite::MessageSize(this->histo(static_cast<int>(i)));
      }
    }
  ...
  bool ROOTFilePB::IsInitialized() const {
    if (!::google::protobuf::internal::AllAreInitialized(this->histo()))
      return false;
    return true;
  }
