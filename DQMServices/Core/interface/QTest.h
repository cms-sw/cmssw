...
public:
  ...
  std::vector<DQMChannel> getBadChannels(void) const override
  { 
...
public:
  ...
  ~FixedFlatOccupancy1d(void) override
  {
    if( Nbins > 0 )
    {
      delete [] FailedBins[0];
