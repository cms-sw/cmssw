...
public:
  ConcurrentMonitorElement(void) : me_(nullptr) {}

  explicit ConcurrentMonitorElement(MonitorElement* me) : me_(me) {}
  ...
  void setTitle(std::string const& title) { me_->setTitle(title); }

  void setXTitle(std::string const& title) { me_->getTH1()->SetXTitle(title.c_str()); }

  void setXTitle(const char* title) { me_->getTH1()->SetXTitle(title); }

  void setYTitle(std::string const& title) { me_->getTH1()->SetYTitle(title.c_str()); }

  void setYTitle(const char* title) { me_->getTH1()->SetYTitle(title); }

  void setAxisRange(double xmin, double xmax, int axis = 1) { me_->setAxisRange(xmin, xmax, axis); }

  void setAxisTitle(std::string const& title, int axis = 1) { me_->setAxisTitle(title, axis); }

  void setAxisTimeDisplay(int value, int axis = 1) { me_->setAxisTimeDisplay(value, axis); }

  void setAxisTimeFormat(const char* format = "", int axis = 1) { me_->setAxisTimeFormat(format, axis); }

  void setBinLabel(int bin, std::string const& label, int axis = 1) { me_->setBinLabel(bin, label, axis); }

  void enableSumw2() { me_->getTH1()->Sumw2(); }
  ...
  void setOption(const char* option) { me_->getTH1()->SetOption(option); }
};
