...
//
DQMStoreExample::DQMStoreExample(const edm::ParameterSet& iConfig) : counter(0) {
  ...
  h2 = dbe->book2D("histo2", "Example 2D histogram.", NBINS, XMIN, XMAX, NBINS, XMIN, XMAX);
  assert(NBINS == h1->getNbinsX());

  h7 = dbe->bookProfile("histo7", "Example Profile histogram.", NBINS, XMIN, XMAX, NBINS, XMIN, XMAX);
  ...
  h4 = dbe->book2D("histo4", "Example 2D histogram.", NBINS, XMIN, XMAX, NBINS, XMIN, XMAX);
  ...
  h6 = dbe->book2D("histo6", "Example 2D histogram.", NBINS, XMIN, XMAX, NBINS, XMIN, XMAX);
  ...
  h64 = dbe->book2D("histo6", "Example 2D histogram.", NBINS, XMIN, XMAX, NBINS, XMIN, XMAX);
...
void DQMStoreExample::integrityChecks() {
  ...
  // contents of B1/B2
  contents.clear();
  contents.push_back(h3);
  contents.push_back(h4);
  dbe_ret = dbe->getContents("B1/B2");
  assert(dbe_ret == contents);
  // contents of C1/C2
  contents.clear();
  contents.push_back(f1);
  ...
  contents.clear();
  contents.push_back(h1);
  contents.push_back(h2);
  ...
  contents.clear();
  contents.push_back(h64);
  contents.push_back(h8);
