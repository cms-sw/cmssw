...
void JsonWritingTimeoutPoolOutputModule::reallyOpenFile() {
  sequence_++;
  ...
  resetFile(new edm::RootOutputFile(this, currentFileName_, currentFileName_));
}

void JsonWritingTimeoutPoolOutputModule::reallyCloseFile() {
  TimeoutPoolOutputModule::reallyCloseFile();
