...
[ 72 = $(dqmiolistmes.py alltypes.root -r 1 | wc -l) ]
[ 72 = $(dqmiolistmes.py alltypes.root -r 1 -l 1 | wc -l) ]
...
[ "0: 1, 0.0: 1, 1: 10, 100: 30, 200: 10, 5: 15, 5.0: 5" = "$($LOCAL_TEST_DIR/dqmiodumpentries.py alltypes.root -r 1 --summary)" ]
...
[ "1: 26, 1.0: 6, 20: 40" = "$($LOCAL_TEST_DIR/dqmiodumpentries.py alltypes.root -r 1 -l 1 --summary)" ]
[ "1: 20, 2: 6, 2.0: 6, 20: 40" = "$($LOCAL_TEST_DIR/dqmiodumpentries.py alltypes.root -r 1 -l 2 --summary)" ]
[ "1: 20, 20: 40, 3: 6, 3.0: 6" = "$($LOCAL_TEST_DIR/dqmiodumpentries.py alltypes.root -r 1 -l 3 --summary)" ]
[ "1: 20, 20: 40, 4: 6, 4.0: 6" = "$($LOCAL_TEST_DIR/dqmiodumpentries.py alltypes.root -r 1 -l 4 --summary)" ]
[ "1: 20, 20: 40, 5: 6, 5.0: 6" = "$($LOCAL_TEST_DIR/dqmiodumpentries.py alltypes.root -r 1 -l 5 --summary)" ]
...
do
  [ "0: 1, 0.0: 1, 1: 10, 1000: 20, 2000: 10, 5: 3, 5.0: 3" = "$($LOCAL_TEST_DIR/dqmiodumpentries.py $f -r 1 --summary)" ]
  [ "1: 2, 1.0: 2, 200: 20" = "$($LOCAL_TEST_DIR/dqmiodumpentries.py $f -r 1 -l 1 --summary)" ]
  [ "2: 2, 2.0: 2, 200: 20" = "$($LOCAL_TEST_DIR/dqmiodumpentries.py $f -r 1 -l 2 --summary)" ]
  [ "200: 20, 3: 2, 3.0: 2" = "$($LOCAL_TEST_DIR/dqmiodumpentries.py $f -r 1 -l 3 --summary)" ]
  [ "200: 20, 4: 2, 4.0: 2" = "$($LOCAL_TEST_DIR/dqmiodumpentries.py $f -r 1 -l 4 --summary)" ]
  [ "200: 20, 5: 2, 5.0: 2" = "$($LOCAL_TEST_DIR/dqmiodumpentries.py $f -r 1 -l 5 --summary)" ]
...
[ 173 = $(rootlist DQM_V0001_R000000001__Harvesting__DQMTests__DQMIO.root | wc -l) ]
...
[ 48 = $(rootlist DQM_V0001_R000000001__EmptySource__DQMTests__DQMIO.root | wc -l) ]
...
[ 108 = $(dqmiolistmes.py pbdata.root -r 1 | wc -l) ]
[ 72 = $(dqmiolistmes.py pbdata.root -r 1 -l 1 | wc -l) ]
...
[ 199 = $(rootlist streamDQMHistograms.root | wc -l) ]
...
[ 127 = $(rootlist DQM_V0001_UNKNOWN_R000000001.root | wc -l) ]
[ 127 = $(rootlist DQM_V0001_UNKNOWN_R000000002.root | wc -l) ]
[ 127 = $(rootlist DQM_V0001_UNKNOWN_R000000003.root | wc -l) ]
[ 127 = $(rootlist DQM_V0001_UNKNOWN_R000000004.root | wc -l) ]
...
[ 72 = $(dqmiolistmes.py noevents.root -r 1 | wc -l) ]
[ 72 = $(dqmiolistmes.py noevents.root -r 1 -l 1 | wc -l) ]
[ 72 = $(dqmiolistmes.py noevents.root -r 2 | wc -l) ]
[ 72 = $(dqmiolistmes.py noevents.root -r 2 -l 2 | wc -l) ]
