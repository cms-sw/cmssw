...
private:
  void preDrawTH1F(TCanvas *, const VisDQMObject &o) {
    ...
    // rate histograms
    if (o.name.find("rate_p") != std::string::npos || o.name.find("counts_p") != std::string::npos ||
        o.name.find("hltCount") != std::string::npos || o.name.find("hltRate") != std::string::npos ||
        o.name.find("hltRate") != std::string::npos || o.name.find("mergeCount") != std::string::npos) {
    ...
    if (o.name.find("FourVector/paths/") != std::string::npos) {
      if (o.name.find("custom-eff") != std::string::npos) {
        ...
        if (o.name.find("l1Et_Eff") != std::string::npos)
          obj->GetXaxis()->SetTitle("L1 P_{T}");
        if (o.name.find("onEt_Eff") != std::string::npos)
          obj->GetXaxis()->SetTitle("HLT P_{T}");
        if (o.name.find("offEt_Eff") != std::string::npos)
          obj->GetXaxis()->SetTitle("RECO P_{T}");
      }
      if (o.name.find("custom-eff") == std::string::npos) {
        if (o.name.find("l1Et") != std::string::npos)
          obj->GetXaxis()->SetTitle("L1 P_{T}");
        if (o.name.find("onEt") != std::string::npos)
          obj->GetXaxis()->SetTitle("HLT P_{T}");
        if (o.name.find("offEt") != std::string::npos)
          obj->GetXaxis()->SetTitle("RECO P_{T}");
        if (o.name.find("l1DRL1On") != std::string::npos)
          obj->GetXaxis()->SetTitle("L1-HLT #Delta R [rad]");
        if (o.name.find("offDRL1Off") != std::string::npos)
          obj->GetXaxis()->SetTitle("L1-RECO #Delta R [rad]");
        if (o.name.find("offDROnOff") != std::string::npos)
          obj->GetXaxis()->SetTitle("HLT-RECO #Delta R [rad]");
      }
    }
  ...
  void preDrawTH2F(TCanvas *, const VisDQMObject &o) {
    ...
    if (o.name.find("FourVector") != std::string::npos) {
      ...
      if (o.name.find("l1Eta") != std::string::npos) {
        obj->GetXaxis()->SetTitle("L1 #eta");
        obj->GetYaxis()->SetTitle("L1 #phi");
      }
      if (o.name.find("onEta") != std::string::npos) {
        obj->GetXaxis()->SetTitle("HLT #eta");
        obj->GetYaxis()->SetTitle("HLT #phi");
      }
      if (o.name.find("offEta") != std::string::npos) {
        obj->GetXaxis()->SetTitle("RECO #eta");
        obj->GetYaxis()->SetTitle("RECO #phi");
      }
    }

    if (o.name.find("FourVector/paths/") != std::string::npos && o.name.find("custom-eff") != std::string::npos) {
      obj->SetMinimum(0);
      obj->SetMaximum(1.2);
    }
