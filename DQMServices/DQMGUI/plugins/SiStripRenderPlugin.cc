...
public:
  ...
  void preDraw(TCanvas *c, const VisDQMObject &o, const VisDQMImgInfo &, VisDQMRenderInfo &) override {
    ...
    if ((dynamic_cast<TProfile *>(o.object) || dynamic_cast<TProfile2D *>(o.object) || dynamic_cast<TH1F *>(o.object) ||
         dynamic_cast<TH2F *>(o.object)) &&
        (o.name.find("fedErrorsVsIdVsLumi") != std::string::npos || o.name.find("LumiBlock") != std::string::npos ||
...
private:
  ...
  void preDrawTH1F(TCanvas *c, const VisDQMObject &o) {
    ...
    if (o.name.find("GoodTrackPhi_") != std::string::npos or o.name.find("GoodTrackEta_") != std::string::npos or
    ...
    if (name.find("NumberOfTracks_") != std::string::npos or name.find("Chi2oNDF_") != std::string::npos or
        name.find("TrackPt_") != std::string::npos or name.find("TrackP_") != std::string::npos or
        name.find("NumberOfSeeds_") != std::string::npos or name.find("SeedPt_") != std::string::npos) {
      if (obj->GetEntries() > 10.0)
        c->SetLogy(1);
      c->SetGridy();
    }

    if (name.find("Summary_ClusterCharge_OffTrack__") != std::string::npos or
        (name.find("Track") != std::string::npos and name.find("Err") != std::string::npos) or
  ...
  void preDrawTProfile2D(TCanvas *, const VisDQMObject &o) {
    ...
    if (o.name.find("NumberOfClusterPerRingVsTrendVar") != std::string::npos) {
      ...
      if (((TString)obj->GetTitle()).Contains("TEC")) {
        if (((TString)obj->GetTitle()).Contains("wheel__1") or ((TString)obj->GetTitle()).Contains("wheel__2") or
            ((TString)obj->GetTitle()).Contains("wheel__3"))
          obj->GetYaxis()->SetRangeUser(1, 7);
        if (((TString)obj->GetTitle()).Contains("wheel__4") or ((TString)obj->GetTitle()).Contains("wheel__5") or
            ((TString)obj->GetTitle()).Contains("wheel__6"))
          obj->GetYaxis()->SetRangeUser(2, 7);
        if (((TString)obj->GetTitle()).Contains("wheel__7") or ((TString)obj->GetTitle()).Contains("wheel__8"))
          obj->GetYaxis()->SetRangeUser(3, 7);
        if (((TString)obj->GetTitle()).Contains("wheel__9"))
          obj->GetYaxis()->SetRangeUser(4, 7);
      }
    }
  ...
  void preDrawTProfile(TCanvas *c, const VisDQMObject &o) {
    ...
    if (o.name.find("ProbVs") != std::string::npos or o.name.find("Chi2oNDFVs") != std::string::npos) {
      obj->SetMinimum(0.);
      obj->SetMaximum(1.5);
    }
  ...
  void postDrawTH1F(TCanvas *, const VisDQMObject &o) {
    ...
    if (o.name.find("/ReadoutView/FE/VsId/") != std::string::npos ||
        o.name.find("/ReadoutView/FED/VsId/") != std::string::npos ||
        o.name.find("/ReadoutView/Fiber/VsId/") != std::string::npos ||
        o.name.find("/ReadoutView/DataPresent") != std::string::npos) {
  ...
  void postDrawTProfile(TCanvas *, const VisDQMObject &o) {
    ...
    */
    ...
    if (o.name.find("/MechanicalView/NumberOfDigisinFED_v_FEDID") != std::string::npos ||
        o.name.find("/MechanicalView/NumberOfClustersinFED_v_FEDID") != std::string::npos) {
      float plot_ymax = 1.049 * (obj->GetMaximum() + 2 * sqrt(obj->GetMaximum()));
      if (plot_ymax == 0)
        plot_ymax = 1.049;
      tl4.DrawLine(134.0, -0.05, 134.0, plot_ymax);
