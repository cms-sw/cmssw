...
public:
  ...
  bool applies(const VisDQMObject& o, const VisDQMImgInfo&) override {
    ...
    if (o.name.find("L1T/") != std::string::npos)
      ...
      if (o.name.find("L1TStage2") == std::string::npos && o.name.find("reportSummaryMap") == std::string::npos)
        return true;
...
private:
  void preDrawTH1F(TCanvas*, const VisDQMObject& o) {
    ...
    if (o.name.find("L1TGCT") != std::string::npos) {
      ...
      // HF Ring Sums
      if (o.name.find("ETSumNegEta") != std::string::npos || o.name.find("ETSumPosEta") != std::string::npos) {
    ...
    // rate histograms
    if ((o.name.find("rate_algobit") != std::string::npos || o.name.find("rate_ttbit") != std::string::npos ||
         o.name.find("Rate_AlgoBit") != std::string::npos || o.name.find("Rate_TechBit") != std::string::npos ||
         o.name.find("Rate_Ratio") != std::string::npos || o.name.find("Integral_TechBit") != std::string::npos ||
         ...
         o.name.find("Deadtime_Percent") != std::string::npos || o.name.find("instTrigRate") != std::string::npos ||
         o.name.find("instEventRate") != std::string::npos || o.name.find("Rate_Ratio") != std::string::npos ||
         o.name.find("Number_of_Triggers") != std::string::npos ||
         o.name.find("Physics_Triggers") != std::string::npos || o.name.find("Random_Triggers") != std::string::npos ||
         o.name.find("Lost_Final_Trigger") != std::string::npos || o.name.find("DeadTime") != std::string::npos ||
         o.name.find("Number_Resets") != std::string::npos || o.name.find("Orbit_Number") != std::string::npos ||
         o.name.find("Number_of_Events") != std::string::npos || o.name.find("totAlgoRate") != std::string::npos ||
         o.name.find("totTtRate") != std::string::npos || o.name.find("Instant_Lumi") != std::string::npos ||
         o.name.find("Instant_Lumi_Err") != std::string::npos ||
         o.name.find("Instant_Lumi_Qlty") != std::string::npos || o.name.find("Instant_Et_Lumi") != std::string::npos ||
         o.name.find("Instant_Et_Lumi_Err") != std::string::npos ||
         o.name.find("Instant_Et_Lumi_Qlty") != std::string::npos || o.name.find("Num_Orbits") != std::string::npos ||
      ...
      if ((o.name.find("Integral_TechBit") != std::string::npos ||
           o.name.find("Integral_AlgoBit") != std::string::npos || o.name.find("Rate_Ratio") != std::string::npos ||
           o.name.find("Deadtime_Percent") != std::string::npos ||
           o.name.find("Physics_Triggers") != std::string::npos ||
           o.name.find("Random_Triggers") != std::string::npos || o.name.find("Orbit_Number") != std::string::npos ||
           o.name.find("Number_of_Events") != std::string::npos ||
           o.name.find("Lost_Final_Trigger") != std::string::npos || o.name.find("DeadTime") != std::string::npos ||
           o.name.find("Number_Resets") != std::string::npos || o.name.find("Instant_Lumi") != std::string::npos ||
           o.name.find("Instant_Lumi_Err") != std::string::npos ||
      ...
      else if ((o.name.find("instTrigRate") != std::string::npos || o.name.find("instEventRate") != std::string::npos ||
                o.name.find("Number_of_Triggers") != std::string::npos)) {
    ...
    if (o.name.find("dttf_") != std::string::npos) {
      ...
      // obj->SetOption("colz");
      obj->GetYaxis()->SetRangeUser(0, obj->GetBinContent(obj->GetMaximumBin()) * 1.1);
      ...
      if (o.name.find("bx") != std::string::npos) {
        ...
        if ((o.name.find("etaFine") != std::string::npos) || (o.name.find("nTracks") != std::string::npos)) {
          obj->GetXaxis()->SetNdivisions(2);
        }
        return;
  ...
  void preDrawTH2F(TCanvas*, const VisDQMObject& o) {
    ...
    if ((o.name.find("Rct") != std::string::npos &&
         (o.name.find("Jet") != std::string::npos || o.name.find("IsoEm") != std::string::npos)) &&
    ...
    if (o.name.find("L1TGCT") != std::string::npos) {
      ...
      if (o.name.find("TowerCountCorr") != std::string::npos || o.name.find("HFRing1Corr") != std::string::npos ||
  ...
  void postDrawTH2F(TCanvas*, const VisDQMObject& dqmObj) {
    ...
    if ((dqmObj.name.find("Rct") != std::string::npos || dqmObj.name.find("Jet") != std::string::npos ||
         dqmObj.name.find("IsoEm") != std::string::npos) &&
        dqmObj.name.find("EtaPhi") != std::string::npos) {
      dummybox->Draw("box,same");

      if (dqmObj.name.find("IsoEm") != std::string::npos || dqmObj.name.find("CenJet") != std::string::npos ||
