...
public:
  virtual void initialise(int, char**) {
    ...
    for (int g = 1; g < NRGBs_rainbow; g++) {
      nColorsGradient = (int)(floor(NCont_rainbow * stops_rainbow[g]) -
                              floor(NCont_rainbow *
                                    stops_rainbow[g - 1]));  // Specify number of gradients between stops (g-1) and (g)
...
private:
  void preDrawTH2F(TCanvas* c, const VisDQMObject& o) {
    ...
    if ((o.name.find("E - vertex zx") != std::string::npos) || (o.name.find("E - vertex zy") != std::string::npos) ||
        (o.name.find("E - vertex xy") != std::string::npos) ||
        (o.name.find("H - vertex zx cum") != std::string::npos) ||
        (o.name.find("H - vertex zy cum") != std::string::npos) ||
        (o.name.find("H - vertex xy cum") != std::string::npos)) {
      c->SetGrid();
  ...
  void preDrawTH1F(TCanvas* c, const VisDQMObject& o) {
    ...
    if ((o.name.find("F - vertex x") != std::string::npos) || (o.name.find("F - vertex y") != std::string::npos) ||
        (o.name.find("F - vertex z") != std::string::npos) || (o.name.find("G - vertex x fit") != std::string::npos) ||
        (o.name.find("G - vertex y fit") != std::string::npos) ||
        (o.name.find("G - vertex z fit") != std::string::npos) ||
        (o.name.find("I - vertex x cum") != std::string::npos) ||
        (o.name.find("I - vertex y cum") != std::string::npos) ||
        (o.name.find("I - vertex z cum") != std::string::npos) ||
        (o.name.find("L - status vs lumi") != std::string::npos))
      c->SetGrid(false, false);

    if ((o.name.find("B - muX vs lumi") != std::string::npos) ||
        (o.name.find("B - muY vs lumi") != std::string::npos) ||
        (o.name.find("B - muZ vs lumi") != std::string::npos) ||
        (o.name.find("C - sigmaX vs lumi") != std::string::npos) ||
        (o.name.find("C - sigmaY vs lumi") != std::string::npos) ||
        (o.name.find("C - sigmaZ vs lumi") != std::string::npos) ||
        (o.name.find("D - dxdz vs lumi") != std::string::npos) ||
        (o.name.find("D - dydz vs lumi") != std::string::npos) ||
        (o.name.find("G - vertex x fit") != std::string::npos) ||
        (o.name.find("G - vertex y fit") != std::string::npos) ||
        (o.name.find("G - vertex z fit") != std::string::npos) ||
        (o.name.find("J - pixelHits vs lumi") != std::string::npos) ||
        (o.name.find("K - good vertices vs lumi") != std::string::npos) ||
        (o.name.find("L - status vs lumi") != std::string::npos)) {
