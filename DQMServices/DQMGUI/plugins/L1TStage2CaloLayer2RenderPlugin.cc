...
public:
  ...
  bool applies(const VisDQMObject& o, const VisDQMImgInfo&) override {
    if (o.name.find("L1T/L1TStage2CaloLayer2/") != std::string::npos ||
        o.name.find("L1TEMU/L1TStage2CaloLayer2/") != std::string::npos)
      return true;
...
private:
  void drawExclusionBox(double x1, double y1, double x2, double y2) { exclusionBox_->DrawBox(x1, y1, x2, y2); }
  ...
  void preDrawTH1F(TCanvas*, const VisDQMObject& o) {
    ...
    if (o.name.rfind("Central-Jets/CenJetsRank") != std::string::npos ||
      ...
      if (o.name.rfind("EtSumBxOcc") != std::string::npos || o.name.rfind("METRank") != std::string::npos ||
          o.name.rfind("METPhi") != std::string::npos || o.name.rfind("METHFRank") != std::string::npos ||
          o.name.rfind("ETTRank") != std::string::npos || o.name.rfind("ETTEMRank") != std::string::npos ||
          o.name.rfind("MHTRank") != std::string::npos || o.name.rfind("MHTPhi") != std::string::npos ||
          o.name.rfind("MHTHFRank") != std::string::npos || o.name.rfind("HTTRank") != std::string::npos) {
        gPad->SetLogy(1);
      }
    }
