...
private:
  ...
  void preDrawTH1F(TCanvas *, const VisDQMObject &o) {
    ...
    if (o.name.find("efficiency_") != std::string::npos) {
      ...
      if (o.name.find("eta_") != std::string::npos)
        obj->SetAxisRange(-3.14, 3.14);
      if (o.name.find("pt_") != std::string::npos)
        obj->SetAxisRange(0, 100);
    }
  ...
  void postDrawTH1F(TCanvas *c, const VisDQMObject &o) {
    ...
    if (o.name.find("deltaR_") != std::string::npos or o.name.find("delta_eta_") != std::string::npos or
