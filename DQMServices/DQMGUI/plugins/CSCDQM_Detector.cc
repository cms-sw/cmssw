...
namespace cscdqm {
  ...
  bool Detector::isChamberInstalled(int side, int station, int ring, int chamber) const {
    if (station == 4 && ring == 2) {
      if (side == -1 || side == 2)
        return false;
      if (side == 1 && (chamber < 9 || chamber > 13))
        return false;
    }
    return true;
  }

  int Detector::SideSign(int side) const { return (side == 2 ? -1 : 1); }
  ...
  double Detector::Z_mm(int side, int station, int ring, int chamber, int layer) const {
    ...
    if (station == 1 && ring == 1 && chamber % 2 == 0)
      z = 5834.5 + 22.0 * (double)(layer - 1);
    // ME1/1 odd chambers are further from IP
    else if (station == 1 && ring == 1 && chamber % 2 == 1)
      z = 6101.5 + 22.0 * (double)(layer - 1);
    // All other ME (not ME1/1) - odd chambers mounted to iron, even chambers mounted further from the iron disk
    else if (station == 1 && ring == 2 && chamber % 2 == 0)
      z = 6769.48 + (6937.75 - 6769.48) / 7.0 * (double)(layer);
    else if (station == 1 && ring == 2 && chamber % 2 == 1)
      z = 7043.48 + (7211.75 - 7043.48) / 7.0 * (double)(layer);
    else if (station == 1 && ring == 3)
      z = 6867.45 + (7035.72 - 6867.45) / 7.0 * (double)(layer);
    else if (station == 2 && ring == 1 && chamber % 2 == 0)
      z = 8077.47 + (8245.75 - 8077.47) / 7.0 * (double)(layer);
    else if (station == 2 && ring == 1 && chamber % 2 == 1)
      z = 8325.48 + (8493.75 - 8325.48) / 7.0 * (double)(layer);
    else if (station == 2 && ring == 2 && chamber % 2 == 0)
      z = 8077.47 + (8245.75 - 8077.47) / 7.0 * (double)(layer);
    else if (station == 2 && ring == 2 && chamber % 2 == 1)
      z = 8325.48 + (8493.75 - 8325.48) / 7.0 * (double)(layer);
    else if (station == 3 && ring == 1 && chamber % 2 == 0)
      z = 9394.25 + (9562.53 - 9394.25) / 7.0 * (double)(layer);
    else if (station == 3 && ring == 1 && chamber % 2 == 1)
      z = 9146.25 + (9314.52 - 9146.25) / 7.0 * (double)(layer);
    else if (station == 3 && ring == 2 && chamber % 2 == 0)
      z = 9394.25 + (9562.53 - 9394.25) / 7.0 * (double)(layer);
    else if (station == 3 && ring == 2 && chamber % 2 == 1)
      z = 9146.25 + (9314.52 - 9146.25) / 7.0 * (double)(layer);
    else if (station == 4 && ring == 1 && chamber % 2 == 0)
      z = 10289.25 + (10457.53 - 10289.25) / 7.0 * (double)(layer);
    else if (station == 4 && ring == 1 && chamber % 2 == 1)
      z = 10041.25 + (10209.52 - 10041.25) / 7.0 * (double)(layer);
    else if (station == 4 && ring == 2 && chamber % 2 == 0)
      z = 10289.25 + (10457.53 - 10289.25) / 7.0 * (double)(layer);
    else if (station == 4 && ring == 2 && chamber % 2 == 1)
      z = 10041.25 + (10209.52 - 10041.25) / 7.0 * (double)(layer);
  ...
  double Detector::RPin(int station, int ring) const {
    ...
    if (station == 1 && ring == 1)
      rPin = 1060.0;  // "Pin" = "Chamber's bottom edge" for ME1/1
    if (station == 1 && ring == 2)
      rPin = 2784.9;
    if (station == 1 && ring == 3)
      rPin = 5089.9;
  ...
  double Detector::PhiDegChamberCenter(int station, int ring, int chamber) const {
    ...
    if (station == 1 && ring == 1)
      phiDegChamberCenter = (chamber - 1) * 10.0;
    if (station == 1 && ring == 2)
      phiDegChamberCenter = (chamber - 1) * 10.0;
    if (station == 1 && ring == 3)
      phiDegChamberCenter = (chamber - 1) * 10.0;
    if (station == 2 && ring == 1)
      phiDegChamberCenter = 5.0 + (chamber - 1) * 20.0;
    if (station == 2 && ring == 2)
      phiDegChamberCenter = (chamber - 1) * 10.0;
    if (station == 3 && ring == 1)
      phiDegChamberCenter = 5.0 + (chamber - 1) * 20.0;
  ...
  double Detector::LocalYtoBeam(int side, int station, int ring, const std::string& part, int hstrip, int wgroup) const {
    ...
    if (station == 1 && ring == 1) {
      ...
      if (wgroup == 1 || wgroup == NumberOfWiregroups(1, 1))
        inclineAngleRad = 0.5 * angle * 3.14159 / 180.0;

      localYtoBeam =
          (RPin(station, ring) + dPinToWGCenter_ME1_1[wgroup - 1]) / (1 - tan(inclineAngleRad) * tan(localPhiRad));
    }

    // All other chambers
    else if (station == 1 && ring == 2)
      localYtoBeam = RPin(station, ring) + dPinToWGCenter_ME1_2[wgroup - 1];
    else if (station == 1 && ring == 3)
      localYtoBeam = RPin(station, ring) + dPinToWGCenter_ME1_3[wgroup - 1];
    else if (station == 2 && ring == 1)
      localYtoBeam = RPin(station, ring) + dPinToWGCenter_ME2_1[wgroup - 1];
    else if (station == 2 && ring == 2)
      localYtoBeam = RPin(station, ring) + dPinToWGCenter_ME234_2[wgroup - 1];
    else if (station == 3 && ring == 1)
      localYtoBeam = RPin(station, ring) + dPinToWGCenter_ME3_1[wgroup - 1];
    else if (station == 3 && ring == 2)
      localYtoBeam = RPin(station, ring) + dPinToWGCenter_ME234_2[wgroup - 1];
    else if (station == 4 && ring == 1)
      localYtoBeam = RPin(station, ring) + dPinToWGCenter_ME4_1[wgroup - 1];
  ...
  int Detector::NumberOfStrips(int station, int ring, const std::string& part) const {
    ...
    if (station == 1 && ring == 1 && part == "a")
      nstrips = 48;
    if (station == 1 && ring == 1 && part == "b")
      nstrips = 64;
    if (station == 1 && ring == 2)
      nstrips = 80;
    if (station == 1 && ring == 3)
  ...
  double Detector::stripDPhiDeg(int station, int ring, const std::string& part) const {
    ...
    if (station == 1 && ring == 1 && part == "a")
      stripDPhi = 3.88 * 1e-3 * 180 / PI;  // 3.88 mrad
    if (station == 1 && ring == 1 && part == "b")
      stripDPhi = 2.96 * 1e-3 * 180 / PI;  // 2.96 mrad
    if (station == 1 && ring == 2)
      stripDPhi = 10.0 / 75.0;
    if (station == 1 && ring == 3)
      stripDPhi = 7.893 / 64.0;
    if (station == 2 && ring == 1)
      stripDPhi = 20.0 / 75.0;
    if (station == 2 && ring == 2)
      stripDPhi = 10.0 / 75.0;
  ...
  double Detector::stripStaggerInstripWidth(int station, int ring, int layer) const {
    ...
    if (station == 1 && ring == 2 && (layer == 1 || layer == 3 || layer == 5))
      stripStagger = 0.25;
    if (station == 1 && ring == 2 && (layer == 2 || layer == 4 || layer == 6))
      stripStagger = -0.25;

    if (station == 1 && ring == 3 && (layer == 1 || layer == 3 || layer == 5))
      stripStagger = 0.25;
    if (station == 1 && ring == 3 && (layer == 2 || layer == 4 || layer == 6))
      stripStagger = -0.25;

    if (station == 2 && ring == 1 && (layer == 1 || layer == 3 || layer == 5))
      stripStagger = 0.25;
    if (station == 2 && ring == 1 && (layer == 2 || layer == 4 || layer == 6))
      stripStagger = -0.25;

    if (station == 2 && ring == 2 && (layer == 1 || layer == 3 || layer == 5))
      stripStagger = 0.25;
    if (station == 2 && ring == 2 && (layer == 2 || layer == 4 || layer == 6))
      stripStagger = -0.25;

    if (station == 3 && ring == 1 && (layer == 1 || layer == 3 || layer == 5))
      stripStagger = -0.25;
    if (station == 3 && ring == 1 && (layer == 2 || layer == 4 || layer == 6))
      stripStagger = 0.25;

    if (station == 3 && ring == 2 && (layer == 1 || layer == 3 || layer == 5))
      stripStagger = -0.25;
    if (station == 3 && ring == 2 && (layer == 2 || layer == 4 || layer == 6))
      stripStagger = 0.25;

    if (station == 4 && ring == 1 && (layer == 1 || layer == 3 || layer == 5))
      stripStagger = 0.25;
    if (station == 4 && ring == 1 && (layer == 2 || layer == 4 || layer == 6))
      stripStagger = -0.25;

    if (station == 4 && ring == 2 && (layer == 1 || layer == 3 || layer == 5))
      stripStagger = 0.25;
    if (station == 4 && ring == 2 && (layer == 2 || layer == 4 || layer == 6))
      stripStagger = -0.25;

    return stripStagger;
  }

  double Detector::LocalPhiDegStripToChamberCenter(
      int side, int station, int ring, const std::string& part, int layer, int strip) const {
    double localPhi = 0.0;
  ...
  double Detector::LocalPhiDegHstripToChamberCenter(
      int side, int station, int ring, const std::string& part, int layer, int hstrip) const {
    double localPhi = 0.0;
  ...
  double Detector::Phi_deg(
      int side, int station, int ring, const std::string& part, int chamber, int layer, int hstrip) const {
    double phi = 0.0;
  ...
  double Detector::R_mm(
      int side, int station, int ring, const std::string& part, int layer, int hstrip, int wgroup) const {
    double r = 0.0;
  ...
  double Detector::X_mm(
      int side, int station, int ring, const std::string& part, int chamber, int layer, int hstrip, int wgroup) const {
    double x = 0.0;
  ...
  void Detector::chamberBoundsXY(
      int side, int station, int ring, int chamber, const std::string& part, int hs, int wg, double& x, double& y)
      const {
    int LAYER = 1;
    ...
    if (station == 1 && ring == 1) {
      ...
      double r = localYtoBeam / cos(LocalPhiRadHstripToChamberCenter(side, station, ring, part, LAYER, hs));
  ...
  void Detector::chamberBoundsXY(
      int side, int station, int ring, int chamber, const std::string& part, double* x, double* y) const {
    ...
    chamberBoundsXY(side,
                    station,
                    ring,
                    chamber,
                    part,
                    NumberOfHalfstrips(station, ring, part),
                    NumberOfWiregroups(station, ring),
                    x[2],
                    y[2]);
