 ...
 */
  ...
  public:
    ...
    int NumberOfHalfstrips(int station, int ring, const std::string& part) const {
      return 2 * NumberOfStrips(station, ring, part);
    };
    ...
    double stripDPhiRad(int station, int ring, const std::string& part) const {
      return PI / 180.0 * stripDPhiDeg(station, ring, part);
    };
    double stripDPhiRad(int station, int ring) const { return stripDPhiRad(station, ring, "b"); };

    double hstripDPhiDeg(int station, int ring, const std::string& part) const {
      return 0.5 * stripDPhiDeg(station, ring, part);
    };
    double hstripDPhiDeg(int station, int ring) const { return hstripDPhiDeg(station, ring, "b"); };
    double hstripDPhiRad(int station, int ring, const std::string& part) const {
      return PI / 180.0 * hstripDPhiDeg(station, ring, part);
    };
    double hstripDPhiRad(int station, int ring) const { return hstripDPhiRad(station, ring, "b"); };

    double LocalPhiDegStripToChamberCenter(
    ...
    double LocalPhiRadStripToChamberCenter(
        int side, int station, int ring, const std::string& part, int layer, int strip) const {
    ...
    double LocalPhiDegHstripToChamberCenter(
    ...
    double LocalPhiRadHstripToChamberCenter(
        int side, int station, int ring, const std::string& part, int layer, int hstrip) const {
