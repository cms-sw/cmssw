...
public:
  ...
  bool applies(const VisDQMObject &o, const VisDQMImgInfo &) override {
    if ((o.name.find("Muons/E") != std::string::npos) || (o.name.find("Muons/M") != std::string::npos) ||
        ...
        (o.name.find("Muons/g") != std::string::npos) || (o.name.find("Muons/s") != std::string::npos))
      return true;
...
private:
  ...
  void preDrawTH1(TCanvas *, const VisDQMObject &) { return; }

  void postDrawTProfile2D(TCanvas *, const VisDQMObject &) { return; }

  void postDrawTProfile(TCanvas *, const VisDQMObject &) { return; }
