...
public:
  ...
  virtual void postDraw(TCanvas* c, const VisDQMObject& o, const VisDQMImgInfo&) {
    ...
    if (reMatch(".*Summary/CSC_STATS_[a-zA-Z0-9_-]+$", o.name) || reMatch(".*EventInfo/reportSummaryMap$", o.name)) {
      TH2* obj2 = dynamic_cast<TH2*>(obj);
...
*/
    ...
    if (reMatch(".*/FEDTotalEventSize$", o.name) || reMatch(".*/DCCBufferSize$", o.name)) {
      /** Applying definition [FEDIntegrityMap] **/
    ...
    if (reMatch(".*/FEDTotalCSCs$", o.name) || reMatch(".*/FEDTotalCFEBs$", o.name) ||
        reMatch(".*/FEDTotalALCTs$", o.name) || reMatch(".*/FEDTotalTMBs$", o.name)) {
      /** Applying definition [FEDIntegrityMap] **/
      gStyle->SetOptStat("emro");
      obj->SetFillColor(45);
      /** Applying histogram **/
    ...
    if (reMatch(".*FEDIntegrity/FEDEntries$", o.name) || reMatch(".*FEDIntegrity/FEDFatal$", o.name) ||
        reMatch(".*FEDIntegrity/FEDFormatFatal$", o.name) || reMatch(".*FEDIntegrity/FEDNonFatal$", o.name) ||
    ...
    if (reMatch(".*FEDIntegrity/FEDTotalCSCs$", o.name) || reMatch(".*FEDIntegrity/FEDTotalCFEBs$", o.name) ||
        reMatch(".*FEDIntegrity/FEDTotalALCTs$", o.name) || reMatch(".*FEDIntegrity/FEDTotalTMBs$", o.name)) {
      gStyle->SetOptStat("emro");
      obj->SetFillColor(45);
      return;
    }
