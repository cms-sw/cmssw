...
def csclayout(i, p, *rows): i["CSC/Layouts/" + p] = rows
...
csclayout(dqmitems,"08 FED Data Integrity/01 FED CSCs Stats",
    [{'path':"CSC/Summary/FEDTotalCSCs", 'description': "Histogram shows the total number of CSCs per event."},
...
csclayout(dqmitems,"09 Segments Timing/01 Anodes Segments Timing ME-",
        [None,
         None,
         None,
...
csclayout(dqmitems,"09 Segments Timing/02 Anodes Segments Timing ME+",
...
csclayout(dqmitems,"09 Segments Timing/03 Cathodes Segments Timing ME-",
        [None,
         None,
         None,
...
csclayout(dqmitems,"09 Segments Timing/04 Cathodes Segments Timing ME+",
...
csclayout(dqmitems,"09 Segments Timing/05 Combined (anode+cathode) Segments Timing ME-",
        [None,
         None,
         None,
...
csclayout(dqmitems,"09 Segments Timing/06 Combined (anode+cathode) Segments Timing ME+",
...
csclayout(dqmitems,"09 Segments Timing/07 Anode minus Cathode Segment Timing ME-",
        [None,
         None,
         None,
...
csclayout(dqmitems,"09 Segments Timing/08 Anode minus Cathode Segment Timing ME+",
