...
#def shiftpflowlayout(i, p, *rows): i[p] = rows

#def shiftpflowjetreslayout(i, p , *rows): i["PTJetRes/" + p] = rows

#shiftpflowjetreslayout(dqmitems, "01 - Jet Pt Resolution - Barrel",
shiftpflowlayout(dqmitems, "01 - Jet Pt Resolution - Barrel",
...
shiftpflowlayout(dqmitems, "02 - Jet Pt Resolution - Endcap",
...
shiftpflowlayout(dqmitems, "03 - Jet Pt Resolution distribution - Barrel",
...
shiftpflowlayout(dqmitems, "04 - Jet Pt Resolution distribution - Endcap",
