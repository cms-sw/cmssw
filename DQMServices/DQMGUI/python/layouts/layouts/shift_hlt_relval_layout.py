...
#  def hltval<subsys>(i, p, *rows): i["00 Shift/TRIGGER Validation/HLT <subsys>" + p] = rows
...
def trigvalFVMuon(i, p, *rows): i["00 Shift/HLT/RelVal/FourVector/Muon/" + p] = rows
...
def trigvalFVEle(i, p, *rows): i["00 Shift/HLT/RelVal/FourVector/Electron/" + p] = rows
...
def trigvalFVJet(i, p, *rows): i["00 Shift/HLT/RelVal/FourVector/Jet/" + p] = rows
...
def trigvalFVPho(i, p, *rows): i["00 Shift/HLT/RelVal/FourVector/Photon/" + p] = rows
...
def trigvalegammaZ(i, p, *rows): i["00 Shift/HLT/Egamma/Zee Preselection/" + p] = rows
...
def trigvalegammaW(i, p, *rows): i["00 Shift/HLT/Egamma/Wenu Preselection/" + p] = rows
...
def trigvalmuon(i, p, *rows): i["00 Shift/HLT/Muon/" + p] = rows
...
def trigvaltau(i, p, *rows): i["00 Shift/HLT/Tau/" + p] = rows
hltTAUlumi='8E29'
...
def trigvaljetmet(i, p, *rows): i["00 Shift/HLT/JetMET/" + p] = rows
...
def trigvalbjet(i, p, *rows): i["00 Shift/HLT/BJet/" + p] = rows

###---- ALCA selection goes here: ----

def trigvalalca(i, p, *rows): i["00 Shift/HLT/AlCa/" + p] = rows
...
def trigvalbphys(i, p, *rows): i["00 Shift/HLT/HeavyFlavor/" + p] = rows
...
def trigvaltop(i, p, *rows): i["00 Shift/HLT/Top/" + p] = rows
...
def trigvalsusybsm(i, p, *rows): i["00 Shift/HLT/SusyExo/" + p] = rows
...
def trigvalhiggs(i, p, *rows): i["00 Shift/HLT/Higgs/" + p] = rows
...
def trigvalqcd(i, p, *rows): i["00 Shift/HLT/QCD/" + p] = rows
