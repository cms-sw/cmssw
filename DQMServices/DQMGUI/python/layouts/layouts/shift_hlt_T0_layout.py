...
def trigvalFVMuon(i, p, *rows): i["00 Shift/HLT/FourVector/Muon/" + p] = rows
...
def trigvalFVEle(i, p, *rows): i["00 Shift/HLT/FourVector/Electron/" + p] = rows
...
def trigvalFVJet(i, p, *rows): i["00 Shift/HLT/FourVector/Jet/" + p] = rows
...
def trigvalFVPho(i, p, *rows): i["00 Shift/HLT/FourVector/Photon/" + p] = rows
...
def hltCollLayout(i, p, *rows): i["00 Shift/HLT/Collisions/" + p] = rows
...
def hltlayout(i, p, *rows): i["00 Shift/HLT/Cosmics/" + p] = rows
...
def tpgOfflineLayout(i, p, *rows): i["HLT/Layouts/TPG-Summary-HLTOffline/" + p] = rows
