...
(function (factory) {
  ...
  JSROOT.ToolbarIcons.th2color = {
    recs: [
      { x: 0, y: 256, w: 13, h: 39, f: 'rgb(38,62,168)' },
      { x: 13, y: 371, w: 39, h: 39 },
      { y: 294, h: 39 },
      { y: 256, h: 39 },
      { y: 218, h: 39 },
      { x: 51, y: 410, w: 39, h: 39 },
      { y: 371, h: 39 },
      { y: 333, h: 39 },
      { y: 294 },
      { y: 256, h: 39 },
      ...
      { y: 102, h: 39 },
      { y: 64 },
      { x: 90, y: 448, w: 39, h: 39 },
      { y: 410 },
      { y: 371, h: 39 },
      { y: 333, h: 39, f: 'rgb(22,82,205)' },
      { y: 294 },
      { y: 256, h: 39, f: 'rgb(16,100,220)' },
      { y: 218, h: 39 },
      { y: 179, h: 39, f: 'rgb(22,82,205)' },
      { y: 141, h: 39 },
      { y: 102, h: 39, f: 'rgb(38,62,168)' },
      { y: 64 },
      { y: 0, h: 27 },
      { x: 128, y: 448, w: 39, h: 39 },
      { y: 410 },
      { y: 371, h: 39 },
      { y: 333, h: 39, f: 'rgb(22,82,205)' },
      { y: 294, f: 'rgb(20,129,214)' },
      { y: 256, h: 39, f: 'rgb(9,157,204)' },
      { y: 218, h: 39, f: 'rgb(14,143,209)' },
      { y: 179, h: 39, f: 'rgb(20,129,214)' },
      { y: 141, h: 39, f: 'rgb(16,100,220)' },
      { y: 102, h: 39, f: 'rgb(22,82,205)' },
      { y: 64, f: 'rgb(38,62,168)' },
      { y: 26, h: 39 },
      { y: 0, h: 27 },
      { x: 166, y: 486, h: 14 },
      { y: 448, h: 39 },
      { y: 410 },
      { y: 371, h: 39, f: 'rgb(22,82,205)' },
      { y: 333, h: 39, f: 'rgb(20,129,214)' },
      { y: 294, f: 'rgb(82,186,146)' },
      { y: 256, h: 39, f: 'rgb(179,189,101)' },
      { y: 218, h: 39, f: 'rgb(116,189,129)' },
      { y: 179, h: 39, f: 'rgb(82,186,146)' },
      { y: 141, h: 39, f: 'rgb(14,143,209)' },
      { y: 102, h: 39, f: 'rgb(16,100,220)' },
      { y: 64, f: 'rgb(38,62,168)' },
      { y: 26, h: 39 },
      { x: 205, y: 486, w: 39, h: 14 },
      { y: 448, h: 39 },
      { y: 410 },
      { y: 371, h: 39, f: 'rgb(16,100,220)' },
      { y: 333, h: 39, f: 'rgb(9,157,204)' },
      { y: 294, f: 'rgb(149,190,113)' },
      { y: 256, h: 39, f: 'rgb(244,198,59)' },
      { y: 218, h: 39 },
      { y: 179, h: 39, f: 'rgb(226,192,75)' },
      { y: 141, h: 39, f: 'rgb(13,167,195)' },
      { y: 102, h: 39, f: 'rgb(18,114,217)' },
      { y: 64, f: 'rgb(22,82,205)' },
      { y: 26, h: 39, f: 'rgb(38,62,168)' },
      { x: 243, y: 448, w: 39, h: 39 },
      { y: 410 },
      { y: 371, h: 39, f: 'rgb(18,114,217)' },
      { y: 333, h: 39, f: 'rgb(30,175,179)' },
      { y: 294, f: 'rgb(209,187,89)' },
      { y: 256, h: 39, f: 'rgb(251,230,29)' },
      { y: 218, h: 39, f: 'rgb(249,249,15)' },
      { y: 179, h: 39, f: 'rgb(226,192,75)' },
      { y: 141, h: 39, f: 'rgb(30,175,179)' },
      { y: 102, h: 39, f: 'rgb(18,114,217)' },
      { y: 64, f: 'rgb(38,62,168)' },
      { y: 26, h: 39 },
      { x: 282, y: 448, h: 39 },
      { y: 410 },
      { y: 371, h: 39, f: 'rgb(18,114,217)' },
      { y: 333, h: 39, f: 'rgb(14,143,209)' },
      { y: 294, f: 'rgb(149,190,113)' },
      { y: 256, h: 39, f: 'rgb(226,192,75)' },
      { y: 218, h: 39, f: 'rgb(244,198,59)' },
      { y: 179, h: 39, f: 'rgb(149,190,113)' },
      { y: 141, h: 39, f: 'rgb(9,157,204)' },
      { y: 102, h: 39, f: 'rgb(18,114,217)' },
      { y: 64, f: 'rgb(38,62,168)' },
      { y: 26, h: 39 },
      { x: 320, y: 448, w: 39, h: 39 },
      { y: 410 },
      { y: 371, h: 39, f: 'rgb(22,82,205)' },
      { y: 333, h: 39, f: 'rgb(20,129,214)' },
      { y: 294, f: 'rgb(46,183,164)' },
      { y: 256, h: 39 },
      { y: 218, h: 39, f: 'rgb(82,186,146)' },
      { y: 179, h: 39, f: 'rgb(9,157,204)' },
      { y: 141, h: 39, f: 'rgb(20,129,214)' },
      { y: 102, h: 39, f: 'rgb(16,100,220)' },
      { y: 64, f: 'rgb(38,62,168)' },
      { y: 26, h: 39 },
      { x: 358, y: 448, h: 39 },
      ...
      { y: 371, h: 39, f: 'rgb(22,82,205)' },
      { y: 333, h: 39 },
      { y: 294, f: 'rgb(16,100,220)' },
      { y: 256, h: 39, f: 'rgb(20,129,214)' },
      { y: 218, h: 39, f: 'rgb(14,143,209)' },
      { y: 179, h: 39, f: 'rgb(18,114,217)' },
      { y: 141, h: 39, f: 'rgb(22,82,205)' },
      { y: 102, h: 39, f: 'rgb(38,62,168)' },
      { y: 64 },
      { y: 26, h: 39 },
      { x: 397, y: 448, w: 39, h: 39 },
      { y: 371, h: 39 },
      { y: 333, h: 39 },
      { y: 294, f: 'rgb(22,82,205)' },
      { y: 256, h: 39 },
      { y: 218, h: 39 },
      { y: 179, h: 39, f: 'rgb(38,62,168)' },
      { y: 141, h: 39 },
      { y: 102, h: 39 },
      { y: 64 },
      { y: 26, h: 39 },
  ...
  JSROOT.ToolbarIcons.th2colorz = {
    recs: [
      { x: 128, y: 486, w: 256, h: 26, f: 'rgb(38,62,168)' },
      { y: 461, f: 'rgb(22,82,205)' },
      { y: 435, f: 'rgb(16,100,220)' },
      { y: 410, f: 'rgb(18,114,217)' },
      { y: 384, f: 'rgb(20,129,214)' },
      { y: 358, f: 'rgb(14,143,209)' },
      { y: 333, f: 'rgb(9,157,204)' },
      { y: 307, f: 'rgb(13,167,195)' },
      { y: 282, f: 'rgb(30,175,179)' },
      { y: 256, f: 'rgb(46,183,164)' },
      { y: 230, f: 'rgb(82,186,146)' },
      { y: 205, f: 'rgb(116,189,129)' },
      { y: 179, f: 'rgb(149,190,113)' },
      { y: 154, f: 'rgb(179,189,101)' },
      { y: 128, f: 'rgb(209,187,89)' },
      { y: 102, f: 'rgb(226,192,75)' },
      { y: 77, f: 'rgb(244,198,59)' },
      { y: 51, f: 'rgb(253,210,43)' },
      { y: 26, f: 'rgb(251,230,29)' },
      { y: 0, f: 'rgb(249,249,15)' },
    ],
  };
  ...
  JSROOT.Painter.CreateGradientColorTable = function (
    Stops,
    Red,
    Green,
    Blue,
    ...
    for (var g = 1; g < Stops.length; g++) {
      // create the colors...
      var nColorsGradient = parseInt(
        Math.floor(NColors * Stops[g]) - Math.floor(NColors * Stops[g - 1])
      );
  ...
  JSROOT.Painter.GetColorPalette = function (col, alfa) {
    ...
    return JSROOT.Painter.CreateGradientColorTable(
      stops,
      red,
      green,
      blue,
  ...
  TPavePainter.prototype.DrawPave = function (arg) {
    ...
    if (!this.Enabled) return this.RemoveDrawG();
    ...
    if ('PaveDrawFunc' in this) this.PaveDrawFunc(width, height, arg);
    ...
    this.AddDrag({
      ...
      ctxmenu:
        JSROOT.touches && JSROOT.gStyle.ContextMenu && this.UseContextMenu,
    });
  ...
  TPavePainter.prototype.DrawPaveLabel = function (_width, _height) {
    ...
    this.DrawText({
      align: pave.fTextAlign,
      width: _width,
      height: _height,
      text: pave.fLabel,
      color: this.get_color(pave.fTextColor),
    });
  ...
  TPavePainter.prototype.DrawPaveStats = function (width, height) {
    ...
    if (first_stat > 0 && num_cols > 1) {
      ...
      for (var ncol = 0; ncol < num_cols - 1; ++ncol)
        lpath +=
          'M' +
          Math.round((width / num_cols) * (ncol + 1)) +
          ',' +
    ...
    if (lpath)
      this.draw_g.append('svg:path').attr('d', lpath).call(this.lineatt.func);
  ...
  TPavePainter.prototype.DrawPaveText = function (
    width,
    height,
    dummy_arg,
    text_g
    ...
    var fast_draw = nlines == 1 && pp && pp._fast_drawing,
      nline = 0;
    ...
    for (var j = 0; j < pt.fLines.arr.length; ++j) {
      var entry = pt.fLines.arr[j],
        ytext =
          nlines > 0 ? Math.round((1 - (nline - 0.5) / nlines) * height) : 0;
      switch (entry._typename) {
        ...
        case 'TLatex':
          ...
          if (individual_positioning) {
            ...
            if (lx > 0 && lx < 1) lx = Math.round(lx * width);
            else lx = pt.fMargin * width;
            if (ly > 0 && ly < 1) ly = Math.round((1 - ly) * height);
            else ly = ytext;

            var jcolor = entry.fTextColor
              ? this.get_color(entry.fTextColor)
              : '';
            if (!jcolor) {
              jcolor = tcolor;
              this.UseTextColor = true;
            ...
            this.StartTextDrawing(
              pt.fTextFont,
              (entry.fTextSize || pt.fTextSize) * can_height,
              text_g
            );

            this.DrawText({
              align: entry.fTextAlign || pt.fTextAlign,
              x: lx,
              y: ly,
              text: entry.fTitle,
              color: jcolor,
    ...
    if (individual_positioning) {
      ...
      for (var j = 0; j < nlines; ++j) {
        ...
        if (nlines == 1) {
          ...
          if (lj.fTextSize)
            arg.font_size = Math.round(lj.fTextSize * can_height);
        }
  ...
  TPavePainter.prototype.Format = function (value, fmt) {
    ...
    switch (fmt) {
      case 'stat':
        fmt = pave.fStatFormat || JSROOT.gStyle.fStatFormat;
        break;
      case 'fit':
        fmt = pave.fFitFormat || JSROOT.gStyle.fFitFormat;
        break;
      case 'entries':
  ...
  TPavePainter.prototype.DrawPaveLegend = function (w, h) {
    ...
    if (
      legend.fTextSize &&
      ph * legend.fTextSize > 2 &&
      ph * legend.fTextSize < font_size
    )
    ...
    for (var ii = 0; ii < nlines; ++ii) {
      ...
      if (
        lopt.indexOf('e') != -1 &&
        (lopt.indexOf('l') == -1 || lopt.indexOf('f') != -1)
      ) {
      }
  ...
  TPavePainter.prototype.DrawPaletteAxis = function (s_width, s_height, arg) {
        ...
        if (this.IsTooltipAllowed())
          r.on('mouseover', function () {
            d3.select(this)
              .transition()
              .duration(100)
              .style('fill', d3.select(this).property('fill1'));
          })
            .on('mouseout', function () {
              d3.select(this)
                .transition()
                .duration(100)
                .style('fill', d3.select(this).property('fill0'));
            })
            .append('svg:title')
            .text(contour[i].toFixed(2) + ' - ' + contour[i + 1].toFixed(2));

        if (JSROOT.gStyle.Zooming)
          r.on('dblclick', function () {
            pthis.frame_painter().Unzoom('z');
          });
      }
    ...
    function moveRectSel() {
      ...
      if (m[1] < sel1) sel1 = m[1];
      else sel2 = m[1];

      zoom_rect.attr('y', sel1).attr('height', Math.abs(sel2 - sel1));
    }
    ...
    function startRectSel() {
      ...
      d3.select(window)
        .on('mousemove.colzoomRect', moveRectSel)
  ...
  TPavePainter.prototype.FillContextMenu = function (menu) {
    ...
    if (this.IsStats()) {
      ...
      function AddStatOpt(pos, name) {
        ...
        menu.addchk(opt, name, opt * 100 + pos, function (arg) {
          ...
          newopt -=
            (oldopt > 0 ? oldopt : -1) * parseInt(Math.pow(10, arg % 10));
          if (arg % 100 < 10) {
    ...
    if (this.UseTextColor) this.TextAttContextMenu(menu);
  ...
  TPavePainter.prototype.ShowContextMenu = function (evnt) {
    // for color palette
    if (this.z_handle)
      return this.frame_painter().ShowContextMenu(
        'z',
        evnt,
        this.GetObject().fAxis
      );
  ...
  TPavePainter.prototype.FillFunctionStat = function (f1, dofit) {
    ...
    if (print_fchi2 > 0)
      this.AddText(
        '#chi^2 / ndf = ' + this.Format(f1.fChisquare, 'fit') + ' / ' + f1.fNDF
      );
    if (print_fprob > 0)
      this.AddText(
        'Prob = ' +
          ('Math' in JSROOT
            ? this.Format(JSROOT.Math.Prob(f1.fChisquare, f1.fNDF))
            : '<not avail>')
      );
    if (print_fval > 0)
      for (var n = 0; n < f1.GetNumPars(); ++n) {
        var parname = f1.GetParName(n),
          parvalue = f1.GetParValue(n),
          parerr = f1.GetParError(n);

        parvalue =
          parvalue === undefined
            ? '<not avail>'
            : this.Format(Number(parvalue), 'fit');
        if (parerr !== undefined) {
        ...
        else this.AddText(parname + ' = ' + parvalue);
      }
  ...
  TPavePainter.prototype.FillStatistic = function () {
    ...
    var dostat = parseInt(pave.fOptStat),
      dofit = parseInt(pave.fOptFit);
  ...
  TPavePainter.prototype.UpdateObject = function (obj) {
    ...
    if (!pave.modified_NDC && !this.IsDummyPos(obj)) {
      ...
      if (
        ...
        this.stored.fX2 == obj.fX2 &&
        this.stored.fY1 == obj.fY1 &&
        this.stored.fY2 == obj.fY2
      ) {
    ...
    switch (obj._typename) {
      ...
      case 'TLegend':
        ...
        if (
          ...
          oldprim.arr &&
          pave.fPrimitives &&
          pave.fPrimitives.arr &&
          oldprim.arr.length == pave.fPrimitives.arr.length
        ) {
          ...
          for (var k = 0; k < oldprim.arr.length; ++k) {
            var oldobj = oldprim.arr[k].fObject,
              newobj = pave.fPrimitives.arr[k].fObject;

            if (
              oldobj &&
              newobj &&
              oldobj._typename == newobj._typename &&
              oldobj.fName == newobj.fName
            )
  ...
  function produceLegend(divid, opt) {
    ...
    var szx = 0.4,
      szy = leg.fPrimitives.arr.length;
    if (!szy) return;
    if (szy > 8) szy = 8;
    szy *= 0.1;
  ...
  THistDrawOptions.prototype.Decode = function (
    opt,
    hdim,
    histo,
    pad,
    ...
    if (d.check('MINIMUM:', true)) this.minimum = parseFloat(d.part);
    else this.minimum = histo.fMinimum;
    if (d.check('MAXIMUM:', true)) this.maximum = parseFloat(d.part);
    ...
    if (d.check('FILL_', true)) {
      if (d.partAsInt(1) > 0) this.histoFillColor = d.partAsInt();
      else
        for (var col = 0; col < 8; ++col)
          if (JSROOT.Painter.root_colors[col].toUpperCase() === d.part)
            this.histoFillColor = col;
    }
    if (d.check('LINE_', true)) {
      if (d.partAsInt(1) > 0)
        this.histoLineColor = JSROOT.Painter.root_colors[d.partAsInt()];
      else
        for (var col = 0; col < 8; ++col)
          if (JSROOT.Painter.root_colors[col].toUpperCase() === d.part)
    ...
    if (d.check('BASE0') || d.check('MIN0')) this.BaseLine = 0;
    else if (JSROOT.gStyle.fHistMinimumZero) this.BaseLine = 0;
    ...
    if (d.check('CONT', true) && hdim > 1) {
      this.Contour = 1;
      if (d.part.indexOf('Z') >= 0) this.Zscale = true;
      if (d.part.indexOf('1') >= 0) this.Contour = 11;
      else if (d.part.indexOf('2') >= 0) this.Contour = 12;
      else if (d.part.indexOf('3') >= 0) this.Contour = 13;
      else if (d.part.indexOf('4') >= 0) this.Contour = 14;
    }

    // decode bar/hbar option
    if (d.check('HBAR', true)) this.BarStyle = 20;
    else if (d.check('BAR', true)) this.BarStyle = 10;
    if (this.BarStyle > 0) {
      this.Hist = false;
    ...
    if (d.check('ARR')) this.Arrow = true;

    if (d.check('BOX', true)) this.BoxStyle = 10 + d.partAsInt();
  ...
  THistPainter.prototype.IsTH2Poly = function () {
    return (
      this.MatchObjectType(/^TH2Poly/) || this.MatchObjectType(/^TProfile2Poly/)
    );
  };

  THistPainter.prototype.Clear3DScene = function () {
    var fp = this.frame_painter();
    if (fp && typeof fp.Create3DScene === 'function') fp.Create3DScene(-1);
    this.mode3d = false;
  };
  ...
  THistPainter.prototype.DecodeOptions = function (opt) {
    ...
    if (!this.options) this.options = new THistDrawOptions();
    else this.options.Reset();
  ...
  THistPainter.prototype.CheckHistDrawAttributes = function () {
    ...
    if (pp && (this.options._pfc || this.options._plc || this.options._pmc)) {
      ...
      if (this.options._pfc) {
        histo.fFillColor = icolor;
        delete this.fillatt;
      }
      if (this.options._plc) {
        histo.fLineColor = icolor;
        delete this.lineatt;
      }
      if (this.options._pmc) {
    ...
    this.createAttFill({
      attr: histo,
      color: this.options.histoFillColor,
      kind: 1,
    });
  ...
  THistPainter.prototype.UpdateObject = function (obj, opt) {
    ...
    if (obj !== histo) {
      ...
      if (
        histo.TestBit(JSROOT.TH1StatusBits.kNoStats) !=
        obj.TestBit(JSROOT.TH1StatusBits.kNoStats)
      ) {
        histo.fBits = obj.fBits;

        var statpainter = this.FindPainterFor(this.FindStat());
        if (statpainter)
          statpainter.Enabled = !histo.TestBit(JSROOT.TH1StatusBits.kNoStats);
      }

      // if (histo.TestBit(JSROOT.TH1StatusBits.kNoStats)) this.ToggleStat();

      // special treatment for webcanvas - also name can be changed
      if (this.snapid !== undefined) histo.fName = obj.fName;
      ...
      if (this.options.Func) {
        ...
        if (obj.fFunctions)
          for (var n = 0; n < obj.fFunctions.arr.length; ++n) {
            ...
            var funcpainter = null,
              func_indx = -1;

            // try to find matching object in associated list of painters
            for (var i = 0; i < painters.length; ++i)
              if (
                painters[i].MatchObjectType(func._typename) &&
                painters[i].GetObject().fName === func.fName
              ) {
            ...
            if (!funcpainter && func.fName)
              funcpainter = this.FindPainterFor(
                null,
                func.fName,
                func._typename
              );
        ...
        if (pp && newfuncs.length > 0) {
          var prev_name = pp.has_canvas
            ? pp.CurrentPadName(pp.this_pad_name)
            : undefined;
          for (var k = 0; k < newfuncs.length; ++k)
            JSROOT.draw(this.divid, newfuncs[k], '', function (painter) {
              painter.child_painter_id = pid;
            });
    ...
    function AssignFuncs(axis) {
      if (axis.fXbins.length >= axis.fNbins) {
        ...
        axis.GetBinCoord = function (bin) {
          ...
          return (
            this.fXbins[indx] * Math.abs(bin - indx2) +
            this.fXbins[indx2] * Math.abs(bin - indx)
          );
        };
  ...
  THistPainter.prototype.DrawTitle = function () {
    ...
    var draw_title =
      !histo.TestBit(JSROOT.TH1StatusBits.kNoTitle) && st.fOptTitle > 0;
  ...
  THistPainter.prototype.GetSelectIndex = function (axis, side, add) {
    ...
    if (min !== max && taxis) {
      if (side == 'left') indx = taxis.FindBin(min, add || 0);
      else indx = taxis.FindBin(max, (add || 0) + 0.5);
      if (indx < 0) indx = 0;
    ...
    if (taxis) {
      if (
        taxis.fFirst === taxis.fLast ||
        !taxis.TestBit(JSROOT.EAxisBits.kAxisRange) ||
  ...
  THistPainter.prototype.IgnoreStatsFill = function () {
    return (
      !this.GetObject() ||
      (!this.draw_content && !this.create_stats) ||
      this.options.Axis > 0
    );
  };
  ...
  THistPainter.prototype.AddFunction = function (obj, asfirst) {
    ...
    if (!histo.fFunctions) histo.fFunctions = JSROOT.Create('TList');

    if (asfirst) histo.fFunctions.AddFirst(obj);
    else histo.fFunctions.Add(obj);
  };
  ...
  THistPainter.prototype.DrawNextFunction = function (indx, callback, painter) {
    ...
    if (func_painter === null) {
      if (func._typename === 'TPaveText' || func._typename === 'TPaveStats') {
        do_draw =
          !histo.TestBit(JSROOT.TH1StatusBits.kNoStats) && !this.options.NoStat;
  ...
  THistPainter.prototype.UnzoomUserRange = function (dox, doy, doz) {
    ...
    function UzoomMinMax(ndim, hist) {
      ...
      if (
        painter.options.minimum === -1111 &&
        painter.options.maximum === -1111
      )
        return false;
  ...
  THistPainter.prototype.ShowContextMenu = function (kind, evnt, obj) {
    ...
    var menu_painter = this,
      frame_corner = false,
      fp = null; // object used to show context menu
  ...
  THistPainter.prototype.ChangeUserRange = function (arg) {
    ...
    var res = prompt(
      'Enter user range for axis ' + arg + ' like [1,' + taxis.fNbins + ']',
      curr
    );
    if (!res) return;
    res = JSON.parse(res);
  ...
  THistPainter.prototype.FillContextMenu = function (menu) {
    ...
    if (this.draw_content) {
      menu.addchk(this.ToggleStat('only-check'), 'Show statbox', function () {
        this.ToggleStat();
      });
      if (this.Dimension() == 1) {
        ...
        if (this.Dimension() > 2) menu.add('Z', 'Z', this.ChangeUserRange);
        menu.add('endsub:');
      }
    ...
    if (this.options.Mode3D) {
      ...
      if (menu.size() > 0) menu.add('separator');
      ...
      menu.addchk(fp.enable_highlight, 'Highlight bins', function () {
        ...
        if (!fp.enable_highlight && fp.BinHighlight3D && fp.mode3d)
          fp.BinHighlight3D(null);
      });
    ...
    switch (funcname) {
      case 'ToggleZoom':
        if (
          ...
          fp.zoom_ymin !== fp.zoom_ymax ||
          fp.zoom_zmin !== fp.zoom_zmax
        ) {
          fp.Unzoom();
          fp.zoom_changed_interactive = 0;
          return true;
  ...
  THistPainter.prototype.FillToolbar = function (not_shown) {
    ...
    pp.AddButton(
      JSROOT.ToolbarIcons.auto_zoom,
      'Toggle between unzoom and autozoom-in',
      'ToggleZoom',
      'Ctrl *'
    );
    pp.AddButton(
      JSROOT.ToolbarIcons.arrow_right,
      'Toggle log x',
      'ToggleLogX',
      'PageDown'
    );
    pp.AddButton(
      JSROOT.ToolbarIcons.arrow_up,
      'Toggle log y',
      'ToggleLogY',
      'PageUp'
    );
    if (this.Dimension() > 1)
      pp.AddButton(
        JSROOT.ToolbarIcons.arrow_diag,
        'Toggle log z',
        'ToggleLogZ'
      );
    if (this.draw_content)
      pp.AddButton(
        JSROOT.ToolbarIcons.statbox,
        'Toggle stat box',
        'ToggleStatBox'
      );
  ...
  THistPainter.prototype.Get3DToolTip = function (indx) {
    ...
    switch (this.Dimension()) {
      ...
      case 3:
        ...
        tip.iz =
          (indx - tip.ix - tip.iy * (this.nbinsx + 2)) /
          (this.nbinsx + 2) /
          (this.nbinsy + 2);
  ...
  THistPainter.prototype.CreateContour = function (
    nlevels,
    zmin,
    zmax,
    zminpositive
    ...
    if (this.root_pad().fLogz) {
      ...
      if (this.colzmin <= 0)
        if (zminpositive === undefined || zminpositive <= 0)
          ...
          this.colzmin =
            zminpositive < 3 || zminpositive > 100 ? 0.3 * zminpositive : 1;
  ...
  THistPainter.prototype.GetContour = function () {
    ...
    var histo = this.GetObject(),
      nlevels = JSROOT.gStyle.fNumberContours,
      zmin = this.minbin,
      zmax = this.maxbin,
      zminpos = this.minposbin;
    if (zmin === zmax) {
      zmin = this.gminbin;
      zmax = this.gmaxbin;
      zminpos = this.gminposbin;
    }
    ...
    if (
      histo.fContour &&
      histo.fContour.length > 1 &&
      histo.TestBit(JSROOT.TH1StatusBits.kUserContour)
    ) {
  ...
  THistPainter.prototype.getContourIndex = function (zc) {
    ...
    if (zc === this.colzmin)
      return this.colzmin != 0 || !this.options.Zero || this.IsTH2Poly()
        ? 0
        : -1;

    return Math.floor(
      0.01 +
        ((zc - this.colzmin) * (cntr.length - 1)) /
          (this.colzmax - this.colzmin)
    );
  };
  ...
  THistPainter.prototype.DrawColorPalette = function (
    ...
    if (!pal) {
      ...
      JSROOT.extend(pal, {
        _typename: 'TPaletteAxis',
        fName: 'TPave',
        fH: null,
        fAxis: JSROOT.Create('TGaxis'),
        fX1NDC: 0.91,
        fX2NDC: 0.95,
        fY1NDC: 0.1,
        fY2NDC: 0.9,
      ...
      JSROOT.extend(pal.fAxis, {
        fTitle: zaxis.fTitle,
        fTitleSize: zaxis.fTitleSize,
        fChopt: '+',
        fLineColor: zaxis.fAxisColor,
        fLineSyle: 1,
        fLineWidth: 1,
        fTextAngle: 0,
        fTextSize: zaxis.fLabelSize,
        fTextAlign: 11,
        fTextColor: zaxis.fLabelColor,
        fTextFont: zaxis.fLabelFont,
      });
    ...
    if (
      can_move &&
      frame_painter &&
      pal.fX1NDC - 0.005 < frame_painter.fX2NDC &&
      !this.do_redraw_palette
    ) {
  ...
  THistPainter.prototype.ToggleColz = function () {
    var can_toggle = this.options.Mode3D
  ...
  THistPainter.prototype.ToggleMode3D = function () {
    ...
    if (this.options.Mode3D) {
      if (!this.options.Surf && !this.options.Lego && !this.options.Error) {
        ...
        else this.options.Lego = this.options.Color ? 12 : 1;
  ...
  THistPainter.prototype.PrepareColorDraw = function (args) {
    ...
    if (
      typeof histo.fBarOffset == 'number' &&
      typeof histo.fBarWidth == 'number' &&
    ...
    for (i = res.i1; i <= res.i2; ++i) {
      ...
      if (args.use3d) {
        if (res.grx[i] < -pmain.size_xy3d) {
          res.i1 = i;
          res.grx[i] = -pmain.size_xy3d;
        }
        if (res.grx[i] > pmain.size_xy3d) {
          res.i2 = i;
          res.grx[i] = pmain.size_xy3d;
    ...
    if (hdim === 1) {
      ...
      for (j = res.j1; j <= res.j2; ++j) {
        ...
        if (args.use3d) {
          if (res.gry[j] < -pmain.size_xy3d) {
            res.j1 = j;
            res.gry[j] = -pmain.size_xy3d;
          }
          if (res.gry[j] > pmain.size_xy3d) {
            res.j2 = j;
            res.gry[j] = pmain.size_xy3d;
    ...
    for (i = res.i1; i < res.i2; ++i) {
      for (j = res.j1; j < res.j2; ++j) {
        ...
        if (args.pixel_density) {
          binarea =
            (res.grx[i + 1] - res.grx[i]) * (res.gry[j] - res.gry[j + 1]);
        ...
        if (binz > 0)
          if (this.minposbin === null || binz < this.minposbin)
            this.minposbin = binz;
      }
    }
  ...
  TH1Painter.prototype.ScanContent = function (when_axis_changed) {
    ...
    else hsum += histo.getBinContent(0) + histo.getBinContent(this.nbinsx + 1);
    ...
    if (hmin != -1111 && hmax != -1111 && !this.draw_content && !set_zoom2) {
      ...
      if (hmin != -1111) {
        if (hmin < this.ymin) this.ymin = hmin;
        else set_zoom = true;
      }
      if (hmax != -1111) {
        if (hmax > this.ymax) this.ymax = hmax;
        else set_zoom = true;
      }
    }
    ...
    if (this.Dimension() > 1) this.wheel_zoomy = true;
    else if (this.draw_content) this.wheel_zoomy = false;
  };
  ...
  TH1Painter.prototype.CountStat = function (cond) {
    ...
    if (stat_sumw > 0) {
      ...
      res.rmsx = Math.sqrt(
        Math.abs(stat_sumwx2 / stat_sumw - res.meanx * res.meanx)
      );
      res.rmsy = Math.sqrt(
        Math.abs(stat_sumwy2 / stat_sumw - res.meany * res.meany)
      );
    }
  ...
  TH1Painter.prototype.FillStatistic = function (stat, dostat, dofit) {
    ...
    if (print_name > 0) stat.AddText(data.name);
    ...
    if (this.IsTProfile()) {
      ...
      if (print_mean > 0) stat.AddText('Mean = ' + stat.Format(data.meanx));

      if (print_rms > 0) stat.AddText('Std Dev = ' + stat.Format(data.rmsx));

      if (print_under > 0)
        stat.AddText(
          'Underflow = ' +
            stat.Format(
              histo.fArray.length > 0 ? histo.fArray[0] : 0,
              'entries'
            )
        );
      ...
      if (print_over > 0)
        stat.AddText(
          'Overflow = ' +
            stat.Format(
              histo.fArray.length > 0
                ? histo.fArray[histo.fArray.length - 1]
                : 0,
              'entries'
            )
        );
      ...
      if (print_skew > 0) stat.AddText('Skew = <not avail>');

      if (print_kurt > 0) stat.AddText('Kurt = <not avail>');
    }
  ...
  TH1Painter.prototype.DrawBars = function (width, height) {
    ...
    for (i = left; i < right; ++i) {
      ...
      if (show_text && y) {
        var lbl =
          y === Math.round(y)
            ? y.toString()
            : JSROOT.FFormat(y, JSROOT.gStyle.fPaintTextFormat);

        if (pmain.swap_xy)
          this.DrawText({
            align: 12,
            x: Math.round(gry1 + text_size / 2),
            y: Math.round(grx1 + 0.1),
          ...
          this.DrawText({
            align: 12,
            x: grx1 + w / 2,
            y: Math.round(gry1 - 2 - text_size / 5),
            width: 0,
            height: 0,
            rotate: text_angle,
            text: lbl,
          ...
          this.DrawText({
            align: 22,
            x: Math.round(grx1 + w * 0.1),
            y: Math.round(gry1 - 2 - text_size),
    ...
    if (bars)
      this.draw_g.append('svg:path').attr('d', bars).call(this.fillatt.func);
    ...
    if (show_text) this.FinishTextDrawing(this.draw_g);
  };
  ...
  TH1Painter.prototype.DrawBins = function () {
    ...
    if (this.options.Bar) return this.DrawBars(width, height);
    ...
    var draw_markers = show_errors || show_markers,
      ...
      draw_hist =
        this.options.Hist && (!this.lineatt.empty() || !this.fillatt.empty());

    if (!draw_hist && !draw_any_but_hist) return this.RemoveDrawG();
      ...
      if (extract_bin(bin)) {
          ...
          if (cont !== 0) {
            var lbl =
              cont === Math.round(cont)
                ? cont.toString()
                : JSROOT.FFormat(cont, JSROOT.gStyle.fPaintTextFormat);

            if (text_angle)
              pthis.DrawText({
                align: 12,
                x: midx,
                y: Math.round(my - 2 - text_size / 5),
                width: 0,
                height: 0,
                rotate: text_angle,
                text: lbl,
              ...
              pthis.DrawText({
                align: 22,
                x: Math.round(mx1 + (mx2 - mx1) * 0.1),
                y: Math.round(my - 2 - text_size),
                width: Math.round((mx2 - mx1) * 0.8),
                height: text_size,
                text: lbl,
                color: text_col,
                latex: 0,
        ...
        if (draw_markers) {
          if (my >= -yerr1 && my <= height + yerr2) {
            ...
            if (path_err !== null && do_err) draw_errbin(bin);
          }
        }
      }
    }
    ...
    if (do_marker || do_err)
      if (
        !JSROOT.gStyle.OptimizeDraw ||
        (right - left < 50000 && JSROOT.gStyle.OptimizeDraw == 1)
      ) {
        for (i = left; i < right; ++i) {
          if (extract_bin(i)) {
            if (path_marker !== null)
              path_marker += pthis.markeratt.create(midx, my);
            if (path_err !== null) draw_errbin(i);
          }
        }
    ...
    for (i = left; i <= right; ++i) {
      ...
      if (res.length === 0) {
        ...
        if (grx === currx && !lastbin) {
          if (gry < curry_min) bestimax = i;
          else if (gry > curry_max) bestimin = i;
          ...
          if (draw_hist && (curry_min !== curry_max || prevy !== curry_min)) {
            if (prevx !== currx) res += 'h' + (currx - prevx);

            if (curry === curry_min) {
              if (curry_max !== prevy) res += 'v' + (curry_max - prevy);
              if (curry_min !== curry_max) res += 'v' + (curry_min - curry_max);
            } else {
              if (curry_min !== prevy) res += 'v' + (curry_min - prevy);
              if (curry_max !== curry_min) res += 'v' + (curry_max - curry_min);
              if (curry !== curry_max) res += 'v' + (curry - curry_max);
            }
          ...
          if (lastbin && prevx !== grx) res += 'h' + (grx - prevx);
  ...
  TH1Painter.prototype.GetBinTips = function (bin) {
    ...
    if (pmain.x_kind === 'labels') xlbl = pmain.AxisAsText('x', x1);
    else if (pmain.x_kind === 'time')
      xlbl = pmain.AxisAsText('x', (x1 + x2) / 2);
    else {
      xnormal = true;
      xlbl =
        '[' +
        pmain.AxisAsText('x', x1) +
        ', ' +
        pmain.AxisAsText('x', x2) +
        ')';
    }
    ...
    if (this.options.Error || this.options.Mark) {
      ...
      if (cont === Math.round(cont)) tips.push('entries = ' + cont);
      else
        tips.push(
  ...
  TH1Painter.prototype.ProcessTooltip = function (pnt) {
    if (
      ...
      if (this.draw_g !== null) this.draw_g.select('.tooltip_bin').remove();
      return null;
    }
    ...
    while (l < r - 1) {
      ...
      if (xx === null || xx < pnt_x - 0.5) {
        if (pmain.swap_xy) r = m;
        else l = m;
      } else if (xx > pnt_x + 0.5) {
        if (pmain.swap_xy) l = m;
        else r = m;
      } else {
        l++;
        r--;
    ...
    if (findbin !== null) {
      ...
      if (findbin === left && grx1 > pnt_x + gapx) findbin = null;
      else if (findbin === right - 1 && grx2 < pnt_x - gapx) findbin = null;
      // if bars option used check that bar is not match
      else if (pnt_x < grx1 - gapx || pnt_x > grx2 + gapx) findbin = null;
    ...
    if (pnt.disabled) {
      ...
      if (res.changed)
        ttrect
          .attr('x', pmain.swap_xy ? gry1 : grx1)
      ...
      res.exact =
        Math.abs(midy - pnt_y) <= 5 || (pnt_y >= gry1 && pnt_y <= gry2);

      res.menu = true; // one could show context menu
      // distance to middle point, use to decide which menu to activate
      res.menu_dist = Math.sqrt(
        (midx - pnt_x) * (midx - pnt_x) + (midy - pnt_y) * (midy - pnt_y)
      );
    } else {
      ...
      res.exact =
        Math.abs(midx - pnt.x) <= radius && Math.abs(midy - pnt.y) <= radius;

      res.menu = res.exact; // show menu only when mouse pointer exactly over the histogram
      res.menu_dist = Math.sqrt(
        (midx - pnt.x) * (midx - pnt.x) + (midy - pnt.y) * (midy - pnt.y)
      );
    ...
    if (res.changed)
      res.user_info = {
        ...
        name: histo.fName,
        bin: findbin,
        cont: histo.getBinContent(findbin + 1),
        grx: midx,
        gry: midy,
      };
  ...
  TH1Painter.prototype.AutoZoom = function () {
    ...
    if (right - left < dist && left < right)
      this.frame_painter().Zoom(
        histo.fXaxis.GetBinLowEdge(left + 1),
        histo.fXaxis.GetBinLowEdge(right + 1)
      );
  };
  ...
  TH1Painter.prototype.CanZoomIn = function (axis, min, max) {
    ...
    if (
      axis == 'x' &&
      histo &&
      histo.fXaxis.FindBin(max, 0.5) - histo.fXaxis.FindBin(min, 0) > 1
    )
      return true;

    if (
      axis == 'y' &&
      Math.abs(max - min) > Math.abs(this.ymax - this.ymin) * 1e-6
    )
      return true;
  ...
  TH2Painter.prototype.ToggleProjection = function (kind, width) {
    ...
    if (canp)
      canp.ToggleProjection(
        new_proj,
        this.RedrawProjection.bind(this, 'toggling', new_proj)
      );
  };
  ...
  TH2Painter.prototype.RedrawProjection = function (ii1, ii2, jj1, jj2) {
    ...
    if (canp && !canp._readonly && this.snapid !== undefined) {
      ...
      var exec =
        'EXECANDSEND:D' + this.is_projection + 'PROJ:' + this.snapid + ':';
      if (this.is_projection == 'X')
        exec += 'ProjectionX("_projx",' + (jj1 + 1) + ',' + jj2 + ',"")';
      else exec += 'ProjectionY("_projy",' + (ii1 + 1) + ',' + ii2 + ',"")';
  ...
  TH2Painter.prototype.ExecuteMenuCommand = function (method, args) {
    if (THistPainter.prototype.ExecuteMenuCommand.call(this, method, args))
      return true;

    if (
      method.fName == 'SetShowProjectionX' ||
      method.fName == 'SetShowProjectionY'
    ) {
      this.ToggleProjection(
        method.fName[17],
        args && parseInt(args) ? parseInt(args) : 1
      );
      return true;
    }
  ...
  TH2Painter.prototype.FillHistContextMenu = function (menu) {
    ...
    if (this.options.Color) this.FillPaletteMenu(menu);
  };
  ...
  TH2Painter.prototype.ScanContent = function (when_axis_changed) {
    ...
    if (this.IsTH2Poly()) {
      ...
      for (var n = 0, len = histo.fBins.arr.length; n < len; ++n) {
        ...
        else if (bin_content > this.gmaxbin) this.gmaxbin = bin_content;
  ...
  TH2Painter.prototype.CountStat = function (cond) {
    ...
    if (this.IsTH2Poly()) {
      var len = histo.fBins.arr.length,
        i,
        bin,
        n,
        gr,
      ...
      for (i = 0; i < len; ++i) {
        ...
        if (bin.fXmin > pmain.scale_xmax) xside = 2;
        else if (bin.fXmax < pmain.scale_xmin) xside = 0;
        if (bin.fYmin > pmain.scale_ymax) yside = 2;
        else if (bin.fYmax < pmain.scale_ymin) yside = 0;
    ...
    if (stat_sum0 > 0) {
      ...
      res.rmsx = Math.sqrt(
        Math.abs(stat_sumx2 / stat_sum0 - res.meanx * res.meanx)
      );
      res.rmsy = Math.sqrt(
        Math.abs(stat_sumy2 / stat_sum0 - res.meany * res.meany)
      );
    }
  ...
  TH2Painter.prototype.FillStatistic = function (stat, dostat, dofit) {
    ...
    if (print_kurt > 0) stat.AddText('Kurt = <undef>');

    if (print_under > 0 || print_over > 0) {
      var m = data.matrix;

      stat.AddText(
        '' + m[6].toFixed(0) + ' | ' + m[7].toFixed(0) + ' | ' + m[7].toFixed(0)
      );
      stat.AddText(
        '' + m[3].toFixed(0) + ' | ' + m[4].toFixed(0) + ' | ' + m[5].toFixed(0)
      );
      stat.AddText(
        '' + m[0].toFixed(0) + ' | ' + m[1].toFixed(0) + ' | ' + m[2].toFixed(0)
      );
    }
  ...
  TH2Painter.prototype.BuildContour = function (
    handle,
    levels,
    palette,
    contour_func
    ...
    for (j = handle.j1; j < handle.j2 - 1; ++j) {
      ...
      for (i = handle.i1; i < handle.i2 - 1; ++i) {
        ...
        for (k = 0; k < 4; k++) ir[k] = BinarySearch(zc[k]);
        ...
        if (
          ...
          for (ix = 1; ix <= lj - 2; ix += 2) {
            ...
            if (ipoly >= 0 && ipoly < levels.length) {
              poly = polys[ipoly];
              if (!poly)
                poly = polys[ipoly] = JSROOT.CreateTPolyLine(
                  kMAXCONTOUR * 4,
                  true
                );
    ...
    var polysort = new Int32Array(levels.length),
      first = 0;
  ...
  TH2Painter.prototype.DrawBinsContour = function (frame_w, frame_h) {
    var handle = this.PrepareColorDraw({
      rounding: false,
      extra: 100,
      original: this.options.Proj != 0,
    });
    ...
    function BuildPath(xp, yp, iminus, iplus) {
      ...
      for (i = iminus; i <= iplus; ++i) {
        ...
        switch (main.projection) {
          case 1:
            pnt = main.ProjectAitoff2xy(xp[i], yp[i]);
            break;
          case 2:
            pnt = main.ProjectMercator2xy(xp[i], yp[i]);
            break;
          case 3:
            pnt = main.ProjectSinusoidal2xy(xp[i], yp[i]);
            break;
          case 4:
            pnt = main.ProjectParabolic2xy(xp[i], yp[i]);
            break;
        }
        if (pnt) {
    ...
    if (this.options.Contour === 14) {
      ...
      if (this.options.Proj) {
        var sz = handle.j2 - handle.j1,
          xd = new Float32Array(sz * 2),
          yd = new Float32Array(sz * 2);
        for (var i = 0; i < sz; ++i) {
          xd[i] = handle.origx[handle.i1];
          yd[i] =
            (handle.origy[handle.j1] * (i + 0.5) +
              handle.origy[handle.j2] * (sz - 0.5 - i)) /
            sz;
          xd[i + sz] = handle.origx[handle.i2];
          yd[i + sz] =
            (handle.origy[handle.j2] * (i + 0.5) +
              handle.origy[handle.j1] * (sz - 0.5 - i)) /
            sz;
        }
    ...
    this.BuildContour(handle, levels, palette, function (
      colindx,
      xp,
      yp,
      iminus,
      ...
      switch (painter.options.Contour) {
        ...
        case 11:
          fillcolor = 'none';
          lineatt = new JSROOT.TAttLineHandler({ color: icol });
          break;
        case 12:
          fillcolor = 'none';
          lineatt = new JSROOT.TAttLineHandler({
            color: 1,
            style: (colindx % 5) + 1,
            width: 1,
          });
      ...
      var elem = painter.draw_g
        ...
        .attr(
          'd',
          BuildPath(xp, yp, iminus, iplus) + (fillcolor == 'none' ? '' : 'z')
        )
        .style('fill', fillcolor);

      if (lineatt !== null) elem.call(lineatt.func);
      else elem.style('stroke', 'none');
    });
  ...
  TH2Painter.prototype.CreatePolyBin = function (pmain, bin, text_pos) {
    ...
    if (text_pos) bin._sumx = bin._sumy = bin._suml = 0;
    ...
    for (ngr = 0; ngr < ngraphs; ++ngr) {
      ...
      for (n = 1; n < npnts; ++n) {
        ...
        if (grx !== nextx || gry !== nexty) {
          if (grx === nextx) cmd += 'v' + (nexty - gry);
          else if (gry === nexty) cmd += 'h' + (nextx - grx);
          else cmd += 'l' + (nextx - grx) + ',' + (nexty - gry);
        }
        grx = nextx;
        gry = nexty;
      }
      ...
      if (text_pos)
        AddPoint(
          grx,
          gry,
          Math.round(pmain.grx(x[0])),
          Math.round(pmain.gry(y[0]))
        );
      cmd += 'z';
    }
  ...
  TH2Painter.prototype.DrawPolyBinsColor = function (w, h) {
    ...
    for (i = 0; i < len; ++i) {
      ...
      if (
        bin.fXmin > pmain.scale_xmax ||
        bin.fXmax < pmain.scale_xmin ||
        bin.fYmin > pmain.scale_ymax ||
        bin.fYmax < pmain.scale_ymin
      )
        continue;

      cmd = this.CreatePolyBin(pmain, bin, this.options.Text && bin.fContent);

      if (colPaths[colindx] === undefined) colPaths[colindx] = cmd;
      else colPaths[colindx] += cmd;
    ...
    for (colindx = 0; colindx < colPaths.length; ++colindx)
      if (colPaths[colindx]) {
        item = this.draw_g
          ...
          .attr('d', colPaths[colindx]);
        if (this.options.Line) item.call(this.lineatt.func);
      }
    ...
    if (textbins.length > 0) {
      ...
      for (i = 0; i < textbins.length; ++i) {
        ...
        if (!this.options.TextKind) {
          lbl =
            Math.round(bin.fContent) === bin.fContent
  ...
  TH2Painter.prototype.DrawBinsText = function (w, h, handle) {
    var histo = this.GetObject(),
      ...
      text_offset = 0,
      profile2d =
        this.MatchObjectType('TProfile2D') &&
        typeof histo.getBinEntries == 'function',
    ...
    for (i = handle.i1; i < handle.i2; ++i)
      for (j = handle.j1; j < handle.j2; ++j) {
        ...
        if (profile2d) binz = histo.getBinEntries(i + 1, j + 1);

        lbl =
          binz === Math.round(binz)
            ? binz.toString()
        ...
        if (show_err) {
          ...
          lble =
            errz === Math.round(errz)
              ? errz.toString()
              : JSROOT.FFormat(errz, JSROOT.gStyle.fPaintTextFormat);
          if (this.options.TextLine) lbl += '\xB1' + lble;
          else lbl = '#splitline{' + lbl + '}{#pm' + lble + '}';
        }
  ...
  TH2Painter.prototype.DrawBinsArrow = function (w, h) {
    var histo = this.GetObject(),
      ...
      scale_x =
        (handle.grx[handle.i2] - handle.grx[handle.i1]) /
        (handle.i2 - handle.i1 + 1 - 0.03) /
        2,
      scale_y =
        (handle.gry[handle.j2] - handle.gry[handle.j1]) /
        (handle.j2 - handle.j1 + 1 - 0.03) /
        2;
    ...
    for (var loop = 0; loop < 2; ++loop)
      for (i = handle.i1; i < handle.i2; ++i)
        for (j = handle.j1; j < handle.j2; ++j) {
          if (i === handle.i1) {
            dx =
              histo.getBinContent(i + 2, j + 1) -
              histo.getBinContent(i + 1, j + 1);
          } else if (i === handle.i2 - 1) {
            dx =
              histo.getBinContent(i + 1, j + 1) - histo.getBinContent(i, j + 1);
          } else {
            dx =
              0.5 *
              (histo.getBinContent(i + 2, j + 1) -
                histo.getBinContent(i, j + 1));
          }
          if (j === handle.j1) {
            dy =
              histo.getBinContent(i + 1, j + 2) -
              histo.getBinContent(i + 1, j + 1);
          } else if (j === handle.j2 - 1) {
            dy =
              histo.getBinContent(i + 1, j + 1) - histo.getBinContent(i + 1, j);
          } else {
            dy =
              0.5 *
              (histo.getBinContent(i + 1, j + 2) -
                histo.getBinContent(i + 1, j));
          }
  ...
  TH2Painter.prototype.DrawBinsBox = function (w, h) {
    ...
    if (this.root_pad().fLogz && absmax > 0) {
      ...
      if (absmin > 0) logmin = Math.log(absmin);
      else if (main.minposbin >= 1 && main.minposbin < 100)
        logmin = Math.log(0.7);
      else
        logmin =
          main.minposbin > 0 ? Math.log(0.7 * main.minposbin) : logmax - 10;
    ...
    if (res.length > 0) {
      ...
      else elem.call(this.lineatt.func);
    }
      ...
      this.draw_g
        ...
        .style(
          ...
          this.fillatt.color === 'none'
            ? 'red'
            : d3.rgb(this.fillatt.color).darker(0.5).toString()
        );
    ...
    if (cross.length > 0) {
      var elem = this.draw_g
        ...
        .attr('d', cross)
        .style('fill', 'none');
      if (this.lineatt.color !== 'none') elem.call(this.lineatt.func);
      else elem.style('stroke', 'black');
    }
  ...
  TH2Painter.prototype.DrawCandle = function (w, h) {
    ...
    for (i = handle.i1; i < handle.i2; ++i) {
      ...
      for (j = 0; j < this.nbinsy; ++j) {
        ...
        if (counter / integral < 0.001 && (counter + cont) / integral >= 0.001)
          pnt.whiskerm = posy; // Lower whisker
        if (counter / integral < 0.25 && (counter + cont) / integral >= 0.25)
          pnt.m25y = posy; // Lower edge of box
        if (counter / integral < 0.5 && (counter + cont) / integral >= 0.5)
          pnt.median = posy; //Median
        if (counter / integral < 0.75 && (counter + cont) / integral >= 0.75)
          pnt.p25y = posy; //Upper edge of box
        if (counter / integral < 0.999 && (counter + cont) / integral >= 0.999)
          pnt.whiskerp = posy; // Upper whisker
        counter += cont;
      ...
      w *= 0.66;
      center =
        (handle.grx[i + 1] + handle.grx[i]) / 2 + (histo.fBarOffset / 1000) * w;
      ...
      for (j = 0; j < this.nbinsy; ++j) {
        cont = histo.getBinContent(i + 1, j + 1);
        posy = histo.fYaxis.GetBinCenter(j + 1);
        if (cont > 0 && posy < pnt.whiskerm)
          markers += this.markeratt.create(center, posy);
        if (cont > 0 && posy > pnt.whiskerp)
          markers += this.markeratt.create(center, posy);
      }
  ...
  TH2Painter.prototype.DrawBinsScatter = function (w, h) {
    var histo = this.GetObject(),
      ...
      factor = 1,
      scale =
        this.options.ScatCoef * (this.gmaxbin > 2000 ? 2000 / this.gmaxbin : 1);
    ...
    if (scale * handle.sumz < 1e5) {
      ...
      this.draw_g.append('svg:path').attr('d', path).call(this.markeratt.func);
    ...
    for (colindx = 0; colindx < colPaths.length; ++colindx)
      if (colPaths[colindx] !== undefined && colindx < this.fContour.length) {
        ...
        else pattern.selectAll('*').remove();

        var npix = Math.round(
          factor * this.fContour[colindx] * cell_w[colindx] * cell_h[colindx]
        );
        if (npix < 1) npix = 1;

        var arrx = new Float32Array(npix),
          arry = new Float32Array(npix);
        ...
        for (var n = 0; n < npix; ++n)
          path += this.markeratt.create(
            arrx[n] * cell_w[colindx],
            arry[n] * cell_h[colindx]
          );

        pattern
          .attr('width', cell_w[colindx])
  ...
  TH2Painter.prototype.DrawBins = function () {
    if (!this.draw_content) return this.RemoveDrawG();
    ...
    if (this.IsTH2Poly()) {
      ...
      if (this.options.Scat) handle = this.DrawBinsScatter(w, h);
      else if (this.options.Color) handle = this.DrawBinsColor(w, h);
      else if (this.options.Box) handle = this.DrawBinsBox(w, h);
      else if (this.options.Arrow) handle = this.DrawBinsArrow(w, h);
      else if (this.options.Contour) handle = this.DrawBinsContour(w, h);
      else if (this.options.Candle) handle = this.DrawCandle(w, h);

      if (this.options.Text) handle = this.DrawBinsText(w, h, handle);

      if (!handle) handle = this.DrawBinsScatter(w, h);
    }
  ...
  TH2Painter.prototype.GetBinTips = function (i, j) {
    ...
    if (pmain.x_kind == 'labels')
      lines.push(
        'x = ' + pmain.AxisAsText('x', histo.fXaxis.GetBinLowEdge(i + 1))
      );
    else
      lines.push(
        'x = [' +
          pmain.AxisAsText('x', histo.fXaxis.GetBinLowEdge(i + 1)) +
          ', ' +
          pmain.AxisAsText('x', histo.fXaxis.GetBinLowEdge(i + 2)) +
          ')'
      );

    if (pmain.y_kind == 'labels')
      lines.push(
        'y = ' + pmain.AxisAsText('y', histo.fYaxis.GetBinLowEdge(j + 1))
      );
    else
      lines.push(
        'y = [' +
          pmain.AxisAsText('y', histo.fYaxis.GetBinLowEdge(j + 1)) +
          ', ' +
          pmain.AxisAsText('y', histo.fYaxis.GetBinLowEdge(j + 2)) +
          ')'
      );
    ...
    lines.push(
      'entries = ' +
        (binz === Math.round(binz)
          ? binz
          : JSROOT.FFormat(binz, JSROOT.gStyle.fStatFormat))
    );
  ...
  TH2Painter.prototype.GetCandleTips = function (p) {
    ...
    lines.push(
      'x = ' + main.AxisAsText('x', histo.fXaxis.GetBinLowEdge(p.bin + 1))
    );
  ...
  TH2Painter.prototype.ProcessTooltip = function (pnt) {
    ...
    if (h.poly) {
      ...
      if (pnt.disabled) {
        ...
        if (res.changed)
          ttrect
            .attr('d', this.CreatePolyBin(pmain, bin))
            .style('opacity', '0.7')
      ...
      for (i = 0; i < h.candle.length; ++i) {
        p = h.candle[i];
        if (p.x1 <= pnt.x && pnt.x <= p.x2 && p.yy1 <= pnt.y && pnt.y <= p.yy2)
          break;
      }
    ...
    if (i < h.i2 && j < h.j2) {
      ...
      if (this.is_projection) {
        ...
        colindx = this.getContourColor(binz, true);
        if (colindx === null && binz === 0 && this._show_empty_bins)
          colindx = 0;
      }
    }
    ...
    if (pnt.disabled && !this.is_projection) {
      ...
      if (this.is_projection == 'X') {
        ...
        if (this.projection_width > 1) {
          ...
          if (j2 + dd >= h.j2) {
            j2 = Math.min(Math.round(j2 + dd), h.j2);
            j1 = Math.max(j2 - this.projection_width, h.j1);
          } else {
            j1 = Math.max(Math.round(j1 - dd), h.j1);
            j2 = Math.min(j1 + this.projection_width, h.j2);
          }
        }
        y1 = h.gry[j2];
        y2 = h.gry[j1];
        ...
        y1 = 0;
        y2 = this.frame_height();
        if (this.projection_width > 1) {
          var dd = (this.projection_width - 1) / 2;
          if (i2 + dd >= h.i2) {
            i2 = Math.min(Math.round(i2 + dd), h.i2);
            i1 = Math.max(i2 - this.projection_width, h.i1);
          } else {
            i1 = Math.max(Math.round(i1 - dd), h.i1);
            i2 = Math.min(i1 + this.projection_width, h.i2);
          }
        }
        (x1 = h.grx[i1]), (x2 = h.grx[i2]), (binid = i1 * 777 + i2 * 333);
      }
  ...
  TH2Painter.prototype.Draw2D = function (call_back, resize) {
    ...
    var pp = this.DrawColorPalette(
      this.options.Zscale && (this.options.Color || this.options.Contour),
      true
    );
  ...
  function drawHistogram2D(divid, histo, opt) {
    ...
    if (painter.IsTH2Poly()) {
      if (painter.options.Mode3D) painter.options.Lego = 12;
      // lego always 12
    ...
    painter.CheckPadRange(
      !painter.options.Mode3D && painter.options.Contour != 14
    );
  ...
  function drawTF2(divid, func, opt) {
    ...
    if (d.empty()) opt = 'cont3';
    else if (d.opt === 'SAME') opt = 'cont2 same';
    else opt = d.opt;
  ...
  THStackPainter.prototype.GetMinMax = function (iserr, pad) {
    ...
    if (this.options.nostack) {
      ...
      res.max = this.GetHistMinMax(
        stack.fStack.arr[stack.fStack.arr.length - 1],
        iserr
      ).max;
    }
  ...
  THStackPainter.prototype.DrawNextHisto = function (indx, mm, subp, reenter) {
    ...
    JSROOT.draw(
      ...
      hist,
      hopt,
      this.DrawNextHisto.bind(this, indx, 'callback')
    );
  };
  ...
  THStackPainter.prototype.DecodeOptions = function (opt) {
    ...
    var stack = this.GetObject(),
      hist =
        stack.fHistogram ||
        (stack.fHists ? stack.fHists.arr[0] : null) ||
        (stack.fStack ? stack.fStack.arr[0] : null);
    ...
    if (stack.fHists && !this.options.nostack) {
      for (var k = 0; k < stack.fHists.arr.length; ++k)
        this.options.has_errors =
          this.options.has_errors || this.HasErrors(stack.fHists.arr[k]);
    }
  ...
  THStackPainter.prototype.CreateHistogram = function (stack) {
    ...
    var h0 = histos.arr[0];
    var histo = JSROOT.CreateHistogram(
      this.options.ndim == 1 ? 'TH1I' : 'TH2I',
      h0.fXaxis.fNbins,
      h0.fYaxis.fNbins
    );
    histo.fName = 'axis_hist';
    JSROOT.extend(histo.fXaxis, h0.fXaxis);
    if (this.options.ndim == 2) JSROOT.extend(histo.fYaxis, h0.fYaxis);
  ...
  THStackPainter.prototype.drawStack = function () {
    ...
    if (!this.options.nostack) this.options.nostack = !this.BuildStack(stack);

    if (!stack.fHistogram && !this.options.same)
      stack.fHistogram = this.CreateHistogram(stack);

    var mm = this.GetMinMax(
      this.options.errors || this.options.draw_errors,
      this.root_pad()
    );
  ...
  THStackPainter.prototype.UpdateObject = function (obj) {
    ...
    if (this.firstpainter) {
      ...
      if (!src) src = stack.fHistogram = this.CreateHistogram(stack);
  ...
  THStackPainter.prototype.Redraw = function () {
    ...
    if (this.firstpainter) this.firstpainter.Redraw();
