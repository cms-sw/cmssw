...
process.siStripDQMHistoryPopCon = cms.EDAnalyzer("SiStripDQMHistoryPopCon",
                                                 ...
                                                 Source = cms.PSet(since = cms.untracked.uint32(69572),
...
process.SiStripHistoryDQMService = cms.Service("SiStripHistoryDQMService",
                                               ...
                                               FILE_NAME = cms.untracked.string("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/data/Cosmics__Commissioning08_CRAFT_ALL_V9_225-v2__RECO/69572/DQM_V0001_R000069572__Cosmics__Commissioning08_CRAFT_ALL_V9_225-v2__RECO_1.root"),
