...
cmsDriver.py step3_MC1_4 -s ${DQMSEQUENCE} --harvesting AtRunEnd --conditions auto:mc --filetype DQM --filein file:step2_MC1_4_RAW2DIGI_RECO_VALIDATION_DQM_inDQM.root --mc --customise DQMServices/Components/test/customHarvesting.py --python_filename=test_${tnum}_b_1.py  --no_exec
