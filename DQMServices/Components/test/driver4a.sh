...
cmsDriver.py SingleMuPt10_pythia8_cfi.py -s GEN,SIM,RECOBEFMIX,DIGI:pdigi_valid,L1,L1Reco,RECO,EI,HLT:@fake,VALIDATION --fast --pileup=NoPileUp  --geometry DB --conditions=auto:run1_mc --eventcontent=FEVTDEBUGHLT,DQM --datatier FEVTDEBUGHLT,DQMIO -n ${numev} --no_exec --python_filename=test_${tnum}_${step}_1.py --customise DQMServices/Components/test/customFEVTDEBUGHLT.py  --fileout file:test_${tnum}_${step}_1.root
