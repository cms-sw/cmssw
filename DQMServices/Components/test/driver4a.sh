...
cmsDriver.py SingleMuPt10_cfi.py -s GEN,SIM,RECO,HLT:GRun,VALIDATION --fast --pileup=NoPileUp  --geometry DB --conditions=auto:startup_GRun --eventcontent=FEVTDEBUGHLT,DQM --datatier GEN-SIM-DIGI-RECO,DQMROOT -n ${numev} --no_exec --python_filename=test_${tnum}_${step}_1.py --customise DQMServices/Components/test/customFEVTDEBUGHLT.py  --fileout file:test_${tnum}_${step}_1.root
