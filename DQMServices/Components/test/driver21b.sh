...
cmsDriver.py test_${tnum}_${step}_1 -s HARVESTING:dqmHarvesting --conditions auto:com10 --datatier DQMROOT --filetype DQM --data --filein "file:test_${tnum}_a_1_${rnum}_RAW2DIGI_RECO_DQM.root"  --scenario pp --customise_commands="process.dqmSaver.saveByLumiSection = cms.untracked.int32(1)\nprocess.dqmSaver.workflow = cms.untracked.string('/Jet/Run2011A-BoundaryTest-HighMET-06Oct2011-44-v1CJ/DQM')" --no_exec --python_filename=test_${tnum}_${step}_1.py
