...
do
  ...
  echo -e "   ***   ${COLOR_WARN}RUNNING TEST 9 on ${bookIn} with OPTION $postfix${COLOR_NORMAL}   ***   "
  ...
  compare_using_files.py DQM_V0001_R000999999__Test__{,Merged_}File1_File2_File3__DQM.root -C -s b2b -t 0.999999 2> /dev/null | grep 'Successes: 100.00%'
