...
do
  ...
  compare_using_files.py DQM_V0001_R000000001__Test__{,Merged_}File1_File2_File3_oldf__DQM.root -C -s b2b -t 0.999999 2> /dev/null | grep 'Successes: 100.00%'
  compare_using_files.py DQM_V0001_R000000002__Test__{,Merged_}File1_File2_File3_oldf__DQM.root -C -s b2b -t 0.999999 2> /dev/null | grep 'Successes: 100.00%'
