...
cmsDriver.py test_${tnum}_${step}_1 -s ${DQMSEQUENCE} --conditions auto:com10 --filetype DQM  --filein file:test_${tnum}_a_1_RAW2DIGI_RECO_DQM_inDQM.root --data --customise DQMServices/Components/test/customHarvesting.py --no_exec --python_filename=test_${tnum}_${step}_1.py
...
cmsDriver.py test_${tnum}_${step}_2 -s ${DQMSEQUENCE} --conditions auto:com10 --filetype DQM  --filein file:test_${tnum}_a_2_RAW2DIGI_RECO_DQM_inDQM.root --data --customise DQMServices/Components/test/customHarvesting.py --no_exec --python_filename=test_${tnum}_${step}_2.py
...
cmsDriver.py test_${tnum}_${step}_3 -s ${DQMSEQUENCE} --conditions auto:com10 --filetype DQM  --filein file:test_${tnum}_a_3_RAW2DIGI_RECO_DQM_inDQM.root --data --customise DQMServices/Components/test/customHarvesting.py --no_exec --python_filename=test_${tnum}_${step}_3.py
