...
cmsDriver.py test_${tnum}_${step}_1 -s ${DQMSEQUENCE} --harvesting AtJobEnd --conditions auto:mc --filein file:test_${tnum}_a_1.root --mc --customise DQMServices/Components/test/customHarvesting.py --no_exec --python_filename=test_${tnum}_${tnum}_1.py
