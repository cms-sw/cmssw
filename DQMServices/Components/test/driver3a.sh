...
cmsDriver.py SingleMuPt10_pythia8.cfi -s GEN,SIM,DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@fake -n ${numev} --eventcontent FEVTDEBUGHLT --datatier FEVTDEBUGHLT --conditions auto:run1_mc --mc --no_exec --python_filename=test_${tnum}_${step}_1.py
