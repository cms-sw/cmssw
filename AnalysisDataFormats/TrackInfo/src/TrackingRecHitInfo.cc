...
const LocalVector TrackingRecHitInfo::localTrackMomentumOnMono(TrackingRecHitInfo::StateType statetype) const {
...
const LocalVector TrackingRecHitInfo::localTrackMomentumOnStereo(TrackingRecHitInfo::StateType statetype)const {
  TrackingStates::const_iterator state=states_.find(statetype);
...
const LocalPoint TrackingRecHitInfo::localTrackPositionOnMono(TrackingRecHitInfo::StateType statetype) const {
  TrackingStates::const_iterator state=states_.find(statetype);
...
const LocalPoint TrackingRecHitInfo::localTrackPositionOnStereo(TrackingRecHitInfo::StateType statetype)const {
  TrackingStates::const_iterator state=states_.find(statetype);
...
const PTrajectoryStateOnDet * TrackingRecHitInfo::stateOnDet(TrackingRecHitInfo::StateType statetype)const {
  TrackingStates::const_iterator state=states_.find(statetype);
