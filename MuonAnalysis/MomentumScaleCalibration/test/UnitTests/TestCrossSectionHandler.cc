...
public:
  ...
  void testSetParameters() {
    ...
    crossSectionHandler_1->setParameters(
        Start, Step, Mini, Maxi, ind, parname, crossSection, crossSectionOrder, resfind_1);
  ...
  std::vector<double> expandCrossSectionVec(const std::vector<double>& relativeCrossSectionVec,
                                            const std::vector<int>& resfind) {
