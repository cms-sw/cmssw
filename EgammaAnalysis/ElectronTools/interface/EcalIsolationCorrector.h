...
class EcalIsolationCorrector {
 public:
  ...
  float correctForNoise(const reco::GsfElectron& e, bool isData=false, float intL_AB=5.5, float intL_C=6.7, float intL_D=7.3);
  ...
  // Global correction for ABCD together
  float correctForHLTDefinition(const reco::GsfElectron& e, bool isData=false, float intL_AB=5.5, float intL_C=6.7, float intL_D=7.3);
  // Run dependent correction
  ...
  // Global correction for ABCD together
  float correctForNoise(const reco::Photon& p, bool isData=false, float intL_AB=5.5, float intL_C=6.7, float intL_D=7.3);
  // Run dependent correction
  ...
  // Global correction for ABCD together
  float correctForHLTDefinition(const reco::Photon& p, bool isData=false, float intL_AB=5.5, float intL_C=6.7, float intL_D=7.3);
  // Run dependent correction
  ...
  // Global correction for ABCD together
  float correctForNoise(const pat::Electron& e, bool isData=false, float intL_AB=5.5, float intL_C=6.7, float intL_D=7.3);
  // Run dependent correction
  ...
  // Global correction for ABCD together
  float correctForHLTDefinition(const pat::Electron& e, bool isData=false, float intL_AB=5.5, float intL_C=6.7, float intL_D=7.3);
  // Run dependent correction
  ...
  // Global correction for ABCD together
  float correctForNoise(const pat::Photon& p, bool isData=false, float intL_AB=5.5, float intL_C=6.7, float intL_D=7.3);
  // Run dependent correction
  ...
  // Global correction for ABCD together
  float correctForHLTDefinition(const pat::Photon& p, bool isData=false, float intL_AB=5.5, float intL_C=6.7, float intL_D=7.3);
  // Run dependent correction
