...
class PatEleSCEtaMultiRangeCut : public CutApplicatorBase {
public:
  PatEleSCEtaMultiRangeCut(const edm::ParameterSet& c) :
    CutApplicatorBase(c),
  ...
  result_type operator()(const pat::Electron&) const override final;
...
DEFINE_EDM_PLUGIN(CutApplicatorFactory,
		  PatEleSCEtaMultiRangeCut,
		  "PatEleSCEtaMultiRangeCut");

CutApplicatorBase::result_type 
PatEleSCEtaMultiRangeCut::
operator()(const pat::Electron& cand) const{
