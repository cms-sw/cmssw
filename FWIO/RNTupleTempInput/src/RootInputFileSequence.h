#ifndef FWIO_RNTupleTempInput_RootInputFileSequence_h
#define FWIO_RNTupleTempInput_RootInputFileSequence_h
...
used by RNTupleTempSource and EmbeddedRNTypleTempSource. It uses an InputFileCatalog
