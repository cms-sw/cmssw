...
parser.add_argument("--process", default="MERGE", help="Process name")
parser.add_argument("--file", action="append", type=str, help="Files to merge")
parser.add_argument("--output", default="merged_files.rntpl", help="Output file name")
