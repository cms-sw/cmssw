...
def createLumi(dbsession):
    ...
    runsummary.insertColumn('STARTORBIT','unsigned long long')
    runsummary.insertColumn('ENDORBIT','unsigned long long')
    ...
    summary.insertColumn('RUNNUM','unsigned long')
    summary.insertColumn('CMSLSNUM','unsigned long')
    summary.insertColumn('LUMILSNUM','unsigned long')
    ...
    summary.insertColumn('STARTORBIT','unsigned long')
    ...
    hlt.insertColumn( 'INPUTCOUNT','unsigned long long')
    hlt.insertColumn( 'ACCEPTCOUNT','unsigned long long')
