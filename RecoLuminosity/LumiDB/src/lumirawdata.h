#ifndef RecoLuminosity_LumiDB_LUMIRAWDATA_H
#define RecoLuminosity_LumiDB_LUMIRAWDATA_H
/*
...
namespace HCAL_HLX{
  ...
  struct ET_SUM_NIBBLE {
    ...
    uint32_t data[MAX_BUNCHES];
  };
  
  struct OCCUPANCY_NIBBLE {
    LUMI_NIBBLE_HEADER hdr;
    uint16_t data[6][MAX_BUNCHES];
  };

  struct LHC_NIBBLE {
    LUMI_NIBBLE_HEADER hdr;
    uint16_t data[MAX_BUNCHES];
  };
  ...
  struct ET_SUM_SECTION {
    ...
    float data[MAX_BUNCHES];
  };

  struct OCCUPANCY_SECTION {
    LUMI_SECTION_SUB_HEADER hdr;
    uint32_t data[6][MAX_BUNCHES];
  };
  ...
  struct LUMI_SECTION {
    ...
    ET_SUM_SECTION etSum[MAX_HLXS];
    OCCUPANCY_SECTION occupancy[MAX_HLXS];
    LHC_SECTION lhc[MAX_HLXS];
  };
...
#endif //RecoLuminosity_LumiDB_LUMIRAWDATA_H
