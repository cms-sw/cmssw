...
int main(int argc, char** argv){
  ...
  std::string lumidb("oracle://cms_orcoff_prep/cms_lumi_dev_offline");
  std::string runinfodb("oracle://cms_orcoff_prod/CMS_RUNINFO");
  std::string trgdb("oracle://cms_orcoff_prep/cms_lumi_dev_offline");
  std::string hltconfdb("oracle://cms_orcoff_prod/CMS_HLT");
