...
void DIPLumiProducer::fillsummarycache(unsigned int runnumber, unsigned int currentlsnum) {
...
void DIPLumiProducer::filldetailcache(unsigned int runnumber, unsigned int currentlsnum) {
  m_detailcache.clear();
