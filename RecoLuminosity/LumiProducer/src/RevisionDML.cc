...
void lumi::RevisionDML::insertLumiRunData(coral::ISchema& schema, const lumi::RevisionDML::LumiEntry& lumientry) {
...
void lumi::RevisionDML::insertTrgRunData(coral::ISchema& schema, const lumi::RevisionDML::TrgEntry& trgentry) {
...
void lumi::RevisionDML::insertHltRunData(coral::ISchema& schema, const lumi::RevisionDML::HltEntry& hltentry) {
...
unsigned long long lumi::RevisionDML::currentHFDataTagId(coral::ISchema& schema) {
  ...
  delete qHandle;
  if (!alltagids.empty()) {
    auto currentdatatagidIt = std::max_element(alltagids.begin(), alltagids.end());
    currentdatatagid = *currentdatatagidIt;
  }
  return currentdatatagid;
}

unsigned long long lumi::RevisionDML::HFDataTagIdByName(coral::ISchema& schema, const std::string& datatagname) {
