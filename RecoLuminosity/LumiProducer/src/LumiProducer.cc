...
// $Id: LumiProducer.cc,v 1.1 2007/07/13 20:13:40 wdd Exp $
...
void LumiProducer::beginLuminosityBlock(edm::LuminosityBlock &iLBlock, edm::EventSetup const &iSetup) {
  ...
  std::auto_ptr<LumiDetails> pOut2(new LumiDetails(
			  ...
			  lumiBlockPSet.getUntrackedParameter<std::vector<int> >("lumietsumqual", defvecd),
			  ...
			  lumiBlockPSet.getUntrackedParameter<std::vector<int> >("lumioccqual", defvecd) ) );
  iLBlock.put(pOut2);
