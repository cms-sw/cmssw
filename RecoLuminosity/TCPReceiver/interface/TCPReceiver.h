...
/*
   Error Codes
     ...
     201: invalid mode
        Acceptable modes are 0:  tcp data,  1: constant fake data, 2: random
fake data 301: socket() failed 302: connect() failed 401: Disconnect() called
without being connected 501: Failed to Receive Data from server 601; close()
failed
