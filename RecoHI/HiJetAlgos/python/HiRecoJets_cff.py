...
voronoiBackgroundCalo = cms.EDProducer('VoronoiBackgroundProducer',
                                       ...
                                       selfSubtract = cms.bool(False),
                                       selfSubtractAntiktDistance = cms.double(0.2),
                                       selfSubtractExclusionPtMin = cms.double(25.0),
                                       selfSubtractExclusionRadius = cms.double(0.4),
