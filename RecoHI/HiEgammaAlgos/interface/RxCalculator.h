...
class RxCalculator
{
  ...
  //RxCalculator(const edm::Event &iEvent, const edm::EventSetup &iSetup, edm::InputTag hbheLabel, edm::InputTag hfLabel, edm::InputTag hoLabel) ;
   RxCalculator(const edm::Event &iEvent, const edm::EventSetup &iSetup, edm::Handle<HBHERecHitCollection> hbhe, edm::Handle<HFRecHitCollection> hfLabel, edm::Handle<HORecHitCollection> hoLabel) ;
