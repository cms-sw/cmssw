...
class CxCalculator
{
  ...
  CxCalculator(const edm::Event &iEvent, const edm::EventSetup &iSetup, edm::Handle<reco::BasicClusterCollection> barrel, edm::Handle<reco::BasicClusterCollection> endcap);
