...
CxCalculator::CxCalculator(const edm::Event &iEvent, const edm::EventSetup &iSetup, edm::Handle<BasicClusterCollection> pEBclusters, edm::Handle<BasicClusterCollection> pEEclusters)
{
