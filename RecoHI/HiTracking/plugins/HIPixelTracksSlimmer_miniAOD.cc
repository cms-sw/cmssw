...
public:
  ...
  ~HIPixelTracksSlimmer_miniAOD() override;
...
void HIPixelTracksSlimmer_miniAOD::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;
  using namespace std;
...
void HIPixelTracksSlimmer_miniAOD::beginStream(edm::StreamID) {}

// ------------ method called once each stream after processing all runs, lumis and events  ------------
void HIPixelTracksSlimmer_miniAOD::endStream() {}
...
void HIPixelTracksSlimmer_miniAOD::addPackedCandidate(std::vector<pat::PackedCandidate>& cands,
                                                      const reco::TrackRef& trk,
                                                      const reco::VertexRef& pvSlimmed,
                                                      const reco::VertexRefProd& pvSlimmedColl,
                                                      bool passPixelTrackSel) const {
...
void HIPixelTracksSlimmer_miniAOD::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
