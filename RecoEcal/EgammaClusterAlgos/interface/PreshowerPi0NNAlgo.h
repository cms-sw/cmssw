#ifndef RecoEcal_EgammaClusterAlgos_PreshowerPi0NNAlgo_h
#define RecoEcal_EgammaClusterAlgos_PreshowerPi0NNAlgo_h
//
// $Id: PreshowerPi0NNAlgo.h,v 1.2 2006/07/11 18:02:54 kyriakis Exp $
//
...
class PreshowerPi0NNAlgo {
 ...
 public:
   ...
   PreshowerPi0NNAlgo(double stripEnergyCut, int nStripCut, DebugLevel_pi0 debugLevel = pINFO ) :
