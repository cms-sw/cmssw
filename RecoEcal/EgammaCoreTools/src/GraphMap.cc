...
const GraphMap::GraphOutput &GraphMap::collectNodes(const GraphMap::CollectionStrategy strategy,
...
void GraphMap::mergeSubGraphs(const float threshold,
                              const GraphOutput &cat1NodesGraph,
