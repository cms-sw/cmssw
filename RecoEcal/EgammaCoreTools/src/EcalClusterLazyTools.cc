...
//EcalClusterLazyToolsBase::EcalClusterLazyToolsBase( const edm::Event &ev, const edm::EventSetup &es, const edm::InputTag& redEBRecHits, const edm::InputTag& redEERecHits,const edm::ParameterSet& config )
EcalClusterLazyToolsBase::EcalClusterLazyToolsBase( const edm::Event &ev, const edm::EventSetup &es, const edm::InputTag& redEBRecHits, const edm::InputTag& redEERecHits)
{
        getGeometry( es );
        getTopology( es );
...
EcalClusterLazyToolsBase::EcalClusterLazyToolsBase( const edm::Event &ev, const edm::EventSetup &es, const edm::InputTag& redEBRecHits, const edm::InputTag& redEERecHits, const edm::InputTag& redESRecHits)
{
        getGeometry( es );
        getTopology( es );
        getEBRecHits( ev, redEBRecHits );
...
void EcalClusterLazyToolsBase::getEBRecHits( const edm::Event &ev, const edm::InputTag& redEBRecHits )
{
...
void EcalClusterLazyToolsBase::getEERecHits( const edm::Event &ev, const edm::InputTag& redEERecHits )
{
...
void EcalClusterLazyToolsBase::getESRecHits( const edm::Event &ev, const edm::InputTag& redESRecHits )
{
