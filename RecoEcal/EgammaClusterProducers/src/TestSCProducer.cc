...
TestSCProducer::TestSCProducer(const edm::ParameterSet& ps)
{
...
TestSCProducer::~TestSCProducer()
{
  std::cout << "Destructor of TestSCProducer called!" << std::endl;
}


void TestSCProducer::produce(edm::Event& evt, const edm::EventSetup& es)
{
