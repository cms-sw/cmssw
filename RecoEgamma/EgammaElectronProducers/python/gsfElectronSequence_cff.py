...
_gsfEcalDrivenElectronSequenceFromMC = gsfEcalDrivenElectronSequence.copy()
_gsfEcalDrivenElectronSequenceFromMC += cms.Sequence(ecalDrivenGsfElectronCoresFromMC*ecalDrivenGsfElectronsFromMC)
...
phase2_hgcal.toReplaceWith(
  gsfEcalDrivenElectronSequence, _gsfEcalDrivenElectronSequenceFromMC
)
