...
gedGsfElectronsTmp = cms.EDProducer("GEDGsfElectronProducer",
    ...
    maxHOverEBarrelPflowCone = cms.double(999999999.),
    maxHOverEEndcapsPflowCone = cms.double(999999999.),
    maxHBarrelPflowCone = cms.double(0.0),
    maxHEndcapsPflowCone = cms.double(0.0),
    maxHOverEBarrelPflowTower = cms.double(999999999.),
    maxHOverEEndcapsPflowTower = cms.double(999999999.),
    maxHBarrelPflowTower = cms.double(0.0),
    maxHEndcapsPflowTower = cms.double(0.0),
