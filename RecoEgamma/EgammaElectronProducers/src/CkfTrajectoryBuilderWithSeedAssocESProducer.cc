//#include "RecoTracker/CkfPattern/interface/CkfTrajectoryBuilderWithSeedAssocESProducer.h"
...
CkfTrajectoryBuilderWithSeedAssocESProducer::CkfTrajectoryBuilderWithSeedAssocESProducer(const edm::ParameterSet & p) 
{ 
