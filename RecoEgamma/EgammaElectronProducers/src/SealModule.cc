...
//temporary: #include "RecoEgamma/EgammaElectronProducers/interface/PixelMatchElectronProducer.h"
...
//temporary: DEFINE_ANOTHER_FWK_MODULE(PixelMatchElectronProducer);
