...
// $Id: GsfElectronDataAnalyzer.cc,v 1.10 2008/12/11 23:29:35 charlot Exp $
//
//
...
void GsfElectronDataAnalyzer::beginJob(edm::EventSetup const&iSetup){
  ...
  h_ele_matchingObjectPt_matched       = new TH1F( "h_ele_matchingObjectPt_matched",       "matching SC p_{T}",  nbinpteff,5.,ptmax);
  ...
  h_ele_matchingObjectAbsEta_matched      = new TH1F( "h_ele_matchingObjectAbsEta_matched",      "matching SC |#eta|",    nbineta/2,0.,2.5);
  h_ele_matchingObjectEta_matched      = new TH1F( "h_ele_matchingObjectEta_matched",      "matching SC #eta",    nbineta,etamin,etamax);
  h_ele_matchingObjectPhi_matched               = new TH1F( "h_ele_matchingObjectPhi_matched", "matching SC phi",        nbinphi,phimin,phimax); 
  ...
  h_ele_matchingObjectZ_matched      = new TH1F( "h_ele_matchingObjectZ_matched",      "matching SC z",    nbinxyz,-25,25);
  ...
  h_ele_PoPmatchingObject        = new TH1F( "h_ele_PoPmatchingObject",        "ele P/P_{matching SC} @ vertex", 75,0.,1.5);
  h_ele_PoPmatchingObjectVsEta   = new TH2F( "h_ele_PoPmatchingObjectVsEta",        "ele P/P_{matching SC} @ vertex vs eta", nbineta2D,etamin,etamax,50,0.,1.5);
  h_ele_PoPmatchingObjectVsPhi   = new TH2F( "h_ele_PoPmatchingObjectVsPhi",        "ele P/P_{matching SC} @ vertex vs phi", nbinphi2D,phimin,phimax,50,0.,1.5);
  h_ele_PoPmatchingObjectVsPt   = new TH2F( "h_ele_PoPmatchingObjectVsPt",        "ele P/P_{matching SC} @ vertex vs eta", nbinpt2D,0.,ptmax,50,0.,1.5);
  h_ele_PoPmatchingObject_barrel         = new TH1F( "h_ele_PoPmatchingObject_barrel",        "ele P/P_{matching SC} @ vertex, barrel",75,0.,1.5);
  h_ele_PoPmatchingObject_endcaps        = new TH1F( "h_ele_PoPmatchingObject_endcaps",        "ele P/P_{matching SC} @ vertex, endcaps",75,0.,1.5);
  h_ele_EtaMnEtamatchingObject   = new TH1F( "h_ele_EtaMnEtamatchingObject",   "ele #eta_{rec} - #eta_{matching SC} @ vertex",nbindeta,detamin,detamax);
  h_ele_EtaMnEtamatchingObjectVsEta   = new TH2F( "h_ele_EtaMnEtamatchingObjectVsEta",   "ele #eta_{rec} - #eta_{matching SC} @ vertex vs eta",nbineta2D,etamin,etamax,nbindeta/2,detamin,detamax);
  h_ele_EtaMnEtamatchingObjectVsPhi   = new TH2F( "h_ele_EtaMnEtamatchingObjectVsPhi",   "ele #eta_{rec} - #eta_{matching SC} @ vertex vs phi",nbinphi2D,phimin,phimax,nbindeta/2,detamin,detamax);
  h_ele_EtaMnEtamatchingObjectVsPt   = new TH2F( "h_ele_EtaMnEtamatchingObjectVsPt",   "ele #eta_{rec} - #eta_{matching SC} @ vertex vs pt",nbinpt,0.,ptmax,nbindeta/2,detamin,detamax);
  h_ele_PhiMnPhimatchingObject   = new TH1F( "h_ele_PhiMnPhimatchingObject",   "ele #phi_{rec} - #phi_{matching SC} @ vertex",nbindphi,dphimin,dphimax);
  h_ele_PhiMnPhimatchingObject2   = new TH1F( "h_ele_PhiMnPhimatchingObject2",   "ele #phi_{rec} - #phi_{matching SC} @ vertex",nbindphimatch2D,dphimatchmin,dphimatchmax);
  h_ele_PhiMnPhimatchingObjectVsEta   = new TH2F( "h_ele_PhiMnPhimatchingObjectVsEta",   "ele #phi_{rec} - #phi_{matching SC} @ vertex vs eta",nbineta2D,etamin,etamax,nbindphi/2,dphimin,dphimax);
  h_ele_PhiMnPhimatchingObjectVsPhi   = new TH2F( "h_ele_PhiMnPhimatchingObjectVsPhi",   "ele #phi_{rec} - #phi_{matching SC} @ vertex vs phi",nbinphi2D,phimin,phimax,nbindphi/2,dphimin,dphimax);
  ...
  histSclEoEmatchingObject_barrel = new TH1F("h_scl_EoEmatchingObject_barrel","ele SC energy over matching SC energy, barrel",50,0.2,1.2);
  histSclEoEmatchingObject_endcaps = new TH1F("h_scl_EoEmatchingObject_endcaps","ele SC energy over matching SC energy, endcaps",50,0.2,1.2);
  ...
  histSclEoEmatchingObjectShowering0_barrel = new TH1F("h_scl_EoEmatchingObject showering0, barrel","ele supercluster energy over matchingObject energy, showering0, barrel",100,0.2,1.2);
  histSclEoEmatchingObjectShowering0_endcaps = new TH1F("h_scl_EoEmatchingObject showering0, endcaps","ele supercluster energy over matchingObject energy, showering0, endcaps",100,0.2,1.2);
  histSclEoEmatchingObjectShowering1234_barrel = new TH1F("h_scl_EoEmatchingObject showering1234, barrel","ele supercluster energy over matchingObject energy, showering1234, barrel",100,0.2,1.2);
  histSclEoEmatchingObjectShowering1234_endcaps = new TH1F("h_scl_EoEmatchingObject showering1234, endcaps","ele supercluster energy over matchingObject energy, showering1234, endcaps",100,0.2,1.2);
  ...
  // histos titles
  h_matchingObjectNum              -> GetXaxis()-> SetTitle("# SCs");
  h_matchingObjectEta             -> GetXaxis()-> SetTitle("SC #eta");
  h_matchingObjectP               -> GetXaxis()-> SetTitle("SC p (GeV/c)");
  ...
  h_ele_PoPmatchingObject        -> GetXaxis()-> SetTitle("P/P_{SC}");
  h_ele_EtaMnEtamatchingObject   -> GetXaxis()-> SetTitle("#eta_{rec} - #eta_{SC}");
  h_ele_PhiMnPhimatchingObject   -> GetXaxis()-> SetTitle("#phi_{rec} - #phi_{SC}");
  ...
  h_ele_EseedOP            -> GetXaxis()-> SetTitle("E_seed}/p_{vertex}");
