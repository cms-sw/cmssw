#ifndef PixelMatchGsfElectronAnalyzer_h
#define PixelMatchGsfElectronAnalyzer_h
  
//
// Package:         RecoEgamma/Exmaples
...
// $Id: PixelMatchGsfElectronAnalyzer.h,v 1.3 2007/06/29 09:25:55 charlot Exp $
//
//
...
class PixelMatchGsfElectronAnalyzer : public edm::EDAnalyzer
{
 public:
  
  explicit PixelMatchGsfElectronAnalyzer(const edm::ParameterSet& conf);
  
  virtual ~PixelMatchGsfElectronAnalyzer();
