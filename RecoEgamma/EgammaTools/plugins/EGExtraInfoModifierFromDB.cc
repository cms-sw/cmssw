...
private:
  ...
  edm::Handle<EcalRecHitCollection > ecalRecHitsEB_;
  edm::Handle<EcalRecHitCollection > ecalRecHitsEE_;
...
void EGExtraInfoModifierFromDB::setConsumes(edm::ConsumesCollector& sumes) {
  ...
  ecalRecHitEBToken_ = sumes.consumes<EcalRecHitCollection > ( ecalRecHitEBTag_ );
  ecalRecHitEEToken_ = sumes.consumes<EcalRecHitCollection > ( ecalRecHitEETag_ );
