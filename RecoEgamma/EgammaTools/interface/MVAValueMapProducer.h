...
namespace {
  ...
  inline auto getMVAEstimators(const edm::VParameterSet& vConfig) {
  ...
  inline std::vector<std::string> getValueMapNames(const edm::VParameterSet& vConfig, std::string&& suffix) {
