...
//copy of RecoEcal / EgammaCoreTools / src/ Mustache.cc with Modification of function for Mustache ECorr variables by Rishi Patel  rpatel@cern.ch
...
void Mustache::MustacheID(std::vector<CaloCluster>clusters, std::vector<unsigned int>& insideMust, std::vector<unsigned int>& outsideMust)
{
