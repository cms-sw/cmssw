...
public:
  ...
  std::vector<std::array<float, ElectronDNNEstimator::nOutputs>> evaluate(
      const reco::GsfElectronCollection& ele, const std::vector<tensorflow::Session*> session) const;
