...
void ElectronMVAEstimatorRun2Fall17iso::setConsumes(edm::ConsumesCollector&& cc) const {
...
int ElectronMVAEstimatorRun2Fall17iso::findCategory( const edm::Ptr<reco::Candidate>& particle) const {
...
int ElectronMVAEstimatorRun2Fall17iso::findCategory( const reco::GsfElectron * eleRecoPtr ) const {
...
bool ElectronMVAEstimatorRun2Fall17iso::
...
void ElectronMVAEstimatorRun2Fall17iso::constrainMVAVariables(std::vector<float>& vars) const {
