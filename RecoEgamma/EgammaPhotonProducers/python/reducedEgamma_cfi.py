...
reducedEgamma = cms.EDProducer("ReducedEGProducer",
  keepPhotons = cms.string("(pt > 14 && hadTowOverEm()<0.15) || (pt>10 && pt<14 && chargedHadronIso()<10)"), #keep in output
  slimRelinkPhotons = cms.string("(pt > 14 && hadTowOverEm()<0.15) || (pt>10 && pt<14 && chargedHadronIso()<10)"), #keep only slimmed SuperCluster plus seed cluster
