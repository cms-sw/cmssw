#ifndef RecoEgamma_EgammaPhotonProducerHGCals_PhotonProducerHGCal_h
#define RecoEgamma_EgammaPhotonProducerHGCals_PhotonProducerHGCal_h
...
class PhotonProducerHGCal : public edm::stream::EDProducer<> {
 public:
  PhotonProducerHGCal(const edm::ParameterSet& ps);
  ~PhotonProducerHGCal();

  virtual void beginRun(edm::Run const& r,
                        edm::EventSetup const& es) override final;
  virtual void endRun(edm::Run const&, edm::EventSetup const&) override final;
  virtual void produce(edm::Event& evt, const edm::EventSetup& es) override;

 private:
  void fillPhotonCollection(
      ...
      reco::PhotonCollection& outputCollection, int& iSC,
