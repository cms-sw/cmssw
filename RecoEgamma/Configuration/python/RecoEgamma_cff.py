...
egammaHighLevelRecoPostPF = cms.Sequence(gsfElectronMergingSequence*gedElectronPFIsoSequence*interestingEgammaIsoDetIds*photonIDSequence*eIdSequence*hfEMClusteringSequence)
