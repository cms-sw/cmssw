...
import copy
from RecoEgamma.EgammaHLTProducers.hltEgammaRegionalCTFFinalFitWithMaterial_cfi import *
l1NonIsoEgammaRegionalCTFFinalFitWithMaterial = copy.deepcopy(hltEgammaRegionalCTFFinalFitWithMaterial)
l1NonIsoEgammaRegionalCTFFinalFitWithMaterial.src = 'l1NonIsoEgammaRegionalCkfTrackCandidates'
