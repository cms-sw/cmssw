...
import copy
from RecoEgamma.EgammaHLTProducers.hltEgammaRegionalCTFFinalFitWithMaterial_cfi import *
l1IsoEgammaRegionalCTFFinalFitWithMaterial = copy.deepcopy(hltEgammaRegionalCTFFinalFitWithMaterial)
l1IsoEgammaRegionalCTFFinalFitWithMaterial.src = 'l1IsoEgammaRegionalCkfTrackCandidates'
