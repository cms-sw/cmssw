...
# TrackProducer
#include "RecoEgamma/EgammaHLTProducers/data/hltEgammaRegionalCTFFinalFitWithMaterial.cfi"
l1IsoElectronsRegionalCTFFinalFitWithMaterial = copy.deepcopy(hltEgammaRegionalCTFFinalFitWithMaterial)
l1IsoElectronsRegionalCTFFinalFitWithMaterial.src = 'l1IsoElectronsRegionalCkfTrackCandidates'
