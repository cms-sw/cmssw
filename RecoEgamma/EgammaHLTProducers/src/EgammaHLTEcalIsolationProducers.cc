...
EgammaHLTEcalIsolationProducers::EgammaHLTEcalIsolationProducers(const edm::ParameterSet& config) : conf_(config)
{
...
void EgammaHLTEcalIsolationProducers::produce(edm::Event& iEvent, const edm::EventSetup& iSetup){
