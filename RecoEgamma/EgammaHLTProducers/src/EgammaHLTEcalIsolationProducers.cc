...
EgammaHLTEcalIsolationProducers::EgammaHLTEcalIsolationProducers(const edm::ParameterSet& iConfig)
{
...
void
EgammaHLTEcalIsolationProducers::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
