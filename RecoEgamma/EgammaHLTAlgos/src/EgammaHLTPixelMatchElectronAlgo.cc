...
void EgammaHLTPixelMatchElectronAlgo::process(const edm::Handle<TrackCollection>& tracksH, const edm::Handle<GsfTrackCollection>& gsfTracksH, ElectronCollection & outEle, Global3DPoint & bs) {
