...
class PFPhotonIsolationCalculator{
 ...
 std::vector<float > getIsolationInRingsChargedAll(){ return fIsolationInRingsChargedAll_; };
  ...
  //Veto implementation
  float isPhotonParticleVetoed(  reco::PFCandidateRef pfIsoCand );
  ...
  float isNeutralParticleVetoed( reco::PFCandidateRef pfIsoCand );
  //
  ...
  float isChargedParticleVetoed( reco::PFCandidateRef pfIsoCand,reco::VertexRef vtx, edm::Handle< reco::VertexCollection > vertices );
  ...
  float fGetIsolation(const reco::Photon* photon,  edm::Handle<reco::PFCandidateCollection> pfCandidateHandle ,reco::VertexRef vtx, edm::Handle< reco::VertexCollection > vertices );
