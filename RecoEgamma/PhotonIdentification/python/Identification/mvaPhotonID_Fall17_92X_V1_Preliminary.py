...
mvaFall1792XV1PreliminaryClassName = "PhotonMVAEstimatorRun2Fall1792XV1Preliminary"
...
mvaFall1792XV1PreliminaryWeightFiles_V1 = cms.vstring(
    "RecoEgamma/PhotonIdentification/data/Fall17/photon_general_MVA_Fall17_92X_V1_Preliminary_EB.weights.xml",
    "RecoEgamma/PhotonIdentification/data/Fall17/photon_general_MVA_Fall17_92X_V1_Preliminary_EE.weights.xml"
    )
...
mvaValueMapName        = mvaProducerModuleLabel + ":" + mvaFall1792XV1PreliminaryClassName + mvaTag + "Values"
mvaCategoriesMapName   = mvaProducerModuleLabel + ":" + mvaFall1792XV1PreliminaryClassName + mvaTag + "Categories"

# The working point for this MVA that is expected to have about 90% signal
# efficiency in each category for photons with pt>30 GeV (somewhat lower
# for lower pt photons).
idName = "mvaPhoID-Fall17-92X-V1-Preliminary-wp90"
...
# efficiency in each category for photons with pt>30 GeV (somewhat lower
# for lower pt photons).
idName = "mvaPhoID-Fall17-92X-V1-Preliminary-wp80"
...
mvaPhoID_Fall17_92X_V1_Preliminary_producer_config = cms.PSet( 
    mvaName            = cms.string(mvaFall1792XV1PreliminaryClassName),
    mvaTag             = cms.string(mvaTag),
    weightFileNames    = mvaFall1792XV1PreliminaryWeightFiles_V1,
    #
...
mvaPhoID_Fall17_92X_V1_Preliminary_wp90 = configureVIDMVAPhoID_V1( MVA_WP90 )
mvaPhoID_Fall17_92X_V1_Preliminary_wp80 = configureVIDMVAPhoID_V1( MVA_WP80 )
...
mvaPhoID_Fall17_92X_V1_Preliminary_wp90.isPOGApproved = cms.untracked.bool(False)
mvaPhoID_Fall17_92X_V1_Preliminary_wp80.isPOGApproved = cms.untracked.bool(False)
