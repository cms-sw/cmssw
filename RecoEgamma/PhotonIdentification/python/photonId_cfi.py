...
PhotonIDProd = cms.EDProducer("PhotonIDProducer",
    ...
    LooseEMEcalRecHitIsoEB = cms.double(999.9),
    LooseEMHcalRecHitIsoEB = cms.double(999.9),
    LooseEMR9CutEB = cms.double(0.0),
    #LoosePhoton cuts EB  
    LoosePhotonHollowTrkEB = cms.double(999.9),
    ...
    LoosePhotonEcalRecHitIsoEB = cms.double(999.9),
    LoosePhotonHcalRecHitIsoEB = cms.double(999.9),
    LoosePhotonR9CutEB = cms.double(0.0),
    #TightPhoton cuts EB
    TightPhotonHollowTrkEB = cms.double(999.9),
    ...
    TightPhotonEcalRecHitIsoEB = cms.double(999.9),
    TightPhotonHcalRecHitIsoEB = cms.double(999.9),
    ...
    LooseEMEcalRecHitIsoEE = cms.double(999.9),
    LooseEMHcalRecHitIsoEE = cms.double(999.9),
    LooseEMR9CutEE = cms.double(0.0),
    #LoosePhoton cuts EB  
    LoosePhotonHollowTrkEE = cms.double(999.9),
    ...
    LoosePhotonEcalRecHitIsoEE = cms.double(999.9),
    LoosePhotonHcalRecHitIsoEE = cms.double(999.9),
    LoosePhotonR9CutEE = cms.double(0.0),
    #TightPhoton cuts EB
    TightPhotonHollowTrkEE = cms.double(999.9),
    ...
    TightPhotonEcalRecHitIsoEE = cms.double(999.9),
    TightPhotonHcalRecHitIsoEE = cms.double(999.9),
