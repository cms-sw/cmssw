...
PhotonIDProd = cms.EDProducer("PhotonIDProducer",
    ...
    #LoosePhoton cuts EB
    LoosePhotonEcalIsoRelativeCutSlopeEB = cms.double(0.0045),
    ...
    #TightPhoton cuts EB
    TightPhotonEcalIsoRelativeCutSlopeEB = cms.double(0.0045),
    ...
    #LoosePhoton cuts EE
    LoosePhotonEcalIsoRelativeCutSlopeEE = cms.double(0.023),
    ...
    #TightPhoton cuts EE
    TightPhotonEcalIsoRelativeCutSlopeEE = cms.double(0.023),
