...
PhotonIDProd = cms.EDProducer("PhotonIDProducer",
    ...
    #LoosePhoton cuts EB
    LoosePhotonEcalIsoRelativeCutSlopeEB = cms.double(0.),
    ...
    #TightPhoton cuts EB
    TightPhotonEcalIsoRelativeCutSlopeEB = cms.double(0.),
    ...
    TightPhotonEtaWidthEB=cms.double(0.01),
    TightPhotonHadOverEMEB=cms.double(0.15),
    TightPhotonR9CutEB=cms.double(0.0),
    #LoosePhoton cuts EE
    LoosePhotonEcalIsoRelativeCutSlopeEE = cms.double(0.),
    ...
    #TightPhoton cuts EE
    TightPhotonEcalIsoRelativeCutSlopeEE = cms.double(0.),
    ...
    TightPhotonEtaWidthEE=cms.double(0.01),
