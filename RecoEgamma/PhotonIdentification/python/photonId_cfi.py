...
PhotonIDProd = cms.EDProducer("PhotonIDProducer",
    ...
    LooseEMHollowTrkOffsetEB=cms.double(9999.),
    LooseEMSolidTrkSlopeEB=cms.double(0.),
    LooseEMSolidTrkOffsetEB=cms.double(999.),
    LooseEMSolidTrkEB=cms.double(999.),
    LooseEMSolidNTrkEB=cms.int32(999),
    LooseEMHollowNTrkEB=cms.int32(999),
    LooseEMEtaWidthEB=cms.double(999.),
    ...
    LooseEMHollowTrkOffsetEE=cms.double(9999.),
    LooseEMSolidTrkSlopeEE=cms.double(0.),
    LooseEMSolidTrkOffsetEE=cms.double(999.),
    LooseEMSolidTrkEE=cms.double(999.),
    LooseEMSolidNTrkEE=cms.int32(999),
    LooseEMHollowNTrkEE=cms.int32(999),
    LooseEMEtaWidthEE=cms.double(999.),
