...
GsfElectronAlgo::EventData GsfElectronAlgo::beginEvent(edm::Event const& event,
  ...
  EventData eventData{
      ...
      .hadIsolation03 =
      EgammaHcalIsolation(EgammaHcalIsolation::InclusionRule::withinConeAroundCluster, egHcalIsoConeSizeOutSmall,
                          EgammaHcalIsolation::InclusionRule::withinConeAroundCluster, egHcalIsoConeSizeIn,
      ...
      .hadIsolation04 =
      EgammaHcalIsolation(EgammaHcalIsolation::InclusionRule::withinConeAroundCluster, egHcalIsoConeSizeOutLarge,
                          EgammaHcalIsolation::InclusionRule::withinConeAroundCluster, egHcalIsoConeSizeIn,
                          std::array<double, 4>{{0., 0., 0., 0.}},
                          std::array<double, 4>{{egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin}},
                          hcalHelperCone_.maxSeverityHB(),
      ...
      .hadIsolation03Bc =
      EgammaHcalIsolation(EgammaHcalIsolation::InclusionRule::withinConeAroundCluster, egHcalIsoConeSizeOutSmall,
                          EgammaHcalIsolation::InclusionRule::isBehindClusterSeed, 0.,
                          std::array<double, 4>{{0., 0., 0., 0.}},
                          std::array<double, 4>{{egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin}},
                          hcalHelperCone_.maxSeverityHB(),
                          std::array<double, 7>{{0., 0., 0., 0., 0., 0., 0.}},
