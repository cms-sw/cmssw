...
int main(int ac, char* av[]) {
  ...
  try {
    ...
    desc.add_options()("help,h", "produce help message")("input-file,i", po::value<string>(&file), "input file")(
        "num,n", po::value<string>(&num), "numHisto")("den,d", po::value<string>(&den), "denHisto")(
        "plotname,o", po::value<string>(&pname), "plot name")(
        "rebin,r", po::value<unsigned int>(&rebin)->default_value(1), "rebin")(
        "plot-format,p", po::value<string>(&ext)->default_value("gif"), "output plot format");
