...
int main(int ac, char *av[]) {
  ...
  try {
    ...
    desc.add_options()("help,h", "produce help message")("input-file,i", po::value<string>(&file), "input file")(
        ...
        "denDATA,d", po::value<string>(&denDATA), "denHistoDATA")("numMC,m", po::value<string>(&numMC), "MCnumHisto")(
        "denMC,e", po::value<string>(&denMC), "MCdenHisto")("plotname,o", po::value<string>(&pname), "plot name")(
