...
#include <string>
  ...
  THStack * hs = new THStack("hs","#mu #mu invariant mass distribution");
...
double lumiT = 10.;
  ...
  TH1F *h1 = (TH1F*)z.Get("goodZToMuMu2HLTPlots/zMass");
  h1->SetFillColor(kRed);
  h1->SetLineColor(kRed);

  h1->Scale(lumi/lumiZ);
  double i1 = h1->Integral(60,120);
  TH1F *h2 = (TH1F*)w.Get("goodZToMuMu2HLTPlots/zMass");
  ...
  TH1F *h3 = (TH1F*)tt.Get("goodZToMuMu2HLTPlots/zMass");
...
TH1F *h4 = (TH1F*)qcd.Get("goodZToMuMu2HLTPlots/zMass");
