...
#include <string>
  ...
  TH1F *h1 = (TH1F*)z.Get("goodZToMuMuOneStandAloneMuonPlots/zMass");
  ...
  h1->Rebin(rebin);
  TH1F *h2 = (TH1F*)w.Get("goodZToMuMuOneStandAloneMuonPlots/zMass");
  ...
  TH1F *h3 = (TH1F*)tt.Get("goodZToMuMuOneStandAloneMuonPlots/zMass");
  ...
  //  h1->Scale(0.7509);
    h3->Rebin(rebin);  
TH1F *h4 = (TH1F*)qcd.Get("goodZToMuMuOneStandAloneMuonPlots/zMass");
