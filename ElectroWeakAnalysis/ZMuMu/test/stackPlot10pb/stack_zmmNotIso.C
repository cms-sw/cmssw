...
#include <string>
  ...
  TH1F *h1 = (TH1F*)z.Get("nonIsolatedZToMuMuPlots/zMass");
  ...
  TH1F *h2 = (TH1F*)w.Get("nonIsolatedZToMuMuPlots/zMass");
  ...
  TH1F *h3 = (TH1F*)tt.Get("nonIsolatedZToMuMuPlots/zMass");
...
TH1F *h4 = (TH1F*)qcd.Get("nonIsolatedZToMuMuPlots/zMass");
