...
// different scenarius form 0.1 to 10 pb....
  ...
  TH1F *h1 = (TH1F*)z.Get("goodZToMuMuOneTrackerMuonPlots/zMass");
  ...
  TH1F *h2 = (TH1F*)w.Get("goodZToMuMuOneTrackerMuonPlots/zMass");
  ...
  TH1F *h3 = (TH1F*)tt.Get("goodZToMuMuOneTrackerMuonPlots/zMass");
...
TH1F *h4 = (TH1F*)qcd.Get("goodZToMuMuOneTrackerMuonPlots/zMass");
