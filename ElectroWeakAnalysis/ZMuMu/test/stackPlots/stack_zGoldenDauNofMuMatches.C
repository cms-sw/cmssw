...
void stack_zGoldenDauNofMuMatches() {
  ...
  makePlots("zGoldenDau1NofMuMatches", "zGoldenDau2NofMuMatches",  massCut + kin_common ,  1, "zGoldenDauNofMuMatches",  0.001, 12, -0.5 ,11.5, true, false);
  ...
  //  c1->SaveAs("zGoldenDauNofMuMatches.pdf");
  ...
  //TCut Invcut("zGoldenMass>60 && zGoldenMass<120 &&  zGoldenDau1Pt> 20 && zGoldenDau2Pt>20 && zGoldenDau1TrkIso< 3.0 && zGoldenDau1TrkIso < 3.0 && abs(zGoldenDau1Eta)<2.4 &&  abs(zGoldenDau2Eta)<2.4 && zGoldenDau1Chi2<10&& zGoldenDau2Chi2<10 && abs(zGoldenDau1dxyFromBS)<0.2 && abs(zGoldenDau2dxyFromBS)<0.2 && ( zGoldenDau1NofStripHits + zGoldenDau1NofPixelHits)>9 && zGoldenDau1NofPixelHits>0 && ( zGoldenDau2NofStripHits + zGoldenDau2NofPixelHits)>9 &&  zGoldenDau2NofPixelHits>0 && zGoldenDau1NofMuonHits>0 && zGoldenDau2NofMuonHits>0 && zGoldenDau1NofMuMatches<2 && zGoldenDau2NofMuMatches<2  && zGoldenDau1TrackerMuonBit==1 && zGoldenDau2TrackerMuonBit==1 && (zGoldenDau1HLTBit==1 || zGoldenDau2HLTBit==1) ");


  //evalEff("zGoldenDau1NofMuMatches", "zGoldenDau2NofMuMatches",  cut_zGolden, Ncut,  100, -0.5, 99.5); 
  //evalEff("zGoldenDau1HLTBit", "zGoldenDau2HLTBit",  cut_zGolden, Invcut,  1, 0.5, 1.5); 
  //evalEff("zGoldenDau1HLTBit", "zGoldenDau2HLTBit",  cut_zGolden, Invcut,  1, -0.5, 0.5); 
