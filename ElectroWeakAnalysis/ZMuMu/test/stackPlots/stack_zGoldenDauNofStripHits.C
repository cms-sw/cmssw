...
void stack_zGoldenDauNofStripHits() {
  ...
  makePlots("zGoldenDau1NofStripHits +zGoldenDau1NofPixelHits ", "zGoldenDau2NofStripHits + zGoldenDau2NofPixelHits",  massCut + kin_common,  1, "zGoldenDauNofTrkHits",  0.001, 40, -0.5 ,39.5, true);
