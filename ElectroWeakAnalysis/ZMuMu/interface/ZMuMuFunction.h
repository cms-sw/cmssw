...
namespace function {
  class ZMuMuFunction {
   public:
    enum{ arguments = 1 };
    enum{ parameters = 9 };
    ZMuMuFunction(boost::shared_ptr<double> m, boost::shared_ptr<double> g, boost::shared_ptr<double> Ng, boost::shared_ptr<double> Ni, 
      ...
      cgz_(m, g, Ng, Ni, me, s) {}
    ZMuMuFunction(double m, double g, double Ng, double Ni, 
		  double me, double s, 
