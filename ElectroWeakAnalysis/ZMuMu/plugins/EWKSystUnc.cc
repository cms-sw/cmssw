...
class EWKSystUnc : public edm::EDAnalyzer {
public:
...
EWKSystUnc::EWKSystUnc(const ParameterSet& pset) :
...
void EWKSystUnc::analyze(const edm::Event& event, const edm::EventSetup& setup) {
