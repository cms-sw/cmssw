...
private:
  ...
  // general histograms
  TH1D *h_n_globalMuon_perEvent, *h_n_staOnlyMuon_perEvent, *h_n_trackerOnlyMuon_perEvent,
  ...
  TH2D *h_DEtaGlobalGenvsEtaGen, *h_DPtGlobalGenvsPtGen, *h_DEtaGlobalStaComponentGenvsEtaGen,
      *h_DPtGlobalStaComponentGenvsPtGen;
  ...
  TH1D *h_zMuTrackMass_ZMuMuTagged, *h_etaTrack_ZMuMuTagged, *h_phiTrack_ZMuMuTagged, *h_ptTrack_ZMuMuTagged,
      *h_DRTrack_ZMuMuTagged;
  ...
  TH1D *h_zMuStaMass_ZMuMuTagged, *h_etaSta_ZMuMuTagged, *h_phiSta_ZMuMuTagged, *h_ptSta_ZMuMuTagged,
      *h_DRSta_ZMuMuTagged;
  ...
  TH1D *h_zMuTrackMass_ZMuTrackTagged, *h_etaTrack_ZMuTrackTagged, *h_phiTrack_ZMuTrackTagged,
      *h_ptTrack_ZMuTrackTagged, *h_DRTrack_ZMuTrackTagged;
  ...
  TH1D *h_phiTrack_wrongStaCharge_ZMuTrackTagged, *h_ptTrack_wrongStaCharge_ZMuTrackTagged,
      *h_DRTrack_wrongStaCharge_ZMuTrackTagged;
...
ZMuMuPerformances::ZMuMuPerformances(const ParameterSet &pset)
  ...
  h_n_staOnlyMuon_perEvent =
      fs->make<TH1D>("n_staOnlyMuon_perEvent", "n.of standAlone Only Muons per Event", 6, -.5, 5.5);
  h_n_trackerOnlyMuon_perEvent =
      fs->make<TH1D>("n_trackerOnlyMuon_perEvent", "n.of tracker Only Muons per Event", 6, -.5, 5.5);
  h_n_trackerStaOnlyMuon_perEvent =
      fs->make<TH1D>("n_trackerStaOnlyMuon_perEvent", "n.of tracker & StandAlone Only Muons per Event", 6, -.5, 5.5);
  h_n_globalMuon_perEvent_MCmatch =
      fs->make<TH1D>("n_globalMuon_perEvent_MCmatch", "n.of globalMuons per Event (MCmatch)", 6, -.5, 5.5);
  h_n_staOnlyMuon_perEvent_MCmatch =
      fs->make<TH1D>("n_staOnlyMuon_perEvent_MCmatch", "n.of standAlone Only Muons per Event (MCmatch)", 6, -.5, 5.5);
  h_n_trackerOnlyMuon_perEvent_MCmatch =
      fs->make<TH1D>("n_trackerOnlyMuon_perEvent_MCmatch", "n.of tracker Only Muons per Event (MCmatch)", 6, -.5, 5.5);
  h_n_trackerStaOnlyMuon_perEvent_MCmatch = fs->make<TH1D>(
      "n_trackerStaOnlyMuon_perEvent_MCmatch", "n.of tracker & StandAlone Only Muons per Event (MCmatch)", 6, -.5, 5.5);
  ...
  h_zMuMuMassSameSign_MCmatch =
      fs->make<TH1D>("zMuMuMassSameSign_MCmatch", "inv Mass ZMuMu cand SameSign (MC match)", 100, 0., 200.);

  // histograms for MC truth
  // charge truth
  h_GlobalMuonChargeTimeGenCharge =
      fs->make<TH1D>("GlobalMuonChargeTimeGenCharge", "charge global mu times charge generated mu", 3, -1.5, 1.5);
  h_TrackerMuonChargeTimeGenCharge =
      fs->make<TH1D>("TrackerMuonChargeTimeGenCharge", "charge Tracker mu times charge generated mu", 3, -1.5, 1.5);
  // resolution respect to gen particles
  h_GlobalMuonEtaMinusGenEta =
      fs->make<TH1D>("GlobalMuonEtaMinusGenEta", "global mu Eta minus generated mu Eta", 100, -.005, .005);
  h_GlobalMuonPtMinusGenPt =
      fs->make<TH1D>("GlobalMuonPtMinusGenPtoverPt", "global mu Pt minus generated mu Pt over Pt", 100, -.5, .5);
  h_GlobalMuonStaComponentEtaMinusGenEta = fs->make<TH1D>(
      "GlobalMuonStaComponentEtaMinusGenEta", "global mu Sta cmponent Eta minus generated mu Eta", 100, -.5, .5);
  h_GlobalMuonStaComponentPtMinusGenPt = fs->make<TH1D>("GlobalMuonStaComponentPtMinusGenPtoerPt",
                                                        "global mu Sta component Pt minus generated mu Pt over Pt",
                                                        100,
                                                        -1.,
                                                        1.);
  h_TrackerMuonEtaMinusGenEta =
      fs->make<TH1D>("TrackerMuonEtaMinusGenEta", "Tracker mu Eta minus Eta generated mu", 100, -.005, .005);
  h_TrackerMuonPtMinusGenPt =
      fs->make<TH1D>("TrackerMuonPtMinusenPtoverPt", "Tracker mu Pt minus Pt generated mu over Pt", 100, -.5, .5);

  h_DEtaGlobalGenvsEtaGen =
      fs->make<TH2D>("h_DEtaGlobalGenvsEtaGen", "Eta global - Eta Gen vs Eta gen", 50, -2.5, 2.5, 100, -.005, .005);
  h_DEtaGlobalStaComponentGenvsEtaGen = fs->make<TH2D>("h_DEtaGlobalStaComponentGenvsEtaGen",
                                                       "Eta Sta component of a Global - Eta Gen vs Eta gen",
                                                       50,
                                                       -2.5,
                                                       2.5,
                                                       100,
                                                       -.5,
                                                       .5);
  h_DPtGlobalGenvsPtGen =
      fs->make<TH2D>("h_DPtGlobalGenovePtvsPtGen", "Pt global - Pt Gen over Pt vs Pt gen", 50, 0., 100., 100, -.5, .5);
  h_DPtGlobalStaComponentGenvsPtGen = fs->make<TH2D>("h_DPtGlobalStaComponentGenoverPtvsPtGen",
                                                     "Pt Sta component of a Global - Pt Gen over Pt vs Pt gen",
                                                     50,
                                                     0.,
                                                     100.,
                                                     100,
  ...
  // resolution respect to gen particles for ZMuMuTagged events
  h_GlobalMuonEtaMinusGenEta_ZMuMuTagged =
      fs->make<TH1D>("GlobalMuonEtaMinusGenEta_ZMuMuTagged", "global mu Eta minus generated mu Eta", 100, -.005, .005);
  h_GlobalMuonPtMinusGenPt_ZMuMuTagged = fs->make<TH1D>(
      "GlobalMuonPtMinusGenPtoverPt_ZMuMuTagged", "global mu Pt minus generated mu Pt over Pt", 100, -.5, .5);
  h_GlobalMuonStaComponentEtaMinusGenEta_ZMuMuTagged =
      fs->make<TH1D>("GlobalMuonStaComponentEtaMinusGenEta_ZMuMuTagged",
                     "global mu Sta cmponent Eta minus generated mu Eta",
                     100,
                     -.5,
                     .5);
  h_GlobalMuonStaComponentPtMinusGenPt_ZMuMuTagged =
      fs->make<TH1D>("GlobalMuonStaComponentPtMinusGenPtoverPt_ZMuMuTagged",
                     "global mu Sta component Pt minus generated mu Pt over Pt",
                     100,
                     -1.,
                     1.);
  h_DEtaGlobalGenvsEtaGen_ZMuMuTagged = fs->make<TH2D>(
      "h_DEtaGlobalGenvsEtaGen_ZMuMuTagged", "Eta global - Eta Gen vs Eta gen", 50, -2.5, 2.5, 100, -.005, .005);
  h_DEtaGlobalStaComponentGenvsEtaGen_ZMuMuTagged = fs->make<TH2D>("h_DEtaGlobalStaComponentGenvsEtaGen_ZMuMuTagged",
                                                                   "Eta Sta component of a Global - Eta Gen vs Eta gen",
                                                                   50,
                                                                   -2.5,
                                                                   2.5,
                                                                   ...
                                                                   -.5,
                                                                   .5);
  h_DPtGlobalGenvsPtGen_ZMuMuTagged = fs->make<TH2D>(
      "h_DPtGlobalGenOverPtvsPtGen_ZMuMuTagged", "Pt global - Pt Gen vs Pt gen over Pt", 50, 0., 100., 100, -.5, .5);
  h_DPtGlobalStaComponentGenvsPtGen_ZMuMuTagged =
      fs->make<TH2D>("h_DPtGlobalStaComponentGenoverPtvsPtGen_ZMuMuTagged",
                     "Pt Sta component of a Global - Pt Gen over Pt vs Pt gen",
                     50,
                     0.,
                     100.,
                     ...
                     -1.,
                     1.);
  h_DPtGlobalGenvsEtaGen_ZMuMuTagged = fs->make<TH2D>(
      "h_DPtGlobalGenOverPtvsEtaGen_ZMuMuTagged", "Pt global - Pt Gen over Pt vs Eta gen", 50, -2.5, 2.5, 100, -.5, .5);
  h_DPtGlobalStaComponentGenvsEtaGen_ZMuMuTagged =
      fs->make<TH2D>("h_DPtGlobalStaComponentGenoverPtvsEtaGen_ZMuMuTagged",
                     "Pt Sta component of a Global - Pt Gen over Pt vs Eta gen",
                     50,
                     -2.5,
                     2.5,
                     100,
                     -1.,
                     1.);
  h_DPtTrackGenvsPtGen_ZMuMuTagged = fs->make<TH2D>(
      "h_DPtTrackGenOverPtvsPtGen_ZMuMuTagged", "Pt track - Pt Gen vs Pt gen over Pt", 50, 0., 100., 100, -.5, .5);
  h_DPtTrackGenvsEtaGen_ZMuMuTagged = fs->make<TH2D>(
      "h_DPtTrackGenOverPtvsEtaGen_ZMuMuTagged", "Pt track - Pt Gen over Pt vs Eta gen", 50, -2.5, 2.5, 100, -.5, .5);

  // histograms for cynematic of ZMuMutagged muons for Sta performances studies
  h_zMuTrackMass_ZMuMuTagged =
      fs->make<TH1D>("zMuTrackMass_ZMuMuTagged", "inv Mass ZMuTrack cand (global-global)", 100, 0., 200.);
  ...
  // histograms for cynematic of ZMuMutagged muons when StandAlone has wrong charge
  h_zMuTrackMass_wrongStaCharge_ZMuMuTagged = fs->make<TH1D>(
      "zMuTrackMass_wrongStaCharge_ZMuMuTagged", "inv Mass ZMuTrack cand (global-global wrongStaCharge)", 100, 0., 200.);
  h_etaTrack_wrongStaCharge_ZMuMuTagged = fs->make<TH1D>(
      "etaTrack_wrongStaCharge_ZMuMuTagged", "eta of Track (global-global wrongStaCharge)", 50, -2.5, 2.5);
  h_phiTrack_wrongStaCharge_ZMuMuTagged = fs->make<TH1D>(
      "phiTrack_wrongStaCharge_ZMuMuTagged", "phi of Track (global-global wrongStaCharge)", 50, -3.1415, 3.1415);
  h_ptTrack_wrongStaCharge_ZMuMuTagged =
      fs->make<TH1D>("ptTrack_wrongStaCharge_ZMuMuTagged", "pt of Track (global-global wrongStaCharge)", 100, 0., 100.);
  h_DRTrack_wrongStaCharge_ZMuMuTagged = fs->make<TH1D>(
      "DRTrackSta_wrongStaCharge_ZMuMuTagged", "DR track-sta (global-global wrongStaCharge)", 100, 0., 5.);

  // hisograms for performances of StandAlone when StandAlone has correct charge
  h_zMuStaMass_correctStaCharge_ZMuMuTagged = fs->make<TH1D>(
      "zMuStaMass_correctStaCharge_ZMuMuTagged", "inv Mass ZMuSta cand (global-global correctStaCharge)", 100, 0., 200.);
  h_ptStaMinusptTrack_correctStaCharge_ZMuMuTagged =
      fs->make<TH1D>("ptStaMinusptTrackoverPT_correctStaCharge_ZMuMuTagged",
                     "ptSta - ptTrack over Pt (global-global correctStaCharge)",
                     100,
                     -1.,
                     1.);
  h_ptStaMinusptTrack_vsPtTracker_correctStaCharge_ZMuMuTagged =
      fs->make<TH2D>("ptStaMinusptTrackoverPt_vsPtTracker_correctStaCharge_ZMuMuTagged",
                     "ptSta - ptTrack over Pt vs ptTrack (global-global correctStaCharge)",
                     100,
                     0.,
                     100.,
                     100,
                     -1.,
                     1.);
  h_ptStaMinusptTrack_vsEtaTracker_correctStaCharge_ZMuMuTagged =
      fs->make<TH2D>("ptStaMinusptTrackoverPt_vsEtaTracker_correctStaCharge_ZMuMuTagged",
                     "ptSta - ptTrack over Pt vs etaTrack (global-global correctStaCharge)",
                     100,
                     -2.5,
                     2.5,
                     100,
  ...
  // histograms for cynematic of ZMuMutagged muons for TRK performances studies
  h_zMuStaMass_ZMuMuTagged =
      fs->make<TH1D>("zMuStaMass_ZMuMuTagged", "inv Mass ZMuSta cand (global-global)", 100, 0., 200.);
  ...
  h_DRSta_ZMuMuTagged =
      fs->make<TH1D>("DRTrackSta_ZMuMuTagged_staSelected", "DR track-sta sta selected (global-global)", 100, 0., 5.);

  // histograms for cynematic of ZMuMutagged muons when Track has wrong charge
  h_zMuStaMass_wrongTrkCharge_ZMuMuTagged = fs->make<TH1D>(
      "zMuStaMass_wrongTrkCharge_ZMuMuTagged", "inv Mass ZMuSta cand (global-global wrongTrkCharge)", 100, 0., 200.);
  h_etaSta_wrongTrkCharge_ZMuMuTagged =
      fs->make<TH1D>("etaSta_wrongTrkCharge_ZMuMuTagged", "eta of Sta (global-global wrongTrkCharge)", 50, -2.5, 2.5);
  h_phiSta_wrongTrkCharge_ZMuMuTagged = fs->make<TH1D>(
      "phiSta_wrongTrkCharge_ZMuMuTagged", "phi of Sta (global-global wrongTrkCharge)", 50, -3.1415, 3.1415);
  h_ptSta_wrongTrkCharge_ZMuMuTagged =
      fs->make<TH1D>("ptSta_wrongTrkCharge_ZMuMuTagged", "pt of Sta (global-global wrongTrkCharge)", 100, 0., 100.);
  h_DRSta_wrongTrkCharge_ZMuMuTagged = fs->make<TH1D>(
      "DRTrackSta_wrongTrkCharge_ZMuMuTagged", "DR track-sta (global-global wrongTrkCharge)", 100, 0., 5.);

  //
  // ****************************************************************************************************
  // histograms for cynematic of ZMuTracktagged muons with unMatched StandAlone
  h_zMuTrackMass_ZMuTrackTagged =
      fs->make<TH1D>("zMuTrackMass_ZMuTrackTagged", "inv Mass ZMuTrack cand (global-track)", 100, 0., 200.);
  h_etaTrack_ZMuTrackTagged = fs->make<TH1D>("etaTrack_ZMuTrackTagged", "eta of Track (global-track)", 50, -2.5, 2.5);
  h_phiTrack_ZMuTrackTagged =
      fs->make<TH1D>("phiTrack_ZMuTrackTagged", "phi of Track (global-track)", 50, -3.1415, 3.1415);
  ...
  // histograms for cynematic of ZMuTracktagged muons when unMatched StandAlone has wrong charge
  h_zMuTrackMass_wrongStaCharge_ZMuTrackTagged =
      fs->make<TH1D>("zMuTrackMass_wrongStaCharge_ZMuTrackTagged",
                     "inv Mass ZMuTrack cand (global-track wrongUnMatcehdStaCharge)",
                     100,
                     0.,
                     200.);
  h_etaTrack_wrongStaCharge_ZMuTrackTagged = fs->make<TH1D>(
      "etaTrack_wrongStaCharge_ZMuTrackTagged", "eta of Track (global-track wrongUnMatchedStaCharge)", 50, -2.5, 2.5);
  h_phiTrack_wrongStaCharge_ZMuTrackTagged = fs->make<TH1D>("phiTrack_wrongStaCharge_ZMuTrackTagged",
                                                            "phi of Track (global-track wrongUnMatchedStaCharge)",
                                                            50,
                                                            -3.1415,
                                                            3.1415);
  h_ptTrack_wrongStaCharge_ZMuTrackTagged = fs->make<TH1D>(
      "ptTrack_wrongStaCharge_ZMuTrackTagged", "pt of Track (global-track wrongUnMatchedStaCharge)", 100, 0., 100.);
  h_DRTrack_wrongStaCharge_ZMuTrackTagged = fs->make<TH1D>(
      "DRTrackSta_wrongStaCharge_ZMuTrackTagged", "DR track-sta (global-track wrongUnMatchedStaCharge)", 100, 0., 5.);

  // histograms for cynematic of ZMuStatagged muons with unMatched Track
  h_zMuStaMass_ZMuStaTagged =
      fs->make<TH1D>("zMuStaMass_ZMuStaTagged", "inv Mass ZMuSta cand (global-sta)", 100, 0., 200.);
  ...
  // histograms for cynematic of ZMuStatagged muons when unMatched track has wrong charge
  h_zMuStaMass_wrongTrkCharge_ZMuStaTagged = fs->make<TH1D>("zMuStaMass_wrongTrkCharge_ZMuStaTagged",
                                                            "inv Mass ZMuSta cand (global-sta wrongUnMatcehdTrkCharge)",
                                                            100,
                                                            0.,
                                                            200.);
  h_etaSta_wrongTrkCharge_ZMuStaTagged = fs->make<TH1D>(
      "etaSta_wrongTrkCharge_ZMuStaTagged", "eta of Sta (global-sta wrongUnMatchedTrkCharge)", 50, -2.5, 2.5);
  h_phiSta_wrongTrkCharge_ZMuStaTagged = fs->make<TH1D>(
      "phiSta_wrongTrkCharge_ZMuStaTagged", "phi of Sta (global-sta wrongUnMatchedTrkCharge)", 50, -3.1415, 3.1415);
  h_ptSta_wrongTrkCharge_ZMuStaTagged = fs->make<TH1D>(
      "ptSta_wrongTrkCharge_ZMuStaTagged", "pt of Sta (global-sta wrongUnMatchedTrkCharge)", 100, 0., 100.);
  ...
  */
  ...
  for (unsigned int j = 0; j < muons->size(); ++j) {
    ...
    if (muCandRef->isGlobalMuon() == 1)
      n_globalMuon_perEvent++;
    if (muCandRef->isGlobalMuon() == 0 && muCandRef->isTrackerMuon() == 0 && muCandRef->isStandAloneMuon() == 1)
      n_staOnlyMuon_perEvent++;
    if (muCandRef->isGlobalMuon() == 0 && muCandRef->isTrackerMuon() == 1 && muCandRef->isStandAloneMuon() == 0)
      n_trackerOnlyMuon_perEvent++;
    if (muCandRef->isGlobalMuon() == 0 && muCandRef->isTrackerMuon() == 1 && muCandRef->isStandAloneMuon() == 1)
    ...
    if (muonMatch.isNonnull()) {
      ...
      if (muCandRef->isGlobalMuon() == 0 && muCandRef->isTrackerMuon() == 1 && muCandRef->isStandAloneMuon() == 1)
        n_trackerStaOnlyMuon_perEvent_MCmatch++;
      ...
      if (muCandRef->isGlobalMuon() == 1) {
        ...
        h_DPtGlobalStaComponentGenvsPtGen->Fill(muonMatch->pt(),
                                                (muStaComponentRef->pt() - muonMatch->pt()) / muonMatch->pt());
      }
  ...
  if (!zMuMu->empty()) {
    ...
    for (unsigned int i = 0; i < zMuMu->size(); ++i) {  //loop on candidates
      ...
      double massGlobalSta =
          (pg1 + ps2).mass();  // inv. mass done with the global daughter(0) and the Sta part of Daughter(1)
      double massStaGlobal =
          (ps1 + pg2).mass();  // inv. mass done with the global daughter(1) and the Sta part of Daughter(0)
      //      double mass2Tracker = (ptrk1+ptrk2).mass();    // inv. mass done with the two tracker compnents
      double massGlobalTracker =
          (pg1 + ptrk2).mass();  // inv. mass done with the global daughter(0) and the tracker part of Daughter(1)
      double massTrackerGlobal =
          (ptrk1 + pg2).mass();  // inv. mass done with the global daughter(1) and the tracker part of Daughter(0)
      ...
      if (abs(etaGlobal1) < etamax_ && abs(etaTracker2) < etamax_)
        etaCut = true;
      if (ptGlobal1 > ptmin_ && ptTracker2 > ptmin_)
        ptCut = true;
      if (massGlobalTracker > massMin_ && massGlobalTracker < massMax_)
        massCut = true;
      ...
      if (etaCut && ptCut && massCut) {
        ...
        if (chargeSta1 == chargeTracker1 &&
            chargeTracker1 != chargeTracker2) {  // event tagged to study StandAlone2 charge
          ...
          if (chargeSta2 == chargeTracker2) {  // StandAlone2 has correct charge
            ...
            h_zMuStaMass_correctStaCharge_ZMuMuTagged->Fill(
                massGlobalSta);  // inv mass of global-Sta part for correct charge muons
            h_ptStaMinusptTrack_correctStaCharge_ZMuMuTagged->Fill((ptSta2 - ptTracker2) / ptTracker2);
            h_ptStaMinusptTrack_vsEtaTracker_correctStaCharge_ZMuMuTagged->Fill(etaTracker2,
                                                                                (ptSta2 - ptTracker2) / ptTracker2);
            h_ptStaMinusptTrack_vsPtTracker_correctStaCharge_ZMuMuTagged->Fill(ptTracker2,
                                                                               (ptSta2 - ptTracker2) / ptTracker2);
          ...
          if (chargeSta2 != chargeTracker2) {  // StandAlone2 has wrong charge
            ...
            h_zMuTrackMass_wrongStaCharge_ZMuMuTagged->Fill(
                massGlobalTracker);  // inv mass global+tracker part (wrong Sta charge)
            ...
            h_DRTrack_wrongStaCharge_ZMuMuTagged->Fill(
                DR2);  // DR between sta2 and tracker2 for tagged track (wrong Sta charge)
          }
      ...
      massCut = false;
      //isoCut = false;
      if (abs(etaGlobal2) < etamax_ && abs(etaTracker1) < etamax_)
        etaCut = true;
      if (ptGlobal2 > ptmin_ && ptTracker1 > ptmin_)
        ptCut = true;
      if (massTrackerGlobal > massMin_ && massTrackerGlobal < massMax_)
        massCut = true;
      ...
      if (etaCut && ptCut && massCut) {
        ...
        if (chargeSta2 == chargeTracker2 &&
          ...
          if (chargeSta1 == chargeTracker1) {  // StandAlone1 has correct charge
            n_correctStaCharge_ZMuMutagged++;
            h_zMuStaMass_correctStaCharge_ZMuMuTagged->Fill(
                massStaGlobal);  // inv mass of Sta-global part for correct charge muons
            h_ptStaMinusptTrack_correctStaCharge_ZMuMuTagged->Fill((ptSta1 - ptTracker1) / ptTracker1);
            h_ptStaMinusptTrack_vsEtaTracker_correctStaCharge_ZMuMuTagged->Fill(etaTracker1,
                                                                                (ptSta1 - ptTracker1) / ptTracker1);
            h_ptStaMinusptTrack_vsPtTracker_correctStaCharge_ZMuMuTagged->Fill(ptTracker1,
                                                                               (ptSta1 - ptTracker1) / ptTracker1);
          }
          if (chargeSta1 != chargeTracker1) {  // StandAlone2 has wrong charge
            n_wrongStaCharge_ZMuMutagged++;
            h_zMuTrackMass_wrongStaCharge_ZMuMuTagged->Fill(
                massTrackerGlobal);  // inv mass global+tracker part (wrong Sta charge)
            ...
            h_DRTrack_wrongStaCharge_ZMuMuTagged->Fill(
                DR1);  // DR between sta1 and tracker1 for tagged track (wrong Sta charge)
          }
      ...
      if (abs(etaGlobal1) < etamax_ && abs(etaSta2) < etamax_)
        etaCut = true;
      if (ptGlobal1 > ptmin_ && ptSta2 > ptmin_)
        ptCut = true;
      if (massGlobalSta > massMin_ && massGlobalSta < massMax_)
        massCut = true;
      ...
      if (etaCut && ptCut && massCut) {
        ...
        if (chargeSta1 == chargeTracker1 && chargeTracker1 != chargeSta2) {  // event tagged to study track2 charge
          ...
          if (chargeSta2 != chargeTracker2) {  // track2 has wrong charge
            ...
            h_zMuStaMass_wrongTrkCharge_ZMuMuTagged->Fill(
                massGlobalSta);                                  // inv mass global+sta part (wrong Trk charge)
            ...
            h_DRSta_wrongTrkCharge_ZMuMuTagged->Fill(
                DR2);  // DR between sta2 and tracker2 for tagged sta (wrong trk charge)
          }
      ...
      if (abs(etaGlobal2) < etamax_ && abs(etaSta1) < etamax_)
        etaCut = true;
      if (ptGlobal2 > ptmin_ && ptSta1 > ptmin_)
        ptCut = true;
      if (massStaGlobal > massMin_ && massStaGlobal < massMax_)
        massCut = true;
      ...
      if (etaCut && ptCut && massCut) {
        ...
        if (chargeSta2 == chargeTracker2 && chargeTracker2 != chargeSta1) {  // event tagged to study track1 charge
          ...
          if (chargeSta1 != chargeTracker1) {  // track1 has wrong charge
            n_wrongTrkCharge_ZMuMutagged++;
            h_zMuStaMass_wrongTrkCharge_ZMuMuTagged->Fill(
                massStaGlobal);                                  // inv mass global+sta part (wrong Trk charge)
            ...
            h_DRSta_wrongTrkCharge_ZMuMuTagged->Fill(
                DR1);  // DR between sta2 and tracker2 for tagged sta (wrong trk charge)
          }
  ...
  if (!zMuTrack->empty() && zMuMu->empty()) {  // check ZMuTrack just if no ZMuMu has been found in the event
    ...
    for (unsigned int i = 0; i < zMuTrack->size(); ++i) {  //loop on candidates
      ...
      //      bool isoCut = false;
      bool massCut = false;
      if (abs(ZglobalDaughterEta) < etamax_ && abs(ZtrackerDaughterEta) < etamax_)
        etaCut = true;
      if (ZglobalDaughterPt > ptmin_ && ZtrackerDaughterPt > ptmin_)
        ptCut = true;
      if (m > massMin_ && m < massMax_)
        massCut = true;
      ...
      if (etaCut && ptCut && massCut && ZglobalDaughter_StaComponentCharge == ZglobalDaughter_TrackComponentCharge &&
          ZglobalDaughter_TrackComponentCharge !=
              ZtrackerDaughterCharge) {  // cynematic cuts and global charge consistent and opposite tracker charge
  ...
  if (n_ZMuTrackTagged_inEvent > 0) {  // at Least one ZMuTRack tagged
    ...
    if (taggedZ_index == -1) {  // StandAlone inefficient
      ...
      if (muCharge != ZtrackerDaughterCharge) {  // wrong Sta charge
        ...
        h_zMuTrackMass_wrongStaCharge_ZMuTrackTagged->Fill(
            m);  // inv mass ZMuTrack for tagged events wrong unMatched Sta charge
        h_etaTrack_wrongStaCharge_ZMuTrackTagged->Fill(
            ZtrackerDaughterEta);  // eta of tagged track wrong unMatched Sta charge
        h_phiTrack_wrongStaCharge_ZMuTrackTagged->Fill(
            ZtrackerDaughterPhi);  // phi of tagged track wrong unMatched Sta charge
        h_ptTrack_wrongStaCharge_ZMuTrackTagged->Fill(
            ZtrackerDaughterPt);  // pt of tagged track wrong unMatched Sta charge
        h_DRTrack_wrongStaCharge_ZMuTrackTagged->Fill(
            DRmuSta_trackOfZ);                // DR between unMatched Sta and tracker for wrong sta charge
  ...
  if (!zMuStandAlone->empty()) {   // check ZMuSta just if no ZMuMu has been found in the event
    ...
    for (unsigned int i = 0; i < zMuStandAlone->size(); ++i) {  //loop on candidates
      ...
      //      bool isoCut = false;
      bool massCut = false;
      if (abs(ZglobalDaughterEta) < etamax_ && abs(ZstaDaughter_StaComponentEta) < etamax_)
        etaCut = true;
      if (ZglobalDaughterPt > ptmin_ && ZstaDaughter_StaComponentPt > ptmin_)
        ptCut = true;
      if (m > massMin_ && m < massMax_)
        massCut = true;  // dovrei usare la massa fatta con la sola parte sta
      ...
      if (etaCut && ptCut && massCut && ZglobalDaughter_StaComponentCharge == ZglobalDaughter_TrackComponentCharge &&
          ZglobalDaughter_StaComponentCharge !=
              ZstaDaughter_StaComponentCharge) {  // cynematic cuts and global charge consistent and opposite sta charge
        n_ZMuStaTagged_inEvent++;
        if (isZMuStaMatched)
          n_ZMuStaTaggedMatched++;
        // posso inserire istogrammi eta e pt track per studio Sta efficiency
        // ...
        if (zstandaloneDaughter->isStandAloneMuon() == 1 &&
            zstandaloneDaughter->isTrackerMuon() == 1) {  // track matched
          ...
          if (ZstaDaughter_StaComponentCharge != ZstaDaughter_TrackComponentCharge) {  // wrong Trk charge
            ...
            h_zMuStaMass_wrongTrkCharge_ZMuStaTagged->Fill(
                m);  // inv mass ZMuSta for tagged evts wrong unMatched track charge
            h_etaSta_wrongTrkCharge_ZMuStaTagged->Fill(
                ZstaDaughter_StaComponentEta);  // eta of tagged sta wrong unMatched track charge
            h_phiSta_wrongTrkCharge_ZMuStaTagged->Fill(
                ZstaDaughter_StaComponentPhi);  // phi of tagged sta wrong unMatched track charge
            h_ptSta_wrongTrkCharge_ZMuStaTagged->Fill(
                ZstaDaughter_StaComponentPt);   // pt of tagged sta wrong unMatched track charge
          } else {                              // correct Sta charge
...
void ZMuMuPerformances::endJob() {
  ...
  cout << "------------------------------------  Counters for standAlone charge mis-id studies "
          "--------------------------------"
       << endl;
  cout << " number of goodTracks tagged for ZMuMu collection = " << n_goodTrack_ZMuMutagged << endl;
  cout << " number of goodTracks tagged for ZMuMu collection (correct Sta charge) = " << n_correctStaCharge_ZMuMutagged
       << endl;
  cout << " number of goodTracks tagged for ZMuMu collection (wrong Sta charge) = " << n_wrongStaCharge_ZMuMutagged
       << endl
       << endl;
  cout << " number of goodTracks tagged for ZMuTrack collection unMatchedSTA = " << n_goodTrack_ZMuTracktagged << endl;
  cout << " number of goodTracks tagged for ZMuTrack collection unMatchedSTA (correct Sta charge) = "
       << n_correctStaCharge_ZMuTracktagged << endl;
  cout << " number of goodTracks tagged for ZMuTrack collection unMatchedSTA (wrong Sta charge) = "
       << n_wrongStaCharge_ZMuTracktagged << endl
       << endl;
  cout << " number of goodTracks tagged for ZMuTrack collection (No STA found) = " << n_StaNotFound_ZMuTracktagged
       << endl;

  cout << "------------------------------------  Counters for Track charge mis-id studies "
          "--------------------------------"
       << endl;
  cout << " number of goodStandAlone tagged for ZMuMu collection = " << n_goodSta_ZMuMutagged << endl;
  cout << " number of goodStandAlone tagged for ZMuMu collection (correct Trk charge) = "
       << n_correctTrkCharge_ZMuMutagged << endl;
  cout << " number of goodStandAlone tagged for ZMuMu collection (wrong Trk charge) = " << n_wrongTrkCharge_ZMuMutagged
       << endl
       << endl;
  cout << " number of goodSta tagged for ZMuSta collection unMatchedTrk = " << n_goodSta_ZMuStatagged << endl;
  cout << " number of goodSta tagged for ZMuSta collection unMatchedTrk (correct Trk charge) = "
       << n_correctTrkCharge_ZMuStatagged << endl;
  cout << " number of goodSta tagged for ZMuSta collection unMatchedTrk (wrong Trk charge) = "
       << n_wrongTrkCharge_ZMuStatagged << endl
       << endl;
