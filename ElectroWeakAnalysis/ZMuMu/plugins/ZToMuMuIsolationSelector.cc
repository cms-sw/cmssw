...
struct IsolatedSelector {
  ...
  bool operator()(double i1, double i2) const { return i1 < cut_ && i2 < cut_; }
...
struct NonIsolatedSelector {
  ...
  bool operator()(double i1, double i2) const { return !isolated_(i1, i2); }
...
struct OneNonIsolatedSelector {
  ...
  bool operator()(double i1, double i2) const { return (i1 < cut_ && i2 >= cut_) || (i1 >= cut_ && i2 < cut_); }
  double cut() const { return cut_; }
...
public:
  ZToMuMuIsolationSelector(const edm::ParameterSet &cfg, edm::ConsumesCollector &iC)
    ...
    if (iso == "track") {
      ...
      throw edm::Exception(edm::errors::Configuration) << "Invalid isolation type: " << iso << ". Valid types are:"
...
typedef SingleObjectSelector<
    reco::CandidateView,
    AndSelector<ZToMuMuIsolationSelector<IsolatedSelector>, StringCutObjectSelector<reco::Candidate> > >
    ZToMuMuIsolatedSelector;

typedef SingleObjectSelector<
    reco::CandidateView,
    AndSelector<ZToMuMuIsolationSelector<NonIsolatedSelector>, StringCutObjectSelector<reco::Candidate> > >
    ZToMuMuNonIsolatedSelector;

typedef SingleObjectSelector<
    reco::CandidateView,
    AndSelector<ZToMuMuIsolationSelector<OneNonIsolatedSelector>, StringCutObjectSelector<reco::Candidate> > >
    ZToMuMuOneNonIsolatedSelector;

typedef SingleObjectSelector<
    reco::CandidateView,
    AndSelector<ZToMuMuIsolationSelector<TwoNonIsolatedSelector>, StringCutObjectSelector<reco::Candidate> > >
