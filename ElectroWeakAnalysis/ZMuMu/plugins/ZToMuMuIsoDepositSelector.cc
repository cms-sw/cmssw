...
typedef SingleObjectSelector<
    reco::CandidateView,
    AndSelector<ZToMuMuIsoDepositSelector<IsolatedSelector>, StringCutObjectSelector<reco::Candidate> > >
    ZToMuMuIsolatedIDSelector;

typedef SingleObjectSelector<
    reco::CandidateView,
    AndSelector<ZToMuMuIsoDepositSelector<NonIsolatedSelector>, StringCutObjectSelector<reco::Candidate> > >
    ZToMuMuNonIsolatedIDSelector;

typedef SingleObjectSelector<
    reco::CandidateView,
    AndSelector<ZToMuMuIsoDepositSelector<OneNonIsolatedSelector>, StringCutObjectSelector<reco::Candidate> > >
    ZToMuMuOneNonIsolatedIDSelector;

typedef SingleObjectSelector<
    reco::CandidateView,
    AndSelector<ZToMuMuIsoDepositSelector<TwoNonIsolatedSelector>, StringCutObjectSelector<reco::Candidate> > >
