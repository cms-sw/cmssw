...
#     '/store/data/Run2010A/EG/RECO/Jun14thReReco_v1/0001/AC3549F8-BE78-DF11-B07B-003048F0E186.root',
   'rfio:/tmp/ikesisog/D449BF0F-C378-DF11-AB42-003048F0E81E.root'
    )
)
...
process.plotter = cms.EDAnalyzer('ZeePlots',
                                 ...
                                 usePrecalcIDType = cms.untracked.string('simpleEleId95relIso'),
...
process.p = cms.Path( process.gsfElectrons*process.ourJetSequence*
                      process.patDefaultSequence*process.zeeFilter*process.plotter)
