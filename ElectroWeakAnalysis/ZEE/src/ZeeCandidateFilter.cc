...
//     maxETelec2.addUserFloat("ele_tip_pv", Float_t(ele_tip_pv2));
    ...
    if ( useValidFirstPXBHit1_ || calculateValidFirstPXBHit1_ ) {
        ...
        Bool_t fail = ( ! maxETelec1.gsfTrack()->hitPattern().hasValidHitInFirstPixelBarrel(reco::HitPattern::TRACK_HITS)) ;
    ...
    if ( useValidFirstPXBHit2_ || calculateValidFirstPXBHit2_ ) {
        ...
        Bool_t fail = ( ! maxETelec2.gsfTrack()->hitPattern().hasValidHitInFirstPixelBarrel(reco::HitPattern::TRACK_HITS) );
