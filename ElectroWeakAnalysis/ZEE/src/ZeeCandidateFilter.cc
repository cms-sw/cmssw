...
//     maxETelec2.addUserFloat("ele_tip_pv", Float_t(ele_tip_pv2));
    ...
    if ( useValidFirstPXBHit1_ || calculateValidFirstPXBHit1_ ) {
        ...
        Bool_t fail = ( ! maxETelec1.gsfTrack()->getHitPattern().hasValidHitInFirstPixelBarrel(reco::HitPattern::TRACK_HITS)) ;
    ...
    if ( useValidFirstPXBHit2_ || calculateValidFirstPXBHit2_ ) {
        ...
        Bool_t fail = ( ! maxETelec2.gsfTrack()->getHitPattern().hasValidHitInFirstPixelBarrel(reco::HitPattern::TRACK_HITS) );
    ...
    if ( useExpectedMissingHits1_ || calculateExpectedMissingHits1_ ) {
        ...
        Int_t numberOfInnerHits = (Int_t)( maxETelec1.gsfTrack()->getHitPattern().numberOfHits(reco::HitPattern::MISSING_INNER_HITS));
    ...
    if ( useExpectedMissingHits2_ || calculateExpectedMissingHits2_ ) {
        ...
        Int_t numberOfInnerHits = (Int_t)( maxETelec2.gsfTrack()->getHitPattern().numberOfHits(reco::HitPattern::MISSING_INNER_HITS) );
