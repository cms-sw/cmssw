...
void ZeePlots::analyze(const edm::Event& iEvent, const edm::EventSetup& es)
{
    ...
    ele1_cr_mhitsinner  = (Float_t)( myElec1->gsfTrack()->getHitPattern().numberOfHits(reco::HitPattern::MISSING_INNER_HITS));
    ...
    ele2_cr_mhitsinner  = (Float_t)( myElec2->gsfTrack()->getHitPattern().numberOfHits(reco::HitPattern::MISSING_INNER_HITS));
