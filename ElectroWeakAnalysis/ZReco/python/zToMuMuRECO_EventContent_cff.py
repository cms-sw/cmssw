...
zToMuMuRECOEventContent = cms.PSet(
    outputCommands = cms.untracked.vstring('keep recoCandidatesOwned_genParticleCandidates_*_*', 
        ...
        'keep *_allStandAloneMuonTrackIsolations_*_*', 
        'keep *_zToMuMu_*_*', 
        'keep *_zToMuMuOneTrack_*_*', 
        'keep *_zToMuMuOneStandAloneMuonTrack_*_*', 
        'keep *_allMuonsGenParticlesMatch_*_*', 
        'keep *_allTracksGenParticlesLeptonMatch_*_*', 
        'keep *_allStandAloneMuonTracksGenParticlesLeptonMatch_*_*', 
        'keep *_zToMuMuGenParticlesMatch_*_*', 
        'keep *_zToMuMuOneTrackGenParticlesMatch_*_*', 
        'keep *_zToMuMuOneStandAloneMuonTrackGenParticlesMatch_*_*')
)
zToMuMuRECOEventSelection = cms.PSet(
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('zToMuMuRECOPath', 
            'zToMuMuOneTrackRECOPath', 
            'zToMuMuOneStandAloneMuonTrackRECOPath')
    )
)
