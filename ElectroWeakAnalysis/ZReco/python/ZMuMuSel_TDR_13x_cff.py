...
zMuMuIsolations.EtaBounds = [0.0435, 0.1305, 0.2175, 0.3045, 0.3915, 
    ...
    2.4110]
zMuMuIsolations.ConeSizes = [0.24, 0.24, 0.24, 0.24, 0.24, 
    0.24, 0.24, 0.24, 0.24, 0.24, 
    0.24, 0.24, 0.24, 0.24, 0.24, 
    0.24, 0.24, 0.24, 0.24, 0.24, 
    0.24, 0.24, 0.24, 0.24, 0.24, 
    0.24]
zMuMuIsolations.Thresholds = [3.20, 3.10, 2.80, 3.00, 3.30, 
...
zMuMuTrackerIsolations.EtaBounds = [0.0435, 0.1305, 0.2175, 0.3045, 0.3915, 
    0.4785, 0.5655, 0.6525, 0.7395, 0.8265, 
    0.9135, 1.0005, 1.0875, 1.1745, 1.2615, 
    1.3485, 1.4355, 1.5225, 1.6095, 1.6965, 
    1.7850, 1.8800, 1.9865, 2.1075, 2.2470, 
    2.4110]
zMuMuTrackerIsolations.ConeSizes = [0.24, 0.24, 0.24, 0.24, 0.24, 
    0.24, 0.24, 0.24, 0.24, 0.24, 
    0.24, 0.24, 0.24, 0.24, 0.24, 
    0.24, 0.24, 0.24, 0.24, 0.24, 
    0.24, 0.24, 0.24, 0.24, 0.24, 
    0.24]
zMuMuTrackerIsolations.Thresholds = [3.20, 3.10, 2.80, 3.00, 3.30, 
    3.30, 2.80, 3.30, 2.90, 2.20, 
    2.50, 2.70, 2.90, 2.70, 2.50, 
    2.80, 2.30, 2.60, 2.70, 2.50, 
    2.40, 2.90, 2.50, 2.70, 2.10, 
