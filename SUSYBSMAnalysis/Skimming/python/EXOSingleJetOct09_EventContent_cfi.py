...
exoticaSingleJetOutputModule = cms.OutputModule("PoolOutputModule",
    ...
    SelectEvents = cms.untracked.PSet(
       SelectEvents = cms.vstring("exoticaSingleJetSkimPath") #the selector name must be same as the path name in EXOSingleJetOct09_cfg.py in test directory.
      ),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string('EXOSingleJet'), #name a name you like.
        dataTier = cms.untracked.string('EXOGroup')
    ),
    fileName = cms.untracked.string('exoticasinglejettest.root') # can be modified later in EXOSingleJetOct09_cfg.py in  test directory. 
  )
