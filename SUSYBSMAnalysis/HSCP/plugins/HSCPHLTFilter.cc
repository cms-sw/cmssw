...
bool HSCPHLTFilter::filter(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  if (RemoveDuplicates) {
    if (isDuplicate(iEvent.eventAuxiliary().run(), iEvent.eventAuxiliary().event()))
      return false;
    else
      return true;
  }
  ...
  if (MuonTrigger1Mask != 0) {
    if (TrIndex_Unknown != tr.triggerIndex("HLT_Mu40_eta2p1_v5")) {
      if (tr.accept(tr.triggerIndex("HLT_Mu40_eta2p1_v5"))) {
        MuonTrigger1 = true;
      }
    } else {
      if (TrIndex_Unknown != tr.triggerIndex("HLT_Mu40_eta2p1_v4")) {
        if (tr.accept(tr.triggerIndex("HLT_Mu40_eta2p1_v4"))) {
          MuonTrigger1 = true;
        }
      } else {
        if (TrIndex_Unknown != tr.triggerIndex("HLT_Mu40_eta2p1_v1")) {
          if (tr.accept(tr.triggerIndex("HLT_Mu40_eta2p1_v1"))) {
            MuonTrigger1 = true;
          }
        } else {
          if (TrIndex_Unknown != tr.triggerIndex("HLT_Mu30_v8")) {
            if (IncreasedTreshold(
                    trEv, InputTag("hltSingleMu30L2QualL3Filtered30", "", TriggerProcess), 40, 2.1, 1, false)) {
              MuonTrigger1 = true;
            }
          } else {
            if (TrIndex_Unknown != tr.triggerIndex("HLT_Mu30_v7")) {
              ...
              if (TrIndex_Unknown != tr.triggerIndex("HLT_Mu30_v6")) {
                ...
                if (TrIndex_Unknown != tr.triggerIndex("HLT_Mu30_v5")) {
                  if (IncreasedTreshold(
                          trEv, InputTag("hltSingleMu30L3Filtered30", "", TriggerProcess), 40, 2.1, 1, false)) {
                    MuonTrigger1 = true;
                  }
                } else {
  ...
  if (PFMetTriggerMask != 0) {
    if (TrIndex_Unknown != tr.triggerIndex("HLT_PFMHT150_v17")) {
      if (tr.accept(tr.triggerIndex("HLT_PFMHT150_v17"))) {
        PFMetTrigger = true;
      }
    } else {
      if (TrIndex_Unknown != tr.triggerIndex("HLT_PFMHT150_v16")) {
        ...
        if (TrIndex_Unknown != tr.triggerIndex("HLT_PFMHT150_v12")) {
          if (tr.accept(tr.triggerIndex("HLT_PFMHT150_v12"))) {
            PFMetTrigger = true;
          }
        } else {
          if (TrIndex_Unknown != tr.triggerIndex("HLT_PFMHT150_v11")) {
            if (tr.accept(tr.triggerIndex("HLT_PFMHT150_v11"))) {
              PFMetTrigger = true;
            }
          } else {
            if (TrIndex_Unknown != tr.triggerIndex("HLT_PFMHT150_v10")) {
              if (tr.accept(tr.triggerIndex("HLT_PFMHT150_v10"))) {
                PFMetTrigger = true;
              }
            } else {
              if (TrIndex_Unknown != tr.triggerIndex("HLT_PFMHT150_v9")) {
                if (tr.accept(tr.triggerIndex("HLT_PFMHT150_v9"))) {
                  PFMetTrigger = true;
                }
              } else {
                if (TrIndex_Unknown != tr.triggerIndex("HLT_PFMHT150_v8")) {
                  if (tr.accept(tr.triggerIndex("HLT_PFMHT150_v8"))) {
                    PFMetTrigger = true;
                  }
                } else {
                  if (TrIndex_Unknown != tr.triggerIndex("HLT_PFMHT150_v7")) {
                    if (tr.accept(tr.triggerIndex("HLT_PFMHT150_v7"))) {
                      PFMetTrigger = true;
                    }
                  } else {
                    if (TrIndex_Unknown != tr.triggerIndex("HLT_PFMHT150_v6")) {
                      if (tr.accept(tr.triggerIndex("HLT_PFMHT150_v6"))) {
                        PFMetTrigger = true;
                      }
                    } else {
                      if (TrIndex_Unknown != tr.triggerIndex("HLT_PFMHT150_v5")) {
                        if (tr.accept(tr.triggerIndex("HLT_PFMHT150_v5"))) {
                          PFMetTrigger = true;
                        }
                      } else {
                          ...
                          if (TrIndex_Unknown != tr.triggerIndex("HLT_PFMHT150_v3")) {
                            ...
                            if (TrIndex_Unknown != tr.triggerIndex("HLT_PFMHT150_v2")) {
                              ...
                              if (TrIndex_Unknown != tr.triggerIndex("HLT_PFMHT150_v1")) {
                                if (tr.accept(tr.triggerIndex("HLT_PFMHT150_v1"))) {
                                  PFMetTrigger = true;
                                }
                              } else {
  ...
  if (L2MuMETTriggerMask != 0) {
    ...
    if (TrIndex_Unknown != tr.triggerIndex("HLT_L2Mu60_1Hit_MET60_v6")) {
      ...
      if (TrIndex_Unknown != tr.triggerIndex("HLT_L2Mu60_1Hit_MET60_v5")) {
        if (tr.accept(tr.triggerIndex("HLT_L2Mu60_1Hit_MET60_v5"))) {
          L2MuMETTrigger = true;
        }
      } else {
        if (TrIndex_Unknown != tr.triggerIndex("HLT_L2Mu60_1Hit_MET60_v4")) {
          ...
          if (TrIndex_Unknown != tr.triggerIndex("HLT_L2Mu60_1Hit_MET60_v3")) {
            ...
            if (TrIndex_Unknown != tr.triggerIndex("HLT_L2Mu60_1Hit_MET60_v2")) {
              if (tr.accept(tr.triggerIndex("HLT_L2Mu60_1Hit_MET60_v2"))) {
                L2MuMETTrigger = true;
              }
            } else {
              if (TrIndex_Unknown != tr.triggerIndex("HLT_L2Mu60_1Hit_MET60_v1")) {
                if (tr.accept(tr.triggerIndex("HLT_L2Mu60_1Hit_MET60_v1"))) {
                  L2MuMETTrigger = true;
                }
              }
            }
    ...
    if (L2MuMETTriggerMask == 2) {
      ...
      if (IncreasedTreshold(trEv, InputTag("hltL2Mu20L2Filtered20", "", TriggerProcess), 60, 2.1, 1, false) &&
          IncreasedTreshold(trEv, InputTag("hltMET80", "", TriggerProcess), 80, 2.1, 1, false)) {
        L2MuMETTrigger = true;
      }
    }
  }
  ...
  if (PFMetTriggerMask == 0)
    PFMetTrigger = false;
  if (L2MuMETTriggerMask == 0)
    L2MuMETTrigger = false;

  //Allow option of requiring that one of the triggers did NOT fire to remove duplicated events
  if (MuonTrigger1Mask < 0 && MuonTrigger1)
    return false;
  if (PFMetTriggerMask < 0 && PFMetTrigger)
    return false;
  if (L2MuMETTriggerMask < 0 && L2MuMETTrigger)
    return false;
