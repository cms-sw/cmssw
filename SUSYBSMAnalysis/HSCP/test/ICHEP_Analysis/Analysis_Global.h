...
double IntegratedLuminosity8TeV = 18316;
...
const   float TrueDist2012_f[60] = {6.71891e-07 ,1.78702e-06 ,4.93035e-06 ,1.62099e-05 ,3.06025e-05 ,0.000166703 ,0.000957822 ,0.00280185 ,0.00649091 ,0.0132359 ,0.0234314 ,0.036122 ,0.0465905 ,0.0527572 ,0.056486 ,0.0588833 ,0.0599714 ,0.0601269 ,0.0596724 ,0.0585123 ,0.0568038 ,0.0549189 ,0.0529822 ,0.0506533 ,0.0474171 ,0.0430411 ,0.037704 ,0.0317867 ,0.0256976 ,0.0198582 ,0.0146623 ,0.0103605 ,0.00701189 ,0.00453809 ,0.00279951 ,0.00164123 ,0.000913423 ,0.00048337 ,0.000244247 ,0.000118603 ,5.57948e-05 ,2.56714e-05 ,1.16758e-05 ,5.30817e-06 ,2.43699e-06 ,1.13784e-06 ,5.41333e-07 ,2.61476e-07 ,1.2725e-07 ,6.18247e-08 ,2.97314e-08 ,1.40544e-08 ,6.49771e-09 ,2.92784e-09 ,1.28286e-09 ,5.45764e-10 ,2.25222e-10 ,9.0099e-11 ,3.49259e-11 ,1.31149e-11};
...
void InitBaseDirectory(){  
   ...
   if(host.find("ucl.ac.be")!=std::string::npos){
     ...
     BaseDirectory = "dcache:/pnfs/cms/WAX/11/store/user/farrell3/HSCPEDMFiles7and8TeV/";
   }else{
