...
public:
  ...
  HelixBarrelCylinderCrossing(const GlobalPoint &startingPos,
                              const GlobalVector &startingDir, double rho,
                              PropagationDirection propDir, const Cylinder &cyl,
  ...
  /// Method to access separately each solution of the helix-cylinder crossing
  /// equations
...
private:
  ...
  std::pair<Vector, int>
  chooseSolution(const Point &p1, const Point &p2,
