...
PropagationDirection PropagationDirectionChooser::
operator()(const FreeTrajectoryState &fts, const Surface &surface) const {
...
PropagationDirection PropagationDirectionChooser::
operator()(const FreeTrajectoryState &fts, const Plane &plane) const {
...
PropagationDirection PropagationDirectionChooser::
operator()(const FreeTrajectoryState &fts, const Cylinder &cylinder) const {
