...
/** Class containing (6x6) error matrix of a track in the global, Cartesian
 * frame. This error matrix should be used with care and in particular not as an
...
public:
  ...
  /** Returning (3x3) submatrix of error matrix containing information about the
   * errors and correlations between the different position coordinates.
   */
