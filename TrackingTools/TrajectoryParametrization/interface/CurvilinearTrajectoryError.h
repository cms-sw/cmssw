 ...
 *
 *  Please note that lambda and phi are defined in the global frame. Lambda is
 * the helix dip angle (pi/2 minus theta (polar angle)), while phi is the angle
 * of inclination with the global x-axis in the transverse (global xy) plane.
 */
