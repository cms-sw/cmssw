...
void TrackDetectorAssociator::fillEcal(const edm::Event& iEvent,
  ...
  for (const auto& trajectoryState : trajectoryStates)
    coreTrajectory.push_back(trajectoryState.position());
...
void TrackDetectorAssociator::fillCaloTowers(const edm::Event& iEvent,
  ...
  for (const auto& ecalTrajectoryState : ecalTrajectoryStates)
    trajectory.push_back(ecalTrajectoryState.position());
  for (const auto& hcalTrajectoryState : hcalTrajectoryStates)
    trajectory.push_back(hcalTrajectoryState.position());
...
void TrackDetectorAssociator::fillPreshower(const edm::Event& iEvent,
  ...
  for (const auto& trajectoryState : trajectoryStates)
    trajectory.push_back(trajectoryState.position());
