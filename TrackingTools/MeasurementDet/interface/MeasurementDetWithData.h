...
public:
  ...
  MeasurementDetWithData(const MeasurementDet &det,
  ...
  bool recHits(const TrajectoryStateOnSurface &stateOnThisDet,
               const MeasurementEstimator &me, RecHitContainer &result,
