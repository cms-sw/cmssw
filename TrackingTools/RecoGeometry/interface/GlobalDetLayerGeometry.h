...
/**
 * Global "reconstruction" geometry. It implements the idToLayer() method for
 * both Tracker and Muon layers. \author Boris Mangano (UCSD)  1/7/2009
 */
...
public:
  ...
  */
  ...
  /// Give the DetId of a module, returns the pointer to the corresponding
  /// DetLayer
