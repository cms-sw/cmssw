...
electronSeeds=(trackerDrivenElectronSeeds*ecalDrivenElectronSeeds*electronMergedSeeds) 


from TrackingTools.GsfTracking.CkfElectronCandidateMaker_cff import *
from TrackingTools.GsfTracking.GsfElectronGsfFit_cff import *
electronGsfTracking=(electronSeeds*electronCkfTrackCandidates*electronGsfTracks)
