...
public:
  ...
  /** Constructor from local and global trajectory parameters and surface
   * defining the local frame.
   */
...
private:
  void compute(Surface::RotationType const &rot, LocalVector const &tnl,
               GlobalVector const &tn, GlobalVector const &hq) dso_internal;
