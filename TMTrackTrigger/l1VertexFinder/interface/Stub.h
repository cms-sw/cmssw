#ifndef __TMTrackTrigger_VertexFinder_Stub_h__
...
public:
  ...
  Stub(TTStubRef ttStubRef, unsigned int index_in_vStubs, const Settings* settings, const TrackerGeometry*  trackerGeometry, const TrackerTopology*  trackerTopology, const std::map<DetId, DetId>* geoDetIdMap);
  ~Stub(){}
