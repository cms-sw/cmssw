...
class FileCatalogItem {
 public:
  ...
  FileCatalogItem(std::string const& pfn, std::string const& lfn,
...
class InputFileCatalog {
 ...
 private:
  void init(std::string const& override, std::string const& overrideFallback,
            bool useLFNasPFNifLFNnotFound);
  void findFile(std::string& pfn, std::string& fallbackPfn,
                std::string const& lfn, bool useLFNasPFNifLFNnotFound);
  ...
  edm::propagate_const<std::unique_ptr<FileLocator>>
