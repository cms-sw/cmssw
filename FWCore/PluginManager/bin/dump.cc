...
int main(int argc, char** argv) {
  ...
  desc.add_options()(kHelpCommandOpt, "produce help message")(
      ...
      //(kAllCommandOpt,"when no paths given, try to update caches for all known
      //directories [default is to only scan the first directory]")
      ;
