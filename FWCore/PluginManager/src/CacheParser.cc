...
namespace edmplugin {
  ...
  bool CacheParser::readline(std::istream& iIn, const boost::filesystem::path& iDirectory, unsigned long iRecordNumber,
  ...
  void CacheParser::read(std::istream& iIn, const boost::filesystem::path& iDirectory,
