...
// Class  :     OStreamColumn
//
/**\class OStreamColumn OStreamColumn.h
 ...
 \code
 edm::OStreamColumn col1 {"FirstNames"}; // Default width is size of the string
 "FirstNames"
 edm::OStreamColumn col2 {"LastNames", 30}; // Width is explicitly specifed as
 30.
 \endcode
 ...
 \code
 std::cout << col1 << col2 << '\n'; // Print column titles with the widths
 associated for col1 and col2.
