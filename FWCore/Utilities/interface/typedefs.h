...
// typedefs to provide platform independent types for members of ROOT persistent
// classes.
...
// int64_t, uint64_t cannot be used, because they resolve to long on some
// platforms and long long on others.
// For consistency, we don't use int32_t, uint32_t, int16_t, uint16_t, int8_t or
// uint8_t, either.
