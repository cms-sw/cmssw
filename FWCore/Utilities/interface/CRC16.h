...
inline unsigned short evf::compute_crc(unsigned char* buffer,
...
//______________________________________________________________________________
inline unsigned short evf::compute_crc_8bit(unsigned short crc,
                                            unsigned char data) {
  return (evf::crc_table[((crc >> 8) ^ data) & 0xFF] ^ (crc << 8));
}

//______________________________________________________________________________
inline unsigned short evf::compute_crc_64bit(unsigned short crc,
                                             unsigned char* p64) {
