...
inline typename ForwardSequence::const_iterator find_in_all(
    ForwardSequence const& s, Datum const& d) {
  return std::find(s.begin(), s.end(), d);
}

template <typename ForwardSequence, typename Datum>
inline typename ForwardSequence::iterator find_in_all(ForwardSequence& s,
                                                      Datum const& d) {
  return std::find(s.begin(), s.end(), d);
}
...
inline typename ForwardSequence::const_iterator find_if_in_all(
    ForwardSequence const& s, Predicate const& p) {
  return std::find_if(s.begin(), s.end(), p);
}

template <typename ForwardSequence, typename Predicate>
inline typename ForwardSequence::iterator find_if_in_all(ForwardSequence& s,
                                                         Predicate const& p) {
  return std::find_if(s.begin(), s.end(), p);
}
...
template <typename ForwardSequence, typename Datum>
inline typename ForwardSequence::const_iterator lower_bound_all(
    ForwardSequence const& s, Datum const& d) {
  return std::lower_bound(s.begin(), s.end(), d);
}

template <typename ForwardSequence, typename Datum>
inline typename ForwardSequence::iterator lower_bound_all(ForwardSequence& s,
                                                          Datum const& d) {
  return std::lower_bound(s.begin(), s.end(), d);
}
...
template <typename ForwardSequence, typename Datum, typename Predicate>
inline typename ForwardSequence::const_iterator lower_bound_all(
    ForwardSequence const& s, Datum const& d, Predicate p) {
