...
// A union which permits us to convert between a long double and three 32 bit
// ints.
typedef union {
  long double value;
  struct {
    ...
    // unsigned int empty1:32;   // maybe needed for 128-bit long double ?
    // (x86-64 and/or -m128bit-long-double)
  } parts;
