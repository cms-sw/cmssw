...
process.MessageLogger = cms.Service("MessageLogger",
    ...
    generate_preconfiguration_message = cms.untracked.string('precon-message'),
#   generate_preconfiguration_message = cms.string('precon-message'),
#   generate_preconfiguration_message = cms.untracked.int32(2),
