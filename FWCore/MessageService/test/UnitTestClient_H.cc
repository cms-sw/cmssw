...
void UnitTestClient_H::analyze(edm::Event const& /*unused*/
  ...
  IfLogTrace(nonexistent, "cat_A")
      << "IfLogTrace was used to send this message";  // check that these
                                                      // compile with
                                                      // non-existent variable
                                                      // as the condition
  IfLogTrace(nonexistent, "cat_A")
      << "IfLogTrace was used to not send this message";
  IfLogDebug(nonexistent, "cat_B")
      << "IfLogDebug was used to send this other message";
  IfLogDebug(nonexistent, "cat_B")
      << "IfLogDebug was used to not send other this message";
