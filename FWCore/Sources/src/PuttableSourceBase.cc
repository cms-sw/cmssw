...
void PuttableSourceBase::doEndRun(RunPrincipal& rp, bool cleaningUpAfterException, ProcessContext const*) {
  Run run(rp, moduleDescription(), nullptr);
  run.setProducer(this);
...
void PuttableSourceBase::doEndLumi(LuminosityBlockPrincipal& lbp, bool cleaningUpAfterException,
                                   ProcessContext const*) {
  LuminosityBlock lb(lbp, moduleDescription(), nullptr);
  lb.setProducer(this);
  callWithTryCatchAndPrint<void>([this, &lb]() { endLuminosityBlock(lb); }, "Calling Source::endLuminosityBlock",
...
void PuttableSourceBase::endRun(Run&) {}

void PuttableSourceBase::beginLuminosityBlock(LuminosityBlock&) {}

void PuttableSourceBase::endLuminosityBlock(LuminosityBlock&) {}
