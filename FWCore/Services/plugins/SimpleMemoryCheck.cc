...
// This is a form of reportMemoryInfo taking s vector, not a map
    ...
    void SimpleMemoryCheck::andPrint(std::string const& type, std::string const& mdlabel,
    ...
    void SimpleMemoryCheck::updateAndPrint(std::string const& type, std::string const& mdlabel,
...
#ifdef SIMPLE_MEMORY_CHECK_ORIGINAL_XML_OUTPUT
    void SimpleMemoryCheck::eventStatOutput(std::string title, SignificantEvent const& e,
...
#endif
    // changelog 2
    void SimpleMemoryCheck::updateModuleMemoryStats(SignificantModule& m, double dv,
