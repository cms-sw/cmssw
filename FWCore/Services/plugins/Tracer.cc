...
class Tracer {
 public:
  ...
  void postPathEvent(StreamContext const&, PathContext const&,
                     HLTPathStatus const&);
  ...
  void preModuleEventPrefetching(StreamContext const&,
                                 ModuleCallingContext const&);
  void postModuleEventPrefetching(StreamContext const&,
                                  ModuleCallingContext const&);
  void preModuleEvent(StreamContext const&, ModuleCallingContext const&);
  void postModuleEvent(StreamContext const&, ModuleCallingContext const&);
  void preModuleEventDelayedGet(StreamContext const&,
                                ModuleCallingContext const&);
  void postModuleEventDelayedGet(StreamContext const&,
                                 ModuleCallingContext const&);
  void preEventReadFromSource(StreamContext const&,
                              ModuleCallingContext const&);
  void postEventReadFromSource(StreamContext const&,
                               ModuleCallingContext const&);

  void preModuleStreamBeginRun(StreamContext const&,
                               ModuleCallingContext const&);
  void postModuleStreamBeginRun(StreamContext const&,
                                ModuleCallingContext const&);
  void preModuleStreamEndRun(StreamContext const&, ModuleCallingContext const&);
  void postModuleStreamEndRun(StreamContext const&,
                              ModuleCallingContext const&);

  void preModuleStreamBeginLumi(StreamContext const&,
                                ModuleCallingContext const&);
  void postModuleStreamBeginLumi(StreamContext const&,
                                 ModuleCallingContext const&);
  void preModuleStreamEndLumi(StreamContext const&,
                              ModuleCallingContext const&);
  void postModuleStreamEndLumi(StreamContext const&,
                               ModuleCallingContext const&);

  void preModuleGlobalBeginRun(GlobalContext const&,
                               ModuleCallingContext const&);
  void postModuleGlobalBeginRun(GlobalContext const&,
                                ModuleCallingContext const&);
  void preModuleGlobalEndRun(GlobalContext const&, ModuleCallingContext const&);
  void postModuleGlobalEndRun(GlobalContext const&,
                              ModuleCallingContext const&);

  void preModuleGlobalBeginLumi(GlobalContext const&,
                                ModuleCallingContext const&);
  void postModuleGlobalBeginLumi(GlobalContext const&,
                                 ModuleCallingContext const&);
  void preModuleGlobalEndLumi(GlobalContext const&,
                              ModuleCallingContext const&);
  void postModuleGlobalEndLumi(GlobalContext const&,
                               ModuleCallingContext const&);
...
Tracer::Tracer(ParameterSet const& iPS, ActivityRegistry& iRegistry)
    : indention_(iPS.getUntrackedParameter<std::string>("indention")),
      ...
      dumpNonModuleContext_(
          iPS.getUntrackedParameter<bool>("dumpNonModuleContext")),
      dumpPathsAndConsumes_(
          iPS.getUntrackedParameter<bool>("dumpPathsAndConsumes")),
      printTimestamps_(iPS.getUntrackedParameter<bool>("printTimestamps")) {
  for (std::string& label : iPS.getUntrackedParameter<std::vector<std::string>>(
  ...
  iRegistry.watchPreModuleEventPrefetching(this,
                                           &Tracer::preModuleEventPrefetching);
  iRegistry.watchPostModuleEventPrefetching(
      this, &Tracer::postModuleEventPrefetching);
  iRegistry.watchPreModuleEvent(this, &Tracer::preModuleEvent);
  iRegistry.watchPostModuleEvent(this, &Tracer::postModuleEvent);
  iRegistry.watchPreModuleEventDelayedGet(this,
                                          &Tracer::preModuleEventDelayedGet);
  iRegistry.watchPostModuleEventDelayedGet(this,
                                           &Tracer::postModuleEventDelayedGet);
  iRegistry.watchPreEventReadFromSource(this, &Tracer::preEventReadFromSource);
  iRegistry.watchPostEventReadFromSource(this,
                                         &Tracer::postEventReadFromSource);

  iRegistry.watchPreModuleStreamBeginRun(this,
                                         &Tracer::preModuleStreamBeginRun);
  iRegistry.watchPostModuleStreamBeginRun(this,
                                          &Tracer::postModuleStreamBeginRun);
  ...
  iRegistry.watchPreModuleStreamBeginLumi(this,
                                          &Tracer::preModuleStreamBeginLumi);
  iRegistry.watchPostModuleStreamBeginLumi(this,
                                           &Tracer::postModuleStreamBeginLumi);
  iRegistry.watchPreModuleStreamEndLumi(this, &Tracer::preModuleStreamEndLumi);
  iRegistry.watchPostModuleStreamEndLumi(this,
                                         &Tracer::postModuleStreamEndLumi);

  iRegistry.watchPreModuleGlobalBeginRun(this,
                                         &Tracer::preModuleGlobalBeginRun);
  iRegistry.watchPostModuleGlobalBeginRun(this,
                                          &Tracer::postModuleGlobalBeginRun);
  ...
  iRegistry.watchPreModuleGlobalBeginLumi(this,
                                          &Tracer::preModuleGlobalBeginLumi);
  iRegistry.watchPostModuleGlobalBeginLumi(this,
                                           &Tracer::postModuleGlobalBeginLumi);
  iRegistry.watchPreModuleGlobalEndLumi(this, &Tracer::preModuleGlobalEndLumi);
  iRegistry.watchPostModuleGlobalEndLumi(this,
                                         &Tracer::postModuleGlobalEndLumi);
  ...
  iRegistry.preSourceEarlyTerminationSignal_.connect(
      [this](edm::TerminationOrigin iOrigin) {
        LogAbsolute out("Tracer");
        out << TimeStamper(printTimestamps_);
        out << indention_ << indention_
            << " early termination before processing transition";
      });
  iRegistry.preStreamEarlyTerminationSignal_.connect([this](
      edm::StreamContext const& iContext, edm::TerminationOrigin iOrigin) {
    LogAbsolute out("Tracer");
    out << TimeStamper(printTimestamps_);
    if (iContext.eventID().luminosityBlock() == 0) {
      out << indention_ << indention_
          << " early termination of run: stream = " << iContext.streamID()
          << " run = " << iContext.eventID().run();
    } else {
      if (iContext.eventID().event() == 0) {
        out << indention_ << indention_
            << " early termination of stream lumi: stream = "
            << iContext.streamID() << " run = " << iContext.eventID().run()
            << " lumi = " << iContext.eventID().luminosityBlock();
      } else {
        out << indention_ << indention_
            << " early termination of event: stream = " << iContext.streamID()
            << " run = " << iContext.eventID().run()
            << " lumi = " << iContext.eventID().luminosityBlock()
  ...
  iRegistry.preGlobalEarlyTerminationSignal_.connect([this](
      edm::GlobalContext const& iContext, edm::TerminationOrigin iOrigin) {
    LogAbsolute out("Tracer");
    out << TimeStamper(printTimestamps_);
    if (iContext.luminosityBlockID().value() == 0) {
      out << indention_ << indention_ << " early termination of global run "
          << iContext.luminosityBlockID().run();
    } else {
      out << indention_ << indention_
          << " early termination of global lumi run = "
          << iContext.luminosityBlockID().run()
...
void Tracer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  desc.addUntracked<std::string>("indention", "++")
      ->setComment(
          "Prefix characters for output. The characters are repeated to form "
          "the indentation.");
  desc.addUntracked<std::vector<std::string>>("dumpContextForLabels",
                                              std::vector<std::string>{})
      ->setComment(
          "Prints context information to cout for the module transitions "
          "associated with these modules' labels");
  desc.addUntracked<bool>("dumpNonModuleContext", false)
      ->setComment(
          "Prints context information to cout for the transitions not "
          "associated with any module label");
  desc.addUntracked<bool>("dumpPathsAndConsumes", false)
      ->setComment(
          "Prints information to cout about paths, endpaths, products consumed "
          "by modules and the dependencies between modules created by the "
          "products they consume");
  desc.addUntracked<bool>("printTimestamps", false)
      ->setComment("Prints a time stamp for every transition");
  descriptions.add("Tracer", desc);
  descriptions.setComment(
      "This service prints each phase the framework is processing, e.g. "
      "constructing a module,running a module, etc.");
}
...
void Tracer::preallocate(service::SystemBounds const& bounds) {
  LogAbsolute("Tracer") << TimeStamper(printTimestamps_) << indention_
                        ...
                        << " concurrent luminosity sections, "
  ...
  if (dumpPathsAndConsumes_) {
    ...
    for (unsigned int j = 0; j < paths.size(); ++j) {
      std::vector<ModuleDescription const*> const& modulesOnPath =
          pathsAndConsumes.modulesOnPath(j);
    ...
    for (unsigned int j = 0; j < endpaths.size(); ++j) {
      std::vector<ModuleDescription const*> const& modulesOnEndPath =
          pathsAndConsumes.modulesOnEndPath(j);
    ...
    std::vector<ModuleDescription const*> const& allModules =
        pathsAndConsumes.allModules();
    out << "All modules and modules in the current process whose products they "
           "consume:\n";
    out << "(This does not include modules from previous processes or the "
           "source)\n";
    for (auto const& module : allModules) {
      ...
      if (!modulesWhoseProductsAreConsumedBy.empty()) {
        ...
        for (auto const& producingModule : modulesWhoseProductsAreConsumedBy) {
          out << "    " << producingModule->moduleName() << "/\'"
    ...
    out << "All modules (listed by class and label) and all their consumed "
           "products.\n";
    out << "Consumed products are listed by type, label, instance, process.\n";
    out << "For products not in the event, \'run\' or \'lumi\' is added to "
           "indicate the TTree they are from.\n";
    out << "For products that are declared with mayConsume, \'may consume\' is "
           "added.\n";
    out << "For products consumed for Views, \'element type\' is added\n";
    out << "For products only read from previous processes, \'skip current "
           "process\' is added\n";
    for (auto const* module : allModules) {
      out << "  " << module->moduleName() << "/\'" << module->moduleLabel()
          << "\'";
      std::vector<ConsumesInfo> consumesInfo =
          pathsAndConsumes.consumesInfo(module->id());
      if (!consumesInfo.empty()) {
        out << " consumes:\n";
        for (auto const& info : consumesInfo) {
          out << "    " << info.type() << " \'" << info.label() << "\' \'"
              << info.instance();
          out << "\' \'" << info.process() << "\'";
...
void Tracer::preSourceEvent(StreamID sid) {
  LogAbsolute("Tracer") << TimeStamper(printTimestamps_) << indention_
                        << indention_ << " starting: source event";
}

void Tracer::postSourceEvent(StreamID sid) {
  LogAbsolute("Tracer") << TimeStamper(printTimestamps_) << indention_
                        << indention_ << " finished: source event";
}

void Tracer::preSourceLumi() {
  LogAbsolute("Tracer") << TimeStamper(printTimestamps_) << indention_
                        << indention_ << " starting: source lumi";
}

void Tracer::postSourceLumi() {
  LogAbsolute("Tracer") << TimeStamper(printTimestamps_) << indention_
                        << indention_ << " finished: source lumi";
}

void Tracer::preSourceRun() {
  LogAbsolute("Tracer") << TimeStamper(printTimestamps_) << indention_
                        << indention_ << " starting: source run";
}

void Tracer::postSourceRun() {
  LogAbsolute("Tracer") << TimeStamper(printTimestamps_) << indention_
                        << indention_ << " finished: source run";
}
...
void Tracer::preOpenFile(std::string const& lfn, bool b) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " starting: open input file: lfn = " << lfn;
...
void Tracer::postOpenFile(std::string const& lfn, bool b) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " finished: open input file: lfn = " << lfn;
  if (dumpNonModuleContext_) out << " usedFallBack = " << b;
}
...
void Tracer::preCloseFile(std::string const& lfn, bool b) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " starting: close input file: lfn = " << lfn;
  if (dumpNonModuleContext_) out << " usedFallBack = " << b;
}
void Tracer::postCloseFile(std::string const& lfn, bool b) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " finished: close input file: lfn = " << lfn;
  if (dumpNonModuleContext_) out << " usedFallBack = " << b;
}
...
void Tracer::preModuleBeginStream(StreamContext const& sc,
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " starting: begin stream for module: stream = " << sc.streamID()
      << " label = '" << desc.moduleLabel() << "' id = " << desc.id();
  if (dumpContextForLabels_.find(desc.moduleLabel()) !=
      dumpContextForLabels_.end()) {
    out << "\n" << sc;
    out << mcc;
  }
}
...
void Tracer::postModuleBeginStream(StreamContext const& sc,
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " finished: begin stream for module: stream = " << sc.streamID()
      << " label = '" << desc.moduleLabel() << "' id = " << desc.id();
  if (dumpContextForLabels_.find(desc.moduleLabel()) !=
      dumpContextForLabels_.end()) {
    out << "\n" << sc;
...
void Tracer::preModuleEndStream(StreamContext const& sc,
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " starting: end stream for module: stream = " << sc.streamID()
      << " label = '" << desc.moduleLabel() << "' id = " << desc.id();
  if (dumpContextForLabels_.find(desc.moduleLabel()) !=
      dumpContextForLabels_.end()) {
    out << "\n" << sc;
...
void Tracer::postModuleEndStream(StreamContext const& sc,
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " finished: end stream for module: stream = " << sc.streamID()
      << " label = '" << desc.moduleLabel() << "' id = " << desc.id();
  if (dumpContextForLabels_.find(desc.moduleLabel()) !=
      dumpContextForLabels_.end()) {
    out << "\n" << sc;
...
void Tracer::preGlobalBeginRun(GlobalContext const& gc) {
  LogAbsolute out("Tracer");
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_ << " starting: global begin run "
      << gc.luminosityBlockID().run() << " : time = " << gc.timestamp().value();
...
void Tracer::postGlobalBeginRun(GlobalContext const& gc) {
  LogAbsolute out("Tracer");
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_ << " finished: global begin run "
      << gc.luminosityBlockID().run() << " : time = " << gc.timestamp().value();
  if (dumpNonModuleContext_) {
    out << "\n" << gc;
  }
...
void Tracer::preGlobalEndRun(GlobalContext const& gc) {
  LogAbsolute out("Tracer");
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_ << " starting: global end run "
      << gc.luminosityBlockID().run() << " : time = " << gc.timestamp().value();
  if (dumpNonModuleContext_) {
    out << "\n" << gc;
  }
...
void Tracer::postGlobalEndRun(GlobalContext const& gc) {
  LogAbsolute out("Tracer");
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_ << " finished: global end run "
      << gc.luminosityBlockID().run() << " : time = " << gc.timestamp().value();
  if (dumpNonModuleContext_) {
    out << "\n" << gc;
  }
...
void Tracer::preStreamBeginRun(StreamContext const& sc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " starting: begin run: stream = " << sc.streamID()
      << " run = " << sc.eventID().run()
...
void Tracer::postStreamBeginRun(StreamContext const& sc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " finished: begin run: stream = " << sc.streamID()
      << " run = " << sc.eventID().run()
      << " time = " << sc.timestamp().value();
  if (dumpNonModuleContext_) {
    out << "\n" << sc;
...
void Tracer::preStreamEndRun(StreamContext const& sc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " starting: end run: stream = " << sc.streamID()
      << " run = " << sc.eventID().run()
      << " time = " << sc.timestamp().value();
  if (dumpNonModuleContext_) {
    out << "\n" << sc;
...
void Tracer::postStreamEndRun(StreamContext const& sc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " finished: end run: stream = " << sc.streamID()
      << " run = " << sc.eventID().run()
      << " time = " << sc.timestamp().value();
  if (dumpNonModuleContext_) {
    out << "\n" << sc;
...
void Tracer::preGlobalBeginLumi(GlobalContext const& gc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " starting: global begin lumi: run = " << gc.luminosityBlockID().run()
...
void Tracer::postGlobalBeginLumi(GlobalContext const& gc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " finished: global begin lumi: run = " << gc.luminosityBlockID().run()
      << " lumi = " << gc.luminosityBlockID().luminosityBlock()
      << " time = " << gc.timestamp().value();
  if (dumpNonModuleContext_) {
    out << "\n" << gc;
...
void Tracer::preGlobalEndLumi(GlobalContext const& gc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " starting: global end lumi: run = " << gc.luminosityBlockID().run()
      << " lumi = " << gc.luminosityBlockID().luminosityBlock()
      << " time = " << gc.timestamp().value();
  if (dumpNonModuleContext_) {
    out << "\n" << gc;
...
void Tracer::postGlobalEndLumi(GlobalContext const& gc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " finished: global end lumi: run = " << gc.luminosityBlockID().run()
      << " lumi = " << gc.luminosityBlockID().luminosityBlock()
      << " time = " << gc.timestamp().value();
  if (dumpNonModuleContext_) {
    out << "\n" << gc;
...
void Tracer::preStreamBeginLumi(StreamContext const& sc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " starting: begin lumi: stream = " << sc.streamID()
      << " run = " << sc.eventID().run()
...
void Tracer::postStreamBeginLumi(StreamContext const& sc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " finished: begin lumi: stream = " << sc.streamID()
      << " run = " << sc.eventID().run()
      << " lumi = " << sc.eventID().luminosityBlock()
      << " time = " << sc.timestamp().value();
  if (dumpNonModuleContext_) {
...
void Tracer::preStreamEndLumi(StreamContext const& sc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " starting: end lumi: stream = " << sc.streamID()
      << " run = " << sc.eventID().run()
      << " lumi = " << sc.eventID().luminosityBlock()
      << " time = " << sc.timestamp().value();
  if (dumpNonModuleContext_) {
...
void Tracer::postStreamEndLumi(StreamContext const& sc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " finished: end lumi: stream = " << sc.streamID()
      << " run = " << sc.eventID().run()
      << " lumi = " << sc.eventID().luminosityBlock()
      << " time = " << sc.timestamp().value();
  if (dumpNonModuleContext_) {
...
void Tracer::preEvent(StreamContext const& sc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " starting: processing event : stream = " << sc.streamID()
      << " run = " << sc.eventID().run()
      << " lumi = " << sc.eventID().luminosityBlock()
...
void Tracer::postEvent(StreamContext const& sc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " finished: processing event : stream = " << sc.streamID()
      << " run = " << sc.eventID().run()
      << " lumi = " << sc.eventID().luminosityBlock()
      << " event = " << sc.eventID().event()
      << " time = " << sc.timestamp().value();
...
void Tracer::prePathEvent(StreamContext const& sc, PathContext const& pc) {
  LogAbsolute out("Tracer");
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_ << indention_
      << " starting: processing path '" << pc.pathName()
      << "' : stream = " << sc.streamID();
  if (dumpNonModuleContext_) {
    out << "\n" << sc;
    out << pc;
...
void Tracer::postPathEvent(StreamContext const& sc, PathContext const& pc,
                           HLTPathStatus const& hlts) {
  LogAbsolute out("Tracer");
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_ << indention_
      << " finished: processing path '" << pc.pathName()
      << "' : stream = " << sc.streamID();
  if (dumpNonModuleContext_) {
    out << "\n" << sc;
    out << pc;
...
void Tracer::preModuleConstruction(ModuleDescription const& desc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " starting: constructing module with label '" << desc.moduleLabel()
      << "' id = " << desc.id();
  if (dumpContextForLabels_.find(desc.moduleLabel()) !=
      dumpContextForLabels_.end()) {
    out << "\n" << desc;
...
void Tracer::postModuleConstruction(ModuleDescription const& desc) {
  ...
  out << TimeStamper(printTimestamps_);
  out << indention_ << indention_
      << " finished: constructing module with label '" << desc.moduleLabel()
      << "' id = " << desc.id();
  if (dumpContextForLabels_.find(desc.moduleLabel()) !=
      dumpContextForLabels_.end()) {
    out << "\n" << desc;
...
void Tracer::preModuleEventPrefetching(StreamContext const& sc,
  ...
  out << " starting: prefetching before processing event for module: stream = "
      << sc.streamID() << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
    out << "\n" << sc;
    out << mcc;
  }
...
void Tracer::postModuleEventPrefetching(StreamContext const& sc,
  ...
  out << " finished: prefetching before processing event for module: stream = "
      << sc.streamID() << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::preModuleEvent(StreamContext const& sc,
  ...
  out << " starting: processing event for module: stream = " << sc.streamID()
...
void Tracer::postModuleEvent(StreamContext const& sc,
  ...
  out << " finished: processing event for module: stream = " << sc.streamID()
      << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::preModuleEventDelayedGet(StreamContext const& sc,
  ...
  out << " starting: delayed processing event for module: stream = "
      << sc.streamID() << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::postModuleEventDelayedGet(StreamContext const& sc,
  ...
  out << " finished: delayed processing event for module: stream = "
      << sc.streamID() << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::preEventReadFromSource(StreamContext const& sc,
  ...
  out << " starting: event delayed read from source: stream = " << sc.streamID()
      << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
}
...
void Tracer::postEventReadFromSource(StreamContext const& sc,
  ...
  out << " finished: event delayed read from source: stream = " << sc.streamID()
      << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
}
...
void Tracer::preModuleStreamBeginRun(StreamContext const& sc,
  ...
  out << " starting: begin run for module: stream = " << sc.streamID()
      << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::postModuleStreamBeginRun(StreamContext const& sc,
  ...
  out << " finished: begin run for module: stream = " << sc.streamID()
      << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::preModuleStreamEndRun(StreamContext const& sc,
  ...
  out << " starting: end run for module: stream = " << sc.streamID()
      << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::postModuleStreamEndRun(StreamContext const& sc,
  ...
  out << " finished: end run for module: stream = " << sc.streamID()
      << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::preModuleStreamBeginLumi(StreamContext const& sc,
  ...
  out << " starting: begin lumi for module: stream = " << sc.streamID()
      << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::postModuleStreamBeginLumi(StreamContext const& sc,
  ...
  out << " finished: begin lumi for module: stream = " << sc.streamID()
      << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::preModuleStreamEndLumi(StreamContext const& sc,
  ...
  out << " starting: end lumi for module: stream = " << sc.streamID()
      << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::postModuleStreamEndLumi(StreamContext const& sc,
  ...
  out << " finished: end lumi for module: stream = " << sc.streamID()
      << " label = '" << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::preModuleGlobalBeginRun(GlobalContext const& gc,
  ...
  out << " starting: global begin run for module: label = '"
...
void Tracer::postModuleGlobalBeginRun(GlobalContext const& gc,
  ...
  out << " finished: global begin run for module: label = '"
      << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::preModuleGlobalEndRun(GlobalContext const& gc,
  ...
  out << " starting: global end run for module: label = '"
      << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::postModuleGlobalEndRun(GlobalContext const& gc,
  ...
  out << " finished: global end run for module: label = '"
      << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::preModuleGlobalBeginLumi(GlobalContext const& gc,
  ...
  out << " starting: global begin lumi for module: label = '"
      << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::postModuleGlobalBeginLumi(GlobalContext const& gc,
  ...
  out << " finished: global begin lumi for module: label = '"
      << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::preModuleGlobalEndLumi(GlobalContext const& gc,
  ...
  out << " starting: global end lumi for module: label = '"
      << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
...
void Tracer::postModuleGlobalEndLumi(GlobalContext const& gc,
  ...
  out << " finished: global end lumi for module: label = '"
      << mcc.moduleDescription()->moduleLabel()
      << "' id = " << mcc.moduleDescription()->id();
  if (dumpContextForLabels_.find(mcc.moduleDescription()->moduleLabel()) !=
      dumpContextForLabels_.end()) {
