 ...
 *
 * This has the advantage that value_for_column does not have to be redefined
 * for multiple classes with a similar interface, but it has one caveat: if a
 * different value_for_column function needs to be defined for a given class,
 * it needs to be defined also for all derived classes, otherwise the templated
 * value_for_column function will still be used for the derived classes.
 *
 * Therefore, it is encouraged to adapt the interface of the class to the
 * generic value_for_column function generated by this macro, rather than
 * implementing value_for_column overloads for each class.
 */
