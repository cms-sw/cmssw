...
PYBIND11_MODULE(libFWCorePythonParameterSet, m) {
  ...
  pybind11::class_<Python11ParameterSet>(m, "ParameterSet")
      ...
      .def("addFloat", &Python11ParameterSet::addParameter<float>)
      .def("getFloat", &Python11ParameterSet::getParameter<float>)
      .def("addVFloat", &Python11ParameterSet::addParameters<float>)
      .def("getVFloat", &Python11ParameterSet::getParameters<float>)
