...
BOOST_PYTHON_MODULE(libFWCorePythonParameterSet) {
  ...
  boost::python::class_<edm::InputTag>("InputTag",
  ...
  boost::python::class_<edm::ESInputTag>("ESInputTag",
                                         boost::python::init<std::string>())
      .def(boost::python::init<std::string, std::string>())
  ...
  boost::python::class_<edm::EventID>(
      "EventID",
      boost::python::init<edm::RunNumber_t, edm::LuminosityBlockNumber_t,
                          edm::EventNumber_t>())
      .def("run", &edm::EventID::run)
      .def("luminosityBlock", &edm::EventID::luminosityBlock)
      .def("event", &edm::EventID::event);

  boost::python::class_<edm::LuminosityBlockID>(
  ...
  boost::python::class_<edm::FileInPath>("FileInPath",
                                         boost::python::init<std::string>())
  ...
  boost::python::class_<edm::LuminosityBlockRange>(
      "LuminosityBlockRange", boost::python::init<unsigned int, unsigned int,
  ...
  boost::python::class_<edm::EventRange>(
      "EventRange",
      boost::python::init<edm::RunNumber_t, edm::LuminosityBlockNumber_t,
                          edm::EventNumber_t, edm::RunNumber_t,
                          edm::LuminosityBlockNumber_t, edm::EventNumber_t>())
  ...
  boost::python::class_<PythonParameterSet>("ParameterSet")
      ...
      .def("addVESInputTag",
           &PythonParameterSet::addParameters<edm::ESInputTag>)
      .def("getVESInputTag",
           &PythonParameterSet::getParameters<edm::ESInputTag>)
      ...
      .def("addLuminosityBlockID",
           &PythonParameterSet::addParameter<edm::LuminosityBlockID>)
      .def("getLuminosityBlockID",
           &PythonParameterSet::getParameter<edm::LuminosityBlockID>)
      .def("addVLuminosityBlockID",
           &PythonParameterSet::addParameters<edm::LuminosityBlockID>)
      .def("getVLuminosityBlockID",
           &PythonParameterSet::getParameters<edm::LuminosityBlockID>)
      .def("addLuminosityBlockRange",
           &PythonParameterSet::addParameter<edm::LuminosityBlockRange>)
      .def("getLuminosityBlockRange",
           &PythonParameterSet::getParameter<edm::LuminosityBlockRange>)
      ...
      .def("addVEventRange",
           &PythonParameterSet::addParameters<edm::EventRange>)
      .def("getVEventRange",
           &PythonParameterSet::getParameters<edm::EventRange>)
  ...
  boost::python::class_<PythonProcessDesc>("ProcessDesc",
                                           boost::python::init<>())
