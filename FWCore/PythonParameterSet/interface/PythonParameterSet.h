...
class PythonParameterSet {
 public:
  ...
  template <typename T>
  boost::python::list getParameters(bool tracked,
  ...
  template <typename T>
  void addParameters(bool tracked, std::string const& name,
  ...
  edm::EventID newEventID(edm::RunNumber_t run,
                          edm::LuminosityBlockNumber_t lumi,
                          edm::EventNumber_t event) {
    return edm::EventID(run, lumi, event);
  }

  edm::LuminosityBlockID newLuminosityBlockID(unsigned int run,
                                              unsigned int lumi) {
  ...
  void addNewFileInPath(bool tracked, std::string const& name,
