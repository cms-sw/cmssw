...
@example_track #include "FWCore/Utilities/interface/InputTag.h" @example_track #include
    "DataFormats/TrackReco/interface/Track.h" @example_track #include "DataFormats/TrackReco/interface/TrackFwd.h"
    @example_histo #include "FWCore/ServiceRegistry/interface/Service.h" @example_histo #include
    "CommonTools/UtilAlgos/interface/TFileService.h" @example_histo #include "TH1.h"
    //
    // class declaration
    //
...
//
__class__::__class__(const edm::ParameterSet& iConfig) @example_track :
...
void __class__::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  @example_track @example_track  // Specify that only 'tracks' is allowed
