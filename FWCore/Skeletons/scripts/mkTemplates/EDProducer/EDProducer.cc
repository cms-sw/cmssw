...
@example_myparticle #include "DataFormats/MuonReco/interface/Muon.h"
    @example_myparticle #include
    "DataFormats/EgammaCandidates/interface/PixelMatchGsfElectron.h"
...
__class__::__class__(const edm::ParameterSet& iConfig) @example_myparticle :
    ...
    @example_myparticle electronTags_(
...
void __class__::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  */
  ...
  @example_myparticle
      @example_myparticle Handle<PixelMatchGsfElectronCollection>
          electrons;
  ...
  @example_myparticle @example_myparticle  // if the number of electrons or
                                           // muons is 4 (or 2 and 2), costruct
                                           // a new particle
    ...
    @example_myparticle @example_myparticle  // loop over muons, sum over p4s
                                             // and charges. Later same for
                                             // electrons
        @example_myparticle for (MuonCollection::const_iterator muon =
                                     muons->begin();
                                 muon != muons->end(); ++muon) {
    ...
    @example_myparticle
        @example_myparticle for (PixelMatchGsfElectronCollection::const_iterator
    ...
    @example_myparticle @example_myparticle  // create a particle with momentum
                                             // and charge from muons and
                                             // electrons
...
/*
void
__class__::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup
const&)
{
}
*/
...
/*
void
__class__::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup
const&)
{
}
*/
...
void __class__::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  @example_myparticle @example_myparticle  // Specify that only 'muons' and
                                           // 'electrons' are allowed
      @example_myparticle  // To use, remove the default given above and
                           // uncomment below
