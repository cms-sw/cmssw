...
namespace edmtest {
  class TransformAsyncIntUntypedProducer : public edm::global::EDProducer<edm::Transformer> {
  public:
    struct WorkCache {
    ...
    TransformAsyncIntUntypedProducer(edm::ParameterSet const& iPSet)
...
using edmtest::TransformAsyncIntUntypedProducer;
DEFINE_FWK_MODULE(TransformAsyncIntUntypedProducer);
