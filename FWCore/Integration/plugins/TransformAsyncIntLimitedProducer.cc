...
namespace edmtest {
  class TransformAsyncIntLimitedProducer : public edm::limited::EDProducer<edm::Transformer> {
  public:
    struct WorkCache {
    ...
    TransformAsyncIntLimitedProducer(edm::ParameterSet const& iPSet)
...
using edmtest::TransformAsyncIntLimitedProducer;
DEFINE_FWK_MODULE(TransformAsyncIntLimitedProducer);
