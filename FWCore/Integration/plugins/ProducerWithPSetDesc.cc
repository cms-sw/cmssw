...
namespace edmtest {
  ...
  template <int N>
  ProducerWithPSetDesc<N>::ProducerWithPSetDesc(edm::ParameterSet const& ps) {
    testingAutoGeneratedCfi = ps.getUntrackedParameter<bool>("testingAutoGeneratedCfi", true);

    REQUIRE(ps.getParameter<int>("p_int") == 2147483647);
    REQUIRE(ps.getUntrackedParameter<int>("p_int_untracked") == -2147483647);
    if (testingAutoGeneratedCfi)
      REQUIRE(ps.getParameter<int>("p_int_opt") == 0);
    if (testingAutoGeneratedCfi) {
      REQUIRE(ps.getUntrackedParameter<int>("p_int_optuntracked") == 7);
      REQUIRE(!ps.exists("p_int_opt_nd"));
      REQUIRE(!ps.exists("p_int_optuntracked_nd"));
    } else {
      REQUIRE(!ps.exists("p_int_optuntracked"));
      REQUIRE(ps.getParameter<int>("p_int_opt_nd") == 11);
      REQUIRE(ps.getUntrackedParameter<int>("p_int_optuntracked_nd") == 12);
    }
    ...
    REQUIRE(vint[0] == 2147483647);
    vint = ps.getParameter<std::vector<int>>("vint3");
    REQUIRE(vint[0] == 2147483647);
    REQUIRE(vint[1] == -2147483647);
    std::array<int, 2> testArray = ps.getParameter<std::array<int, 2>>(std::string("vint3"));
    REQUIRE(testArray[0] == 2147483647);
    REQUIRE(testArray[1] == -2147483647);
    std::array<int, 2> testArray1 = ps.getParameter<std::array<int, 2>>("vint3");
    REQUIRE(testArray1[0] == 2147483647);
    REQUIRE(testArray1[1] == -2147483647);
    vint = ps.getParameter<std::vector<int>>("vint4");
    REQUIRE(vint[0] == 2147483647);
    REQUIRE(vint[1] == -2147483647);
    REQUIRE(vint[2] == 0);

    REQUIRE(ps.getParameter<unsigned>("uint1") == 4294967295U);
    REQUIRE(ps.getUntrackedParameter<unsigned>("uint2") == 0);
    ...
    REQUIRE(ps.getParameter<long long>("int64v1") == 9000000000000000000LL);
    REQUIRE(ps.getParameter<long long>("int64v2") == -9000000000000000000LL);
    REQUIRE(ps.getParameter<long long>("int64v3") == 0);

    std::vector<long long> vint64;
    vint64 = ps.getParameter<std::vector<long long>>("vint64v1");
    REQUIRE(vint64.empty());
    vint64 = ps.getParameter<std::vector<long long>>("vint64v2");
    REQUIRE(vint64[0] == 9000000000000000000LL);
    vint64 = ps.getParameter<std::vector<long long>>("vint64v3");
    REQUIRE(vint64[0] == 9000000000000000000LL);
    REQUIRE(vint64[1] == -9000000000000000000LL);
    vint64 = ps.getParameter<std::vector<long long>>("vint64v4");
    REQUIRE(vint64[0] == 9000000000000000000LL);
    REQUIRE(vint64[1] == -9000000000000000000LL);
    REQUIRE(vint64[2] == 0);

    REQUIRE(ps.getParameter<unsigned long long>("uint64v1") == 18000000000000000000ULL);
    REQUIRE(ps.getUntrackedParameter<unsigned long long>("uint64v2") == 0);

    std::vector<unsigned long long> vuint64;
    vuint64 = ps.getParameter<std::vector<unsigned long long>>("vuint64v1");
    REQUIRE(vuint64.empty());
    vuint64 = ps.getParameter<std::vector<unsigned long long>>("vuint64v2");
    REQUIRE(vuint64[0] == 18000000000000000000ULL);
    ...
    REQUIRE(vLuminosityBlockID.empty());
    vLuminosityBlockID = ps.getParameter<std::vector<edm::LuminosityBlockID>>("vLuminosityBlockIDv2");
    REQUIRE(vLuminosityBlockID[0] == edm::LuminosityBlockID(1000, 1100));
    vLuminosityBlockID = ps.getParameter<std::vector<edm::LuminosityBlockID>>("vLuminosityBlockIDv3");
    REQUIRE(vLuminosityBlockID[0] == edm::LuminosityBlockID(1000, 1100));
    REQUIRE(vLuminosityBlockID[1] == edm::LuminosityBlockID(10000, 11000));
    vLuminosityBlockID = ps.getParameter<std::vector<edm::LuminosityBlockID>>("vLuminosityBlockIDv4");
    REQUIRE(vLuminosityBlockID[0] == edm::LuminosityBlockID(1000, 1100));
    REQUIRE(vLuminosityBlockID[1] == edm::LuminosityBlockID(10000, 11000));
    REQUIRE(vLuminosityBlockID[2] == edm::LuminosityBlockID(100000, 110000));

    edm::LuminosityBlockRange lumiRange1(1, 1, 9, 9);
    REQUIRE(ps.getParameter<edm::LuminosityBlockRange>("lumiRangev1").startLumiID() == lumiRange1.startLumiID());
    REQUIRE(ps.getParameter<edm::LuminosityBlockRange>("lumiRangev1").endLumiID() == lumiRange1.endLumiID());
    edm::LuminosityBlockRange lumiRange2(3, 4, 1000, 1000);
    REQUIRE(ps.getParameter<edm::LuminosityBlockRange>("lumiRangev2").startLumiID() == lumiRange2.startLumiID());
    REQUIRE(ps.getParameter<edm::LuminosityBlockRange>("lumiRangev2").endLumiID() == lumiRange2.endLumiID());
    ...
    REQUIRE(vLumiRange.empty());
    vLumiRange = ps.getParameter<std::vector<edm::LuminosityBlockRange>>("vLumiRangev2");
    REQUIRE(vLumiRange[0].startLumiID() == lumiRange1.startLumiID());
    vLumiRange = ps.getParameter<std::vector<edm::LuminosityBlockRange>>("vLumiRangev3");
    REQUIRE(vLumiRange[0].startLumiID() == lumiRange1.startLumiID());
    REQUIRE(vLumiRange[1].startLumiID() == lumiRange2.startLumiID());
    REQUIRE(vLumiRange[1].endLumiID() == lumiRange2.endLumiID());

    edm::EventRange eventRange1(1, 0, 1, 8, 0, 8);
    REQUIRE(ps.getParameter<edm::EventRange>("eventRangev1").startEventID() == eventRange1.startEventID());
    REQUIRE(ps.getParameter<edm::EventRange>("eventRangev1").endEventID() == eventRange1.endEventID());
    edm::EventRange eventRange2(3, 0, 4, 1001, 0, 1002);
    REQUIRE(ps.getParameter<edm::EventRange>("eventRangev2").startEventID() == eventRange2.startEventID());
    REQUIRE(ps.getParameter<edm::EventRange>("eventRangev2").endEventID() == eventRange2.endEventID());

    std::vector<edm::EventRange> vEventRange;
    vEventRange = ps.getParameter<std::vector<edm::EventRange>>("vEventRangev1");
    REQUIRE(vEventRange.empty());
    vEventRange = ps.getParameter<std::vector<edm::EventRange>>("vEventRangev2");
    REQUIRE(vEventRange[0].startEventID() == eventRange1.startEventID());
    vEventRange = ps.getParameter<std::vector<edm::EventRange>>("vEventRangev3");
    REQUIRE(vEventRange[0].startEventID() == eventRange1.startEventID());
    REQUIRE(vEventRange[1].startEventID() == eventRange2.startEventID());

    edm::InputTag inputTag1("One", "Two", "Three");
    REQUIRE(ps.getParameter<edm::InputTag>("inputTagv1") == inputTag1);
    edm::InputTag inputTag2("One", "Two");
    REQUIRE(ps.getParameter<edm::InputTag>("inputTagv2") == inputTag2);
    edm::InputTag inputTag3("One");
    REQUIRE(ps.getParameter<edm::InputTag>("inputTagv3") == inputTag3);
    edm::InputTag inputTag4("One", "", "Three");
    REQUIRE(ps.getParameter<edm::InputTag>("inputTagv4") == inputTag4);

    std::vector<edm::InputTag> vInputTag;
    vInputTag = ps.getParameter<std::vector<edm::InputTag>>("vInputTagv1");
    REQUIRE(vInputTag.empty());
    vInputTag = ps.getParameter<std::vector<edm::InputTag>>("vInputTagv2");
    REQUIRE(vInputTag[0] == inputTag1);
    vInputTag = ps.getParameter<std::vector<edm::InputTag>>("vInputTagv3");
    REQUIRE(vInputTag[0] == inputTag1);
    REQUIRE(vInputTag[1] == inputTag2);
    vInputTag = ps.getParameter<std::vector<edm::InputTag>>("vInputTagv4");
    REQUIRE(vInputTag[0] == inputTag1);
    REQUIRE(vInputTag[1] == inputTag2);
    REQUIRE(vInputTag[2] == inputTag3);
    vInputTag = ps.getParameter<std::vector<edm::InputTag>>("vInputTagv5");
    REQUIRE(vInputTag[0] == inputTag1);
    REQUIRE(vInputTag[1] == inputTag2);
    REQUIRE(vInputTag[2] == inputTag3);
    REQUIRE(vInputTag[3] == inputTag4);

    edm::ESInputTag esinputTag1("One", "Two");
    REQUIRE(ps.getParameter<edm::ESInputTag>("esinputTagv1") == esinputTag1);
    edm::ESInputTag esinputTag2("One", "");
    REQUIRE(ps.getParameter<edm::ESInputTag>("esinputTagv2") == esinputTag2);
    edm::ESInputTag esinputTag3("", "Two");
    REQUIRE(ps.getParameter<edm::ESInputTag>("esinputTagv3") == esinputTag3);

    std::vector<edm::ESInputTag> vESInputTag;
    vESInputTag = ps.getParameter<std::vector<edm::ESInputTag>>("vESInputTagv1");
    REQUIRE(vESInputTag.empty());
    vESInputTag = ps.getParameter<std::vector<edm::ESInputTag>>("vESInputTagv2");
    REQUIRE(vESInputTag[0] == esinputTag1);
    vESInputTag = ps.getParameter<std::vector<edm::ESInputTag>>("vESInputTagv3");
    REQUIRE(vESInputTag[0] == esinputTag1);
    REQUIRE(vESInputTag[1] == esinputTag2);
    vESInputTag = ps.getParameter<std::vector<edm::ESInputTag>>("vESInputTagv4");
    REQUIRE(vESInputTag[0] == esinputTag1);
    REQUIRE(vESInputTag[1] == esinputTag2);
    REQUIRE(vESInputTag[2] == esinputTag3);
    ...
    REQUIRE(fileInPath == ps.getParameter<edm::FileInPath>("fileInPath"));

    edm::ParameterSet const& pset = ps.getParameterSet("bar");
    REQUIRE(pset.getParameter<unsigned>("Drinks") == 5U);
    REQUIRE(pset.getUntrackedParameter<unsigned>("uDrinks") == 5U);
    if (testingAutoGeneratedCfi)
      REQUIRE(pset.getParameter<unsigned>("oDrinks") == 5U);
    if (testingAutoGeneratedCfi)
      REQUIRE(pset.getUntrackedParameter<unsigned>("ouDrinks") == 5U);
    ...
    REQUIRE(vpset.size() == 2U);

    const edm::ParameterSet& pset0 = vpset[0];
    REQUIRE(pset0.getParameter<unsigned>("Drinks") == 5U);
    REQUIRE(pset0.getUntrackedParameter<unsigned>("uDrinks") == 5U);
    REQUIRE(pset0.getParameter<unsigned>("oDrinks") == 11U);
    REQUIRE(pset0.exists("ouDrinks") == false);
    REQUIRE(pset0.exists("ndoDrinks") == false);
    REQUIRE(pset0.exists("ndouDrinks") == false);
    // REQUIRE(pset0.getUntrackedParameter<unsigned>("ndouDrinks") == 5);

    const edm::ParameterSet& pset1 = vpset[1];
    REQUIRE(pset1.getParameter<unsigned>("Drinks") == 5U);
    REQUIRE(pset1.getUntrackedParameter<unsigned>("uDrinks") == 5U);
    REQUIRE(pset1.getParameter<unsigned>("oDrinks") == 11U);
    REQUIRE(pset1.getUntrackedParameter<unsigned>("ouDrinks") == 11U);
    REQUIRE(pset1.exists("ndoDrinks") == false);
    REQUIRE(pset1.getUntrackedParameter<unsigned>("ndouDrinks") == 11U);

    REQUIRE(ps.getParameter<double>("test1") == 0.1);
    if (testingAutoGeneratedCfi) {
      REQUIRE(ps.getParameter<double>("test2") == 0.2);
      REQUIRE(ps.exists("test3") == false);

      REQUIRE(ps.getParameter<std::string>("testA") == std::string("fooA"));
      REQUIRE(ps.getParameter<int>("testB") == 100);
      REQUIRE(ps.getParameter<int>("testC") == 101);

      REQUIRE(ps.getParameter<int>("oiswitch") == 1);
      REQUIRE(ps.getParameter<double>("oivalue1") == 101.0);
      REQUIRE(ps.getParameter<double>("oivalue2") == 101.0);
    } else {
      REQUIRE(!ps.exists("test2"));
      REQUIRE(!ps.exists("test3"));

      REQUIRE(!ps.exists("testA"));
      REQUIRE(!ps.exists("testB"));
      REQUIRE(!ps.exists("testC"));

      REQUIRE(!ps.exists("oiswitch"));
      REQUIRE(!ps.exists("oivalue1"));
      REQUIRE(!ps.exists("oivalue2"));
    }

    edm::ParameterSet const& deeplyNestedPSet = pset1.getParameterSet("testDeeplyNested");
    if (testingAutoGeneratedCfi) {
      REQUIRE(!deeplyNestedPSet.exists("ndiswitch"));
      REQUIRE(!deeplyNestedPSet.exists("ndivalue1"));
      REQUIRE(!deeplyNestedPSet.exists("ndivalue2"));
    } else {
      REQUIRE(!deeplyNestedPSet.exists("ndiswitch"));
      REQUIRE(!deeplyNestedPSet.exists("ndivalue1"));
      REQUIRE(!deeplyNestedPSet.exists("ndivalue2"));
    ...
    REQUIRE(deeplyNestedPSet.getParameter<bool>("bswitch") == false);
    REQUIRE(deeplyNestedPSet.getParameter<double>("bvalue1") == 101.0);
    REQUIRE(deeplyNestedPSet.getParameter<double>("bvalue2") == 101.0);
    REQUIRE(!deeplyNestedPSet.exists("bvalue"));

    REQUIRE(deeplyNestedPSet.getParameter<int>("iswitch") == 1);
    REQUIRE(deeplyNestedPSet.getParameter<double>("ivalue1") == 101.0);
    REQUIRE(deeplyNestedPSet.getUntrackedParameter<double>("ivalue2") == 101.0);
    REQUIRE(!deeplyNestedPSet.exists("ivalue"));

    REQUIRE(deeplyNestedPSet.getParameter<std::string>("sswitch") == std::string("1"));
    REQUIRE(deeplyNestedPSet.getParameter<double>("svalue1") == 101.0);
    REQUIRE(deeplyNestedPSet.getParameter<double>("svalue2") == 101.0);
    REQUIRE(!deeplyNestedPSet.exists("svalue"));

    if (testingAutoGeneratedCfi) {
      edm::ParameterSet const& pset11 = ps.getParameterSet("subpset");
      REQUIRE(pset11.getParameter<int>("xvalue") == 11);
      edm::ParameterSet const& pset111 = pset11.getUntrackedParameterSet("bar");
      REQUIRE(pset111.getParameter<unsigned>("Drinks") == 5U);
      REQUIRE(pset111.getUntrackedParameter<unsigned>("uDrinks") == 5U);
      REQUIRE(pset111.getParameter<unsigned>("oDrinks") == 5U);
      REQUIRE(pset111.getUntrackedParameter<unsigned>("ouDrinks") == 5U);
    }

    edm::ParameterSet const& psetXor = ps.getParameterSet("xorPset");
    REQUIRE(psetXor.getParameter<std::string>("name1") == std::string("11"));
    REQUIRE(!psetXor.exists("name2"));
    if (testingAutoGeneratedCfi) {
      REQUIRE(psetXor.getParameter<std::string>("name") == std::string("11"));
    } else {
      REQUIRE(psetXor.getParameter<unsigned>("name") == 11U);
    }

    edm::ParameterSet const& psetOr = ps.getParameterSet("orPset");
    REQUIRE(!psetOr.exists("z1"));
    REQUIRE(!psetOr.exists("z2"));
    if (testingAutoGeneratedCfi) {
      REQUIRE(psetOr.getParameter<std::string>("x1") == std::string("11"));
      REQUIRE(!psetOr.exists("x2"));
      REQUIRE(psetOr.getParameter<std::string>("y1") == std::string("11"));
      REQUIRE(!psetOr.exists("y2"));
    } else {
      REQUIRE(!psetOr.exists("x1"));
      REQUIRE(psetOr.getParameter<unsigned>("x2") == 11U);
      REQUIRE(psetOr.getParameter<std::string>("y1") == std::string("11"));
      REQUIRE(psetOr.getParameter<unsigned>("y2") == 11U);
    }

    edm::ParameterSet const& psetAnd = ps.getParameterSet("andPset");
    REQUIRE(psetAnd.getParameter<std::string>("x1") == std::string("11"));
    REQUIRE(psetAnd.getParameter<unsigned>("x2") == 11U);
    REQUIRE(psetAnd.getParameter<std::string>("y1") == std::string("11"));
    REQUIRE(psetAnd.getParameter<unsigned>("y2") == 11U);
    REQUIRE(psetAnd.getParameter<std::string>("z1") == std::string("11"));
    REQUIRE(psetAnd.getParameter<unsigned>("z2") == 11U);
    REQUIRE(psetAnd.getParameter<std::string>("b1") == std::string("11"));
    REQUIRE(psetAnd.getParameter<unsigned>("b2") == 11U);
    REQUIRE(psetAnd.getParameter<unsigned>("b3") == 11U);
    REQUIRE(psetAnd.getParameter<unsigned>("b4") == 11U);
    REQUIRE(psetAnd.getParameter<unsigned>("b5") == 11U);
    REQUIRE(psetAnd.getParameter<unsigned>("b6") == 11U);
    if (testingAutoGeneratedCfi) {
      REQUIRE(!psetAnd.exists("a1"));
      REQUIRE(!psetAnd.exists("a2"));
    } else {
      REQUIRE(psetAnd.getParameter<std::string>("a1") == std::string("11"));
      REQUIRE(psetAnd.getParameter<unsigned>("a2") == 11U);
    }

    edm::ParameterSet const& psetIfExists = ps.getParameterSet("ifExistsPset");
    REQUIRE(psetIfExists.getParameter<unsigned>("x1") == 11U);
    REQUIRE(psetIfExists.getParameter<std::string>("x2") == std::string("11"));
    REQUIRE(psetIfExists.getParameter<unsigned>("z1") == 11U);
    REQUIRE(psetIfExists.getParameter<std::string>("z2") == std::string("11"));
    if (testingAutoGeneratedCfi) {
      REQUIRE(!psetIfExists.exists("y1"));
      REQUIRE(!psetIfExists.exists("y2"));
    } else {
      REQUIRE(psetIfExists.getParameter<unsigned>("y1") == 11U);
      REQUIRE(!psetIfExists.exists("y2"));
    }

    edm::ParameterSet const& psetAllowed = ps.getParameterSet("allowedLabelsPset");
    if (testingAutoGeneratedCfi) {
      REQUIRE(psetAllowed.getParameter<std::vector<std::string>>("testAllowedLabels").empty());
      REQUIRE(psetAllowed.getUntrackedParameter<std::vector<std::string>>("testAllowedLabelsUntracked").empty());
      REQUIRE(!psetAllowed.exists("testOptAllowedLabels"));
      REQUIRE(!psetAllowed.exists("testOptAllowedLabelsUntracked"));
    }
  ...
  template <int N>
  void ProducerWithPSetDesc<N>::produce(edm::StreamID, edm::Event& e, edm::EventSetup const&) const {
  ...
  namespace {
    edm::ParameterSetDescription description(int p_int) {
      ...
      edm::ParameterDescription<std::vector<edm::ParameterSet>> test102(
          "test102", edm::ParameterSetDescription(), true);
      ...
      allowedLabelsPset.labelsFromOptionalUntracked<edm::ParameterSetDescription>(
          std::string("testWithSet"), true, bar);
  ...
  template <int N>
  void ProducerWithPSetDesc<N>::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
    if constexpr (N == 1) {
      descriptions.addDefault(description(2));
    } else if constexpr (N == 2) {
      // ------------------------------------------

      edm::ParameterSetDescription iDesc1 = description(1);
      ...
      descriptions.addWithDefaultLabel(description(3));
      // ------------------------------------------
...
using ProducerWithPSetDescNoCfi = edmtest::ProducerWithPSetDesc<1>;
using ProducerWithPSetDescNoDefaults = edmtest::ProducerWithPSetDesc<2>;
using ProducerWithPSetDesc = edmtest::ProducerWithPSetDesc<3>;
DEFINE_FWK_MODULE(ProducerWithPSetDesc);
DEFINE_FWK_MODULE(ProducerWithPSetDescNoDefaults);
