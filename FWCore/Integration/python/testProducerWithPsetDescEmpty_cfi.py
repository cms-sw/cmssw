...
testProducerWithPsetDescEmpty = cms.EDProducer('ProducerWithPSetDesc',
  ...
  allowedLabelsPset = cms.PSet(
    allowedLabels = cms.vstring('i1', 'i2', 'i3'),
    i1 = cms.int32(1),
    i2 = cms.int32(2),
    i3 = cms.int32(3),
    allowedLabelsUntracked = cms.untracked.vstring('u1', 'u2', 'u3'),
    u1 = cms.untracked.uint32(1),
    u3 = cms.untracked.uint32(3),
    optAllowedLabels = cms.vstring('oi1', 'oi2', 'oi3'),
    oi1 = cms.int32(1),
    oi2 = cms.int32(2),
    oi3 = cms.int32(3),
    optAllowedLabelsUntracked = cms.untracked.vstring('ou1', 'ou2', 'ou3'),
