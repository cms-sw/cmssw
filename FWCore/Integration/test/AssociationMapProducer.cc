...
class AssociationMapProducer : public edm::one::EDProducer<> {
 public:
  ...
  typedef edm::AssociationMap<edm::OneToValue<std::vector<int>, double> >
      AssocOneToValue;
  typedef edm::AssociationMap<
      edm::OneToOne<std::vector<int>, std::vector<int> > >
      AssocOneToOne;
  typedef edm::AssociationMap<
      edm::OneToMany<std::vector<int>, std::vector<int> > >
      AssocOneToMany;
  typedef edm::AssociationMap<
      edm::OneToManyWithQuality<std::vector<int>, std::vector<int>, double> >
      AssocOneToManyWithQuality;
  typedef edm::AssociationMap<edm::OneToOne<edm::View<int>, edm::View<int> > >
      AssocOneToOneView;
...
AssociationMapProducer::AssociationMapProducer(edm::ParameterSet const& pset) {
  inputToken1_ = consumes<std::vector<int> >(
      pset.getParameter<edm::InputTag>("inputTag1"));
  inputToken2_ = consumes<std::vector<int> >(
      pset.getParameter<edm::InputTag>("inputTag2"));

  inputToken1V_ =
      consumes<edm::View<int> >(pset.getParameter<edm::InputTag>("inputTag1"));
  inputToken2V_ =
      consumes<edm::View<int> >(pset.getParameter<edm::InputTag>("inputTag2"));
...
void AssociationMapProducer::produce(edm::Event& event,
  ...
  auto assoc2 =
      std::make_unique<AssocOneToOne>(inputCollection1, inputCollection2);
  ...
  auto assoc6 =
      std::make_unique<AssocOneToManyWithQuality>(&event.productGetter());
