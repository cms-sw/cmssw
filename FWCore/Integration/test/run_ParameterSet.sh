...
# Compare the cfi file to a reference file to ensure it is correct
  diff ${LOCAL_TMP_DIR}/src/FWCore/Integration/plugins/FWCoreIntegrationTestPSet/edm_write_config/testProducerWithPsetDesc_cfi.py ${LOCAL_TEST_DIR}/unit_test_outputs/testProducerWithPsetDesc_cfi.py || die "comparing testProducerWithPsetDesc_cfi.py" $?
