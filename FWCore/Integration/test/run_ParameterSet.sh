...
# Compare the cfi file to a reference file to ensure it is correct
  diff `python3 -c 'import FWCore.Integration.testProducerWithPsetDesc_cfi; print(FWCore.Integration.testProducerWithPsetDesc_cfi.__file__);'` ${LOCAL_TEST_DIR}/unit_test_outputs/testProducerWithPsetDesc_cfi.py || die "comparing testProducerWithPsetDesc_cfi.py" $?
