...
TestPSetAnalyzer::TestPSetAnalyzer(edm::ParameterSet const& iConfig) {
  ...
  testVLumi_ =
      iConfig.getParameter<std::vector<edm::LuminosityBlockID> >("testVLumi");
  testLRange_ = iConfig.getParameter<edm::LuminosityBlockRange>("testRange");
  testVLRange_ = iConfig.getParameter<std::vector<edm::LuminosityBlockRange> >(
      "testVRange");
  testERange_ = iConfig.getParameter<edm::EventRange>("testERange");
  testVERange_ =
      iConfig.getParameter<std::vector<edm::EventRange> >("testVERange");
  ...
  testVEventID_ =
      iConfig.getParameter<std::vector<edm::EventID> >("testVEventID");
  ...
  testVERange2_ =
      iConfig.getParameter<std::vector<edm::EventRange> >("testVERange2");
