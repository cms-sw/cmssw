...
namespace edmtest {
  ...
  fillDescriptions(edm::ConfigurationDescriptions & descriptions) {
    ...
    edm::ParameterDescription<std::vector<edm::ParameterSetDescription> > test102("test102", bars, true);
    iDesc.addOptionalNode(test102, false);

    bars.push_back(barx);

    edm::ParameterDescription<std::vector<edm::ParameterSetDescription> > test103("test103", bars, true);
    ...
    std::auto_ptr<edm::ParameterDescriptionNode> wnode3(new edm::ParameterWildcard<std::vector<edm::ParameterSetDescription> >("*", edm::RequireExactlyOne, true));
    wildcardPset.addOptionalNode(wnode3, false);

    std::vector<edm::ParameterSetDescription> wVPset;
    wVPset.push_back(wSet1);
    wSet1.add<unsigned int>("Drinks2", 11);
    wVPset.push_back(wSet1);

    std::auto_ptr<edm::ParameterDescriptionNode> wnode4(new edm::ParameterWildcard<std::vector<edm::ParameterSetDescription> >("*", edm::RequireAtLeastOne, true, wVPset));
    ...
    std::vector<edm::ParameterSetDescription> bars2;
    bars2.push_back(bar);
    bars2.push_back(bar);
    allowedLabelsPset.labelsFromOptionalUntracked<std::vector<edm::ParameterSetDescription> >(std::string("testWithVectorOfSets"), true, bars2);
