...
ProducerWithPSetDesc::ProducerWithPSetDesc(edm::ParameterSet const& ps) {
  testingAutoGeneratedCfi =
      ps.getUntrackedParameter<bool>("testingAutoGeneratedCfi", true);
  ...
  assert(ps.getParameter<unsigned long long>("uint64v1") ==
  ...
  // This one does not work because the precision in the ParameterSet
  // stringified
  // format is 16 instead of 17.
  // assert(ps.getParameter<double>("doublev1") ==
  ...
  assert(ps.getParameter<edm::LuminosityBlockID>("luminosityIDv1") ==
         luminosityID1);
  edm::LuminosityBlockID luminosityID2(101, 102);
  assert(ps.getParameter<edm::LuminosityBlockID>("luminosityIDv2") ==
         luminosityID2);

  std::vector<edm::LuminosityBlockID> vLuminosityBlockID;
  vLuminosityBlockID = ps.getParameter<std::vector<edm::LuminosityBlockID>>(
  ...
  assert(
      ps.getParameter<edm::LuminosityBlockRange>("lumiRangev1").startLumiID() ==
      lumiRange1.startLumiID());
  assert(
      ps.getParameter<edm::LuminosityBlockRange>("lumiRangev1").endLumiID() ==
      lumiRange1.endLumiID());
  edm::LuminosityBlockRange lumiRange2(3, 4, 1000, 1000);
  assert(
      ps.getParameter<edm::LuminosityBlockRange>("lumiRangev2").startLumiID() ==
      lumiRange2.startLumiID());
  assert(
      ps.getParameter<edm::LuminosityBlockRange>("lumiRangev2").endLumiID() ==
      lumiRange2.endLumiID());

  std::vector<edm::LuminosityBlockRange> vLumiRange;
  vLumiRange =
      ps.getParameter<std::vector<edm::LuminosityBlockRange>>("vLumiRangev1");
  assert(vLumiRange.empty());
  vLumiRange =
      ps.getParameter<std::vector<edm::LuminosityBlockRange>>("vLumiRangev2");
  assert(vLumiRange[0].startLumiID() == lumiRange1.startLumiID());
  vLumiRange =
      ps.getParameter<std::vector<edm::LuminosityBlockRange>>("vLumiRangev3");
  assert(vLumiRange[0].startLumiID() == lumiRange1.startLumiID());
  ...
  edm::ParameterSet const& deeplyNestedPSet =
      pset1.getParameterSet("testDeeplyNested");
  if (testingAutoGeneratedCfi) {
  ...
  assert(deeplyNestedPSet.getParameter<std::string>("sswitch") ==
         std::string("1"));
  ...
  edm::ParameterSet const& psetAllowed =
      ps.getParameterSet("allowedLabelsPset");
  if (testingAutoGeneratedCfi) {
    assert(psetAllowed.getParameter<std::vector<std::string>>(
               "testAllowedLabels") == std::vector<std::string>());
...
void ProducerWithPSetDesc::fillDescriptions(
  ...
  edm::ParameterDescription<edm::ParameterSetDescription> test101("test101",
                                                                  bar, true);
  ...
  edm::ParameterDescription<std::vector<edm::ParameterSet>> test103(
      std::string("test103"), barx, true);
  ...
  iDesc.addOptionalNode(edm::ParameterDescription<double>("test2", d2, true),
                        true);
  // The value in the second argument is not used in this case
  iDesc.addOptionalNode(edm::ParameterDescription<double>("test3", d3, true),
                        false);

  iDesc.addOptionalNode(
      edm::ParameterDescription<std::string>("testA", "fooA", true) and
          edm::ParameterDescription<int>("testB", 100, true) &&
          edm::ParameterDescription<int>("testC", 101, true),
      true);

  iDesc.ifValueOptional(
  ...
  bool case0 = true;
  bool case1 = false;
  deeplyNested.ifValue(
      edm::ParameterDescription<bool>("bswitch", false, true),
      case0 >> edm::ParameterDescription<int>("bvalue", 100, true) or
          case1 >>
              (edm::ParameterDescription<double>("bvalue1", 101.0, true) and
  ...
  deeplyNested.ifValue(
      edm::ParameterDescription<std::string>("sswitch", std::string("1"), true),
  ...
  psetInVector2.addParameter<std::vector<edm::ParameterSet>>(
      "anotherVPSet", anotherDefaultVPSet);

  edm::ParameterSet defaultForDeeplyNested;
  defaultForDeeplyNested.addParameter<int>("testint", 2);
  psetInVector2.addParameter<edm::ParameterSet>("testDeeplyNested",
                                                defaultForDeeplyNested);
  ...
  subPsetDescription->addUntracked<edm::ParameterSetDescription>(
      std::string("bar"), bar);
  ...
  pn = switchPset.ifValue(
      edm::ParameterDescription<int>("iswitch", 1, true),
      0 >> edm::ParameterDescription<std::vector<int>>("ivalue", testIntVector,
                                                       true) or
          1 >> (edm::ParameterDescription<double>("ivalue1", 101.0, true) and
  ...
  switchPset
      .ifValue(edm::ParameterDescription<bool>("addTeVRefits", true, true),
               true >> (edm::ParameterDescription<edm::InputTag>(
                            "pickySrc", edm::InputTag(), true) and
                        edm::ParameterDescription<edm::InputTag>(
                            "tpfmsSrc", edm::InputTag(), true)) or
  ...
  xorPset.addNode(
      edm::ParameterDescription<std::string>("name1", "11", true) xor
      edm::ParameterDescription<unsigned int>("name1", 11U, true));

  xorPset.addOptionalNode(
      edm::ParameterDescription<std::string>("name2", "11", true) xor
          edm::ParameterDescription<unsigned int>("name2", 11U, true),
      false);

  xorPset.addNode(
      edm::ParameterDescription<std::string>("name3", "11", true) xor
  ...
  orPset.addOptionalNode(
      edm::ParameterDescription<std::string>("z1", "11", true) or
          edm::ParameterDescription<unsigned int>("z2", 11U, true) or test101 or
          test103,
      false);
  ...
  andPset.addOptionalNode(
      edm::ParameterDescription<std::string>("a1", "11", true) and
          edm::ParameterDescription<unsigned int>("a2", 11U, true),
      false);

  andPset.addOptionalNode(
      (edm::ParameterDescription<std::string>("b1", "11", true) and
  ...
  ifExistsPset.ifExists(
      edm::ParameterDescription<unsigned int>("x1", 11U, true),
      edm::ParameterDescription<std::string>("x2", "11", true));

  ifExistsPset.ifExistsOptional(
      edm::ParameterDescription<unsigned int>("y1", 11U, true),
      edm::ParameterDescription<std::string>("y2", "11", true), false);

  ifExistsPset.ifExists(
      edm::ParameterDescription<unsigned int>("z1", 11U, true),
  ...
  allowedLabelsPset.labelsFromUntracked<unsigned>(
      std::string("testAllowedLabelsUntracked"));
  ...
  noDefaultPset3.addOptional<std::vector<edm::LuminosityBlockID>>(
      "noDefault17");
  ...
  noDefaultPset3.addOptional<std::vector<edm::LuminosityBlockRange>>(
      "noDefault22");
  ...
  noDefaultPset4.addOptionalUntracked<std::vector<unsigned long long>>(
      "noDefault8");
  ...
  noDefaultPset4.addOptionalUntracked<std::vector<edm::LuminosityBlockID>>(
      "noDefault17");
  noDefaultPset4.addOptionalUntracked<edm::InputTag>("noDefault18");
  noDefaultPset4.addOptionalUntracked<std::vector<edm::InputTag>>(
      "noDefault19");
  ...
  noDefaultPset4.addOptionalUntracked<std::vector<edm::LuminosityBlockRange>>(
      "noDefault22");
  noDefaultPset4.addOptionalUntracked<edm::EventRange>("noDefault23");
  noDefaultPset4.addOptionalUntracked<std::vector<edm::EventRange>>(
      "noDefault24");
  ...
  noDefaultPset2.addUntracked<std::vector<edm::LuminosityBlockID>>(
      "noDefault17");
  ...
  noDefaultPset2.addUntracked<std::vector<edm::LuminosityBlockRange>>(
      "noDefault22");
