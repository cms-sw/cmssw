...
#wantSummary = cms.untracked.bool(True),Rethrow = FWCore.Framework.test.cmsExceptionsFatalOption_cff.Rethrow) process.source = cms.Source("PoolSource", fileNames = cms.untracked.vstring('file:testSeriesOfProcessesPROD2TEST.root'), )
...
#HLT configuration(the first one in this series). expectedSum = cms.untracked.int32(15300)) process.test1 = cms.Path(process.a)
