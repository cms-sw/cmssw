...
bool checkRunOrLumiEntry(edm::IndexIntoFile::RunOrLumiEntry const& rl, edm::IndexIntoFile::EntryNumber_t orderPHIDRun,
                         edm::IndexIntoFile::EntryNumber_t orderPHIDRunLumi, edm::IndexIntoFile::EntryNumber_t entry,
                         int processHistoryIDIndex, edm::RunNumber_t run, edm::LuminosityBlockNumber_t lumi,
                         edm::IndexIntoFile::EntryNumber_t beginEvents, edm::IndexIntoFile::EntryNumber_t endEvents) {
