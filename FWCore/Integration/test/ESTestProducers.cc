...
ESTestProducerA::ESTestProducerA(edm::ParameterSet const&)
    : data_(new ESTestDataA(0)) {
  setWhatProduced(this);
}

std::shared_ptr<ESTestDataA> ESTestProducerA::produce(
    ESTestRecordA const& rec) {
  ++data_->value();
  return data_;
}
...
ESTestProducerB::ESTestProducerB(edm::ParameterSet const&)
    : data_(new ESTestDataB(0)) {
  setWhatProduced(this);
}

std::shared_ptr<ESTestDataB> ESTestProducerB::produce(
    ESTestRecordB const& rec) {
  ++data_->value();
  return data_;
}
...
ESTestProducerC::ESTestProducerC(edm::ParameterSet const&)
    : data_(new ESTestDataC(0)) {
  setWhatProduced(this);
}

std::shared_ptr<ESTestDataC> ESTestProducerC::produce(
    ESTestRecordC const& rec) {
  ++data_->value();
  return data_;
}
...
ESTestProducerD::ESTestProducerD(edm::ParameterSet const&)
    : data_(new ESTestDataD(0)) {
  setWhatProduced(this);
}

std::shared_ptr<ESTestDataD> ESTestProducerD::produce(
    ESTestRecordD const& rec) {
  ++data_->value();
  return data_;
}
...
ESTestProducerE::ESTestProducerE(edm::ParameterSet const&)
    : data_(new ESTestDataE(0)) {
  setWhatProduced(this);
}

std::shared_ptr<ESTestDataE> ESTestProducerE::produce(
    ESTestRecordE const& rec) {
  ++data_->value();
  return data_;
}
...
ESTestProducerF::ESTestProducerF(edm::ParameterSet const&)
    : data_(new ESTestDataF(0)) {
  setWhatProduced(this);
}

std::shared_ptr<ESTestDataF> ESTestProducerF::produce(
    ESTestRecordF const& rec) {
  ++data_->value();
  return data_;
}
...
ESTestProducerG::ESTestProducerG(edm::ParameterSet const&)
    : data_(new ESTestDataG(0)) {
  setWhatProduced(this);
}

std::shared_ptr<ESTestDataG> ESTestProducerG::produce(
    ESTestRecordG const& rec) {
  ++data_->value();
  return data_;
}
...
ESTestProducerH::ESTestProducerH(edm::ParameterSet const&)
    : data_(new ESTestDataH(0)) {
  setWhatProduced(this);
}

std::shared_ptr<ESTestDataH> ESTestProducerH::produce(
    ESTestRecordH const& rec) {
  ++data_->value();
  return data_;
}
...
ESTestProducerI::ESTestProducerI(edm::ParameterSet const&)
    : data_(new ESTestDataI(0)) {
  setWhatProduced(this);
}

std::shared_ptr<ESTestDataI> ESTestProducerI::produce(
    ESTestRecordI const& rec) {
  ++data_->value();
  return data_;
}
...
ESTestProducerJ::ESTestProducerJ(edm::ParameterSet const&)
    : data_(new ESTestDataJ(0)) {
  setWhatProduced(this);
}

std::shared_ptr<ESTestDataJ> ESTestProducerJ::produce(
    ESTestRecordJ const& rec) {
  ++data_->value();
  return data_;
}
...
ESTestProducerK::ESTestProducerK(edm::ParameterSet const&)
    : data_(new ESTestDataK(0)) {
  setWhatProduced(this);
}

std::shared_ptr<ESTestDataK> ESTestProducerK::produce(
    ESTestRecordK const& rec) {
  ++data_->value();
  return data_;
}
...
ESTestProducerAZ::ESTestProducerAZ(edm::ParameterSet const&)
  ...
  setWhatProduced(this, &edmtest::ESTestProducerAZ::produceA,
                  edm::es::Label("foo"));
  setWhatProduced(this, &edmtest::ESTestProducerAZ::produceZ,
                  edm::es::Label("foo"));
}

std::shared_ptr<ESTestDataA> ESTestProducerAZ::produceA(
    ESTestRecordA const& rec) {
  ++dataA_->value();
  return dataA_;
}

std::shared_ptr<ESTestDataZ> ESTestProducerAZ::produceZ(
    ESTestRecordZ const& rec) {
  ++dataZ_->value();
  return dataZ_;
}
}
