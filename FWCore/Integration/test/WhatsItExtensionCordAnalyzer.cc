...
//
/**\class WhatsItExtensionCordAnalyzer WhatsItExtensionCordAnalyzer.cc
 test/WhatsItExtensionCordAnalyzer/src/WhatsItExtensionCordAnalyzer.cc
...
void WhatsItExtensionCordAnalyzer::analyze(const edm::Event& /*iEvent*/,
