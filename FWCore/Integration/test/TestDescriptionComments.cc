  ...
  void TestDescriptionComments::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
    ...
    desc.ifValue(
        ...
        "a" >> edm::ParameterDescription<int>(std::string("x"), 100, true, edm::Comment("test2")) or
            ...
            "d" >> edm::ParameterDescription<edm::ParameterSetDescription>("nested1", nestedDesc, true,
                                                                           edm::Comment(std::string("test5"))) or
            "e" >> edm::ParameterDescription<edm::ParameterSetDescription>(std::string("nested2"), nestedDesc, true,
                                                                           edm::Comment(std::string("test6"))) or
            "f" >> edm::ParameterDescription<std::vector<edm::ParameterSet> >("vpset1", nestedDesc, true, vectorOfPSets,
                                                                              edm::Comment("test7")) or
            "g" >> edm::ParameterDescription<std::vector<edm::ParameterSet> >(std::string("vpset2"), nestedDesc, true,
                                                                              vectorOfPSets, edm::Comment("test8")) or
            "h" >> edm::ParameterDescription<std::vector<edm::ParameterSet> >("vpset3", nestedDesc, true,
                                                                              edm::Comment("test9")) or
            "i" >> edm::ParameterDescription<std::vector<edm::ParameterSet> >(std::string("vpset4"), nestedDesc, true,
                                                                              edm::Comment("test10")));
