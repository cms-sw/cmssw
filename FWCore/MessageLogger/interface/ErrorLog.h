...
// Define ELseverity here so that the user only has to include ONE
// file in order to use the error logger.
...
// ----------------------------------------------------------------------
  ...
  // -----  logging operations:
  //
  ErrorLog & operator()( ErrorObj & msg );	  // an entire message
...
private:
  ...
  // -----  Maintenance and testing methods; not intended for users:
  //
public:
...
#define ERRORLOG_ICC
  #include "FWCore/MessageLogger/interface/ErrorLog.icc"
#undef  ERRORLOG_ICC
