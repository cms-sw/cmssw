...
private:
  ...
  ELlist_dest         sinks_;		// e.g., list<ELdestination *>
  ...
  int                 xxxxInt;          // Testing purposes only

public:
  // ---  Maintenance and testing methods, not for user invocation:
  //
  void xxxxSet( int i );// Testing purposes only - not for users to invoke
  void xxxxShout();     // Testing purposes only - not for users to invoke
