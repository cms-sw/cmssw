...
//
//  3 wmtan 6/22/11     Hold the ErrorObj with a shared pointer with a custom
//  deleter.
//                      The custom deleter takes over the function of the
//                      message sending from the MessageSender destructor.
//                      This allows MessageSender to be copyable, which fixes
//                      the clang compilation errors.
...
class MessageSender {
 ...
 public:
  ...
  bool valid() { return errorobj_p != 0; }
