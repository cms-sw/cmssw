...
namespace edm {
  ...
  public:
    ...
    // ---------- member functions ---------------------------
    void setIntervalFor(eventsetup::EventSetupRecordKey const&, IOVSyncValue const& iTime,
  ...
  void EmptyESSource::setIntervalFor(eventsetup::EventSetupRecordKey const&, IOVSyncValue const& iTime,
