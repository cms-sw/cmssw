...
namespace edm {
  namespace serviceregistry {
    ...
    ServicesManager::MakerHolder::MakerHolder(std::shared_ptr<ServiceMakerBase> iMaker, ParameterSet& iPSet,
    ...
    ServicesManager::ServicesManager(ServiceToken iToken, ServiceLegacy iLegacy,
                                     std::vector<ParameterSet>& iConfiguration, bool associate)
      ...
      if (nullptr != iToken.manager_.get()) {
        ...
        std::set_intersection(configTypes.begin(), configTypes.end(), tokenTypes.begin(), tokenTypes.end(),
