...
namespace edm::signalslot {
  ...
  struct function_args<std::function<R(Args...)>> {
    ...
    static constexpr bool invocable = std::is_invocable_r_v<R, TMethod, TClass*, Args...>;
  };
}  // namespace edm::signalslot

// The 'if constexpr' prevents the compiler from parsing code that would fail anyway. This results in much shorter and
// clearer error message.
#define AR_WATCH_USING_METHOD(SignalAlias)                                                                    \
  template <class TClass, class TMethod>                                                                      \
  void watch##SignalAlias(TClass* iObject, TMethod iMethod) {                                                 \
    constexpr bool methodInvocable =                                                                          \
        edm::signalslot::function_args<typename SignalAlias::slot_type>::template invocable<TClass, TMethod>; \
    static_assert(methodInvocable, "The method signature does not match the signal signature");               \
    if constexpr (methodInvocable) {                                                                          \
      watch##SignalAlias([iObject, iMethod](auto&&... iArgs) {                                                \
        return (iObject->*iMethod)(std::forward<decltype(iArgs)>(iArgs)...);                                  \
      });                                                                                                     \
    }                                                                                                         \
  }
...
namespace edm {
  ...
  public:
    ...
    AR_WATCH_USING_METHOD(PostServicesConstruction)
    ...
    AR_WATCH_USING_METHOD(PreEventSetupModulesConstruction)
    ...
    AR_WATCH_USING_METHOD(PostEventSetupModulesConstruction)
    ...
    AR_WATCH_USING_METHOD(PreESModuleConstruction)
    ...
    AR_WATCH_USING_METHOD(PostESModuleConstruction)
    ...
    AR_WATCH_USING_METHOD(PreModulesAndSourceConstruction)
    ...
    AR_WATCH_USING_METHOD(PostModulesAndSourceConstruction)
	...
	*/
    ...
    AR_WATCH_USING_METHOD(PreSourceConstruction)
    ...
    // WARNING - ModuleDescription is not in fixed place.  See note M above.
    AR_WATCH_USING_METHOD(PostSourceConstruction)
    ...
    AR_WATCH_USING_METHOD(PreOpenFile)
    ...
    AR_WATCH_USING_METHOD(PostOpenFile)
    ...
    // WARNING - ModuleDescription is not in fixed place.  See note M above.
    AR_WATCH_USING_METHOD(PreModuleConstruction)
    ...
    // WARNING - ModuleDescription is not in fixed place.  See note M above.
    AR_WATCH_USING_METHOD(PostModuleConstruction)
    ...
    AR_WATCH_USING_METHOD(PreFinishSchedule)
    ...
    AR_WATCH_USING_METHOD(PostFinishSchedule)
    ...
    AR_WATCH_USING_METHOD(PrePrincipalsCreation)
    ...
    AR_WATCH_USING_METHOD(PostPrincipalsCreation)
    ...
    AR_WATCH_USING_METHOD(Preallocate)
    ...
    AR_WATCH_USING_METHOD(PreScheduleConsistencyCheck)
    ...
    AR_WATCH_USING_METHOD(PostScheduleConsistencyCheck)
    ...
    AR_WATCH_USING_METHOD(PreModuleDestruction)
    ...
    // WARNING - ModuleDescription IS NOT in fixed place.  See note M above.
    AR_WATCH_USING_METHOD(PostModuleDestruction)
    ...
    AR_WATCH_USING_METHOD(PreEventSetupConfigurationFinalized)
    ...
    AR_WATCH_USING_METHOD(PostEventSetupConfigurationFinalized)
    ...
    AR_WATCH_USING_METHOD(EventSetupConfiguration)
    ...
    AR_WATCH_USING_METHOD(PreModulesInitializationFinalized)
    ...
    AR_WATCH_USING_METHOD(PostModulesInitializationFinalized)
    ...
    AR_WATCH_USING_METHOD(PreBeginJob)
    ...
    AR_WATCH_USING_METHOD(PostBeginJob)
    ...
    AR_WATCH_USING_METHOD(PreModuleBeginJob)
    ...
    AR_WATCH_USING_METHOD(PostModuleBeginJob)
    ...
    AR_WATCH_USING_METHOD(LookupInitializationComplete)
    ...
    AR_WATCH_USING_METHOD(PreBeginStream)
    ...
    AR_WATCH_USING_METHOD(PostBeginStream)
    ...
    AR_WATCH_USING_METHOD(PreModuleBeginStream)
    ...
    AR_WATCH_USING_METHOD(PostModuleBeginStream)
    ...
    AR_WATCH_USING_METHOD(BeginProcessing)
    ...
    AR_WATCH_USING_METHOD(PreSourceNextTransition)
    ...
    AR_WATCH_USING_METHOD(PostSourceNextTransition)
    ...
    AR_WATCH_USING_METHOD(PreOpenOutputFiles)
    ...
    AR_WATCH_USING_METHOD(PostOpenOutputFiles)
    ...
    AR_WATCH_USING_METHOD(PreBeginProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PostBeginProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PreModuleBeginProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PostModuleBeginProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PreSourceProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PostSourceProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PreAccessInputProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PostAccessInputProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PreModuleAccessInputProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PostModuleAccessInputProcessBlock)
    ...
    AR_WATCH_USING_METHOD(ESSyncIOVQueuing)
    ...
    AR_WATCH_USING_METHOD(PreESSyncIOV)
    ...
    AR_WATCH_USING_METHOD(PostESSyncIOV)
    ...
    AR_WATCH_USING_METHOD(PreSourceRun)
    ...
    AR_WATCH_USING_METHOD(PostSourceRun)
    ...
    AR_WATCH_USING_METHOD(PreGlobalBeginRun)
    ...
    AR_WATCH_USING_METHOD(PostGlobalBeginRun)
    ...
    AR_WATCH_USING_METHOD(PreModuleGlobalPrefetching)
    ...
    AR_WATCH_USING_METHOD(PostModuleGlobalPrefetching)
    ...
    AR_WATCH_USING_METHOD(PreESModulePrefetching)
    ...
    AR_WATCH_USING_METHOD(PostESModulePrefetching)
    ...
    AR_WATCH_USING_METHOD(PreESModuleAcquire)
    ...
    AR_WATCH_USING_METHOD(PostESModuleAcquire)
    ...
    AR_WATCH_USING_METHOD(PreESModule)
    ...
    AR_WATCH_USING_METHOD(PostESModule)
    ...
    AR_WATCH_USING_METHOD(PreModuleGlobalBeginRun)
    ...
    AR_WATCH_USING_METHOD(PostModuleGlobalBeginRun)
    ...
    AR_WATCH_USING_METHOD(PreStreamBeginRun)
    ...
    AR_WATCH_USING_METHOD(PostStreamBeginRun)
    ...
    AR_WATCH_USING_METHOD(PreModuleStreamPrefetching)
    ...
    AR_WATCH_USING_METHOD(PostModuleStreamPrefetching)
    ...
    AR_WATCH_USING_METHOD(PreModuleStreamBeginRun)
    ...
    AR_WATCH_USING_METHOD(PostModuleStreamBeginRun)
    ...
    AR_WATCH_USING_METHOD(PreSourceLumi)
    ...
    AR_WATCH_USING_METHOD(PostSourceLumi)
    ...
    AR_WATCH_USING_METHOD(PreGlobalBeginLumi)
    ...
    AR_WATCH_USING_METHOD(PostGlobalBeginLumi)
    ...
    AR_WATCH_USING_METHOD(PreModuleGlobalBeginLumi)
    ...
    AR_WATCH_USING_METHOD(PostModuleGlobalBeginLumi)
    ...
    AR_WATCH_USING_METHOD(PreStreamBeginLumi)
    ...
    AR_WATCH_USING_METHOD(PostStreamBeginLumi)
    ...
    AR_WATCH_USING_METHOD(PreModuleStreamBeginLumi)
    ...
    AR_WATCH_USING_METHOD(PostModuleStreamBeginLumi)
    ...
    AR_WATCH_USING_METHOD(PreSourceEvent)
    ...
    AR_WATCH_USING_METHOD(PostSourceEvent)
    ...
    AR_WATCH_USING_METHOD(PreEvent)
    ...
    AR_WATCH_USING_METHOD(PostEvent)
    ...
    AR_WATCH_USING_METHOD(PreEventReadFromSource)
    ...
    AR_WATCH_USING_METHOD(PostEventReadFromSource)
    ...
    AR_WATCH_USING_METHOD(PrePathEvent)
    ...
    AR_WATCH_USING_METHOD(PostPathEvent)
    ...
    AR_WATCH_USING_METHOD(PreModuleEventPrefetching)
    ...
    AR_WATCH_USING_METHOD(PostModuleEventPrefetching)
    ...
    AR_WATCH_USING_METHOD(PreModuleEventAcquire)
    ...
    AR_WATCH_USING_METHOD(PostModuleEventAcquire)
    ...
    AR_WATCH_USING_METHOD(PreModuleEventDelayedGet)
    ...
    AR_WATCH_USING_METHOD(PostModuleEventDelayedGet)
    ...
    AR_WATCH_USING_METHOD(PreModuleEvent)
    ...
    AR_WATCH_USING_METHOD(PostModuleEvent)
    ...
    AR_WATCH_USING_METHOD(PreModuleTransformPrefetching)
    ...
    AR_WATCH_USING_METHOD(PostModuleTransformPrefetching)
    ...
    AR_WATCH_USING_METHOD(PreModuleTransformAcquiring)
    ...
    AR_WATCH_USING_METHOD(PostModuleTransformAcquiring)
    ...
    AR_WATCH_USING_METHOD(PreModuleTransform)
    ...
    AR_WATCH_USING_METHOD(PostModuleTransform)
    ...
    AR_WATCH_USING_METHOD(PreClearEvent)
    ...
    AR_WATCH_USING_METHOD(PostClearEvent)
    ...
    AR_WATCH_USING_METHOD(PreStreamEndLumi)
    ...
    AR_WATCH_USING_METHOD(PostStreamEndLumi)
    ...
    AR_WATCH_USING_METHOD(PreModuleStreamEndLumi)
    ...
    AR_WATCH_USING_METHOD(PostModuleStreamEndLumi)
    ...
    AR_WATCH_USING_METHOD(PreGlobalEndLumi)
    ...
    AR_WATCH_USING_METHOD(PostGlobalEndLumi)
    ...
    AR_WATCH_USING_METHOD(PreModuleGlobalEndLumi)
    ...
    AR_WATCH_USING_METHOD(PostModuleGlobalEndLumi)
    ...
    AR_WATCH_USING_METHOD(PreGlobalWriteLumi)
    ...
    AR_WATCH_USING_METHOD(PostGlobalWriteLumi)
    ...
    AR_WATCH_USING_METHOD(PreModuleWriteLumi)
    ...
    AR_WATCH_USING_METHOD(PostModuleWriteLumi)
    ...
    AR_WATCH_USING_METHOD(PreStreamEndRun)
    ...
    AR_WATCH_USING_METHOD(PostStreamEndRun)
    ...
    AR_WATCH_USING_METHOD(PreModuleStreamEndRun)
    ...
    AR_WATCH_USING_METHOD(PostModuleStreamEndRun)
    ...
    AR_WATCH_USING_METHOD(PreGlobalEndRun)
    ...
    AR_WATCH_USING_METHOD(PostGlobalEndRun)
    ...
    AR_WATCH_USING_METHOD(PreModuleGlobalEndRun)
    ...
    AR_WATCH_USING_METHOD(PostModuleGlobalEndRun)
    ...
    AR_WATCH_USING_METHOD(PreGlobalWriteRun)
    ...
    AR_WATCH_USING_METHOD(PostGlobalWriteRun)
    ...
    AR_WATCH_USING_METHOD(PreModuleWriteRun)
    ...
    AR_WATCH_USING_METHOD(PostModuleWriteRun)
    ...
    AR_WATCH_USING_METHOD(PreWriteProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PostWriteProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PreModuleWriteProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PostModuleWriteProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PreCloseFile)
    ...
    AR_WATCH_USING_METHOD(PostCloseFile)
    ...
    AR_WATCH_USING_METHOD(PreEndProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PostEndProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PreModuleEndProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PostModuleEndProcessBlock)
    ...
    AR_WATCH_USING_METHOD(PreCloseOutputFiles)
    ...
    AR_WATCH_USING_METHOD(PostCloseOutputFiles)
    ...
    AR_WATCH_USING_METHOD(EndProcessing)
    ...
    AR_WATCH_USING_METHOD(PreEndStream)
    ...
    AR_WATCH_USING_METHOD(PostEndStream)
    ...
    AR_WATCH_USING_METHOD(PreModuleEndStream)
    ...
    AR_WATCH_USING_METHOD(PostModuleEndStream)
    ...
    AR_WATCH_USING_METHOD(PreEndJob)
    ...
    AR_WATCH_USING_METHOD(PostEndJob)
    ...
    AR_WATCH_USING_METHOD(PreModuleEndJob)
    ...
    AR_WATCH_USING_METHOD(PostModuleEndJob)
    ...
    AR_WATCH_USING_METHOD(PreStreamEarlyTermination)
    ...
    AR_WATCH_USING_METHOD(PreGlobalEarlyTermination)
    ...
    AR_WATCH_USING_METHOD(PreSourceEarlyTermination)
