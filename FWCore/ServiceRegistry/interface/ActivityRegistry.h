...
//
/**\class ActivityRegistry ActivityRegistry.h
FWCore/ServiceRegistry/interface/ActivityRegistry.h
 ...
 Usage:
    Services can connect to the signals distributed by the ActivityRegistry in
order to monitor the activity of the application.
...
class ActivityRegistry {
 public:
  ActivityRegistry() {}
  ActivityRegistry(ActivityRegistry const&) =
      delete;  // Disallow copying and moving
  ActivityRegistry& operator=(ActivityRegistry const&) =
      delete;  // Disallow copying and moving
  ...
  typedef signalslot::Signal<void(PathsAndConsumesOfModulesBase const&,
  ...
  typedef signalslot::Signal<void(StreamContext const&,
  ...
  void watchPostModuleBeginStream(
      PostModuleBeginStream::slot_type const& iSlot) {
  ...
  /// signal is emitted after the Run has been created by the InputSource but
  /// before any modules have seen the Run
  ...
  /// signal is emitted after the Event has been created by the InputSource but
  /// before any modules have seen the Event
  ...
  typedef signalslot::Signal<void(StreamContext const&, PathContext const&)>
      PrePathEvent;
  ...
  /// signal is emitted after all modules have finished for the Path for an
  /// event
  typedef signalslot::Signal<void(StreamContext const&, PathContext const&,
                                  HLTPathStatus const&)>
      PostPathEvent;
  ...
  typedef signalslot::Signal<void(StreamContext const&, TerminationOrigin)>
      PreStreamEarlyTermination;
  PreStreamEarlyTermination preStreamEarlyTerminationSignal_;
  void watchPreStreamEarlyTermination(
      PreStreamEarlyTermination::slot_type const& iSlot) {
  ...
  ///  then we began terminating the application
  typedef signalslot::Signal<void(GlobalContext const&, TerminationOrigin)>
      PreGlobalEarlyTermination;
  PreGlobalEarlyTermination preGlobalEarlyTerminationSignal_;
  void watchPreGlobalEarlyTermination(
      PreGlobalEarlyTermination::slot_type const& iSlot) {
    preGlobalEarlyTerminationSignal_.connect(iSlot);
  }
  AR_WATCH_USING_METHOD_2(watchPreGlobalEarlyTermination)

  /// signal is emitted if while communicating with a source we began
  /// terminating
  ///  the application
  typedef signalslot::Signal<void(TerminationOrigin)> PreSourceEarlyTermination;
  PreSourceEarlyTermination preSourceEarlyTerminationSignal_;
  void watchPreSourceEarlyTermination(
      PreSourceEarlyTermination::slot_type const& iSlot) {
    preSourceEarlyTerminationSignal_.connect(iSlot);
  }
  AR_WATCH_USING_METHOD_1(watchPreSourceEarlyTermination)

  // OLD DELETE THIS
  typedef signalslot::ObsoleteSignal<void(EventID const&, Timestamp const&)>
      PreProcessEvent;
  /// signal is emitted after the Event has been created by the InputSource but
  /// before any modules have seen the Event
  ...
  // OLD DELETE THIS
  typedef signalslot::ObsoleteSignal<void(Event const&, EventSetup const&)>
      PostProcessEvent;
  /// signal is emitted after all modules have finished processing the Event
  ...
  // OLD DELETE THIS
  typedef signalslot::ObsoleteSignal<void(RunID const&, Timestamp const&)>
      PreBeginRun;
  /// signal is emitted after the Run has been created by the InputSource but
  /// before any modules have seen the Run
  ...
  // OLD DELETE THIS
  typedef signalslot::ObsoleteSignal<void(Run const&, EventSetup const&)>
      PostBeginRun;
  ...
  // OLD DELETE THIS
  typedef signalslot::ObsoleteSignal<void(LuminosityBlockID const&,
                                          Timestamp const&)>
      PreBeginLumi;
  /// signal is emitted after the Lumi has been created by the InputSource but
  /// before any modules have seen the Lumi
  ...
  // OLD DELETE THIS
  typedef signalslot::ObsoleteSignal<void(LuminosityBlock const&,
                                          EventSetup const&)>
      PostBeginLumi;
  ...
  /// signal is emitted after all modules have finished for the Path for an
  /// event
  typedef signalslot::ObsoleteSignal<void(std::string const&,
                                          HLTPathStatus const&)>
      PostProcessPath;
  ...
  */
  ...
  typedef signalslot::Signal<void(ModuleDescription const&)>
      PreModuleConstruction;
  PreModuleConstruction preModuleConstructionSignal_;
  void watchPreModuleConstruction(
      PreModuleConstruction::slot_type const& iSlot) {
  ...
  void watchPostModuleConstruction(
      PostModuleConstruction::slot_type const& iSlot) {
  ...
  /// signal is emitted before the module starts processing the Event and before
  /// prefetching has started
  typedef signalslot::Signal<void(StreamContext const&,
                                  ModuleCallingContext const&)>
      PreModuleEventPrefetching;
  PreModuleEventPrefetching preModuleEventPrefetchingSignal_;
  void watchPreModuleEventPrefetching(
      PreModuleEventPrefetching::slot_type const& iSlot) {
    preModuleEventPrefetchingSignal_.connect(iSlot);
  }
  AR_WATCH_USING_METHOD_2(watchPreModuleEventPrefetching)

  /// signal is emitted before the module starts processing the Event and after
  /// prefetching has finished
  typedef signalslot::Signal<void(StreamContext const&,
                                  ModuleCallingContext const&)>
      PostModuleEventPrefetching;
  PostModuleEventPrefetching postModuleEventPrefetchingSignal_;
  void watchPostModuleEventPrefetching(
      PostModuleEventPrefetching::slot_type const& iSlot) {
  ...
  /// signal is emitted after the module starts processing the Event and before
  /// a delayed get has started
  typedef signalslot::Signal<void(StreamContext const&,
                                  ModuleCallingContext const&)>
      PreModuleEventDelayedGet;
  PreModuleEventDelayedGet preModuleEventDelayedGetSignal_;
  void watchPreModuleEventDelayedGet(
      PreModuleEventDelayedGet::slot_type const& iSlot) {
    preModuleEventDelayedGetSignal_.connect(iSlot);
  }
  AR_WATCH_USING_METHOD_2(watchPreModuleEventDelayedGet)

  /// signal is emitted after the module starts processing the Event and after a
  /// delayed get has finished
  typedef signalslot::Signal<void(StreamContext const&,
                                  ModuleCallingContext const&)>
      PostModuleEventDelayedGet;
  PostModuleEventDelayedGet postModuleEventDelayedGetSignal_;
  void watchPostModuleEventDelayedGet(
      PostModuleEventDelayedGet::slot_type const& iSlot) {
    postModuleEventDelayedGetSignal_.connect_front(iSlot);
  }
  AR_WATCH_USING_METHOD_2(watchPostModuleEventDelayedGet)

  /// signal is emitted after the module starts processing the Event, after a
  /// delayed get has started, and before a source read
  typedef signalslot::Signal<void(StreamContext const&,
                                  ModuleCallingContext const&)>
      PreEventReadFromSource;
  PreEventReadFromSource preEventReadFromSourceSignal_;
  void watchPreEventReadFromSource(
      PreEventReadFromSource::slot_type const& iSlot) {
    preEventReadFromSourceSignal_.connect(iSlot);
  }
  AR_WATCH_USING_METHOD_2(watchPreEventReadFromSource)

  /// signal is emitted after the module starts processing the Event, after a
  /// delayed get has started, and after a source read
  typedef signalslot::Signal<void(StreamContext const&,
                                  ModuleCallingContext const&)>
      PostEventReadFromSource;
  PostEventReadFromSource postEventReadFromSourceSignal_;
  void watchPostEventReadFromSource(
      PostEventReadFromSource::slot_type const& iSlot) {
  ...
  void watchPreModuleStreamBeginRun(
      PreModuleStreamBeginRun::slot_type const& iSlot) {
  ...
  void watchPostModuleStreamBeginRun(
      PostModuleStreamBeginRun::slot_type const& iSlot) {
  ...
  void watchPreModuleStreamEndRun(
      PreModuleStreamEndRun::slot_type const& iSlot) {
  ...
  void watchPostModuleStreamEndRun(
      PostModuleStreamEndRun::slot_type const& iSlot) {
  ...
  void watchPreModuleStreamBeginLumi(
      PreModuleStreamBeginLumi::slot_type const& iSlot) {
  ...
  void watchPostModuleStreamBeginLumi(
      PostModuleStreamBeginLumi::slot_type const& iSlot) {
  ...
  void watchPreModuleStreamEndLumi(
      PreModuleStreamEndLumi::slot_type const& iSlot) {
  ...
  void watchPostModuleStreamEndLumi(
      PostModuleStreamEndLumi::slot_type const& iSlot) {
    postModuleStreamEndLumiSignal_.connect_front(iSlot);
  }
  AR_WATCH_USING_METHOD_2(watchPostModuleStreamEndLumi)

  typedef signalslot::Signal<void(GlobalContext const&,
                                  ModuleCallingContext const&)>
      PreModuleGlobalBeginRun;
  PreModuleGlobalBeginRun preModuleGlobalBeginRunSignal_;
  void watchPreModuleGlobalBeginRun(
      PreModuleGlobalBeginRun::slot_type const& iSlot) {
  ...
  void watchPostModuleGlobalBeginRun(
      PostModuleGlobalBeginRun::slot_type const& iSlot) {
  ...
  void watchPreModuleGlobalEndRun(
      PreModuleGlobalEndRun::slot_type const& iSlot) {
  ...
  void watchPostModuleGlobalEndRun(
      PostModuleGlobalEndRun::slot_type const& iSlot) {
  ...
  void watchPreModuleGlobalBeginLumi(
      PreModuleGlobalBeginLumi::slot_type const& iSlot) {
  ...
  void watchPostModuleGlobalBeginLumi(
      PostModuleGlobalBeginLumi::slot_type const& iSlot) {
  ...
  void watchPreModuleGlobalEndLumi(
      PreModuleGlobalEndLumi::slot_type const& iSlot) {
  ...
  void watchPostModuleGlobalEndLumi(
      PostModuleGlobalEndLumi::slot_type const& iSlot) {
  ...
  typedef signalslot::ObsoleteSignal<void(ModuleDescription const&)>
      PreModuleBeginRun;
  ...
  void watchPreSourceConstruction(
      PreSourceConstruction::slot_type const& iSlot) {
  ...
  void watchPostSourceConstruction(
      PostSourceConstruction::slot_type const& iSlot) {
