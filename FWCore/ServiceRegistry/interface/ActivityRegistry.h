...
/**\class ActivityRegistry ActivityRegistry.h FWCore/ServiceRegistry/interface/ActivityRegistry.h
 ...
 Usage:
    Services can connect to the signals distributed by the ActivityRegistry in order to monitor the activity of the
application.
...
namespace edm {
  ...
  public:
    ...
    */
    ...
    /// signal is emitted after the module starts processing the Event, after a delayed get has started, and before a
    /// source read
    ...
    /// signal is emitted after the module starts processing the Event, after a delayed get has started, and after a
    /// source read
