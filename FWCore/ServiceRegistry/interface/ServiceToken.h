...
// Class  :     ServiceToken
//
/**\class ServiceToken ServiceToken.h
 ...
 Usage:
  ...
  the ServiceRegistry will return a ServiceToken.  When you want this 'service
 set' to be used,
  create a ServiceRegistry::Operate by passing the ServiceToken via the
 constructor.
