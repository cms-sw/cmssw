...
void DummyServiceBase::fillDescriptions(
...
DummyServiceE0::DummyServiceE0(edm::ParameterSet const&,
  ...
  iAR.watchPostBeginJob(this,
                        &testserviceregistry::DummyServiceE0::postBeginJob);
...
DummyServiceA1::DummyServiceA1(edm::ParameterSet const&,
  ...
  iAR.watchPostBeginJob(this,
                        &testserviceregistry::DummyServiceA1::postBeginJob);
...
DummyServiceD2::DummyServiceD2(edm::ParameterSet const&,
  ...
  iAR.watchPostBeginJob(this,
                        &testserviceregistry::DummyServiceD2::postBeginJob);
...
DummyServiceB3::DummyServiceB3(edm::ParameterSet const&,
  ...
  iAR.watchPostBeginJob(this,
                        &testserviceregistry::DummyServiceB3::postBeginJob);
...
DummyServiceC4::DummyServiceC4(edm::ParameterSet const&,
  ...
  iAR.watchPostBeginJob(this,
                        &testserviceregistry::DummyServiceC4::postBeginJob);
