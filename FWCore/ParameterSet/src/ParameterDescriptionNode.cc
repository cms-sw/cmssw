...
void ParameterDescriptionNode::setComment(std::string const& value) {
  comment_ = value;
}

void ParameterDescriptionNode::setComment(char const* value) {
  comment_ = value;
}

void ParameterDescriptionNode::print(std::ostream& os, bool optional,
                                     bool writeToCfi,
...
void ParameterDescriptionNode::printNestedContent(std::ostream& os,
                                                  bool optional,
                                                  DocFormatHelper& dfh) const {
  if (hasNestedContent()) {
    dfh.incrementCounter();
...
std::unique_ptr<ParameterDescriptionNode> operator&&(
    ...
    ParameterDescriptionNode const& node_right) {
  return std::make_unique<ANDGroupDescription>(std::move(node_left),
                                               node_right);
}
...
std::unique_ptr<ParameterDescriptionNode> operator&&(
  ...
  return std::make_unique<ANDGroupDescription>(node_left,
                                               std::move(node_right));
}
...
std::unique_ptr<ParameterDescriptionNode> operator||(
    std::unique_ptr<ParameterDescriptionNode> node_left,
    std::unique_ptr<ParameterDescriptionNode> node_right) {
  return std::make_unique<ORGroupDescription>(std::move(node_left),
                                              std::move(node_right));
}
...
std::unique_ptr<ParameterDescriptionNode> operator^(
    std::unique_ptr<ParameterDescriptionNode> node_left,
    ParameterDescriptionNode const& node_right) {
  return std::make_unique<XORGroupDescription>(std::move(node_left),
                                               node_right);
}
...
std::unique_ptr<ParameterDescriptionNode> operator^(
    ParameterDescriptionNode const& node_left,
    std::unique_ptr<ParameterDescriptionNode> node_right) {
  return std::make_unique<XORGroupDescription>(node_left,
                                               std::move(node_right));
}
