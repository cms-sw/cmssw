...
void ParameterDescriptionBase::throwMissingRequiredNoDefault() const {
  ...
  throw Exception(errors::Configuration)
      << "Missing required parameter.  It should have label \"" << label()
      << "\" and have type \"" << tr << " " << parameterTypeEnumToString(type())
      << "\".\n"
      << "The description has no default.  The parameter must be defined "
         "in the configuration\n";
}

void ParameterDescriptionBase::checkAndGetLabelsAndTypes_(
...
void ParameterDescriptionBase::writeCfi_(std::ostream& os, bool& startWithComma,
                                         int indentation,
...
void ParameterDescriptionBase::print_(std::ostream& os, bool optional,
                                      bool writeToCfi,
...
void ParameterDescriptionBase::printDefault_(std::ostream& os, bool writeToCfi,
                                             DocFormatHelper& dfh) const {
...
bool ParameterDescriptionBase::partiallyExists_(
    ParameterSet const& pset) const {
  return exists(pset);
}

int ParameterDescriptionBase::howManyXORSubNodesExist_(
    ParameterSet const& pset) const {
