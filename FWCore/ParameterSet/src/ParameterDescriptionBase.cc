...
namespace edm {
  ...
  ParameterDescriptionBase::ParameterDescriptionBase(std::string const& iLabel, ParameterTypes iType, bool isTracked,
                                                     bool hasDefault, Comment const& iComment)
  ...
  ParameterDescriptionBase::ParameterDescriptionBase(char const* iLabel, ParameterTypes iType, bool isTracked,
                                                     bool hasDefault, Comment const& iComment)
      : ParameterDescriptionNode(iComment),
        label_(iLabel),
        type_(iType),
  ...
  void ParameterDescriptionBase::throwParameterWrongTrackiness() const {
    ...
    throw Exception(errors::Configuration) << "In the configuration, parameter \"" << label() << "\" is defined "
                                                                                                 "as "
  ...
  void ParameterDescriptionBase::throwParameterWrongType() const {
    ...
    throw Exception(errors::Configuration) << "Parameter \"" << label() << "\" should be defined "
                                                                           "as "
                                           << tr << " " << parameterTypeEnumToString(type()) << ".\n"
  ...
  void ParameterDescriptionBase::validate_(ParameterSet& pset, std::set<std::string>& validatedLabels,
                                           bool optional) const {
  ...
  void ParameterDescriptionBase::writeCfi_(std::ostream& os, bool& startWithComma, int indentation,
