...
/*
 * $Id: pset_parse.y,v 1.7 2005/05/26 19:06:59 paterno Exp $
 *
 * Author: Us
 * Date:   4/28/05
...
static int yyerror(char* msg);
 ...
 int yylex();    // we do not want to do it like this
 namespace edm { namespace pset {
 int lines=1;
 } }
...
//namespace edm {
 ...
 namespace edm { namespace pset { NodePtrList* global_gunk; } }
