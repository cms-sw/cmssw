// ----------------------------------------------------------------------
// $Id: Entry.cc,v 1.5 2005/05/19 18:30:56 chrjones Exp $
//
...
edm::Entry::Entry( std::vector<int> const& val
                 , bool                    is_tracked
                 )
  : rep    ()
  , type   ('i')
...
edm::Entry::Entry( std::vector<unsigned> const& val
                 , bool                         is_tracked
                 )
  : rep    ()
  , type   ('u')
...
edm::Entry::Entry( std::vector<double>  const& val
                 , bool                        is_tracked
                 )
  : rep    ()
  , type   ('d')
...
edm::Entry::Entry( std::string const& val
                 , bool                is_tracked
                 )
  : rep    ()
  , type   ('S')
...
edm::Entry::Entry( std::vector<std::string> const& val
                 , bool                            is_tracked
                 )
  : rep    ()
  , type   ('s')
...
edm::Entry::Entry( ParameterSet const& val
                 , bool         is_tracked
                 )
  : rep    ()
  , type   ('P')
...
edm::Entry::Entry( std::vector<ParameterSet>  const& val
                 , bool                      is_tracked
                 )
  : rep    ()
  , type   ('p')
...
edm::Entry::Entry( std::string const& code
                 )
  : rep    ("")
  , type   ('?')
  , tracked('?')
{
  if( ! fromString( code.begin()
                   , code.end()
    )              )
...
edm::Entry::Entry( std::string const& type, std::string const& value, bool is_tracked)
: rep    ("")
, type   ('?')
, tracked('?')
{
   ...
   if( ! fromString( codedString.begin()
                      , codedString.end()
                      )              )
...
edm::Entry::Entry( std::string const& type, std::vector<std::string> const& value, bool is_tracked)
: rep    ("")
, type   ('?')
, tracked('?')
{
...
bool
  edm::Entry::fromString( std::string::const_iterator const b
                         , std::string::const_iterator const e
                         )
{
  if(    static_cast<unsigned long>(e - b) < 4u
      || b[ 2] != '('
      || e[-1] != ')'
    )
    return false;
