...
static std::map<edm::ParameterTypes, FillDescriptionFromParameter>
...
void fillDescriptionFromParameter(edm::ParameterSet const& pset,
                                  std::string const& name, bool isTracked,
...
void initMap() {
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('I')] =
      &fillDescriptionFromParameter<int>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('i')] =
      &fillDescriptionFromParameter<std::vector<int>>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('U')] =
      &fillDescriptionFromParameter<unsigned>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('u')] =
      &fillDescriptionFromParameter<std::vector<unsigned>>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('L')] =
      &fillDescriptionFromParameter<long long>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('l')] =
      &fillDescriptionFromParameter<std::vector<long long>>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('X')] =
      &fillDescriptionFromParameter<unsigned long long>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('x')] =
      &fillDescriptionFromParameter<std::vector<unsigned long long>>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('D')] =
      &fillDescriptionFromParameter<double>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('d')] =
      &fillDescriptionFromParameter<std::vector<double>>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('B')] =
      &fillDescriptionFromParameter<bool>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('S')] =
      &fillDescriptionFromParameter<std::string>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('s')] =
      &fillDescriptionFromParameter<std::vector<std::string>>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('E')] =
      &fillDescriptionFromParameter<edm::EventID>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('e')] =
  ...
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('t')] =
      &fillDescriptionFromParameter<edm::InputTag>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('v')] =
      &fillDescriptionFromParameter<std::vector<edm::InputTag>>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('F')] =
      &fillDescriptionFromParameter<edm::FileInPath>;
  ...
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('R')] =
      &fillDescriptionFromParameter<edm::EventRange>;
  s_findTheRightFunction[static_cast<edm::ParameterTypes>('r')] =
      &fillDescriptionFromParameter<std::vector<edm::EventRange>>;
}

std::map<edm::ParameterTypes, FillDescriptionFromParameter>&
findTheRightFunction() {
...
void fillDescriptionFromPSet(ParameterSet const& pset,
  ...
  for (ParameterSet::table::const_iterator entry = entries.begin(),
       ...
       entry != endEntries; ++entry) {
    std::map<edm::ParameterTypes, FillDescriptionFromParameter>::iterator iter =
        findTheRightFunction().find(
            static_cast<edm::ParameterTypes>(entry->second.typeCode()));
  ...
  for (ParameterSet::psettable::const_iterator
           pset_entry = pset_entries.begin(),
           endEntries = pset_entries.end();
       pset_entry != endEntries; ++pset_entry) {
    ...
    if (pset_entry->second.isTracked()) {
      desc.add<edm::ParameterSetDescription>(pset_entry->first,
                                             nestedDescription);
    } else {
      desc.addUntracked<edm::ParameterSetDescription>(pset_entry->first,
                                                      nestedDescription);
    }
  }

  ParameterSet::vpsettable const& vpset_entries = pset.vpsetTable();
  for (ParameterSet::vpsettable::const_iterator
           vpset_entry = vpset_entries.begin(),
           endEntries = vpset_entries.end();
       vpset_entry != endEntries; ++vpset_entry) {
    ...
    auto pd = std::make_unique<ParameterDescription<std::vector<ParameterSet>>>(
        vpset_entry->first, emptyDescription, vpset_entry->second.isTracked(),
        nestedVPset);
