...
bool edm::encode(std::string& to, std::vector<bool> const& from) {
  ...
  for (std::vector<bool>::const_iterator b = from.begin(), e = from.end();
       b != e; ++b) {
...
bool edm::encode(std::string& to, std::vector<int> const& from) {
  ...
  std::string converted;
  for (std::vector<int>::const_iterator b = from.begin(), e = from.end();
       b != e; ++b) {
    if (!encode(converted, *b)) {
      return false;
    }
...
bool edm::encode(std::string& to, std::vector<long long> const& from) {
  ...
  std::string converted;
  for (std::vector<long long>::const_iterator b = from.begin(), e = from.end();
       b != e; ++b) {
    if (!encode(converted, *b)) {
      return false;
    }
...
bool edm::encode(std::string& to, std::vector<double> const& from) {
  ...
  std::string converted;
  for (std::vector<double>::const_iterator b = from.begin(), e = from.end();
       b != e; ++b) {
    if (!encode(converted, *b)) return false;
...
bool edm::encode(std::string& to, std::vector<ESInputTag> const& from) {
  std::vector<std::string> strings;
  for (std::vector<ESInputTag>::const_iterator tagItr = from.begin(),
                                               tagItrEnd = from.end();
       tagItr != tagItrEnd; ++tagItr) {
    strings.push_back(tagItr->encode());
  }
...
bool edm::decode(edm::EventID& to, std::string const& from) {
  ...
  unsigned int lumi =
      (tokens.size() == 2 ? 0 : strtoul(tokens[1].c_str(), 0, 0));
...
bool edm::encode(std::string& to,
  ...
  std::vector<std::string> strings;
  for (std::vector<edm::LuminosityBlockID>::const_iterator
           idItr = from.begin(),
           idItrEnd = from.end();
       idItr != idItrEnd; ++idItr) {
...
bool edm::encode(std::string& to, edm::LuminosityBlockRange const& from) {
  std::ostringstream os;
  os << from.startRun() << ":" << from.startLumi() << "-" << from.endRun()
     << ":" << from.endLumi();
  to = os.str();
  return true;
}
...
bool edm::encode(std::string& to,
  ...
  std::vector<std::string> strings;
  for (std::vector<edm::LuminosityBlockRange>::const_iterator
           idItr = from.begin(),
           idItrEnd = from.end();
       idItr != idItrEnd; ++idItr) {
...
bool edm::encode(std::string& to, edm::EventRange const& from) {
  ...
  if (from.startLumi() == 0) {
    ...
    os << from.startRun() << ":" << from.startEvent() << "-" << from.endRun()
       << ":" << from.endEvent();
  } else {
    assert(from.endLumi() != 0);
...
bool edm::encode(std::string& to, std::vector<edm::EventRange> const& from) {
  std::vector<std::string> strings;
  for (std::vector<edm::EventRange>::const_iterator idItr = from.begin(),
                                                    idItrEnd = from.end();
       idItr != idItrEnd; ++idItr) {
