...
const std::string edm::ParameterSetDescriptionFillerBase::kBaseForService(
    "Service");
const std::string edm::ParameterSetDescriptionFillerBase::kBaseForESSource(
    "ESSource");
const std::string edm::ParameterSetDescriptionFillerBase::kBaseForESProducer(
    "ESProducer");
const std::string
...
const std::string
    edm::ParameterSetDescriptionFillerBase::kExtendedBaseForEDFilter(
        "EDFilter");
const std::string
    edm::ParameterSetDescriptionFillerBase::kExtendedBaseForOutputModule(
        "OutputModule");
const std::string
...
//
// const ParameterSetDescriptionFillerBase&
// ParameterSetDescriptionFillerBase::operator=(const
// ParameterSetDescriptionFillerBase& rhs)
// {
