...
namespace edm {
  ...
  ParameterSet::ParameterSet(ParameterSet const& other)
      : tbl_(other.tbl_), psetTable_(other.psetTable_), vpsetTable_(other.vpsetTable_), id_(other.id_) {}
  ...
  void ParameterSet::insertVParameterSet(bool okay_to_replace, std::string const& name,
