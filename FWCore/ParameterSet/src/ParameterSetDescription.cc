...
namespace edm {
  ...
  void ParameterSetDescription::writeCfi(std::ostream& os, bool startWithComma, int indentation) const {
    ...
    for_all(entries_, std::bind(&ParameterSetDescription::writeNode, _1, std::ref(os), std::ref(startWithComma),
  ...
  void ParameterSetDescription::validateNode(SetDescriptionEntry const& entry, ParameterSet& pset,
                                             std::set<std::string>& validatedLabels) {
  ...
  void ParameterSetDescription::writeNode(SetDescriptionEntry const& entry, std::ostream& os, bool& startWithComma,
  ...
  void ParameterSetDescription::throwIfWildcardCollision(std::set<ParameterTypes> const& nodeParameterTypes,
    ...
    if (!nodeWildcardTypes.empty()) {
      ...
      std::set_intersection(typesUsedForParameters_.begin(), typesUsedForParameters_.end(), nodeWildcardTypes.begin(),
                            nodeWildcardTypes.end(), insertIter1);
    ...
    if (!typesUsedForWildcards_.empty()) {
      ...
      std::set_intersection(typesUsedForWildcards_.begin(), typesUsedForWildcards_.end(), nodeParameterTypes.begin(),
                            nodeParameterTypes.end(), insertIter2);
  ...
  ParameterDescriptionNode* ParameterSetDescription::ifExists(ParameterDescriptionNode const& node1,
                                                              ParameterDescriptionNode const& node2, bool optional,
                                                              bool writeToCfi) {
