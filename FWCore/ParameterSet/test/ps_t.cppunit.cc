...
void testps::eventIDTest() {
  ...
  testbody<edm::EventID>(edm::EventID(edm::EventID::maxRunNumber(), edm::EventID::maxLuminosityBlockNumber(),
                                      edm::EventID::maxEventNumber()));
}

void testps::eventRangeTest() {
  testbody<edm::EventRange>(edm::EventRange());
  testbody<edm::EventRange>(edm::EventRange(1, 1, 1, edm::EventID::maxRunNumber(),
                                            edm::EventID::maxLuminosityBlockNumber(), edm::EventID::maxEventNumber()));
...
void testps::vEventRangeTest() {
  ...
  testbody<std::vector<edm::EventRange> >(std::vector<edm::EventRange>(
      1, edm::EventRange(1, 1, 1, edm::EventID::maxRunNumber(), edm::EventID::maxLuminosityBlockNumber(),
                         edm::EventID::maxEventNumber())));
