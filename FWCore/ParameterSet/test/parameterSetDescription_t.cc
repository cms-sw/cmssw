...
namespace testParameterSetDescription {
  ...
  void testDesc(edm::ParameterDescriptionNode const& node, edm::ParameterSetDescription const& psetDesc,
  ...
  void testIfExists() {
    edm::ParameterSetDescription psetDesc1;
    std::unique_ptr<edm::ParameterDescriptionNode> node1(std::make_unique<edm::IfExistsDescription>(
        edm::ParameterDescription<double>("x1", 101.0, true), (edm::ParameterDescription<double>("x2", 101.0, true) and
    ...
    edm::ParameterSetDescription psetDesc2;
    psetDesc2.add<unsigned>("x1", 1U);
    std::unique_ptr<edm::ParameterDescriptionNode> node2(std::make_unique<edm::IfExistsDescription>(
        edm::ParameterDescription<double>("x1", 101.0, true), (edm::ParameterDescription<double>("x2", 101.0, true) and
                                                               edm::ParameterDescription<double>("x3", 101.0, true))));
    ...
    // One of the labels cannot already exist in the description, other order
    edm::ParameterSetDescription psetDesc3;
    std::unique_ptr<edm::ParameterDescriptionNode> node3(std::make_unique<edm::IfExistsDescription>(
        edm::ParameterDescription<double>("x1", 101.0, true), (edm::ParameterDescription<double>("x2", 101.0, true) and
                                                               edm::ParameterDescription<double>("x3", 101.0, true))));
    psetDesc3.addNode(std::move(node3));
    ...
    // Put the duplicate labels in different nodes of the "and" expression
    edm::ParameterSetDescription psetDesc4;
    std::unique_ptr<edm::ParameterDescriptionNode> node4(std::make_unique<edm::IfExistsDescription>(
        edm::ParameterDescription<double>("x1", 101.0, true), (edm::ParameterDescription<double>("x2", 101.0, true) and
                                                               edm::ParameterDescription<double>("x1", 101.0, true))));
    try {
      psetDesc4.addNode(std::move(node4));
    ...
    edm::ParameterSetDescription psetDesc7;
    psetDesc7.addWildcard<double>("*");
    std::unique_ptr<edm::ParameterDescriptionNode> node7(std::make_unique<edm::IfExistsDescription>(
        edm::ParameterDescription<double>("x1", 11.0, true), (edm::ParameterDescription<unsigned>("x2", 101U, true) and
                                                              edm::ParameterDescription<unsigned>("x3", 102U, true))));
    try {
      psetDesc7.addNode(std::move(node7));
      assert(0);
