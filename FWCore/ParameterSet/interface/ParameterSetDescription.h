...
namespace edm {
  ...
  private:
    ...
    template <typename U>
    ParameterDescriptionBase* addVPSet(U const& iLabel, ParameterSetDescription const& validator, bool isTracked,
    ...
    static void writeNode(SetDescriptionEntry const& entry, std::ostream& os, bool& startWithComma, int indentation,
                          bool& wroteSomething);
...
namespace edm {
  ...
  template <typename T, typename U>
  ParameterDescriptionBase* ParameterSetDescription::add(U const& iLabel, T const& value, bool isTracked,
                                                         bool isOptional, bool writeToCfi) {
  ...
  template <typename T, typename U>
  ParameterDescriptionBase* ParameterSetDescription::add(U const& iLabel, bool isTracked, bool isOptional,
                                                         bool writeToCfi) {
  ...
  template <typename U>
  ParameterDescriptionBase* ParameterSetDescription::addVPSet(U const& iLabel, ParameterSetDescription const& validator,
                                                              std::vector<ParameterSet> const& defaults, bool isTracked,
                                                              bool isOptional, bool writeToCfi) {
    std::unique_ptr<ParameterDescriptionNode> node =
  ...
  template <typename T, typename U>
  ParameterDescriptionNode* ParameterSetDescription::labelsFrom(U const& iLabel, bool isTracked, bool optional,
                                                                bool writeToCfi) {
