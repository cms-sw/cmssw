...
//
/**\class ParameterSetDescriptionFillerPluginFactory ParameterSetDescriptionFillerPluginFactory.h
...
// NOTE: Can't do the below since this appears on the same line as another factory and w'ed have two variables with the
// same name DEFINE_EDM_PLUGIN (edm::ParameterSetDescriptionFillerPluginFactory,type,#type)
