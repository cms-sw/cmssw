...
template <class FwdIter>
FwdIter contextual_find_not(FwdIter b, FwdIter e, char first, char sep,
                            char last);

template <class OutIter>
bool split(OutIter result, std::string const& string_to_split, char first,
           char sep, char last);
...
template <class FwdIter>
FwdIter edm::contextual_find(FwdIter b, FwdIter e, char first, char sep,
                             char last) {
...
template <class FwdIter>
FwdIter edm::contextual_find_not(FwdIter b, FwdIter e, char /* first */,
                                 char sep, char /* last */) {
  for (; b != e; ++b) {
    if (*b != sep) return b;
  }
...
template <class OutIter>
bool edm::split(OutIter dest, std::string const& s, char first, char sep,
                char last) {
