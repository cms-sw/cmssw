...
class ParameterSwitchBase : public ParameterDescriptionNode {
 ...
 protected:
  ...
  void printBase(std::ostream& os, bool optional, bool writeToCfi,
                 DocFormatHelper& dfh, std::string const& switchLabel,
                 bool isTracked, std::string const& typeString) const;

  virtual bool hasNestedContent_() const;

  void printNestedContentBase(std::ostream& os, DocFormatHelper& dfh,
                              DocFormatHelper& new_dfh,
                              std::string const& switchLabel) const;

  template <typename T>
  static void printCaseT(
      std::pair<T, edm::value_ptr<ParameterDescriptionNode> > const& p,
      std::ostream& os, bool optional, DocFormatHelper& dfh,
 ...
 private:
  static void printCase(
      std::pair<bool, edm::value_ptr<ParameterDescriptionNode> > const& p,
      std::ostream& os, bool optional, DocFormatHelper& dfh,
      std::string const& switchLabel);

  static void printCase(
      std::pair<int, edm::value_ptr<ParameterDescriptionNode> > const& p,
      std::ostream& os, bool optional, DocFormatHelper& dfh,
      std::string const& switchLabel);

  static void printCase(
      std::pair<std::string, edm::value_ptr<ParameterDescriptionNode> > const&
          p,
      std::ostream& os, bool optional, DocFormatHelper& dfh,
      std::string const& switchLabel);
