...
//
/**\class ParameterDescriptionBase ParameterDescriptionBase.h
...
class ParameterDescriptionBase : public ParameterDescriptionNode {
 ...
 protected:
  ...
  ParameterDescriptionBase(std::string const& iLabel, ParameterTypes iType,
                           bool isTracked, bool hasDefault);

  ParameterDescriptionBase(char const* iLabel, ParameterTypes iType,
                           bool isTracked, bool hasDefault);
 ...
 private:
  ...
  virtual void printDefault_(std::ostream& os, bool writeToCfi,
                             DocFormatHelper& dfh) const;
