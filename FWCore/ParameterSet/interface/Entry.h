...
class Entry {
 public:
  ...
  // vUint32
  Entry(std::string const& name, std::vector<unsigned> const& val,
        bool is_tracked);
  ...
  // vInt64
  Entry(std::string const& name, std::vector<long long> const& val,
        bool is_tracked);
  ...
  // vUint64
  Entry(std::string const& name, std::vector<unsigned long long> const& val,
        bool is_tracked);
  ...
  // vDouble
  Entry(std::string const& name, std::vector<double> const& val,
        bool is_tracked);
  ...
  // vString
  Entry(std::string const& name, std::vector<std::string> const& val,
        bool is_tracked);
  ...
  // InputTag
  Entry(std::string const& name, std::vector<InputTag> const& vtag,
        bool is_tracked);
  ...
  // VESInputTag
  Entry(std::string const& name, std::vector<ESInputTag> const& vtag,
        bool is_tracked);
  ...
  // VEventID
  Entry(std::string const& name, std::vector<EventID> const& vtag,
        bool is_tracked);
  ...
  // VLuminosityBlockID
  Entry(std::string const& name, std::vector<LuminosityBlockID> const& vtag,
        bool is_tracked);
  std::vector<LuminosityBlockID> getVLuminosityBlockID() const;

  // LuminosityBlockRange
  Entry(std::string const& name, LuminosityBlockRange const& tag,
        bool is_tracked);
  LuminosityBlockRange getLuminosityBlockRange() const;

  // VLuminosityBlockRange
  Entry(std::string const& name, std::vector<LuminosityBlockRange> const& vtag,
        bool is_tracked);
  ...
  // VEventRange
  Entry(std::string const& name, std::vector<EventRange> const& vtag,
        bool is_tracked);
  ...
  // vPSet
  Entry(std::string const& name, std::vector<ParameterSet> const& val,
        bool is_tracked);
 ...
 private:
  ...
  void throwEntryError(char const* expectedType,
                       std::string const& badRep) const;
  void throwEncodeError(char const* type) const;

};  // Entry

inline bool operator==(Entry const& a, Entry const& b) {
