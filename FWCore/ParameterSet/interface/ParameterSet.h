...
class ParameterSet {
 public:
  ...
  ParameterSetEntry const* retrieveUntrackedParameterSet(
      std::string const&) const;
  ParameterSetEntry const* retrieveUnknownParameterSet(
      std::string const&) const;
  VParameterSetEntry const& retrieveVParameterSet(std::string const&) const;
  VParameterSetEntry const* retrieveUntrackedVParameterSet(
      std::string const&) const;
  VParameterSetEntry const* retrieveUnknownVParameterSet(
      std::string const&) const;

  void insertParameterSet(bool okay_to_replace, std::string const& name,
                          ParameterSetEntry const& entry);
  void insertVParameterSet(bool okay_to_replace, std::string const& name,
  ...
  ParameterSet getUntrackedParameterSet(std::string const& name,
                                        ParameterSet const& defaultValue) const;

  ParameterSet getUntrackedParameterSet(char const* name,
                                        ParameterSet const& defaultValue) const;
  ...
  std::vector<FileInPath>::size_type getAllFileInPaths(
  ...
  void deprecatedInputTagWarning(std::string const& name,
                                 std::string const& label) const;

  template <typename T>
  std::vector<std::string> getParameterNamesForType(
      bool trackiness = true) const {
 ...
 private:
  ...
  size_t getNamesByCode_(char code, bool trackiness,
...
inline bool operator!=(ParameterSet const& a, ParameterSet const& b) {
  return !(a == b);
}
