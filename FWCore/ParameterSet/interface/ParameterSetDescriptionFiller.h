...
method of the templated argument.  This allows the ParameterSetDescriptionFillerPluginFactory to communicate with
existing plugins.
...
namespace edm {
  ...
  public:
    ...
    void fill(ConfigurationDescriptions& descriptions) const override {
      std::conditional_t<edm::fillDetails::has_fillDescriptions_function<T>::value,
                         edm::fillDetails::DoFillDescriptions<T>, edm::fillDetails::DoFillAsUnknown<T>>
          fill_descriptions;
  ...
  public:
    ...
    void fill(ConfigurationDescriptions& descriptions) const override {
      ...
      std::conditional_t<edm::fillDetails::has_prevalidate_function<T>::value, edm::fillDetails::DoPrevalidate<T>,
