  ...
  private:
    void checkAndGetLabelsAndTypes_(std::set<std::string>& usedLabels, std::set<ParameterTypes>& parameterTypes,
      ...
      for_all(cases_, std::bind(&ParameterSwitch::checkCaseLabels, std::placeholders::_1, std::ref(caseLabels),
                                std::ref(caseParameterTypes), std::ref(caseWildcardTypes)));
    ...
    void print_(std::ostream& os, bool optional, bool writeToCfi, DocFormatHelper& dfh) const override {
      printBase(os, optional, writeToCfi, dfh, switch_.label(), switch_.isTracked(),
    ...
    void printNestedContent_(std::ostream& os, bool optional, DocFormatHelper& dfh) const override {
      ...
      for_all(cases_, std::bind(&ParameterSwitchBase::printCaseT<T>, std::placeholders::_1, std::ref(os), optional,
