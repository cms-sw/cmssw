...
namespace edm {
  ...
  bool Worker::shouldRethrowException(std::exception_ptr iPtr, ParentContext const& parentContext, bool isEvent,
  ...
  void Worker::prePrefetchSelectionAsync(WaitingTask* successTask, StreamID id, EventPrincipal const* iPrincipal) {
