...
//
/**\class edm::OutputModuleCommunicator OutputModuleCommunicator.h
 "FWCore/Framework/interface/OutputModuleCommunicator.h"

 Description: Base class used by the framework to communicate with an
 OutputModule
...
class OutputModuleCommunicator {
 ...
 private:
  OutputModuleCommunicator(const OutputModuleCommunicator&) =
      delete;  // stop default

  const OutputModuleCommunicator& operator=(const OutputModuleCommunicator&) =
      delete;  // stop default
