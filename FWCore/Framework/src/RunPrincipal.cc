...
RunPrincipal::RunPrincipal(std::shared_ptr<RunAuxiliary> aux,
                           ...
                           unsigned int iRunIndex, bool isForPrimaryProcess)
...
void RunPrincipal::fillRunPrincipal(
    ProcessHistoryRegistry const& processHistoryRegistry,
    DelayedReader* reader) {
  complete_ = false;

  m_reducedHistoryID =
      processHistoryRegistry.reducedProcessHistoryID(aux_->processHistoryID());
...
void RunPrincipal::put(BranchDescription const& bd,
