...
class PrincipalCache {
 public:
  ...
  RunPrincipal& runPrincipal(ProcessHistoryID const& phid,
                             RunNumber_t run) const;
  std::shared_ptr<RunPrincipal> const& runPrincipalPtr(
  ...
  LuminosityBlockPrincipal& lumiPrincipal(ProcessHistoryID const& phid,
                                          RunNumber_t run,
  ...
  void merge(std::shared_ptr<RunAuxiliary> aux,
  ...
  void deleteLumi(ProcessHistoryID const& phid, RunNumber_t run,
                  LuminosityBlockNumber_t lumi);

  void adjustEventsToNewProductRegistry(
      std::shared_ptr<ProductRegistry const> reg);
