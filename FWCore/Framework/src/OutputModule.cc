...
namespace edm {
  ...
  bool OutputModule::doEvent(EventPrincipal const& ep, EventSetup const&, ActivityRegistry* act,
  ...
  bool OutputModule::doBeginRun(RunPrincipal const& rp, EventSetup const&, ModuleCallingContext const* mcc) {
  ...
  bool OutputModule::doEndRun(RunPrincipal const& rp, EventSetup const&, ModuleCallingContext const* mcc) {
  ...
  void OutputModule::doWriteRun(RunPrincipal const& rp, ModuleCallingContext const* mcc) {
  ...
  bool OutputModule::doBeginLuminosityBlock(LuminosityBlockPrincipal const& lbp, EventSetup const&,
                                            ModuleCallingContext const* mcc) {
  ...
  bool OutputModule::doEndLuminosityBlock(LuminosityBlockPrincipal const& lbp, EventSetup const&,
                                          ModuleCallingContext const* mcc) {
