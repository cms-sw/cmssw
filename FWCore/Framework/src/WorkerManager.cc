...
namespace edm {
  ...
  WorkerManager::WorkerManager(std::shared_ptr<ModuleRegistry> modReg, std::shared_ptr<ActivityRegistry> areg,
  ...
  Worker* WorkerManager::getWorker(ParameterSet& pset, ProductRegistry& preg,
  ...
  void WorkerManager::addToUnscheduledWorkers(ParameterSet& pset, ProductRegistry& preg,
                                              PreallocationConfiguration const* prealloc,
