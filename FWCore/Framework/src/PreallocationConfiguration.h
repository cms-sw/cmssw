...
/**\class edm::PreallocationConfiguration PreallocationConfiguration.h
 ...
 Description: Holds number of simultaneous Streams, LuminosityBlocks and Runs
 the job will allow.
...
class PreallocationConfiguration {
 public:
  ...
  PreallocationConfiguration(unsigned int iNThreads, unsigned int iNStreams,
                             unsigned int iNLumis, unsigned int iNRuns)
 ...
 private:
  // PreallocationConfiguration(const PreallocationConfiguration&) = delete; //
  // stop default

  // const PreallocationConfiguration& operator=(const
  // PreallocationConfiguration&) = delete; // stop default
