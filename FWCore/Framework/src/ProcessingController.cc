...
//
// const ProcessingController& ProcessingController::operator=(const
// ProcessingController& rhs)
// {
...
ProcessingController::Transition ProcessingController::requestedTransition()
    const {
  return transition_;
}
