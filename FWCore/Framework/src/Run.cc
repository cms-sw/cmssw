...
namespace edm {
  ...
  Run::Run(RunPrincipal const& rp, ModuleDescription const& md, ModuleCallingContext const* moduleCallingContext)
      : provRecorder_(rp, md), aux_(rp.aux()), moduleCallingContext_(moduleCallingContext) {}
  ...
  */
  ...
  BasicHandle Run::getByLabelImpl(std::type_info const&, std::type_info const& iProductType,
