...
namespace edm {
  ...
  static std::shared_ptr<cms::Exception> makeNotFoundException(char const* where, KindOfType kindOfType,
                                                               TypeID const& productType, std::string const& label,
  ...
  static void throwAmbiguousException(const char* where, TypeID const& productType, std::string const& label,
  ...
  namespace {
    ...
    void failedToRegisterConsumes(KindOfType kindOfType, TypeID const& productType, std::string const& moduleLabel,
  ...
  Principal::Principal(std::shared_ptr<ProductRegistry const> reg,
                       std::shared_ptr<ProductResolverIndexHelper const> productLookup, ProcessConfiguration const& pc,
                       BranchType bt, HistoryAppender* historyAppender, bool isForPrimaryProcess)
      : EDProductGetter(),
        processHistoryPtr_(),
        processHistoryID_(),
  ...
  void Principal::fillPrincipal(ProcessHistoryID const& hist, ProcessHistoryRegistry const& processHistoryRegistry,
  ...
  BasicHandle Principal::getByLabel(KindOfType kindOfType, TypeID const& typeID, InputTag const& inputTag,
  ...
  BasicHandle Principal::getByLabel(KindOfType kindOfType, TypeID const& typeID, std::string const& label,
                                    std::string const& instance, std::string const& process,
                                    EDConsumerBase const* consumer, SharedResourcesAcquirer* sra,
                                    ModuleCallingContext const* mcc) const {
  ...
  BasicHandle Principal::getByToken(KindOfType, TypeID const&, ProductResolverIndex index, bool skipCurrentProcess,
                                    bool& ambiguous, SharedResourcesAcquirer* sra,
                                    ModuleCallingContext const* mcc) const {
    assert(index != ProductResolverIndexInvalid);
  ...
  void Principal::prefetchAsync(WaitingTask* task, ProductResolverIndex index, bool skipCurrentProcess,
                                ModuleCallingContext const* mcc) const {
  ...
  void Principal::getManyByType(TypeID const& typeID, BasicHandleVec& results, EDConsumerBase const* consumer,
  ...
  void Principal::findProducts(std::vector<ProductResolverBase const*> const& holders, TypeID const&,
  ...
  ProductData const* Principal::findProductByLabel(KindOfType kindOfType, TypeID const& typeID,
                                                   InputTag const& inputTag, EDConsumerBase const* consumer,
  ...
  ProductData const* Principal::findProductByLabel(KindOfType kindOfType, TypeID const& typeID,
                                                   ...
                                                   std::string const& process, EDConsumerBase const* consumer,
                                                   SharedResourcesAcquirer* sra,
                                                   ModuleCallingContext const* mcc) const {
  ...
  ProductData const* Principal::findProductByTag(TypeID const& typeID, InputTag const& tag,
                                                 ModuleCallingContext const* mcc) const {
  ...
  void Principal::getThinnedProducts(ProductID const&, std::vector<WrapperBase const*>&,
