...
namespace edm {
  ...
  void ESProducer::esModulesWhoseProductsAreConsumed(
    ...
    for (auto const& transition : consumesInfos_) {
      ...
      for (auto const& esConsumesInfoEntry : *transition) {
        eventsetup::EventSetupRecordImpl const* eventSetupRecordImpl = nullptr;
        eventsetup::EventSetupRecordProvider const* eventSetupRecordProvider =
            eventSetupProvider.tryToGetRecordProvider(esConsumesInfoEntry.recordKey_);
        if (eventSetupRecordProvider) {
          eventSetupRecordImpl = &eventSetupRecordProvider->firstRecordImpl();
        }
        ...
        if (esConsumesInfoEntry.chooser_) {
          ...
          for (auto const& esTagGetterInfo : esTagGetterInfos) {
            assert(eventSetupRecordProvider);
            eventsetup::ComponentDescription const* componentDescription =
                eventSetupRecordImpl->componentDescription(esTagGetterInfo.index_);
  ...
  std::vector<std::vector<EventSetupConsumesInfo>> ESProducer::eventSetupConsumesInfo(
      eventsetup::EventSetupProvider const& eventSetupProvider) const {
    std::vector<std::vector<EventSetupConsumesInfo>> result;
      ...
      for (auto const& esConsumesInfoEntry : *esConsumesInfo) {
        ...
        if (esConsumesInfoEntry.chooser_) {
          ...
          for (auto const& esTagGetterInfo : esTagGetterInfos) {
            ...
            info.transitionOfProducer_ = eventSetupRecordImpl->transitionID(esTagGetterInfo.index_);
