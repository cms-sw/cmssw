...
namespace edm {
  namespace eventsetup {
    ...
    //
    // const IntersectingIOVRecordIntervalFinder& IntersectingIOVRecordIntervalFinder::operator=(const
    // IntersectingIOVRecordIntervalFinder& rhs)
    // {
    ...
    void IntersectingIOVRecordIntervalFinder::setIntervalFor(const EventSetupRecordKey& iKey, const IOVSyncValue& iTime,
