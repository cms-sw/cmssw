...
class WorkerT : public Worker {
 public:
  ...
  WorkerT(std::shared_ptr<T>, ModuleDescription const&,
 ...
 private:
  ...
  virtual bool implDoPrePrefetchSelection(
      StreamID id, EventPrincipal const& ep,
      ModuleCallingContext const* mcc) override;
  ...
  virtual void implRegisterThinnedAssociations(
      ProductRegistry const&, ThinnedAssociationsHelper&) override;
  ...
  virtual void convertCurrentProcessAlias(
      std::string const& processName) override {
  ...
  virtual void itemsToGet(
      ...
      std::vector<ProductResolverIndexAndSkipBit>& indexes) const override {
  ...
  virtual std::vector<ProductResolverIndexAndSkipBit> const& itemsToGetFrom(
      BranchType iType) const override final {
  ...
  virtual void preActionBeforeRunEventAsync(
    ...
    module_->preActionBeforeRunEventAsync(iTask, iModuleCallingContext,
                                          iPrincipal);
  }
