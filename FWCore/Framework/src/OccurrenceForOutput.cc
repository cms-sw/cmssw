...
namespace edm {
  ...
  OccurrenceForOutput::OccurrenceForOutput(Principal const& p, ModuleDescription const& md,
  ...
  bool OccurrenceForOutput::getByToken(EDGetToken token, TypeID const& typeID, BasicHandle& result) const {
    result.clear();
