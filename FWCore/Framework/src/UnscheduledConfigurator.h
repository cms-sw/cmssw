...
//
/**\class UnscheduledConfigurator UnscheduledConfigurator.h
...
class UnscheduledConfigurator {
 ...
 private:
  UnscheduledConfigurator(const UnscheduledConfigurator&) =
      delete;  // stop default

  const UnscheduledConfigurator& operator=(const UnscheduledConfigurator&) =
      delete;  // stop default
