...
namespace edm {
  namespace eventsetup {
    ...
    void ModuleMakerTraits::addTo(EventSetupProvider& iProvider, std::shared_ptr<DataProxyProvider> iComponent,
    ...
    void ModuleMakerTraits::putComponent(EventSetupsController& esController, ParameterSet const& iConfiguration,
