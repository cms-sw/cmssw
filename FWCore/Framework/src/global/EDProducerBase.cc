...
namespace edm {
  ...
  namespace global {
    ...
    EDProducerBase::doEvent(EventPrincipal const& ep, EventSetupImpl const& c,
      ...
      this->produce(e.streamID(), e, EventSetup{c,static_cast<unsigned int>(Transition::Event)});
                                     ...
                                     ModuleCallingContext const* mcc)
    {
      Run r(rp, moduleDescription_, mcc, false);
      r.setConsumer(this);
      this->doStreamBeginRun_(id, r, EventSetup{c,static_cast<unsigned int>(Transition::BeginRun)});
    }
    void
    ...
    EDProducerBase::doStreamBeginLuminosityBlock(StreamID id,
      ...
      LuminosityBlock lb(lbp, moduleDescription_, mcc, false);
      lb.setConsumer(this);
      this->doStreamBeginLuminosityBlock_(id,lb, EventSetup{c,static_cast<unsigned int>(Transition::BeginLuminosityBlock)});
    }
