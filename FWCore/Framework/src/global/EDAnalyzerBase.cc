...
void EDAnalyzerBase::doPreallocate(
...
void EDAnalyzerBase::doStreamBeginRun(StreamID id, RunPrincipal const& rp,
                                      EventSetup const& c,
                                      ModuleCallingContext const* mcc) {
  Run r(rp, moduleDescription_, mcc);
  r.setConsumer(this);
...
void EDAnalyzerBase::doStreamEndRun(StreamID id, RunPrincipal const& rp,
                                    EventSetup const& c,
                                    ModuleCallingContext const* mcc) {
  Run r(rp, moduleDescription_, mcc);
  r.setConsumer(this);
...
void EDAnalyzerBase::doStreamBeginLuminosityBlock(
...
void EDAnalyzerBase::doStreamEndLuminosityBlock(
    StreamID id, LuminosityBlockPrincipal const& lbp, EventSetup const& c,
    ModuleCallingContext const* mcc) {
  LuminosityBlock lb(lbp, moduleDescription_, mcc);
  lb.setConsumer(this);
...
void EDAnalyzerBase::doStreamBeginRun_(StreamID id, Run const& rp,
                                       EventSetup const& c) {}
void EDAnalyzerBase::doStreamEndRun_(StreamID id, Run const& rp,
                                     EventSetup const& c) {}
void EDAnalyzerBase::doStreamEndRunSummary_(StreamID id, Run const& rp,
                                            EventSetup const& c) {}
...
void EDAnalyzerBase::doStreamEndLuminosityBlock_(StreamID id,
                                                 LuminosityBlock const& lbp,
                                                 EventSetup const& c) {}
void EDAnalyzerBase::doStreamEndLuminosityBlockSummary_(
...
void EDAnalyzerBase::registerProductsAndCallbacks(EDAnalyzerBase*,
                                                  ProductRegistry* reg) {
