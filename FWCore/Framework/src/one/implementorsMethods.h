...
template <typename T>
void LuminosityBlockWatcher<T>::doBeginLuminosityBlock_(
    LuminosityBlock const& rp, EventSetup const& c) {
  this->beginLuminosityBlock(rp, c);
}
template <typename T>
void LuminosityBlockWatcher<T>::doEndLuminosityBlock_(LuminosityBlock const& rp,
                                                      EventSetup const& c) {
