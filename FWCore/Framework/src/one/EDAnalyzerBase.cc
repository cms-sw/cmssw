...
bool EDAnalyzerBase::doEvent(EventPrincipal const& ep, EventSetup const& c,
...
void EDAnalyzerBase::doBeginRun(RunPrincipal const& rp, EventSetup const& c,
                                ModuleCallingContext const* mcc) {
...
void EDAnalyzerBase::doEndRun(RunPrincipal const& rp, EventSetup const& c,
                              ModuleCallingContext const* mcc) {
  Run r(rp, moduleDescription_, mcc);
  r.setConsumer(this);
  Run const& cnstR = r;
...
void EDAnalyzerBase::prevalidate(ConfigurationDescriptions& iConfig) {
