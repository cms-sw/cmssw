...
//
SystemTimeKeeper::SystemTimeKeeper(unsigned int iNumStreams, std::vector<const ModuleDescription*> const& iModules,
...
static void fillPathSummary(unsigned int iStartIndex, unsigned int iEndIndex,
