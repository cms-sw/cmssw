...
namespace edm {
  ...
  void IOVSyncValue::throwInvalidComparison() const {
    throw cms::Exception("InvalidIOVSyncValueComparison") << "Attempted to compare a time-only and a "
                                                             "run/lumi/event-only IOVSyncValue. Please report this "
                                                             "error to the framework experts.";
  }
