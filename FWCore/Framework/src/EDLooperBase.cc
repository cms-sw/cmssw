...
namespace edm {
 ...
 { }
  ...
  EDLooperBase::doDuringLoop(edm::EventPrincipal& eventPrincipal, const edm::EventSetupImpl& esi,
    ...
    try {
      const EventSetup es{esi,static_cast<unsigned int>(Transition::Event)};
  ...
  EDLooperBase::doEndOfLoop(const edm::EventSetupImpl& esi) {
    const EventSetup es{esi,static_cast<unsigned int>(Transition::EndRun)};
  ...
  void EDLooperBase::beginOfJob(const edm::EventSetupImpl& iImpl) { beginOfJob(EventSetup{iImpl,static_cast<unsigned int>(Transition::BeginRun)});}
  ...
  void EDLooperBase::doBeginRun(RunPrincipal& iRP, EventSetupImpl const& iES, ProcessContext* processContext) {
        ...
        const EventSetup es{iES,static_cast<unsigned int>(Transition::BeginRun)};
        beginRun(run,es);
  }
  ...
  void EDLooperBase::doEndRun(RunPrincipal& iRP, EventSetupImpl const& iES, ProcessContext* processContext){
        ...
        const EventSetup es{iES,static_cast<unsigned int>(Transition::EndRun)};
        endRun(run,es);
  }
  void EDLooperBase::doBeginLuminosityBlock(LuminosityBlockPrincipal& iLB, EventSetupImpl const& iES, ProcessContext* processContext){
    ...
    const EventSetup es{iES,static_cast<unsigned int>(Transition::BeginLuminosityBlock)};
  ...
  void EDLooperBase::doEndLuminosityBlock(LuminosityBlockPrincipal& iLB, EventSetupImpl const& iES, ProcessContext* processContext){
    ...
    const EventSetup es{iES,static_cast<unsigned int>(Transition::EndLuminosityBlock)};
