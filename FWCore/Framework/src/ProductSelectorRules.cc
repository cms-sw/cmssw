...
namespace edm {
  ...
  void ProductSelectorRules::fillDescription(ParameterSetDescription& desc, char const* parameterName,
  ...
  ProductSelectorRules::ProductSelectorRules(ParameterSet const& pset, std::string const& parameterName,
