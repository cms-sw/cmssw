/**
   ...
   \version $Id: ScheduleBuilder.cc,v 1.16 2005/10/28 01:42:56 chrjones Exp $
   \date 18 May 2005
*/

static const char CVSId[] = "$Id: ScheduleBuilder.cc,v 1.16 2005/10/28 01:42:56 chrjones Exp $";
