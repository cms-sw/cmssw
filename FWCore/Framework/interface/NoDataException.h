...
//
/**\class NoDataException NoDataException.h
 Exception/interface/NoDataException.h
...
class NoDataExceptionBase : public cms::Exception {
 ...
 private:
  ...
  // const NoDataExceptionBase& operator=(const NoDataExceptionBase&); // allow
  // default
...
class NoDataException : public NoDataExceptionBase {
 public:
  ...
  NoDataException(const EventSetupRecordKey& iRecordKey,
                  const DataKey& iDataKey, const char* category_name,
