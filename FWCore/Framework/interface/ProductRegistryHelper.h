...
namespace edm {
  ...
  public:
    ...
    static void addToRegistry(TypeLabelList::const_iterator const& iBegin, TypeLabelList::const_iterator const& iEnd,
                              ModuleDescription const& iDesc, ProductRegistry& iReg, bool iIsListener = false);
    ...
    BranchAliasSetter produces(const TypeID& id, std::string instanceName = std::string(),
