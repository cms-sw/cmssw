...
class ProductRegistryHelper {
 public:
  ...
  struct TypeLabelItem {
    TypeLabelItem(Transition const& transition, TypeID const& tid,
  ...
  static void addToRegistry(TypeLabelList::const_iterator const& iBegin,
                            ...
                            ProductRegistry& iReg, bool iIsListener = false);
  ...
  TypeLabelItem const& produces(
      const TypeID& id, std::string const& instanceName = std::string()) {
