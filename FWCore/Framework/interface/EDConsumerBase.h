...
class EDConsumerBase {
 public:
  ...
  ProductResolverIndexAndSkipBit indexFrom(EDGetToken, BranchType,
                                           TypeID const&) const;
  ...
  ///\return true if the product corresponding to the index was registered via
  ///consumes or mayConsume call
  bool registeredToConsume(ProductResolverIndex, bool, BranchType) const;

  ///\return true of TypeID corresponds to a type specified in a consumesMany
  ///call
  ...
  /// Convert "@currentProcess" in InputTag process names to the actual current
  /// process name.
 ...
 protected:
  ...
  /// Use a ConsumesCollector to gather consumes information from helper
  /// functions
  ...
  EDGetTokenT<ProductType> consumes(edm::InputTag const& tag) {
    ...
    return EDGetTokenT<ProductType>{
        recordConsumes(B, tid, checkIfEmpty(tag), true)};
  }
  ...
  EDGetTokenT<ProductType> mayConsume(edm::InputTag const& tag) {
    TypeToGet tid = TypeToGet::make<ProductType>();
    return EDGetTokenT<ProductType>{
        recordConsumes(B, tid, checkIfEmpty(tag), false)};
  }
 ...
 private:
  ...
  struct TokenLookupInfo {
    TokenLookupInfo(edm::TypeID const& iID, ProductResolverIndex iIndex,
                    bool skipCurrentProcess, BranchType iBranch)
        : m_type(iID),
          m_index(iIndex, skipCurrentProcess),
          m_branchType(iBranch) {}
    edm::TypeID m_type;
  ...
  edm::SoATuple<TokenLookupInfo, bool, LabelPlacement, edm::KindOfType>
      m_tokenInfo;
