...
//
/**\class OutputModuleBase OutputModuleBase.h
 "FWCore/Framework/interface/one/OutputModuleBase.h"
...
class OutputModuleBase : public EDConsumerBase {
 public:
  ...
  OutputModuleBase(OutputModuleBase const&) =
      delete;  // Disallow copying and moving
  OutputModuleBase& operator=(OutputModuleBase const&) =
      delete;  // Disallow copying and moving
 ...
 private:
  ...
  std::string workerType() const {
    return "WorkerT<edm::one::OutputModuleBase>";
  }
  ...
  void registerProductsAndCallbacks(OutputModuleBase const*,
