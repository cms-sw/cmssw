...
/**\file implementors.h "FWCore/Framework/interface/one/implementors.h"
 ...
 Description: Base classes used to implement the interfaces for the edm::one::*
 module  abilities
...
class LuminosityBlockWatcher : public virtual T {
 ...
 private:
  void doBeginLuminosityBlock_(LuminosityBlock const& rp,
                               EventSetup const& c) override final;
  void doEndLuminosityBlock_(LuminosityBlock const& rp,
                             EventSetup const& c) override final;
...
class BeginLuminosityBlockProducer : public virtual T {
 ...
 private:
  void doBeginLuminosityBlockProduce_(LuminosityBlock& lbp,
                                      EventSetup const& c) override final;

  virtual void beginLuminosityBlockProduce(edm::LuminosityBlock&,
                                           edm::EventSetup const&) = 0;
};
...
class EndLuminosityBlockProducer : public virtual T {
 ...
 private:
  void doEndLuminosityBlockProduce_(LuminosityBlock& lbp,
                                    EventSetup const& c) override final;
