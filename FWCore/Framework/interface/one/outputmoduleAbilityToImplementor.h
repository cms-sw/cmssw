...
namespace edm {
  ...
  namespace one {
    namespace outputmodule {
      ...
      template <typename C> class RunCacheHolder : public virtual OutputModuleBase {
      public:
      ...
      template <typename C> class LuminosityBlockCacheHolder : public virtual OutputModuleBase {
      public:
        template <typename... A> LuminosityBlockCacheHolder(edm::ParameterSet const& iPSet) : OutputModuleBase(iPSet) {}
