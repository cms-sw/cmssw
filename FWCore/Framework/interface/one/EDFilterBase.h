...
//
/**\class one::EDFilterBase EDFilterBase.h
...
class EDFilterBase : public ProducerBase, public EDConsumerBase {
 ...
 private:
  ...
  void registerProductsAndCallbacks(EDFilterBase* module,
                                    ProductRegistry* reg) {
  ...
  virtual void doBeginLuminosityBlock_(LuminosityBlock const& lbp,
                                       EventSetup const& c);
  virtual void doEndLuminosityBlock_(LuminosityBlock const& lbp,
                                     EventSetup const& c);
