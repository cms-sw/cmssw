...
/**\file moduleAbilities moduleAbilities.h
 ...
 Description: Template arguments for stream::{Module}, global::{Module},
 one::{Module} classes

 Usage:
    These classes are used the declare the 'abilities' a developer wants to make
 use of in their module.
