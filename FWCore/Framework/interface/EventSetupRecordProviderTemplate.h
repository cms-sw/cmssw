...
//
/**\class EventSetupRecordProviderTemplate EventSetupRecordProviderTemplate.h
 FWCore/Framework/interface/EventSetupRecordProviderTemplate.h

 Description: <one line class summary>

 Usage:
    NOTE: The class inherits from DependentEventSetupRecordProvider only if T
 inherits from DependentRecordTag, else the class inherits directly
...
template <typename T>
void addRecordToDependencies(const T*, const T*,
...
void addRecordToDependencies(const TFirst*, const TEnd* iEnd,
  ...
  oSet.insert(
      EventSetupRecordKey::makeKey<typename boost::mpl::deref<TFirst>::type>());
...
std::set<EventSetupRecordKey> findDependentRecordsFor() {
  typedef typename boost::mpl::if_<
      typename boost::is_base_and_derived<edm::eventsetup::DependentRecordTag,
                                          T>::type,
      FindDependenciesFromDependentRecord<T>, NoDependenciesForRecord>::type
      DepFinder;
...
class EventSetupRecordProviderTemplate : public EventSetupRecordProvider {
 public:
  ...
  EventSetupRecordProviderTemplate()
      : BaseType(EventSetupRecordKey::makeKey<T>()), record_() {}
 ...
 private:
  EventSetupRecordProviderTemplate(
      EventSetupRecordProviderTemplate const&);  // stop default

  EventSetupRecordProviderTemplate const& operator=(
      EventSetupRecordProviderTemplate const&);  // stop default
