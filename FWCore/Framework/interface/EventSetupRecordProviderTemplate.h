...
/**\class EventSetupRecordProviderTemplate EventSetupRecordProviderTemplate.h
 ...
 Usage:
    NOTE: The class inherits from DependentEventSetupRecordProvider only if T inherits from DependentRecordTag, else the
...
namespace edm {
  namespace eventsetup {
    ...
    public:
      ...
      // ---------- member functions ---------------------------
      std::set<EventSetupRecordKey> dependentRecords() const override { return findDependentRecordsFor<T>(); }
    ...
    private:
      ...
      EventSetupRecordProviderTemplate const& operator=(EventSetupRecordProviderTemplate const&) = delete;  // stop
                                                                                                            // default
