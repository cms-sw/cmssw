...
//
/**\class print_eventsetup_record_dependencies print_eventsetup_record_dependencies.h
...
namespace edm {
  ...
  void print_eventsetup_record_dependencies(std::ostream& oStream, std::string iIndent, TFirst const*,
                                            TEnd const* iEnd) {
    iIndent += " ";
  ...
  template <typename RecordT>
  void print_eventsetup_record_dependencies_recursive(std::ostream& oStream, std::string const& iIndent,
                                                      boost::mpl::true_) {
