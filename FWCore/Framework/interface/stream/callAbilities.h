...
namespace edm {
  ...
  namespace stream {
    ...
    struct CallGlobalRunImpl {
      static void beginRun(edm::Run const& iRun, edm::EventSetup const& iES, typename T::GlobalCache const* iGC,
    ...
    struct CallGlobalRunSummaryImpl {
      static void beginRun(edm::Run const& iRun, edm::EventSetup const& iES, typename T::RunContext const* iRC,
      ...
      static void globalEndRun(edm::Run const& iRun, edm::EventSetup const& iES, typename T::RunContext const* iContext,
                               typename T::RunSummaryCache* iCache) {
    ...
    struct CallGlobalRunSummaryImpl<T, false> {
      ...
      static void globalEndRun(edm::Run const&, edm::EventSetup const&, typename T::RunContext const*,
    ...
    struct CallGlobalLuminosityBlockImpl {
      static void beginLuminosityBlock(edm::LuminosityBlock const& Lumi, edm::EventSetup const& iES,
    ...
    struct CallGlobalLuminosityBlockSummaryImpl {
      ...
      static void globalEndLuminosityBlock(edm::LuminosityBlock const& Lumi, edm::EventSetup const& iES,
                                           typename T::LuminosityBlockContext const* iContext,
                                           typename T::LuminosityBlockSummaryCache* iCache) {
    ...
    struct CallGlobalLuminosityBlockSummaryImpl<T, false> {
      ...
      static void streamEndLuminosityBlockSummary(void* iProd, edm::LuminosityBlock const&, edm::EventSetup const&,
                                                  typename T::LuminosityBlockSummaryCache* iCache) {}
    ...
    struct CallEndLuminosityBlockProduceImpl {
      static void produce(edm::LuminosityBlock&, edm::EventSetup const&, typename T::LuminosityBlockContext const*,
