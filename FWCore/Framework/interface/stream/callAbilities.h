...
// Class  :     callAbilities
//
/**\class callAbilities callAbilities.h
 "FWCore/Framework/interface/stream/callAbilities.h"
...
struct CallGlobalRunImpl<T, false> {
  static void beginRun(edm::Run const&, edm::EventSetup const&,
                       typename T::GlobalCache const*, impl::dummy_ptr) {}
  static void set(void* iProd, typename T::RunCache const* iCache) {}
  static void endRun(edm::Run const&, edm::EventSetup const&,
...
struct CallGlobalRunSummaryImpl {
  ...
  template <typename B>
  static void streamEndRunSummary(B* iProd, edm::Run const& iRun,
...
struct CallGlobalRunSummaryImpl<T, false> {
  ...
  static void streamEndRunSummary(void* iProd, edm::Run const&,
...
template <typename T>
using CallGlobalRunSummary =
    CallGlobalRunSummaryImpl<T, T::HasAbility::kRunSummaryCache>;
...
struct CallGlobalLuminosityBlockImpl {
  ...
  static void endLuminosityBlock(
      edm::LuminosityBlock const& Lumi, edm::EventSetup const& iES,
...
struct CallGlobalLuminosityBlockSummaryImpl {
  ...
  template <typename B>
  static void streamEndLuminosityBlockSummary(
      B* iProd, edm::LuminosityBlock const& iLumi, edm::EventSetup const& iES,
...
struct CallGlobalLuminosityBlockSummaryImpl<T, false> {
  static void beginLuminosityBlock(edm::LuminosityBlock const&,
                                   ...
                                   impl::dummy_ptr) {}
  static void streamEndLuminosityBlockSummary(
      void* iProd, edm::LuminosityBlock const&, edm::EventSetup const&,
      typename T::LuminosityBlockSummaryCache* iCache) {}
  static void globalEndLuminosityBlock(
...
template <typename T>
using CallGlobalLuminosityBlockSummary = CallGlobalLuminosityBlockSummaryImpl<
    T, T::HasAbility::kLuminosityBlockSummaryCache>;
...
template <typename T>
using CallBeginRunProduce =
    CallBeginRunProduceImpl<T, T::HasAbility::kBeginRunProducer>;
...
struct CallEndRunProduceImpl {
  static void produce(edm::Run&, edm::EventSetup const&,
                      typename T::RunContext const*,
...
using CallEndRunProduce =
    CallEndRunProduceImpl<T, T::HasAbility::kEndRunProducer,
                          T::HasAbility::kRunSummaryCache>;
...
template <typename T>
using CallBeginLuminosityBlockProduce = CallBeginLuminosityBlockProduceImpl<
    T, T::HasAbility::kBeginLuminosityBlockProducer>;
...
template <typename T>
using CallEndLuminosityBlockProduce = CallEndLuminosityBlockProduceImpl<
    T, T::HasAbility::kEndLuminosityBlockProducer,
