...
namespace edm {
  ...
  namespace stream {
    ...
    private:
      ...
      void streamEndLuminosityBlockSummary(M* iProd, edm::LuminosityBlock const& iLumi,
      ...
      void doBeginLuminosityBlock(LuminosityBlockPrincipal const& lbp, EventSetup const& c,
        ...
        if (T::HasAbility::kLuminosityBlockCache or T::HasAbility::kLuminosityBlockSummaryCache or
