...
// Class  :     EDAnalyzer
//
/**\class edm::stream::EDAnalyzer EDAnalyzer.h
...
class EDAnalyzer : public AbilityToImplementor<T>::Type...,
 ...
 public:
  ...
  typedef LuminosityBlockContextT<LuminosityBlockCache, RunCache, GlobalCache>
      LuminosityBlockContext;
  typedef typename CacheTypes::RunSummaryCache RunSummaryCache;
  typedef typename CacheTypes::LuminosityBlockSummaryCache
