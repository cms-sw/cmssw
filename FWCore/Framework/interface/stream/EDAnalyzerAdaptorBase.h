...
class EDAnalyzerAdaptorBase {
 public:
  ...
  void registerProductsAndCallbacks(EDAnalyzerAdaptorBase const*,
                                    ProductRegistry* reg);
 ...
 protected:
  ...
  void itemsToGet(BranchType,
                  std::vector<ProductResolverIndexAndSkipBit>&) const;
  void itemsMayGet(BranchType,
                   std::vector<ProductResolverIndexAndSkipBit>&) const;
  std::vector<ProductResolverIndexAndSkipBit> const& itemsToGetFrom(
      BranchType) const;

  void updateLookup(BranchType iBranchType, ProductResolverIndexHelper const&,
 ...
 private:
  ...
  const EDAnalyzerAdaptorBase& operator=(
      const EDAnalyzerAdaptorBase&);  // stop default
  ...
  void doStreamEndRun(StreamID id, RunPrincipal const& ep, EventSetup const& c,
                      ModuleCallingContext const*);
  virtual void streamEndRunSummary(EDAnalyzerBase*, edm::Run const&,
