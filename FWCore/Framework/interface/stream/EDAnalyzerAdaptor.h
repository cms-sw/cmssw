...
//
/**\class edm::stream::EDAnalyzerAdaptor EDAnalyzerAdaptor.h
 "EDAnalyzerAdaptor.h"
...
class EDAnalyzerAdaptor : public EDAnalyzerAdaptorBase {
 ...
 private:
  ...
  void setupLuminosityBlock(EDAnalyzerBase* iProd,
  ...
  void streamEndLuminosityBlockSummary(
      EDAnalyzerBase* iProd, edm::LuminosityBlock const& iLumi,
      edm::EventSetup const& iES) override final {
