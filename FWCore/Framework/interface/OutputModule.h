...
class OutputModule : public EDConsumerBase {
 public:
  ...
  OutputModule& operator=(OutputModule const&) =
  ...
  static void fillDescription(
      ...
      std::vector<std::string> const& iDefaultOutputCommands =
 ...
 protected:
  ...
  // event.
  Trig getTriggerResults(EDGetTokenT<TriggerResults> const& token,
  ...
  std::map<BranchID::value_type, BranchID::value_type> const&
 ...
 private:
  ...
  std::map<BranchID::value_type, BranchID::value_type>
      droppedBranchIDToKeptBranchID_;
  edm::propagate_const<std::unique_ptr<BranchIDLists>> branchIDLists_;
  BranchIDLists const* origBranchIDLists_;

  edm::propagate_const<std::unique_ptr<ThinnedAssociationsHelper>>
  ...
  void registerProductsAndCallbacks(OutputModule const*,
                                    ProductRegistry const*) {}

  bool prePrefetchSelection(StreamID id, EventPrincipal const&,
  ...
  void keepThisBranch(BranchDescription const& desc,
                      std::map<BranchID, BranchDescription const*>&
