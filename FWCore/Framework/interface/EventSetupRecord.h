...
namespace edm {
  ...
  namespace eventsetup {
    ...
    protected:
      ...
      void addTraceInfoToCmsException(cms::Exception& iException, char const* iName, ComponentDescription const*,
                                      DataKey const&) const;
      void changeStdExceptionToCmsException(char const* iExceptionWhatMessage, char const* iName,
                                            ComponentDescription const*, DataKey const&) const;
    ...
    private:
      ...
      void const* getFromProxy(DataKey const& iKey, ComponentDescription const*& iDesc,
                               bool iTransientAccessOnly) const;

      template <typename DataT>
      void getImplementation(DataT const*& iData, char const* iName, ComponentDescription const*& iDesc,
        ...
        if (nullptr == pValue) {
          whyFailedFactory = makeESHandleExceptionFactory([=]() -> std::exception_ptr {
