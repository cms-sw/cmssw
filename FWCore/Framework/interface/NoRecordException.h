...
//
/**\class NoRecordException NoRecordException.h
 Framework/interface/NoRecordException.h

 Description: An exception that is thrown whenever a EventSetup is asked to
 retrieve
...
bool recordDoesExist(edm::EventSetup const&,
                     edm::eventsetup::EventSetupRecordKey const&);
...
class NoRecordException : public cms::Exception {
 ...
 private:
  ...
  // const NoRecordException& operator=(const NoRecordException&); // stop
  // default
