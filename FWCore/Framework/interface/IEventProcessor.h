...
namespace edm {
  ...
  public:
    ...
    virtual void beginRun(ProcessHistoryID const& phid, RunNumber_t run) = 0;
    virtual void endRun(ProcessHistoryID const& phid, RunNumber_t run, bool cleaningUpAfterException) = 0;
    ...
    virtual void deleteRunFromCache(ProcessHistoryID const& phid, RunNumber_t run) = 0;
