...
namespace edm {
  ...
  namespace eventsetup {
    ...
    struct ModuleMakerTraits {
      ...
      static void addTo(EventSetupProvider& iProvider, std::shared_ptr<DataProxyProvider> iComponent,
      ...
      static void putComponent(EventSetupsController& esController, ParameterSet const& iConfiguration,
