...
/**\class ScheduleInfo ScheduleInfo.h FWCore/Framework/interface/ScheduleInfo.h
 ...
 Usage:
    This class allows EDLoopers to find out about the configuration of module
 and paths in the process.
...
class ScheduleInfo {
 public:
  ...
  /**returns a pointer to the parameters for the module with label iLabel,
   returns 0 if
  ...
  /// add to oLabelsToFill in execution order the labels of all modules in path
  /// iPathLabel
