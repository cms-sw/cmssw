...
class ProducerBase : private ProductRegistryHelper {
 public:
  ...
  void registerProducts(ProducerBase*, ProductRegistry*,
  ...
  std::vector<edm::ProductResolverIndex> const& indiciesForPutProducts(
 ...
 private:
  ...
  void commit_(P& iPrincipal) {
    iPrincipal.commit_(
        putIndicies_[producerbasehelper::PrincipalTraits<P>::kBranchType]);
  }
  ...
  std::array<std::vector<edm::ProductResolverIndex>, edm::NumBranchTypes>
      putIndicies_;
};
}
#endif
