...
class OccurrenceTraits<EventPrincipal, BranchActionStreamBegin> {
 public:
  ...
  static void setStreamContext(StreamContext& streamContext,
  ...
  static void preScheduleSignal(ActivityRegistry* a,
                                StreamContext const* streamContext) {
    a->preEventSignal_(*streamContext);
  }
  static void postScheduleSignal(ActivityRegistry* a,
                                 StreamContext const* streamContext) {
    a->postEventSignal_(*streamContext);
  }
  static void prePathSignal(ActivityRegistry* a,
                            PathContext const* pathContext) {
    a->prePathEventSignal_(*pathContext->streamContext(), *pathContext);
  }
  static void postPathSignal(ActivityRegistry* a, HLTPathStatus const& status,
                             PathContext const* pathContext) {
    a->postPathEventSignal_(*pathContext->streamContext(), *pathContext,
                            status);
  }
...
class OccurrenceTraits<RunPrincipal, BranchActionGlobalBegin> {
 public:
  ...
  static GlobalContext makeGlobalContext(MyPrincipal const& principal,
  ...
  static void postPathSignal(ActivityRegistry*, HLTPathStatus const&,
                             PathContext const*) {}
  static void preModuleSignal(
      ActivityRegistry* a, GlobalContext const* globalContext,
      ModuleCallingContext const* moduleCallingContext) {
    a->preModuleGlobalBeginRunSignal_(*globalContext, *moduleCallingContext);
  }
  static void postModuleSignal(
      ActivityRegistry* a, GlobalContext const* globalContext,
      ModuleCallingContext const* moduleCallingContext) {
...
class OccurrenceTraits<RunPrincipal, BranchActionStreamBegin> {
 public:
  ...
  static void postPathSignal(ActivityRegistry*, HLTPathStatus const&,
                             PathContext const*) {}
  static void preModuleSignal(
      ActivityRegistry* a, StreamContext const* streamContext,
      ModuleCallingContext const* moduleCallingContext) {
 ...
 public:
  ...
  static GlobalContext makeGlobalContext(MyPrincipal const& principal,
    ...
    return GlobalContext(GlobalContext::Transition::kEndRun,
                         ...
                         principal.index(),
                         LuminosityBlockIndex::invalidLuminosityBlockIndex(),
                         principal.endTime(), processContext);
  }
 ...
 public:
  ...
  static GlobalContext makeGlobalContext(MyPrincipal const& principal,
    ...
    return GlobalContext(GlobalContext::Transition::kBeginLuminosityBlock,
                         principal.id(), principal.runPrincipal().index(),
                         principal.index(), principal.beginTime(),
                         processContext);
  }
...
class OccurrenceTraits<LuminosityBlockPrincipal, BranchActionStreamBegin> {
 public:
  ...
  static void setStreamContext(StreamContext& streamContext,
                               MyPrincipal const& principal) {
    streamContext.setTransition(
        StreamContext::Transition::kBeginLuminosityBlock);
    streamContext.setEventID(
        EventID(principal.run(), principal.luminosityBlock(), 0));
...
class OccurrenceTraits<LuminosityBlockPrincipal, BranchActionStreamEnd> {
 public:
  ...
  static StreamContext const* context(StreamContext const* s,
                                      GlobalContext const*) {
    return s;
  }
