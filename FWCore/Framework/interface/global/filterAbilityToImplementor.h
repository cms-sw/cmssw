...
//
/**\file  filterAbilityToImplementor.h
 "FWCore/Framework/interface/global/filterAbilityToImplementor.h"
...
struct AbilityToImplementor<edm::StreamCache<C>> {
  typedef edm::global::impl::StreamCacheHolder<edm::global::EDFilterBase, C>
      Type;
};
...
struct AbilityToImplementor<edm::RunSummaryCache<C>> {
  typedef edm::global::impl::RunSummaryCacheHolder<edm::global::EDFilterBase, C>
      Type;
};
