...
//
/**\file  producerAbilityToImplementor.h
...
struct AbilityToImplementor<edm::StreamCache<C>> {
  typedef edm::global::impl::StreamCacheHolder<edm::global::EDProducerBase, C>
      Type;
};

template <typename C>
struct AbilityToImplementor<edm::RunCache<C>> {
  typedef edm::global::impl::RunCacheHolder<edm::global::EDProducerBase, C>
      Type;
};

template <typename C>
struct AbilityToImplementor<edm::RunSummaryCache<C>> {
  typedef edm::global::impl::RunSummaryCacheHolder<edm::global::EDProducerBase,
                                                   C>
      Type;
};
...
struct AbilityToImplementor<edm::LuminosityBlockCache<C>> {
  typedef edm::global::impl::LuminosityBlockCacheHolder<
      edm::global::EDProducerBase, C>
      Type;
};

template <typename C>
struct AbilityToImplementor<edm::LuminosityBlockSummaryCache<C>> {
  typedef edm::global::impl::LuminosityBlockSummaryCacheHolder<
      edm::global::EDProducerBase, C>
      Type;
};
...
struct AbilityToImplementor<edm::BeginLuminosityBlockProducer> {
  typedef edm::global::impl::BeginLuminosityBlockProducer<
...
struct AbilityToImplementor<edm::EndLuminosityBlockProducer> {
  typedef edm::global::impl::EndLuminosityBlockProducer<
      edm::global::EDProducerBase>
      Type;
};
...
struct SpecializeAbilityToImplementor<true, B, edm::RunSummaryCache<C>> {
  typedef typename edm::global::impl::EndRunSummaryProducer<
      edm::global::EDProducerBase, C>
      Type;
};
...
template <bool B, typename C>
struct SpecializeAbilityToImplementor<B, true,
                                      edm::LuminosityBlockSummaryCache<C>> {
  typedef typename edm::global::impl::EndLuminosityBlockSummaryProducer<
      edm::global::EDProducerBase, C>
      Type;
};
