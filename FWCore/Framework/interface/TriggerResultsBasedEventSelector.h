...
namespace edm {
  ...
  namespace detail {
    ...
    public:
      ...
      void setup(std::vector<parsed_path_spec_t> const& path_specs, std::vector<std::string> const& triggernames,
    ...
    bool configureEventSelector(edm::ParameterSet const& iPSet, std::string const& iProcessName,
                                ...
                                edm::detail::TriggerResultsBasedEventSelector& oSelector, ConsumesCollector&& iC);
