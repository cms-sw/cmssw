...
typedef Callback<UniquePtrProd, std::unique_ptr<Data>, Record>
    UniquePtrCallback;
...
typedef Callback<SharedPtrProd, std::shared_ptr<Data>, Record>
    SharedPtrCallback;
...
typedef Callback<PtrProductsProd, edm::ESProducts<const Data*, const Double*>,
                 Record>
    PtrProductsCallback;
