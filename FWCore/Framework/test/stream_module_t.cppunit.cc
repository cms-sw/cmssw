...
private:
  ...
  public:
    ...
    static std::shared_ptr<int> globalBeginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&,
                                                           RunContext const*) {
      ++m_count;
      return std::shared_ptr<int>{};
    }
  ...
  public:
    ...
    static std::shared_ptr<int> globalBeginLuminosityBlockSummary(edm::LuminosityBlock const&, edm::EventSetup const&,
                                                                  LuminosityBlockContext const*) {
      ++m_count;
      return std::shared_ptr<int>{};
    }
    ...
    static void globalEndLuminosityBlockSummary(edm::LuminosityBlock const&, edm::EventSetup const&,
                                                LuminosityBlockContext const*, int*) {
      ++m_count;
    }
  };
  ...
  public:
    ...
    static void globalEndLuminosityBlockProduce(edm::LuminosityBlock&, edm::EventSetup const&,
                                                LuminosityBlockContext const*, int const*) {
      ++m_count;
    }
  };
};
...
namespace {
  ...
  void testTransition(edm::Worker* iWorker, testStreamModule::Trans iTrans,
                      testStreamModule::Expectations const& iExpect, std::function<void(edm::Worker*)> iFunc) {
    assert(0 == T::m_count);
    iFunc(iWorker);
