/**
   ...
   \version $Id: TestSchedulerModule2.cc,v 1.12 2006/10/21 17:18:57 wmtan Exp $
   \date 19 May 2005
*/

static const char CVSId[] = "$Id: TestSchedulerModule2.cc,v 1.12 2006/10/21 17:18:57 wmtan Exp $";
