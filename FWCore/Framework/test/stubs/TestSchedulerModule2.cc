/**
   ...
   \version $Id: TestSchedulerModule2.cc,v 1.3 2005/06/09 15:58:10 argiro Exp $
   \date 19 May 2005
*/

static const char CVSId[] = "$Id: TestSchedulerModule2.cc,v 1.3 2005/06/09 15:58:10 argiro Exp $";
