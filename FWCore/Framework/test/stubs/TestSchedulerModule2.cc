/**
   ...
   \version $Id: TestSchedulerModule2.cc,v 1.13 2007/01/12 21:07:59 wmtan Exp $
   \date 19 May 2005
*/

static const char CVSId[] = "$Id: TestSchedulerModule2.cc,v 1.13 2007/01/12 21:07:59 wmtan Exp $";
