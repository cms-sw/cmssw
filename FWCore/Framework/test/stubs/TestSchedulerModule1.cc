/**
   ...
   \version $Id: TestSchedulerModule1.cc,v 1.4 2005/06/14 00:01:01 wmtan Exp $
   \date 19 May 2005
*/
...
static const char CVSId[] = "$Id: TestSchedulerModule1.cc,v 1.4 2005/06/14 00:01:01 wmtan Exp $";
