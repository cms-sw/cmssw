/**
   ...
   \version $Id: TestSchedulerModule1.cc,v 1.2 2005/06/09 08:29:12 argiro Exp $
   \date 19 May 2005
*/
...
static const char CVSId[] = "$Id: TestSchedulerModule1.cc,v 1.2 2005/06/09 08:29:12 argiro Exp $";
