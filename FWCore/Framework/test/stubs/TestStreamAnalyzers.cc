...
class GlobalIntAnalyzer
    : public edm::stream::EDAnalyzer<edm::GlobalCache<Cache>> {
 public:
...
class RunIntAnalyzer : public edm::stream::EDAnalyzer<edm::RunCache<Cache>> {
 public:
  ...
  void analyze(edm::Event const&, edm::EventSetup const&) override {
    if (moduleDescription().processName() !=
        edm::Service<edm::service::TriggerNamesService>()->getProcessName()) {
...
class LumiIntAnalyzer
    : public edm::stream::EDAnalyzer<edm::LuminosityBlockCache<Cache>> {
 public:
  static std::atomic<unsigned int> m_count;
  unsigned int trans_;
  static std::atomic<unsigned int> cvalue_;
...
class RunSummaryIntAnalyzer
    : public edm::stream::EDAnalyzer<edm::RunCache<Cache>,
