  ...
  ~SharedResourcesFilter() {
    if (m_count != trans_) {
      throw cms::Exception("transitions")
          << "SharedResourcesFilter transitions " << m_count
...
class WatchRunsFilter : public edm::one::EDFilter<edm::one::WatchRuns> {
 public:
  ...
  ~WatchRunsFilter() {
    if (m_count != trans_) {
      throw cms::Exception("transitions")
          << "WatchRunsFilter transitions " << m_count
          << " but it was supposed to be " << trans_;
    }
  }
};

class WatchLumiBlocksFilter
    : public edm::one::EDFilter<edm::one::WatchLuminosityBlocks> {
 public:
  ...
  ~WatchLumiBlocksFilter() {
    if (m_count != trans_) {
      throw cms::Exception("transitions")
          << "WatchLumiBlocksFilter transitions " << m_count
          << " but it was supposed to be " << trans_;
    }
  }
};

class BeginRunFilter
    : public edm::one::EDFilter<edm::one::WatchRuns, edm::BeginRunProducer> {
 public:
  ...
  ~BeginRunFilter() {
    if (m_count != trans_) {
      throw cms::Exception("transitions")
          << "BeginRunFilter transitions " << m_count
          << " but it was supposed to be " << trans_;
    }
  }
};
...
class BeginLumiBlockFilter
 ...
 public:
  ...
  ~BeginLumiBlockFilter() {
    if (m_count != trans_) {
      throw cms::Exception("transitions")
          << "BeginLumiBlockFilter transitions " << m_count
          << " but it was supposed to be " << trans_;
    }
  }
};
...
class EndRunFilter
    : public edm::one::EDFilter<edm::one::WatchRuns, edm::EndRunProducer> {
 public:
  ...
  ~EndRunFilter() {
    if (m_count != trans_) {
      throw cms::Exception("transitions")
          << "EndRunFilter transitions " << m_count
          << " but it was supposed to be " << trans_;
    }
  }
};
...
class EndLumiBlockFilter
 ...
 public:
  ...
  ~EndLumiBlockFilter() {
    if (m_count != trans_) {
      throw cms::Exception("transitions")
          << "EndLumiBlockFilter transitions " << m_count
          << " but it was supposed to be " << trans_;
    }
  }
};
