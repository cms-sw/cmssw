...
class GlobalIntProducer
    : public edm::stream::EDProducer<edm::GlobalCache<Cache>> {
 public:
...
class LumiIntProducer
    : public edm::stream::EDProducer<edm::LuminosityBlockCache<Cache>> {
 public:
  static std::atomic<unsigned int> m_count;
  unsigned int trans_;
  static std::atomic<unsigned int> cvalue_;
...
class RunSummaryIntProducer
    : public edm::stream::EDProducer<edm::RunCache<Cache>,
 ...
 public:
  ...
  static std::shared_ptr<UnsafeCache> globalBeginRunSummary(
      edm::Run const&, edm::EventSetup const&, GlobalCache const*) {
    ++m_count;
    gbrs = true;
    gers = false;
    brs = true;
  ...
  static void globalEndRunSummary(edm::Run const&, edm::EventSetup const&,
                                  RunContext const*, UnsafeCache* gCache) {
    ++m_count;
    gbrs = false;
    gers = true;
    if (!ers) {
...
class LumiSummaryIntProducer
 ...
 public:
  ...
  static std::shared_ptr<UnsafeCache> globalBeginLuminosityBlockSummary(
...
class TestBeginRunProducer
    : public edm::stream::EDProducer<edm::RunCache<bool>,
 ...
 public:
  ...
  static std::shared_ptr<bool> globalBeginRun(edm::Run const& iRun,
                                              edm::EventSetup const&,
                                              GlobalCache const*) {
    gbr = true;
    ger = false;
...
class TestEndRunProducer
    : public edm::stream::EDProducer<edm::RunCache<bool>, edm::EndRunProducer> {
 public:
  static std::atomic<unsigned int> m_count;
  unsigned int trans_;
  static std::atomic<unsigned int> cvalue_;
...
class TestBeginLumiBlockProducer
    : public edm::stream::EDProducer<edm::LuminosityBlockCache<bool>,
 ...
 public:
  ...
  static std::shared_ptr<bool> globalBeginLuminosityBlock(
      edm::LuminosityBlock const& iLB, edm::EventSetup const&,
      RunContext const*) {
    gbl = true;
    gel = false;
...
std::atomic<unsigned int> edmtest::stream::TestBeginLumiBlockProducer::m_count{
    0};
...
std::atomic<unsigned int> edmtest::stream::TestBeginLumiBlockProducer::cvalue_{
    0};
