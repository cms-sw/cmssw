...
namespace edmtest {
  namespace stream {
    ...
    public:
      ...
      static std::shared_ptr<UnsafeCache> globalBeginRunSummary(edm::Run const&, edm::EventSetup const&,
                                                                GlobalCache const*) {
        ++m_count;
        gbrs = true;
        gers = false;
    ...
    public:
      ...
      static void globalEndLuminosityBlockSummary(edm::LuminosityBlock const&, edm::EventSetup const&,
                                                  LuminosityBlockContext const*, UnsafeCache* gCache) {
        ++m_count;
        gbls = false;
        gels = true;
        if (!els) {
    ...
    public:
      ...
      static std::shared_ptr<bool> globalBeginLuminosityBlock(edm::LuminosityBlock const& iLB, edm::EventSetup const&,
                                                              RunContext const*) {
        gbl = true;
        gel = false;
        gblp = false;
