...
namespace edmtest {
  namespace global {
    ...
    public:
      ...
      void streamBeginLuminosityBlock(edm::StreamID iID, edm::LuminosityBlock const&,
    ...
    public:
      ...
      void streamBeginLuminosityBlock(edm::StreamID iID, edm::LuminosityBlock const& iLB,
                                      edm::EventSetup const&) const override {
      ...
      void streamEndLuminosityBlock(edm::StreamID iID, edm::LuminosityBlock const& iLB,
                                    edm::EventSetup const&) const override {
        auto lCache = luminosityBlockCache(iLB.index());
        if (lCache->lumi == 0) {
          throw cms::Exception("out of sequence")
    ...
    public:
      ...
      void streamEndRunSummary(edm::StreamID iID, edm::Run const&, edm::EventSetup const&,
    ...
    public:
      ...
      void streamEndLuminosityBlockSummary(edm::StreamID iID, edm::LuminosityBlock const&, edm::EventSetup const&,
                                           UnsafeCache* gCache) const override {
        ++m_count;
        if (gCache->lumi == 0) {
          throw cms::Exception("out of sequence")
      ...
      void globalEndLuminosityBlockSummary(edm::LuminosityBlock const&, edm::EventSetup const&,
                                           UnsafeCache* gCache) const override {
        ++m_count;
        if (gCache->value != cvalue_) {
          throw cms::Exception("cache value")
