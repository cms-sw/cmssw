...
namespace {
  ...
  public:
    ...
    void globalEndLuminosityBlockSummary(edm::LuminosityBlock const&, edm::EventSetup const&, int*) const override {
      ++m_count;
      REQUIRE(m_globalEndLuminosityBlockSummaryCalled == false);
    ...
    void globalEndLuminosityBlockProduce(edm::LuminosityBlock&, edm::EventSetup const&, int const*) const override {
      ++m_count;
      REQUIRE(m_globalEndLuminosityBlockSummaryCalled == true);
  ...
  TEST_CASE("Global producer tests", "[GlobalProducer]") {
    TestFixture fixture;
    ...
    SECTION("basicTest") {
      ...
      fixture.testTransitions(testProd, {Trans::kEvent});
    }
    ...
    SECTION("runTest") {
      ...
      REQUIRE(0 == testProd->m_count);
      fixture.testTransitions(testProd, {Trans::kGlobalBeginRun, Trans::kEvent, Trans::kGlobalEndRun});
    }

    SECTION("runSummaryTest") {
      auto testProd = std::make_shared<RunSummaryProd>();

      REQUIRE(0 == testProd->m_count);
      fixture.testTransitions(testProd,
                              {Trans::kGlobalBeginRun, Trans::kEvent, Trans::kStreamEndRun, Trans::kGlobalEndRun});
    }
    ...
    SECTION("lumiTest") {
      ...
      REQUIRE(0 == testProd->m_count);
      fixture.testTransitions(testProd,
                              {Trans::kGlobalBeginLuminosityBlock, Trans::kEvent, Trans::kGlobalEndLuminosityBlock});
    }

    SECTION("lumiSummaryTest") {
    ...
    SECTION("beginRunProdTest") {
      auto testProd = std::make_shared<BeginRunProd>();

      REQUIRE(0 == testProd->m_count);
      fixture.testTransitions(testProd, {Trans::kGlobalBeginRun, Trans::kEvent});
    }

    SECTION("beginLumiProdTest") {
      auto testProd = std::make_shared<BeginLumiProd>();

      REQUIRE(0 == testProd->m_count);
      fixture.testTransitions(testProd, {Trans::kGlobalBeginLuminosityBlock, Trans::kEvent});
    }

    SECTION("endRunProdTest") {
      auto testProd = std::make_shared<EndRunProd>();

      REQUIRE(0 == testProd->m_count);
      fixture.testTransitions(testProd, {Trans::kGlobalEndRun, Trans::kEvent});
    }

    SECTION("endLumiProdTest") {
      auto testProd = std::make_shared<EndLumiProd>();

      REQUIRE(0 == testProd->m_count);
      fixture.testTransitions(testProd, {Trans::kGlobalEndLuminosityBlock, Trans::kEvent});
    }

    SECTION("endRunSummaryProdTest") {
      auto testProd = std::make_shared<EndRunSummaryProd>();

      REQUIRE(0 == testProd->m_count);
      fixture.testTransitions(
          testProd,
          {Trans::kGlobalEndRun, Trans::kEvent, Trans::kGlobalBeginRun, Trans::kStreamEndRun, Trans::kGlobalEndRun});
    }

    SECTION("endLumiSummaryProdTest") {
