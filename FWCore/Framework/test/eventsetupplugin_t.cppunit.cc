...

{
  ...
  dummyFinderPSet.addParameter("@module_type",
                               std::string("LoadableDummyFinder"));
  ...
  std::set<ComponentDescription> descriptions(
      provider.proxyProviderDescriptions());
  ...
  dummyProviderPSet.addParameter("@module_type",
                                 std::string("LoadableDummyProvider"));
  ...
  dummySourcePSet.addParameter("@module_type",
                               std::string("LoadableDummyESSource"));
