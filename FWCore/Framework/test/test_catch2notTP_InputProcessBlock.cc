...
TEST_CASE("test InputProcessBlock", "[InputProcessBlock]") {
  ...
  SECTION("test type aliases") {
    REQUIRE(std::is_same<edmtest::TestAnalyzerWithInputProcessBlockAbility::InputProcessBlockCache,
    ...
    REQUIRE(std::is_same<edm::stream::impl::choose_unique_ptr<
    ...
    REQUIRE(std::is_same<edmtest::TestFilterWithInputProcessBlockAbility::InputProcessBlockCache,
                         edm::impl::InputProcessBlockCacheImpl<int, unsigned int, int>>());
    ...
    REQUIRE(std::is_same<edmtest::TestProducerWithInputProcessBlockAbility::InputProcessBlockCache,
                         edm::impl::InputProcessBlockCacheImpl<int, unsigned int, int>>());
