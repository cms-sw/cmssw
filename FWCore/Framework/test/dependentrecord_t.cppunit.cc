...
void testdependentrecord::timeAndRunTest()
{
  //test case where we have two providers, one synching on time the other on run/lumi/event
...

   {
     ...
     {
       const edm::EventSetup eventSetup1{  provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 1), edm::Timestamp(1))), 0 };
       long long id1 = eventSetup1.get<DepOn2Record>().cacheIdentifier();
       

       const edm::EventSetup eventSetup2{  provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 1), edm::Timestamp(2))), 0 };
       long long id2 = eventSetup2.get<DepOn2Record>().cacheIdentifier();
       CPPUNIT_ASSERT(id1 == id2);

       const edm::EventSetup eventSetup3{  provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 2), edm::Timestamp(2))), 0 };
       ...
       const edm::EventSetup eventSetup4{  provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 4), edm::Timestamp(7))), 0 };
       ...
       const edm::EventSetup eventSetup5{  provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 7), edm::Timestamp(8))), 0 };
...
void testdependentrecord::getTest()
{
   ...
   provider.add(depProv);
   {
      const edm::EventSetup eventSetup{  provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 1))),0 };
   ...
   {
      const edm::EventSetup eventSetup{  provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 4))),0 };
...
void testdependentrecord::extendIOVTest()
{
   ...
   provider.add(std::shared_ptr<edm::EventSetupRecordIntervalFinder>(dummy2Finder));
   {
      ...
      {
         const edm::EventSetup eventSetup{  provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 5), edm::Timestamp(2))),0 };
      ...
      dummyFinder->setInterval(edm::ValidityInterval{startSyncValue, 
                                                     edm::IOVSyncValue{edm::EventID{1, 1, 7}}});
      {
         const edm::EventSetup eventSetup{  provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 6), edm::Timestamp(7))),0 };
         unsigned long long id = eventSetup.get<DepOn2Record>().cacheIdentifier();
         CPPUNIT_ASSERT(id1 == id);
         CPPUNIT_ASSERT(id1 == eventSetup.get<DummyRecord>().cacheIdentifier());
         CPPUNIT_ASSERT(id1 == eventSetup.get<Dummy2Record>().cacheIdentifier());
      ...
      {
         const edm::EventSetup eventSetup{  provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 7), edm::Timestamp(7))),0 };
         unsigned long long id = eventSetup.get<DepOn2Record>().cacheIdentifier();
         CPPUNIT_ASSERT(id1 == id);
         CPPUNIT_ASSERT(id1 == eventSetup.get<DummyRecord>().cacheIdentifier());
         CPPUNIT_ASSERT(id1 == eventSetup.get<Dummy2Record>().cacheIdentifier());
      ...
      dummyFinder->setInterval(edm::ValidityInterval{startSyncValue, 
         edm::IOVSyncValue{edm::EventID{1, 1, 8}}});
      {
         const edm::EventSetup eventSetup{  provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 8), edm::Timestamp(7))),0 };
         unsigned long long id = eventSetup.get<DepOn2Record>().cacheIdentifier();
         CPPUNIT_ASSERT(id1 == id);
         CPPUNIT_ASSERT(id1 == eventSetup.get<DummyRecord>().cacheIdentifier());
         CPPUNIT_ASSERT(id1 == eventSetup.get<Dummy2Record>().cacheIdentifier());
      ...
      dummyFinder->setInterval(edm::ValidityInterval{edm::IOVSyncValue{edm::EventID{1, 1, 9}}, 
                                                     edm::IOVSyncValue{edm::EventID{1, 1, 9}}});
      {
         const edm::EventSetup eventSetup{  provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 9), edm::Timestamp(7))),0 };
         unsigned long long id = eventSetup.get<DepOn2Record>().cacheIdentifier();
      ...
      {
         const edm::EventSetup eventSetup{  provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 10), edm::Timestamp(7))),0 };
         unsigned long long id = eventSetup.get<DepOn2Record>().cacheIdentifier();
