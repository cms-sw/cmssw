...
namespace {
  ...
  void testTransition(std::shared_ptr<T> iMod, edm::Worker* iWorker, edm::OutputModuleCommunicator* iComm,
                      testOneOutputModule::Trans iTrans, testOneOutputModule::Expectations const& iExpect,
...
void testOneOutputModule::runTest() {
  ...
  testTransitions(testProd,
                  {Trans::kGlobalBeginRun, Trans::kEvent, Trans::kGlobalEndLuminosityBlock, Trans::kGlobalEndRun,
                   Trans::kGlobalEndRun});
}
