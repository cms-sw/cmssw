...
// Class  :     DummyProvider
//
/**\class DummyProvider DummyProvider.h
 FWCore/Framework/interface/DummyProvider.h
...
class WorkingDummyProxy
    : public edm::eventsetup::DataProxyTemplate<DummyRecord, DummyData> {
 public:
...
class DummyProxyProvider : public edm::eventsetup::DataProxyProvider {
 ...
 protected:
  void registerProxies(const eventsetup::EventSetupRecordKey&,
    ...
    std::shared_ptr<WorkingDummyProxy> pProxy =
        std::make_shared<WorkingDummyProxy>(&dummy_);
