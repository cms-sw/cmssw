...
from ZoomableWidget import ZoomableWidget
from Exceptions import *
from BasicDataAccessor import BasicDataAccessor

import ROOT
import pxl
from array import array

class RootCanvasView(AbstractView, ZoomableWidget):
  ...
  def _plotscript(self, canvas, object):
      ...
      if isinstance(object, pxl.base.BasicContainer):
        ...
        for x in self.p:
          x.SetMarkerColor(ROOT.kGreen + 1)
          x.Draw()
  ...
  def createGraph(self, eventview):
      ...
      print "Display " + str(len(particles)) + " Particles"
      if (len(particles) > 0):
        etas = []
        phis = []
