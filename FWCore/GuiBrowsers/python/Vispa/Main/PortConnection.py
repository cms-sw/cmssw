...
class PointToPointConnection(ZoomableWidget):
    ...
    def routeIsValid(self):
        try:
            if type(self._route).__name__ != 'list':
                print "PointToPointConnection.routeIsValid() - ERROR: 'route' does not contain a list an so is not a valid route."
                return False
        except:
            print "PointToPointConnection.routeIsValid() - ERROR: 'route' is not valid."
            return False
        return True
    ...
    def getPointByDistance(self, start, distance, direction):
        ...
        if direction == self.ConnectionDirection.DOWN:
            ...
            print "PointToPointConnection.getPointByDistance() - ERROR: Unknown ConnectionDirection."
    ...
    def nextPointByDistance(self, route, distance, direction):
        ...
        if len(route) < 1:
            print "PointToPointConnection.nextPointByDistance() - ERROR: Can not calculate next point for empty route."
            return
    ...
    def nextPointByTarget(self, route, target, orientation):
        ...
        """
        if len(route) < 1:
            print "PointToPointConnection.nextPointByTarget() - ERROR: Can not calculate next point for empty route."
            return
        ...
        if orientation == self.DrawOrientation.HORIZONTAL:
            ...
            print "PointToPointConnection.nextPointByTarget() - ERROR: Unknown DrwaOrientation."
    ...
    def calculateRoute(self):
        ...
        if throughCenter:
            ...
            if rowKind:
                ...
                print "PointToPointConnection.calculateRoute() - ERROR: Sorry connections going through the center have to be either rowKind or columKind."
...
#        print "\n\n"
    ...
    def drawStraightLine(self, painter, firstP, secondP):
        ...
        pen = QPen(self.FILL_COLOR2, 2 * halfthick)
        painter.setPen(pen)
