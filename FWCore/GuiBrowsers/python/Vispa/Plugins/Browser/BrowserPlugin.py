...
class BrowserPlugin(VispaPlugin):
    ...
    def _fillMenu(self):
        ...
        self._boxContentAction = self.application().createAction('&Set box content...', self._showBoxContentDialog, "Ctrl+B")
        ...
        self._zoomAction = self.application().createAction('&Zoom...', self.zoomDialog, "Ctrl+Z")
