...
patTestDir="$CMSSW_BASE/src/PhysicsTools/PatAlgos/test"
standardConfigDir=os.path.abspath(os.path.expandvars(patTestDir))
if not os.path.exists(standardConfigDir):
    patTestDir="$CMSSW_RELEASE_BASE/src/PhysicsTools/PatAlgos/test"
    standardConfigDir=os.path.abspath(os.path.expandvars(patTestDir))
...
class ImportTool(ConfigToolBase):
    ...
    def dumpPython(self):
        ...
        if os.path.abspath(os.path.dirname(self._parameters['filename'].value))==standardConfigDir:
            dump += "import sys\n"
            dump += "import os.path\n"
