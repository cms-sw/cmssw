...
def customise(process):
    print "!!!You are using the SUPPORTED Flat version of the Phase2 Tracker Only geometry !!!"
...
def customise_Sim(process):
    ...
    process.simulation_step.remove(process.g4SimHits.MuonSD)
    process.simulation_step.remove(process.g4SimHits.CaloSD)
    process.simulation_step.remove(process.g4SimHits.CaloResponse)
    process.simulation_step.remove(process.g4SimHits.ECalSD)
    process.simulation_step.remove(process.g4SimHits.HCalSD)
    process.simulation_step.remove(process.g4SimHits.CaloTrkProcessing)
    process.simulation_step.remove(process.g4SimHits.HFShower)
    process.simulation_step.remove(process.g4SimHits.HFShowerLibrary)
    process.simulation_step.remove(process.g4SimHits.HFShowerPMT)
    process.simulation_step.remove(process.g4SimHits.HFShowerStraightBundle)
    process.simulation_step.remove(process.g4SimHits.HFShowerConicalBundle)
    process.simulation_step.remove(process.g4SimHits.HFGflash)
    process.simulation_step.remove(process.g4SimHits.CastorSD)
    process.simulation_step.remove(process.g4SimHits.CastorShowerLibrary)
    process.simulation_step.remove(process.g4SimHits.BHMSD)
    process.simulation_step.remove(process.g4SimHits.FastTimerSD)
    process.simulation_step.remove(process.g4SimHits.HGCSD)
    process.simulation_step.remove(process.g4SimHits.TotemSD) 
    process.simulation_step.remove(process.g4SimHits.ZdcSD)
    process.simulation_step.remove(process.g4SimHits.ZdcShowerLibrary)
    process.simulation_step.remove(process.g4SimHits.FP420SD)
    process.simulation_step.remove(process.g4SimHits.BscSD)
    process.simulation_step.remove(process.g4SimHits.PltSD)
    process.simulation_step.remove(process.g4SimHits.Bcm1fSD)
    process.simulation_step.remove(process.g4SimHits.HcalTB02SD)
    process.simulation_step.remove(process.g4SimHits.EcalTBH4BeamSD) 
    process.simulation_step.remove(process.g4SimHits.HcalTB06BeamSD)
...
def customise_Digi(process):
    ...
    process.digitisation_step.remove(process.mix.mixObjects.mixCH)
    process.digitisation_step.remove(process.mix.mixObjects.mixSH)
    ...
    process.digitisation_step.remove(process.mix.digitizers.ecal)
    process.digitisation_step.remove(process.mix.digitizers.hcal)
    process.digitisation_step.remove(process.mix.digitizers.castor)
