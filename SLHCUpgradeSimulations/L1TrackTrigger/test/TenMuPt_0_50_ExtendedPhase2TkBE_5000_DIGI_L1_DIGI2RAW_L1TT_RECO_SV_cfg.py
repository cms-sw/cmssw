...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:PGUN_612.root')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('TenMuPt_0_50_ExtendedPhase2TkBE_5000_TrackTrigger nevts:-1'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TenMuPt_0_50_ExtendedPhase2TkBE_5000_DIGI_L1_DIGI2RAW_L1TT_RECO.root'),
