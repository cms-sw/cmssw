...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:TenMuPt_0_50_ExtendedPhase2TkLB4PS22S_5000_GEN_SIM.root')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('TenMuPt_0_50_ExtendedPhase2TkLB4PS22S_5000_TrackTrigger nevts:-1'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TenMuPt_0_50_ExtendedPhase2TkLB4PS22S_5000_DIGI_L1_DIGI2RAW_L1TT_RECO.root'),
...
from SLHCUpgradeSimulations.Configuration.phase2TkCustoms_LB_4LPS_2L2S import customise,l1EventContent 
