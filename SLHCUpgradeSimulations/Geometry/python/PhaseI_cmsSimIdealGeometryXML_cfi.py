...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('SLHCUpgradeSimulations/Geometry/data/PhaseI/materials.xml', 
        ...
        'SLHCUpgradeSimulations/Geometry/data/PhaseI/pixfwdDisk.xml', 
        'SLHCUpgradeSimulations/Geometry/data/PhaseI/pixfwdInnerDisk.xml',
        'SLHCUpgradeSimulations/Geometry/data/PhaseI/pixfwdOuterDisk.xml',
        'SLHCUpgradeSimulations/Geometry/data/PhaseI/pixfwdblade.xml',
