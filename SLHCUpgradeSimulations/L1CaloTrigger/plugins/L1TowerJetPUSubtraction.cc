// -*- C++ -*-
//
// Package:    L1TowerJetPUSubtraction
// Class:      L1TowerJetPUSubtraction
// 
/**\class CalibTowerJetCollection L1TowerJetPUSubtraction.cc MVACALIB/L1TowerJetPUSubtraction/src/L1TowerJetPUSubtraction.cc
...
// $Id: L1TowerJetPUSubtraction.cc,v 1.4 2013/03/20 10:14:23 rlucas Exp $
//
//
...
class L1TowerJetPUSubtraction : public edm::EDProducer {
   public:
      explicit L1TowerJetPUSubtraction(const edm::ParameterSet&);
      ~L1TowerJetPUSubtraction();
...
L1TowerJetPUSubtraction::L1TowerJetPUSubtraction(const edm::ParameterSet& iConfig):
conf_(iConfig)
{
...
L1TowerJetPUSubtraction::~L1TowerJetPUSubtraction()
{
...
void
L1TowerJetPUSubtraction::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void 
L1TowerJetPUSubtraction::beginJob()
{
...
void 
L1TowerJetPUSubtraction::endJob() {
}

// ------------ method called when starting to processes a run  ------------
void 
L1TowerJetPUSubtraction::beginRun(edm::Run&, edm::EventSetup const&)
{    
...
void 
L1TowerJetPUSubtraction::endRun(edm::Run&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
L1TowerJetPUSubtraction::beginLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
L1TowerJetPUSubtraction::endLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
L1TowerJetPUSubtraction::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
// member functions
//
double L1TowerJetPUSubtraction::Median( vector<double> aVec){
...
double L1TowerJetPUSubtraction::get_rho(double L1_rho)
{
...
DEFINE_FWK_MODULE(L1TowerJetPUSubtraction);
