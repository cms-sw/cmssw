...

{
  ...
  // resolution
  make1DPlot("Resolution/hSResid+11",f1,"Expected Position from Fit - Reconstructed, ME+1/1", 1110,"Resolution_hSResid+11.png");
  ...
  // rechit local x error
  make1DPlot("recHits/hRHxerr+11",f1,"Estimated Error on Local X (ME+1/1)", 1110,"recHits_hRHxerr+11.png");
  make1DPlot("recHits/hRHxerr+12",f1,"Estimated Error on Local X (ME+1/2)", 1110,"recHits_hRHxerr+12.png");
  make1DPlot("recHits/hRHxerr+13",f1,"Estimated Error on Local X (ME+1/3)", 1110,"recHits_hRHxerr+13.png");
  make1DPlot("recHits/hRHxerr+21",f1,"Estimated Error on Local X (ME+2/1)", 1110,"recHits_hRHxerr+21.png");
  make1DPlot("recHits/hRHxerr+22",f1,"Estimated Error on Local X (ME+2/2)", 1110,"recHits_hRHxerr+22.png");
  make1DPlot("recHits/hRHxerr+31",f1,"Estimated Error on Local X (ME+3/1)", 1110,"recHits_hRHxerr+31.png");
  make1DPlot("recHits/hRHxerr+32",f1,"Estimated Error on Local X (ME+3/2)", 1110,"recHits_hRHxerr+32.png");
  make1DPlot("recHits/hRHxerr+41",f1,"Estimated Error on Local X (ME+4/1)", 1110,"recHits_hRHxerr+41.png");
  make1DPlot("recHits/hRHxerr-11",f1,"Estimated Error on Local X (ME-1/1)", 1110,"recHits_hRHxerr-11.png");
  make1DPlot("recHits/hRHxerr-12",f1,"Estimated Error on Local X (ME-1/2)", 1110,"recHits_hRHxerr-12.png");
  make1DPlot("recHits/hRHxerr-13",f1,"Estimated Error on Local X (ME-1/3)", 1110,"recHits_hRHxerr-13.png");
  make1DPlot("recHits/hRHxerr-21",f1,"Estimated Error on Local X (ME-2/1)", 1110,"recHits_hRHxerr-21.png");
  ...
  make1DPlot("recHits/hRHstpos+11",f1,"Strip Position (ME+1/1)", 1110,"recHits_hRHstpos+11.png");
  ...
  // rechit strip error
  make1DPlot("recHits/hRHsterr+11",f1,"Estimated Error on Strip Position (ME+1/1)", 1110,"recHits_hRHsterr+11.png");
  make1DPlot("recHits/hRHsterr+12",f1,"Estimated Error on Strip Position (ME+1/2)", 1110,"recHits_hRHsterr+12.png");
  make1DPlot("recHits/hRHsterr+13",f1,"Estimated Error on Strip Position (ME+1/3)", 1110,"recHits_hRHsterr+13.png");
  make1DPlot("recHits/hRHsterr+21",f1,"Estimated Error on Strip Position (ME+2/1)", 1110,"recHits_hRHsterr+21.png");
  make1DPlot("recHits/hRHsterr+22",f1,"Estimated Error on Strip Position (ME+2/2)", 1110,"recHits_hRHsterr+22.png");
  make1DPlot("recHits/hRHsterr+31",f1,"Estimated Error on Strip Position (ME+3/1)", 1110,"recHits_hRHsterr+31.png");
  make1DPlot("recHits/hRHsterr+32",f1,"Estimated Error on Strip Position (ME+3/2)", 1110,"recHits_hRHsterr+32.png");
  make1DPlot("recHits/hRHsterr+41",f1,"Estimated Error on Strip Position (ME+4/1)", 1110,"recHits_hRHsterr+41.png");
  make1DPlot("recHits/hRHsterr-11",f1,"Estimated Error on Strip Position (ME-1/1)", 1110,"recHits_hRHsterr-11.png");
  make1DPlot("recHits/hRHsterr-12",f1,"Estimated Error on Strip Position (ME-1/2)", 1110,"recHits_hRHsterr-12.png");
  make1DPlot("recHits/hRHsterr-13",f1,"Estimated Error on Strip Position (ME-1/3)", 1110,"recHits_hRHsterr-13.png");
  make1DPlot("recHits/hRHsterr-21",f1,"Estimated Error on Strip Position (ME-2/1)", 1110,"recHits_hRHsterr-21.png");
  ...
  // rechit timing
  make1DPlot("recHits/hRHTiming+11",f1,"RecHit Timing ME+1/1", 1110,"recHits_hRHTiming+11.png");
  ...
  // rechit charge
  make1DPlot("recHits/hRHSumQ+11",f1,"Sum 3x3 RecHit Charge ME+1/1", 1110,"recHits_hRHSumQ+11.png");
  ...
  make1DPlot("recHits/hRHRatioQ+11",f1,"Charge Ratio (Ql_Qr)/Qt ME+1/1", 1110,"recHits_hRHRatioQ+11.png");
  ...
  //hits on a segment
  make1DPlot("Segments/hSnHits+11",f1,"N Hits on Segments ME+1/1", 1110,"Segments_hSnHits+11.png");
  ...
  // segment chi2
  make1DPlot("Segments/hSChiSq+11",f1,"Segment Chi2/ndof ME+1/1", 1110,"Segments_hSChiSq+11.png");
  ...
  // segment chi2 probability
  make1DPlot("Segments/hSChiSqProb+11",f1,"Segment Chi2 Probability ME+1/1", 1110,"Segments_hSChiSqProb+11.png");
  make1DPlot("Segments/hSChiSqProb+12",f1,"Segment Chi2 Probability ME+1/2", 1110,"Segments_hSChiSqProb+12.png");
  make1DPlot("Segments/hSChiSqProb+13",f1,"Segment Chi2 Probability ME+1/3", 1110,"Segments_hSChiSqProb+13.png");
  make1DPlot("Segments/hSChiSqProb+21",f1,"Segment Chi2 Probability ME+2/1", 1110,"Segments_hSChiSqProb+21.png");
  make1DPlot("Segments/hSChiSqProb+22",f1,"Segment Chi2 Probability ME+2/2", 1110,"Segments_hSChiSqProb+22.png");
  make1DPlot("Segments/hSChiSqProb+31",f1,"Segment Chi2 Probability ME+3/1", 1110,"Segments_hSChiSqProb+31.png");
  make1DPlot("Segments/hSChiSqProb+32",f1,"Segment Chi2 Probability ME+3/2", 1110,"Segments_hSChiSqProb+32.png");
  make1DPlot("Segments/hSChiSqProb+41",f1,"Segment Chi2 Probability ME+4/1", 1110,"Segments_hSChiSqProb+41.png");
  make1DPlot("Segments/hSChiSqProb-11",f1,"Segment Chi2 Probability ME-1/1", 1110,"Segments_hSChiSqProb-11.png");
  make1DPlot("Segments/hSChiSqProb-12",f1,"Segment Chi2 Probability ME-1/2", 1110,"Segments_hSChiSqProb-12.png");
  make1DPlot("Segments/hSChiSqProb-13",f1,"Segment Chi2 Probability ME-1/3", 1110,"Segments_hSChiSqProb-13.png");
  make1DPlot("Segments/hSChiSqProb-21",f1,"Segment Chi2 Probability ME-2/1", 1110,"Segments_hSChiSqProb-21.png");
