...
public:
  typedef std::pair<const ME0EtaPartition*, std::map<uint32_t, const ME0EtaPartition*> >ME0Ensamble; 
    ...
    */
    virtual std::vector<ME0Segment> run(ME0Ensamble ensamble, const std::vector<const ME0RecHit*>& rechits) = 0;  
