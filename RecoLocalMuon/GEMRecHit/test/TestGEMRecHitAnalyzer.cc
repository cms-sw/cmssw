...

{
  ...
  BX_RecHits_GE1in_Plus = std::make_unique<TH1F>("BX_RecHits_GE1in_Plus", "BX_RecHits_GE1in_Plus", n_bx, n1_bx, n2_bx);
  ...
  ST_RecHits_GE1in_Plus = std::make_unique<TH1F>("ST_RecHits_GE1in_Plus", "ST_RecHits_GE1in_Plus", n_st, n1_st, n2_st);
  ...
  CL_RecHits_GE1in_Plus = std::make_unique<TH1F>("CL_RecHits_GE1in_Plus", "CL_RecHits_GE1in_Plus", n_cl, n1_cl, n2_cl);
