...
# with command line options: SingleMuPt100_cfi -s GEN,SIM,DIGI --conditions auto:upgradePLS3 --datatier GEN-SIM-DIGI --geometry Extended2023 --eventcontent FEVTDEBUGHLT --era Run2_25ns --customise=SimMuon/GEMDigitizer/customizeGEMDigi.customize_digi_addGEM_muon_only,SLHCUpgradeSimulations/Configuration/fixMissingUpgradeGTPayloads.fixCSCAlignmentConditions,SLHCUpgradeSimulations/Configuration/fixMissingUpgradeGTPayloads.fixDTAlignmentConditions,SLHCUpgradeSimulations/Configuration/fixMissingUpgradeGTPayloads.fixRPCConditions,SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --magField 38T_PostLS1 -n 100 --no_exec --fileout out_digi.root --python filename SingleMuPt100 cfi GEM-SIM-DIGI Extended2023 cfg.py
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/tmp/archie/out_digi_Pt200_clean.root'),
