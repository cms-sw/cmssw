...
void SiGaussianTailNoiseAdder::addNoiseVR(
    std::vector<float> &in, std::vector<float> &noiseRMS,
    CLHEP::HepRandomEngine *engine) const {
  // Add noise
...
void SiGaussianTailNoiseAdder::addCMNoise(
    std::vector<float> &in, float cmnRMS, std::vector<bool> &badChannels,
    CLHEP::HepRandomEngine *engine) const {
...
void SiGaussianTailNoiseAdder::addBaselineShift(
    std::vector<float> &in, std::vector<bool> &badChannels) const {
