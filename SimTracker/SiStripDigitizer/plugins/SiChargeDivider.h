...
/**
 * Base class for the division of a Geant energy deposit in smaller elementary
 * charges inside the silicon
 */
class SiChargeDivider {
public:
  typedef std::vector<EnergyDepositUnit> ionization_type;
  virtual ~SiChargeDivider() {}
  virtual ionization_type divide(const PSimHit *, const LocalVector &, double,
