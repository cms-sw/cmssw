...
/**
 * Concrete implementation of SiChargeCollectionDrifter. Drifts the charges
 * linearly. Drift each energy deposits in the bulk to the surface. The
 * resulting position depends on the Lorentz angle, and a sigma is computed that
...
public:
  ...
  drift(const SiChargeCollectionDrifter::ionization_type &, const LocalVector &,
        double, double) override;

private:
  SignalPoint drift(const EnergyDepositUnit &, const LocalVector &, double,
                    double);
