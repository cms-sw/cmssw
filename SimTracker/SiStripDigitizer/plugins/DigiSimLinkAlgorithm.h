...
public:
  ...
  typedef DigiSimLinkPileUpSignals::HitCounterToDigisMapType
  ...
  void run(edm::DetSet<SiStripDigi> &, edm::DetSet<SiStripRawDigi> &,
           ...
           edm::ESHandle<SiStripBadStrip> &, const TrackerTopology *tTopo,
...
private:
  ...
  void push_link(const DigitalVecType &, const HitToDigisMapType &,
                 const HitCounterToDigisMapType &, const std::vector<float> &,
                 unsigned int);

  void push_link_raw(const DigitalRawVecType &, const HitToDigisMapType &,
