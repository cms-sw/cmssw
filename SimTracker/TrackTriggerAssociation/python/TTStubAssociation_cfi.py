...
TTStubAssociatorFromPhase2TrackerDigis = cms.EDProducer("TTStubAssociator_Phase2TrackerDigi_",
    ...
    TTClusterTruth = cms.VInputTag( cms.InputTag("TTClusterAssociatorFromPhase2TrackerDigis", "ClusterAccepted"),
                                    cms.InputTag("TTClusterAssociatorFromPhase2TrackerDigis", "ClusterInclusive"),
