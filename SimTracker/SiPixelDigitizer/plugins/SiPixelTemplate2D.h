...
#include "SimTracker/SiPixelDigitizer/plugins/SiPixelTemplateDefs.h"
#else
...
public:
   ...
   void sideload(SiPixelTemplateEntry2D* entry, int iDtype, float locBx, float locBz, float lorwdx, float lorwdy, float q50, float fbin[3], float xsize, float ysize, float zsize);
   ...
   bool xytempl(float xhit, float yhit, bool ydouble[BYM2], bool xdouble[BXM2], float template2d[BXM2][BYM2], bool dervatives, float dpdx2d[2][BXM2][BYM2], float& QTemplate);
   
   // Overload for backward compatibility
   
   bool xytempl(float xhit, float yhit, bool ydouble[BYM2], bool xdouble[BXM2], float template2d[BXM2][BYM2]);
   
   // Overload for backward compatibility with re-weighting code
   
   bool xytempl(int id, float cotalpha, float cotbeta, float xhit, float yhit, std::vector<bool>& ydouble, std::vector<bool>& xdouble, float template2d[BXM2][BYM2]);
