...
public:
  ...
  BoundingBox(const double& min_r,const double& max_r,
  ...
  inline bool inside(const double& r,const double& z) const { return (r >= r_min and r <= r_max and z >= z_min and z <= z_max); };
