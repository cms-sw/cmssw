...
process.p = cms.Path(process.playback * process.svTagInfoProxy * process.trackAssociatorByHits * process.vertexAssociatorSequence * process.vertexHistoryAnalyzer)
