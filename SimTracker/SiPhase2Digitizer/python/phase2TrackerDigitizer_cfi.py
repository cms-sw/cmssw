...
#Pixel Digitizer Algorithm
    PixelDigitizerAlgorithm = cms.PSet(
      ...
      Phase2ReadoutMode = cms.int32(-1), # Flag to decide Readout Mode :Digital(0) or Analog(+-1,+-2,+-3,+-4) with different slopes with(+)/without(-) threshold reduction
...
#Pixel in PS Module
    PSPDigitizerAlgorithm = cms.PSet(
      ...
      Phase2ReadoutMode = cms.int32(0), # Digital(0) / Analog(+-1,+-2,+-3,+-4) with different slope parameters and with(+)/without(-) threshold reduction
