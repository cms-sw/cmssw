...
#Pixel Digitizer Algorithm
    PixelDigitizerAlgorithm = cms.PSet(
      ...
      InterstripCoupling = cms.double(0.0),	#D.B.
      Odd_row_interchannelCoupling_next_row = cms.double(0.),	#D.B.
      Even_row_interchannelCoupling_next_row = cms.double(0.),	#D.B.
      Odd_column_interchannelCoupling_next_column = cms.double(0.),	#D.B.
      Even_column_interchannelCoupling_next_column = cms.double(0.),	#D.B.
