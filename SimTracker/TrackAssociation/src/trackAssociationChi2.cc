...
double trackAssociationChi2(
  ...
  return trackAssociationChi2(rParameters, recoTrackCovMatrix, momAtVtx, vert,
                              charge, magfield, bs);
}
...
double trackAssociationChi2(const reco::TrackBase &track,
  ...
  return trackAssociationChi2(track.parameters(), cov, trackingParticle,
                              magfield, bs);
}
} // namespace track_associator
