...
class HcalLutManager{
 public:
  ...
  std::map<int, shared_ptr<LutXml> > getLinearizationLutXmlFromCoder( string _tag, bool split_by_crate = true );
  ...
  int createAllLutXmlFilesFromCoder( string _tag, bool split_by_crate = true );
