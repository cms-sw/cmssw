...
#
#
# read list of tags/iovs from
input_pool_connect_string = "sqlite_file:test_o2o.db"
#
# where to write changes
output_pool_connect_string = "sqlite_file:test_o2o.db"
#
# pool log DB file
pool_logconnect = "sqlite_file:log.db"
...
def get_iovs(tag, input_pool_connect_string, mode):
    ...
    if mode == "online" or mode == "online_dropbox":
        try:
            ...
            print "Cannot the IOV update list for tag", tag+", exiting..."
            sys.exit()
