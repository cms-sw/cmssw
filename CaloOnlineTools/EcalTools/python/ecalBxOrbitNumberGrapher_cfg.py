...
process = cms.Process("ECALBXORBITGRAPH")
...
process.MessageLogger = cms.Service("MessageLogger",
    ...
    categories = cms.untracked.vstring('EcalBxOrbitNumberGrapher'),
...
process.p = cms.Path(process.ecalEBunpacker*process.ecalUncalibHit*process.ecalRecHit*process.ecalBxOrbitNumberGrapher)
