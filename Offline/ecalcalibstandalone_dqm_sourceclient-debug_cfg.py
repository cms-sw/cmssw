...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2015A/TestEnablesEcalHcal/RAW/v1/000/250/932/00000/365696E1-A023-E511-B702-02163E0135D7.root')
)
...
process.ecalLaserLedPath = cms.Path(process.ecalPreRecoSequence)
process.ecalTestPulsePath = cms.Path(process.ecalPreRecoSequence)
