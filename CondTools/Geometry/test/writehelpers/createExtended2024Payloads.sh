...
# big XML file for the Extended2024 scenario.
cmsRun geometryExtended2024_xmlwriter.py || die 'failed geometryExtended2024_xmlwriter.py' $?
...
cmsRun geometryExtended2024_writer.py --tag=${mytag} || die 'failed geometryExtended2024_writer.py' $?
...
#sed -i '{s/Extended2024/Extended2024ZeroMaterial/g}' geometryExtended2024_xmlwriter.py
#sed -i '{s/\/ge/\/gez/g}' geometryExtended2024_xmlwriter.py
cmsRun geometryExtended2024_xmlwriter.py --geom=Extended2024ZeroMaterial --out=gez || die 'failed geometryExtended2024_xmlwriter.py Extended2024ZeroMaterial' $?

#sed -i '{s/Extended2024ZeroMaterial/Extended2024FlatMinus05Percent/g}' geometryExtended2024_xmlwriter.py
#sed -i '{s/\/gez/\/geFM05/g}' geometryExtended2024_xmlwriter.py
cmsRun geometryExtended2024_xmlwriter.py --geom=Extended2024FlatMinus05Percent --out=geFM05 || die 'failed geometryExtended2024_xmlwriter.py Extended2024FlatMinus05Percent' $?

#sed -i '{s/Extended2024FlatMinus05Percent/Extended2024FlatMinus10Percent/g}' geometryExtended2024_xmlwriter.py
#sed -i '{s/\/geFM05/\/geFM10/g}' geometryExtended2024_xmlwriter.py
cmsRun geometryExtended2024_xmlwriter.py --geom=Extended2024FlatMinus10Percent --out=geFM10 || die 'failed geometryExtended2024_xmlwriter.py' $?

#sed -i '{s/Extended2024FlatMinus10Percent/Extended2024FlatPlus05Percent/g}' geometryExtended2024_xmlwriter.py
#sed -i '{s/\/geFM10/\/geFP05/g}' geometryExtended2024_xmlwriter.py
cmsRun geometryExtended2024_xmlwriter.py --geom=Extended2024FlatPlus05Percent --out=geFP05 || die 'failed geometryExtended2024_xmlwriter.py Extended2024FlatPlus05Percent' $?

#sed -i '{s/Extended2024FlatPlus05Percent/Extended2024FlatPlus10Percent/g}' geometryExtended2024_xmlwriter.py
#sed -i '{s/\/geFP05/\/geFP10/g}' geometryExtended2024_xmlwriter.py
cmsRun geometryExtended2024_xmlwriter.py --geom=Extended2024FlatPlus10Percent --out=geFP10 || die 'failed geometryExtended2024_xmlwriter.py' $?
