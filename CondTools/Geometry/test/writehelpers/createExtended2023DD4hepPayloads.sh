...
cmsRun geometryExtended2023DD4hep_xmlwriter.py --geom=ExtendedGeometry2023FlatPlus05Percent --out=geFP10 || die 'failed geometryExtended2023DD4hep_xmlwriter.py' $?
