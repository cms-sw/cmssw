...
conddb -f sqlite_file:myfile.db -c sqlite_file:GeometryFileExtendedRun4D128.db -t XMLFILE_Geometry_TagXX_ExtendedRun4D128_mc -i XMLFILE_Geometry_TagXX_ExtendedRun4D128_mc
