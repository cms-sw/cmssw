...
# big XML file for the Extended2026 scenario.
cmsRun geometryExtended2026_xmlwriter.py || die 'failed geometryExtended2026_xmlwriter.py' $?
...
cmsRun geometryExtended2026_writer.py --tag=${mytag} || die 'failed geometryExtended2026_writer.py' $?
