...
conddb_import -f sqlite_file:myfile.db -c sqlite_file:GeometryFileExtended2021.db -t XMLFILE_Geometry_TagXX_Extended2021_mc -i XMLFILE_Geometry_TagXX_Extended2021_mc
