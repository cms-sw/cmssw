...
conddb_import -f sqlite_file:myfile.db -c sqlite_file:GeometryFileExtendedTest2014.db -t XMLFILE_Geometry_TagXX_ExtendedTest2014_mc -i XMLFILE_Geometry_TagXX_ExtendedTest2014_mc
