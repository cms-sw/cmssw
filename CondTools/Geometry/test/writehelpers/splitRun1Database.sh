...
cmscond_export_iov -s sqlite_file:myfile.db -d sqlite_file:GeometryFileExtendedTest2014.db -D CondFormatsGeometryObjects  -t XMLFILE_Geometry_TagXX_ExtendedTest2014_mc -l sqlite_file:localpopconlog.db
