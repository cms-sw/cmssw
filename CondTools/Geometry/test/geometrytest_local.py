...
process.GlobalTag.toGet = cms.VPSet(
    cms.PSet(record = cms.string("PCastorRcd"),
             tag = cms.string("CASTORRECO_Geometry_120DD4hepV4X"),
             connect = cms.string("sqlite_file:myfile.db")
             ),
    cms.PSet(record = cms.string("PZdcRcd"),
             tag = cms.string("ZDCRECO_Geometry_120DD4hepV4X"),
             connect = cms.string("sqlite_file:myfile.db")
             ),
    cms.PSet(record = cms.string("PCaloTowerRcd"),
             tag = cms.string("CTRECO_Geometry_120DD4hepV4X"),
             connect = cms.string("sqlite_file:myfile.db")
             ),
    cms.PSet(record = cms.string("PEcalEndcapRcd"),
             tag = cms.string("EERECO_Geometry_120DD4hepV4X"),
             connect = cms.string("sqlite_file:myfile.db")
             ),
    cms.PSet(record = cms.string("CSCRecoDigiParametersRcd"),
             tag = cms.string("CSCRECODIGI_Geometry_120DD4hepV4X"),
             connect = cms.string("sqlite_file:myfile.db")
             ),
    cms.PSet(record = cms.string("CSCRecoGeometryRcd"),
             tag = cms.string("CSCRECO_Geometry_120DD4hepV4X"),
             connect = cms.string("sqlite_file:myfile.db")
             ),
    cms.PSet(record = cms.string("PEcalBarrelRcd"),
             tag = cms.string("EBRECO_Geometry_120DD4hepV4X"),
             connect = cms.string("sqlite_file:myfile.db")
             ),
    cms.PSet(record = cms.string("RPCRecoGeometryRcd"),
             tag = cms.string("RPCRECO_Geometry_120DD4hepV4X"),
             connect = cms.string("sqlite_file:myfile.db")
             ),
    cms.PSet(record = cms.string("DTRecoGeometryRcd"),
             tag = cms.string("DTRECO_Geometry_120DD4hepV4X"),
             connect = cms.string("sqlite_file:myfile.db")
             ),
    cms.PSet(record = cms.string("PEcalPreshowerRcd"),
             tag = cms.string("EPRECO_Geometry_120DD4hepV4X"),
             connect = cms.string("sqlite_file:myfile.db")
             ),
    cms.PSet(record = cms.string("GeometryFileRcd"),
             tag = cms.string("XMLFILE_Geometry_Extended_120DD4hepV4X"),
             connect = cms.string("sqlite_file:myfile.db"),
#             label = cms.string("Extended")
             ),
    cms.PSet(record = cms.string("IdealGeometryRecord"),
             tag = cms.string("TKRECO_Geometry_120DD4hepV4X"),
             connect = cms.string("sqlite_file:myfile.db")
             ),
    cms.PSet(record = cms.string('PTrackerParametersRcd'),
             tag = cms.string('TKParameters_Geometry_120DD4hepV4X'),
             connect = cms.string("sqlite_file:myfile.db")
             ),
    cms.PSet(record = cms.string("PHcalRcd"),
             tag = cms.string("HCALRECO_Geometry_120DD4hepV4X"),
             connect = cms.string("sqlite_file:myfile.db")
             )
    )
