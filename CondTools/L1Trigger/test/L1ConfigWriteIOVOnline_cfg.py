...
process.L1CondDBIOVWriter.offlineDB = cms.string(options.orconConnect)
process.L1CondDBIOVWriter.offlineAuthentication = options.orconAuth
process.L1CondDBIOVWriter.tscKey = cms.string( options.tscKey )
process.L1CondDBIOVWriter.L1TriggerKeyTag = cms.string('L1TriggerKey_' + options.tagBase + '_hlt')
