...
process.dqmReferenceHistogramRootFileGetter = cms.EDAnalyzer("DQMReferenceHistogramRootFileEventSetupAnalyzer")

process.path = cms.Path(process.dqmReferenceHistogramRootFileGetter)
