...
process.EcalTrivialConditionRetriever.getLaserAlphaFromTypeEB =  cms.untracked.bool(False)
process.EcalTrivialConditionRetriever.getLaserAlphaFromTypeEE =  cms.untracked.bool(False)
...
process.CondDB.connect = 'sqlite_file:EcalLaserAlphas_fromFILE.db'
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    toPut = cms.VPSet(cms.PSet(
        ...
        tag = cms.string('EcalLaserAlphas_fromFILE')
        ))
)
