...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    tag = cms.string('ESIntercalibConstants_LG') # this is just a test tag for 2012D
...
process.ecalModule = cms.EDAnalyzer("StoreESCondition",
    ...
    inputFile = cms.untracked.string('CondTools/Ecal/test/preshower/ESIntercalibConstants_LG.txt')
    )))
