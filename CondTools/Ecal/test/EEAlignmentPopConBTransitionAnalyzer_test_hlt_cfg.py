...
options.register( 'destinationConnection'
                , 'sqlite_file:EEAlignment_PopCon_test.db' #default value
                , VarParsing.VarParsing.multiplicity.singleton
...
options.register( 'sourceConnection'
                ...
                , VarParsing.VarParsing.multiplicity.singleton
                , VarParsing.VarParsing.varType.string
                , """Connection string to the DB hosting tags for RunInfo and EEAlignment.
...
options.register( 'tagForBOff'
                ...
                , VarParsing.VarParsing.multiplicity.singleton
                , VarParsing.VarParsing.varType.string
                , "Tag used to retrieve the EEAlignment payload for magnet off."
                  )
options.register( 'tagForBOn'
                , 'EEAlignment_hlt_3.8T'
                , VarParsing.VarParsing.multiplicity.singleton
                , VarParsing.VarParsing.varType.string
                , "Tag used to retrieve the EEAlignment payload for magnet on."
                  )
