...
process = cms.Process("EEAlignmentPopulator")
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
                                          CondDBConnection,
                                          toPut = cms.VPSet(cms.PSet(record = cms.string("EEAlignmentRcd"),
                                                                     tag = cms.string(conddb_init.options.destinationTag)
                                                                     )
                                                            )
                                          )

process.popConEEAlignment = cms.EDAnalyzer("EcalAlignmentPopConBTransitionAnalyzer",
