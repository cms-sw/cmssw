...
process = cms.Process("ESGainPopulator")
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
                                          CondDBConnection,
                                          toPut = cms.VPSet(cms.PSet(record = cms.string("ESGainRcd"),
                                                                     tag = cms.string(conddb_init.options.destinationTag)
                                                                     )
                                                            )
                                          )

process.popConESGain = cms.EDAnalyzer("ESGainPopConTransitionAnalyzer",
