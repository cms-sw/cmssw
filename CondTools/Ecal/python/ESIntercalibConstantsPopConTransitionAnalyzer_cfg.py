...
process = cms.Process("ESIntercalibConstantsPopulator")
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
                                          CondDBConnection,
                                          toPut = cms.VPSet(cms.PSet(record = cms.string("ESIntercalibConstantsRcd"),
                                                                     tag = cms.string(conddb_init.options.destinationTag)
                                                                     )
                                                            )
                                          )

process.popConESIntercalibConstants = cms.EDAnalyzer("ESIntercalibConstantsPopConTransitionAnalyzer",
