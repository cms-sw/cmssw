...
#    DBpass  = cms.string('0r4cms_3c4lc0nf'),
    ...
    outFile = cms.string('TPG_beamv6_trans_rrrrrr_spikekill.txt'),
   ...
   #### TPG calculation parameters ####
    ...
    transparency_corrections = cms.string('../../../Tools/DBDump/bin/weekly_rrrrrr'), # transparency corr to be used to compute linearizer parameters 1/crystal
