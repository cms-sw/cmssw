#ifndef ECAL_TPG_FINEGRAINEBIDMAP_HANDLER_H
#define ECAL_TPG_FINEGRAINEBIDMAP_HANDLER_H
...
namespace popcon
{
	...
	class EcalTPGFineGrainEBIdMapHandler : public popcon::PopConSourceHandler<EcalTPGFineGrainEBIdMap>
	{
