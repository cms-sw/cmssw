...
namespace popcon
{
  class EcalLaser_weekly_Linearization_Check : public popcon::PopConSourceHandler<EcalTPGLinearizationConst>
  {
    
  public:
    void getNewObjects() override;
    ~EcalLaser_weekly_Linearization_Check() override;
    EcalLaser_weekly_Linearization_Check(edm::ParameterSet const & ); 
