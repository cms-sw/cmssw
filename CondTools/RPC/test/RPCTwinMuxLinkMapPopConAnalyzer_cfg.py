...
process.MessageLogger.destinations.append("RPCTwinMuxLinkMapPopConAnalyzer_log")
process.MessageLogger.RPCTwinMuxLinkMapPopConAnalyzer_log = cms.untracked.PSet(
