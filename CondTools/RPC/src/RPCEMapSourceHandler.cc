...
// get links
      ...
      for(auto & iLink : theLink) {
        ...
        condition = "LINKBOARD.MASTERID="+IntToString(iLink.first)+" AND BOARD.BOARDID=LINKBOARD.LINKBOARDID AND LINKBOARD.MASTERID<>LINKBOARD.LINKBOARDID";
...
// get FEBs
          ...
          condition = "FEBLOCATION.LB_LINKBOARDID="+IntToString(iLB.first)+" AND FEBLOCATION.FEBLOCATIONID=FEBCONNECTOR.FL_FEBLOCATIONID";
