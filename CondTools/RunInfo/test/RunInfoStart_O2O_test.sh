...
cmsRun $CMSSW_BASE/src/CondTools/RunInfo/python/RunInfoPopConAnalyzer_cfg.py runNumber=$lastRun destinationConnection=sqlite_file:runinfo_O2O_test.db tag=runinfo_start_31X_hlt
ret=$?
