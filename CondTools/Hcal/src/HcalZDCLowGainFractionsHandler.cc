...
void HcalZDCLowGainFractionsHandler::getNewObjects() {
  edm::LogInfo("HcalZDCLowGainFractionsHandler") << "------- " << m_name << " - > getNewObjects\n"
                                                 <<
...
void HcalZDCLowGainFractionsHandler::initObject(HcalZDCLowGainFractions* fObject) { myDBObject = fObject; }
