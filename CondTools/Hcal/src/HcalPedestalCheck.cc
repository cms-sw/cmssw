#include "CondTools/Hcal/src/HcalPedestalCheck.h"

//HcalPedestalCheck::HcalPedestalCheck(edm::ParameterSet const& ps)
//{
//  //  front = ps.getUntrackedParameter<string>("outFilePrefix","Dump");
//}
//
//~HcalPedestalCheck::HcalPedestalCheck()
//{
//}

void HcalPedestalCheck::analyze(const edm::Event& ev, const edm::EventSetup& es)
{
  ...
  const HcalElectronicsMap* myRefEMap = refEMap.product();
    ...
    std::ofstream outStream3(filename3.str().c_str());
...
//vecDetId HcalPedestalCheck::getMissingDetIds(vector<HcalPedestals> & myPedestals)
//{
