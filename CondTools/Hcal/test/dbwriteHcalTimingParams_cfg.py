...
process.es_ascii = cms.ESSource("HcalTextCalibrations",
    input = cms.VPSet(cms.PSet(
        object = cms.string('TimingParams'),
        file = cms.FileInPath('CondTools/Hcal/test/testdata/timingtest.txt')
    ))
)
...
process.mytest = cms.EDAnalyzer("HcalTimingParamsPopConAnalyzer",
    record = cms.string('HcalTimingParamsRcd'),
    loggingOn= cms.untracked.bool(True),
    SinceAppendMode=cms.bool(False),
    name=cms.untracked.string('HcalTimingParams'),
    Source=cms.PSet(
