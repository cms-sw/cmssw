...
std::unique_ptr<HFPhase1PMTParams> make_HFPhase1PMTParams_dummy()
{
    ...
    std::unique_ptr<HFPhase1PMTData> defaultItem(new HFPhase1PMTData(
            cuts, -FLT_MAX, -FLT_MAX, FLT_MAX));
    ...
    return std::unique_ptr<HFPhase1PMTParams>(new HFPhase1PMTParams(
