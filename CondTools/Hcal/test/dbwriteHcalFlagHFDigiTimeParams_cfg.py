...
process.es_ascii = cms.ESSource("HcalTextCalibrations",
    input = cms.VPSet(cms.PSet(
        ...
        file = cms.FileInPath('CondTools/Hcal/test/testdata/FlagHFDigiTimeParams2011-run153943.txt')
    ))
)
...
process.mytest = cms.EDAnalyzer("HcalFlagHFDigiTimeParamsPopConAnalyzer",
    record = cms.string('HcalFlagHFDigiTimeParamsRcd'),
