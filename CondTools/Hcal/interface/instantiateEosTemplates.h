#ifndef CondTools_Hcal_instantiateEosTemplates_h_
#define CondTools_Hcal_instantiateEosTemplates_h_

// Explicit instantiation of boost templates for eos archives.
// Needed to overcome g++ quirks.
...
#endif // CondTools_Hcal_instantiateEosTemplates_h_
