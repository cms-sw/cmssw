...
#
$CMSSW_BASE/src/CondTools/OracleDBA/scripts/cmscond_bootstrap_detector.pl --offline_connect oracle://$CondDb/CMS_COND_PIXEL --auth $auth PIXEL
#
# Qusto e' per SQLite
#
...
#$CMSSW_BASE/src/CondTools/OracleDBA/scripts/cmscond_bootstrap_detector.pl --offline_connect sqlite_file:prova.db --auth $auth PIXEL