...
// Operations --
//--------------
DTHVAbstractCheck* DTHVAbstractCheck::getInstance() { return instance; }

bool DTHVAbstractCheck::chkFlag(const DTHVAbstractCheck::flag& f) { return (f.a || f.c || f.s); }

bool DTHVAbstractCheck::compare(const DTHVAbstractCheck::flag& fl, const DTHVAbstractCheck::flag& fr) {
  return ((fl.a == fr.a) && (fl.c == fr.c) && (fl.s == fr.s));
}
