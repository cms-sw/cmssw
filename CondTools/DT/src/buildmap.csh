...
set pagesize 2
select 'ENTRY',
       dt_wheel.orca_number as wheel,
       dt_chamber.orca_sector as sector,
       dt_chamber.orca_number as station,
       dt_superlayer.orca_number as sl,
       dt_layer.layer_number as layer,
       dt_cell.fe_position as cell,
  ...
  from dt_wheel,dt_sector,dt_chamber,dt_superlayer,dt_layer,dt_cell,
