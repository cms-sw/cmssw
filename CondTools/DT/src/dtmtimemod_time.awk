BEGIN {CLASS="DTMtime"; \
       CDATA="DTMtime::slData"; \
       SCOPE="DTMtime::slData::DTSLMtimeData"}
($2==     "::" && $3==  "DTMtime") {OBJECT_TABLE_NAME=$5}
...
($2==SCOPE"::" && $3==    "mTime") {COLUMN_NAME="T_MTIME"};
($2==SCOPE"::" && $3==    "mTrms") {COLUMN_NAME="T_MTRMS"};
($2==SCOPE"::") {
...
END {print "update POOL_OR_MAPPING_COLUMNS"                    \
     ...
     print "update POOL_OR_MAPPING_ELEMENTS"                   \
           " set TABLE_NAME=\047DT_MTIMESL\047"                \
           " where TABLE_NAME=\047"VECTOR_TABLE_NAME"\047;";
     print "alter table "VECTOR_TABLE_NAME                     \
           " rename to DT_MTIMESL;";
     print "update POOL_OR_MAPPING_COLUMNS"                    \
           " set COLUMN_NAME=\047IOV_VALUE_ID\047"             \
