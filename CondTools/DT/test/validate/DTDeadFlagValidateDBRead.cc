...
void DTDeadFlagValidateDBRead::analyze( const edm::Event& e,
  ...
  std::cout << std::distance( df->begin(), df->end() )
  ...
  while ( iter != iend ) {
    ...
    if ( status ) logFile << "ERROR while getting cell flags "
                          ...
                          << dfId.cellId    << " , status = "
                          << status << std::endl;
    if ( ( dfData.dead_HV ^ dead_HV ) ||
         ( dfData.dead_TP ^ dead_TP ) ||
         ( dfData.dead_RO ^ dead_RO ) ||
         ...
         logFile << "MISMATCH WHEN READING cell flags "
                 ...
                 << dfId.layerId   << " "
                 << dfId.cellId    << " : "
                 << dfData.dead_HV << " " << dfData.dead_TP << " "
                 << dfData.dead_RO << " " << dfData.discCat << " -> "
                 <<        dead_HV << " " <<        dead_TP << " "
