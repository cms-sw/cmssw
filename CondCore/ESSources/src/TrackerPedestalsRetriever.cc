...
TrackerPedestalsRetriever::~TrackerPedestalsRetriever()
{
  std::cout<<"TrackerPedestalRetriever::~TrackerPedestalRetriever"<<std::endl;
...
//
const Pedestals*
TrackerPedestalsRetriever::produce( const TrackerPedestalsRcd& )
{
  std::cout<<"TrackerPedestalsRetriever::produce"<<std::endl;
  try{
...
void
TrackerPedestalsRetriever::setIntervalFor( const EventSetupRecordKey&,
					   const edm::Timestamp& iTime, 
					   edm::ValidityInterval& oValidity)
{
  std::cout<<"TrackerPedestalsRetriever::setIntervalFor "<< iTime.value()<<std::endl;
  ...
  std::cout<<"end TrackerPedestalsRetriever::setIntervalFor"<<std::endl;
}
