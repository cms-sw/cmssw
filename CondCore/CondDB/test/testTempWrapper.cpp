...
int main (int argc, char** argv)
{
  ...
  //std::string connectionString("sqlite_file:RUN_INFO.db");
  std::string connectionString("oracle://cms_orcon_adg/CMS_COND_31X_RUN_INFO");
  //std::string connectionString("oracle://cms_orcoff_prep/CMS_CONDITIONS");
  ...
  try{
    ...
    //conddb::IOVProxy reader = session.readIov( "runinfo_31X_hlt_GG_TEST", true );
    conddb::IOVProxy reader = session.readIov( "runinfo_31X_mc", true );
    for( auto iov: reader ){
