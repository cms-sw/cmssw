...
/// Access output level
coral::MsgLevel
cond::persistency::CoralMsgReporter::outputLevel() const
{
  return m_level;
}
...
/// Modify output level
void
cond::persistency::CoralMsgReporter::setOutputLevel(coral::MsgLevel lvl)
{
  m_level = lvl;
}
...
void
cond::persistency::CoralMsgReporter::report( int lvl,
