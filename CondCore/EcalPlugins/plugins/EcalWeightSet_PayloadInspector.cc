 ...
 *******************************************************/
  ...
  public:
    EcalWeightSetPlot() : cond::payloadInspector::PlotImage<EcalWeightSet>("Ecal Weight Set - map ") {
      setSingleIov(true);
    }
...
PAYLOAD_INSPECTOR_MODULE(EcalWeightSet) { PAYLOAD_INSPECTOR_CLASS(EcalWeightSetPlot); }