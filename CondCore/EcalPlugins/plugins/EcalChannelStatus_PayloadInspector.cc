...
public:
  ...
  void getBarrelErrorSummary(std::vector<EcalChannelStatusCode> vItems,long unsigned int & errorCount){
  ...
  void getEndCapErrorSummary(std::vector<EcalChannelStatusCode> vItems,long unsigned int & errorCountEE1,
