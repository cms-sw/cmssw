...
namespace {
  ...
  *******************************************************/
  ...
  public:
    EcalLaserAlphasEBMap() : cond::payloadInspector::Histogram2D<EcalLaserAlphas>("ECAL Barrel Laser Alphas- map ",
  ...
  *******************************************************/
  ...
  public:
    EcalLaserAlphasEEMap() : cond::payloadInspector::Histogram2D<EcalLaserAlphas>( "ECAL Endcap Laser Alphas- map ",
...
class EcalLaserAlphasSummaryPlot: public cond::payloadInspector::PlotImage<EcalLaserAlphas>{
  ...
  bool fill(const std::vector<std::tuple<cond::Time_t, cond::Hash> >& iovs)override {
    ...
    if(payload.get()){
      NbRows=2;
      align=new TH2F("Ecal Laser Alphas","EB/EE      mean_x      rms        num_x",4,0,4,NbRows,0,NbRows);
