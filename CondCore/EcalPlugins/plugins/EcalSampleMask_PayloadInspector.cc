 ...
 *******************************************************/
  ...
  public:
    EcalSampleMaskPlot() : cond::payloadInspector::PlotImage<EcalSampleMask>("ECAL Sample Mask - map ") {
      setSingleIov(true);
    }
...
PAYLOAD_INSPECTOR_MODULE(EcalSampleMask) { PAYLOAD_INSPECTOR_CLASS(EcalSampleMaskPlot); }