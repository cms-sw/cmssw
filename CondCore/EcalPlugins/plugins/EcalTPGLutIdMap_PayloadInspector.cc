 ...
 ******************************************/
  ...
  public:
    EcalTPGLutIdMapPlot() : cond::payloadInspector::PlotImage<EcalTPGLutIdMap>("Ecal TPG LutId Map - map ") {
      setSingleIov(true);
    }
    ...
    bool fill(const std::vector<std::tuple<cond::Time_t, cond::Hash> >& iovs) override {
      ...
      if (payload.get()) {
        ...
        align = new TH2F("Ecal TPG LutId Map",
                         "EB                                 LutEcalTPGLut                 EE                          "
                         "       LutEcalTPGLut",
                         4,
                         0,
...
PAYLOAD_INSPECTOR_MODULE(EcalTPGLutIdMap) { PAYLOAD_INSPECTOR_CLASS(EcalTPGLutIdMapPlot); }
