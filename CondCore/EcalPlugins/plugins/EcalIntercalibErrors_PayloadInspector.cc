...
namespace {
  ...
  *******************************************************/
  ...
  public:
    EcalIntercalibErrorsEBMap() : cond::payloadInspector::Histogram2D<EcalIntercalibErrors>("ECAL Barrel Intercalib Errors- map ",
  ...
  *******************************************************/
  ...
  public:
    EcalIntercalibErrorsEEMap() : cond::payloadInspector::Histogram2D<EcalIntercalibErrors>( "ECAL Endcap Intercalib Errors - map ",
  ...
  *************************************************/
  ...
  public:
    EcalIntercalibErrorsPlot() : cond::payloadInspector::PlotImage<EcalIntercalibErrors>("ECAL Intercalib Error - map ") {
      setSingleIov( true );
    }
  ...
  *****************************************************************/
  ...
  public:
    EcalIntercalibErrorsDiff() : cond::payloadInspector::PlotImage<EcalIntercalibErrors>("ECAL Intercalib Error difference ") {
      setSingleIov(false);
    }
...
class EcalIntercalibErrorsSummaryPlot: public cond::payloadInspector::PlotImage<EcalIntercalibErrors>{
  ...
  bool fill(const std::vector<std::tuple<cond::Time_t, cond::Hash> >& iovs)override {
    ...
    if(payload.get()){
      NbRows=2;
      align=new TH2F("Ecal Intercalib Errors","EB/EE      mean_x      rms        num_x",4,0,4,NbRows,0,NbRows);
