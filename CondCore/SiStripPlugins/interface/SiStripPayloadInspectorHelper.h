...
const char * regionType(int index)
{
  ...
  switch(region){
  case sistrippayloadinspector::TIB1r: return "TIB L1 r-#varphi";
  case sistrippayloadinspector::TIB1s: return "TIB L1 stereo";
  case sistrippayloadinspector::TIB2r: return "TIB L2 r-#varphi";
  ...
  case sistrippayloadinspector::TOB1r: return "TOB L1 r-#varphi";
  case sistrippayloadinspector::TOB1s: return "TOB L1 stereo";
  case sistrippayloadinspector::TOB2r: return "TOB L2 r-#varphi";
  case sistrippayloadinspector::TOB2s: return "TOB L2 stereo";
  case sistrippayloadinspector::TOB3r: return "TOB L3 r-#varphi";
  ...
  case sistrippayloadinspector::TEC1r: return "TEC D1 r-#varphi";
  case sistrippayloadinspector::TEC1s: return "TEC D1 stereo";
  case sistrippayloadinspector::TEC2r: return "TEC D2 r-#varphi";
  case sistrippayloadinspector::TEC2s: return "TEC D2 stereo";
  case sistrippayloadinspector::TEC3r: return "TEC D3 r-#varphi";
  case sistrippayloadinspector::TEC3s: return "TEC D3 stereo";
  case sistrippayloadinspector::TEC4r: return "TEC D4 r-#varphi";
  case sistrippayloadinspector::TEC4s: return "TEC D4 stereo";
  case sistrippayloadinspector::TEC5r: return "TEC D5 r-#varphi";
  case sistrippayloadinspector::TEC5s: return "TEC D5 stereo";
  case sistrippayloadinspector::TEC6r: return "TEC D6 r-#varphi";
  case sistrippayloadinspector::TEC6s: return "TEC D6 stereo";
  case sistrippayloadinspector::TEC7r: return "TEC D7 r-#varphi";
  case sistrippayloadinspector::TEC7s: return "TEC D7 stereo";
  case sistrippayloadinspector::TEC8r: return "TEC D8 r-#varphi";
  case sistrippayloadinspector::TEC8s: return "TEC D8 stereo";
  case sistrippayloadinspector::TEC9r: return "TEC D9 r-#varphi";
  case sistrippayloadinspector::TEC9s: return "TEC D9 stereo";
  case sistrippayloadinspector::TID1r: return "TID D1 r-#varphi";
  case sistrippayloadinspector::TID1s: return "TID D1 stereo";
  case sistrippayloadinspector::TID2r: return "TID D2 r-#varphi";
  case sistrippayloadinspector::TID2s: return "TID D2 stereo";
  case sistrippayloadinspector::TID3r: return "TID D3 r-#varphi"; 
