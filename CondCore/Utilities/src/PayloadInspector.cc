...
namespace cond {
  ...
  namespace payloadInspector {
    ...
    bool PlotBase::isTwoTags() const {
      return m_plotAnnotations.twoTags;
    }
    ...
    bool PlotBase::process( const std::string& connectionString,  const std::string& tag, const std::string&, cond::Time_t begin, cond::Time_t end ){
      init();
    ...
    **/
    ...
    bool PlotBase::processTwoTags( const std::string& connectionString,  const std::string& tag0, const std::string& tag1, cond::Time_t time0, cond::Time_t time1 ){
      init();
    ...
    void PlotBase::setTwoTags( bool flag ){
      ...
      if(flag) m_plotAnnotations.singleIov = flag;
    }
