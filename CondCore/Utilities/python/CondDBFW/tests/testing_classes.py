...
secrets_file_1 = "/tmp/jdawes/cmssw-dev-env/CMSSW_7_6_X_2015-09-30-2300/src/CondCore/Utilities/python/netrc_test"
...
class querying_tests(unittest.TestCase):
	...
	def test_factory_multiple_results(self):
		tags = self.connection.tag(synchronization="Offline")
