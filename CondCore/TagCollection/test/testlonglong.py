...
session = svc.connect( 'sqlite_file:testcoral.db',accessMode = coral.access_Update )
#session = svc.connect( 'oracle://devdb10/cms_xiezhen_dev',accessMode = coral.access_Update )
