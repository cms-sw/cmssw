...
process.load('SimGeneral.MixingModule.mixNoPU_pps2017_cfi')
...
#process.load('Configuration.Geometry.GeometryExtended2017_CTPPS_cff') # Gustavo

process.load('Configuration.StandardSequences.GeometryDB_cff')
#process.load('Configuration.StandardSequences.GeometryRecoDB_cff') # Sunanda
...
process.GlobalTag.toGet = cms.VPSet(
    cms.PSet(
        ...
        tag = cms.string("CTPPSRPAlignment_real_2017_test"),
