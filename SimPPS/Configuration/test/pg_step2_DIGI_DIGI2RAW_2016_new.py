...
process.load('SimGeneral.MixingModule.mixNoPU_pps2016_cfi')
...
##analyse event content
#process.eca = cms.EDAnalyzer("EventContentAnalyzer")
#process.event_analysis= cms.Path(process.eca)

# Schedule definition
process.schedule = cms.Schedule(#process.event_analysis,
