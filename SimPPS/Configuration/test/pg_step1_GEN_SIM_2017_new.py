...
#process.load('Configuration.Geometry.GeometryExtended2021_cff') # Gustavo
process.load('Configuration.StandardSequences.GeometryRecoDB_cff') # Sunanda
#### before CMSSW_12_1_X_2021-10-07-2300 Gustavo 
#### dropped following line from Configuration/Geometry/python/GeometryExtended2021_cff.py (or 2017_CTPPS)
...
#process.g4SimHits.HepMCProductLabel   = cms.InputTag('LHCTransport')
#process.g4SimHits.Generator.HepMCProductLabel   = cms.InputTag('LHCTransport')
...
process.options = cms.untracked.PSet(
    SkipEvent = cms.untracked.vstring('EventCorruption','ProductNotFound')
)
