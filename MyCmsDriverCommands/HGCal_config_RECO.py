...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('DYToMuMu_M-20_HGCALGS_PU140_ME0_RECO_100ps_amandeep_100_v3.root'),
...
process.me0Segments.dTimeChainBoxMax = cms.double(400.0)
# done at RAW level :-)
# process.simMuonME0Digis.timeResolution = cms.double(0.100) # in ns 
